...
! **********************************************************************
  ...
  complex(qp), intent(in)  :: sarr(Npart,Npart)
  real(qp),    intent(out) :: vdip, c_dip(0:2)
  real(qp) :: Q2_aux, Fjk(0:2), Gj(0:2), norm_qcd, norm_qed
  integer        :: i, j, k
...
! **********************************************************************
  use kind_types, only: qp
  use ol_parameters_decl_qp
  use ol_loop_parameters_decl_qp, only: pi2_6, tf, ca, mu2_IR
...
! **********************************************************************
  use kind_types, only: qp
  use ol_parameters_decl_qp
  use ol_loop_parameters_decl_qp, only: mu2_IR, pi2_6, tf, ca, kappa
  use ol_loop_parameters_decl_dp, only: N_lf, SwF, SwB
  implicit none
