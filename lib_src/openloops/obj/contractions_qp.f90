...
! **********************************************************************
  ...
  ! Aout(2) = B(3) * (C(4)*D(1) - C(1)*D(4)) + B(4) * (C(1)*D(3) - C(3)*D(1)) + B(1) * (C(3)*D(4) - C(4)*D(3))
  ! Aout(3) = B(4) * (C(2)*D(1) - C(1)*D(2)) + B(1) * (C(4)*D(2) - C(2)*D(4)) + B(2) * (C(1)*D(4) - C(4)*D(1))
  ! Aout(4) = B(1) * (C(2)*D(3) - C(3)*D(2)) + B(2) * (C(3)*D(1) - C(1)*D(3)) + B(3) * (C(1)*D(2) - C(2)*D(1))
  ! light-cone representation
  ! Aout(1) = B(1) * (C(4)*D(3) - C(3)*D(4)) + B(4) * (C(3)*D(1) - C(1)*D(3)) + B(3) * (C(1)*D(4) - C(4)*D(1))
  ! Aout(2) = B(2) * (C(3)*D(4) - C(4)*D(3)) + B(3) * (C(4)*D(2) - C(2)*D(4)) + B(4) * (C(2)*D(3) - C(3)*D(2))
  ! Aout(3) = B(3) * (C(1)*D(2) - C(2)*D(1)) + B(1) * (C(2)*D(3) - C(3)*D(2)) + B(2) * (C(3)*D(1) - C(1)*D(3))
  ! Aout(4) = B(4) * (C(2)*D(1) - C(1)*D(2)) + B(2) * (C(1)*D(4) - C(4)*D(1)) + B(1) * (C(4)*D(2) - C(2)*D(4))
