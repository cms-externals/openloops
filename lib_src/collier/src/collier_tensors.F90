...
contains
  ...
  subroutine Aten_main_cll(TA,TAuv,masses2,rmax,TAerr)
    ...
    integer, parameter :: noutCritPointsTAtenmax=50
    ...
    if (Monitoring) then
      ...
      if(maxval(TAacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntAten_cll.le.noutCritPointsTAtenmax ) then
          call CritPointsOut_cll('TAten_cll',0,maxval(TAacc),CritPointsCntAten_cll)
          if( CritPointsCntAten_cll.eq.noutCritPointsTAtenmax) then
  ...
  subroutine Bten_main_cll(TB,TBuv,MomVec,MomInv,masses2,rmax,TBerr)
    ...
    integer :: r,n0,n1,n2,n3    
    integer, parameter :: noutCritPointsTBtenmax=50
    ...
    if (Monitoring) then
      ...
      if(maxval(TBacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntBten_cll.le.noutCritPointsTBtenmax ) then
          call CritPointsOut_cll('TBten_cll',0,maxval(TBacc),CritPointsCntBten_cll)
          if( CritPointsCntBten_cll.eq.noutCritPointsTBtenmax) then
  ...
  subroutine Cten_main_cll(TC,TCuv,MomVec,MomInv,masses2,rmax,TCerr)
    ...
    integer :: r,n0,n1,n2,n3    
    integer, parameter :: noutCritPointsTCtenmax=50
    ...
    if (Monitoring) then
      ...
      if(maxval(TCacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntCten_cll.le.noutCritPointsTCtenmax ) then
          call CritPointsOut_cll('TCten_cll',0,maxval(TCacc),CritPointsCntCten_cll)
          if( CritPointsCntCten_cll.eq.noutCritPointsTCtenmax) then
  ...
  subroutine Dten_main_cll(TD,TDuv,MomVec,MomInv,masses2,rmax,TDerr)
    ...
    integer :: r,n0,n1,n2,n3    
    integer, parameter :: noutCritPointsTDtenmax=50
    ...
    if (Monitoring) then
      ...
      if(maxval(TDacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntDten_cll.le.noutCritPointsTDtenmax ) then
          call CritPointsOut_cll('TDten_cll',0,maxval(TDacc),CritPointsCntDten_cll)
          if( CritPointsCntDten_cll.eq.noutCritPointsTDtenmax) then
  ...
  subroutine Eten_main_cll(TE,TEuv,MomVec,MomInv,masses2,rmax,TEerr)
    ...
    integer :: r,n0,n1,n2,n3    
    integer, parameter :: noutCritPointsTEtenmax=50
    ...
    if (Monitoring) then
      ...
      if(maxval(TEacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntEten_cll.le.noutCritPointsTEtenmax ) then
          call CritPointsOut_cll('TEten_cll',0,maxval(TEacc),CritPointsCntEten_cll)
          if( CritPointsCntEten_cll.eq.noutCritPointsTEtenmax) then
  ...
  subroutine Ften_main_cll(TF,TFuv,MomVec,MomInv,masses2,rmax,TFerr)
    ...
    integer :: r,n0,n1,n2,n3    
    integer, parameter :: noutCritPointsTFtenmax=50
    ...
    call setTenCache_cll(tenred_cll)
    ...
    if (Monitoring) then
      ...
      if(maxval(TFacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntFten_cll.le.noutCritPointsTFtenmax ) then
          call CritPointsOut_cll('TFten_cll',0,maxval(TFacc),CritPointsCntFten_cll)
          if( CritPointsCntFten_cll.eq.noutCritPointsTFtenmax) then
  ...
  subroutine Gten_main_cll(TG,TGuv,MomVec,MomInv,masses2,rmax,TGerr)
    ...
    double precision :: CGerr(0:rmax), TGerr_aux(0:rmax), TGacc(0:rmax)
    double precision :: norm(0:rmax)
    double complex :: args(52)
    integer :: r,n0,n1,n2,n3
    integer, parameter :: noutCritPointsTGtenmax=50
    ...
    if (Monitoring) then
      ...
      if(maxval(TGacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntGten_cll.le.noutCritPointsTGtenmax ) then
          call CritPointsOut_cll('TGten_cll',0,maxval(TGacc),CritPointsCntGten_cll)
          if( CritPointsCntGten_cll.eq.noutCritPointsTGtenmax) then
  ...
  subroutine TNten_main_cll(TN,TNuv,MomVec,MomInv,masses2,N,rmax,TNerr)
    ...
    integer :: r,n0,n1,n2,n3    
    integer, parameter :: noutCritPointsTNtenmax=50
    logical :: eflag
    ...
    if (Monitoring) then
      ...
      if(maxval(TNacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntTNten_cll(N).le.noutCritPointsTNtenmax ) then
          call CritPointsOut_cll('TNten_cll',N,maxval(TNacc),CritPointsCntTNten_cll(N))
          if( CritPointsCntTNten_cll(N).eq.noutCritPointsTNtenmax) then
...
!      call A_cll(CA,CAuv,masses2(0),rmax,CAerr,0)
    ...
    if (Monitoring) then
      ...
      if(maxval(TAacc).gt.critacc_cll) then
        ...
        if ( CritPointsCntTNten_cll(1).le.noutCritPointsTNtenmax ) then
          call CritPointsOut_cll('TNten_cll',1,maxval(TAacc),CritPointsCntTNten_cll(1))
          if( CritPointsCntTNten_cll(1).eq.noutCritPointsTNtenmax) then
