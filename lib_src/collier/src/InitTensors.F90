...
contains
  ...
  subroutine init_tables2(N,rmax)
  ...
  subroutine setCFtab(rmax)
    ...
    integer, intent(in) :: rmax
    integer :: mu, n, nu, IndMu(0:3), IndNu(0:3), CF, i
  ...
  subroutine CheckTensors_cll(T1,T2,MomVec,MomInv,masses2,norm,N,rmax,Tdiff)
    ...
    "(A6,' TNten(',i1,','i1,','i1,','i1,') = (',E23.16,' , ',E23.16,' ), r=',i2)"
    character(len=*),parameter :: fmt3 = &
    "(A7,'(',i1,','i2,') = dcmplx(',d24.18,' , ',d24.18,' )')"    
