...
contains
  ...
  subroutine CheckCoefsA_cll(A,A2,m02,rmax,norm0,Adiff)
    ...
    double precision, intent(out) :: Adiff(0:rmax/2)
...
!    integer, save :: DiffCntA
    ...
    character(len=*),parameter :: fmt1 = "(A5,'dcmplx( ',d24.18,' , ',d24.18,' )')"
...
!    integer, save :: DiffCntB
    ...
    character(len=*),parameter :: fmt1 = "(A6,'dcmplx( ',d24.18,' , ',d24.18,' )')"
    character(len=*),parameter :: fmt2 = &
...
!    data DiffCntE /0/
    ...
    if(ncheckout_cll.eq.-1) flagEc=0    
    ratio=0d0
...
!    integer, save :: DiffCntTN
    ...
    integer :: i1,i2
    character(len=*),parameter :: fmt1 = "(A8'(',i2,')=dcmplx(',d24.18,',',d24.18,')')"
    character(len=*),parameter :: fmt2 = &
...
!    integer, save :: DiffCntDB
    ...
    character(len=*),parameter :: fmt1 = "(A5,'dcmplx(',g24.18,',',g24.18,')')"
...
!  end subroutine getErrFlag_cll
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !  subroutine ErrOut_cll(sub,err)
  !
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

! Suppression of output must be implemented in calling routines!

  subroutine ErrOut_cll(sub,err,flag)
...
110 format (/' Numbers of calls of COLLIER functions'/  &
        ' with an estimated accuracy worse than  reqacc_coli = ',Es10.4)
...
130 format (/' Numbers of calls of COLLIER functions'/  &
        ...
        ' sqrt(reqacc_coli) = ',Es10.4)


    write(ncpout_cll,120) critacc_cll
120 format (/' Numbers of calls of COLLIER functions'/  &
        ' with an estimated accuracy worse than critacc_coli = ',Es10.4)
...
330 format (/' Numbers of calls of COLLIER functions'/  &
        ' with difference between COLI and DD > checkacc_cll = ',Es10.4)
