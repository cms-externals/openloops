...
contains
  ...
  subroutine WriteMaster_cll(nout)
    ...
    character(len=*),parameter :: fmt7 = "(A7,'dcmplx( ',d24.18,' , ',d24.18,' )')"
    character(len=*),parameter :: fmt9 = "(A8,i2,A7,'dcmplx( ',d24.18,' , ',d24.18,' )')"
    character(len=*),parameter :: fmt11 = "(A8,i2,A7,'dcmplx( ',d24.18,' , ',d24.18,' )')"
    character(len=*),parameter :: fmt12 = "(A8,i1,A2,i2,A4,'dcmplx( ',d24.18,' , ',d24.18,' )')"
    character(len=*),parameter :: fmt15 = "(A8,i2,A7,'dcmplx( ',d24.18,' , ',d24.18,' )')"
    character(len=*),parameter :: fmt16 = "(A8,i1,A2,i2,A4,'dcmplx( ',d24.18,' , ',d24.18,' )')"
