...
contains
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !  subroutine Init_cll(Nin)
  !
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

  subroutine Init_cll(Nin,folder_name,noreset)
...
!      call setninfoutcoli_cll(177)
!      call OpenInfOutFileCOLI_cll(trim(foldername_cll)//'/InfOut.coli')

!      call setnstatsoutcoli_cll(189)

!      call setncheckout_cll(175)
...
!    call addminf2_cll(dcmplx(0.001d0))
  ...
  subroutine InitEventCnt_cll()
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: phase-space point counter set to zero'
    end if
  ...
  subroutine SetMode_cll(mode)
    ...
    if (infoutlev_cll.ge.1) then
      write(ninfout_cll,'(a26,i2)') ' COLLIER: mode_cll set to ', mode_cll 
    end if
  ...
  subroutine SetMuUV2_cll(mu2)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: UV scale set to muUV2 =', muUV2_cll
    end if
  ...
  subroutine SetMuIR2_cll(mu2)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: IR scale set to muIR2 =', muIR2_cll
    end if
  ...
  subroutine SetDeltaUV_cll(delta)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: UV pole set to deltaUV =', DeltaUV_cll
    end if
  ...
  subroutine SetDeltaIR_cll(delta1,delta2)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: IR single pole set to deltaIR1 =', DeltaIR1_cll
      write(ninfout_cll,*) 'COLLIER: IR double pole set to deltaIR2 =', DeltaIR2_cll
    end if
  ...
  subroutine addminf2_cll(m2)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: added to list of infinitesimal masses: ', minf2_cll(nminf_cll)
    end if
  ...
  subroutine clearminf2_cll
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: list of infinitesimal masses cleared'
    end if
  ...
  subroutine SwitchOffIRrational_cll()
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: IR rational terms switched off'
    end if
  ...
  subroutine SetTenRed_cll(tenred)
    ...
    tenred_cll = tenred
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: direct tensor reduction switched on for N >= ',tenred
    end if
  ...
  subroutine SwitchOnTenRed_cll()
    ...
    tenred_cll = 6
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: direct tensor reduction switched on for N >= 6'
    end if
  ...
  subroutine SwitchOffTenRed_cll()
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: direct tensor reduction switched off'
    end if
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !  subroutine SwitchOffErrorStop_cll()
  !
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  end subroutine SwitchOffErrorStop_cll
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !  subroutine SetErrorStop_cll(errstop)
  !
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  end subroutine SetErrorStop_cll
  ...
  subroutine SwitchOnFileOutput_cll
    ...
    if ((nerrout_cp_cll.ne.-1).and.(nerrout_cp_cll.ne.stdout_cll)) then
    ...
    if ((nerroutcoli_cp_cll.ne.-1).and.(nerroutcoli_cp_cll.ne.stdout_cll)) then
    ...
    if ((nerroutdd_cp_cll.ne.-1).and.(nerroutdd_cp_cll.ne.stdout_cll)) then
    ...
    if ((ninfout_cp_cll.ne.-1).and.(ninfout_cp_cll.ne.stdout_cll)) then
    ...
    if ((ninfoutcoli_cp_cll.ne.-1).and.(ninfoutcoli_cp_cll.ne.stdout_cll)) then
    ...
    if ((ncheckout_cp_cll.ne.-1).and.(ncheckout_cp_cll.ne.stdout_cll)) then
    ...
    if ((ncpoutcoli_cp_cll.ne.-1).and.(ncpoutcoli_cp_cll.ne.stdout_cll)) then
    ...
    if ((ncpout_cp_cll.ne.-1).and.(ncpout_cp_cll.ne.stdout_cll)) then
    ...
    if ((ncpout2_cp_cll.ne.-1).and.(ncpout2_cp_cll.ne.stdout_cll)) then
    ...
    if ((nstatsoutcoli_cp_cll.ne.-1).and.(nstatsoutcoli_cp_cll.ne.stdout_cll)) then
  ...
  subroutine InitGlobalDD_cll
    ...
    integer :: nmax,rmax,rmax1,rmax2,rmax3,rmax4,rmax5,rmax6
    ...
    call DDsetcout_on(.true.)
    call DDgetglobal(nmax,rmax,rmax1,rmax2,rmax3,  &
                     rmax4,rmax5,rmax6)
  ...
  subroutine GetCPUprec_cll
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: estimator of CPU double precision set to dprec =', dprec_cll  
    end if
  ...
  subroutine SetAccuracy_cll(acc0,acc1,acc2)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: target precision set to acc0 =', reqacc_cll
      write(ninfout_cll,*) 'COLLIER: critical precision set to acc1 =', critacc_cll
      write(ninfout_cll,*) 'COLLIER: check precision set to acc2 =', checkacc_cll
    end if
  ...
  subroutine SetReqAcc_cll(acc)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: target precision set to reqacc =', reqacc_cll
    end if
  ...
  subroutine SetCritAcc_cll(acc)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: critical precision set to critacc =', critacc_cll
    end if

    if (infoutlev_cll.ge.1.and.critacc_cll.lt.reqacc_cll) then
      write(ninfout_cll,*) 'COLLIER WARNING: critical precision critacc =', critacc_cll
      write(ninfout_cll,*) '     smaller than required precision reqacc =', reqacc_cll
  ...
  subroutine SetCheckAcc_cll(acc)
    ...
    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: check precision set to checkacc =', checkacc_cll
    end if
  ...
  subroutine SetRitmaxBCD_cll(ritmax_B,ritmax_C,ritmax_D)
    ...
    if (ritmax_D.lt.4) then
      if (infoutlev_cll.ge.2) then
        write(ninfout_cll,*) 'COLLIER: SetRitmax_cll'
        write(ninfout_cll,*) 'ritmax_D has to be at least 4 --> it is set to 4'
      end if
      rmaxD_cll = 4
    else
      rmaxD_cll = ritmax_D
    ...
    if (ritmax_C.le.rmaxD_cll) then
      if (infoutlev_cll.ge.2) then
        write(ninfout_cll,*) 'COLLIER: SetRitmax_cll'
        write(ninfout_cll,*) 'ritmax_C has to be larger than ritmax_D --> it is set to ritmax_D+1'
      end if
    ...
    if (ritmax_B.le.rmaxC_cll) then
      if (infoutlev_cll.ge.2) then
        write(ninfout_cll,*) 'COLLIER: SetRitmax_coli'
        write(ninfout_cll,*) 'ritmax_B has to be larger than ritmax_C --> it is set to ritmax_C+1'
      end if
...
!    ErrCntDD_cll = val
  ...
  subroutine InitPointsCnt_cll()
    ...
    ! allocate Counters for Critical Points
  ...
  subroutine InitMonitoring_cll()
    ...
    if (Monitoring) then
      if (infoutlev_cll.ge.2) then
        write(ninfout_cll,*) 'COLLIER: CritPointsMonitor already initialized'
      end if
      return
    endif

    if (infoutlev_cll.ge.2) then
      write(ninfout_cll,*) 'COLLIER: CritPointsMonitor initialized'
    end if

    Monitoring = .true. 

    call InitPointsCnt_cll()
!    call setncritpointsout_cll(180)
    call OpenCritPointsOutFile_cll(trim(foldername_cll)//'/CritPointsOut.cll')
 
!    call setncritpointsout2_cll(181)
...
!    call setncpoutcoli_cll(183)
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !  subroutine InitOutChan_cll(exceptstdout)
  !
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!    qopened_critcoli=.true.
    ...
    write(unit=ncpoutcoli_cll,fmt=*) '***********************************************************'
    write(unit=ncpoutcoli_cll,fmt=*) '                                                           '
    write(unit=ncpoutcoli_cll,fmt='(A31,Es14.8)') &
...
!    qopened_crit=.true.
    ...
    write(unit=ncpout_cll,fmt=*) '***********************************************************'
    write(unit=ncpout_cll,fmt=*) '                                                           '
    write(unit=ncpout_cll,fmt='(A31,Es14.8)') &
        ' Critical precision: critacc = ',critacc_cll 
    write(unit=ncpout_cll,fmt=*) '                                                           '
    write(unit=ncpout_cll,fmt=*) '***********************************************************'
    write(unit=ncpout_cll,fmt=*)                                         
...
!    qopened_crit2=.true.
    ...
    write(unit=ncpout2_cll,fmt=*) '***********************************************************'
    write(unit=ncpout2_cll,fmt=*) '                                                           '
    write(unit=ncpout2_cll,fmt='(A31,Es14.8)') &
        ' Critical precision: critacc = ',critacc_cll
    write(unit=ncpout2_cll,fmt=*) '                                                           '
    write(unit=ncpout2_cll,fmt=*) '***********************************************************'
    write(unit=ncpout2_cll,fmt=*)                                         
  ...
  subroutine OpenCheckOutFile_cll(filename,nchan)
    ...
    write(unit=ncheckout_cll,fmt=*) '***********************************************************'
    write(unit=ncheckout_cll,fmt=*) '                                                           '
    write(unit=ncheckout_cll,fmt='(A30,Es14.8)') &
...
!    end if 
  ...
  subroutine WriteIntro_cll(un)
    ...
    write(unit=un,fmt=*) '        *                                         *        '
    write(unit=un,fmt=*) '        *             version 1.0 beta            *        '
    write(unit=un,fmt=*) '        *                                         *        '    
    write(unit=un,fmt=*) '        *******************************************        '
    write(unit=un,fmt=*) '                                                           ' 
