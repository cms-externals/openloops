...
*     +          del3ij,del4i,fdel4,ier)
      write(*,*) 'WARNING: function call'
      write(*,*) 'ffxe2(ce2ij,cexi(2),cexi(1),cd1ij,cd0i,xpi,fpij5,
     &            del3ij,del4i,fdel4,ier)'
      write(*,*) 'commented because the subroutine does not exist.'
	if ( atest ) then
*
*	PV-reduction
*
...
*     +		xpi,fpij5, del3ij,del4i,fdel4, ier)
      write(*,*) 'WARNING: function call'
      write(*,*) 'ffxe3(ce3ijk,ce2ij,cexi(2),cexi(1), cd2ijk,cd2i,cd1ij,cd0i,
     &            xpi,fpij5, del3ij,del4i,fdel4, ier)'
      write(*,*) 'commented because the subroutine does not exist.'
*
