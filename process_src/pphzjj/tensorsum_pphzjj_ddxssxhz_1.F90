...
! **********************************************************************
module ol_tensor_sum_storage_pphzjj_ddxssxhz_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphzjj_ddxssxhz_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphzjj_ddxssxhz_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pphzjj_ddxssxhz_1, only: channel_number_pphzjj_ddxssxhz_1
  ...
  call channel_on(channel_number_pphzjj_ddxssxhz_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,49)
  momenta_2(:,1) = Q(1:4,50)
  momenta_3(:,1) = Q(1:4,51)
  momenta_4(:,1) = Q(1:4,52)
  momenta_5(:,1) = Q(1:4,56)
  momenta_6(:,1) = Q(1:4,60)
  momenta_7(:,1) = Q(1:4,2)
  momenta_7(:,2) = Q(1:4,62)
  momenta_8(:,1) = Q(1:4,4)
  momenta_8(:,2) = Q(1:4,60)
  momenta_9(:,1) = Q(1:4,8)
  momenta_9(:,2) = Q(1:4,56)
  momenta_10(:,1) = Q(1:4,8)
  momenta_10(:,2) = Q(1:4,59)
  ...
  momenta_32(:,2) = Q(1:4,11)
  momenta_32(:,3) = Q(1:4,59)
  momenta_33(:,1) = Q(1:4,8)
  momenta_33(:,2) = Q(1:4,12)
  momenta_33(:,3) = Q(1:4,61)
  momenta_34(:,1) = Q(1:4,8)
  momenta_34(:,2) = Q(1:4,12)
  momenta_34(:,3) = Q(1:4,62)
  momenta_35(:,1) = Q(1:4,8)
  momenta_35(:,2) = Q(1:4,56)
  momenta_35(:,3) = Q(1:4,59)
  momenta_36(:,1) = Q(1:4,8)
  momenta_36(:,2) = Q(1:4,60)
  momenta_36(:,3) = Q(1:4,62)
  momenta_37(:,1) = Q(1:4,12)
  momenta_37(:,2) = Q(1:4,14)
  momenta_37(:,3) = Q(1:4,62)
  momenta_38(:,1) = Q(1:4,12)
  momenta_38(:,2) = Q(1:4,28)
  momenta_38(:,3) = Q(1:4,60)
  momenta_39(:,1) = Q(1:4,12)
  momenta_39(:,2) = Q(1:4,44)
  momenta_39(:,3) = Q(1:4,60)
  momenta_40(:,1) = Q(1:4,16)
  momenta_40(:,2) = Q(1:4,28)
  momenta_40(:,3) = Q(1:4,60)
  momenta_41(:,1) = Q(1:4,52)
  momenta_41(:,2) = Q(1:4,60)
  ...
  call TI_call(2, momenta_14, masses2_6, T2sum(:,9), M2)
  call TI_call(2, momenta_17, masses2_6, T2sum(:,10), M2)
  call TI_call(2, momenta_21, masses2_6, T2sum(:,11), M2)
  call TI_call(2, momenta_15, masses2_6, T2sum(:,12), M2)
  call TI_call(2, momenta_10, masses2_6, T2sum(:,13), M2)
  call TI_call(2, momenta_22, masses2_6, T2sum(:,14), M2)
  call TI_call(2, momenta_28, masses2_9, T2sum(:,15), M2)
  call TI_call(2, momenta_33, masses2_9, T2sum(:,16), M2)
  call TI_call(2, momenta_29, masses2_9, T2sum(:,17), M2)
  call TI_call(2, momenta_34, masses2_9, T2sum(:,18), M2)
  call TI_call(2, momenta_7, masses2_6, T2sum(:,19), M2)
  call TI_call(2, momenta_25, masses2_6, T2sum(:,20), M2)
  call TI_call(2, momenta_36, masses2_9, T2sum(:,21), M2)
  call TI_call(2, momenta_41, masses2_9, T2sum(:,22), M2)
  call TI_call(2, momenta_31, masses2_9, T2sum(:,23), M2)
  ...
  call TI_call(3, momenta_13, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_13, masses2_4, T3sum(:,3), M2)
  call TI_call(3, momenta_19, masses2_5, T3sum(:,4), M2)
  call TI_call(3, momenta_19, masses2_4, T3sum(:,5), M2)
  call TI_call(3, momenta_35, masses2_9, T3sum(:,6), M2)
  call TI_call(3, momenta_32, masses2_9, T3sum(:,7), M2)
  call TI_call(3, momenta_30, masses2_9, T3sum(:,8), M2)
  call TI_call(3, momenta_18, masses2_5, T3sum(:,9), M2)
  call TI_call(3, momenta_18, masses2_4, T3sum(:,10), M2)
  call TI_call(3, momenta_27, masses2_9, T3sum(:,11), M2)
  call TI_call(3, momenta_26, masses2_9, T3sum(:,12), M2)
  call TI_call(3, momenta_37, masses2_9, T3sum(:,13), M2)
  ...
  call TI_call(4, momenta_39, masses2_8, T4sum(:,1), M2)
  call TI_call(4, momenta_39, masses2_7, T4sum(:,2), M2)
  call TI_call(4, momenta_38, masses2_8, T4sum(:,3), M2)
  call TI_call(4, momenta_38, masses2_7, T4sum(:,4), M2)
  call TI_call(4, momenta_40, masses2_8, T4sum(:,5), M2)
  call TI_call(4, momenta_40, masses2_7, T4sum(:,6), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pphzjj_ddxssxhz_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphzjj_ddxssxhz_1_/**/REALKIND
