...
module ol_vamp_2_pphzjj_uuxhzgg_1_/**/REALKIND
contains
...
! **********************************************************************
  ...
  call loop_AZ_Q(G1(:,:,:,18),wf(:,6),G1(:,:,:,19),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,22),wf(:,6),G1(:,:,:,23),gZu)
  ...
  call loop_QZ_A(G2(:,:,:,27),wf(:,6),G2(:,:,:,28),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,30),wf(:,6),G2(:,:,:,31),gZu)
  ...
  call loop_AZ_Q(G3(:,:,:,15),wf(:,6),G3(:,:,:,16),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,43),wf(:,6),G2(:,:,:,44),gZu)
  ...
  call loop_AZ_Q(G3(:,:,:,21),wf(:,6),G3(:,:,:,22),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,36),wf(:,6),G1(:,:,:,37),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,56),wf(:,6),G2(:,:,:,57),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,48),wf(:,6),G1(:,:,:,49),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,54),wf(:,6),G1(:,:,:,55),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,71),wf(:,6),G2(:,:,:,72),gZu)
  ...
  call loop_AZ_Q(G3(:,:,:,36),wf(:,6),G3(:,:,:,37),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,74),wf(:,6),G2(:,:,:,75),gZu)
  ...
  call loop_AZ_Q(G3(:,:,:,40),wf(:,6),G3(:,:,:,41),gZu)
...
end module ol_vamp_2_pphzjj_uuxhzgg_1_/**/REALKIND
