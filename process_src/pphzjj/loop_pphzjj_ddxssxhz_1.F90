...
module ol_colourmatrix_pphzjj_ddxssxhz_1_/**/REALKIND
...
end module ol_colourmatrix_pphzjj_ddxssxhz_1_/**/REALKIND



module ol_forced_parameters_pphzjj_ddxssxhz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphzjj_ddxssxhz_1_/**/REALKIND

module ol_loop_pphzjj_ddxssxhz_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,3),wf(:,-2),wf(:,7))
  ...
  call vert_AZ_Q(gZd,wf(:,-1),wf(:,-5),wf(:,35))
  ...
  call counter_ZQ_A(gZd,wf(:,3),wf(:,0),wf(:,46))
  ...
  call counter_Q_A(ctqq,wf(:,6),Q(:,7),wf(:,55))
  call counter_Q_A(ctqq,wf(:,9),Q(:,52),wf(:,56))
...
end module ol_loop_pphzjj_ddxssxhz_1_/**/REALKIND
