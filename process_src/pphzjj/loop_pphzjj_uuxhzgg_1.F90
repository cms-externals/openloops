...
module ol_colourmatrix_pphzjj_uuxhzgg_1_/**/REALKIND
...
end module ol_colourmatrix_pphzjj_uuxhzgg_1_/**/REALKIND



module ol_forced_parameters_pphzjj_uuxhzgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphzjj_uuxhzgg_1_/**/REALKIND

module ol_loop_pphzjj_uuxhzgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,6),wf(:,8))
  ...
  call vert_QA_Z(gZu,wf(:,13),wf(:,14),wf(:,15))
  call vert_ZQ_A(gZu,wf(:,6),wf(:,0),wf(:,16))
  ...
  call counter_QA_Z(gZu,wf(:,4),wf(:,5),wf(:,33))
  call vert_QA_V(wf(:,4),wf(:,-1),wf(:,34))
  call counter_VQ_A(wf(:,-5),wf(:,4),wf(:,35))
  call counter_QA_Z(gZu,wf(:,13),wf(:,14),wf(:,36))
  ...
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,0),wf(:,47))
  ...
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,-3),wf(:,63))
  ...
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,4),wf(:,74))
  call vert_AZ_Q(gZu,wf(:,14),wf(:,-3),wf(:,75))
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,13),wf(:,76))
  call vert_AZ_Q(gZu,wf(:,5),wf(:,-3),wf(:,77))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,6),wf(:,78))
  ...
  call vert_QA_Z(gZu,wf(:,4),wf(:,81),wf(:,82))
  ...
  call vert_QA_Z(gZu,wf(:,13),wf(:,87),wf(:,88))
  call vert_AV_Q(wf(:,87),wf(:,-5),wf(:,89))
  call counter_ZQ_A(gZu,wf(:,6),wf(:,0),wf(:,90))
  ...
  call vert_QA_Z(gZu,wf(:,93),wf(:,14),wf(:,94))
...
end module ol_loop_pphzjj_uuxhzgg_1_/**/REALKIND
