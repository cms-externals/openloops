...
module ol_versiondata_pphzjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pphzjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphzjj
  end interface
end module ol_versiondata_pphzjj


subroutine ol_version_pphzjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphzjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphzjj
