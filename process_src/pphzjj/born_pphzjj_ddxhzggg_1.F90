...
module ol_colourmatrix_pphzjj_ddxhzggg_1_/**/REALKIND
...
end module ol_colourmatrix_pphzjj_ddxhzggg_1_/**/REALKIND



module ol_forced_parameters_pphzjj_ddxhzggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphzjj_ddxhzggg_1_/**/REALKIND

module ol_tree_pphzjj_ddxhzggg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pphzjj_ddxhzggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pphzjj_ddxhzggg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for down anti-down higgs Z glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_pphzjj_ddxhzggg_1, only: external_perm_pphzjj_ddxhzggg_1, &
    & external_perm_inv_pphzjj_ddxhzggg_1, extcomb_perm_pphzjj_ddxhzggg_1, &
    & average_factor_pphzjj_ddxhzggg_1
  use ol_external_pphzjj_ddxhzggg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_pphzjj_ddxhzggg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_pphzjj_ddxhzggg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_pphzjj_ddxhzggg_1
  ...
  extmasses2 = [ rZERO2, rZERO2, rMH2, rMZ2, rZERO2, rZERO2, rZERO2 ]
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_pphzjj_ddxhzggg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pphzjj_ddxhzggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pphzjj_ddxhzggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_pphzjj_ddxhzggg_1(extcombs(k))
  end do
  ...
  call prop_W_W(ntry, wf3(:,1), Q(:,12), MZ, 1_intkind1, wf3(:,2), n2(1))
  call vert_ZQ_A(gZd,ntry, wf3(:,2), ex1, wf6(:,1), n3(:,2), t3x6(:,:,1))
  ...
  call vert_AZ_Q(gZd,ntry, ex2, wf3(:,2), wf6(:,3), n3(:,7), t3x6(:,:,2))
  ...
  call vert_AZ_Q(gZd,ntry, wf4(:,4), wf3(:,2), wf12(:,1), n3(:,13), t3x12(:,:,1))
  call prop_Q_A(ntry, wf8(:,4), Q(:,81), ZERO, 0_intkind1, wf8(:,5), n2(8))
  call vert_AV_Q(ntry, wf4(:,4), ex7, wf8(:,6), n3(:,14), t3x8(:,:,2))
  call vert_ZQ_A(gZd,ntry, wf3(:,2), wf4(:,3), wf12(:,2), n3(:,15), t3x12(:,:,2))
  ...
  call vert_AZ_Q(gZd,ntry, wf4(:,6), wf3(:,2), wf12(:,3), n3(:,18), t3x12(:,:,3))
  ...
  call vert_AZ_Q(gZd,ntry, wf4(:,11), wf3(:,2), wf12(:,6), n3(:,28), t3x12(:,:,6))
  call prop_Q_A(ntry, wf8(:,14), Q(:,97), ZERO, 0_intkind1, wf8(:,15), n2(17))
  call vert_AV_Q(ntry, wf4(:,11), ex7, wf8(:,16), n3(:,29), t3x8(:,:,7))
  call vert_ZQ_A(gZd,ntry, wf3(:,2), wf4(:,10), wf12(:,7), n3(:,30), t3x12(:,:,7))
  ...
  call vert_ZQ_A(gZd,ntry, wf3(:,2), wf4(:,13), wf12(:,8), n3(:,34), t3x12(:,:,8))
  ...
  M2add = M2 / average_factor_pphzjj_ddxhzggg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_pphzjj_ddxhzggg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_pphzjj_ddxhzggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pphzjj_ddxhzggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pphzjj_ddxhzggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pphzjj_ddxhzggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pphzjj_ddxhzggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pphzjj_ddxhzggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pphzjj_ddxhzggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pphzjj_ddxhzggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pphzjj_ddxhzggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pphzjj_ddxhzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pphzjj_ddxhzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pphzjj_ddxhzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pphzjj_ddxhzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pphzjj_ddxhzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pphzjj_ddxhzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pphzjj_ddxhzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pphzjj_ddxhzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_pphzjj_ddxhzggg_1_/**/REALKIND
