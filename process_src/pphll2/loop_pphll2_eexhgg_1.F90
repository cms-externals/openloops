...
module ol_colourmatrix_pphll2_eexhgg_1_/**/REALKIND
...
end module ol_colourmatrix_pphll2_eexhgg_1_/**/REALKIND



module ol_forced_parameters_pphll2_eexhgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphll2_eexhgg_1_/**/REALKIND

module ol_loop_pphll2_eexhgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = (countertermnorm*ctZGG*eQED**3*gQCD**2*lambdaHZZ*MW)/(cw**2*sw)
    f(2) = (eQED**3*gQCD**2*integralnorm*lambdaHZZ*MW*SwF)/(cw**2*sw)
    f(3) = (2*eQED**3*gQCD**2*integralnorm*lambdaHZZ*MW*SwF)/(cw**2*sw)
    f(4) = (eQED**3*gQCD**2*integralnorm*SwF*YB)/(MW*sw*6._/**/REALKIND)
    f(5) = (eQED**3*gQCD**2*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f(6) = (eQED**3*gQCD**2*integralnorm*SwF*YT)/(MW*sw*3._/**/REALKIND)
    f(7) = (eQED**3*gQCD**2*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_GG_V(wf(:,-3),Q(:,8),wf(:,-4),Q(:,16),wf(:,2))
  call prop_W_W(wf(:,1),Q(:,3),MZ,1_intkind1,wf(:,3))
  call prop_W_W(wf(:,2),Q(:,24),MZ,1_intkind1,wf(:,4))
  call vert_SV_V(wf(:,-2),wf(:,3),wf(:,5))
  call prop_W_W(wf(:,5),Q(:,7),MZ,1_intkind1,wf(:,6))
...
end module ol_loop_pphll2_eexhgg_1_/**/REALKIND
