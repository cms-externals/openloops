...
module ol_colourmatrix_pphll2_nenexhgg_1_/**/REALKIND
...
end module ol_colourmatrix_pphll2_nenexhgg_1_/**/REALKIND



module ol_forced_parameters_pphll2_nenexhgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphll2_nenexhgg_1_/**/REALKIND

module ol_loop_pphll2_nenexhgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(4) = (eQED**3*gQCD**2*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f(5) = (eQED**3*gQCD**2*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
...
end module ol_loop_pphll2_nenexhgg_1_/**/REALKIND
