...
module ol_versiondata_heftpphjjj
  implicit none
  character(4) :: generator_revision = "1790"
  interface
    subroutine version_heftpphjjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_heftpphjjj
  end interface
end module ol_versiondata_heftpphjjj


subroutine ol_version_heftpphjjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_heftpphjjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_heftpphjjj
