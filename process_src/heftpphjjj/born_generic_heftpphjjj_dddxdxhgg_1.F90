...
module ol_external_heftpphjjj_dddxdxhgg_1
  ...
  subroutine set_permutation(perm) &
    ...
    average_factor_heftpphjjj_dddxdxhgg_1 = 1
    do i = 1, n_scatt
    ...
    if (out_symmetry_on /= 0) then
      do i = 1, 7
        average_factor_heftpphjjj_dddxdxhgg_1 = &
          average_factor_heftpphjjj_dddxdxhgg_1 &
          * factorial(count(particle_types_perm_heftpphjjj_dddxdxhgg_1(n_scatt+1:7) == i))
      end do
    end if
  ...
  subroutine pol_init(pol) &
      & bind(c,name="ol_f_pol_init_heftpphjjj_dddxdxhgg_1")
    implicit none
