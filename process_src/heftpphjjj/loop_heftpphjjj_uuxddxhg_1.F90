...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(61)-A(63)-A(65)-A(66)+A(121)+A(122)+A(123)+A(124)+A(125)+A(126)+A(127)+A(128)+A(129)+A(130)+A(131) &
       ...
       -A(87))*f(5))/6._/**/REALKIND+((A(20)+A(21)+A(22)+A(23)+A(25)+A(26))*f(9))/6._/**/REALKIND+((A(62)+A(64)+A(67)+A(68)+A(69) &
       +A(70)+A(79)+A(80)+A(88)+A(90))*f(11))/6._/**/REALKIND
  ...
  M2(4) = ((-A(39)-A(41)-A(42)-A(43)+A(109)+A(110)+A(111)+A(112)+A(113)+A(114)+A(115)+A(116)+A(117)+A(118)+A(119) &
       ...
       -A(99))*f(5))/6._/**/REALKIND+((A(14)+A(15)+A(17)+A(18)+A(28)+A(29))*f(9))/6._/**/REALKIND+((A(38)+A(40)+A(48)+A(49)+A(55) &
       +A(56)+A(82)+A(83)+A(91)+A(92))*f(11))/6._/**/REALKIND
