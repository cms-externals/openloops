...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(13)-A(16)-A(18)-A(19))*f(1))/2._/**/REALKIND+((-A(21)-A(22)-A(23)-A(24))*f(1))/6._/**/REALKIND+(CI*(A(2)+A(10) &
       -A(11)+A(12))*f(2))/2._/**/REALKIND
  ...
  M2(1) = ((-A(88)-A(93)-A(104)-A(105)+A(229)+A(230)+A(231)+A(237)+A(238)+A(239)+A(244)+A(245)+A(246)+A(247)+A(249) &
       +A(252))*f(3))/2._/**/REALKIND+((-A(107)-A(110)-A(111)-A(112)+A(253)+A(254)+A(255)+A(256)+A(257)+A(258)+A(259)+A(260) &
       +A(261)+A(262)+A(263)+A(264))*f(3))/6._/**/REALKIND+(CI*(A(83)-A(84)+A(85)-A(86)+A(87)+A(220)-A(221)-A(222)+A(223)-A(224) &
       -A(225)+A(226)+A(227)-A(228))*f(4))/2._/**/REALKIND+((-A(124)-A(125)-A(126)-A(127)-A(156)-A(157)-A(158)-A(159)-A(177) &
       -A(178)-A(179)-A(180))*f(5))/6._/**/REALKIND+((-A(94)-A(96)-A(118)-A(120)-A(145)-A(147)-A(163)-A(165)-A(169)-A(170)-A(189) &
  ...
  M2(2) = ((A(102)+A(104)+A(105)+A(106)-A(241)-A(242)-A(243)-A(244)-A(245)-A(246)-A(247)-A(248)-A(249)-A(250)-A(251) &
       ...
       +A(205)+A(206)-A(207))*f(4))/2._/**/REALKIND+((A(117)+A(118)+A(119)+A(120)+A(145)+A(146)+A(147)+A(148)+A(188)+A(189)+A(190) &
       +A(191))*f(5))/6._/**/REALKIND+((A(73)+A(75)+A(125)+A(127)+A(136)+A(138)+A(157)+A(159)+A(177)+A(178)+A(195) &
  ...
  M2(4) = ((-A(68)-A(70)-A(71)-A(72)+A(208)+A(209)+A(210)+A(211)+A(212)+A(213)+A(214)+A(215)+A(216)+A(217)+A(218) &
       ...
       +A(185))*f(11))/2._/**/REALKIND+((A(67)+A(69)+A(77)+A(78)+A(132)+A(134)+A(139)+A(140)+A(184)+A(187))*f(11))/6._/**/REALKIND &
       +(CI*(-A(100)+A(123)+A(151)-A(172))*f(12))/2._/**/REALKIND
