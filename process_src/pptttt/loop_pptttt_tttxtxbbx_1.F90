...
module ol_colourmatrix_pptttt_tttxtxbbx_1_/**/REALKIND
...
end module ol_colourmatrix_pptttt_tttxtxbbx_1_/**/REALKIND



module ol_forced_parameters_pptttt_tttxtxbbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pptttt_tttxtxbbx_1_/**/REALKIND

module ol_loop_pptttt_tttxtxbbx_1_/**/REALKIND
  ...
  complex(REALKIND), save :: M0(6,64), Mct(6,64), Mcol_loop(6,64)
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,8),Q(:,26),MB,1_intkind1,wf(:,10))
  call vert_VQ_A(wf(:,1),wf(:,-1),wf(:,11))
  call vert_AV_Q(wf(:,-3),wf(:,3),wf(:,12))
  call prop_Q_A(wf(:,11),Q(:,7),MT,1_intkind1,wf(:,13))
  call vert_VQ_A(wf(:,3),wf(:,-1),wf(:,14))
  call vert_AV_Q(wf(:,-3),wf(:,1),wf(:,15))
  call prop_Q_A(wf(:,14),Q(:,50),MT,1_intkind1,wf(:,16))
  ...
  call prop_Q_A(wf(:,20),Q(:,25),MB,1_intkind1,wf(:,22))
  call vert_VQ_A(wf(:,18),wf(:,-4),wf(:,23))
  call vert_AV_Q(wf(:,-5),wf(:,17),wf(:,24))
  call prop_Q_A(wf(:,23),Q(:,22),MB,1_intkind1,wf(:,25))
  ...
  call prop_Q_A(wf(:,28),Q(:,49),MT,1_intkind1,wf(:,30))
  call vert_VQ_A(wf(:,17),wf(:,-1),wf(:,31))
  call vert_AV_Q(wf(:,-2),wf(:,3),wf(:,32))
  call prop_Q_A(wf(:,31),Q(:,11),MT,1_intkind1,wf(:,33))
  call vert_AV_Q(wf(:,-2),wf(:,17),wf(:,34))
  call vert_VQ_A(wf(:,2),wf(:,0),wf(:,35))
  call prop_Q_A(wf(:,35),Q(:,11),MT,1_intkind1,wf(:,36))
  ...
  call prop_A_Q(wf(:,9),Q(:,37),MB,1_intkind1,wf(:,42))
  call counter_VQ_A(wf(:,1),wf(:,-4),wf(:,43))
  call prop_A_Q(wf(:,6),Q(:,42),MB,1_intkind1,wf(:,44))
  call counter_QA_V(wf(:,-4),wf(:,-5),wf(:,45))
  call vert_AV_Q(wf(:,-3),wf(:,45),wf(:,46))
  call vert_VQ_A(wf(:,45),wf(:,-1),wf(:,47))
  call prop_Q_A(wf(:,47),Q(:,50),MT,1_intkind1,wf(:,48))
  ...
  call prop_A_Q(wf(:,24),Q(:,41),MB,1_intkind1,wf(:,55))
  call counter_VQ_A(wf(:,17),wf(:,-4),wf(:,56))
  call prop_A_Q(wf(:,21),Q(:,38),MB,1_intkind1,wf(:,57))
  call vert_VQ_A(wf(:,45),wf(:,0),wf(:,58))
  call prop_Q_A(wf(:,58),Q(:,49),MT,1_intkind1,wf(:,59))
  ...
  call prop_A_Q(wf(:,15),Q(:,13),MT,1_intkind1,wf(:,66))
  call counter_VQ_A(wf(:,1),wf(:,-1),wf(:,67))
  call prop_A_Q(wf(:,12),Q(:,56),MT,1_intkind1,wf(:,68))
  ...
  call prop_Q_A(wf(:,72),Q(:,26),MB,1_intkind1,wf(:,73))
  call prop_A_Q(wf(:,34),Q(:,13),MT,1_intkind1,wf(:,74))
  call counter_VQ_A(wf(:,17),wf(:,-1),wf(:,75))
  call prop_A_Q(wf(:,32),Q(:,52),MT,1_intkind1,wf(:,76))
  call vert_AV_Q(wf(:,-2),wf(:,69),wf(:,77))
  call vert_VQ_A(wf(:,69),wf(:,0),wf(:,78))
  call prop_Q_A(wf(:,78),Q(:,11),MT,1_intkind1,wf(:,79))
  ...
  call prop_Q_A(wf(:,103),Q(:,21),MB,1_intkind1,wf(:,104))
  call vert_AV_Q(wf(:,-5),wf(:,101),wf(:,105))
  call vert_VQ_A(wf(:,101),wf(:,-1),wf(:,106))
  call prop_Q_A(wf(:,106),Q(:,7),MT,1_intkind1,wf(:,107))
  ...
  call counter_Q_A(ctbb,wf(:,7),Q(:,21),wf(:,118))
  call counter_Q_A(ctbb,wf(:,10),Q(:,26),wf(:,119))
  call vert_VQ_A(wf(:,110),wf(:,-1),wf(:,120))
  call vert_AV_Q(wf(:,-3),wf(:,110),wf(:,121))
  call counter_Q_A(cttt,wf(:,13),Q(:,7),wf(:,122))
  call counter_Q_A(cttt,wf(:,16),Q(:,50),wf(:,123))
  ...
  call counter_Q_A(ctbb,wf(:,22),Q(:,25),wf(:,134))
  call counter_Q_A(ctbb,wf(:,25),Q(:,22),wf(:,135))
  call vert_VQ_A(wf(:,129),wf(:,0),wf(:,136))
  call counter_Q_A(cttt,wf(:,27),Q(:,7),wf(:,137))
  call counter_Q_A(cttt,wf(:,30),Q(:,49),wf(:,138))
  ...
  call counter_Q_A(cttt,wf(:,33),Q(:,11),wf(:,143))
  call vert_AV_Q(wf(:,-2),wf(:,113),wf(:,144))
  call vert_VQ_A(wf(:,112),wf(:,0),wf(:,145))
  call counter_Q_A(cttt,wf(:,36),Q(:,11),wf(:,146))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(90)-A(91)-A(94)-A(97)-A(98)-A(99)-A(101)-A(103)-A(106))*f(3))/4._/**/REALKIND+((-A(74)-A(75)-A(76)-A(77)-A(78) &
       ...
       +((A(27)+A(28)+A(32)+A(35))*f(5))/4._/**/REALKIND+((A(16)+A(17)+A(18)+A(19)+A(37)+A(38))*f(5))/12._/**/REALKIND &
       -(CI*A(30)*f(6))/4._/**/REALKIND+((A(34)+A(39)+A(49)+A(54)+A(55)+A(58)+A(61)+A(64))*f(7))/4._/**/REALKIND+((A(41)+A(42) &
       +A(46)+A(47)+A(50)+A(51)+A(62)+A(63)+A(67)+A(68))*f(7))/12._/**/REALKIND+(CI*(-A(52)-A(59))*f(8))/4._/**/REALKIND &
       -(CI*A(25)*f(9))/4._/**/REALKIND
  M2(2) = ((A(89)+A(90)+A(91)+A(92)+A(93)+A(94)+A(95)+A(96)+A(97)+A(98)+A(99)+A(100))*f(3))/12._/**/REALKIND+((A(75)+A(76)+A(79) &
       ...
       -A(28)-A(29)-A(31)-A(32))*f(5))/12._/**/REALKIND+((-A(17)-A(18)-A(21)-A(38))*f(5))/4._/**/REALKIND &
       -(CI*A(20)*f(6))/4._/**/REALKIND+((-A(33)-A(34)-A(53)-A(54)-A(55)-A(56)-A(57)-A(58)-A(60)-A(61))*f(7))/12._/**/REALKIND+(( &
       -A(23)-A(42)-A(44)-A(47)-A(50)-A(63)-A(68)-A(69))*f(7))/4._/**/REALKIND+(CI*(-A(45)-A(66))*f(8))/4._/**/REALKIND &
  ...
  M2(3) = ((A(89)+A(90)+A(91)+A(92)+A(93)+A(94)+A(101)+A(102)+A(103)+A(104)+A(105)+A(106))*f(3))/12._/**/REALKIND+((A(74)+A(77) &
       ...
       -A(26)-A(27)-A(28)-A(29)-A(35)-A(36))*f(5))/12._/**/REALKIND+((-A(16)-A(19)-A(22)-A(37))*f(5))/4._/**/REALKIND &
       +(CI*A(20)*f(6))/4._/**/REALKIND+((-A(39)-A(40)-A(48)-A(49)-A(53)-A(54)-A(60)-A(61)-A(64)-A(65))*f(7))/12._/**/REALKIND+(( &
       -A(24)-A(41)-A(43)-A(46)-A(51)-A(62)-A(67)-A(70))*f(7))/4._/**/REALKIND+(CI*(A(45)+A(66))*f(8))/4._/**/REALKIND &
       +(CI*A(15)*f(9))/4._/**/REALKIND
  M2(4) = ((-A(74)-A(75)-A(76)-A(77)-A(78)-A(79)-A(80)-A(81)-A(82)-A(83)-A(84)-A(85))*f(3))/12._/**/REALKIND+((-A(89)-A(92)-A(93) &
       -A(95)-A(96)-A(100)-A(102)-A(104)-A(105))*f(3))/4._/**/REALKIND+(CI*(A(86)-A(87)-A(88))*f(4))/4._/**/REALKIND+((A(16)+A(17) &
       +A(18)+A(19)+A(21)+A(22))*f(5))/12._/**/REALKIND+((A(26)+A(29)+A(31)+A(36))*f(5))/4._/**/REALKIND &
       +(CI*A(30)*f(6))/4._/**/REALKIND+((A(33)+A(40)+A(48)+A(53)+A(56)+A(57)+A(60)+A(65))*f(7))/4._/**/REALKIND+((A(23)+A(24) &
       +A(43)+A(44)+A(46)+A(47)+A(67)+A(68)+A(69)+A(70))*f(7))/12._/**/REALKIND+(CI*(A(52)+A(59))*f(8))/4._/**/REALKIND &
       +(CI*A(25)*f(9))/4._/**/REALKIND
  M2(5) = ((-A(89)-A(90)-A(91)-A(92)-A(93)-A(94)-A(95)-A(96)-A(97)-A(98)-A(99)-A(100)-A(101)-A(102)-A(103)-A(104)-A(105) &
       ...
       -A(112))*f(3))/12._/**/REALKIND+((A(26)+A(27)+A(28)+A(29)+A(31)+A(32)+A(35)+A(36))*f(5))/36._/**/REALKIND+((A(21)+A(22) &
       +A(37)+A(38))*f(5))/12._/**/REALKIND+((A(33)+A(34)+A(39)+A(40)+A(48)+A(49)+A(53)+A(54)+A(55)+A(56)+A(57)+A(58)+A(60)+A(61) &
       +A(64)+A(65))*f(7))/36._/**/REALKIND+((A(23)+A(24)+A(41)+A(42)+A(43)+A(44)+A(50)+A(51)+A(62)+A(63)+A(69) &
       +A(70))*f(7))/12._/**/REALKIND
  M2(6) = ((A(95)+A(96)+A(97)+A(98)+A(99)+A(100)+A(101)+A(102)+A(103)+A(104)+A(105)+A(106))*f(3))/12._/**/REALKIND+((A(74)+A(75) &
       ...
       +A(112))*f(3))/36._/**/REALKIND+((-A(31)-A(32)-A(35)-A(36))*f(5))/12._/**/REALKIND+((-A(16)-A(17)-A(18)-A(19)-A(21)-A(22) &
       -A(37)-A(38))*f(5))/36._/**/REALKIND+((-A(33)-A(34)-A(39)-A(40)-A(48)-A(49)-A(55)-A(56)-A(57)-A(58)-A(64) &
       -A(65))*f(7))/12._/**/REALKIND+((-A(23)-A(24)-A(41)-A(42)-A(43)-A(44)-A(46)-A(47)-A(50)-A(51)-A(62)-A(63)-A(67)-A(68)-A(69) &
       -A(70))*f(7))/36._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pptttt_tttxtxbbx_1_/**/REALKIND
