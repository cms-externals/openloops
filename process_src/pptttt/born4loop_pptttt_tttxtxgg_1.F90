...
module ol_tree_pptttt_tttxtxgg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pptttt_tttxtxgg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pptttt_tttxtxgg_1_/**/DREALKIND, only: &
...
! **********************************************************************
  ...
  use ol_heltables_pptttt_tttxtxgg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_pptttt_tttxtxgg_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pptttt_tttxtxgg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pptttt_tttxtxgg_1(-I)
  end if
  ...
  call prop_Q_A(ntry, wf4(:,6), Q(:,18), MT, 1_intkind1, wf4(:,8), n2(1))
  call prop_A_Q(ntry, wf4(:,7), Q(:,40), MT, 1_intkind1, wf4(:,9), n2(2))
  ...
  call prop_A_Q(ntry, wf8(:,5), Q(:,13), MT, 1_intkind1, wf8(:,7), n2(3))
  ...
  call prop_Q_A(ntry, wf4(:,10), Q(:,34), MT, 1_intkind1, wf4(:,12), n2(4))
  call prop_A_Q(ntry, wf4(:,11), Q(:,24), MT, 1_intkind1, wf4(:,13), n2(5))
  ...
  call prop_Q_A(ntry, wf8(:,9), Q(:,7), MT, 1_intkind1, wf8(:,11), n2(6))
  ...
  call prop_Q_A(ntry, wf8(:,18), Q(:,50), MT, 1_intkind1, wf8(:,19), n2(7))
  ...
  call prop_Q_A(ntry, wf4(:,14), Q(:,17), MT, 1_intkind1, wf4(:,15), n2(8))
  ...
  call prop_A_Q(ntry, wf8(:,25), Q(:,14), MT, 1_intkind1, wf8(:,27), n2(9))
  call vert_VQ_A(ntry, ex6, ex1, wf4(:,16), n3(:,39), t3x4(:,:,11))
  call prop_Q_A(ntry, wf4(:,16), Q(:,33), MT, 1_intkind1, wf4(:,17), n2(10))
  call vert_VQ_A(ntry, wf4(:,4), wf4(:,17), wf16(:,12), n3(:,40), t3x16(:,:,6))
  call vert_VQ_A(ntry, wf4(:,4), ex1, wf8(:,28), n3(:,41), t3x8(:,:,24))
  call prop_Q_A(ntry, wf8(:,28), Q(:,7), MT, 1_intkind1, wf8(:,29), n2(11))
  ...
  call prop_Q_A(ntry, wf8(:,39), Q(:,11), MT, 1_intkind1, wf8(:,41), n2(16))
  ...
  call prop_A_Q(ntry, wf8(:,48), Q(:,14), MT, 1_intkind1, wf8(:,49), n2(17))
  call vert_VQ_A(ntry, wf4(:,2), wf4(:,17), wf16(:,16), n3(:,63), t3x16(:,:,10))
  call vert_VQ_A(ntry, wf4(:,2), ex1, wf8(:,50), n3(:,64), t3x8(:,:,41))
  call prop_Q_A(ntry, wf8(:,50), Q(:,11), MT, 1_intkind1, wf8(:,51), n2(18))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_pptttt_tttxtxgg_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_pptttt_tttxtxgg_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_pptttt_tttxtxgg_1(k))
  end do
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pptttt_tttxtxgg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pptttt_tttxtxgg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pptttt_tttxtxgg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pptttt_tttxtxgg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pptttt_tttxtxgg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pptttt_tttxtxgg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pptttt_tttxtxgg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pptttt_tttxtxgg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pptttt_tttxtxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pptttt_tttxtxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pptttt_tttxtxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pptttt_tttxtxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pptttt_tttxtxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pptttt_tttxtxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pptttt_tttxtxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pptttt_tttxtxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_pptttt_tttxtxgg_1_/**/REALKIND
