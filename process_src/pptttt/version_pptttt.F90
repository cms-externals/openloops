...
module ol_versiondata_pptttt
  implicit none
  character(4) :: generator_revision = "3995"
  interface
    subroutine version_pptttt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptttt
  end interface
end module ol_versiondata_pptttt


subroutine ol_version_pptttt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptttt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptttt
