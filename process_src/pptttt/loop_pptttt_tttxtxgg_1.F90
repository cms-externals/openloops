...
! **********************************************************************
  ...
  call counter_Q_A(cttt,wf(:,19),Q(:,18),wf(:,284))
  call prop_A_Q(wf(:,283),Q(:,45),MT,1_intkind1,wf(:,285))
  call counter_A_Q(cttt,wf(:,20),Q(:,40),wf(:,286))
  ...
  call counter_Q_A(cttt,wf(:,33),Q(:,7),wf(:,303))
  ...
  call counter_Q_A(cttt,wf(:,41),Q(:,50),wf(:,314))
  ...
  call counter_Q_A(cttt,wf(:,48),Q(:,17),wf(:,326))
  ...
  call counter_A_Q(cttt,wf(:,53),Q(:,14),wf(:,335))
  call vert_AV_Q(wf(:,29),wf(:,7),wf(:,336))
  call counter_Q_A(cttt,wf(:,55),Q(:,33),wf(:,337))
  ...
  call counter_Q_A(cttt,wf(:,58),Q(:,7),wf(:,343))
  ...
  call counter_Q_A(cttt,wf(:,64),Q(:,49),wf(:,351))
  ...
  call counter_A_Q(cttt,wf(:,72),Q(:,20),wf(:,365))
  ...
  call counter_Q_A(cttt,wf(:,76),Q(:,11),wf(:,370))
  ...
  call counter_A_Q(cttt,wf(:,85),Q(:,14),wf(:,387))
  ...
  call counter_Q_A(cttt,wf(:,88),Q(:,11),wf(:,394))
