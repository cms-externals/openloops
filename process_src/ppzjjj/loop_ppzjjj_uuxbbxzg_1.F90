...
module ol_colourmatrix_ppzjjj_uuxbbxzg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzjjj_uuxbbxzg_1_/**/REALKIND



module ol_forced_parameters_ppzjjj_uuxbbxzg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzjjj_uuxbbxzg_1_/**/REALKIND

module ol_loop_ppzjjj_uuxbbxzg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 7) = CI*countertermnorm*ctGqq*eQED*gQCD**5
    f( 8) = countertermnorm*ctGqq*eQED*gQCD**5
    f( 9) = CI*countertermnorm*ctVbb*eQED*gQCD**5
    f(10) = countertermnorm*ctVbb*eQED*gQCD**5
    f(11) = CI*countertermnorm*ctVqq*eQED*gQCD**5
    f(12) = countertermnorm*ctVqq*eQED*gQCD**5
...
end module ol_loop_ppzjjj_uuxbbxzg_1_/**/REALKIND
