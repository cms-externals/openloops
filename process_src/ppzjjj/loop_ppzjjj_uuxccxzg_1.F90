...
module ol_colourmatrix_ppzjjj_uuxccxzg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzjjj_uuxccxzg_1_/**/REALKIND



module ol_forced_parameters_ppzjjj_uuxccxzg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzjjj_uuxccxzg_1_/**/REALKIND

module ol_loop_ppzjjj_uuxccxzg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGcc*eQED*gQCD**5
    f( 6) = countertermnorm*ctGcc*eQED*gQCD**5
    f( 7) = CI*countertermnorm*ctGqq*eQED*gQCD**5
    f( 8) = countertermnorm*ctGqq*eQED*gQCD**5
    f( 9) = CI*countertermnorm*ctVcc*eQED*gQCD**5
    f(10) = countertermnorm*ctVcc*eQED*gQCD**5
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,4),Q(:,20),wf(:,150))
  call prop_A_Q(wf(:,149),Q(:,43),ZERO,0_intkind1,wf(:,151))
  call counter_A_Q(ctcc,wf(:,5),Q(:,40),wf(:,152))
  ...
  call counter_Q_A(ctcc,wf(:,19),Q(:,7),wf(:,170))
...
end module ol_loop_ppzjjj_uuxccxzg_1_/**/REALKIND
