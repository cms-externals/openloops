...
module ol_colourmatrix_ppza_uuxaz_1_/**/REALKIND
...
end module ol_colourmatrix_ppza_uuxaz_1_/**/REALKIND



module ol_forced_parameters_ppza_uuxaz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppza_uuxaz_1_/**/REALKIND

module ol_loop_ppza_uuxaz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (2*CI*countertermnorm*eQED**2*gQCD**2)/3._/**/REALKIND
    f(3) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**2)/3._/**/REALKIND
    f(4) = (2*eQED**2*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
...
end module ol_loop_ppza_uuxaz_1_/**/REALKIND
