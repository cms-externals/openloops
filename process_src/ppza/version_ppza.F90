...
module ol_versiondata_ppza
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppza(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppza
  end interface
end module ol_versiondata_ppza


subroutine ol_version_ppza(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppza, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppza
