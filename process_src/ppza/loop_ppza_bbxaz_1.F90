...
module ol_colourmatrix_ppza_bbxaz_1_/**/REALKIND
...
end module ol_colourmatrix_ppza_bbxaz_1_/**/REALKIND



module ol_forced_parameters_ppza_bbxaz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppza_bbxaz_1_/**/REALKIND

module ol_loop_ppza_bbxaz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**2*gQCD**2)/3._/**/REALKIND
    f(3) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**2)/3._/**/REALKIND
    f(4) = (eQED**2*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,0),wf(:,4))
  call vert_AV_Q(wf(:,-1),wf(:,-2),wf(:,5))
  call prop_Q_A(wf(:,4),Q(:,9),MB,1_intkind1,wf(:,6))
  call counter_AZ_Q(gZd,wf(:,-1),wf(:,-3),wf(:,7))
  call counter_AV_Q(wf(:,-1),wf(:,-2),wf(:,8))
  call counter_ZQ_A(gZd,wf(:,-3),wf(:,0),wf(:,9))
...
end module ol_loop_ppza_bbxaz_1_/**/REALKIND
