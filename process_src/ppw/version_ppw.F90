...
module ol_versiondata_ppw
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppw(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppw
  end interface
end module ol_versiondata_ppw


subroutine ol_version_ppw(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppw, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
