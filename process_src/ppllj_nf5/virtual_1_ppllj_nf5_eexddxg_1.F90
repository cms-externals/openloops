...
module ol_vamp_1_ppllj_nf5_eexddxg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllj_nf5_eexddxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllj_nf5_eexddxg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllj_nf5_eexddxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllj_nf5_eexddxg_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_QZ_A(G1(:,:,:,9),wf(:,6),G1(:,:,:,11),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,12),wf(:,6),G1(:,:,:,14),gZd)
  ...
  call loop_AZ_Q(G2(:,:,:,19),wf(:,6),G2(:,:,:,21),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,15),wf(:,6),G1(:,:,:,18),gZd)
  ...
  call loop_AZ_Q(G2(:,:,:,26),wf(:,6),G2(:,:,:,28),gZd)
...
end module ol_vamp_1_ppllj_nf5_eexddxg_1_/**/REALKIND
