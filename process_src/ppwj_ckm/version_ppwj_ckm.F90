...
module ol_versiondata_ppwj_ckm
  implicit none
  character(4) :: generator_revision = "2423"
  interface
    subroutine version_ppwj_ckm(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppwj_ckm
  end interface
end module ol_versiondata_ppwj_ckm


subroutine ol_version_ppwj_ckm(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppwj_ckm, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppwj_ckm
