...
module ol_colourmatrix_ppwj_ckm_cxbwxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwj_ckm_cxbwxg_1_/**/REALKIND



module ol_forced_parameters_ppwj_ckm_cxbwxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwj_ckm_cxbwxg_1_/**/REALKIND

module ol_loop_ppwj_ckm_cxbwxg_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED*gQCD**3*VCKMbc)/(sqrt2*sw)
    f(3) = (CI*countertermnorm*ctGbb*eQED*gQCD**3*VCKMbc)/(sqrt2*sw)
    f(4) = (CI*countertermnorm*ctGcc*eQED*gQCD**3*VCKMbc)/(sqrt2*sw)
    f(5) = (CI*countertermnorm*ctVbc*eQED*gQCD**3*VCKMbc)/(sqrt2*sw)
    f(6) = (CI*eQED*gQCD**3*integralnorm*SwB*VCKMbc)/(sqrt2*sw)
    f(7) = (eQED*gQCD**3*integralnorm*SwB*VCKMbc)/(sqrt2*sw)
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,2),Q(:,10),MB,1_intkind1,wf(:,12))
  call counter_A_Q(ctbb,wf(:,3),Q(:,5),wf(:,13))
...
end module ol_loop_ppwj_ckm_cxbwxg_1_/**/REALKIND
