...
module ol_colourmatrix_ppwj_ckm_cxswxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwj_ckm_cxswxg_1_/**/REALKIND



module ol_forced_parameters_ppwj_ckm_cxswxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwj_ckm_cxswxg_1_/**/REALKIND

module ol_loop_ppwj_ckm_cxswxg_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED*gQCD**3*VCKMsc)/(sqrt2*sw)
    f(3) = (CI*countertermnorm*ctGcc*eQED*gQCD**3*VCKMsc)/(sqrt2*sw)
    f(4) = (CI*countertermnorm*ctGqq*eQED*gQCD**3*VCKMsc)/(sqrt2*sw)
    f(5) = (CI*countertermnorm*ctVsc*eQED*gQCD**3*VCKMsc)/(sqrt2*sw)
    f(6) = (CI*eQED*gQCD**3*integralnorm*SwB*VCKMsc)/(sqrt2*sw)
    f(7) = (eQED*gQCD**3*integralnorm*SwB*VCKMsc)/(sqrt2*sw)
...
end module ol_loop_ppwj_ckm_cxswxg_1_/**/REALKIND
