...
module ol_vamp_1_ppwj_ckm_uxswxg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppwj_ckm_uxswxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppwj_ckm_uxswxg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppwj_ckm_uxswxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppwj_ckm_uxswxg_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_A_Q(G1(:,:,:,4),Q(:,13),ZERO,G2(:,:,:,2))
  ...
  call loop_Q_A(G1(:,:,:,6),Q(:,10),ZERO,G2(:,:,:,4))
  ...
  call loop_A_Q(G1(:,:,:,10),Q(:,13),ZERO,G2(:,:,:,7))
  ...
  call loop_Q_A(G0(:,:,:,5),Q(:,10),ZERO,G1(:,:,:,11))
  ...
  call loop_Q_A(G1(:,:,:,14),Q(:,10),ZERO,G2(:,:,:,9))
...
end module ol_vamp_1_ppwj_ckm_uxswxg_1_/**/REALKIND
