...
subroutine set_permutation_eellllbb_nenexeexmmxbbxg_1(perm)
  use ol_external_eellllbb_nenexeexmmxbbxg_1, only: set_permutation
  implicit none
  integer, intent(in) :: perm(9)
  call set_permutation(perm)
end subroutine set_permutation_eellllbb_nenexeexmmxbbxg_1
