...
module ol_colourmatrix_pplljjj_eexbbxggg_1_/**/REALKIND
...
end module ol_colourmatrix_pplljjj_eexbbxggg_1_/**/REALKIND



module ol_forced_parameters_pplljjj_eexbbxggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljjj_eexbbxggg_1_/**/REALKIND

module ol_loop_pplljjj_eexbbxggg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(17) = (CI*countertermnorm*ctVVV*eQED**2*gQCD**5)/3._/**/REALKIND
    f(18) = CI*countertermnorm*ctVVV*eQED**2*gQCD**5
    f(19) = (countertermnorm*ctVVV*eQED**2*gQCD**5)/3._/**/REALKIND
    f(20) = countertermnorm*ctVVV*eQED**2*gQCD**5
    f(21) = (CI*countertermnorm*ctVVVV*eQED**2*gQCD**5)/3._/**/REALKIND
    ...
    f(25) = (CI*countertermnorm*eQED**2*gQCD**5*R2GGGG)/3._/**/REALKIND
    f(26) = CI*countertermnorm*eQED**2*gQCD**5*R2GGGG
    f(27) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(28) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(29) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(30) = CI*eQED**2*gQCD**5*integralnorm*SwB
    f(31) = (eQED**2*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(32) = (eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(33) = (eQED**2*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
  ...
  c = [ 9*CI*f(27), 18*CI*f(27), CI*f(28), 3*CI*f(28), 8*CI*f(28), 9*CI*f(28), 18*CI*f(28), 9*CI*f(29), 18*CI*f(29), CI*f(30) &
    , 3*CI*f(30), 8*CI*f(30), 9*CI*f(30), 18*CI*f(30), 3*f(31), 6*f(31), 9*f(31), 18*f(31), f(32), 3*f(32), 6*f(32), 8*f(32) &
    , 9*f(32), 18*f(32), 3*f(33), 6*f(33), 9*f(33), 18*f(33), f(34), 3*f(34), 6*f(34), 8*f(34), 9*f(34), 18*f(34), CI*f(35) &
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,3),Q(:,7),MB,1_intkind1,wf(:,5))
  ...
  call vert_ZQ_A(gZd,wf(:,11),wf(:,-2),wf(:,12))
  call prop_Q_A(wf(:,12),Q(:,7),MB,1_intkind1,wf(:,13))
  call vert_VQ_A(wf(:,2),wf(:,-2),wf(:,14))
  call vert_AV_Q(wf(:,-3),wf(:,1),wf(:,15))
  call prop_Q_A(wf(:,14),Q(:,116),MB,1_intkind1,wf(:,16))
  call vert_VQ_A(wf(:,6),wf(:,-2),wf(:,17))
  call prop_Q_A(wf(:,17),Q(:,116),MB,1_intkind1,wf(:,18))
  call vert_VQ_A(wf(:,8),wf(:,-2),wf(:,19))
  call prop_Q_A(wf(:,19),Q(:,116),MB,1_intkind1,wf(:,20))
  call vert_AZ_Q(gZd,wf(:,-3),wf(:,11),wf(:,21))
  call vert_VQ_A(wf(:,-4),wf(:,-2),wf(:,22))
  call vert_AV_Q(wf(:,-3),wf(:,-5),wf(:,23))
  call prop_Q_A(wf(:,22),Q(:,20),MB,1_intkind1,wf(:,24))
  call prop_A_Q(wf(:,23),Q(:,40),MB,1_intkind1,wf(:,25))
  call vert_VQ_A(wf(:,-6),wf(:,24),wf(:,26))
  call vert_AV_Q(wf(:,25),wf(:,1),wf(:,27))
  call prop_Q_A(wf(:,26),Q(:,84),MB,1_intkind1,wf(:,28))
  call vert_AZ_Q(gZd,wf(:,25),wf(:,11),wf(:,29))
  call vert_AV_Q(wf(:,25),wf(:,-6),wf(:,30))
  call vert_VQ_A(wf(:,1),wf(:,24),wf(:,31))
  call prop_A_Q(wf(:,30),Q(:,104),MB,1_intkind1,wf(:,32))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,24),wf(:,33))
  call vert_AV_Q(wf(:,-3),wf(:,-6),wf(:,34))
  call prop_A_Q(wf(:,34),Q(:,72),MB,1_intkind1,wf(:,35))
  call vert_VQ_A(wf(:,-5),wf(:,24),wf(:,36))
  call vert_AV_Q(wf(:,35),wf(:,1),wf(:,37))
  call prop_Q_A(wf(:,36),Q(:,52),MB,1_intkind1,wf(:,38))
  call vert_AZ_Q(gZd,wf(:,35),wf(:,11),wf(:,39))
  call vert_AV_Q(wf(:,35),wf(:,-5),wf(:,40))
  call prop_A_Q(wf(:,40),Q(:,104),MB,1_intkind1,wf(:,41))
  call vert_UV_W(wf(:,-5),Q(:,32),wf(:,-6),Q(:,64),wf(:,42))
  call vert_VQ_A(wf(:,42),wf(:,24),wf(:,43))
  call prop_A_Q(wf(:,15),Q(:,11),MB,1_intkind1,wf(:,44))
  call prop_A_Q(wf(:,21),Q(:,11),MB,1_intkind1,wf(:,45))
  call vert_AV_Q(wf(:,-3),wf(:,42),wf(:,46))
  call prop_A_Q(wf(:,46),Q(:,104),MB,1_intkind1,wf(:,47))
  ...
  call prop_Q_A(wf(:,52),Q(:,36),MB,1_intkind1,wf(:,54))
  call prop_A_Q(wf(:,53),Q(:,24),MB,1_intkind1,wf(:,55))
  call vert_VQ_A(wf(:,-6),wf(:,54),wf(:,56))
  call vert_AV_Q(wf(:,55),wf(:,1),wf(:,57))
  call prop_Q_A(wf(:,56),Q(:,100),MB,1_intkind1,wf(:,58))
  call vert_AZ_Q(gZd,wf(:,55),wf(:,11),wf(:,59))
  call vert_AV_Q(wf(:,55),wf(:,-6),wf(:,60))
  call vert_VQ_A(wf(:,1),wf(:,54),wf(:,61))
  call prop_A_Q(wf(:,60),Q(:,88),MB,1_intkind1,wf(:,62))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,54),wf(:,63))
  call vert_VQ_A(wf(:,-6),wf(:,-2),wf(:,64))
  call prop_Q_A(wf(:,64),Q(:,68),MB,1_intkind1,wf(:,65))
  call vert_VQ_A(wf(:,-5),wf(:,65),wf(:,66))
  call prop_Q_A(wf(:,66),Q(:,100),MB,1_intkind1,wf(:,67))
  call vert_AV_Q(wf(:,55),wf(:,-5),wf(:,68))
  call vert_VQ_A(wf(:,1),wf(:,65),wf(:,69))
  call prop_A_Q(wf(:,68),Q(:,56),MB,1_intkind1,wf(:,70))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,65),wf(:,71))
  call vert_AV_Q(wf(:,55),wf(:,42),wf(:,72))
  call vert_VQ_A(wf(:,42),wf(:,-2),wf(:,73))
  call prop_Q_A(wf(:,73),Q(:,100),MB,1_intkind1,wf(:,74))
  ...
  call prop_A_Q(wf(:,100),Q(:,56),MB,1_intkind1,wf(:,101))
  call vert_AV_Q(wf(:,35),wf(:,98),wf(:,102))
  call vert_VQ_A(wf(:,98),wf(:,-2),wf(:,103))
  call prop_Q_A(wf(:,103),Q(:,52),MB,1_intkind1,wf(:,104))
  ...
  call prop_Q_A(wf(:,168),Q(:,116),MB,1_intkind1,wf(:,169))
  call vert_VQ_A(wf(:,164),wf(:,-2),wf(:,170))
  call prop_Q_A(wf(:,170),Q(:,116),MB,1_intkind1,wf(:,171))
  call vert_VQ_A(wf(:,166),wf(:,-2),wf(:,172))
  call prop_Q_A(wf(:,172),Q(:,116),MB,1_intkind1,wf(:,173))
  ...
  call counter_AZ_Q(gZd,wf(:,-3),wf(:,11),wf(:,178))
  ...
  call prop_A_Q(wf(:,4),Q(:,120),MB,1_intkind1,wf(:,183))
  call prop_A_Q(wf(:,7),Q(:,120),MB,1_intkind1,wf(:,184))
  call prop_A_Q(wf(:,9),Q(:,120),MB,1_intkind1,wf(:,185))
  call counter_ZQ_A(gZd,wf(:,11),wf(:,-2),wf(:,186))
  ...
  call counter_AZ_Q(gZd,wf(:,25),wf(:,11),wf(:,200))
  call counter_VQ_A(wf(:,1),wf(:,24),wf(:,201))
  call counter_ZQ_A(gZd,wf(:,11),wf(:,24),wf(:,202))
  call counter_AV_Q(wf(:,25),wf(:,-6),wf(:,203))
  call prop_Q_A(wf(:,31),Q(:,23),MB,1_intkind1,wf(:,204))
  call prop_Q_A(wf(:,33),Q(:,23),MB,1_intkind1,wf(:,205))
  call counter_VQ_A(wf(:,-6),wf(:,24),wf(:,206))
  call prop_A_Q(wf(:,27),Q(:,43),MB,1_intkind1,wf(:,207))
  call prop_A_Q(wf(:,29),Q(:,43),MB,1_intkind1,wf(:,208))
  call vert_QA_V(wf(:,24),wf(:,25),wf(:,209))
  call counter_AV_Q(wf(:,35),wf(:,1),wf(:,210))
  call counter_AZ_Q(gZd,wf(:,35),wf(:,11),wf(:,211))
  call counter_VQ_A(wf(:,42),wf(:,24),wf(:,212))
  call counter_AV_Q(wf(:,44),wf(:,-6),wf(:,213))
  call counter_AV_Q(wf(:,45),wf(:,-6),wf(:,214))
  call prop_Q_A(wf(:,206),Q(:,84),MB,1_intkind1,wf(:,215))
  ...
  call prop_A_Q(wf(:,37),Q(:,75),MB,1_intkind1,wf(:,220))
  call prop_A_Q(wf(:,39),Q(:,75),MB,1_intkind1,wf(:,221))
  call vert_QA_V(wf(:,24),wf(:,35),wf(:,222))
  call counter_AV_Q(wf(:,44),wf(:,-5),wf(:,223))
  call counter_AV_Q(wf(:,45),wf(:,-5),wf(:,224))
  call prop_Q_A(wf(:,219),Q(:,52),MB,1_intkind1,wf(:,225))
  ...
  call prop_A_Q(wf(:,230),Q(:,104),MB,1_intkind1,wf(:,231))
  call counter_AV_Q(wf(:,55),wf(:,1),wf(:,232))
  call counter_AZ_Q(gZd,wf(:,55),wf(:,11),wf(:,233))
  call counter_VQ_A(wf(:,1),wf(:,54),wf(:,234))
  call counter_ZQ_A(gZd,wf(:,11),wf(:,54),wf(:,235))
  call counter_AV_Q(wf(:,55),wf(:,-6),wf(:,236))
  call prop_Q_A(wf(:,61),Q(:,39),MB,1_intkind1,wf(:,237))
  call prop_Q_A(wf(:,63),Q(:,39),MB,1_intkind1,wf(:,238))
  call counter_VQ_A(wf(:,-6),wf(:,54),wf(:,239))
  call prop_A_Q(wf(:,57),Q(:,27),MB,1_intkind1,wf(:,240))
  call prop_A_Q(wf(:,59),Q(:,27),MB,1_intkind1,wf(:,241))
  call vert_QA_V(wf(:,54),wf(:,55),wf(:,242))
  call counter_VQ_A(wf(:,1),wf(:,65),wf(:,243))
  call counter_ZQ_A(gZd,wf(:,11),wf(:,65),wf(:,244))
  call counter_AV_Q(wf(:,55),wf(:,42),wf(:,245))
  call prop_A_Q(wf(:,236),Q(:,88),MB,1_intkind1,wf(:,246))
  ...
  call prop_Q_A(wf(:,69),Q(:,71),MB,1_intkind1,wf(:,252))
  call prop_Q_A(wf(:,71),Q(:,71),MB,1_intkind1,wf(:,253))
  call counter_VQ_A(wf(:,-5),wf(:,65),wf(:,254))
  call vert_QA_V(wf(:,65),wf(:,55),wf(:,255))
  call prop_A_Q(wf(:,251),Q(:,56),MB,1_intkind1,wf(:,256))
  ...
  call prop_Q_A(wf(:,254),Q(:,100),MB,1_intkind1,wf(:,278))
  call vert_UV_W(wf(:,-4),Q(:,16),wf(:,160),Q(:,76),wf(:,279))
  call vert_QA_V(wf(:,90),wf(:,-3),wf(:,280))
  call prop_A_Q(wf(:,218),Q(:,104),MB,1_intkind1,wf(:,281))
  ...
  call counter_Q_A(ctbb,wf(:,5),Q(:,7),wf(:,290))
  call counter_Q_A(ctbb,wf(:,13),Q(:,7),wf(:,291))
  call counter_Q_A(ctbb,wf(:,16),Q(:,116),wf(:,292))
  call counter_Q_A(ctbb,wf(:,18),Q(:,116),wf(:,293))
  call counter_Q_A(ctbb,wf(:,20),Q(:,116),wf(:,294))
  ...
  call prop_Q_A(wf(:,305),Q(:,52),MB,1_intkind1,wf(:,309))
  ...
  call prop_Q_A(wf(:,325),Q(:,84),MB,1_intkind1,wf(:,326))
  call prop_Q_A(wf(:,317),Q(:,84),MB,1_intkind1,wf(:,327))
  call vert_UV_W(wf(:,-5),Q(:,32),wf(:,160),Q(:,76),wf(:,328))
  call prop_A_Q(wf(:,304),Q(:,88),MB,1_intkind1,wf(:,329))
  ...
  call prop_A_Q(wf(:,339),Q(:,56),MB,1_intkind1,wf(:,340))
  call vert_AV_Q(wf(:,35),wf(:,337),wf(:,341))
  call vert_VQ_A(wf(:,337),wf(:,-2),wf(:,342))
  call prop_Q_A(wf(:,342),Q(:,52),MB,1_intkind1,wf(:,343))
  call vert_UV_W(wf(:,337),Q(:,48),wf(:,-6),Q(:,64),wf(:,344))
  call vert_VQ_A(wf(:,-6),wf(:,343),wf(:,345))
  call counter_AV_Q(wf(:,-3),wf(:,42),wf(:,346))
  call prop_Q_A(wf(:,43),Q(:,116),MB,1_intkind1,wf(:,347))
  call prop_A_Q(wf(:,177),Q(:,11),MB,1_intkind1,wf(:,348))
  call vert_AV_Q(wf(:,348),wf(:,-6),wf(:,349))
  call prop_A_Q(wf(:,178),Q(:,11),MB,1_intkind1,wf(:,350))
  ...
  call prop_A_Q(wf(:,354),Q(:,72),MB,1_intkind1,wf(:,355))
  call vert_AV_Q(wf(:,355),wf(:,1),wf(:,356))
  call vert_AZ_Q(gZd,wf(:,355),wf(:,11),wf(:,357))
  call vert_AV_Q(wf(:,355),wf(:,-5),wf(:,358))
  call prop_A_Q(wf(:,358),Q(:,104),MB,1_intkind1,wf(:,359))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,360))
  call prop_A_Q(wf(:,360),Q(:,40),MB,1_intkind1,wf(:,361))
  call vert_AV_Q(wf(:,361),wf(:,1),wf(:,362))
  call vert_AZ_Q(gZd,wf(:,361),wf(:,11),wf(:,363))
  call vert_AV_Q(wf(:,361),wf(:,-6),wf(:,364))
  call prop_A_Q(wf(:,364),Q(:,104),MB,1_intkind1,wf(:,365))
  call counter_AV_Q(wf(:,-3),wf(:,83),wf(:,366))
  call prop_Q_A(wf(:,84),Q(:,116),MB,1_intkind1,wf(:,367))
  call vert_AV_Q(wf(:,348),wf(:,-4),wf(:,368))
  call vert_AV_Q(wf(:,350),wf(:,-4),wf(:,369))
  call vert_AV_Q(wf(:,355),wf(:,-4),wf(:,370))
  call prop_A_Q(wf(:,370),Q(:,88),MB,1_intkind1,wf(:,371))
  call counter_AV_Q(wf(:,-3),wf(:,98),wf(:,372))
  call prop_Q_A(wf(:,99),Q(:,116),MB,1_intkind1,wf(:,373))
  call prop_A_Q(wf(:,372),Q(:,56),MB,1_intkind1,wf(:,374))
  ...
  call prop_A_Q(wf(:,366),Q(:,88),MB,1_intkind1,wf(:,380))
  call prop_A_Q(wf(:,346),Q(:,104),MB,1_intkind1,wf(:,381))
  call vert_AV_Q(wf(:,361),wf(:,-4),wf(:,382))
  call prop_A_Q(wf(:,382),Q(:,56),MB,1_intkind1,wf(:,383))
  call vert_AV_Q(wf(:,361),wf(:,83),wf(:,384))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,385))
  call prop_A_Q(wf(:,385),Q(:,24),MB,1_intkind1,wf(:,386))
  call vert_AV_Q(wf(:,386),wf(:,1),wf(:,387))
  call vert_AZ_Q(gZd,wf(:,386),wf(:,11),wf(:,388))
  call vert_AV_Q(wf(:,386),wf(:,-6),wf(:,389))
  call prop_A_Q(wf(:,389),Q(:,88),MB,1_intkind1,wf(:,390))
  call vert_AV_Q(wf(:,386),wf(:,-5),wf(:,391))
  call prop_A_Q(wf(:,391),Q(:,56),MB,1_intkind1,wf(:,392))
  call vert_AV_Q(wf(:,386),wf(:,42),wf(:,393))
  call counter_VQ_A(wf(:,42),wf(:,-2),wf(:,394))
  call prop_A_Q(wf(:,72),Q(:,120),MB,1_intkind1,wf(:,395))
  call prop_Q_A(wf(:,182),Q(:,7),MB,1_intkind1,wf(:,396))
  call vert_VQ_A(wf(:,-5),wf(:,396),wf(:,397))
  call prop_Q_A(wf(:,186),Q(:,7),MB,1_intkind1,wf(:,398))
  ...
  call prop_Q_A(wf(:,402),Q(:,68),MB,1_intkind1,wf(:,403))
  call vert_VQ_A(wf(:,-5),wf(:,403),wf(:,404))
  call prop_Q_A(wf(:,404),Q(:,100),MB,1_intkind1,wf(:,405))
  call vert_VQ_A(wf(:,1),wf(:,403),wf(:,406))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,403),wf(:,407))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,408))
  call prop_Q_A(wf(:,408),Q(:,36),MB,1_intkind1,wf(:,409))
  call vert_VQ_A(wf(:,-6),wf(:,409),wf(:,410))
  call prop_Q_A(wf(:,410),Q(:,100),MB,1_intkind1,wf(:,411))
  call vert_VQ_A(wf(:,1),wf(:,409),wf(:,412))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,409),wf(:,413))
  call counter_VQ_A(wf(:,83),wf(:,-2),wf(:,414))
  call prop_A_Q(wf(:,93),Q(:,120),MB,1_intkind1,wf(:,415))
  call vert_VQ_A(wf(:,-4),wf(:,396),wf(:,416))
  call vert_VQ_A(wf(:,-4),wf(:,398),wf(:,417))
  call vert_VQ_A(wf(:,-4),wf(:,403),wf(:,418))
  call prop_Q_A(wf(:,418),Q(:,84),MB,1_intkind1,wf(:,419))
  call counter_VQ_A(wf(:,98),wf(:,-2),wf(:,420))
  call prop_A_Q(wf(:,102),Q(:,120),MB,1_intkind1,wf(:,421))
  call counter_QA_V(wf(:,-2),wf(:,44),wf(:,422))
  call counter_QA_V(wf(:,-2),wf(:,45),wf(:,423))
  call prop_Q_A(wf(:,420),Q(:,52),MB,1_intkind1,wf(:,424))
  ...
  call prop_Q_A(wf(:,414),Q(:,84),MB,1_intkind1,wf(:,429))
  call vert_VQ_A(wf(:,-5),wf(:,429),wf(:,430))
  call prop_Q_A(wf(:,394),Q(:,100),MB,1_intkind1,wf(:,431))
  call vert_VQ_A(wf(:,-4),wf(:,431),wf(:,432))
  call vert_VQ_A(wf(:,-4),wf(:,409),wf(:,433))
  call prop_Q_A(wf(:,433),Q(:,52),MB,1_intkind1,wf(:,434))
  call vert_VQ_A(wf(:,83),wf(:,409),wf(:,435))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,436))
  call prop_Q_A(wf(:,436),Q(:,20),MB,1_intkind1,wf(:,437))
  call vert_VQ_A(wf(:,-6),wf(:,437),wf(:,438))
  call prop_Q_A(wf(:,438),Q(:,84),MB,1_intkind1,wf(:,439))
  call vert_VQ_A(wf(:,1),wf(:,437),wf(:,440))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,437),wf(:,441))
  call vert_VQ_A(wf(:,-5),wf(:,437),wf(:,442))
  call prop_Q_A(wf(:,442),Q(:,52),MB,1_intkind1,wf(:,443))
  call vert_VQ_A(wf(:,42),wf(:,437),wf(:,444))
  call counter_Q_A(ctbb,wf(:,24),Q(:,20),wf(:,445))
  call prop_Q_A(wf(:,445),Q(:,20),MB,1_intkind1,wf(:,446))
  call vert_VQ_A(wf(:,-6),wf(:,446),wf(:,447))
  call vert_VQ_A(wf(:,1),wf(:,446),wf(:,448))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,446),wf(:,449))
  call counter_A_Q(ctbb,wf(:,25),Q(:,40),wf(:,450))
  call prop_A_Q(wf(:,450),Q(:,40),MB,1_intkind1,wf(:,451))
  call vert_AV_Q(wf(:,451),wf(:,-6),wf(:,452))
  call vert_AV_Q(wf(:,451),wf(:,1),wf(:,453))
  call vert_AZ_Q(gZd,wf(:,451),wf(:,11),wf(:,454))
  call counter_Q_A(ctbb,wf(:,28),Q(:,84),wf(:,455))
  call counter_A_Q(ctbb,wf(:,32),Q(:,104),wf(:,456))
  call vert_VQ_A(wf(:,-5),wf(:,446),wf(:,457))
  call counter_A_Q(ctbb,wf(:,35),Q(:,72),wf(:,458))
  call prop_A_Q(wf(:,458),Q(:,72),MB,1_intkind1,wf(:,459))
  call vert_AV_Q(wf(:,459),wf(:,-5),wf(:,460))
  call vert_AV_Q(wf(:,459),wf(:,1),wf(:,461))
  call vert_AZ_Q(gZd,wf(:,459),wf(:,11),wf(:,462))
  call counter_Q_A(ctbb,wf(:,38),Q(:,52),wf(:,463))
  call counter_A_Q(ctbb,wf(:,41),Q(:,104),wf(:,464))
  ...
  call counter_A_Q(ctbb,wf(:,44),Q(:,11),wf(:,469))
  call counter_A_Q(ctbb,wf(:,45),Q(:,11),wf(:,470))
  call counter_A_Q(ctbb,wf(:,47),Q(:,104),wf(:,471))
  call vert_VQ_A(wf(:,467),wf(:,24),wf(:,472))
  call prop_Q_A(wf(:,457),Q(:,52),MB,1_intkind1,wf(:,473))
  call prop_A_Q(wf(:,50),Q(:,43),MB,1_intkind1,wf(:,474))
  call prop_A_Q(wf(:,51),Q(:,43),MB,1_intkind1,wf(:,475))
  call vert_VQ_A(wf(:,-5),wf(:,28),wf(:,476))
  call prop_Q_A(wf(:,476),Q(:,116),MB,1_intkind1,wf(:,477))
  call vert_VQ_A(wf(:,-6),wf(:,38),wf(:,478))
  call prop_Q_A(wf(:,478),Q(:,116),MB,1_intkind1,wf(:,479))
  call prop_A_Q(wf(:,48),Q(:,75),MB,1_intkind1,wf(:,480))
  call prop_A_Q(wf(:,49),Q(:,75),MB,1_intkind1,wf(:,481))
  call counter_Q_A(ctbb,wf(:,54),Q(:,36),wf(:,482))
  call prop_Q_A(wf(:,482),Q(:,36),MB,1_intkind1,wf(:,483))
  call vert_VQ_A(wf(:,-6),wf(:,483),wf(:,484))
  call vert_VQ_A(wf(:,1),wf(:,483),wf(:,485))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,483),wf(:,486))
  call counter_A_Q(ctbb,wf(:,55),Q(:,24),wf(:,487))
  call prop_A_Q(wf(:,487),Q(:,24),MB,1_intkind1,wf(:,488))
  call vert_AV_Q(wf(:,488),wf(:,-6),wf(:,489))
  call vert_AV_Q(wf(:,488),wf(:,1),wf(:,490))
  call vert_AZ_Q(gZd,wf(:,488),wf(:,11),wf(:,491))
  call counter_Q_A(ctbb,wf(:,58),Q(:,100),wf(:,492))
  call counter_A_Q(ctbb,wf(:,62),Q(:,88),wf(:,493))
  call counter_Q_A(ctbb,wf(:,65),Q(:,68),wf(:,494))
  call prop_Q_A(wf(:,494),Q(:,68),MB,1_intkind1,wf(:,495))
  call vert_VQ_A(wf(:,-5),wf(:,495),wf(:,496))
  call vert_VQ_A(wf(:,1),wf(:,495),wf(:,497))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,495),wf(:,498))
  call vert_AV_Q(wf(:,488),wf(:,-5),wf(:,499))
  call counter_Q_A(ctbb,wf(:,67),Q(:,100),wf(:,500))
  call counter_A_Q(ctbb,wf(:,70),Q(:,56),wf(:,501))
  call vert_VQ_A(wf(:,467),wf(:,-2),wf(:,502))
  call counter_Q_A(ctbb,wf(:,74),Q(:,100),wf(:,503))
  ...
  call prop_A_Q(wf(:,508),Q(:,120),MB,1_intkind1,wf(:,509))
  call vert_AV_Q(wf(:,70),wf(:,-6),wf(:,510))
  call prop_A_Q(wf(:,510),Q(:,120),MB,1_intkind1,wf(:,511))
  call prop_A_Q(wf(:,499),Q(:,56),MB,1_intkind1,wf(:,512))
  call prop_Q_A(wf(:,75),Q(:,39),MB,1_intkind1,wf(:,513))
  call prop_Q_A(wf(:,76),Q(:,39),MB,1_intkind1,wf(:,514))
  call prop_Q_A(wf(:,77),Q(:,71),MB,1_intkind1,wf(:,515))
  call prop_Q_A(wf(:,78),Q(:,71),MB,1_intkind1,wf(:,516))
  call vert_VQ_A(wf(:,-4),wf(:,483),wf(:,517))
  call vert_AV_Q(wf(:,459),wf(:,-4),wf(:,518))
  call counter_Q_A(ctbb,wf(:,80),Q(:,52),wf(:,519))
  call counter_A_Q(ctbb,wf(:,82),Q(:,88),wf(:,520))
  ...
  call counter_A_Q(ctbb,wf(:,86),Q(:,88),wf(:,525))
  call vert_VQ_A(wf(:,523),wf(:,54),wf(:,526))
  call prop_Q_A(wf(:,517),Q(:,52),MB,1_intkind1,wf(:,527))
  call prop_A_Q(wf(:,87),Q(:,27),MB,1_intkind1,wf(:,528))
  call prop_A_Q(wf(:,88),Q(:,27),MB,1_intkind1,wf(:,529))
  call vert_VQ_A(wf(:,-4),wf(:,58),wf(:,530))
  call prop_Q_A(wf(:,530),Q(:,116),MB,1_intkind1,wf(:,531))
  call vert_VQ_A(wf(:,-6),wf(:,80),wf(:,532))
  call prop_Q_A(wf(:,532),Q(:,116),MB,1_intkind1,wf(:,533))
  call vert_VQ_A(wf(:,-4),wf(:,495),wf(:,534))
  call vert_AV_Q(wf(:,451),wf(:,-4),wf(:,535))
  call counter_Q_A(ctbb,wf(:,90),Q(:,84),wf(:,536))
  call counter_A_Q(ctbb,wf(:,92),Q(:,56),wf(:,537))
  call vert_VQ_A(wf(:,523),wf(:,-2),wf(:,538))
  call counter_Q_A(ctbb,wf(:,95),Q(:,84),wf(:,539))
  ...
  call prop_A_Q(wf(:,544),Q(:,120),MB,1_intkind1,wf(:,545))
  call vert_AV_Q(wf(:,92),wf(:,-6),wf(:,546))
  call prop_A_Q(wf(:,546),Q(:,120),MB,1_intkind1,wf(:,547))
  call prop_A_Q(wf(:,535),Q(:,56),MB,1_intkind1,wf(:,548))
  call prop_Q_A(wf(:,96),Q(:,23),MB,1_intkind1,wf(:,549))
  call prop_Q_A(wf(:,97),Q(:,23),MB,1_intkind1,wf(:,550))
  ...
  call counter_A_Q(ctbb,wf(:,101),Q(:,56),wf(:,555))
  call vert_VQ_A(wf(:,553),wf(:,65),wf(:,556))
  call vert_VQ_A(wf(:,553),wf(:,-2),wf(:,557))
  call counter_Q_A(ctbb,wf(:,104),Q(:,52),wf(:,558))
  ...
  call prop_A_Q(wf(:,563),Q(:,120),MB,1_intkind1,wf(:,564))
  call vert_VQ_A(wf(:,105),wf(:,-2),wf(:,565))
  call prop_Q_A(wf(:,565),Q(:,116),MB,1_intkind1,wf(:,566))
  call prop_Q_A(wf(:,557),Q(:,52),MB,1_intkind1,wf(:,567))
  call vert_AV_Q(wf(:,101),wf(:,-6),wf(:,568))
  call prop_A_Q(wf(:,568),Q(:,120),MB,1_intkind1,wf(:,569))
  call counter_V_V(ctGG,wf(:,105),Q(:,112),wf(:,570))
  call prop_A_Q(wf(:,554),Q(:,56),MB,1_intkind1,wf(:,571))
  call prop_Q_A(wf(:,110),Q(:,116),MB,1_intkind1,wf(:,572))
  call vert_UV_W(wf(:,553),Q(:,48),wf(:,-6),Q(:,64),wf(:,573))
  call prop_Q_A(wf(:,534),Q(:,84),MB,1_intkind1,wf(:,574))
  call vert_VQ_A(wf(:,-4),wf(:,67),wf(:,575))
  call prop_Q_A(wf(:,575),Q(:,116),MB,1_intkind1,wf(:,576))
  call vert_VQ_A(wf(:,-5),wf(:,90),wf(:,577))
  call prop_Q_A(wf(:,577),Q(:,116),MB,1_intkind1,wf(:,578))
  call vert_AV_Q(wf(:,41),wf(:,-4),wf(:,579))
  call prop_A_Q(wf(:,579),Q(:,120),MB,1_intkind1,wf(:,580))
  call vert_AV_Q(wf(:,82),wf(:,-5),wf(:,581))
  call prop_A_Q(wf(:,581),Q(:,120),MB,1_intkind1,wf(:,582))
  call prop_A_Q(wf(:,518),Q(:,88),MB,1_intkind1,wf(:,583))
  call vert_AV_Q(wf(:,-3),wf(:,111),wf(:,584))
  call prop_A_Q(wf(:,584),Q(:,120),MB,1_intkind1,wf(:,585))
  call vert_VQ_A(wf(:,111),wf(:,-2),wf(:,586))
  call prop_Q_A(wf(:,586),Q(:,116),MB,1_intkind1,wf(:,587))
  call prop_Q_A(wf(:,538),Q(:,84),MB,1_intkind1,wf(:,588))
  call vert_AV_Q(wf(:,86),wf(:,-5),wf(:,589))
  call prop_A_Q(wf(:,589),Q(:,120),MB,1_intkind1,wf(:,590))
  call counter_V_V(ctGG,wf(:,111),Q(:,112),wf(:,591))
  call prop_A_Q(wf(:,524),Q(:,88),MB,1_intkind1,wf(:,592))
  call prop_Q_A(wf(:,112),Q(:,116),MB,1_intkind1,wf(:,593))
  call vert_UV_W(wf(:,-5),Q(:,32),wf(:,523),Q(:,80),wf(:,594))
  call vert_AV_Q(wf(:,-3),wf(:,113),wf(:,595))
  call prop_A_Q(wf(:,595),Q(:,120),MB,1_intkind1,wf(:,596))
  call vert_VQ_A(wf(:,113),wf(:,-2),wf(:,597))
  call prop_Q_A(wf(:,597),Q(:,116),MB,1_intkind1,wf(:,598))
  call vert_AV_Q(wf(:,47),wf(:,-4),wf(:,599))
  call prop_A_Q(wf(:,599),Q(:,120),MB,1_intkind1,wf(:,600))
  call counter_V_V(ctGG,wf(:,113),Q(:,112),wf(:,601))
  call prop_Q_A(wf(:,502),Q(:,100),MB,1_intkind1,wf(:,602))
  call prop_Q_A(wf(:,114),Q(:,116),MB,1_intkind1,wf(:,603))
  call prop_A_Q(wf(:,468),Q(:,104),MB,1_intkind1,wf(:,604))
  ...
  call prop_Q_A(wf(:,611),Q(:,55),MB,1_intkind1,wf(:,612))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,38),wf(:,613))
  call prop_Q_A(wf(:,613),Q(:,55),MB,1_intkind1,wf(:,614))
  call vert_QA_V(wf(:,28),wf(:,-3),wf(:,615))
  call vert_VQ_A(wf(:,1),wf(:,28),wf(:,616))
  call prop_Q_A(wf(:,616),Q(:,87),MB,1_intkind1,wf(:,617))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,28),wf(:,618))
  call prop_Q_A(wf(:,618),Q(:,87),MB,1_intkind1,wf(:,619))
  call vert_QA_V(wf(:,204),wf(:,-3),wf(:,620))
  call vert_QA_V(wf(:,205),wf(:,-3),wf(:,621))
  call vert_VQ_A(wf(:,-5),wf(:,204),wf(:,622))
  call prop_Q_A(wf(:,622),Q(:,55),MB,1_intkind1,wf(:,623))
  call vert_VQ_A(wf(:,-5),wf(:,205),wf(:,624))
  call prop_Q_A(wf(:,624),Q(:,55),MB,1_intkind1,wf(:,625))
  call vert_VQ_A(wf(:,-6),wf(:,204),wf(:,626))
  call prop_Q_A(wf(:,626),Q(:,87),MB,1_intkind1,wf(:,627))
  ...
  call prop_A_Q(wf(:,635),Q(:,59),MB,1_intkind1,wf(:,636))
  call vert_AZ_Q(gZd,wf(:,70),wf(:,11),wf(:,637))
  ...
  call vert_AZ_Q(gZd,wf(:,62),wf(:,11),wf(:,641))
  call prop_A_Q(wf(:,641),Q(:,91),MB,1_intkind1,wf(:,642))
  ...
  call prop_A_Q(wf(:,647),Q(:,91),MB,1_intkind1,wf(:,648))
  call vert_AV_Q(wf(:,241),wf(:,-6),wf(:,649))
  call prop_A_Q(wf(:,649),Q(:,91),MB,1_intkind1,wf(:,650))
  call vert_QA_V(wf(:,54),wf(:,44),wf(:,651))
  call vert_QA_V(wf(:,54),wf(:,45),wf(:,652))
  call vert_VQ_A(wf(:,1),wf(:,80),wf(:,653))
  call prop_Q_A(wf(:,653),Q(:,55),MB,1_intkind1,wf(:,654))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,80),wf(:,655))
  call prop_Q_A(wf(:,655),Q(:,55),MB,1_intkind1,wf(:,656))
  call vert_QA_V(wf(:,58),wf(:,-3),wf(:,657))
  call vert_VQ_A(wf(:,1),wf(:,58),wf(:,658))
  call prop_Q_A(wf(:,658),Q(:,103),MB,1_intkind1,wf(:,659))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,58),wf(:,660))
  call prop_Q_A(wf(:,660),Q(:,103),MB,1_intkind1,wf(:,661))
  call vert_QA_V(wf(:,237),wf(:,-3),wf(:,662))
  call vert_QA_V(wf(:,238),wf(:,-3),wf(:,663))
  call vert_VQ_A(wf(:,-4),wf(:,237),wf(:,664))
  call prop_Q_A(wf(:,664),Q(:,55),MB,1_intkind1,wf(:,665))
  call vert_VQ_A(wf(:,-4),wf(:,238),wf(:,666))
  call prop_Q_A(wf(:,666),Q(:,55),MB,1_intkind1,wf(:,667))
  call vert_VQ_A(wf(:,-6),wf(:,237),wf(:,668))
  call prop_Q_A(wf(:,668),Q(:,103),MB,1_intkind1,wf(:,669))
  call vert_VQ_A(wf(:,-6),wf(:,238),wf(:,670))
  call prop_Q_A(wf(:,670),Q(:,103),MB,1_intkind1,wf(:,671))
  ...
  call prop_A_Q(wf(:,677),Q(:,59),MB,1_intkind1,wf(:,678))
  call vert_AZ_Q(gZd,wf(:,92),wf(:,11),wf(:,679))
  call prop_A_Q(wf(:,679),Q(:,59),MB,1_intkind1,wf(:,680))
  call vert_AV_Q(wf(:,32),wf(:,1),wf(:,681))
  call prop_A_Q(wf(:,681),Q(:,107),MB,1_intkind1,wf(:,682))
  call vert_AZ_Q(gZd,wf(:,32),wf(:,11),wf(:,683))
  call prop_A_Q(wf(:,683),Q(:,107),MB,1_intkind1,wf(:,684))
  call vert_AV_Q(wf(:,207),wf(:,-4),wf(:,685))
  call prop_A_Q(wf(:,685),Q(:,59),MB,1_intkind1,wf(:,686))
  call vert_AV_Q(wf(:,208),wf(:,-4),wf(:,687))
  call prop_A_Q(wf(:,687),Q(:,59),MB,1_intkind1,wf(:,688))
  call vert_AV_Q(wf(:,207),wf(:,-6),wf(:,689))
  call prop_A_Q(wf(:,689),Q(:,107),MB,1_intkind1,wf(:,690))
  call vert_AV_Q(wf(:,208),wf(:,-6),wf(:,691))
  call prop_A_Q(wf(:,691),Q(:,107),MB,1_intkind1,wf(:,692))
  call vert_VQ_A(wf(:,98),wf(:,5),wf(:,693))
  call prop_Q_A(wf(:,693),Q(:,55),MB,1_intkind1,wf(:,694))
  call vert_VQ_A(wf(:,98),wf(:,13),wf(:,695))
  call prop_Q_A(wf(:,695),Q(:,55),MB,1_intkind1,wf(:,696))
  call vert_AV_Q(wf(:,44),wf(:,98),wf(:,697))
  call prop_A_Q(wf(:,697),Q(:,59),MB,1_intkind1,wf(:,698))
  call vert_AV_Q(wf(:,45),wf(:,98),wf(:,699))
  call prop_A_Q(wf(:,699),Q(:,59),MB,1_intkind1,wf(:,700))
  call vert_VQ_A(wf(:,1),wf(:,104),wf(:,701))
  call prop_Q_A(wf(:,701),Q(:,55),MB,1_intkind1,wf(:,702))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,104),wf(:,703))
  call prop_Q_A(wf(:,703),Q(:,55),MB,1_intkind1,wf(:,704))
  call vert_AV_Q(wf(:,101),wf(:,1),wf(:,705))
  call prop_A_Q(wf(:,705),Q(:,59),MB,1_intkind1,wf(:,706))
  call vert_AZ_Q(gZd,wf(:,101),wf(:,11),wf(:,707))
  call prop_A_Q(wf(:,707),Q(:,59),MB,1_intkind1,wf(:,708))
  call vert_QA_V(wf(:,65),wf(:,44),wf(:,709))
  call vert_QA_V(wf(:,65),wf(:,45),wf(:,710))
  call vert_VQ_A(wf(:,1),wf(:,90),wf(:,711))
  call prop_Q_A(wf(:,711),Q(:,87),MB,1_intkind1,wf(:,712))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,90),wf(:,713))
  call prop_Q_A(wf(:,713),Q(:,87),MB,1_intkind1,wf(:,714))
  call vert_QA_V(wf(:,67),wf(:,-3),wf(:,715))
  call vert_VQ_A(wf(:,1),wf(:,67),wf(:,716))
  call prop_Q_A(wf(:,716),Q(:,103),MB,1_intkind1,wf(:,717))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,67),wf(:,718))
  call prop_Q_A(wf(:,718),Q(:,103),MB,1_intkind1,wf(:,719))
  call vert_QA_V(wf(:,252),wf(:,-3),wf(:,720))
  call vert_QA_V(wf(:,253),wf(:,-3),wf(:,721))
  call vert_VQ_A(wf(:,-4),wf(:,252),wf(:,722))
  call prop_Q_A(wf(:,722),Q(:,87),MB,1_intkind1,wf(:,723))
  call vert_VQ_A(wf(:,-4),wf(:,253),wf(:,724))
  call prop_Q_A(wf(:,724),Q(:,87),MB,1_intkind1,wf(:,725))
  call vert_VQ_A(wf(:,-5),wf(:,252),wf(:,726))
  call prop_Q_A(wf(:,726),Q(:,103),MB,1_intkind1,wf(:,727))
  call vert_VQ_A(wf(:,-5),wf(:,253),wf(:,728))
  call prop_Q_A(wf(:,728),Q(:,103),MB,1_intkind1,wf(:,729))
  ...
  call prop_A_Q(wf(:,735),Q(:,91),MB,1_intkind1,wf(:,736))
  call vert_AZ_Q(gZd,wf(:,82),wf(:,11),wf(:,737))
  call prop_A_Q(wf(:,737),Q(:,91),MB,1_intkind1,wf(:,738))
  call vert_AV_Q(wf(:,41),wf(:,1),wf(:,739))
  call prop_A_Q(wf(:,739),Q(:,107),MB,1_intkind1,wf(:,740))
  call vert_AZ_Q(gZd,wf(:,41),wf(:,11),wf(:,741))
  call prop_A_Q(wf(:,741),Q(:,107),MB,1_intkind1,wf(:,742))
  call vert_AV_Q(wf(:,220),wf(:,-4),wf(:,743))
  call prop_A_Q(wf(:,743),Q(:,91),MB,1_intkind1,wf(:,744))
  call vert_AV_Q(wf(:,221),wf(:,-4),wf(:,745))
  call prop_A_Q(wf(:,745),Q(:,91),MB,1_intkind1,wf(:,746))
  call vert_AV_Q(wf(:,220),wf(:,-5),wf(:,747))
  call prop_A_Q(wf(:,747),Q(:,107),MB,1_intkind1,wf(:,748))
  call vert_AV_Q(wf(:,221),wf(:,-5),wf(:,749))
  call prop_A_Q(wf(:,749),Q(:,107),MB,1_intkind1,wf(:,750))
  call vert_VQ_A(wf(:,83),wf(:,5),wf(:,751))
  call prop_Q_A(wf(:,751),Q(:,87),MB,1_intkind1,wf(:,752))
  call vert_VQ_A(wf(:,83),wf(:,13),wf(:,753))
  call prop_Q_A(wf(:,753),Q(:,87),MB,1_intkind1,wf(:,754))
  call vert_AV_Q(wf(:,44),wf(:,83),wf(:,755))
  call prop_A_Q(wf(:,755),Q(:,91),MB,1_intkind1,wf(:,756))
  call vert_AV_Q(wf(:,45),wf(:,83),wf(:,757))
  call prop_A_Q(wf(:,757),Q(:,91),MB,1_intkind1,wf(:,758))
  call vert_VQ_A(wf(:,1),wf(:,95),wf(:,759))
  call prop_Q_A(wf(:,759),Q(:,87),MB,1_intkind1,wf(:,760))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,95),wf(:,761))
  call prop_Q_A(wf(:,761),Q(:,87),MB,1_intkind1,wf(:,762))
  call vert_AV_Q(wf(:,86),wf(:,1),wf(:,763))
  call prop_A_Q(wf(:,763),Q(:,91),MB,1_intkind1,wf(:,764))
  call vert_AZ_Q(gZd,wf(:,86),wf(:,11),wf(:,765))
  call prop_A_Q(wf(:,765),Q(:,91),MB,1_intkind1,wf(:,766))
  call vert_VQ_A(wf(:,42),wf(:,5),wf(:,767))
  call prop_Q_A(wf(:,767),Q(:,103),MB,1_intkind1,wf(:,768))
  call vert_VQ_A(wf(:,42),wf(:,13),wf(:,769))
  call prop_Q_A(wf(:,769),Q(:,103),MB,1_intkind1,wf(:,770))
  call vert_AV_Q(wf(:,44),wf(:,42),wf(:,771))
  call prop_A_Q(wf(:,771),Q(:,107),MB,1_intkind1,wf(:,772))
  call vert_AV_Q(wf(:,45),wf(:,42),wf(:,773))
  call prop_A_Q(wf(:,773),Q(:,107),MB,1_intkind1,wf(:,774))
  call vert_VQ_A(wf(:,1),wf(:,74),wf(:,775))
  call prop_Q_A(wf(:,775),Q(:,103),MB,1_intkind1,wf(:,776))
  call vert_ZQ_A(gZd,wf(:,11),wf(:,74),wf(:,777))
  call prop_Q_A(wf(:,777),Q(:,103),MB,1_intkind1,wf(:,778))
  call vert_AV_Q(wf(:,47),wf(:,1),wf(:,779))
  call prop_A_Q(wf(:,779),Q(:,107),MB,1_intkind1,wf(:,780))
  call vert_AZ_Q(gZd,wf(:,47),wf(:,11),wf(:,781))
  call prop_A_Q(wf(:,781),Q(:,107),MB,1_intkind1,wf(:,782))
  ...
  call prop_Q_A(wf(:,791),Q(:,55),MB,1_intkind1,wf(:,792))
  call vert_VQ_A(wf(:,-5),wf(:,550),wf(:,793))
  call prop_Q_A(wf(:,793),Q(:,55),MB,1_intkind1,wf(:,794))
  call vert_VQ_A(wf(:,-6),wf(:,549),wf(:,795))
  call prop_Q_A(wf(:,795),Q(:,87),MB,1_intkind1,wf(:,796))
  call vert_VQ_A(wf(:,-6),wf(:,550),wf(:,797))
  call prop_Q_A(wf(:,797),Q(:,87),MB,1_intkind1,wf(:,798))
  call vert_QA_V(wf(:,513),wf(:,-3),wf(:,799))
  call vert_QA_V(wf(:,514),wf(:,-3),wf(:,800))
  call vert_VQ_A(wf(:,-4),wf(:,513),wf(:,801))
  call prop_Q_A(wf(:,801),Q(:,55),MB,1_intkind1,wf(:,802))
  call vert_VQ_A(wf(:,-4),wf(:,514),wf(:,803))
  call prop_Q_A(wf(:,803),Q(:,55),MB,1_intkind1,wf(:,804))
  call vert_VQ_A(wf(:,-6),wf(:,513),wf(:,805))
  call prop_Q_A(wf(:,805),Q(:,103),MB,1_intkind1,wf(:,806))
  call vert_VQ_A(wf(:,-6),wf(:,514),wf(:,807))
  call prop_Q_A(wf(:,807),Q(:,103),MB,1_intkind1,wf(:,808))
  call vert_QA_V(wf(:,515),wf(:,-3),wf(:,809))
  call vert_QA_V(wf(:,516),wf(:,-3),wf(:,810))
  call vert_VQ_A(wf(:,-4),wf(:,515),wf(:,811))
  call prop_Q_A(wf(:,811),Q(:,87),MB,1_intkind1,wf(:,812))
  call vert_VQ_A(wf(:,-4),wf(:,516),wf(:,813))
  call prop_Q_A(wf(:,813),Q(:,87),MB,1_intkind1,wf(:,814))
  call vert_VQ_A(wf(:,-5),wf(:,515),wf(:,815))
  call prop_Q_A(wf(:,815),Q(:,103),MB,1_intkind1,wf(:,816))
  call vert_VQ_A(wf(:,-5),wf(:,516),wf(:,817))
  call prop_Q_A(wf(:,817),Q(:,103),MB,1_intkind1,wf(:,818))
  ...
  call prop_A_Q(wf(:,831),Q(:,59),MB,1_intkind1,wf(:,832))
  call vert_AV_Q(wf(:,529),wf(:,-5),wf(:,833))
  call prop_A_Q(wf(:,833),Q(:,59),MB,1_intkind1,wf(:,834))
  call vert_AV_Q(wf(:,528),wf(:,-6),wf(:,835))
  call prop_A_Q(wf(:,835),Q(:,91),MB,1_intkind1,wf(:,836))
  call vert_AV_Q(wf(:,529),wf(:,-6),wf(:,837))
  call prop_A_Q(wf(:,837),Q(:,91),MB,1_intkind1,wf(:,838))
  call vert_AV_Q(wf(:,474),wf(:,-4),wf(:,839))
  call prop_A_Q(wf(:,839),Q(:,59),MB,1_intkind1,wf(:,840))
  call vert_AV_Q(wf(:,475),wf(:,-4),wf(:,841))
  call prop_A_Q(wf(:,841),Q(:,59),MB,1_intkind1,wf(:,842))
  call vert_AV_Q(wf(:,474),wf(:,-6),wf(:,843))
  call prop_A_Q(wf(:,843),Q(:,107),MB,1_intkind1,wf(:,844))
  call vert_AV_Q(wf(:,475),wf(:,-6),wf(:,845))
  call prop_A_Q(wf(:,845),Q(:,107),MB,1_intkind1,wf(:,846))
  call vert_AV_Q(wf(:,480),wf(:,-4),wf(:,847))
  call prop_A_Q(wf(:,847),Q(:,91),MB,1_intkind1,wf(:,848))
  call vert_AV_Q(wf(:,481),wf(:,-4),wf(:,849))
  call prop_A_Q(wf(:,849),Q(:,91),MB,1_intkind1,wf(:,850))
  call vert_AV_Q(wf(:,480),wf(:,-5),wf(:,851))
  call prop_A_Q(wf(:,851),Q(:,107),MB,1_intkind1,wf(:,852))
  call vert_AV_Q(wf(:,481),wf(:,-5),wf(:,853))
  call prop_A_Q(wf(:,853),Q(:,107),MB,1_intkind1,wf(:,854))
...
subroutine denominators()
  ...
  den(189) = 1 / (Q(5,44))
  den(193) = 1 / (Q(5,76))
  den(217) = 1 / (Q(5,120) - MB2)
  den(233) = 1 / (Q(5,67))
  den(240) = 1 / (Q(5,35))
  den(247) = 1 / (Q(5,19))
  den(251) = 1 / (Q(5,23) - MB2)
  den(256) = 1 / (Q(5,43) - MB2)
  den(269) = 1 / (Q(5,75) - MB2)
  den(279) = 1 / (Q(5,39) - MB2)
  den(284) = 1 / (Q(5,27) - MB2)
  den(295) = 1 / (Q(5,71) - MB2)
  den(656) = 1 / (Q(5,15))
  den(776) = 1 / (Q(5,31))
  den(784) = 1 / (Q(5,55) - MB2)
  den(790) = 1 / (Q(5,87) - MB2)
  den(811) = 1 / (Q(5,59) - MB2)
  den(816) = 1 / (Q(5,91) - MB2)
  den(825) = 1 / (Q(5,47))
  den(838) = 1 / (Q(5,103) - MB2)
  den(863) = 1 / (Q(5,107) - MB2)
  den(890) = 1 / (Q(5,79))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2( 1) = (-A(390)+A(391)-A(396)+A(397)-A(402)+A(403)-A(408)+A(409)-A(742)-A(744)-A(746)-A(748)-A(750)-A(752)-A(768)-A(770) &
        -A(776)-A(874)-A(876)-A(882)-A(888)-A(894)-A(896)-A(900)-A(902)-A(908)-A(946)-A(948)-A(952)-A(958)-A(966)-A(968))*f(5) &
        +((A(149)+A(151)+A(161)+A(163))*f(6))/2._/**/REALKIND+(-A(393)+A(394)-A(399)+A(400)-A(405)+A(406)-A(411)+A(412)-A(743) &
        -A(745)-A(747)-A(749)-A(751)-A(753)-A(769)-A(771)-A(777)-A(875)-A(877)-A(883)-A(889)-A(895)-A(897)-A(901)-A(903)-A(909) &
        -A(947)-A(949)-A(953)-A(959)-A(967)-A(969))*f(6)+CI*(-A(754)-A(756)-A(758)-A(760)-A(762)-A(764)-A(850)-A(852)-A(854) &
        -A(856)-A(858)-A(860)-A(880)-A(886)-A(890)-A(954)-A(956)-A(962))*f(7)+(CI*(A(110)+A(112)+A(117)+A(119)+A(133)+A(135) &
        -A(141)-A(143))*f(8))/2._/**/REALKIND+CI*(-A(755)-A(757)-A(759)-A(761)-A(763)-A(765)-A(851)-A(853)-A(855)-A(857)-A(859) &
        -A(861)-A(881)-A(887)-A(891)-A(955)-A(957)-A(963))*f(8)+(A(193)-A(194)+A(205)-A(206)+A(291)+A(295)+A(297)+A(300)+A(362) &
        +A(444)+A(524)+A(548)+A(574)+A(576)+A(584)+A(594)+A(596)+A(618)+A(642)+A(652))*f(9)+(A(196)-A(197)+A(208)-A(209)+A(292) &
        +A(296)+A(298)+A(301)+A(363)+A(445)+A(525)+A(549)+A(575)+A(577)+A(585)+A(595)+A(597)+A(619)+A(643)+A(653))*f(10) &
        +CI*(A(284)+A(340)+A(352)+A(462)+A(518)+A(522)+A(578)+A(580)+A(586)+A(626)+A(628)+A(644))*f(11)+CI*(A(285)+A(341)+A(353) &
        +A(463)+A(519)+A(523)+A(579)+A(581)+A(587)+A(627)+A(629)+A(645))*f(12)+(A(199)-A(200)+A(211)-A(212)+A(280)+A(282)+A(528) &
        +A(536)+A(552)+A(592)+A(622)+A(646))*f(13)+(A(202)-A(203)+A(214)-A(215)+A(281)+A(283)+A(529)+A(537)+A(553)+A(593)+A(623) &
  ...
  M2( 2) = (-A(391)+A(392)-A(397)+A(398)-A(403)+A(404)-A(409)+A(410)-A(730)-A(732)-A(734)-A(736)-A(738)-A(740)-A(766)-A(772) &
        -A(774)-A(804)-A(806)-A(812)+A(922)+A(924)+A(930)+A(936)+A(942)+A(944)+A(946)+A(948)+A(952)+A(958)+A(966)+A(968))*f(5) &
        +((A(150)+A(152)+A(153)+A(155))*f(6))/2._/**/REALKIND+(-A(394)+A(395)-A(400)+A(401)-A(406)+A(407)-A(412)+A(413)-A(731) &
        -A(733)-A(735)-A(737)-A(739)-A(741)-A(767)-A(773)-A(775)-A(805)-A(807)-A(813)+A(923)+A(925)+A(931)+A(937)+A(943)+A(945) &
        +A(947)+A(949)+A(953)+A(959)+A(967)+A(969))*f(6)+CI*(A(754)+A(756)+A(758)+A(760)+A(762)+A(764)-A(790)-A(792)-A(794)-A(796) &
  ...
  M2( 3) = (A(390)-A(392)+A(396)-A(398)+A(402)-A(404)+A(408)-A(410)-A(814)-A(816)-A(818)-A(820)-A(822)-A(824)-A(840)-A(842)-A(848) &
        +A(874)+A(876)+A(882)+A(888)+A(894)+A(896)-A(898)-A(904)-A(906)-A(922)-A(924)-A(930)-A(936)-A(942)-A(944))*f(5)+((A(157) &
        +A(159)+A(162)+A(164))*f(6))/2._/**/REALKIND+(A(393)-A(395)+A(399)-A(401)+A(405)-A(407)+A(411)-A(413)-A(815)-A(817)-A(819) &
        -A(821)-A(823)-A(825)-A(841)-A(843)-A(849)+A(875)+A(877)+A(883)+A(889)+A(895)+A(897)-A(899)-A(905)-A(907)-A(923)-A(925) &
        -A(931)-A(937)-A(943)-A(945))*f(6)+CI*(-A(826)-A(828)-A(830)-A(832)-A(834)-A(836)+A(850)+A(852)+A(854)+A(856)+A(858) &
        +A(860)+A(880)+A(886)+A(890)-A(926)-A(932)-A(940))*f(7)+(CI*(-A(110)-A(112)+A(113)+A(115)+A(137)+A(139)-A(142) &
  ...
  M2( 4) = (-A(391)+A(392)-A(397)+A(398)-A(403)+A(404)-A(409)+A(410)-A(682)-A(684)-A(686)-A(688)-A(690)-A(692)-A(720)-A(722) &
        -A(728)-A(838)-A(844)-A(846)+A(922)+A(924)+A(930)+A(936)+A(942)+A(944)+A(946)+A(948)+A(952)+A(958)+A(966)+A(968))*f(5) &
        +((A(145)+A(147)+A(158)+A(160))*f(6))/2._/**/REALKIND+(-A(394)+A(395)-A(400)+A(401)-A(406)+A(407)-A(412)+A(413)-A(683) &
        -A(685)-A(687)-A(689)-A(691)-A(693)-A(721)-A(723)-A(729)-A(839)-A(845)-A(847)+A(923)+A(925)+A(931)+A(937)+A(943)+A(945) &
        +A(947)+A(949)+A(953)+A(959)+A(967)+A(969))*f(6)+CI*(-A(706)-A(708)-A(710)-A(712)-A(714)-A(716)+A(826)+A(828)+A(830) &
        +A(832)+A(834)+A(836)+A(926)+A(932)+A(940)-A(950)-A(960)-A(964))*f(7)+(CI*(-A(113)-A(115)-A(117)-A(119)+A(134)+A(136) &
        +A(138)+A(140))*f(8))/2._/**/REALKIND+CI*(-A(707)-A(709)-A(711)-A(713)-A(715)-A(717)+A(827)+A(829)+A(831)+A(833)+A(835) &
        +A(837)+A(927)+A(933)+A(941)-A(951)-A(961)-A(965))*f(8)+(A(194)-A(195)+A(206)-A(207)+A(236)+A(238)+A(252)+A(261)+A(334) &
        +A(436)+A(502)+A(504)-A(540)-A(548)+A(566)-A(634)-A(642)+A(666)+A(668)+A(680))*f(9)+(A(197)-A(198)+A(209)-A(210)+A(237) &
        +A(239)+A(253)+A(262)+A(335)+A(437)+A(503)+A(505)-A(541)-A(549)+A(567)-A(635)-A(643)+A(667)+A(669)+A(681))*f(10) &
        +CI*(A(245)-A(329)-A(378)+A(458)+A(490)+A(546)-A(562)-A(564)-A(602)-A(636)+A(674)+A(676))*f(11)+CI*(A(246)-A(330)-A(379) &
        +A(459)+A(491)+A(547)-A(563)-A(565)-A(603)-A(637)+A(675)+A(677))*f(12)+(A(200)-A(201)+A(212)-A(213)+A(232)+A(234)+A(496) &
        -A(544)-A(552)+A(606)-A(638)-A(646))*f(13)+(A(203)-A(204)+A(215)-A(216)+A(233)+A(235)+A(497)-A(545)-A(553)+A(607)-A(639) &
        ...
        -A(184))*f(25)+(19*(A(173)+A(174)+A(185)+A(186))*f(25))/2._/**/REALKIND+18*(-A(178)-A(190))*f(26)+(19*(A(179)+A(180) &
        +A(191)+A(192))*f(26))/2._/**/REALKIND
  M2( 5) = (A(390)-A(392)+A(396)-A(398)+A(402)-A(404)+A(408)-A(410)-A(778)-A(780)-A(782)-A(784)-A(786)-A(788)-A(802)-A(808)-A(810) &
        +A(874)+A(876)+A(882)+A(888)+A(894)+A(896)-A(912)-A(914)-A(920)-A(922)-A(924)-A(930)-A(936)-A(942)-A(944))*f(5)+((A(154) &
        +A(156)+A(165)+A(167))*f(6))/2._/**/REALKIND+(A(393)-A(395)+A(399)-A(401)+A(405)-A(407)+A(411)-A(413)-A(779)-A(781)-A(783) &
        -A(785)-A(787)-A(789)-A(803)-A(809)-A(811)+A(875)+A(877)+A(883)+A(889)+A(895)+A(897)-A(913)-A(915)-A(921)-A(923)-A(925) &
        -A(931)-A(937)-A(943)-A(945))*f(6)+CI*(A(790)+A(792)+A(794)+A(796)+A(798)+A(800)-A(862)-A(864)-A(866)-A(868)-A(870)-A(872) &
        -A(878)-A(884)-A(892)+A(928)+A(934)+A(938))*f(7)+(CI*(A(109)+A(111)-A(114)-A(116)-A(138)-A(140)+A(141) &
        +A(143))*f(8))/2._/**/REALKIND+CI*(A(791)+A(793)+A(795)+A(797)+A(799)+A(801)-A(863)-A(865)-A(867)-A(869)-A(871)-A(873) &
        -A(879)-A(885)-A(893)+A(929)+A(935)+A(939))*f(8)+(-A(193)+A(195)-A(205)+A(207)+A(319)+A(368)+A(414)+A(416)+A(421)+A(450) &
        +A(514)+A(516)-A(524)+A(540)+A(556)-A(618)+A(634)+A(654)+A(656)+A(662))*f(9)+(-A(196)+A(198)-A(208)+A(210)+A(320)+A(369) &
        +A(415)+A(417)+A(422)+A(451)+A(515)+A(517)-A(525)+A(541)+A(557)-A(619)+A(635)+A(655)+A(657)+A(663))*f(10)+CI*(-A(314) &
        +A(345)+A(356)-A(374)-A(506)+A(530)+A(532)-A(538)+A(614)+A(620)-A(658)-A(660))*f(11)+CI*(-A(315)+A(346)+A(357)-A(375) &
        -A(507)+A(531)+A(533)-A(539)+A(615)+A(621)-A(659)-A(661))*f(12)+(-A(199)+A(201)-A(211)+A(213)+A(310)+A(312)+A(510)-A(528) &
        +A(544)-A(622)+A(632)+A(638))*f(13)+(-A(202)+A(204)-A(214)+A(216)+A(311)+A(313)+A(511)-A(529)+A(545)-A(623)+A(633) &
        ...
        -A(185))*f(25)+(19*(A(172)+A(174)+A(184)+A(186))*f(25))/2._/**/REALKIND+18*(-A(179)-A(191))*f(26)+(19*(A(178)+A(180) &
        +A(190)+A(192))*f(26))/2._/**/REALKIND
  M2( 6) = (-A(390)+A(391)-A(396)+A(397)-A(402)+A(403)-A(408)+A(409)-A(694)-A(696)-A(698)-A(700)-A(702)-A(704)-A(718)-A(724) &
        -A(726)-A(874)-A(876)-A(882)-A(888)-A(894)-A(896)-A(910)-A(916)-A(918)-A(946)-A(948)-A(952)-A(958)-A(966)-A(968))*f(5) &
        +((A(146)+A(148)+A(166)+A(168))*f(6))/2._/**/REALKIND+(-A(393)+A(394)-A(399)+A(400)-A(405)+A(406)-A(411)+A(412)-A(695) &
        -A(697)-A(699)-A(701)-A(703)-A(705)-A(719)-A(725)-A(727)-A(875)-A(877)-A(883)-A(889)-A(895)-A(897)-A(911)-A(917)-A(919) &
        -A(947)-A(949)-A(953)-A(959)-A(967)-A(969))*f(6)+CI*(A(706)+A(708)+A(710)+A(712)+A(714)+A(716)+A(862)+A(864)+A(866)+A(868) &
...
end module ol_loop_pplljjj_eexbbxggg_1_/**/REALKIND
