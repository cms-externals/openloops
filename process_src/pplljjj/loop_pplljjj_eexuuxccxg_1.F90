...
module ol_colourmatrix_pplljjj_eexuuxccxg_1_/**/REALKIND
...
end module ol_colourmatrix_pplljjj_eexuuxccxg_1_/**/REALKIND



module ol_forced_parameters_pplljjj_eexuuxccxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljjj_eexuuxccxg_1_/**/REALKIND

module ol_loop_pplljjj_eexuuxccxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 9) = (2*CI*countertermnorm*ctGcc*eQED**2*gQCD**5)/3._/**/REALKIND
    f(10) = CI*countertermnorm*ctGcc*eQED**2*gQCD**5
    f(11) = (2*countertermnorm*ctGcc*eQED**2*gQCD**5)/3._/**/REALKIND
    f(12) = countertermnorm*ctGcc*eQED**2*gQCD**5
    f(13) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(14) = CI*countertermnorm*ctGqq*eQED**2*gQCD**5
    f(15) = (2*countertermnorm*ctGqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(16) = countertermnorm*ctGqq*eQED**2*gQCD**5
    f(17) = (2*CI*countertermnorm*ctVcc*eQED**2*gQCD**5)/3._/**/REALKIND
    f(18) = CI*countertermnorm*ctVcc*eQED**2*gQCD**5
    f(19) = (2*countertermnorm*ctVcc*eQED**2*gQCD**5)/3._/**/REALKIND
    f(20) = countertermnorm*ctVcc*eQED**2*gQCD**5
    f(21) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**5)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,4),Q(:,80),wf(:,225))
  ...
  call counter_A_Q(ctcc,wf(:,7),Q(:,35),wf(:,230))
  call counter_A_Q(ctcc,wf(:,11),Q(:,35),wf(:,231))
  call counter_A_Q(ctcc,wf(:,14),Q(:,44),wf(:,232))
  call vert_VQ_A(wf(:,222),wf(:,-4),wf(:,233))
  call vert_VQ_A(wf(:,222),wf(:,20),wf(:,234))
  call vert_VQ_A(wf(:,222),wf(:,22),wf(:,235))
  call counter_Q_A(ctcc,wf(:,20),Q(:,19),wf(:,236))
  call counter_Q_A(ctcc,wf(:,22),Q(:,19),wf(:,237))
  call counter_Q_A(ctcc,wf(:,25),Q(:,28),wf(:,238))
  call counter_A_Q(ctcc,wf(:,17),Q(:,96),wf(:,239))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(304)-A(306)-A(308)-A(310)-A(312)-A(314)-A(316)-A(318)-A(320)-A(322)-A(324)-A(326)-A(332)-A(334)-A(338)-A(340) &
       ...
       +A(371)+A(373)+A(375))*f(6))/6._/**/REALKIND+((A(128)+A(132)+A(144)+A(148)+A(160)+A(162)+A(164)+A(166)+A(170) &
       ...
       -A(151))*f(18))/6._/**/REALKIND+((A(111)+A(116)+A(178)+A(184)+A(210)+A(218))*f(21))/6._/**/REALKIND+((-A(112)-A(117)-A(179) &
       -A(185)-A(211)-A(219))*f(22))/6._/**/REALKIND+((A(110)+A(115)+A(126)+A(127))*f(28))/6._/**/REALKIND
  M2(2) = ((A(256)+A(258)+A(260)+A(262)+A(264)+A(266)+A(282)+A(292)+A(298)+A(316)+A(318)+A(320)+A(322)+A(324)+A(326)+A(332)+A(338) &
       ...
       +A(225)+A(227)+A(229)+A(241)+A(243)+A(249))*f(14))/2._/**/REALKIND+(CI*(A(182)+A(212)-A(250)-A(254))*f(15))/2._/**/REALKIND &
       +(CI*(-A(183)-A(213)+A(251)+A(255))*f(16))/2._/**/REALKIND+((-A(58)-A(78)-A(100)-A(134)-A(150))*f(17))/2._/**/REALKIND &
       +((A(59)+A(79)+A(101)+A(135)+A(151))*f(18))/2._/**/REALKIND+(CI*(-A(86)-A(102))*f(19))/2._/**/REALKIND+(CI*(A(87) &
       +A(103))*f(20))/2._/**/REALKIND+((-A(116)-A(184)-A(198)-A(210)-A(230))*f(21))/2._/**/REALKIND+((A(117)+A(185)+A(199)+A(211) &
       +A(231))*f(22))/2._/**/REALKIND+(CI*(A(186)+A(216))*f(23))/2._/**/REALKIND+(CI*(-A(187)-A(217))*f(24))/2._/**/REALKIND &
       +(CI*(-A(68)-A(72)+A(118)+A(122))*f(25))/2._/**/REALKIND+(CI*(A(69)+A(73)-A(119)-A(123))*f(26))/2._/**/REALKIND+(CI*(A(53) &
       -A(54)-A(55))*f(27))/2._/**/REALKIND+((-A(60)-A(75)-A(115)-A(126))*f(28))/2._/**/REALKIND
  M2(3) = ((A(268)+A(270)+A(272)+A(274)+A(276)+A(278)+A(280)+A(294)+A(302)+A(304)+A(306)+A(308)+A(310)+A(312)+A(314)+A(334)+A(340) &
       ...
       +A(233)+A(237)+A(239)+A(245)+A(247)+A(253))*f(14))/2._/**/REALKIND+(CI*(-A(182)-A(212)+A(250) &
       +A(254))*f(15))/2._/**/REALKIND+(CI*(A(183)+A(213)-A(251)-A(255))*f(16))/2._/**/REALKIND+((-A(63)-A(84)-A(94)-A(130) &
       -A(146))*f(17))/2._/**/REALKIND+((A(64)+A(85)+A(95)+A(131)+A(147))*f(18))/2._/**/REALKIND+(CI*(A(86) &
       +A(102))*f(19))/2._/**/REALKIND+(CI*(-A(87)-A(103))*f(20))/2._/**/REALKIND+((-A(111)-A(178)-A(202)-A(218) &
       -A(234))*f(21))/2._/**/REALKIND+((A(112)+A(179)+A(203)+A(219)+A(235))*f(22))/2._/**/REALKIND+(CI*(-A(186) &
       ...
       +A(55))*f(27))/2._/**/REALKIND+((-A(65)-A(74)-A(110)-A(127))*f(28))/2._/**/REALKIND
  M2(4) = ((-A(256)-A(258)-A(260)-A(262)-A(264)-A(266)-A(268)-A(270)-A(272)-A(274)-A(276)-A(278)-A(280)-A(282)-A(292)-A(294) &
       ...
       +A(395)+A(397)+A(399))*f(6))/6._/**/REALKIND+((A(56)+A(61)+A(66)+A(70)+A(76)+A(82)+A(88)+A(90)+A(92)+A(98)+A(104)+A(106) &
       +A(136)+A(138)+A(140)+A(142)+A(152)+A(154)+A(156)+A(158))*f(9))/6._/**/REALKIND+((-A(57)-A(62)-A(67)-A(71)-A(77)-A(83) &
       -A(89)-A(91)-A(93)-A(99)-A(105)-A(107)-A(137)-A(139)-A(141)-A(143)-A(153)-A(155)-A(157)-A(159))*f(10))/6._/**/REALKIND &
       +((A(196)+A(200)+A(228)+A(232)+A(240)+A(242)+A(244)+A(246)+A(248)+A(252))*f(13))/6._/**/REALKIND+((-A(197)-A(201)-A(229) &
       -A(233)-A(241)-A(243)-A(245)-A(247)-A(249)-A(253))*f(14))/6._/**/REALKIND+((A(58)+A(63)+A(78)+A(84)+A(94) &
       +A(100))*f(17))/6._/**/REALKIND+((-A(59)-A(64)-A(79)-A(85)-A(95)-A(101))*f(18))/6._/**/REALKIND+((A(198)+A(202)+A(230) &
       +A(234))*f(21))/6._/**/REALKIND+((-A(199)-A(203)-A(231)-A(235))*f(22))/6._/**/REALKIND+((A(60)+A(65)+A(74) &
       +A(75))*f(28))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplljjj_eexuuxccxg_1_/**/REALKIND
