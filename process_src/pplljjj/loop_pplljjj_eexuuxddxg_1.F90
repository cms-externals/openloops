...
module ol_colourmatrix_pplljjj_eexuuxddxg_1_/**/REALKIND
...
end module ol_colourmatrix_pplljjj_eexuuxddxg_1_/**/REALKIND



module ol_forced_parameters_pplljjj_eexuuxddxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljjj_eexuuxddxg_1_/**/REALKIND

module ol_loop_pplljjj_eexuuxddxg_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(49), c(71)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(19) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(20) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(21) = CI*countertermnorm*ctVqq*eQED**2*gQCD**5
    f(22) = (countertermnorm*ctVqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(23) = (2*countertermnorm*ctVqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(24) = countertermnorm*ctVqq*eQED**2*gQCD**5
    f(25) = (countertermnorm*ctVVV*eQED**2*gQCD**5)/3._/**/REALKIND
    f(26) = (2*countertermnorm*ctVVV*eQED**2*gQCD**5)/3._/**/REALKIND
    f(27) = countertermnorm*ctVVV*eQED**2*gQCD**5
    f(28) = CI*countertermnorm*ctZGG*eQED**2*gQCD**5
    f(29) = countertermnorm*ctZGG*eQED**2*gQCD**5
    f(30) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(31) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(32) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(33) = (2*CI*eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(34) = CI*eQED**2*gQCD**5*integralnorm*SwB
    f(35) = (eQED**2*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(36) = (eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(37) = (eQED**2*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(38) = (2*eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(39) = eQED**2*gQCD**5*integralnorm*SwB
    f(40) = (CI*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(41) = (2*CI*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(42) = CI*eQED**2*gQCD**5*integralnorm*SwF
    f(43) = (4*CI*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(44) = 2*CI*eQED**2*gQCD**5*integralnorm*SwF
    f(45) = (eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(46) = (2*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(47) = eQED**2*gQCD**5*integralnorm*SwF
    f(48) = (4*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(49) = 2*eQED**2*gQCD**5*integralnorm*SwF

  c = [ 27*CI*f(30), 54*CI*f(30), 3*CI*f(31), 9*CI*f(31), 24*CI*f(31), 27*CI*f(31), 54*CI*f(31), 27*CI*f(32), 54*CI*f(32) &
    , 3*CI*f(33), 9*CI*f(33), 24*CI*f(33), 27*CI*f(33), 54*CI*f(33), 3*CI*f(34), 9*CI*f(34), 24*CI*f(34), 27*CI*f(34), 54*CI*f(34) &
    , 18*f(35), 54*f(35), f(36), 3*f(36), 6*f(36), 8*f(36), 9*f(36), 10*f(36), 18*f(36), 21*f(36), 24*f(36), 27*f(36), 54*f(36) &
    , 18*f(37), 54*f(37), f(38), 3*f(38), 6*f(38), 8*f(38), 9*f(38), 10*f(38), 18*f(38), 21*f(38), 24*f(38), 27*f(38), 54*f(38) &
    , f(39), 3*f(39), 6*f(39), 8*f(39), 9*f(39), 10*f(39), 18*f(39), 21*f(39), 24*f(39), 27*f(39), 54*f(39), 9*CI*f(40) &
    , 9*CI*f(41), 9*CI*f(42), 9*CI*f(43), 9*CI*f(44), 3*f(45), 9*f(45), 3*f(46), 9*f(46), 3*f(47), 9*f(47), 3*f(48), 9*f(48) &
    , 3*f(49), 9*f(49) ]
  c = (1._/**/REALKIND / 36) * c
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(352)+A(354)+A(356)+A(358)+A(360)+A(362)+A(364)+A(366)+A(368)+A(370)+A(372)+A(374))*f(7))/6._/**/REALKIND+((-A(304) &
       ...
       +A(361)+A(363)+A(365)+A(367)+A(369)+A(371)+A(373)+A(375))*f(9))/6._/**/REALKIND+((-A(128)-A(132)-A(144)-A(148)-A(192) &
       -A(194)-A(204)-A(206)-A(224)-A(226)-A(236)-A(238))*f(13))/6._/**/REALKIND+((A(108)+A(113)+A(120)+A(124)+A(160)+A(162) &
       +A(164)+A(166)+A(170)+A(174)+A(176)+A(180)+A(188)+A(190)+A(208)+A(214)+A(220)+A(222))*f(14))/6._/**/REALKIND+((-A(109) &
       -A(114)-A(121)-A(125)-A(129)-A(133)-A(145)-A(149)-A(161)-A(163)-A(165)-A(167)-A(171)-A(175)-A(177)-A(181)-A(189)-A(191) &
       -A(193)-A(195)-A(205)-A(207)-A(209)-A(215)-A(221)-A(223)-A(225)-A(227)-A(237)-A(239))*f(15))/6._/**/REALKIND+((-A(130) &
       -A(134)-A(146)-A(150))*f(19))/6._/**/REALKIND+((A(111)+A(116)+A(178)+A(184)+A(210)+A(218))*f(20))/6._/**/REALKIND+((-A(112) &
       -A(117)-A(131)-A(135)-A(147)-A(151)-A(179)-A(185)-A(211)-A(219))*f(21))/6._/**/REALKIND+((A(110)+A(115)+A(126) &
       +A(127))*f(29))/6._/**/REALKIND
  M2(2) = ((-A(256)-A(258)-A(260)-A(262)-A(264)-A(266)-A(282)-A(292)-A(298)-A(364)-A(366)-A(368)-A(370)-A(372) &
       ...
       +A(104)+A(106)+A(132)+A(148)+A(204)+A(206)+A(224)+A(226)+A(240)+A(242)+A(248))*f(13))/2._/**/REALKIND+((-A(113)-A(124) &
       -A(136)-A(138)-A(156)-A(158)-A(164)-A(166)-A(174)-A(188)-A(190)-A(196)-A(208)-A(214)-A(228))*f(14))/2._/**/REALKIND+((A(57) &
       +A(67)+A(77)+A(83)+A(105)+A(107)+A(114)+A(125)+A(133)+A(137)+A(139)+A(149)+A(157)+A(159)+A(165)+A(167)+A(175)+A(189)+A(191) &
       +A(197)+A(205)+A(207)+A(209)+A(215)+A(225)+A(227)+A(229)+A(241)+A(243)+A(249))*f(15))/2._/**/REALKIND+(CI*(A(80)+A(96) &
       +A(250)+A(254))*f(16))/2._/**/REALKIND+(CI*(A(168)+A(172)+A(182)+A(212))*f(17))/2._/**/REALKIND+(CI*(A(81)+A(97)-A(169) &
       -A(173)-A(183)-A(213)+A(251)+A(255))*f(18))/2._/**/REALKIND+((A(58)+A(78)+A(100)+A(134)+A(150))*f(19))/2._/**/REALKIND+(( &
       -A(116)-A(184)-A(198)-A(210)-A(230))*f(20))/2._/**/REALKIND+((A(59)+A(79)+A(101)+A(117)+A(135)+A(151)+A(185)+A(199)+A(211) &
       +A(231))*f(21))/2._/**/REALKIND+(CI*(A(86)+A(102))*f(22))/2._/**/REALKIND+(CI*(A(186)+A(216))*f(23))/2._/**/REALKIND &
       +(CI*(A(87)+A(103)-A(187)-A(217))*f(24))/2._/**/REALKIND+(CI*(A(68)+A(72))*f(25))/2._/**/REALKIND+(CI*(A(118) &
       +A(122))*f(26))/2._/**/REALKIND+(CI*(A(69)+A(73)-A(119)-A(123))*f(27))/2._/**/REALKIND+(CI*(A(53)-A(54) &
       -A(55))*f(28))/2._/**/REALKIND+((-A(60)-A(75)-A(115)-A(126))*f(29))/2._/**/REALKIND
  M2(3) = ((-A(268)-A(270)-A(272)-A(274)-A(276)-A(278)-A(280)-A(294)-A(302)-A(352)-A(354)-A(356)-A(358)-A(360) &
       ...
       +A(92)+A(98)+A(128)+A(144)+A(192)+A(194)+A(236)+A(238)+A(244)+A(246)+A(252))*f(13))/2._/**/REALKIND+((-A(108)-A(120)-A(140) &
       -A(142)-A(152)-A(154)-A(160)-A(162)-A(170)-A(176)-A(180)-A(200)-A(220)-A(222)-A(232))*f(14))/2._/**/REALKIND+((A(62)+A(71) &
       +A(89)+A(91)+A(93)+A(99)+A(109)+A(121)+A(129)+A(141)+A(143)+A(145)+A(153)+A(155)+A(161)+A(163)+A(171)+A(177)+A(181)+A(193) &
       +A(195)+A(201)+A(221)+A(223)+A(233)+A(237)+A(239)+A(245)+A(247)+A(253))*f(15))/2._/**/REALKIND+(CI*(-A(80)-A(96)-A(250) &
       -A(254))*f(16))/2._/**/REALKIND+(CI*(-A(168)-A(172)-A(182)-A(212))*f(17))/2._/**/REALKIND+(CI*(-A(81)-A(97)+A(169)+A(173) &
       +A(183)+A(213)-A(251)-A(255))*f(18))/2._/**/REALKIND+((A(63)+A(84)+A(94)+A(130)+A(146))*f(19))/2._/**/REALKIND+((-A(111) &
       -A(178)-A(202)-A(218)-A(234))*f(20))/2._/**/REALKIND+((A(64)+A(85)+A(95)+A(112)+A(131)+A(147)+A(179)+A(203)+A(219) &
       +A(235))*f(21))/2._/**/REALKIND+(CI*(-A(86)-A(102))*f(22))/2._/**/REALKIND+(CI*(-A(186)-A(216))*f(23))/2._/**/REALKIND &
       +(CI*(-A(87)-A(103)+A(187)+A(217))*f(24))/2._/**/REALKIND+(CI*(-A(68)-A(72))*f(25))/2._/**/REALKIND+(CI*(-A(118) &
       -A(122))*f(26))/2._/**/REALKIND+(CI*(-A(69)-A(73)+A(119)+A(123))*f(27))/2._/**/REALKIND+(CI*(-A(53)+A(54) &
       +A(55))*f(28))/2._/**/REALKIND+((-A(65)-A(74)-A(110)-A(127))*f(29))/2._/**/REALKIND
  M2(4) = ((A(256)+A(258)+A(260)+A(262)+A(264)+A(266)+A(268)+A(270)+A(272)+A(274)+A(276)+A(278)+A(280)+A(282)+A(292)+A(294)+A(298) &
       ...
       -A(88)-A(90)-A(92)-A(98)-A(104)-A(106)-A(240)-A(242)-A(244)-A(246)-A(248)-A(252))*f(13))/6._/**/REALKIND+((A(136)+A(138) &
       +A(140)+A(142)+A(152)+A(154)+A(156)+A(158)+A(196)+A(200)+A(228)+A(232))*f(14))/6._/**/REALKIND+((-A(57)-A(62)-A(67)-A(71) &
       -A(77)-A(83)-A(89)-A(91)-A(93)-A(99)-A(105)-A(107)-A(137)-A(139)-A(141)-A(143)-A(153)-A(155)-A(157)-A(159)-A(197)-A(201) &
       -A(229)-A(233)-A(241)-A(243)-A(245)-A(247)-A(249)-A(253))*f(15))/6._/**/REALKIND+((-A(58)-A(63)-A(78)-A(84)-A(94) &
       -A(100))*f(19))/6._/**/REALKIND+((A(198)+A(202)+A(230)+A(234))*f(20))/6._/**/REALKIND+((-A(59)-A(64)-A(79)-A(85)-A(95) &
       -A(101)-A(199)-A(203)-A(231)-A(235))*f(21))/6._/**/REALKIND+((A(60)+A(65)+A(74)+A(75))*f(29))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplljjj_eexuuxddxg_1_/**/REALKIND
