...
module ol_versiondata_eetttt
  implicit none
  character(4) :: generator_revision = "1497"
  interface
    subroutine version_eetttt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_eetttt
  end interface
end module ol_versiondata_eetttt


subroutine ol_version_eetttt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_eetttt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_eetttt
