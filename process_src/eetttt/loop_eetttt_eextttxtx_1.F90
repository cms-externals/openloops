...
module ol_colourmatrix_eetttt_eextttxtx_1_/**/REALKIND
...
end module ol_colourmatrix_eetttt_eextttxtx_1_/**/REALKIND



module ol_forced_parameters_eetttt_eextttxtx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eetttt_eextttxtx_1_/**/REALKIND

module ol_loop_eetttt_eextttxtx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (2*CI*countertermnorm*ctGtt*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 6) = CI*countertermnorm*ctGtt*eQED**2*gQCD**4
    f( 7) = (2*CI*countertermnorm*ctVtt*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 8) = CI*countertermnorm*ctVtt*eQED**2*gQCD**4
    f( 9) = countertermnorm*ctZGG*eQED**2*gQCD**4
    f(10) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(11) = CI*eQED**2*gQCD**4*integralnorm*SwB
    f(12) = (eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(13) = (eQED**2*gQCD**4*integralnorm*SwB)/2._/**/REALKIND
    f(14) = (2*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
  ...
  c = [ 9*CI*f(10), 27*CI*f(10), 9*CI*f(11), 27*CI*f(11), 18*f(12), 54*f(12), 18*f(13), 54*f(13), f(14), 3*f(14), 6*f(14), 8*f(14) &
    , 10*f(14), 18*f(14), 21*f(14), 24*f(14), 54*f(14), f(15), 3*f(15), 6*f(15), 8*f(15), 10*f(15), 18*f(15), 21*f(15), 24*f(15) &
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,3),Q(:,11),MT,1_intkind1,wf(:,5))
  call vert_QA_Z(gZl,wf(:,0),wf(:,-1),wf(:,6))
  call prop_W_W(wf(:,6),Q(:,3),MZ,1_intkind1,wf(:,7))
  call vert_ZQ_A(gZu,wf(:,7),wf(:,-3),wf(:,8))
  call prop_Q_A(wf(:,8),Q(:,11),MT,1_intkind1,wf(:,9))
  ...
  call prop_Q_A(wf(:,18),Q(:,7),MT,1_intkind1,wf(:,19))
  ...
  call counter_AZ_Q(gZu,wf(:,-4),wf(:,7),wf(:,40))
  call counter_AV_Q(wf(:,-4),wf(:,28),wf(:,41))
  call counter_VQ_A(wf(:,2),wf(:,-3),wf(:,42))
  call prop_A_Q(wf(:,11),Q(:,35),MT,1_intkind1,wf(:,43))
  call prop_A_Q(wf(:,13),Q(:,35),MT,1_intkind1,wf(:,44))
  call counter_VQ_A(wf(:,1),wf(:,-3),wf(:,45))
  call prop_A_Q(wf(:,4),Q(:,52),MT,1_intkind1,wf(:,46))
  call counter_ZQ_A(gZu,wf(:,7),wf(:,-3),wf(:,47))
  call counter_VQ_A(wf(:,22),wf(:,-3),wf(:,48))
  call prop_A_Q(wf(:,25),Q(:,19),MT,1_intkind1,wf(:,49))
  call prop_A_Q(wf(:,27),Q(:,19),MT,1_intkind1,wf(:,50))
  call prop_A_Q(wf(:,23),Q(:,52),MT,1_intkind1,wf(:,51))
  call counter_QA_V(wf(:,-3),wf(:,-5),wf(:,52))
  call vert_AV_Q(wf(:,-4),wf(:,52),wf(:,53))
  call vert_VQ_A(wf(:,52),wf(:,-2),wf(:,54))
  call prop_Q_A(wf(:,54),Q(:,44),MT,1_intkind1,wf(:,55))
  call counter_QA_V(wf(:,-3),wf(:,-4),wf(:,56))
  call vert_AV_Q(wf(:,-5),wf(:,56),wf(:,57))
  call vert_VQ_A(wf(:,56),wf(:,-2),wf(:,58))
  call prop_Q_A(wf(:,58),Q(:,28),MT,1_intkind1,wf(:,59))
  call counter_VQ_A(wf(:,14),wf(:,-2),wf(:,60))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,61))
  call prop_A_Q(wf(:,16),Q(:,56),MT,1_intkind1,wf(:,62))
  call counter_ZQ_A(gZu,wf(:,7),wf(:,-2),wf(:,63))
  call counter_VQ_A(wf(:,28),wf(:,-2),wf(:,64))
  call prop_A_Q(wf(:,29),Q(:,56),MT,1_intkind1,wf(:,65))
  call counter_QA_V(wf(:,-2),wf(:,-5),wf(:,66))
  call vert_AV_Q(wf(:,-4),wf(:,66),wf(:,67))
  call vert_VQ_A(wf(:,66),wf(:,-3),wf(:,68))
  call prop_Q_A(wf(:,68),Q(:,44),MT,1_intkind1,wf(:,69))
  call counter_QA_V(wf(:,-2),wf(:,-4),wf(:,70))
  call vert_AV_Q(wf(:,-5),wf(:,70),wf(:,71))
  call vert_VQ_A(wf(:,70),wf(:,-3),wf(:,72))
  call prop_Q_A(wf(:,72),Q(:,28),MT,1_intkind1,wf(:,73))
  call counter_V_V(ctGG,wf(:,2),Q(:,20),wf(:,74))
  call vert_VQ_A(wf(:,74),wf(:,-3),wf(:,75))
  call vert_AV_Q(wf(:,-5),wf(:,74),wf(:,76))
  call counter_Q_A(cttt,wf(:,5),Q(:,11),wf(:,77))
  call counter_Q_A(cttt,wf(:,9),Q(:,11),wf(:,78))
  call counter_Q_A(cttt,wf(:,12),Q(:,28),wf(:,79))
  call counter_V_V(ctGG,wf(:,14),Q(:,24),wf(:,80))
  call vert_VQ_A(wf(:,80),wf(:,-2),wf(:,81))
  call counter_Q_A(cttt,wf(:,17),Q(:,7),wf(:,82))
  call counter_Q_A(cttt,wf(:,19),Q(:,7),wf(:,83))
  call counter_Q_A(cttt,wf(:,21),Q(:,28),wf(:,84))
  ...
  call counter_Q_A(cttt,wf(:,26),Q(:,44),wf(:,89))
  call counter_V_V(ctGG,wf(:,28),Q(:,40),wf(:,90))
  call vert_VQ_A(wf(:,90),wf(:,-2),wf(:,91))
  call counter_Q_A(cttt,wf(:,31),Q(:,44),wf(:,92))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(75)-A(77)-A(79)-A(81)-A(83)-A(85)-A(87)-A(89))*f(3))/6._/**/REALKIND+((-A(67)-A(69)-A(71)-A(73)-A(91)-A(93)-A(95) &
       ...
       +A(61))*f(5))/6._/**/REALKIND+((A(18)+A(31)+A(35)+A(43)+A(45)+A(55)+A(63)+A(65))*f(5))/2._/**/REALKIND+((-A(24)-A(28)-A(40) &
       -A(48)-A(50)-A(52)-A(60)-A(62))*f(6))/6._/**/REALKIND+((-A(19)-A(32)-A(36)-A(44)-A(46)-A(56)-A(64) &
...
end module ol_loop_eetttt_eextttxtx_1_/**/REALKIND
