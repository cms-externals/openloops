...
module ol_colourmatrix_ppjjj_uuuxuxbbx_1_/**/REALKIND
...
end module ol_colourmatrix_ppjjj_uuuxuxbbx_1_/**/REALKIND



module ol_forced_parameters_ppjjj_uuuxuxbbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppjjj_uuuxuxbbx_1_/**/REALKIND

module ol_tree_ppjjj_uuuxuxbbx_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppjjj_uuuxuxbbx_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppjjj_uuuxuxbbx_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for up up anti-up anti-up bottom anti-bottom -> 0
...
! **********************************************************************
  ...
  use ol_external_ppjjj_uuuxuxbbx_1, only: external_perm_ppjjj_uuuxuxbbx_1, &
    & external_perm_inv_ppjjj_uuuxuxbbx_1, extcomb_perm_ppjjj_uuuxuxbbx_1, &
    & average_factor_ppjjj_uuuxuxbbx_1
  use ol_external_ppjjj_uuuxuxbbx_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppjjj_uuuxuxbbx_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppjjj_uuuxuxbbx_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppjjj_uuuxuxbbx_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppjjj_uuuxuxbbx_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppjjj_uuuxuxbbx_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppjjj_uuuxuxbbx_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppjjj_uuuxuxbbx_1(extcombs(k))
  end do
  ...
  call vert_UV_W(ntry, wf4(:,1), Q(:,5), wf4(:,2), Q(:,10), wf16(:,1), n3(:,4), t3x16(:,:,1))
  call vert_VQ_A(ntry, wf4(:,1), ex5, wf8(:,1), n3(:,5), t3x8(:,:,1))
  call vert_AV_Q(ntry, ex6, wf4(:,2), wf8(:,2), n3(:,6), t3x8(:,:,2))
  call prop_Q_A(ntry, wf8(:,1), Q(:,21), MB, 1_intkind1, wf8(:,3), n2(1))
  call vert_VQ_A(ntry, wf4(:,2), ex5, wf8(:,4), n3(:,7), t3x8(:,:,3))
  call vert_AV_Q(ntry, ex6, wf4(:,1), wf8(:,5), n3(:,8), t3x8(:,:,4))
  call prop_Q_A(ntry, wf8(:,4), Q(:,26), MB, 1_intkind1, wf8(:,6), n2(2))
  call vert_VQ_A(ntry, wf4(:,1), ex2, wf8(:,7), n3(:,9), t3x8(:,:,5))
  call vert_AV_Q(ntry, ex4, wf4(:,3), wf8(:,8), n3(:,10), t3x8(:,:,6))
  call prop_Q_A(ntry, wf8(:,7), Q(:,7), ZERO, 0_intkind1, wf8(:,9), n2(3))
  call vert_VQ_A(ntry, wf4(:,3), ex2, wf8(:,10), n3(:,11), t3x8(:,:,7))
  call vert_AV_Q(ntry, ex4, wf4(:,1), wf8(:,11), n3(:,12), t3x8(:,:,8))
  call prop_Q_A(ntry, wf8(:,10), Q(:,50), ZERO, 0_intkind1, wf8(:,12), n2(4))
  call vert_QA_V(ntry, ex1, ex4, wf4(:,4), n3(:,13), t3x4(:,:,4))
  call vert_QA_V(ntry, ex2, ex3, wf4(:,5), n3(:,14), t3x4(:,:,5))
  call vert_UV_W(ntry, wf4(:,5), Q(:,6), wf4(:,4), Q(:,9), wf16(:,2), n3(:,15), t3x16(:,:,2))
  call vert_VQ_A(ntry, wf4(:,4), ex5, wf8(:,13), n3(:,16), t3x8(:,:,9))
  call vert_AV_Q(ntry, ex6, wf4(:,5), wf8(:,14), n3(:,17), t3x8(:,:,10))
  call prop_Q_A(ntry, wf8(:,13), Q(:,25), MB, 1_intkind1, wf8(:,15), n2(5))
  call vert_VQ_A(ntry, wf4(:,5), ex5, wf8(:,16), n3(:,18), t3x8(:,:,11))
  call vert_AV_Q(ntry, ex6, wf4(:,4), wf8(:,17), n3(:,19), t3x8(:,:,12))
  call prop_Q_A(ntry, wf8(:,16), Q(:,22), MB, 1_intkind1, wf8(:,18), n2(6))
  call vert_VQ_A(ntry, wf4(:,5), ex1, wf8(:,19), n3(:,20), t3x8(:,:,13))
  call prop_Q_A(ntry, wf8(:,19), Q(:,7), ZERO, 0_intkind1, wf8(:,20), n2(7))
  call vert_VQ_A(ntry, wf4(:,3), ex1, wf8(:,21), n3(:,21), t3x8(:,:,14))
  call vert_AV_Q(ntry, ex4, wf4(:,5), wf8(:,22), n3(:,22), t3x8(:,:,15))
  call prop_Q_A(ntry, wf8(:,21), Q(:,49), ZERO, 0_intkind1, wf8(:,23), n2(8))
  call vert_VQ_A(ntry, wf4(:,4), ex2, wf8(:,24), n3(:,23), t3x8(:,:,16))
  call vert_AV_Q(ntry, ex3, wf4(:,3), wf8(:,25), n3(:,24), t3x8(:,:,17))
  call prop_Q_A(ntry, wf8(:,24), Q(:,11), ZERO, 0_intkind1, wf8(:,26), n2(9))
  call vert_AV_Q(ntry, ex3, wf4(:,4), wf8(:,27), n3(:,25), t3x8(:,:,18))
  call vert_VQ_A(ntry, wf4(:,2), ex1, wf8(:,28), n3(:,26), t3x8(:,:,19))
  call prop_Q_A(ntry, wf8(:,28), Q(:,11), ZERO, 0_intkind1, wf8(:,29), n2(10))
  call vert_AV_Q(ntry, ex3, wf4(:,2), wf8(:,30), n3(:,27), t3x8(:,:,20))
  ...
  M2add = M2 / average_factor_ppjjj_uuuxuxbbx_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_ppjjj_uuuxuxbbx_1(k))
  end do
...
subroutine diagrams()
  ...
  ! e.g. call cont_VV(nsync, wf3, wf6, A(:,1), n64, t64, nhel, den(5)) ...
    ...
    call cont_QA(nsync, wf8(:,8), wf8(:,9), A(:,4), n3(:,31), t3x64(:,:,4), nhel, den(14))
    call cont_QA(nsync, wf8(:,11), wf8(:,12), A(:,5), n3(:,32), t3x64(:,:,5), nhel, den(17))
    call cont_VV(nsync, wf4(:,3), wf16(:,2), A(:,6), n3(:,33), t3x64(:,:,6), nhel, den(21))
    call cont_QA(nsync, wf8(:,14), wf8(:,15), A(:,7), n3(:,34), t3x64(:,:,7), nhel, den(24))
    call cont_QA(nsync, wf8(:,17), wf8(:,18), A(:,8), n3(:,35), t3x64(:,:,8), nhel, den(27))
    call cont_QA(nsync, wf8(:,8), wf8(:,20), A(:,9), n3(:,36), t3x64(:,:,9), nhel, den(29))
    call cont_QA(nsync, wf8(:,22), wf8(:,23), A(:,10), n3(:,37), t3x64(:,:,10), nhel, den(32))
    call cont_QA(nsync, wf8(:,25), wf8(:,26), A(:,11), n3(:,38), t3x64(:,:,11), nhel, den(35))
    call cont_QA(nsync, wf8(:,12), wf8(:,27), A(:,12), n3(:,39), t3x64(:,:,12), nhel, den(36))
    call cont_QA(nsync, wf8(:,25), wf8(:,29), A(:,13), n3(:,40), t3x64(:,:,13), nhel, den(38))
    call cont_QA(nsync, wf8(:,23), wf8(:,30), A(:,14), n3(:,41), t3x64(:,:,14), nhel, den(39))
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppjjj_uuuxuxbbx_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppjjj_uuuxuxbbx_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppjjj_uuuxuxbbx_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppjjj_uuuxuxbbx_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppjjj_uuuxuxbbx_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppjjj_uuuxuxbbx_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppjjj_uuuxuxbbx_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppjjj_uuuxuxbbx_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppjjj_uuuxuxbbx_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppjjj_uuuxuxbbx_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppjjj_uuuxuxbbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppjjj_uuuxuxbbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppjjj_uuuxuxbbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppjjj_uuuxuxbbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppjjj_uuuxuxbbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppjjj_uuuxuxbbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppjjj_uuuxuxbbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_ppjjj_uuuxuxbbx_1_/**/REALKIND
