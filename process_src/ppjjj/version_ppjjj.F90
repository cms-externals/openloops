...
module ol_versiondata_ppjjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppjjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppjjj
  end interface
end module ol_versiondata_ppjjj


subroutine ol_version_ppjjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppjjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppjjj
