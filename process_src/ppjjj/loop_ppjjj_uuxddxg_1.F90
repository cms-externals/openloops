...
module ol_colourmatrix_ppjjj_uuxddxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppjjj_uuxddxg_1_/**/REALKIND



module ol_forced_parameters_ppjjj_uuxddxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppjjj_uuxddxg_1_/**/REALKIND

module ol_loop_ppjjj_uuxddxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,4),Q(:,20),ZERO,0_intkind1,wf(:,5))
  ...
  call prop_Q_A(wf(:,10),Q(:,17),ZERO,0_intkind1,wf(:,11))
  ...
  call prop_A_Q(wf(:,18),Q(:,24),ZERO,0_intkind1,wf(:,19))
  ...
  call counter_Q_A(ctqq,wf(:,5),Q(:,20),wf(:,40))
  call prop_A_Q(wf(:,6),Q(:,11),ZERO,0_intkind1,wf(:,41))
  call vert_QA_V(wf(:,-2),wf(:,8),wf(:,42))
  call counter_A_Q(ctqq,wf(:,8),Q(:,24),wf(:,43))
  call prop_Q_A(wf(:,9),Q(:,7),ZERO,0_intkind1,wf(:,44))
  call vert_AV_Q(wf(:,-1),wf(:,2),wf(:,45))
  call counter_Q_A(ctqq,wf(:,11),Q(:,17),wf(:,46))
  call prop_A_Q(wf(:,45),Q(:,14),ZERO,0_intkind1,wf(:,47))
  call vert_VQ_A(wf(:,2),wf(:,0),wf(:,48))
  call counter_A_Q(ctqq,wf(:,14),Q(:,18),wf(:,49))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(27)+A(28)+A(29)+A(30))*f(3))/6._/**/REALKIND+((-A(12)-A(13)-A(14)-A(15)-A(16)-A(17))*f(5))/6._/**/REALKIND
  M2(2) = ((-A(23)-A(24)-A(29)-A(30))*f(3))/2._/**/REALKIND+(CI*(A(21)-A(22))*f(4))/2._/**/REALKIND+((A(7)+A(10)+A(13)+A(15)+A(16) &
       +A(19))*f(5))/2._/**/REALKIND+(CI*(A(11)+A(18))*f(6))/2._/**/REALKIND+(CI*A(6)*f(7))/2._/**/REALKIND
  M2(3) = ((-A(25)-A(26)-A(27)-A(28))*f(3))/2._/**/REALKIND+(CI*(-A(21)+A(22))*f(4))/2._/**/REALKIND+((A(8)+A(9)+A(12)+A(14)+A(17) &
       +A(20))*f(5))/2._/**/REALKIND+(CI*(-A(11)-A(18))*f(6))/2._/**/REALKIND-(CI*A(6)*f(7))/2._/**/REALKIND
  M2(4) = ((A(23)+A(24)+A(25)+A(26))*f(3))/6._/**/REALKIND+((-A(7)-A(8)-A(9)-A(10)-A(19)-A(20))*f(5))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppjjj_uuxddxg_1_/**/REALKIND
