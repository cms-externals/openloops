...
module ol_colourmatrix_ppjjj_dddxdxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppjjj_dddxdxg_1_/**/REALKIND



module ol_forced_parameters_ppjjj_dddxdxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppjjj_dddxdxg_1_/**/REALKIND

module ol_loop_ppjjj_dddxdxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,4),Q(:,18),ZERO,0_intkind1,wf(:,5))
  ...
  call prop_Q_A(wf(:,34),Q(:,18),ZERO,0_intkind1,wf(:,35))
  ...
  call prop_Q_A(wf(:,42),Q(:,17),ZERO,0_intkind1,wf(:,43))
  ...
  call counter_Q_A(ctqq,wf(:,5),Q(:,18),wf(:,59))
  call prop_A_Q(wf(:,6),Q(:,13),ZERO,0_intkind1,wf(:,60))
  call vert_QA_V(wf(:,-1),wf(:,8),wf(:,61))
  call counter_A_Q(ctqq,wf(:,8),Q(:,24),wf(:,62))
  call prop_Q_A(wf(:,9),Q(:,7),ZERO,0_intkind1,wf(:,63))
  ...
  call counter_Q_A(ctqq,wf(:,14),Q(:,17),wf(:,68))
  call prop_A_Q(wf(:,67),Q(:,14),ZERO,0_intkind1,wf(:,69))
  call vert_QA_V(wf(:,0),wf(:,8),wf(:,70))
  call prop_Q_A(wf(:,16),Q(:,7),ZERO,0_intkind1,wf(:,71))
  call vert_QA_V(wf(:,5),wf(:,-2),wf(:,72))
  call prop_A_Q(wf(:,17),Q(:,13),ZERO,0_intkind1,wf(:,73))
  call vert_QA_V(wf(:,-1),wf(:,19),wf(:,74))
  call counter_A_Q(ctqq,wf(:,19),Q(:,20),wf(:,75))
  call prop_Q_A(wf(:,20),Q(:,11),ZERO,0_intkind1,wf(:,76))
  call vert_AV_Q(wf(:,-2),wf(:,2),wf(:,77))
  call prop_A_Q(wf(:,77),Q(:,14),ZERO,0_intkind1,wf(:,78))
  call vert_QA_V(wf(:,0),wf(:,19),wf(:,79))
  call prop_Q_A(wf(:,22),Q(:,11),ZERO,0_intkind1,wf(:,80))
...
end module ol_loop_ppjjj_dddxdxg_1_/**/REALKIND
