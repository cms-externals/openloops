...
module ol_colourmatrix_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND
...
end module ol_colourmatrix_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND



module ol_forced_parameters_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND

module ol_tree_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND
...
subroutine born_denominators_init()
  ...
  den(35) = 1 / (Q(5,96))
  den(39) = 1 / (Q(5,108))
  den(42) = 1 / (Q(5,224) - MB2)
  den(46) = 1 / (Q(5,28) - MB2)
  den(58) = 1 / (Q(5,144))
  den(59) = 1 / (Q(5,76) - MB2)
  den(66) = 1 / (Q(5,156))
  den(69) = 1 / (Q(5,67) - MB2)
  den(73) = 1 / (Q(5,176) - MB2)
  den(81) = 1 / (Q(5,160))
  den(85) = 1 / (Q(5,172))
  den(99) = 1 / (Q(5,83))
  den(110) = 1 / (Q(5,99))
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppnnjjj_nenexddxbbbxbx_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppnnjjj_nenexddxbbbxbx_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for nu_e anti-nu_e down anti-down bottom bottom anti-bottom anti-bottom -> 0
...
! **********************************************************************
  ...
  use ol_external_ppnnjjj_nenexddxbbbxbx_1, only: external_perm_ppnnjjj_nenexddxbbbxbx_1, &
    & external_perm_inv_ppnnjjj_nenexddxbbbxbx_1, extcomb_perm_ppnnjjj_nenexddxbbbxbx_1, &
    & average_factor_ppnnjjj_nenexddxbbbxbx_1
  use ol_external_ppnnjjj_nenexddxbbbxbx_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppnnjjj_nenexddxbbbxbx_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppnnjjj_nenexddxbbbxbx_1,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppnnjjj_nenexddxbbbxbx_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppnnjjj_nenexddxbbbxbx_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppnnjjj_nenexddxbbbxbx_1(extcombs(k))
  end do
  ...
  call prop_A_Q(ntry, wf8(:,5), Q(:,208), MB, 1_intkind1, wf8(:,6), n2(4))
  ...
  call prop_Q_A(ntry, wf8(:,7), Q(:,44), MB, 1_intkind1, wf8(:,9), n2(5))
  ...
  call prop_A_Q(ntry, wf8(:,21), Q(:,76), MB, 1_intkind1, wf8(:,22), n2(12))
  call vert_VQ_A(ntry, wf4(:,6), wf8(:,3), wf32(:,13), n3(:,35), t3x32(:,:,13))
  call vert_AV_Q(ntry, ex7, wf4(:,6), wf8(:,23), n3(:,36), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,23), Q(:,208), MB, 1_intkind1, wf8(:,24), n2(13))
  ...
  call prop_Q_A(ntry, wf8(:,27), Q(:,176), MB, 1_intkind1, wf8(:,28), n2(15))
  ...
  call prop_A_Q(ntry, wf8(:,29), Q(:,224), MB, 1_intkind1, wf8(:,30), n2(16))
  ...
  call vert_ZQ_A(gZd,ntry, wf4(:,4), ex3, wf8(:,33), n3(:,63), t3x8(:,:,17))
  ...
  call prop_A_Q(ntry, wf8(:,35), Q(:,88), ZERO, 0_intkind1, wf8(:,36), n2(19))
  call vert_QA_V(ntry, wf8(:,34), wf8(:,36), wf64(:,1), n3(:,67), t3x64(:,:,1))
  call vert_AV_Q(ntry, ex4, wf4(:,7), wf8(:,37), n3(:,68), t3x8(:,:,19))
  call prop_A_Q(ntry, wf8(:,37), Q(:,168), ZERO, 0_intkind1, wf8(:,38), n2(20))
  call vert_QA_V(ntry, wf8(:,34), wf8(:,38), wf64(:,2), n3(:,69), t3x64(:,:,2))
  call vert_AZ_Q(gZd,ntry, ex4, wf4(:,4), wf8(:,39), n3(:,70), t3x8(:,:,20))
  call prop_A_Q(ntry, wf8(:,39), Q(:,11), ZERO, 0_intkind1, wf8(:,40), n2(21))
  call vert_QA_V(ntry, ex3, wf8(:,40), wf16(:,23), n3(:,71), t3x16(:,:,23))
  call vert_VQ_A(ntry, wf4(:,3), ex3, wf8(:,41), n3(:,72), t3x8(:,:,21))
  call prop_Q_A(ntry, wf8(:,41), Q(:,84), ZERO, 0_intkind1, wf8(:,42), n2(22))
  call vert_QA_V(ntry, wf8(:,42), wf8(:,40), wf64(:,3), n3(:,73), t3x64(:,:,3))
  call vert_VQ_A(ntry, wf4(:,7), ex3, wf8(:,43), n3(:,74), t3x8(:,:,22))
  call prop_Q_A(ntry, wf8(:,43), Q(:,164), ZERO, 0_intkind1, wf8(:,44), n2(23))
  call vert_QA_V(ntry, wf8(:,44), wf8(:,40), wf64(:,4), n3(:,75), t3x64(:,:,4))
  call vert_ZQ_A(gZd,ntry, wf4(:,4), wf8(:,42), wf32(:,21), n3(:,76), t3x32(:,:,21))
  call vert_ZQ_A(gZd,ntry, wf4(:,4), wf8(:,44), wf32(:,22), n3(:,77), t3x32(:,:,22))
  ...
  M2add = M2 / average_factor_ppnnjjj_nenexddxbbbxbx_1

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_ppnnjjj_nenexddxbbbxbx_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppnnjjj_nenexddxbbbxbx_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppnnjjj_nenexddxbbbxbx_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppnnjjj_nenexddxbbbxbx_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppnnjjj_nenexddxbbbxbx_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppnnjjj_nenexddxbbbxbx_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppnnjjj_nenexddxbbbxbx_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppnnjjj_nenexddxbbbxbx_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppnnjjj_nenexddxbbbxbx_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppnnjjj_nenexddxbbbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppnnjjj_nenexddxbbbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppnnjjj_nenexddxbbbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppnnjjj_nenexddxbbbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppnnjjj_nenexddxbbbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppnnjjj_nenexddxbbbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppnnjjj_nenexddxbbbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppnnjjj_nenexddxbbbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_ppnnjjj_nenexddxbbbxbx_1_/**/REALKIND
