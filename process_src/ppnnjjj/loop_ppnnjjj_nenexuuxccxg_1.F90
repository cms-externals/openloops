...
module ol_colourmatrix_ppnnjjj_nenexuuxccxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppnnjjj_nenexuuxccxg_1_/**/REALKIND



module ol_forced_parameters_ppnnjjj_nenexuuxccxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppnnjjj_nenexuuxccxg_1_/**/REALKIND

module ol_loop_ppnnjjj_nenexuuxccxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGcc*eQED**2*gQCD**5
    f( 6) = countertermnorm*ctGcc*eQED**2*gQCD**5
    f( 7) = CI*countertermnorm*ctGqq*eQED**2*gQCD**5
    f( 8) = countertermnorm*ctGqq*eQED**2*gQCD**5
    f( 9) = CI*countertermnorm*ctVcc*eQED**2*gQCD**5
    f(10) = countertermnorm*ctVcc*eQED**2*gQCD**5
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,5),Q(:,80),wf(:,172))
  call prop_Q_A(wf(:,172),Q(:,80),ZERO,0_intkind1,wf(:,173))
  call vert_VQ_A(wf(:,2),wf(:,173),wf(:,174))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,173),wf(:,175))
  call counter_A_Q(ctcc,wf(:,8),Q(:,35),wf(:,176))
  call counter_A_Q(ctcc,wf(:,11),Q(:,44),wf(:,177))
  call vert_VQ_A(wf(:,169),wf(:,-4),wf(:,178))
  call vert_VQ_A(wf(:,169),wf(:,16),wf(:,179))
  call counter_Q_A(ctcc,wf(:,16),Q(:,19),wf(:,180))
  call counter_Q_A(ctcc,wf(:,19),Q(:,28),wf(:,181))
  call counter_A_Q(ctcc,wf(:,13),Q(:,96),wf(:,182))
...
end module ol_loop_ppnnjjj_nenexuuxccxg_1_/**/REALKIND
