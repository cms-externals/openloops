...
module ol_colourmatrix_ppnnjjj_nenexuuxbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppnnjjj_nenexuuxbbxg_1_/**/REALKIND



module ol_forced_parameters_ppnnjjj_nenexuuxbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppnnjjj_nenexuuxbbxg_1_/**/REALKIND

module ol_loop_ppnnjjj_nenexuuxbbxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 7) = CI*countertermnorm*ctGqq*eQED**2*gQCD**5
    f( 8) = countertermnorm*ctGqq*eQED**2*gQCD**5
    f( 9) = CI*countertermnorm*ctVbb*eQED**2*gQCD**5
    f(10) = countertermnorm*ctVbb*eQED**2*gQCD**5
    f(11) = CI*countertermnorm*ctVqq*eQED**2*gQCD**5
    f(12) = countertermnorm*ctVqq*eQED**2*gQCD**5
...
end module ol_loop_ppnnjjj_nenexuuxbbxg_1_/**/REALKIND
