...
module ol_colourmatrix_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND
...
end module ol_colourmatrix_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND



module ol_forced_parameters_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND

module ol_tree_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND
...
subroutine born_denominators_init()
  ...
  den(35) = 1 / (Q(5,80))
  den(39) = 1 / (Q(5,116))
  den(42) = 1 / (Q(5,208) - MB2)
  den(46) = 1 / (Q(5,44) - MB2)
  den(58) = 1 / (Q(5,136))
  den(59) = 1 / (Q(5,100) - MB2)
  den(66) = 1 / (Q(5,172))
  den(69) = 1 / (Q(5,67) - MB2)
  den(73) = 1 / (Q(5,152) - MB2)
  den(81) = 1 / (Q(5,144))
  den(85) = 1 / (Q(5,180))
  den(99) = 1 / (Q(5,75))
  den(110) = 1 / (Q(5,83))
  ...
  den(131) = 1 / (Q(5,68))
  den(132) = 1 / (Q(5,40))
  den(133) = 1 / (Q(5,196) - MB2)
  den(137) = 1 / (Q(5,168) - MB2)
  den(144) = 1 / (Q(5,84) - MB2)
  den(148) = 1 / (Q(5,56) - MB2)
  den(158) = 1 / (Q(5,7) - MB2)
  den(160) = 1 / (Q(5,120))
  den(178) = 1 / (Q(5,132))
  den(181) = 1 / (Q(5,104) - MB2)
  den(188) = 1 / (Q(5,148) - MB2)
  den(199) = 1 / (Q(5,184))
  den(214) = 1 / (Q(5,71))
  den(237) = 1 / (Q(5,135))
  den(241) = 1 / (Q(5,48))
  den(247) = 1 / (Q(5,176) - MB2)
  den(251) = 1 / (Q(5,76) - MB2)
  den(285) = 1 / (Q(5,112) - MB2)
  den(289) = 1 / (Q(5,140) - MB2)
  den(341) = 1 / (Q(5,204))
  den(344) = 1 / (Q(5,35) - MB2)
  den(355) = 1 / (Q(5,212))
  den(367) = 1 / (Q(5,43))
  den(378) = 1 / (Q(5,51))
  den(410) = 1 / (Q(5,216))
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppnnjjj_nenexbbbbxbxbx_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppnnjjj_nenexbbbbxbxbx_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for nu_e anti-nu_e bottom bottom bottom anti-bottom anti-bottom anti-bottom -> 0
...
! **********************************************************************
  ...
  use ol_external_ppnnjjj_nenexbbbbxbxbx_1, only: external_perm_ppnnjjj_nenexbbbbxbxbx_1, &
    & external_perm_inv_ppnnjjj_nenexbbbbxbxbx_1, extcomb_perm_ppnnjjj_nenexbbbbxbxbx_1, &
    & average_factor_ppnnjjj_nenexbbbbxbxbx_1
  use ol_external_ppnnjjj_nenexbbbbxbxbx_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppnnjjj_nenexbbbbxbxbx_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppnnjjj_nenexbbbbxbxbx_1,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppnnjjj_nenexbbbbxbxbx_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppnnjjj_nenexbbbbxbxbx_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppnnjjj_nenexbbbbxbxbx_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf8(:,1), Q(:,19), MB, 1_intkind1, wf8(:,3), n2(2))
  call prop_A_Q(ntry, wf8(:,2), Q(:,164), MB, 1_intkind1, wf8(:,4), n2(3))
  call vert_VQ_A(ntry, wf4(:,3), wf8(:,3), wf32(:,1), n3(:,6), t3x32(:,:,1))
  call vert_AV_Q(ntry, ex8, wf4(:,3), wf8(:,5), n3(:,7), t3x8(:,:,3))
  call prop_A_Q(ntry, wf8(:,5), Q(:,200), MB, 1_intkind1, wf8(:,6), n2(4))
  ...
  call prop_Q_A(ntry, wf8(:,7), Q(:,52), MB, 1_intkind1, wf8(:,9), n2(5))
  ...
  call prop_Q_A(ntry, wf8(:,11), Q(:,88), MB, 1_intkind1, wf8(:,12), n2(7))
  ...
  call prop_A_Q(ntry, wf8(:,21), Q(:,100), MB, 1_intkind1, wf8(:,22), n2(12))
  call vert_VQ_A(ntry, wf4(:,6), wf8(:,3), wf32(:,13), n3(:,35), t3x32(:,:,13))
  call vert_AV_Q(ntry, ex7, wf4(:,6), wf8(:,23), n3(:,36), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,23), Q(:,200), MB, 1_intkind1, wf8(:,24), n2(13))
  ...
  call prop_A_Q(ntry, wf8(:,25), Q(:,67), MB, 1_intkind1, wf8(:,26), n2(14))
  call vert_VQ_A(ntry, wf4(:,6), wf8(:,9), wf32(:,14), n3(:,40), t3x32(:,:,14))
  call vert_VQ_A(ntry, wf4(:,6), ex5, wf8(:,27), n3(:,41), t3x8(:,:,14))
  call prop_Q_A(ntry, wf8(:,27), Q(:,152), MB, 1_intkind1, wf8(:,28), n2(15))
  ...
  call prop_Q_A(ntry, wf8(:,31), Q(:,152), MB, 1_intkind1, wf8(:,32), n2(17))
  ...
  call prop_A_Q(ntry, wf8(:,33), Q(:,196), MB, 1_intkind1, wf8(:,34), n2(18))
  call vert_VQ_A(ntry, wf4(:,9), wf8(:,3), wf32(:,21), n3(:,66), t3x32(:,:,21))
  call vert_AV_Q(ntry, ex8, wf4(:,9), wf8(:,35), n3(:,67), t3x8(:,:,18))
  call prop_A_Q(ntry, wf8(:,35), Q(:,168), MB, 1_intkind1, wf8(:,36), n2(19))
  ...
  call prop_Q_A(ntry, wf8(:,37), Q(:,84), MB, 1_intkind1, wf8(:,38), n2(20))
  call vert_VQ_A(ntry, wf4(:,9), wf8(:,38), wf32(:,23), n3(:,71), t3x32(:,:,23))
  call vert_VQ_A(ntry, wf4(:,9), ex5, wf8(:,39), n3(:,72), t3x8(:,:,20))
  call prop_Q_A(ntry, wf8(:,39), Q(:,56), MB, 1_intkind1, wf8(:,40), n2(21))
  ...
  call prop_Q_A(ntry, wf8(:,41), Q(:,7), MB, 1_intkind1, wf8(:,42), n2(22))
  ...
  call prop_Q_A(ntry, wf8(:,43), Q(:,44), MB, 1_intkind1, wf8(:,44), n2(23))
  ...
  call prop_A_Q(ntry, wf8(:,47), Q(:,196), MB, 1_intkind1, wf8(:,48), n2(25))
  call vert_AV_Q(ntry, ex7, wf4(:,9), wf8(:,49), n3(:,90), t3x8(:,:,25))
  call prop_A_Q(ntry, wf8(:,49), Q(:,104), MB, 1_intkind1, wf8(:,50), n2(26))
  ...
  call prop_Q_A(ntry, wf8(:,51), Q(:,148), MB, 1_intkind1, wf8(:,52), n2(27))
  ...
  call prop_Q_A(ntry, wf8(:,53), Q(:,148), MB, 1_intkind1, wf8(:,54), n2(28))
  ...
  call prop_Q_A(ntry, wf8(:,61), Q(:,76), MB, 1_intkind1, wf8(:,62), n2(32))
  call vert_VQ_A(ntry, wf4(:,11), wf8(:,62), wf32(:,49), n3(:,128), t3x32(:,:,49))
  call vert_VQ_A(ntry, wf4(:,11), ex3, wf8(:,63), n3(:,129), t3x8(:,:,32))
  call prop_Q_A(ntry, wf8(:,63), Q(:,52), MB, 1_intkind1, wf8(:,64), n2(33))
  ...
  call prop_A_Q(ntry, wf8(:,65), Q(:,112), MB, 1_intkind1, wf8(:,66), n2(34))
  call vert_VQ_A(ntry, wf4(:,10), wf8(:,14), wf32(:,53), n3(:,135), t3x32(:,:,53))
  call vert_VQ_A(ntry, wf4(:,10), ex4, wf8(:,67), n3(:,136), t3x8(:,:,34))
  call prop_Q_A(ntry, wf8(:,67), Q(:,140), MB, 1_intkind1, wf8(:,68), n2(35))
  ...
  call prop_Q_A(ntry, wf8(:,69), Q(:,140), MB, 1_intkind1, wf8(:,70), n2(36))
  ...
  call prop_A_Q(ntry, wf8(:,71), Q(:,100), MB, 1_intkind1, wf8(:,72), n2(37))
  call vert_AV_Q(ntry, ex6, wf4(:,6), wf8(:,73), n3(:,155), t3x8(:,:,37))
  call prop_A_Q(ntry, wf8(:,73), Q(:,168), MB, 1_intkind1, wf8(:,74), n2(38))
  ...
  call prop_A_Q(ntry, wf8(:,75), Q(:,35), MB, 1_intkind1, wf8(:,76), n2(39))
  ...
  call prop_A_Q(ntry, wf8(:,77), Q(:,176), MB, 1_intkind1, wf8(:,78), n2(40))
  ...
  call prop_A_Q(ntry, wf8(:,79), Q(:,164), MB, 1_intkind1, wf8(:,80), n2(41))
  call vert_AV_Q(ntry, ex6, wf4(:,3), wf8(:,81), n3(:,177), t3x8(:,:,41))
  call prop_A_Q(ntry, wf8(:,81), Q(:,104), MB, 1_intkind1, wf8(:,82), n2(42))
  ...
  call prop_A_Q(ntry, wf8(:,83), Q(:,112), MB, 1_intkind1, wf8(:,84), n2(43))
  ...
  M2add = M2 / average_factor_ppnnjjj_nenexbbbbxbxbx_1

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_ppnnjjj_nenexbbbbxbxbx_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppnnjjj_nenexbbbbxbxbx_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppnnjjj_nenexbbbbxbxbx_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppnnjjj_nenexbbbbxbxbx_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppnnjjj_nenexbbbbxbxbx_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppnnjjj_nenexbbbbxbxbx_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppnnjjj_nenexbbbbxbxbx_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppnnjjj_nenexbbbbxbxbx_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppnnjjj_nenexbbbbxbxbx_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppnnjjj_nenexbbbbxbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppnnjjj_nenexbbbbxbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppnnjjj_nenexbbbbxbxbx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppnnjjj_nenexbbbbxbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppnnjjj_nenexbbbbxbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppnnjjj_nenexbbbbxbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppnnjjj_nenexbbbbxbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppnnjjj_nenexbbbbxbxbx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_ppnnjjj_nenexbbbbxbxbx_1_/**/REALKIND
