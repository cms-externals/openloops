...
module ol_colourmatrix_pplljj_eexuuxccx_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_eexuuxccx_1_/**/REALKIND



module ol_forced_parameters_pplljj_eexuuxccx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_eexuuxccx_1_/**/REALKIND

module ol_loop_pplljj_eexuuxccx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (2*CI*countertermnorm*ctGcc*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 6) = CI*countertermnorm*ctGcc*eQED**2*gQCD**4
    f( 7) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 8) = CI*countertermnorm*ctGqq*eQED**2*gQCD**4
    f( 9) = (2*CI*countertermnorm*ctVcc*eQED**2*gQCD**4)/3._/**/REALKIND
    f(10) = CI*countertermnorm*ctVcc*eQED**2*gQCD**4
    f(11) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(12) = CI*countertermnorm*ctVqq*eQED**2*gQCD**4
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,8),Q(:,19),ZERO,0_intkind1,wf(:,9))
  ...
  call prop_A_Q(wf(:,11),Q(:,35),ZERO,0_intkind1,wf(:,29))
  call prop_A_Q(wf(:,13),Q(:,35),ZERO,0_intkind1,wf(:,30))
  call counter_VQ_A(wf(:,1),wf(:,-4),wf(:,31))
  call prop_A_Q(wf(:,4),Q(:,44),ZERO,0_intkind1,wf(:,32))
  ...
  call prop_Q_A(wf(:,49),Q(:,28),ZERO,0_intkind1,wf(:,50))
  call counter_V_V(ctGG,wf(:,2),Q(:,12),wf(:,51))
  call vert_VQ_A(wf(:,51),wf(:,-4),wf(:,52))
  call vert_AV_Q(wf(:,-5),wf(:,51),wf(:,53))
  call counter_Q_A(ctcc,wf(:,5),Q(:,19),wf(:,54))
  call counter_Q_A(ctcc,wf(:,9),Q(:,19),wf(:,55))
  call counter_Q_A(ctcc,wf(:,12),Q(:,28),wf(:,56))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(34)+A(36)+A(38)+A(40)+A(42)+A(44)+A(46)+A(48))*f(3))/2._/**/REALKIND+((-A(35)-A(37)-A(39)-A(41)-A(43)-A(45)-A(47) &
       -A(49))*f(4))/2._/**/REALKIND+((-A(10)-A(14)-A(18)-A(20))*f(5))/2._/**/REALKIND+((A(11)+A(15)+A(19) &
       +A(21))*f(6))/2._/**/REALKIND+((-A(22)-A(26)-A(30)-A(32))*f(7))/2._/**/REALKIND+((A(23)+A(27)+A(31) &
       +A(33))*f(8))/2._/**/REALKIND+((-A(12)-A(16))*f(9))/2._/**/REALKIND+((A(13)+A(17))*f(10))/2._/**/REALKIND+((-A(24) &
       -A(28))*f(11))/2._/**/REALKIND+((A(25)+A(29))*f(12))/2._/**/REALKIND-(A(9)*f(13))/2._/**/REALKIND
  M2(2) = ((-A(34)-A(36)-A(38)-A(40)-A(42)-A(44)-A(46)-A(48))*f(3))/6._/**/REALKIND+((A(35)+A(37)+A(39)+A(41)+A(43)+A(45)+A(47) &
       +A(49))*f(4))/6._/**/REALKIND+((A(10)+A(14)+A(18)+A(20))*f(5))/6._/**/REALKIND+((-A(11)-A(15)-A(19) &
       -A(21))*f(6))/6._/**/REALKIND+((A(22)+A(26)+A(30)+A(32))*f(7))/6._/**/REALKIND+((-A(23)-A(27)-A(31) &
       -A(33))*f(8))/6._/**/REALKIND+((A(12)+A(16))*f(9))/6._/**/REALKIND+((-A(13)-A(17))*f(10))/6._/**/REALKIND+((A(24) &
       +A(28))*f(11))/6._/**/REALKIND+((-A(25)-A(29))*f(12))/6._/**/REALKIND+(A(9)*f(13))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplljj_eexuuxccx_1_/**/REALKIND
