...
! **********************************************************************
module ol_tensor_sum_storage_pplljj_nenexddxgg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplljj_nenexddxgg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplljj_nenexddxgg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pplljj_nenexddxgg_1, only: channel_number_pplljj_nenexddxgg_1
  ...
  call channel_on(channel_number_pplljj_nenexddxgg_1)
  M2 = 0
  ...
  call TI_call(3, momenta_18, masses2_6, T3sum(:,8), M2)
  call TI_call(3, momenta_18, masses2_5, T3sum(:,9), M2)
  call TI_call(3, momenta_18, masses2_4, T3sum(:,10), M2)
  call TI_call(3, momenta_61, masses2_9, T3sum(:,11), M2)
  call TI_call(3, momenta_53, masses2_9, T3sum(:,12), M2)
  call TI_call(3, momenta_54, masses2_9, T3sum(:,13), M2)
  call TI_call(3, momenta_62, masses2_9, T3sum(:,14), M2)
  call TI_call(3, momenta_55, masses2_9, T3sum(:,15), M2)
  call TI_call(3, momenta_56, masses2_9, T3sum(:,16), M2)
  call TI_call(3, momenta_51, masses2_9, T3sum(:,17), M2)
  call TI_call(3, momenta_63, masses2_9, T3sum(:,18), M2)
  call TI_call(3, momenta_64, masses2_9, T3sum(:,19), M2)
  call TI_call(3, momenta_52, masses2_9, T3sum(:,20), M2)
  call TI_call(3, momenta_65, masses2_9, T3sum(:,21), M2)
  call TI_call(3, momenta_66, masses2_9, T3sum(:,22), M2)
  call TI_call(3, momenta_41, masses2_9, T3sum(:,23), M2)
  call TI_call(3, momenta_38, masses2_9, T3sum(:,24), M2)
  call TI_call(3, momenta_13, masses2_6, T3sum(:,25), M2)
  call TI_call(3, momenta_13, masses2_5, T3sum(:,26), M2)
  call TI_call(3, momenta_13, masses2_4, T3sum(:,27), M2)
  call TI_call(3, momenta_57, masses2_9, T3sum(:,28), M2)
  call TI_call(3, momenta_46, masses2_9, T3sum(:,29), M2)
  call TI_call(3, momenta_39, masses2_9, T3sum(:,30), M2)
  call TI_call(3, momenta_59, masses2_9, T3sum(:,31), M2)
  call TI_call(3, momenta_40, masses2_9, T3sum(:,32), M2)
  call TI_call(3, momenta_49, masses2_9, T3sum(:,33), M2)
  call TI_call(3, momenta_58, masses2_9, T3sum(:,34), M2)
  call TI_call(3, momenta_47, masses2_9, T3sum(:,35), M2)
  call TI_call(3, momenta_43, masses2_9, T3sum(:,36), M2)
  call TI_call(3, momenta_50, masses2_9, T3sum(:,37), M2)
  call TI_call(3, momenta_42, masses2_9, T3sum(:,38), M2)
  call TI_call(3, momenta_60, masses2_9, T3sum(:,39), M2)

  call TI_call(4, momenta_45, masses2_9, T4sum(:,1), M2)
  call TI_call(4, momenta_45, masses2_8, T4sum(:,2), M2)
  call TI_call(4, momenta_45, masses2_7, T4sum(:,3), M2)
  call TI_call(4, momenta_44, masses2_9, T4sum(:,4), M2)
  call TI_call(4, momenta_44, masses2_8, T4sum(:,5), M2)
  call TI_call(4, momenta_44, masses2_7, T4sum(:,6), M2)
  call TI_call(4, momenta_48, masses2_9, T4sum(:,7), M2)
  call TI_call(4, momenta_48, masses2_8, T4sum(:,8), M2)
  call TI_call(4, momenta_48, masses2_7, T4sum(:,9), M2)
  call TI_call(4, momenta_72, masses2_10, T4sum(:,10), M2)
  call TI_call(4, momenta_69, masses2_10, T4sum(:,11), M2)
  call TI_call(4, momenta_70, masses2_10, T4sum(:,12), M2)
  call TI_call(4, momenta_68, masses2_10, T4sum(:,13), M2)
  call TI_call(4, momenta_71, masses2_10, T4sum(:,14), M2)
  call TI_call(4, momenta_73, masses2_10, T4sum(:,15), M2)
  call TI_call(4, momenta_74, masses2_10, T4sum(:,16), M2)
  call TI_call(4, momenta_77, masses2_10, T4sum(:,17), M2)
  call TI_call(4, momenta_75, masses2_10, T4sum(:,18), M2)
  call TI_call(4, momenta_76, masses2_10, T4sum(:,19), M2)
  call TI_call(4, momenta_78, masses2_10, T4sum(:,20), M2)
  call TI_call(4, momenta_79, masses2_10, T4sum(:,21), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pplljj_nenexddxgg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplljj_nenexddxgg_1_/**/REALKIND
