...
module ol_colourmatrix_pplljj_eexddxgg_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_eexddxgg_1_/**/REALKIND



module ol_forced_parameters_pplljj_eexddxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_eexddxgg_1_/**/REALKIND

module ol_loop_pplljj_eexddxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 9) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(10) = CI*countertermnorm*ctGqq*eQED**2*gQCD**4
    f(11) = (countertermnorm*ctGqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(12) = countertermnorm*ctGqq*eQED**2*gQCD**4
    f(13) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(14) = CI*countertermnorm*ctVqq*eQED**2*gQCD**4
    f(15) = (countertermnorm*ctVqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(16) = countertermnorm*ctVqq*eQED**2*gQCD**4
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,27),Q(:,56),ZERO,0_intkind1,wf(:,76))
  call counter_VQ_A(wf(:,28),wf(:,-2),wf(:,77))
  call prop_A_Q(wf(:,29),Q(:,56),ZERO,0_intkind1,wf(:,78))
  call vert_VQ_A(wf(:,-4),wf(:,73),wf(:,79))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,80))
  call prop_Q_A(wf(:,80),Q(:,20),ZERO,0_intkind1,wf(:,81))
  ...
  call counter_Q_A(ctqq,wf(:,4),Q(:,20),wf(:,86))
  call prop_A_Q(wf(:,85),Q(:,43),ZERO,0_intkind1,wf(:,87))
  call vert_AZ_Q(gZd,wf(:,5),wf(:,8),wf(:,88))
  call prop_A_Q(wf(:,88),Q(:,43),ZERO,0_intkind1,wf(:,89))
  call counter_A_Q(ctqq,wf(:,5),Q(:,40),wf(:,90))
  call prop_Q_A(wf(:,6),Q(:,23),ZERO,0_intkind1,wf(:,91))
  call prop_Q_A(wf(:,9),Q(:,23),ZERO,0_intkind1,wf(:,92))
  call prop_Q_A(wf(:,86),Q(:,20),ZERO,0_intkind1,wf(:,93))
  call vert_VQ_A(wf(:,-5),wf(:,93),wf(:,94))
  call counter_A_Q(ctqq,wf(:,12),Q(:,11),wf(:,95))
  call counter_A_Q(ctqq,wf(:,14),Q(:,11),wf(:,96))
  call vert_AV_Q(wf(:,18),wf(:,1),wf(:,97))
  call counter_Q_A(ctqq,wf(:,17),Q(:,36),wf(:,98))
  call prop_A_Q(wf(:,97),Q(:,27),ZERO,0_intkind1,wf(:,99))
  call vert_AZ_Q(gZd,wf(:,18),wf(:,8),wf(:,100))
  call prop_A_Q(wf(:,100),Q(:,27),ZERO,0_intkind1,wf(:,101))
  call counter_A_Q(ctqq,wf(:,18),Q(:,24),wf(:,102))
  call prop_Q_A(wf(:,19),Q(:,39),ZERO,0_intkind1,wf(:,103))
  call prop_Q_A(wf(:,20),Q(:,39),ZERO,0_intkind1,wf(:,104))
  call counter_Q_A(ctqq,wf(:,23),Q(:,7),wf(:,105))
  call counter_Q_A(ctqq,wf(:,25),Q(:,7),wf(:,106))
  call prop_A_Q(wf(:,102),Q(:,24),ZERO,0_intkind1,wf(:,107))
  call vert_AV_Q(wf(:,107),wf(:,-5),wf(:,108))
  call prop_Q_A(wf(:,98),Q(:,36),ZERO,0_intkind1,wf(:,109))
  call vert_VQ_A(wf(:,-4),wf(:,109),wf(:,110))
  call prop_A_Q(wf(:,90),Q(:,40),ZERO,0_intkind1,wf(:,111))
  call vert_AV_Q(wf(:,111),wf(:,-4),wf(:,112))
  call counter_Q_A(ctqq,wf(:,31),Q(:,52),wf(:,113))
  ...
  call prop_Q_A(wf(:,125),Q(:,39),ZERO,0_intkind1,wf(:,126))
  ...
  call prop_A_Q(wf(:,133),Q(:,43),ZERO,0_intkind1,wf(:,134))
  call vert_AV_Q(wf(:,14),wf(:,-5),wf(:,135))
  call prop_A_Q(wf(:,135),Q(:,43),ZERO,0_intkind1,wf(:,136))
...
end module ol_loop_pplljj_eexddxgg_1_/**/REALKIND
