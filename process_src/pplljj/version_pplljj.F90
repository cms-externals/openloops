...
module ol_versiondata_pplljj
  implicit none
  character(4) :: generator_revision = "1500"
  interface
    subroutine version_pplljj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplljj
  end interface
end module ol_versiondata_pplljj


subroutine ol_version_pplljj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplljj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplljj
