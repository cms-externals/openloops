...
module ol_colourmatrix_pplljj_eexuuuxux_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_eexuuuxux_1_/**/REALKIND



module ol_forced_parameters_pplljj_eexuuuxux_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_eexuuuxux_1_/**/REALKIND

module ol_loop_pplljj_eexuuuxux_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 8) = CI*countertermnorm*ctVqq*eQED**2*gQCD**4
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,20),Q(:,28),ZERO,0_intkind1,wf(:,21))
  ...
  call prop_Q_A(wf(:,24),Q(:,44),ZERO,0_intkind1,wf(:,26))
  ...
  call prop_Q_A(wf(:,30),Q(:,44),ZERO,0_intkind1,wf(:,31))
  ...
  call prop_A_Q(wf(:,11),Q(:,35),ZERO,0_intkind1,wf(:,43))
  call prop_A_Q(wf(:,13),Q(:,35),ZERO,0_intkind1,wf(:,44))
  call counter_VQ_A(wf(:,1),wf(:,-3),wf(:,45))
  call prop_A_Q(wf(:,4),Q(:,52),ZERO,0_intkind1,wf(:,46))
  call counter_ZQ_A(gZu,wf(:,7),wf(:,-3),wf(:,47))
  call counter_VQ_A(wf(:,22),wf(:,-3),wf(:,48))
  call prop_A_Q(wf(:,25),Q(:,19),ZERO,0_intkind1,wf(:,49))
  call prop_A_Q(wf(:,27),Q(:,19),ZERO,0_intkind1,wf(:,50))
  call prop_A_Q(wf(:,23),Q(:,52),ZERO,0_intkind1,wf(:,51))
  ...
  call counter_Q_A(ctqq,wf(:,5),Q(:,11),wf(:,77))
  call counter_Q_A(ctqq,wf(:,9),Q(:,11),wf(:,78))
  call counter_Q_A(ctqq,wf(:,12),Q(:,28),wf(:,79))
  call counter_V_V(ctGG,wf(:,14),Q(:,24),wf(:,80))
  call vert_VQ_A(wf(:,80),wf(:,-2),wf(:,81))
  call counter_Q_A(ctqq,wf(:,17),Q(:,7),wf(:,82))
  call counter_Q_A(ctqq,wf(:,19),Q(:,7),wf(:,83))
  call counter_Q_A(ctqq,wf(:,21),Q(:,28),wf(:,84))
  ...
  call counter_Q_A(ctqq,wf(:,26),Q(:,44),wf(:,89))
  call counter_V_V(ctGG,wf(:,28),Q(:,40),wf(:,90))
  call vert_VQ_A(wf(:,90),wf(:,-2),wf(:,91))
  call counter_Q_A(ctqq,wf(:,31),Q(:,44),wf(:,92))
...
end module ol_loop_pplljj_eexuuuxux_1_/**/REALKIND
