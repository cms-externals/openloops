...
module ol_colourmatrix_pplljj_nenexuuxccx_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_nenexuuxccx_1_/**/REALKIND



module ol_forced_parameters_pplljj_nenexuuxccx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_nenexuuxccx_1_/**/REALKIND

module ol_loop_pplljj_nenexuuxccx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,6),Q(:,19),wf(:,41))
  call counter_Q_A(ctcc,wf(:,9),Q(:,28),wf(:,42))
...
end module ol_loop_pplljj_nenexuuxccx_1_/**/REALKIND
