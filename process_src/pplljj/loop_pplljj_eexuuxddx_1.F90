...
module ol_colourmatrix_pplljj_eexuuxddx_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_eexuuxddx_1_/**/REALKIND



module ol_forced_parameters_pplljj_eexuuxddx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_eexuuxddx_1_/**/REALKIND

module ol_loop_pplljj_eexuuxddx_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(26), c(47)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(14) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(15) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(16) = CI*eQED**2*gQCD**4*integralnorm*SwB
    f(17) = (eQED**2*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(18) = (eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(19) = (eQED**2*gQCD**4*integralnorm*SwB)/2._/**/REALKIND
    f(20) = (2*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(21) = eQED**2*gQCD**4*integralnorm*SwB
    f(22) = (eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(23) = (2*eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(24) = eQED**2*gQCD**4*integralnorm*SwF
    f(25) = (4*eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(26) = 2*eQED**2*gQCD**4*integralnorm*SwF

  c = [ 9*CI*f(14), 27*CI*f(14), 9*CI*f(15), 27*CI*f(15), 9*CI*f(16), 27*CI*f(16), 18*f(17), 54*f(17), f(18), 3*f(18), 6*f(18) &
    , 8*f(18), 10*f(18), 18*f(18), 21*f(18), 24*f(18), 54*f(18), 18*f(19), 54*f(19), f(20), 3*f(20), 6*f(20), 8*f(20), 10*f(20) &
    , 18*f(20), 21*f(20), 24*f(20), 54*f(20), f(21), 3*f(21), 6*f(21), 8*f(21), 10*f(21), 18*f(21), 21*f(21), 24*f(21), 54*f(21) &
    , 3*f(22), 9*f(22), 3*f(23), 9*f(23), 3*f(24), 9*f(24), 3*f(25), 9*f(25), 3*f(26), 9*f(26) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call counter_Q_A(ctqq,wf(:,5),Q(:,19),wf(:,54))
  call counter_Q_A(ctqq,wf(:,9),Q(:,19),wf(:,55))
  call counter_Q_A(ctqq,wf(:,12),Q(:,28),wf(:,56))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(34)-A(36)-A(38)-A(40))*f(4))/2._/**/REALKIND+((A(42)+A(44)+A(46)+A(48))*f(5))/2._/**/REALKIND+((-A(35)-A(37)-A(39) &
       -A(41)-A(43)-A(45)-A(47)-A(49))*f(6))/2._/**/REALKIND+((A(10)+A(14)+A(30)+A(32))*f(7))/2._/**/REALKIND+((-A(18)-A(20)-A(22) &
       -A(26))*f(8))/2._/**/REALKIND+((A(11)+A(15)+A(19)+A(21)+A(23)+A(27)+A(31)+A(33))*f(9))/2._/**/REALKIND+((A(12) &
       +A(16))*f(10))/2._/**/REALKIND+((-A(24)-A(28))*f(11))/2._/**/REALKIND+((A(13)+A(17)+A(25)+A(29))*f(12))/2._/**/REALKIND &
       -(A(9)*f(13))/2._/**/REALKIND
  M2(2) = ((A(34)+A(36)+A(38)+A(40))*f(4))/6._/**/REALKIND+((-A(42)-A(44)-A(46)-A(48))*f(5))/6._/**/REALKIND+((A(35)+A(37)+A(39) &
       +A(41)+A(43)+A(45)+A(47)+A(49))*f(6))/6._/**/REALKIND+((-A(10)-A(14)-A(30)-A(32))*f(7))/6._/**/REALKIND+((A(18)+A(20)+A(22) &
       +A(26))*f(8))/6._/**/REALKIND+((-A(11)-A(15)-A(19)-A(21)-A(23)-A(27)-A(31)-A(33))*f(9))/6._/**/REALKIND+((-A(12) &
       -A(16))*f(10))/6._/**/REALKIND+((A(24)+A(28))*f(11))/6._/**/REALKIND+((-A(13)-A(17)-A(25)-A(29))*f(12))/6._/**/REALKIND &
       +(A(9)*f(13))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplljj_eexuuxddx_1_/**/REALKIND
