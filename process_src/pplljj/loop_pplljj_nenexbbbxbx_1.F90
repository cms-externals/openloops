...
module ol_colourmatrix_pplljj_nenexbbbxbx_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_nenexbbbxbx_1_/**/REALKIND



module ol_forced_parameters_pplljj_nenexbbbxbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_nenexbbbxbx_1_/**/REALKIND

module ol_loop_pplljj_nenexbbbxbx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,14),Q(:,28),MB,1_intkind1,wf(:,15))
  ...
  call counter_Q_A(ctbb,wf(:,6),Q(:,11),wf(:,64))
  call counter_Q_A(ctbb,wf(:,9),Q(:,28),wf(:,65))
  call counter_V_V(ctGG,wf(:,10),Q(:,24),wf(:,66))
  call vert_VQ_A(wf(:,66),wf(:,-2),wf(:,67))
  call counter_Q_A(ctbb,wf(:,13),Q(:,7),wf(:,68))
  call counter_Q_A(ctbb,wf(:,15),Q(:,28),wf(:,69))
  ...
  call counter_Q_A(ctbb,wf(:,20),Q(:,44),wf(:,74))
  call counter_V_V(ctGG,wf(:,21),Q(:,40),wf(:,75))
  call vert_VQ_A(wf(:,75),wf(:,-2),wf(:,76))
  call counter_Q_A(ctbb,wf(:,24),Q(:,44),wf(:,77))
...
end module ol_loop_pplljj_nenexbbbxbx_1_/**/REALKIND
