...
module ol_colourmatrix_pplljj_nenexuuuxux_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_nenexuuuxux_1_/**/REALKIND



module ol_forced_parameters_pplljj_nenexuuuxux_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_nenexuuuxux_1_/**/REALKIND

module ol_loop_pplljj_nenexuuuxux_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZu,wf(:,3),wf(:,-3),wf(:,4))
  ...
  call vert_AZ_Q(gZu,wf(:,-4),wf(:,3),wf(:,19))
  ...
  call counter_ZQ_A(gZu,wf(:,3),wf(:,-2),wf(:,49))
...
end module ol_loop_pplljj_nenexuuuxux_1_/**/REALKIND
