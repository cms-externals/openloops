...
module ol_colourmatrix_pplljj_eexddxbbx_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_eexddxbbx_1_/**/REALKIND



module ol_forced_parameters_pplljj_eexddxbbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_eexddxbbx_1_/**/REALKIND

module ol_loop_pplljj_eexddxbbx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(10) = CI*countertermnorm*ctVbb*eQED**2*gQCD**4
    f(11) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/3._/**/REALKIND
    ...
    f(16) = (eQED**2*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(17) = (eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(18) = (eQED**2*gQCD**4*integralnorm*SwB)/2._/**/REALKIND
  ...
  c = [ 9*CI*f(14), 27*CI*f(14), 9*CI*f(15), 27*CI*f(15), 18*f(16), 54*f(16), f(17), 3*f(17), 6*f(17), 8*f(17), 10*f(17), 18*f(17) &
    , 21*f(17), 24*f(17), 54*f(17), 18*f(18), 54*f(18), f(19), 3*f(19), 6*f(19), 8*f(19), 10*f(19), 18*f(19), 21*f(19), 24*f(19) &
...
! **********************************************************************
  ...
  call vert_AZ_Q(gZd,wf(:,-3),wf(:,7),wf(:,23))
  ...
  call counter_AZ_Q(gZd,wf(:,-3),wf(:,7),wf(:,40))
  ...
  call counter_ZQ_A(gZd,wf(:,7),wf(:,-2),wf(:,46))
...
end module ol_loop_pplljj_eexddxbbx_1_/**/REALKIND
