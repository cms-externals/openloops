...
module ol_vamp_1_pplljj_eexbbxgg_1_/**/REALKIND
contains
...
! **********************************************************************
  ...
  call loop_A_Q(G0(:,:,:,3),Q(:,56),MB,G1(:,:,:,1))
  ...
  call loop_A_Q(G0(:,:,:,7),Q(:,56),MB,G1(:,:,:,6))
  ...
  call loop_A_Q(G0(:,:,:,11),Q(:,56),MB,G1(:,:,:,11))
  ...
  call loop_A_Q(G2(:,:,:,178),Q(:,59),MB,G3(:,:,:,63))
  call check_last_AQ_V(l_switch,G3(:,:,:,63),wf(:,-2),G3tensor(:,97))
  call loop_AZ_Q(G2(:,:,:,177),wf(:,8),G2(:,:,:,179),gZd)
  call loop_A_Q(G2(:,:,:,179),Q(:,59),MB,G3(:,:,:,64))
  ...
  call loop_Q_A(G0(:,:,:,33),Q(:,20),MB,G1(:,:,:,92))
  call loop_QV_A(G1(:,:,:,92),wf(:,-5),G1(:,:,:,93))
  call loop_Q_A(G1(:,:,:,93),Q(:,52),MB,G2(:,:,:,180))
  ...
  call loop_Q_A(G2(:,:,:,181),Q(:,55),MB,G3(:,:,:,65))
  call check_last_QA_V(l_switch,G3(:,:,:,65),wf(:,-3),G3tensor(:,99))
  call loop_QZ_A(G2(:,:,:,180),wf(:,8),G2(:,:,:,182),gZd)
  call loop_Q_A(G2(:,:,:,182),Q(:,55),MB,G3(:,:,:,66))
  call check_last_QA_V(l_switch,G3(:,:,:,66),wf(:,-3),G3tensor(:,100))
  call loop_QV_A(G1(:,:,:,92),wf(:,1),G1(:,:,:,94))
  call loop_Q_A(G1(:,:,:,94),Q(:,23),MB,G2(:,:,:,183))
  call loop_QV_A(G2(:,:,:,183),wf(:,-5),G2(:,:,:,184))
  call loop_Q_A(G2(:,:,:,184),Q(:,55),MB,G3(:,:,:,67))
  call check_last_QA_V(l_switch,G3(:,:,:,67),wf(:,-3),G3tensor(:,101))
  call loop_QZ_A(G1(:,:,:,92),wf(:,8),G1(:,:,:,95),gZd)
  call loop_Q_A(G1(:,:,:,95),Q(:,23),MB,G2(:,:,:,185))
  call loop_QV_A(G2(:,:,:,185),wf(:,-5),G2(:,:,:,186))
  call loop_Q_A(G2(:,:,:,186),Q(:,55),MB,G3(:,:,:,68))
  ...
  call loop_Q_A(G1(:,:,:,97),Q(:,52),MB,G2(:,:,:,187))
  ...
  call loop_A_Q(G2(:,:,:,204),Q(:,56),MB,G3(:,:,:,80))
  ...
  call loop_Q_A(G0(:,:,:,40),Q(:,52),MB,G1(:,:,:,122))
  call loop_QV_A(G1(:,:,:,122),wf(:,1),G1(:,:,:,123))
  call loop_Q_A(G1(:,:,:,123),Q(:,55),MB,G2(:,:,:,233))
  call check_last_QA_V(l_switch,G2(:,:,:,233),wf(:,-3),G2tensor(:,25))
  call loop_QZ_A(G1(:,:,:,122),wf(:,8),G1(:,:,:,124),gZd)
  call loop_Q_A(G1(:,:,:,124),Q(:,55),MB,G2(:,:,:,234))
  ...
  call loop_Q_A(G2(:,:,:,242),Q(:,55),MB,G3(:,:,:,89))
  call check_last_QA_V(l_switch,G3(:,:,:,89),wf(:,-3),G3tensor(:,131))
  call loop_QZ_A(G2(:,:,:,241),wf(:,8),G2(:,:,:,243),gZd)
  call loop_Q_A(G2(:,:,:,243),Q(:,55),MB,G3(:,:,:,90))
  ...
  call loop_A_Q(G0(:,:,:,44),Q(:,24),MB,G1(:,:,:,133))
  call loop_AV_Q(G1(:,:,:,133),wf(:,-5),G1(:,:,:,134))
  call loop_A_Q(G1(:,:,:,134),Q(:,56),MB,G2(:,:,:,244))
  ...
  call loop_AZ_Q(G2(:,:,:,244),wf(:,8),G2(:,:,:,246),gZd)
  call loop_A_Q(G2(:,:,:,246),Q(:,59),MB,G3(:,:,:,92))
  call check_last_AQ_V(l_switch,G3(:,:,:,92),wf(:,-2),G3tensor(:,134))
  call loop_AV_Q(G1(:,:,:,133),wf(:,1),G1(:,:,:,135))
  call loop_A_Q(G1(:,:,:,135),Q(:,27),MB,G2(:,:,:,247))
  call loop_AV_Q(G2(:,:,:,247),wf(:,-5),G2(:,:,:,248))
  call loop_A_Q(G2(:,:,:,248),Q(:,59),MB,G3(:,:,:,93))
  call check_last_AQ_V(l_switch,G3(:,:,:,93),wf(:,-2),G3tensor(:,135))
  call loop_AZ_Q(G1(:,:,:,133),wf(:,8),G1(:,:,:,136),gZd)
  call loop_A_Q(G1(:,:,:,136),Q(:,27),MB,G2(:,:,:,249))
  call loop_AV_Q(G2(:,:,:,249),wf(:,-5),G2(:,:,:,250))
  call loop_A_Q(G2(:,:,:,250),Q(:,59),MB,G3(:,:,:,94))
  ...
  call loop_A_Q(G0(:,:,:,51),Q(:,56),MB,G1(:,:,:,149))
  call loop_AV_Q(G1(:,:,:,149),wf(:,1),G1(:,:,:,150))
  call loop_A_Q(G1(:,:,:,150),Q(:,59),MB,G2(:,:,:,271))
  call check_last_AQ_V(l_switch,G2(:,:,:,271),wf(:,-2),G2tensor(:,35))
  call loop_AZ_Q(G1(:,:,:,149),wf(:,8),G1(:,:,:,151),gZd)
  call loop_A_Q(G1(:,:,:,151),Q(:,59),MB,G2(:,:,:,272))
  ...
  call loop_Q_A(G1(:,:,:,157),Q(:,52),MB,G2(:,:,:,275))
  ...
  call loop_A_Q(G2(:,:,:,286),Q(:,56),MB,G3(:,:,:,99))
  ...
  call loop_A_Q(G3(:,:,:,100),Q(:,59),MB,G4(:,:,:,7))
  call check_last_AQ_V(l_switch,G4(:,:,:,7),wf(:,-2),G4tensor(:,49))
  call loop_AZ_Q(G3(:,:,:,99),wf(:,8),G3(:,:,:,101),gZd)
  call loop_A_Q(G3(:,:,:,101),Q(:,59),MB,G4(:,:,:,8))
  ...
  call loop_Q_A(G0(:,:,:,55),Q(:,39),MB,G1(:,:,:,173))
  call loop_QV_A(G1(:,:,:,173),wf(:,-4),G1(:,:,:,174))
  call loop_Q_A(G1(:,:,:,174),Q(:,55),MB,G2(:,:,:,303))
  ...
  call loop_Q_A(G0(:,:,:,56),Q(:,39),MB,G1(:,:,:,175))
  call loop_QV_A(G1(:,:,:,175),wf(:,-4),G1(:,:,:,176))
  call loop_Q_A(G1(:,:,:,176),Q(:,55),MB,G2(:,:,:,304))
  ...
  call loop_A_Q(G1(:,:,:,178),Q(:,59),MB,G2(:,:,:,305))
  call check_last_AQ_V(l_switch,G2(:,:,:,305),wf(:,-2),G2tensor(:,55))
  call loop_AZ_Q(G1(:,:,:,177),wf(:,8),G1(:,:,:,179),gZd)
  call loop_A_Q(G1(:,:,:,179),Q(:,59),MB,G2(:,:,:,306))
  ...
  call loop_A_Q(G0(:,:,:,58),Q(:,43),MB,G1(:,:,:,180))
  call loop_AV_Q(G1(:,:,:,180),wf(:,-4),G1(:,:,:,181))
  call loop_A_Q(G1(:,:,:,181),Q(:,59),MB,G2(:,:,:,307))
  ...
  call loop_A_Q(G0(:,:,:,59),Q(:,43),MB,G1(:,:,:,182))
  call loop_AV_Q(G1(:,:,:,182),wf(:,-4),G1(:,:,:,183))
  call loop_A_Q(G1(:,:,:,183),Q(:,59),MB,G2(:,:,:,308))
  ...
  call loop_A_Q(G0(:,:,:,60),Q(:,8),MB,G1(:,:,:,184))
  call loop_AV_Q(G1(:,:,:,184),wf(:,28),G1(:,:,:,185))
  call loop_A_Q(G1(:,:,:,185),Q(:,56),MB,G2(:,:,:,309))
  ...
  call loop_A_Q(G3(:,:,:,133),Q(:,59),MB,G4(:,:,:,21))
  call check_last_AQ_V(l_switch,G4(:,:,:,21),wf(:,-2),G4tensor(:,63))
  call loop_AZ_Q(G3(:,:,:,132),wf(:,8),G3(:,:,:,134),gZd)
  call loop_A_Q(G3(:,:,:,134),Q(:,59),MB,G4(:,:,:,22))
  call check_last_AQ_V(l_switch,G4(:,:,:,22),wf(:,-2),G4tensor(:,64))
  call loop_AV_Q(G2(:,:,:,324),wf(:,1),G2(:,:,:,326))
  call loop_A_Q(G2(:,:,:,326),Q(:,43),MB,G3(:,:,:,135))
  call loop_AV_Q(G3(:,:,:,135),wf(:,-4),G3(:,:,:,136))
  call loop_A_Q(G3(:,:,:,136),Q(:,59),MB,G4(:,:,:,23))
  call check_last_AQ_V(l_switch,G4(:,:,:,23),wf(:,-2),G4tensor(:,65))
  call loop_AZ_Q(G2(:,:,:,324),wf(:,8),G2(:,:,:,327),gZd)
  call loop_A_Q(G2(:,:,:,327),Q(:,43),MB,G3(:,:,:,137))
  call loop_AV_Q(G3(:,:,:,137),wf(:,-4),G3(:,:,:,138))
  call loop_A_Q(G3(:,:,:,138),Q(:,59),MB,G4(:,:,:,24))
  ...
  call loop_A_Q(G1(:,:,:,191),Q(:,56),MB,G2(:,:,:,328))
  ...
  call loop_QZ_A(G1(:,:,:,202),wf(:,8),G1(:,:,:,204),gZd)
  call loop_Q_A(G1(:,:,:,204),Q(:,55),MB,G2(:,:,:,344))
  ...
  call loop_A_Q(G0(:,:,:,64),Q(:,56),MB,G1(:,:,:,205))
  call loop_AV_Q(G1(:,:,:,205),wf(:,1),G1(:,:,:,206))
  call loop_A_Q(G1(:,:,:,206),Q(:,59),MB,G2(:,:,:,345))
  call check_last_AQ_V(l_switch,G2(:,:,:,345),wf(:,-2),G2tensor(:,73))
  call loop_AZ_Q(G1(:,:,:,205),wf(:,8),G1(:,:,:,207),gZd)
  call loop_A_Q(G1(:,:,:,207),Q(:,59),MB,G2(:,:,:,346))
  ...
  call loop_Q_A(G0(:,:,:,68),Q(:,39),MB,G1(:,:,:,216))
  call loop_QV_A(G1(:,:,:,216),wf(:,-4),G1(:,:,:,217))
  call loop_Q_A(G1(:,:,:,217),Q(:,55),MB,G2(:,:,:,352))
  ...
  call loop_A_Q(G0(:,:,:,72),Q(:,43),MB,G1(:,:,:,224))
  call loop_AV_Q(G1(:,:,:,224),wf(:,-4),G1(:,:,:,225))
  call loop_A_Q(G1(:,:,:,225),Q(:,59),MB,G2(:,:,:,356))
  ...
  Gcoeff = (c(26)*(-M(1)+M(2))) * den(140)
  T3sum(1:35,5) = T3sum(1:35,5) + Gcoeff * G3tensor(:,15)
  Gcoeff = (c(24)*(-M(1)+M(2))) * den(140)
  ...
  Gcoeff = (c(26)*(M(1)-M(2))) * den(141)
  T3sum(1:35,8) = T3sum(1:35,8) + Gcoeff * G3tensor(:,29)
  Gcoeff = (c(24)*(M(1)-M(2))) * den(141)
  ...
  Gcoeff = (c(35)*M(2)) * den(144)
  T3sum(1:35,5) = T3sum(1:35,5) + Gcoeff * G3tensor(:,115)
  Gcoeff = (c(31)*M(2)) * den(144)
  ...
  Gcoeff = (-(c(37)*M(1))) * den(49)
  T3sum(1:35,5) = T3sum(1:35,5) + Gcoeff * G3tensor(:,139)
  Gcoeff = (-(c(33)*M(1))) * den(49)
  ...
  Gcoeff = (c(13)*M(2)) * den(76)
  T3sum(1:35,20) = T3sum(1:35,20) + Gcoeff * G3tensor(:,154)
  Gcoeff = (-(c(15)*M(2))) * den(72)
  T3sum(1:35,21) = T3sum(1:35,21) + Gcoeff * G3tensor(:,95)
  Gcoeff = (-(c(19)*M(2))) * den(76)
  ...
  Gcoeff = (-(c(15)*M(2))+c(16)*M(3)) * den(10)
  T3sum(1:35,36) = T3sum(1:35,36) + Gcoeff * G3tensor(:,177)
  Gcoeff = (-(c(19)*M(2))+c(20)*M(3)) * den(12)
  T3sum(1:35,36) = T3sum(1:35,36) + Gcoeff * G3tensor(:,179)
  Gcoeff = (c(18)*M(2)+c(16)*M(3)) * den(10)
  T3sum(1:35,37) = T3sum(1:35,37) + Gcoeff * G3tensor(:,161)
  Gcoeff = (c(22)*M(2)+c(20)*M(3)) * den(12)
  T3sum(1:35,37) = T3sum(1:35,37) + Gcoeff * G3tensor(:,162)
  Gcoeff = (-(c(15)*M(1))+c(16)*M(3)) * den(10)
  T3sum(1:35,38) = T3sum(1:35,38) + Gcoeff * G3tensor(:,178)
  Gcoeff = (-(c(19)*M(1))+c(20)*M(3)) * den(12)
  T3sum(1:35,38) = T3sum(1:35,38) + Gcoeff * G3tensor(:,180)
  Gcoeff = (c(18)*M(1)+c(16)*M(3)) * den(10)
  T3sum(1:35,39) = T3sum(1:35,39) + Gcoeff * G3tensor(:,111)
  Gcoeff = (c(22)*M(1)+c(20)*M(3)) * den(12)
  T3sum(1:35,39) = T3sum(1:35,39) + Gcoeff * G3tensor(:,112)
  Gcoeff = (-(c(15)*M(2))+c(16)*M(3)) * den(1)
  T4sum(1:70,10) = T4sum(1:70,10) + Gcoeff * G4tensor(:,65)
  Gcoeff = (-(c(19)*M(2))+c(20)*M(3)) * den(6)
  ...
  Gcoeff = (-(c(19)*M(1))+c(20)*M(3)) * den(6)
  T4sum(1:70,12) = T4sum(1:70,12) + Gcoeff * G4tensor(:,62)
  Gcoeff = (-(c(15)*M(1))+c(16)*M(3)) * den(1)
  ...
  Gcoeff = (c(17)*M(1)) * den(109)
  T1sum(1:5,5) = T1sum(1:5,5) + Gcoeff * G1tensor(:,49)
  Gcoeff = (c(21)*M(1)) * den(110)
