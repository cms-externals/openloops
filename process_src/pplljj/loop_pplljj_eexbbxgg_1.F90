...
module ol_colourmatrix_pplljj_eexbbxgg_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_eexbbxgg_1_/**/REALKIND



module ol_forced_parameters_pplljj_eexbbxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_eexbbxgg_1_/**/REALKIND

module ol_loop_pplljj_eexbbxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 4) = eQED**2*gQCD**2
    f( 5) = (CI*countertermnorm*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 6) = CI*countertermnorm*eQED**2*gQCD**4
    f( 7) = (countertermnorm*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 8) = countertermnorm*eQED**2*gQCD**4
    f( 9) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/3._/**/REALKIND
    f(10) = CI*countertermnorm*ctGbb*eQED**2*gQCD**4
    f(11) = (countertermnorm*ctGbb*eQED**2*gQCD**4)/3._/**/REALKIND
    f(12) = countertermnorm*ctGbb*eQED**2*gQCD**4
    f(13) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**4)/3._/**/REALKIND
    f(14) = CI*countertermnorm*ctVbb*eQED**2*gQCD**4
    f(15) = (countertermnorm*ctVbb*eQED**2*gQCD**4)/3._/**/REALKIND
    f(16) = countertermnorm*ctVbb*eQED**2*gQCD**4
    f(17) = (countertermnorm*ctVVV*eQED**2*gQCD**4)/3._/**/REALKIND
    ...
    f(21) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(22) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(23) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/2._/**/REALKIND
    f(24) = CI*eQED**2*gQCD**4*integralnorm*SwB
    f(25) = (eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
  ...
  c = [ 9*CI*f(21), 18*CI*f(21), CI*f(22), 3*CI*f(22), 8*CI*f(22), 9*CI*f(22), 18*CI*f(22), 9*CI*f(23), 18*CI*f(23), CI*f(24) &
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,30),Q(:,52),MB,1_intkind1,wf(:,31))
  ...
  call prop_Q_A(wf(:,56),Q(:,52),MB,1_intkind1,wf(:,57))
  call counter_AV_Q(wf(:,-3),wf(:,1),wf(:,58))
  call prop_Q_A(wf(:,11),Q(:,52),MB,1_intkind1,wf(:,59))
  call counter_AZ_Q(gZd,wf(:,-3),wf(:,8),wf(:,60))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,61))
  call prop_A_Q(wf(:,61),Q(:,40),MB,1_intkind1,wf(:,62))
  call prop_Q_A(wf(:,26),Q(:,52),MB,1_intkind1,wf(:,63))
  call counter_AV_Q(wf(:,-3),wf(:,28),wf(:,64))
  call vert_AV_Q(wf(:,62),wf(:,-4),wf(:,65))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,66))
  call prop_A_Q(wf(:,66),Q(:,24),MB,1_intkind1,wf(:,67))
  call vert_AV_Q(wf(:,67),wf(:,-5),wf(:,68))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,69))
  call prop_A_Q(wf(:,22),Q(:,56),MB,1_intkind1,wf(:,70))
  call counter_ZQ_A(gZd,wf(:,8),wf(:,-2),wf(:,71))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,72))
  call prop_Q_A(wf(:,72),Q(:,36),MB,1_intkind1,wf(:,73))
  call vert_VQ_A(wf(:,1),wf(:,73),wf(:,74))
  call vert_ZQ_A(gZd,wf(:,8),wf(:,73),wf(:,75))
  call prop_A_Q(wf(:,27),Q(:,56),MB,1_intkind1,wf(:,76))
  call counter_VQ_A(wf(:,28),wf(:,-2),wf(:,77))
  call prop_A_Q(wf(:,29),Q(:,56),MB,1_intkind1,wf(:,78))
  ...
  call vert_ZQ_A(gZd,wf(:,8),wf(:,81),wf(:,83))
  call vert_VQ_A(wf(:,-5),wf(:,81),wf(:,84))
  call vert_AV_Q(wf(:,5),wf(:,1),wf(:,85))
  call counter_Q_A(ctbb,wf(:,4),Q(:,20),wf(:,86))
  call prop_A_Q(wf(:,85),Q(:,43),MB,1_intkind1,wf(:,87))
  call vert_AZ_Q(gZd,wf(:,5),wf(:,8),wf(:,88))
  call prop_A_Q(wf(:,88),Q(:,43),MB,1_intkind1,wf(:,89))
  call counter_A_Q(ctbb,wf(:,5),Q(:,40),wf(:,90))
  call prop_Q_A(wf(:,6),Q(:,23),MB,1_intkind1,wf(:,91))
  call prop_Q_A(wf(:,9),Q(:,23),MB,1_intkind1,wf(:,92))
  call prop_Q_A(wf(:,86),Q(:,20),MB,1_intkind1,wf(:,93))
  call vert_VQ_A(wf(:,-5),wf(:,93),wf(:,94))
  call counter_A_Q(ctbb,wf(:,12),Q(:,11),wf(:,95))
  call counter_A_Q(ctbb,wf(:,14),Q(:,11),wf(:,96))
  call vert_AV_Q(wf(:,18),wf(:,1),wf(:,97))
  call counter_Q_A(ctbb,wf(:,17),Q(:,36),wf(:,98))
  call prop_A_Q(wf(:,97),Q(:,27),MB,1_intkind1,wf(:,99))
  call vert_AZ_Q(gZd,wf(:,18),wf(:,8),wf(:,100))
  call prop_A_Q(wf(:,100),Q(:,27),MB,1_intkind1,wf(:,101))
  call counter_A_Q(ctbb,wf(:,18),Q(:,24),wf(:,102))
  call prop_Q_A(wf(:,19),Q(:,39),MB,1_intkind1,wf(:,103))
  call prop_Q_A(wf(:,20),Q(:,39),MB,1_intkind1,wf(:,104))
  call counter_Q_A(ctbb,wf(:,23),Q(:,7),wf(:,105))
  call counter_Q_A(ctbb,wf(:,25),Q(:,7),wf(:,106))
  call prop_A_Q(wf(:,102),Q(:,24),MB,1_intkind1,wf(:,107))
  call vert_AV_Q(wf(:,107),wf(:,-5),wf(:,108))
  call prop_Q_A(wf(:,98),Q(:,36),MB,1_intkind1,wf(:,109))
  call vert_VQ_A(wf(:,-4),wf(:,109),wf(:,110))
  call prop_A_Q(wf(:,90),Q(:,40),MB,1_intkind1,wf(:,111))
  call vert_AV_Q(wf(:,111),wf(:,-4),wf(:,112))
  call counter_Q_A(ctbb,wf(:,31),Q(:,52),wf(:,113))
  ...
  call prop_Q_A(wf(:,119),Q(:,23),MB,1_intkind1,wf(:,120))
  call vert_VQ_A(wf(:,-4),wf(:,25),wf(:,121))
  call prop_Q_A(wf(:,121),Q(:,23),MB,1_intkind1,wf(:,122))
  call vert_VQ_A(wf(:,-5),wf(:,23),wf(:,123))
  call prop_Q_A(wf(:,123),Q(:,39),MB,1_intkind1,wf(:,124))
  call vert_VQ_A(wf(:,-5),wf(:,25),wf(:,125))
  call prop_Q_A(wf(:,125),Q(:,39),MB,1_intkind1,wf(:,126))
  call vert_QA_V(wf(:,-2),wf(:,12),wf(:,127))
  call vert_QA_V(wf(:,-2),wf(:,14),wf(:,128))
  call vert_AV_Q(wf(:,12),wf(:,-4),wf(:,129))
  call prop_A_Q(wf(:,129),Q(:,27),MB,1_intkind1,wf(:,130))
  call vert_AV_Q(wf(:,14),wf(:,-4),wf(:,131))
  call prop_A_Q(wf(:,131),Q(:,27),MB,1_intkind1,wf(:,132))
  call vert_AV_Q(wf(:,12),wf(:,-5),wf(:,133))
  call prop_A_Q(wf(:,133),Q(:,43),MB,1_intkind1,wf(:,134))
  call vert_AV_Q(wf(:,14),wf(:,-5),wf(:,135))
  call prop_A_Q(wf(:,135),Q(:,43),MB,1_intkind1,wf(:,136))
...
end module ol_loop_pplljj_eexbbxgg_1_/**/REALKIND
