...
module ol_vamp_1_pplljj_nenexuuuxux_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplljj_nenexuuuxux_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplljj_nenexuuuxux_1.
! **********************************************************************
...
#endif
  use ol_loop_pplljj_nenexuuuxux_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplljj_nenexuuuxux_1_/**/REALKIND
  ...
  call loop_AZ_Q(G1(:,:,:,34),wf(:,3),G1(:,:,:,35),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,74),wf(:,3),G1(:,:,:,75),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,82),wf(:,3),G2(:,:,:,83),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,81),wf(:,3),G1(:,:,:,82),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,83),wf(:,3),G1(:,:,:,84),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,89),wf(:,3),G1(:,:,:,100),gZu)
...
end module ol_vamp_1_pplljj_nenexuuuxux_1_/**/REALKIND
