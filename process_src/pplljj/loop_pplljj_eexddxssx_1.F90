...
module ol_colourmatrix_pplljj_eexddxssx_1_/**/REALKIND
...
end module ol_colourmatrix_pplljj_eexddxssx_1_/**/REALKIND



module ol_forced_parameters_pplljj_eexddxssx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplljj_eexddxssx_1_/**/REALKIND

module ol_loop_pplljj_eexddxssx_1_/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(34)-A(36)-A(38)-A(40)-A(42)-A(44)-A(46)-A(48))*f(3))/2._/**/REALKIND+((-A(35)-A(37)-A(39)-A(41)-A(43)-A(45)-A(47) &
       -A(49))*f(4))/2._/**/REALKIND+((A(10)+A(14)+A(18)+A(20)+A(22)+A(26)+A(30)+A(32))*f(5))/2._/**/REALKIND+((A(11)+A(15)+A(19) &
       +A(21)+A(23)+A(27)+A(31)+A(33))*f(6))/2._/**/REALKIND+((A(12)+A(16)+A(24)+A(28))*f(7))/2._/**/REALKIND+((A(13)+A(17)+A(25) &
       +A(29))*f(8))/2._/**/REALKIND-(A(9)*f(9))/2._/**/REALKIND
  M2(2) = ((A(34)+A(36)+A(38)+A(40)+A(42)+A(44)+A(46)+A(48))*f(3))/6._/**/REALKIND+((A(35)+A(37)+A(39)+A(41)+A(43)+A(45)+A(47) &
       +A(49))*f(4))/6._/**/REALKIND+((-A(10)-A(14)-A(18)-A(20)-A(22)-A(26)-A(30)-A(32))*f(5))/6._/**/REALKIND+((-A(11)-A(15) &
       -A(19)-A(21)-A(23)-A(27)-A(31)-A(33))*f(6))/6._/**/REALKIND+((-A(12)-A(16)-A(24)-A(28))*f(7))/6._/**/REALKIND+((-A(13) &
       -A(17)-A(25)-A(29))*f(8))/6._/**/REALKIND+(A(9)*f(9))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplljj_eexddxssx_1_/**/REALKIND
