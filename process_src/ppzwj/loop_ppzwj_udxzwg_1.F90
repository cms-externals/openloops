...
module ol_colourmatrix_ppzwj_udxzwg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzwj_udxzwg_1_/**/REALKIND



module ol_forced_parameters_ppzwj_udxzwg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzwj_udxzwg_1_/**/REALKIND

module ol_loop_ppzwj_udxzwg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_ZQ_A(gZd,wf(:,-2),wf(:,11),wf(:,27))
  call counter_VG_G(wf(:,-2),wf(:,-4),Q(:,16),wf(:,28),Q(:,20))
  call vert_QA_V(wf(:,11),wf(:,-1),wf(:,29))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,15),wf(:,30))
  call vert_QA_V(wf(:,0),wf(:,4),wf(:,31))
  call counter_AV_Q(wf(:,-1),wf(:,-4),wf(:,32))
  call prop_A_Q(wf(:,32),Q(:,18),ZERO,0_intkind1,wf(:,33))
  call counter_AW_Q(wf(:,-1),wf(:,-3),wf(:,34))
  call prop_A_Q(wf(:,34),Q(:,10),ZERO,0_intkind1,wf(:,35))
  call counter_QA_W(wf(:,15),wf(:,-1),wf(:,36))
  call vert_QA_W(wf(:,0),wf(:,33),wf(:,37))
  call counter_AZ_Q(gZd,wf(:,-1),wf(:,-2),wf(:,38))
  call prop_A_Q(wf(:,38),Q(:,6),ZERO,0_intkind1,wf(:,39))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,40))
  call prop_Q_A(wf(:,40),Q(:,17),ZERO,0_intkind1,wf(:,41))
  call vert_WQ_A(wf(:,-3),wf(:,41),wf(:,42))
  call counter_WQ_A(wf(:,-3),wf(:,0),wf(:,43))
  call prop_Q_A(wf(:,43),Q(:,9),ZERO,0_intkind1,wf(:,44))
  call vert_VQ_A(wf(:,-4),wf(:,44),wf(:,45))
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,41),wf(:,46))
  call counter_QA_W(wf(:,0),wf(:,7),wf(:,47))
  call vert_QA_W(wf(:,41),wf(:,-1),wf(:,48))
  call vert_ZQ_A(gZd,wf(:,-2),wf(:,44),wf(:,49))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,0),wf(:,50))
  call prop_Q_A(wf(:,50),Q(:,5),ZERO,0_intkind1,wf(:,51))
  call vert_VQ_A(wf(:,-4),wf(:,51),wf(:,52))
  call vert_WQ_A(wf(:,-3),wf(:,51),wf(:,53))
  ...
  call vert_AW_Q(wf(:,7),wf(:,-3),wf(:,59))
  ...
  call vert_AV_Q(wf(:,12),wf(:,-4),wf(:,63))
  call counter_Q_A(ctqq,wf(:,11),Q(:,9),wf(:,64))
  call prop_A_Q(wf(:,63),Q(:,22),ZERO,0_intkind1,wf(:,65))
  call counter_A_Q(ctqq,wf(:,12),Q(:,6),wf(:,66))
  call prop_Q_A(wf(:,13),Q(:,25),ZERO,0_intkind1,wf(:,67))
  call vert_AW_Q(wf(:,12),wf(:,-3),wf(:,68))
  call counter_Q_A(ctqq,wf(:,15),Q(:,17),wf(:,69))
  call prop_A_Q(wf(:,68),Q(:,14),ZERO,0_intkind1,wf(:,70))
  call prop_Q_A(wf(:,16),Q(:,25),ZERO,0_intkind1,wf(:,71))
  call vert_AZ_Q(gZd,wf(:,7),wf(:,-2),wf(:,72))
  call prop_A_Q(wf(:,72),Q(:,22),ZERO,0_intkind1,wf(:,73))
  call prop_Q_A(wf(:,17),Q(:,13),ZERO,0_intkind1,wf(:,74))
  call vert_AZ_Q(gZu,wf(:,4),wf(:,-2),wf(:,75))
  call prop_A_Q(wf(:,75),Q(:,14),ZERO,0_intkind1,wf(:,76))
  call prop_Q_A(wf(:,18),Q(:,21),ZERO,0_intkind1,wf(:,77))
  call vert_AW_Q(wf(:,-1),wf(:,20),wf(:,78))
  call prop_A_Q(wf(:,78),Q(:,14),ZERO,0_intkind1,wf(:,79))
  call vert_WQ_A(wf(:,20),wf(:,0),wf(:,80))
...
end module ol_loop_ppzwj_udxzwg_1_/**/REALKIND
