...
! **********************************************************************
  use ol_external_ppttj_ttxddxg_1, only: channel_number_ppttj_ttxddxg_1
  ...
  call TI_call(2, momenta_25, masses2_9, T2sum(:,1), M2)
  call TI_call(2, momenta_28, masses2_8, T2sum(:,2), M2)
  call TI_call(2, momenta_26, masses2_9, T2sum(:,3), M2)
  call TI_call(2, momenta_12, masses2_9, T2sum(:,4), M2)
  call TI_call(2, momenta_27, masses2_9, T2sum(:,5), M2)
  call TI_call(2, momenta_9, masses2_9, T2sum(:,6), M2)
  call TI_call(2, momenta_10, masses2_9, T2sum(:,7), M2)
  call TI_call(2, momenta_19, masses2_9, T2sum(:,8), M2)
  call TI_call(2, momenta_13, masses2_9, T2sum(:,9), M2)
  call TI_call(2, momenta_20, masses2_9, T2sum(:,10), M2)
  call TI_call(2, momenta_11, masses2_9, T2sum(:,11), M2)
  call TI_call(2, momenta_23, masses2_7, T2sum(:,12), M2)
  call TI_call(2, momenta_15, masses2_8, T2sum(:,13), M2)
  call TI_call(2, momenta_24, masses2_7, T2sum(:,14), M2)
  call TI_call(2, momenta_16, masses2_8, T2sum(:,15), M2)
  call TI_call(2, momenta_17, masses2_7, T2sum(:,16), M2)
  call TI_call(2, momenta_21, masses2_8, T2sum(:,17), M2)
  call TI_call(2, momenta_18, masses2_7, T2sum(:,18), M2)
  call TI_call(2, momenta_22, masses2_8, T2sum(:,19), M2)
  call TI_call(2, momenta_8, masses2_7, T2sum(:,20), M2)
  call TI_call(2, momenta_32, masses2_12, T2sum(:,21), M2)
  call TI_call(2, momenta_38, masses2_12, T2sum(:,22), M2)
  call TI_call(2, momenta_33, masses2_12, T2sum(:,23), M2)
  call TI_call(2, momenta_39, masses2_12, T2sum(:,24), M2)
  call TI_call(2, momenta_41, masses2_12, T2sum(:,25), M2)
  call TI_call(2, momenta_47, masses2_12, T2sum(:,26), M2)
  call TI_call(2, momenta_35, masses2_12, T2sum(:,27), M2)
  call TI_call(2, momenta_48, masses2_12, T2sum(:,28), M2)
  call TI_call(2, momenta_7, masses2_4, T2sum(:,29), M2)
  call TI_call(2, momenta_4, masses2_4, T2sum(:,30), M2)
  call TI_call(2, momenta_4, masses2_2, T2sum(:,31), M2)
  call TI_call(2, momenta_4, masses2_1, T2sum(:,32), M2)
  call TI_call(2, momenta_7, masses2_2, T2sum(:,33), M2)
  call TI_call(2, momenta_7, masses2_1, T2sum(:,34), M2)

  call TI_call(3, momenta_14, masses2_9, T3sum(:,1), M2)
  call TI_call(3, momenta_14, masses2_6, T3sum(:,2), M2)
  call TI_call(3, momenta_14, masses2_5, T3sum(:,3), M2)
  call TI_call(3, momenta_36, masses2_13, T3sum(:,4), M2)
  call TI_call(3, momenta_37, masses2_13, T3sum(:,5), M2)
  call TI_call(3, momenta_40, masses2_13, T3sum(:,6), M2)
  call TI_call(3, momenta_31, masses2_13, T3sum(:,7), M2)
  call TI_call(3, momenta_34, masses2_13, T3sum(:,8), M2)
  call TI_call(3, momenta_45, masses2_13, T3sum(:,9), M2)
  call TI_call(3, momenta_29, masses2_10, T3sum(:,10), M2)
  call TI_call(3, momenta_46, masses2_12, T3sum(:,11), M2)
  call TI_call(3, momenta_30, masses2_10, T3sum(:,12), M2)
  call TI_call(3, momenta_43, masses2_12, T3sum(:,13), M2)
  call TI_call(3, momenta_42, masses2_11, T3sum(:,14), M2)
  call TI_call(3, momenta_44, masses2_11, T3sum(:,15), M2)
  call TI_call(3, momenta_51, masses2_15, T3sum(:,16), M2)
  call TI_call(3, momenta_50, masses2_15, T3sum(:,17), M2)
  call TI_call(3, momenta_54, masses2_15, T3sum(:,18), M2)
  call TI_call(3, momenta_53, masses2_15, T3sum(:,19), M2)
  call TI_call(3, momenta_56, masses2_15, T3sum(:,20), M2)
  call TI_call(3, momenta_55, masses2_15, T3sum(:,21), M2)
  call TI_call(3, momenta_49, masses2_14, T3sum(:,22), M2)
  ...
  call channel_off(channel_number_ppttj_ttxddxg_1)
