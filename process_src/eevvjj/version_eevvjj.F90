...
module ol_versiondata_eevvjj
  implicit none
  character(4) :: generator_revision = "1497"
  interface
    subroutine version_eevvjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_eevvjj
  end interface
end module ol_versiondata_eevvjj


subroutine ol_version_eevvjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_eevvjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_eevvjj
