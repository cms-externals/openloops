...
module ol_colourmatrix_eevvjj_eexuuxwwx_1_/**/REALKIND
...
end module ol_colourmatrix_eevvjj_eexuuxwwx_1_/**/REALKIND



module ol_forced_parameters_eevvjj_eexuuxwwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eevvjj_eexuuxwwx_1_/**/REALKIND

module ol_loop_eevvjj_eexuuxwwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 6) = (4*CI*countertermnorm*ctVqq*eQED**4*gQCD**2)/9._/**/REALKIND
    f( 7) = (2*CI*countertermnorm*ctVqq*eQED**4*gQCD**2)/3._/**/REALKIND
    ...
    f(28) = (2*CI*cw*eQED**4)/(3._/**/REALKIND*sw)
    f(29) = (CI*cw*eQED**4)/sw
    f(30) = (2*CI*countertermnorm*cw*eQED**4*gQCD**2)/(3._/**/REALKIND*sw)
    f(31) = (CI*countertermnorm*cw*eQED**4*gQCD**2)/sw
    f(32) = (2*CI*countertermnorm*ctVqq*cw*eQED**4*gQCD**2)/(3._/**/REALKIND*sw)
    f(33) = (CI*countertermnorm*ctVqq*cw*eQED**4*gQCD**2)/sw
    f(34) = (4*eQED**4*gQCD**2*integralnorm*SwB)/9._/**/REALKIND
    f(35) = (2*eQED**4*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
    ...
    f(44) = (2*cw*eQED**4*gQCD**2*integralnorm*SwB)/(sw*3._/**/REALKIND)
...
! **********************************************************************
  ...
  call vert_QA_Z(gZu,wf(:,-2),wf(:,-3),wf(:,4))
  ...
  call vert_AW_Q(wf(:,-3),wf(:,-5),wf(:,24))
  call prop_Q_A(wf(:,23),Q(:,20),ZERO,0_intkind1,wf(:,25))
  call prop_A_Q(wf(:,24),Q(:,40),ZERO,0_intkind1,wf(:,26))
  call vert_VQ_A(wf(:,1),wf(:,25),wf(:,27))
  call vert_ZQ_A(gZd,wf(:,7),wf(:,25),wf(:,28))
  call vert_AV_Q(wf(:,-3),wf(:,1),wf(:,29))
  call vert_WQ_A(wf(:,-5),wf(:,25),wf(:,30))
  call prop_A_Q(wf(:,29),Q(:,11),ZERO,0_intkind1,wf(:,31))
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,7),wf(:,32))
  call prop_A_Q(wf(:,32),Q(:,11),ZERO,0_intkind1,wf(:,33))
  call vert_QA_W(wf(:,25),wf(:,-3),wf(:,34))
  call prop_W_W(wf(:,34),Q(:,28),MW,1_intkind1,wf(:,35))
  call vert_VQ_A(wf(:,1),wf(:,-2),wf(:,36))
  call vert_AW_Q(wf(:,26),wf(:,-4),wf(:,37))
  call prop_Q_A(wf(:,36),Q(:,7),ZERO,0_intkind1,wf(:,38))
  call vert_ZQ_A(gZu,wf(:,7),wf(:,-2),wf(:,39))
  call prop_Q_A(wf(:,39),Q(:,7),ZERO,0_intkind1,wf(:,40))
  call vert_QA_W(wf(:,-2),wf(:,26),wf(:,41))
  ...
  call counter_QA_Z(gZu,wf(:,-2),wf(:,-3),wf(:,77))
  call prop_W_W(wf(:,77),Q(:,12),MZ,1_intkind1,wf(:,78))
  call counter_VQ_A(wf(:,1),wf(:,25),wf(:,79))
  call counter_ZQ_A(gZd,wf(:,7),wf(:,25),wf(:,80))
  call counter_WQ_A(wf(:,-5),wf(:,25),wf(:,81))
  call counter_AW_Q(wf(:,26),wf(:,-4),wf(:,82))
  call counter_QA_W(wf(:,25),wf(:,-3),wf(:,83))
  call prop_W_W(wf(:,18),Q(:,35),MW,1_intkind1,wf(:,84))
  call prop_W_W(wf(:,22),Q(:,35),MW,1_intkind1,wf(:,85))
  call counter_AV_Q(wf(:,-3),wf(:,1),wf(:,86))
  call prop_Q_A(wf(:,30),Q(:,52),ZERO,0_intkind1,wf(:,87))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,7),wf(:,88))
  call counter_AW_Q(wf(:,-3),wf(:,-5),wf(:,89))
  call prop_A_Q(wf(:,89),Q(:,40),ZERO,0_intkind1,wf(:,90))
  call counter_AV_Q(wf(:,-3),wf(:,43),wf(:,91))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,45),wf(:,92))
  call vert_AW_Q(wf(:,90),wf(:,-4),wf(:,93))
  call vert_QA_W(wf(:,-2),wf(:,90),wf(:,94))
  call prop_W_W(wf(:,94),Q(:,44),MW,1_intkind1,wf(:,95))
  call counter_QA_W(wf(:,-2),wf(:,26),wf(:,96))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,97))
  call prop_A_Q(wf(:,37),Q(:,56),ZERO,0_intkind1,wf(:,98))
  call counter_ZQ_A(gZu,wf(:,7),wf(:,-2),wf(:,99))
  call counter_VQ_A(wf(:,43),wf(:,-2),wf(:,100))
  call counter_ZQ_A(gZu,wf(:,45),wf(:,-2),wf(:,101))
  call prop_A_Q(wf(:,44),Q(:,56),ZERO,0_intkind1,wf(:,102))
  call prop_A_Q(wf(:,46),Q(:,56),ZERO,0_intkind1,wf(:,103))
  call counter_WQ_A(wf(:,-4),wf(:,-2),wf(:,104))
  call prop_Q_A(wf(:,104),Q(:,20),ZERO,0_intkind1,wf(:,105))
  call vert_VQ_A(wf(:,1),wf(:,105),wf(:,106))
  call vert_ZQ_A(gZd,wf(:,7),wf(:,105),wf(:,107))
  call vert_WQ_A(wf(:,-5),wf(:,105),wf(:,108))
  call vert_QA_W(wf(:,105),wf(:,-3),wf(:,109))
  call prop_W_W(wf(:,109),Q(:,28),MW,1_intkind1,wf(:,110))
  ...
  call counter_Q_A(ctqq,wf(:,25),Q(:,20),wf(:,127))
  call prop_A_Q(wf(:,126),Q(:,43),ZERO,0_intkind1,wf(:,128))
  call vert_AZ_Q(gZd,wf(:,26),wf(:,7),wf(:,129))
  call prop_A_Q(wf(:,129),Q(:,43),ZERO,0_intkind1,wf(:,130))
  call counter_A_Q(ctqq,wf(:,26),Q(:,40),wf(:,131))
  call prop_Q_A(wf(:,27),Q(:,23),ZERO,0_intkind1,wf(:,132))
  call prop_Q_A(wf(:,28),Q(:,23),ZERO,0_intkind1,wf(:,133))
  call prop_Q_A(wf(:,127),Q(:,20),ZERO,0_intkind1,wf(:,134))
  call vert_QA_W(wf(:,134),wf(:,-3),wf(:,135))
  call vert_WQ_A(wf(:,-5),wf(:,134),wf(:,136))
  call counter_A_Q(ctqq,wf(:,31),Q(:,11),wf(:,137))
  call counter_A_Q(ctqq,wf(:,33),Q(:,11),wf(:,138))
  call prop_A_Q(wf(:,131),Q(:,40),ZERO,0_intkind1,wf(:,139))
  call vert_QA_W(wf(:,-2),wf(:,139),wf(:,140))
  call counter_Q_A(ctqq,wf(:,38),Q(:,7),wf(:,141))
  call counter_Q_A(ctqq,wf(:,40),Q(:,7),wf(:,142))
  call vert_AW_Q(wf(:,139),wf(:,-4),wf(:,143))
  ...
  call vert_WQ_A(wf(:,-4),wf(:,38),wf(:,150))
  call prop_Q_A(wf(:,150),Q(:,23),ZERO,0_intkind1,wf(:,151))
  call vert_WQ_A(wf(:,-4),wf(:,40),wf(:,152))
  call prop_Q_A(wf(:,152),Q(:,23),ZERO,0_intkind1,wf(:,153))
  call vert_AW_Q(wf(:,31),wf(:,-5),wf(:,154))
  call prop_A_Q(wf(:,154),Q(:,43),ZERO,0_intkind1,wf(:,155))
  call vert_AW_Q(wf(:,33),wf(:,-5),wf(:,156))
  call prop_A_Q(wf(:,156),Q(:,43),ZERO,0_intkind1,wf(:,157))
  call vert_WQ_A(wf(:,13),wf(:,-2),wf(:,158))
  call prop_Q_A(wf(:,158),Q(:,23),ZERO,0_intkind1,wf(:,159))
  call vert_WQ_A(wf(:,16),wf(:,-2),wf(:,160))
  call prop_Q_A(wf(:,160),Q(:,23),ZERO,0_intkind1,wf(:,161))
  ...
  call vert_AW_Q(wf(:,-3),wf(:,84),wf(:,166))
  call prop_A_Q(wf(:,166),Q(:,43),ZERO,0_intkind1,wf(:,167))
  call vert_AW_Q(wf(:,-3),wf(:,85),wf(:,168))
  call prop_A_Q(wf(:,168),Q(:,43),ZERO,0_intkind1,wf(:,169))
  call vert_UV_W(wf(:,84),Q(:,35),wf(:,-4),Q(:,16),wf(:,170))
  call prop_W_W(wf(:,170),Q(:,51),MZ,1_intkind1,wf(:,171))
  call vert_UV_W(wf(:,85),Q(:,35),wf(:,-4),Q(:,16),wf(:,172))
  call prop_W_W(wf(:,172),Q(:,51),MZ,1_intkind1,wf(:,173))
  call prop_W_W(wf(:,55),Q(:,51),MZ,1_intkind1,wf(:,174))
  call vert_WQ_A(wf(:,57),wf(:,-2),wf(:,175))
  call prop_Q_A(wf(:,175),Q(:,23),ZERO,0_intkind1,wf(:,176))
  ...
  call vert_AW_Q(wf(:,-3),wf(:,64),wf(:,183))
...
subroutine denominators()
  ...
  den(99) = den(25)*den(54)
  den(100) = den(1)*den(99)
  den(101) = den(6)*den(99)
  den(102) = den(12)*den(26)
  den(103) = den(15)*den(26)
  den(105) = den(26)*den(104)
  den(106) = den(1)*den(105)
  den(107) = den(6)*den(105)
  den(108) = den(32)*den(48)
  den(109) = den(32)*den(50)
  den(110) = den(34)*den(48)
  den(111) = den(34)*den(50)
  ...
  den(130) = den(25)**2
  den(131) = den(95)*den(130)
  den(132) = den(97)*den(130)
  den(133) = den(32)*den(130)
  den(134) = den(34)*den(130)
  den(135) = den(32)*den(99)
  den(136) = den(34)*den(99)
  den(137) = den(26)**2
  den(138) = den(12)*den(137)
  den(139) = den(15)*den(137)
  den(140) = den(40)*den(105)
  den(141) = den(42)*den(105)
  den(142) = den(40)*den(137)
  den(143) = den(42)*den(137)
  den(144) = den(40)*den(112)
  den(145) = den(40)*den(114)
  den(146) = den(42)*den(112)
  den(147) = den(42)*den(114)
  den(148) = den(32)*den(55)
  den(149) = den(32)*den(57)
  den(150) = den(34)*den(55)
  den(151) = den(34)*den(57)
  ...
  den(162) = den(40)*den(125)
  den(163) = den(42)*den(125)
  den(164) = den(32)*den(119)
  den(165) = den(34)*den(119)
  den(166) = den(12)*den(125)
  den(167) = den(15)*den(125)
  den(168) = den(12)*den(154)
  den(169) = den(12)*den(156)
  den(170) = den(15)*den(154)
  den(171) = den(15)*den(156)
  den(172) = den(95)*den(119)
  den(173) = den(97)*den(119)
  den(174) = den(95)*den(154)
  den(175) = den(95)*den(156)
  den(176) = den(97)*den(154)
  den(177) = den(97)*den(156)
  den(178) = den(63)*den(156)
  den(179) = den(65)*den(125)
  den(180) = den(65)*den(154)
  den(181) = den(65)*den(156)
  den(183) = den(62)*den(182)
  den(184) = den(154)*den(183)
  den(185) = den(156)*den(183)
  den(186) = den(74)*den(119)
  ...
  den(208) = den(25)*den(164)
  den(209) = den(25)*den(165)
  den(210) = den(25)*den(172)
  den(211) = den(25)*den(173)
  den(212) = den(26)*den(162)
  den(213) = den(26)*den(163)
  den(214) = den(26)*den(166)
  den(215) = den(26)*den(167)
  den(216) = den(26)*den(179)
  den(217) = den(25)*den(186)
...
subroutine diagrams(A)
  ...
  A(24) = cont_QA(wf(:,38),wf(:,44)) * den(49)
  A(25) = cont_QA(wf(:,38),wf(:,46)) * den(51)
  A(26) = cont_QA(wf(:,40),wf(:,44)) * den(52)
  A(27) = cont_QA(wf(:,40),wf(:,46)) * den(53)
  A(28) = cont_QA(wf(:,29),wf(:,48)) * den(56)
  A(29) = cont_QA(wf(:,29),wf(:,50)) * den(58)
  A(30) = cont_QA(wf(:,32),wf(:,48)) * den(59)
  A(31) = cont_QA(wf(:,32),wf(:,50)) * den(60)
  ...
  A(61) = cont_VV(wf(:,83),wf(:,84)) * den(96)
  A(62) = cont_VV(wf(:,83),wf(:,85)) * den(98)
  A(63) = cont_QA(wf(:,86),wf(:,87)) * den(100)
  A(64) = cont_QA(wf(:,87),wf(:,88)) * den(101)
  A(65) = cont_QA(wf(:,27),wf(:,90)) * den(28)
  A(66) = cont_QA(wf(:,28),wf(:,90)) * den(30)
  A(67) = cont_QA(wf(:,38),wf(:,91)) * den(49)
  A(68) = cont_QA(wf(:,38),wf(:,92)) * den(51)
  A(69) = cont_QA(wf(:,40),wf(:,91)) * den(52)
  A(70) = cont_QA(wf(:,40),wf(:,92)) * den(53)
  A(71) = cont_QA(wf(:,48),wf(:,86)) * den(56)
  A(72) = cont_QA(wf(:,50),wf(:,86)) * den(58)
  A(73) = cont_QA(wf(:,48),wf(:,88)) * den(59)
  A(74) = cont_QA(wf(:,50),wf(:,88)) * den(60)
  A(75) = cont_QA(wf(:,38),wf(:,93)) * den(41)
  A(76) = cont_QA(wf(:,40),wf(:,93)) * den(43)
  A(77) = cont_VV(wf(:,11),wf(:,95)) * den(46)
  A(78) = cont_VV(wf(:,15),wf(:,95)) * den(47)
  A(79) = cont_VV(wf(:,13),wf(:,96)) * den(102)
  A(80) = cont_VV(wf(:,16),wf(:,96)) * den(103)
  A(81) = cont_QA(wf(:,97),wf(:,98)) * den(106)
  A(82) = cont_QA(wf(:,98),wf(:,99)) * den(107)
  A(83) = cont_QA(wf(:,31),wf(:,100)) * den(108)
  A(84) = cont_QA(wf(:,31),wf(:,101)) * den(109)
  A(85) = cont_QA(wf(:,33),wf(:,100)) * den(110)
  A(86) = cont_QA(wf(:,33),wf(:,101)) * den(111)
  A(87) = cont_QA(wf(:,97),wf(:,102)) * den(113)
  A(88) = cont_QA(wf(:,97),wf(:,103)) * den(115)
  A(89) = cont_QA(wf(:,99),wf(:,102)) * den(116)
  A(90) = cont_QA(wf(:,99),wf(:,103)) * den(117)
  A(91) = cont_QA(wf(:,26),wf(:,106)) * den(28)
  A(92) = cont_QA(wf(:,26),wf(:,107)) * den(30)
  A(93) = cont_QA(wf(:,31),wf(:,108)) * den(33)
  A(94) = cont_QA(wf(:,33),wf(:,108)) * den(35)
  A(95) = cont_VV(wf(:,18),wf(:,110)) * den(37)
  A(96) = cont_VV(wf(:,22),wf(:,110)) * den(38)
  ...
  A(106) = cont_VV(wf(:,57),wf(:,94)) * den(93)
  A(107) = cont_VV(wf(:,64),wf(:,83)) * den(94)
  A(108) = cont_VV(wf(:,57),wf(:,96)) * den(93)
  A(109) = cont_VV(wf(:,64),wf(:,109)) * den(94)
  ...
  A(131) = cont_VV(wf(:,84),wf(:,135)) * den(131)
  A(132) = cont_VV(wf(:,85),wf(:,135)) * den(132)
  A(133) = cont_QA(wf(:,31),wf(:,136)) * den(133)
  A(134) = cont_QA(wf(:,33),wf(:,136)) * den(134)
  A(135) = cont_QA(wf(:,87),wf(:,137)) * den(135)
  A(136) = cont_QA(wf(:,87),wf(:,138)) * den(136)
  A(137) = cont_VV(wf(:,13),wf(:,140)) * den(138)
  A(138) = cont_VV(wf(:,16),wf(:,140)) * den(139)
  A(139) = cont_QA(wf(:,98),wf(:,141)) * den(140)
  A(140) = cont_QA(wf(:,98),wf(:,142)) * den(141)
  A(141) = cont_QA(wf(:,38),wf(:,143)) * den(142)
  A(142) = cont_QA(wf(:,40),wf(:,143)) * den(143)
  A(143) = cont_QA(wf(:,102),wf(:,141)) * den(144)
  A(144) = cont_QA(wf(:,103),wf(:,141)) * den(145)
  A(145) = cont_QA(wf(:,102),wf(:,142)) * den(146)
  A(146) = cont_QA(wf(:,103),wf(:,142)) * den(147)
  A(147) = cont_QA(wf(:,31),wf(:,144)) * den(148)
  A(148) = cont_QA(wf(:,31),wf(:,145)) * den(149)
  A(149) = cont_QA(wf(:,33),wf(:,144)) * den(150)
  A(150) = cont_QA(wf(:,33),wf(:,145)) * den(151)
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = (-A(24)-A(28))*f(1)+(A(1)-A(6)-A(10)+A(26)+A(30)+A(41)+A(45))*f(2)+(-A(43)-A(46))*f(3)+(A(49)+A(50))*f(9)+(A(19)+A(23) &
       +A(34)+A(38))*f(12)+A(14)*f(15)+(-A(16)-A(20)+A(33)-A(35)+A(37)-A(39))*f(16)+(A(15)+A(17)-A(18)+A(21)-A(22)+A(32)+A(36) &
       +A(40))*f(17)+(-A(4)+A(9)+A(13))*f(18)-A(5)*f(26)+(-A(3)+A(8)+A(12)-A(25)-A(29)-A(42)-A(47))*f(28)+(A(2)-A(7)-A(11)+A(27) &
       +A(31)+A(44)+A(48))*f(29)

  M2(1) = (A(143)+A(147))*f(4)+(-A(145)-A(149))*f(5)+(-A(67)-A(71)-A(83)-A(87))*f(6)+(A(51)+A(69)+A(73)+A(85)+A(89)-A(98)-A(102) &
       +A(119)+A(123))*f(7)+(-A(120)-A(125))*f(8)+(-A(151)-A(152))*f(10)+(A(106)+A(107)+A(108)+A(109))*f(11)+(-A(132) &
       -A(138))*f(13)+(A(62)+A(78)+A(80)+A(96)+A(112)+A(116))*f(14)+(-A(127)-A(129))*f(19)+(A(133)+A(135)+A(139)+A(141))*f(20)+( &
       -A(128)-A(130)+A(131)-A(134)-A(136)+A(137)-A(140)-A(142))*f(21)+(A(55)+A(65)+A(91))*f(22)+(-A(57)-A(59)-A(63)-A(75)-A(81) &
       -A(93)+A(111)-A(113)+A(115)-A(117))*f(23)+(A(56)+A(58)+A(60)-A(61)+A(64)+A(66)+A(76)-A(77)-A(79)+A(82)+A(92)+A(94)-A(95) &
       +A(110)+A(114)+A(118))*f(24)+(-A(54)+A(101)+A(105))*f(25)-A(97)*f(27)+(A(144)+A(148))*f(30)+(-A(146)-A(150))*f(31)+(-A(53) &
       -A(68)-A(72)-A(84)-A(88)+A(100)+A(104)-A(121)-A(124))*f(32)+(A(52)+A(70)+A(74)+A(86)+A(90)-A(99)-A(103)+A(122) &
       +A(126))*f(33)

end subroutine colourvectors

end module ol_loop_eevvjj_eexuuxwwx_1_/**/REALKIND
