...
module ol_colourmatrix_eevvjj_eexuuxaa_1_/**/REALKIND
...
end module ol_colourmatrix_eevvjj_eexuuxaa_1_/**/REALKIND



module ol_forced_parameters_eevvjj_eexuuxaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eevvjj_eexuuxaa_1_/**/REALKIND

module ol_loop_eevvjj_eexuuxaa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 4) = CI*eQED**4
    f( 5) = (8*CI*countertermnorm*eQED**4*gQCD**2)/27._/**/REALKIND
    f( 6) = (4*CI*countertermnorm*eQED**4*gQCD**2)/9._/**/REALKIND
    f( 7) = (2*CI*countertermnorm*eQED**4*gQCD**2)/3._/**/REALKIND
    f( 8) = (8*CI*countertermnorm*ctVqq*eQED**4*gQCD**2)/27._/**/REALKIND
    f( 9) = (4*CI*countertermnorm*ctVqq*eQED**4*gQCD**2)/9._/**/REALKIND
    f(10) = (2*CI*countertermnorm*ctVqq*eQED**4*gQCD**2)/3._/**/REALKIND
    f(11) = CI*countertermnorm*ctVqq*eQED**4*gQCD**2
    f(12) = (8*eQED**4*gQCD**2*integralnorm*SwB)/27._/**/REALKIND
    f(13) = (4*eQED**4*gQCD**2*integralnorm*SwB)/9._/**/REALKIND
    f(14) = (2*eQED**4*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(121)+A(123)+A(125)+A(127)+A(129)+A(131)+A(133)+A(135)+A(137)+A(139)+A(141)+A(143))*f(5)+(-A(122)-A(124)-A(126)-A(128) &
       -A(130)-A(132)-A(134)-A(136)-A(138)-A(140)-A(142)-A(144)-A(145)-A(147)-A(149)-A(151)-A(153)-A(155)-A(157)-A(159))*f(6) &
       +(A(146)+A(148)+A(150)+A(152)+A(154)+A(156)+A(158)+A(160))*f(7)+(-A(41)-A(43)-A(45)-A(47)-A(49)-A(51)-A(53)-A(55)-A(57) &
       -A(59)-A(61)-A(63)-A(65)-A(67)-A(69)-A(71)-A(73)-A(75))*f(8)+(A(42)+A(44)+A(46)+A(48)+A(50)+A(52)+A(54)+A(56)+A(58)+A(60) &
       +A(62)+A(64)+A(66)+A(68)+A(70)+A(72)+A(74)+A(76)+A(77)+A(79)+A(81)+A(83)+A(85)+A(87)+A(89)+A(91)+A(93)+A(95)+A(97)+A(99) &
       +A(101)+A(103)+A(105)+A(107))*f(9)+(-A(78)-A(80)-A(82)-A(84)-A(86)-A(88)-A(90)-A(92)-A(94)-A(96)-A(98)-A(100)-A(102)-A(104) &
       -A(106)-A(108)-A(109)-A(111)-A(113)-A(115)-A(117)-A(119))*f(10)+(A(110)+A(112)+A(114)+A(116)+A(118)+A(120))*f(11)

end subroutine colourvectors

end module ol_loop_eevvjj_eexuuxaa_1_/**/REALKIND
