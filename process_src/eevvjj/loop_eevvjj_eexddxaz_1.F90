...
module ol_colourmatrix_eevvjj_eexddxaz_1_/**/REALKIND
...
end module ol_colourmatrix_eevvjj_eexddxaz_1_/**/REALKIND



module ol_forced_parameters_eevvjj_eexddxaz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eevvjj_eexddxaz_1_/**/REALKIND

module ol_loop_eevvjj_eexddxaz_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,-5),wf(:,-2),wf(:,15))
  ...
  call vert_AZ_Q(gZd,wf(:,18),wf(:,-5),wf(:,22))
  ...
  call counter_ZQ_A(gZd,wf(:,-5),wf(:,4),wf(:,77))
  call counter_VQ_A(wf(:,1),wf(:,17),wf(:,78))
  call counter_ZQ_A(gZd,wf(:,8),wf(:,17),wf(:,79))
  call counter_AZ_Q(gZd,wf(:,18),wf(:,-5),wf(:,80))
  ...
  call counter_AZ_Q(gZd,wf(:,-3),wf(:,-5),wf(:,86))
  ...
  call vert_ZQ_A(gZd,wf(:,-5),wf(:,103),wf(:,106))
  ...
  call vert_ZQ_A(gZd,wf(:,-5),wf(:,142),wf(:,143))
  ...
  call vert_AZ_Q(gZd,wf(:,156),wf(:,-5),wf(:,157))
  ...
  call vert_ZQ_A(gZd,wf(:,-5),wf(:,23),wf(:,174))
  call prop_Q_A(wf(:,174),Q(:,39),ZERO,0_intkind1,wf(:,175))
  call vert_ZQ_A(gZd,wf(:,-5),wf(:,25),wf(:,176))
  ...
  call vert_AZ_Q(gZd,wf(:,12),wf(:,-5),wf(:,182))
  call prop_A_Q(wf(:,182),Q(:,43),ZERO,0_intkind1,wf(:,183))
  call vert_AZ_Q(gZd,wf(:,14),wf(:,-5),wf(:,184))
...
end module ol_loop_eevvjj_eexddxaz_1_/**/REALKIND
