...
! **********************************************************************
module ol_tensor_sum_storage_eevvjj_eexddxwwx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_eevvjj_eexddxwwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_eevvjj_eexddxwwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_eevvjj_eexddxwwx_1, only: channel_number_eevvjj_eexddxwwx_1
  ...
  call channel_on(channel_number_eevvjj_eexddxwwx_1)
  M2 = 0
  ...
  call TI_call(2, momenta_16, masses2_2, T2sum(:,5), M2)
  ...
  call TI_call(3, momenta_20, masses2_3, T3sum(:,9), M2)
  call TI_call(3, momenta_19, masses2_3, T3sum(:,10), M2)
  ...
  call channel_off(channel_number_eevvjj_eexddxwwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_eevvjj_eexddxwwx_1_/**/REALKIND
