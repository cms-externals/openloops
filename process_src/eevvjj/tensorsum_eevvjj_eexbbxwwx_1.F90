...
! **********************************************************************
module ol_tensor_sum_storage_eevvjj_eexbbxwwx_1_/**/REALKIND
! **********************************************************************
  ...
  complex(REALKIND), save :: T4sum(70,3) = 0

  contains

#ifdef PRECISION_dp
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_eevvjj_eexbbxwwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_eevvjj_eexbbxwwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_eevvjj_eexbbxwwx_1, only: channel_number_eevvjj_eexbbxwwx_1
  ...
  call channel_on(channel_number_eevvjj_eexbbxwwx_1)
  M2 = 0
  ...
  momenta_23(:,1) = Q(1:4,24)
  momenta_23(:,2) = Q(1:4,27)
  momenta_23(:,3) = Q(1:4,59)
  momenta_24(:,1) = Q(1:4,24)
  ...
  momenta_27(:,4) = Q(1:4,59)
  momenta_28(:,1) = Q(1:4,8)
  momenta_28(:,2) = Q(1:4,24)
  momenta_28(:,3) = Q(1:4,27)
  momenta_28(:,4) = Q(1:4,59)
  ...
  masses2_4 = [ ZERO2, MT2, MB2 ]
  masses2_5 = [ ZERO2, MT2, MT2 ]
  masses2_6 = [ ZERO2, MB2, MB2, MB2 ]
  masses2_7 = [ ZERO2, MB2, MT2, MB2 ]
  masses2_8 = [ ZERO2, MT2, MB2, MB2 ]
  masses2_9 = [ ZERO2, MT2, MT2, MB2 ]
  masses2_10 = [ ZERO2, MB2, MB2, MT2, MB2 ]
  masses2_11 = [ ZERO2, MB2, MT2, MB2, MB2 ]
  masses2_12 = [ ZERO2, MB2, MT2, MT2, MB2 ]
  ...
  call TI_call(1, momenta_4, masses2_1, T1sum(:,3), M2)
  call TI_call(1, momenta_3, masses2_1, T1sum(:,4), M2)

  call TI_call(2, momenta_6, masses2_3, T2sum(:,1), M2)
  ...
  call TI_call(2, momenta_16, masses2_3, T2sum(:,5), M2)
  ...
  call TI_call(2, momenta_15, masses2_3, T2sum(:,9), M2)
  call TI_call(2, momenta_14, masses2_4, T2sum(:,10), M2)
  call TI_call(2, momenta_5, masses2_3, T2sum(:,11), M2)
  call TI_call(2, momenta_7, masses2_3, T2sum(:,12), M2)

  call TI_call(3, momenta_23, masses2_9, T3sum(:,1), M2)
  call TI_call(3, momenta_24, masses2_8, T3sum(:,2), M2)
  call TI_call(3, momenta_25, masses2_9, T3sum(:,3), M2)
  call TI_call(3, momenta_26, masses2_8, T3sum(:,4), M2)
  call TI_call(3, momenta_21, masses2_6, T3sum(:,5), M2)
  call TI_call(3, momenta_17, masses2_6, T3sum(:,6), M2)
  call TI_call(3, momenta_18, masses2_7, T3sum(:,7), M2)
  call TI_call(3, momenta_22, masses2_7, T3sum(:,8), M2)
  call TI_call(3, momenta_20, masses2_7, T3sum(:,9), M2)
  call TI_call(3, momenta_19, masses2_7, T3sum(:,10), M2)

  call TI_call(4, momenta_28, masses2_12, T4sum(:,1), M2)
  call TI_call(4, momenta_27, masses2_10, T4sum(:,2), M2)
  call TI_call(4, momenta_29, masses2_11, T4sum(:,3), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_eevvjj_eexbbxwwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_eevvjj_eexbbxwwx_1_/**/REALKIND
