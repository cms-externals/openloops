...
module ol_colourmatrix_eevvjj_eexuuxaz_1_/**/REALKIND
...
end module ol_colourmatrix_eevvjj_eexuuxaz_1_/**/REALKIND



module ol_forced_parameters_eevvjj_eexuuxaz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eevvjj_eexuuxaz_1_/**/REALKIND

module ol_loop_eevvjj_eexuuxaz_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,-5),wf(:,3))
  ...
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,4),wf(:,11))
  ...
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,-2),wf(:,15))
  ...
  call vert_AZ_Q(gZu,wf(:,18),wf(:,-5),wf(:,22))
  ...
  call vert_AZ_Q(gZl,wf(:,-1),wf(:,-5),wf(:,29))
  ...
  call vert_ZQ_A(gZl,wf(:,-5),wf(:,0),wf(:,42))
  ...
  call vert_AZ_Q(gZl,wf(:,45),wf(:,-5),wf(:,49))
  ...
  call vert_QA_Z(gZu,wf(:,4),wf(:,-3),wf(:,68))
  ...
  call vert_QA_Z(gZu,wf(:,-2),wf(:,18),wf(:,74))
  call counter_VQ_A(wf(:,1),wf(:,4),wf(:,75))
  call counter_ZQ_A(gZu,wf(:,8),wf(:,4),wf(:,76))
  call counter_ZQ_A(gZu,wf(:,-5),wf(:,4),wf(:,77))
  call counter_VQ_A(wf(:,1),wf(:,17),wf(:,78))
  call counter_ZQ_A(gZu,wf(:,8),wf(:,17),wf(:,79))
  call counter_AZ_Q(gZu,wf(:,18),wf(:,-5),wf(:,80))
  call counter_VQ_A(wf(:,-4),wf(:,17),wf(:,81))
  call counter_AV_Q(wf(:,5),wf(:,-4),wf(:,82))
  call counter_AV_Q(wf(:,-3),wf(:,1),wf(:,83))
  call prop_Q_A(wf(:,11),Q(:,52),ZERO,0_intkind1,wf(:,84))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,8),wf(:,85))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,-5),wf(:,86))
  call prop_A_Q(wf(:,86),Q(:,40),ZERO,0_intkind1,wf(:,87))
  call prop_Q_A(wf(:,26),Q(:,52),ZERO,0_intkind1,wf(:,88))
  call vert_AV_Q(wf(:,87),wf(:,-4),wf(:,89))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,90))
  call prop_A_Q(wf(:,90),Q(:,24),ZERO,0_intkind1,wf(:,91))
  call vert_AZ_Q(gZu,wf(:,91),wf(:,-5),wf(:,92))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,93))
  call prop_A_Q(wf(:,22),Q(:,56),ZERO,0_intkind1,wf(:,94))
  call counter_ZQ_A(gZu,wf(:,8),wf(:,-2),wf(:,95))
  call counter_ZQ_A(gZu,wf(:,-5),wf(:,-2),wf(:,96))
  call prop_Q_A(wf(:,96),Q(:,36),ZERO,0_intkind1,wf(:,97))
  call vert_VQ_A(wf(:,1),wf(:,97),wf(:,98))
  call vert_ZQ_A(gZu,wf(:,8),wf(:,97),wf(:,99))
  call prop_A_Q(wf(:,27),Q(:,56),ZERO,0_intkind1,wf(:,100))
  call vert_VQ_A(wf(:,-4),wf(:,97),wf(:,101))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,102))
  call prop_Q_A(wf(:,102),Q(:,20),ZERO,0_intkind1,wf(:,103))
  call vert_VQ_A(wf(:,1),wf(:,103),wf(:,104))
  call vert_ZQ_A(gZu,wf(:,8),wf(:,103),wf(:,105))
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,103),wf(:,106))
  call counter_QA_V(wf(:,17),wf(:,-3),wf(:,107))
  call counter_QA_Z(gZu,wf(:,17),wf(:,-3),wf(:,108))
  call vert_QA_V(wf(:,-2),wf(:,87),wf(:,109))
  call vert_QA_Z(gZu,wf(:,-2),wf(:,87),wf(:,110))
  call counter_QA_V(wf(:,4),wf(:,-3),wf(:,111))
  call counter_QA_Z(gZu,wf(:,4),wf(:,-3),wf(:,112))
  call vert_QA_V(wf(:,-2),wf(:,91),wf(:,113))
  call vert_QA_Z(gZu,wf(:,-2),wf(:,91),wf(:,114))
  call counter_QA_V(wf(:,-2),wf(:,5),wf(:,115))
  call counter_QA_Z(gZu,wf(:,-2),wf(:,5),wf(:,116))
  call vert_QA_V(wf(:,97),wf(:,-3),wf(:,117))
  call vert_QA_Z(gZu,wf(:,97),wf(:,-3),wf(:,118))
  call counter_QA_V(wf(:,-2),wf(:,18),wf(:,119))
  call counter_QA_Z(gZu,wf(:,-2),wf(:,18),wf(:,120))
  call vert_QA_V(wf(:,103),wf(:,-3),wf(:,121))
  call vert_QA_Z(gZu,wf(:,103),wf(:,-3),wf(:,122))
  call counter_QA_V(wf(:,-2),wf(:,-3),wf(:,123))
  call counter_QA_Z(gZu,wf(:,-2),wf(:,-3),wf(:,124))
  ...
  call vert_AZ_Q(gZu,wf(:,5),wf(:,8),wf(:,137))
  call prop_A_Q(wf(:,137),Q(:,43),ZERO,0_intkind1,wf(:,138))
  call counter_A_Q(ctqq,wf(:,5),Q(:,40),wf(:,139))
  call prop_Q_A(wf(:,6),Q(:,23),ZERO,0_intkind1,wf(:,140))
  call prop_Q_A(wf(:,9),Q(:,23),ZERO,0_intkind1,wf(:,141))
  call prop_Q_A(wf(:,135),Q(:,20),ZERO,0_intkind1,wf(:,142))
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,142),wf(:,143))
  call counter_A_Q(ctqq,wf(:,12),Q(:,11),wf(:,144))
  call counter_A_Q(ctqq,wf(:,14),Q(:,11),wf(:,145))
  call vert_AV_Q(wf(:,18),wf(:,1),wf(:,146))
  call counter_Q_A(ctqq,wf(:,17),Q(:,36),wf(:,147))
  call prop_A_Q(wf(:,146),Q(:,27),ZERO,0_intkind1,wf(:,148))
  call vert_AZ_Q(gZu,wf(:,18),wf(:,8),wf(:,149))
  call prop_A_Q(wf(:,149),Q(:,27),ZERO,0_intkind1,wf(:,150))
  call counter_A_Q(ctqq,wf(:,18),Q(:,24),wf(:,151))
  call prop_Q_A(wf(:,19),Q(:,39),ZERO,0_intkind1,wf(:,152))
  call prop_Q_A(wf(:,20),Q(:,39),ZERO,0_intkind1,wf(:,153))
  call counter_Q_A(ctqq,wf(:,23),Q(:,7),wf(:,154))
  call counter_Q_A(ctqq,wf(:,25),Q(:,7),wf(:,155))
  call prop_A_Q(wf(:,151),Q(:,24),ZERO,0_intkind1,wf(:,156))
  call vert_AZ_Q(gZu,wf(:,156),wf(:,-5),wf(:,157))
  call prop_Q_A(wf(:,147),Q(:,36),ZERO,0_intkind1,wf(:,158))
  call vert_VQ_A(wf(:,-4),wf(:,158),wf(:,159))
  call prop_A_Q(wf(:,139),Q(:,40),ZERO,0_intkind1,wf(:,160))
  call vert_AV_Q(wf(:,160),wf(:,-4),wf(:,161))
  call vert_QA_V(wf(:,158),wf(:,-3),wf(:,162))
  call vert_QA_Z(gZu,wf(:,158),wf(:,-3),wf(:,163))
  call vert_QA_V(wf(:,-2),wf(:,160),wf(:,164))
  call vert_QA_Z(gZu,wf(:,-2),wf(:,160),wf(:,165))
  call vert_QA_V(wf(:,142),wf(:,-3),wf(:,166))
  call vert_QA_Z(gZu,wf(:,142),wf(:,-3),wf(:,167))
  call vert_QA_V(wf(:,-2),wf(:,156),wf(:,168))
  call vert_QA_Z(gZu,wf(:,-2),wf(:,156),wf(:,169))
  call vert_VQ_A(wf(:,-4),wf(:,23),wf(:,170))
  call prop_Q_A(wf(:,170),Q(:,23),ZERO,0_intkind1,wf(:,171))
  call vert_VQ_A(wf(:,-4),wf(:,25),wf(:,172))
  call prop_Q_A(wf(:,172),Q(:,23),ZERO,0_intkind1,wf(:,173))
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,23),wf(:,174))
  call prop_Q_A(wf(:,174),Q(:,39),ZERO,0_intkind1,wf(:,175))
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,25),wf(:,176))
  call prop_Q_A(wf(:,176),Q(:,39),ZERO,0_intkind1,wf(:,177))
  call vert_AV_Q(wf(:,12),wf(:,-4),wf(:,178))
  call prop_A_Q(wf(:,178),Q(:,27),ZERO,0_intkind1,wf(:,179))
  call vert_AV_Q(wf(:,14),wf(:,-4),wf(:,180))
  call prop_A_Q(wf(:,180),Q(:,27),ZERO,0_intkind1,wf(:,181))
  call vert_AZ_Q(gZu,wf(:,12),wf(:,-5),wf(:,182))
  call prop_A_Q(wf(:,182),Q(:,43),ZERO,0_intkind1,wf(:,183))
  call vert_AZ_Q(gZu,wf(:,14),wf(:,-5),wf(:,184))
  ...
  call vert_ZQ_A(gZu,wf(:,59),wf(:,-2),wf(:,189))
  ...
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,59),wf(:,193))
  call prop_A_Q(wf(:,193),Q(:,27),ZERO,0_intkind1,wf(:,194))
  ...
  call vert_ZQ_A(gZu,wf(:,64),wf(:,-2),wf(:,202))
  call prop_Q_A(wf(:,202),Q(:,23),ZERO,0_intkind1,wf(:,203))
  call vert_AV_Q(wf(:,-3),wf(:,62),wf(:,204))
  call prop_A_Q(wf(:,204),Q(:,27),ZERO,0_intkind1,wf(:,205))
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,64),wf(:,206))
  ...
  call vert_ZQ_A(gZu,wf(:,69),wf(:,-2),wf(:,214))
  ...
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,69),wf(:,218))
  ...
  call vert_ZQ_A(gZu,wf(:,72),wf(:,-2),wf(:,226))
  ...
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,72),wf(:,230))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = (A(1)+A(3)+A(5)+A(7)+A(9)+A(11)+A(33)+A(35)+A(37)+A(39))*f(1)+(-A(2)-A(4)-A(6)-A(8)-A(10)-A(12)-A(13)-A(15)-A(17)-A(19) &
       -A(21)-A(23)-A(25)-A(27)-A(29)-A(31)-A(34)-A(36)-A(38)-A(40))*f(2)+(A(14)+A(16)+A(18)+A(20)+A(22)+A(24)+A(26)+A(28)+A(30) &
       +A(32))*f(3)

  M2(1) = (-A(121)-A(123)-A(125)-A(127)-A(129)-A(131)-A(133)-A(135)-A(137)-A(139)-A(141)-A(143)-A(153)-A(155)-A(157)-A(159))*f(4) &
       +(A(122)+A(124)+A(126)+A(128)+A(130)+A(132)+A(134)+A(136)+A(138)+A(140)+A(142)+A(144)+A(145)+A(147)+A(149)+A(151)+A(154) &
       +A(156)+A(158)+A(160))*f(5)+(-A(146)-A(148)-A(150)-A(152))*f(6)+(A(41)+A(43)+A(45)+A(47)+A(49)+A(51)+A(53)+A(55)+A(57) &
       +A(59)+A(61)+A(63)+A(65)+A(67)+A(69)+A(71)+A(73)+A(75)+A(85)+A(87)+A(89)+A(91)+A(101)+A(103)+A(105)+A(107))*f(7)+(-A(42) &
       -A(44)-A(46)-A(48)-A(50)-A(52)-A(54)-A(56)-A(58)-A(60)-A(62)-A(64)-A(66)-A(68)-A(70)-A(72)-A(74)-A(76)-A(77)-A(79)-A(81) &
       -A(83)-A(86)-A(88)-A(90)-A(92)-A(93)-A(95)-A(97)-A(99)-A(102)-A(104)-A(106)-A(108)-A(109)-A(111)-A(113)-A(115)-A(117) &
       -A(119))*f(8)+(A(78)+A(80)+A(82)+A(84)+A(94)+A(96)+A(98)+A(100)+A(110)+A(112)+A(114)+A(116)+A(118)+A(120))*f(9)

end subroutine colourvectors

end module ol_loop_eevvjj_eexuuxaz_1_/**/REALKIND
