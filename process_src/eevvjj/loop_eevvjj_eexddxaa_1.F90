...
module ol_colourmatrix_eevvjj_eexddxaa_1_/**/REALKIND
...
end module ol_colourmatrix_eevvjj_eexddxaa_1_/**/REALKIND



module ol_forced_parameters_eevvjj_eexddxaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eevvjj_eexddxaa_1_/**/REALKIND

module ol_loop_eevvjj_eexddxaa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 8) = (CI*countertermnorm*ctVqq*eQED**4*gQCD**2)/27._/**/REALKIND
    f( 9) = (CI*countertermnorm*ctVqq*eQED**4*gQCD**2)/9._/**/REALKIND
    f(10) = (CI*countertermnorm*ctVqq*eQED**4*gQCD**2)/3._/**/REALKIND
...
end module ol_loop_eevvjj_eexddxaa_1_/**/REALKIND
