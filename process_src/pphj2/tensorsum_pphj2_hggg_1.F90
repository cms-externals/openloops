...
! **********************************************************************
module ol_tensor_sum_storage_pphj2_hggg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphj2_hggg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphj2_hggg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pphj2_hggg_1, only: channel_number_pphj2_hggg_1
  ...
  call channel_on(channel_number_pphj2_hggg_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,2)
  momenta_1(:,2) = Q(1:4,14)
  momenta_2(:,1) = Q(1:4,4)
  ...
  call tensor_integral(4, momenta_5, masses2_4, T4sum(:,1))
  ...
  if (a_switch == 1 .and. ncall_coli < maxcachetrain) then
    ...
    if (YB == 0) then
      call channel_off(channel_number_pphj2_hggg_1)
      return
    end if
  end if
  ...
  call tensor_integral(4, momenta_5, masses2_3, T4sum(:,2))
  call tensor_integral(4, momenta_4, masses2_3, T4sum(:,4))
  call tensor_integral(4, momenta_6, masses2_3, T4sum(:,6))
...
end module ol_tensor_sum_storage_pphj2_hggg_1_/**/REALKIND
