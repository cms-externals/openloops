...
module ol_colourmatrix_pphj2_uuxhg_1_/**/REALKIND
...
end module ol_colourmatrix_pphj2_uuxhg_1_/**/REALKIND



module ol_forced_parameters_pphj2_uuxhg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphj2_uuxhg_1_/**/REALKIND

module ol_loop_pphj2_uuxhg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(3) = (CI*countertermnorm*ctHGG*eQED*gQCD**3*MT*YT)/MQ2sum
    f(4) = (eQED*gQCD**3*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_SG_G(wf(:,-2),wf(:,-3),wf(:,2))
...
end module ol_loop_pphj2_uuxhg_1_/**/REALKIND
