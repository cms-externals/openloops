...
module ol_vamp_5_ppjjjj_dddxdxgg_1_/**/REALKIND
contains
...
! **********************************************************************
  ...
  call loop_Q_A(G0(:,:,:,24),Q(:,18),ZERO,G1(:,:,:,166))
  ...
  call loop_A_Q(G0(:,:,:,34),Q(:,24),ZERO,G1(:,:,:,239))
  ...
  call loop_A_Q(G0(:,:,:,42),Q(:,29),ZERO,G1(:,:,:,279))
  call loop_AV_Q(G1(:,:,:,279),wf(:,-5),G1(:,:,:,280))
  call loop_A_Q(G1(:,:,:,280),Q(:,61),ZERO,G2(:,:,:,487))
...
end module ol_vamp_5_ppjjjj_dddxdxgg_1_/**/REALKIND
