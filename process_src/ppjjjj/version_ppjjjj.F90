...
module ol_versiondata_ppjjjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppjjjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppjjjj
  end interface
end module ol_versiondata_ppjjjj


subroutine ol_version_ppjjjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppjjjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppjjjj
