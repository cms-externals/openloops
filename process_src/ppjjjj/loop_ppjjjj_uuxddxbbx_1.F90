...
module ol_colourmatrix_ppjjjj_uuxddxbbx_1_/**/REALKIND
...
end module ol_colourmatrix_ppjjjj_uuxddxbbx_1_/**/REALKIND



module ol_forced_parameters_ppjjjj_uuxddxbbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppjjjj_uuxddxbbx_1_/**/REALKIND

module ol_loop_ppjjjj_uuxddxbbx_1_/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(39)+A(40)+A(41)+A(42)+A(43)+A(44)+A(51)+A(52)+A(53)+A(54)+A(55)+A(56))*f(3))/12._/**/REALKIND+((-A(9)-A(10)-A(11) &
       -A(12)-A(23)-A(24))*f(5))/12._/**/REALKIND+((-A(21)-A(22)-A(25)-A(26)-A(27)-A(28)-A(29)-A(30)-A(32) &
       -A(33))*f(7))/12._/**/REALKIND
  M2(2) = ((-A(40)-A(41)-A(44)-A(45)-A(47)-A(50)-A(52)-A(54)-A(55))*f(3))/4._/**/REALKIND+(CI*(-A(36)+A(37) &
       ...
       +A(19)+A(22)+A(25)+A(28)+A(30)+A(33)+A(34))*f(7))/4._/**/REALKIND+(CI*(A(20)+A(31))*f(8))/4._/**/REALKIND &
  ...
  M2(3) = ((-A(39)-A(42)-A(43)-A(46)-A(48)-A(49)-A(51)-A(53)-A(56))*f(3))/4._/**/REALKIND+(CI*(A(36)-A(37) &
       ...
       +A(21)+A(26)+A(27)+A(29)+A(32)+A(35))*f(7))/4._/**/REALKIND+(CI*(-A(20)-A(31))*f(8))/4._/**/REALKIND &
       -(CI*A(8)*f(9))/4._/**/REALKIND
  M2(4) = ((A(39)+A(40)+A(41)+A(42)+A(43)+A(44)+A(45)+A(46)+A(47)+A(48)+A(49)+A(50))*f(3))/12._/**/REALKIND+((-A(9)-A(10)-A(11) &
       -A(12)-A(14)-A(15))*f(5))/12._/**/REALKIND+((-A(16)-A(17)-A(18)-A(19)-A(21)-A(22)-A(32)-A(33)-A(34) &
       -A(35))*f(7))/12._/**/REALKIND
  M2(5) = ((A(45)+A(46)+A(47)+A(48)+A(49)+A(50)+A(51)+A(52)+A(53)+A(54)+A(55)+A(56))*f(3))/12._/**/REALKIND+((-A(14)-A(15)-A(23) &
       -A(24))*f(5))/12._/**/REALKIND+((-A(16)-A(17)-A(18)-A(19)-A(25)-A(26)-A(27)-A(28)-A(29)-A(30)-A(34) &
       -A(35))*f(7))/12._/**/REALKIND
  M2(6) = ((-A(39)-A(40)-A(41)-A(42)-A(43)-A(44)-A(45)-A(46)-A(47)-A(48)-A(49)-A(50)-A(51)-A(52)-A(53)-A(54)-A(55) &
       ...
       +A(19)+A(21)+A(22)+A(25)+A(26)+A(27)+A(28)+A(29)+A(30)+A(32)+A(33)+A(34)+A(35))*f(7))/36._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppjjjj_uuxddxbbx_1_/**/REALKIND
