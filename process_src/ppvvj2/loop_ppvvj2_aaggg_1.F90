...
module ol_colourmatrix_ppvvj2_aaggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvj2_aaggg_1_/**/REALKIND



module ol_forced_parameters_ppvvj2_aaggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvj2_aaggg_1_/**/REALKIND

module ol_loop_ppvvj2_aaggg_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-5+1:6)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = countertermnorm*ctAAGG*eQED**2*gQCD**3
    f(2) = (CI*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(3) = (2*CI*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(4) = (4*CI*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(5) = (8*CI*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(6) = (eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(7) = (2*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(8) = (4*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(9) = (8*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
...
end module ol_loop_ppvvj2_aaggg_1_/**/REALKIND
