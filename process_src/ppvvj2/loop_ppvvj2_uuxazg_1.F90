...
module ol_colourmatrix_ppvvj2_uuxazg_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvj2_uuxazg_1_/**/REALKIND



module ol_forced_parameters_ppvvj2_uuxazg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvj2_uuxazg_1_/**/REALKIND

module ol_loop_ppvvj2_uuxazg_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-5+1:9)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = CI*countertermnorm*ctAZGG*eQED**2*gQCD**3
    f(2) = (2*countertermnorm*ctZGG*eQED**2*gQCD**3)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_VG_G(wf(:,-3),wf(:,-4),Q(:,16),wf(:,4),Q(:,24))
  call prop_Q_A(wf(:,3),Q(:,5),ZERO,0_intkind1,wf(:,5))
  call vert_QA_V(wf(:,5),wf(:,-1),wf(:,6))
  call vert_AV_Q(wf(:,-1),wf(:,-2),wf(:,7))
  call prop_A_Q(wf(:,7),Q(:,6),ZERO,0_intkind1,wf(:,8))
...
subroutine diagrams(A)
  ...
  A(2) = cont_VV(wf(:,4),wf(:,6)) * den(4)
  A(3) = cont_VV(wf(:,4),wf(:,9)) * den(6)
...
end module ol_loop_ppvvj2_uuxazg_1_/**/REALKIND
