...
module ol_vamp_1_ppvvj2_uuxaag_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppvvj2_uuxaag_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppvvj2_uuxaag_1.
! **********************************************************************
...
#endif
  use ol_loop_ppvvj2_uuxaag_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppvvj2_uuxaag_1_/**/REALKIND
  ...
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_3,masses2_3,G4tensor(:,1),T4sum(1:70,1))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_3,masses2_1,G4tensor(:,5),T4sum(1:70,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_3,masses2_3,G4tensor(:,3),T4sum(1:70,1))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_3,masses2_1,G4tensor(:,6),T4sum(1:70,3))
  M(1) = M(1) + (-(f(5)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_1,masses2_3,G4tensor(:,7),T4sum(1:70,4))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_1,masses2_2,G4tensor(:,9),T4sum(1:70,5))
  M(1) = M(1) + (-(f(5)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_1,masses2_3,G4tensor(:,11),T4sum(1:70,4))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_1,masses2_2,G4tensor(:,13),T4sum(1:70,5))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_1,masses2_3,G4tensor(:,7),T4sum(1:70,4))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_1,masses2_1,G4tensor(:,15),T4sum(1:70,6))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_1,masses2_3,G4tensor(:,11),T4sum(1:70,4))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_1,masses2_1,G4tensor(:,17),T4sum(1:70,6))
  M(1) = M(1) + (-(f(5)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_3,G4tensor(:,8),T4sum(1:70,7))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_2,G4tensor(:,10),T4sum(1:70,8))
  M(1) = M(1) + (-(f(5)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_3,G4tensor(:,12),T4sum(1:70,7))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_2,G4tensor(:,14),T4sum(1:70,8))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_3,G4tensor(:,8),T4sum(1:70,7))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_1,G4tensor(:,16),T4sum(1:70,9))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_3,G4tensor(:,12),T4sum(1:70,7))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_1,G4tensor(:,18),T4sum(1:70,9))
...
end module ol_vamp_1_ppvvj2_uuxaag_1_/**/REALKIND
