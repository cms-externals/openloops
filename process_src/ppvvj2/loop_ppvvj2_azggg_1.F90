...
module ol_colourmatrix_ppvvj2_azggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvj2_azggg_1_/**/REALKIND



module ol_forced_parameters_ppvvj2_azggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvj2_azggg_1_/**/REALKIND

module ol_loop_ppvvj2_azggg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = countertermnorm*ctAZGG*eQED**2*gQCD**3
    f(2) = (CI*eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(3) = (2*CI*eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(4) = (4*CI*eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(5) = (eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(6) = (2*eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(7) = (4*eQED**2*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
...
end module ol_loop_ppvvj2_azggg_1_/**/REALKIND
