...
module ol_colourmatrix_ppvvj2_uuxaag_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvj2_uuxaag_1_/**/REALKIND



module ol_forced_parameters_ppvvj2_uuxaag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvj2_uuxaag_1_/**/REALKIND

module ol_loop_ppvvj2_uuxaag_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-5+1:2)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = CI*countertermnorm*ctAAGG*eQED**2*gQCD**3
    f(2) = (eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(3) = (2*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(4) = (4*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
    f(5) = (8*eQED**2*gQCD**3*integralnorm*SwF)/9._/**/REALKIND
...
end module ol_loop_ppvvj2_uuxaag_1_/**/REALKIND
