...
module ol_vamp_1_ppvvj2_uuxwwxg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppvvj2_uuxwwxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppvvj2_uuxwwxg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppvvj2_uuxwwxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppvvj2_uuxwwxg_1_/**/REALKIND
  ...
  call loop_AV_Q(G0(:,:,:,1),wf(:,5),G0(:,:,:,10))
  ...
  call loop_QV_A(G0(:,:,:,1),wf(:,5),G0(:,:,:,11))
  ...
  call loop_AZ_Q(G0(:,:,:,1),wf(:,6),G0(:,:,:,12),gZu)
  ...
  call loop_AZ_Q(G0(:,:,:,1),wf(:,6),G0(:,:,:,13),gZu)
  ...
  call loop_QZ_A(G0(:,:,:,1),wf(:,6),G0(:,:,:,14),gZu)
  ...
  call loop_QZ_A(G0(:,:,:,1),wf(:,6),G0(:,:,:,15),gZu)
  ...
  call loop_AZ_Q(G0(:,:,:,1),wf(:,6),G0(:,:,:,16),gZd)
  ...
  call loop_AZ_Q(G0(:,:,:,1),wf(:,6),G0(:,:,:,17),gZd)
  ...
  call loop_QZ_A(G0(:,:,:,1),wf(:,6),G0(:,:,:,18),gZd)
  ...
  call loop_QZ_A(G0(:,:,:,1),wf(:,6),G0(:,:,:,19),gZd)
  ...
  M(1) = M(1) + (f(13)/2._/**/REALKIND * den(3)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,1),T3sum(1:35,1))
  M(1) = M(1) + (f(13)/2._/**/REALKIND * den(3)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,2),T3sum(1:35,1))
  M(1) = M(1) + (f(11)/2._/**/REALKIND * den(3)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,3),T3sum(1:35,2))
  M(1) = M(1) + (f(11)/2._/**/REALKIND * den(3)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,4),T3sum(1:35,2))
  M(1) = M(1) + (-(f(5)/2._/**/REALKIND) * den(7)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,5),T3sum(1:35,3))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(7)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,6),T3sum(1:35,1))
  M(1) = M(1) + (-(f(5)/2._/**/REALKIND) * den(7)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,7),T3sum(1:35,3))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(7)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,8),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(7)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,5),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(7)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,9),T3sum(1:35,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(7)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,7),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(7)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,10),T3sum(1:35,2))
  M(1) = M(1) + (-(f(9)/2._/**/REALKIND) * den(5)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,11),T3sum(1:35,3))
  M(1) = M(1) + (-(f(8)/2._/**/REALKIND) * den(5)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,12),T3sum(1:35,1))
  M(1) = M(1) + (-(f(9)/2._/**/REALKIND) * den(5)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,13),T3sum(1:35,3))
  M(1) = M(1) + (-(f(8)/2._/**/REALKIND) * den(5)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,14),T3sum(1:35,1))
  M(1) = M(1) + (-(f(9)/2._/**/REALKIND) * den(5)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,15),T3sum(1:35,3))
  M(1) = M(1) + (-(f(8)/2._/**/REALKIND) * den(5)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,16),T3sum(1:35,2))
  M(1) = M(1) + (-(f(9)/2._/**/REALKIND) * den(5)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,17),T3sum(1:35,3))
  M(1) = M(1) + (-(f(8)/2._/**/REALKIND) * den(5)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,18),T3sum(1:35,2))
  M(1) = M(1) + (-(f(7)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_4,masses2_8,G4tensor(:,1),T4sum(1:70,1))
  M(1) = M(1) + (-(f(6)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_4,masses2_5,G4tensor(:,2),T4sum(1:70,2))
  M(1) = M(1) + (-(f(7)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_4,masses2_8,G4tensor(:,3),T4sum(1:70,1))
  M(1) = M(1) + (-(f(6)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,4),T4sum(1:70,3))
  M(1) = M(1) + (-(f(7)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_8,G4tensor(:,5),T4sum(1:70,4))
  M(1) = M(1) + (-(f(6)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_5,G4tensor(:,7),T4sum(1:70,5))
  M(1) = M(1) + (-(f(7)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_8,G4tensor(:,9),T4sum(1:70,4))
  M(1) = M(1) + (-(f(6)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_2,masses2_6,G4tensor(:,11),T4sum(1:70,6))
  M(1) = M(1) + (-(f(7)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_3,masses2_8,G4tensor(:,10),T4sum(1:70,7))
  M(1) = M(1) + (-(f(6)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_3,masses2_7,G4tensor(:,12),T4sum(1:70,8))
  M(1) = M(1) + (-(f(7)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_3,masses2_8,G4tensor(:,6),T4sum(1:70,7))
  M(1) = M(1) + (-(f(6)/2._/**/REALKIND) * den(1)) * TI2_call(4,momenta_3,masses2_4,G4tensor(:,8),T4sum(1:70,9))
...
end module ol_vamp_1_ppvvj2_uuxwwxg_1_/**/REALKIND
