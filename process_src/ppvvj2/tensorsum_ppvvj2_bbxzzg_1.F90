...
! **********************************************************************
module ol_tensor_sum_storage_ppvvj2_bbxzzg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppvvj2_bbxzzg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppvvj2_bbxzzg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppvvj2_bbxzzg_1, only: channel_number_ppvvj2_bbxzzg_1
  ...
  call channel_on(channel_number_ppvvj2_bbxzzg_1)
  M2 = 0
  ...
  call tensor_integral(4, momenta_4, masses2_3, T4sum(:,3))
  call tensor_integral(4, momenta_2, masses2_5, T4sum(:,4))
  call tensor_integral(4, momenta_2, masses2_4, T4sum(:,5))
  call tensor_integral(4, momenta_2, masses2_3, T4sum(:,6))
  call tensor_integral(4, momenta_3, masses2_5, T4sum(:,7))
  call tensor_integral(4, momenta_3, masses2_4, T4sum(:,8))
  call tensor_integral(4, momenta_3, masses2_3, T4sum(:,9))

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppvvj2_bbxzzg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppvvj2_bbxzzg_1_/**/REALKIND
