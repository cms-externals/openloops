...
module ol_versiondata_pplla2
  implicit none
  character(4) :: generator_revision = "4051"
  interface
    subroutine version_pplla2(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplla2
  end interface
end module ol_versiondata_pplla2


subroutine ol_version_pplla2(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplla2, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplla2
