...
module ol_colourmatrix_pplla2_nenexagg_1_/**/REALKIND
...
end module ol_colourmatrix_pplla2_nenexagg_1_/**/REALKIND



module ol_forced_parameters_pplla2_nenexagg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplla2_nenexagg_1_/**/REALKIND

module ol_loop_pplla2_nenexagg_1_/**/REALKIND
  ...
  complex(REALKIND), save :: M0(0,32), Mct(1,32), Mcol_loop(1,32)
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (eQED**3*gQCD**2*integralnorm*SwF)/3._/**/REALKIND
    f(3) = (2*eQED**3*gQCD**2*integralnorm*SwF)/3._/**/REALKIND
    f(4) = (4*eQED**3*gQCD**2*integralnorm*SwF)/3._/**/REALKIND
...
end module ol_loop_pplla2_nenexagg_1_/**/REALKIND
