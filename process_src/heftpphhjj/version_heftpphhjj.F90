...
module ol_versiondata_heftpphhjj
  implicit none
  character(4) :: generator_revision = "2905"
  interface
    subroutine version_heftpphhjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_heftpphhjj
  end interface
end module ol_versiondata_heftpphhjj


subroutine ol_version_heftpphhjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_heftpphhjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_heftpphhjj
