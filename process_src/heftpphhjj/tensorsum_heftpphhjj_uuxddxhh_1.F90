...
! **********************************************************************
module ol_tensor_sum_storage_heftpphhjj_uuxddxhh_1_/**/REALKIND
! **********************************************************************
  ...
  complex(REALKIND), save :: T2sum(15,7) = 0
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_heftpphhjj_uuxddxhh_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_heftpphhjj_uuxddxhh_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_heftpphhjj_uuxddxhh_1, only: channel_number_heftpphhjj_uuxddxhh_1
  ...
  call channel_on(channel_number_heftpphhjj_uuxddxhh_1)
  M2 = 0
  ...
  momenta_15(:,3) = Q(1:4,62)
  momenta_16(:,1) = Q(1:4,48)
  momenta_16(:,2) = Q(1:4,50)
  ...
  call TI_call(2, momenta_11, masses2_2, T2sum(:,1), M2)
  call TI_call(2, momenta_12, masses2_2, T2sum(:,2), M2)
  call TI_call(2, momenta_5, masses2_2, T2sum(:,3), M2)
  call TI_call(2, momenta_4, masses2_2, T2sum(:,4), M2)
  call TI_call(2, momenta_1, masses2_1, T2sum(:,5), M2)
  call TI_call(2, momenta_3, masses2_1, T2sum(:,6), M2)
  call TI_call(2, momenta_2, masses2_1, T2sum(:,7), M2)

  call TI_call(3, momenta_7, masses2_2, T3sum(:,1), M2)
  call TI_call(3, momenta_8, masses2_2, T3sum(:,2), M2)
  call TI_call(3, momenta_9, masses2_2, T3sum(:,3), M2)
  call TI_call(3, momenta_10, masses2_2, T3sum(:,4), M2)

  call TI_call(4, momenta_6, masses2_2, T4sum(:,1), M2)
  call TI_call(4, momenta_13, masses2_3, T4sum(:,2), M2)
  call TI_call(4, momenta_14, masses2_3, T4sum(:,3), M2)
  call TI_call(4, momenta_17, masses2_3, T4sum(:,4), M2)
  call TI_call(4, momenta_15, masses2_3, T4sum(:,5), M2)
  call TI_call(4, momenta_18, masses2_3, T4sum(:,6), M2)
  call TI_call(4, momenta_16, masses2_3, T4sum(:,7), M2)
  call TI_call(4, momenta_19, masses2_4, T4sum(:,8), M2)
  call TI_call(4, momenta_20, masses2_4, T4sum(:,9), M2)
  call TI_call(4, momenta_22, masses2_4, T4sum(:,10), M2)
  call TI_call(4, momenta_21, masses2_4, T4sum(:,11), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_heftpphhjj_uuxddxhh_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_heftpphhjj_uuxddxhh_1_/**/REALKIND
