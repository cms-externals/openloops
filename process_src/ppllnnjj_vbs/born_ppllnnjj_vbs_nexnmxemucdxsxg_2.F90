...
module ol_colourmatrix_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND
...
end module ol_colourmatrix_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND



module ol_forced_parameters_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND

module ol_tree_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllnnjj_vbs_nexnmxemucdxsxg_2")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/DREALKIND, only: &
    & ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for anti-nu_e anti-nu_mu e- mu- up charm anti-down anti-strange glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppllnnjj_vbs_nexnmxemucdxsxg_2, only: &
    & external_perm_ppllnnjj_vbs_nexnmxemucdxsxg_2, &
    & external_perm_inv_ppllnnjj_vbs_nexnmxemucdxsxg_2, &
    & extcomb_perm_ppllnnjj_vbs_nexnmxemucdxsxg_2, &
    & average_factor_ppllnnjj_vbs_nexnmxemucdxsxg_2
  use ol_external_ppllnnjj_vbs_nexnmxemucdxsxg_2, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_ppllnnjj_vbs_nexnmxemucdxsxg_2
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_ppllnnjj_vbs_nexnmxemucdxsxg_2,9)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllnnjj_vbs_nexnmxemucdxsxg_2(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllnnjj_vbs_nexnmxemucdxsxg_2(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllnnjj_vbs_nexnmxemucdxsxg_2(extcombs(k))
  end do
  ...
  call vert_QA_W(ntry, ex6, ex8, wf4(:,12), n3(:,9), t3x4(:,:,7))
  call prop_Q_A(ntry, wf4(:,11), Q(:,272), ZERO, 0_intkind1, wf4(:,13), n2(8))
  call prop_W_W(ntry, wf4(:,12), Q(:,160), MW, 1_intkind1, wf4(:,14), n2(9))
  call vert_QA_W(ntry, wf4(:,13), ex7, wf8(:,5), n3(:,10), t3x8(:,:,3))
  call vert_WWV_V(ntry, wf4(:,6), wf4(:,7), wf4(:,14), wf64(:,2), n4(:,2), t4x64(:,:,2))
  call prop_W_W(ntry, wf8(:,5), Q(:,336), MW, 1_intkind1, wf8(:,6), n2(10))
  call vert_AV_Q(ntry, ex7, ex9, wf4(:,15), n3(:,11), t3x4(:,:,8))
  call prop_A_Q(ntry, wf4(:,15), Q(:,320), ZERO, 0_intkind1, wf4(:,16), n2(11))
  call vert_QA_W(ntry, ex5, wf4(:,16), wf8(:,7), n3(:,12), t3x8(:,:,4))
  call prop_W_W(ntry, wf8(:,7), Q(:,336), MW, 1_intkind1, wf8(:,8), n2(12))
  call vert_AW_Q(ntry, ex8, wf4(:,6), wf8(:,9), n3(:,13), t3x8(:,:,5))
  call vert_UV_W(ntry, wf4(:,8), Q(:,80), wf4(:,7), Q(:,10), wf16(:,1), n3(:,14), t3x16(:,:,1))
  call prop_A_Q(ntry, wf8(:,9), Q(:,133), ZERO, 0_intkind1, wf8(:,10), n2(13))
  call vert_QA_V(ntry, wf4(:,5), wf8(:,10), wf32(:,1), n3(:,15), t3x32(:,:,1))
  call prop_W_W(ntry, wf16(:,1), Q(:,90), MZ, 1_intkind1, wf16(:,2), n2(14))
  call vert_QA_Z(gZu,ntry, wf4(:,5), wf8(:,10), wf32(:,2), n3(:,16), t3x32(:,:,2))
  call vert_WQ_A(ntry, wf4(:,7), wf4(:,5), wf16(:,3), n3(:,17), t3x16(:,:,2))
  call prop_Q_A(ntry, wf16(:,3), Q(:,298), ZERO, 0_intkind1, wf16(:,4), n2(15))
  call vert_AW_Q(ntry, wf8(:,10), wf4(:,8), wf32(:,3), n3(:,18), t3x32(:,:,3))
  call vert_AW_Q(ntry, ex8, wf4(:,7), wf8(:,11), n3(:,19), t3x8(:,:,6))
  call vert_UV_W(ntry, wf4(:,8), Q(:,80), wf4(:,6), Q(:,5), wf16(:,5), n3(:,20), t3x16(:,:,3))
  call prop_A_Q(ntry, wf8(:,11), Q(:,138), ZERO, 0_intkind1, wf8(:,12), n2(16))
  call vert_QA_V(ntry, wf4(:,5), wf8(:,12), wf32(:,4), n3(:,21), t3x32(:,:,4))
  call prop_W_W(ntry, wf16(:,5), Q(:,85), MZ, 1_intkind1, wf16(:,6), n2(17))
  call vert_QA_Z(gZu,ntry, wf4(:,5), wf8(:,12), wf32(:,5), n3(:,22), t3x32(:,:,5))
  call vert_WQ_A(ntry, wf4(:,6), wf4(:,5), wf16(:,7), n3(:,23), t3x16(:,:,4))
  call prop_Q_A(ntry, wf16(:,7), Q(:,293), ZERO, 0_intkind1, wf16(:,8), n2(18))
  call vert_AW_Q(ntry, wf8(:,12), wf4(:,8), wf32(:,6), n3(:,24), t3x32(:,:,6))
  call vert_VV_S(ntry, wf4(:,6), wf4(:,8), wf16(:,9), n3(:,25), t3x16(:,:,5))
  call vert_VV_S(ntry, wf4(:,7), wf8(:,2), wf32(:,7), n3(:,26), t3x32(:,:,7))
  call vert_UV_W(ntry, wf8(:,2), Q(:,416), wf4(:,7), Q(:,10), wf32(:,8), n3(:,27), t3x32(:,:,8))
  call vert_AV_Q(ntry, ex8, wf16(:,5), wf32(:,9), n3(:,28), t3x32(:,:,9))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,6), wf32(:,10), n3(:,29), t3x32(:,:,10))
  call vert_VV_S(ntry, wf4(:,7), wf4(:,8), wf16(:,10), n3(:,30), t3x16(:,:,6))
  call vert_VV_S(ntry, wf4(:,6), wf8(:,2), wf32(:,11), n3(:,31), t3x32(:,:,11))
  call vert_UV_W(ntry, wf8(:,2), Q(:,416), wf4(:,6), Q(:,5), wf32(:,12), n3(:,32), t3x32(:,:,12))
  call vert_QA_V(ntry, wf16(:,8), ex8, wf32(:,13), n3(:,33), t3x32(:,:,13))
  call vert_QA_Z(gZd,ntry, wf16(:,8), ex8, wf32(:,14), n3(:,34), t3x32(:,:,14))
  call vert_WQ_A(ntry, wf4(:,6), ex6, wf8(:,13), n3(:,35), t3x8(:,:,7))
  call prop_Q_A(ntry, wf8(:,13), Q(:,37), ZERO, 0_intkind1, wf8(:,14), n2(19))
  call vert_QA_V(ntry, wf8(:,14), wf4(:,10), wf32(:,15), n3(:,36), t3x32(:,:,15))
  call vert_QA_Z(gZd,ntry, wf8(:,14), wf4(:,10), wf32(:,16), n3(:,37), t3x32(:,:,16))
  call vert_AW_Q(ntry, wf4(:,10), wf4(:,7), wf16(:,11), n3(:,38), t3x16(:,:,7))
  call prop_A_Q(ntry, wf16(:,11), Q(:,394), ZERO, 0_intkind1, wf16(:,12), n2(20))
  call vert_WQ_A(ntry, wf4(:,8), wf8(:,14), wf32(:,17), n3(:,39), t3x32(:,:,17))
  call vert_WQ_A(ntry, wf4(:,7), ex6, wf8(:,15), n3(:,40), t3x8(:,:,8))
  call prop_Q_A(ntry, wf8(:,15), Q(:,42), ZERO, 0_intkind1, wf8(:,16), n2(21))
  call vert_QA_V(ntry, wf8(:,16), wf4(:,10), wf32(:,18), n3(:,41), t3x32(:,:,18))
  call vert_QA_Z(gZd,ntry, wf8(:,16), wf4(:,10), wf32(:,19), n3(:,42), t3x32(:,:,19))
  call vert_AW_Q(ntry, wf4(:,10), wf4(:,6), wf16(:,13), n3(:,43), t3x16(:,:,8))
  call prop_A_Q(ntry, wf16(:,13), Q(:,389), ZERO, 0_intkind1, wf16(:,14), n2(22))
  call vert_WQ_A(ntry, wf4(:,8), wf8(:,16), wf32(:,20), n3(:,44), t3x32(:,:,20))
  call vert_VV_S(ntry, wf4(:,7), wf8(:,4), wf32(:,21), n3(:,45), t3x32(:,:,21))
  call vert_UV_W(ntry, wf8(:,4), Q(:,416), wf4(:,7), Q(:,10), wf32(:,22), n3(:,46), t3x32(:,:,22))
  call vert_VQ_A(ntry, wf16(:,5), ex6, wf32(:,23), n3(:,47), t3x32(:,:,23))
  call vert_ZQ_A(gZu,ntry, wf16(:,6), ex6, wf32(:,24), n3(:,48), t3x32(:,:,24))
  call vert_VV_S(ntry, wf4(:,6), wf8(:,4), wf32(:,25), n3(:,49), t3x32(:,:,25))
  call vert_UV_W(ntry, wf8(:,4), Q(:,416), wf4(:,6), Q(:,5), wf32(:,26), n3(:,50), t3x32(:,:,26))
  call vert_QA_V(ntry, ex6, wf16(:,14), wf32(:,27), n3(:,51), t3x32(:,:,27))
  call vert_QA_Z(gZu,ntry, ex6, wf16(:,14), wf32(:,28), n3(:,52), t3x32(:,:,28))
  call vert_VQ_A(ntry, ex9, wf8(:,14), wf16(:,15), n3(:,53), t3x16(:,:,9))
  call prop_Q_A(ntry, wf16(:,15), Q(:,293), ZERO, 0_intkind1, wf16(:,16), n2(23))
  call vert_AV_Q(ntry, wf8(:,12), ex9, wf16(:,17), n3(:,54), t3x16(:,:,10))
  call prop_A_Q(ntry, wf16(:,17), Q(:,394), ZERO, 0_intkind1, wf16(:,18), n2(24))
  call vert_AV_Q(ntry, ex8, wf16(:,1), wf32(:,29), n3(:,55), t3x32(:,:,29))
  call prop_A_Q(ntry, wf32(:,29), Q(:,218), ZERO, 0_intkind1, wf32(:,30), n2(25))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,2), wf32(:,31), n3(:,56), t3x32(:,:,30))
  call prop_A_Q(ntry, wf32(:,31), Q(:,218), ZERO, 0_intkind1, wf32(:,32), n2(26))
  call vert_VQ_A(ntry, ex9, wf8(:,16), wf16(:,19), n3(:,57), t3x16(:,:,11))
  call prop_Q_A(ntry, wf16(:,19), Q(:,298), ZERO, 0_intkind1, wf16(:,20), n2(27))
  call vert_AV_Q(ntry, wf8(:,10), ex9, wf16(:,21), n3(:,58), t3x16(:,:,12))
  call prop_A_Q(ntry, wf16(:,21), Q(:,389), ZERO, 0_intkind1, wf16(:,22), n2(28))
  call vert_VQ_A(ntry, wf16(:,1), ex6, wf32(:,33), n3(:,59), t3x32(:,:,31))
  call prop_Q_A(ntry, wf32(:,33), Q(:,122), ZERO, 0_intkind1, wf32(:,34), n2(29))
  call vert_ZQ_A(gZu,ntry, wf16(:,2), ex6, wf32(:,35), n3(:,60), t3x32(:,:,32))
  call prop_Q_A(ntry, wf32(:,35), Q(:,122), ZERO, 0_intkind1, wf32(:,36), n2(30))
  call prop_A_Q(ntry, wf32(:,9), Q(:,213), ZERO, 0_intkind1, wf32(:,37), n2(31))
  call prop_A_Q(ntry, wf32(:,10), Q(:,213), ZERO, 0_intkind1, wf32(:,38), n2(32))
  call prop_Q_A(ntry, wf32(:,23), Q(:,117), ZERO, 0_intkind1, wf32(:,39), n2(33))
  call prop_Q_A(ntry, wf32(:,24), Q(:,117), ZERO, 0_intkind1, wf32(:,40), n2(34))
  call vert_AW_Q(ntry, ex7, wf4(:,6), wf8(:,17), n3(:,61), t3x8(:,:,9))
  call vert_WQ_A(ntry, wf4(:,7), wf4(:,13), wf16(:,23), n3(:,62), t3x16(:,:,13))
  call prop_A_Q(ntry, wf8(:,17), Q(:,69), ZERO, 0_intkind1, wf8(:,18), n2(35))
  call prop_Q_A(ntry, wf16(:,23), Q(:,282), ZERO, 0_intkind1, wf16(:,24), n2(36))
  call vert_AW_Q(ntry, wf8(:,18), wf4(:,14), wf32(:,41), n3(:,63), t3x32(:,:,33))
  call vert_UV_W(ntry, wf4(:,14), Q(:,160), wf4(:,7), Q(:,10), wf16(:,25), n3(:,64), t3x16(:,:,14))
  call vert_QA_V(ntry, wf4(:,13), wf8(:,18), wf32(:,42), n3(:,65), t3x32(:,:,34))
  call prop_W_W(ntry, wf16(:,25), Q(:,170), MZ, 1_intkind1, wf16(:,26), n2(37))
  call vert_QA_Z(gZu,ntry, wf4(:,13), wf8(:,18), wf32(:,43), n3(:,66), t3x32(:,:,35))
  call vert_AW_Q(ntry, ex7, wf4(:,7), wf8(:,19), n3(:,67), t3x8(:,:,10))
  call vert_WQ_A(ntry, wf4(:,6), wf4(:,13), wf16(:,27), n3(:,68), t3x16(:,:,15))
  call prop_A_Q(ntry, wf8(:,19), Q(:,74), ZERO, 0_intkind1, wf8(:,20), n2(38))
  call prop_Q_A(ntry, wf16(:,27), Q(:,277), ZERO, 0_intkind1, wf16(:,28), n2(39))
  call vert_AW_Q(ntry, wf8(:,20), wf4(:,14), wf32(:,44), n3(:,69), t3x32(:,:,36))
  call vert_UV_W(ntry, wf4(:,14), Q(:,160), wf4(:,6), Q(:,5), wf16(:,29), n3(:,70), t3x16(:,:,16))
  call vert_QA_V(ntry, wf4(:,13), wf8(:,20), wf32(:,45), n3(:,71), t3x32(:,:,37))
  call prop_W_W(ntry, wf16(:,29), Q(:,165), MZ, 1_intkind1, wf16(:,30), n2(40))
  call vert_QA_Z(gZu,ntry, wf4(:,13), wf8(:,20), wf32(:,46), n3(:,72), t3x32(:,:,38))
  call vert_VV_S(ntry, wf4(:,6), wf4(:,14), wf16(:,31), n3(:,73), t3x16(:,:,17))
  call vert_VV_S(ntry, wf4(:,7), wf8(:,6), wf32(:,47), n3(:,74), t3x32(:,:,39))
  call vert_UV_W(ntry, wf8(:,6), Q(:,336), wf4(:,7), Q(:,10), wf32(:,48), n3(:,75), t3x32(:,:,40))
  call vert_VV_S(ntry, wf4(:,7), wf4(:,14), wf16(:,32), n3(:,76), t3x16(:,:,18))
  call vert_VV_S(ntry, wf4(:,6), wf8(:,6), wf32(:,49), n3(:,77), t3x32(:,:,41))
  call vert_UV_W(ntry, wf8(:,6), Q(:,336), wf4(:,6), Q(:,5), wf32(:,50), n3(:,78), t3x32(:,:,42))
  call vert_QA_V(ntry, wf16(:,28), ex7, wf32(:,51), n3(:,79), t3x32(:,:,43))
  call vert_QA_Z(gZd,ntry, wf16(:,28), ex7, wf32(:,52), n3(:,80), t3x32(:,:,44))
  call vert_AV_Q(ntry, ex7, wf16(:,29), wf32(:,53), n3(:,81), t3x32(:,:,45))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,30), wf32(:,54), n3(:,82), t3x32(:,:,46))
  call vert_WQ_A(ntry, wf4(:,6), ex5, wf8(:,21), n3(:,83), t3x8(:,:,11))
  call prop_Q_A(ntry, wf8(:,21), Q(:,21), ZERO, 0_intkind1, wf8(:,22), n2(41))
  call vert_QA_V(ntry, wf8(:,22), wf4(:,16), wf32(:,55), n3(:,84), t3x32(:,:,47))
  call vert_QA_Z(gZd,ntry, wf8(:,22), wf4(:,16), wf32(:,56), n3(:,85), t3x32(:,:,48))
  call vert_AW_Q(ntry, wf4(:,16), wf4(:,7), wf16(:,33), n3(:,86), t3x16(:,:,19))
  call prop_A_Q(ntry, wf16(:,33), Q(:,330), ZERO, 0_intkind1, wf16(:,34), n2(42))
  call vert_WQ_A(ntry, wf4(:,14), wf8(:,22), wf32(:,57), n3(:,87), t3x32(:,:,49))
  call vert_WQ_A(ntry, wf4(:,7), ex5, wf8(:,23), n3(:,88), t3x8(:,:,12))
  call prop_Q_A(ntry, wf8(:,23), Q(:,26), ZERO, 0_intkind1, wf8(:,24), n2(43))
  call vert_QA_V(ntry, wf8(:,24), wf4(:,16), wf32(:,58), n3(:,89), t3x32(:,:,50))
  call vert_QA_Z(gZd,ntry, wf8(:,24), wf4(:,16), wf32(:,59), n3(:,90), t3x32(:,:,51))
  call vert_AW_Q(ntry, wf4(:,16), wf4(:,6), wf16(:,35), n3(:,91), t3x16(:,:,20))
  call prop_A_Q(ntry, wf16(:,35), Q(:,325), ZERO, 0_intkind1, wf16(:,36), n2(44))
  call vert_WQ_A(ntry, wf4(:,14), wf8(:,24), wf32(:,60), n3(:,92), t3x32(:,:,52))
  call vert_VV_S(ntry, wf4(:,6), wf8(:,8), wf32(:,61), n3(:,93), t3x32(:,:,53))
  call vert_UV_W(ntry, wf8(:,8), Q(:,336), wf4(:,6), Q(:,5), wf32(:,62), n3(:,94), t3x32(:,:,54))
  call vert_VV_S(ntry, wf4(:,7), wf8(:,8), wf32(:,63), n3(:,95), t3x32(:,:,55))
  call vert_UV_W(ntry, wf8(:,8), Q(:,336), wf4(:,7), Q(:,10), wf32(:,64), n3(:,96), t3x32(:,:,56))
  call vert_VQ_A(ntry, wf16(:,29), ex5, wf32(:,65), n3(:,97), t3x32(:,:,57))
  call vert_ZQ_A(gZu,ntry, wf16(:,30), ex5, wf32(:,66), n3(:,98), t3x32(:,:,58))
  call vert_QA_V(ntry, ex5, wf16(:,36), wf32(:,67), n3(:,99), t3x32(:,:,59))
  call vert_QA_Z(gZu,ntry, ex5, wf16(:,36), wf32(:,68), n3(:,100), t3x32(:,:,60))
  call vert_VQ_A(ntry, ex9, wf8(:,22), wf16(:,37), n3(:,101), t3x16(:,:,21))
  call prop_Q_A(ntry, wf16(:,37), Q(:,277), ZERO, 0_intkind1, wf16(:,38), n2(45))
  call vert_AV_Q(ntry, wf8(:,20), ex9, wf16(:,39), n3(:,102), t3x16(:,:,22))
  call prop_A_Q(ntry, wf16(:,39), Q(:,330), ZERO, 0_intkind1, wf16(:,40), n2(46))
  call vert_AV_Q(ntry, ex7, wf16(:,25), wf32(:,69), n3(:,103), t3x32(:,:,61))
  call prop_A_Q(ntry, wf32(:,69), Q(:,234), ZERO, 0_intkind1, wf32(:,70), n2(47))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,26), wf32(:,71), n3(:,104), t3x32(:,:,62))
  call prop_A_Q(ntry, wf32(:,71), Q(:,234), ZERO, 0_intkind1, wf32(:,72), n2(48))
  call vert_VQ_A(ntry, ex9, wf8(:,24), wf16(:,41), n3(:,105), t3x16(:,:,23))
  call prop_Q_A(ntry, wf16(:,41), Q(:,282), ZERO, 0_intkind1, wf16(:,42), n2(49))
  call vert_AV_Q(ntry, wf8(:,18), ex9, wf16(:,43), n3(:,106), t3x16(:,:,24))
  call prop_A_Q(ntry, wf16(:,43), Q(:,325), ZERO, 0_intkind1, wf16(:,44), n2(50))
  call vert_VQ_A(ntry, wf16(:,25), ex5, wf32(:,73), n3(:,107), t3x32(:,:,63))
  call prop_Q_A(ntry, wf32(:,73), Q(:,186), ZERO, 0_intkind1, wf32(:,74), n2(51))
  call vert_ZQ_A(gZu,ntry, wf16(:,26), ex5, wf32(:,75), n3(:,108), t3x32(:,:,64))
  call prop_Q_A(ntry, wf32(:,75), Q(:,186), ZERO, 0_intkind1, wf32(:,76), n2(52))
  ...
  call prop_Q_A(ntry, wf32(:,65), Q(:,181), ZERO, 0_intkind1, wf32(:,79), n2(55))
  call prop_Q_A(ntry, wf32(:,66), Q(:,181), ZERO, 0_intkind1, wf32(:,80), n2(56))
  call vert_QA_V(ntry, wf8(:,14), ex8, wf16(:,45), n3(:,109), t3x16(:,:,25))
  call vert_QA_Z(gZd,ntry, wf8(:,14), ex8, wf16(:,46), n3(:,110), t3x16(:,:,26))
  call prop_W_W(ntry, wf16(:,46), Q(:,165), MZ, 1_intkind1, wf16(:,47), n2(57))
  call vert_WQ_A(ntry, wf8(:,6), wf8(:,14), wf64(:,3), n3(:,111), t3x64(:,:,1))
  call vert_QA_V(ntry, wf16(:,24), ex7, wf32(:,81), n3(:,112), t3x32(:,:,65))
  call vert_QA_Z(gZd,ntry, wf16(:,24), ex7, wf32(:,82), n3(:,113), t3x32(:,:,66))
  call prop_W_W(ntry, wf32(:,82), Q(:,346), MZ, 1_intkind1, wf32(:,83), n2(58))
  call vert_QA_V(ntry, wf8(:,16), ex8, wf16(:,48), n3(:,114), t3x16(:,:,27))
  call vert_QA_Z(gZd,ntry, wf8(:,16), ex8, wf16(:,49), n3(:,115), t3x16(:,:,28))
  call prop_W_W(ntry, wf16(:,49), Q(:,170), MZ, 1_intkind1, wf16(:,50), n2(59))
  call vert_QA_V(ntry, ex6, wf8(:,12), wf16(:,51), n3(:,116), t3x16(:,:,29))
  call vert_QA_Z(gZu,ntry, ex6, wf8(:,12), wf16(:,52), n3(:,117), t3x16(:,:,30))
  call prop_W_W(ntry, wf16(:,52), Q(:,170), MZ, 1_intkind1, wf16(:,53), n2(60))
  call vert_WQ_A(ntry, wf8(:,6), wf8(:,16), wf64(:,4), n3(:,118), t3x64(:,:,2))
  call vert_QA_V(ntry, ex6, wf8(:,10), wf16(:,54), n3(:,119), t3x16(:,:,31))
  call vert_QA_Z(gZu,ntry, ex6, wf8(:,10), wf16(:,55), n3(:,120), t3x16(:,:,32))
  call prop_W_W(ntry, wf16(:,55), Q(:,165), MZ, 1_intkind1, wf16(:,56), n2(61))
  call prop_W_W(ntry, wf32(:,52), Q(:,341), MZ, 1_intkind1, wf32(:,84), n2(62))
  call vert_QA_W(ntry, wf8(:,22), wf8(:,20), wf64(:,5), n3(:,121), t3x64(:,:,3))
  call vert_QA_V(ntry, wf8(:,22), ex7, wf16(:,57), n3(:,122), t3x16(:,:,33))
  call vert_QA_Z(gZd,ntry, wf8(:,22), ex7, wf16(:,58), n3(:,123), t3x16(:,:,34))
  call prop_W_W(ntry, wf16(:,58), Q(:,85), MZ, 1_intkind1, wf16(:,59), n2(63))
  call vert_QA_V(ntry, wf16(:,4), ex8, wf32(:,85), n3(:,124), t3x32(:,:,67))
  call vert_QA_Z(gZd,ntry, wf16(:,4), ex8, wf32(:,86), n3(:,125), t3x32(:,:,68))
  call vert_QA_W(ntry, wf8(:,24), wf8(:,18), wf64(:,6), n3(:,126), t3x64(:,:,4))
  call vert_QA_V(ntry, ex5, wf8(:,18), wf16(:,60), n3(:,127), t3x16(:,:,35))
  call vert_QA_Z(gZu,ntry, ex5, wf8(:,18), wf16(:,61), n3(:,128), t3x16(:,:,36))
  call prop_W_W(ntry, wf16(:,61), Q(:,85), MZ, 1_intkind1, wf16(:,62), n2(64))
  call vert_QA_V(ntry, wf8(:,24), ex7, wf16(:,63), n3(:,129), t3x16(:,:,37))
  call vert_QA_Z(gZd,ntry, wf8(:,24), ex7, wf16(:,64), n3(:,130), t3x16(:,:,38))
  call prop_W_W(ntry, wf16(:,64), Q(:,90), MZ, 1_intkind1, wf16(:,65), n2(65))
  call vert_QA_V(ntry, ex5, wf8(:,20), wf16(:,66), n3(:,131), t3x16(:,:,39))
  call vert_QA_Z(gZu,ntry, ex5, wf8(:,20), wf16(:,67), n3(:,132), t3x16(:,:,40))
  call prop_W_W(ntry, wf16(:,67), Q(:,90), MZ, 1_intkind1, wf16(:,68), n2(66))
  call vert_WQ_A(ntry, wf8(:,8), wf8(:,14), wf64(:,7), n3(:,133), t3x64(:,:,5))
  call vert_QA_V(ntry, ex5, wf16(:,34), wf32(:,87), n3(:,134), t3x32(:,:,69))
  call vert_QA_Z(gZu,ntry, ex5, wf16(:,34), wf32(:,88), n3(:,135), t3x32(:,:,70))
  call prop_W_W(ntry, wf32(:,88), Q(:,346), MZ, 1_intkind1, wf32(:,89), n2(67))
  call vert_WQ_A(ntry, wf8(:,8), wf8(:,16), wf64(:,8), n3(:,136), t3x64(:,:,6))
  call prop_W_W(ntry, wf32(:,68), Q(:,341), MZ, 1_intkind1, wf32(:,90), n2(68))
  call vert_WQ_A(ntry, wf8(:,4), wf8(:,22), wf64(:,9), n3(:,137), t3x64(:,:,7))
  call vert_QA_V(ntry, ex6, wf16(:,12), wf32(:,91), n3(:,138), t3x32(:,:,71))
  call vert_QA_Z(gZu,ntry, ex6, wf16(:,12), wf32(:,92), n3(:,139), t3x32(:,:,72))
  call prop_W_W(ntry, wf32(:,92), Q(:,426), MZ, 1_intkind1, wf32(:,93), n2(69))
  call vert_WQ_A(ntry, wf8(:,4), wf8(:,24), wf64(:,10), n3(:,140), t3x64(:,:,8))
  call prop_W_W(ntry, wf32(:,28), Q(:,421), MZ, 1_intkind1, wf32(:,94), n2(70))
  call vert_AV_Q(ntry, ex8, wf16(:,57), wf32(:,95), n3(:,141), t3x32(:,:,73))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,59), wf32(:,96), n3(:,142), t3x32(:,:,74))
  call vert_AV_Q(ntry, ex7, wf16(:,48), wf32(:,97), n3(:,143), t3x32(:,:,75))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,50), wf32(:,98), n3(:,144), t3x32(:,:,76))
  call vert_VQ_A(ntry, wf16(:,57), ex6, wf32(:,99), n3(:,145), t3x32(:,:,77))
  call vert_ZQ_A(gZu,ntry, wf16(:,59), ex6, wf32(:,100), n3(:,146), t3x32(:,:,78))
  call vert_AV_Q(ntry, ex7, wf16(:,51), wf32(:,101), n3(:,147), t3x32(:,:,79))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,53), wf32(:,102), n3(:,148), t3x32(:,:,80))
  call vert_AV_Q(ntry, ex8, wf16(:,63), wf32(:,103), n3(:,149), t3x32(:,:,81))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,65), wf32(:,104), n3(:,150), t3x32(:,:,82))
  call vert_AV_Q(ntry, ex7, wf16(:,45), wf32(:,105), n3(:,151), t3x32(:,:,83))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,47), wf32(:,106), n3(:,152), t3x32(:,:,84))
  call vert_AV_Q(ntry, ex8, wf16(:,66), wf32(:,107), n3(:,153), t3x32(:,:,85))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,68), wf32(:,108), n3(:,154), t3x32(:,:,86))
  call vert_VQ_A(ntry, wf16(:,45), ex5, wf32(:,109), n3(:,155), t3x32(:,:,87))
  call vert_ZQ_A(gZu,ntry, wf16(:,47), ex5, wf32(:,110), n3(:,156), t3x32(:,:,88))
  call vert_AV_Q(ntry, ex8, wf16(:,60), wf32(:,111), n3(:,157), t3x32(:,:,89))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,62), wf32(:,112), n3(:,158), t3x32(:,:,90))
  call vert_VQ_A(ntry, wf16(:,48), ex5, wf32(:,113), n3(:,159), t3x32(:,:,91))
  call vert_ZQ_A(gZu,ntry, wf16(:,50), ex5, wf32(:,114), n3(:,160), t3x32(:,:,92))
  call vert_VQ_A(ntry, wf16(:,60), ex6, wf32(:,115), n3(:,161), t3x32(:,:,93))
  call vert_ZQ_A(gZu,ntry, wf16(:,62), ex6, wf32(:,116), n3(:,162), t3x32(:,:,94))
  call vert_VQ_A(ntry, wf16(:,51), ex5, wf32(:,117), n3(:,163), t3x32(:,:,95))
  call vert_ZQ_A(gZu,ntry, wf16(:,53), ex5, wf32(:,118), n3(:,164), t3x32(:,:,96))
  call vert_VQ_A(ntry, wf16(:,63), ex6, wf32(:,119), n3(:,165), t3x32(:,:,97))
  call vert_ZQ_A(gZu,ntry, wf16(:,65), ex6, wf32(:,120), n3(:,166), t3x32(:,:,98))
  call vert_AV_Q(ntry, ex7, wf16(:,54), wf32(:,121), n3(:,167), t3x32(:,:,99))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,56), wf32(:,122), n3(:,168), t3x32(:,:,100))
  call vert_VQ_A(ntry, wf16(:,66), ex6, wf32(:,123), n3(:,169), t3x32(:,:,101))
  call vert_ZQ_A(gZu,ntry, wf16(:,68), ex6, wf32(:,124), n3(:,170), t3x32(:,:,102))
  call vert_VQ_A(ntry, wf16(:,54), ex5, wf32(:,125), n3(:,171), t3x32(:,:,103))
  call vert_ZQ_A(gZu,ntry, wf16(:,56), ex5, wf32(:,126), n3(:,172), t3x32(:,:,104))
  call vert_AW_Q(ntry, ex2, wf4(:,8), wf8(:,25), n3(:,173), t3x8(:,:,13))
  call prop_A_Q(ntry, wf8(:,25), Q(:,82), ZERO, 0_intkind1, wf8(:,26), n2(71))
  call vert_QA_V(ntry, ex4, wf8(:,26), wf16(:,69), n3(:,174), t3x16(:,:,41))
  call vert_QA_Z(gZl,ntry, ex4, wf8(:,26), wf16(:,70), n3(:,175), t3x16(:,:,42))
  call prop_W_W(ntry, wf16(:,70), Q(:,90), MZ, 1_intkind1, wf16(:,71), n2(72))
  call vert_WQ_A(ntry, wf4(:,8), ex4, wf8(:,27), n3(:,176), t3x8(:,:,14))
  call prop_Q_A(ntry, wf8(:,27), Q(:,88), ZERO, 0_intkind1, wf8(:,28), n2(73))
  call vert_QA_Z(gZn,ntry, wf8(:,28), ex2, wf16(:,72), n3(:,177), t3x16(:,:,43))
  call prop_W_W(ntry, wf16(:,72), Q(:,90), MZ, 1_intkind1, wf16(:,73), n2(74))
  call vert_AW_Q(ntry, ex2, wf8(:,2), wf16(:,74), n3(:,178), t3x16(:,:,44))
  call vert_VQ_A(ntry, wf16(:,5), ex4, wf32(:,127), n3(:,179), t3x32(:,:,105))
  call prop_A_Q(ntry, wf16(:,74), Q(:,418), ZERO, 0_intkind1, wf16(:,75), n2(75))
  call vert_ZQ_A(gZl,ntry, wf16(:,6), ex4, wf32(:,128), n3(:,180), t3x32(:,:,106))
  call vert_AZ_Q(gZn,ntry, ex2, wf16(:,6), wf32(:,129), n3(:,181), t3x32(:,:,107))
  call vert_WQ_A(ntry, wf8(:,2), ex4, wf16(:,76), n3(:,182), t3x16(:,:,45))
  call prop_A_Q(ntry, wf32(:,129), Q(:,87), ZERO, 0_intkind1, wf32(:,130), n2(76))
  call vert_AW_Q(ntry, wf8(:,26), wf4(:,6), wf32(:,131), n3(:,183), t3x32(:,:,108))
  call prop_Q_A(ntry, wf16(:,76), Q(:,424), ZERO, 0_intkind1, wf16(:,77), n2(77))
  call vert_WQ_A(ntry, wf4(:,6), wf8(:,28), wf32(:,132), n3(:,184), t3x32(:,:,109))
  call vert_AW_Q(ntry, ex2, wf8(:,4), wf16(:,78), n3(:,185), t3x16(:,:,46))
  call prop_A_Q(ntry, wf16(:,78), Q(:,418), ZERO, 0_intkind1, wf16(:,79), n2(78))
  call vert_WQ_A(ntry, wf8(:,4), ex4, wf16(:,80), n3(:,186), t3x16(:,:,47))
  call prop_Q_A(ntry, wf16(:,80), Q(:,424), ZERO, 0_intkind1, wf16(:,81), n2(79))
  call vert_AV_Q(ntry, ex8, wf16(:,69), wf32(:,133), n3(:,187), t3x32(:,:,110))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,71), wf32(:,134), n3(:,188), t3x32(:,:,111))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,73), wf32(:,135), n3(:,189), t3x32(:,:,112))
  call vert_VQ_A(ntry, wf16(:,69), ex6, wf32(:,136), n3(:,190), t3x32(:,:,113))
  call vert_ZQ_A(gZu,ntry, wf16(:,71), ex6, wf32(:,137), n3(:,191), t3x32(:,:,114))
  call vert_ZQ_A(gZu,ntry, wf16(:,73), ex6, wf32(:,138), n3(:,192), t3x32(:,:,115))
  call vert_AW_Q(ntry, ex2, wf4(:,14), wf8(:,29), n3(:,193), t3x8(:,:,15))
  call prop_A_Q(ntry, wf8(:,29), Q(:,162), ZERO, 0_intkind1, wf8(:,30), n2(80))
  call vert_QA_V(ntry, ex4, wf8(:,30), wf16(:,82), n3(:,194), t3x16(:,:,48))
  call vert_QA_Z(gZl,ntry, ex4, wf8(:,30), wf16(:,83), n3(:,195), t3x16(:,:,49))
  call prop_W_W(ntry, wf16(:,83), Q(:,170), MZ, 1_intkind1, wf16(:,84), n2(81))
  call vert_WQ_A(ntry, wf4(:,14), ex4, wf8(:,31), n3(:,196), t3x8(:,:,16))
  call prop_Q_A(ntry, wf8(:,31), Q(:,168), ZERO, 0_intkind1, wf8(:,32), n2(82))
  call vert_QA_Z(gZn,ntry, wf8(:,32), ex2, wf16(:,85), n3(:,197), t3x16(:,:,50))
  call prop_W_W(ntry, wf16(:,85), Q(:,170), MZ, 1_intkind1, wf16(:,86), n2(83))
  call vert_AW_Q(ntry, ex2, wf8(:,6), wf16(:,87), n3(:,198), t3x16(:,:,51))
  call vert_VQ_A(ntry, wf16(:,29), ex4, wf32(:,139), n3(:,199), t3x32(:,:,116))
  call prop_A_Q(ntry, wf16(:,87), Q(:,338), ZERO, 0_intkind1, wf16(:,88), n2(84))
  call vert_ZQ_A(gZl,ntry, wf16(:,30), ex4, wf32(:,140), n3(:,200), t3x32(:,:,117))
  call vert_AZ_Q(gZn,ntry, ex2, wf16(:,30), wf32(:,141), n3(:,201), t3x32(:,:,118))
  call vert_WQ_A(ntry, wf8(:,6), ex4, wf16(:,89), n3(:,202), t3x16(:,:,52))
  call prop_A_Q(ntry, wf32(:,141), Q(:,167), ZERO, 0_intkind1, wf32(:,142), n2(85))
  call vert_AW_Q(ntry, wf8(:,30), wf4(:,6), wf32(:,143), n3(:,203), t3x32(:,:,119))
  call prop_Q_A(ntry, wf16(:,89), Q(:,344), ZERO, 0_intkind1, wf16(:,90), n2(86))
  call vert_WQ_A(ntry, wf4(:,6), wf8(:,32), wf32(:,144), n3(:,204), t3x32(:,:,120))
  call vert_AW_Q(ntry, ex2, wf8(:,8), wf16(:,91), n3(:,205), t3x16(:,:,53))
  call prop_A_Q(ntry, wf16(:,91), Q(:,338), ZERO, 0_intkind1, wf16(:,92), n2(87))
  call vert_WQ_A(ntry, wf8(:,8), ex4, wf16(:,93), n3(:,206), t3x16(:,:,54))
  call prop_Q_A(ntry, wf16(:,93), Q(:,344), ZERO, 0_intkind1, wf16(:,94), n2(88))
  call vert_AV_Q(ntry, ex7, wf16(:,82), wf32(:,145), n3(:,207), t3x32(:,:,121))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,84), wf32(:,146), n3(:,208), t3x32(:,:,122))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,86), wf32(:,147), n3(:,209), t3x32(:,:,123))
  call vert_ZQ_A(gZu,ntry, wf16(:,86), ex5, wf32(:,148), n3(:,210), t3x32(:,:,124))
  call vert_VQ_A(ntry, wf16(:,82), ex5, wf32(:,149), n3(:,211), t3x32(:,:,125))
  call vert_ZQ_A(gZu,ntry, wf16(:,84), ex5, wf32(:,150), n3(:,212), t3x32(:,:,126))
  call vert_QA_V(ntry, ex4, wf16(:,88), wf32(:,151), n3(:,213), t3x32(:,:,127))
  call vert_QA_Z(gZl,ntry, ex4, wf16(:,88), wf32(:,152), n3(:,214), t3x32(:,:,128))
  call vert_QA_Z(gZn,ntry, wf16(:,90), ex2, wf32(:,153), n3(:,215), t3x32(:,:,129))
  call vert_QA_Z(gZn,ntry, wf16(:,77), ex2, wf32(:,154), n3(:,216), t3x32(:,:,130))
  call vert_QA_V(ntry, ex4, wf16(:,75), wf32(:,155), n3(:,217), t3x32(:,:,131))
  call vert_QA_Z(gZl,ntry, ex4, wf16(:,75), wf32(:,156), n3(:,218), t3x32(:,:,132))
  call vert_QA_V(ntry, ex4, wf16(:,92), wf32(:,157), n3(:,219), t3x32(:,:,133))
  call vert_QA_Z(gZl,ntry, ex4, wf16(:,92), wf32(:,158), n3(:,220), t3x32(:,:,134))
  call vert_QA_Z(gZn,ntry, wf16(:,94), ex2, wf32(:,159), n3(:,221), t3x32(:,:,135))
  call vert_QA_V(ntry, ex4, wf16(:,79), wf32(:,160), n3(:,222), t3x32(:,:,136))
  call vert_QA_Z(gZl,ntry, ex4, wf16(:,79), wf32(:,161), n3(:,223), t3x32(:,:,137))
  call vert_QA_Z(gZn,ntry, wf16(:,81), ex2, wf32(:,162), n3(:,224), t3x32(:,:,138))
  call vert_AW_Q(ntry, ex1, wf4(:,8), wf8(:,33), n3(:,225), t3x8(:,:,17))
  call prop_A_Q(ntry, wf8(:,33), Q(:,81), ZERO, 0_intkind1, wf8(:,34), n2(89))
  call vert_QA_V(ntry, ex3, wf8(:,34), wf16(:,95), n3(:,226), t3x16(:,:,55))
  call vert_QA_Z(gZl,ntry, ex3, wf8(:,34), wf16(:,96), n3(:,227), t3x16(:,:,56))
  call prop_W_W(ntry, wf16(:,96), Q(:,85), MZ, 1_intkind1, wf16(:,97), n2(90))
  call vert_WQ_A(ntry, wf4(:,8), ex3, wf8(:,35), n3(:,228), t3x8(:,:,18))
  call prop_Q_A(ntry, wf8(:,35), Q(:,84), ZERO, 0_intkind1, wf8(:,36), n2(91))
  call vert_QA_Z(gZn,ntry, wf8(:,36), ex1, wf16(:,98), n3(:,229), t3x16(:,:,57))
  call prop_W_W(ntry, wf16(:,98), Q(:,85), MZ, 1_intkind1, wf16(:,99), n2(92))
  call vert_AW_Q(ntry, ex1, wf8(:,2), wf16(:,100), n3(:,230), t3x16(:,:,58))
  call vert_VQ_A(ntry, wf16(:,1), ex3, wf32(:,163), n3(:,231), t3x32(:,:,139))
  call prop_A_Q(ntry, wf16(:,100), Q(:,417), ZERO, 0_intkind1, wf16(:,101), n2(93))
  call vert_ZQ_A(gZl,ntry, wf16(:,2), ex3, wf32(:,164), n3(:,232), t3x32(:,:,140))
  call vert_AZ_Q(gZn,ntry, ex1, wf16(:,2), wf32(:,165), n3(:,233), t3x32(:,:,141))
  call vert_WQ_A(ntry, wf8(:,2), ex3, wf16(:,102), n3(:,234), t3x16(:,:,59))
  call prop_A_Q(ntry, wf32(:,165), Q(:,91), ZERO, 0_intkind1, wf32(:,166), n2(94))
  call vert_AW_Q(ntry, wf8(:,34), wf4(:,7), wf32(:,167), n3(:,235), t3x32(:,:,142))
  call prop_Q_A(ntry, wf16(:,102), Q(:,420), ZERO, 0_intkind1, wf16(:,103), n2(95))
  call vert_WQ_A(ntry, wf4(:,7), wf8(:,36), wf32(:,168), n3(:,236), t3x32(:,:,143))
  call vert_AW_Q(ntry, ex1, wf8(:,4), wf16(:,104), n3(:,237), t3x16(:,:,60))
  call prop_A_Q(ntry, wf16(:,104), Q(:,417), ZERO, 0_intkind1, wf16(:,105), n2(96))
  call vert_WQ_A(ntry, wf8(:,4), ex3, wf16(:,106), n3(:,238), t3x16(:,:,61))
  call prop_Q_A(ntry, wf16(:,106), Q(:,420), ZERO, 0_intkind1, wf16(:,107), n2(97))
  call vert_AV_Q(ntry, ex8, wf16(:,95), wf32(:,169), n3(:,239), t3x32(:,:,144))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,97), wf32(:,170), n3(:,240), t3x32(:,:,145))
  call vert_VQ_A(ntry, wf16(:,95), ex6, wf32(:,171), n3(:,241), t3x32(:,:,146))
  call vert_ZQ_A(gZu,ntry, wf16(:,97), ex6, wf32(:,172), n3(:,242), t3x32(:,:,147))
  call vert_ZQ_A(gZu,ntry, wf16(:,99), ex6, wf32(:,173), n3(:,243), t3x32(:,:,148))
  call vert_AZ_Q(gZd,ntry, ex8, wf16(:,99), wf32(:,174), n3(:,244), t3x32(:,:,149))
  call vert_AW_Q(ntry, ex1, wf4(:,14), wf8(:,37), n3(:,245), t3x8(:,:,19))
  call prop_A_Q(ntry, wf8(:,37), Q(:,161), ZERO, 0_intkind1, wf8(:,38), n2(98))
  call vert_QA_V(ntry, ex3, wf8(:,38), wf16(:,108), n3(:,246), t3x16(:,:,62))
  call vert_QA_Z(gZl,ntry, ex3, wf8(:,38), wf16(:,109), n3(:,247), t3x16(:,:,63))
  call prop_W_W(ntry, wf16(:,109), Q(:,165), MZ, 1_intkind1, wf16(:,110), n2(99))
  call vert_WQ_A(ntry, wf4(:,14), ex3, wf8(:,39), n3(:,248), t3x8(:,:,20))
  call prop_Q_A(ntry, wf8(:,39), Q(:,164), ZERO, 0_intkind1, wf8(:,40), n2(100))
  call vert_QA_Z(gZn,ntry, wf8(:,40), ex1, wf16(:,111), n3(:,249), t3x16(:,:,64))
  call prop_W_W(ntry, wf16(:,111), Q(:,165), MZ, 1_intkind1, wf16(:,112), n2(101))
  call vert_AW_Q(ntry, ex1, wf8(:,6), wf16(:,113), n3(:,250), t3x16(:,:,65))
  call vert_VQ_A(ntry, wf16(:,25), ex3, wf32(:,175), n3(:,251), t3x32(:,:,150))
  call prop_A_Q(ntry, wf16(:,113), Q(:,337), ZERO, 0_intkind1, wf16(:,114), n2(102))
  call vert_ZQ_A(gZl,ntry, wf16(:,26), ex3, wf32(:,176), n3(:,252), t3x32(:,:,151))
  call vert_AZ_Q(gZn,ntry, ex1, wf16(:,26), wf32(:,177), n3(:,253), t3x32(:,:,152))
  call vert_WQ_A(ntry, wf8(:,6), ex3, wf16(:,115), n3(:,254), t3x16(:,:,66))
  call prop_A_Q(ntry, wf32(:,177), Q(:,171), ZERO, 0_intkind1, wf32(:,178), n2(103))
  call vert_AW_Q(ntry, wf8(:,38), wf4(:,7), wf32(:,179), n3(:,255), t3x32(:,:,153))
  call prop_Q_A(ntry, wf16(:,115), Q(:,340), ZERO, 0_intkind1, wf16(:,116), n2(104))
  call vert_WQ_A(ntry, wf4(:,7), wf8(:,40), wf32(:,180), n3(:,256), t3x32(:,:,154))
  call vert_AW_Q(ntry, ex1, wf8(:,8), wf16(:,117), n3(:,257), t3x16(:,:,67))
  call prop_A_Q(ntry, wf16(:,117), Q(:,337), ZERO, 0_intkind1, wf16(:,118), n2(105))
  call vert_WQ_A(ntry, wf8(:,8), ex3, wf16(:,119), n3(:,258), t3x16(:,:,68))
  call prop_Q_A(ntry, wf16(:,119), Q(:,340), ZERO, 0_intkind1, wf16(:,120), n2(106))
  call vert_ZQ_A(gZu,ntry, wf16(:,112), ex5, wf32(:,181), n3(:,259), t3x32(:,:,155))
  call vert_AV_Q(ntry, ex7, wf16(:,108), wf32(:,182), n3(:,260), t3x32(:,:,156))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,110), wf32(:,183), n3(:,261), t3x32(:,:,157))
  call vert_VQ_A(ntry, wf16(:,108), ex5, wf32(:,184), n3(:,262), t3x32(:,:,158))
  call vert_ZQ_A(gZu,ntry, wf16(:,110), ex5, wf32(:,185), n3(:,263), t3x32(:,:,159))
  call vert_AZ_Q(gZd,ntry, ex7, wf16(:,112), wf32(:,186), n3(:,264), t3x32(:,:,160))
  call vert_QA_Z(gZn,ntry, wf16(:,116), ex1, wf32(:,187), n3(:,265), t3x32(:,:,161))
  call vert_QA_V(ntry, ex3, wf16(:,114), wf32(:,188), n3(:,266), t3x32(:,:,162))
  call vert_QA_Z(gZl,ntry, ex3, wf16(:,114), wf32(:,189), n3(:,267), t3x32(:,:,163))
  call vert_QA_Z(gZn,ntry, wf16(:,103), ex1, wf32(:,190), n3(:,268), t3x32(:,:,164))
  call vert_QA_V(ntry, ex3, wf16(:,101), wf32(:,191), n3(:,269), t3x32(:,:,165))
  call vert_QA_Z(gZl,ntry, ex3, wf16(:,101), wf32(:,192), n3(:,270), t3x32(:,:,166))
  call vert_QA_V(ntry, ex3, wf16(:,118), wf32(:,193), n3(:,271), t3x32(:,:,167))
  call vert_QA_Z(gZl,ntry, ex3, wf16(:,118), wf32(:,194), n3(:,272), t3x32(:,:,168))
  call vert_QA_Z(gZn,ntry, wf16(:,120), ex1, wf32(:,195), n3(:,273), t3x32(:,:,169))
  call vert_QA_Z(gZn,ntry, wf16(:,107), ex1, wf32(:,196), n3(:,274), t3x32(:,:,170))
  call vert_QA_V(ntry, ex3, wf16(:,105), wf32(:,197), n3(:,275), t3x32(:,:,171))
  call vert_QA_Z(gZl,ntry, ex3, wf16(:,105), wf32(:,198), n3(:,276), t3x32(:,:,172))
  call vert_AZ_Q(gZn,ntry, ex2, wf16(:,99), wf32(:,199), n3(:,277), t3x32(:,:,173))
  call vert_AZ_Q(gZn,ntry, ex1, wf16(:,73), wf32(:,200), n3(:,278), t3x32(:,:,174))
  call vert_ZQ_A(gZl,ntry, wf16(:,99), ex4, wf32(:,201), n3(:,279), t3x32(:,:,175))
  call vert_AZ_Q(gZn,ntry, ex2, wf16(:,97), wf32(:,202), n3(:,280), t3x32(:,:,176))
  call vert_AZ_Q(gZn,ntry, ex2, wf16(:,112), wf32(:,203), n3(:,281), t3x32(:,:,177))
  call vert_AZ_Q(gZn,ntry, ex1, wf16(:,86), wf32(:,204), n3(:,282), t3x32(:,:,178))
  call vert_ZQ_A(gZl,ntry, wf16(:,112), ex4, wf32(:,205), n3(:,283), t3x32(:,:,179))
  call vert_AZ_Q(gZn,ntry, ex2, wf16(:,110), wf32(:,206), n3(:,284), t3x32(:,:,180))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppllnnjj_vbs_nexnmxemucdxsxg_2
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_ppllnnjj_vbs_nexnmxemucdxsxg_2

  do k = 0, 47-1
    M2(k) = M2add(extcomb_perm_ppllnnjj_vbs_nexnmxemucdxsxg_2(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllnnjj_vbs_nexnmxemucdxsxg_2")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllnnjj_vbs_nexnmxemucdxsxg_2")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllnnjj_vbs_nexnmxemucdxsxg_2")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllnnjj_vbs_nexnmxemucdxsxg_2")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllnnjj_vbs_nexnmxemucdxsxg_2")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllnnjj_vbs_nexnmxemucdxsxg_2")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllnnjj_vbs_nexnmxemucdxsxg_2")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllnnjj_vbs_nexnmxemucdxsxg_2")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllnnjj_vbs_nexnmxemucdxsxg_2")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllnnjj_vbs_nexnmxemucdxsxg_2")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllnnjj_vbs_nexnmxemucdxsxg_2")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllnnjj_vbs_nexnmxemucdxsxg_2_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllnnjj_vbs_nexnmxemucdxsxg_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllnnjj_vbs_nexnmxemucdxsxg_2_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2(0:47-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllnnjj_vbs_nexnmxemucdxsxg_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllnnjj_vbs_nexnmxemucdxsxg_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2(9)
...
end module ol_tree_ppllnnjj_vbs_nexnmxemucdxsxg_2_/**/REALKIND
