...
module ol_tree_ppllnnjj_vbs_nenmexmxuxcxds_2_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllnnjj_vbs_nenmexmxuxcxds_2")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllnnjj_vbs_nenmexmxuxcxds_2_/**/DREALKIND, only: &
    & ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for nu_e nu_mu e+ mu+ anti-up anti-charm down strange -> 0
...
! **********************************************************************
  ...
  use ol_external_ppllnnjj_vbs_nenmexmxuxcxds_2, only: &
    & external_perm_ppllnnjj_vbs_nenmexmxuxcxds_2, &
    & external_perm_inv_ppllnnjj_vbs_nenmexmxuxcxds_2, &
    & extcomb_perm_ppllnnjj_vbs_nenmexmxuxcxds_2, &
    & average_factor_ppllnnjj_vbs_nenmexmxuxcxds_2
  use ol_external_ppllnnjj_vbs_nenmexmxuxcxds_2, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppllnnjj_vbs_nenmexmxuxcxds_2_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllnnjj_vbs_nenmexmxuxcxds_2_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_ppllnnjj_vbs_nenmexmxuxcxds_2
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_ppllnnjj_vbs_nenmexmxuxcxds_2,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllnnjj_vbs_nenmexmxuxcxds_2(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllnnjj_vbs_nenmexmxuxcxds_2(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllnnjj_vbs_nenmexmxuxcxds_2(extcombs(k))
  end do
  ...
  call vert_UV_W(ntry, wf4(:,5), Q(:,5), wf4(:,7), Q(:,80), wf16(:,3), n3(:,7), t3x16(:,:,3))
  call vert_UV_W(ntry, wf4(:,6), Q(:,10), wf4(:,8), Q(:,160), wf16(:,4), n3(:,8), t3x16(:,:,4))
  ...
  call vert_UV_W(ntry, wf4(:,5), Q(:,5), wf4(:,8), Q(:,160), wf16(:,8), n3(:,11), t3x16(:,:,7))
  call vert_UV_W(ntry, wf4(:,6), Q(:,10), wf4(:,7), Q(:,80), wf16(:,9), n3(:,12), t3x16(:,:,8))
  call prop_W_W(ntry, wf16(:,8), Q(:,165), MZ, 1_intkind1, wf16(:,10), n2(6))
  call vert_AW_Q(ntry, ex6, wf4(:,5), wf8(:,1), n3(:,13), t3x8(:,:,1))
  call vert_WQ_A(ntry, wf4(:,6), ex8, wf8(:,2), n3(:,14), t3x8(:,:,2))
  call prop_A_Q(ntry, wf8(:,1), Q(:,37), ZERO, 0_intkind1, wf8(:,3), n2(7))
  call prop_Q_A(ntry, wf8(:,2), Q(:,138), ZERO, 0_intkind1, wf8(:,4), n2(8))
  call vert_AW_Q(ntry, wf8(:,3), wf4(:,7), wf32(:,1), n3(:,15), t3x32(:,:,1))
  call vert_QA_V(ntry, ex8, wf8(:,3), wf16(:,11), n3(:,16), t3x16(:,:,9))
  call prop_W_W(ntry, wf16(:,9), Q(:,90), MZ, 1_intkind1, wf16(:,12), n2(9))
  call vert_QA_Z(gZd,ntry, ex8, wf8(:,3), wf16(:,13), n3(:,17), t3x16(:,:,10))
  call vert_AW_Q(ntry, ex6, wf4(:,6), wf8(:,5), n3(:,18), t3x8(:,:,3))
  call vert_WQ_A(ntry, wf4(:,5), ex8, wf8(:,6), n3(:,19), t3x8(:,:,4))
  call prop_A_Q(ntry, wf8(:,5), Q(:,42), ZERO, 0_intkind1, wf8(:,7), n2(10))
  call prop_Q_A(ntry, wf8(:,6), Q(:,133), ZERO, 0_intkind1, wf8(:,8), n2(11))
  call vert_AW_Q(ntry, wf8(:,7), wf4(:,7), wf32(:,2), n3(:,20), t3x32(:,:,2))
  call vert_QA_V(ntry, wf8(:,8), ex6, wf16(:,14), n3(:,21), t3x16(:,:,11))
  call vert_QA_Z(gZu,ntry, wf8(:,8), ex6, wf16(:,15), n3(:,22), t3x16(:,:,12))
  call vert_QA_V(ntry, ex8, wf8(:,7), wf16(:,16), n3(:,23), t3x16(:,:,13))
  call vert_QA_Z(gZd,ntry, ex8, wf8(:,7), wf16(:,17), n3(:,24), t3x16(:,:,14))
  call vert_QA_V(ntry, wf8(:,4), ex6, wf16(:,18), n3(:,25), t3x16(:,:,15))
  call vert_QA_Z(gZu,ntry, wf8(:,4), ex6, wf16(:,19), n3(:,26), t3x16(:,:,16))
  call vert_AW_Q(ntry, ex5, wf4(:,5), wf8(:,9), n3(:,27), t3x8(:,:,5))
  call vert_WQ_A(ntry, wf4(:,6), ex7, wf8(:,10), n3(:,28), t3x8(:,:,6))
  call prop_A_Q(ntry, wf8(:,9), Q(:,21), ZERO, 0_intkind1, wf8(:,11), n2(12))
  call prop_Q_A(ntry, wf8(:,10), Q(:,74), ZERO, 0_intkind1, wf8(:,12), n2(13))
  call vert_AW_Q(ntry, wf8(:,11), wf4(:,8), wf32(:,3), n3(:,29), t3x32(:,:,3))
  call vert_QA_V(ntry, ex7, wf8(:,11), wf16(:,20), n3(:,30), t3x16(:,:,17))
  call prop_W_W(ntry, wf16(:,4), Q(:,170), MZ, 1_intkind1, wf16(:,21), n2(14))
  call vert_QA_Z(gZd,ntry, ex7, wf8(:,11), wf16(:,22), n3(:,31), t3x16(:,:,18))
  call vert_AW_Q(ntry, ex5, wf4(:,6), wf8(:,13), n3(:,32), t3x8(:,:,7))
  call vert_WQ_A(ntry, wf4(:,5), ex7, wf8(:,14), n3(:,33), t3x8(:,:,8))
  call prop_A_Q(ntry, wf8(:,13), Q(:,26), ZERO, 0_intkind1, wf8(:,15), n2(15))
  call prop_Q_A(ntry, wf8(:,14), Q(:,69), ZERO, 0_intkind1, wf8(:,16), n2(16))
  call vert_AW_Q(ntry, wf8(:,15), wf4(:,8), wf32(:,4), n3(:,34), t3x32(:,:,4))
  call vert_QA_V(ntry, wf8(:,16), ex5, wf16(:,23), n3(:,35), t3x16(:,:,19))
  call vert_QA_Z(gZu,ntry, wf8(:,16), ex5, wf16(:,24), n3(:,36), t3x16(:,:,20))
  call vert_QA_V(ntry, ex7, wf8(:,15), wf16(:,25), n3(:,37), t3x16(:,:,21))
  call vert_QA_Z(gZd,ntry, ex7, wf8(:,15), wf16(:,26), n3(:,38), t3x16(:,:,22))
  call vert_QA_V(ntry, wf8(:,12), ex5, wf16(:,27), n3(:,39), t3x16(:,:,23))
  call vert_QA_Z(gZu,ntry, wf8(:,12), ex5, wf16(:,28), n3(:,40), t3x16(:,:,24))
  ...
  call vert_WQ_A(ntry, wf4(:,7), ex2, wf8(:,17), n3(:,41), t3x8(:,:,9))
  call prop_Q_A(ntry, wf8(:,17), Q(:,82), ZERO, 0_intkind1, wf8(:,18), n2(23))
  call vert_QA_V(ntry, wf8(:,18), ex4, wf16(:,35), n3(:,42), t3x16(:,:,25))
  call vert_QA_Z(gZl,ntry, wf8(:,18), ex4, wf16(:,36), n3(:,43), t3x16(:,:,26))
  call vert_WQ_A(ntry, wf4(:,8), ex2, wf8(:,19), n3(:,44), t3x8(:,:,10))
  call prop_Q_A(ntry, wf8(:,19), Q(:,162), ZERO, 0_intkind1, wf8(:,20), n2(24))
  call vert_QA_V(ntry, wf8(:,20), ex4, wf16(:,37), n3(:,45), t3x16(:,:,27))
  call vert_QA_Z(gZl,ntry, wf8(:,20), ex4, wf16(:,38), n3(:,46), t3x16(:,:,28))
  call vert_AW_Q(ntry, ex4, wf4(:,7), wf8(:,21), n3(:,47), t3x8(:,:,11))
  call prop_A_Q(ntry, wf8(:,21), Q(:,88), ZERO, 0_intkind1, wf8(:,22), n2(25))
  call vert_QA_Z(gZn,ntry, ex2, wf8(:,22), wf16(:,39), n3(:,48), t3x16(:,:,29))
  call vert_AW_Q(ntry, ex4, wf4(:,8), wf8(:,23), n3(:,49), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,23), Q(:,168), ZERO, 0_intkind1, wf8(:,24), n2(26))
  call vert_QA_Z(gZn,ntry, ex2, wf8(:,24), wf16(:,40), n3(:,50), t3x16(:,:,30))
  call vert_WQ_A(ntry, wf4(:,5), wf8(:,18), wf32(:,5), n3(:,51), t3x32(:,:,5))
  call vert_WQ_A(ntry, wf4(:,5), wf8(:,20), wf32(:,6), n3(:,52), t3x32(:,:,6))
  ...
  call vert_WQ_A(ntry, wf4(:,7), ex1, wf8(:,25), n3(:,53), t3x8(:,:,13))
  call prop_Q_A(ntry, wf8(:,25), Q(:,81), ZERO, 0_intkind1, wf8(:,26), n2(31))
  call vert_QA_V(ntry, wf8(:,26), ex3, wf16(:,45), n3(:,54), t3x16(:,:,31))
  call vert_QA_Z(gZl,ntry, wf8(:,26), ex3, wf16(:,46), n3(:,55), t3x16(:,:,32))
  call vert_WQ_A(ntry, wf4(:,8), ex1, wf8(:,27), n3(:,56), t3x8(:,:,14))
  call prop_Q_A(ntry, wf8(:,27), Q(:,161), ZERO, 0_intkind1, wf8(:,28), n2(32))
  call vert_QA_V(ntry, wf8(:,28), ex3, wf16(:,47), n3(:,57), t3x16(:,:,33))
  call vert_QA_Z(gZl,ntry, wf8(:,28), ex3, wf16(:,48), n3(:,58), t3x16(:,:,34))
  call vert_AW_Q(ntry, ex3, wf4(:,7), wf8(:,29), n3(:,59), t3x8(:,:,15))
  call prop_A_Q(ntry, wf8(:,29), Q(:,84), ZERO, 0_intkind1, wf8(:,30), n2(33))
  call vert_QA_Z(gZn,ntry, ex1, wf8(:,30), wf16(:,49), n3(:,60), t3x16(:,:,35))
  call vert_AW_Q(ntry, ex3, wf4(:,8), wf8(:,31), n3(:,61), t3x8(:,:,16))
  call prop_A_Q(ntry, wf8(:,31), Q(:,164), ZERO, 0_intkind1, wf8(:,32), n2(34))
  call vert_QA_Z(gZn,ntry, ex1, wf8(:,32), wf16(:,50), n3(:,62), t3x16(:,:,36))
  call vert_WQ_A(ntry, wf4(:,6), wf8(:,26), wf32(:,7), n3(:,63), t3x32(:,:,7))
  call vert_WQ_A(ntry, wf4(:,6), wf8(:,28), wf32(:,8), n3(:,64), t3x32(:,:,8))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppllnnjj_vbs_nenmexmxuxcxds_2
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_ppllnnjj_vbs_nenmexmxuxcxds_2

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_ppllnnjj_vbs_nenmexmxuxcxds_2(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllnnjj_vbs_nenmexmxuxcxds_2_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllnnjj_vbs_nenmexmxuxcxds_2")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllnnjj_vbs_nenmexmxuxcxds_2")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllnnjj_vbs_nenmexmxuxcxds_2")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllnnjj_vbs_nenmexmxuxcxds_2")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllnnjj_vbs_nenmexmxuxcxds_2")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllnnjj_vbs_nenmexmxuxcxds_2")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllnnjj_vbs_nenmexmxuxcxds_2")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllnnjj_vbs_nenmexmxuxcxds_2")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllnnjj_vbs_nenmexmxuxcxds_2")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllnnjj_vbs_nenmexmxuxcxds_2")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllnnjj_vbs_nenmexmxuxcxds_2")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllnnjj_vbs_nenmexmxuxcxds_2_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllnnjj_vbs_nenmexmxuxcxds_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllnnjj_vbs_nenmexmxuxcxds_2_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllnnjj_vbs_nenmexmxuxcxds_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllnnjj_vbs_nenmexmxuxcxds_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_ppllnnjj_vbs_nenmexmxuxcxds_2_/**/REALKIND
