...
module ol_colourmatrix_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND



module ol_forced_parameters_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND

module ol_tree_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllnnjj_vbs_nenmexmxuxuxddg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/DREALKIND, only: &
...
! **********************************************************************
  ...
  use ol_external_ppllnnjj_vbs_nenmexmxuxuxddg_1, only: &
    & external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1, &
    & external_perm_inv_ppllnnjj_vbs_nenmexmxuxuxddg_1, &
    & extcomb_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1, &
    & average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1
  use ol_external_ppllnnjj_vbs_nenmexmxuxuxddg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_ppllnnjj_vbs_nenmexmxuxuxddg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_ppllnnjj_vbs_nenmexmxuxuxddg_1,9)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(extcombs(k))
  end do
  ...
  call vert_WQ_A(ntry, wf4(:,5), ex8, wf8(:,5), n3(:,8), t3x8(:,:,3))
  call prop_Q_A(ntry, wf8(:,5), Q(:,138), ZERO, 0_intkind1, wf8(:,6), n2(6))
  call vert_QA_V(ntry, ex7, wf8(:,3), wf16(:,2), n3(:,9), t3x16(:,:,2))
  call vert_QA_V(ntry, wf8(:,6), wf4(:,6), wf32(:,2), n3(:,10), t3x32(:,:,2))
  call vert_AW_Q(ntry, wf4(:,6), wf4(:,5), wf16(:,3), n3(:,11), t3x16(:,:,3))
  call prop_A_Q(ntry, wf16(:,3), Q(:,282), ZERO, 0_intkind1, wf16(:,4), n2(7))
  call vert_QA_V(ntry, ex8, wf16(:,4), wf32(:,3), n3(:,12), t3x32(:,:,3))
  call vert_QA_V(ntry, ex7, wf16(:,4), wf32(:,4), n3(:,13), t3x32(:,:,4))
  call vert_AW_Q(ntry, ex6, wf4(:,5), wf8(:,7), n3(:,14), t3x8(:,:,4))
  call vert_WQ_A(ntry, wf4(:,4), ex7, wf8(:,8), n3(:,15), t3x8(:,:,5))
  call prop_A_Q(ntry, wf8(:,7), Q(:,42), ZERO, 0_intkind1, wf8(:,9), n2(8))
  call prop_Q_A(ntry, wf8(:,8), Q(:,69), ZERO, 0_intkind1, wf8(:,10), n2(9))
  call vert_QA_V(ntry, ex8, wf8(:,9), wf16(:,5), n3(:,16), t3x16(:,:,4))
  call vert_QA_V(ntry, wf8(:,10), wf4(:,6), wf32(:,5), n3(:,17), t3x32(:,:,5))
  call vert_QA_V(ntry, wf8(:,10), ex6, wf16(:,6), n3(:,18), t3x16(:,:,5))
  call vert_QA_V(ntry, wf8(:,6), ex6, wf16(:,7), n3(:,19), t3x16(:,:,6))
  call vert_WQ_A(ntry, wf4(:,4), ex8, wf8(:,11), n3(:,20), t3x8(:,:,6))
  call prop_Q_A(ntry, wf8(:,11), Q(:,133), ZERO, 0_intkind1, wf8(:,12), n2(10))
  call vert_QA_V(ntry, ex7, wf8(:,9), wf16(:,8), n3(:,21), t3x16(:,:,7))
  call vert_QA_V(ntry, wf8(:,12), wf4(:,6), wf32(:,6), n3(:,22), t3x32(:,:,6))
  call vert_QA_V(ntry, wf8(:,4), ex6, wf16(:,9), n3(:,23), t3x16(:,:,8))
  call vert_QA_V(ntry, wf8(:,12), ex6, wf16(:,10), n3(:,24), t3x16(:,:,9))
  call vert_AW_Q(ntry, wf4(:,6), wf4(:,4), wf16(:,11), n3(:,25), t3x16(:,:,10))
  call prop_A_Q(ntry, wf16(:,11), Q(:,277), ZERO, 0_intkind1, wf16(:,12), n2(11))
  call vert_QA_V(ntry, ex8, wf16(:,12), wf32(:,7), n3(:,26), t3x32(:,:,7))
  call vert_QA_V(ntry, ex7, wf16(:,12), wf32(:,8), n3(:,27), t3x32(:,:,8))
  call vert_AV_Q(ntry, ex6, ex9, wf4(:,7), n3(:,28), t3x4(:,:,4))
  call vert_AW_Q(ntry, ex5, wf4(:,4), wf8(:,13), n3(:,29), t3x8(:,:,7))
  call prop_A_Q(ntry, wf8(:,13), Q(:,21), ZERO, 0_intkind1, wf8(:,14), n2(12))
  call prop_A_Q(ntry, wf4(:,7), Q(:,288), ZERO, 0_intkind1, wf4(:,8), n2(13))
  call vert_QA_V(ntry, ex8, wf8(:,14), wf16(:,13), n3(:,30), t3x16(:,:,11))
  call vert_QA_V(ntry, wf8(:,4), wf4(:,8), wf32(:,9), n3(:,31), t3x32(:,:,9))
  call vert_QA_V(ntry, ex7, wf8(:,14), wf16(:,14), n3(:,32), t3x16(:,:,12))
  call vert_QA_V(ntry, wf8(:,6), wf4(:,8), wf32(:,10), n3(:,33), t3x32(:,:,10))
  call vert_AW_Q(ntry, wf4(:,8), wf4(:,5), wf16(:,15), n3(:,34), t3x16(:,:,13))
  call prop_A_Q(ntry, wf16(:,15), Q(:,298), ZERO, 0_intkind1, wf16(:,16), n2(14))
  call vert_QA_V(ntry, ex8, wf16(:,16), wf32(:,11), n3(:,35), t3x32(:,:,11))
  call vert_QA_V(ntry, ex7, wf16(:,16), wf32(:,12), n3(:,36), t3x32(:,:,12))
  call vert_AW_Q(ntry, ex5, wf4(:,5), wf8(:,15), n3(:,37), t3x8(:,:,8))
  call prop_A_Q(ntry, wf8(:,15), Q(:,26), ZERO, 0_intkind1, wf8(:,16), n2(15))
  call vert_QA_V(ntry, ex8, wf8(:,16), wf16(:,17), n3(:,38), t3x16(:,:,14))
  call vert_QA_V(ntry, wf8(:,10), wf4(:,8), wf32(:,13), n3(:,39), t3x32(:,:,13))
  call vert_QA_V(ntry, wf8(:,10), ex5, wf16(:,18), n3(:,40), t3x16(:,:,15))
  call vert_QA_V(ntry, wf8(:,6), ex5, wf16(:,19), n3(:,41), t3x16(:,:,16))
  call vert_QA_V(ntry, ex7, wf8(:,16), wf16(:,20), n3(:,42), t3x16(:,:,17))
  call vert_QA_V(ntry, wf8(:,12), wf4(:,8), wf32(:,14), n3(:,43), t3x32(:,:,14))
  call vert_QA_V(ntry, wf8(:,4), ex5, wf16(:,21), n3(:,44), t3x16(:,:,18))
  call vert_QA_V(ntry, wf8(:,12), ex5, wf16(:,22), n3(:,45), t3x16(:,:,19))
  call vert_AW_Q(ntry, wf4(:,8), wf4(:,4), wf16(:,23), n3(:,46), t3x16(:,:,20))
  call prop_A_Q(ntry, wf16(:,23), Q(:,293), ZERO, 0_intkind1, wf16(:,24), n2(16))
  call vert_QA_V(ntry, ex8, wf16(:,24), wf32(:,15), n3(:,47), t3x32(:,:,15))
  call vert_QA_V(ntry, ex7, wf16(:,24), wf32(:,16), n3(:,48), t3x32(:,:,16))
  call vert_VQ_A(ntry, ex9, ex7, wf4(:,9), n3(:,49), t3x4(:,:,5))
  call prop_Q_A(ntry, wf4(:,9), Q(:,320), ZERO, 0_intkind1, wf4(:,10), n2(17))
  call vert_QA_V(ntry, wf4(:,10), wf8(:,9), wf32(:,17), n3(:,50), t3x32(:,:,17))
  call vert_QA_V(ntry, wf4(:,10), wf8(:,14), wf32(:,18), n3(:,51), t3x32(:,:,18))
  call vert_WQ_A(ntry, wf4(:,5), wf4(:,10), wf16(:,25), n3(:,52), t3x16(:,:,21))
  call prop_Q_A(ntry, wf16(:,25), Q(:,330), ZERO, 0_intkind1, wf16(:,26), n2(18))
  call vert_QA_V(ntry, wf16(:,26), ex6, wf32(:,19), n3(:,53), t3x32(:,:,19))
  call vert_QA_V(ntry, wf4(:,10), wf8(:,3), wf32(:,20), n3(:,54), t3x32(:,:,20))
  call vert_QA_V(ntry, wf4(:,10), wf8(:,16), wf32(:,21), n3(:,55), t3x32(:,:,21))
  call vert_QA_V(ntry, wf16(:,26), ex5, wf32(:,22), n3(:,56), t3x32(:,:,22))
  call vert_WQ_A(ntry, wf4(:,4), wf4(:,10), wf16(:,27), n3(:,57), t3x16(:,:,22))
  call prop_Q_A(ntry, wf16(:,27), Q(:,325), ZERO, 0_intkind1, wf16(:,28), n2(19))
  call vert_QA_V(ntry, wf16(:,28), ex6, wf32(:,23), n3(:,58), t3x32(:,:,23))
  call vert_QA_V(ntry, wf16(:,28), ex5, wf32(:,24), n3(:,59), t3x32(:,:,24))
  call vert_VQ_A(ntry, ex9, ex8, wf4(:,11), n3(:,60), t3x4(:,:,6))
  call prop_Q_A(ntry, wf4(:,11), Q(:,384), ZERO, 0_intkind1, wf4(:,12), n2(20))
  call vert_QA_V(ntry, wf4(:,12), wf8(:,9), wf32(:,25), n3(:,61), t3x32(:,:,25))
  call vert_QA_V(ntry, wf4(:,12), wf8(:,14), wf32(:,26), n3(:,62), t3x32(:,:,26))
  call vert_WQ_A(ntry, wf4(:,5), wf4(:,12), wf16(:,29), n3(:,63), t3x16(:,:,23))
  call prop_Q_A(ntry, wf16(:,29), Q(:,394), ZERO, 0_intkind1, wf16(:,30), n2(21))
  call vert_QA_V(ntry, wf16(:,30), ex6, wf32(:,27), n3(:,64), t3x32(:,:,27))
  call vert_QA_V(ntry, wf4(:,12), wf8(:,3), wf32(:,28), n3(:,65), t3x32(:,:,28))
  call vert_QA_V(ntry, wf4(:,12), wf8(:,16), wf32(:,29), n3(:,66), t3x32(:,:,29))
  call vert_QA_V(ntry, wf16(:,30), ex5, wf32(:,30), n3(:,67), t3x32(:,:,30))
  call vert_WQ_A(ntry, wf4(:,4), wf4(:,12), wf16(:,31), n3(:,68), t3x16(:,:,24))
  call prop_Q_A(ntry, wf16(:,31), Q(:,389), ZERO, 0_intkind1, wf16(:,32), n2(22))
  call vert_QA_V(ntry, wf16(:,32), ex6, wf32(:,31), n3(:,69), t3x32(:,:,31))
  call vert_QA_V(ntry, wf16(:,32), ex5, wf32(:,32), n3(:,70), t3x32(:,:,32))
  call vert_UV_W(ntry, wf16(:,14), Q(:,85), ex9, Q(:,256), wf32(:,33), n3(:,71), t3x32(:,:,33))
  call vert_AV_Q(ntry, wf8(:,9), ex9, wf16(:,33), n3(:,72), t3x16(:,:,25))
  call prop_A_Q(ntry, wf16(:,33), Q(:,298), ZERO, 0_intkind1, wf16(:,34), n2(23))
  call vert_VQ_A(ntry, wf16(:,14), ex8, wf32(:,34), n3(:,73), t3x32(:,:,34))
  call vert_UV_W(ntry, wf16(:,8), Q(:,106), ex9, Q(:,256), wf32(:,35), n3(:,74), t3x32(:,:,35))
  call vert_VQ_A(ntry, wf16(:,13), ex7, wf32(:,36), n3(:,75), t3x32(:,:,36))
  call vert_AV_Q(ntry, wf8(:,14), ex9, wf16(:,35), n3(:,76), t3x16(:,:,26))
  call prop_A_Q(ntry, wf16(:,35), Q(:,277), ZERO, 0_intkind1, wf16(:,36), n2(24))
  call vert_VQ_A(ntry, wf16(:,8), ex8, wf32(:,37), n3(:,77), t3x32(:,:,37))
  call vert_VQ_A(ntry, wf16(:,5), ex7, wf32(:,38), n3(:,78), t3x32(:,:,38))
  call vert_UV_W(ntry, wf16(:,9), Q(:,106), ex9, Q(:,256), wf32(:,39), n3(:,79), t3x32(:,:,39))
  call vert_VQ_A(ntry, ex9, wf8(:,4), wf16(:,37), n3(:,80), t3x16(:,:,27))
  call prop_Q_A(ntry, wf16(:,37), Q(:,330), ZERO, 0_intkind1, wf16(:,38), n2(25))
  call vert_AV_Q(ntry, ex6, wf16(:,13), wf32(:,40), n3(:,81), t3x32(:,:,40))
  call vert_VQ_A(ntry, wf16(:,9), ex8, wf32(:,41), n3(:,82), t3x32(:,:,41))
  call vert_VQ_A(ntry, ex9, wf8(:,6), wf16(:,39), n3(:,83), t3x16(:,:,28))
  call prop_Q_A(ntry, wf16(:,39), Q(:,394), ZERO, 0_intkind1, wf16(:,40), n2(26))
  call vert_AV_Q(ntry, ex6, wf16(:,14), wf32(:,42), n3(:,84), t3x32(:,:,42))
  call vert_UV_W(ntry, wf16(:,7), Q(:,170), ex9, Q(:,256), wf32(:,43), n3(:,85), t3x32(:,:,43))
  call vert_VQ_A(ntry, wf16(:,7), ex7, wf32(:,44), n3(:,86), t3x32(:,:,44))
  call vert_UV_W(ntry, wf16(:,20), Q(:,90), ex9, Q(:,256), wf32(:,45), n3(:,87), t3x32(:,:,45))
  call vert_AV_Q(ntry, wf8(:,3), ex9, wf16(:,41), n3(:,88), t3x16(:,:,29))
  call prop_A_Q(ntry, wf16(:,41), Q(:,293), ZERO, 0_intkind1, wf16(:,42), n2(27))
  call vert_VQ_A(ntry, wf16(:,20), ex8, wf32(:,46), n3(:,89), t3x32(:,:,46))
  call vert_UV_W(ntry, wf16(:,2), Q(:,101), ex9, Q(:,256), wf32(:,47), n3(:,90), t3x32(:,:,47))
  call vert_VQ_A(ntry, wf16(:,17), ex7, wf32(:,48), n3(:,91), t3x32(:,:,48))
  call vert_AV_Q(ntry, wf8(:,16), ex9, wf16(:,43), n3(:,92), t3x16(:,:,30))
  call prop_A_Q(ntry, wf16(:,43), Q(:,282), ZERO, 0_intkind1, wf16(:,44), n2(28))
  call vert_VQ_A(ntry, wf16(:,2), ex8, wf32(:,49), n3(:,93), t3x32(:,:,49))
  call vert_VQ_A(ntry, wf16(:,1), ex7, wf32(:,50), n3(:,94), t3x32(:,:,50))
  call vert_VQ_A(ntry, wf16(:,21), ex8, wf32(:,51), n3(:,95), t3x32(:,:,51))
  call vert_UV_W(ntry, wf16(:,21), Q(:,90), ex9, Q(:,256), wf32(:,52), n3(:,96), t3x32(:,:,52))
  call vert_AV_Q(ntry, ex5, wf16(:,1), wf32(:,53), n3(:,97), t3x32(:,:,53))
  call vert_VQ_A(ntry, wf16(:,19), ex7, wf32(:,54), n3(:,98), t3x32(:,:,54))
  call vert_AV_Q(ntry, ex5, wf16(:,2), wf32(:,55), n3(:,99), t3x32(:,:,55))
  ...
  call vert_VQ_A(ntry, ex9, wf8(:,10), wf16(:,45), n3(:,102), t3x16(:,:,31))
  call prop_Q_A(ntry, wf16(:,45), Q(:,325), ZERO, 0_intkind1, wf16(:,46), n2(29))
  call vert_AV_Q(ntry, ex6, wf16(:,17), wf32(:,58), n3(:,103), t3x32(:,:,58))
  call vert_VQ_A(ntry, wf16(:,6), ex8, wf32(:,59), n3(:,104), t3x32(:,:,59))
  call vert_VQ_A(ntry, wf16(:,18), ex8, wf32(:,60), n3(:,105), t3x32(:,:,60))
  call vert_UV_W(ntry, wf16(:,18), Q(:,85), ex9, Q(:,256), wf32(:,61), n3(:,106), t3x32(:,:,61))
  call vert_AV_Q(ntry, ex5, wf16(:,5), wf32(:,62), n3(:,107), t3x32(:,:,62))
  call vert_AV_Q(ntry, ex6, wf16(:,18), wf32(:,63), n3(:,108), t3x32(:,:,63))
  call vert_AV_Q(ntry, ex6, wf16(:,19), wf32(:,64), n3(:,109), t3x32(:,:,64))
  call vert_AV_Q(ntry, ex5, wf16(:,6), wf32(:,65), n3(:,110), t3x32(:,:,65))
  call vert_AV_Q(ntry, ex5, wf16(:,7), wf32(:,66), n3(:,111), t3x32(:,:,66))
  call vert_VQ_A(ntry, ex9, wf8(:,12), wf16(:,47), n3(:,112), t3x16(:,:,32))
  call prop_Q_A(ntry, wf16(:,47), Q(:,389), ZERO, 0_intkind1, wf16(:,48), n2(30))
  call vert_AV_Q(ntry, ex6, wf16(:,20), wf32(:,67), n3(:,113), t3x32(:,:,67))
  call vert_UV_W(ntry, wf16(:,10), Q(:,165), ex9, Q(:,256), wf32(:,68), n3(:,114), t3x32(:,:,68))
  call vert_VQ_A(ntry, wf16(:,10), ex7, wf32(:,69), n3(:,115), t3x32(:,:,69))
  call vert_VQ_A(ntry, wf16(:,22), ex7, wf32(:,70), n3(:,116), t3x32(:,:,70))
  call vert_AV_Q(ntry, ex5, wf16(:,8), wf32(:,71), n3(:,117), t3x32(:,:,71))
  call vert_UV_W(ntry, wf16(:,22), Q(:,149), ex9, Q(:,256), wf32(:,72), n3(:,118), t3x32(:,:,72))
  call vert_AV_Q(ntry, ex6, wf16(:,21), wf32(:,73), n3(:,119), t3x32(:,:,73))
  call vert_AV_Q(ntry, ex6, wf16(:,22), wf32(:,74), n3(:,120), t3x32(:,:,74))
  call vert_AV_Q(ntry, ex5, wf16(:,9), wf32(:,75), n3(:,121), t3x32(:,:,75))
  call vert_AV_Q(ntry, ex5, wf16(:,10), wf32(:,76), n3(:,122), t3x32(:,:,76))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1

  do k = 0, 47-1
    M2(k) = M2add(extcomb_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(2) = ((A(j,1)%j+A(j,4)%j+A(j,5)%j+A(j,7)%j+A(j,11)%j+A(j,12)%j+A(j,14)%j+A(j,16)%j+A(j,49)%j+A(j,52)%j+A(j,53)%j+A(j,55)%j &
  ...
  M1(3) = ((A(j,17)%j+A(j,20)%j+A(j,21)%j+A(j,23)%j+A(j,27)%j+A(j,28)%j+A(j,30)%j+A(j,32)%j+A(j,33)%j+A(j,36)%j+A(j,37)%j &
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllnnjj_vbs_nenmexmxuxuxddg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllnnjj_vbs_nenmexmxuxuxddg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllnnjj_vbs_nenmexmxuxuxddg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllnnjj_vbs_nenmexmxuxuxddg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllnnjj_vbs_nenmexmxuxuxddg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllnnjj_vbs_nenmexmxuxuxddg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllnnjj_vbs_nenmexmxuxuxddg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllnnjj_vbs_nenmexmxuxuxddg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllnnjj_vbs_nenmexmxuxuxddg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllnnjj_vbs_nenmexmxuxuxddg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllnnjj_vbs_nenmexmxuxuxddg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllnnjj_vbs_nenmexmxuxuxddg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllnnjj_vbs_nenmexmxuxuxddg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllnnjj_vbs_nenmexmxuxuxddg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2(0:47-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllnnjj_vbs_nenmexmxuxuxddg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllnnjj_vbs_nenmexmxuxuxddg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,9)
  real(c_double), intent(out) :: m2(9)
...
end module ol_tree_ppllnnjj_vbs_nenmexmxuxuxddg_1_/**/REALKIND
