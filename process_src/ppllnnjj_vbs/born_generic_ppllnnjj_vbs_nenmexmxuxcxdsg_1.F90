...
module ol_external_ppllnnjj_vbs_nenmexmxuxcxdsg_1
  implicit none
  integer :: dummy_counter
  ! Permutation and inverse permutation of external particles
  integer, save :: external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(9) = &
                     [ (dummy_counter, dummy_counter = 1, 9) ]
  integer, save :: external_perm_inv_ppllnnjj_vbs_nenmexmxuxcxdsg_1(9) = &
                     [ (dummy_counter, dummy_counter = 1, 9) ]
  integer, save :: extcomb_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(0:46) = &
                     [ (dummy_counter, dummy_counter = 0, 46) ]
  ! Particle types (mapping of fields to integers is not fixed!)
  integer, save :: particle_types_ppllnnjj_vbs_nenmexmxuxcxdsg_1(9) = &
                     [ 1, 2, 3, 4, 5, 6, 7, 8, 9 ]
  ! Colour and helicity average factors per particle
  integer, save :: average_factors_ppllnnjj_vbs_nenmexmxuxcxdsg_1(9) = &
                     [ 2, 2, 2, 2, 6, 6, 6, 6, 16 ]
  ! Average factor; initialised to the identity permutation
  integer, save :: average_factor_ppllnnjj_vbs_nenmexmxuxcxdsg_1 = &
                     4
  integer, save :: channel_number_ppllnnjj_vbs_nenmexmxuxcxdsg_1 = -1
  ...
  subroutine n_external(n) &
      & bind(c,name="ol_f_n_external_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
  ...
  subroutine n_external_c(n) &
      & bind(c,name="ol_n_external_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
  ...
  subroutine set_permutation(perm) &
      & bind(c,name="ol_f_set_permutation_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    ...
    integer :: i, j, ii, jj
    integer :: particle_types_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(9)
    external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1 = perm
    do i = 1, 9
      external_perm_inv_ppllnnjj_vbs_nenmexmxuxcxdsg_1( &
        external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(i)) = i
      particle_types_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(i) = &
        particle_types_ppllnnjj_vbs_nenmexmxuxcxdsg_1( &
        external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(i))
    end do
    do i = 1, 9
      do j = 1, i
        if (external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(i) >= &
          external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(j)) then
          ii = external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(i)
          jj = external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(j)
        else
          ii = external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(j)
          jj = external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(i)
        end if
        extcomb_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1((i*(i-1))/2 + j) = (ii*(ii-1))/2 + jj
      end do
    end do
    ! Colour and helicity average factor
    average_factor_ppllnnjj_vbs_nenmexmxuxcxdsg_1 = 1
    do i = 1, n_scatt
      average_factor_ppllnnjj_vbs_nenmexmxuxcxdsg_1 = &
        average_factor_ppllnnjj_vbs_nenmexmxuxcxdsg_1 &
        * average_factors_ppllnnjj_vbs_nenmexmxuxcxdsg_1( &
        external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(i))
    end do
    ...
    if (out_symmetry_on /= 0) then
      do i = 1, 9
        average_factor_ppllnnjj_vbs_nenmexmxuxcxdsg_1 = &
          average_factor_ppllnnjj_vbs_nenmexmxuxcxdsg_1 &
          * factorial(count(particle_types_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(n_scatt+1:9) == i))
      end do
    end if
  ...
  subroutine set_permutation_c(perm) &
      & bind(c,name="ol_set_permutation_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    use, intrinsic :: iso_c_binding, only: c_int
    implicit none
  ...
  subroutine get_masses(m_ex) &
      & bind(c,name="ol_f_get_masses_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    ...
    do i = 1, 9
      m_ex(i) = m_ex_orig(external_perm_ppllnnjj_vbs_nenmexmxuxcxdsg_1(i))
    end do
  end subroutine get_masses


  subroutine get_masses_c(m_ex) &
      & bind(c,name="ol_get_masses_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo(sqrt_s, p_rambo) &
      & bind(c,name="ol_f_rambo_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo_c(sqrt_s, p_rambo) &
      & bind(c,name="ol_rambo_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
  ...
  subroutine pol_init(pol) &
      & bind(c,name="ol_f_pol_init_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    implicit none
    integer, intent(in) :: pol(9)
    POLSEL = pol
  end subroutine pol_init

end module ol_external_ppllnnjj_vbs_nenmexmxuxcxdsg_1


module colour_basis_ppllnnjj_vbs_nenmexmxuxcxdsg_1
  implicit none
  ! tree colour basis
  ...
  pure subroutine tree_colbasis_dim(extcols, ncolb, ncoupl, maxpows, nhel) &
    & bind(c, name="ol_tree_colbasis_dim_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    implicit none
  ...
  subroutine tree_colbasis(basis, powers) &
    & bind(c, name="ol_tree_colbasis_ppllnnjj_vbs_nenmexmxuxcxdsg_1")
    implicit none
...
end module colour_basis_ppllnnjj_vbs_nenmexmxuxcxdsg_1


! Only for compatibility with the Sherpa interface

subroutine set_permutation_ppllnnjj_vbs_nenmexmxuxcxdsg_1(perm)
  use ol_external_ppllnnjj_vbs_nenmexmxuxcxdsg_1, only: set_permutation
  implicit none
  integer, intent(in) :: perm(9)
  call set_permutation(perm)
end subroutine set_permutation_ppllnnjj_vbs_nenmexmxuxcxdsg_1

! **********************************************************************
module ol_heltables_ppllnnjj_vbs_nenmexmxuxcxdsg_1
! **********************************************************************
...
! **********************************************************************
  ...
  n2(6) = 16
  call heltable([2,16,32], n3(:,9), t3x32(:,:,2))
  ...
  n2(11) = 16
  call heltable([2,16,32], n3(:,19), t3x32(:,:,4))
  ...
  n2(14) = 16
  call heltable([2,16,32], n3(:,25), t3x32(:,:,6))
  ...
  n2(16) = 16
  call heltable([2,16,32], n3(:,32), t3x32(:,:,8))
  ...
  n2(18) = 16
  call heltable([16,2,32], n3(:,37), t3x32(:,:,11))
  call heltable([4,4,16], n3(:,38), t3x16(:,:,14))
  n2(19) = 16
  call heltable([16,2,32], n3(:,39), t3x32(:,:,12))
  call heltable([2,2,4], n3(:,40), t3x4(:,:,6))
  n2(20) = 4
  call heltable([4,8,32], n3(:,41), t3x32(:,:,13))
  call heltable([4,4,16], n3(:,42), t3x16(:,:,15))
  n2(21) = 16
  call heltable([16,2,32], n3(:,43), t3x32(:,:,14))
  call heltable([4,8,32], n3(:,44), t3x32(:,:,15))
  call heltable([4,4,16], n3(:,45), t3x16(:,:,16))
  n2(22) = 16
  call heltable([16,2,32], n3(:,46), t3x32(:,:,16))
  call heltable([16,2,32], n3(:,47), t3x32(:,:,17))
  call heltable([8,2,16], n3(:,48), t3x16(:,:,17))
  n2(23) = 16
  call heltable([16,2,32], n3(:,49), t3x32(:,:,18))
  call heltable([8,2,16], n3(:,50), t3x16(:,:,18))
  n2(24) = 16
  call heltable([16,2,32], n3(:,51), t3x32(:,:,19))
  call heltable([2,8,16], n3(:,52), t3x16(:,:,19))
  n2(25) = 16
  call heltable([2,16,32], n3(:,53), t3x32(:,:,20))
  call heltable([16,2,32], n3(:,54), t3x32(:,:,21))
  call heltable([16,2,32], n3(:,55), t3x32(:,:,22))
  call heltable([16,2,32], n3(:,56), t3x32(:,:,23))
  call heltable([8,2,16], n3(:,57), t3x16(:,:,20))
  n2(26) = 16
  call heltable([16,2,32], n3(:,58), t3x32(:,:,24))
  call heltable([8,2,16], n3(:,59), t3x16(:,:,21))
  n2(27) = 16
  call heltable([16,2,32], n3(:,60), t3x32(:,:,25))
  call heltable([16,2,32], n3(:,61), t3x32(:,:,26))
  call heltable([16,2,32], n3(:,62), t3x32(:,:,27))
  call heltable([2,8,16], n3(:,63), t3x16(:,:,22))
  n2(28) = 16
  call heltable([2,16,32], n3(:,64), t3x32(:,:,28))
  call heltable([16,2,32], n3(:,65), t3x32(:,:,29))
  call heltable([16,2,32], n3(:,66), t3x32(:,:,30))
  call heltable([2,8,16], n3(:,67), t3x16(:,:,23))
  n2(29) = 16
  call heltable([2,16,32], n3(:,68), t3x32(:,:,31))
  call heltable([2,16,32], n3(:,69), t3x32(:,:,32))
  call heltable([2,16,32], n3(:,70), t3x32(:,:,33))
  call heltable([2,8,16], n3(:,71), t3x16(:,:,24))
  n2(30) = 16
  call heltable([2,16,32], n3(:,72), t3x32(:,:,34))
  call heltable([16,2,32], n3(:,73), t3x32(:,:,35))
  call heltable([16,2,32], n3(:,74), t3x32(:,:,36))
  call heltable([2,16,32], n3(:,75), t3x32(:,:,37))
  call heltable([2,16,32], n3(:,76), t3x32(:,:,38))
...
end module ol_heltables_ppllnnjj_vbs_nenmexmxuxcxdsg_1
