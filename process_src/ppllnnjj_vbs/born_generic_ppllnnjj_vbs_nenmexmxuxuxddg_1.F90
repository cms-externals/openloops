...
module ol_external_ppllnnjj_vbs_nenmexmxuxuxddg_1
  implicit none
  integer :: dummy_counter
  ! Permutation and inverse permutation of external particles
  integer, save :: external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(9) = &
                     [ (dummy_counter, dummy_counter = 1, 9) ]
  integer, save :: external_perm_inv_ppllnnjj_vbs_nenmexmxuxuxddg_1(9) = &
                     [ (dummy_counter, dummy_counter = 1, 9) ]
  integer, save :: extcomb_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(0:46) = &
                     [ (dummy_counter, dummy_counter = 0, 46) ]
  ! Particle types (mapping of fields to integers is not fixed!)
  integer, save :: particle_types_ppllnnjj_vbs_nenmexmxuxuxddg_1(9) = &
                     [ 1, 2, 3, 4, 5, 5, 6, 6, 7 ]
  ! Colour and helicity average factors per particle
  integer, save :: average_factors_ppllnnjj_vbs_nenmexmxuxuxddg_1(9) = &
                     [ 2, 2, 2, 2, 6, 6, 6, 6, 16 ]
  ! Average factor; initialised to the identity permutation
  integer, save :: average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1 = &
                     16
  integer, save :: channel_number_ppllnnjj_vbs_nenmexmxuxuxddg_1 = -1
  ...
  subroutine n_external(n) &
      & bind(c,name="ol_f_n_external_ppllnnjj_vbs_nenmexmxuxuxddg_1")
  ...
  subroutine n_external_c(n) &
      & bind(c,name="ol_n_external_ppllnnjj_vbs_nenmexmxuxuxddg_1")
  ...
  subroutine set_permutation(perm) &
      & bind(c,name="ol_f_set_permutation_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    ...
    integer :: i, j, ii, jj
    integer :: particle_types_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(9)
    external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1 = perm
    do i = 1, 9
      external_perm_inv_ppllnnjj_vbs_nenmexmxuxuxddg_1( &
        external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(i)) = i
      particle_types_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(i) = &
        particle_types_ppllnnjj_vbs_nenmexmxuxuxddg_1( &
        external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(i))
    end do
    do i = 1, 9
      do j = 1, i
        if (external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(i) >= &
          external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(j)) then
          ii = external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(i)
          jj = external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(j)
        else
          ii = external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(j)
          jj = external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(i)
        end if
        extcomb_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1((i*(i-1))/2 + j) = (ii*(ii-1))/2 + jj
      end do
    end do
    ! Colour and helicity average factor
    average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1 = 1
    do i = 1, n_scatt
      average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1 = &
        average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1 &
        * average_factors_ppllnnjj_vbs_nenmexmxuxuxddg_1( &
        external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(i))
    end do
    ...
    if (out_symmetry_on /= 0) then
      do i = 1, 9
        average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1 = &
          average_factor_ppllnnjj_vbs_nenmexmxuxuxddg_1 &
          * factorial(count(particle_types_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(n_scatt+1:9) == i))
      end do
    end if
  ...
  subroutine set_permutation_c(perm) &
      & bind(c,name="ol_set_permutation_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    use, intrinsic :: iso_c_binding, only: c_int
    implicit none
  ...
  subroutine get_masses(m_ex) &
      & bind(c,name="ol_f_get_masses_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    ...
    do i = 1, 9
      m_ex(i) = m_ex_orig(external_perm_ppllnnjj_vbs_nenmexmxuxuxddg_1(i))
    end do
  end subroutine get_masses


  subroutine get_masses_c(m_ex) &
      & bind(c,name="ol_get_masses_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo(sqrt_s, p_rambo) &
      & bind(c,name="ol_f_rambo_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo_c(sqrt_s, p_rambo) &
      & bind(c,name="ol_rambo_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
  ...
  subroutine pol_init(pol) &
      & bind(c,name="ol_f_pol_init_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    implicit none
    integer, intent(in) :: pol(9)
    POLSEL = pol
  end subroutine pol_init

end module ol_external_ppllnnjj_vbs_nenmexmxuxuxddg_1


module colour_basis_ppllnnjj_vbs_nenmexmxuxuxddg_1
  implicit none
  ! tree colour basis
  ...
  pure subroutine tree_colbasis_dim(extcols, ncolb, ncoupl, maxpows, nhel) &
    & bind(c, name="ol_tree_colbasis_dim_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    implicit none
  ...
  subroutine tree_colbasis(basis, powers) &
    & bind(c, name="ol_tree_colbasis_ppllnnjj_vbs_nenmexmxuxuxddg_1")
    implicit none
    ...
    basis = reshape( &
      [1,99,4,1,101,4,1,105,4,1,107,4], &
      [3,4])
#endif
  end subroutine tree_colbasis

end module colour_basis_ppllnnjj_vbs_nenmexmxuxuxddg_1


! Only for compatibility with the Sherpa interface

subroutine set_permutation_ppllnnjj_vbs_nenmexmxuxuxddg_1(perm)
  use ol_external_ppllnnjj_vbs_nenmexmxuxuxddg_1, only: set_permutation
  implicit none
  integer, intent(in) :: perm(9)
  call set_permutation(perm)
end subroutine set_permutation_ppllnnjj_vbs_nenmexmxuxuxddg_1

! **********************************************************************
module ol_heltables_ppllnnjj_vbs_nenmexmxuxuxddg_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(30), n3(3,234)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x4(2,4,6), t3x8(2,8,8), t3x16(2,16,32), t3x32(2,32,76), t3x512(2,512,112)
...
! **********************************************************************
  ...
  call heltable([8,4,32], n3(:,7), t3x32(:,:,1))
  ...
  n2(7) = 16
  call heltable([2,16,32], n3(:,12), t3x32(:,:,3))
  call heltable([2,16,32], n3(:,13), t3x32(:,:,4))
  ...
  call heltable([8,2,16], n3(:,23), t3x16(:,:,8))
  call heltable([8,2,16], n3(:,24), t3x16(:,:,9))
  call heltable([4,4,16], n3(:,25), t3x16(:,:,10))
  n2(11) = 16
  call heltable([2,16,32], n3(:,26), t3x32(:,:,7))
  call heltable([2,16,32], n3(:,27), t3x32(:,:,8))
  ...
  n2(14) = 16
  call heltable([2,16,32], n3(:,35), t3x32(:,:,11))
  call heltable([2,16,32], n3(:,36), t3x32(:,:,12))
  ...
  call heltable([8,2,16], n3(:,41), t3x16(:,:,16))
  ...
  n2(16) = 16
  call heltable([2,16,32], n3(:,47), t3x32(:,:,15))
  call heltable([2,16,32], n3(:,48), t3x32(:,:,16))
  call heltable([2,2,4], n3(:,49), t3x4(:,:,5))
  n2(17) = 4
  call heltable([4,8,32], n3(:,50), t3x32(:,:,17))
  call heltable([4,8,32], n3(:,51), t3x32(:,:,18))
  call heltable([4,4,16], n3(:,52), t3x16(:,:,21))
  n2(18) = 16
  call heltable([16,2,32], n3(:,53), t3x32(:,:,19))
  call heltable([4,8,32], n3(:,54), t3x32(:,:,20))
  call heltable([4,8,32], n3(:,55), t3x32(:,:,21))
  call heltable([16,2,32], n3(:,56), t3x32(:,:,22))
  call heltable([4,4,16], n3(:,57), t3x16(:,:,22))
  n2(19) = 16
  call heltable([16,2,32], n3(:,58), t3x32(:,:,23))
  call heltable([16,2,32], n3(:,59), t3x32(:,:,24))
  call heltable([2,2,4], n3(:,60), t3x4(:,:,6))
  n2(20) = 4
  call heltable([4,8,32], n3(:,61), t3x32(:,:,25))
  call heltable([4,8,32], n3(:,62), t3x32(:,:,26))
  call heltable([4,4,16], n3(:,63), t3x16(:,:,23))
  n2(21) = 16
  call heltable([16,2,32], n3(:,64), t3x32(:,:,27))
  call heltable([4,8,32], n3(:,65), t3x32(:,:,28))
  call heltable([4,8,32], n3(:,66), t3x32(:,:,29))
  call heltable([16,2,32], n3(:,67), t3x32(:,:,30))
  call heltable([4,4,16], n3(:,68), t3x16(:,:,24))
  n2(22) = 16
  call heltable([16,2,32], n3(:,69), t3x32(:,:,31))
  call heltable([16,2,32], n3(:,70), t3x32(:,:,32))
  call heltable([16,2,32], n3(:,71), t3x32(:,:,33))
  call heltable([8,2,16], n3(:,72), t3x16(:,:,25))
  n2(23) = 16
  call heltable([16,2,32], n3(:,73), t3x32(:,:,34))
  call heltable([16,2,32], n3(:,74), t3x32(:,:,35))
  call heltable([16,2,32], n3(:,75), t3x32(:,:,36))
  call heltable([8,2,16], n3(:,76), t3x16(:,:,26))
  n2(24) = 16
  call heltable([16,2,32], n3(:,77), t3x32(:,:,37))
  call heltable([16,2,32], n3(:,78), t3x32(:,:,38))
  call heltable([16,2,32], n3(:,79), t3x32(:,:,39))
  call heltable([2,8,16], n3(:,80), t3x16(:,:,27))
  n2(25) = 16
  call heltable([2,16,32], n3(:,81), t3x32(:,:,40))
  call heltable([16,2,32], n3(:,82), t3x32(:,:,41))
  call heltable([2,8,16], n3(:,83), t3x16(:,:,28))
  n2(26) = 16
  call heltable([2,16,32], n3(:,84), t3x32(:,:,42))
  call heltable([16,2,32], n3(:,85), t3x32(:,:,43))
  call heltable([16,2,32], n3(:,86), t3x32(:,:,44))
  call heltable([16,2,32], n3(:,87), t3x32(:,:,45))
  call heltable([8,2,16], n3(:,88), t3x16(:,:,29))
  n2(27) = 16
  call heltable([16,2,32], n3(:,89), t3x32(:,:,46))
  call heltable([16,2,32], n3(:,90), t3x32(:,:,47))
  call heltable([16,2,32], n3(:,91), t3x32(:,:,48))
  call heltable([8,2,16], n3(:,92), t3x16(:,:,30))
  n2(28) = 16
  call heltable([16,2,32], n3(:,93), t3x32(:,:,49))
  call heltable([16,2,32], n3(:,94), t3x32(:,:,50))
  call heltable([16,2,32], n3(:,95), t3x32(:,:,51))
  call heltable([16,2,32], n3(:,96), t3x32(:,:,52))
  call heltable([2,16,32], n3(:,97), t3x32(:,:,53))
  call heltable([16,2,32], n3(:,98), t3x32(:,:,54))
  call heltable([2,16,32], n3(:,99), t3x32(:,:,55))
  call heltable([16,2,32], n3(:,100), t3x32(:,:,56))
  call heltable([16,2,32], n3(:,101), t3x32(:,:,57))
  call heltable([2,8,16], n3(:,102), t3x16(:,:,31))
  n2(29) = 16
  call heltable([2,16,32], n3(:,103), t3x32(:,:,58))
  call heltable([16,2,32], n3(:,104), t3x32(:,:,59))
  call heltable([16,2,32], n3(:,105), t3x32(:,:,60))
  call heltable([16,2,32], n3(:,106), t3x32(:,:,61))
  call heltable([2,16,32], n3(:,107), t3x32(:,:,62))
  call heltable([2,16,32], n3(:,108), t3x32(:,:,63))
  call heltable([2,16,32], n3(:,109), t3x32(:,:,64))
  call heltable([2,16,32], n3(:,110), t3x32(:,:,65))
  call heltable([2,16,32], n3(:,111), t3x32(:,:,66))
  call heltable([2,8,16], n3(:,112), t3x16(:,:,32))
  n2(30) = 16
  call heltable([2,16,32], n3(:,113), t3x32(:,:,67))
  call heltable([16,2,32], n3(:,114), t3x32(:,:,68))
  call heltable([16,2,32], n3(:,115), t3x32(:,:,69))
  call heltable([16,2,32], n3(:,116), t3x32(:,:,70))
  call heltable([2,16,32], n3(:,117), t3x32(:,:,71))
  call heltable([16,2,32], n3(:,118), t3x32(:,:,72))
  call heltable([2,16,32], n3(:,119), t3x32(:,:,73))
  call heltable([2,16,32], n3(:,120), t3x32(:,:,74))
  call heltable([2,16,32], n3(:,121), t3x32(:,:,75))
  call heltable([2,16,32], n3(:,122), t3x32(:,:,76))
  call heltable([16,32,512], n3(:,123), t3x512(:,:,1))
  call heltable([16,32,512], n3(:,124), t3x512(:,:,2))
  call heltable([16,32,512], n3(:,125), t3x512(:,:,3))
  call heltable([16,32,512], n3(:,126), t3x512(:,:,4))
  call heltable([16,32,512], n3(:,127), t3x512(:,:,5))
  call heltable([32,16,512], n3(:,128), t3x512(:,:,6))
  call heltable([32,16,512], n3(:,129), t3x512(:,:,7))
  call heltable([32,16,512], n3(:,130), t3x512(:,:,8))
  call heltable([16,32,512], n3(:,131), t3x512(:,:,9))
  call heltable([32,16,512], n3(:,132), t3x512(:,:,10))
  call heltable([32,16,512], n3(:,133), t3x512(:,:,11))
  call heltable([32,16,512], n3(:,134), t3x512(:,:,12))
  call heltable([16,32,512], n3(:,135), t3x512(:,:,13))
  call heltable([16,32,512], n3(:,136), t3x512(:,:,14))
  call heltable([16,32,512], n3(:,137), t3x512(:,:,15))
  call heltable([16,32,512], n3(:,138), t3x512(:,:,16))
  call heltable([16,32,512], n3(:,139), t3x512(:,:,17))
  call heltable([16,32,512], n3(:,140), t3x512(:,:,18))
  call heltable([16,32,512], n3(:,141), t3x512(:,:,19))
  call heltable([16,32,512], n3(:,142), t3x512(:,:,20))
  call heltable([16,32,512], n3(:,143), t3x512(:,:,21))
  call heltable([32,16,512], n3(:,144), t3x512(:,:,22))
  call heltable([32,16,512], n3(:,145), t3x512(:,:,23))
  call heltable([32,16,512], n3(:,146), t3x512(:,:,24))
  call heltable([16,32,512], n3(:,147), t3x512(:,:,25))
  call heltable([32,16,512], n3(:,148), t3x512(:,:,26))
  call heltable([32,16,512], n3(:,149), t3x512(:,:,27))
  call heltable([32,16,512], n3(:,150), t3x512(:,:,28))
  call heltable([16,32,512], n3(:,151), t3x512(:,:,29))
  call heltable([16,32,512], n3(:,152), t3x512(:,:,30))
  call heltable([16,32,512], n3(:,153), t3x512(:,:,31))
  call heltable([16,32,512], n3(:,154), t3x512(:,:,32))
  call heltable([16,32,512], n3(:,155), t3x512(:,:,33))
  call heltable([16,32,512], n3(:,156), t3x512(:,:,34))
  call heltable([16,32,512], n3(:,157), t3x512(:,:,35))
  call heltable([16,32,512], n3(:,158), t3x512(:,:,36))
  call heltable([16,32,512], n3(:,159), t3x512(:,:,37))
  call heltable([16,32,512], n3(:,160), t3x512(:,:,38))
  call heltable([16,32,512], n3(:,161), t3x512(:,:,39))
  call heltable([16,32,512], n3(:,162), t3x512(:,:,40))
  call heltable([16,32,512], n3(:,163), t3x512(:,:,41))
  call heltable([16,32,512], n3(:,164), t3x512(:,:,42))
  call heltable([16,32,512], n3(:,165), t3x512(:,:,43))
  call heltable([16,32,512], n3(:,166), t3x512(:,:,44))
  call heltable([16,32,512], n3(:,167), t3x512(:,:,45))
  call heltable([16,32,512], n3(:,168), t3x512(:,:,46))
  call heltable([16,32,512], n3(:,169), t3x512(:,:,47))
  call heltable([16,32,512], n3(:,170), t3x512(:,:,48))
  call heltable([16,32,512], n3(:,171), t3x512(:,:,49))
  call heltable([16,32,512], n3(:,172), t3x512(:,:,50))
  call heltable([16,32,512], n3(:,173), t3x512(:,:,51))
  call heltable([16,32,512], n3(:,174), t3x512(:,:,52))
  call heltable([16,32,512], n3(:,175), t3x512(:,:,53))
  call heltable([16,32,512], n3(:,176), t3x512(:,:,54))
  call heltable([16,32,512], n3(:,177), t3x512(:,:,55))
  call heltable([16,32,512], n3(:,178), t3x512(:,:,56))
  call heltable([16,32,512], n3(:,179), t3x512(:,:,57))
  call heltable([16,32,512], n3(:,180), t3x512(:,:,58))
  call heltable([16,32,512], n3(:,181), t3x512(:,:,59))
  call heltable([16,32,512], n3(:,182), t3x512(:,:,60))
  call heltable([16,32,512], n3(:,183), t3x512(:,:,61))
  call heltable([16,32,512], n3(:,184), t3x512(:,:,62))
  call heltable([16,32,512], n3(:,185), t3x512(:,:,63))
  call heltable([16,32,512], n3(:,186), t3x512(:,:,64))
  call heltable([16,32,512], n3(:,187), t3x512(:,:,65))
  call heltable([16,32,512], n3(:,188), t3x512(:,:,66))
  call heltable([16,32,512], n3(:,189), t3x512(:,:,67))
  call heltable([16,32,512], n3(:,190), t3x512(:,:,68))
  call heltable([16,32,512], n3(:,191), t3x512(:,:,69))
  call heltable([16,32,512], n3(:,192), t3x512(:,:,70))
  call heltable([16,32,512], n3(:,193), t3x512(:,:,71))
  call heltable([16,32,512], n3(:,194), t3x512(:,:,72))
  call heltable([16,32,512], n3(:,195), t3x512(:,:,73))
  call heltable([16,32,512], n3(:,196), t3x512(:,:,74))
  call heltable([16,32,512], n3(:,197), t3x512(:,:,75))
  call heltable([16,32,512], n3(:,198), t3x512(:,:,76))
  call heltable([16,32,512], n3(:,199), t3x512(:,:,77))
  call heltable([16,32,512], n3(:,200), t3x512(:,:,78))
  call heltable([16,32,512], n3(:,201), t3x512(:,:,79))
  call heltable([16,32,512], n3(:,202), t3x512(:,:,80))
  call heltable([16,32,512], n3(:,203), t3x512(:,:,81))
  call heltable([16,32,512], n3(:,204), t3x512(:,:,82))
  call heltable([16,32,512], n3(:,205), t3x512(:,:,83))
  call heltable([16,32,512], n3(:,206), t3x512(:,:,84))
  call heltable([16,32,512], n3(:,207), t3x512(:,:,85))
  call heltable([16,32,512], n3(:,208), t3x512(:,:,86))
  call heltable([16,32,512], n3(:,209), t3x512(:,:,87))
  call heltable([16,32,512], n3(:,210), t3x512(:,:,88))
  call heltable([16,32,512], n3(:,211), t3x512(:,:,89))
  call heltable([16,32,512], n3(:,212), t3x512(:,:,90))
  call heltable([16,32,512], n3(:,213), t3x512(:,:,91))
  call heltable([16,32,512], n3(:,214), t3x512(:,:,92))
  call heltable([16,32,512], n3(:,215), t3x512(:,:,93))
  call heltable([16,32,512], n3(:,216), t3x512(:,:,94))
  call heltable([16,32,512], n3(:,217), t3x512(:,:,95))
  call heltable([16,32,512], n3(:,218), t3x512(:,:,96))
  call heltable([16,32,512], n3(:,219), t3x512(:,:,97))
  call heltable([16,32,512], n3(:,220), t3x512(:,:,98))
  call heltable([16,32,512], n3(:,221), t3x512(:,:,99))
  call heltable([16,32,512], n3(:,222), t3x512(:,:,100))
  call heltable([16,32,512], n3(:,223), t3x512(:,:,101))
  call heltable([16,32,512], n3(:,224), t3x512(:,:,102))
  call heltable([16,32,512], n3(:,225), t3x512(:,:,103))
  call heltable([16,32,512], n3(:,226), t3x512(:,:,104))
  call heltable([16,32,512], n3(:,227), t3x512(:,:,105))
  call heltable([16,32,512], n3(:,228), t3x512(:,:,106))
  call heltable([16,32,512], n3(:,229), t3x512(:,:,107))
  call heltable([16,32,512], n3(:,230), t3x512(:,:,108))
  call heltable([16,32,512], n3(:,231), t3x512(:,:,109))
  call heltable([16,32,512], n3(:,232), t3x512(:,:,110))
  call heltable([16,32,512], n3(:,233), t3x512(:,:,111))
  call heltable([16,32,512], n3(:,234), t3x512(:,:,112))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_ppllnnjj_vbs_nenmexmxuxuxddg_1
