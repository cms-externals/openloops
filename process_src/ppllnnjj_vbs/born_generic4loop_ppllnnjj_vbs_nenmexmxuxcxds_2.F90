...
! **********************************************************************
module ol_heltables_ppllnnjj_vbs_nenmexmxuxcxds_2
! **********************************************************************
...
! **********************************************************************
  ...
  n2(7) = 8
  n2(8) = 8
  call heltable([8,4,32], n3(:,15), t3x32(:,:,1))
  call heltable([2,8,16], n3(:,16), t3x16(:,:,9))
  n2(9) = 16
  call heltable([2,8,16], n3(:,17), t3x16(:,:,10))
  call heltable([2,4,8], n3(:,18), t3x8(:,:,3))
  call heltable([4,2,8], n3(:,19), t3x8(:,:,4))
  n2(10) = 8
  n2(11) = 8
  call heltable([8,4,32], n3(:,20), t3x32(:,:,2))
  call heltable([8,2,16], n3(:,21), t3x16(:,:,11))
  call heltable([8,2,16], n3(:,22), t3x16(:,:,12))
  call heltable([2,8,16], n3(:,23), t3x16(:,:,13))
  call heltable([2,8,16], n3(:,24), t3x16(:,:,14))
  call heltable([8,2,16], n3(:,25), t3x16(:,:,15))
  call heltable([8,2,16], n3(:,26), t3x16(:,:,16))
  ...
  call heltable([8,2,16], n3(:,36), t3x16(:,:,20))
  call heltable([2,8,16], n3(:,37), t3x16(:,:,21))
  call heltable([2,8,16], n3(:,38), t3x16(:,:,22))
  call heltable([8,2,16], n3(:,39), t3x16(:,:,23))
  call heltable([8,2,16], n3(:,40), t3x16(:,:,24))
  n2(17) = 16
  n2(18) = 16
  n2(19) = 16
  n2(20) = 16
  ...
  n2(23) = 8
  call heltable([8,2,16], n3(:,42), t3x16(:,:,25))
  call heltable([8,2,16], n3(:,43), t3x16(:,:,26))
  call heltable([4,2,8], n3(:,44), t3x8(:,:,10))
  n2(24) = 8
  call heltable([8,2,16], n3(:,45), t3x16(:,:,27))
  call heltable([8,2,16], n3(:,46), t3x16(:,:,28))
  call heltable([2,4,8], n3(:,47), t3x8(:,:,11))
  n2(25) = 8
  call heltable([2,8,16], n3(:,48), t3x16(:,:,29))
  call heltable([2,4,8], n3(:,49), t3x8(:,:,12))
  n2(26) = 8
  call heltable([2,8,16], n3(:,50), t3x16(:,:,30))
  call heltable([4,8,32], n3(:,51), t3x32(:,:,5))
  call heltable([4,8,32], n3(:,52), t3x32(:,:,6))
  n2(27) = 16
  n2(28) = 16
  n2(29) = 16
  n2(30) = 16
  call heltable([4,2,8], n3(:,53), t3x8(:,:,13))
  n2(31) = 8
  call heltable([8,2,16], n3(:,54), t3x16(:,:,31))
  call heltable([8,2,16], n3(:,55), t3x16(:,:,32))
  call heltable([4,2,8], n3(:,56), t3x8(:,:,14))
  n2(32) = 8
  call heltable([8,2,16], n3(:,57), t3x16(:,:,33))
  call heltable([8,2,16], n3(:,58), t3x16(:,:,34))
  call heltable([2,4,8], n3(:,59), t3x8(:,:,15))
  n2(33) = 8
  call heltable([2,8,16], n3(:,60), t3x16(:,:,35))
  call heltable([2,4,8], n3(:,61), t3x8(:,:,16))
  n2(34) = 8
  call heltable([2,8,16], n3(:,62), t3x16(:,:,36))
...
end module ol_heltables_ppllnnjj_vbs_nenmexmxuxcxds_2
