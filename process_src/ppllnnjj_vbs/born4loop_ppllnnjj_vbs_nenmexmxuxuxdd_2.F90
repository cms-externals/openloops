...
module ol_tree_ppllnnjj_vbs_nenmexmxuxuxdd_2_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllnnjj_vbs_nenmexmxuxuxdd_2")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllnnjj_vbs_nenmexmxuxuxdd_2_/**/DREALKIND, only: &
...
! **********************************************************************
  ...
  use ol_external_ppllnnjj_vbs_nenmexmxuxuxdd_2, only: &
    & external_perm_ppllnnjj_vbs_nenmexmxuxuxdd_2, &
    & external_perm_inv_ppllnnjj_vbs_nenmexmxuxuxdd_2, &
    & extcomb_perm_ppllnnjj_vbs_nenmexmxuxuxdd_2, &
    & average_factor_ppllnnjj_vbs_nenmexmxuxuxdd_2
  use ol_external_ppllnnjj_vbs_nenmexmxuxuxdd_2, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppllnnjj_vbs_nenmexmxuxuxdd_2_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllnnjj_vbs_nenmexmxuxuxdd_2_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_ppllnnjj_vbs_nenmexmxuxuxdd_2
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_ppllnnjj_vbs_nenmexmxuxuxdd_2,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllnnjj_vbs_nenmexmxuxuxdd_2(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllnnjj_vbs_nenmexmxuxuxdd_2(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllnnjj_vbs_nenmexmxuxuxdd_2(extcombs(k))
  end do
  ...
  call vert_QA_W(ntry, ex8, ex6, wf4(:,4), n3(:,4), t3x4(:,:,4))
  call vert_WWV_V(ntry, wf4(:,1), wf4(:,2), wf4(:,3), wf64(:,1), n4(:,1), t4x64(:,:,1))
  call vert_QA_W(ntry, ex8, ex5, wf4(:,5), n3(:,5), t3x4(:,:,5))
  call vert_QA_W(ntry, ex7, ex6, wf4(:,6), n3(:,6), t3x4(:,:,6))
  ...
  call vert_UV_W(ntry, wf4(:,1), Q(:,5), wf4(:,3), Q(:,80), wf16(:,3), n3(:,9), t3x16(:,:,3))
  call vert_UV_W(ntry, wf4(:,2), Q(:,10), wf4(:,4), Q(:,160), wf16(:,4), n3(:,10), t3x16(:,:,4))
  call vert_VV_S(ntry, wf4(:,1), wf4(:,4), wf16(:,5), n3(:,11), t3x16(:,:,5))
  call vert_VV_S(ntry, wf4(:,2), wf4(:,3), wf16(:,6), n3(:,12), t3x16(:,:,6))
  call vert_UV_W(ntry, wf4(:,1), Q(:,5), wf4(:,4), Q(:,160), wf16(:,7), n3(:,13), t3x16(:,:,7))
  call vert_UV_W(ntry, wf4(:,2), Q(:,10), wf4(:,3), Q(:,80), wf16(:,8), n3(:,14), t3x16(:,:,8))
  call vert_AW_Q(ntry, ex6, wf4(:,1), wf8(:,1), n3(:,15), t3x8(:,:,1))
  call vert_WQ_A(ntry, wf4(:,2), ex8, wf8(:,2), n3(:,16), t3x8(:,:,2))
  call prop_A_Q(ntry, wf8(:,1), Q(:,37), ZERO, 0_intkind1, wf8(:,3), n2(1))
  call prop_Q_A(ntry, wf8(:,2), Q(:,138), ZERO, 0_intkind1, wf8(:,4), n2(2))
  call vert_AW_Q(ntry, wf8(:,3), wf4(:,3), wf32(:,1), n3(:,17), t3x32(:,:,1))
  call vert_QA_V(ntry, ex8, wf8(:,3), wf16(:,9), n3(:,18), t3x16(:,:,9))
  call vert_QA_Z(gZd,ntry, ex8, wf8(:,3), wf16(:,10), n3(:,19), t3x16(:,:,10))
  call vert_AW_Q(ntry, ex6, wf4(:,2), wf8(:,5), n3(:,20), t3x8(:,:,3))
  call vert_WQ_A(ntry, wf4(:,1), ex8, wf8(:,6), n3(:,21), t3x8(:,:,4))
  call prop_A_Q(ntry, wf8(:,5), Q(:,42), ZERO, 0_intkind1, wf8(:,7), n2(3))
  call prop_Q_A(ntry, wf8(:,6), Q(:,133), ZERO, 0_intkind1, wf8(:,8), n2(4))
  call vert_AW_Q(ntry, wf8(:,7), wf4(:,3), wf32(:,2), n3(:,22), t3x32(:,:,2))
  call vert_QA_V(ntry, wf8(:,8), ex6, wf16(:,11), n3(:,23), t3x16(:,:,11))
  call vert_QA_Z(gZu,ntry, wf8(:,8), ex6, wf16(:,12), n3(:,24), t3x16(:,:,12))
  call vert_QA_V(ntry, ex8, wf8(:,7), wf16(:,13), n3(:,25), t3x16(:,:,13))
  call vert_QA_Z(gZd,ntry, ex8, wf8(:,7), wf16(:,14), n3(:,26), t3x16(:,:,14))
  call vert_QA_V(ntry, wf8(:,4), ex6, wf16(:,15), n3(:,27), t3x16(:,:,15))
  call vert_QA_Z(gZu,ntry, wf8(:,4), ex6, wf16(:,16), n3(:,28), t3x16(:,:,16))
  call vert_VV_S(ntry, wf4(:,1), wf4(:,5), wf16(:,17), n3(:,29), t3x16(:,:,17))
  call vert_VV_S(ntry, wf4(:,2), wf4(:,6), wf16(:,18), n3(:,30), t3x16(:,:,18))
  call vert_UV_W(ntry, wf4(:,1), Q(:,5), wf4(:,5), Q(:,144), wf16(:,19), n3(:,31), t3x16(:,:,19))
  call vert_UV_W(ntry, wf4(:,2), Q(:,10), wf4(:,6), Q(:,96), wf16(:,20), n3(:,32), t3x16(:,:,20))
  call vert_VV_S(ntry, wf4(:,1), wf4(:,6), wf16(:,21), n3(:,33), t3x16(:,:,21))
  call vert_VV_S(ntry, wf4(:,2), wf4(:,5), wf16(:,22), n3(:,34), t3x16(:,:,22))
  call vert_UV_W(ntry, wf4(:,1), Q(:,5), wf4(:,6), Q(:,96), wf16(:,23), n3(:,35), t3x16(:,:,23))
  call vert_UV_W(ntry, wf4(:,2), Q(:,10), wf4(:,5), Q(:,144), wf16(:,24), n3(:,36), t3x16(:,:,24))
  call vert_AW_Q(ntry, ex5, wf4(:,1), wf8(:,9), n3(:,37), t3x8(:,:,5))
  call prop_A_Q(ntry, wf8(:,9), Q(:,21), ZERO, 0_intkind1, wf8(:,10), n2(5))
  call vert_AW_Q(ntry, wf8(:,10), wf4(:,6), wf32(:,3), n3(:,38), t3x32(:,:,3))
  call vert_QA_V(ntry, ex8, wf8(:,10), wf16(:,25), n3(:,39), t3x16(:,:,25))
  call vert_QA_Z(gZd,ntry, ex8, wf8(:,10), wf16(:,26), n3(:,40), t3x16(:,:,26))
  call vert_AW_Q(ntry, ex5, wf4(:,2), wf8(:,11), n3(:,41), t3x8(:,:,6))
  call prop_A_Q(ntry, wf8(:,11), Q(:,26), ZERO, 0_intkind1, wf8(:,12), n2(6))
  call vert_AW_Q(ntry, wf8(:,12), wf4(:,6), wf32(:,4), n3(:,42), t3x32(:,:,4))
  call vert_QA_V(ntry, wf8(:,8), ex5, wf16(:,27), n3(:,43), t3x16(:,:,27))
  call vert_QA_Z(gZu,ntry, wf8(:,8), ex5, wf16(:,28), n3(:,44), t3x16(:,:,28))
  call vert_QA_V(ntry, ex8, wf8(:,12), wf16(:,29), n3(:,45), t3x16(:,:,29))
  call vert_QA_Z(gZd,ntry, ex8, wf8(:,12), wf16(:,30), n3(:,46), t3x16(:,:,30))
  call vert_QA_V(ntry, wf8(:,4), ex5, wf16(:,31), n3(:,47), t3x16(:,:,31))
  call vert_QA_Z(gZu,ntry, wf8(:,4), ex5, wf16(:,32), n3(:,48), t3x16(:,:,32))
  call vert_WQ_A(ntry, wf4(:,2), ex7, wf8(:,13), n3(:,49), t3x8(:,:,7))
  call prop_Q_A(ntry, wf8(:,13), Q(:,74), ZERO, 0_intkind1, wf8(:,14), n2(7))
  call vert_AW_Q(ntry, wf8(:,3), wf4(:,5), wf32(:,5), n3(:,50), t3x32(:,:,5))
  call vert_QA_V(ntry, ex7, wf8(:,3), wf16(:,33), n3(:,51), t3x16(:,:,33))
  call vert_QA_Z(gZd,ntry, ex7, wf8(:,3), wf16(:,34), n3(:,52), t3x16(:,:,34))
  call vert_WQ_A(ntry, wf4(:,1), ex7, wf8(:,15), n3(:,53), t3x8(:,:,8))
  call prop_Q_A(ntry, wf8(:,15), Q(:,69), ZERO, 0_intkind1, wf8(:,16), n2(8))
  call vert_AW_Q(ntry, wf8(:,7), wf4(:,5), wf32(:,6), n3(:,54), t3x32(:,:,6))
  call vert_QA_V(ntry, wf8(:,16), ex6, wf16(:,35), n3(:,55), t3x16(:,:,35))
  call vert_QA_Z(gZu,ntry, wf8(:,16), ex6, wf16(:,36), n3(:,56), t3x16(:,:,36))
  call vert_QA_V(ntry, ex7, wf8(:,7), wf16(:,37), n3(:,57), t3x16(:,:,37))
  call vert_QA_Z(gZd,ntry, ex7, wf8(:,7), wf16(:,38), n3(:,58), t3x16(:,:,38))
  call vert_QA_V(ntry, wf8(:,14), ex6, wf16(:,39), n3(:,59), t3x16(:,:,39))
  call vert_QA_Z(gZu,ntry, wf8(:,14), ex6, wf16(:,40), n3(:,60), t3x16(:,:,40))
  call vert_AW_Q(ntry, wf8(:,10), wf4(:,4), wf32(:,7), n3(:,61), t3x32(:,:,7))
  call vert_QA_V(ntry, ex7, wf8(:,10), wf16(:,41), n3(:,62), t3x16(:,:,41))
  call vert_QA_Z(gZd,ntry, ex7, wf8(:,10), wf16(:,42), n3(:,63), t3x16(:,:,42))
  call vert_AW_Q(ntry, wf8(:,12), wf4(:,4), wf32(:,8), n3(:,64), t3x32(:,:,8))
  call vert_QA_V(ntry, wf8(:,16), ex5, wf16(:,43), n3(:,65), t3x16(:,:,43))
  call vert_QA_Z(gZu,ntry, wf8(:,16), ex5, wf16(:,44), n3(:,66), t3x16(:,:,44))
  call vert_QA_V(ntry, ex7, wf8(:,12), wf16(:,45), n3(:,67), t3x16(:,:,45))
  call vert_QA_Z(gZd,ntry, ex7, wf8(:,12), wf16(:,46), n3(:,68), t3x16(:,:,46))
  call vert_QA_V(ntry, wf8(:,14), ex5, wf16(:,47), n3(:,69), t3x16(:,:,47))
  call vert_QA_Z(gZu,ntry, wf8(:,14), ex5, wf16(:,48), n3(:,70), t3x16(:,:,48))
  call vert_WQ_A(ntry, wf4(:,3), ex2, wf8(:,17), n3(:,71), t3x8(:,:,9))
  call prop_Q_A(ntry, wf8(:,17), Q(:,82), ZERO, 0_intkind1, wf8(:,18), n2(9))
  call vert_QA_V(ntry, wf8(:,18), ex4, wf16(:,49), n3(:,72), t3x16(:,:,49))
  call vert_QA_Z(gZl,ntry, wf8(:,18), ex4, wf16(:,50), n3(:,73), t3x16(:,:,50))
  call vert_WQ_A(ntry, wf4(:,4), ex2, wf8(:,19), n3(:,74), t3x8(:,:,10))
  call prop_Q_A(ntry, wf8(:,19), Q(:,162), ZERO, 0_intkind1, wf8(:,20), n2(10))
  call vert_QA_V(ntry, wf8(:,20), ex4, wf16(:,51), n3(:,75), t3x16(:,:,51))
  call vert_QA_Z(gZl,ntry, wf8(:,20), ex4, wf16(:,52), n3(:,76), t3x16(:,:,52))
  call vert_AW_Q(ntry, ex4, wf4(:,3), wf8(:,21), n3(:,77), t3x8(:,:,11))
  call prop_A_Q(ntry, wf8(:,21), Q(:,88), ZERO, 0_intkind1, wf8(:,22), n2(11))
  call vert_QA_Z(gZn,ntry, ex2, wf8(:,22), wf16(:,53), n3(:,78), t3x16(:,:,53))
  call vert_AW_Q(ntry, ex4, wf4(:,4), wf8(:,23), n3(:,79), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,23), Q(:,168), ZERO, 0_intkind1, wf8(:,24), n2(12))
  call vert_QA_Z(gZn,ntry, ex2, wf8(:,24), wf16(:,54), n3(:,80), t3x16(:,:,54))
  call vert_WQ_A(ntry, wf4(:,1), wf8(:,18), wf32(:,9), n3(:,81), t3x32(:,:,9))
  call vert_WQ_A(ntry, wf4(:,1), wf8(:,20), wf32(:,10), n3(:,82), t3x32(:,:,10))
  call vert_WQ_A(ntry, wf4(:,5), ex2, wf8(:,25), n3(:,83), t3x8(:,:,13))
  call prop_Q_A(ntry, wf8(:,25), Q(:,146), ZERO, 0_intkind1, wf8(:,26), n2(13))
  call vert_QA_V(ntry, wf8(:,26), ex4, wf16(:,55), n3(:,84), t3x16(:,:,55))
  call vert_QA_Z(gZl,ntry, wf8(:,26), ex4, wf16(:,56), n3(:,85), t3x16(:,:,56))
  call vert_WQ_A(ntry, wf4(:,6), ex2, wf8(:,27), n3(:,86), t3x8(:,:,14))
  call prop_Q_A(ntry, wf8(:,27), Q(:,98), ZERO, 0_intkind1, wf8(:,28), n2(14))
  call vert_QA_V(ntry, wf8(:,28), ex4, wf16(:,57), n3(:,87), t3x16(:,:,57))
  call vert_QA_Z(gZl,ntry, wf8(:,28), ex4, wf16(:,58), n3(:,88), t3x16(:,:,58))
  call vert_AW_Q(ntry, ex4, wf4(:,5), wf8(:,29), n3(:,89), t3x8(:,:,15))
  call prop_A_Q(ntry, wf8(:,29), Q(:,152), ZERO, 0_intkind1, wf8(:,30), n2(15))
  call vert_QA_Z(gZn,ntry, ex2, wf8(:,30), wf16(:,59), n3(:,90), t3x16(:,:,59))
  call vert_AW_Q(ntry, ex4, wf4(:,6), wf8(:,31), n3(:,91), t3x8(:,:,16))
  call prop_A_Q(ntry, wf8(:,31), Q(:,104), ZERO, 0_intkind1, wf8(:,32), n2(16))
  call vert_QA_Z(gZn,ntry, ex2, wf8(:,32), wf16(:,60), n3(:,92), t3x16(:,:,60))
  call vert_WQ_A(ntry, wf4(:,1), wf8(:,26), wf32(:,11), n3(:,93), t3x32(:,:,11))
  call vert_WQ_A(ntry, wf4(:,1), wf8(:,28), wf32(:,12), n3(:,94), t3x32(:,:,12))
  call vert_WQ_A(ntry, wf4(:,3), ex1, wf8(:,33), n3(:,95), t3x8(:,:,17))
  call prop_Q_A(ntry, wf8(:,33), Q(:,81), ZERO, 0_intkind1, wf8(:,34), n2(17))
  call vert_QA_V(ntry, wf8(:,34), ex3, wf16(:,61), n3(:,96), t3x16(:,:,61))
  call vert_QA_Z(gZl,ntry, wf8(:,34), ex3, wf16(:,62), n3(:,97), t3x16(:,:,62))
  call vert_WQ_A(ntry, wf4(:,4), ex1, wf8(:,35), n3(:,98), t3x8(:,:,18))
  call prop_Q_A(ntry, wf8(:,35), Q(:,161), ZERO, 0_intkind1, wf8(:,36), n2(18))
  call vert_QA_V(ntry, wf8(:,36), ex3, wf16(:,63), n3(:,99), t3x16(:,:,63))
  call vert_QA_Z(gZl,ntry, wf8(:,36), ex3, wf16(:,64), n3(:,100), t3x16(:,:,64))
  call vert_AW_Q(ntry, ex3, wf4(:,3), wf8(:,37), n3(:,101), t3x8(:,:,19))
  call prop_A_Q(ntry, wf8(:,37), Q(:,84), ZERO, 0_intkind1, wf8(:,38), n2(19))
  call vert_QA_Z(gZn,ntry, ex1, wf8(:,38), wf16(:,65), n3(:,102), t3x16(:,:,65))
  call vert_AW_Q(ntry, ex3, wf4(:,4), wf8(:,39), n3(:,103), t3x8(:,:,20))
  call prop_A_Q(ntry, wf8(:,39), Q(:,164), ZERO, 0_intkind1, wf8(:,40), n2(20))
  call vert_QA_Z(gZn,ntry, ex1, wf8(:,40), wf16(:,66), n3(:,104), t3x16(:,:,66))
  call vert_WQ_A(ntry, wf4(:,2), wf8(:,34), wf32(:,13), n3(:,105), t3x32(:,:,13))
  call vert_WQ_A(ntry, wf4(:,2), wf8(:,36), wf32(:,14), n3(:,106), t3x32(:,:,14))
  call vert_WQ_A(ntry, wf4(:,5), ex1, wf8(:,41), n3(:,107), t3x8(:,:,21))
  call prop_Q_A(ntry, wf8(:,41), Q(:,145), ZERO, 0_intkind1, wf8(:,42), n2(21))
  call vert_QA_V(ntry, wf8(:,42), ex3, wf16(:,67), n3(:,108), t3x16(:,:,67))
  call vert_QA_Z(gZl,ntry, wf8(:,42), ex3, wf16(:,68), n3(:,109), t3x16(:,:,68))
  call vert_WQ_A(ntry, wf4(:,6), ex1, wf8(:,43), n3(:,110), t3x8(:,:,22))
  call prop_Q_A(ntry, wf8(:,43), Q(:,97), ZERO, 0_intkind1, wf8(:,44), n2(22))
  call vert_QA_V(ntry, wf8(:,44), ex3, wf16(:,69), n3(:,111), t3x16(:,:,69))
  call vert_QA_Z(gZl,ntry, wf8(:,44), ex3, wf16(:,70), n3(:,112), t3x16(:,:,70))
  call vert_AW_Q(ntry, ex3, wf4(:,5), wf8(:,45), n3(:,113), t3x8(:,:,23))
  call prop_A_Q(ntry, wf8(:,45), Q(:,148), ZERO, 0_intkind1, wf8(:,46), n2(23))
  call vert_QA_Z(gZn,ntry, ex1, wf8(:,46), wf16(:,71), n3(:,114), t3x16(:,:,71))
  call vert_AW_Q(ntry, ex3, wf4(:,6), wf8(:,47), n3(:,115), t3x8(:,:,24))
  call prop_A_Q(ntry, wf8(:,47), Q(:,100), ZERO, 0_intkind1, wf8(:,48), n2(24))
  call vert_QA_Z(gZn,ntry, ex1, wf8(:,48), wf16(:,72), n3(:,116), t3x16(:,:,72))
  call vert_WQ_A(ntry, wf4(:,2), wf8(:,42), wf32(:,15), n3(:,117), t3x32(:,:,15))
  call vert_WQ_A(ntry, wf4(:,2), wf8(:,44), wf32(:,16), n3(:,118), t3x32(:,:,16))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppllnnjj_vbs_nenmexmxuxuxdd_2
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_ppllnnjj_vbs_nenmexmxuxuxdd_2

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_ppllnnjj_vbs_nenmexmxuxuxdd_2(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllnnjj_vbs_nenmexmxuxuxdd_2_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllnnjj_vbs_nenmexmxuxuxdd_2")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllnnjj_vbs_nenmexmxuxuxdd_2")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllnnjj_vbs_nenmexmxuxuxdd_2")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllnnjj_vbs_nenmexmxuxuxdd_2")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllnnjj_vbs_nenmexmxuxuxdd_2")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllnnjj_vbs_nenmexmxuxuxdd_2")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllnnjj_vbs_nenmexmxuxuxdd_2")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllnnjj_vbs_nenmexmxuxuxdd_2")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllnnjj_vbs_nenmexmxuxuxdd_2")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllnnjj_vbs_nenmexmxuxuxdd_2")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllnnjj_vbs_nenmexmxuxuxdd_2")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllnnjj_vbs_nenmexmxuxuxdd_2_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllnnjj_vbs_nenmexmxuxuxdd_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllnnjj_vbs_nenmexmxuxuxdd_2_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllnnjj_vbs_nenmexmxuxuxdd_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllnnjj_vbs_nenmexmxuxuxdd_2_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_ppllnnjj_vbs_nenmexmxuxuxdd_2_/**/REALKIND
