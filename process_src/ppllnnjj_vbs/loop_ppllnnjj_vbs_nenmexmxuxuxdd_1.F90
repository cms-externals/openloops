...
! **********************************************************************
  ...
  call vert_AW_Q(wf(:,-4),wf(:,3),wf(:,5))
  call vert_AW_Q(wf(:,-5),wf(:,4),wf(:,6))
  call prop_A_Q(wf(:,5),Q(:,21),ZERO,0_intkind1,wf(:,7))
  call prop_A_Q(wf(:,6),Q(:,42),ZERO,0_intkind1,wf(:,8))
  call vert_QA_V(wf(:,-6),wf(:,7),wf(:,9))
  call vert_QA_V(wf(:,-7),wf(:,8),wf(:,10))
  call vert_QA_V(wf(:,-6),wf(:,8),wf(:,11))
  call vert_QA_V(wf(:,-7),wf(:,7),wf(:,12))
  call vert_WQ_A(wf(:,4),wf(:,-6),wf(:,13))
  call prop_Q_A(wf(:,13),Q(:,74),ZERO,0_intkind1,wf(:,14))
  call vert_QA_V(wf(:,14),wf(:,-5),wf(:,15))
  call vert_WQ_A(wf(:,4),wf(:,-7),wf(:,16))
  call prop_Q_A(wf(:,16),Q(:,138),ZERO,0_intkind1,wf(:,17))
  call vert_QA_V(wf(:,17),wf(:,-5),wf(:,18))
  call vert_AW_Q(wf(:,-4),wf(:,4),wf(:,19))
  call vert_AW_Q(wf(:,-5),wf(:,3),wf(:,20))
  call prop_A_Q(wf(:,19),Q(:,26),ZERO,0_intkind1,wf(:,21))
  call prop_A_Q(wf(:,20),Q(:,37),ZERO,0_intkind1,wf(:,22))
  call vert_QA_V(wf(:,-6),wf(:,21),wf(:,23))
  call vert_QA_V(wf(:,-7),wf(:,22),wf(:,24))
  call vert_QA_V(wf(:,-6),wf(:,22),wf(:,25))
  call vert_QA_V(wf(:,-7),wf(:,21),wf(:,26))
  call vert_QA_V(wf(:,14),wf(:,-4),wf(:,27))
  call vert_QA_V(wf(:,17),wf(:,-4),wf(:,28))
  call vert_WQ_A(wf(:,3),wf(:,-6),wf(:,29))
  call prop_Q_A(wf(:,29),Q(:,69),ZERO,0_intkind1,wf(:,30))
  call vert_QA_V(wf(:,30),wf(:,-5),wf(:,31))
  call vert_QA_V(wf(:,30),wf(:,-4),wf(:,32))
  call vert_WQ_A(wf(:,3),wf(:,-7),wf(:,33))
  call prop_Q_A(wf(:,33),Q(:,133),ZERO,0_intkind1,wf(:,34))
  call vert_QA_V(wf(:,34),wf(:,-5),wf(:,35))
  call vert_QA_V(wf(:,34),wf(:,-4),wf(:,36))
  call counter_QA_V(wf(:,-7),wf(:,8),wf(:,37))
  call counter_QA_V(wf(:,-7),wf(:,7),wf(:,38))
  call counter_WQ_A(wf(:,4),wf(:,-7),wf(:,39))
  call prop_Q_A(wf(:,39),Q(:,138),ZERO,0_intkind1,wf(:,40))
  call vert_QA_V(wf(:,40),wf(:,-5),wf(:,41))
  call counter_QA_V(wf(:,-7),wf(:,22),wf(:,42))
  call counter_QA_V(wf(:,-7),wf(:,21),wf(:,43))
  call vert_QA_V(wf(:,40),wf(:,-4),wf(:,44))
  call counter_WQ_A(wf(:,3),wf(:,-7),wf(:,45))
  call prop_Q_A(wf(:,45),Q(:,133),ZERO,0_intkind1,wf(:,46))
  call vert_QA_V(wf(:,46),wf(:,-5),wf(:,47))
  call vert_QA_V(wf(:,46),wf(:,-4),wf(:,48))
  call counter_QA_V(wf(:,-6),wf(:,8),wf(:,49))
  call counter_QA_V(wf(:,-6),wf(:,7),wf(:,50))
  call counter_WQ_A(wf(:,4),wf(:,-6),wf(:,51))
  call prop_Q_A(wf(:,51),Q(:,74),ZERO,0_intkind1,wf(:,52))
  call vert_QA_V(wf(:,52),wf(:,-5),wf(:,53))
  call counter_QA_V(wf(:,-6),wf(:,22),wf(:,54))
  call counter_QA_V(wf(:,-6),wf(:,21),wf(:,55))
  call vert_QA_V(wf(:,52),wf(:,-4),wf(:,56))
  call counter_WQ_A(wf(:,3),wf(:,-6),wf(:,57))
  call prop_Q_A(wf(:,57),Q(:,69),ZERO,0_intkind1,wf(:,58))
  call vert_QA_V(wf(:,58),wf(:,-5),wf(:,59))
  call vert_QA_V(wf(:,58),wf(:,-4),wf(:,60))
  call counter_QA_V(wf(:,14),wf(:,-5),wf(:,61))
  call counter_QA_V(wf(:,17),wf(:,-5),wf(:,62))
  call counter_AW_Q(wf(:,-5),wf(:,4),wf(:,63))
  call prop_A_Q(wf(:,63),Q(:,42),ZERO,0_intkind1,wf(:,64))
  call vert_QA_V(wf(:,-7),wf(:,64),wf(:,65))
  call vert_QA_V(wf(:,-6),wf(:,64),wf(:,66))
  call counter_QA_V(wf(:,30),wf(:,-5),wf(:,67))
  call counter_QA_V(wf(:,34),wf(:,-5),wf(:,68))
  call counter_AW_Q(wf(:,-5),wf(:,3),wf(:,69))
  call prop_A_Q(wf(:,69),Q(:,37),ZERO,0_intkind1,wf(:,70))
  call vert_QA_V(wf(:,-7),wf(:,70),wf(:,71))
  call vert_QA_V(wf(:,-6),wf(:,70),wf(:,72))
  call counter_QA_V(wf(:,14),wf(:,-4),wf(:,73))
  call counter_QA_V(wf(:,17),wf(:,-4),wf(:,74))
  call counter_AW_Q(wf(:,-4),wf(:,4),wf(:,75))
  call prop_A_Q(wf(:,75),Q(:,26),ZERO,0_intkind1,wf(:,76))
  call vert_QA_V(wf(:,-6),wf(:,76),wf(:,77))
  call vert_QA_V(wf(:,-7),wf(:,76),wf(:,78))
  call counter_QA_V(wf(:,30),wf(:,-4),wf(:,79))
  call counter_QA_V(wf(:,34),wf(:,-4),wf(:,80))
  call counter_AW_Q(wf(:,-4),wf(:,3),wf(:,81))
  call prop_A_Q(wf(:,81),Q(:,21),ZERO,0_intkind1,wf(:,82))
  call vert_QA_V(wf(:,-6),wf(:,82),wf(:,83))
  call vert_QA_V(wf(:,-7),wf(:,82),wf(:,84))
  ...
  call counter_A_Q(ctqq,wf(:,7),Q(:,21),wf(:,89))
  call prop_A_Q(wf(:,89),Q(:,21),ZERO,0_intkind1,wf(:,90))
  call vert_QA_V(wf(:,-6),wf(:,90),wf(:,91))
  call counter_A_Q(ctqq,wf(:,21),Q(:,26),wf(:,92))
  call prop_A_Q(wf(:,92),Q(:,26),ZERO,0_intkind1,wf(:,93))
  call vert_QA_V(wf(:,-6),wf(:,93),wf(:,94))
  call counter_Q_A(ctqq,wf(:,14),Q(:,74),wf(:,95))
  call prop_Q_A(wf(:,95),Q(:,74),ZERO,0_intkind1,wf(:,96))
  call vert_QA_V(wf(:,96),wf(:,-4),wf(:,97))
  call counter_Q_A(ctqq,wf(:,30),Q(:,69),wf(:,98))
  call prop_Q_A(wf(:,98),Q(:,69),ZERO,0_intkind1,wf(:,99))
  call vert_QA_V(wf(:,99),wf(:,-4),wf(:,100))
  call vert_QA_V(wf(:,-7),wf(:,90),wf(:,101))
  call vert_QA_V(wf(:,-7),wf(:,93),wf(:,102))
  call counter_Q_A(ctqq,wf(:,17),Q(:,138),wf(:,103))
  call prop_Q_A(wf(:,103),Q(:,138),ZERO,0_intkind1,wf(:,104))
  call vert_QA_V(wf(:,104),wf(:,-4),wf(:,105))
  call counter_Q_A(ctqq,wf(:,34),Q(:,133),wf(:,106))
  call prop_Q_A(wf(:,106),Q(:,133),ZERO,0_intkind1,wf(:,107))
  call vert_QA_V(wf(:,107),wf(:,-4),wf(:,108))
  call counter_A_Q(ctqq,wf(:,8),Q(:,42),wf(:,109))
  call prop_A_Q(wf(:,109),Q(:,42),ZERO,0_intkind1,wf(:,110))
  call vert_QA_V(wf(:,-6),wf(:,110),wf(:,111))
  call vert_QA_V(wf(:,96),wf(:,-5),wf(:,112))
  call counter_V_V(ctGG,wf(:,18),Q(:,170),wf(:,113))
  call counter_A_Q(ctqq,wf(:,22),Q(:,37),wf(:,114))
  call prop_A_Q(wf(:,114),Q(:,37),ZERO,0_intkind1,wf(:,115))
  call vert_QA_V(wf(:,-6),wf(:,115),wf(:,116))
  call vert_QA_V(wf(:,99),wf(:,-5),wf(:,117))
  call counter_V_V(ctGG,wf(:,35),Q(:,165),wf(:,118))
  call vert_QA_V(wf(:,-7),wf(:,110),wf(:,119))
  call counter_V_V(ctGG,wf(:,15),Q(:,106),wf(:,120))
  call vert_QA_V(wf(:,104),wf(:,-5),wf(:,121))
  call vert_QA_V(wf(:,-7),wf(:,115),wf(:,122))
  call counter_V_V(ctGG,wf(:,31),Q(:,101),wf(:,123))
  call vert_QA_V(wf(:,107),wf(:,-5),wf(:,124))
  ...
  call vert_AV_Q(wf(:,-5),wf(:,9),wf(:,129))
  call prop_A_Q(wf(:,129),Q(:,117),ZERO,0_intkind1,wf(:,130))
  call vert_VQ_A(wf(:,9),wf(:,-7),wf(:,131))
  call prop_Q_A(wf(:,131),Q(:,213),ZERO,0_intkind1,wf(:,132))
  call vert_AV_Q(wf(:,-5),wf(:,12),wf(:,133))
  call prop_A_Q(wf(:,133),Q(:,181),ZERO,0_intkind1,wf(:,134))
  call vert_VQ_A(wf(:,12),wf(:,-6),wf(:,135))
  call prop_Q_A(wf(:,135),Q(:,213),ZERO,0_intkind1,wf(:,136))
  call vert_AV_Q(wf(:,-4),wf(:,25),wf(:,137))
  call prop_A_Q(wf(:,137),Q(:,117),ZERO,0_intkind1,wf(:,138))
  call vert_AV_Q(wf(:,-4),wf(:,24),wf(:,139))
  call prop_A_Q(wf(:,139),Q(:,181),ZERO,0_intkind1,wf(:,140))
  call vert_VQ_A(wf(:,25),wf(:,-7),wf(:,141))
  call prop_Q_A(wf(:,141),Q(:,229),ZERO,0_intkind1,wf(:,142))
  call vert_VQ_A(wf(:,24),wf(:,-6),wf(:,143))
  call prop_Q_A(wf(:,143),Q(:,229),ZERO,0_intkind1,wf(:,144))
  call vert_AV_Q(wf(:,-5),wf(:,32),wf(:,145))
  call prop_A_Q(wf(:,145),Q(:,117),ZERO,0_intkind1,wf(:,146))
  call vert_AV_Q(wf(:,-4),wf(:,31),wf(:,147))
  call prop_A_Q(wf(:,147),Q(:,117),ZERO,0_intkind1,wf(:,148))
  call vert_VQ_A(wf(:,32),wf(:,-7),wf(:,149))
  call prop_Q_A(wf(:,149),Q(:,213),ZERO,0_intkind1,wf(:,150))
  call vert_VQ_A(wf(:,31),wf(:,-7),wf(:,151))
  call prop_Q_A(wf(:,151),Q(:,229),ZERO,0_intkind1,wf(:,152))
  call vert_AV_Q(wf(:,-5),wf(:,36),wf(:,153))
  call prop_A_Q(wf(:,153),Q(:,181),ZERO,0_intkind1,wf(:,154))
  call vert_AV_Q(wf(:,-4),wf(:,35),wf(:,155))
  call prop_A_Q(wf(:,155),Q(:,181),ZERO,0_intkind1,wf(:,156))
  call vert_VQ_A(wf(:,36),wf(:,-6),wf(:,157))
  call prop_Q_A(wf(:,157),Q(:,213),ZERO,0_intkind1,wf(:,158))
  call vert_VQ_A(wf(:,35),wf(:,-6),wf(:,159))
  call prop_Q_A(wf(:,159),Q(:,229),ZERO,0_intkind1,wf(:,160))
  call vert_AV_Q(wf(:,-5),wf(:,23),wf(:,161))
  call prop_A_Q(wf(:,161),Q(:,122),ZERO,0_intkind1,wf(:,162))
  call vert_VQ_A(wf(:,23),wf(:,-7),wf(:,163))
  call prop_Q_A(wf(:,163),Q(:,218),ZERO,0_intkind1,wf(:,164))
  call vert_AV_Q(wf(:,-5),wf(:,26),wf(:,165))
  call prop_A_Q(wf(:,165),Q(:,186),ZERO,0_intkind1,wf(:,166))
  call vert_VQ_A(wf(:,26),wf(:,-6),wf(:,167))
  call prop_Q_A(wf(:,167),Q(:,218),ZERO,0_intkind1,wf(:,168))
  call vert_AV_Q(wf(:,-4),wf(:,11),wf(:,169))
  call prop_A_Q(wf(:,169),Q(:,122),ZERO,0_intkind1,wf(:,170))
  call vert_AV_Q(wf(:,-4),wf(:,10),wf(:,171))
  call prop_A_Q(wf(:,171),Q(:,186),ZERO,0_intkind1,wf(:,172))
  call vert_VQ_A(wf(:,11),wf(:,-7),wf(:,173))
  call prop_Q_A(wf(:,173),Q(:,234),ZERO,0_intkind1,wf(:,174))
  call vert_VQ_A(wf(:,10),wf(:,-6),wf(:,175))
  call prop_Q_A(wf(:,175),Q(:,234),ZERO,0_intkind1,wf(:,176))
  call vert_AV_Q(wf(:,-5),wf(:,27),wf(:,177))
  call prop_A_Q(wf(:,177),Q(:,122),ZERO,0_intkind1,wf(:,178))
  call vert_AV_Q(wf(:,-4),wf(:,15),wf(:,179))
  call prop_A_Q(wf(:,179),Q(:,122),ZERO,0_intkind1,wf(:,180))
  call vert_VQ_A(wf(:,27),wf(:,-7),wf(:,181))
  call prop_Q_A(wf(:,181),Q(:,218),ZERO,0_intkind1,wf(:,182))
  call vert_VQ_A(wf(:,15),wf(:,-7),wf(:,183))
  call prop_Q_A(wf(:,183),Q(:,234),ZERO,0_intkind1,wf(:,184))
  call vert_AV_Q(wf(:,-5),wf(:,28),wf(:,185))
  call prop_A_Q(wf(:,185),Q(:,186),ZERO,0_intkind1,wf(:,186))
  call vert_AV_Q(wf(:,-4),wf(:,18),wf(:,187))
  call prop_A_Q(wf(:,187),Q(:,186),ZERO,0_intkind1,wf(:,188))
  call vert_VQ_A(wf(:,28),wf(:,-6),wf(:,189))
  call prop_Q_A(wf(:,189),Q(:,218),ZERO,0_intkind1,wf(:,190))
  call vert_VQ_A(wf(:,18),wf(:,-6),wf(:,191))
  call prop_Q_A(wf(:,191),Q(:,234),ZERO,0_intkind1,wf(:,192))
