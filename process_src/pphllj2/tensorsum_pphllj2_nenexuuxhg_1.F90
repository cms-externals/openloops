...
! **********************************************************************
module ol_tensor_sum_storage_pphllj2_nenexuuxhg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphllj2_nenexuuxhg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphllj2_nenexuuxhg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pphllj2_nenexuuxhg_1, only: channel_number_pphllj2_nenexuuxhg_1
  ...
  call channel_on(channel_number_pphllj2_nenexuuxhg_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,16)
  momenta_1(:,2) = Q(1:4,48)
  momenta_2(:,1) = Q(1:4,19)
  momenta_2(:,2) = Q(1:4,51)
  ...
  call tensor_integral(3, momenta_2, masses2_3, T3sum(:,1))
  call tensor_integral(3, momenta_2, masses2_2, T3sum(:,2))
  call tensor_integral(3, momenta_2, masses2_1, T3sum(:,3))
  call tensor_integral(3, momenta_1, masses2_2, T3sum(:,4))
  call tensor_integral(3, momenta_1, masses2_1, T3sum(:,5))

  call tensor_integral(4, momenta_4, masses2_5, T4sum(:,1))
  call tensor_integral(4, momenta_4, masses2_4, T4sum(:,2))
  call tensor_integral(4, momenta_3, masses2_5, T4sum(:,3))
  call tensor_integral(4, momenta_3, masses2_4, T4sum(:,4))
  call tensor_integral(4, momenta_5, masses2_5, T4sum(:,5))
  call tensor_integral(4, momenta_5, masses2_4, T4sum(:,6))

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pphllj2_nenexuuxhg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphllj2_nenexuuxhg_1_/**/REALKIND
