...
module ol_versiondata_pphllj2
  implicit none
  character(4) :: generator_revision = "1733"
  interface
    subroutine version_pphllj2(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphllj2
  end interface
end module ol_versiondata_pphllj2


subroutine ol_version_pphllj2(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphllj2, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphllj2
