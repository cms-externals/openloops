...
module ol_versiondata_ppaatt
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppaatt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppaatt
  end interface
end module ol_versiondata_ppaatt


subroutine ol_version_ppaatt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppaatt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppaatt
