...
module ol_colourmatrix_ppaatt_ttxddxaa_1_/**/REALKIND
...
end module ol_colourmatrix_ppaatt_ttxddxaa_1_/**/REALKIND



module ol_forced_parameters_ppaatt_ttxddxaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaatt_ttxddxaa_1_/**/REALKIND

module ol_loop_ppaatt_ttxddxaa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 8) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/9._/**/REALKIND
    f( 9) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/9._/**/REALKIND
    f(10) = (4*CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/9._/**/REALKIND
    ...
    f(14) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/9._/**/REALKIND
    f(15) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/9._/**/REALKIND
...
end module ol_loop_ppaatt_ttxddxaa_1_/**/REALKIND
