...
module ol_colourmatrix_ppaatt_ttxbbxaa_1_/**/REALKIND
...
end module ol_colourmatrix_ppaatt_ttxbbxaa_1_/**/REALKIND



module ol_forced_parameters_ppaatt_ttxbbxaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaatt_ttxbbxaa_1_/**/REALKIND

module ol_loop_ppaatt_ttxbbxaa_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(28), c(43)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 2) = (2*CI*eQED**2*gQCD**2)/9._/**/REALKIND
    f( 3) = (4*CI*eQED**2*gQCD**2)/9._/**/REALKIND
    f( 4) = (CI*countertermnorm*eQED**2*gQCD**4)/9._/**/REALKIND
    f( 5) = (2*CI*countertermnorm*eQED**2*gQCD**4)/9._/**/REALKIND
    f( 6) = (4*CI*countertermnorm*eQED**2*gQCD**4)/9._/**/REALKIND
    f( 7) = CI*countertermnorm*ctAAGG*eQED**2*gQCD**4
    f( 8) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/9._/**/REALKIND
    f( 9) = (2*CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/9._/**/REALKIND
    f(10) = (4*CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/9._/**/REALKIND
    f(11) = (CI*countertermnorm*ctGtt*eQED**2*gQCD**4)/9._/**/REALKIND
    f(12) = (2*CI*countertermnorm*ctGtt*eQED**2*gQCD**4)/9._/**/REALKIND
    f(13) = (4*CI*countertermnorm*ctGtt*eQED**2*gQCD**4)/9._/**/REALKIND
    f(14) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**4)/9._/**/REALKIND
    f(15) = (2*CI*countertermnorm*ctVbb*eQED**2*gQCD**4)/9._/**/REALKIND
    f(16) = (2*CI*countertermnorm*ctVtt*eQED**2*gQCD**4)/9._/**/REALKIND
    f(17) = (4*CI*countertermnorm*ctVtt*eQED**2*gQCD**4)/9._/**/REALKIND
    f(18) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(19) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(20) = (4*CI*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(21) = (eQED**2*gQCD**4*integralnorm*SwB)/18._/**/REALKIND
    f(22) = (eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(23) = (2*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(24) = (4*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(25) = (eQED**2*gQCD**4*integralnorm*SwF)/9._/**/REALKIND
    f(26) = (2*eQED**2*gQCD**4*integralnorm*SwF)/9._/**/REALKIND
    f(27) = (4*eQED**2*gQCD**4*integralnorm*SwF)/9._/**/REALKIND
    f(28) = (8*eQED**2*gQCD**4*integralnorm*SwF)/9._/**/REALKIND

  c = [ 9*CI*f(18), 27*CI*f(18), 9*CI*f(19), 27*CI*f(19), 9*CI*f(20), 27*CI*f(20), 18*f(21), 54*f(21), f(22), 3*f(22), 6*f(22) &
    , 8*f(22), 10*f(22), 18*f(22), 21*f(22), 24*f(22), 54*f(22), f(23), 3*f(23), 6*f(23), 8*f(23), 10*f(23), 18*f(23), 21*f(23) &
    , 24*f(23), 54*f(23), f(24), 3*f(24), 6*f(24), 8*f(24), 10*f(24), 18*f(24), 21*f(24), 24*f(24), 54*f(24), 3*f(25), 9*f(25) &
    , 3*f(26), 9*f(26), 3*f(27), 9*f(27), 3*f(28), 9*f(28) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,20),Q(:,17),MT,1_intkind1,wf(:,23))
  call prop_A_Q(wf(:,21),Q(:,34),MT,1_intkind1,wf(:,24))
  call vert_QA_V(wf(:,23),wf(:,24),wf(:,25))
  call vert_AV_Q(wf(:,-1),wf(:,22),wf(:,26))
  call vert_VQ_A(wf(:,-5),wf(:,23),wf(:,27))
  call prop_A_Q(wf(:,26),Q(:,14),MT,1_intkind1,wf(:,28))
  call vert_VQ_A(wf(:,-5),wf(:,0),wf(:,29))
  call vert_AV_Q(wf(:,-1),wf(:,-4),wf(:,30))
  call prop_Q_A(wf(:,29),Q(:,33),MT,1_intkind1,wf(:,31))
  call prop_A_Q(wf(:,30),Q(:,18),MT,1_intkind1,wf(:,32))
  call vert_QA_V(wf(:,31),wf(:,32),wf(:,33))
  call vert_VQ_A(wf(:,22),wf(:,0),wf(:,34))
  call vert_AV_Q(wf(:,32),wf(:,-5),wf(:,35))
  call prop_Q_A(wf(:,34),Q(:,13),MT,1_intkind1,wf(:,36))
  ...
  call prop_Q_A(wf(:,8),Q(:,52),MB,1_intkind1,wf(:,55))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,56))
  call prop_A_Q(wf(:,56),Q(:,40),MB,1_intkind1,wf(:,57))
  call prop_Q_A(wf(:,18),Q(:,52),MB,1_intkind1,wf(:,58))
  call vert_AV_Q(wf(:,57),wf(:,-4),wf(:,59))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,60))
  call prop_A_Q(wf(:,60),Q(:,24),MB,1_intkind1,wf(:,61))
  call vert_AV_Q(wf(:,61),wf(:,-5),wf(:,62))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,63))
  call prop_A_Q(wf(:,16),Q(:,56),MB,1_intkind1,wf(:,64))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,65))
  call prop_Q_A(wf(:,65),Q(:,36),MB,1_intkind1,wf(:,66))
  call vert_VQ_A(wf(:,1),wf(:,66),wf(:,67))
  call prop_A_Q(wf(:,19),Q(:,56),MB,1_intkind1,wf(:,68))
  ...
  call prop_A_Q(wf(:,89),Q(:,14),MT,1_intkind1,wf(:,90))
  call vert_VQ_A(wf(:,88),wf(:,0),wf(:,91))
  call prop_Q_A(wf(:,91),Q(:,13),MT,1_intkind1,wf(:,92))
  call counter_AV_Q(wf(:,-1),wf(:,22),wf(:,93))
  call prop_Q_A(wf(:,27),Q(:,49),MT,1_intkind1,wf(:,94))
  call counter_AV_Q(wf(:,-1),wf(:,-5),wf(:,95))
  call prop_A_Q(wf(:,95),Q(:,34),MT,1_intkind1,wf(:,96))
  call vert_QA_V(wf(:,23),wf(:,96),wf(:,97))
  call prop_Q_A(wf(:,37),Q(:,49),MT,1_intkind1,wf(:,98))
  call vert_AV_Q(wf(:,96),wf(:,-4),wf(:,99))
  call counter_AV_Q(wf(:,-1),wf(:,-4),wf(:,100))
  call prop_A_Q(wf(:,100),Q(:,18),MT,1_intkind1,wf(:,101))
  ...
  call prop_A_Q(wf(:,35),Q(:,50),MT,1_intkind1,wf(:,109))
  call counter_VQ_A(wf(:,-5),wf(:,0),wf(:,110))
  call prop_Q_A(wf(:,110),Q(:,33),MT,1_intkind1,wf(:,111))
  call vert_QA_V(wf(:,111),wf(:,32),wf(:,112))
  call prop_A_Q(wf(:,38),Q(:,50),MT,1_intkind1,wf(:,113))
  call vert_VQ_A(wf(:,-4),wf(:,111),wf(:,114))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,115))
  call prop_Q_A(wf(:,115),Q(:,17),MT,1_intkind1,wf(:,116))
  ...
  call prop_A_Q(wf(:,125),Q(:,11),MB,1_intkind1,wf(:,126))
  call vert_VQ_A(wf(:,123),wf(:,12),wf(:,127))
  call vert_VQ_A(wf(:,123),wf(:,-2),wf(:,128))
  call prop_Q_A(wf(:,128),Q(:,7),MB,1_intkind1,wf(:,129))
  call vert_QA_V(wf(:,4),wf(:,5),wf(:,130))
  call counter_V_V(ctGG,wf(:,1),Q(:,3),wf(:,131))
  call vert_AV_Q(wf(:,5),wf(:,1),wf(:,132))
  call counter_Q_A(ctbb,wf(:,4),Q(:,20),wf(:,133))
  call prop_A_Q(wf(:,132),Q(:,43),MB,1_intkind1,wf(:,134))
  call counter_A_Q(ctbb,wf(:,5),Q(:,40),wf(:,135))
  call prop_Q_A(wf(:,6),Q(:,23),MB,1_intkind1,wf(:,136))
  call vert_AV_Q(wf(:,-3),wf(:,131),wf(:,137))
  call prop_Q_A(wf(:,133),Q(:,20),MB,1_intkind1,wf(:,138))
  call vert_VQ_A(wf(:,-5),wf(:,138),wf(:,139))
  call counter_A_Q(ctbb,wf(:,9),Q(:,11),wf(:,140))
  call vert_QA_V(wf(:,12),wf(:,13),wf(:,141))
  call vert_AV_Q(wf(:,13),wf(:,1),wf(:,142))
  call counter_Q_A(ctbb,wf(:,12),Q(:,36),wf(:,143))
  call prop_A_Q(wf(:,142),Q(:,27),MB,1_intkind1,wf(:,144))
  call counter_A_Q(ctbb,wf(:,13),Q(:,24),wf(:,145))
  call prop_Q_A(wf(:,14),Q(:,39),MB,1_intkind1,wf(:,146))
  call vert_VQ_A(wf(:,131),wf(:,-2),wf(:,147))
  call counter_Q_A(ctbb,wf(:,17),Q(:,7),wf(:,148))
  call prop_A_Q(wf(:,145),Q(:,24),MB,1_intkind1,wf(:,149))
  call vert_AV_Q(wf(:,149),wf(:,-5),wf(:,150))
  call prop_Q_A(wf(:,143),Q(:,36),MB,1_intkind1,wf(:,151))
  call vert_VQ_A(wf(:,-4),wf(:,151),wf(:,152))
  call prop_A_Q(wf(:,135),Q(:,40),MB,1_intkind1,wf(:,153))
  call vert_AV_Q(wf(:,153),wf(:,-4),wf(:,154))
  call vert_AV_Q(wf(:,24),wf(:,22),wf(:,155))
  call counter_Q_A(cttt,wf(:,23),Q(:,17),wf(:,156))
  call prop_A_Q(wf(:,155),Q(:,46),MT,1_intkind1,wf(:,157))
  call vert_VQ_A(wf(:,22),wf(:,23),wf(:,158))
  call counter_A_Q(cttt,wf(:,24),Q(:,34),wf(:,159))
  call prop_Q_A(wf(:,158),Q(:,29),MT,1_intkind1,wf(:,160))
  call counter_V_V(ctGG,wf(:,22),Q(:,12),wf(:,161))
  call prop_Q_A(wf(:,156),Q(:,17),MT,1_intkind1,wf(:,162))
  call vert_VQ_A(wf(:,-5),wf(:,162),wf(:,163))
  call vert_AV_Q(wf(:,-1),wf(:,161),wf(:,164))
  call counter_A_Q(cttt,wf(:,28),Q(:,14),wf(:,165))
  call vert_AV_Q(wf(:,32),wf(:,22),wf(:,166))
  call counter_Q_A(cttt,wf(:,31),Q(:,33),wf(:,167))
  call prop_A_Q(wf(:,166),Q(:,30),MT,1_intkind1,wf(:,168))
  call vert_VQ_A(wf(:,22),wf(:,31),wf(:,169))
  call counter_A_Q(cttt,wf(:,32),Q(:,18),wf(:,170))
  call prop_Q_A(wf(:,169),Q(:,45),MT,1_intkind1,wf(:,171))
  call vert_VQ_A(wf(:,161),wf(:,0),wf(:,172))
  call counter_Q_A(cttt,wf(:,36),Q(:,13),wf(:,173))
  call prop_A_Q(wf(:,170),Q(:,18),MT,1_intkind1,wf(:,174))
  call vert_AV_Q(wf(:,174),wf(:,-5),wf(:,175))
  call prop_Q_A(wf(:,167),Q(:,33),MT,1_intkind1,wf(:,176))
  call vert_VQ_A(wf(:,-4),wf(:,176),wf(:,177))
  call prop_A_Q(wf(:,159),Q(:,34),MT,1_intkind1,wf(:,178))
  ...
  call prop_Q_A(wf(:,192),Q(:,23),MB,1_intkind1,wf(:,193))
  call vert_VQ_A(wf(:,-5),wf(:,17),wf(:,194))
  call prop_Q_A(wf(:,194),Q(:,39),MB,1_intkind1,wf(:,195))
  call vert_AV_Q(wf(:,9),wf(:,-4),wf(:,196))
  call prop_A_Q(wf(:,196),Q(:,27),MB,1_intkind1,wf(:,197))
  call vert_AV_Q(wf(:,9),wf(:,-5),wf(:,198))
  call prop_A_Q(wf(:,198),Q(:,43),MB,1_intkind1,wf(:,199))
  call vert_VQ_A(wf(:,-4),wf(:,36),wf(:,200))
  call prop_Q_A(wf(:,200),Q(:,29),MT,1_intkind1,wf(:,201))
  call vert_VQ_A(wf(:,-5),wf(:,36),wf(:,202))
  call prop_Q_A(wf(:,202),Q(:,45),MT,1_intkind1,wf(:,203))
  call vert_AV_Q(wf(:,28),wf(:,-4),wf(:,204))
  call prop_A_Q(wf(:,204),Q(:,30),MT,1_intkind1,wf(:,205))
  call vert_AV_Q(wf(:,28),wf(:,-5),wf(:,206))
  call prop_A_Q(wf(:,206),Q(:,46),MT,1_intkind1,wf(:,207))
  call vert_VQ_A(wf(:,39),wf(:,-2),wf(:,208))
  call prop_Q_A(wf(:,208),Q(:,23),MB,1_intkind1,wf(:,209))
  ...
  call prop_Q_A(wf(:,213),Q(:,23),MB,1_intkind1,wf(:,214))
  call vert_AV_Q(wf(:,-3),wf(:,42),wf(:,215))
  call prop_A_Q(wf(:,215),Q(:,27),MB,1_intkind1,wf(:,216))
  call vert_QA_V(wf(:,0),wf(:,109),wf(:,217))
  call vert_VQ_A(wf(:,44),wf(:,0),wf(:,218))
  call prop_Q_A(wf(:,218),Q(:,29),MT,1_intkind1,wf(:,219))
  call vert_AV_Q(wf(:,-1),wf(:,44),wf(:,220))
  call prop_A_Q(wf(:,220),Q(:,30),MT,1_intkind1,wf(:,221))
  call vert_QA_V(wf(:,55),wf(:,-3),wf(:,222))
  call vert_VQ_A(wf(:,46),wf(:,0),wf(:,223))
  call prop_Q_A(wf(:,223),Q(:,29),MT,1_intkind1,wf(:,224))
  call vert_AV_Q(wf(:,-1),wf(:,46),wf(:,225))
  call prop_A_Q(wf(:,225),Q(:,30),MT,1_intkind1,wf(:,226))
  ...
  call prop_Q_A(wf(:,238),Q(:,45),MT,1_intkind1,wf(:,239))
  call vert_AV_Q(wf(:,-1),wf(:,40),wf(:,240))
  call prop_A_Q(wf(:,240),Q(:,46),MT,1_intkind1,wf(:,241))
  call vert_QA_V(wf(:,58),wf(:,-3),wf(:,242))
  call vert_VQ_A(wf(:,41),wf(:,0),wf(:,243))
  call prop_Q_A(wf(:,243),Q(:,45),MT,1_intkind1,wf(:,244))
  call vert_AV_Q(wf(:,-1),wf(:,41),wf(:,245))
  call prop_A_Q(wf(:,245),Q(:,46),MT,1_intkind1,wf(:,246))
...
subroutine denominators()
  ...
  den(89) = 1 / (Q(5,43) - MB2)
  den(92) = 1 / (Q(5,23) - MB2)
  den(104) = 1 / (Q(5,27) - MB2)
  den(107) = 1 / (Q(5,39) - MB2)
  den(123) = 1 / (Q(5,46) - MT2)
  den(127) = 1 / (Q(5,29) - MT2)
  den(130) = 1 / (Q(5,51))
  den(139) = 1 / (Q(5,30) - MT2)
  den(143) = 1 / (Q(5,45) - MT2)
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((A(1)+A(2)+A(3)+A(4)+A(5)+A(6))*f(1))/2._/**/REALKIND+((-A(13)-A(14)-A(15)-A(16)-A(17)-A(18)-A(19) &
       -A(20))*f(2))/2._/**/REALKIND+((A(7)+A(8)+A(9)+A(10)+A(11)+A(12))*f(3))/2._/**/REALKIND
  M1(2) = ((-A(1)-A(2)-A(3)-A(4)-A(5)-A(6))*f(1))/6._/**/REALKIND+((A(13)+A(14)+A(15)+A(16)+A(17)+A(18)+A(19) &
       +A(20))*f(2))/6._/**/REALKIND+((-A(7)-A(8)-A(9)-A(10)-A(11)-A(12))*f(3))/6._/**/REALKIND

  M2(1) = ((-A(102)-A(103)-A(104)-A(105)-A(106)-A(107)-A(108)-A(109)-A(110)-A(111)-A(112)-A(113)-A(114)-A(115)-A(116)-A(117) &
       -A(118)-A(119))*f(4))/2._/**/REALKIND+((A(138)+A(139)+A(140)+A(141)+A(142)+A(143)+A(144)+A(145)+A(146)+A(147)+A(148)+A(149) &
       +A(150)+A(151)+A(152)+A(153)+A(154)+A(155)+A(156)+A(157)+A(158)+A(159)+A(160)+A(161))*f(5))/2._/**/REALKIND+((-A(120) &
       -A(121)-A(122)-A(123)-A(124)-A(125)-A(126)-A(127)-A(128)-A(129)-A(130)-A(131)-A(132)-A(133)-A(134)-A(135)-A(136) &
       -A(137))*f(6))/2._/**/REALKIND+(A(21)*f(7))/2._/**/REALKIND+((A(22)+A(24)+A(28)+A(30)+A(34)+A(36))*f(8))/2._/**/REALKIND+(( &
       -A(46)-A(48)-A(50)-A(51)-A(54)-A(56)-A(58)-A(59))*f(9))/2._/**/REALKIND+((A(62)+A(63)+A(64)+A(65)+A(66) &
       +A(67))*f(10))/2._/**/REALKIND+((A(96)+A(97)+A(98)+A(99)+A(100)+A(101))*f(11))/2._/**/REALKIND+((-A(74)-A(75)-A(76)-A(78) &
       -A(88)-A(89)-A(90)-A(92))*f(12))/2._/**/REALKIND+((A(40)+A(42)+A(68)+A(70)+A(82)+A(84))*f(13))/2._/**/REALKIND+((A(23) &
       +A(25)+A(26)+A(27)+A(29)+A(31)+A(32)+A(33)+A(35)+A(37)+A(38)+A(39))*f(14))/2._/**/REALKIND+((-A(47)-A(49)-A(52)-A(53)-A(55) &
       -A(57)-A(60)-A(61))*f(15))/2._/**/REALKIND+((-A(77)-A(79)-A(80)-A(81)-A(91)-A(93)-A(94)-A(95))*f(16))/2._/**/REALKIND &
       +((A(41)+A(43)+A(44)+A(45)+A(69)+A(71)+A(72)+A(73)+A(83)+A(85)+A(86)+A(87))*f(17))/2._/**/REALKIND
  M2(2) = ((A(102)+A(103)+A(104)+A(105)+A(106)+A(107)+A(108)+A(109)+A(110)+A(111)+A(112)+A(113)+A(114)+A(115)+A(116)+A(117)+A(118) &
       +A(119))*f(4))/6._/**/REALKIND+((-A(138)-A(139)-A(140)-A(141)-A(142)-A(143)-A(144)-A(145)-A(146)-A(147)-A(148)-A(149) &
       -A(150)-A(151)-A(152)-A(153)-A(154)-A(155)-A(156)-A(157)-A(158)-A(159)-A(160)-A(161))*f(5))/6._/**/REALKIND+((A(120)+A(121) &
       +A(122)+A(123)+A(124)+A(125)+A(126)+A(127)+A(128)+A(129)+A(130)+A(131)+A(132)+A(133)+A(134)+A(135)+A(136) &
       +A(137))*f(6))/6._/**/REALKIND-(A(21)*f(7))/6._/**/REALKIND+((-A(22)-A(24)-A(28)-A(30)-A(34)-A(36))*f(8))/6._/**/REALKIND &
       +((A(46)+A(48)+A(50)+A(51)+A(54)+A(56)+A(58)+A(59))*f(9))/6._/**/REALKIND+((-A(62)-A(63)-A(64)-A(65)-A(66) &
       -A(67))*f(10))/6._/**/REALKIND+((-A(96)-A(97)-A(98)-A(99)-A(100)-A(101))*f(11))/6._/**/REALKIND+((A(74)+A(75)+A(76)+A(78) &
       +A(88)+A(89)+A(90)+A(92))*f(12))/6._/**/REALKIND+((-A(40)-A(42)-A(68)-A(70)-A(82)-A(84))*f(13))/6._/**/REALKIND+((-A(23) &
       -A(25)-A(26)-A(27)-A(29)-A(31)-A(32)-A(33)-A(35)-A(37)-A(38)-A(39))*f(14))/6._/**/REALKIND+((A(47)+A(49)+A(52)+A(53)+A(55) &
       +A(57)+A(60)+A(61))*f(15))/6._/**/REALKIND+((A(77)+A(79)+A(80)+A(81)+A(91)+A(93)+A(94)+A(95))*f(16))/6._/**/REALKIND+(( &
       -A(41)-A(43)-A(44)-A(45)-A(69)-A(71)-A(72)-A(73)-A(83)-A(85)-A(86)-A(87))*f(17))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppaatt_ttxbbxaa_1_/**/REALKIND
