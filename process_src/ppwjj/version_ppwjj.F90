...
module ol_versiondata_ppwjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppwjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppwjj
  end interface
end module ol_versiondata_ppwjj


subroutine ol_version_ppwjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppwjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppwjj
