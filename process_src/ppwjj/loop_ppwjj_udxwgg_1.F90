...
module ol_colourmatrix_ppwjj_udxwgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_udxwgg_1_/**/REALKIND



module ol_forced_parameters_ppwjj_udxwgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_udxwgg_1_/**/REALKIND

module ol_loop_ppwjj_udxwgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*eQED*gQCD**4)/(sqrt2*sw)
    f( 4) = (countertermnorm*eQED*gQCD**4)/(sqrt2*sw)
    f( 5) = (CI*countertermnorm*ctGqq*eQED*gQCD**4)/(sqrt2*sw)
    f( 6) = (countertermnorm*ctGqq*eQED*gQCD**4)/(sqrt2*sw)
    f( 7) = (CI*countertermnorm*ctVqq*eQED*gQCD**4)/(sqrt2*sw)
    f( 8) = (countertermnorm*ctVqq*eQED*gQCD**4)/(sqrt2*sw)
    f( 9) = (countertermnorm*ctVVV*eQED*gQCD**4)/(sqrt2*sw)
    f(10) = (CI*eQED*gQCD**4*integralnorm*SwB)/(2._/**/REALKIND*sqrt2*sw)
    f(11) = (CI*eQED*gQCD**4*integralnorm*SwB)/(sqrt2*sw)
    f(12) = (eQED*gQCD**4*integralnorm*SwB)/(sqrt2*sw)
    f(13) = (CI*eQED*gQCD**4*integralnorm*SwF)/(sqrt2*sw)
    f(14) = (2*CI*eQED*gQCD**4*integralnorm*SwF)/(sqrt2*sw)
    f(15) = (eQED*gQCD**4*integralnorm*SwF)/(sqrt2*sw)
    f(16) = (2*eQED*gQCD**4*integralnorm*SwF)/(sqrt2*sw)
...
end module ol_loop_ppwjj_udxwgg_1_/**/REALKIND
