...
! **********************************************************************
module ol_heltables_ppwjj_uccxdxw_1
! **********************************************************************
...
! **********************************************************************
  ...
  ! n = <n>
  call heltable([3,2,6], n1, t1)
  call heltable([2,2,4], n2, t2)
  n3 = 6
  call heltable([6,2,12], n4, t4)
  call heltable([2,3,6], n5, t5)
  n6 = 6
  call heltable([4,2,8], n7, t7)
...
end module ol_heltables_ppwjj_uccxdxw_1
