...
module ol_vamp_1_ppzj_uuxzg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppzj_uuxzg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppzj_uuxzg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppzj_uuxzg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppzj_uuxzg_1_/**/REALKIND
  ...
  call loop_A_Q(G0(:,:,:,13),Q(:,10),ZERO,G1(:,:,:,27))
  call loop_AZ_Q(G1(:,:,:,27),wf(:,-2),G1(:,:,:,28),gZu)
  call loop_A_Q(G1(:,:,:,28),Q(:,14),ZERO,G2(:,:,:,24))
  ...
  call loop_A_Q(G1(:,:,:,30),Q(:,10),ZERO,G2(:,:,:,25))
  call loop_AZ_Q(G2(:,:,:,25),wf(:,-2),G2(:,:,:,26),gZu)
  call loop_A_Q(G2(:,:,:,26),Q(:,14),ZERO,G3(:,:,:,2))
  call check_last_AQ_V(l_switch,G3(:,:,:,2),wf(:,0),G3tensor(:,10))
  call loop_AZ_Q(G1(:,:,:,29),wf(:,-2),G1(:,:,:,31),gZu)
  call loop_A_Q(G1(:,:,:,31),Q(:,6),ZERO,G2(:,:,:,27))
  call loop_AV_Q(G2(:,:,:,27),wf(:,-3),G2(:,:,:,28))
  call loop_A_Q(G2(:,:,:,28),Q(:,14),ZERO,G3(:,:,:,3))
...
end module ol_vamp_1_ppzj_uuxzg_1_/**/REALKIND
