...
module ol_versiondata_ppzj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppzj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzj
  end interface
end module ol_versiondata_ppzj


subroutine ol_version_ppzj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzj
