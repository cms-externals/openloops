...
module ol_versiondata_heftpphj
  implicit none
  character(4) :: generator_revision = "1790"
  interface
    subroutine version_heftpphj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_heftpphj
  end interface
end module ol_versiondata_heftpphj


subroutine ol_version_heftpphj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_heftpphj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_heftpphj
