...
module ol_vamp_1_pplltt_nenexttxgg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplltt_nenexttxgg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplltt_nenexttxgg_1.
! **********************************************************************
...
#endif
  use ol_loop_pplltt_nenexttxgg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplltt_nenexttxgg_1_/**/REALKIND
  ...
  call loop_A_Q(G0(:,:,:,4),Q(:,59),MT,G1(:,:,:,3))
  ...
  call loop_A_Q(G2(:,:,:,145),Q(:,43),MT,G3(:,:,:,51))
  call loop_AV_Q(G3(:,:,:,51),wf(:,-4),G3(:,:,:,52))
  call loop_A_Q(G3(:,:,:,52),Q(:,59),MT,G4(:,:,:,2))
  ...
  call loop_A_Q(G2(:,:,:,147),Q(:,56),MT,G3(:,:,:,53))
  ...
  call loop_Q_A(G0(:,:,:,37),Q(:,52),MT,G1(:,:,:,109))
  call loop_QZ_A(G1(:,:,:,109),wf(:,4),G1(:,:,:,110),gZu)
  call loop_Q_A(G1(:,:,:,110),Q(:,55),MT,G2(:,:,:,166))
  ...
  call loop_A_Q(G0(:,:,:,47),Q(:,56),MT,G1(:,:,:,131))
  call loop_AZ_Q(G1(:,:,:,131),wf(:,4),G1(:,:,:,132),gZu)
  call loop_A_Q(G1(:,:,:,132),Q(:,59),MT,G2(:,:,:,190))
  ...
  call loop_A_Q(G0(:,:,:,48),Q(:,27),MT,G1(:,:,:,133))
  call loop_AV_Q(G1(:,:,:,133),wf(:,-5),G1(:,:,:,134))
  call loop_A_Q(G1(:,:,:,134),Q(:,59),MT,G2(:,:,:,191))
  ...
  call loop_Q_A(G0(:,:,:,50),Q(:,39),MT,G1(:,:,:,146))
  call loop_QV_A(G1(:,:,:,146),wf(:,-4),G1(:,:,:,147))
  call loop_Q_A(G1(:,:,:,147),Q(:,55),MT,G2(:,:,:,209))
  ...
  call loop_A_Q(G0(:,:,:,51),Q(:,56),MT,G1(:,:,:,148))
  call loop_AZ_Q(G1(:,:,:,148),wf(:,4),G1(:,:,:,149),gZu)
  call loop_A_Q(G1(:,:,:,149),Q(:,59),MT,G2(:,:,:,210))
  ...
  call loop_A_Q(G0(:,:,:,52),Q(:,43),MT,G1(:,:,:,150))
  call loop_AV_Q(G1(:,:,:,150),wf(:,-4),G1(:,:,:,151))
  call loop_A_Q(G1(:,:,:,151),Q(:,59),MT,G2(:,:,:,211))
  ...
  call loop_A_Q(G0(:,:,:,56),Q(:,56),MT,G1(:,:,:,166))
  call loop_AZ_Q(G1(:,:,:,166),wf(:,4),G1(:,:,:,167),gZu)
  call loop_A_Q(G1(:,:,:,167),Q(:,59),MT,G2(:,:,:,233))
...
end module ol_vamp_1_pplltt_nenexttxgg_1_/**/REALKIND
