...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,20),Q(:,52),MT,1_intkind1,wf(:,22))
  ...
  call prop_Q_A(wf(:,36),Q(:,52),MT,1_intkind1,wf(:,37))
  ...
  call prop_A_Q(wf(:,21),Q(:,11),MT,1_intkind1,wf(:,42))
  call prop_A_Q(wf(:,23),Q(:,11),MT,1_intkind1,wf(:,43))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,44))
  call prop_A_Q(wf(:,16),Q(:,56),MT,1_intkind1,wf(:,45))
  ...
  call counter_Q_A(cttt,wf(:,17),Q(:,7),wf(:,57))
  call counter_Q_A(cttt,wf(:,19),Q(:,7),wf(:,58))
  call counter_Q_A(cttt,wf(:,22),Q(:,52),wf(:,59))
