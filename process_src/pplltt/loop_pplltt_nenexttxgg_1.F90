...
module ol_colourmatrix_pplltt_nenexttxgg_1_/**/REALKIND
...
end module ol_colourmatrix_pplltt_nenexttxgg_1_/**/REALKIND



module ol_forced_parameters_pplltt_nenexttxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplltt_nenexttxgg_1_/**/REALKIND

module ol_loop_pplltt_nenexttxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGtt*eQED**2*gQCD**4
    f( 6) = countertermnorm*ctGtt*eQED**2*gQCD**4
    f( 7) = CI*countertermnorm*ctVtt*eQED**2*gQCD**4
    f( 8) = countertermnorm*ctVtt*eQED**2*gQCD**4
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,2),Q(:,20),MT,1_intkind1,wf(:,5))
  call prop_A_Q(wf(:,3),Q(:,40),MT,1_intkind1,wf(:,6))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,5),wf(:,7))
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,4),wf(:,8))
  call vert_VQ_A(wf(:,-5),wf(:,5),wf(:,9))
  call prop_A_Q(wf(:,8),Q(:,11),MT,1_intkind1,wf(:,10))
  call vert_VQ_A(wf(:,-5),wf(:,-2),wf(:,11))
  call vert_AV_Q(wf(:,-3),wf(:,-4),wf(:,12))
  call prop_Q_A(wf(:,11),Q(:,36),MT,1_intkind1,wf(:,13))
  call prop_A_Q(wf(:,12),Q(:,24),MT,1_intkind1,wf(:,14))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,13),wf(:,15))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,-2),wf(:,16))
  call vert_AV_Q(wf(:,14),wf(:,-5),wf(:,17))
  call prop_Q_A(wf(:,16),Q(:,7),MT,1_intkind1,wf(:,18))
  ...
  call prop_Q_A(wf(:,23),Q(:,52),MT,1_intkind1,wf(:,24))
  ...
  call counter_ZQ_A(gZu,wf(:,4),wf(:,5),wf(:,33))
  call counter_VQ_A(wf(:,-5),wf(:,5),wf(:,34))
  call vert_QA_V(wf(:,5),wf(:,-3),wf(:,35))
  call counter_ZQ_A(gZu,wf(:,4),wf(:,13),wf(:,36))
  ...
  call prop_Q_A(wf(:,45),Q(:,52),MT,1_intkind1,wf(:,46))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,4),wf(:,47))
  call prop_Q_A(wf(:,9),Q(:,52),MT,1_intkind1,wf(:,48))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,49))
  call prop_A_Q(wf(:,49),Q(:,40),MT,1_intkind1,wf(:,50))
  call prop_Q_A(wf(:,19),Q(:,52),MT,1_intkind1,wf(:,51))
  ...
  call counter_ZQ_A(gZu,wf(:,4),wf(:,-2),wf(:,57))
  call prop_A_Q(wf(:,17),Q(:,56),MT,1_intkind1,wf(:,58))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,59))
  call prop_Q_A(wf(:,59),Q(:,36),MT,1_intkind1,wf(:,60))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,60),wf(:,61))
  call prop_A_Q(wf(:,20),Q(:,56),MT,1_intkind1,wf(:,62))
  call counter_VQ_A(wf(:,21),wf(:,-2),wf(:,63))
  call prop_A_Q(wf(:,22),Q(:,56),MT,1_intkind1,wf(:,64))
  call vert_VQ_A(wf(:,-4),wf(:,60),wf(:,65))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,66))
  call prop_Q_A(wf(:,66),Q(:,20),MT,1_intkind1,wf(:,67))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,67),wf(:,68))
  call vert_VQ_A(wf(:,-5),wf(:,67),wf(:,69))
  call vert_AZ_Q(gZu,wf(:,6),wf(:,4),wf(:,70))
  call counter_Q_A(cttt,wf(:,5),Q(:,20),wf(:,71))
  call prop_A_Q(wf(:,70),Q(:,43),MT,1_intkind1,wf(:,72))
  call counter_A_Q(cttt,wf(:,6),Q(:,40),wf(:,73))
  call prop_Q_A(wf(:,7),Q(:,23),MT,1_intkind1,wf(:,74))
  call prop_Q_A(wf(:,71),Q(:,20),MT,1_intkind1,wf(:,75))
  call vert_VQ_A(wf(:,-5),wf(:,75),wf(:,76))
  call counter_A_Q(cttt,wf(:,10),Q(:,11),wf(:,77))
  call vert_AZ_Q(gZu,wf(:,14),wf(:,4),wf(:,78))
  call counter_Q_A(cttt,wf(:,13),Q(:,36),wf(:,79))
  call prop_A_Q(wf(:,78),Q(:,27),MT,1_intkind1,wf(:,80))
  call counter_A_Q(cttt,wf(:,14),Q(:,24),wf(:,81))
  call prop_Q_A(wf(:,15),Q(:,39),MT,1_intkind1,wf(:,82))
  call counter_Q_A(cttt,wf(:,18),Q(:,7),wf(:,83))
  call prop_A_Q(wf(:,81),Q(:,24),MT,1_intkind1,wf(:,84))
  call vert_AV_Q(wf(:,84),wf(:,-5),wf(:,85))
  call prop_Q_A(wf(:,79),Q(:,36),MT,1_intkind1,wf(:,86))
  call vert_VQ_A(wf(:,-4),wf(:,86),wf(:,87))
  call prop_A_Q(wf(:,73),Q(:,40),MT,1_intkind1,wf(:,88))
  call vert_AV_Q(wf(:,88),wf(:,-4),wf(:,89))
  call counter_Q_A(cttt,wf(:,24),Q(:,52),wf(:,90))
  ...
  call prop_Q_A(wf(:,95),Q(:,23),MT,1_intkind1,wf(:,96))
  call vert_VQ_A(wf(:,-5),wf(:,18),wf(:,97))
  call prop_Q_A(wf(:,97),Q(:,39),MT,1_intkind1,wf(:,98))
  ...
  call prop_A_Q(wf(:,102),Q(:,43),MT,1_intkind1,wf(:,103))
...
end module ol_loop_pplltt_nenexttxgg_1_/**/REALKIND
