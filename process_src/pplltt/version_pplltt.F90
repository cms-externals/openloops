...
module ol_versiondata_pplltt
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pplltt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplltt
  end interface
end module ol_versiondata_pplltt


subroutine ol_version_pplltt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplltt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplltt
