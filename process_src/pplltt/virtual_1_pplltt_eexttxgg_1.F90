...
module ol_vamp_1_pplltt_eexttxgg_1_/**/REALKIND
contains
...
! **********************************************************************
  ...
  call loop_A_Q(G0(:,:,:,3),Q(:,56),MT,G1(:,:,:,1))
  ...
  call loop_A_Q(G0(:,:,:,7),Q(:,56),MT,G1(:,:,:,6))
  ...
  call loop_A_Q(G0(:,:,:,11),Q(:,56),MT,G1(:,:,:,11))
  ...
  call loop_Q_A(G0(:,:,:,33),Q(:,20),MT,G1(:,:,:,92))
  call loop_QV_A(G1(:,:,:,92),wf(:,-5),G1(:,:,:,93))
  call loop_Q_A(G1(:,:,:,93),Q(:,52),MT,G2(:,:,:,180))
  ...
  call loop_Q_A(G1(:,:,:,97),Q(:,52),MT,G2(:,:,:,187))
  ...
  call loop_A_Q(G2(:,:,:,204),Q(:,56),MT,G3(:,:,:,80))
  ...
  call loop_A_Q(G0(:,:,:,44),Q(:,24),MT,G1(:,:,:,133))
  call loop_AV_Q(G1(:,:,:,133),wf(:,-5),G1(:,:,:,134))
  call loop_A_Q(G1(:,:,:,134),Q(:,56),MT,G2(:,:,:,244))
  ...
  call loop_Q_A(G1(:,:,:,157),Q(:,52),MT,G2(:,:,:,275))
  ...
  call loop_A_Q(G2(:,:,:,286),Q(:,56),MT,G3(:,:,:,99))
  ...
  call loop_Q_A(G0(:,:,:,55),Q(:,39),MT,G1(:,:,:,173))
  call loop_QV_A(G1(:,:,:,173),wf(:,-4),G1(:,:,:,174))
  call loop_Q_A(G1(:,:,:,174),Q(:,55),MT,G2(:,:,:,303))
  ...
  call loop_Q_A(G0(:,:,:,56),Q(:,39),MT,G1(:,:,:,175))
  call loop_QV_A(G1(:,:,:,175),wf(:,-4),G1(:,:,:,176))
  call loop_Q_A(G1(:,:,:,176),Q(:,55),MT,G2(:,:,:,304))
  ...
  call loop_A_Q(G0(:,:,:,58),Q(:,43),MT,G1(:,:,:,180))
  call loop_AV_Q(G1(:,:,:,180),wf(:,-4),G1(:,:,:,181))
  call loop_A_Q(G1(:,:,:,181),Q(:,59),MT,G2(:,:,:,307))
  ...
  call loop_A_Q(G0(:,:,:,59),Q(:,43),MT,G1(:,:,:,182))
  call loop_AV_Q(G1(:,:,:,182),wf(:,-4),G1(:,:,:,183))
  call loop_A_Q(G1(:,:,:,183),Q(:,59),MT,G2(:,:,:,308))
  ...
  call loop_A_Q(G0(:,:,:,60),Q(:,8),MT,G1(:,:,:,184))
  call loop_AV_Q(G1(:,:,:,184),wf(:,28),G1(:,:,:,185))
  call loop_A_Q(G1(:,:,:,185),Q(:,56),MT,G2(:,:,:,309))
  ...
  call loop_A_Q(G1(:,:,:,191),Q(:,56),MT,G2(:,:,:,328))
  ...
  call loop_Q_A(G0(:,:,:,68),Q(:,39),MT,G1(:,:,:,216))
  call loop_QV_A(G1(:,:,:,216),wf(:,-4),G1(:,:,:,217))
  call loop_Q_A(G1(:,:,:,217),Q(:,55),MT,G2(:,:,:,352))
  ...
  call loop_A_Q(G0(:,:,:,72),Q(:,43),MT,G1(:,:,:,224))
  call loop_AV_Q(G1(:,:,:,224),wf(:,-4),G1(:,:,:,225))
  call loop_A_Q(G1(:,:,:,225),Q(:,59),MT,G2(:,:,:,356))
  ...
  Gcoeff = (c(35)*M(1)-c(34)*M(3)) * den(126)
  ...
  Gcoeff = (c(35)*M(2)-c(34)*M(3)) * den(126)
  ...
  Gcoeff = (c(35)*M(1)-c(34)*M(3)) * den(132)
  ...
  Gcoeff = (c(35)*M(2)-c(34)*M(3)) * den(132)
  ...
  Gcoeff = (c(4)*(-M(1)+M(2))) * den(161)
  T2sum(1:15,25) = T2sum(1:15,25) + Gcoeff * G2tensor(:,66)
  Gcoeff = (c(7)*(M(1)-M(2))) * den(116)
  ...
  Gcoeff = (c(4)*(-M(1)+M(2))) * den(163)
  T2sum(1:15,25) = T2sum(1:15,25) + Gcoeff * G2tensor(:,68)
  Gcoeff = (c(7)*(M(1)-M(2))) * den(118)
...
end module ol_vamp_1_pplltt_eexttxgg_1_/**/REALKIND
