...
module ol_colourmatrix_pplltt_nenexuuxttx_1_/**/REALKIND
...
end module ol_colourmatrix_pplltt_nenexuuxttx_1_/**/REALKIND



module ol_forced_parameters_pplltt_nenexuuxttx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplltt_nenexuuxttx_1_/**/REALKIND

module ol_loop_pplltt_nenexuuxttx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctVqq*eQED**2*gQCD**4
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,4),Q(:,19),MT,1_intkind1,wf(:,6))
  call vert_VQ_A(wf(:,2),wf(:,-4),wf(:,7))
  call vert_AZ_Q(gZu,wf(:,-5),wf(:,3),wf(:,8))
  call prop_Q_A(wf(:,7),Q(:,28),MT,1_intkind1,wf(:,9))
  ...
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,3),wf(:,19))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,20))
  call prop_A_Q(wf(:,8),Q(:,35),MT,1_intkind1,wf(:,21))
  call counter_ZQ_A(gZu,wf(:,3),wf(:,-4),wf(:,22))
  call prop_A_Q(wf(:,5),Q(:,44),MT,1_intkind1,wf(:,23))
  ...
  call prop_Q_A(wf(:,36),Q(:,28),MT,1_intkind1,wf(:,37))
  call counter_V_V(ctGG,wf(:,2),Q(:,12),wf(:,38))
  call vert_VQ_A(wf(:,38),wf(:,-4),wf(:,39))
  call vert_AV_Q(wf(:,-5),wf(:,38),wf(:,40))
  call counter_Q_A(cttt,wf(:,6),Q(:,19),wf(:,41))
  call counter_Q_A(cttt,wf(:,9),Q(:,28),wf(:,42))
...
end module ol_loop_pplltt_nenexuuxttx_1_/**/REALKIND
