...
module ol_colourmatrix_pplltt_nenexttxbbx_1_/**/REALKIND
...
end module ol_colourmatrix_pplltt_nenexttxbbx_1_/**/REALKIND



module ol_forced_parameters_pplltt_nenexttxbbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplltt_nenexttxbbx_1_/**/REALKIND

module ol_loop_pplltt_nenexttxbbx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 4) = CI*countertermnorm*ctGtt*eQED**2*gQCD**4
    f( 5) = CI*countertermnorm*ctVbb*eQED**2*gQCD**4
    f( 6) = CI*countertermnorm*ctVtt*eQED**2*gQCD**4
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,8),Q(:,35),MB,1_intkind1,wf(:,21))
  call counter_ZQ_A(gZd,wf(:,3),wf(:,-4),wf(:,22))
  call prop_A_Q(wf(:,5),Q(:,44),MB,1_intkind1,wf(:,23))
  call counter_QA_V(wf(:,-4),wf(:,-5),wf(:,24))
  call vert_AV_Q(wf(:,-3),wf(:,24),wf(:,25))
  call vert_VQ_A(wf(:,24),wf(:,-2),wf(:,26))
  call prop_Q_A(wf(:,26),Q(:,52),MT,1_intkind1,wf(:,27))
  call counter_AV_Q(wf(:,-3),wf(:,10),wf(:,28))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,3),wf(:,29))
  call counter_VQ_A(wf(:,10),wf(:,-2),wf(:,30))
  call prop_A_Q(wf(:,15),Q(:,11),MT,1_intkind1,wf(:,31))
  call counter_ZQ_A(gZu,wf(:,3),wf(:,-2),wf(:,32))
  call prop_A_Q(wf(:,12),Q(:,56),MT,1_intkind1,wf(:,33))
  ...
  call counter_Q_A(ctbb,wf(:,6),Q(:,19),wf(:,41))
  call counter_Q_A(ctbb,wf(:,9),Q(:,28),wf(:,42))
  call counter_Q_A(cttt,wf(:,13),Q(:,7),wf(:,43))
  call counter_Q_A(cttt,wf(:,16),Q(:,52),wf(:,44))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(18)-A(19)-A(20)-A(21)-A(22)-A(23)-A(24)-A(25))*f(2))/2._/**/REALKIND+((A(6)+A(8)+A(10)+A(11))*f(3))/2._/**/REALKIND &
       +((A(12)+A(14)+A(16)+A(17))*f(4))/2._/**/REALKIND+((A(7)+A(9))*f(5))/2._/**/REALKIND+((A(13)+A(15))*f(6))/2._/**/REALKIND &
       -(A(5)*f(7))/2._/**/REALKIND
  M2(2) = ((A(18)+A(19)+A(20)+A(21)+A(22)+A(23)+A(24)+A(25))*f(2))/6._/**/REALKIND+((-A(6)-A(8)-A(10)-A(11))*f(3))/6._/**/REALKIND &
       +((-A(12)-A(14)-A(16)-A(17))*f(4))/6._/**/REALKIND+((-A(7)-A(9))*f(5))/6._/**/REALKIND+((-A(13) &
       -A(15))*f(6))/6._/**/REALKIND+(A(5)*f(7))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplltt_nenexttxbbx_1_/**/REALKIND
