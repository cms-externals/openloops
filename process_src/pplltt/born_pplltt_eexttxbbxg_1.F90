...
module ol_colourmatrix_pplltt_eexttxbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_pplltt_eexttxbbxg_1_/**/REALKIND



module ol_forced_parameters_pplltt_eexttxbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplltt_eexttxbbxg_1_/**/REALKIND

module ol_tree_pplltt_eexttxbbxg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pplltt_eexttxbbxg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pplltt_eexttxbbxg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for e- e+ top anti-top bottom anti-bottom glue -> 0
...
! **********************************************************************
  ...
  use ol_external_pplltt_eexttxbbxg_1, only: external_perm_pplltt_eexttxbbxg_1, &
    & external_perm_inv_pplltt_eexttxbbxg_1, extcomb_perm_pplltt_eexttxbbxg_1, &
    & average_factor_pplltt_eexttxbbxg_1
  use ol_external_pplltt_eexttxbbxg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_pplltt_eexttxbbxg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_pplltt_eexttxbbxg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_pplltt_eexttxbbxg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_pplltt_eexttxbbxg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pplltt_eexttxbbxg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pplltt_eexttxbbxg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_pplltt_eexttxbbxg_1(extcombs(k))
  end do
  ...
  call prop_A_Q(ntry, wf8(:,14), Q(:,11), MT, 1_intkind1, wf8(:,15), n2(11))
  call vert_AZ_Q(gZu,ntry, ex4, wf4(:,6), wf8(:,16), n3(:,30), t3x8(:,:,9))
  call prop_A_Q(ntry, wf8(:,16), Q(:,11), MT, 1_intkind1, wf8(:,17), n2(12))
  call vert_AV_Q(ntry, ex4, wf4(:,10), wf8(:,18), n3(:,31), t3x8(:,:,10))
  call vert_VQ_A(ntry, wf4(:,1), wf4(:,11), wf16(:,15), n3(:,32), t3x16(:,:,15))
  call prop_A_Q(ntry, wf8(:,18), Q(:,56), MT, 1_intkind1, wf8(:,19), n2(13))
  call vert_ZQ_A(gZu,ntry, wf4(:,6), wf4(:,11), wf16(:,16), n3(:,33), t3x16(:,:,16))
  call vert_AV_Q(ntry, ex4, ex7, wf4(:,12), n3(:,34), t3x4(:,:,8))
  call prop_A_Q(ntry, wf4(:,12), Q(:,72), MT, 1_intkind1, wf4(:,13), n2(14))
  call vert_VQ_A(ntry, wf4(:,1), ex3, wf8(:,20), n3(:,35), t3x8(:,:,11))
  call vert_AV_Q(ntry, wf4(:,13), wf4(:,10), wf16(:,17), n3(:,36), t3x16(:,:,17))
  call prop_Q_A(ntry, wf8(:,20), Q(:,7), MT, 1_intkind1, wf8(:,21), n2(15))
  call vert_ZQ_A(gZu,ntry, wf4(:,6), ex3, wf8(:,22), n3(:,37), t3x8(:,:,12))
  call prop_Q_A(ntry, wf8(:,22), Q(:,7), MT, 1_intkind1, wf8(:,23), n2(16))
  call vert_VQ_A(ntry, wf4(:,10), ex3, wf8(:,24), n3(:,38), t3x8(:,:,13))
  call vert_AV_Q(ntry, wf4(:,13), wf4(:,1), wf16(:,18), n3(:,39), t3x16(:,:,18))
  call prop_Q_A(ntry, wf8(:,24), Q(:,52), MT, 1_intkind1, wf8(:,25), n2(17))
  call vert_AZ_Q(gZu,ntry, wf4(:,13), wf4(:,6), wf16(:,19), n3(:,40), t3x16(:,:,19))
  ...
  M2add = M2 / average_factor_pplltt_eexttxbbxg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_pplltt_eexttxbbxg_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = ((-A(j,33)%j-A(j,35)%j-A(j,37)%j-A(j,39)%j)*f(1))/6._/**/REALKIND+((A(j,17)%j+A(j,19)%j+A(j,21)%j+A(j,23)%j+A(j,27)%j &
       +A(j,31)%j)*f(2))/6._/**/REALKIND+((-A(j,18)%j-A(j,20)%j-A(j,22)%j-A(j,24)%j-A(j,28)%j-A(j,32)%j-A(j,34)%j-A(j,36)%j &
       -A(j,38)%j-A(j,40)%j)*f(3))/6._/**/REALKIND
  M1(2) = ((A(j,1)%j+A(j,3)%j+A(j,9)%j+A(j,37)%j+A(j,39)%j)*f(1))/2._/**/REALKIND+((-A(j,21)%j-A(j,23)%j-A(j,31)%j-A(j,41)%j &
       -A(j,43)%j)*f(2))/2._/**/REALKIND+((A(j,2)%j+A(j,4)%j+A(j,10)%j+A(j,22)%j+A(j,24)%j+A(j,32)%j+A(j,38)%j+A(j,40)%j+A(j,42)%j &
       +A(j,44)%j)*f(3))/2._/**/REALKIND+(CI*(A(j,11)%j+A(j,15)%j)*f(4))/2._/**/REALKIND+(CI*(A(j,25)%j &
       +A(j,29)%j)*f(5))/2._/**/REALKIND+(CI*(A(j,12)%j+A(j,16)%j-A(j,26)%j-A(j,30)%j)*f(6))/2._/**/REALKIND
  M1(3) = ((A(j,5)%j+A(j,7)%j+A(j,13)%j+A(j,33)%j+A(j,35)%j)*f(1))/2._/**/REALKIND+((-A(j,17)%j-A(j,19)%j-A(j,27)%j-A(j,45)%j &
       -A(j,47)%j)*f(2))/2._/**/REALKIND+((A(j,6)%j+A(j,8)%j+A(j,14)%j+A(j,18)%j+A(j,20)%j+A(j,28)%j+A(j,34)%j+A(j,36)%j+A(j,46)%j &
       +A(j,48)%j)*f(3))/2._/**/REALKIND+(CI*(-A(j,11)%j-A(j,15)%j)*f(4))/2._/**/REALKIND+(CI*(-A(j,25)%j &
       -A(j,29)%j)*f(5))/2._/**/REALKIND+(CI*(-A(j,12)%j-A(j,16)%j+A(j,26)%j+A(j,30)%j)*f(6))/2._/**/REALKIND
  M1(4) = ((-A(j,1)%j-A(j,3)%j-A(j,5)%j-A(j,7)%j-A(j,9)%j-A(j,13)%j)*f(1))/6._/**/REALKIND+((A(j,41)%j+A(j,43)%j+A(j,45)%j &
       +A(j,47)%j)*f(2))/6._/**/REALKIND+((-A(j,2)%j-A(j,4)%j-A(j,6)%j-A(j,8)%j-A(j,10)%j-A(j,14)%j-A(j,42)%j-A(j,44)%j-A(j,46)%j &
       -A(j,48)%j)*f(3))/6._/**/REALKIND
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_pplltt_eexttxbbxg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pplltt_eexttxbbxg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pplltt_eexttxbbxg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pplltt_eexttxbbxg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pplltt_eexttxbbxg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pplltt_eexttxbbxg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pplltt_eexttxbbxg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pplltt_eexttxbbxg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pplltt_eexttxbbxg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pplltt_eexttxbbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pplltt_eexttxbbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pplltt_eexttxbbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pplltt_eexttxbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pplltt_eexttxbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pplltt_eexttxbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pplltt_eexttxbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pplltt_eexttxbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_pplltt_eexttxbbxg_1_/**/REALKIND
