...
! **********************************************************************
module ol_tensor_sum_storage_pplltt_nenexttxbbx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplltt_nenexttxbbx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplltt_nenexttxbbx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pplltt_nenexttxbbx_1, only: channel_number_pplltt_nenexttxbbx_1
  ...
  call channel_on(channel_number_pplltt_nenexttxbbx_1)
  M2 = 0
  ...
  masses2_11 = [ ZERO2, ZERO2, MT2 ]
  masses2_12 = [ ZERO2, ZERO2, ZERO2 ]
  masses2_13 = [ ZERO2, MB2, MB2, MB2 ]
  masses2_14 = [ ZERO2, MB2, MB2, ZERO2 ]
  masses2_15 = [ ZERO2, MB2, ZERO2, MT2 ]
  masses2_16 = [ ZERO2, MT2, MT2, MT2 ]
  masses2_17 = [ ZERO2, ZERO2, MT2, MT2 ]
  masses2_18 = [ ZERO2, MB2, MB2, ZERO2, MT2 ]
  masses2_19 = [ ZERO2, MB2, ZERO2, MT2, MT2 ]
  ...
  call TI_call(2, momenta_7, masses2_10, T2sum(:,7), M2)
  call TI_call(2, momenta_19, masses2_11, T2sum(:,8), M2)
  call TI_call(2, momenta_9, masses2_10, T2sum(:,9), M2)
  call TI_call(2, momenta_20, masses2_11, T2sum(:,10), M2)
  call TI_call(2, momenta_22, masses2_10, T2sum(:,11), M2)
  ...
  call TI_call(2, momenta_33, masses2_15, T2sum(:,15), M2)
  call TI_call(2, momenta_27, masses2_15, T2sum(:,16), M2)
  call TI_call(2, momenta_28, masses2_15, T2sum(:,17), M2)
  call TI_call(2, momenta_34, masses2_15, T2sum(:,18), M2)
  call TI_call(2, momenta_8, masses2_10, T2sum(:,19), M2)
  call TI_call(2, momenta_21, masses2_11, T2sum(:,20), M2)
  call TI_call(2, momenta_35, masses2_15, T2sum(:,21), M2)
  call TI_call(2, momenta_30, masses2_15, T2sum(:,22), M2)
  call TI_call(2, momenta_29, masses2_15, T2sum(:,23), M2)
  call TI_call(2, momenta_36, masses2_15, T2sum(:,24), M2)
  call TI_call(2, momenta_4, masses2_5, T2sum(:,25), M2)
  call TI_call(2, momenta_4, masses2_3, T2sum(:,26), M2)
  call TI_call(2, momenta_4, masses2_1, T2sum(:,27), M2)
  call TI_call(2, momenta_3, masses2_5, T2sum(:,28), M2)
  call TI_call(2, momenta_3, masses2_3, T2sum(:,29), M2)
  call TI_call(2, momenta_3, masses2_1, T2sum(:,30), M2)

  call TI_call(3, momenta_10, masses2_12, T3sum(:,1), M2)
  ...
  call TI_call(3, momenta_26, masses2_14, T3sum(:,6), M2)
  call TI_call(3, momenta_25, masses2_16, T3sum(:,7), M2)
  call TI_call(3, momenta_24, masses2_16, T3sum(:,8), M2)
  call TI_call(3, momenta_37, masses2_17, T3sum(:,9), M2)
  call TI_call(3, momenta_38, masses2_18, T3sum(:,10), M2)
  call TI_call(3, momenta_40, masses2_18, T3sum(:,11), M2)
  call TI_call(3, momenta_39, masses2_19, T3sum(:,12), M2)
  call TI_call(3, momenta_41, masses2_19, T3sum(:,13), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pplltt_nenexttxbbx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplltt_nenexttxbbx_1_/**/REALKIND
