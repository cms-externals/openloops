...
module ol_colourmatrix_pplltt_eexttxggg_1_/**/REALKIND
...
end module ol_colourmatrix_pplltt_eexttxggg_1_/**/REALKIND



module ol_forced_parameters_pplltt_eexttxggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplltt_eexttxggg_1_/**/REALKIND

module ol_tree_pplltt_eexttxggg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pplltt_eexttxggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pplltt_eexttxggg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
...
! **********************************************************************
  ...
  use ol_external_pplltt_eexttxggg_1, only: external_perm_pplltt_eexttxggg_1, &
    & external_perm_inv_pplltt_eexttxggg_1, extcomb_perm_pplltt_eexttxggg_1, &
    & average_factor_pplltt_eexttxggg_1
  use ol_external_pplltt_eexttxggg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_pplltt_eexttxggg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_pplltt_eexttxggg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_pplltt_eexttxggg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_pplltt_eexttxggg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pplltt_eexttxggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pplltt_eexttxggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_pplltt_eexttxggg_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf8(:,2), Q(:,7), MT, 1_intkind1, wf8(:,3), n2(1))
  ...
  call prop_Q_A(ntry, wf8(:,6), Q(:,7), MT, 1_intkind1, wf8(:,7), n2(3))
  call vert_VQ_A(ntry, wf8(:,1), ex3, wf16(:,4), n3(:,8), t3x16(:,:,4))
  call vert_AV_Q(ntry, ex4, wf4(:,1), wf8(:,8), n3(:,9), t3x8(:,:,3))
  call prop_Q_A(ntry, wf16(:,4), Q(:,116), MT, 1_intkind1, wf16(:,5), n2(4))
  call vert_VQ_A(ntry, wf8(:,4), ex3, wf16(:,6), n3(:,10), t3x16(:,:,5))
  call prop_Q_A(ntry, wf16(:,6), Q(:,116), MT, 1_intkind1, wf16(:,7), n2(5))
  call vert_VQ_A(ntry, wf8(:,5), ex3, wf16(:,8), n3(:,11), t3x16(:,:,6))
  call prop_Q_A(ntry, wf16(:,8), Q(:,116), MT, 1_intkind1, wf16(:,9), n2(6))
  ...
  call prop_Q_A(ntry, wf4(:,4), Q(:,20), MT, 1_intkind1, wf4(:,6), n2(7))
  call prop_A_Q(ntry, wf4(:,5), Q(:,40), MT, 1_intkind1, wf4(:,7), n2(8))
  call vert_VQ_A(ntry, ex7, wf4(:,6), wf8(:,10), n3(:,15), t3x8(:,:,5))
  call vert_AV_Q(ntry, wf4(:,7), wf4(:,1), wf16(:,10), n3(:,16), t3x16(:,:,7))
  call prop_Q_A(ntry, wf8(:,10), Q(:,84), MT, 1_intkind1, wf8(:,11), n2(9))
  ...
  call prop_Q_A(ntry, wf4(:,11), Q(:,36), MT, 1_intkind1, wf4(:,13), n2(17))
  call prop_A_Q(ntry, wf4(:,12), Q(:,24), MT, 1_intkind1, wf4(:,14), n2(18))
  call vert_VQ_A(ntry, ex7, wf4(:,13), wf8(:,22), n3(:,35), t3x8(:,:,10))
  call vert_AV_Q(ntry, wf4(:,14), wf4(:,1), wf16(:,21), n3(:,36), t3x16(:,:,18))
  call prop_Q_A(ntry, wf8(:,22), Q(:,100), MT, 1_intkind1, wf8(:,23), n2(19))
  ...
  call prop_A_Q(ntry, wf8(:,24), Q(:,88), MT, 1_intkind1, wf8(:,25), n2(20))
  call vert_ZQ_A(gZu,ntry, wf4(:,3), wf4(:,13), wf16(:,24), n3(:,40), t3x16(:,:,21))
  call vert_VQ_A(ntry, ex7, ex3, wf4(:,15), n3(:,41), t3x4(:,:,9))
  call prop_Q_A(ntry, wf4(:,15), Q(:,68), MT, 1_intkind1, wf4(:,16), n2(21))
  ...
  call prop_A_Q(ntry, wf8(:,28), Q(:,56), MT, 1_intkind1, wf8(:,29), n2(23))
  ...
  call prop_Q_A(ntry, wf8(:,30), Q(:,100), MT, 1_intkind1, wf8(:,31), n2(24))
  ...
  call prop_Q_A(ntry, wf8(:,32), Q(:,52), MT, 1_intkind1, wf8(:,33), n2(25))
  call vert_AV_Q(ntry, wf4(:,9), ex5, wf8(:,34), n3(:,53), t3x8(:,:,16))
  call prop_A_Q(ntry, wf8(:,34), Q(:,88), MT, 1_intkind1, wf8(:,35), n2(26))
  ...
  call prop_A_Q(ntry, wf8(:,36), Q(:,88), MT, 1_intkind1, wf8(:,37), n2(27))
  ...
  call prop_Q_A(ntry, wf8(:,42), Q(:,84), MT, 1_intkind1, wf8(:,43), n2(30))
  ...
  call prop_A_Q(ntry, wf8(:,44), Q(:,56), MT, 1_intkind1, wf8(:,45), n2(31))
  call vert_AV_Q(ntry, wf4(:,9), wf4(:,18), wf16(:,39), n3(:,68), t3x16(:,:,36))
  call vert_VQ_A(ntry, wf4(:,18), ex3, wf8(:,46), n3(:,69), t3x8(:,:,22))
  call prop_Q_A(ntry, wf8(:,46), Q(:,52), MT, 1_intkind1, wf8(:,47), n2(32))
  ...
  M2add = M2 / average_factor_pplltt_eexttxggg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_pplltt_eexttxggg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_pplltt_eexttxggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pplltt_eexttxggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pplltt_eexttxggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pplltt_eexttxggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pplltt_eexttxggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pplltt_eexttxggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pplltt_eexttxggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pplltt_eexttxggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pplltt_eexttxggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pplltt_eexttxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pplltt_eexttxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pplltt_eexttxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pplltt_eexttxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pplltt_eexttxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pplltt_eexttxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pplltt_eexttxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pplltt_eexttxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_pplltt_eexttxggg_1_/**/REALKIND
