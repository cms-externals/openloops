...
module ol_colourmatrix_pplltt_eexuuxttx_1_/**/REALKIND
...
end module ol_colourmatrix_pplltt_eexuuxttx_1_/**/REALKIND



module ol_forced_parameters_pplltt_eexuuxttx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplltt_eexuuxttx_1_/**/REALKIND

module ol_loop_pplltt_eexuuxttx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 6) = CI*countertermnorm*ctGqq*eQED**2*gQCD**4
    f( 7) = (2*CI*countertermnorm*ctGtt*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 8) = CI*countertermnorm*ctGtt*eQED**2*gQCD**4
    f( 9) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(10) = CI*countertermnorm*ctVqq*eQED**2*gQCD**4
    f(11) = (2*CI*countertermnorm*ctVtt*eQED**2*gQCD**4)/3._/**/REALKIND
    f(12) = CI*countertermnorm*ctVtt*eQED**2*gQCD**4
    f(13) = countertermnorm*ctZGG*eQED**2*gQCD**4
    f(14) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(15) = CI*eQED**2*gQCD**4*integralnorm*SwB
    f(16) = (eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(17) = (eQED**2*gQCD**4*integralnorm*SwB)/2._/**/REALKIND
    f(18) = (2*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(19) = eQED**2*gQCD**4*integralnorm*SwB
    f(20) = (eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(21) = (2*eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(22) = eQED**2*gQCD**4*integralnorm*SwF
    f(23) = (4*eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(24) = 2*eQED**2*gQCD**4*integralnorm*SwF

  c = [ 9*CI*f(14), 27*CI*f(14), 9*CI*f(15), 27*CI*f(15), 18*f(16), 54*f(16), 18*f(17), 54*f(17), f(18), 3*f(18), 6*f(18), 8*f(18) &
    , 10*f(18), 18*f(18), 21*f(18), 24*f(18), 54*f(18), f(19), 3*f(19), 6*f(19), 8*f(19), 10*f(19), 18*f(19), 21*f(19), 24*f(19) &
    , 54*f(19), 3*f(20), 9*f(20), 3*f(21), 9*f(21), 3*f(22), 9*f(22), 3*f(23), 9*f(23), 3*f(24), 9*f(24) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,3),Q(:,19),MT,1_intkind1,wf(:,5))
  call vert_QA_Z(gZl,wf(:,0),wf(:,-1),wf(:,6))
  call prop_W_W(wf(:,6),Q(:,3),MZ,1_intkind1,wf(:,7))
  call vert_ZQ_A(gZu,wf(:,7),wf(:,-4),wf(:,8))
  call prop_Q_A(wf(:,8),Q(:,19),MT,1_intkind1,wf(:,9))
  call vert_VQ_A(wf(:,2),wf(:,-4),wf(:,10))
  call vert_AV_Q(wf(:,-5),wf(:,1),wf(:,11))
  call prop_Q_A(wf(:,10),Q(:,28),MT,1_intkind1,wf(:,12))
  call vert_AZ_Q(gZu,wf(:,-5),wf(:,7),wf(:,13))
  ...
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,7),wf(:,27))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,28))
  call prop_A_Q(wf(:,11),Q(:,35),MT,1_intkind1,wf(:,29))
  call prop_A_Q(wf(:,13),Q(:,35),MT,1_intkind1,wf(:,30))
  call counter_VQ_A(wf(:,1),wf(:,-4),wf(:,31))
  call prop_A_Q(wf(:,4),Q(:,44),MT,1_intkind1,wf(:,32))
  call counter_ZQ_A(gZu,wf(:,7),wf(:,-4),wf(:,33))
  ...
  call prop_Q_A(wf(:,49),Q(:,28),MT,1_intkind1,wf(:,50))
  call counter_V_V(ctGG,wf(:,2),Q(:,12),wf(:,51))
  call vert_VQ_A(wf(:,51),wf(:,-4),wf(:,52))
  call vert_AV_Q(wf(:,-5),wf(:,51),wf(:,53))
  call counter_Q_A(cttt,wf(:,5),Q(:,19),wf(:,54))
  call counter_Q_A(cttt,wf(:,9),Q(:,19),wf(:,55))
  call counter_Q_A(cttt,wf(:,12),Q(:,28),wf(:,56))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(1)-A(3)-A(5)-A(7))*f(1))/2._/**/REALKIND+((A(2)+A(4)+A(6)+A(8))*f(2))/2._/**/REALKIND
  M1(2) = ((A(1)+A(3)+A(5)+A(7))*f(1))/6._/**/REALKIND+((-A(2)-A(4)-A(6)-A(8))*f(2))/6._/**/REALKIND

  M2(1) = ((A(34)+A(36)+A(38)+A(40)+A(42)+A(44)+A(46)+A(48))*f(3))/2._/**/REALKIND+((-A(35)-A(37)-A(39)-A(41)-A(43)-A(45)-A(47) &
       -A(49))*f(4))/2._/**/REALKIND+((-A(22)-A(26)-A(30)-A(32))*f(5))/2._/**/REALKIND+((A(23)+A(27)+A(31) &
       +A(33))*f(6))/2._/**/REALKIND+((-A(10)-A(14)-A(18)-A(20))*f(7))/2._/**/REALKIND+((A(11)+A(15)+A(19) &
       +A(21))*f(8))/2._/**/REALKIND+((-A(24)-A(28))*f(9))/2._/**/REALKIND+((A(25)+A(29))*f(10))/2._/**/REALKIND+((-A(12) &
       -A(16))*f(11))/2._/**/REALKIND+((A(13)+A(17))*f(12))/2._/**/REALKIND-(A(9)*f(13))/2._/**/REALKIND
  M2(2) = ((-A(34)-A(36)-A(38)-A(40)-A(42)-A(44)-A(46)-A(48))*f(3))/6._/**/REALKIND+((A(35)+A(37)+A(39)+A(41)+A(43)+A(45)+A(47) &
       +A(49))*f(4))/6._/**/REALKIND+((A(22)+A(26)+A(30)+A(32))*f(5))/6._/**/REALKIND+((-A(23)-A(27)-A(31) &
       -A(33))*f(6))/6._/**/REALKIND+((A(10)+A(14)+A(18)+A(20))*f(7))/6._/**/REALKIND+((-A(11)-A(15)-A(19) &
       -A(21))*f(8))/6._/**/REALKIND+((A(24)+A(28))*f(9))/6._/**/REALKIND+((-A(25)-A(29))*f(10))/6._/**/REALKIND+((A(12) &
       +A(16))*f(11))/6._/**/REALKIND+((-A(13)-A(17))*f(12))/6._/**/REALKIND+(A(9)*f(13))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplltt_eexuuxttx_1_/**/REALKIND
