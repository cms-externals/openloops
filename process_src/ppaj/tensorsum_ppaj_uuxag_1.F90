...
! **********************************************************************
module ol_tensor_sum_storage_ppaj_uuxag_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppaj_uuxag_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppaj_uuxag_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppaj_uuxag_1, only: channel_number_ppaj_uuxag_1
  ...
  call channel_on(channel_number_ppaj_uuxag_1)
  M2 = 0
  ...
  call TI_call(3, momenta_3, masses2_3, T3sum(:,2), M2)
  call TI_call(3, momenta_3, masses2_2, T3sum(:,3), M2)
  call TI_call(3, momenta_11, masses2_5, T3sum(:,4), M2)
  call TI_call(3, momenta_10, masses2_5, T3sum(:,5), M2)
  ...
  call channel_off(channel_number_ppaj_uuxag_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppaj_uuxag_1_/**/REALKIND
