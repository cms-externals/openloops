...
module ol_versiondata_ppaj
  implicit none
  character(4) :: generator_revision = "3336"
  interface
    subroutine version_ppaj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppaj
  end interface
end module ol_versiondata_ppaj


subroutine ol_version_ppaj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppaj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppaj
