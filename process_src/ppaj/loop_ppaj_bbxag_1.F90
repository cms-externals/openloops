...
module ol_colourmatrix_ppaj_bbxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppaj_bbxag_1_/**/REALKIND



module ol_forced_parameters_ppaj_bbxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaj_bbxag_1_/**/REALKIND

module ol_loop_ppaj_bbxag_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(9), c(6)
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-4+1:15)
  ! denominators
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED*gQCD**3)/3._/**/REALKIND
    f(3) = (CI*countertermnorm*ctGbb*eQED*gQCD**3)/3._/**/REALKIND
    f(4) = (CI*countertermnorm*ctVbb*eQED*gQCD**3)/3._/**/REALKIND
    f(5) = (CI*eQED*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(6) = (eQED*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(7) = (eQED*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(8) = (2*eQED*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(9) = (4*eQED*gQCD**3*integralnorm*SwF)/3._/**/REALKIND

  c = [ 9*CI*f(5), f(6), 8*f(6), 3*f(7), 3*f(8), 3*f(9) ]
  c = (1._/**/REALKIND / 6) * c
...
! **********************************************************************
  ...
  call counter_AV_Q(wf(:,-1),wf(:,-2),wf(:,8))
  call counter_VQ_A(wf(:,-3),wf(:,0),wf(:,9))
  call prop_A_Q(wf(:,5),Q(:,6),MB,1_intkind1,wf(:,10))
  call counter_VQ_A(wf(:,-2),wf(:,0),wf(:,11))
  call prop_A_Q(wf(:,2),Q(:,10),MB,1_intkind1,wf(:,12))
  call counter_Q_A(ctbb,wf(:,3),Q(:,5),wf(:,13))
  call counter_Q_A(ctbb,wf(:,6),Q(:,9),wf(:,14))
...
end module ol_loop_ppaj_bbxag_1_/**/REALKIND
