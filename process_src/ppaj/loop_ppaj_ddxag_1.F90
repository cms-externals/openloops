...
module ol_colourmatrix_ppaj_ddxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppaj_ddxag_1_/**/REALKIND



module ol_forced_parameters_ppaj_ddxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaj_ddxag_1_/**/REALKIND

module ol_loop_ppaj_ddxag_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(3) = (CI*countertermnorm*ctGqq*eQED*gQCD**3)/3._/**/REALKIND
    f(4) = (CI*countertermnorm*ctVqq*eQED*gQCD**3)/3._/**/REALKIND
...
end module ol_loop_ppaj_ddxag_1_/**/REALKIND
