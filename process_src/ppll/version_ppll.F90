...
module ol_versiondata_ppll
  implicit none
  character(4) :: generator_revision = "1500"
  interface
    subroutine version_ppll(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppll
  end interface
end module ol_versiondata_ppll


subroutine ol_version_ppll(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppll, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppll
