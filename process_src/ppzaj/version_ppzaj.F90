...
module ol_versiondata_ppzaj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppzaj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzaj
  end interface
end module ol_versiondata_ppzaj


subroutine ol_version_ppzaj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzaj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzaj
