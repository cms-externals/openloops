...
module ol_colourmatrix_ppzaj_bbxazg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzaj_bbxazg_1_/**/REALKIND



module ol_forced_parameters_ppzaj_bbxazg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzaj_bbxazg_1_/**/REALKIND

module ol_loop_ppzaj_bbxazg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 4) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 5) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**3)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,34),Q(:,6),MB,1_intkind1,wf(:,35))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,36))
  call prop_Q_A(wf(:,36),Q(:,17),MB,1_intkind1,wf(:,37))
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,37),wf(:,38))
  call counter_ZQ_A(gZd,wf(:,-3),wf(:,0),wf(:,39))
  call prop_Q_A(wf(:,39),Q(:,9),MB,1_intkind1,wf(:,40))
  ...
  call prop_Q_A(wf(:,44),Q(:,5),MB,1_intkind1,wf(:,45))
  call vert_VQ_A(wf(:,-4),wf(:,45),wf(:,46))
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,45),wf(:,47))
  call vert_AV_Q(wf(:,4),wf(:,-4),wf(:,48))
  call counter_Q_A(ctbb,wf(:,3),Q(:,5),wf(:,49))
  call prop_A_Q(wf(:,48),Q(:,26),MB,1_intkind1,wf(:,50))
  call counter_A_Q(ctbb,wf(:,4),Q(:,10),wf(:,51))
  call prop_Q_A(wf(:,5),Q(:,21),MB,1_intkind1,wf(:,52))
  call vert_AZ_Q(gZd,wf(:,7),wf(:,-3),wf(:,53))
  call prop_A_Q(wf(:,53),Q(:,26),MB,1_intkind1,wf(:,54))
  call counter_A_Q(ctbb,wf(:,7),Q(:,18),wf(:,55))
  call prop_Q_A(wf(:,8),Q(:,13),MB,1_intkind1,wf(:,56))
  call vert_AV_Q(wf(:,12),wf(:,-4),wf(:,57))
  call counter_Q_A(ctbb,wf(:,11),Q(:,9),wf(:,58))
  call prop_A_Q(wf(:,57),Q(:,22),MB,1_intkind1,wf(:,59))
  call counter_A_Q(ctbb,wf(:,12),Q(:,6),wf(:,60))
  call prop_Q_A(wf(:,13),Q(:,25),MB,1_intkind1,wf(:,61))
  call vert_AZ_Q(gZd,wf(:,12),wf(:,-3),wf(:,62))
  call counter_Q_A(ctbb,wf(:,15),Q(:,17),wf(:,63))
  call prop_A_Q(wf(:,62),Q(:,14),MB,1_intkind1,wf(:,64))
  call prop_Q_A(wf(:,16),Q(:,25),MB,1_intkind1,wf(:,65))
  call vert_AV_Q(wf(:,7),wf(:,-2),wf(:,66))
  call prop_A_Q(wf(:,66),Q(:,22),MB,1_intkind1,wf(:,67))
  call prop_Q_A(wf(:,17),Q(:,13),MB,1_intkind1,wf(:,68))
  call vert_AV_Q(wf(:,4),wf(:,-2),wf(:,69))
  call prop_A_Q(wf(:,69),Q(:,14),MB,1_intkind1,wf(:,70))
  call prop_Q_A(wf(:,18),Q(:,21),MB,1_intkind1,wf(:,71))
...
end module ol_loop_ppzaj_bbxazg_1_/**/REALKIND
