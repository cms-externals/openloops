...
module ol_colourmatrix_ppzaj_uuxazg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzaj_uuxazg_1_/**/REALKIND



module ol_forced_parameters_ppzaj_uuxazg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzaj_uuxazg_1_/**/REALKIND

module ol_loop_ppzaj_uuxazg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 4) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 5) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 6) = (2*countertermnorm*ctZGG*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 7) = (2*CI*eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f( 8) = (2*eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-3),wf(:,32))
  ...
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,37),wf(:,38))
  call counter_ZQ_A(gZu,wf(:,-3),wf(:,0),wf(:,39))
  ...
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,45),wf(:,47))
  ...
  call vert_AZ_Q(gZu,wf(:,7),wf(:,-3),wf(:,53))
  ...
  call vert_AZ_Q(gZu,wf(:,12),wf(:,-3),wf(:,62))
...
end module ol_loop_ppzaj_uuxazg_1_/**/REALKIND
