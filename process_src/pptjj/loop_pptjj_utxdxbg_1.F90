...
module ol_colourmatrix_pptjj_utxdxbg_1_/**/REALKIND
...
end module ol_colourmatrix_pptjj_utxdxbg_1_/**/REALKIND



module ol_forced_parameters_pptjj_utxdxbg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pptjj_utxdxbg_1_/**/REALKIND

module ol_loop_pptjj_utxdxbg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_AV_Q(wf(:,-1),wf(:,-4),wf(:,2))
  call prop_A_Q(wf(:,2),Q(:,18),MT,1_intkind1,wf(:,3))
  call vert_WQ_A(wf(:,1),wf(:,-3),wf(:,4))
  call vert_VQ_A(wf(:,-4),wf(:,-3),wf(:,5))
  call prop_Q_A(wf(:,5),Q(:,24),MB,1_intkind1,wf(:,6))
  call vert_AW_Q(wf(:,-1),wf(:,1),wf(:,7))
  call vert_VQ_A(wf(:,-4),wf(:,0),wf(:,8))
  call vert_QA_W(wf(:,-3),wf(:,-1),wf(:,9))
  ...
  call vert_WQ_A(wf(:,9),wf(:,0),wf(:,14))
  call counter_WQ_A(wf(:,1),wf(:,-3),wf(:,15))
  call counter_VQ_A(wf(:,-4),wf(:,-3),wf(:,16))
  call prop_Q_A(wf(:,16),Q(:,24),MB,1_intkind1,wf(:,17))
  call vert_AQ_S(gPtb,wf(:,-1),wf(:,-3),wf(:,18))
  call counter_AQ_S(gPdu,wf(:,-2),wf(:,10),wf(:,19))
  call counter_QA_W(wf(:,10),wf(:,-2),wf(:,20))
  call counter_AV_Q(wf(:,-2),wf(:,-4),wf(:,21))
  call prop_A_Q(wf(:,21),Q(:,20),ZERO,0_intkind1,wf(:,22))
  call counter_AW_Q(wf(:,-1),wf(:,1),wf(:,23))
  call counter_AV_Q(wf(:,-1),wf(:,-4),wf(:,24))
  call prop_A_Q(wf(:,24),Q(:,18),MT,1_intkind1,wf(:,25))
  call counter_QA_W(wf(:,-3),wf(:,-1),wf(:,26))
  call vert_WQ_A(wf(:,26),wf(:,0),wf(:,27))
  call counter_QS_A(gPdu,wf(:,0),wf(:,18),wf(:,28))
  call counter_WQ_A(wf(:,9),wf(:,0),wf(:,29))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,30))
  call prop_Q_A(wf(:,30),Q(:,17),ZERO,0_intkind1,wf(:,31))
  call vert_QA_W(wf(:,31),wf(:,-2),wf(:,32))
  call counter_AQ_S(gPdu,wf(:,-2),wf(:,0),wf(:,33))
  call vert_QS_A(gPtb,wf(:,-3),wf(:,33),wf(:,34))
  call counter_QA_W(wf(:,0),wf(:,-2),wf(:,35))
  call vert_WQ_A(wf(:,35),wf(:,-3),wf(:,36))
  call vert_SA_Q(gPtb,wf(:,33),wf(:,-1),wf(:,37))
  call vert_AW_Q(wf(:,-1),wf(:,35),wf(:,38))
  call counter_A_Q(cttt,wf(:,3),Q(:,18),wf(:,39))
  call prop_Q_A(wf(:,4),Q(:,13),MT,1_intkind1,wf(:,40))
  call counter_Q_A(ctbb,wf(:,6),Q(:,24),wf(:,41))
  call prop_A_Q(wf(:,7),Q(:,7),MB,1_intkind1,wf(:,42))
  call vert_AW_Q(wf(:,-2),wf(:,9),wf(:,43))
  call counter_Q_A(ctqq,wf(:,10),Q(:,17),wf(:,44))
  call prop_A_Q(wf(:,43),Q(:,14),ZERO,0_intkind1,wf(:,45))
  call counter_A_Q(ctqq,wf(:,13),Q(:,20),wf(:,46))
  call prop_Q_A(wf(:,14),Q(:,11),ZERO,0_intkind1,wf(:,47))
  call vert_QA_W(wf(:,-3),wf(:,3),wf(:,48))
  call vert_QA_W(wf(:,0),wf(:,13),wf(:,49))
  call vert_QA_W(wf(:,6),wf(:,-1),wf(:,50))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(21)-A(22))*f(2)+A(6)*f(3)+A(11)*f(5)+(A(5)+A(10))*f(6)+(A(18)+A(20))*f(7)+(A(17)+A(19))*f(8)
  M2(2) = (-A(23)-A(24))*f(2)+(A(9)+A(16))*f(4)+(A(12)+A(13))*f(6)+(A(8)+A(15))*f(7)+(A(7)+A(14))*f(8)

end subroutine colourvectors

end module ol_loop_pptjj_utxdxbg_1_/**/REALKIND
