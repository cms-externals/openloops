...
! **********************************************************************
module ol_tensor_sum_storage_pptjj_utxdxbg_1_/**/REALKIND
! **********************************************************************
  ...
  complex(REALKIND), save :: T3sum(35,18) = 0

  contains

#ifdef PRECISION_dp
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pptjj_utxdxbg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pptjj_utxdxbg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pptjj_utxdxbg_1, only: channel_number_pptjj_utxdxbg_1
  ...
  call channel_on(channel_number_pptjj_utxdxbg_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,17)
  momenta_2(:,1) = Q(1:4,18)
  momenta_3(:,1) = Q(1:4,20)
  momenta_4(:,1) = Q(1:4,24)
  momenta_5(:,1) = Q(1:4,4)
  momenta_5(:,2) = Q(1:4,30)
  momenta_6(:,1) = Q(1:4,8)
  momenta_6(:,2) = Q(1:4,24)
  momenta_7(:,1) = Q(1:4,8)
  ...
  momenta_16(:,1) = Q(1:4,18)
  momenta_16(:,2) = Q(1:4,23)
  momenta_17(:,1) = Q(1:4,20)
  momenta_17(:,2) = Q(1:4,30)
  momenta_18(:,1) = Q(1:4,24)
  momenta_18(:,2) = Q(1:4,29)
  ...
  momenta_21(:,2) = Q(1:4,5)
  momenta_21(:,3) = Q(1:4,29)
  ...
  momenta_32(:,2) = Q(1:4,24)
  momenta_32(:,3) = Q(1:4,29)
  momenta_33(:,1) = Q(1:4,17)
  momenta_33(:,2) = Q(1:4,21)
  momenta_33(:,3) = Q(1:4,23)
  momenta_34(:,1) = Q(1:4,17)
  momenta_34(:,2) = Q(1:4,21)
  momenta_34(:,3) = Q(1:4,29)
  momenta_35(:,1) = Q(1:4,18)
  momenta_35(:,2) = Q(1:4,26)
  momenta_35(:,3) = Q(1:4,27)
  momenta_36(:,1) = Q(1:4,18)
  momenta_36(:,2) = Q(1:4,26)
  momenta_36(:,3) = Q(1:4,30)
  momenta_37(:,1) = Q(1:4,20)
  momenta_37(:,2) = Q(1:4,21)
  momenta_37(:,3) = Q(1:4,23)
  momenta_38(:,1) = Q(1:4,20)
  momenta_38(:,2) = Q(1:4,21)
  momenta_38(:,3) = Q(1:4,29)
  momenta_39(:,1) = Q(1:4,24)
  momenta_39(:,2) = Q(1:4,26)
  momenta_39(:,3) = Q(1:4,27)
  momenta_40(:,1) = Q(1:4,24)
  momenta_40(:,2) = Q(1:4,26)
  momenta_40(:,3) = Q(1:4,30)
  momenta_41(:,1) = Q(1:4,2)
  momenta_41(:,2) = Q(1:4,10)
  momenta_41(:,3) = Q(1:4,14)
  momenta_41(:,4) = Q(1:4,30)
  momenta_42(:,1) = Q(1:4,2)
  momenta_42(:,2) = Q(1:4,18)
  momenta_42(:,3) = Q(1:4,26)
  momenta_42(:,4) = Q(1:4,30)
  momenta_43(:,1) = Q(1:4,4)
  momenta_43(:,2) = Q(1:4,5)
  momenta_43(:,3) = Q(1:4,13)
  momenta_43(:,4) = Q(1:4,29)
  momenta_44(:,1) = Q(1:4,4)
  momenta_44(:,2) = Q(1:4,20)
  momenta_44(:,3) = Q(1:4,21)
  momenta_44(:,4) = Q(1:4,29)
  momenta_45(:,1) = Q(1:4,8)
  momenta_45(:,2) = Q(1:4,10)
  momenta_45(:,3) = Q(1:4,11)
  momenta_45(:,4) = Q(1:4,27)
  momenta_46(:,1) = Q(1:4,8)
  momenta_46(:,2) = Q(1:4,10)
  momenta_46(:,3) = Q(1:4,14)
  momenta_46(:,4) = Q(1:4,30)
  momenta_47(:,1) = Q(1:4,8)
  momenta_47(:,2) = Q(1:4,24)
  momenta_47(:,3) = Q(1:4,26)
  momenta_47(:,4) = Q(1:4,27)
  momenta_48(:,1) = Q(1:4,8)
  momenta_48(:,2) = Q(1:4,24)
  momenta_48(:,3) = Q(1:4,26)
  momenta_48(:,4) = Q(1:4,30)
  momenta_49(:,1) = Q(1:4,16)
  momenta_49(:,2) = Q(1:4,18)
  momenta_49(:,3) = Q(1:4,26)
  momenta_49(:,4) = Q(1:4,30)
  momenta_50(:,1) = Q(1:4,16)
  momenta_50(:,2) = Q(1:4,20)
  momenta_50(:,3) = Q(1:4,21)
  momenta_50(:,4) = Q(1:4,29)
  momenta_51(:,1) = Q(1:4,16)
  momenta_51(:,2) = Q(1:4,24)
  momenta_51(:,3) = Q(1:4,26)
  momenta_51(:,4) = Q(1:4,27)
  momenta_52(:,1) = Q(1:4,16)
  momenta_52(:,2) = Q(1:4,24)
  momenta_52(:,3) = Q(1:4,26)
  ...
  masses2_11 = [ ZERO2, MB2, MB2, MT2 ]
  masses2_12 = [ ZERO2, MB2, MT2, MT2 ]
  masses2_13 = [ ZERO2, MB2, MW2, ZERO2 ]
  masses2_14 = [ ZERO2, MT2, MW2, ZERO2 ]
  masses2_15 = [ ZERO2, ZERO2, MB2, MT2 ]
  masses2_16 = [ ZERO2, ZERO2, MW2, MB2 ]
  masses2_17 = [ ZERO2, ZERO2, MW2, MT2 ]
  masses2_18 = [ ZERO2, ZERO2, ZERO2, ZERO2 ]
  masses2_19 = [ ZERO2, MB2, MB2, MW2, ZERO2 ]
  masses2_20 = [ ZERO2, MB2, MW2, ZERO2, ZERO2 ]
  masses2_21 = [ ZERO2, MT2, MT2, MW2, ZERO2 ]
  masses2_22 = [ ZERO2, MT2, MW2, ZERO2, ZERO2 ]
  masses2_23 = [ ZERO2, ZERO2, MB2, MW2, ZERO2 ]
  masses2_24 = [ ZERO2, ZERO2, MT2, MW2, ZERO2 ]
  masses2_25 = [ ZERO2, ZERO2, MW2, MT2, MT2 ]
  masses2_26 = [ ZERO2, ZERO2, ZERO2, MW2, MT2 ]
  ...
  call TI_call(1, momenta_1, masses2_3, T1sum(:,3), M2)
  call TI_call(1, momenta_3, masses2_3, T1sum(:,4), M2)

  call TI_call(2, momenta_16, masses2_6, T2sum(:,1), M2)
  call TI_call(2, momenta_18, masses2_5, T2sum(:,2), M2)
  call TI_call(2, momenta_6, masses2_4, T2sum(:,3), M2)
  call TI_call(2, momenta_11, masses2_8, T2sum(:,4), M2)
  call TI_call(2, momenta_9, masses2_7, T2sum(:,5), M2)
  call TI_call(2, momenta_13, masses2_9, T2sum(:,6), M2)
  call TI_call(2, momenta_15, masses2_10, T2sum(:,7), M2)
  call TI_call(2, momenta_17, masses2_10, T2sum(:,8), M2)
  call TI_call(2, momenta_8, masses2_10, T2sum(:,9), M2)
  call TI_call(2, momenta_12, masses2_10, T2sum(:,10), M2)
  call TI_call(2, momenta_10, masses2_10, T2sum(:,11), M2)
  call TI_call(2, momenta_14, masses2_10, T2sum(:,12), M2)
  call TI_call(2, momenta_7, masses2_5, T2sum(:,13), M2)
  call TI_call(2, momenta_33, masses2_16, T2sum(:,14), M2)
  call TI_call(2, momenta_24, masses2_17, T2sum(:,15), M2)
  call TI_call(2, momenta_34, masses2_17, T2sum(:,16), M2)
  call TI_call(2, momenta_25, masses2_13, T2sum(:,17), M2)
  call TI_call(2, momenta_5, masses2_10, T2sum(:,18), M2)
  call TI_call(2, momenta_30, masses2_13, T2sum(:,19), M2)
  call TI_call(2, momenta_35, masses2_14, T2sum(:,20), M2)
  call TI_call(2, momenta_36, masses2_14, T2sum(:,21), M2)
  call TI_call(2, momenta_29, masses2_13, T2sum(:,22), M2)
  call TI_call(2, momenta_19, masses2_14, T2sum(:,23), M2)
  call TI_call(2, momenta_37, masses2_16, T2sum(:,24), M2)
  call TI_call(2, momenta_38, masses2_17, T2sum(:,25), M2)
  call TI_call(2, momenta_26, masses2_13, T2sum(:,26), M2)
  call TI_call(2, momenta_20, masses2_14, T2sum(:,27), M2)
  call TI_call(2, momenta_39, masses2_13, T2sum(:,28), M2)
  call TI_call(2, momenta_40, masses2_13, T2sum(:,29), M2)
  call TI_call(2, momenta_21, masses2_17, T2sum(:,30), M2)

  call TI_call(3, momenta_27, masses2_12, T3sum(:,1), M2)
  call TI_call(3, momenta_28, masses2_11, T3sum(:,2), M2)
  call TI_call(3, momenta_32, masses2_15, T3sum(:,3), M2)
  call TI_call(3, momenta_22, masses2_18, T3sum(:,4), M2)
  call TI_call(3, momenta_23, masses2_18, T3sum(:,5), M2)
  call TI_call(3, momenta_31, masses2_18, T3sum(:,6), M2)
  call TI_call(3, momenta_51, masses2_23, T3sum(:,7), M2)
  call TI_call(3, momenta_42, masses2_21, T3sum(:,8), M2)
  call TI_call(3, momenta_47, masses2_19, T3sum(:,9), M2)
  call TI_call(3, momenta_41, masses2_22, T3sum(:,10), M2)
  call TI_call(3, momenta_45, masses2_20, T3sum(:,11), M2)
  call TI_call(3, momenta_43, masses2_25, T3sum(:,12), M2)
  call TI_call(3, momenta_48, masses2_19, T3sum(:,13), M2)
  call TI_call(3, momenta_50, masses2_26, T3sum(:,14), M2)
  call TI_call(3, momenta_52, masses2_23, T3sum(:,15), M2)
  call TI_call(3, momenta_49, masses2_24, T3sum(:,16), M2)
  call TI_call(3, momenta_46, masses2_20, T3sum(:,17), M2)
  call TI_call(3, momenta_44, masses2_26, T3sum(:,18), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pptjj_utxdxbg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pptjj_utxdxbg_1_/**/REALKIND
