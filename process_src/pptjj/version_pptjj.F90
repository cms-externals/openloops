...
module ol_versiondata_pptjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptjj
  end interface
end module ol_versiondata_pptjj


subroutine ol_version_pptjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptjj
