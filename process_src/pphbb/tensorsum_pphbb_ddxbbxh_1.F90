...
! **********************************************************************
  ...
  masses2_13 = [ ZERO2, MB2, MB2, ZERO2, ZERO2 ]
  ...
  call TI_call(2, momenta_7, masses2_7, T2sum(:,2), M2)
  call TI_call(2, momenta_11, masses2_6, T2sum(:,3), M2)
  ...
  call TI_call(2, momenta_4, masses2_9, T2sum(:,7), M2)
  call TI_call(2, momenta_12, masses2_9, T2sum(:,8), M2)
  call TI_call(2, momenta_17, masses2_12, T2sum(:,9), M2)
  call TI_call(2, momenta_18, masses2_12, T2sum(:,10), M2)
  call TI_call(2, momenta_14, masses2_12, T2sum(:,11), M2)
  call TI_call(2, momenta_19, masses2_12, T2sum(:,12), M2)
  ...
  call TI_call(3, momenta_9, masses2_8, T3sum(:,1), M2)
  call TI_call(3, momenta_9, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_15, masses2_10, T3sum(:,3), M2)
  call TI_call(3, momenta_16, masses2_10, T3sum(:,4), M2)
  call TI_call(3, momenta_13, masses2_11, T3sum(:,5), M2)
  call TI_call(3, momenta_20, masses2_13, T3sum(:,6), M2)
  call TI_call(3, momenta_21, masses2_13, T3sum(:,7), M2)
