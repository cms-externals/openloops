...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(19) = (CI*countertermnorm*ctHGG*eQED*gQCD**4*MC*YC)/MQ2sum
    f(20) = (countertermnorm*ctHGG*eQED*gQCD**4*MC*YC)/MQ2sum
    f(21) = (CI*eQED*gQCD**4*integralnorm*SwF*YC)/(2._/**/REALKIND*MW*sw)
    f(22) = (eQED*gQCD**4*integralnorm*SwF*YC)/(MW*sw*2._/**/REALKIND)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(30)+A(33))*f(1)+CI*(A(10)+A(13)-A(16))*f(2)+(-A(54)-A(55)-A(62)-A(63)-A(68)-A(69))*f(5)+CI*(-A(58)-A(59)-A(64) &
       -A(65))*f(6)+(A(18)+A(22)+A(40)+A(42)+A(47)+A(49))*f(7)+CI*(A(38)+A(46))*f(8)+(A(28)+A(44)+A(51))*f(9)+CI*(A(45) &
       +A(53))*f(10)+CI*(A(20)+A(23))*f(11)+(A(31)+A(34))*f(19)+CI*(A(11)+A(14)-A(17))*f(20)+(A(29)+A(32))*f(23)+CI*(A(9)+A(12) &
       -A(15))*f(24)
  M2(2) = (A(26)+A(36))*f(1)+CI*(-A(10)-A(13)+A(16))*f(2)+(-A(56)-A(57)-A(60)-A(61)-A(66)-A(67))*f(5)+CI*(A(58)+A(59)+A(64) &
       +A(65))*f(6)+(A(19)+A(21)+A(39)+A(41)+A(48)+A(50))*f(7)+CI*(-A(38)-A(46))*f(8)+(A(24)+A(43)+A(52))*f(9)+CI*(-A(45) &
       -A(53))*f(10)+CI*(-A(20)-A(23))*f(11)+(A(27)+A(37))*f(19)+CI*(-A(11)-A(14)+A(17))*f(20)+(A(25)+A(35))*f(23)+CI*(-A(9)-A(12) &
       +A(15))*f(24)
