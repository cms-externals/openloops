...
! **********************************************************************
  ...
  call TI_call(2, momenta_29, masses2_7, T2sum(:,1), M2)
  call TI_call(2, momenta_15, masses2_8, T2sum(:,2), M2)
  call TI_call(2, momenta_35, masses2_7, T2sum(:,3), M2)
  call TI_call(2, momenta_11, masses2_11, T2sum(:,4), M2)
  call TI_call(2, momenta_13, masses2_7, T2sum(:,5), M2)
  call TI_call(2, momenta_25, masses2_7, T2sum(:,6), M2)
  call TI_call(2, momenta_27, masses2_7, T2sum(:,7), M2)
  call TI_call(2, momenta_14, masses2_8, T2sum(:,8), M2)
  call TI_call(2, momenta_36, masses2_7, T2sum(:,9), M2)
  call TI_call(2, momenta_12, masses2_11, T2sum(:,10), M2)
  call TI_call(2, momenta_26, masses2_7, T2sum(:,11), M2)
  call TI_call(2, momenta_30, masses2_7, T2sum(:,12), M2)
  call TI_call(2, momenta_19, masses2_11, T2sum(:,13), M2)
  call TI_call(2, momenta_31, masses2_7, T2sum(:,14), M2)
  call TI_call(2, momenta_20, masses2_11, T2sum(:,15), M2)
  call TI_call(2, momenta_24, masses2_7, T2sum(:,16), M2)
  call TI_call(2, momenta_28, masses2_7, T2sum(:,17), M2)
  ...
  call TI_call(2, momenta_16, masses2_7, T2sum(:,21), M2)
  call TI_call(2, momenta_33, masses2_11, T2sum(:,22), M2)
  call TI_call(2, momenta_9, masses2_7, T2sum(:,23), M2)
  ...
  call TI_call(2, momenta_17, masses2_7, T2sum(:,29), M2)
  call TI_call(2, momenta_34, masses2_11, T2sum(:,30), M2)
  call TI_call(2, momenta_10, masses2_7, T2sum(:,31), M2)
  ...
  call TI_call(2, momenta_7, masses2_3, T2sum(:,50), M2)
  ...
  call TI_call(2, momenta_5, masses2_3, T2sum(:,54), M2)
  ...
  call TI_call(2, momenta_4, masses2_3, T2sum(:,58), M2)
  call TI_call(2, momenta_4, masses2_4, T2sum(:,59), M2)
  call TI_call(2, momenta_4, masses2_1, T2sum(:,60), M2)

  call TI_call(3, momenta_21, masses2_9, T3sum(:,1), M2)
  ...
  call TI_call(3, momenta_18, masses2_9, T3sum(:,7), M2)
