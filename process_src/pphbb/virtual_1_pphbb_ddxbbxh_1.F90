...
! **********************************************************************
  ...
  call loop_A_Q(G1(:,:,:,12),Q(:,30),ZERO,G2(:,:,:,10))
  call check_last_AQ_V(l_switch,G2(:,:,:,10),wf(:,0),G2tensor(:,2))
  call check_last_QA_V(l_switch,G1(:,:,:,9),wf(:,22),G1tensor(:,1))
  ...
  call loop_A_Q(G2(:,:,:,15),Q(:,30),ZERO,G3(:,:,:,2))
  ...
  call loop_A_Q(G0(:,:,:,8),Q(:,24),MB,G1(:,:,:,18))
  call loop_AV_Q(G1(:,:,:,18),wf(:,1),G1(:,:,:,19))
  call loop_A_Q(G1(:,:,:,19),Q(:,27),MB,G2(:,:,:,18))
  call check_last_AQ_V(l_switch,G2(:,:,:,18),wf(:,-2),G2tensor(:,6))
  call loop_AQ_V(G1(:,:,:,18),wf(:,-2),G1(:,:,:,20))
  call loop_VA_Q(G1(:,:,:,20),wf(:,-1),G1(:,:,:,21))
  call loop_A_Q(G1(:,:,:,21),Q(:,30),ZERO,G2(:,:,:,19))
  call check_last_AQ_V(l_switch,G2(:,:,:,19),wf(:,0),G2tensor(:,7))
  call check_last_AQ_V(l_switch,G1(:,:,:,18),wf(:,25),G1tensor(:,2))
  call loop_VQ_A(G0(:,:,:,1),wf(:,-2),G0(:,:,:,9))
  call loop_Q_A(G0(:,:,:,9),Q(:,4),MB,G1(:,:,:,22))
  call loop_QA_V(G1(:,:,:,22),wf(:,6),G1(:,:,:,23))
  call check_last_UV_W(l_switch,G1(:,:,:,23),Q(:,28),wf(:,1),Q(:,3),G2tensor(:,8))
  call loop_VA_Q(G1(:,:,:,23),wf(:,-1),G1(:,:,:,24))
  call loop_A_Q(G1(:,:,:,24),Q(:,30),ZERO,G2(:,:,:,20))
  call check_last_AQ_V(l_switch,G2(:,:,:,20),wf(:,0),G2tensor(:,9))
  call loop_QS_A(G1(:,:,:,22),wf(:,-4),G1(:,:,:,25),gH)
  call loop_Q_A(G1(:,:,:,25),Q(:,20),MB,G2(:,:,:,21))
  call loop_QA_V(G2(:,:,:,21),wf(:,-3),G2(:,:,:,22))
  call check_last_UV_W(l_switch,G2(:,:,:,22),Q(:,28),wf(:,1),Q(:,3),G3tensor(:,8))
  call loop_VA_Q(G2(:,:,:,22),wf(:,-1),G2(:,:,:,23))
  call loop_A_Q(G2(:,:,:,23),Q(:,30),ZERO,G3(:,:,:,4))
  call check_last_AQ_V(l_switch,G3(:,:,:,4),wf(:,0),G3tensor(:,9))
  call loop_VA_Q(G0(:,:,:,1),wf(:,22),G0(:,:,:,10))
  call loop_A_Q(G0(:,:,:,10),Q(:,11),MB,G1(:,:,:,26))
  call loop_AS_Q(G1(:,:,:,26),wf(:,-4),G1(:,:,:,27),gH)
  call loop_A_Q(G1(:,:,:,27),Q(:,27),MB,G2(:,:,:,24))
  call check_last_AQ_V(l_switch,G2(:,:,:,24),wf(:,-2),G2tensor(:,10))
  call loop_VA_Q(G0(:,:,:,1),wf(:,-1),G0(:,:,:,11))
  call loop_A_Q(G0(:,:,:,11),Q(:,2),ZERO,G1(:,:,:,28))
  call loop_AV_Q(G1(:,:,:,28),wf(:,19),G1(:,:,:,29))
  call loop_A_Q(G1(:,:,:,29),Q(:,30),ZERO,G2(:,:,:,25))
  call check_last_AQ_V(l_switch,G2(:,:,:,25),wf(:,0),G2tensor(:,11))
  call loop_AV_Q(G1(:,:,:,28),wf(:,23),G1(:,:,:,30))
  call loop_A_Q(G1(:,:,:,30),Q(:,30),ZERO,G2(:,:,:,26))
  call check_last_AQ_V(l_switch,G2(:,:,:,26),wf(:,0),G2tensor(:,12))
  call loop_UV_W(G0(:,:,:,1),Q(:,0),wf(:,19),Q(:,28),G1(:,:,:,31))
  call loop_VA_Q(G1(:,:,:,31),wf(:,-1),G1(:,:,:,32))
  call loop_A_Q(G1(:,:,:,32),Q(:,30),ZERO,G2(:,:,:,27))
  call check_last_AQ_V(l_switch,G2(:,:,:,27),wf(:,0),G2tensor(:,13))
  call check_last_UV_W(l_switch,G1(:,:,:,31),Q(:,28),wf(:,1),Q(:,3),G2tensor(:,14))
  call loop_UV_W(G0(:,:,:,1),Q(:,0),wf(:,23),Q(:,28),G1(:,:,:,33))
  call loop_VA_Q(G1(:,:,:,33),wf(:,-1),G1(:,:,:,34))
  call loop_A_Q(G1(:,:,:,34),Q(:,30),ZERO,G2(:,:,:,28))
  call check_last_AQ_V(l_switch,G2(:,:,:,28),wf(:,0),G2tensor(:,15))
  call check_last_UV_W(l_switch,G1(:,:,:,33),Q(:,28),wf(:,1),Q(:,3),G2tensor(:,16))
  call loop_QV_A(G0(:,:,:,1),wf(:,19),G0(:,:,:,12))
  call loop_Q_A(G0(:,:,:,12),Q(:,28),ZERO,G1(:,:,:,35))
  call loop_QV_A(G1(:,:,:,35),wf(:,1),G1(:,:,:,36))
  call check_last_Q_A(l_switch,G1(:,:,:,36),Q(:,31),ZERO,G2tensor(:,17))
  call loop_QV_A(G0(:,:,:,1),wf(:,19),G0(:,:,:,13))
  call loop_Q_A(G0(:,:,:,13),Q(:,28),MT,G1(:,:,:,37))
  call loop_QV_A(G1(:,:,:,37),wf(:,1),G1(:,:,:,38))
  call check_last_Q_A(l_switch,G1(:,:,:,38),Q(:,31),MT,G2tensor(:,18))
  call loop_QV_A(G0(:,:,:,1),wf(:,19),G0(:,:,:,14))
  call loop_Q_A(G0(:,:,:,14),Q(:,28),MB,G1(:,:,:,39))
  call loop_QV_A(G1(:,:,:,39),wf(:,1),G1(:,:,:,40))
  call check_last_Q_A(l_switch,G1(:,:,:,40),Q(:,31),MB,G2tensor(:,19))
  call loop_CV_D(G0(:,:,:,1),Q(:,0),wf(:,19),Q(:,28),G1(:,:,:,41))
  call check_last_CV_D(l_switch,G1(:,:,:,41),Q(:,28),wf(:,1),Q(:,3),G2tensor(:,20))
  call loop_QV_A(G0(:,:,:,1),wf(:,23),G0(:,:,:,15))
  call loop_Q_A(G0(:,:,:,15),Q(:,28),ZERO,G1(:,:,:,42))
  call loop_QV_A(G1(:,:,:,42),wf(:,1),G1(:,:,:,43))
  call check_last_Q_A(l_switch,G1(:,:,:,43),Q(:,31),ZERO,G2tensor(:,21))
  call loop_QV_A(G0(:,:,:,1),wf(:,23),G0(:,:,:,16))
  call loop_Q_A(G0(:,:,:,16),Q(:,28),MT,G1(:,:,:,44))
  call loop_QV_A(G1(:,:,:,44),wf(:,1),G1(:,:,:,45))
  call check_last_Q_A(l_switch,G1(:,:,:,45),Q(:,31),MT,G2tensor(:,22))
  call loop_QV_A(G0(:,:,:,1),wf(:,23),G0(:,:,:,17))
  call loop_Q_A(G0(:,:,:,17),Q(:,28),MB,G1(:,:,:,46))
  call loop_QV_A(G1(:,:,:,46),wf(:,1),G1(:,:,:,47))
  call check_last_Q_A(l_switch,G1(:,:,:,47),Q(:,31),MB,G2tensor(:,23))
  call loop_CV_D(G0(:,:,:,1),Q(:,0),wf(:,23),Q(:,28),G1(:,:,:,48))
  call check_last_CV_D(l_switch,G1(:,:,:,48),Q(:,28),wf(:,1),Q(:,3),G2tensor(:,24))
