...
! **********************************************************************
module ol_tensor_sum_storage_pphbb_ccxddxh_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphbb_ccxddxh_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphbb_ccxddxh_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphbb_ccxddxh_1, only: channel_number_pphbb_ccxddxh_1
  ...
  call channel_on(channel_number_pphbb_ccxddxh_1)
  M2 = 0
  ...
  masses2_13 = [ ZERO2, ZERO2, MC2, MC2 ]
  masses2_14 = [ ZERO2, ZERO2, ZERO2, MC2 ]
  masses2_15 = [ ZERO2, ZERO2, ZERO2, MC2, MC2 ]
  ...
  call TI_call(2, momenta_10, masses2_8, T2sum(:,1), M2)
  call TI_call(2, momenta_6, masses2_10, T2sum(:,2), M2)
  call TI_call(2, momenta_11, masses2_8, T2sum(:,3), M2)
  call TI_call(2, momenta_7, masses2_10, T2sum(:,4), M2)
  call TI_call(2, momenta_8, masses2_8, T2sum(:,5), M2)
  ...
  call TI_call(2, momenta_15, masses2_14, T2sum(:,9), M2)
  call TI_call(2, momenta_17, masses2_14, T2sum(:,10), M2)
  call TI_call(2, momenta_16, masses2_14, T2sum(:,11), M2)
  call TI_call(2, momenta_18, masses2_14, T2sum(:,12), M2)
  ...
  call TI_call(3, momenta_5, masses2_7, T3sum(:,1), M2)
  call TI_call(3, momenta_5, masses2_9, T3sum(:,2), M2)
  call TI_call(3, momenta_5, masses2_6, T3sum(:,3), M2)
  call TI_call(3, momenta_13, masses2_12, T3sum(:,4), M2)
  call TI_call(3, momenta_14, masses2_12, T3sum(:,5), M2)
  call TI_call(3, momenta_19, masses2_13, T3sum(:,6), M2)
  ...
  call channel_off(channel_number_pphbb_ccxddxh_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphbb_ccxddxh_1_/**/REALKIND
