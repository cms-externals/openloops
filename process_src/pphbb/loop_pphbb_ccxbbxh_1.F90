...
module ol_colourmatrix_pphbb_ccxbbxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphbb_ccxbbxh_1_/**/REALKIND



module ol_forced_parameters_pphbb_ccxbbxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphbb_ccxbbxh_1_/**/REALKIND

module ol_loop_pphbb_ccxbbxh_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 5) = (CI*countertermnorm*ctGcc*eQED*gQCD**4*YB)/(2._/**/REALKIND*MW*sw)
    ...
    f(12) = (CI*countertermnorm*ctHGG*eQED*gQCD**4*MC*YC)/MQ2sum
    f(13) = (CI*eQED*gQCD**2*YC)/(2._/**/REALKIND*MW*sw)
    f(14) = (CI*countertermnorm*eQED*gQCD**4*YC)/(2._/**/REALKIND*MW*sw)
    f(15) = (CI*countertermnorm*ctGbb*eQED*gQCD**4*YC)/(2._/**/REALKIND*MW*sw)
    f(16) = (CI*countertermnorm*ctGcc*eQED*gQCD**4*YC)/(2._/**/REALKIND*MW*sw)
    f(17) = (CI*countertermnorm*ctScc*eQED*gQCD**4*YC)/(2._/**/REALKIND*MW*sw)
    f(18) = (CI*eQED*gQCD**4*integralnorm*SwB*YC)/(2._/**/REALKIND*MW*sw)
    f(19) = (eQED*gQCD**4*integralnorm*SwB*YC)/(MW*sw*4._/**/REALKIND)
    f(20) = (eQED*gQCD**4*integralnorm*SwB*YC)/(MW*sw*2._/**/REALKIND)
    ...
    f(24) = (eQED*gQCD**4*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
  ...
  c = [ 9*CI*f(7), 27*CI*f(7), 18*f(8), 54*f(8), f(9), 3*f(9), 6*f(9), 8*f(9), 10*f(9), 18*f(9), 21*f(9), 24*f(9), 54*f(9) &
    ...
    , 18*f(20), 21*f(20), 24*f(20), 54*f(20), 3*f(21), 9*f(21), 3*f(22), 9*f(22), 3*f(24), 9*f(24) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,10),Q(:,17),wf(:,42))
  call prop_A_Q(wf(:,41),Q(:,14),MC,1_intkind1,wf(:,43))
  call counter_V_V(ctGG,wf(:,9),Q(:,12),wf(:,44))
  call vert_VQ_A(wf(:,9),wf(:,0),wf(:,45))
  call counter_A_Q(ctcc,wf(:,13),Q(:,18),wf(:,46))
  call prop_Q_A(wf(:,45),Q(:,13),MC,1_intkind1,wf(:,47))
...
subroutine diagrams(A)
  ...
  A(7) = cont_VV(wf(:,9),wf(:,15)) * den(11)
  A(8) = cont_QA(wf(:,3),wf(:,16)) * den(3)
  A(9) = cont_QA(wf(:,7),wf(:,18)) * den(5)
  A(10) = cont_QA(wf(:,6),wf(:,19)) * den(5)
  A(11) = cont_QA(wf(:,4),wf(:,21)) * den(3)
  A(12) = cont_VV(wf(:,11),wf(:,22)) * den(8)
  A(13) = cont_VV(wf(:,14),wf(:,22)) * den(10)
  A(14) = cont_VV(wf(:,9),wf(:,23)) * den(8)
  A(15) = cont_VV(wf(:,9),wf(:,26)) * den(10)
  A(16) = cont_VV(wf(:,9),wf(:,27)) * den(10)
  A(17) = cont_VV(wf(:,9),wf(:,30)) * den(8)
  A(18) = cont_QA(wf(:,3),wf(:,32)) * den(3)
  A(19) = cont_QA(wf(:,6),wf(:,33)) * den(5)
  A(20) = cont_VV(wf(:,34),wf(:,35)) * den(14)
  A(21) = cont_QA(wf(:,36),wf(:,37)) * den(17)
  A(22) = cont_VV(wf(:,35),wf(:,38)) * den(19)
  A(23) = cont_QA(wf(:,39),wf(:,40)) * den(22)
  A(24) = cont_QA(wf(:,42),wf(:,43)) * den(25)
  A(25) = cont_VV(wf(:,11),wf(:,44)) * den(28)
  A(26) = cont_QA(wf(:,46),wf(:,47)) * den(31)
  A(27) = cont_VV(wf(:,14),wf(:,44)) * den(33)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(6)*f(1))/2._/**/REALKIND+((-A(20)-A(21)-A(22)-A(23))*f(3))/2._/**/REALKIND+((A(8)+A(10))*f(4))/2._/**/REALKIND &
       +((A(18)+A(19))*f(5))/2._/**/REALKIND+((A(9)+A(11))*f(6))/2._/**/REALKIND+(A(7)*f(12))/2._/**/REALKIND+((-A(24)-A(25)-A(26) &
       -A(27))*f(14))/2._/**/REALKIND+((A(12)+A(13))*f(15))/2._/**/REALKIND+((A(14)+A(16))*f(16))/2._/**/REALKIND+((A(15) &
       +A(17))*f(17))/2._/**/REALKIND+(A(5)*f(23))/2._/**/REALKIND
  M2(2) = -(A(6)*f(1))/6._/**/REALKIND+((A(20)+A(21)+A(22)+A(23))*f(3))/6._/**/REALKIND+((-A(8)-A(10))*f(4))/6._/**/REALKIND+(( &
       -A(18)-A(19))*f(5))/6._/**/REALKIND+((-A(9)-A(11))*f(6))/6._/**/REALKIND-(A(7)*f(12))/6._/**/REALKIND+((A(24)+A(25)+A(26) &
       +A(27))*f(14))/6._/**/REALKIND+((-A(12)-A(13))*f(15))/6._/**/REALKIND+((-A(14)-A(16))*f(16))/6._/**/REALKIND+((-A(15) &
       -A(17))*f(17))/6._/**/REALKIND-(A(5)*f(23))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphbb_ccxbbxh_1_/**/REALKIND
