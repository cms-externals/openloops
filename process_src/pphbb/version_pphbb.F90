...
module ol_versiondata_pphbb
  implicit none
  character(4) :: generator_revision = "4024"
  interface
    subroutine version_pphbb(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphbb
  end interface
end module ol_versiondata_pphbb


subroutine ol_version_pphbb(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphbb, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphbb
