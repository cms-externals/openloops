...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(11) = (CI*countertermnorm*ctHGG*eQED*gQCD**4*MT*YT)/MQ2sum
    f(12) = (eQED*gQCD**4*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)

  c = [ 9*CI*f(6), 27*CI*f(6), 18*f(7), 54*f(7), f(8), 3*f(8), 6*f(8), 8*f(8), 10*f(8), 18*f(8), 21*f(8), 24*f(8), 54*f(8), 3*f(9) &
    , 9*f(9), 3*f(10), 9*f(10), 3*f(12), 9*f(12) ]
  c = (1._/**/REALKIND / 36) * c
...
subroutine diagrams(A)
  ...
  A(11) = cont_QA(wf(:,3),wf(:,22)) * den(3)
  A(12) = cont_QA(wf(:,7),wf(:,24)) * den(5)
  A(13) = cont_VV(wf(:,9),wf(:,25)) * den(18)
  A(14) = cont_VV(wf(:,9),wf(:,25)) * den(18)
  A(15) = cont_VV(wf(:,9),wf(:,26)) * den(8)
  A(16) = cont_QA(wf(:,12),wf(:,24)) * den(9)
  A(17) = cont_QA(wf(:,3),wf(:,27)) * den(11)
  A(18) = cont_QA(wf(:,17),wf(:,29)) * den(13)
  A(19) = cont_VV(wf(:,18),wf(:,30)) * den(15)
  A(20) = cont_QA(wf(:,20),wf(:,29)) * den(16)
  A(21) = cont_QA(wf(:,6),wf(:,31)) * den(5)
  A(22) = cont_QA(wf(:,4),wf(:,33)) * den(3)
  A(23) = cont_QA(wf(:,16),wf(:,34)) * den(13)
  A(24) = cont_QA(wf(:,14),wf(:,33)) * den(11)
  A(25) = cont_VV(wf(:,19),wf(:,35)) * den(15)
  A(26) = cont_QA(wf(:,16),wf(:,36)) * den(16)
  A(27) = cont_VV(wf(:,11),wf(:,37)) * den(8)
  A(28) = cont_QA(wf(:,6),wf(:,38)) * den(9)
  A(29) = cont_QA(wf(:,6),wf(:,39)) * den(9)
  A(30) = cont_VV(wf(:,9),wf(:,42)) * den(8)
  A(31) = cont_QA(wf(:,16),wf(:,43)) * den(16)
  A(32) = cont_VV(wf(:,18),wf(:,44)) * den(15)
  A(33) = cont_QA(wf(:,3),wf(:,46)) * den(11)
  A(34) = cont_QA(wf(:,16),wf(:,47)) * den(13)
  A(35) = cont_QA(wf(:,3),wf(:,49)) * den(3)
  A(36) = cont_QA(wf(:,6),wf(:,50)) * den(5)
  A(37) = cont_VV(wf(:,51),wf(:,52)) * den(21)
  A(38) = cont_QA(wf(:,53),wf(:,54)) * den(24)
  A(39) = cont_VV(wf(:,52),wf(:,55)) * den(26)
  A(40) = cont_QA(wf(:,56),wf(:,57)) * den(29)
  A(41) = cont_QA(wf(:,59),wf(:,60)) * den(32)
  A(42) = cont_VV(wf(:,11),wf(:,61)) * den(35)
  A(43) = cont_VV(wf(:,61),wf(:,62)) * den(37)
  A(44) = cont_QA(wf(:,56),wf(:,63)) * den(39)
  A(45) = cont_VV(wf(:,64),wf(:,65)) * den(42)
  A(46) = cont_QA(wf(:,53),wf(:,66)) * den(44)
  A(47) = cont_VV(wf(:,65),wf(:,67)) * den(46)
  A(48) = cont_QA(wf(:,68),wf(:,69)) * den(49)
  A(49) = cont_QA(wf(:,59),wf(:,71)) * den(51)
  A(50) = cont_VV(wf(:,19),wf(:,72)) * den(54)
  A(51) = cont_VV(wf(:,72),wf(:,73)) * den(56)
  A(52) = cont_QA(wf(:,68),wf(:,74)) * den(58)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = -(A(10)*f(1))/2._/**/REALKIND-(A(14)*f(1))/6._/**/REALKIND+((A(41)+A(42)+A(43)+A(44)+A(45)+A(46)+A(47) &
       +A(48))*f(3))/6._/**/REALKIND+((A(37)+A(38)+A(39)+A(40)+A(49)+A(50)+A(51)+A(52))*f(3))/2._/**/REALKIND+((-A(15)-A(17)-A(23) &
       -A(27)-A(28)-A(29)-A(33)-A(34))*f(4))/6._/**/REALKIND+((-A(11)-A(19)-A(21)-A(25)-A(26)-A(31)-A(35) &
       -A(36))*f(4))/2._/**/REALKIND+((-A(16)-A(18)-A(24)-A(30))*f(5))/6._/**/REALKIND+((-A(12)-A(20)-A(22) &
       -A(32))*f(5))/2._/**/REALKIND-(A(9)*f(11))/2._/**/REALKIND-(A(13)*f(11))/6._/**/REALKIND
  M2(2) = (A(10)*f(1))/6._/**/REALKIND+(A(14)*f(1))/2._/**/REALKIND+((-A(41)-A(42)-A(43)-A(44)-A(45)-A(46)-A(47) &
       -A(48))*f(3))/2._/**/REALKIND+((-A(37)-A(38)-A(39)-A(40)-A(49)-A(50)-A(51)-A(52))*f(3))/6._/**/REALKIND+((A(15)+A(17)+A(23) &
       +A(27)+A(28)+A(29)+A(33)+A(34))*f(4))/2._/**/REALKIND+((A(11)+A(19)+A(21)+A(25)+A(26)+A(31)+A(35) &
       +A(36))*f(4))/6._/**/REALKIND+((A(16)+A(18)+A(24)+A(30))*f(5))/2._/**/REALKIND+((A(12)+A(20)+A(22) &
       +A(32))*f(5))/6._/**/REALKIND+(A(9)*f(11))/6._/**/REALKIND+(A(13)*f(11))/2._/**/REALKIND
