...
module ol_colourmatrix_pphbb_ccxddxhg_1_/**/REALKIND
...
end module ol_colourmatrix_pphbb_ccxddxhg_1_/**/REALKIND



module ol_forced_parameters_pphbb_ccxddxhg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphbb_ccxddxhg_1_/**/REALKIND

module ol_tree_pphbb_ccxddxhg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pphbb_ccxddxhg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pphbb_ccxddxhg_1_/**/DREALKIND, only: &
    & ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for charm anti-charm down anti-down higgs glue -> 0
...
! **********************************************************************
  ...
  use ol_external_pphbb_ccxddxhg_1, only: &
    & external_perm_pphbb_ccxddxhg_1, &
    & external_perm_inv_pphbb_ccxddxhg_1, &
    & extcomb_perm_pphbb_ccxddxhg_1, &
    & average_factor_pphbb_ccxddxhg_1
  use ol_external_pphbb_ccxddxhg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_pphbb_ccxddxhg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_pphbb_ccxddxhg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_pphbb_ccxddxhg_1
  ...
  type(wfun) :: wf2(2,4), wf4(4,15), wf8(8,9), wf32(32,12)
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_pphbb_ccxddxhg_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pphbb_ccxddxhg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pphbb_ccxddxhg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_pphbb_ccxddxhg_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf2(:,1), Q(:,17), MC, 1_intkind1, wf2(:,2), n2(1))
  call prop_A_Q(ntry, wf4(:,1), Q(:,34), MC, 1_intkind1, wf4(:,3), n2(2))
  ...
  call prop_A_Q(ntry, wf8(:,3), Q(:,14), MC, 1_intkind1, wf8(:,4), n2(3))
  call vert_VQ_A(ntry, ex6, ex1, wf4(:,6), n3(:,9), t3x4(:,:,5))
  call vert_SA_Q(gH,ntry, ex5, ex2, wf2(:,3), n3(:,10), t3x2(:,:,2))
  call prop_Q_A(ntry, wf4(:,6), Q(:,33), MC, 1_intkind1, wf4(:,7), n2(4))
  call prop_A_Q(ntry, wf2(:,3), Q(:,18), MC, 1_intkind1, wf2(:,4), n2(5))
  ...
  call prop_Q_A(ntry, wf8(:,6), Q(:,13), MC, 1_intkind1, wf8(:,7), n2(6))
  ...
  call prop_Q_A(ntry, wf4(:,12), Q(:,36), ZERO, 0_intkind1, wf4(:,13), n2(7))
  call vert_QA_V(ntry, wf4(:,13), ex4, wf8(:,8), n3(:,18), t3x8(:,:,6))
  call vert_AV_Q(ntry, ex4, ex6, wf4(:,14), n3(:,19), t3x4(:,:,11))
  call prop_A_Q(ntry, wf4(:,14), Q(:,40), ZERO, 0_intkind1, wf4(:,15), n2(8))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_pphbb_ccxddxhg_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_pphbb_ccxddxhg_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_pphbb_ccxddxhg_1(k))
  end do
...
subroutine diagrams()
  ...
  ! e.g. call cont_VV(nsync, wf3, wf6, A(:,1), n64, t64, nhel, den(5)) ...
    ...
    call cont_VV(nsync, wf4(:,2), wf8(:,1), A(:,1), n3(:,21), t3x32(:,:,1), nhel, den(5))
    call cont_VV(nsync, wf4(:,4), wf8(:,2), A(:,2), n3(:,22), t3x32(:,:,2), nhel, den(8))
    call cont_QA(nsync, wf4(:,5), wf8(:,4), A(:,3), n3(:,23), t3x32(:,:,3), nhel, den(11))
    call cont_VV(nsync, wf4(:,2), wf8(:,5), A(:,4), n3(:,24), t3x32(:,:,4), nhel, den(15))
    call cont_VV(nsync, wf8(:,2), wf4(:,8), A(:,5), n3(:,25), t3x32(:,:,5), nhel, den(17))
    call cont_QA(nsync, wf4(:,9), wf8(:,7), A(:,6), n3(:,26), t3x32(:,:,6), nhel, den(20))
    call cont_QA(nsync, wf8(:,4), wf4(:,10), A(:,7), n3(:,27), t3x32(:,:,7), nhel, den(21))
    call cont_QA(nsync, wf8(:,7), wf4(:,11), A(:,8), n3(:,28), t3x32(:,:,8), nhel, den(22))
    call cont_VV(nsync, wf4(:,4), wf8(:,8), A(:,9), n3(:,29), t3x32(:,:,9), nhel, den(24))
    call cont_VV(nsync, wf4(:,4), wf8(:,9), A(:,10), n3(:,30), t3x32(:,:,10), nhel, den(26))
    call cont_VV(nsync, wf4(:,8), wf8(:,8), A(:,11), n3(:,31), t3x32(:,:,11), nhel, den(27))
    call cont_VV(nsync, wf4(:,8), wf8(:,9), A(:,12), n3(:,32), t3x32(:,:,12), nhel, den(28))
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_pphbb_ccxddxhg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pphbb_ccxddxhg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pphbb_ccxddxhg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pphbb_ccxddxhg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pphbb_ccxddxhg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pphbb_ccxddxhg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pphbb_ccxddxhg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pphbb_ccxddxhg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pphbb_ccxddxhg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pphbb_ccxddxhg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pphbb_ccxddxhg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pphbb_ccxddxhg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pphbb_ccxddxhg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pphbb_ccxddxhg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pphbb_ccxddxhg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pphbb_ccxddxhg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pphbb_ccxddxhg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_pphbb_ccxddxhg_1_/**/REALKIND
