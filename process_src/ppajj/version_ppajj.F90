...
module ol_versiondata_ppajj
  implicit none
  character(4) :: generator_revision = "3336"
  interface
    subroutine version_ppajj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppajj
  end interface
end module ol_versiondata_ppajj


subroutine ol_version_ppajj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppajj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppajj
