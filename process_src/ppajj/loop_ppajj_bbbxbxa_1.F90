...
module ol_colourmatrix_ppajj_bbbxbxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppajj_bbbxbxa_1_/**/REALKIND



module ol_forced_parameters_ppajj_bbbxbxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajj_bbbxbxa_1_/**/REALKIND

module ol_loop_ppajj_bbbxbxa_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 4) = (CI*countertermnorm*ctVbb*eQED*gQCD**4)/3._/**/REALKIND
    f( 5) = (CI*eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f( 6) = (eQED*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f( 7) = (eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctbb,wf(:,3),Q(:,18),wf(:,51))
  call prop_A_Q(wf(:,4),Q(:,13),MB,1_intkind1,wf(:,52))
  call vert_QA_V(wf(:,-1),wf(:,6),wf(:,53))
  call counter_A_Q(ctbb,wf(:,6),Q(:,24),wf(:,54))
  call prop_Q_A(wf(:,7),Q(:,7),MB,1_intkind1,wf(:,55))
  call vert_AV_Q(wf(:,-3),wf(:,9),wf(:,56))
  call counter_Q_A(ctbb,wf(:,10),Q(:,17),wf(:,57))
  call prop_A_Q(wf(:,56),Q(:,14),MB,1_intkind1,wf(:,58))
  call counter_V_V(ctGG,wf(:,9),Q(:,6),wf(:,59))
  call vert_QA_V(wf(:,0),wf(:,6),wf(:,60))
  call prop_Q_A(wf(:,12),Q(:,7),MB,1_intkind1,wf(:,61))
  call vert_QA_V(wf(:,3),wf(:,-2),wf(:,62))
  call counter_V_V(ctGG,wf(:,13),Q(:,9),wf(:,63))
  call prop_A_Q(wf(:,14),Q(:,13),MB,1_intkind1,wf(:,64))
  call vert_QA_V(wf(:,-1),wf(:,16),wf(:,65))
  call counter_A_Q(ctbb,wf(:,16),Q(:,20),wf(:,66))
  call prop_Q_A(wf(:,17),Q(:,11),MB,1_intkind1,wf(:,67))
  ...
  call prop_Q_A(wf(:,20),Q(:,11),MB,1_intkind1,wf(:,72))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(37)-A(38)-A(39)-A(40)-A(41)-A(42)-A(43)-A(44))*f(2))/6._/**/REALKIND+((-A(33)-A(34)-A(35)-A(36)-A(45)-A(46)-A(47) &
       ...
       +A(21)+A(22)+A(27)+A(31)+A(32))*f(3))/2._/**/REALKIND+((A(12)+A(14)+A(20)+A(26))*f(4))/6._/**/REALKIND+((A(10)+A(16)+A(18) &
       +A(28))*f(4))/2._/**/REALKIND
  M2(2) = ((A(37)+A(38)+A(39)+A(40)+A(41)+A(42)+A(43)+A(44))*f(2))/2._/**/REALKIND+((A(33)+A(34)+A(35)+A(36)+A(45)+A(46)+A(47) &
       ...
       -A(21)-A(22)-A(27)-A(31)-A(32))*f(3))/6._/**/REALKIND+((-A(12)-A(14)-A(20)-A(26))*f(4))/2._/**/REALKIND+((-A(10)-A(16) &
       -A(18)-A(28))*f(4))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppajj_bbbxbxa_1_/**/REALKIND
