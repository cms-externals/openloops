...
module ol_colourmatrix_ppajj_uuxbbxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppajj_uuxbbxa_1_/**/REALKIND



module ol_forced_parameters_ppajj_uuxbbxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajj_uuxbbxa_1_/**/REALKIND

module ol_loop_ppajj_uuxbbxa_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 7) = (CI*countertermnorm*ctGqq*eQED*gQCD**4)/3._/**/REALKIND
    f( 8) = (2*CI*countertermnorm*ctGqq*eQED*gQCD**4)/3._/**/REALKIND
    f( 9) = (CI*countertermnorm*ctVbb*eQED*gQCD**4)/3._/**/REALKIND
    f(10) = (2*CI*countertermnorm*ctVqq*eQED*gQCD**4)/3._/**/REALKIND
...
end module ol_loop_ppajj_uuxbbxa_1_/**/REALKIND
