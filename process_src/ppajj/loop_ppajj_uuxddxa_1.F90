...
module ol_colourmatrix_ppajj_uuxddxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppajj_uuxddxa_1_/**/REALKIND



module ol_forced_parameters_ppajj_uuxddxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajj_uuxddxa_1_/**/REALKIND

module ol_loop_ppajj_uuxddxa_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(16), c(30)
  ! tree wavefunctions
  ...
  complex(REALKIND), save :: M0(2,32), Mct(2,32), Mcol_loop(2,32)
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 7) = (CI*countertermnorm*ctVqq*eQED*gQCD**4)/3._/**/REALKIND
    f( 8) = (2*CI*countertermnorm*ctVqq*eQED*gQCD**4)/3._/**/REALKIND
    f( 9) = (CI*eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(10) = (2*CI*eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(11) = (eQED*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(12) = (eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(13) = (2*eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(14) = (eQED*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(15) = (2*eQED*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(16) = (4*eQED*gQCD**4*integralnorm*SwF)/3._/**/REALKIND

  c = [ 9*CI*f(9), 27*CI*f(9), 9*CI*f(10), 27*CI*f(10), 18*f(11), 54*f(11), f(12), 3*f(12), 6*f(12), 8*f(12), 10*f(12), 18*f(12) &
    , 21*f(12), 24*f(12), 54*f(12), f(13), 3*f(13), 6*f(13), 8*f(13), 10*f(13), 18*f(13), 21*f(13), 24*f(13), 54*f(13), 3*f(14) &
    , 9*f(14), 3*f(15), 9*f(15), 3*f(16), 9*f(16) ]
  c = (1._/**/REALKIND / 36) * c
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(17)+A(18)+A(19)+A(20))*f(3))/2._/**/REALKIND+((-A(21)-A(22)-A(23)-A(24))*f(4))/2._/**/REALKIND+((-A(5)-A(7)-A(15) &
       -A(16))*f(5))/2._/**/REALKIND+((A(9)+A(10)+A(11)+A(13))*f(6))/2._/**/REALKIND+((-A(6)-A(8))*f(7))/2._/**/REALKIND+((A(12) &
       +A(14))*f(8))/2._/**/REALKIND
  M2(2) = ((-A(17)-A(18)-A(19)-A(20))*f(3))/6._/**/REALKIND+((A(21)+A(22)+A(23)+A(24))*f(4))/6._/**/REALKIND+((A(5)+A(7)+A(15) &
       +A(16))*f(5))/6._/**/REALKIND+((-A(9)-A(10)-A(11)-A(13))*f(6))/6._/**/REALKIND+((A(6)+A(8))*f(7))/6._/**/REALKIND+((-A(12) &
       -A(14))*f(8))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppajj_uuxddxa_1_/**/REALKIND
