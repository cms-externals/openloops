...
module ol_colourmatrix_ppajj_ddxssxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppajj_ddxssxa_1_/**/REALKIND



module ol_forced_parameters_ppajj_ddxssxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajj_ddxssxa_1_/**/REALKIND

module ol_loop_ppajj_ddxssxa_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*ctGqq*eQED*gQCD**4)/3._/**/REALKIND
    f( 4) = (CI*countertermnorm*ctVqq*eQED*gQCD**4)/3._/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(17)+A(18)+A(19)+A(20)+A(21)+A(22)+A(23)+A(24))*f(2))/2._/**/REALKIND+((-A(5)-A(7)-A(9)-A(10)-A(11)-A(13)-A(15) &
       -A(16))*f(3))/2._/**/REALKIND+((-A(6)-A(8)-A(12)-A(14))*f(4))/2._/**/REALKIND
  M2(2) = ((-A(17)-A(18)-A(19)-A(20)-A(21)-A(22)-A(23)-A(24))*f(2))/6._/**/REALKIND+((A(5)+A(7)+A(9)+A(10)+A(11)+A(13)+A(15) &
       +A(16))*f(3))/6._/**/REALKIND+((A(6)+A(8)+A(12)+A(14))*f(4))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppajj_ddxssxa_1_/**/REALKIND
