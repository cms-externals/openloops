...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppajj_ddxaggg_1_/**/DREALKIND, only: &
...
! **********************************************************************
  ...
  use ol_external_ppajj_ddxaggg_1, only: &
    & external_perm_ppajj_ddxaggg_1, &
    & external_perm_inv_ppajj_ddxaggg_1, &
    & extcomb_perm_ppajj_ddxaggg_1, &
    & average_factor_ppajj_ddxaggg_1
  use ol_external_ppajj_ddxaggg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppajj_ddxaggg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppajj_ddxaggg_1_/**/REALKIND, only: &
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_ppajj_ddxaggg_1,6)
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppajj_ddxaggg_1
  end if
