...
module ol_colourmatrix_ppz2_zgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppz2_zgg_1_/**/REALKIND



module ol_forced_parameters_ppz2_zgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppz2_zgg_1_/**/REALKIND

module ol_loop_ppz2_zgg_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(3), c(0)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = countertermnorm*ctZGG*eQED*gQCD**2
    f(2) = eQED*gQCD**2*integralnorm*SwF
    f(3) = 2*eQED*gQCD**2*integralnorm*SwF
...
! **********************************************************************
  ...
  ! internal WFs
  call counter_VG_G(wf(:,0),wf(:,-1),Q(:,2),wf(:,1),Q(:,3))
...
end module ol_loop_ppz2_zgg_1_/**/REALKIND
