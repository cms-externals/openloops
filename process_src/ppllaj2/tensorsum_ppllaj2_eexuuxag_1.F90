...
! **********************************************************************
module ol_tensor_sum_storage_ppllaj2_eexuuxag_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllaj2_eexuuxag_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllaj2_eexuuxag_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppllaj2_eexuuxag_1, only: channel_number_ppllaj2_eexuuxag_1
  ...
  call channel_on(channel_number_ppllaj2_eexuuxag_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,19)
  momenta_1(:,2) = Q(1:4,51)
  ...
  call channel_off(channel_number_ppllaj2_eexuuxag_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllaj2_eexuuxag_1_/**/REALKIND
