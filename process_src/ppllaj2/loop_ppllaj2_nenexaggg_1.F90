...
module ol_colourmatrix_ppllaj2_nenexaggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllaj2_nenexaggg_1_/**/REALKIND



module ol_forced_parameters_ppllaj2_nenexaggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllaj2_nenexaggg_1_/**/REALKIND

module ol_loop_ppllaj2_nenexaggg_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-6+1:8)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = countertermnorm*ctAZGG*eQED**3*gQCD**3
    f(2) = (CI*eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(3) = (2*CI*eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(4) = (4*CI*eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(5) = (eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(6) = (2*eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(7) = (4*eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_VVG_G(wf(:,3),wf(:,-2),wf(:,-5),wf(:,4))
  call vert_UV_W(wf(:,-3),Q(:,8),wf(:,-5),Q(:,32),wf(:,5))
  call counter_VVG_G(wf(:,3),wf(:,-2),wf(:,-4),wf(:,6))
  call vert_UV_W(wf(:,-4),Q(:,16),wf(:,-5),Q(:,32),wf(:,7))
  call counter_VVG_G(wf(:,3),wf(:,-2),wf(:,-3),wf(:,8))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = 2*CI*(-A(1)+A(2)-A(3))*f(1)
  M2(2) = 2*CI*(A(1)-A(2)+A(3))*f(1)

end subroutine colourvectors

end module ol_loop_ppllaj2_nenexaggg_1_/**/REALKIND
