...
module ol_colourmatrix_ppllaj2_nenexuuxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppllaj2_nenexuuxag_1_/**/REALKIND



module ol_forced_parameters_ppllaj2_nenexuuxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllaj2_nenexuuxag_1_/**/REALKIND

module ol_loop_ppllaj2_nenexuuxag_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = CI*countertermnorm*ctAZGG*eQED**3*gQCD**3
    f(2) = (2*countertermnorm*ctZGG*eQED**3*gQCD**3)/3._/**/REALKIND
    f(3) = (eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(4) = (2*eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
    f(5) = (4*eQED**3*gQCD**3*integralnorm*SwF)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_VVG_G(wf(:,3),wf(:,-4),wf(:,-5),wf(:,4))
  call vert_VQ_A(wf(:,-4),wf(:,-2),wf(:,5))
  call prop_Q_A(wf(:,5),Q(:,20),ZERO,0_intkind1,wf(:,6))
  call vert_QA_V(wf(:,6),wf(:,-3),wf(:,7))
  call counter_VG_G(wf(:,3),wf(:,-5),Q(:,32),wf(:,8),Q(:,35))
  call vert_AV_Q(wf(:,-3),wf(:,-4),wf(:,9))
  call prop_A_Q(wf(:,9),Q(:,24),ZERO,0_intkind1,wf(:,10))
  call vert_QA_V(wf(:,-2),wf(:,10),wf(:,11))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = -(A(1)*f(1))+(-A(2)-A(3))*f(2)

end subroutine colourvectors

end module ol_loop_ppllaj2_nenexuuxag_1_/**/REALKIND
