...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(24) = (CI*eQED*gQCD**5*integralnorm*SwF*YC)/(2._/**/REALKIND*MW*sw)
    f(25) = (eQED*gQCD**5*integralnorm*SwF*YC)/(MW*sw*2._/**/REALKIND)
  ...
  c = [ 27*CI*f(14), 54*CI*f(14), 3*CI*f(15), 9*CI*f(15), 24*CI*f(15), 27*CI*f(15), 54*CI*f(15), 18*f(16), 54*f(16), f(17) &
    ...
    , 3*f(20), 9*f(20), 3*f(21), 9*f(21), 9*CI*f(24), 3*f(25), 9*f(25), 9*CI*f(28), 3*f(29), 9*f(29) ]
  c = (1._/**/REALKIND / 36) * c
...
subroutine diagrams(A)
  ...
  A(15) = cont_VV(wf(:,11),wf(:,30)) * den(34)
  A(16) = cont_VV(wf(:,31),wf(:,32)) * den(37)
  A(17) = cont_VV(wf(:,31),wf(:,32)) * den(37)
  A(18) = cont_VV(wf(:,31),wf(:,32)) * den(37)
  A(19) = cont_VV(wf(:,33),wf(:,34)) * den(40)
  A(20) = cont_VV(wf(:,33),wf(:,34)) * den(40)
  A(21) = cont_VV(wf(:,33),wf(:,34)) * den(40)
  A(22) = cont_QA(wf(:,5),wf(:,35)) * den(5)
  A(23) = cont_QA(wf(:,9),wf(:,36)) * den(8)
  A(24) = cont_VV(wf(:,10),wf(:,37)) * den(11)
  A(25) = cont_QA(wf(:,15),wf(:,38)) * den(15)
  A(26) = cont_QA(wf(:,19),wf(:,39)) * den(18)
  A(27) = cont_VV(wf(:,20),wf(:,37)) * den(20)
  A(28) = cont_QA(wf(:,9),wf(:,40)) * den(21)
  A(29) = cont_VV(wf(:,32),wf(:,41)) * den(42)
  A(30) = cont_VV(wf(:,32),wf(:,41)) * den(42)
  A(31) = cont_VV(wf(:,32),wf(:,41)) * den(42)
  A(32) = cont_QA(wf(:,19),wf(:,42)) * den(22)
  A(33) = cont_VV(wf(:,32),wf(:,43)) * den(44)
  A(34) = cont_VV(wf(:,32),wf(:,43)) * den(44)
  A(35) = cont_VV(wf(:,32),wf(:,43)) * den(44)
  A(36) = cont_QA(wf(:,19),wf(:,44)) * den(45)
  A(37) = cont_QA(wf(:,19),wf(:,44)) * den(45)
  A(38) = cont_QA(wf(:,19),wf(:,44)) * den(45)
  A(39) = cont_QA(wf(:,7),wf(:,46)) * den(48)
  A(40) = cont_QA(wf(:,7),wf(:,46)) * den(48)
  A(41) = cont_QA(wf(:,7),wf(:,46)) * den(48)
  A(42) = cont_VV(wf(:,11),wf(:,47)) * den(49)
  A(43) = cont_QA(wf(:,48),wf(:,49)) * den(51)
  A(44) = cont_QA(wf(:,6),wf(:,51)) * den(5)
  A(45) = cont_QA(wf(:,48),wf(:,52)) * den(53)
  A(46) = cont_QA(wf(:,19),wf(:,53)) * den(22)
  A(47) = cont_QA(wf(:,16),wf(:,55)) * den(15)
  A(48) = cont_QA(wf(:,19),wf(:,56)) * den(18)
  A(49) = cont_VV(wf(:,11),wf(:,57)) * den(20)
  A(50) = cont_VV(wf(:,11),wf(:,58)) * den(54)
  A(51) = cont_QA(wf(:,59),wf(:,60)) * den(57)
  A(52) = cont_QA(wf(:,15),wf(:,63)) * den(15)
  A(53) = cont_QA(wf(:,59),wf(:,64)) * den(59)
  A(54) = cont_QA(wf(:,9),wf(:,65)) * den(21)
  A(55) = cont_QA(wf(:,5),wf(:,68)) * den(5)
  A(56) = cont_QA(wf(:,9),wf(:,69)) * den(8)
  A(57) = cont_VV(wf(:,11),wf(:,70)) * den(11)
  A(58) = cont_VV(wf(:,25),wf(:,30)) * den(60)
  A(59) = cont_VV(wf(:,25),wf(:,30)) * den(60)
  A(60) = cont_VV(wf(:,25),wf(:,30)) * den(60)
  A(61) = cont_VV(wf(:,28),wf(:,30)) * den(61)
  A(62) = cont_VV(wf(:,28),wf(:,30)) * den(61)
  A(63) = cont_VV(wf(:,28),wf(:,30)) * den(61)
  A(64) = cont_QA(wf(:,72),wf(:,73)) * den(64)
  A(65) = cont_QA(wf(:,72),wf(:,73)) * den(64)
  A(66) = cont_QA(wf(:,72),wf(:,73)) * den(64)
  A(67) = cont_QA(wf(:,75),wf(:,76)) * den(67)
  A(68) = cont_QA(wf(:,75),wf(:,76)) * den(67)
  A(69) = cont_QA(wf(:,75),wf(:,76)) * den(67)
  A(70) = cont_VV(wf(:,25),wf(:,47)) * den(26)
  A(71) = cont_VV(wf(:,28),wf(:,47)) * den(29)
  A(72) = cont_VV(wf(:,25),wf(:,57)) * den(30)
  A(73) = cont_VV(wf(:,28),wf(:,57)) * den(31)
  A(74) = cont_VV(wf(:,25),wf(:,58)) * den(30)
  A(75) = cont_VV(wf(:,28),wf(:,58)) * den(31)
  A(76) = cont_VV(wf(:,25),wf(:,70)) * den(26)
  A(77) = cont_VV(wf(:,28),wf(:,70)) * den(29)
  A(78) = cont_VV(wf(:,10),wf(:,77)) * den(68)
  A(79) = cont_VV(wf(:,10),wf(:,80)) * den(29)
  A(80) = cont_VV(wf(:,20),wf(:,77)) * den(69)
  A(81) = cont_VV(wf(:,20),wf(:,80)) * den(31)
  A(82) = cont_VV(wf(:,10),wf(:,81)) * den(70)
  A(83) = cont_VV(wf(:,10),wf(:,84)) * den(26)
  A(84) = cont_VV(wf(:,20),wf(:,81)) * den(71)
  A(85) = cont_VV(wf(:,20),wf(:,84)) * den(30)
  A(86) = cont_QA(wf(:,5),wf(:,86)) * den(5)
  A(87) = cont_QA(wf(:,8),wf(:,88)) * den(8)
  A(88) = cont_VV(wf(:,10),wf(:,89)) * den(11)
  A(89) = cont_QA(wf(:,15),wf(:,90)) * den(15)
  A(90) = cont_QA(wf(:,18),wf(:,92)) * den(18)
  A(91) = cont_VV(wf(:,20),wf(:,89)) * den(20)
  A(92) = cont_QA(wf(:,21),wf(:,88)) * den(21)
  A(93) = cont_QA(wf(:,22),wf(:,92)) * den(22)
  A(94) = cont_VV(wf(:,93),wf(:,94)) * den(75)
  A(95) = cont_QA(wf(:,96),wf(:,97)) * den(79)
  A(96) = cont_QA(wf(:,98),wf(:,99)) * den(82)
  A(97) = cont_QA(wf(:,49),wf(:,100)) * den(84)
  A(98) = cont_VV(wf(:,10),wf(:,101)) * den(85)
  A(99) = cont_VV(wf(:,11),wf(:,103)) * den(87)
  A(100) = cont_QA(wf(:,9),wf(:,104)) * den(88)
  A(101) = cont_QA(wf(:,49),wf(:,105)) * den(89)
  A(102) = cont_VV(wf(:,11),wf(:,106)) * den(90)
  A(103) = cont_VV(wf(:,94),wf(:,107)) * den(93)
  A(104) = cont_QA(wf(:,109),wf(:,110)) * den(97)
  A(105) = cont_QA(wf(:,111),wf(:,112)) * den(100)
  A(106) = cont_QA(wf(:,60),wf(:,113)) * den(101)
  A(107) = cont_VV(wf(:,20),wf(:,101)) * den(102)
  A(108) = cont_VV(wf(:,11),wf(:,115)) * den(104)
  A(109) = cont_QA(wf(:,60),wf(:,116)) * den(105)
  A(110) = cont_VV(wf(:,11),wf(:,117)) * den(106)
  A(111) = cont_QA(wf(:,19),wf(:,118)) * den(107)
  A(112) = cont_QA(wf(:,52),wf(:,100)) * den(108)
  A(113) = cont_QA(wf(:,9),wf(:,120)) * den(110)
  A(114) = cont_QA(wf(:,52),wf(:,105)) * den(111)
  A(115) = cont_QA(wf(:,64),wf(:,113)) * den(112)
  A(116) = cont_QA(wf(:,64),wf(:,116)) * den(113)
  A(117) = cont_QA(wf(:,19),wf(:,122)) * den(115)
  A(118) = cont_VV(wf(:,10),wf(:,125)) * den(117)
  A(119) = cont_VV(wf(:,10),wf(:,126)) * den(118)
  A(120) = cont_VV(wf(:,25),wf(:,103)) * den(119)
  A(121) = cont_VV(wf(:,10),wf(:,129)) * den(121)
  A(122) = cont_VV(wf(:,10),wf(:,130)) * den(122)
  A(123) = cont_VV(wf(:,28),wf(:,103)) * den(123)
  A(124) = cont_VV(wf(:,20),wf(:,125)) * den(124)
  A(125) = cont_VV(wf(:,20),wf(:,126)) * den(125)
  A(126) = cont_VV(wf(:,25),wf(:,115)) * den(126)
  A(127) = cont_VV(wf(:,20),wf(:,129)) * den(127)
  A(128) = cont_VV(wf(:,20),wf(:,130)) * den(128)
  A(129) = cont_VV(wf(:,28),wf(:,115)) * den(129)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(59)-A(62)-A(65)-A(68))*f(1))/6._/**/REALKIND+((A(118)+A(119)+A(120)+A(121)+A(122)+A(123)+A(124)+A(125)+A(126) &
       +A(127)+A(128)+A(129))*f(5))/6._/**/REALKIND+((-A(70)-A(71)-A(74)-A(75))*f(7))/6._/**/REALKIND+((-A(78)-A(79)-A(80)-A(81) &
       -A(82)-A(83)-A(84)-A(85))*f(9))/6._/**/REALKIND+((-A(72)-A(73)-A(76)-A(77))*f(11))/6._/**/REALKIND+((-A(60)-A(63)-A(66) &
       -A(69))*f(22))/6._/**/REALKIND+((-A(58)-A(61)-A(64)-A(67))*f(26))/6._/**/REALKIND
  M2(2) = ((A(30)+A(40)+A(62)+A(65))*f(1))/2._/**/REALKIND+(CI*(A(14)-A(17)-A(20))*f(2))/2._/**/REALKIND+((-A(97)-A(100)-A(101) &
       -A(103)-A(104)-A(105)-A(112)-A(113)-A(114)-A(121)-A(122)-A(123)-A(127)-A(128)-A(129))*f(5))/2._/**/REALKIND+(CI*(-A(98) &
       -A(99)-A(102)-A(107)-A(108)-A(110))*f(6))/2._/**/REALKIND+((A(23)+A(25)+A(43)+A(45)+A(52)+A(54)+A(71) &
       +A(75))*f(7))/2._/**/REALKIND+(CI*(A(42)+A(50))*f(8))/2._/**/REALKIND+((A(79)+A(81)+A(82)+A(84)+A(87)+A(89) &
       +A(92))*f(9))/2._/**/REALKIND+(CI*(A(88)+A(91))*f(10))/2._/**/REALKIND+((A(28)+A(47)+A(56)+A(73) &
       +A(77))*f(11))/2._/**/REALKIND+(CI*(A(49)+A(57))*f(12))/2._/**/REALKIND+(CI*(A(24)+A(27))*f(13))/2._/**/REALKIND+((A(31) &
       +A(41)+A(63)+A(66))*f(22))/2._/**/REALKIND+(CI*(A(15)-A(18)-A(21))*f(23))/2._/**/REALKIND+((A(29)+A(39)+A(61) &
       +A(64))*f(26))/2._/**/REALKIND+(CI*(A(13)-A(16)-A(19))*f(27))/2._/**/REALKIND
  M2(3) = ((A(34)+A(37)+A(59)+A(68))*f(1))/2._/**/REALKIND+(CI*(-A(14)+A(17)+A(20))*f(2))/2._/**/REALKIND+((-A(94)-A(95)-A(96) &
       -A(106)-A(109)-A(111)-A(115)-A(116)-A(117)-A(118)-A(119)-A(120)-A(124)-A(125)-A(126))*f(5))/2._/**/REALKIND+(CI*(A(98) &
       +A(99)+A(102)+A(107)+A(108)+A(110))*f(6))/2._/**/REALKIND+((A(22)+A(26)+A(44)+A(46)+A(51)+A(53)+A(70) &
       +A(74))*f(7))/2._/**/REALKIND+(CI*(-A(42)-A(50))*f(8))/2._/**/REALKIND+((A(78)+A(80)+A(83)+A(85)+A(86)+A(90) &
       +A(93))*f(9))/2._/**/REALKIND+(CI*(-A(88)-A(91))*f(10))/2._/**/REALKIND+((A(32)+A(48)+A(55)+A(72) &
       +A(76))*f(11))/2._/**/REALKIND+(CI*(-A(49)-A(57))*f(12))/2._/**/REALKIND+(CI*(-A(24)-A(27))*f(13))/2._/**/REALKIND+((A(35) &
       +A(38)+A(60)+A(69))*f(22))/2._/**/REALKIND+(CI*(-A(15)+A(18)+A(21))*f(23))/2._/**/REALKIND+((A(33)+A(36)+A(58) &
       +A(67))*f(26))/2._/**/REALKIND+(CI*(-A(13)+A(16)+A(19))*f(27))/2._/**/REALKIND
  M2(4) = ((-A(30)-A(34)-A(37)-A(40))*f(1))/6._/**/REALKIND+((A(94)+A(95)+A(96)+A(97)+A(100)+A(101)+A(103)+A(104)+A(105)+A(106) &
       +A(109)+A(111)+A(112)+A(113)+A(114)+A(115)+A(116)+A(117))*f(5))/6._/**/REALKIND+((-A(22)-A(23)-A(25)-A(26)-A(43)-A(44) &
       -A(45)-A(46)-A(51)-A(52)-A(53)-A(54))*f(7))/6._/**/REALKIND+((-A(86)-A(87)-A(89)-A(90)-A(92)-A(93))*f(9))/6._/**/REALKIND &
       +((-A(28)-A(32)-A(47)-A(48)-A(55)-A(56))*f(11))/6._/**/REALKIND+((-A(31)-A(35)-A(38)-A(41))*f(22))/6._/**/REALKIND+((-A(29) &
       -A(33)-A(36)-A(39))*f(26))/6._/**/REALKIND
