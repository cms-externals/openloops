...
module ol_versiondata_pphbbj
  implicit none
  character(4) :: generator_revision = "4024"
  interface
    subroutine version_pphbbj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphbbj
  end interface
end module ol_versiondata_pphbbj


subroutine ol_version_pphbbj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphbbj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphbbj
