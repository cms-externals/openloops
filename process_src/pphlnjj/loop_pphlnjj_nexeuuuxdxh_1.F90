...
module ol_colourmatrix_pphlnjj_nexeuuuxdxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphlnjj_nexeuuuxdxh_1_/**/REALKIND



module ol_forced_parameters_pphlnjj_nexeuuuxdxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlnjj_nexeuuuxdxh_1_/**/REALKIND

module ol_loop_pphlnjj_nexeuuuxdxh_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_QA_W(wf(:,-3),wf(:,10),wf(:,11))
  call vert_QA_V(wf(:,-3),wf(:,-4),wf(:,12))
  call vert_VQ_A(wf(:,12),wf(:,-2),wf(:,13))
  call prop_Q_A(wf(:,13),Q(:,28),ZERO,0_intkind1,wf(:,14))
  call vert_QA_W(wf(:,14),wf(:,-5),wf(:,15))
  call vert_AV_Q(wf(:,-5),wf(:,12),wf(:,16))
  call prop_A_Q(wf(:,16),Q(:,56),ZERO,0_intkind1,wf(:,17))
  call vert_QA_W(wf(:,-2),wf(:,17),wf(:,18))
  call vert_WQ_A(wf(:,3),wf(:,-3),wf(:,19))
  call counter_SG_G(wf(:,-6),wf(:,2),wf(:,20))
  call prop_Q_A(wf(:,19),Q(:,11),ZERO,0_intkind1,wf(:,21))
  call vert_QA_V(wf(:,21),wf(:,-5),wf(:,22))
  call vert_AW_Q(wf(:,-5),wf(:,3),wf(:,23))
  call prop_A_Q(wf(:,23),Q(:,35),ZERO,0_intkind1,wf(:,24))
  call vert_QA_V(wf(:,-3),wf(:,24),wf(:,25))
  call counter_QA_W(wf(:,6),wf(:,-5),wf(:,26))
  call counter_AV_Q(wf(:,-5),wf(:,2),wf(:,27))
  call prop_A_Q(wf(:,27),Q(:,52),ZERO,0_intkind1,wf(:,28))
  call vert_QA_W(wf(:,-3),wf(:,28),wf(:,29))
  call vert_WQ_A(wf(:,3),wf(:,-2),wf(:,30))
  call counter_SG_G(wf(:,-6),wf(:,12),wf(:,31))
  call prop_Q_A(wf(:,30),Q(:,7),ZERO,0_intkind1,wf(:,32))
  call vert_QA_V(wf(:,32),wf(:,-5),wf(:,33))
  call vert_QA_V(wf(:,-2),wf(:,24),wf(:,34))
  call counter_QA_W(wf(:,14),wf(:,-5),wf(:,35))
  call counter_AV_Q(wf(:,-5),wf(:,12),wf(:,36))
  call prop_A_Q(wf(:,36),Q(:,56),ZERO,0_intkind1,wf(:,37))
  call vert_QA_W(wf(:,-2),wf(:,37),wf(:,38))
  call counter_QA_W(wf(:,-3),wf(:,10),wf(:,39))
  call counter_VQ_A(wf(:,2),wf(:,-3),wf(:,40))
  call prop_Q_A(wf(:,40),Q(:,28),ZERO,0_intkind1,wf(:,41))
  call vert_QA_W(wf(:,41),wf(:,-5),wf(:,42))
  call counter_QA_V(wf(:,-3),wf(:,-4),wf(:,43))
  call vert_AV_Q(wf(:,-5),wf(:,43),wf(:,44))
  call prop_A_Q(wf(:,44),Q(:,56),ZERO,0_intkind1,wf(:,45))
  call vert_QA_W(wf(:,-2),wf(:,45),wf(:,46))
  call vert_VQ_A(wf(:,43),wf(:,-2),wf(:,47))
  call prop_Q_A(wf(:,47),Q(:,28),ZERO,0_intkind1,wf(:,48))
  call vert_QA_W(wf(:,48),wf(:,-5),wf(:,49))
  call counter_VQ_A(wf(:,12),wf(:,-2),wf(:,50))
  call prop_Q_A(wf(:,50),Q(:,28),ZERO,0_intkind1,wf(:,51))
  call vert_QA_W(wf(:,51),wf(:,-5),wf(:,52))
  call counter_QA_W(wf(:,-2),wf(:,17),wf(:,53))
  call counter_QA_V(wf(:,-2),wf(:,-4),wf(:,54))
  call vert_VQ_A(wf(:,54),wf(:,-3),wf(:,55))
  call prop_Q_A(wf(:,55),Q(:,28),ZERO,0_intkind1,wf(:,56))
  call vert_QA_W(wf(:,56),wf(:,-5),wf(:,57))
  call vert_AV_Q(wf(:,-5),wf(:,54),wf(:,58))
  call prop_A_Q(wf(:,58),Q(:,52),ZERO,0_intkind1,wf(:,59))
  call vert_QA_W(wf(:,-3),wf(:,59),wf(:,60))
  ...
  call vert_WQ_A(wf(:,7),wf(:,-3),wf(:,65))
  call vert_AV_Q(wf(:,-5),wf(:,61),wf(:,66))
  call prop_Q_A(wf(:,65),Q(:,75),ZERO,0_intkind1,wf(:,67))
  call counter_Q_A(ctqq,wf(:,6),Q(:,28),wf(:,68))
  call prop_A_Q(wf(:,63),Q(:,99),ZERO,0_intkind1,wf(:,69))
  call counter_A_Q(ctqq,wf(:,10),Q(:,52),wf(:,70))
  call counter_V_V(ctGG,wf(:,12),Q(:,24),wf(:,71))
  call vert_VQ_A(wf(:,71),wf(:,-2),wf(:,72))
  call prop_Q_A(wf(:,72),Q(:,28),ZERO,0_intkind1,wf(:,73))
  call counter_Q_A(ctqq,wf(:,14),Q(:,28),wf(:,74))
  call vert_WQ_A(wf(:,7),wf(:,-2),wf(:,75))
  call counter_A_Q(ctqq,wf(:,17),Q(:,56),wf(:,76))
  call prop_Q_A(wf(:,75),Q(:,71),ZERO,0_intkind1,wf(:,77))
  call vert_AV_Q(wf(:,-5),wf(:,71),wf(:,78))
  call vert_QA_V(wf(:,77),wf(:,-5),wf(:,79))
  call vert_QA_V(wf(:,-2),wf(:,69),wf(:,80))
  call vert_QA_V(wf(:,67),wf(:,-5),wf(:,81))
  call vert_QA_V(wf(:,-3),wf(:,69),wf(:,82))
...
subroutine diagrams(A)
  ...
  A(11) = cont_VV(wf(:,31),wf(:,33)) * den(29)
  A(12) = cont_VV(wf(:,31),wf(:,33)) * den(29)
  A(13) = cont_VV(wf(:,31),wf(:,34)) * den(30)
  A(14) = cont_VV(wf(:,31),wf(:,34)) * den(30)
  A(15) = cont_VV(wf(:,7),wf(:,35)) * den(13)
  A(16) = cont_VV(wf(:,7),wf(:,38)) * den(16)
  A(17) = cont_VV(wf(:,7),wf(:,39)) * den(10)
  A(18) = cont_VV(wf(:,7),wf(:,42)) * den(7)
  A(19) = cont_VV(wf(:,7),wf(:,46)) * den(16)
  A(20) = cont_VV(wf(:,7),wf(:,49)) * den(13)
  A(21) = cont_VV(wf(:,7),wf(:,52)) * den(13)
  ...
  A(31) = cont_QA(wf(:,76),wf(:,77)) * den(47)
  A(32) = cont_QA(wf(:,77),wf(:,78)) * den(48)
...
end module ol_loop_pphlnjj_nexeuuuxdxh_1_/**/REALKIND
