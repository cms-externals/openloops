...
! **********************************************************************
module ol_tensor_sum_storage_pphlnjj_nexeuddxdxh_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphlnjj_nexeuddxdxh_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphlnjj_nexeuddxdxh_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphlnjj_nexeuddxdxh_1, only: channel_number_pphlnjj_nexeuddxdxh_1
  ...
  call channel_on(channel_number_pphlnjj_nexeuddxdxh_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,71)
  momenta_2(:,1) = Q(1:4,83)
  momenta_3(:,1) = Q(1:4,87)
  momenta_4(:,1) = Q(1:4,99)
  momenta_5(:,1) = Q(1:4,103)
  ...
  call TI_call(2, momenta_8, masses2_6, T2sum(:,1), M2)
  call TI_call(2, momenta_17, masses2_6, T2sum(:,2), M2)
  call TI_call(2, momenta_9, masses2_6, T2sum(:,3), M2)
  ...
  call TI_call(2, momenta_15, masses2_6, T2sum(:,7), M2)
  call TI_call(2, momenta_18, masses2_6, T2sum(:,8), M2)
  call TI_call(2, momenta_13, masses2_6, T2sum(:,9), M2)
  call TI_call(2, momenta_19, masses2_6, T2sum(:,10), M2)
  call TI_call(2, momenta_14, masses2_6, T2sum(:,11), M2)
  call TI_call(2, momenta_10, masses2_6, T2sum(:,12), M2)
  call TI_call(2, momenta_20, masses2_6, T2sum(:,13), M2)
  call TI_call(2, momenta_6, masses2_6, T2sum(:,14), M2)
  call TI_call(2, momenta_22, masses2_6, T2sum(:,15), M2)
  call TI_call(2, momenta_33, masses2_7, T2sum(:,16), M2)
  call TI_call(2, momenta_28, masses2_7, T2sum(:,17), M2)
  call TI_call(2, momenta_36, masses2_7, T2sum(:,18), M2)
  ...
  call TI_call(2, momenta_23, masses2_7, T2sum(:,22), M2)
  ...
  call TI_call(3, momenta_11, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_11, masses2_4, T3sum(:,2), M2)
  call TI_call(3, momenta_32, masses2_7, T3sum(:,3), M2)
  call TI_call(3, momenta_31, masses2_7, T3sum(:,4), M2)
  call TI_call(3, momenta_29, masses2_7, T3sum(:,5), M2)
  call TI_call(3, momenta_12, masses2_5, T3sum(:,6), M2)
  call TI_call(3, momenta_12, masses2_4, T3sum(:,7), M2)
  call TI_call(3, momenta_27, masses2_7, T3sum(:,8), M2)
  call TI_call(3, momenta_26, masses2_7, T3sum(:,9), M2)
  call TI_call(3, momenta_34, masses2_7, T3sum(:,10), M2)
  call TI_call(3, momenta_37, masses2_8, T3sum(:,11), M2)
  call TI_call(3, momenta_38, masses2_8, T3sum(:,12), M2)
  call TI_call(3, momenta_39, masses2_8, T3sum(:,13), M2)
  call TI_call(3, momenta_40, masses2_8, T3sum(:,14), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pphlnjj_nexeuddxdxh_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphlnjj_nexeuddxdxh_1_/**/REALKIND
