...
! **********************************************************************
module ol_tensor_sum_storage_pphlnjj_neexuxdssxh_2_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphlnjj_neexuxdssxh_2")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphlnjj_neexuxdssxh_2")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphlnjj_neexuxdssxh_2, only: channel_number_pphlnjj_neexuxdssxh_2
  ...
  call channel_on(channel_number_pphlnjj_neexuxdssxh_2)
  M2 = 0
  ...
  momenta_4(:,2) = Q(1:4,111)
  momenta_5(:,1) = Q(1:4,48)
  momenta_5(:,2) = Q(1:4,112)
  ...
  call TI_call(2, momenta_6, masses2_6, T2sum(:,3), M2)
  ...
  call TI_call(2, momenta_15, masses2_7, T2sum(:,9), M2)
  call TI_call(2, momenta_17, masses2_7, T2sum(:,10), M2)
  call TI_call(2, momenta_16, masses2_7, T2sum(:,11), M2)
  call TI_call(2, momenta_18, masses2_7, T2sum(:,12), M2)
  ...
  call TI_call(3, momenta_5, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_5, masses2_4, T3sum(:,2), M2)
  call TI_call(3, momenta_14, masses2_7, T3sum(:,3), M2)
  call TI_call(3, momenta_13, masses2_7, T3sum(:,4), M2)
  ...
  call channel_off(channel_number_pphlnjj_neexuxdssxh_2)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphlnjj_neexuxdssxh_2_/**/REALKIND
