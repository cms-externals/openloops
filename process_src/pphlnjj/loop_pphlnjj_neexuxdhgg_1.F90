...
module ol_colourmatrix_pphlnjj_neexuxdhgg_1_/**/REALKIND
...
end module ol_colourmatrix_pphlnjj_neexuxdhgg_1_/**/REALKIND



module ol_forced_parameters_pphlnjj_neexuxdhgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlnjj_neexuxdhgg_1_/**/REALKIND

module ol_loop_pphlnjj_neexuxdhgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_AV_Q(wf(:,-2),wf(:,-5),wf(:,2))
  call vert_VQ_A(wf(:,-6),wf(:,-3),wf(:,3))
  call prop_W_W(wf(:,1),Q(:,3),MW,1_intkind1,wf(:,4))
  call prop_A_Q(wf(:,2),Q(:,36),ZERO,0_intkind1,wf(:,5))
  call prop_Q_A(wf(:,3),Q(:,72),ZERO,0_intkind1,wf(:,6))
  call vert_SV_V(wf(:,-4),wf(:,4),wf(:,7))
  call vert_QA_W(wf(:,6),wf(:,5),wf(:,8))
  call prop_W_W(wf(:,7),Q(:,19),MW,1_intkind1,wf(:,9))
  call vert_AV_Q(wf(:,5),wf(:,-6),wf(:,10))
  call prop_A_Q(wf(:,10),Q(:,100),ZERO,0_intkind1,wf(:,11))
  call vert_WQ_A(wf(:,9),wf(:,-3),wf(:,12))
  call vert_AV_Q(wf(:,-2),wf(:,-6),wf(:,13))
  call vert_VQ_A(wf(:,-5),wf(:,-3),wf(:,14))
  call prop_A_Q(wf(:,13),Q(:,68),ZERO,0_intkind1,wf(:,15))
  call prop_Q_A(wf(:,14),Q(:,40),ZERO,0_intkind1,wf(:,16))
  call vert_QA_W(wf(:,16),wf(:,15),wf(:,17))
  call vert_VQ_A(wf(:,-6),wf(:,16),wf(:,18))
  call prop_Q_A(wf(:,18),Q(:,104),ZERO,0_intkind1,wf(:,19))
  call vert_AW_Q(wf(:,-2),wf(:,9),wf(:,20))
  call vert_AV_Q(wf(:,15),wf(:,-5),wf(:,21))
  call prop_A_Q(wf(:,21),Q(:,100),ZERO,0_intkind1,wf(:,22))
  call vert_VQ_A(wf(:,-5),wf(:,6),wf(:,23))
  call prop_Q_A(wf(:,23),Q(:,104),ZERO,0_intkind1,wf(:,24))
  call vert_UV_W(wf(:,-5),Q(:,32),wf(:,-6),Q(:,64),wf(:,25))
  call vert_VQ_A(wf(:,25),wf(:,-3),wf(:,26))
  call prop_Q_A(wf(:,26),Q(:,104),ZERO,0_intkind1,wf(:,27))
  call vert_QA_W(wf(:,27),wf(:,-2),wf(:,28))
  call vert_AV_Q(wf(:,-2),wf(:,25),wf(:,29))
  call prop_A_Q(wf(:,29),Q(:,100),ZERO,0_intkind1,wf(:,30))
  call vert_QA_W(wf(:,-3),wf(:,30),wf(:,31))
  call counter_QA_W(wf(:,6),wf(:,5),wf(:,32))
  call counter_AV_Q(wf(:,5),wf(:,-6),wf(:,33))
  call prop_A_Q(wf(:,33),Q(:,100),ZERO,0_intkind1,wf(:,34))
  call counter_QA_W(wf(:,16),wf(:,15),wf(:,35))
  call counter_VQ_A(wf(:,-6),wf(:,16),wf(:,36))
  call prop_Q_A(wf(:,36),Q(:,104),ZERO,0_intkind1,wf(:,37))
  call counter_AV_Q(wf(:,15),wf(:,-5),wf(:,38))
  call prop_A_Q(wf(:,38),Q(:,100),ZERO,0_intkind1,wf(:,39))
  call counter_VQ_A(wf(:,-5),wf(:,6),wf(:,40))
  call prop_Q_A(wf(:,40),Q(:,104),ZERO,0_intkind1,wf(:,41))
  call counter_UV_W(wf(:,-5),Q(:,32),wf(:,-6),Q(:,64),wf(:,42))
  call vert_VQ_A(wf(:,42),wf(:,-3),wf(:,43))
  call prop_Q_A(wf(:,43),Q(:,104),ZERO,0_intkind1,wf(:,44))
  call vert_QA_W(wf(:,44),wf(:,-2),wf(:,45))
  call vert_AV_Q(wf(:,-2),wf(:,42),wf(:,46))
  call prop_A_Q(wf(:,46),Q(:,100),ZERO,0_intkind1,wf(:,47))
  call vert_QA_W(wf(:,-3),wf(:,47),wf(:,48))
  call counter_SG_G(wf(:,-4),wf(:,-6),wf(:,49))
  call vert_WQ_A(wf(:,4),wf(:,-3),wf(:,50))
  call vert_AV_Q(wf(:,5),wf(:,49),wf(:,51))
  call prop_Q_A(wf(:,50),Q(:,11),ZERO,0_intkind1,wf(:,52))
  call vert_VQ_A(wf(:,49),wf(:,-3),wf(:,53))
  call vert_AW_Q(wf(:,5),wf(:,4),wf(:,54))
  call prop_Q_A(wf(:,53),Q(:,88),ZERO,0_intkind1,wf(:,55))
  call vert_AW_Q(wf(:,-2),wf(:,4),wf(:,56))
  call vert_VQ_A(wf(:,49),wf(:,16),wf(:,57))
  call prop_A_Q(wf(:,56),Q(:,7),ZERO,0_intkind1,wf(:,58))
  call vert_AV_Q(wf(:,-2),wf(:,49),wf(:,59))
  call vert_WQ_A(wf(:,4),wf(:,16),wf(:,60))
  call prop_A_Q(wf(:,59),Q(:,84),ZERO,0_intkind1,wf(:,61))
  call counter_SG_G(wf(:,-4),wf(:,25),wf(:,62))
  call vert_QA_V(wf(:,-3),wf(:,58),wf(:,63))
  call vert_QA_V(wf(:,52),wf(:,-2),wf(:,64))
  call vert_UV_W(wf(:,-5),Q(:,32),wf(:,49),Q(:,80),wf(:,65))
  call vert_AV_Q(wf(:,58),wf(:,-5),wf(:,66))
  call vert_AV_Q(wf(:,61),wf(:,-5),wf(:,67))
  call counter_SG_G(wf(:,-4),wf(:,-5),wf(:,68))
  call vert_AV_Q(wf(:,15),wf(:,68),wf(:,69))
  call vert_VQ_A(wf(:,68),wf(:,-3),wf(:,70))
  call vert_AW_Q(wf(:,15),wf(:,4),wf(:,71))
  call prop_Q_A(wf(:,70),Q(:,56),ZERO,0_intkind1,wf(:,72))
  call vert_VQ_A(wf(:,68),wf(:,6),wf(:,73))
  call vert_AV_Q(wf(:,-2),wf(:,68),wf(:,74))
  call vert_WQ_A(wf(:,4),wf(:,6),wf(:,75))
  call prop_A_Q(wf(:,74),Q(:,52),ZERO,0_intkind1,wf(:,76))
  call vert_UV_W(wf(:,68),Q(:,48),wf(:,-6),Q(:,64),wf(:,77))
  call vert_AV_Q(wf(:,58),wf(:,-6),wf(:,78))
  call vert_AV_Q(wf(:,76),wf(:,-6),wf(:,79))
  call counter_WQ_A(wf(:,9),wf(:,-3),wf(:,80))
  call counter_VQ_A(wf(:,-6),wf(:,-3),wf(:,81))
  call prop_Q_A(wf(:,81),Q(:,72),ZERO,0_intkind1,wf(:,82))
  call vert_QA_W(wf(:,82),wf(:,5),wf(:,83))
  call counter_VQ_A(wf(:,25),wf(:,-3),wf(:,84))
  call prop_Q_A(wf(:,84),Q(:,104),ZERO,0_intkind1,wf(:,85))
  call vert_QA_W(wf(:,85),wf(:,-2),wf(:,86))
  call counter_QA_W(wf(:,-3),wf(:,30),wf(:,87))
  call vert_VQ_A(wf(:,-5),wf(:,82),wf(:,88))
  call prop_Q_A(wf(:,88),Q(:,104),ZERO,0_intkind1,wf(:,89))
  call counter_VQ_A(wf(:,-5),wf(:,-3),wf(:,90))
  call prop_Q_A(wf(:,90),Q(:,40),ZERO,0_intkind1,wf(:,91))
  call vert_QA_W(wf(:,91),wf(:,15),wf(:,92))
  call vert_VQ_A(wf(:,-6),wf(:,91),wf(:,93))
  call prop_Q_A(wf(:,93),Q(:,104),ZERO,0_intkind1,wf(:,94))
  call counter_AW_Q(wf(:,-2),wf(:,9),wf(:,95))
  call counter_AV_Q(wf(:,-2),wf(:,-6),wf(:,96))
  call prop_A_Q(wf(:,96),Q(:,68),ZERO,0_intkind1,wf(:,97))
  call vert_QA_W(wf(:,16),wf(:,97),wf(:,98))
  call counter_QA_W(wf(:,27),wf(:,-2),wf(:,99))
  call counter_AV_Q(wf(:,-2),wf(:,25),wf(:,100))
  call prop_A_Q(wf(:,100),Q(:,100),ZERO,0_intkind1,wf(:,101))
  call vert_QA_W(wf(:,-3),wf(:,101),wf(:,102))
  call vert_AV_Q(wf(:,97),wf(:,-5),wf(:,103))
  call prop_A_Q(wf(:,103),Q(:,100),ZERO,0_intkind1,wf(:,104))
  call counter_AV_Q(wf(:,-2),wf(:,-5),wf(:,105))
  call prop_A_Q(wf(:,105),Q(:,36),ZERO,0_intkind1,wf(:,106))
  call vert_QA_W(wf(:,6),wf(:,106),wf(:,107))
  call vert_AV_Q(wf(:,106),wf(:,-6),wf(:,108))
  call prop_A_Q(wf(:,108),Q(:,100),ZERO,0_intkind1,wf(:,109))
  call counter_A_Q(ctqq,wf(:,5),Q(:,36),wf(:,110))
  call prop_A_Q(wf(:,110),Q(:,36),ZERO,0_intkind1,wf(:,111))
  call vert_QA_W(wf(:,6),wf(:,111),wf(:,112))
  call counter_Q_A(ctqq,wf(:,6),Q(:,72),wf(:,113))
  call prop_Q_A(wf(:,113),Q(:,72),ZERO,0_intkind1,wf(:,114))
  call vert_QA_W(wf(:,114),wf(:,5),wf(:,115))
  call vert_AV_Q(wf(:,111),wf(:,-6),wf(:,116))
  call prop_Q_A(wf(:,12),Q(:,27),ZERO,0_intkind1,wf(:,117))
  call counter_A_Q(ctqq,wf(:,11),Q(:,100),wf(:,118))
  call counter_A_Q(ctqq,wf(:,15),Q(:,68),wf(:,119))
  call prop_A_Q(wf(:,119),Q(:,68),ZERO,0_intkind1,wf(:,120))
  call vert_QA_W(wf(:,16),wf(:,120),wf(:,121))
  call counter_Q_A(ctqq,wf(:,16),Q(:,40),wf(:,122))
  call prop_Q_A(wf(:,122),Q(:,40),ZERO,0_intkind1,wf(:,123))
  call vert_QA_W(wf(:,123),wf(:,15),wf(:,124))
  call counter_Q_A(ctqq,wf(:,19),Q(:,104),wf(:,125))
  call prop_A_Q(wf(:,20),Q(:,23),ZERO,0_intkind1,wf(:,126))
  call vert_VQ_A(wf(:,-6),wf(:,123),wf(:,127))
  call vert_AV_Q(wf(:,120),wf(:,-5),wf(:,128))
  call counter_A_Q(ctqq,wf(:,22),Q(:,100),wf(:,129))
  call counter_Q_A(ctqq,wf(:,24),Q(:,104),wf(:,130))
  call vert_VQ_A(wf(:,-5),wf(:,114),wf(:,131))
  call counter_Q_A(ctqq,wf(:,27),Q(:,104),wf(:,132))
  call counter_A_Q(ctqq,wf(:,30),Q(:,100),wf(:,133))
  call counter_V_V(ctGG,wf(:,25),Q(:,96),wf(:,134))
  call vert_AV_Q(wf(:,-2),wf(:,134),wf(:,135))
  call prop_A_Q(wf(:,135),Q(:,100),ZERO,0_intkind1,wf(:,136))
  call vert_VQ_A(wf(:,134),wf(:,-3),wf(:,137))
  call vert_QA_V(wf(:,52),wf(:,5),wf(:,138))
  call vert_AW_Q(wf(:,5),wf(:,9),wf(:,139))
  call prop_A_Q(wf(:,139),Q(:,55),ZERO,0_intkind1,wf(:,140))
  call prop_A_Q(wf(:,54),Q(:,39),ZERO,0_intkind1,wf(:,141))
  call vert_QA_V(wf(:,-3),wf(:,141),wf(:,142))
  call vert_QA_V(wf(:,16),wf(:,58),wf(:,143))
  call vert_WQ_A(wf(:,9),wf(:,16),wf(:,144))
  call prop_Q_A(wf(:,144),Q(:,59),ZERO,0_intkind1,wf(:,145))
  call prop_Q_A(wf(:,60),Q(:,43),ZERO,0_intkind1,wf(:,146))
  call vert_QA_V(wf(:,146),wf(:,-2),wf(:,147))
  call vert_QA_V(wf(:,52),wf(:,15),wf(:,148))
  call vert_AW_Q(wf(:,15),wf(:,9),wf(:,149))
  call prop_A_Q(wf(:,149),Q(:,87),ZERO,0_intkind1,wf(:,150))
  call prop_A_Q(wf(:,71),Q(:,71),ZERO,0_intkind1,wf(:,151))
  call vert_QA_V(wf(:,-3),wf(:,151),wf(:,152))
  call vert_QA_V(wf(:,6),wf(:,58),wf(:,153))
  call vert_WQ_A(wf(:,9),wf(:,6),wf(:,154))
  call prop_Q_A(wf(:,154),Q(:,91),ZERO,0_intkind1,wf(:,155))
  call prop_Q_A(wf(:,75),Q(:,75),ZERO,0_intkind1,wf(:,156))
  call vert_QA_V(wf(:,156),wf(:,-2),wf(:,157))
  call vert_UV_W(wf(:,63),Q(:,15),wf(:,-5),Q(:,32),wf(:,158))
  call vert_UV_W(wf(:,63),Q(:,15),wf(:,-6),Q(:,64),wf(:,159))
  call prop_A_Q(wf(:,66),Q(:,39),ZERO,0_intkind1,wf(:,160))
  call vert_QA_V(wf(:,-3),wf(:,160),wf(:,161))
  call prop_A_Q(wf(:,78),Q(:,71),ZERO,0_intkind1,wf(:,162))
  call vert_QA_V(wf(:,-3),wf(:,162),wf(:,163))
  call vert_UV_W(wf(:,64),Q(:,15),wf(:,-5),Q(:,32),wf(:,164))
  call vert_UV_W(wf(:,64),Q(:,15),wf(:,-6),Q(:,64),wf(:,165))
  call vert_VQ_A(wf(:,-5),wf(:,52),wf(:,166))
  call prop_Q_A(wf(:,166),Q(:,43),ZERO,0_intkind1,wf(:,167))
  call vert_QA_V(wf(:,167),wf(:,-2),wf(:,168))
  call vert_VQ_A(wf(:,-6),wf(:,52),wf(:,169))
  call prop_Q_A(wf(:,169),Q(:,75),ZERO,0_intkind1,wf(:,170))
  call vert_QA_V(wf(:,170),wf(:,-2),wf(:,171))
  call vert_QA_V(wf(:,-3),wf(:,126),wf(:,172))
  call vert_QA_V(wf(:,117),wf(:,-2),wf(:,173))
  call vert_AV_Q(wf(:,126),wf(:,-5),wf(:,174))
  call prop_A_Q(wf(:,174),Q(:,55),ZERO,0_intkind1,wf(:,175))
  call vert_AV_Q(wf(:,126),wf(:,-6),wf(:,176))
  call prop_A_Q(wf(:,176),Q(:,87),ZERO,0_intkind1,wf(:,177))
  call vert_VQ_A(wf(:,-5),wf(:,117),wf(:,178))
  call prop_Q_A(wf(:,178),Q(:,59),ZERO,0_intkind1,wf(:,179))
  call vert_VQ_A(wf(:,-6),wf(:,117),wf(:,180))
  call prop_Q_A(wf(:,180),Q(:,91),ZERO,0_intkind1,wf(:,181))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(69)+A(70)+A(71)+A(72)+A(79)+A(80))*f(3)+CI*(A(81)+A(82)+A(83)+A(84))*f(4)+(-A(10)-A(14)-A(54)-A(58)-A(67)-A(68))*f(5) &
       +CI*(-A(56)-A(65))*f(6)+(-A(9)-A(53)-A(63))*f(7)+CI*(-A(57)-A(64))*f(8)+CI*(-A(15)-A(16))*f(9)+(-A(18)-A(20)-A(32)-A(42) &
       -A(44)-A(52))*f(17)+CI*(-A(26)-A(28)-A(30)-A(34)-A(46)-A(50))*f(18)+(-A(17)-A(19)-A(31)-A(41)-A(43)-A(51))*f(21)+CI*(-A(25) &
       -A(27)-A(29)-A(33)-A(45)-A(49))*f(22)
  M2(2) = (A(73)+A(74)+A(75)+A(76)+A(77)+A(78))*f(3)+CI*(-A(81)-A(82)-A(83)-A(84))*f(4)+(-A(12)-A(13)-A(59)-A(60)-A(62) &
       -A(66))*f(5)+CI*(A(56)+A(65))*f(6)+(-A(11)-A(55)-A(61))*f(7)+CI*(A(57)+A(64))*f(8)+CI*(A(15)+A(16))*f(9)+(-A(22)-A(24) &
       -A(36)-A(38)-A(40)-A(48))*f(17)+CI*(A(26)+A(28)+A(30)+A(34)+A(46)+A(50))*f(18)+(-A(21)-A(23)-A(35)-A(37)-A(39)-A(47))*f(21) &
       +CI*(A(25)+A(27)+A(29)+A(33)+A(45)+A(49))*f(22)

end subroutine colourvectors

end module ol_loop_pphlnjj_neexuxdhgg_1_/**/REALKIND
