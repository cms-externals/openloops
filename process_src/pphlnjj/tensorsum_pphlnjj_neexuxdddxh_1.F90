...
! **********************************************************************
module ol_tensor_sum_storage_pphlnjj_neexuxdddxh_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphlnjj_neexuxdddxh_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphlnjj_neexuxdddxh_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphlnjj_neexuxdddxh_1, only: channel_number_pphlnjj_neexuxdddxh_1
  ...
  call channel_on(channel_number_pphlnjj_neexuxdddxh_1)
  M2 = 0
  ...
  momenta_5(:,1) = Q(1:4,87)
  momenta_6(:,1) = Q(1:4,32)
  momenta_6(:,2) = Q(1:4,111)
  momenta_7(:,1) = Q(1:4,32)
  momenta_7(:,2) = Q(1:4,119)
  momenta_8(:,1) = Q(1:4,40)
  momenta_8(:,2) = Q(1:4,104)
  momenta_9(:,1) = Q(1:4,40)
  momenta_9(:,2) = Q(1:4,111)
  momenta_10(:,1) = Q(1:4,40)
  momenta_10(:,2) = Q(1:4,123)
  momenta_11(:,1) = Q(1:4,44)
  momenta_11(:,2) = Q(1:4,111)
  momenta_12(:,1) = Q(1:4,48)
  momenta_12(:,2) = Q(1:4,112)
  momenta_13(:,1) = Q(1:4,48)
  momenta_13(:,2) = Q(1:4,119)
  ...
  momenta_19(:,1) = Q(1:4,75)
  momenta_19(:,2) = Q(1:4,123)
  momenta_20(:,1) = Q(1:4,79)
  momenta_20(:,2) = Q(1:4,111)
  momenta_21(:,1) = Q(1:4,83)
  momenta_21(:,2) = Q(1:4,123)
  momenta_22(:,1) = Q(1:4,87)
  ...
  momenta_28(:,3) = Q(1:4,123)
  momenta_29(:,1) = Q(1:4,16)
  momenta_29(:,2) = Q(1:4,83)
  momenta_29(:,3) = Q(1:4,123)
  momenta_30(:,1) = Q(1:4,16)
  momenta_30(:,2) = Q(1:4,87)
  ...
  call TI_call(2, momenta_11, masses2_6, T2sum(:,1), M2)
  ...
  call TI_call(2, momenta_10, masses2_6, T2sum(:,6), M2)
  ...
  call TI_call(3, momenta_34, masses2_7, T3sum(:,5), M2)
  call TI_call(3, momenta_12, masses2_5, T3sum(:,6), M2)
  call TI_call(3, momenta_12, masses2_4, T3sum(:,7), M2)
  call TI_call(3, momenta_25, masses2_7, T3sum(:,8), M2)
  call TI_call(3, momenta_24, masses2_7, T3sum(:,9), M2)
  call TI_call(3, momenta_35, masses2_7, T3sum(:,10), M2)
  ...
  call channel_off(channel_number_pphlnjj_neexuxdddxh_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphlnjj_neexuxdddxh_1_/**/REALKIND
