...
module ol_colourmatrix_ppw_ckm_udxw_1_/**/REALKIND
...
end module ol_colourmatrix_ppw_ckm_udxw_1_/**/REALKIND



module ol_forced_parameters_ppw_ckm_udxw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppw_ckm_udxw_1_/**/REALKIND

module ol_loop_ppw_ckm_udxw_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVqq*eQED*gQCD**2*VCKMdu)/(sqrt2*sw)
    f(3) = (eQED*gQCD**2*integralnorm*SwB*VCKMdu)/(sqrt2*sw)
...
! **********************************************************************
  ...
  call counter_QA_W(wf(:,0),wf(:,-1),wf(:,2))
...
end module ol_loop_ppw_ckm_udxw_1_/**/REALKIND
