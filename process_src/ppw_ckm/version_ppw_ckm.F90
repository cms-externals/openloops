...
module ol_versiondata_ppw_ckm
  implicit none
  character(4) :: generator_revision = "2423"
  interface
    subroutine version_ppw_ckm(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppw_ckm
  end interface
end module ol_versiondata_ppw_ckm


subroutine ol_version_ppw_ckm(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppw_ckm, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppw_ckm
