...
module ol_colourmatrix_ppw_ckm_usxw_1_/**/REALKIND
...
end module ol_colourmatrix_ppw_ckm_usxw_1_/**/REALKIND



module ol_forced_parameters_ppw_ckm_usxw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppw_ckm_usxw_1_/**/REALKIND

module ol_loop_ppw_ckm_usxw_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVqq*eQED*gQCD**2*VCKMsu)/(sqrt2*sw)
    f(3) = (eQED*gQCD**2*integralnorm*SwB*VCKMsu)/(sqrt2*sw)
...
end module ol_loop_ppw_ckm_usxw_1_/**/REALKIND
