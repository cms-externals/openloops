...
module ol_versiondata_ppatt
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppatt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppatt
  end interface
end module ol_versiondata_ppatt


subroutine ol_version_ppatt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppatt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppatt
