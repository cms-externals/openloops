...
module ol_colourmatrix_ppatt_uuxttxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppatt_uuxttxa_1_/**/REALKIND



module ol_forced_parameters_ppatt_uuxttxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppatt_uuxttxa_1_/**/REALKIND

module ol_loop_ppatt_uuxttxa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 4) = (2*CI*countertermnorm*ctGtt*eQED*gQCD**4)/3._/**/REALKIND
    f( 5) = (2*CI*countertermnorm*ctVqq*eQED*gQCD**4)/3._/**/REALKIND
    f( 6) = (2*CI*countertermnorm*ctVtt*eQED*gQCD**4)/3._/**/REALKIND
    f( 7) = (2*CI*eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f( 8) = (eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f( 9) = (2*eQED*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,16),Q(:,24),MT,1_intkind1,wf(:,17))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,18))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,19))
  call prop_Q_A(wf(:,19),Q(:,20),MT,1_intkind1,wf(:,20))
  ...
  call counter_Q_A(cttt,wf(:,3),Q(:,20),wf(:,35))
  call prop_A_Q(wf(:,4),Q(:,11),MT,1_intkind1,wf(:,36))
  call vert_QA_V(wf(:,-2),wf(:,6),wf(:,37))
  call counter_A_Q(cttt,wf(:,6),Q(:,24),wf(:,38))
  call prop_Q_A(wf(:,7),Q(:,7),MT,1_intkind1,wf(:,39))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(17)-A(18)-A(19)-A(20)-A(21)-A(22)-A(23)-A(24))*f(2))/2._/**/REALKIND+((A(11)+A(13)+A(15) &
       +A(16))*f(3))/2._/**/REALKIND+((A(5)+A(7)+A(9)+A(10))*f(4))/2._/**/REALKIND+((A(12)+A(14))*f(5))/2._/**/REALKIND+((A(6) &
       +A(8))*f(6))/2._/**/REALKIND
  M2(2) = ((A(17)+A(18)+A(19)+A(20)+A(21)+A(22)+A(23)+A(24))*f(2))/6._/**/REALKIND+((-A(11)-A(13)-A(15) &
       -A(16))*f(3))/6._/**/REALKIND+((-A(5)-A(7)-A(9)-A(10))*f(4))/6._/**/REALKIND+((-A(12)-A(14))*f(5))/6._/**/REALKIND+((-A(6) &
       -A(8))*f(6))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppatt_uuxttxa_1_/**/REALKIND
