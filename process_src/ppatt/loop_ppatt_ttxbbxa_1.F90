...
module ol_colourmatrix_ppatt_ttxbbxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppatt_ttxbbxa_1_/**/REALKIND



module ol_forced_parameters_ppatt_ttxbbxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppatt_ttxbbxa_1_/**/REALKIND

module ol_loop_ppatt_ttxbbxa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (CI*countertermnorm*ctGbb*eQED*gQCD**4)/3._/**/REALKIND
    f( 6) = (2*CI*countertermnorm*ctGbb*eQED*gQCD**4)/3._/**/REALKIND
    f( 7) = (CI*countertermnorm*ctGtt*eQED*gQCD**4)/3._/**/REALKIND
    f( 8) = (2*CI*countertermnorm*ctGtt*eQED*gQCD**4)/3._/**/REALKIND
    f( 9) = (CI*countertermnorm*ctVbb*eQED*gQCD**4)/3._/**/REALKIND
...
end module ol_loop_ppatt_ttxbbxa_1_/**/REALKIND
