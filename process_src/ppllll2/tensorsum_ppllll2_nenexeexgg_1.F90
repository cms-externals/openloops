...
! **********************************************************************
  ...
  call tensor_integral(4, momenta_5, masses2_10, T4sum(:,1))
  call tensor_integral(4, momenta_5, masses2_9, T4sum(:,2))
  ...
  call tensor_integral(4, momenta_7, masses2_9, T4sum(:,8))
