...
! **********************************************************************
module ol_tensor_sum_storage_ppllll2_nenexeexgg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllll2_nenexeexgg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllll2_nenexeexgg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppllll2_nenexeexgg_1, only: channel_number_ppllll2_nenexeexgg_1
  ...
  call channel_on(channel_number_ppllll2_nenexeexgg_1)
  M2 = 0
  ...
  call tensor_integral(4, momenta_5, masses2_9, T4sum(:,1))
  call tensor_integral(4, momenta_5, masses2_4, T4sum(:,2))
  call tensor_integral(4, momenta_5, masses2_10, T4sum(:,3))
  call tensor_integral(4, momenta_4, masses2_9, T4sum(:,4))
  call tensor_integral(4, momenta_4, masses2_4, T4sum(:,5))
  call tensor_integral(4, momenta_4, masses2_10, T4sum(:,6))
  call tensor_integral(4, momenta_7, masses2_9, T4sum(:,7))
  call tensor_integral(4, momenta_7, masses2_4, T4sum(:,8))
  call tensor_integral(4, momenta_7, masses2_10, T4sum(:,9))
  call tensor_integral(4, momenta_2, masses2_10, T4sum(:,10))
  call tensor_integral(4, momenta_2, masses2_8, T4sum(:,11))
  call tensor_integral(4, momenta_2, masses2_5, T4sum(:,12))
  ...
  call tensor_integral(4, momenta_6, masses2_10, T4sum(:,16))
  call tensor_integral(4, momenta_6, masses2_7, T4sum(:,17))
  ...
  call channel_off(channel_number_ppllll2_nenexeexgg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllll2_nenexeexgg_1_/**/REALKIND
