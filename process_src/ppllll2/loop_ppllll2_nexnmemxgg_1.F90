...
! **********************************************************************
  ...
  call vert_AZ_Q(gZl,wf(:,-3),wf(:,9),wf(:,12))
  call prop_Q_A(wf(:,11),Q(:,7),ZERO,0_intkind1,wf(:,13))
  call vert_ZQ_A(gZn,wf(:,9),wf(:,-1),wf(:,14))
  call vert_AW_Q(wf(:,-3),wf(:,3),wf(:,15))
  call prop_Q_A(wf(:,14),Q(:,50),ZERO,0_intkind1,wf(:,16))
  call vert_AW_Q(wf(:,0),wf(:,4),wf(:,17))
  call vert_ZQ_A(gZl,wf(:,9),wf(:,-2),wf(:,18))
  call prop_A_Q(wf(:,17),Q(:,11),ZERO,0_intkind1,wf(:,19))
  call vert_AZ_Q(gZn,wf(:,0),wf(:,9),wf(:,20))
  call vert_WQ_A(wf(:,4),wf(:,-2),wf(:,21))
  call prop_A_Q(wf(:,20),Q(:,49),ZERO,0_intkind1,wf(:,22))
  call prop_W_W(wf(:,10),Q(:,15),MZ,1_intkind1,wf(:,23))
  call vert_QA_V(wf(:,13),wf(:,-3),wf(:,24))
  call vert_QA_Z(gZl,wf(:,13),wf(:,-3),wf(:,25))
  call prop_W_W(wf(:,25),Q(:,15),MZ,1_intkind1,wf(:,26))
  call prop_A_Q(wf(:,15),Q(:,13),ZERO,0_intkind1,wf(:,27))
  call vert_QA_Z(gZn,wf(:,-1),wf(:,27),wf(:,28))
  call prop_W_W(wf(:,28),Q(:,15),MZ,1_intkind1,wf(:,29))
  call vert_QA_V(wf(:,-2),wf(:,19),wf(:,30))
  call vert_QA_Z(gZl,wf(:,-2),wf(:,19),wf(:,31))
  call prop_W_W(wf(:,31),Q(:,15),MZ,1_intkind1,wf(:,32))
  call prop_Q_A(wf(:,21),Q(:,14),ZERO,0_intkind1,wf(:,33))
  call vert_QA_Z(gZn,wf(:,33),wf(:,0),wf(:,34))
