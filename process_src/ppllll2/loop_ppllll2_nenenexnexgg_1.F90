...
subroutine diagrams(A)
  ...
  A(4) = cont_SS(wf(:,11),wf(:,12)) * den(8)
  A(5) = cont_QA(wf(:,16),wf(:,17)) * den(12)
  A(6) = cont_QA(wf(:,19),wf(:,20)) * den(15)
  A(7) = cont_SS(wf(:,11),wf(:,21)) * den(16)
  A(8) = cont_SS(wf(:,11),wf(:,21)) * den(16)
  A(9) = cont_QA(wf(:,16),wf(:,23)) * den(18)
  A(10) = cont_QA(wf(:,25),wf(:,26)) * den(21)
  A(11) = cont_QA(wf(:,28),wf(:,29)) * den(24)
  A(12) = cont_QA(wf(:,20),wf(:,30)) * den(25)
  A(13) = cont_QA(wf(:,28),wf(:,32)) * den(27)
  A(14) = cont_QA(wf(:,26),wf(:,33)) * den(28)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = 2*(A(5)+A(6)-A(9)-A(10)-A(11)-A(12)+A(13)+A(14))*f(1)+2*(-A(1)+A(2))*f(2)+2*(A(4)-A(8))*f(5)+2*(A(3)-A(7))*f(7)
