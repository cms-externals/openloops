...
! **********************************************************************
  ...
  call vert_QS_A(gH,wf(:,-3),wf(:,6),wf(:,12))
  call prop_A_Q(wf(:,11),Q(:,7),ZERO,0_intkind1,wf(:,13))
  call vert_ZQ_A(gZl,wf(:,9),wf(:,-3),wf(:,14))
  call vert_AZ_Q(gZn,wf(:,-1),wf(:,9),wf(:,15))
  call vert_WQ_A(wf(:,3),wf(:,-3),wf(:,16))
  call prop_A_Q(wf(:,15),Q(:,50),ZERO,0_intkind1,wf(:,17))
  call vert_WQ_A(wf(:,4),wf(:,0),wf(:,18))
  call vert_SA_Q(gH,wf(:,6),wf(:,-2),wf(:,19))
  call prop_Q_A(wf(:,18),Q(:,11),ZERO,0_intkind1,wf(:,20))
  call vert_AZ_Q(gZl,wf(:,-2),wf(:,9),wf(:,21))
  call vert_ZQ_A(gZn,wf(:,9),wf(:,0),wf(:,22))
  call vert_AW_Q(wf(:,-2),wf(:,4),wf(:,23))
  call prop_Q_A(wf(:,22),Q(:,49),ZERO,0_intkind1,wf(:,24))
  call prop_W_W(wf(:,10),Q(:,15),MZ,1_intkind1,wf(:,25))
  call vert_AQ_S(gH,wf(:,13),wf(:,-3),wf(:,26))
  call vert_QA_V(wf(:,-3),wf(:,13),wf(:,27))
  call vert_QA_Z(gZl,wf(:,-3),wf(:,13),wf(:,28))
  call prop_W_W(wf(:,28),Q(:,15),MZ,1_intkind1,wf(:,29))
  call prop_Q_A(wf(:,16),Q(:,13),ZERO,0_intkind1,wf(:,30))
  call vert_QA_Z(gZn,wf(:,30),wf(:,-1),wf(:,31))
  call prop_W_W(wf(:,31),Q(:,15),MZ,1_intkind1,wf(:,32))
  call vert_AQ_S(gH,wf(:,-2),wf(:,20),wf(:,33))
  call vert_QA_V(wf(:,20),wf(:,-2),wf(:,34))
  call vert_QA_Z(gZl,wf(:,20),wf(:,-2),wf(:,35))
  call prop_W_W(wf(:,35),Q(:,15),MZ,1_intkind1,wf(:,36))
  call prop_A_Q(wf(:,23),Q(:,14),ZERO,0_intkind1,wf(:,37))
