...
! **********************************************************************
module ol_tensor_sum_storage_ppllll2_nenenexnexgg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllll2_nenenexnexgg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllll2_nenenexnexgg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppllll2_nenenexnexgg_1, only: channel_number_ppllll2_nenenexnexgg_1
  ...
  call channel_on(channel_number_ppllll2_nenenexnexgg_1)
  M2 = 0
  ...
  call tensor_integral(4, momenta_2, masses2_6, T4sum(:,10))
  call tensor_integral(4, momenta_2, masses2_5, T4sum(:,11))
  call tensor_integral(4, momenta_2, masses2_4, T4sum(:,12))
  ...
  call tensor_integral(4, momenta_6, masses2_6, T4sum(:,16))
  call tensor_integral(4, momenta_6, masses2_5, T4sum(:,17))
  call tensor_integral(4, momenta_6, masses2_4, T4sum(:,18))

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppllll2_nenenexnexgg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllll2_nenenexnexgg_1_/**/REALKIND
