...
module ol_versiondata_ppthjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppthjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppthjj
  end interface
end module ol_versiondata_ppthjj


subroutine ol_version_ppthjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppthjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppthjj
