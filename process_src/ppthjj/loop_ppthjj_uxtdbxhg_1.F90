...
! **********************************************************************
  ...
  call vert_SA_Q(gH,wf(:,-4),wf(:,5),wf(:,23))
  call vert_AQ_S(gPbt,wf(:,5),wf(:,-1),wf(:,24))
  call vert_QA_W(wf(:,-1),wf(:,5),wf(:,25))
  call vert_AV_Q(wf(:,0),wf(:,-5),wf(:,26))
  call vert_AQ_S(gPbt,wf(:,-3),wf(:,-1),wf(:,27))
  call prop_A_Q(wf(:,26),Q(:,33),ZERO,0_intkind1,wf(:,28))
  call vert_QA_W(wf(:,-2),wf(:,28),wf(:,29))
  call vert_ST_V(wf(:,27),Q(:,10),wf(:,-4),Q(:,16),wf(:,30))
  call vert_QA_W(wf(:,-1),wf(:,-3),wf(:,31))
  call vert_SV_V(wf(:,-4),wf(:,31),wf(:,32))
  call vert_VQ_A(wf(:,-5),wf(:,-2),wf(:,33))
  call prop_Q_A(wf(:,33),Q(:,36),ZERO,0_intkind1,wf(:,34))
  call vert_QA_W(wf(:,34),wf(:,0),wf(:,35))
  call vert_QA_W(wf(:,4),wf(:,-3),wf(:,36))
  call vert_QA_W(wf(:,-1),wf(:,13),wf(:,37))
  call counter_WQ_A(wf(:,1),wf(:,4),wf(:,38))
  call counter_VQ_A(wf(:,-5),wf(:,4),wf(:,39))
  call counter_WQ_A(wf(:,1),wf(:,12),wf(:,40))
  call counter_AV_Q(wf(:,13),wf(:,-5),wf(:,41))
  call counter_QS_A(gH,wf(:,12),wf(:,-4),wf(:,42))
  call counter_SA_Q(gH,wf(:,-4),wf(:,5),wf(:,43))
  call counter_SG_G(wf(:,-4),wf(:,-5),wf(:,44))
  call vert_AV_Q(wf(:,-3),wf(:,44),wf(:,45))
  call vert_VQ_A(wf(:,44),wf(:,-1),wf(:,46))
  call prop_Q_A(wf(:,46),Q(:,50),MT,1_intkind1,wf(:,47))
  call counter_AW_Q(wf(:,-3),wf(:,1),wf(:,48))
  call prop_Q_A(wf(:,8),Q(:,50),MT,1_intkind1,wf(:,49))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,50))
  call prop_A_Q(wf(:,50),Q(:,40),MB,1_intkind1,wf(:,51))
  call counter_AQ_S(ctSbt,wf(:,-3),wf(:,12),wf(:,52))
  call counter_QA_W(wf(:,12),wf(:,-3),wf(:,53))
  call prop_Q_A(wf(:,18),Q(:,50),MT,1_intkind1,wf(:,54))
  call vert_SA_Q(gH,wf(:,-4),wf(:,51),wf(:,55))
  call vert_AQ_S(gPbt,wf(:,51),wf(:,-1),wf(:,56))
  call vert_QA_W(wf(:,-1),wf(:,51),wf(:,57))
  call counter_SA_Q(gH,wf(:,-4),wf(:,-3),wf(:,58))
  call prop_A_Q(wf(:,58),Q(:,24),MB,1_intkind1,wf(:,59))
  call vert_AV_Q(wf(:,59),wf(:,-5),wf(:,60))
  call vert_AW_Q(wf(:,0),wf(:,31),wf(:,61))
  call vert_VQ_A(wf(:,44),wf(:,-2),wf(:,62))
  call prop_A_Q(wf(:,61),Q(:,11),ZERO,0_intkind1,wf(:,63))
  call vert_AV_Q(wf(:,0),wf(:,44),wf(:,64))
  call vert_WQ_A(wf(:,31),wf(:,-2),wf(:,65))
  call prop_A_Q(wf(:,64),Q(:,49),ZERO,0_intkind1,wf(:,66))
  call counter_QA_W(wf(:,4),wf(:,-3),wf(:,67))
  call vert_QA_W(wf(:,-1),wf(:,59),wf(:,68))
  call vert_SS_S(wf(:,27),wf(:,-4),wf(:,69))
  call counter_AQ_S(gPud,wf(:,28),wf(:,-2),wf(:,70))
  call counter_QA_W(wf(:,-2),wf(:,28),wf(:,71))
  call vert_TV_S(wf(:,-4),Q(:,16),wf(:,31),Q(:,10),wf(:,72))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,73))
  call prop_Q_A(wf(:,73),Q(:,36),ZERO,0_intkind1,wf(:,74))
  call vert_QA_W(wf(:,74),wf(:,0),wf(:,75))
  call vert_AQ_S(gPbt,wf(:,-3),wf(:,4),wf(:,76))
  call vert_AQ_S(gPbt,wf(:,13),wf(:,-1),wf(:,77))
  call counter_WQ_A(wf(:,1),wf(:,-1),wf(:,78))
  call prop_A_Q(wf(:,16),Q(:,56),MB,1_intkind1,wf(:,79))
  call counter_VQ_A(wf(:,-5),wf(:,-1),wf(:,80))
  call prop_Q_A(wf(:,80),Q(:,34),MT,1_intkind1,wf(:,81))
  call vert_WQ_A(wf(:,1),wf(:,81),wf(:,82))
  call counter_AQ_S(ctSbt,wf(:,5),wf(:,-1),wf(:,83))
  call counter_QA_W(wf(:,-1),wf(:,5),wf(:,84))
  call prop_A_Q(wf(:,23),Q(:,56),MB,1_intkind1,wf(:,85))
  call vert_QS_A(gH,wf(:,81),wf(:,-4),wf(:,86))
  call vert_AQ_S(gPbt,wf(:,-3),wf(:,81),wf(:,87))
  call vert_QA_W(wf(:,81),wf(:,-3),wf(:,88))
  call counter_QS_A(gH,wf(:,-1),wf(:,-4),wf(:,89))
  call prop_Q_A(wf(:,89),Q(:,18),MT,1_intkind1,wf(:,90))
  call vert_WQ_A(wf(:,1),wf(:,90),wf(:,91))
  call vert_VQ_A(wf(:,-5),wf(:,90),wf(:,92))
  call counter_QA_W(wf(:,-1),wf(:,13),wf(:,93))
  call vert_QA_W(wf(:,90),wf(:,-3),wf(:,94))
  call counter_AQ_S(ctSbt,wf(:,-3),wf(:,-1),wf(:,95))
  call vert_ST_V(wf(:,95),Q(:,10),wf(:,-4),Q(:,16),wf(:,96))
  call counter_QA_W(wf(:,-1),wf(:,-3),wf(:,97))
  call vert_SV_V(wf(:,-4),wf(:,97),wf(:,98))
  call counter_AQ_S(gPud,wf(:,0),wf(:,34),wf(:,99))
  call counter_QA_W(wf(:,34),wf(:,0),wf(:,100))
  call counter_AV_Q(wf(:,0),wf(:,-5),wf(:,101))
  call prop_A_Q(wf(:,101),Q(:,33),ZERO,0_intkind1,wf(:,102))
  call vert_QA_W(wf(:,-2),wf(:,102),wf(:,103))
  call counter_AQ_S(gPud,wf(:,0),wf(:,-2),wf(:,104))
  call vert_QS_A(gPbt,wf(:,4),wf(:,104),wf(:,105))
  call counter_QA_W(wf(:,-2),wf(:,0),wf(:,106))
  call vert_WQ_A(wf(:,106),wf(:,4),wf(:,107))
  call vert_SA_Q(gPbt,wf(:,104),wf(:,-3),wf(:,108))
  call prop_A_Q(wf(:,108),Q(:,13),MT,1_intkind1,wf(:,109))
  call vert_AW_Q(wf(:,-3),wf(:,106),wf(:,110))
  call prop_A_Q(wf(:,110),Q(:,13),MT,1_intkind1,wf(:,111))
  call vert_QS_A(gPbt,wf(:,12),wf(:,104),wf(:,112))
  call vert_WQ_A(wf(:,106),wf(:,12),wf(:,113))
  call vert_QS_A(gPbt,wf(:,-1),wf(:,104),wf(:,114))
  call prop_Q_A(wf(:,114),Q(:,7),MB,1_intkind1,wf(:,115))
  call vert_WQ_A(wf(:,106),wf(:,-1),wf(:,116))
  ...
  call vert_AW_Q(wf(:,5),wf(:,1),wf(:,122))
  call counter_Q_A(cttt,wf(:,4),Q(:,18),wf(:,123))
  call prop_A_Q(wf(:,122),Q(:,45),MT,1_intkind1,wf(:,124))
  call counter_A_Q(ctbb,wf(:,5),Q(:,40),wf(:,125))
  call prop_Q_A(wf(:,6),Q(:,23),MB,1_intkind1,wf(:,126))
  call prop_Q_A(wf(:,123),Q(:,18),MT,1_intkind1,wf(:,127))
  call vert_VQ_A(wf(:,-5),wf(:,127),wf(:,128))
  call counter_A_Q(cttt,wf(:,9),Q(:,13),wf(:,129))
  call vert_AW_Q(wf(:,13),wf(:,1),wf(:,130))
  call counter_Q_A(cttt,wf(:,12),Q(:,34),wf(:,131))
  call prop_A_Q(wf(:,130),Q(:,29),MT,1_intkind1,wf(:,132))
  call counter_A_Q(ctbb,wf(:,13),Q(:,24),wf(:,133))
  call prop_Q_A(wf(:,14),Q(:,39),MB,1_intkind1,wf(:,134))
  call counter_Q_A(ctbb,wf(:,17),Q(:,7),wf(:,135))
  call prop_A_Q(wf(:,133),Q(:,24),MB,1_intkind1,wf(:,136))
  call vert_AV_Q(wf(:,136),wf(:,-5),wf(:,137))
  call prop_Q_A(wf(:,131),Q(:,34),MT,1_intkind1,wf(:,138))
  call vert_AQ_S(gPbt,wf(:,-3),wf(:,138),wf(:,139))
  call vert_QA_W(wf(:,138),wf(:,-3),wf(:,140))
  call vert_QS_A(gH,wf(:,138),wf(:,-4),wf(:,141))
  call prop_A_Q(wf(:,125),Q(:,40),MB,1_intkind1,wf(:,142))
  call vert_AQ_S(gPbt,wf(:,142),wf(:,-1),wf(:,143))
  call vert_QA_W(wf(:,-1),wf(:,142),wf(:,144))
  call vert_SA_Q(gH,wf(:,-4),wf(:,142),wf(:,145))
  call counter_A_Q(ctqq,wf(:,28),Q(:,33),wf(:,146))
  call prop_A_Q(wf(:,146),Q(:,33),ZERO,0_intkind1,wf(:,147))
  call vert_QA_W(wf(:,-2),wf(:,147),wf(:,148))
  call counter_Q_A(ctqq,wf(:,34),Q(:,36),wf(:,149))
  call prop_Q_A(wf(:,149),Q(:,36),ZERO,0_intkind1,wf(:,150))
  call vert_QA_W(wf(:,150),wf(:,0),wf(:,151))
  call vert_QA_W(wf(:,127),wf(:,-3),wf(:,152))
  call vert_QA_W(wf(:,-1),wf(:,136),wf(:,153))
  call vert_QA_V(wf(:,17),wf(:,-3),wf(:,154))
  call vert_QS_A(gH,wf(:,17),wf(:,-4),wf(:,155))
  call prop_Q_A(wf(:,155),Q(:,23),MB,1_intkind1,wf(:,156))
  call vert_VQ_A(wf(:,-5),wf(:,17),wf(:,157))
  call prop_Q_A(wf(:,157),Q(:,39),MB,1_intkind1,wf(:,158))
  call vert_QA_V(wf(:,-1),wf(:,9),wf(:,159))
  call vert_SA_Q(gH,wf(:,-4),wf(:,9),wf(:,160))
  call prop_A_Q(wf(:,160),Q(:,29),MT,1_intkind1,wf(:,161))
  call vert_AV_Q(wf(:,9),wf(:,-5),wf(:,162))
  call prop_A_Q(wf(:,162),Q(:,45),MT,1_intkind1,wf(:,163))
  call vert_QS_A(gPbt,wf(:,-1),wf(:,20),wf(:,164))
  call prop_Q_A(wf(:,164),Q(:,23),MB,1_intkind1,wf(:,165))
  call vert_WQ_A(wf(:,22),wf(:,-1),wf(:,166))
  call prop_Q_A(wf(:,166),Q(:,23),MB,1_intkind1,wf(:,167))
  call vert_SA_Q(gPbt,wf(:,20),wf(:,-3),wf(:,168))
  call prop_A_Q(wf(:,168),Q(:,29),MT,1_intkind1,wf(:,169))
  call vert_AW_Q(wf(:,-3),wf(:,22),wf(:,170))
  call prop_A_Q(wf(:,170),Q(:,29),MT,1_intkind1,wf(:,171))
  call vert_QA_V(wf(:,-2),wf(:,63),wf(:,172))
  call prop_Q_A(wf(:,65),Q(:,14),ZERO,0_intkind1,wf(:,173))
  call vert_QA_V(wf(:,173),wf(:,0),wf(:,174))
  call vert_AW_Q(wf(:,0),wf(:,30),wf(:,175))
  call prop_A_Q(wf(:,175),Q(:,27),ZERO,0_intkind1,wf(:,176))
  call vert_AW_Q(wf(:,0),wf(:,32),wf(:,177))
  call prop_A_Q(wf(:,177),Q(:,27),ZERO,0_intkind1,wf(:,178))
  call vert_WQ_A(wf(:,30),wf(:,-2),wf(:,179))
  call prop_Q_A(wf(:,179),Q(:,30),ZERO,0_intkind1,wf(:,180))
  call vert_WQ_A(wf(:,32),wf(:,-2),wf(:,181))
  call prop_Q_A(wf(:,181),Q(:,30),ZERO,0_intkind1,wf(:,182))
  call vert_QA_W(wf(:,4),wf(:,5),wf(:,183))
  call vert_AW_Q(wf(:,0),wf(:,36),wf(:,184))
  call prop_A_Q(wf(:,184),Q(:,27),ZERO,0_intkind1,wf(:,185))
  call vert_WQ_A(wf(:,36),wf(:,-2),wf(:,186))
  call prop_Q_A(wf(:,186),Q(:,30),ZERO,0_intkind1,wf(:,187))
  call vert_QA_W(wf(:,49),wf(:,-3),wf(:,188))
  call vert_QA_W(wf(:,12),wf(:,13),wf(:,189))
  call vert_AW_Q(wf(:,0),wf(:,37),wf(:,190))
  call prop_A_Q(wf(:,190),Q(:,27),ZERO,0_intkind1,wf(:,191))
  call vert_WQ_A(wf(:,37),wf(:,-2),wf(:,192))
  call prop_Q_A(wf(:,192),Q(:,30),ZERO,0_intkind1,wf(:,193))
  call vert_QA_W(wf(:,-1),wf(:,79),wf(:,194))
  call vert_WQ_A(wf(:,29),wf(:,-1),wf(:,195))
  call prop_Q_A(wf(:,195),Q(:,39),MB,1_intkind1,wf(:,196))
  call vert_AW_Q(wf(:,-3),wf(:,29),wf(:,197))
  call prop_A_Q(wf(:,197),Q(:,45),MT,1_intkind1,wf(:,198))
  ...
  call vert_QA_W(wf(:,54),wf(:,-3),wf(:,203))
  call vert_WQ_A(wf(:,35),wf(:,-1),wf(:,204))
  call prop_Q_A(wf(:,204),Q(:,39),MB,1_intkind1,wf(:,205))
  call vert_AW_Q(wf(:,-3),wf(:,35),wf(:,206))
  call prop_A_Q(wf(:,206),Q(:,45),MT,1_intkind1,wf(:,207))
  ...
  call vert_QA_W(wf(:,-1),wf(:,85),wf(:,212))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = (A(11)+A(13))*f(2)+(A(12)+A(14))*f(9)+(A(17)+A(18))*f(21)+(A(15)+A(16))*f(34)
  M1(2) = (A(6)+A(9))*f(2)+(A(7)+A(10))*f(9)+(A(3)+A(4)+A(8))*f(21)+(A(1)+A(2)+A(5))*f(34)

  M2(1) = (A(47)+A(77))*f(1)+(A(73)+A(75)-A(125)-A(127))*f(3)+(A(51)+A(81))*f(5)+(A(49)+A(78))*f(7)+(A(48)+A(79))*f(8)+(-A(126) &
  ...
  M2(2) = (A(99)+A(105))*f(1)+(A(31)+A(61)-A(117)-A(121))*f(3)+A(35)*f(4)+A(65)*f(6)+(A(100)+A(106))*f(7)+(A(101)+A(107))*f(8)+( &
