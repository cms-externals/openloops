...
! **********************************************************************
module ol_tensor_sum_storage_pphjj2_uuxhgg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphjj2_uuxhgg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphjj2_uuxhgg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pphjj2_uuxhgg_1, only: channel_number_pphjj2_uuxhgg_1
  ...
  call channel_on(channel_number_pphjj2_uuxhgg_1)
  M2 = 0
  ...
  call tensor_integral(3, momenta_3, masses2_2, T3sum(:,3))
  ...
  if (a_switch == 1 .and. ncall_coli < maxcachetrain) then
    ...
    if (YB == 0) then
      call channel_off(channel_number_pphjj2_uuxhgg_1)
      return
    end if
  end if

  call tensor_integral(3, momenta_1, masses2_1, T3sum(:,2))
  call tensor_integral(3, momenta_3, masses2_1, T3sum(:,4))
...
end module ol_tensor_sum_storage_pphjj2_uuxhgg_1_/**/REALKIND
