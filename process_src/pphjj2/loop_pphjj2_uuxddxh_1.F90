...
module ol_colourmatrix_pphjj2_uuxddxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphjj2_uuxddxh_1_/**/REALKIND



module ol_forced_parameters_pphjj2_uuxddxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphjj2_uuxddxh_1_/**/REALKIND

module ol_loop_pphjj2_uuxddxh_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-5+1:3)
  ! denominators
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(2)*f(1))/2._/**/REALKIND+(A(1)*f(3))/2._/**/REALKIND
  M2(2) = -(A(2)*f(1))/6._/**/REALKIND-(A(1)*f(3))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphjj2_uuxddxh_1_/**/REALKIND
