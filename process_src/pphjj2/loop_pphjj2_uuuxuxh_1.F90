...
module ol_colourmatrix_pphjj2_uuuxuxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphjj2_uuuxuxh_1_/**/REALKIND



module ol_forced_parameters_pphjj2_uuuxuxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphjj2_uuuxuxh_1_/**/REALKIND

module ol_loop_pphjj2_uuuxuxh_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(4) = (eQED*gQCD**4*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_SG_G(wf(:,-4),wf(:,1),wf(:,3))
  call vert_QA_V(wf(:,0),wf(:,-3),wf(:,4))
  call vert_QA_V(wf(:,-1),wf(:,-2),wf(:,5))
  call counter_SG_G(wf(:,-4),wf(:,4),wf(:,6))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = -(A(2)*f(1))/2._/**/REALKIND-(A(4)*f(1))/6._/**/REALKIND-(A(1)*f(3))/2._/**/REALKIND-(A(3)*f(3))/6._/**/REALKIND
  M2(2) = (A(2)*f(1))/6._/**/REALKIND+(A(4)*f(1))/2._/**/REALKIND+(A(1)*f(3))/6._/**/REALKIND+(A(3)*f(3))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphjj2_uuuxuxh_1_/**/REALKIND
