...
module ol_versiondata_ppztt
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppztt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppztt
  end interface
end module ol_versiondata_ppztt


subroutine ol_version_ppztt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppztt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppztt
