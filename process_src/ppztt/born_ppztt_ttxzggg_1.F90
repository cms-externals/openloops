...
module ol_colourmatrix_ppztt_ttxzggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppztt_ttxzggg_1_/**/REALKIND



module ol_forced_parameters_ppztt_ttxzggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppztt_ttxzggg_1_/**/REALKIND

module ol_tree_ppztt_ttxzggg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppztt_ttxzggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppztt_ttxzggg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for top anti-top Z glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppztt_ttxzggg_1, only: external_perm_ppztt_ttxzggg_1, &
    & external_perm_inv_ppztt_ttxzggg_1, extcomb_perm_ppztt_ttxzggg_1, &
    & average_factor_ppztt_ttxzggg_1
  use ol_external_ppztt_ttxzggg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppztt_ttxzggg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppztt_ttxzggg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppztt_ttxzggg_1
  ...
  extmasses2 = [ rMT2, rMT2, rMZ2, rZERO2, rZERO2, rZERO2 ]
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppztt_ttxzggg_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppztt_ttxzggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppztt_ttxzggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppztt_ttxzggg_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf6(:,1), Q(:,5), MT, 1_intkind1, wf6(:,2), n2(1))
  ...
  call vert_AZ_Q(gZu,ntry, ex2, ex3, wf6(:,3), n3(:,3), t3x6(:,:,2))
  call prop_A_Q(ntry, wf6(:,3), Q(:,6), MT, 1_intkind1, wf6(:,4), n2(2))
  ...
  call prop_A_Q(ntry, wf4(:,1), Q(:,10), MT, 1_intkind1, wf4(:,3), n2(3))
  ...
  call prop_Q_A(ntry, wf12(:,6), Q(:,13), MT, 1_intkind1, wf12(:,7), n2(7))
  call vert_AV_Q(ntry, wf4(:,6), ex4, wf8(:,8), n3(:,17), t3x8(:,:,4))
  call prop_A_Q(ntry, wf8(:,8), Q(:,26), MT, 1_intkind1, wf8(:,9), n2(8))
  call vert_AV_Q(ntry, ex2, ex6, wf4(:,7), n3(:,18), t3x4(:,:,5))
  call vert_UV_W(ntry, ex4, Q(:,8), ex5, Q(:,16), wf4(:,8), n3(:,19), t3x4(:,:,6))
  call prop_A_Q(ntry, wf4(:,7), Q(:,34), MT, 1_intkind1, wf4(:,9), n2(9))
  ...
  call prop_Q_A(ntry, wf8(:,22), Q(:,25), MT, 1_intkind1, wf8(:,23), n2(15))
  call vert_AV_Q(ntry, wf6(:,4), ex5, wf12(:,9), n3(:,33), t3x12(:,:,7))
  call vert_VQ_A(ntry, ex6, wf4(:,11), wf8(:,24), n3(:,34), t3x8(:,:,14))
  call prop_A_Q(ntry, wf12(:,9), Q(:,22), MT, 1_intkind1, wf12(:,10), n2(16))
  call vert_VQ_A(ntry, ex5, ex1, wf4(:,12), n3(:,35), t3x4(:,:,8))
  call prop_Q_A(ntry, wf4(:,12), Q(:,17), MT, 1_intkind1, wf4(:,13), n2(17))
  call vert_QA_V(ntry, wf4(:,13), wf6(:,4), wf24(:,5), n3(:,36), t3x24(:,:,5))
  call vert_VQ_A(ntry, ex4, wf4(:,13), wf8(:,25), n3(:,37), t3x8(:,:,15))
  call prop_Q_A(ntry, wf8(:,25), Q(:,25), MT, 1_intkind1, wf8(:,26), n2(18))
  call vert_AV_Q(ntry, wf6(:,4), ex4, wf12(:,11), n3(:,38), t3x12(:,:,8))
  call vert_VQ_A(ntry, ex6, wf4(:,13), wf8(:,27), n3(:,39), t3x8(:,:,16))
  call prop_A_Q(ntry, wf12(:,11), Q(:,14), MT, 1_intkind1, wf12(:,12), n2(19))
  call vert_VQ_A(ntry, ex6, ex1, wf4(:,14), n3(:,40), t3x4(:,:,9))
  call prop_Q_A(ntry, wf4(:,14), Q(:,33), MT, 1_intkind1, wf4(:,15), n2(20))
  call vert_QA_V(ntry, wf4(:,15), wf6(:,4), wf24(:,6), n3(:,41), t3x24(:,:,6))
  call vert_VQ_A(ntry, wf4(:,8), ex1, wf8(:,28), n3(:,42), t3x8(:,:,17))
  call prop_Q_A(ntry, wf8(:,28), Q(:,25), MT, 1_intkind1, wf8(:,29), n2(21))
  call vert_VQ_A(ntry, ex4, wf4(:,15), wf8(:,30), n3(:,43), t3x8(:,:,18))
  call prop_Q_A(ntry, wf8(:,30), Q(:,41), MT, 1_intkind1, wf8(:,31), n2(22))
  call vert_VQ_A(ntry, ex5, wf4(:,15), wf8(:,32), n3(:,44), t3x8(:,:,19))
  call vert_VQ_A(ntry, wf4(:,5), ex1, wf8(:,33), n3(:,45), t3x8(:,:,20))
  call prop_Q_A(ntry, wf8(:,33), Q(:,41), MT, 1_intkind1, wf8(:,34), n2(23))
  call vert_VQ_A(ntry, wf4(:,2), ex1, wf8(:,35), n3(:,46), t3x8(:,:,21))
  call prop_Q_A(ntry, wf8(:,35), Q(:,49), MT, 1_intkind1, wf8(:,36), n2(24))
  call vert_ZQ_A(gZu,ntry, ex3, wf4(:,11), wf12(:,13), n3(:,47), t3x12(:,:,9))
  call prop_Q_A(ntry, wf12(:,13), Q(:,13), MT, 1_intkind1, wf12(:,14), n2(25))
  call vert_AZ_Q(gZu,ntry, wf4(:,6), ex3, wf12(:,15), n3(:,48), t3x12(:,:,10))
  call prop_A_Q(ntry, wf12(:,15), Q(:,22), MT, 1_intkind1, wf12(:,16), n2(26))
  call vert_AZ_Q(gZu,ntry, wf4(:,9), ex3, wf12(:,17), n3(:,49), t3x12(:,:,11))
  call prop_A_Q(ntry, wf12(:,17), Q(:,38), MT, 1_intkind1, wf12(:,18), n2(27))
  call vert_ZQ_A(gZu,ntry, ex3, wf4(:,13), wf12(:,19), n3(:,50), t3x12(:,:,12))
  call prop_Q_A(ntry, wf12(:,19), Q(:,21), MT, 1_intkind1, wf12(:,20), n2(28))
  call vert_AZ_Q(gZu,ntry, wf4(:,3), ex3, wf12(:,21), n3(:,51), t3x12(:,:,13))
  call prop_A_Q(ntry, wf12(:,21), Q(:,14), MT, 1_intkind1, wf12(:,22), n2(29))
  call vert_ZQ_A(gZu,ntry, ex3, wf4(:,15), wf12(:,23), n3(:,52), t3x12(:,:,14))
  call prop_Q_A(ntry, wf12(:,23), Q(:,37), MT, 1_intkind1, wf12(:,24), n2(30))
  ...
  M2add = M2 / average_factor_ppztt_ttxzggg_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_ppztt_ttxzggg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppztt_ttxzggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppztt_ttxzggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppztt_ttxzggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppztt_ttxzggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppztt_ttxzggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppztt_ttxzggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppztt_ttxzggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppztt_ttxzggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppztt_ttxzggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppztt_ttxzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppztt_ttxzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppztt_ttxzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppztt_ttxzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppztt_ttxzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppztt_ttxzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppztt_ttxzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppztt_ttxzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_ppztt_ttxzggg_1_/**/REALKIND
