...
module ol_colourmatrix_ppztt_ttxzgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppztt_ttxzgg_1_/**/REALKIND



module ol_forced_parameters_ppztt_ttxzgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppztt_ttxzgg_1_/**/REALKIND

module ol_loop_ppztt_ttxzgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGtt*eQED*gQCD**4
    f( 6) = countertermnorm*ctGtt*eQED*gQCD**4
    f( 7) = CI*countertermnorm*ctVtt*eQED*gQCD**4
    f( 8) = countertermnorm*ctVtt*eQED*gQCD**4
...
! **********************************************************************
  ...
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,-2),wf(:,12))
  ...
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,13),wf(:,20))
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,17),wf(:,21))
  ...
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,13),wf(:,35))
  call vert_QA_V(wf(:,13),wf(:,-1),wf(:,36))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,17),wf(:,37))
  ...
  call prop_A_Q(wf(:,42),Q(:,18),MT,1_intkind1,wf(:,43))
  call counter_AV_Q(wf(:,-1),wf(:,-3),wf(:,44))
  call prop_A_Q(wf(:,44),Q(:,10),MT,1_intkind1,wf(:,45))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-2),wf(:,46))
  call prop_A_Q(wf(:,46),Q(:,6),MT,1_intkind1,wf(:,47))
  call vert_QA_V(wf(:,0),wf(:,47),wf(:,48))
  call counter_QA_V(wf(:,0),wf(:,14),wf(:,49))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,50))
  call prop_Q_A(wf(:,50),Q(:,17),MT,1_intkind1,wf(:,51))
  call vert_VQ_A(wf(:,-3),wf(:,51),wf(:,52))
  call counter_VQ_A(wf(:,-3),wf(:,0),wf(:,53))
  call prop_Q_A(wf(:,53),Q(:,9),MT,1_intkind1,wf(:,54))
  call vert_VQ_A(wf(:,-4),wf(:,54),wf(:,55))
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,51),wf(:,56))
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,54),wf(:,57))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,0),wf(:,58))
  call prop_Q_A(wf(:,58),Q(:,5),MT,1_intkind1,wf(:,59))
  ...
  call counter_Q_A(cttt,wf(:,3),Q(:,5),wf(:,64))
  call prop_A_Q(wf(:,63),Q(:,26),MT,1_intkind1,wf(:,65))
  call counter_A_Q(cttt,wf(:,4),Q(:,10),wf(:,66))
  call prop_Q_A(wf(:,5),Q(:,21),MT,1_intkind1,wf(:,67))
  call vert_AV_Q(wf(:,7),wf(:,-3),wf(:,68))
  call prop_A_Q(wf(:,68),Q(:,26),MT,1_intkind1,wf(:,69))
  call counter_A_Q(cttt,wf(:,7),Q(:,18),wf(:,70))
  call prop_Q_A(wf(:,8),Q(:,13),MT,1_intkind1,wf(:,71))
  call vert_AV_Q(wf(:,-1),wf(:,9),wf(:,72))
  call prop_A_Q(wf(:,72),Q(:,26),MT,1_intkind1,wf(:,73))
  call counter_V_V(ctGG,wf(:,9),Q(:,24),wf(:,74))
  call vert_AV_Q(wf(:,14),wf(:,-4),wf(:,75))
  call counter_Q_A(cttt,wf(:,13),Q(:,9),wf(:,76))
  call prop_A_Q(wf(:,75),Q(:,22),MT,1_intkind1,wf(:,77))
  call counter_A_Q(cttt,wf(:,14),Q(:,6),wf(:,78))
  call prop_Q_A(wf(:,15),Q(:,25),MT,1_intkind1,wf(:,79))
  call vert_AV_Q(wf(:,14),wf(:,-3),wf(:,80))
  call counter_Q_A(cttt,wf(:,17),Q(:,17),wf(:,81))
  call prop_A_Q(wf(:,80),Q(:,14),MT,1_intkind1,wf(:,82))
  call prop_Q_A(wf(:,18),Q(:,25),MT,1_intkind1,wf(:,83))
  call vert_VQ_A(wf(:,9),wf(:,0),wf(:,84))
  call prop_Q_A(wf(:,84),Q(:,25),MT,1_intkind1,wf(:,85))
  call vert_AZ_Q(gZu,wf(:,7),wf(:,-2),wf(:,86))
  call prop_A_Q(wf(:,86),Q(:,22),MT,1_intkind1,wf(:,87))
  call prop_Q_A(wf(:,20),Q(:,13),MT,1_intkind1,wf(:,88))
  call vert_AZ_Q(gZu,wf(:,4),wf(:,-2),wf(:,89))
  call prop_A_Q(wf(:,89),Q(:,14),MT,1_intkind1,wf(:,90))
  call prop_Q_A(wf(:,21),Q(:,21),MT,1_intkind1,wf(:,91))
...
end module ol_loop_ppztt_ttxzgg_1_/**/REALKIND
