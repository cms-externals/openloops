...
module ol_versiondata_eehllllbb
  implicit none
  character(4) :: generator_revision = "1947"
  interface
    subroutine version_eehllllbb(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_eehllllbb
  end interface
end module ol_versiondata_eehllllbb


subroutine ol_version_eehllllbb(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_eehllllbb, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_eehllllbb
