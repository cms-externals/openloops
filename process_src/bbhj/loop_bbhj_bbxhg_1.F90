...
module ol_colourmatrix_bbhj_bbxhg_1_/**/REALKIND
...
end module ol_colourmatrix_bbhj_bbxhg_1_/**/REALKIND



module ol_forced_parameters_bbhj_bbxhg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_bbhj_bbxhg_1_/**/REALKIND

module ol_loop_bbhj_bbxhg_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 2) = (CI*eQED*gQCD*YB)/(2._/**/REALKIND*MW*sw)
    f( 3) = (CI*countertermnorm*eQED*gQCD**3*YB)/(2._/**/REALKIND*MW*sw)
    f( 4) = (CI*countertermnorm*ctGbb*eQED*gQCD**3*YB)/(2._/**/REALKIND*MW*sw)
    f( 5) = (CI*countertermnorm*ctSbb*eQED*gQCD**3*YB)/(2._/**/REALKIND*MW*sw)
    f( 6) = (CI*eQED*gQCD**3*integralnorm*SwB*YB)/(2._/**/REALKIND*MW*sw)
    f( 7) = (eQED*gQCD**3*integralnorm*SwB*YB)/(MW*sw*2._/**/REALKIND)
    f( 8) = (eQED*gQCD**3*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f( 9) = (CI*countertermnorm*ctHGG*eQED*gQCD**3*MC*YC)/MQ2sum
  ...
  c = [ 9*CI*f(6), f(7), 8*f(7), 3*f(8), 3*f(10), 3*f(12) ]
  c = (1._/**/REALKIND / 6) * c
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,4),Q(:,9),MB,1_intkind1,wf(:,6))
  ...
  call prop_A_Q(wf(:,5),Q(:,6),MB,1_intkind1,wf(:,12))
  call counter_QS_A(gH,wf(:,0),wf(:,-2),wf(:,13))
  call prop_A_Q(wf(:,2),Q(:,10),MB,1_intkind1,wf(:,14))
  call counter_Q_A(ctbb,wf(:,3),Q(:,5),wf(:,15))
  call counter_Q_A(ctbb,wf(:,6),Q(:,9),wf(:,16))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = A(4)*f(1)+(-A(10)-A(11))*f(3)+(A(6)+A(8))*f(4)+(A(7)+A(9))*f(5)+A(5)*f(9)+A(3)*f(11)

end subroutine colourvectors

end module ol_loop_bbhj_bbxhg_1_/**/REALKIND
