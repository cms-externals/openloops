...
module ol_vamp_1_bbhj_ccxhg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_bbhj_ccxhg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_bbhj_ccxhg_1.
! **********************************************************************
...
#endif
  use ol_loop_bbhj_ccxhg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_bbhj_ccxhg_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_A_Q(G0(:,:,:,2),Q(:,4),MC,G1(:,:,:,1))
  call loop_AV_Q(G1(:,:,:,1),wf(:,-3),G1(:,:,:,2))
  call loop_A_Q(G1(:,:,:,2),Q(:,12),MC,G2(:,:,:,1))
  call loop_AV_Q(G2(:,:,:,1),wf(:,7),G2(:,:,:,2))
  call check_last_A_Q(l_switch,G2(:,:,:,2),Q(:,15),MC,G3tensor(:,1))
  ...
  call loop_Q_A(G0(:,:,:,4),Q(:,4),MC,G1(:,:,:,5))
  call loop_QV_A(G1(:,:,:,5),wf(:,-3),G1(:,:,:,6))
  call loop_Q_A(G1(:,:,:,6),Q(:,12),MC,G2(:,:,:,5))
  call loop_QV_A(G2(:,:,:,5),wf(:,7),G2(:,:,:,6))
  call check_last_Q_A(l_switch,G2(:,:,:,6),Q(:,15),MC,G3tensor(:,3))
...
end module ol_vamp_1_bbhj_ccxhg_1_/**/REALKIND
