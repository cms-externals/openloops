...
! **********************************************************************
module ol_tensor_sum_storage_bbhj_bbxhg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_bbhj_bbxhg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_bbhj_bbxhg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_bbhj_bbxhg_1, only: channel_number_bbhj_bbxhg_1
  ...
  call channel_on(channel_number_bbhj_bbxhg_1)
  M2 = 0
  ...
  masses2_4 = [ MC2, MC2, MC2 ]
  masses2_5 = [ MT2, MT2, MT2 ]
  masses2_6 = [ ZERO2, ZERO2, MB2 ]
  ...
  call TI_call(2, momenta_5, masses2_3, T2sum(:,3), M2)
  call TI_call(2, momenta_7, masses2_6, T2sum(:,4), M2)
  call TI_call(2, momenta_8, masses2_3, T2sum(:,5), M2)
  call TI_call(2, momenta_9, masses2_3, T2sum(:,6), M2)

  call TI_call(3, momenta_3, masses2_4, T3sum(:,1), M2)
  ...
  call channel_off(channel_number_bbhj_bbxhg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_bbhj_bbxhg_1_/**/REALKIND
