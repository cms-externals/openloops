...
module ol_versiondata_bbhj
  implicit none
  character(4) :: generator_revision = "4024"
  interface
    subroutine version_bbhj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_bbhj
  end interface
end module ol_versiondata_bbhj


subroutine ol_version_bbhj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_bbhj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_bbhj
