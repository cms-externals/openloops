...
! **********************************************************************
module ol_tensor_sum_storage_bbhj_ccxhg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_bbhj_ccxhg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_bbhj_ccxhg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_bbhj_ccxhg_1, only: channel_number_bbhj_ccxhg_1
  ...
  call channel_on(channel_number_bbhj_ccxhg_1)
  M2 = 0
  ...
  masses2_3 = [ MC2, MC2, MC2 ]
  masses2_4 = [ ZERO2, MC2, MC2 ]
  masses2_5 = [ MT2, MT2, MT2 ]
  masses2_6 = [ ZERO2, ZERO2, MC2 ]
  masses2_7 = [ ZERO2, MC2, MC2, MC2 ]
  masses2_8 = [ ZERO2, ZERO2, MC2, MC2 ]
  ...
  call TI_call(2, momenta_7, masses2_6, T2sum(:,4), M2)
  ...
  call TI_call(3, momenta_3, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_3, masses2_2, T3sum(:,3), M2)
  call TI_call(3, momenta_11, masses2_7, T3sum(:,4), M2)
  ...
  call channel_off(channel_number_bbhj_ccxhg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_bbhj_ccxhg_1_/**/REALKIND
