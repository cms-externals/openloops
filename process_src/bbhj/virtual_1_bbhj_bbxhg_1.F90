...
module ol_vamp_1_bbhj_bbxhg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_bbhj_bbxhg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_bbhj_bbxhg_1.
! **********************************************************************
...
#endif
  use ol_loop_bbhj_bbxhg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_bbhj_bbxhg_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_A_Q(G0(:,:,:,11),Q(:,10),MB,G1(:,:,:,23))
  call loop_AS_Q(G1(:,:,:,23),wf(:,-2),G1(:,:,:,24),gH)
  call loop_A_Q(G1(:,:,:,24),Q(:,14),MB,G2(:,:,:,20))
...
end module ol_vamp_1_bbhj_bbxhg_1_/**/REALKIND
