...
module ol_versiondata_pptajj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptajj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptajj
  end interface
end module ol_versiondata_pptajj


subroutine ol_version_pptajj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptajj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptajj
