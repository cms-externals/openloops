...
module ol_versiondata_pptzjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptzjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptzjj
  end interface
end module ol_versiondata_pptzjj


subroutine ol_version_pptzjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptzjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptzjj
