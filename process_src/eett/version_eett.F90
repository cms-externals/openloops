...
module ol_versiondata_eett
  implicit none
  character(4) :: generator_revision = "1497"
  interface
    subroutine version_eett(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_eett
  end interface
end module ol_versiondata_eett


subroutine ol_version_eett(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_eett, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_eett
