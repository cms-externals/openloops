...
module ol_colourmatrix_ppwjj_ckm_cccxbxw_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_cccxbxw_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_cccxbxw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_cccxbxw_1_/**/REALKIND

module ol_loop_ppwjj_ckm_cccxbxw_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,18),Q(:,18),MB,1_intkind1,wf(:,19))
  ...
  call counter_Q_A(ctbb,wf(:,3),Q(:,18),wf(:,31))
  call prop_A_Q(wf(:,4),Q(:,13),MB,1_intkind1,wf(:,32))
  ...
  call counter_Q_A(ctbb,wf(:,10),Q(:,17),wf(:,37))
  call prop_A_Q(wf(:,36),Q(:,14),MB,1_intkind1,wf(:,38))
...
end module ol_loop_ppwjj_ckm_cccxbxw_1_/**/REALKIND
