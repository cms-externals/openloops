...
module ol_vamp_1_ppwjj_ckm_cxdbbxwx_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppwjj_ckm_cxdbbxwx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppwjj_ckm_cxdbbxwx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppwjj_ckm_cxdbbxwx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppwjj_ckm_cxdbbxwx_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_VQ_A(G1(:,:,:,3),wf(:,6),G1(:,:,:,5))
  call loop_Q_A(G1(:,:,:,5),Q(:,30),ZERO,G2(:,:,:,3))
  call check_last_QA_V(l_switch,G2(:,:,:,3),wf(:,0),G2tensor(:,3))
  call loop_VQ_A(G1(:,:,:,3),wf(:,-1),G1(:,:,:,6))
  call loop_Q_A(G1(:,:,:,6),Q(:,14),ZERO,G2(:,:,:,4))
  ...
  call loop_Q_A(G0(:,:,:,3),Q(:,18),ZERO,G1(:,:,:,7))
  call loop_QV_A(G1(:,:,:,7),wf(:,2),G1(:,:,:,8))
  call loop_Q_A(G1(:,:,:,8),Q(:,30),ZERO,G2(:,:,:,6))
  call check_last_QA_V(l_switch,G2(:,:,:,6),wf(:,0),G2tensor(:,4))
  call check_last_QA_V(l_switch,G1(:,:,:,7),wf(:,23),G1tensor(:,2))
  call loop_VA_Q(G0(:,:,:,1),wf(:,23),G0(:,:,:,4))
  call loop_A_Q(G0(:,:,:,4),Q(:,13),ZERO,G1(:,:,:,9))
  call loop_AW_Q(G1(:,:,:,9),wf(:,-4),G1(:,:,:,10))
  call loop_A_Q(G1(:,:,:,10),Q(:,29),ZERO,G2(:,:,:,7))
  call check_last_AQ_V(l_switch,G2(:,:,:,7),wf(:,-1),G2tensor(:,5))
  call loop_VQ_A(G0(:,:,:,1),wf(:,19),G0(:,:,:,5))
  call loop_Q_A(G0(:,:,:,5),Q(:,14),ZERO,G1(:,:,:,11))
  call loop_QW_A(G1(:,:,:,11),wf(:,-4),G1(:,:,:,12))
  call loop_Q_A(G1(:,:,:,12),Q(:,30),ZERO,G2(:,:,:,8))
  call check_last_QA_V(l_switch,G2(:,:,:,8),wf(:,0),G2tensor(:,6))
  call loop_VQ_A(G0(:,:,:,1),wf(:,-1),G0(:,:,:,6))
  call loop_Q_A(G0(:,:,:,6),Q(:,2),ZERO,G1(:,:,:,13))
  call loop_QV_A(G1(:,:,:,13),wf(:,2),G1(:,:,:,14))
  call loop_Q_A(G1(:,:,:,14),Q(:,14),ZERO,G2(:,:,:,9))
  call loop_QW_A(G2(:,:,:,9),wf(:,-4),G2(:,:,:,10))
  call loop_Q_A(G2(:,:,:,10),Q(:,30),ZERO,G3(:,:,:,2))
  call check_last_QA_V(l_switch,G3(:,:,:,2),wf(:,0),G3tensor(:,2))
  call loop_QW_A(G1(:,:,:,13),wf(:,-4),G1(:,:,:,15))
  call loop_Q_A(G1(:,:,:,15),Q(:,18),ZERO,G2(:,:,:,11))
  ...
  call loop_A_Q(G1(:,:,:,17),Q(:,27),MB,G2(:,:,:,13))
  ...
  call check_last_AQ_V(l_switch,G2(:,:,:,14),wf(:,-1),G2tensor(:,8))
  call loop_VQ_A(G1(:,:,:,18),wf(:,6),G1(:,:,:,20))
  call loop_Q_A(G1(:,:,:,20),Q(:,30),ZERO,G2(:,:,:,15))
  call check_last_QA_V(l_switch,G2(:,:,:,15),wf(:,0),G2tensor(:,9))
  call loop_VQ_A(G1(:,:,:,18),wf(:,-1),G1(:,:,:,21))
  call loop_Q_A(G1(:,:,:,21),Q(:,14),ZERO,G2(:,:,:,16))
  ...
  call loop_A_Q(G1(:,:,:,22),Q(:,27),MB,G2(:,:,:,18))
  ...
  call loop_A_Q(G1(:,:,:,24),Q(:,27),MB,G2(:,:,:,19))
  ...
  call loop_Q_A(G0(:,:,:,8),Q(:,4),MB,G1(:,:,:,25))
  call loop_QA_V(G1(:,:,:,25),wf(:,-3),G1(:,:,:,26))
  call loop_VA_Q(G1(:,:,:,26),wf(:,3),G1(:,:,:,27))
  call loop_A_Q(G1(:,:,:,27),Q(:,29),ZERO,G2(:,:,:,20))
  call check_last_AQ_V(l_switch,G2(:,:,:,20),wf(:,-1),G2tensor(:,13))
  call loop_VQ_A(G1(:,:,:,26),wf(:,6),G1(:,:,:,28))
  call loop_Q_A(G1(:,:,:,28),Q(:,30),ZERO,G2(:,:,:,21))
  call check_last_QA_V(l_switch,G2(:,:,:,21),wf(:,0),G2tensor(:,14))
  call loop_VQ_A(G1(:,:,:,26),wf(:,-1),G1(:,:,:,29))
  call loop_Q_A(G1(:,:,:,29),Q(:,14),ZERO,G2(:,:,:,22))
  ...
  call loop_A_Q(G1(:,:,:,31),Q(:,27),MB,G2(:,:,:,24))
...
end module ol_vamp_1_ppwjj_ckm_cxdbbxwx_1_/**/REALKIND
