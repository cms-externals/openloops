...
! **********************************************************************
module ol_tensor_sum_storage_ppwjj_ckm_cccxbxw_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwjj_ckm_cccxbxw_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwjj_ckm_cccxbxw_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppwjj_ckm_cccxbxw_1, only: channel_number_ppwjj_ckm_cccxbxw_1
  ...
  call channel_on(channel_number_ppwjj_ckm_cccxbxw_1)
  M2 = 0
  ...
  momenta_19(:,1) = Q(1:4,25)
  momenta_19(:,2) = Q(1:4,29)
  momenta_20(:,1) = Q(1:4,26)
  momenta_20(:,2) = Q(1:4,30)
  momenta_21(:,1) = Q(1:4,2)
  momenta_21(:,2) = Q(1:4,6)
  ...
  momenta_32(:,1) = Q(1:4,17)
  momenta_32(:,2) = Q(1:4,25)
  momenta_32(:,3) = Q(1:4,29)
  momenta_33(:,1) = Q(1:4,18)
  ...
  masses2_14 = [ ZERO2, ZERO2, ZERO2, MB2, ZERO2 ]
  ...
  call TI_call(2, momenta_6, masses2_7, T2sum(:,12), M2)
  call TI_call(2, momenta_19, masses2_7, T2sum(:,13), M2)
  call TI_call(2, momenta_30, masses2_9, T2sum(:,14), M2)
  call TI_call(2, momenta_32, masses2_9, T2sum(:,15), M2)
  call TI_call(2, momenta_7, masses2_7, T2sum(:,16), M2)
  call TI_call(2, momenta_20, masses2_7, T2sum(:,17), M2)
  call TI_call(2, momenta_31, masses2_9, T2sum(:,18), M2)
  call TI_call(2, momenta_33, masses2_9, T2sum(:,19), M2)
  call TI_call(2, momenta_22, masses2_11, T2sum(:,20), M2)
  call TI_call(2, momenta_21, masses2_11, T2sum(:,21), M2)
  call TI_call(2, momenta_34, masses2_11, T2sum(:,22), M2)
  call TI_call(2, momenta_23, masses2_11, T2sum(:,23), M2)
  ...
  call TI_call(3, momenta_26, masses2_8, T3sum(:,1), M2)
  call TI_call(3, momenta_28, masses2_9, T3sum(:,2), M2)
  call TI_call(3, momenta_24, masses2_10, T3sum(:,3), M2)
  call TI_call(3, momenta_27, masses2_8, T3sum(:,4), M2)
  call TI_call(3, momenta_29, masses2_9, T3sum(:,5), M2)
  call TI_call(3, momenta_25, masses2_10, T3sum(:,6), M2)
  ...
  call TI_call(3, momenta_37, masses2_14, T3sum(:,10), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppwjj_ckm_cccxbxw_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwjj_ckm_cccxbxw_1_/**/REALKIND
