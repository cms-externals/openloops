...
module ol_colourmatrix_ppwjj_ckm_usxbbxw_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_usxbbxw_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_usxbbxw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_usxbbxw_1_/**/REALKIND

module ol_loop_ppwjj_ckm_usxbbxw_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*ctGbb*eQED*gQCD**4*VCKMsu)/(sqrt2*sw)
...
end module ol_loop_ppwjj_ckm_usxbbxw_1_/**/REALKIND
