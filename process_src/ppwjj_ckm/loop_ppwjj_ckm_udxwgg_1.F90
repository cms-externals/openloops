...
module ol_colourmatrix_ppwjj_ckm_udxwgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_udxwgg_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_udxwgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_udxwgg_1_/**/REALKIND

module ol_loop_ppwjj_ckm_udxwgg_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*eQED*gQCD**4*VCKMdu)/(sqrt2*sw)
    f( 4) = (countertermnorm*eQED*gQCD**4*VCKMdu)/(sqrt2*sw)
    f( 5) = (CI*countertermnorm*ctGqq*eQED*gQCD**4*VCKMdu)/(sqrt2*sw)
    f( 6) = (countertermnorm*ctGqq*eQED*gQCD**4*VCKMdu)/(sqrt2*sw)
    f( 7) = (CI*countertermnorm*ctVqq*eQED*gQCD**4*VCKMdu)/(sqrt2*sw)
    f( 8) = (countertermnorm*ctVqq*eQED*gQCD**4*VCKMdu)/(sqrt2*sw)
    f( 9) = (countertermnorm*ctVVV*eQED*gQCD**4*VCKMdu)/(sqrt2*sw)
    f(10) = (CI*eQED*gQCD**4*integralnorm*SwB*VCKMdu)/(2._/**/REALKIND*sqrt2*sw)
    f(11) = (CI*eQED*gQCD**4*integralnorm*SwB*VCKMdu)/(sqrt2*sw)
    f(12) = (eQED*gQCD**4*integralnorm*SwB*VCKMdu)/(sqrt2*sw)
    f(13) = (CI*eQED*gQCD**4*integralnorm*SwF*VCKMdu)/(sqrt2*sw)
    f(14) = (2*CI*eQED*gQCD**4*integralnorm*SwF*VCKMdu)/(sqrt2*sw)
    f(15) = (eQED*gQCD**4*integralnorm*SwF*VCKMdu)/(sqrt2*sw)
    f(16) = (2*eQED*gQCD**4*integralnorm*SwF*VCKMdu)/(sqrt2*sw)
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,46),Q(:,5),ZERO,0_intkind1,wf(:,47))
  ...
  call prop_A_Q(wf(:,60),Q(:,26),ZERO,0_intkind1,wf(:,61))
  ...
  call prop_Q_A(wf(:,20),Q(:,13),ZERO,0_intkind1,wf(:,76))
  call vert_AW_Q(wf(:,4),wf(:,-2),wf(:,77))
  call prop_A_Q(wf(:,77),Q(:,14),ZERO,0_intkind1,wf(:,78))
  call prop_Q_A(wf(:,21),Q(:,21),ZERO,0_intkind1,wf(:,79))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(33)+A(34)+A(41)+A(42)+A(47)+A(48))*f(3)+CI*(A(37)+A(38)+A(43)+A(44))*f(4)+(-A(9)-A(13)-A(19)-A(21)-A(26)-A(28))*f(5) &
       +CI*(-A(17)-A(25))*f(6)+(-A(16)-A(23)-A(30))*f(7)+CI*(-A(24)-A(32))*f(8)+CI*(-A(11)-A(14))*f(9)
  M2(2) = (A(35)+A(36)+A(39)+A(40)+A(45)+A(46))*f(3)+CI*(-A(37)-A(38)-A(43)-A(44))*f(4)+(-A(10)-A(12)-A(18)-A(20)-A(27) &
       -A(29))*f(5)+CI*(A(17)+A(25))*f(6)+(-A(15)-A(22)-A(31))*f(7)+CI*(A(24)+A(32))*f(8)+CI*(A(11)+A(14))*f(9)

end subroutine colourvectors

end module ol_loop_ppwjj_ckm_udxwgg_1_/**/REALKIND
