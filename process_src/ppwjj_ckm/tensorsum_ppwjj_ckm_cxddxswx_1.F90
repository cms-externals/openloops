...
! **********************************************************************
module ol_tensor_sum_storage_ppwjj_ckm_cxddxswx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwjj_ckm_cxddxswx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwjj_ckm_cxddxswx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppwjj_ckm_cxddxswx_1, only: channel_number_ppwjj_ckm_cxddxswx_1
  ...
  call channel_on(channel_number_ppwjj_ckm_cxddxswx_1)
  M2 = 0
  ...
  call TI_call(2, momenta_7, masses2_4, T2sum(:,2), M2)
  call TI_call(2, momenta_10, masses2_4, T2sum(:,3), M2)
  call TI_call(2, momenta_5, masses2_4, T2sum(:,4), M2)
  ...
  call TI_call(2, momenta_17, masses2_5, T2sum(:,9), M2)
  call TI_call(2, momenta_18, masses2_5, T2sum(:,10), M2)
  ...
  call TI_call(3, momenta_16, masses2_5, T3sum(:,2), M2)
  ...
  call channel_off(channel_number_ppwjj_ckm_cxddxswx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwjj_ckm_cxddxswx_1_/**/REALKIND
