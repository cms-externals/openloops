...
! **********************************************************************
module ol_tensor_sum_storage_ppwjj_ckm_cxddxbwx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwjj_ckm_cxddxbwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwjj_ckm_cxddxbwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppwjj_ckm_cxddxbwx_1, only: channel_number_ppwjj_ckm_cxddxbwx_1
  ...
  call channel_on(channel_number_ppwjj_ckm_cxddxbwx_1)
  M2 = 0
  ...
  momenta_18(:,3) = Q(1:4,29)
  momenta_19(:,1) = Q(1:4,2)
  momenta_19(:,2) = Q(1:4,6)
  momenta_19(:,3) = Q(1:4,14)
  momenta_19(:,4) = Q(1:4,30)
  momenta_20(:,1) = Q(1:4,4)
  momenta_20(:,2) = Q(1:4,6)
  ...
  masses2_12 = [ ZERO2, ZERO2, ZERO2, MB2, ZERO2 ]
  ...
  call TI_call(2, momenta_17, masses2_9, T2sum(:,9), M2)
  call TI_call(2, momenta_18, masses2_9, T2sum(:,10), M2)
  call TI_call(2, momenta_12, masses2_11, T2sum(:,11), M2)
  call TI_call(2, momenta_13, masses2_11, T2sum(:,12), M2)
  ...
  call TI_call(3, momenta_15, masses2_8, T3sum(:,1), M2)
  call TI_call(3, momenta_16, masses2_9, T3sum(:,2), M2)
  call TI_call(3, momenta_14, masses2_10, T3sum(:,3), M2)
  call TI_call(3, momenta_19, masses2_12, T3sum(:,4), M2)
  ...
  call channel_off(channel_number_ppwjj_ckm_cxddxbwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwjj_ckm_cxddxbwx_1_/**/REALKIND
