...
module ol_colourmatrix_ppwjj_ckm_udxssxw_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_udxssxw_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_udxssxw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_udxssxw_1_/**/REALKIND

module ol_loop_ppwjj_ckm_udxssxw_1_/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(9)+A(10)+A(11)+A(12))*f(2))/2._/**/REALKIND+((-A(3)-A(4)-A(5)-A(7))*f(3))/2._/**/REALKIND+((-A(6) &
       -A(8))*f(4))/2._/**/REALKIND
  M2(2) = ((-A(9)-A(10)-A(11)-A(12))*f(2))/6._/**/REALKIND+((A(3)+A(4)+A(5)+A(7))*f(3))/6._/**/REALKIND+((A(6) &
       +A(8))*f(4))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppwjj_ckm_udxssxw_1_/**/REALKIND
