...
module ol_colourmatrix_ppwjj_ckm_uxdwxgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_uxdwxgg_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_uxdwxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_uxdwxgg_1_/**/REALKIND

module ol_loop_ppwjj_ckm_uxdwxgg_1_/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(35)-A(36)-A(39)-A(40)-A(45)-A(46))*f(3)+CI*(-A(37)-A(38)-A(43)-A(44))*f(4)+(A(10)+A(12)+A(18)+A(20)+A(27) &
       +A(29))*f(5)+CI*(A(17)+A(25))*f(6)+(A(15)+A(22)+A(31))*f(7)+CI*(A(24)+A(32))*f(8)+CI*(A(11)+A(14))*f(9)
  M2(2) = (-A(33)-A(34)-A(41)-A(42)-A(47)-A(48))*f(3)+CI*(A(37)+A(38)+A(43)+A(44))*f(4)+(A(9)+A(13)+A(19)+A(21)+A(26)+A(28))*f(5) &
       +CI*(-A(17)-A(25))*f(6)+(A(16)+A(23)+A(30))*f(7)+CI*(-A(24)-A(32))*f(8)+CI*(-A(11)-A(14))*f(9)

end subroutine colourvectors

end module ol_loop_ppwjj_ckm_uxdwxgg_1_/**/REALKIND
