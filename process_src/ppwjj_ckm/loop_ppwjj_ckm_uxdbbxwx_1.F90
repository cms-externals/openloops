...
module ol_colourmatrix_ppwjj_ckm_uxdbbxwx_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_uxdbbxwx_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_uxdbbxwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_uxdbbxwx_1_/**/REALKIND

module ol_loop_ppwjj_ckm_uxdbbxwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctqq,wf(:,6),Q(:,18),wf(:,22))
...
end module ol_loop_ppwjj_ckm_uxdbbxwx_1_/**/REALKIND
