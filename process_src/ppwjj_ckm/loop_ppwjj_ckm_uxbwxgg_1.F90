...
module ol_colourmatrix_ppwjj_ckm_uxbwxgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_uxbwxgg_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_uxbwxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_uxbwxgg_1_/**/REALKIND

module ol_loop_ppwjj_ckm_uxbwxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,1),Q(:,5),MB,1_intkind1,wf(:,3))
  call prop_Q_A(wf(:,2),Q(:,10),MB,1_intkind1,wf(:,4))
  call vert_AV_Q(wf(:,3),wf(:,-4),wf(:,5))
  call vert_VQ_A(wf(:,-4),wf(:,-1),wf(:,6))
  call prop_Q_A(wf(:,6),Q(:,18),MB,1_intkind1,wf(:,7))
  ...
  call prop_Q_A(wf(:,30),Q(:,18),MB,1_intkind1,wf(:,31))
  call counter_VQ_A(wf(:,-3),wf(:,-1),wf(:,32))
  call prop_Q_A(wf(:,32),Q(:,10),MB,1_intkind1,wf(:,33))
  ...
  call prop_A_Q(wf(:,46),Q(:,5),MB,1_intkind1,wf(:,47))
  ...
  call counter_A_Q(ctbb,wf(:,3),Q(:,5),wf(:,52))
  call prop_Q_A(wf(:,51),Q(:,26),MB,1_intkind1,wf(:,53))
  call counter_Q_A(ctbb,wf(:,4),Q(:,10),wf(:,54))
  call prop_A_Q(wf(:,5),Q(:,21),MB,1_intkind1,wf(:,55))
  call vert_VQ_A(wf(:,-3),wf(:,7),wf(:,56))
  call prop_Q_A(wf(:,56),Q(:,26),MB,1_intkind1,wf(:,57))
  call counter_Q_A(ctbb,wf(:,7),Q(:,18),wf(:,58))
  call prop_A_Q(wf(:,8),Q(:,13),MB,1_intkind1,wf(:,59))
  call vert_VQ_A(wf(:,9),wf(:,-1),wf(:,60))
  call prop_Q_A(wf(:,60),Q(:,26),MB,1_intkind1,wf(:,61))
  call counter_V_V(ctGG,wf(:,9),Q(:,24),wf(:,62))
  call vert_VQ_A(wf(:,-4),wf(:,14),wf(:,63))
  call counter_A_Q(ctqq,wf(:,13),Q(:,9),wf(:,64))
  call prop_Q_A(wf(:,63),Q(:,22),ZERO,0_intkind1,wf(:,65))
  call counter_Q_A(ctqq,wf(:,14),Q(:,6),wf(:,66))
  call prop_A_Q(wf(:,15),Q(:,25),ZERO,0_intkind1,wf(:,67))
  call vert_VQ_A(wf(:,-3),wf(:,14),wf(:,68))
  call counter_A_Q(ctqq,wf(:,17),Q(:,17),wf(:,69))
  ...
  call prop_A_Q(wf(:,20),Q(:,13),MB,1_intkind1,wf(:,76))
  call vert_WQ_A(wf(:,-2),wf(:,4),wf(:,77))
  call prop_Q_A(wf(:,77),Q(:,14),ZERO,0_intkind1,wf(:,78))
  call prop_A_Q(wf(:,21),Q(:,21),MB,1_intkind1,wf(:,79))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(35)-A(36)-A(39)-A(40)-A(45)-A(46))*f(3)+CI*(-A(37)-A(38)-A(43)-A(44))*f(4)+(A(10)+A(18)+A(20))*f(5)+CI*A(17)*f(6) &
       +(A(12)+A(27)+A(29))*f(7)+CI*A(25)*f(8)+(A(15)+A(22)+A(31))*f(9)+CI*(A(24)+A(32))*f(10)+CI*(A(11)+A(14))*f(11)
  M2(2) = (-A(33)-A(34)-A(41)-A(42)-A(47)-A(48))*f(3)+CI*(A(37)+A(38)+A(43)+A(44))*f(4)+(A(9)+A(19)+A(21))*f(5)-CI*A(17)*f(6) &
       +(A(13)+A(26)+A(28))*f(7)-CI*A(25)*f(8)+(A(16)+A(23)+A(30))*f(9)+CI*(-A(24)-A(32))*f(10)+CI*(-A(11)-A(14))*f(11)

end subroutine colourvectors

end module ol_loop_ppwjj_ckm_uxbwxgg_1_/**/REALKIND
