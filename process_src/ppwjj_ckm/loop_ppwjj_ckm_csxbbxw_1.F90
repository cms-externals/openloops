...
module ol_colourmatrix_ppwjj_ckm_csxbbxw_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_csxbbxw_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_csxbbxw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_csxbbxw_1_/**/REALKIND

module ol_loop_ppwjj_ckm_csxbbxw_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*ctGbb*eQED*gQCD**4*VCKMsc)/(sqrt2*sw)
    f( 4) = (CI*countertermnorm*ctGcc*eQED*gQCD**4*VCKMsc)/(sqrt2*sw)
    f( 5) = (CI*countertermnorm*ctGqq*eQED*gQCD**4*VCKMsc)/(sqrt2*sw)
    f( 6) = (CI*countertermnorm*ctVsc*eQED*gQCD**4*VCKMsc)/(sqrt2*sw)
    f( 7) = (CI*eQED*gQCD**4*integralnorm*SwB*VCKMsc)/(sqrt2*sw)
    f( 8) = (eQED*gQCD**4*integralnorm*SwB*VCKMsc)/(sqrt2*sw*2._/**/REALKIND)
    f( 9) = (eQED*gQCD**4*integralnorm*SwB*VCKMsc)/(sqrt2*sw)
    f(10) = (eQED*gQCD**4*integralnorm*SwF*VCKMsc)/(sqrt2*sw)
    f(11) = (2*eQED*gQCD**4*integralnorm*SwF*VCKMsc)/(sqrt2*sw)
...
end module ol_loop_ppwjj_ckm_csxbbxw_1_/**/REALKIND
