...
module ol_colourmatrix_ppwjj_ckm_cxbwxggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjj_ckm_cxbwxggg_1_/**/REALKIND



module ol_forced_parameters_ppwjj_ckm_cxbwxggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjj_ckm_cxbwxggg_1_/**/REALKIND

module ol_tree_ppwjj_ckm_cxbwxggg_1_/**/REALKIND
...
subroutine factors_init()
  ...
  ! factors of the diagrams
    f(1) = (CI*eQED*gQCD**3*VCKMbc)/(sqrt2*sw)
    f(2) = (eQED*gQCD**3*VCKMbc)/(sqrt2*sw)
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppwjj_ckm_cxbwxggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppwjj_ckm_cxbwxggg_1_/**/DREALKIND, only: &
    & ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for anti-charm bottom W+ glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppwjj_ckm_cxbwxggg_1, only: &
    & external_perm_ppwjj_ckm_cxbwxggg_1, &
    & external_perm_inv_ppwjj_ckm_cxbwxggg_1, &
    & extcomb_perm_ppwjj_ckm_cxbwxggg_1, &
    & average_factor_ppwjj_ckm_cxbwxggg_1
  use ol_external_ppwjj_ckm_cxbwxggg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_ppwjj_ckm_cxbwxggg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppwjj_ckm_cxbwxggg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_ppwjj_ckm_cxbwxggg_1
  ...
  extmasses2 = [ rZERO2, rMB2, rMW2, rZERO2, rZERO2, rZERO2 ]
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_ppwjj_ckm_cxbwxggg_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppwjj_ckm_cxbwxggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppwjj_ckm_cxbwxggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppwjj_ckm_cxbwxggg_1(extcombs(k))
  end do
  ...
  call vert_AW_Q(ntry, ex1, ex3, wf6(:,1), n3(:,1), t3x6(:,:,1))
  call vert_GGG_G(ntry, ex4, ex5, ex6, wf8(:,1), n4(:,1), t4x8(:,:,1))
  call prop_A_Q(ntry, wf6(:,1), Q(:,5), MB, 1_intkind1, wf6(:,2), n2(1))
  call vert_QA_V(ntry, ex2, wf6(:,2), wf12(:,1), n3(:,2), t3x12(:,:,1))
  call vert_GGG_G(ntry, ex5, ex6, ex4, wf8(:,2), n4(:,2), t4x8(:,:,2))
  call vert_GGG_G(ntry, ex6, ex4, ex5, wf8(:,3), n4(:,3), t4x8(:,:,3))
  call vert_WQ_A(ntry, ex3, ex2, wf6(:,3), n3(:,3), t3x6(:,:,2))
  call prop_Q_A(ntry, wf6(:,3), Q(:,6), ZERO, 0_intkind1, wf6(:,4), n2(2))
  call vert_QA_V(ntry, wf6(:,4), ex1, wf12(:,2), n3(:,4), t3x12(:,:,2))
  call vert_VQ_A(ntry, ex4, ex2, wf4(:,1), n3(:,5), t3x4(:,:,1))
  call vert_UV_W(ntry, ex5, Q(:,16), ex6, Q(:,32), wf4(:,2), n3(:,6), t3x4(:,:,2))
  call prop_Q_A(ntry, wf4(:,1), Q(:,10), MB, 1_intkind1, wf4(:,3), n2(3))
  call vert_QA_V(ntry, wf4(:,3), wf6(:,2), wf24(:,1), n3(:,7), t3x24(:,:,1))
  call vert_AV_Q(ntry, wf6(:,2), ex5, wf12(:,3), n3(:,8), t3x12(:,:,3))
  call vert_VQ_A(ntry, ex6, wf4(:,3), wf8(:,4), n3(:,9), t3x8(:,:,1))
  call prop_A_Q(ntry, wf12(:,3), Q(:,21), MB, 1_intkind1, wf12(:,4), n2(4))
  call vert_VQ_A(ntry, ex5, wf4(:,3), wf8(:,5), n3(:,10), t3x8(:,:,2))
  call vert_AV_Q(ntry, wf6(:,2), ex6, wf12(:,5), n3(:,11), t3x12(:,:,4))
  call prop_Q_A(ntry, wf8(:,5), Q(:,26), MB, 1_intkind1, wf8(:,6), n2(5))
  call vert_VQ_A(ntry, ex5, ex2, wf4(:,4), n3(:,12), t3x4(:,:,3))
  call vert_UV_W(ntry, ex4, Q(:,8), ex6, Q(:,32), wf4(:,5), n3(:,13), t3x4(:,:,4))
  call prop_Q_A(ntry, wf4(:,4), Q(:,18), MB, 1_intkind1, wf4(:,6), n2(6))
  call vert_QA_V(ntry, wf4(:,6), wf6(:,2), wf24(:,2), n3(:,14), t3x24(:,:,2))
  call vert_AV_Q(ntry, wf6(:,2), ex4, wf12(:,6), n3(:,15), t3x12(:,:,5))
  call vert_VQ_A(ntry, ex6, wf4(:,6), wf8(:,7), n3(:,16), t3x8(:,:,3))
  call prop_A_Q(ntry, wf12(:,6), Q(:,13), MB, 1_intkind1, wf12(:,7), n2(7))
  call vert_VQ_A(ntry, ex4, wf4(:,6), wf8(:,8), n3(:,17), t3x8(:,:,4))
  call prop_Q_A(ntry, wf8(:,8), Q(:,26), MB, 1_intkind1, wf8(:,9), n2(8))
  call vert_VQ_A(ntry, ex6, ex2, wf4(:,7), n3(:,18), t3x4(:,:,5))
  call vert_UV_W(ntry, ex4, Q(:,8), ex5, Q(:,16), wf4(:,8), n3(:,19), t3x4(:,:,6))
  call prop_Q_A(ntry, wf4(:,7), Q(:,34), MB, 1_intkind1, wf4(:,9), n2(9))
  call vert_QA_V(ntry, wf4(:,9), wf6(:,2), wf24(:,3), n3(:,20), t3x24(:,:,3))
  call vert_UV_W(ntry, wf4(:,8), Q(:,24), ex6, Q(:,32), wf8(:,10), n3(:,21), t3x8(:,:,5))
  call vert_VQ_A(ntry, wf4(:,8), ex2, wf8(:,11), n3(:,22), t3x8(:,:,6))
  call prop_Q_A(ntry, wf8(:,11), Q(:,26), MB, 1_intkind1, wf8(:,12), n2(10))
  call vert_VQ_A(ntry, ex5, wf4(:,9), wf8(:,13), n3(:,23), t3x8(:,:,7))
  call vert_VQ_A(ntry, ex4, wf4(:,9), wf8(:,14), n3(:,24), t3x8(:,:,8))
  call prop_Q_A(ntry, wf8(:,14), Q(:,42), MB, 1_intkind1, wf8(:,15), n2(11))
  call vert_UV_W(ntry, ex5, Q(:,16), wf4(:,5), Q(:,40), wf8(:,16), n3(:,25), t3x8(:,:,9))
  call vert_VQ_A(ntry, wf4(:,5), ex2, wf8(:,17), n3(:,26), t3x8(:,:,10))
  call prop_Q_A(ntry, wf8(:,17), Q(:,42), MB, 1_intkind1, wf8(:,18), n2(12))
  call vert_UV_W(ntry, ex4, Q(:,8), wf4(:,2), Q(:,48), wf8(:,19), n3(:,27), t3x8(:,:,11))
  call vert_VQ_A(ntry, wf4(:,2), ex2, wf8(:,20), n3(:,28), t3x8(:,:,12))
  call prop_Q_A(ntry, wf8(:,20), Q(:,50), MB, 1_intkind1, wf8(:,21), n2(13))
  call vert_AV_Q(ntry, ex1, ex4, wf4(:,10), n3(:,29), t3x4(:,:,7))
  call prop_A_Q(ntry, wf4(:,10), Q(:,9), ZERO, 0_intkind1, wf4(:,11), n2(14))
  call vert_QA_V(ntry, wf6(:,4), wf4(:,11), wf24(:,4), n3(:,30), t3x24(:,:,4))
  call vert_AV_Q(ntry, wf4(:,11), ex5, wf8(:,22), n3(:,31), t3x8(:,:,13))
  call vert_VQ_A(ntry, ex6, wf6(:,4), wf12(:,8), n3(:,32), t3x12(:,:,6))
  call prop_A_Q(ntry, wf8(:,22), Q(:,25), ZERO, 0_intkind1, wf8(:,23), n2(15))
  call vert_VQ_A(ntry, ex5, wf6(:,4), wf12(:,9), n3(:,33), t3x12(:,:,7))
  call vert_AV_Q(ntry, wf4(:,11), ex6, wf8(:,24), n3(:,34), t3x8(:,:,14))
  call prop_Q_A(ntry, wf12(:,9), Q(:,22), ZERO, 0_intkind1, wf12(:,10), n2(16))
  call vert_AV_Q(ntry, ex1, ex5, wf4(:,12), n3(:,35), t3x4(:,:,8))
  call prop_A_Q(ntry, wf4(:,12), Q(:,17), ZERO, 0_intkind1, wf4(:,13), n2(17))
  call vert_QA_V(ntry, wf6(:,4), wf4(:,13), wf24(:,5), n3(:,36), t3x24(:,:,5))
  call vert_AV_Q(ntry, wf4(:,13), ex4, wf8(:,25), n3(:,37), t3x8(:,:,15))
  call prop_A_Q(ntry, wf8(:,25), Q(:,25), ZERO, 0_intkind1, wf8(:,26), n2(18))
  call vert_VQ_A(ntry, ex4, wf6(:,4), wf12(:,11), n3(:,38), t3x12(:,:,8))
  call vert_AV_Q(ntry, wf4(:,13), ex6, wf8(:,27), n3(:,39), t3x8(:,:,16))
  call prop_Q_A(ntry, wf12(:,11), Q(:,14), ZERO, 0_intkind1, wf12(:,12), n2(19))
  call vert_AV_Q(ntry, ex1, ex6, wf4(:,14), n3(:,40), t3x4(:,:,9))
  call prop_A_Q(ntry, wf4(:,14), Q(:,33), ZERO, 0_intkind1, wf4(:,15), n2(20))
  call vert_QA_V(ntry, wf6(:,4), wf4(:,15), wf24(:,6), n3(:,41), t3x24(:,:,6))
  call vert_AV_Q(ntry, ex1, wf4(:,8), wf8(:,28), n3(:,42), t3x8(:,:,17))
  call prop_A_Q(ntry, wf8(:,28), Q(:,25), ZERO, 0_intkind1, wf8(:,29), n2(21))
  call vert_AV_Q(ntry, wf4(:,15), ex4, wf8(:,30), n3(:,43), t3x8(:,:,18))
  call prop_A_Q(ntry, wf8(:,30), Q(:,41), ZERO, 0_intkind1, wf8(:,31), n2(22))
  call vert_AV_Q(ntry, wf4(:,15), ex5, wf8(:,32), n3(:,44), t3x8(:,:,19))
  call vert_AV_Q(ntry, ex1, wf4(:,5), wf8(:,33), n3(:,45), t3x8(:,:,20))
  call prop_A_Q(ntry, wf8(:,33), Q(:,41), ZERO, 0_intkind1, wf8(:,34), n2(23))
  call vert_AV_Q(ntry, ex1, wf4(:,2), wf8(:,35), n3(:,46), t3x8(:,:,21))
  call prop_A_Q(ntry, wf8(:,35), Q(:,49), ZERO, 0_intkind1, wf8(:,36), n2(24))
  call vert_AW_Q(ntry, wf4(:,11), ex3, wf12(:,13), n3(:,47), t3x12(:,:,9))
  call prop_A_Q(ntry, wf12(:,13), Q(:,13), MB, 1_intkind1, wf12(:,14), n2(25))
  call vert_WQ_A(ntry, ex3, wf4(:,6), wf12(:,15), n3(:,48), t3x12(:,:,10))
  call prop_Q_A(ntry, wf12(:,15), Q(:,22), ZERO, 0_intkind1, wf12(:,16), n2(26))
  call vert_WQ_A(ntry, ex3, wf4(:,9), wf12(:,17), n3(:,49), t3x12(:,:,11))
  call prop_Q_A(ntry, wf12(:,17), Q(:,38), ZERO, 0_intkind1, wf12(:,18), n2(27))
  call vert_AW_Q(ntry, wf4(:,13), ex3, wf12(:,19), n3(:,50), t3x12(:,:,12))
  call prop_A_Q(ntry, wf12(:,19), Q(:,21), MB, 1_intkind1, wf12(:,20), n2(28))
  call vert_WQ_A(ntry, ex3, wf4(:,3), wf12(:,21), n3(:,51), t3x12(:,:,13))
  call prop_Q_A(ntry, wf12(:,21), Q(:,14), ZERO, 0_intkind1, wf12(:,22), n2(29))
  call vert_AW_Q(ntry, wf4(:,15), ex3, wf12(:,23), n3(:,52), t3x12(:,:,14))
  call prop_A_Q(ntry, wf12(:,23), Q(:,37), MB, 1_intkind1, wf12(:,24), n2(30))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_ppwjj_ckm_cxbwxggg_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_ppwjj_ckm_cxbwxggg_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_ppwjj_ckm_cxbwxggg_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = (A(j,1)%j-A(j,2)%j+A(j,4)%j-A(j,5)%j+A(j,14)%j+A(j,16)%j+A(j,20)%j+A(j,23)%j+A(j,29)%j+A(j,35)%j+A(j,39)%j &
       +A(j,40)%j)*f(1)+CI*(A(j,13)%j+A(j,21)%j+A(j,22)%j+A(j,30)%j+A(j,41)%j+A(j,54)%j)*f(2)
  M1(2) = (A(j,2)%j-A(j,3)%j+A(j,5)%j-A(j,6)%j+A(j,11)%j-A(j,18)%j-A(j,20)%j+A(j,24)%j-A(j,33)%j-A(j,35)%j+A(j,37)%j &
       +A(j,38)%j)*f(1)+CI*(A(j,10)%j-A(j,21)%j-A(j,22)%j+A(j,34)%j-A(j,41)%j+A(j,52)%j)*f(2)
  M1(3) = (-A(j,1)%j+A(j,3)%j-A(j,4)%j+A(j,6)%j-A(j,14)%j+A(j,17)%j+A(j,18)%j+A(j,26)%j-A(j,29)%j+A(j,33)%j+A(j,47)%j &
       +A(j,48)%j)*f(1)+CI*(-A(j,13)%j+A(j,19)%j+A(j,25)%j-A(j,30)%j+A(j,49)%j-A(j,54)%j)*f(2)
  M1(4) = (A(j,2)%j-A(j,3)%j+A(j,5)%j-A(j,6)%j+A(j,8)%j-A(j,18)%j-A(j,20)%j+A(j,27)%j-A(j,33)%j-A(j,35)%j+A(j,42)%j &
       +A(j,43)%j)*f(1)+CI*(A(j,7)%j-A(j,19)%j-A(j,25)%j+A(j,36)%j+A(j,46)%j-A(j,49)%j)*f(2)
  M1(5) = (-A(j,1)%j+A(j,3)%j-A(j,4)%j+A(j,6)%j+A(j,12)%j-A(j,14)%j+A(j,18)%j-A(j,29)%j+A(j,31)%j+A(j,33)%j+A(j,50)%j &
       +A(j,51)%j)*f(1)+CI*(-A(j,10)%j+A(j,15)%j+A(j,28)%j-A(j,34)%j-A(j,52)%j+A(j,53)%j)*f(2)
  M1(6) = (A(j,1)%j-A(j,2)%j+A(j,4)%j-A(j,5)%j+A(j,9)%j+A(j,14)%j+A(j,20)%j+A(j,29)%j+A(j,32)%j+A(j,35)%j+A(j,44)%j &
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppwjj_ckm_cxbwxggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppwjj_ckm_cxbwxggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppwjj_ckm_cxbwxggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppwjj_ckm_cxbwxggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppwjj_ckm_cxbwxggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppwjj_ckm_cxbwxggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppwjj_ckm_cxbwxggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppwjj_ckm_cxbwxggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppwjj_ckm_cxbwxggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppwjj_ckm_cxbwxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppwjj_ckm_cxbwxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppwjj_ckm_cxbwxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppwjj_ckm_cxbwxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppwjj_ckm_cxbwxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppwjj_ckm_cxbwxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppwjj_ckm_cxbwxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppwjj_ckm_cxbwxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_ppwjj_ckm_cxbwxggg_1_/**/REALKIND
