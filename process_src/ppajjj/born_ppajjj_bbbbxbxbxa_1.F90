...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppajjj_bbbbxbxbxa_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
...
! **********************************************************************
  ...
  use ol_external_ppajjj_bbbbxbxbxa_1, only: external_perm_ppajjj_bbbbxbxbxa_1, &
    & external_perm_inv_ppajjj_bbbbxbxbxa_1, extcomb_perm_ppajjj_bbbbxbxbxa_1, &
    & average_factor_ppajjj_bbbbxbxbxa_1
  use ol_external_ppajjj_bbbbxbxbxa_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppajjj_bbbbxbxbxa_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppajjj_bbbbxbxbxa_1_/**/REALKIND, only: check_forced_parameters
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppajjj_bbbbxbxbxa_1,7)
