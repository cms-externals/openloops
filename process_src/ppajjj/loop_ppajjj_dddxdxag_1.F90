...
module ol_colourmatrix_ppajjj_dddxdxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppajjj_dddxdxag_1_/**/REALKIND



module ol_forced_parameters_ppajjj_dddxdxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajjj_dddxdxag_1_/**/REALKIND

module ol_loop_ppajjj_dddxdxag_1_/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(273)+A(274)+A(277)+A(278)+A(279)+A(280)+A(287)+A(288)+A(289)+A(293)+A(294)+A(295)+A(305)+A(308)+A(310)+A(314)+A(315) &
       +A(316)+A(347)+A(348)+A(349)+A(354)+A(355)+A(358)+A(365)+A(366)+A(367)+A(384)+A(386)+A(387))*f(3))/2._/**/REALKIND+((A(317) &
       +A(318)+A(319)+A(321)+A(322)+A(325)+A(326)+A(327)+A(328)+A(329)+A(331)+A(334)+A(335)+A(336)+A(337)+A(338)+A(339)+A(340) &
       +A(353)+A(356)+A(357)+A(359)+A(360)+A(361)+A(377)+A(378)+A(379)+A(383)+A(385)+A(388))*f(3))/6._/**/REALKIND+((-A(49) &
  ...
  M2(2) = ((-A(293)-A(294)-A(295)-A(296)-A(299)-A(300)-A(302)-A(303)-A(304)-A(305)-A(308)-A(310)-A(311)-A(312)-A(313)-A(314) &
       -A(315)-A(316)-A(342)-A(343)-A(346)-A(347)-A(348)-A(349)-A(380)-A(381)-A(382)-A(384)-A(386)-A(387))*f(3))/6._/**/REALKIND &
       +((-A(248)-A(251)-A(252)-A(254)-A(255)-A(256)-A(263)-A(264)-A(265)-A(317)-A(318)-A(319)-A(329)-A(331)-A(334)-A(338)-A(339) &
       -A(340)-A(341)-A(344)-A(345)-A(359)-A(360)-A(361)-A(368)-A(369)-A(370)-A(383)-A(385)-A(388))*f(3))/2._/**/REALKIND &
       ...
       +A(242))*f(7))/2._/**/REALKIND+((A(59)+A(66)+A(100)+A(115)+A(131)+A(146)+A(155)+A(179)+A(210)+A(225))*f(8))/2._/**/REALKIND &
       +((A(91)+A(92)+A(114)+A(116)+A(122)+A(123)+A(162)+A(163)+A(226)+A(227))*f(8))/6._/**/REALKIND+(CI*(A(68)-A(132)+A(156) &
       -A(211))*f(9))/2._/**/REALKIND+(CI*(A(55)+A(58)-A(94)-A(98))*f(10))/2._/**/REALKIND
  M2(3) = ((-A(269)-A(270)-A(271)-A(273)-A(274)-A(277)-A(278)-A(279)-A(280)-A(281)-A(283)-A(286)-A(287)-A(288)-A(289)-A(290) &
       -A(291)-A(292)-A(354)-A(355)-A(358)-A(362)-A(363)-A(364)-A(365)-A(366)-A(367)-A(372)-A(374)-A(375))*f(3))/6._/**/REALKIND &
       +((-A(245)-A(246)-A(247)-A(257)-A(260)-A(262)-A(266)-A(267)-A(268)-A(321)-A(322)-A(325)-A(326)-A(327)-A(328)-A(335)-A(336) &
       -A(337)-A(350)-A(351)-A(352)-A(353)-A(356)-A(357)-A(371)-A(373)-A(376)-A(377)-A(378)-A(379))*f(3))/2._/**/REALKIND &
  ...
  M2(4) = ((A(245)+A(246)+A(247)+A(248)+A(251)+A(252)+A(254)+A(255)+A(256)+A(257)+A(260)+A(262)+A(263)+A(264)+A(265)+A(266)+A(267) &
       +A(268)+A(341)+A(344)+A(345)+A(350)+A(351)+A(352)+A(368)+A(369)+A(370)+A(371)+A(373)+A(376))*f(3))/6._/**/REALKIND+((A(269) &
       +A(270)+A(271)+A(281)+A(283)+A(286)+A(290)+A(291)+A(292)+A(296)+A(299)+A(300)+A(302)+A(303)+A(304)+A(311)+A(312)+A(313) &
       +A(342)+A(343)+A(346)+A(362)+A(363)+A(364)+A(372)+A(374)+A(375)+A(380)+A(381)+A(382))*f(3))/2._/**/REALKIND+((-A(49) &
       ...
       -A(148)-A(154)-A(155)-A(225)-A(228))*f(8))/6._/**/REALKIND+(CI*(A(84)-A(124)-A(164)+A(203))*f(9))/2._/**/REALKIND &
       +(CI*(A(70)+A(74)-A(87)-A(90))*f(10))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppajjj_dddxdxag_1_/**/REALKIND
