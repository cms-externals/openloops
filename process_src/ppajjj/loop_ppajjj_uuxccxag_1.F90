...
module ol_colourmatrix_ppajjj_uuxccxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppajjj_uuxccxag_1_/**/REALKIND



module ol_forced_parameters_ppajjj_uuxccxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajjj_uuxccxag_1_/**/REALKIND

module ol_loop_ppajjj_uuxccxag_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 6) = (2*CI*countertermnorm*ctGcc*eQED*gQCD**5)/3._/**/REALKIND
    f( 7) = (2*countertermnorm*ctGcc*eQED*gQCD**5)/3._/**/REALKIND
    f( 8) = (2*CI*countertermnorm*ctGqq*eQED*gQCD**5)/3._/**/REALKIND
    f( 9) = (2*countertermnorm*ctGqq*eQED*gQCD**5)/3._/**/REALKIND
    f(10) = (2*CI*countertermnorm*ctVcc*eQED*gQCD**5)/3._/**/REALKIND
    f(11) = (2*countertermnorm*ctVcc*eQED*gQCD**5)/3._/**/REALKIND
    f(12) = (2*CI*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(13) = (2*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,4),Q(:,20),wf(:,140))
  call prop_A_Q(wf(:,139),Q(:,43),ZERO,0_intkind1,wf(:,141))
  call counter_A_Q(ctcc,wf(:,5),Q(:,40),wf(:,142))
  ...
  call counter_Q_A(ctcc,wf(:,19),Q(:,7),wf(:,160))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(147)+A(148)+A(149)+A(151)+A(152)+A(154)+A(156)+A(157)+A(158)+A(160)+A(162)+A(163)+A(165)+A(166)+A(167)+A(168)+A(169) &
       ...
       +A(26))*f(4))/12._/**/REALKIND+((-A(63)-A(64)-A(71)-A(72)-A(75)-A(77)-A(78)-A(80)-A(81)-A(82))*f(6))/6._/**/REALKIND+(( &
  ...
  M2(4) = ((A(123)+A(124)+A(125)+A(126)+A(129)+A(130)+A(132)+A(133)+A(134)+A(135)+A(138)+A(140)+A(141)+A(142)+A(143)+A(144)+A(145) &
       ...
       +A(26))*f(4))/12._/**/REALKIND+((-A(27)-A(28)-A(30)-A(31)-A(36)-A(37)-A(38)-A(39)-A(44)-A(45)-A(46)-A(47)-A(59)-A(60)-A(61) &
       -A(62)-A(67)-A(68)-A(69)-A(70))*f(6))/6._/**/REALKIND+((-A(91)-A(92)-A(107)-A(108)-A(115)-A(116)-A(118)-A(119)-A(121) &
       -A(122))*f(8))/6._/**/REALKIND+((-A(33)-A(34)-A(40)-A(41)-A(48)-A(49))*f(10))/6._/**/REALKIND+((-A(97)-A(98)-A(113) &
       -A(114))*f(12))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppajjj_uuxccxag_1_/**/REALKIND
