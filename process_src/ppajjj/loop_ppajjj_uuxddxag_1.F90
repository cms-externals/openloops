...
module ol_colourmatrix_ppajjj_uuxddxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppajjj_uuxddxag_1_/**/REALKIND



module ol_forced_parameters_ppajjj_uuxddxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajjj_uuxddxag_1_/**/REALKIND

module ol_loop_ppajjj_uuxddxag_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(31), c(45)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(14) = (CI*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(15) = (2*CI*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(16) = (countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(17) = (2*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(18) = (countertermnorm*ctVVV*eQED*gQCD**5)/3._/**/REALKIND
    f(19) = (2*countertermnorm*ctVVV*eQED*gQCD**5)/3._/**/REALKIND
    f(20) = (CI*eQED*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(21) = (CI*eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(22) = (2*CI*eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(23) = (eQED*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(24) = (eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(25) = (2*eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(26) = (CI*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(27) = (2*CI*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(28) = (4*CI*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(29) = (eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(30) = (2*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(31) = (4*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND

  c = [ 27*CI*f(20), 54*CI*f(20), 3*CI*f(21), 9*CI*f(21), 24*CI*f(21), 27*CI*f(21), 54*CI*f(21), 3*CI*f(22), 9*CI*f(22) &
    , 24*CI*f(22), 27*CI*f(22), 54*CI*f(22), 18*f(23), 54*f(23), f(24), 3*f(24), 6*f(24), 8*f(24), 9*f(24), 10*f(24), 18*f(24) &
    , 21*f(24), 24*f(24), 27*f(24), 54*f(24), f(25), 3*f(25), 6*f(25), 8*f(25), 9*f(25), 10*f(25), 18*f(25), 21*f(25), 24*f(25) &
    , 27*f(25), 54*f(25), 9*CI*f(26), 9*CI*f(27), 9*CI*f(28), 3*f(29), 9*f(29), 3*f(30), 9*f(30), 3*f(31), 9*f(31) ]
  c = (1._/**/REALKIND / 36) * c
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(183)-A(184)-A(185)-A(186)-A(187)-A(188)-A(189)-A(190)-A(191)-A(192)-A(193)-A(194))*f(5))/6._/**/REALKIND+((A(147) &
       ...
       +A(170))*f(6))/6._/**/REALKIND+((A(25)+A(26))*f(7))/12._/**/REALKIND+((A(63)+A(64)+A(71)+A(72)+A(93)+A(94)+A(95)+A(96) &
       +A(109)+A(110)+A(111)+A(112))*f(10))/6._/**/REALKIND+((-A(51)-A(53)-A(54)-A(56)-A(75)-A(77)-A(78)-A(80)-A(81)-A(82)-A(83) &
       -A(85)-A(86)-A(87)-A(100)-A(101)-A(102)-A(103))*f(11))/6._/**/REALKIND+((A(65)+A(66)+A(73)+A(74))*f(14))/6._/**/REALKIND+(( &
       -A(57)-A(58)-A(88)-A(89)-A(104)-A(106))*f(15))/6._/**/REALKIND
  M2(2) = ((A(126)+A(129)+A(130)+A(132)+A(133)+A(134)+A(141)+A(142)+A(143)+A(186)+A(187)+A(188)+A(192)+A(193) &
       ...
       -A(38)-A(45)-A(47)-A(64)-A(72)-A(94)-A(96)-A(109)-A(111)-A(116)-A(118)-A(121))*f(10))/2._/**/REALKIND+((A(51)+A(56)+A(59) &
       +A(61)+A(68)+A(70)+A(75)+A(80)+A(82)+A(85)+A(87)+A(91)+A(100)+A(102)+A(107))*f(11))/2._/**/REALKIND+(CI*(-A(35)-A(43) &
       -A(117)-A(120))*f(12))/2._/**/REALKIND+(CI*(-A(76)-A(79)-A(84)-A(99))*f(13))/2._/**/REALKIND+((-A(33)-A(40)-A(49)-A(66) &
       -A(74))*f(14))/2._/**/REALKIND+((A(58)+A(89)+A(97)+A(104)+A(113))*f(15))/2._/**/REALKIND+(CI*(-A(42) &
       -A(50))*f(16))/2._/**/REALKIND+(CI*(-A(90)-A(105))*f(17))/2._/**/REALKIND+(CI*(-A(29)-A(32))*f(18))/2._/**/REALKIND+(CI*( &
       -A(52)-A(55))*f(19))/2._/**/REALKIND
  M2(3) = ((A(123)+A(124)+A(125)+A(135)+A(138)+A(140)+A(144)+A(145)+A(146)+A(183)+A(184)+A(185)+A(189)+A(190) &
       ...
       -A(39)-A(44)-A(46)-A(63)-A(71)-A(93)-A(95)-A(110)-A(112)-A(115)-A(119)-A(122))*f(10))/2._/**/REALKIND+((A(53)+A(54)+A(60) &
       +A(62)+A(67)+A(69)+A(77)+A(78)+A(81)+A(83)+A(86)+A(92)+A(101)+A(103)+A(108))*f(11))/2._/**/REALKIND+(CI*(A(35)+A(43)+A(117) &
       +A(120))*f(12))/2._/**/REALKIND+(CI*(A(76)+A(79)+A(84)+A(99))*f(13))/2._/**/REALKIND+((-A(34)-A(41)-A(48)-A(65) &
       -A(73))*f(14))/2._/**/REALKIND+((A(57)+A(88)+A(98)+A(106)+A(114))*f(15))/2._/**/REALKIND+(CI*(A(42) &
       +A(50))*f(16))/2._/**/REALKIND+(CI*(A(90)+A(105))*f(17))/2._/**/REALKIND+(CI*(A(29)+A(32))*f(18))/2._/**/REALKIND &
       +(CI*(A(52)+A(55))*f(19))/2._/**/REALKIND
  M2(4) = ((-A(123)-A(124)-A(125)-A(126)-A(129)-A(130)-A(132)-A(133)-A(134)-A(135)-A(138)-A(140)-A(141)-A(142)-A(143)-A(144) &
       ...
       +A(44)+A(45)+A(46)+A(47)+A(115)+A(116)+A(118)+A(119)+A(121)+A(122))*f(10))/6._/**/REALKIND+((-A(59)-A(60)-A(61)-A(62)-A(67) &
       -A(68)-A(69)-A(70)-A(91)-A(92)-A(107)-A(108))*f(11))/6._/**/REALKIND+((A(33)+A(34)+A(40)+A(41)+A(48) &
       +A(49))*f(14))/6._/**/REALKIND+((-A(97)-A(98)-A(113)-A(114))*f(15))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppajjj_uuxddxag_1_/**/REALKIND
