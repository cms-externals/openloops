...
module ol_versiondata_ppajjj
  implicit none
  character(4) :: generator_revision = "3336"
  interface
    subroutine version_ppajjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppajjj
  end interface
end module ol_versiondata_ppajjj


subroutine ol_version_ppajjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppajjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppajjj
