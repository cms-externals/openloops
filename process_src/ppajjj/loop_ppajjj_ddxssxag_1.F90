...
module ol_colourmatrix_ppajjj_ddxssxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppajjj_ddxssxag_1_/**/REALKIND



module ol_forced_parameters_ppajjj_ddxssxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajjj_ddxssxag_1_/**/REALKIND

module ol_loop_ppajjj_ddxssxag_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 6) = (CI*countertermnorm*ctGqq*eQED*gQCD**5)/3._/**/REALKIND
    f( 7) = (countertermnorm*ctGqq*eQED*gQCD**5)/3._/**/REALKIND
    f( 8) = (CI*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f( 9) = (countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(10) = (countertermnorm*ctVVV*eQED*gQCD**5)/3._/**/REALKIND
    f(11) = (CI*eQED*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(12) = (CI*eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(13) = (eQED*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(14) = (eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(147)-A(148)-A(149)-A(151)-A(152)-A(154)-A(156)-A(157)-A(158)-A(160)-A(162)-A(163)-A(165)-A(166)-A(167)-A(168) &
       ...
       +((A(25)+A(26))*f(4))/12._/**/REALKIND+((A(51)+A(53)+A(54)+A(56)+A(63)+A(64)+A(71)+A(72)+A(75)+A(77)+A(78)+A(80)+A(81) &
       +A(82)+A(83)+A(85)+A(86)+A(87)+A(93)+A(94)+A(95)+A(96)+A(100)+A(101)+A(102)+A(103)+A(109)+A(110)+A(111) &
       +A(112))*f(6))/6._/**/REALKIND+((A(57)+A(58)+A(65)+A(66)+A(73)+A(74)+A(88)+A(89)+A(104)+A(106))*f(8))/6._/**/REALKIND
  M2(2) = ((A(126)+A(129)+A(130)+A(132)+A(133)+A(134)+A(141)+A(142)+A(143)+A(147)+A(148)+A(149)+A(160)+A(162)+A(163)+A(168)+A(169) &
       ...
       -A(164))*f(5))/2._/**/REALKIND+((-A(28)-A(30)-A(36)-A(38)-A(45)-A(47)-A(51)-A(56)-A(59)-A(61)-A(64)-A(68)-A(70)-A(72)-A(75) &
       -A(80)-A(82)-A(85)-A(87)-A(91)-A(94)-A(96)-A(100)-A(102)-A(107)-A(109)-A(111)-A(116)-A(118)-A(121))*f(6))/2._/**/REALKIND &
       +(CI*(-A(35)-A(43)+A(76)+A(79)+A(84)+A(99)-A(117)-A(120))*f(7))/2._/**/REALKIND+((-A(33)-A(40)-A(49)-A(58)-A(66)-A(74) &
       -A(89)-A(97)-A(104)-A(113))*f(8))/2._/**/REALKIND+(CI*(-A(42)-A(50)+A(90)+A(105))*f(9))/2._/**/REALKIND+(CI*(-A(29)-A(32) &
       +A(52)+A(55))*f(10))/2._/**/REALKIND
  M2(3) = ((A(123)+A(124)+A(125)+A(135)+A(138)+A(140)+A(144)+A(145)+A(146)+A(151)+A(152)+A(154)+A(156)+A(157)+A(158)+A(165)+A(166) &
       ...
       +A(164))*f(5))/2._/**/REALKIND+((-A(27)-A(31)-A(37)-A(39)-A(44)-A(46)-A(53)-A(54)-A(60)-A(62)-A(63)-A(67)-A(69)-A(71)-A(77) &
       -A(78)-A(81)-A(83)-A(86)-A(92)-A(93)-A(95)-A(101)-A(103)-A(108)-A(110)-A(112)-A(115)-A(119)-A(122))*f(6))/2._/**/REALKIND &
       +(CI*(A(35)+A(43)-A(76)-A(79)-A(84)-A(99)+A(117)+A(120))*f(7))/2._/**/REALKIND+((-A(34)-A(41)-A(48)-A(57)-A(65)-A(73)-A(88) &
       -A(98)-A(106)-A(114))*f(8))/2._/**/REALKIND+(CI*(A(42)+A(50)-A(90)-A(105))*f(9))/2._/**/REALKIND+(CI*(A(29)+A(32)-A(52) &
       -A(55))*f(10))/2._/**/REALKIND
  M2(4) = ((-A(123)-A(124)-A(125)-A(126)-A(129)-A(130)-A(132)-A(133)-A(134)-A(135)-A(138)-A(140)-A(141)-A(142)-A(143)-A(144) &
       ...
       +A(60)+A(61)+A(62)+A(67)+A(68)+A(69)+A(70)+A(91)+A(92)+A(107)+A(108)+A(115)+A(116)+A(118)+A(119)+A(121) &
       +A(122))*f(6))/6._/**/REALKIND+((A(33)+A(34)+A(40)+A(41)+A(48)+A(49)+A(97)+A(98)+A(113)+A(114))*f(8))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppajjj_ddxssxag_1_/**/REALKIND
