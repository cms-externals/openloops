...
module ol_colourmatrix_ppajjj_uuuuxuxuxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppajjj_uuuuxuxuxa_1_/**/REALKIND



module ol_forced_parameters_ppajjj_uuuuxuxuxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajjj_uuuuxuxuxa_1_/**/REALKIND

module ol_tree_ppajjj_uuuuxuxuxa_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppajjj_uuuuxuxuxa_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppajjj_uuuuxuxuxa_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for up up up anti-up anti-up anti-up gamma -> 0
...
! **********************************************************************
  ...
  use ol_external_ppajjj_uuuuxuxuxa_1, only: external_perm_ppajjj_uuuuxuxuxa_1, &
    & external_perm_inv_ppajjj_uuuuxuxuxa_1, extcomb_perm_ppajjj_uuuuxuxuxa_1, &
    & average_factor_ppajjj_uuuuxuxuxa_1
  use ol_external_ppajjj_uuuuxuxuxa_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppajjj_uuuuxuxuxa_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppajjj_uuuuxuxuxa_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppajjj_uuuuxuxuxa_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppajjj_uuuuxuxuxa_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppajjj_uuuuxuxuxa_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppajjj_uuuuxuxuxa_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppajjj_uuuuxuxuxa_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf4(:,3), Q(:,68), ZERO, 0_intkind1, wf4(:,4), n2(1))
  ...
  call prop_Q_A(ntry, wf8(:,6), Q(:,13), ZERO, 0_intkind1, wf8(:,7), n2(5))
  call vert_VQ_A(ntry, wf4(:,2), ex3, wf8(:,8), n3(:,13), t3x8(:,:,5))
  call vert_AV_Q(ntry, wf4(:,6), wf4(:,1), wf16(:,5), n3(:,14), t3x16(:,:,5))
  call prop_Q_A(ntry, wf8(:,8), Q(:,22), ZERO, 0_intkind1, wf8(:,9), n2(6))
  ...
  call prop_A_Q(ntry, wf8(:,12), Q(:,52), ZERO, 0_intkind1, wf8(:,13), n2(8))
  call vert_VQ_A(ntry, wf4(:,1), ex2, wf8(:,14), n3(:,25), t3x8(:,:,9))
  call vert_AV_Q(ntry, wf4(:,6), wf4(:,8), wf16(:,11), n3(:,26), t3x16(:,:,11))
  call prop_Q_A(ntry, wf8(:,14), Q(:,11), ZERO, 0_intkind1, wf8(:,15), n2(9))
  call vert_VQ_A(ntry, wf4(:,8), ex2, wf8(:,16), n3(:,27), t3x8(:,:,10))
  call prop_Q_A(ntry, wf8(:,16), Q(:,22), ZERO, 0_intkind1, wf8(:,17), n2(10))
  ...
  call prop_A_Q(ntry, wf8(:,19), Q(:,25), ZERO, 0_intkind1, wf8(:,20), n2(11))
  call vert_AV_Q(ntry, ex5, wf4(:,10), wf8(:,21), n3(:,34), t3x8(:,:,13))
  call prop_A_Q(ntry, wf8(:,21), Q(:,50), ZERO, 0_intkind1, wf8(:,22), n2(12))
  ...
  call prop_Q_A(ntry, wf8(:,24), Q(:,38), ZERO, 0_intkind1, wf8(:,25), n2(14))
  ...
  call prop_A_Q(ntry, wf8(:,28), Q(:,52), ZERO, 0_intkind1, wf8(:,29), n2(15))
  call vert_AV_Q(ntry, wf4(:,12), wf4(:,13), wf16(:,21), n3(:,48), t3x16(:,:,21))
  call vert_VQ_A(ntry, wf4(:,13), ex2, wf8(:,30), n3(:,49), t3x8(:,:,19))
  call prop_Q_A(ntry, wf8(:,30), Q(:,38), ZERO, 0_intkind1, wf8(:,31), n2(16))
  ...
  call prop_A_Q(ntry, wf8(:,33), Q(:,49), ZERO, 0_intkind1, wf8(:,34), n2(17))
  call vert_AV_Q(ntry, ex6, wf4(:,15), wf8(:,35), n3(:,70), t3x8(:,:,22))
  call vert_VQ_A(ntry, wf4(:,14), wf4(:,4), wf16(:,38), n3(:,71), t3x16(:,:,38))
  call prop_A_Q(ntry, wf8(:,35), Q(:,42), ZERO, 0_intkind1, wf8(:,36), n2(18))
  ...
  call prop_Q_A(ntry, wf8(:,37), Q(:,21), ZERO, 0_intkind1, wf8(:,38), n2(19))
  call vert_VQ_A(ntry, wf4(:,15), ex3, wf8(:,39), n3(:,75), t3x8(:,:,24))
  call vert_AV_Q(ntry, wf4(:,6), wf4(:,14), wf16(:,41), n3(:,76), t3x16(:,:,41))
  call prop_Q_A(ntry, wf8(:,39), Q(:,14), ZERO, 0_intkind1, wf8(:,40), n2(20))
  ...
  call prop_Q_A(ntry, wf4(:,16), Q(:,65), ZERO, 0_intkind1, wf4(:,17), n2(21))
  ...
  call prop_Q_A(ntry, wf8(:,42), Q(:,11), ZERO, 0_intkind1, wf8(:,43), n2(22))
  call vert_VQ_A(ntry, wf4(:,8), ex1, wf8(:,44), n3(:,85), t3x8(:,:,27))
  call prop_Q_A(ntry, wf8(:,44), Q(:,21), ZERO, 0_intkind1, wf8(:,45), n2(23))
  ...
  call prop_A_Q(ntry, wf8(:,47), Q(:,49), ZERO, 0_intkind1, wf8(:,48), n2(24))
  call vert_AV_Q(ntry, ex5, wf4(:,15), wf8(:,49), n3(:,91), t3x8(:,:,30))
  call vert_VQ_A(ntry, wf4(:,18), wf4(:,4), wf16(:,49), n3(:,92), t3x16(:,:,49))
  call prop_A_Q(ntry, wf8(:,49), Q(:,26), ZERO, 0_intkind1, wf8(:,50), n2(25))
  ...
  call prop_Q_A(ntry, wf8(:,51), Q(:,37), ZERO, 0_intkind1, wf8(:,52), n2(26))
  ...
  call prop_Q_A(ntry, wf8(:,54), Q(:,37), ZERO, 0_intkind1, wf8(:,55), n2(27))
  ...
  call prop_A_Q(ntry, wf8(:,57), Q(:,44), ZERO, 0_intkind1, wf8(:,58), n2(28))
  call vert_VQ_A(ntry, wf4(:,14), ex2, wf8(:,59), n3(:,123), t3x8(:,:,36))
  call vert_AV_Q(ntry, wf4(:,6), wf4(:,19), wf16(:,74), n3(:,124), t3x16(:,:,74))
  call prop_Q_A(ntry, wf8(:,59), Q(:,19), ZERO, 0_intkind1, wf8(:,60), n2(29))
  call vert_VQ_A(ntry, wf4(:,19), ex2, wf8(:,61), n3(:,125), t3x8(:,:,37))
  call prop_Q_A(ntry, wf8(:,61), Q(:,14), ZERO, 0_intkind1, wf8(:,62), n2(30))
  ...
  call prop_Q_A(ntry, wf8(:,63), Q(:,19), ZERO, 0_intkind1, wf8(:,64), n2(31))
  call vert_VQ_A(ntry, wf4(:,19), ex1, wf8(:,65), n3(:,132), t3x8(:,:,39))
  call prop_Q_A(ntry, wf8(:,65), Q(:,13), ZERO, 0_intkind1, wf8(:,66), n2(32))
  ...
  call prop_A_Q(ntry, wf8(:,67), Q(:,28), ZERO, 0_intkind1, wf8(:,68), n2(33))
  call vert_VQ_A(ntry, wf4(:,18), ex2, wf8(:,69), n3(:,138), t3x8(:,:,41))
  call vert_AV_Q(ntry, wf4(:,12), wf4(:,19), wf16(:,84), n3(:,139), t3x16(:,:,84))
  call prop_Q_A(ntry, wf8(:,69), Q(:,35), ZERO, 0_intkind1, wf8(:,70), n2(34))
  ...
  call prop_Q_A(ntry, wf8(:,71), Q(:,35), ZERO, 0_intkind1, wf8(:,72), n2(35))
  ...
  call prop_A_Q(ntry, wf8(:,73), Q(:,25), ZERO, 0_intkind1, wf8(:,74), n2(36))
  call vert_AV_Q(ntry, ex4, wf4(:,10), wf8(:,75), n3(:,158), t3x8(:,:,44))
  call prop_A_Q(ntry, wf8(:,75), Q(:,42), ZERO, 0_intkind1, wf8(:,76), n2(37))
  ...
  call prop_A_Q(ntry, wf4(:,20), Q(:,72), ZERO, 0_intkind1, wf4(:,21), n2(38))
  ...
  call prop_A_Q(ntry, wf8(:,80), Q(:,44), ZERO, 0_intkind1, wf8(:,81), n2(39))
  ...
  call prop_A_Q(ntry, wf8(:,83), Q(:,41), ZERO, 0_intkind1, wf8(:,84), n2(40))
  call vert_AV_Q(ntry, ex4, wf4(:,2), wf8(:,85), n3(:,183), t3x8(:,:,51))
  call prop_A_Q(ntry, wf8(:,85), Q(:,26), ZERO, 0_intkind1, wf8(:,86), n2(41))
  ...
  call prop_A_Q(ntry, wf8(:,89), Q(:,28), ZERO, 0_intkind1, wf8(:,90), n2(42))
  ...
  M2add = M2 / average_factor_ppajjj_uuuuxuxuxa_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppajjj_uuuuxuxuxa_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppajjj_uuuuxuxuxa_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppajjj_uuuuxuxuxa_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppajjj_uuuuxuxuxa_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppajjj_uuuuxuxuxa_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppajjj_uuuuxuxuxa_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppajjj_uuuuxuxuxa_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppajjj_uuuuxuxuxa_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppajjj_uuuuxuxuxa_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppajjj_uuuuxuxuxa_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppajjj_uuuuxuxuxa_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppajjj_uuuuxuxuxa_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppajjj_uuuuxuxuxa_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppajjj_uuuuxuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppajjj_uuuuxuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppajjj_uuuuxuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppajjj_uuuuxuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppajjj_uuuuxuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppajjj_uuuuxuxuxa_1_/**/REALKIND
