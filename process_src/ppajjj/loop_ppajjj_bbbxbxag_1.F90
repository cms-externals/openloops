...
module ol_colourmatrix_ppajjj_bbbxbxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppajjj_bbbxbxag_1_/**/REALKIND



module ol_forced_parameters_ppajjj_bbbxbxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajjj_bbbxbxag_1_/**/REALKIND

module ol_loop_ppajjj_bbbxbxag_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 8) = (CI*countertermnorm*ctVbb*eQED*gQCD**5)/3._/**/REALKIND
    f( 9) = (countertermnorm*ctVbb*eQED*gQCD**5)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,8),Q(:,50),MB,1_intkind1,wf(:,86))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,87))
  call prop_A_Q(wf(:,87),Q(:,40),MB,1_intkind1,wf(:,88))
  call prop_Q_A(wf(:,21),Q(:,50),MB,1_intkind1,wf(:,89))
  call vert_AV_Q(wf(:,88),wf(:,-4),wf(:,90))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,91))
  call prop_A_Q(wf(:,91),Q(:,24),MB,1_intkind1,wf(:,92))
  ...
  call prop_Q_A(wf(:,30),Q(:,49),MB,1_intkind1,wf(:,101))
  call counter_QA_V(wf(:,25),wf(:,-3),wf(:,102))
  call prop_Q_A(wf(:,38),Q(:,49),MB,1_intkind1,wf(:,103))
  ...
  call prop_A_Q(wf(:,119),Q(:,36),MB,1_intkind1,wf(:,120))
  call vert_AV_Q(wf(:,120),wf(:,-4),wf(:,121))
  call counter_AV_Q(wf(:,-2),wf(:,-4),wf(:,122))
  call prop_A_Q(wf(:,122),Q(:,20),MB,1_intkind1,wf(:,123))
  ...
  call prop_A_Q(wf(:,18),Q(:,56),MB,1_intkind1,wf(:,135))
  call counter_VQ_A(wf(:,-5),wf(:,-1),wf(:,136))
  call prop_Q_A(wf(:,136),Q(:,34),MB,1_intkind1,wf(:,137))
  call vert_VQ_A(wf(:,1),wf(:,137),wf(:,138))
  call prop_A_Q(wf(:,22),Q(:,56),MB,1_intkind1,wf(:,139))
  call vert_VQ_A(wf(:,-4),wf(:,137),wf(:,140))
  call counter_VQ_A(wf(:,-4),wf(:,-1),wf(:,141))
  call prop_Q_A(wf(:,141),Q(:,18),MB,1_intkind1,wf(:,142))
  ...
  call prop_A_Q(wf(:,51),Q(:,52),MB,1_intkind1,wf(:,148))
  call vert_VQ_A(wf(:,39),wf(:,137),wf(:,149))
  call prop_A_Q(wf(:,54),Q(:,52),MB,1_intkind1,wf(:,150))
  ...
  call prop_Q_A(wf(:,163),Q(:,11),MB,1_intkind1,wf(:,164))
  ...
  call counter_A_Q(ctbb,wf(:,31),Q(:,14),wf(:,251))
  call vert_AV_Q(wf(:,15),wf(:,24),wf(:,252))
  call counter_Q_A(ctbb,wf(:,33),Q(:,33),wf(:,253))
  call prop_A_Q(wf(:,252),Q(:,30),MB,1_intkind1,wf(:,254))
  call vert_QA_V(wf(:,33),wf(:,15),wf(:,255))
  call prop_Q_A(wf(:,34),Q(:,39),MB,1_intkind1,wf(:,256))
  ...
  call prop_Q_A(wf(:,253),Q(:,33),MB,1_intkind1,wf(:,261))
  ...
  call prop_Q_A(wf(:,321),Q(:,23),MB,1_intkind1,wf(:,322))
  call vert_VQ_A(wf(:,-5),wf(:,19),wf(:,323))
  call prop_Q_A(wf(:,323),Q(:,39),MB,1_intkind1,wf(:,324))
  call vert_QA_V(wf(:,-1),wf(:,9),wf(:,325))
  call vert_AV_Q(wf(:,9),wf(:,-4),wf(:,326))
  call prop_A_Q(wf(:,326),Q(:,29),MB,1_intkind1,wf(:,327))
  call vert_AV_Q(wf(:,9),wf(:,-5),wf(:,328))
  call prop_A_Q(wf(:,328),Q(:,45),MB,1_intkind1,wf(:,329))
  call vert_VQ_A(wf(:,11),wf(:,-1),wf(:,330))
  call prop_Q_A(wf(:,330),Q(:,39),MB,1_intkind1,wf(:,331))
  call vert_AV_Q(wf(:,-3),wf(:,11),wf(:,332))
  call prop_A_Q(wf(:,332),Q(:,45),MB,1_intkind1,wf(:,333))
  call vert_UV_W(wf(:,24),Q(:,6),wf(:,39),Q(:,9),wf(:,334))
  call vert_QA_V(wf(:,36),wf(:,-3),wf(:,335))
  call vert_VQ_A(wf(:,-4),wf(:,36),wf(:,336))
  call prop_Q_A(wf(:,336),Q(:,23),MB,1_intkind1,wf(:,337))
  ...
  call prop_Q_A(wf(:,350),Q(:,27),MB,1_intkind1,wf(:,351))
  call vert_VQ_A(wf(:,-5),wf(:,52),wf(:,352))
  call prop_Q_A(wf(:,352),Q(:,43),MB,1_intkind1,wf(:,353))
  ...
  call prop_Q_A(wf(:,382),Q(:,27),MB,1_intkind1,wf(:,383))
  call vert_AV_Q(wf(:,-2),wf(:,27),wf(:,384))
  call prop_A_Q(wf(:,384),Q(:,29),MB,1_intkind1,wf(:,385))
  ...
  call prop_Q_A(wf(:,389),Q(:,23),MB,1_intkind1,wf(:,390))
  call vert_VQ_A(wf(:,10),wf(:,0),wf(:,391))
  call prop_Q_A(wf(:,391),Q(:,27),MB,1_intkind1,wf(:,392))
  ...
  call prop_A_Q(wf(:,396),Q(:,30),MB,1_intkind1,wf(:,397))
  ...
  call prop_Q_A(wf(:,455),Q(:,43),MB,1_intkind1,wf(:,456))
  call vert_VQ_A(wf(:,68),wf(:,0),wf(:,457))
  call prop_Q_A(wf(:,457),Q(:,43),MB,1_intkind1,wf(:,458))
  call vert_AV_Q(wf(:,-2),wf(:,72),wf(:,459))
  call prop_A_Q(wf(:,459),Q(:,45),MB,1_intkind1,wf(:,460))
  call vert_QA_V(wf(:,0),wf(:,139),wf(:,461))
  call vert_AV_Q(wf(:,-2),wf(:,68),wf(:,462))
  call prop_A_Q(wf(:,462),Q(:,46),MB,1_intkind1,wf(:,463))
...
subroutine denominators()
  ...
  den(86) = 1 / (Q(5,37))
  den(92) = 1 / (Q(5,41))
  den(107) = 1 / (Q(5,50) - MB2)
  den(112) = 1 / (Q(5,49) - MB2)
  den(134) = 1 / (Q(5,56) - MB2)
  den(140) = 1 / (Q(5,52) - MB2)
  den(164) = 1 / (Q(5,58))
  den(168) = 1 / (Q(5,45) - MB2)
  den(171) = 1 / (Q(5,23) - MB2)
  den(186) = 1 / (Q(5,29) - MB2)
  den(189) = 1 / (Q(5,39) - MB2)
  den(208) = 1 / (Q(5,46) - MB2)
  den(212) = 1 / (Q(5,57))
  den(226) = 1 / (Q(5,30) - MB2)
  den(248) = 1 / (Q(5,54))
  den(254) = 1 / (Q(5,27) - MB2)
  den(270) = 1 / (Q(5,43) - MB2)
  den(291) = 1 / (Q(5,53))
  den(371) = 1 / (Q(5,15))
...
end module ol_loop_ppajjj_bbbxbxag_1_/**/REALKIND
