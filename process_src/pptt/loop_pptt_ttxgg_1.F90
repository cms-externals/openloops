...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,7),Q(:,6),MT,1_intkind1,wf(:,13))
  call counter_VQ_A(wf(:,-2),wf(:,0),wf(:,14))
  call prop_A_Q(wf(:,4),Q(:,10),MT,1_intkind1,wf(:,15))
  call counter_QA_V(wf(:,0),wf(:,-1),wf(:,16))
  call counter_V_V(ctGG,wf(:,1),Q(:,3),wf(:,17))
  call counter_Q_A(cttt,wf(:,5),Q(:,5),wf(:,18))
  call counter_Q_A(cttt,wf(:,8),Q(:,9),wf(:,19))
