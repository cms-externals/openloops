...
! **********************************************************************
module ol_tensor_sum_storage_pptt_ttxddx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pptt_ttxddx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pptt_ttxddx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 2
...
! **********************************************************************
  use ol_external_pptt_ttxddx_1, only: channel_number_pptt_ttxddx_1
  ...
  call channel_on(channel_number_pptt_ttxddx_1)
  M2 = 0
  ...
  masses2_7 = [ ZERO2, ZERO2, ZERO2, MT2 ]
  ...
  call TI_call(2, momenta_3, masses2_6, T2sum(:,2), M2)
  call TI_call(2, momenta_2, masses2_4, T2sum(:,3), M2)
  ...
  call channel_off(channel_number_pptt_ttxddx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pptt_ttxddx_1_/**/REALKIND
