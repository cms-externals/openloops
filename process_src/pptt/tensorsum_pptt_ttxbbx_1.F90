...
! **********************************************************************
module ol_tensor_sum_storage_pptt_ttxbbx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pptt_ttxbbx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pptt_ttxbbx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 2
...
! **********************************************************************
  use ol_external_pptt_ttxbbx_1, only: channel_number_pptt_ttxbbx_1
  ...
  call channel_on(channel_number_pptt_ttxbbx_1)
  M2 = 0
  ...
  masses2_7 = [ ZERO2, ZERO2, MT2 ]
  masses2_8 = [ ZERO2, MB2, ZERO2, MT2 ]
  ...
  call TI_call(2, momenta_6, masses2_8, T2sum(:,5), M2)
  call TI_call(2, momenta_7, masses2_8, T2sum(:,6), M2)
  ...
  call channel_off(channel_number_pptt_ttxbbx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pptt_ttxbbx_1_/**/REALKIND
