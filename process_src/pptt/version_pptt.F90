...
module ol_versiondata_pptt
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptt
  end interface
end module ol_versiondata_pptt


subroutine ol_version_pptt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptt
