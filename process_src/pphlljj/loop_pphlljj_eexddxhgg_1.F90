...
module ol_colourmatrix_pphlljj_eexddxhgg_1_/**/REALKIND
...
end module ol_colourmatrix_pphlljj_eexddxhgg_1_/**/REALKIND



module ol_forced_parameters_pphlljj_eexddxhgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlljj_eexddxhgg_1_/**/REALKIND

module ol_loop_pphlljj_eexddxhgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(24) = (CI*eQED**3*gQCD**4*integralnorm*SwF*YB)/(2._/**/REALKIND*MW*sw)
    f(25) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*6._/**/REALKIND)
    f(26) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f(27) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/(3._/**/REALKIND*MQ2sum)
    f(28) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/MQ2sum
    f(29) = (countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/(MQ2sum*3._/**/REALKIND)
    f(30) = (countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/MQ2sum
    f(31) = (CI*eQED**3*gQCD**4*integralnorm*SwF*YT)/(6._/**/REALKIND*MW*sw)
    f(32) = (CI*eQED**3*gQCD**4*integralnorm*SwF*YT)/(3._/**/REALKIND*MW*sw)
    f(33) = (CI*eQED**3*gQCD**4*integralnorm*SwF*YT)/(2._/**/REALKIND*MW*sw)
    f(34) = (eQED**3*gQCD**4*integralnorm*SwF*YT)/(MW*sw*6._/**/REALKIND)
  ...
  c = [ 9*CI*f(12), 18*CI*f(12), CI*f(13), 3*CI*f(13), 8*CI*f(13), 9*CI*f(13), 18*CI*f(13), f(14), 3*f(14), 8*f(14), 9*f(14) &
    , 3*CI*f(15), 3*CI*f(16), f(17), 3*f(17), f(18), 3*f(18), 3*CI*f(23), 3*CI*f(24), f(25), 3*f(25), f(26), 3*f(26), 3*CI*f(31) &
    , 3*CI*f(32), 3*CI*f(33), f(34), 3*f(34), f(35), 3*f(35), f(36), 3*f(36) ]
  c = (1._/**/REALKIND / 6) * c
...
! **********************************************************************
  ...
  call counter_QA_Z(gZd,wf(:,5),wf(:,6),wf(:,40))
  ...
  call counter_QA_Z(gZd,wf(:,15),wf(:,16),wf(:,45))
  ...
  call vert_AZ_Q(gZd,wf(:,-3),wf(:,4),wf(:,70))
  ...
  call vert_AZ_Q(gZd,wf(:,16),wf(:,4),wf(:,84))
  ...
  call vert_ZQ_A(gZd,wf(:,4),wf(:,15),wf(:,99))
  ...
  call vert_AZ_Q(gZd,wf(:,6),wf(:,4),wf(:,104))
  ...
  call vert_QA_Z(gZd,wf(:,135),wf(:,6),wf(:,136))
  ...
  call vert_ZQ_A(gZd,wf(:,9),wf(:,5),wf(:,169))
  ...
  call vert_AZ_Q(gZd,wf(:,16),wf(:,9),wf(:,177))
  ...
  call vert_ZQ_A(gZd,wf(:,9),wf(:,15),wf(:,185))
  ...
  call vert_AZ_Q(gZd,wf(:,6),wf(:,9),wf(:,193))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(9)*f(3))/2._/**/REALKIND+(-A(118)-A(119)-A(120)-A(121)-A(122)-A(123))*f(3)+CI*(-A(126)-A(127)-A(128)-A(129))*f(4) &
       ...
       +CI*(A(24)+A(25))*f(9)+CI*(A(11)+A(12)-A(13))*f(10)+(-A(18)-A(20))*f(11)+(A(35)+A(39)+A(63)+A(67)+A(71)+A(87))*f(19)+(A(37) &
       +A(41)+A(65)+A(69)+A(73)+A(89))*f(20)+CI*(A(43)+A(47)+A(51)+A(59)+A(83)+A(91))*f(21)+CI*(A(45)+A(49)+A(53)+A(61)+A(85) &
       +A(93))*f(22)+(A(34)+A(38)+A(62)+A(66)+A(70)+A(86))*f(27)+(A(36)+A(40)+A(64)+A(68)+A(72)+A(88))*f(28)+CI*(A(42)+A(46)+A(50) &
       +A(58)+A(82)+A(90))*f(29)+CI*(A(44)+A(48)+A(52)+A(60)+A(84)+A(92))*f(30)
  M2(2) = (A(10)*f(3))/2._/**/REALKIND+(-A(114)-A(115)-A(116)-A(117)-A(124)-A(125))*f(3)+CI*(A(126)+A(127)+A(128)+A(129))*f(4) &
       ...
       -A(85)-A(93))*f(22)+(A(26)+A(30)+A(54)+A(74)+A(78)+A(94))*f(27)+(A(28)+A(32)+A(56)+A(76)+A(80)+A(96))*f(28)+CI*(-A(42) &
       -A(46)-A(50)-A(58)-A(82)-A(90))*f(29)+CI*(-A(44)-A(48)-A(52)-A(60)-A(84)-A(92))*f(30)
  M2(3) = ((-A(9)-A(10))*f(3))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphlljj_eexddxhgg_1_/**/REALKIND
