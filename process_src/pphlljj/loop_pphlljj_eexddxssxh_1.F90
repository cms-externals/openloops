...
module ol_colourmatrix_pphlljj_eexddxssxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphlljj_eexddxssxh_1_/**/REALKIND



module ol_forced_parameters_pphlljj_eexddxssxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlljj_eexddxssxh_1_/**/REALKIND

module ol_loop_pphlljj_eexddxssxh_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_QA_Z(gZd,wf(:,14),wf(:,-3),wf(:,15))
  ...
  call vert_AZ_Q(gZd,wf(:,-3),wf(:,3),wf(:,52))
  ...
  call vert_QA_Z(gZd,wf(:,-2),wf(:,57),wf(:,58))
  call vert_VQ_A(wf(:,55),wf(:,-2),wf(:,59))
  call prop_Q_A(wf(:,59),Q(:,52),ZERO,0_intkind1,wf(:,60))
  call vert_QA_Z(gZd,wf(:,60),wf(:,-3),wf(:,61))
  call counter_QA_Z(gZd,wf(:,14),wf(:,-3),wf(:,62))
  ...
  call vert_QA_Z(gZd,wf(:,67),wf(:,-3),wf(:,68))
  call counter_QA_Z(gZd,wf(:,-2),wf(:,17),wf(:,69))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(34)-A(35)-A(36)-A(37)-A(38)-A(39)-A(40)-A(41))*f(2))/2._/**/REALKIND+((A(15)+A(17)+A(26)+A(27)+A(29)+A(30)+A(32) &
       +A(33))*f(3))/2._/**/REALKIND+((A(14)+A(16)+A(28)+A(31))*f(4))/2._/**/REALKIND-(A(5)*f(5))/2._/**/REALKIND+((A(7)+A(11) &
       +A(19)+A(23))*f(11))/2._/**/REALKIND+((A(9)+A(13)+A(21)+A(25))*f(12))/2._/**/REALKIND+((A(6)+A(10)+A(18) &
       +A(22))*f(15))/2._/**/REALKIND+((A(8)+A(12)+A(20)+A(24))*f(16))/2._/**/REALKIND
  M2(2) = ((A(34)+A(35)+A(36)+A(37)+A(38)+A(39)+A(40)+A(41))*f(2))/6._/**/REALKIND+((-A(15)-A(17)-A(26)-A(27)-A(29)-A(30)-A(32) &
       -A(33))*f(3))/6._/**/REALKIND+((-A(14)-A(16)-A(28)-A(31))*f(4))/6._/**/REALKIND+(A(5)*f(5))/6._/**/REALKIND+((-A(7)-A(11) &
       -A(19)-A(23))*f(11))/6._/**/REALKIND+((-A(9)-A(13)-A(21)-A(25))*f(12))/6._/**/REALKIND+((-A(6)-A(10)-A(18) &
       -A(22))*f(15))/6._/**/REALKIND+((-A(8)-A(12)-A(20)-A(24))*f(16))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphlljj_eexddxssxh_1_/**/REALKIND
