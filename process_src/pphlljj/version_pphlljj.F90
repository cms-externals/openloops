...
module ol_versiondata_pphlljj
  implicit none
  character(4) :: generator_revision = "1268"
  interface
    subroutine version_pphlljj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphlljj
  end interface
end module ol_versiondata_pphlljj


subroutine ol_version_pphlljj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphlljj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphlljj
