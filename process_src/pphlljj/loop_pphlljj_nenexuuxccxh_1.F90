...
module ol_colourmatrix_pphlljj_nenexuuxccxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphlljj_nenexuuxccxh_1_/**/REALKIND



module ol_forced_parameters_pphlljj_nenexuuxccxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlljj_nenexuuxccxh_1_/**/REALKIND

module ol_loop_pphlljj_nenexuuxccxh_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(15) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/MQ2sum
    f(16) = (eQED**3*gQCD**4*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(26)-A(27)-A(28)-A(29)-A(30)-A(31)-A(32)-A(33))*f(2))/2._/**/REALKIND+((A(11)+A(13)+A(18) &
       +A(19))*f(3))/2._/**/REALKIND+((A(21)+A(22)+A(24)+A(25))*f(4))/2._/**/REALKIND+((A(10)+A(12))*f(5))/2._/**/REALKIND+((A(20) &
       +A(23))*f(6))/2._/**/REALKIND-(A(5)*f(7))/2._/**/REALKIND+((A(7)+A(9)+A(15)+A(17))*f(13))/2._/**/REALKIND+((A(6)+A(8)+A(14) &
       +A(16))*f(15))/2._/**/REALKIND
  M2(2) = ((A(26)+A(27)+A(28)+A(29)+A(30)+A(31)+A(32)+A(33))*f(2))/6._/**/REALKIND+((-A(11)-A(13)-A(18) &
       -A(19))*f(3))/6._/**/REALKIND+((-A(21)-A(22)-A(24)-A(25))*f(4))/6._/**/REALKIND+((-A(10)-A(12))*f(5))/6._/**/REALKIND+(( &
       -A(20)-A(23))*f(6))/6._/**/REALKIND+(A(5)*f(7))/6._/**/REALKIND+((-A(7)-A(9)-A(15)-A(17))*f(13))/6._/**/REALKIND+((-A(6) &
       -A(8)-A(14)-A(16))*f(15))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphlljj_nenexuuxccxh_1_/**/REALKIND
