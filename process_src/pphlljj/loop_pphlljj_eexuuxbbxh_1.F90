...
module ol_colourmatrix_pphlljj_eexuuxbbxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphlljj_eexuuxbbxh_1_/**/REALKIND



module ol_forced_parameters_pphlljj_eexuuxbbxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlljj_eexuuxbbxh_1_/**/REALKIND

module ol_loop_pphlljj_eexuuxbbxh_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(54), c(70)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(14) = (2*CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MB*YB)/(3._/**/REALKIND*MQ2sum)
    f(15) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MB*YB)/MQ2sum
    f(16) = (CI*eQED**3*gQCD**2*YB)/(6._/**/REALKIND*MW*sw)
    f(17) = (CI*eQED**3*gQCD**2*YB)/(3._/**/REALKIND*MW*sw)
    f(18) = (CI*eQED**3*gQCD**2*YB)/(2._/**/REALKIND*MW*sw)
    f(19) = (CI*countertermnorm*eQED**3*gQCD**4*YB)/(6._/**/REALKIND*MW*sw)
    f(20) = (CI*countertermnorm*eQED**3*gQCD**4*YB)/(3._/**/REALKIND*MW*sw)
    f(21) = (CI*countertermnorm*eQED**3*gQCD**4*YB)/(2._/**/REALKIND*MW*sw)
    f(22) = (CI*countertermnorm*ctGbb*eQED**3*gQCD**4*YB)/(6._/**/REALKIND*MW*sw)
    f(23) = (CI*countertermnorm*ctGbb*eQED**3*gQCD**4*YB)/(3._/**/REALKIND*MW*sw)
    f(24) = (CI*countertermnorm*ctGbb*eQED**3*gQCD**4*YB)/(2._/**/REALKIND*MW*sw)
    f(25) = (CI*countertermnorm*ctGqq*eQED**3*gQCD**4*YB)/(6._/**/REALKIND*MW*sw)
    f(26) = (CI*countertermnorm*ctGqq*eQED**3*gQCD**4*YB)/(3._/**/REALKIND*MW*sw)
    f(27) = (CI*countertermnorm*ctGqq*eQED**3*gQCD**4*YB)/(2._/**/REALKIND*MW*sw)
    f(28) = (CI*countertermnorm*ctSbb*eQED**3*gQCD**4*YB)/(6._/**/REALKIND*MW*sw)
    f(29) = (CI*countertermnorm*ctSbb*eQED**3*gQCD**4*YB)/(3._/**/REALKIND*MW*sw)
    f(30) = (CI*countertermnorm*ctSbb*eQED**3*gQCD**4*YB)/(2._/**/REALKIND*MW*sw)
    f(31) = (CI*countertermnorm*ctVbb*eQED**3*gQCD**4*YB)/(6._/**/REALKIND*MW*sw)
    f(32) = (CI*countertermnorm*ctVbb*eQED**3*gQCD**4*YB)/(2._/**/REALKIND*MW*sw)
    f(33) = (CI*countertermnorm*ctVqq*eQED**3*gQCD**4*YB)/(3._/**/REALKIND*MW*sw)
    f(34) = (CI*countertermnorm*ctVqq*eQED**3*gQCD**4*YB)/(2._/**/REALKIND*MW*sw)
    f(35) = (countertermnorm*ctZGG*eQED**3*gQCD**4*YB)/(MW*sw*2._/**/REALKIND)
    f(36) = (CI*eQED**3*gQCD**4*integralnorm*SwB*YB)/(6._/**/REALKIND*MW*sw)
    f(37) = (CI*eQED**3*gQCD**4*integralnorm*SwB*YB)/(3._/**/REALKIND*MW*sw)
    f(38) = (CI*eQED**3*gQCD**4*integralnorm*SwB*YB)/(2._/**/REALKIND*MW*sw)
    f(39) = (eQED**3*gQCD**4*integralnorm*SwB*YB)/(MW*sw*12._/**/REALKIND)
    f(40) = (eQED**3*gQCD**4*integralnorm*SwB*YB)/(MW*sw*6._/**/REALKIND)
    f(41) = (eQED**3*gQCD**4*integralnorm*SwB*YB)/(MW*sw*4._/**/REALKIND)
    f(42) = (eQED**3*gQCD**4*integralnorm*SwB*YB)/(MW*sw*3._/**/REALKIND)
    f(43) = (eQED**3*gQCD**4*integralnorm*SwB*YB)/(MW*sw*2._/**/REALKIND)
    f(44) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*6._/**/REALKIND)
    f(45) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*3._/**/REALKIND)
    f(46) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f(47) = (2*eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*3._/**/REALKIND)
    f(48) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw)
    f(49) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/(3._/**/REALKIND*MQ2sum)
    f(50) = (2*CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/(3._/**/REALKIND*MQ2sum)
    f(51) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/MQ2sum
    f(52) = (eQED**3*gQCD**4*integralnorm*SwF*YT)/(MW*sw*6._/**/REALKIND)
    f(53) = (eQED**3*gQCD**4*integralnorm*SwF*YT)/(MW*sw*3._/**/REALKIND)
    f(54) = (eQED**3*gQCD**4*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)

  c = [ 9*CI*f(8), 27*CI*f(8), 18*f(9), 54*f(9), f(10), 3*f(10), 6*f(10), 8*f(10), 10*f(10), 18*f(10), 21*f(10), 24*f(10) &
    , 54*f(10), 3*f(11), 9*f(11), 3*f(12), 9*f(12), 9*CI*f(36), 27*CI*f(36), 9*CI*f(37), 27*CI*f(37), 9*CI*f(38), 27*CI*f(38) &
    , 18*f(39), 54*f(39), f(40), 3*f(40), 6*f(40), 8*f(40), 10*f(40), 18*f(40), 21*f(40), 24*f(40), 54*f(40), 18*f(41), 54*f(41) &
    , f(42), 3*f(42), 6*f(42), 8*f(42), 10*f(42), 18*f(42), 21*f(42), 24*f(42), 54*f(42), f(43), 3*f(43), 6*f(43), 8*f(43) &
    , 10*f(43), 18*f(43), 21*f(43), 24*f(43), 54*f(43), 3*f(44), 9*f(44), 3*f(45), 9*f(45), 3*f(46), 9*f(46), 3*f(47), 9*f(47) &
    , 3*f(48), 9*f(48), 3*f(52), 9*f(52), 3*f(53), 9*f(53), 3*f(54), 9*f(54) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZu,wf(:,9),wf(:,-2),wf(:,45))
  ...
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,9),wf(:,51))
  ...
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,9),wf(:,127))
  ...
  call vert_QA_Z(gZu,wf(:,131),wf(:,-3),wf(:,132))
  call counter_QA_Z(gZu,wf(:,-2),wf(:,39),wf(:,133))
  ...
  call counter_ZQ_A(gZu,wf(:,9),wf(:,-2),wf(:,139))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((A(13)+A(14)+A(15)+A(16))*f(1))/2._/**/REALKIND+((A(1)+A(3)+A(5)+A(7)+A(9)+A(11))*f(16))/2._/**/REALKIND+((-A(17)-A(19) &
       -A(21)-A(23))*f(17))/2._/**/REALKIND+((A(2)+A(4)+A(6)+A(8)+A(10)+A(12)+A(18)+A(20)+A(22)+A(24))*f(18))/2._/**/REALKIND
  M1(2) = ((-A(13)-A(14)-A(15)-A(16))*f(1))/6._/**/REALKIND+((-A(1)-A(3)-A(5)-A(7)-A(9)-A(11))*f(16))/6._/**/REALKIND+((A(17) &
       +A(19)+A(21)+A(23))*f(17))/6._/**/REALKIND+((-A(2)-A(4)-A(6)-A(8)-A(10)-A(12)-A(18)-A(20)-A(22) &
       -A(24))*f(18))/6._/**/REALKIND
  ...
  M2(1) = ((-A(162)-A(165)-A(166)-A(167)-A(176)-A(177)-A(178)-A(179))*f(2))/2._/**/REALKIND+((A(55)+A(69)+A(100) &
       ...
       +((A(102)+A(113))*f(6))/2._/**/REALKIND-(A(25)*f(7))/2._/**/REALKIND+((A(39)+A(45))*f(13))/2._/**/REALKIND+((-A(77) &
       -A(81))*f(14))/2._/**/REALKIND+((A(41)+A(47)+A(79)+A(83))*f(15))/2._/**/REALKIND+((-A(136)-A(138)-A(140)-A(142)-A(144) &
       -A(146)-A(148)-A(150)-A(152)-A(154)-A(156)-A(158)-A(160)-A(163)-A(168)-A(170)-A(172)-A(174))*f(19))/2._/**/REALKIND &
       +((A(180)+A(182)+A(184)+A(186)+A(188)+A(190)+A(192)+A(194)+A(196)+A(198)+A(200)+A(202))*f(20))/2._/**/REALKIND+((-A(137) &
       -A(139)-A(141)-A(143)-A(145)-A(147)-A(149)-A(151)-A(153)-A(155)-A(157)-A(159)-A(161)-A(164)-A(169)-A(171)-A(173)-A(175) &
       -A(181)-A(183)-A(185)-A(187)-A(189)-A(191)-A(193)-A(195)-A(197)-A(199)-A(201)-A(203))*f(21))/2._/**/REALKIND+((A(26)+A(31) &
       +A(48)+A(52)+A(62)+A(66))*f(22))/2._/**/REALKIND+((-A(84)-A(86)-A(92)-A(94))*f(23))/2._/**/REALKIND+((A(27)+A(32)+A(49) &
       +A(53)+A(63)+A(67)+A(85)+A(87)+A(93)+A(95))*f(24))/2._/**/REALKIND+((A(122)+A(124)+A(126)+A(128)+A(130) &
       +A(132))*f(25))/2._/**/REALKIND+((-A(104)-A(108)-A(114)-A(118))*f(26))/2._/**/REALKIND+((A(105)+A(109)+A(115)+A(119)+A(123) &
       +A(125)+A(127)+A(129)+A(131)+A(133))*f(27))/2._/**/REALKIND+((A(36)+A(42)+A(58)+A(60)+A(72)+A(74))*f(28))/2._/**/REALKIND &
       +((-A(88)-A(90)-A(96)-A(98))*f(29))/2._/**/REALKIND+((A(37)+A(43)+A(59)+A(61)+A(73)+A(75)+A(89)+A(91)+A(97) &
       +A(99))*f(30))/2._/**/REALKIND+((A(28)+A(33)+A(50)+A(56)+A(64)+A(70))*f(31))/2._/**/REALKIND+((A(29)+A(34)+A(51)+A(57) &
       +A(65)+A(71))*f(32))/2._/**/REALKIND+((-A(106)-A(110)-A(116)-A(120))*f(33))/2._/**/REALKIND+((A(107)+A(111)+A(117) &
       +A(121))*f(34))/2._/**/REALKIND+((-A(30)-A(35))*f(35))/2._/**/REALKIND+((A(38)+A(44))*f(49))/2._/**/REALKIND+((-A(76) &
       -A(80))*f(50))/2._/**/REALKIND+((A(40)+A(46)+A(78)+A(82))*f(51))/2._/**/REALKIND
  M2(2) = ((A(162)+A(165)+A(166)+A(167)+A(176)+A(177)+A(178)+A(179))*f(2))/6._/**/REALKIND+((-A(55)-A(69)-A(100) &
       ...
       +((-A(102)-A(113))*f(6))/6._/**/REALKIND+(A(25)*f(7))/6._/**/REALKIND+((-A(39)-A(45))*f(13))/6._/**/REALKIND+((A(77) &
       +A(81))*f(14))/6._/**/REALKIND+((-A(41)-A(47)-A(79)-A(83))*f(15))/6._/**/REALKIND+((A(136)+A(138)+A(140)+A(142)+A(144) &
       +A(146)+A(148)+A(150)+A(152)+A(154)+A(156)+A(158)+A(160)+A(163)+A(168)+A(170)+A(172)+A(174))*f(19))/6._/**/REALKIND+(( &
       -A(180)-A(182)-A(184)-A(186)-A(188)-A(190)-A(192)-A(194)-A(196)-A(198)-A(200)-A(202))*f(20))/6._/**/REALKIND+((A(137) &
       +A(139)+A(141)+A(143)+A(145)+A(147)+A(149)+A(151)+A(153)+A(155)+A(157)+A(159)+A(161)+A(164)+A(169)+A(171)+A(173)+A(175) &
       +A(181)+A(183)+A(185)+A(187)+A(189)+A(191)+A(193)+A(195)+A(197)+A(199)+A(201)+A(203))*f(21))/6._/**/REALKIND+((-A(26)-A(31) &
       -A(48)-A(52)-A(62)-A(66))*f(22))/6._/**/REALKIND+((A(84)+A(86)+A(92)+A(94))*f(23))/6._/**/REALKIND+((-A(27)-A(32)-A(49) &
       -A(53)-A(63)-A(67)-A(85)-A(87)-A(93)-A(95))*f(24))/6._/**/REALKIND+((-A(122)-A(124)-A(126)-A(128)-A(130) &
       -A(132))*f(25))/6._/**/REALKIND+((A(104)+A(108)+A(114)+A(118))*f(26))/6._/**/REALKIND+((-A(105)-A(109)-A(115)-A(119)-A(123) &
       -A(125)-A(127)-A(129)-A(131)-A(133))*f(27))/6._/**/REALKIND+((-A(36)-A(42)-A(58)-A(60)-A(72)-A(74))*f(28))/6._/**/REALKIND &
       +((A(88)+A(90)+A(96)+A(98))*f(29))/6._/**/REALKIND+((-A(37)-A(43)-A(59)-A(61)-A(73)-A(75)-A(89)-A(91)-A(97) &
       -A(99))*f(30))/6._/**/REALKIND+((-A(28)-A(33)-A(50)-A(56)-A(64)-A(70))*f(31))/6._/**/REALKIND+((-A(29)-A(34)-A(51)-A(57) &
       -A(65)-A(71))*f(32))/6._/**/REALKIND+((A(106)+A(110)+A(116)+A(120))*f(33))/6._/**/REALKIND+((-A(107)-A(111)-A(117) &
       -A(121))*f(34))/6._/**/REALKIND+((A(30)+A(35))*f(35))/6._/**/REALKIND+((-A(38)-A(44))*f(49))/6._/**/REALKIND+((A(76) &
       +A(80))*f(50))/6._/**/REALKIND+((-A(40)-A(46)-A(78)-A(82))*f(51))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphlljj_eexuuxbbxh_1_/**/REALKIND
