...
module ol_colourmatrix_pphlljj_eexuuxccxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphlljj_eexuuxccxh_1_/**/REALKIND



module ol_forced_parameters_pphlljj_eexuuxccxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlljj_eexuuxccxh_1_/**/REALKIND

module ol_loop_pphlljj_eexuuxccxh_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(21), c(27)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*ctGcc*eQED**3*gQCD**4*lambdaHZZ*MW)/(cw**2*sw)
    f( 4) = (CI*countertermnorm*ctGqq*eQED**3*gQCD**4*lambdaHZZ*MW)/(cw**2*sw)
    f( 5) = (CI*countertermnorm*ctVcc*eQED**3*gQCD**4*lambdaHZZ*MW)/(cw**2*sw)
    ...
    f(13) = (2*CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MB*YB)/(3._/**/REALKIND*MQ2sum)
    f(14) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MB*YB)/MQ2sum
    f(15) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*6._/**/REALKIND)
    f(16) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*3._/**/REALKIND)
    f(17) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    ...
    f(20) = (eQED**3*gQCD**4*integralnorm*SwF*YT)/(MW*sw*3._/**/REALKIND)
    f(21) = (eQED**3*gQCD**4*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)

  c = [ 9*CI*f(8), 27*CI*f(8), 18*f(9), 54*f(9), f(10), 3*f(10), 6*f(10), 8*f(10), 10*f(10), 18*f(10), 21*f(10), 24*f(10) &
    , 54*f(10), 3*f(11), 9*f(11), 3*f(12), 9*f(12), 3*f(15), 9*f(15), 3*f(16), 9*f(16), 3*f(17), 9*f(17), 3*f(20), 9*f(20) &
    , 3*f(21), 9*f(21) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call vert_QA_Z(gZu,wf(:,-4),wf(:,10),wf(:,11))
  ...
  call vert_ZQ_A(gZu,wf(:,3),wf(:,-4),wf(:,25))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(34)-A(35)-A(36)-A(37)-A(38)-A(39)-A(40)-A(41))*f(2))/2._/**/REALKIND+((A(15)+A(17)+A(26) &
       +A(27))*f(3))/2._/**/REALKIND+((A(29)+A(30)+A(32)+A(33))*f(4))/2._/**/REALKIND+((A(14)+A(16))*f(5))/2._/**/REALKIND+((A(28) &
       +A(31))*f(6))/2._/**/REALKIND-(A(5)*f(7))/2._/**/REALKIND+((-A(7)-A(11)-A(19)-A(23))*f(13))/2._/**/REALKIND+((A(9)+A(13) &
       +A(21)+A(25))*f(14))/2._/**/REALKIND+((-A(6)-A(10)-A(18)-A(22))*f(18))/2._/**/REALKIND+((A(8)+A(12)+A(20) &
       +A(24))*f(19))/2._/**/REALKIND
  M2(2) = ((A(34)+A(35)+A(36)+A(37)+A(38)+A(39)+A(40)+A(41))*f(2))/6._/**/REALKIND+((-A(15)-A(17)-A(26) &
       -A(27))*f(3))/6._/**/REALKIND+((-A(29)-A(30)-A(32)-A(33))*f(4))/6._/**/REALKIND+((-A(14)-A(16))*f(5))/6._/**/REALKIND+(( &
       -A(28)-A(31))*f(6))/6._/**/REALKIND+(A(5)*f(7))/6._/**/REALKIND+((A(7)+A(11)+A(19)+A(23))*f(13))/6._/**/REALKIND+((-A(9) &
       -A(13)-A(21)-A(25))*f(14))/6._/**/REALKIND+((A(6)+A(10)+A(18)+A(22))*f(18))/6._/**/REALKIND+((-A(8)-A(12)-A(20) &
       -A(24))*f(19))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphlljj_eexuuxccxh_1_/**/REALKIND
