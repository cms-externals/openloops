...
module ol_colourmatrix_pphlljj_eexuuuxuxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphlljj_eexuuuxuxh_1_/**/REALKIND



module ol_forced_parameters_pphlljj_eexuuuxuxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlljj_eexuuuxuxh_1_/**/REALKIND

module ol_loop_pphlljj_eexuuuxuxh_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(11) = (2*CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MB*YB)/(3._/**/REALKIND*MQ2sum)
    f(12) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MB*YB)/MQ2sum
    f(13) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*6._/**/REALKIND)
    f(14) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*3._/**/REALKIND)
    f(15) = (eQED**3*gQCD**4*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f(16) = (2*CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/(3._/**/REALKIND*MQ2sum)
    f(17) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**4*MT*YT)/MQ2sum
  ...
  c = [ 9*CI*f(6), 27*CI*f(6), 18*f(7), 54*f(7), f(8), 3*f(8), 6*f(8), 8*f(8), 10*f(8), 18*f(8), 21*f(8), 24*f(8), 54*f(8), 3*f(9) &
    , 9*f(9), 3*f(10), 9*f(10), 3*f(13), 9*f(13), 3*f(14), 9*f(14), 3*f(15), 9*f(15), 3*f(18), 9*f(18), 3*f(19), 9*f(19) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZu,wf(:,3),wf(:,-3),wf(:,39))
  ...
  call vert_ZQ_A(gZu,wf(:,3),wf(:,-2),wf(:,57))
  ...
  call counter_QA_Z(gZu,wf(:,14),wf(:,-5),wf(:,62))
  ...
  call vert_AZ_Q(gZu,wf(:,-4),wf(:,3),wf(:,72))
  ...
  call vert_ZQ_A(gZu,wf(:,7),wf(:,-2),wf(:,146))
  ...
  call vert_AZ_Q(gZu,wf(:,-4),wf(:,7),wf(:,152))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(71)+A(72)+A(73)+A(74)+A(75)+A(76)+A(77)+A(78))*f(2))/6._/**/REALKIND+((A(67)+A(68)+A(69)+A(70)+A(79)+A(80)+A(81) &
       ...
       +A(35))*f(16))/6._/**/REALKIND+((A(10)+A(14)+A(39)+A(43))*f(16))/2._/**/REALKIND+((-A(23)-A(27)-A(33) &
       -A(37))*f(17))/6._/**/REALKIND+((-A(12)-A(16)-A(41)-A(45))*f(17))/2._/**/REALKIND
  M2(2) = ((-A(71)-A(72)-A(73)-A(74)-A(75)-A(76)-A(77)-A(78))*f(2))/2._/**/REALKIND+((-A(67)-A(68)-A(69)-A(70)-A(79)-A(80)-A(81) &
       ...
       -A(35))*f(16))/2._/**/REALKIND+((-A(10)-A(14)-A(39)-A(43))*f(16))/6._/**/REALKIND+((A(23)+A(27)+A(33) &
       +A(37))*f(17))/2._/**/REALKIND+((A(12)+A(16)+A(41)+A(45))*f(17))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphlljj_eexuuuxuxh_1_/**/REALKIND
