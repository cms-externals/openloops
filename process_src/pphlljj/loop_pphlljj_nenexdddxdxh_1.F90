...
module ol_colourmatrix_pphlljj_nenexdddxdxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphlljj_nenexdddxdxh_1_/**/REALKIND



module ol_forced_parameters_pphlljj_nenexdddxdxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphlljj_nenexdddxdxh_1_/**/REALKIND

module ol_loop_pphlljj_nenexdddxdxh_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,7),wf(:,-2),wf(:,129))
  ...
  call vert_AZ_Q(gZd,wf(:,-4),wf(:,7),wf(:,135))
...
end module ol_loop_pphlljj_nenexdddxdxh_1_/**/REALKIND
