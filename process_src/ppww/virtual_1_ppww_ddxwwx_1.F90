...
module ol_vamp_1_ppww_ddxwwx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppww_ddxwwx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppww_ddxwwx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppww_ddxwwx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppww_ddxwwx_1_/**/REALKIND
  ...
  call loop_VA_Q(G0(:,:,:,1),wf(:,10),G0(:,:,:,2))
  call loop_A_Q(G0(:,:,:,2),Q(:,6),ZERO,G1(:,:,:,1))
...
end module ol_vamp_1_ppww_ddxwwx_1_/**/REALKIND
