...
module ol_versiondata_ppww
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppww(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppww
  end interface
end module ol_versiondata_ppww


subroutine ol_version_ppww(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppww, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppww
