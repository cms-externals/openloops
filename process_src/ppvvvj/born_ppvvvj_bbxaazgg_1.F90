...
module ol_colourmatrix_ppvvvj_bbxaazgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvvj_bbxaazgg_1_/**/REALKIND



module ol_forced_parameters_ppvvvj_bbxaazgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvvj_bbxaazgg_1_/**/REALKIND

module ol_tree_ppvvvj_bbxaazgg_1_/**/REALKIND
...
subroutine factors_init()
  ...
  ! factors of the diagrams
    ...
    f(2) = (eQED**3*gQCD**2)/9._/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppvvvj_bbxaazgg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppvvvj_bbxaazgg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for bottom anti-bottom gamma gamma Z glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppvvvj_bbxaazgg_1, only: external_perm_ppvvvj_bbxaazgg_1, &
    & external_perm_inv_ppvvvj_bbxaazgg_1, extcomb_perm_ppvvvj_bbxaazgg_1, &
    & average_factor_ppvvvj_bbxaazgg_1
  use ol_external_ppvvvj_bbxaazgg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppvvvj_bbxaazgg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppvvvj_bbxaazgg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppvvvj_bbxaazgg_1
  ...
  extmasses2 = [ rMB2, rMB2, rZERO2, rZERO2, rMZ2, rZERO2, rZERO2 ]
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppvvvj_bbxaazgg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppvvvj_bbxaazgg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppvvvj_bbxaazgg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppvvvj_bbxaazgg_1(extcombs(k))
  end do
  ...
  call prop_A_Q(ntry, wf8(:,1), Q(:,42), MB, 1_intkind1, wf8(:,2), n2(5))
  call vert_VQ_A(ntry, ex7, wf12(:,2), wf24(:,1), n3(:,9), t3x24(:,:,1))
  call vert_AV_Q(ntry, wf4(:,5), ex7, wf8(:,3), n3(:,10), t3x8(:,:,2))
  call prop_A_Q(ntry, wf8(:,3), Q(:,74), MB, 1_intkind1, wf8(:,4), n2(6))
  call vert_VQ_A(ntry, ex6, wf12(:,2), wf24(:,2), n3(:,11), t3x24(:,:,2))
  call vert_VQ_A(ntry, ex6, wf4(:,4), wf8(:,5), n3(:,12), t3x8(:,:,3))
  call prop_Q_A(ntry, wf8(:,5), Q(:,37), MB, 1_intkind1, wf8(:,6), n2(7))
  call vert_AV_Q(ntry, wf12(:,4), ex7, wf24(:,3), n3(:,13), t3x24(:,:,3))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,6), wf24(:,4), n3(:,14), t3x24(:,:,4))
  call vert_VQ_A(ntry, ex7, wf4(:,4), wf8(:,7), n3(:,15), t3x8(:,:,4))
  call prop_Q_A(ntry, wf8(:,7), Q(:,69), MB, 1_intkind1, wf8(:,8), n2(8))
  call vert_AV_Q(ntry, wf12(:,4), ex6, wf24(:,5), n3(:,16), t3x24(:,:,5))
  call vert_AZ_Q(gZd,ntry, wf8(:,2), ex5, wf24(:,6), n3(:,17), t3x24(:,:,6))
  call vert_AZ_Q(gZd,ntry, ex2, ex5, wf6(:,1), n3(:,18), t3x6(:,:,1))
  call prop_A_Q(ntry, wf6(:,1), Q(:,18), MB, 1_intkind1, wf6(:,2), n2(9))
  call vert_VQ_A(ntry, ex4, wf4(:,4), wf8(:,9), n3(:,19), t3x8(:,:,5))
  call vert_AV_Q(ntry, wf6(:,2), wf4(:,3), wf24(:,7), n3(:,20), t3x24(:,:,7))
  call prop_Q_A(ntry, wf8(:,9), Q(:,13), MB, 1_intkind1, wf8(:,10), n2(10))
  call vert_AV_Q(ntry, wf6(:,2), ex4, wf12(:,5), n3(:,21), t3x12(:,:,3))
  call prop_A_Q(ntry, wf12(:,5), Q(:,26), MB, 1_intkind1, wf12(:,6), n2(11))
  call vert_AV_Q(ntry, wf6(:,2), ex6, wf12(:,7), n3(:,22), t3x12(:,:,4))
  call prop_A_Q(ntry, wf12(:,7), Q(:,50), MB, 1_intkind1, wf12(:,8), n2(12))
  call vert_VQ_A(ntry, ex7, wf8(:,10), wf16(:,3), n3(:,23), t3x16(:,:,3))
  call vert_AV_Q(ntry, wf6(:,2), ex7, wf12(:,9), n3(:,24), t3x12(:,:,5))
  call prop_A_Q(ntry, wf12(:,9), Q(:,82), MB, 1_intkind1, wf12(:,10), n2(13))
  ...
  call prop_A_Q(ntry, wf4(:,6), Q(:,34), MB, 1_intkind1, wf4(:,7), n2(14))
  call vert_AZ_Q(gZd,ntry, wf4(:,7), ex5, wf12(:,11), n3(:,31), t3x12(:,:,6))
  call prop_A_Q(ntry, wf12(:,11), Q(:,50), MB, 1_intkind1, wf12(:,12), n2(15))
  call vert_AV_Q(ntry, wf4(:,7), ex7, wf8(:,11), n3(:,32), t3x8(:,:,6))
  call prop_A_Q(ntry, wf8(:,11), Q(:,98), MB, 1_intkind1, wf8(:,12), n2(16))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,10), wf24(:,11), n3(:,33), t3x24(:,:,11))
  call vert_AV_Q(ntry, wf4(:,7), ex4, wf8(:,13), n3(:,34), t3x8(:,:,7))
  call prop_A_Q(ntry, wf8(:,13), Q(:,42), MB, 1_intkind1, wf8(:,14), n2(17))
  call vert_AV_Q(ntry, wf8(:,14), ex7, wf16(:,6), n3(:,35), t3x16(:,:,6))
  call vert_VQ_A(ntry, ex4, wf12(:,2), wf24(:,12), n3(:,36), t3x24(:,:,12))
  call vert_AZ_Q(gZd,ntry, wf8(:,14), ex5, wf24(:,13), n3(:,37), t3x24(:,:,13))
  call vert_AV_Q(ntry, wf12(:,12), ex4, wf24(:,14), n3(:,38), t3x24(:,:,14))
  call vert_AV_Q(ntry, ex2, ex7, wf4(:,8), n3(:,39), t3x4(:,:,5))
  call prop_A_Q(ntry, wf4(:,8), Q(:,66), MB, 1_intkind1, wf4(:,9), n2(18))
  call vert_AZ_Q(gZd,ntry, wf4(:,9), ex5, wf12(:,13), n3(:,40), t3x12(:,:,7))
  call prop_A_Q(ntry, wf12(:,13), Q(:,82), MB, 1_intkind1, wf12(:,14), n2(19))
  call vert_AV_Q(ntry, wf4(:,9), ex6, wf8(:,15), n3(:,41), t3x8(:,:,8))
  call prop_A_Q(ntry, wf8(:,15), Q(:,98), MB, 1_intkind1, wf8(:,16), n2(20))
  call vert_AV_Q(ntry, wf4(:,9), ex4, wf8(:,17), n3(:,42), t3x8(:,:,9))
  call prop_A_Q(ntry, wf8(:,17), Q(:,74), MB, 1_intkind1, wf8(:,18), n2(21))
  call vert_AV_Q(ntry, wf8(:,18), ex6, wf16(:,7), n3(:,43), t3x16(:,:,7))
  call vert_AZ_Q(gZd,ntry, wf8(:,18), ex5, wf24(:,15), n3(:,44), t3x24(:,:,15))
  call vert_AV_Q(ntry, wf12(:,14), ex4, wf24(:,16), n3(:,45), t3x24(:,:,16))
  call vert_AV_Q(ntry, ex2, wf4(:,3), wf8(:,19), n3(:,46), t3x8(:,:,10))
  call prop_A_Q(ntry, wf8(:,19), Q(:,98), MB, 1_intkind1, wf8(:,20), n2(22))
  call vert_AZ_Q(gZd,ntry, wf8(:,20), ex5, wf24(:,17), n3(:,47), t3x24(:,:,17))
  ...
  call prop_Q_A(ntry, wf4(:,10), Q(:,9), MB, 1_intkind1, wf4(:,12), n2(23))
  call prop_A_Q(ntry, wf4(:,11), Q(:,6), MB, 1_intkind1, wf4(:,13), n2(24))
  call vert_ZQ_A(gZd,ntry, ex5, wf4(:,12), wf12(:,15), n3(:,51), t3x12(:,:,8))
  call vert_AV_Q(ntry, wf4(:,13), wf4(:,3), wf16(:,9), n3(:,52), t3x16(:,:,9))
  call prop_Q_A(ntry, wf12(:,15), Q(:,25), MB, 1_intkind1, wf12(:,16), n2(25))
  call vert_AZ_Q(gZd,ntry, wf4(:,13), ex5, wf12(:,17), n3(:,53), t3x12(:,:,9))
  call vert_VQ_A(ntry, wf4(:,3), wf4(:,12), wf16(:,10), n3(:,54), t3x16(:,:,10))
  call prop_A_Q(ntry, wf12(:,17), Q(:,22), MB, 1_intkind1, wf12(:,18), n2(26))
  call vert_AV_Q(ntry, wf4(:,13), ex6, wf8(:,21), n3(:,55), t3x8(:,:,11))
  call prop_A_Q(ntry, wf8(:,21), Q(:,38), MB, 1_intkind1, wf8(:,22), n2(27))
  call vert_VQ_A(ntry, ex7, wf12(:,16), wf24(:,18), n3(:,56), t3x24(:,:,18))
  call vert_AV_Q(ntry, wf4(:,13), ex7, wf8(:,23), n3(:,57), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,23), Q(:,70), MB, 1_intkind1, wf8(:,24), n2(28))
  call vert_VQ_A(ntry, ex6, wf12(:,16), wf24(:,19), n3(:,58), t3x24(:,:,19))
  call vert_VQ_A(ntry, ex6, wf4(:,12), wf8(:,25), n3(:,59), t3x8(:,:,13))
  call prop_Q_A(ntry, wf8(:,25), Q(:,41), MB, 1_intkind1, wf8(:,26), n2(29))
  call vert_AV_Q(ntry, wf12(:,18), ex7, wf24(:,20), n3(:,60), t3x24(:,:,20))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,26), wf24(:,21), n3(:,61), t3x24(:,:,21))
  call vert_VQ_A(ntry, ex7, wf4(:,12), wf8(:,27), n3(:,62), t3x8(:,:,14))
  call prop_Q_A(ntry, wf8(:,27), Q(:,73), MB, 1_intkind1, wf8(:,28), n2(30))
  call vert_AV_Q(ntry, wf12(:,18), ex6, wf24(:,22), n3(:,63), t3x24(:,:,22))
  call vert_AZ_Q(gZd,ntry, wf8(:,22), ex5, wf24(:,23), n3(:,64), t3x24(:,:,23))
  call vert_ZQ_A(gZd,ntry, ex5, ex1, wf6(:,3), n3(:,65), t3x6(:,:,2))
  call prop_Q_A(ntry, wf6(:,3), Q(:,17), MB, 1_intkind1, wf6(:,4), n2(31))
  call vert_VQ_A(ntry, ex4, wf6(:,4), wf12(:,19), n3(:,66), t3x12(:,:,10))
  call prop_Q_A(ntry, wf12(:,19), Q(:,25), MB, 1_intkind1, wf12(:,20), n2(32))
  call vert_AV_Q(ntry, wf4(:,13), ex4, wf8(:,29), n3(:,67), t3x8(:,:,15))
  call vert_VQ_A(ntry, wf4(:,3), wf6(:,4), wf24(:,24), n3(:,68), t3x24(:,:,24))
  call prop_A_Q(ntry, wf8(:,29), Q(:,14), MB, 1_intkind1, wf8(:,30), n2(33))
  ...
  call prop_Q_A(ntry, wf12(:,21), Q(:,49), MB, 1_intkind1, wf12(:,22), n2(34))
  ...
  call prop_Q_A(ntry, wf12(:,23), Q(:,81), MB, 1_intkind1, wf12(:,24), n2(35))
  ...
  call prop_Q_A(ntry, wf4(:,14), Q(:,33), MB, 1_intkind1, wf4(:,15), n2(36))
  call vert_VQ_A(ntry, ex4, wf4(:,15), wf8(:,31), n3(:,78), t3x8(:,:,16))
  call prop_Q_A(ntry, wf8(:,31), Q(:,41), MB, 1_intkind1, wf8(:,32), n2(37))
  call vert_VQ_A(ntry, ex7, wf8(:,32), wf16(:,14), n3(:,79), t3x16(:,:,14))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,32), wf24(:,28), n3(:,80), t3x24(:,:,28))
  call vert_ZQ_A(gZd,ntry, ex5, wf4(:,15), wf12(:,25), n3(:,81), t3x12(:,:,13))
  call prop_Q_A(ntry, wf12(:,25), Q(:,49), MB, 1_intkind1, wf12(:,26), n2(38))
  call vert_VQ_A(ntry, ex4, wf12(:,26), wf24(:,29), n3(:,82), t3x24(:,:,29))
  call vert_VQ_A(ntry, ex7, wf4(:,15), wf8(:,33), n3(:,83), t3x8(:,:,17))
  call prop_Q_A(ntry, wf8(:,33), Q(:,97), MB, 1_intkind1, wf8(:,34), n2(39))
  call vert_AZ_Q(gZd,ntry, wf8(:,30), ex5, wf24(:,30), n3(:,84), t3x24(:,:,30))
  call vert_AV_Q(ntry, wf12(:,18), ex4, wf24(:,31), n3(:,85), t3x24(:,:,31))
  call vert_VQ_A(ntry, ex7, ex1, wf4(:,16), n3(:,86), t3x4(:,:,9))
  call prop_Q_A(ntry, wf4(:,16), Q(:,65), MB, 1_intkind1, wf4(:,17), n2(40))
  call vert_VQ_A(ntry, ex4, wf4(:,17), wf8(:,35), n3(:,87), t3x8(:,:,18))
  call prop_Q_A(ntry, wf8(:,35), Q(:,73), MB, 1_intkind1, wf8(:,36), n2(41))
  call vert_VQ_A(ntry, ex6, wf8(:,36), wf16(:,15), n3(:,88), t3x16(:,:,15))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,36), wf24(:,32), n3(:,89), t3x24(:,:,32))
  call vert_ZQ_A(gZd,ntry, ex5, wf4(:,17), wf12(:,27), n3(:,90), t3x12(:,:,14))
  call prop_Q_A(ntry, wf12(:,27), Q(:,81), MB, 1_intkind1, wf12(:,28), n2(42))
  call vert_VQ_A(ntry, ex4, wf12(:,28), wf24(:,33), n3(:,91), t3x24(:,:,33))
  call vert_VQ_A(ntry, ex6, wf4(:,17), wf8(:,37), n3(:,92), t3x8(:,:,19))
  call prop_Q_A(ntry, wf8(:,37), Q(:,97), MB, 1_intkind1, wf8(:,38), n2(43))
  call vert_VQ_A(ntry, wf4(:,3), ex1, wf8(:,39), n3(:,93), t3x8(:,:,20))
  call prop_Q_A(ntry, wf8(:,39), Q(:,97), MB, 1_intkind1, wf8(:,40), n2(44))
  call vert_VQ_A(ntry, ex4, wf8(:,40), wf16(:,16), n3(:,94), t3x16(:,:,16))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,40), wf24(:,34), n3(:,95), t3x24(:,:,34))
  call vert_VQ_A(ntry, ex3, wf4(:,12), wf8(:,41), n3(:,96), t3x8(:,:,21))
  call prop_Q_A(ntry, wf8(:,41), Q(:,13), MB, 1_intkind1, wf8(:,42), n2(45))
  call vert_AV_Q(ntry, wf6(:,2), ex3, wf12(:,29), n3(:,97), t3x12(:,:,15))
  call prop_A_Q(ntry, wf12(:,29), Q(:,22), MB, 1_intkind1, wf12(:,30), n2(46))
  ...
  call prop_Q_A(ntry, wf12(:,31), Q(:,21), MB, 1_intkind1, wf12(:,32), n2(49))
  call vert_AV_Q(ntry, wf4(:,5), ex3, wf8(:,47), n3(:,116), t3x8(:,:,24))
  call prop_A_Q(ntry, wf8(:,47), Q(:,14), MB, 1_intkind1, wf8(:,48), n2(50))
  ...
  call prop_Q_A(ntry, wf8(:,49), Q(:,37), MB, 1_intkind1, wf8(:,50), n2(51))
  call vert_VQ_A(ntry, ex7, wf8(:,50), wf16(:,26), n3(:,124), t3x16(:,:,26))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,50), wf24(:,47), n3(:,125), t3x24(:,:,47))
  call vert_VQ_A(ntry, ex3, wf12(:,26), wf24(:,48), n3(:,126), t3x24(:,:,48))
  call vert_AZ_Q(gZd,ntry, wf8(:,48), ex5, wf24(:,49), n3(:,127), t3x24(:,:,49))
  call vert_AV_Q(ntry, wf12(:,4), ex3, wf24(:,50), n3(:,128), t3x24(:,:,50))
  call vert_VQ_A(ntry, ex3, wf4(:,17), wf8(:,51), n3(:,129), t3x8(:,:,26))
  call prop_Q_A(ntry, wf8(:,51), Q(:,69), MB, 1_intkind1, wf8(:,52), n2(52))
  call vert_VQ_A(ntry, ex6, wf8(:,52), wf16(:,27), n3(:,130), t3x16(:,:,27))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,52), wf24(:,51), n3(:,131), t3x24(:,:,51))
  ...
  M2add = M2 / average_factor_ppvvvj_bbxaazgg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppvvvj_bbxaazgg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppvvvj_bbxaazgg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppvvvj_bbxaazgg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppvvvj_bbxaazgg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppvvvj_bbxaazgg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppvvvj_bbxaazgg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppvvvj_bbxaazgg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppvvvj_bbxaazgg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppvvvj_bbxaazgg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppvvvj_bbxaazgg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppvvvj_bbxaazgg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppvvvj_bbxaazgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppvvvj_bbxaazgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppvvvj_bbxaazgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppvvvj_bbxaazgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppvvvj_bbxaazgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppvvvj_bbxaazgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppvvvj_bbxaazgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppvvvj_bbxaazgg_1_/**/REALKIND
