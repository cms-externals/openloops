...
module ol_versiondata_ppvvvj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppvvvj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppvvvj
  end interface
end module ol_versiondata_ppvvvj


subroutine ol_version_ppvvvj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppvvvj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppvvvj
