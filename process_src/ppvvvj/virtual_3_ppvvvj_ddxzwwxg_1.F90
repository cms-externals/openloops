...
module ol_vamp_3_ppvvvj_ddxzwwxg_1_/**/REALKIND
contains
...
! **********************************************************************
  ...
  call check_last_QA_V(l_switch,G1(:,:,:,1),wf(:,34),G1tensor(:,1))
  ...
  call check_last_QA_V(l_switch,G1(:,:,:,3),wf(:,34),G1tensor(:,2))
  ...
  call loop_AZ_Q(G1(:,:,:,11),wf(:,-2),G1(:,:,:,12),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,13),wf(:,-2),G1(:,:,:,14),gZd)
  ...
  call loop_Q_A(G0(:,:,:,9),Q(:,53),ZERO,G1(:,:,:,15))
  call loop_QW_A(G1(:,:,:,15),wf(:,-3),G1(:,:,:,16))
...
end module ol_vamp_3_ppvvvj_ddxzwwxg_1_/**/REALKIND
