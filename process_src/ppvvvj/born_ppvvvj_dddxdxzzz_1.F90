...
module ol_colourmatrix_ppvvvj_dddxdxzzz_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvvj_dddxdxzzz_1_/**/REALKIND



module ol_forced_parameters_ppvvvj_dddxdxzzz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvvj_dddxdxzzz_1_/**/REALKIND

module ol_tree_ppvvvj_dddxdxzzz_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppvvvj_dddxdxzzz_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppvvvj_dddxdxzzz_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for down down anti-down anti-down Z Z Z -> 0
...
! **********************************************************************
  ...
  use ol_external_ppvvvj_dddxdxzzz_1, only: external_perm_ppvvvj_dddxdxzzz_1, &
    & external_perm_inv_ppvvvj_dddxdxzzz_1, extcomb_perm_ppvvvj_dddxdxzzz_1, &
    & average_factor_ppvvvj_dddxdxzzz_1
  use ol_external_ppvvvj_dddxdxzzz_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppvvvj_dddxdxzzz_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppvvvj_dddxdxzzz_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppvvvj_dddxdxzzz_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppvvvj_dddxdxzzz_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppvvvj_dddxdxzzz_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppvvvj_dddxdxzzz_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppvvvj_dddxdxzzz_1(extcombs(k))
  end do
  ...
  call vert_ZQ_A(gZd,ntry, ex6, ex2, wf6(:,7), n3(:,15), t3x6(:,:,4))
  ...
  call vert_ZQ_A(gZd,ntry, ex7, ex2, wf6(:,11), n3(:,21), t3x6(:,:,6))
  ...
  call vert_QA_Z(gZd,ntry, ex2, wf8(:,2), wf16(:,2), n3(:,37), t3x16(:,:,2))
  ...
  call vert_ZQ_A(gZd,ntry, ex7, wf6(:,14), wf18(:,25), n3(:,44), t3x18(:,:,13))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf6(:,14), wf18(:,27), n3(:,47), t3x18(:,:,14))
  ...
  call vert_AZ_Q(gZd,ntry, wf8(:,6), ex7, wf24(:,16), n3(:,50), t3x24(:,:,16))
  call vert_AZ_Q(gZd,ntry, wf8(:,6), ex6, wf24(:,17), n3(:,51), t3x24(:,:,17))
  call vert_ZQ_A(gZd,ntry, ex6, ex1, wf6(:,15), n3(:,52), t3x6(:,:,8))
  call prop_Q_A(ntry, wf6(:,15), Q(:,33), ZERO, 0_intkind1, wf6(:,16), n2(28))
  call vert_ZQ_A(gZd,ntry, ex7, wf6(:,16), wf18(:,29), n3(:,53), t3x18(:,:,15))
  ...
  call vert_ZQ_A(gZd,ntry, ex7, ex1, wf6(:,17), n3(:,56), t3x6(:,:,9))
  call prop_Q_A(ntry, wf6(:,17), Q(:,65), ZERO, 0_intkind1, wf6(:,18), n2(30))
  call vert_ZQ_A(gZd,ntry, ex6, wf6(:,18), wf18(:,31), n3(:,57), t3x18(:,:,16))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf8(:,8), wf24(:,21), n3(:,60), t3x24(:,:,21))
  call vert_ZQ_A(gZd,ntry, ex7, wf8(:,8), wf24(:,22), n3(:,61), t3x24(:,:,22))
  call vert_ZQ_A(gZd,ntry, ex5, wf6(:,16), wf18(:,33), n3(:,62), t3x18(:,:,17))
  call prop_Q_A(ntry, wf18(:,33), Q(:,49), ZERO, 0_intkind1, wf18(:,34), n2(33))
  call vert_AZ_Q(gZd,ntry, wf8(:,6), ex5, wf24(:,23), n3(:,63), t3x24(:,:,23))
  call vert_ZQ_A(gZd,ntry, ex5, wf6(:,18), wf18(:,35), n3(:,64), t3x18(:,:,18))
  call prop_Q_A(ntry, wf18(:,35), Q(:,81), ZERO, 0_intkind1, wf18(:,36), n2(34))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,8), wf24(:,24), n3(:,65), t3x24(:,:,24))
  call vert_QA_Z(gZd,ntry, wf8(:,8), ex4, wf16(:,3), n3(:,66), t3x16(:,:,3))
  call vert_QA_Z(gZd,ntry, ex1, wf8(:,6), wf16(:,4), n3(:,67), t3x16(:,:,4))
  call vert_QA_V(ntry, ex1, ex4, wf4(:,3), n3(:,68), t3x4(:,:,3))
  call vert_AZ_Q(gZd,ntry, ex3, ex6, wf6(:,19), n3(:,69), t3x6(:,:,10))
  call prop_A_Q(ntry, wf6(:,19), Q(:,36), ZERO, 0_intkind1, wf6(:,20), n2(35))
  call vert_AV_Q(ntry, wf6(:,20), wf4(:,3), wf24(:,25), n3(:,70), t3x24(:,:,25))
  call vert_AZ_Q(gZd,ntry, wf6(:,20), ex7, wf18(:,37), n3(:,71), t3x18(:,:,19))
  call vert_VQ_A(ntry, wf4(:,3), wf6(:,3), wf24(:,26), n3(:,72), t3x24(:,:,26))
  call prop_A_Q(ntry, wf18(:,37), Q(:,100), ZERO, 0_intkind1, wf18(:,38), n2(36))
  call vert_AZ_Q(gZd,ntry, ex3, ex7, wf6(:,21), n3(:,73), t3x6(:,:,11))
  call prop_A_Q(ntry, wf6(:,21), Q(:,68), ZERO, 0_intkind1, wf6(:,22), n2(37))
  call vert_AV_Q(ntry, wf6(:,22), wf4(:,3), wf24(:,27), n3(:,74), t3x24(:,:,27))
  call vert_AZ_Q(gZd,ntry, wf6(:,22), ex6, wf18(:,39), n3(:,75), t3x18(:,:,20))
  ...
  call vert_AZ_Q(gZd,ntry, wf8(:,10), ex7, wf24(:,28), n3(:,77), t3x24(:,:,28))
  call vert_AZ_Q(gZd,ntry, wf8(:,10), ex6, wf24(:,29), n3(:,78), t3x24(:,:,29))
  call vert_AZ_Q(gZd,ntry, ex3, ex5, wf6(:,23), n3(:,79), t3x6(:,:,12))
  call prop_A_Q(ntry, wf6(:,23), Q(:,20), ZERO, 0_intkind1, wf6(:,24), n2(40))
  call vert_AV_Q(ntry, wf6(:,24), wf4(:,3), wf24(:,30), n3(:,80), t3x24(:,:,30))
  call vert_AZ_Q(gZd,ntry, wf6(:,24), ex7, wf18(:,41), n3(:,81), t3x18(:,:,21))
  call vert_VQ_A(ntry, wf4(:,3), wf6(:,9), wf24(:,31), n3(:,82), t3x24(:,:,31))
  call prop_A_Q(ntry, wf18(:,41), Q(:,84), ZERO, 0_intkind1, wf18(:,42), n2(41))
  call vert_AZ_Q(gZd,ntry, wf6(:,24), ex6, wf18(:,43), n3(:,83), t3x18(:,:,22))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf8(:,12), wf24(:,33), n3(:,86), t3x24(:,:,33))
  call vert_ZQ_A(gZd,ntry, ex7, wf8(:,12), wf24(:,34), n3(:,87), t3x24(:,:,34))
  call vert_AZ_Q(gZd,ntry, wf6(:,22), ex5, wf18(:,45), n3(:,88), t3x18(:,:,23))
  call prop_A_Q(ntry, wf18(:,45), Q(:,84), ZERO, 0_intkind1, wf18(:,46), n2(44))
  call vert_AZ_Q(gZd,ntry, wf8(:,10), ex5, wf24(:,35), n3(:,89), t3x24(:,:,35))
  call vert_AZ_Q(gZd,ntry, wf6(:,20), ex5, wf18(:,47), n3(:,90), t3x18(:,:,24))
  call prop_A_Q(ntry, wf18(:,47), Q(:,52), ZERO, 0_intkind1, wf18(:,48), n2(45))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,12), wf24(:,36), n3(:,91), t3x24(:,:,36))
  call vert_QA_Z(gZd,ntry, wf8(:,12), ex3, wf16(:,5), n3(:,92), t3x16(:,:,5))
  call vert_QA_Z(gZd,ntry, ex2, wf8(:,10), wf16(:,6), n3(:,93), t3x16(:,:,6))
  ...
  call vert_AZ_Q(gZd,ntry, wf8(:,14), ex7, wf24(:,40), n3(:,99), t3x24(:,:,40))
  call vert_AZ_Q(gZd,ntry, wf8(:,14), ex6, wf24(:,41), n3(:,100), t3x24(:,:,41))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf8(:,16), wf24(:,45), n3(:,105), t3x24(:,:,45))
  call vert_ZQ_A(gZd,ntry, ex7, wf8(:,16), wf24(:,46), n3(:,106), t3x24(:,:,46))
  call vert_AZ_Q(gZd,ntry, wf8(:,14), ex5, wf24(:,47), n3(:,107), t3x24(:,:,47))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,16), wf24(:,48), n3(:,108), t3x24(:,:,48))
  call vert_QA_Z(gZd,ntry, wf8(:,16), ex3, wf16(:,7), n3(:,109), t3x16(:,:,7))
  call vert_QA_Z(gZd,ntry, ex1, wf8(:,14), wf16(:,8), n3(:,110), t3x16(:,:,8))
  ...
  M2add = M2 / average_factor_ppvvvj_dddxdxzzz_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppvvvj_dddxdxzzz_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppvvvj_dddxdxzzz_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppvvvj_dddxdxzzz_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppvvvj_dddxdxzzz_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppvvvj_dddxdxzzz_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppvvvj_dddxdxzzz_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppvvvj_dddxdxzzz_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppvvvj_dddxdxzzz_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppvvvj_dddxdxzzz_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppvvvj_dddxdxzzz_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppvvvj_dddxdxzzz_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppvvvj_dddxdxzzz_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppvvvj_dddxdxzzz_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppvvvj_dddxdxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppvvvj_dddxdxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppvvvj_dddxdxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppvvvj_dddxdxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppvvvj_dddxdxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppvvvj_dddxdxzzz_1_/**/REALKIND
