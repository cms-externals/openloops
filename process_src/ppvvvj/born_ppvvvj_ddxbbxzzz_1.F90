...
module ol_colourmatrix_ppvvvj_ddxbbxzzz_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvvj_ddxbbxzzz_1_/**/REALKIND



module ol_forced_parameters_ppvvvj_ddxbbxzzz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvvj_ddxbbxzzz_1_/**/REALKIND

module ol_tree_ppvvvj_ddxbbxzzz_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppvvvj_ddxbbxzzz_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppvvvj_ddxbbxzzz_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for down anti-down bottom anti-bottom Z Z Z -> 0
...
! **********************************************************************
  ...
  use ol_external_ppvvvj_ddxbbxzzz_1, only: external_perm_ppvvvj_ddxbbxzzz_1, &
    & external_perm_inv_ppvvvj_ddxbbxzzz_1, extcomb_perm_ppvvvj_ddxbbxzzz_1, &
    & average_factor_ppvvvj_ddxbbxzzz_1
  use ol_external_ppvvvj_ddxbbxzzz_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppvvvj_ddxbbxzzz_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppvvvj_ddxbbxzzz_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppvvvj_ddxbbxzzz_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppvvvj_ddxbbxzzz_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppvvvj_ddxbbxzzz_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppvvvj_ddxbbxzzz_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppvvvj_ddxbbxzzz_1(extcombs(k))
  end do
  ...
  call vert_AZ_Q(gZd,ntry, ex2, ex6, wf6(:,14), n3(:,58), t3x6(:,:,8))
  ...
  call vert_AZ_Q(gZd,ntry, wf8(:,6), ex7, wf24(:,16), n3(:,69), t3x24(:,:,16))
  call vert_AZ_Q(gZd,ntry, wf8(:,6), ex6, wf24(:,17), n3(:,70), t3x24(:,:,17))
  call vert_ZQ_A(gZd,ntry, ex6, ex1, wf6(:,19), n3(:,71), t3x6(:,:,10))
  call vert_AZ_Q(gZd,ntry, ex2, ex5, wf6(:,20), n3(:,72), t3x6(:,:,11))
  call prop_Q_A(ntry, wf6(:,19), Q(:,33), ZERO, 0_intkind1, wf6(:,21), n2(38))
  call prop_A_Q(ntry, wf6(:,20), Q(:,18), ZERO, 0_intkind1, wf6(:,22), n2(39))
  call vert_ZQ_A(gZd,ntry, ex7, wf6(:,21), wf18(:,45), n3(:,73), t3x18(:,:,23))
  call vert_AV_Q(ntry, wf6(:,22), wf4(:,2), wf24(:,18), n3(:,74), t3x24(:,:,18))
  call prop_Q_A(ntry, wf18(:,45), Q(:,97), ZERO, 0_intkind1, wf18(:,46), n2(40))
  call vert_AZ_Q(gZd,ntry, wf6(:,22), ex7, wf18(:,47), n3(:,75), t3x18(:,:,24))
  call vert_VQ_A(ntry, wf4(:,2), wf6(:,21), wf24(:,19), n3(:,76), t3x24(:,:,19))
  call prop_A_Q(ntry, wf18(:,47), Q(:,82), ZERO, 0_intkind1, wf18(:,48), n2(41))
  call vert_ZQ_A(gZd,ntry, ex7, ex1, wf6(:,23), n3(:,77), t3x6(:,:,12))
  call prop_Q_A(ntry, wf6(:,23), Q(:,65), ZERO, 0_intkind1, wf6(:,24), n2(42))
  call vert_ZQ_A(gZd,ntry, ex6, wf6(:,24), wf18(:,49), n3(:,78), t3x18(:,:,25))
  call prop_Q_A(ntry, wf18(:,49), Q(:,97), ZERO, 0_intkind1, wf18(:,50), n2(43))
  call vert_AZ_Q(gZd,ntry, wf6(:,22), ex6, wf18(:,51), n3(:,79), t3x18(:,:,26))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf8(:,8), wf24(:,21), n3(:,82), t3x24(:,:,21))
  call vert_ZQ_A(gZd,ntry, ex7, wf8(:,8), wf24(:,22), n3(:,83), t3x24(:,:,22))
  call vert_ZQ_A(gZd,ntry, ex5, wf6(:,21), wf18(:,53), n3(:,84), t3x18(:,:,27))
  call prop_Q_A(ntry, wf18(:,53), Q(:,49), ZERO, 0_intkind1, wf18(:,54), n2(46))
  call vert_AZ_Q(gZd,ntry, wf6(:,18), ex5, wf18(:,55), n3(:,85), t3x18(:,:,28))
  call prop_A_Q(ntry, wf18(:,55), Q(:,82), ZERO, 0_intkind1, wf18(:,56), n2(47))
  call vert_AZ_Q(gZd,ntry, wf8(:,6), ex5, wf24(:,23), n3(:,86), t3x24(:,:,23))
  call vert_ZQ_A(gZd,ntry, ex5, wf6(:,24), wf18(:,57), n3(:,87), t3x18(:,:,29))
  call prop_Q_A(ntry, wf18(:,57), Q(:,81), ZERO, 0_intkind1, wf18(:,58), n2(48))
  call vert_AZ_Q(gZd,ntry, wf6(:,16), ex5, wf18(:,59), n3(:,88), t3x18(:,:,30))
  call prop_A_Q(ntry, wf18(:,59), Q(:,50), ZERO, 0_intkind1, wf18(:,60), n2(49))
  call vert_ZQ_A(gZd,ntry, ex5, wf8(:,8), wf24(:,24), n3(:,89), t3x24(:,:,24))
  call vert_QA_Z(gZd,ntry, wf8(:,8), ex2, wf16(:,3), n3(:,90), t3x16(:,:,3))
  call vert_QA_Z(gZd,ntry, ex1, wf8(:,6), wf16(:,4), n3(:,91), t3x16(:,:,4))
  ...
  M2add = M2 / average_factor_ppvvvj_ddxbbxzzz_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppvvvj_ddxbbxzzz_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppvvvj_ddxbbxzzz_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppvvvj_ddxbbxzzz_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppvvvj_ddxbbxzzz_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppvvvj_ddxbbxzzz_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppvvvj_ddxbbxzzz_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppvvvj_ddxbbxzzz_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppvvvj_ddxbbxzzz_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppvvvj_ddxbbxzzz_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppvvvj_ddxbbxzzz_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppvvvj_ddxbbxzzz_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppvvvj_ddxbbxzzz_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppvvvj_ddxbbxzzz_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppvvvj_ddxbbxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppvvvj_ddxbbxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppvvvj_ddxbbxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppvvvj_ddxbbxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppvvvj_ddxbbxzzz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppvvvj_ddxbbxzzz_1_/**/REALKIND
