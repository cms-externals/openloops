...
module ol_colourmatrix_ppvvvj_uuxzzzgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvvj_uuxzzzgg_1_/**/REALKIND



module ol_forced_parameters_ppvvvj_uuxzzzgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvvj_uuxzzzgg_1_/**/REALKIND

module ol_tree_ppvvvj_uuxzzzgg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppvvvj_uuxzzzgg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppvvvj_uuxzzzgg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for up anti-up Z Z Z glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppvvvj_uuxzzzgg_1, only: external_perm_ppvvvj_uuxzzzgg_1, &
    & external_perm_inv_ppvvvj_uuxzzzgg_1, extcomb_perm_ppvvvj_uuxzzzgg_1, &
    & average_factor_ppvvvj_uuxzzzgg_1
  use ol_external_ppvvvj_uuxzzzgg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppvvvj_uuxzzzgg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppvvvj_uuxzzzgg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppvvvj_uuxzzzgg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppvvvj_uuxzzzgg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppvvvj_uuxzzzgg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppvvvj_uuxzzzgg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppvvvj_uuxzzzgg_1(extcombs(k))
  end do
  ...
  call vert_ZQ_A(gZu,ntry, ex5, wf12(:,6), wf36(:,4), n3(:,14), t3x36(:,:,4))
  ...
  call vert_AZ_Q(gZu,ntry, wf12(:,2), ex5, wf36(:,6), n3(:,17), t3x36(:,:,6))
  call vert_AZ_Q(gZu,ntry, ex2, ex5, wf6(:,5), n3(:,18), t3x6(:,:,3))
  call prop_A_Q(ntry, wf6(:,5), Q(:,18), ZERO, 0_intkind1, wf6(:,6), n2(9))
  call vert_ZQ_A(gZu,ntry, ex4, wf6(:,3), wf18(:,5), n3(:,19), t3x18(:,:,3))
  call vert_AV_Q(ntry, wf6(:,6), wf4(:,1), wf24(:,3), n3(:,20), t3x24(:,:,3))
  call prop_Q_A(ntry, wf18(:,5), Q(:,13), ZERO, 0_intkind1, wf18(:,6), n2(10))
  call vert_AZ_Q(gZu,ntry, wf6(:,6), ex4, wf18(:,7), n3(:,21), t3x18(:,:,4))
  ...
  call vert_ZQ_A(gZu,ntry, ex4, wf12(:,6), wf36(:,10), n3(:,27), t3x36(:,:,10))
  call vert_AV_Q(ntry, wf18(:,8), ex6, wf36(:,11), n3(:,28), t3x36(:,:,11))
  call vert_AZ_Q(gZu,ntry, wf12(:,10), ex4, wf36(:,12), n3(:,29), t3x36(:,:,12))
  call vert_AV_Q(ntry, ex2, ex6, wf4(:,2), n3(:,30), t3x4(:,:,2))
  call prop_A_Q(ntry, wf4(:,2), Q(:,34), ZERO, 0_intkind1, wf4(:,3), n2(14))
  call vert_AZ_Q(gZu,ntry, wf4(:,3), ex5, wf12(:,13), n3(:,31), t3x12(:,:,7))
  ...
  call vert_ZQ_A(gZu,ntry, ex5, wf18(:,6), wf54(:,1), n3(:,33), t3x54(:,:,1))
  call vert_AZ_Q(gZu,ntry, wf4(:,3), ex4, wf12(:,15), n3(:,34), t3x12(:,:,8))
  call prop_A_Q(ntry, wf12(:,15), Q(:,42), ZERO, 0_intkind1, wf12(:,16), n2(17))
  call vert_AV_Q(ntry, wf12(:,16), ex7, wf24(:,4), n3(:,35), t3x24(:,:,4))
  call vert_ZQ_A(gZu,ntry, ex4, wf18(:,2), wf54(:,2), n3(:,36), t3x54(:,:,2))
  call vert_AZ_Q(gZu,ntry, wf12(:,16), ex5, wf36(:,13), n3(:,37), t3x36(:,:,13))
  call vert_AZ_Q(gZu,ntry, wf12(:,14), ex4, wf36(:,14), n3(:,38), t3x36(:,:,14))
  call vert_AV_Q(ntry, ex2, ex7, wf4(:,4), n3(:,39), t3x4(:,:,3))
  call prop_A_Q(ntry, wf4(:,4), Q(:,66), ZERO, 0_intkind1, wf4(:,5), n2(18))
  call vert_AZ_Q(gZu,ntry, wf4(:,5), ex5, wf12(:,17), n3(:,40), t3x12(:,:,9))
  ...
  call vert_AZ_Q(gZu,ntry, wf4(:,5), ex4, wf12(:,19), n3(:,42), t3x12(:,:,10))
  call prop_A_Q(ntry, wf12(:,19), Q(:,74), ZERO, 0_intkind1, wf12(:,20), n2(21))
  call vert_AV_Q(ntry, wf12(:,20), ex6, wf24(:,5), n3(:,43), t3x24(:,:,5))
  call vert_AZ_Q(gZu,ntry, wf12(:,20), ex5, wf36(:,15), n3(:,44), t3x36(:,:,15))
  call vert_AZ_Q(gZu,ntry, wf12(:,18), ex4, wf36(:,16), n3(:,45), t3x36(:,:,16))
  call vert_AV_Q(ntry, ex2, wf4(:,1), wf8(:,5), n3(:,46), t3x8(:,:,3))
  call prop_A_Q(ntry, wf8(:,5), Q(:,98), ZERO, 0_intkind1, wf8(:,6), n2(22))
  call vert_AZ_Q(gZu,ntry, wf8(:,6), ex5, wf24(:,6), n3(:,47), t3x24(:,:,6))
  call vert_AZ_Q(gZu,ntry, wf8(:,6), ex4, wf24(:,7), n3(:,48), t3x24(:,:,7))
  call vert_ZQ_A(gZu,ntry, ex4, ex1, wf6(:,7), n3(:,49), t3x6(:,:,4))
  call vert_AZ_Q(gZu,ntry, ex2, ex3, wf6(:,8), n3(:,50), t3x6(:,:,5))
  call prop_Q_A(ntry, wf6(:,7), Q(:,9), ZERO, 0_intkind1, wf6(:,9), n2(23))
  call prop_A_Q(ntry, wf6(:,8), Q(:,6), ZERO, 0_intkind1, wf6(:,10), n2(24))
  call vert_ZQ_A(gZu,ntry, ex5, wf6(:,9), wf18(:,9), n3(:,51), t3x18(:,:,5))
  call vert_AV_Q(ntry, wf6(:,10), wf4(:,1), wf24(:,8), n3(:,52), t3x24(:,:,8))
  call prop_Q_A(ntry, wf18(:,9), Q(:,25), ZERO, 0_intkind1, wf18(:,10), n2(25))
  call vert_AZ_Q(gZu,ntry, wf6(:,10), ex5, wf18(:,11), n3(:,53), t3x18(:,:,6))
  ...
  call vert_ZQ_A(gZu,ntry, ex5, wf12(:,26), wf36(:,20), n3(:,61), t3x36(:,:,20))
  ...
  call vert_AZ_Q(gZu,ntry, wf12(:,22), ex5, wf36(:,22), n3(:,64), t3x36(:,:,22))
  call vert_ZQ_A(gZu,ntry, ex5, ex1, wf6(:,11), n3(:,65), t3x6(:,:,6))
  call prop_Q_A(ntry, wf6(:,11), Q(:,17), ZERO, 0_intkind1, wf6(:,12), n2(31))
  call vert_ZQ_A(gZu,ntry, ex4, wf6(:,12), wf18(:,13), n3(:,66), t3x18(:,:,7))
  call prop_Q_A(ntry, wf18(:,13), Q(:,25), ZERO, 0_intkind1, wf18(:,14), n2(32))
  call vert_AZ_Q(gZu,ntry, wf6(:,10), ex4, wf18(:,15), n3(:,67), t3x18(:,:,8))
  ...
  call vert_ZQ_A(gZu,ntry, ex4, wf12(:,30), wf36(:,26), n3(:,73), t3x36(:,:,26))
  ...
  call vert_ZQ_A(gZu,ntry, ex4, wf8(:,12), wf24(:,13), n3(:,94), t3x24(:,:,13))
  call vert_ZQ_A(gZu,ntry, ex5, wf8(:,12), wf24(:,14), n3(:,95), t3x24(:,:,14))
  call vert_ZQ_A(gZu,ntry, ex3, wf6(:,9), wf18(:,17), n3(:,96), t3x18(:,:,9))
  call prop_Q_A(ntry, wf18(:,17), Q(:,13), ZERO, 0_intkind1, wf18(:,18), n2(45))
  call vert_AZ_Q(gZu,ntry, wf6(:,6), ex3, wf18(:,19), n3(:,97), t3x18(:,:,10))
  ...
  call vert_ZQ_A(gZu,ntry, ex3, wf12(:,26), wf36(:,36), n3(:,101), t3x36(:,:,36))
  call vert_AV_Q(ntry, wf18(:,20), ex6, wf36(:,37), n3(:,102), t3x36(:,:,37))
  call vert_AZ_Q(gZu,ntry, wf12(:,10), ex3, wf36(:,38), n3(:,103), t3x36(:,:,38))
  call vert_ZQ_A(gZu,ntry, ex5, wf18(:,18), wf54(:,5), n3(:,104), t3x54(:,:,5))
  call vert_AZ_Q(gZu,ntry, wf4(:,3), ex3, wf12(:,41), n3(:,105), t3x12(:,:,21))
  call prop_A_Q(ntry, wf12(:,41), Q(:,38), ZERO, 0_intkind1, wf12(:,42), n2(47))
  call vert_AV_Q(ntry, wf12(:,42), ex7, wf24(:,15), n3(:,106), t3x24(:,:,15))
  call vert_ZQ_A(gZu,ntry, ex3, wf18(:,10), wf54(:,6), n3(:,107), t3x54(:,:,6))
  call vert_AZ_Q(gZu,ntry, wf12(:,42), ex5, wf36(:,39), n3(:,108), t3x36(:,:,39))
  call vert_AZ_Q(gZu,ntry, wf12(:,14), ex3, wf36(:,40), n3(:,109), t3x36(:,:,40))
  call vert_AZ_Q(gZu,ntry, wf4(:,5), ex3, wf12(:,43), n3(:,110), t3x12(:,:,22))
  call prop_A_Q(ntry, wf12(:,43), Q(:,70), ZERO, 0_intkind1, wf12(:,44), n2(48))
  call vert_AV_Q(ntry, wf12(:,44), ex6, wf24(:,16), n3(:,111), t3x24(:,:,16))
  call vert_AZ_Q(gZu,ntry, wf12(:,44), ex5, wf36(:,41), n3(:,112), t3x36(:,:,41))
  call vert_AZ_Q(gZu,ntry, wf12(:,18), ex3, wf36(:,42), n3(:,113), t3x36(:,:,42))
  call vert_AZ_Q(gZu,ntry, wf8(:,6), ex3, wf24(:,17), n3(:,114), t3x24(:,:,17))
  call vert_ZQ_A(gZu,ntry, ex3, wf6(:,12), wf18(:,21), n3(:,115), t3x18(:,:,11))
  call prop_Q_A(ntry, wf18(:,21), Q(:,21), ZERO, 0_intkind1, wf18(:,22), n2(49))
  call vert_AZ_Q(gZu,ntry, wf6(:,4), ex3, wf18(:,23), n3(:,116), t3x18(:,:,12))
  ...
  call vert_ZQ_A(gZu,ntry, ex3, wf12(:,30), wf36(:,46), n3(:,120), t3x36(:,:,46))
  call vert_AV_Q(ntry, wf18(:,24), ex6, wf36(:,47), n3(:,121), t3x36(:,:,47))
  call vert_AZ_Q(gZu,ntry, wf12(:,2), ex3, wf36(:,48), n3(:,122), t3x36(:,:,48))
  call vert_ZQ_A(gZu,ntry, ex3, wf4(:,7), wf12(:,45), n3(:,123), t3x12(:,:,23))
  call prop_Q_A(ntry, wf12(:,45), Q(:,37), ZERO, 0_intkind1, wf12(:,46), n2(51))
  call vert_VQ_A(ntry, ex7, wf12(:,46), wf24(:,18), n3(:,124), t3x24(:,:,18))
  call vert_ZQ_A(gZu,ntry, ex5, wf12(:,46), wf36(:,49), n3(:,125), t3x36(:,:,49))
  call vert_ZQ_A(gZu,ntry, ex3, wf12(:,36), wf36(:,50), n3(:,126), t3x36(:,:,50))
  call vert_AZ_Q(gZu,ntry, wf18(:,24), ex5, wf54(:,7), n3(:,127), t3x54(:,:,7))
  call vert_AZ_Q(gZu,ntry, wf18(:,4), ex3, wf54(:,8), n3(:,128), t3x54(:,:,8))
  call vert_ZQ_A(gZu,ntry, ex3, wf4(:,9), wf12(:,47), n3(:,129), t3x12(:,:,24))
  call prop_Q_A(ntry, wf12(:,47), Q(:,69), ZERO, 0_intkind1, wf12(:,48), n2(52))
  call vert_VQ_A(ntry, ex6, wf12(:,48), wf24(:,19), n3(:,130), t3x24(:,:,19))
  call vert_ZQ_A(gZu,ntry, ex5, wf12(:,48), wf36(:,51), n3(:,131), t3x36(:,:,51))
  call vert_ZQ_A(gZu,ntry, ex3, wf12(:,40), wf36(:,52), n3(:,132), t3x36(:,:,52))
  call vert_ZQ_A(gZu,ntry, ex3, wf8(:,12), wf24(:,20), n3(:,133), t3x24(:,:,20))
  call vert_VV_S(ntry, ex3, ex4, wf9(:,1), n3(:,134), t3x9(:,:,1))
  call vert_SV_V(ntry, wf9(:,1), ex5, wf27(:,1), n3(:,135), t3x27(:,:,1))
  call vert_QA_Z(gZu,ntry, wf4(:,7), wf4(:,5), wf16(:,1), n3(:,136), t3x16(:,:,1))
  call prop_W_W(ntry, wf27(:,1), Q(:,28), MZ, 1_intkind1, wf27(:,2), n2(53))
  call vert_AZ_Q(gZu,ntry, ex2, wf27(:,2), wf54(:,9), n3(:,137), t3x54(:,:,9))
  call vert_QA_Z(gZu,ntry, wf4(:,9), wf4(:,3), wf16(:,2), n3(:,138), t3x16(:,:,2))
  call vert_ZQ_A(gZu,ntry, wf27(:,2), ex1, wf54(:,10), n3(:,139), t3x54(:,:,10))
  call vert_QA_Z(gZu,ntry, ex1, wf8(:,6), wf16(:,3), n3(:,140), t3x16(:,:,3))
  call vert_QA_Z(gZu,ntry, wf8(:,12), ex2, wf16(:,4), n3(:,141), t3x16(:,:,4))
  call vert_ZQ_A(gZu,ntry, ex4, wf18(:,22), wf54(:,11), n3(:,142), t3x54(:,:,11))
  call vert_ZQ_A(gZu,ntry, ex3, wf18(:,14), wf54(:,12), n3(:,143), t3x54(:,:,12))
  call vert_AZ_Q(gZu,ntry, wf12(:,42), ex4, wf36(:,53), n3(:,144), t3x36(:,:,53))
  call vert_AZ_Q(gZu,ntry, wf12(:,16), ex3, wf36(:,54), n3(:,145), t3x36(:,:,54))
  call vert_AZ_Q(gZu,ntry, wf12(:,44), ex4, wf36(:,55), n3(:,146), t3x36(:,:,55))
  call vert_AZ_Q(gZu,ntry, wf12(:,20), ex3, wf36(:,56), n3(:,147), t3x36(:,:,56))
  call vert_ZQ_A(gZu,ntry, ex4, wf12(:,46), wf36(:,57), n3(:,148), t3x36(:,:,57))
  call vert_ZQ_A(gZu,ntry, ex3, wf12(:,34), wf36(:,58), n3(:,149), t3x36(:,:,58))
  call vert_AZ_Q(gZu,ntry, wf18(:,20), ex4, wf54(:,13), n3(:,150), t3x54(:,:,13))
  call vert_AZ_Q(gZu,ntry, wf18(:,8), ex3, wf54(:,14), n3(:,151), t3x54(:,:,14))
  call vert_ZQ_A(gZu,ntry, ex4, wf12(:,48), wf36(:,59), n3(:,152), t3x36(:,:,59))
  call vert_ZQ_A(gZu,ntry, ex3, wf12(:,38), wf36(:,60), n3(:,153), t3x36(:,:,60))
  ...
  call vert_AZ_Q(gZu,ntry, ex2, wf27(:,4), wf54(:,15), n3(:,156), t3x54(:,:,15))
  call vert_ZQ_A(gZu,ntry, wf27(:,4), ex1, wf54(:,16), n3(:,157), t3x54(:,:,16))
  ...
  call vert_AZ_Q(gZu,ntry, ex2, wf27(:,6), wf54(:,17), n3(:,160), t3x54(:,:,17))
  call vert_ZQ_A(gZu,ntry, wf27(:,6), ex1, wf54(:,18), n3(:,161), t3x54(:,:,18))
  ...
  M2add = M2 / average_factor_ppvvvj_uuxzzzgg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppvvvj_uuxzzzgg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppvvvj_uuxzzzgg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppvvvj_uuxzzzgg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppvvvj_uuxzzzgg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppvvvj_uuxzzzgg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppvvvj_uuxzzzgg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppvvvj_uuxzzzgg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppvvvj_uuxzzzgg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppvvvj_uuxzzzgg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppvvvj_uuxzzzgg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppvvvj_uuxzzzgg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppvvvj_uuxzzzgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppvvvj_uuxzzzgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppvvvj_uuxzzzgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppvvvj_uuxzzzgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppvvvj_uuxzzzgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppvvvj_uuxzzzgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppvvvj_uuxzzzgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppvvvj_uuxzzzgg_1_/**/REALKIND
