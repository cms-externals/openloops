...
module ol_colourmatrix_ppvvvj_dddxdxazz_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvvj_dddxdxazz_1_/**/REALKIND



module ol_forced_parameters_ppvvvj_dddxdxazz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvvj_dddxdxazz_1_/**/REALKIND

module ol_tree_ppvvvj_dddxdxazz_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppvvvj_dddxdxazz_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppvvvj_dddxdxazz_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for down down anti-down anti-down gamma Z Z -> 0
...
! **********************************************************************
  ...
  use ol_external_ppvvvj_dddxdxazz_1, only: external_perm_ppvvvj_dddxdxazz_1, &
    & external_perm_inv_ppvvvj_dddxdxazz_1, extcomb_perm_ppvvvj_dddxdxazz_1, &
    & average_factor_ppvvvj_dddxdxazz_1
  use ol_external_ppvvvj_dddxdxazz_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppvvvj_dddxdxazz_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppvvvj_dddxdxazz_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppvvvj_dddxdxazz_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppvvvj_dddxdxazz_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppvvvj_dddxdxazz_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppvvvj_dddxdxazz_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppvvvj_dddxdxazz_1(extcombs(k))
  end do
  ...
  call vert_ZQ_A(gZd,ntry, ex6, ex2, wf6(:,5), n3(:,15), t3x6(:,:,3))
  ...
  call vert_ZQ_A(gZd,ntry, ex7, ex2, wf6(:,7), n3(:,21), t3x6(:,:,4))
  ...
  call vert_ZQ_A(gZd,ntry, ex7, wf4(:,8), wf12(:,17), n3(:,36), t3x12(:,:,9))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf4(:,8), wf12(:,19), n3(:,39), t3x12(:,:,10))
  ...
  call vert_AZ_Q(gZd,ntry, wf8(:,6), ex7, wf24(:,11), n3(:,42), t3x24(:,:,11))
  call vert_AZ_Q(gZd,ntry, wf8(:,6), ex6, wf24(:,12), n3(:,43), t3x24(:,:,12))
  call vert_ZQ_A(gZd,ntry, ex6, ex1, wf6(:,9), n3(:,44), t3x6(:,:,5))
  call prop_Q_A(ntry, wf6(:,9), Q(:,33), ZERO, 0_intkind1, wf6(:,10), n2(25))
  call vert_ZQ_A(gZd,ntry, ex7, wf6(:,10), wf18(:,9), n3(:,45), t3x18(:,:,5))
  ...
  call vert_ZQ_A(gZd,ntry, ex7, ex1, wf6(:,11), n3(:,48), t3x6(:,:,6))
  call prop_Q_A(ntry, wf6(:,11), Q(:,65), ZERO, 0_intkind1, wf6(:,12), n2(27))
  call vert_ZQ_A(gZd,ntry, ex6, wf6(:,12), wf18(:,11), n3(:,49), t3x18(:,:,6))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf8(:,8), wf24(:,15), n3(:,52), t3x24(:,:,15))
  call vert_ZQ_A(gZd,ntry, ex7, wf8(:,8), wf24(:,16), n3(:,53), t3x24(:,:,16))
  ...
  call vert_AZ_Q(gZd,ntry, wf8(:,10), ex7, wf24(:,19), n3(:,67), t3x24(:,:,19))
  call vert_AZ_Q(gZd,ntry, wf8(:,10), ex6, wf24(:,20), n3(:,68), t3x24(:,:,20))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf8(:,12), wf24(:,23), n3(:,76), t3x24(:,:,23))
  call vert_ZQ_A(gZd,ntry, ex7, wf8(:,12), wf24(:,24), n3(:,77), t3x24(:,:,24))
  ...
  call vert_AZ_Q(gZd,ntry, wf8(:,14), ex7, wf24(:,27), n3(:,87), t3x24(:,:,27))
  call vert_AZ_Q(gZd,ntry, wf8(:,14), ex6, wf24(:,28), n3(:,88), t3x24(:,:,28))
  ...
  call vert_ZQ_A(gZd,ntry, ex6, wf8(:,16), wf24(:,31), n3(:,93), t3x24(:,:,31))
  call vert_ZQ_A(gZd,ntry, ex7, wf8(:,16), wf24(:,32), n3(:,94), t3x24(:,:,32))
  ...
  M2add = M2 / average_factor_ppvvvj_dddxdxazz_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppvvvj_dddxdxazz_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppvvvj_dddxdxazz_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppvvvj_dddxdxazz_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppvvvj_dddxdxazz_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppvvvj_dddxdxazz_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppvvvj_dddxdxazz_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppvvvj_dddxdxazz_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppvvvj_dddxdxazz_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppvvvj_dddxdxazz_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppvvvj_dddxdxazz_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppvvvj_dddxdxazz_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppvvvj_dddxdxazz_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppvvvj_dddxdxazz_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppvvvj_dddxdxazz_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppvvvj_dddxdxazz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppvvvj_dddxdxazz_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppvvvj_dddxdxazz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppvvvj_dddxdxazz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppvvvj_dddxdxazz_1_/**/REALKIND
