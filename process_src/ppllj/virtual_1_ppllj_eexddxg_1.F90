...
! **********************************************************************
...
#endif
  use ol_loop_ppllj_eexddxg_1_/**/REALKIND, only: c, f, wf, den
  ...
  call loop_Q_A(G1(:,:,:,14),Q(:,23),ZERO,G2(:,:,:,21))
  ...
  call loop_A_Q(G0(:,:,:,9),Q(:,24),ZERO,G1(:,:,:,16))
  ...
  call loop_A_Q(G1(:,:,:,20),Q(:,24),ZERO,G2(:,:,:,25))
  ...
  call loop_A_Q(G1(:,:,:,24),Q(:,24),ZERO,G2(:,:,:,32))
