...
! **********************************************************************
...
#endif
  use ol_loop_ppllj_eexbbxg_1_/**/REALKIND, only: c, f, wf, den
  ...
  call loop_Q_A(G1(:,:,:,14),Q(:,23),MB,G2(:,:,:,21))
  call check_last_QA_V(l_switch,G2(:,:,:,21),wf(:,-3),G2tensor(:,1))
  call loop_QZ_A(G1(:,:,:,13),wf(:,6),G1(:,:,:,15),gZd)
  ...
  call loop_A_Q(G0(:,:,:,9),Q(:,24),MB,G1(:,:,:,16))
  call loop_AV_Q(G1(:,:,:,16),wf(:,1),G1(:,:,:,17))
  call loop_A_Q(G1(:,:,:,17),Q(:,27),MB,G2(:,:,:,23))
  call check_last_AQ_V(l_switch,G2(:,:,:,23),wf(:,-2),G2tensor(:,3))
  call loop_AZ_Q(G1(:,:,:,16),wf(:,6),G1(:,:,:,18),gZd)
  call loop_A_Q(G1(:,:,:,18),Q(:,27),MB,G2(:,:,:,24))
  ...
  call loop_A_Q(G0(:,:,:,10),Q(:,8),MB,G1(:,:,:,19))
  call loop_AV_Q(G1(:,:,:,19),wf(:,-4),G1(:,:,:,20))
  call loop_A_Q(G1(:,:,:,20),Q(:,24),MB,G2(:,:,:,25))
  ...
  call loop_A_Q(G1(:,:,:,24),Q(:,24),MB,G2(:,:,:,32))
