...
! **********************************************************************
  ...
  call counter_Q_A(ctbb,wf(:,3),Q(:,20),wf(:,22))
  call prop_A_Q(wf(:,4),Q(:,11),MB,1_intkind1,wf(:,23))
  call prop_A_Q(wf(:,7),Q(:,11),MB,1_intkind1,wf(:,24))
  call counter_A_Q(ctbb,wf(:,9),Q(:,24),wf(:,25))
  call prop_Q_A(wf(:,10),Q(:,7),MB,1_intkind1,wf(:,26))
  call prop_Q_A(wf(:,11),Q(:,7),MB,1_intkind1,wf(:,27))
