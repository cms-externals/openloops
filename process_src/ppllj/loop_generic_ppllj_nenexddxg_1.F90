...
module ol_external_ppllj_nenexddxg_1
  ...
  subroutine set_permutation(perm) &
    ...
    average_factor_ppllj_nenexddxg_1 = &
      ...
      external_perm_ppllj_nenexddxg_1(1)) &
      * average_factors_ppllj_nenexddxg_1( &
      external_perm_ppllj_nenexddxg_1(2))
    ! Symmetry factor for outgoing particles
    if (out_symmetry_on /= 0) then
      do i = 1, 5
        average_factor_ppllj_nenexddxg_1 = &
          average_factor_ppllj_nenexddxg_1 &
          * factorial(count(particle_types_perm_ppllj_nenexddxg_1(3:5) == i))
      end do
    end if
...
subroutine set_permutation_ppllj_nenexddxg_1(perm)
  use ol_external_ppllj_nenexddxg_1, only: set_permutation
  implicit none
  integer, intent(in) :: perm(5)
  call set_permutation(perm)
end subroutine set_permutation_ppllj_nenexddxg_1
