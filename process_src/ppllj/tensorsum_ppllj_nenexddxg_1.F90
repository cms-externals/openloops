...
! **********************************************************************
  use ol_external_ppllj_nenexddxg_1, only: channel_number_ppllj_nenexddxg_1
  ...
  call TI_call(3, momenta_5, masses2_4, T3sum(:,1), M2)
  ...
  call TI_call(3, momenta_11, masses2_5, T3sum(:,5), M2)
  ...
  call channel_off(channel_number_ppllj_nenexddxg_1)
