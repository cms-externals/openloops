...
! **********************************************************************
...
#endif
  use ol_loop_ppllj_nenexbbxg_1_/**/REALKIND, only: c, f, wf, den
  ...
  call loop_Q_A(G1(:,:,:,14),Q(:,23),MB,G2(:,:,:,15))
  ...
  call loop_A_Q(G0(:,:,:,9),Q(:,24),MB,G1(:,:,:,15))
