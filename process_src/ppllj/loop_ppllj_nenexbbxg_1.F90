...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,12),Q(:,24),MB,1_intkind1,wf(:,13))
  call counter_ZQ_A(gZd,wf(:,3),wf(:,-2),wf(:,14))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,15))
  call prop_Q_A(wf(:,15),Q(:,20),MB,1_intkind1,wf(:,16))
  call counter_Q_A(ctbb,wf(:,4),Q(:,20),wf(:,17))
  call prop_A_Q(wf(:,5),Q(:,11),MB,1_intkind1,wf(:,18))
  call counter_A_Q(ctbb,wf(:,7),Q(:,24),wf(:,19))
  call prop_Q_A(wf(:,8),Q(:,7),MB,1_intkind1,wf(:,20))
