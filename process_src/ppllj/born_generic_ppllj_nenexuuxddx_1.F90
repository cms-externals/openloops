...
module ol_external_ppllj_nenexuuxddx_1
  ...
  subroutine set_permutation(perm) &
    ...
    average_factor_ppllj_nenexuuxddx_1 = &
      ...
      external_perm_ppllj_nenexuuxddx_1(1)) &
      * average_factors_ppllj_nenexuuxddx_1( &
      external_perm_ppllj_nenexuuxddx_1(2))
    ! Symmetry factor for outgoing particles
    if (out_symmetry_on /= 0) then
      do i = 1, 6
        average_factor_ppllj_nenexuuxddx_1 = &
          average_factor_ppllj_nenexuuxddx_1 &
          * factorial(count(particle_types_perm_ppllj_nenexuuxddx_1(3:6) == i))
      end do
    end if
...
subroutine set_permutation_ppllj_nenexuuxddx_1(perm)
  use ol_external_ppllj_nenexuuxddx_1, only: set_permutation
  implicit none
  integer, intent(in) :: perm(6)
  call set_permutation(perm)
end subroutine set_permutation_ppllj_nenexuuxddx_1
