...
module ol_colourmatrix_pplnj_ckm_neexcxdg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnj_ckm_neexcxdg_1_/**/REALKIND



module ol_forced_parameters_pplnj_ckm_neexcxdg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnj_ckm_neexcxdg_1_/**/REALKIND

module ol_loop_pplnj_ckm_neexcxdg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,6),Q(:,24),ZERO,0_intkind1,wf(:,7))
  call vert_AW_Q(wf(:,-2),wf(:,3),wf(:,8))
  call counter_WQ_A(wf(:,3),wf(:,-3),wf(:,9))
  call counter_VQ_A(wf(:,-4),wf(:,-3),wf(:,10))
  call prop_Q_A(wf(:,10),Q(:,24),ZERO,0_intkind1,wf(:,11))
  call counter_AW_Q(wf(:,-2),wf(:,3),wf(:,12))
  call counter_AV_Q(wf(:,-2),wf(:,-4),wf(:,13))
  call prop_A_Q(wf(:,13),Q(:,20),ZERO,0_intkind1,wf(:,14))
  call counter_A_Q(ctcc,wf(:,4),Q(:,20),wf(:,15))
  call prop_Q_A(wf(:,5),Q(:,11),ZERO,0_intkind1,wf(:,16))
  call counter_Q_A(ctqq,wf(:,7),Q(:,24),wf(:,17))
  call prop_A_Q(wf(:,8),Q(:,7),ZERO,0_intkind1,wf(:,18))
...
end module ol_loop_pplnj_ckm_neexcxdg_1_/**/REALKIND
