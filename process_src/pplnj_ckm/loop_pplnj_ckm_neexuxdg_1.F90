...
module ol_colourmatrix_pplnj_ckm_neexuxdg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnj_ckm_neexuxdg_1_/**/REALKIND



module ol_forced_parameters_pplnj_ckm_neexuxdg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnj_ckm_neexuxdg_1_/**/REALKIND

module ol_loop_pplnj_ckm_neexuxdg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_A_Q(ctqq,wf(:,4),Q(:,20),wf(:,15))
...
end module ol_loop_pplnj_ckm_neexuxdg_1_/**/REALKIND
