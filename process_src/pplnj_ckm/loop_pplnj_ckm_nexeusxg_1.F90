...
module ol_colourmatrix_pplnj_ckm_nexeusxg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnj_ckm_nexeusxg_1_/**/REALKIND



module ol_forced_parameters_pplnj_ckm_nexeusxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnj_ckm_nexeusxg_1_/**/REALKIND

module ol_loop_pplnj_ckm_nexeusxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**2*gQCD**3*VCKMsu)/(2._/**/REALKIND*sw**2)
    f(3) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**3*VCKMsu)/(2._/**/REALKIND*sw**2)
    f(4) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**3*VCKMsu)/(2._/**/REALKIND*sw**2)
    f(5) = (CI*eQED**2*gQCD**3*integralnorm*SwB*VCKMsu)/(2._/**/REALKIND*sw**2)
    f(6) = (eQED**2*gQCD**3*integralnorm*SwB*VCKMsu)/(sw**2*2._/**/REALKIND)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(7)+A(8))*f(2)+(-A(4)-A(6))*f(3)+(-A(3)-A(5))*f(4)

end subroutine colourvectors

end module ol_loop_pplnj_ckm_nexeusxg_1_/**/REALKIND
