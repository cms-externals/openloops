...
module ol_vamp_1_pplnj_ckm_neexcxbg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplnj_ckm_neexcxbg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplnj_ckm_neexcxbg_1.
! **********************************************************************
...
#endif
  use ol_loop_pplnj_ckm_neexcxbg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplnj_ckm_neexcxbg_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_Q_A(G0(:,:,:,4),Q(:,8),MB,G1(:,:,:,5))
  call loop_QV_A(G1(:,:,:,5),wf(:,-4),G1(:,:,:,6))
  call loop_Q_A(G1(:,:,:,6),Q(:,24),MB,G2(:,:,:,3))
  ...
  call loop_Q_A(G1(:,:,:,9),Q(:,24),MB,G2(:,:,:,7))
...
end module ol_vamp_1_pplnj_ckm_neexcxbg_1_/**/REALKIND
