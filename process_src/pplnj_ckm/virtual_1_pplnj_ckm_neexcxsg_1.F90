...
module ol_vamp_1_pplnj_ckm_neexcxsg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplnj_ckm_neexcxsg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplnj_ckm_neexcxsg_1.
! **********************************************************************
...
#endif
  use ol_loop_pplnj_ckm_neexcxsg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplnj_ckm_neexcxsg_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_Q_A(G0(:,:,:,3),Q(:,24),ZERO,G1(:,:,:,3))
  call loop_QW_A(G1(:,:,:,3),wf(:,3),G1(:,:,:,4))
  call loop_Q_A(G1(:,:,:,4),Q(:,27),ZERO,G2(:,:,:,2))
  call check_last_QA_V(l_switch,G2(:,:,:,2),wf(:,-2),G2tensor(:,2))
  call check_last_QA_V(l_switch,G1(:,:,:,3),wf(:,18),G1tensor(:,2))
  call loop_VQ_A(G0(:,:,:,1),wf(:,-3),G0(:,:,:,4))
  call loop_Q_A(G0(:,:,:,4),Q(:,8),ZERO,G1(:,:,:,5))
  call loop_QV_A(G1(:,:,:,5),wf(:,-4),G1(:,:,:,6))
  call loop_Q_A(G1(:,:,:,6),Q(:,24),ZERO,G2(:,:,:,3))
  call check_last_QA_V(l_switch,G2(:,:,:,3),wf(:,18),G2tensor(:,3))
  call loop_QW_A(G2(:,:,:,3),wf(:,3),G2(:,:,:,4))
  call loop_Q_A(G2(:,:,:,4),Q(:,27),ZERO,G3(:,:,:,1))
  call check_last_QA_V(l_switch,G3(:,:,:,1),wf(:,-2),G3tensor(:,1))
  call loop_QW_A(G1(:,:,:,5),wf(:,3),G1(:,:,:,7))
  call loop_Q_A(G1(:,:,:,7),Q(:,11),ZERO,G2(:,:,:,5))
  call loop_QV_A(G2(:,:,:,5),wf(:,-4),G2(:,:,:,6))
  call loop_Q_A(G2(:,:,:,6),Q(:,27),ZERO,G3(:,:,:,2))
  call check_last_QA_V(l_switch,G3(:,:,:,2),wf(:,-2),G3tensor(:,2))
  call loop_UV_W(G0(:,:,:,1),Q(:,0),wf(:,-4),Q(:,16),G1(:,:,:,8))
  call loop_VQ_A(G1(:,:,:,8),wf(:,-3),G1(:,:,:,9))
  call loop_Q_A(G1(:,:,:,9),Q(:,24),ZERO,G2(:,:,:,7))
  call check_last_QA_V(l_switch,G2(:,:,:,7),wf(:,18),G2tensor(:,4))
  call loop_QW_A(G2(:,:,:,7),wf(:,3),G2(:,:,:,8))
  call loop_Q_A(G2(:,:,:,8),Q(:,27),ZERO,G3(:,:,:,3))
  call check_last_QA_V(l_switch,G3(:,:,:,3),wf(:,-2),G3tensor(:,3))
  call loop_VQ_A(G1(:,:,:,8),wf(:,16),G1(:,:,:,10))
  ...
  call loop_Q_A(G1(:,:,:,12),Q(:,27),ZERO,G2(:,:,:,10))
...
end module ol_vamp_1_pplnj_ckm_neexcxsg_1_/**/REALKIND
