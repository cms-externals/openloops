...
module ol_colourmatrix_pplnj_ckm_nexecsxg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnj_ckm_nexecsxg_1_/**/REALKIND



module ol_forced_parameters_pplnj_ckm_nexecsxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnj_ckm_nexecsxg_1_/**/REALKIND

module ol_loop_pplnj_ckm_nexecsxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**2*gQCD**3*VCKMsc)/(2._/**/REALKIND*sw**2)
    f(3) = (CI*countertermnorm*ctGcc*eQED**2*gQCD**3*VCKMsc)/(2._/**/REALKIND*sw**2)
    f(4) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**3*VCKMsc)/(2._/**/REALKIND*sw**2)
    f(5) = (CI*countertermnorm*ctVsc*eQED**2*gQCD**3*VCKMsc)/(2._/**/REALKIND*sw**2)
    f(6) = (CI*eQED**2*gQCD**3*integralnorm*SwB*VCKMsc)/(2._/**/REALKIND*sw**2)
    f(7) = (eQED**2*gQCD**3*integralnorm*SwB*VCKMsc)/(sw**2*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call vert_WQ_A(wf(:,3),wf(:,-2),wf(:,8))
  call counter_AW_Q(wf(:,-3),wf(:,3),wf(:,9))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,10))
  call prop_A_Q(wf(:,10),Q(:,24),ZERO,0_intkind1,wf(:,11))
  call counter_WQ_A(wf(:,3),wf(:,-2),wf(:,12))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,13))
  call prop_Q_A(wf(:,13),Q(:,20),ZERO,0_intkind1,wf(:,14))
  call counter_Q_A(ctcc,wf(:,4),Q(:,20),wf(:,15))
  call prop_A_Q(wf(:,5),Q(:,11),ZERO,0_intkind1,wf(:,16))
  call counter_A_Q(ctqq,wf(:,7),Q(:,24),wf(:,17))
  call prop_Q_A(wf(:,8),Q(:,7),ZERO,0_intkind1,wf(:,18))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(7)+A(8))*f(2)-A(6)*f(3)-A(4)*f(4)+(-A(3)-A(5))*f(5)

end subroutine colourvectors

end module ol_loop_pplnj_ckm_nexecsxg_1_/**/REALKIND
