...
module ol_versiondata_pplnj_ckm
  implicit none
  character(4) :: generator_revision = "2408"
  interface
    subroutine version_pplnj_ckm(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplnj_ckm
  end interface
end module ol_versiondata_pplnj_ckm


subroutine ol_version_pplnj_ckm(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplnj_ckm, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplnj_ckm
