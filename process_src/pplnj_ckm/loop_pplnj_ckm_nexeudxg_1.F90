...
module ol_colourmatrix_pplnj_ckm_nexeudxg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnj_ckm_nexeudxg_1_/**/REALKIND



module ol_forced_parameters_pplnj_ckm_nexeudxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnj_ckm_nexeudxg_1_/**/REALKIND

module ol_loop_pplnj_ckm_nexeudxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**2*gQCD**3*VCKMdu)/(2._/**/REALKIND*sw**2)
    f(3) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**3*VCKMdu)/(2._/**/REALKIND*sw**2)
    f(4) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**3*VCKMdu)/(2._/**/REALKIND*sw**2)
    f(5) = (CI*eQED**2*gQCD**3*integralnorm*SwB*VCKMdu)/(2._/**/REALKIND*sw**2)
    f(6) = (eQED**2*gQCD**3*integralnorm*SwB*VCKMdu)/(sw**2*2._/**/REALKIND)
...
end module ol_loop_pplnj_ckm_nexeudxg_1_/**/REALKIND
