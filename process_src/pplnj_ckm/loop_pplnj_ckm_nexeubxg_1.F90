...
module ol_colourmatrix_pplnj_ckm_nexeubxg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnj_ckm_nexeubxg_1_/**/REALKIND



module ol_forced_parameters_pplnj_ckm_nexeubxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnj_ckm_nexeubxg_1_/**/REALKIND

module ol_loop_pplnj_ckm_nexeubxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**2*gQCD**3*VCKMbu)/(2._/**/REALKIND*sw**2)
    f(3) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**3*VCKMbu)/(2._/**/REALKIND*sw**2)
    f(4) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**3*VCKMbu)/(2._/**/REALKIND*sw**2)
    f(5) = (CI*countertermnorm*ctVbu*eQED**2*gQCD**3*VCKMbu)/(2._/**/REALKIND*sw**2)
    f(6) = (CI*eQED**2*gQCD**3*integralnorm*SwB*VCKMbu)/(2._/**/REALKIND*sw**2)
    f(7) = (eQED**2*gQCD**3*integralnorm*SwB*VCKMbu)/(sw**2*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,6),Q(:,24),MB,1_intkind1,wf(:,7))
  ...
  call counter_Q_A(ctqq,wf(:,4),Q(:,20),wf(:,15))
  call prop_A_Q(wf(:,5),Q(:,11),ZERO,0_intkind1,wf(:,16))
  call counter_A_Q(ctbb,wf(:,7),Q(:,24),wf(:,17))
  call prop_Q_A(wf(:,8),Q(:,7),MB,1_intkind1,wf(:,18))
...
end module ol_loop_pplnj_ckm_nexeubxg_1_/**/REALKIND
