...
module ol_colourmatrix_ppll2_eexgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppll2_eexgg_1_/**/REALKIND



module ol_forced_parameters_ppll2_eexgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppll2_eexgg_1_/**/REALKIND

module ol_loop_ppll2_eexgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = countertermnorm*ctZGG*eQED**2*gQCD**2
    f(2) = (eQED**2*gQCD**2*integralnorm*SwF)/3._/**/REALKIND
    f(3) = (2*eQED**2*gQCD**2*integralnorm*SwF)/3._/**/REALKIND
    f(4) = eQED**2*gQCD**2*integralnorm*SwF
    f(5) = (4*eQED**2*gQCD**2*integralnorm*SwF)/3._/**/REALKIND
    f(6) = 2*eQED**2*gQCD**2*integralnorm*SwF
...
end module ol_loop_ppll2_eexgg_1_/**/REALKIND
