...
module ol_vamp_1_eevjj_eexudxw_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_eevjj_eexudxw_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_eevjj_eexudxw_1.
! **********************************************************************
...
#endif
  use ol_loop_eevjj_eexudxw_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_eevjj_eexudxw_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call check_last_QA_V(l_switch,G1(:,:,:,1),wf(:,31),G1tensor(:,2))
  ...
  call loop_AZ_Q(G1(:,:,:,4),wf(:,6),G1(:,:,:,6),gZu)
  call loop_A_Q(G1(:,:,:,6),Q(:,27),ZERO,G2(:,:,:,4))
  call check_last_AQ_V(l_switch,G2(:,:,:,4),wf(:,-2),G2tensor(:,4))
  call check_last_AQ_V(l_switch,G1(:,:,:,4),wf(:,33),G1tensor(:,3))
  call check_last_AQ_V(l_switch,G1(:,:,:,4),wf(:,34),G1tensor(:,4))
  ...
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,33),G2tensor(:,5))
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,34),G2tensor(:,6))
...
end module ol_vamp_1_eevjj_eexudxw_1_/**/REALKIND
