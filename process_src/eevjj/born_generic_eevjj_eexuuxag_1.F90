...
module ol_external_eevjj_eexuuxag_1
  implicit none
  integer :: dummy_counter
  ! Permutation and inverse permutation of external particles
  integer, save :: external_perm_eevjj_eexuuxag_1(6) = &
                     [ (dummy_counter, dummy_counter = 1, 6) ]
  integer, save :: external_perm_inv_eevjj_eexuuxag_1(6) = &
                     [ (dummy_counter, dummy_counter = 1, 6) ]
  integer, save :: extcomb_perm_eevjj_eexuuxag_1(0:22) = &
                     [ (dummy_counter, dummy_counter = 0, 22) ]
  ! Particle types (mapping of fields to integers is not fixed!)
  integer, save :: particle_types_eevjj_eexuuxag_1(6) = &
                     [ 1, 2, 3, 4, 5, 6 ]
  ! Colour and helicity average factors per particle
  integer, save :: average_factors_eevjj_eexuuxag_1(6) = &
                     [ 2, 2, 6, 6, 2, 16 ]
  ! Average factor; initialised to the identity permutation
  integer, save :: average_factor_eevjj_eexuuxag_1 = &
                     4
  integer, save :: channel_number_eevjj_eexuuxag_1 = -1
  ...
  subroutine n_external(n) &
      & bind(c,name="ol_f_n_external_eevjj_eexuuxag_1")
  ...
  subroutine n_external_c(n) &
      & bind(c,name="ol_n_external_eevjj_eexuuxag_1")
  ...
  subroutine set_permutation(perm) &
      & bind(c,name="ol_f_set_permutation_eevjj_eexuuxag_1")
    ...
    integer :: i, j, ii, jj
    integer :: particle_types_perm_eevjj_eexuuxag_1(6)
    external_perm_eevjj_eexuuxag_1 = perm
    do i = 1, 6
      external_perm_inv_eevjj_eexuuxag_1( &
        external_perm_eevjj_eexuuxag_1(i)) = i
      particle_types_perm_eevjj_eexuuxag_1(i) = &
        particle_types_eevjj_eexuuxag_1( &
        external_perm_eevjj_eexuuxag_1(i))
    end do
    do i = 1, 6
      do j = 1, i
        if (external_perm_eevjj_eexuuxag_1(i) >= &
          external_perm_eevjj_eexuuxag_1(j)) then
          ii = external_perm_eevjj_eexuuxag_1(i)
          jj = external_perm_eevjj_eexuuxag_1(j)
        else
          ii = external_perm_eevjj_eexuuxag_1(j)
          jj = external_perm_eevjj_eexuuxag_1(i)
        end if
        extcomb_perm_eevjj_eexuuxag_1((i*(i-1))/2 + j) = (ii*(ii-1))/2 + jj
      end do
    end do
    ! Colour and helicity average factor
    average_factor_eevjj_eexuuxag_1 = 1
    do i = 1, n_scatt
      average_factor_eevjj_eexuuxag_1 = &
        average_factor_eevjj_eexuuxag_1 &
        * average_factors_eevjj_eexuuxag_1( &
        external_perm_eevjj_eexuuxag_1(i))
    end do
    ...
    if (out_symmetry_on /= 0) then
      do i = 1, 6
        average_factor_eevjj_eexuuxag_1 = &
          average_factor_eevjj_eexuuxag_1 &
          * factorial(count(particle_types_perm_eevjj_eexuuxag_1(n_scatt+1:6) == i))
      end do
    end if
  ...
  subroutine set_permutation_c(perm) &
      & bind(c,name="ol_set_permutation_eevjj_eexuuxag_1")
    use, intrinsic :: iso_c_binding, only: c_int
    implicit none
  ...
  subroutine get_masses(m_ex) &
      & bind(c,name="ol_f_get_masses_eevjj_eexuuxag_1")
    ...
    do i = 1, 6
      m_ex(i) = m_ex_orig(external_perm_eevjj_eexuuxag_1(i))
    end do
  end subroutine get_masses


  subroutine get_masses_c(m_ex) &
      & bind(c,name="ol_get_masses_eevjj_eexuuxag_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo(sqrt_s, p_rambo) &
      & bind(c,name="ol_f_rambo_eevjj_eexuuxag_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo_c(sqrt_s, p_rambo) &
      & bind(c,name="ol_rambo_eevjj_eexuuxag_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
  ...
  subroutine pol_init(pol) &
      & bind(c,name="ol_f_pol_init_eevjj_eexuuxag_1")
    implicit none
    integer, intent(in) :: pol(6)
    POLSEL = pol
  end subroutine pol_init

end module ol_external_eevjj_eexuuxag_1


module colour_basis_eevjj_eexuuxag_1
  implicit none
  ! tree colour basis
  ...
  pure subroutine tree_colbasis_dim(extcols, ncolb, ncoupl, maxpows, nhel) &
    & bind(c, name="ol_tree_colbasis_dim_eevjj_eexuuxag_1")
    implicit none
  ...
  subroutine tree_colbasis(basis, powers) &
    & bind(c, name="ol_tree_colbasis_eevjj_eexuuxag_1")
    implicit none
...
end module colour_basis_eevjj_eexuuxag_1


! Only for compatibility with the Sherpa interface

subroutine set_permutation_eevjj_eexuuxag_1(perm)
  use ol_external_eevjj_eexuuxag_1, only: set_permutation
  implicit none
  integer, intent(in) :: perm(6)
  call set_permutation(perm)
end subroutine set_permutation_eevjj_eexuuxag_1

! **********************************************************************
module ol_heltables_eevjj_eexuuxag_1
! **********************************************************************
  ...
  integer(intkind2), save :: t3x16(2,16,4), t3x4(2,4,8), t3x8(2,8,16), t3x64(2,64,20)
...
! **********************************************************************
  ...
  n2(10) = 4
  call heltable([4,2,8], n3(:,20), t3x8(:,:,9))
  ...
  n2(13) = 8
  call heltable([4,16,64], n3(:,29), t3x64(:,:,1))
  call heltable([4,16,64], n3(:,30), t3x64(:,:,2))
  call heltable([8,8,64], n3(:,31), t3x64(:,:,3))
  call heltable([8,8,64], n3(:,32), t3x64(:,:,4))
  call heltable([4,16,64], n3(:,33), t3x64(:,:,5))
  call heltable([4,16,64], n3(:,34), t3x64(:,:,6))
  call heltable([8,8,64], n3(:,35), t3x64(:,:,7))
  call heltable([8,8,64], n3(:,36), t3x64(:,:,8))
  call heltable([8,8,64], n3(:,37), t3x64(:,:,9))
  call heltable([8,8,64], n3(:,38), t3x64(:,:,10))
  call heltable([8,8,64], n3(:,39), t3x64(:,:,11))
  call heltable([8,8,64], n3(:,40), t3x64(:,:,12))
  call heltable([8,8,64], n3(:,41), t3x64(:,:,13))
  call heltable([8,8,64], n3(:,42), t3x64(:,:,14))
  call heltable([8,8,64], n3(:,43), t3x64(:,:,15))
  call heltable([8,8,64], n3(:,44), t3x64(:,:,16))
  call heltable([8,8,64], n3(:,45), t3x64(:,:,17))
  call heltable([8,8,64], n3(:,46), t3x64(:,:,18))
  call heltable([8,8,64], n3(:,47), t3x64(:,:,19))
  call heltable([8,8,64], n3(:,48), t3x64(:,:,20))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_eevjj_eexuuxag_1
