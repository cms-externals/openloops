...
module ol_colourmatrix_eevjj_eexddxa_1_/**/REALKIND
...
end module ol_colourmatrix_eevjj_eexddxa_1_/**/REALKIND



module ol_forced_parameters_eevjj_eexddxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eevjj_eexddxa_1_/**/REALKIND

module ol_loop_eevjj_eexddxa_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 6) = (CI*countertermnorm*ctVqq*eQED**3*gQCD**2)/9._/**/REALKIND
    f( 7) = (CI*countertermnorm*ctVqq*eQED**3*gQCD**2)/3._/**/REALKIND
...
end module ol_loop_eevjj_eexddxa_1_/**/REALKIND
