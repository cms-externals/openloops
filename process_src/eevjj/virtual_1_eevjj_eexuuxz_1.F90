...
module ol_vamp_1_eevjj_eexuuxz_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_eevjj_eexuuxz_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_eevjj_eexuuxz_1.
! **********************************************************************
...
#endif
  use ol_loop_eevjj_eexuuxz_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_eevjj_eexuuxz_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_QZ_A(G1(:,:,:,1),wf(:,6),G1(:,:,:,3),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,10),wf(:,-4),G2(:,:,:,11),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,7),wf(:,40),G1(:,:,:,12),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,7),wf(:,41),G1(:,:,:,14),gZu)
...
end module ol_vamp_1_eevjj_eexuuxz_1_/**/REALKIND
