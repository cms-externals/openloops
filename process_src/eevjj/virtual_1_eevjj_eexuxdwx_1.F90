...
module ol_vamp_1_eevjj_eexuxdwx_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_eevjj_eexuxdwx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_eevjj_eexuxdwx_1.
! **********************************************************************
...
#endif
  use ol_loop_eevjj_eexuxdwx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_eevjj_eexuxdwx_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,6),G1(:,:,:,3),gZd)
  call loop_A_Q(G1(:,:,:,3),Q(:,23),ZERO,G2(:,:,:,2))
  call check_last_AQ_V(l_switch,G2(:,:,:,2),wf(:,-3),G2tensor(:,2))
  call check_last_AQ_V(l_switch,G1(:,:,:,1),wf(:,30),G1tensor(:,1))
  call check_last_AQ_V(l_switch,G1(:,:,:,1),wf(:,31),G1tensor(:,2))
  call loop_VQ_A(G0(:,:,:,1),wf(:,13),G0(:,:,:,3))
  call loop_Q_A(G0(:,:,:,3),Q(:,24),ZERO,G1(:,:,:,4))
  call loop_QV_A(G1(:,:,:,4),wf(:,1),G1(:,:,:,5))
  call loop_Q_A(G1(:,:,:,5),Q(:,27),ZERO,G2(:,:,:,3))
  call check_last_QA_V(l_switch,G2(:,:,:,3),wf(:,-2),G2tensor(:,3))
  call loop_QZ_A(G1(:,:,:,4),wf(:,6),G1(:,:,:,6),gZu)
  call loop_Q_A(G1(:,:,:,6),Q(:,27),ZERO,G2(:,:,:,4))
  call check_last_QA_V(l_switch,G2(:,:,:,4),wf(:,-2),G2tensor(:,4))
  call check_last_QA_V(l_switch,G1(:,:,:,4),wf(:,33),G1tensor(:,3))
  call check_last_QA_V(l_switch,G1(:,:,:,4),wf(:,34),G1tensor(:,4))
  call loop_VQ_A(G0(:,:,:,1),wf(:,-3),G0(:,:,:,4))
  call loop_Q_A(G0(:,:,:,4),Q(:,8),ZERO,G1(:,:,:,7))
  call loop_QW_A(G1(:,:,:,7),wf(:,-4),G1(:,:,:,8))
  call loop_Q_A(G1(:,:,:,8),Q(:,24),ZERO,G2(:,:,:,5))
  call check_last_QA_V(l_switch,G2(:,:,:,5),wf(:,33),G2tensor(:,5))
  call check_last_QA_V(l_switch,G2(:,:,:,5),wf(:,34),G2tensor(:,6))
  call loop_QV_A(G2(:,:,:,5),wf(:,1),G2(:,:,:,6))
  call loop_Q_A(G2(:,:,:,6),Q(:,27),ZERO,G3(:,:,:,1))
  call check_last_QA_V(l_switch,G3(:,:,:,1),wf(:,-2),G3tensor(:,1))
  call loop_QZ_A(G2(:,:,:,5),wf(:,6),G2(:,:,:,7),gZu)
  call loop_Q_A(G2(:,:,:,7),Q(:,27),ZERO,G3(:,:,:,2))
  call check_last_QA_V(l_switch,G3(:,:,:,2),wf(:,-2),G3tensor(:,2))
  call loop_QW_A(G1(:,:,:,7),wf(:,35),G1(:,:,:,9))
  call loop_Q_A(G1(:,:,:,9),Q(:,27),ZERO,G2(:,:,:,8))
  call check_last_QA_V(l_switch,G2(:,:,:,8),wf(:,-2),G2tensor(:,7))
  call loop_QW_A(G1(:,:,:,7),wf(:,36),G1(:,:,:,10))
  call loop_Q_A(G1(:,:,:,10),Q(:,27),ZERO,G2(:,:,:,9))
  call check_last_QA_V(l_switch,G2(:,:,:,9),wf(:,-2),G2tensor(:,8))
  call loop_QV_A(G1(:,:,:,7),wf(:,1),G1(:,:,:,11))
  call loop_Q_A(G1(:,:,:,11),Q(:,11),ZERO,G2(:,:,:,10))
  call loop_QW_A(G2(:,:,:,10),wf(:,-4),G2(:,:,:,11))
  call loop_Q_A(G2(:,:,:,11),Q(:,27),ZERO,G3(:,:,:,3))
  call check_last_QA_V(l_switch,G3(:,:,:,3),wf(:,-2),G3tensor(:,3))
  call loop_QZ_A(G1(:,:,:,7),wf(:,6),G1(:,:,:,12),gZd)
  call loop_Q_A(G1(:,:,:,12),Q(:,11),ZERO,G2(:,:,:,12))
  call loop_QW_A(G2(:,:,:,12),wf(:,-4),G2(:,:,:,13))
  call loop_Q_A(G2(:,:,:,13),Q(:,27),ZERO,G3(:,:,:,4))
  call check_last_QA_V(l_switch,G3(:,:,:,4),wf(:,-2),G3tensor(:,4))
  call loop_QW_A(G1(:,:,:,7),wf(:,37),G1(:,:,:,13))
  call loop_Q_A(G1(:,:,:,13),Q(:,27),ZERO,G2(:,:,:,14))
  call check_last_QA_V(l_switch,G2(:,:,:,14),wf(:,-2),G2tensor(:,9))
  call loop_VQ_A(G0(:,:,:,1),wf(:,30),G0(:,:,:,5))
  call loop_Q_A(G0(:,:,:,5),Q(:,11),ZERO,G1(:,:,:,14))
  call loop_QW_A(G1(:,:,:,14),wf(:,-4),G1(:,:,:,15))
  call loop_Q_A(G1(:,:,:,15),Q(:,27),ZERO,G2(:,:,:,15))
  call check_last_QA_V(l_switch,G2(:,:,:,15),wf(:,-2),G2tensor(:,10))
  call loop_VQ_A(G0(:,:,:,1),wf(:,31),G0(:,:,:,6))
  call loop_Q_A(G0(:,:,:,6),Q(:,11),ZERO,G1(:,:,:,16))
  call loop_QW_A(G1(:,:,:,16),wf(:,-4),G1(:,:,:,17))
  call loop_Q_A(G1(:,:,:,17),Q(:,27),ZERO,G2(:,:,:,16))
...
end module ol_vamp_1_eevjj_eexuxdwx_1_/**/REALKIND
