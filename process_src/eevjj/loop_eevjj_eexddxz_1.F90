...
module ol_colourmatrix_eevjj_eexddxz_1_/**/REALKIND
...
end module ol_colourmatrix_eevjj_eexddxz_1_/**/REALKIND



module ol_forced_parameters_eevjj_eexddxz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eevjj_eexddxz_1_/**/REALKIND

module ol_loop_eevjj_eexddxz_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(7) = (eQED**3*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
...
end module ol_loop_eevjj_eexddxz_1_/**/REALKIND
