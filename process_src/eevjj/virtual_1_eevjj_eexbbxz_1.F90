...
module ol_vamp_1_eevjj_eexbbxz_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_eevjj_eexbbxz_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_eevjj_eexbbxz_1.
! **********************************************************************
...
#endif
  use ol_loop_eevjj_eexbbxz_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_eevjj_eexbbxz_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call check_last_QA_V(l_switch,G1(:,:,:,1),wf(:,38),G1tensor(:,1))
  call check_last_QA_V(l_switch,G1(:,:,:,1),wf(:,39),G1tensor(:,2))
  call loop_VA_Q(G0(:,:,:,1),wf(:,11),G0(:,:,:,3))
  call loop_A_Q(G0(:,:,:,3),Q(:,24),MB,G1(:,:,:,4))
  call loop_AV_Q(G1(:,:,:,4),wf(:,5),G1(:,:,:,5))
  call loop_A_Q(G1(:,:,:,5),Q(:,27),MB,G2(:,:,:,3))
  call check_last_AQ_V(l_switch,G2(:,:,:,3),wf(:,-2),G2tensor(:,3))
  call loop_AZ_Q(G1(:,:,:,4),wf(:,3),G1(:,:,:,6),gZd)
  call loop_A_Q(G1(:,:,:,6),Q(:,27),MB,G2(:,:,:,4))
  call check_last_AQ_V(l_switch,G2(:,:,:,4),wf(:,-2),G2tensor(:,4))
  call check_last_AQ_V(l_switch,G1(:,:,:,4),wf(:,41),G1tensor(:,3))
  call check_last_AQ_V(l_switch,G1(:,:,:,4),wf(:,42),G1tensor(:,4))
  ...
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,41),G2tensor(:,5))
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,42),G2tensor(:,6))
  call loop_AV_Q(G2(:,:,:,5),wf(:,5),G2(:,:,:,6))
  call loop_A_Q(G2(:,:,:,6),Q(:,27),MB,G3(:,:,:,1))
  ...
  call loop_A_Q(G1(:,:,:,9),Q(:,27),MB,G2(:,:,:,8))
  call check_last_AQ_V(l_switch,G2(:,:,:,8),wf(:,-2),G2tensor(:,7))
  call loop_AV_Q(G1(:,:,:,7),wf(:,5),G1(:,:,:,10))
  call loop_A_Q(G1(:,:,:,10),Q(:,11),MB,G2(:,:,:,9))
  call loop_AZ_Q(G2(:,:,:,9),wf(:,-4),G2(:,:,:,10),gZd)
  call loop_A_Q(G2(:,:,:,10),Q(:,27),MB,G3(:,:,:,3))
  call check_last_AQ_V(l_switch,G3(:,:,:,3),wf(:,-2),G3tensor(:,3))
  call loop_AZ_Q(G1(:,:,:,7),wf(:,3),G1(:,:,:,11),gZd)
  call loop_A_Q(G1(:,:,:,11),Q(:,11),MB,G2(:,:,:,11))
  call loop_AZ_Q(G2(:,:,:,11),wf(:,-4),G2(:,:,:,12),gZd)
  call loop_A_Q(G2(:,:,:,12),Q(:,27),MB,G3(:,:,:,4))
  call check_last_AQ_V(l_switch,G3(:,:,:,4),wf(:,-2),G3tensor(:,4))
  call loop_AV_Q(G1(:,:,:,7),wf(:,17),G1(:,:,:,12))
  call loop_A_Q(G1(:,:,:,12),Q(:,27),MB,G2(:,:,:,13))
  call check_last_AQ_V(l_switch,G2(:,:,:,13),wf(:,-2),G2tensor(:,8))
  call loop_AZ_Q(G1(:,:,:,7),wf(:,43),G1(:,:,:,13),gZd)
  call loop_A_Q(G1(:,:,:,13),Q(:,27),MB,G2(:,:,:,14))
  call check_last_AQ_V(l_switch,G2(:,:,:,14),wf(:,-2),G2tensor(:,9))
  call loop_AV_Q(G1(:,:,:,7),wf(:,23),G1(:,:,:,14))
  call loop_A_Q(G1(:,:,:,14),Q(:,27),MB,G2(:,:,:,15))
  call check_last_AQ_V(l_switch,G2(:,:,:,15),wf(:,-2),G2tensor(:,10))
  call loop_AZ_Q(G1(:,:,:,7),wf(:,44),G1(:,:,:,15),gZd)
  call loop_A_Q(G1(:,:,:,15),Q(:,27),MB,G2(:,:,:,16))
  call check_last_AQ_V(l_switch,G2(:,:,:,16),wf(:,-2),G2tensor(:,11))
  call loop_VA_Q(G0(:,:,:,1),wf(:,38),G0(:,:,:,5))
  call loop_A_Q(G0(:,:,:,5),Q(:,11),MB,G1(:,:,:,16))
  call loop_AZ_Q(G1(:,:,:,16),wf(:,-4),G1(:,:,:,17),gZd)
  call loop_A_Q(G1(:,:,:,17),Q(:,27),MB,G2(:,:,:,17))
  call check_last_AQ_V(l_switch,G2(:,:,:,17),wf(:,-2),G2tensor(:,12))
  call loop_VA_Q(G0(:,:,:,1),wf(:,39),G0(:,:,:,6))
  call loop_A_Q(G0(:,:,:,6),Q(:,11),MB,G1(:,:,:,18))
  call loop_AZ_Q(G1(:,:,:,18),wf(:,-4),G1(:,:,:,19),gZd)
  call loop_A_Q(G1(:,:,:,19),Q(:,27),MB,G2(:,:,:,18))
...
end module ol_vamp_1_eevjj_eexbbxz_1_/**/REALKIND
