...
module ol_colourmatrix_eevjj_eexuxdwx_1_/**/REALKIND
...
end module ol_colourmatrix_eevjj_eexuxdwx_1_/**/REALKIND



module ol_forced_parameters_eevjj_eexuxdwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eevjj_eexuxdwx_1_/**/REALKIND

module ol_loop_eevjj_eexuxdwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_UV_W(wf(:,6),Q(:,3),wf(:,-4),Q(:,16),wf(:,7))
  call vert_AW_Q(wf(:,-2),wf(:,-4),wf(:,8))
  call prop_A_Q(wf(:,8),Q(:,20),ZERO,0_intkind1,wf(:,9))
  call vert_VQ_A(wf(:,1),wf(:,-3),wf(:,10))
  call vert_ZQ_A(gZd,wf(:,6),wf(:,-3),wf(:,11))
  call vert_WQ_A(wf(:,-4),wf(:,-3),wf(:,12))
  call prop_Q_A(wf(:,12),Q(:,24),ZERO,0_intkind1,wf(:,13))
  call vert_AV_Q(wf(:,-2),wf(:,1),wf(:,14))
  call vert_AZ_Q(gZu,wf(:,-2),wf(:,6),wf(:,15))
  call vert_WQ_A(wf(:,-4),wf(:,0),wf(:,16))
  call prop_Q_A(wf(:,16),Q(:,17),ZERO,0_intkind1,wf(:,17))
  call vert_QA_W(wf(:,17),wf(:,-1),wf(:,18))
  call counter_VQ_A(wf(:,1),wf(:,-3),wf(:,19))
  call counter_ZQ_A(gZd,wf(:,6),wf(:,-3),wf(:,20))
  call counter_WQ_A(wf(:,-4),wf(:,-3),wf(:,21))
  call prop_Q_A(wf(:,21),Q(:,24),ZERO,0_intkind1,wf(:,22))
  call counter_AV_Q(wf(:,-2),wf(:,1),wf(:,23))
  call counter_AZ_Q(gZu,wf(:,-2),wf(:,6),wf(:,24))
  call counter_AW_Q(wf(:,-2),wf(:,-4),wf(:,25))
  call prop_A_Q(wf(:,25),Q(:,20),ZERO,0_intkind1,wf(:,26))
  call counter_QA_W(wf(:,-3),wf(:,-2),wf(:,27))
  call prop_W_W(wf(:,27),Q(:,12),MW,1_intkind1,wf(:,28))
  call counter_A_Q(ctqq,wf(:,9),Q(:,20),wf(:,29))
  call prop_Q_A(wf(:,10),Q(:,11),ZERO,0_intkind1,wf(:,30))
  call prop_Q_A(wf(:,11),Q(:,11),ZERO,0_intkind1,wf(:,31))
  call counter_Q_A(ctqq,wf(:,13),Q(:,24),wf(:,32))
  call prop_A_Q(wf(:,14),Q(:,7),ZERO,0_intkind1,wf(:,33))
  call prop_A_Q(wf(:,15),Q(:,7),ZERO,0_intkind1,wf(:,34))
...
end module ol_loop_eevjj_eexuxdwx_1_/**/REALKIND
