...
! **********************************************************************
  ...
  call vert_AQ_S(gH,wf(:,-3),wf(:,13),wf(:,14))
  call prop_W_W(wf(:,10),Q(:,112),MZ,1_intkind1,wf(:,15))
  call vert_QA_Z(gZl,wf(:,13),wf(:,-3),wf(:,16))
  call vert_AW_Q(wf(:,-3),wf(:,4),wf(:,17))
  call prop_A_Q(wf(:,17),Q(:,13),ZERO,0_intkind1,wf(:,18))
  call vert_QA_Z(gZn,wf(:,-1),wf(:,18),wf(:,19))
  call vert_AW_Q(wf(:,0),wf(:,5),wf(:,20))
  call prop_A_Q(wf(:,20),Q(:,11),ZERO,0_intkind1,wf(:,21))
  call vert_AQ_S(gH,wf(:,21),wf(:,-2),wf(:,22))
  call vert_QA_Z(gZl,wf(:,-2),wf(:,21),wf(:,23))
  call vert_WQ_A(wf(:,5),wf(:,-2),wf(:,24))
  call prop_Q_A(wf(:,24),Q(:,14),ZERO,0_intkind1,wf(:,25))
  call vert_QA_Z(gZn,wf(:,25),wf(:,0),wf(:,26))
  call vert_QA_V(wf(:,13),wf(:,-3),wf(:,27))
  call prop_W_W(wf(:,16),Q(:,15),MZ,1_intkind1,wf(:,28))
  call prop_W_W(wf(:,19),Q(:,15),MZ,1_intkind1,wf(:,29))
  call vert_QA_V(wf(:,-2),wf(:,21),wf(:,30))
