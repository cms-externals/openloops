...
module ol_colourmatrix_ppllllj2_nexnmemxuuxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj2_nexnmemxuuxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj2_nexnmemxuuxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj2_nexnmemxuuxg_1_/**/REALKIND

module ol_loop_ppllllj2_nexnmemxuuxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_UV_W(wf(:,5),Q(:,10),wf(:,4),Q(:,5),wf(:,9))
  ...
  call vert_QA_Z(gZl,wf(:,13),wf(:,-3),wf(:,15))
  call vert_AW_Q(wf(:,-3),wf(:,4),wf(:,16))
  call prop_A_Q(wf(:,16),Q(:,13),ZERO,0_intkind1,wf(:,17))
  call vert_QA_Z(gZn,wf(:,-1),wf(:,17),wf(:,18))
  call vert_AW_Q(wf(:,0),wf(:,5),wf(:,19))
  call prop_A_Q(wf(:,19),Q(:,11),ZERO,0_intkind1,wf(:,20))
  call vert_QA_Z(gZl,wf(:,-2),wf(:,20),wf(:,21))
  call vert_WQ_A(wf(:,5),wf(:,-2),wf(:,22))
  call prop_Q_A(wf(:,22),Q(:,14),ZERO,0_intkind1,wf(:,23))
  call vert_QA_Z(gZn,wf(:,23),wf(:,0),wf(:,24))
  call vert_QA_V(wf(:,13),wf(:,-3),wf(:,25))
  call prop_W_W(wf(:,15),Q(:,15),MZ,1_intkind1,wf(:,26))
  call prop_W_W(wf(:,18),Q(:,15),MZ,1_intkind1,wf(:,27))
  call vert_QA_V(wf(:,-2),wf(:,20),wf(:,28))
...
end module ol_loop_ppllllj2_nexnmemxuuxg_1_/**/REALKIND
