...
subroutine diagrams(A)
  ...
  A(13) = cont_SS(wf(:,33),wf(:,35)) * den(26)
  A(14) = cont_SS(wf(:,33),wf(:,36)) * den(27)
  A(15) = cont_VV(wf(:,38),wf(:,39)) * den(29)
  A(16) = cont_VV(wf(:,38),wf(:,41)) * den(32)
  A(17) = cont_VV(wf(:,39),wf(:,43)) * den(34)
  A(18) = cont_VV(wf(:,41),wf(:,43)) * den(35)
  A(19) = cont_VV(wf(:,39),wf(:,45)) * den(37)
  A(20) = cont_VV(wf(:,41),wf(:,45)) * den(38)
  A(21) = cont_VV(wf(:,38),wf(:,46)) * den(39)
  A(22) = cont_VV(wf(:,38),wf(:,48)) * den(42)
  A(23) = cont_VV(wf(:,43),wf(:,46)) * den(43)
  A(24) = cont_VV(wf(:,43),wf(:,48)) * den(44)
  A(25) = cont_VV(wf(:,45),wf(:,46)) * den(45)
  A(26) = cont_VV(wf(:,45),wf(:,48)) * den(46)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(4)+A(6)+A(8)+A(10))*f(1)+2*CI*(A(15)+A(16)-A(17)-A(18)+A(19)+A(20)+A(21)+A(22)-A(23)-A(24)+A(25)+A(26))*f(2) &
       +2*CI*(A(1)-A(2)+A(3))*f(3)+2*CI*(-A(12)+A(13)-A(14))*f(4)
  M2(2) = (A(5)+A(7)+A(9)+A(11))*f(1)+2*CI*(-A(15)-A(16)+A(17)+A(18)-A(19)-A(20)-A(21)-A(22)+A(23)+A(24)-A(25)-A(26))*f(2)+2*CI*( &
       -A(1)+A(2)-A(3))*f(3)+2*CI*(A(12)-A(13)+A(14))*f(4)
