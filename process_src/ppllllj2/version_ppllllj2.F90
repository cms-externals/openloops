...
module ol_versiondata_ppllllj2
  implicit none
  character(4) :: generator_revision = "3063"
  interface
    subroutine version_ppllllj2(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllllj2
  end interface
end module ol_versiondata_ppllllj2


subroutine ol_version_ppllllj2(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllllj2, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllllj2
