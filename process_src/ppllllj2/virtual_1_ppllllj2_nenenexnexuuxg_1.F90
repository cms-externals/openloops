...
! **********************************************************************
  ...
  M(1) = M(1) + (-(f(8)/2._/**/REALKIND) * den(12)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,1),T3sum(1:35,1))
  M(1) = M(1) + (-(f(8)/2._/**/REALKIND) * den(12)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,11),T3sum(1:35,1))
  ...
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,9),T4sum(1:70,1))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_7,masses2_5,G4tensor(:,3),T4sum(1:70,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,13),T4sum(1:70,1))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_7,masses2_5,G4tensor(:,1),T4sum(1:70,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,10),T4sum(1:70,1))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_7,masses2_4,G4tensor(:,7),T4sum(1:70,3))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,14),T4sum(1:70,1))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_7,masses2_4,G4tensor(:,5),T4sum(1:70,3))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,17),T4sum(1:70,4))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_4,masses2_5,G4tensor(:,19),T4sum(1:70,5))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,21),T4sum(1:70,4))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_4,masses2_5,G4tensor(:,23),T4sum(1:70,5))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,25),T4sum(1:70,4))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_4,masses2_4,G4tensor(:,27),T4sum(1:70,6))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,29),T4sum(1:70,4))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_4,masses2_4,G4tensor(:,31),T4sum(1:70,6))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,22),T4sum(1:70,7))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_5,masses2_5,G4tensor(:,24),T4sum(1:70,8))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,18),T4sum(1:70,7))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_5,masses2_5,G4tensor(:,20),T4sum(1:70,8))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,30),T4sum(1:70,7))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_5,masses2_4,G4tensor(:,32),T4sum(1:70,9))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,26),T4sum(1:70,7))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(78)) * TI2_call(4,momenta_5,masses2_4,G4tensor(:,28),T4sum(1:70,9))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(79)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,41),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(79)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,12),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(79)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,57),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(79)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,2),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(79)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,42),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(79)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,32),T3sum(1:35,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(79)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,58),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(79)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,22),T3sum(1:35,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(80)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,43),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(80)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,13),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(80)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,59),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(80)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,3),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(80)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,44),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(80)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,33),T3sum(1:35,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(80)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,60),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(80)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,23),T3sum(1:35,2))
  M(1) = M(1) + (f(8)/2._/**/REALKIND * den(38)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,4),T3sum(1:35,1))
  M(1) = M(1) + (f(8)/2._/**/REALKIND * den(38)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,14),T3sum(1:35,1))
  ...
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,15),T4sum(1:70,10))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_6,masses2_5,G4tensor(:,2),T4sum(1:70,11))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,11),T4sum(1:70,10))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_6,masses2_5,G4tensor(:,4),T4sum(1:70,11))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,16),T4sum(1:70,10))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_6,masses2_4,G4tensor(:,6),T4sum(1:70,12))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,12),T4sum(1:70,10))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_6,masses2_4,G4tensor(:,8),T4sum(1:70,12))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_3,masses2_6,G4tensor(:,33),T4sum(1:70,13))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_3,masses2_5,G4tensor(:,35),T4sum(1:70,14))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_3,masses2_6,G4tensor(:,37),T4sum(1:70,13))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_3,masses2_5,G4tensor(:,39),T4sum(1:70,14))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_3,masses2_6,G4tensor(:,41),T4sum(1:70,13))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_3,masses2_4,G4tensor(:,43),T4sum(1:70,15))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_3,masses2_6,G4tensor(:,45),T4sum(1:70,13))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_3,masses2_4,G4tensor(:,47),T4sum(1:70,15))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_2,masses2_6,G4tensor(:,38),T4sum(1:70,16))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_2,masses2_5,G4tensor(:,40),T4sum(1:70,17))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_2,masses2_6,G4tensor(:,34),T4sum(1:70,16))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_2,masses2_5,G4tensor(:,36),T4sum(1:70,17))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_2,masses2_6,G4tensor(:,46),T4sum(1:70,16))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_2,masses2_4,G4tensor(:,48),T4sum(1:70,18))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_2,masses2_6,G4tensor(:,42),T4sum(1:70,16))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(81)) * TI2_call(4,momenta_2,masses2_4,G4tensor(:,44),T4sum(1:70,18))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(82)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,45),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(82)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,15),T3sum(1:35,1))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(82)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,61),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(82)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,5),T3sum(1:35,1))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(82)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,46),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(82)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,35),T3sum(1:35,2))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(82)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,62),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(82)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,25),T3sum(1:35,2))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(83)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,47),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(83)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,16),T3sum(1:35,1))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(83)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,63),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(83)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,6),T3sum(1:35,1))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(83)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,48),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(83)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,36),T3sum(1:35,2))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(83)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,64),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(83)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,26),T3sum(1:35,2))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(84)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,49),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(84)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,17),T3sum(1:35,1))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(84)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,65),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(84)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,7),T3sum(1:35,1))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(84)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,50),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(84)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,37),T3sum(1:35,2))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(84)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,66),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(84)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,27),T3sum(1:35,2))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(85)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,51),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(85)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,18),T3sum(1:35,1))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(85)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,67),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(85)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,8),T3sum(1:35,1))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(85)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,52),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(85)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,38),T3sum(1:35,2))
  M(1) = M(1) + (-(f(4)/2._/**/REALKIND) * den(85)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,68),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(85)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,28),T3sum(1:35,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(86)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,53),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(86)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,19),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(86)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,69),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(86)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,9),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(86)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,54),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(86)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,39),T3sum(1:35,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(86)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,70),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(86)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,29),T3sum(1:35,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(87)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,55),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(87)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,20),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(87)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,71),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(87)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,10),T3sum(1:35,1))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(87)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,56),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(87)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,40),T3sum(1:35,2))
  M(1) = M(1) + (f(4)/2._/**/REALKIND * den(87)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,72),T3sum(1:35,3))
  M(1) = M(1) + (f(3)/2._/**/REALKIND * den(87)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,30),T3sum(1:35,2))
