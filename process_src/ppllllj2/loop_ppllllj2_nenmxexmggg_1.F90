...
! **********************************************************************
  ...
  call vert_QA_Z(gZl,wf(:,-3),wf(:,20),wf(:,49))
  call prop_Q_A(wf(:,25),Q(:,13),ZERO,0_intkind1,wf(:,50))
  call vert_QA_Z(gZn,wf(:,50),wf(:,-1),wf(:,51))
  call prop_W_W(wf(:,45),Q(:,112),MZ,1_intkind1,wf(:,52))
  call prop_W_W(wf(:,47),Q(:,112),MZ,1_intkind1,wf(:,53))
  call vert_QA_Z(gZl,wf(:,31),wf(:,-2),wf(:,54))
  call prop_A_Q(wf(:,36),Q(:,14),ZERO,0_intkind1,wf(:,55))
  call vert_QA_Z(gZn,wf(:,0),wf(:,55),wf(:,56))
  call vert_QA_V(wf(:,-3),wf(:,20),wf(:,57))
  call prop_W_W(wf(:,49),Q(:,15),MZ,1_intkind1,wf(:,58))
  call prop_W_W(wf(:,51),Q(:,15),MZ,1_intkind1,wf(:,59))
  call vert_QA_V(wf(:,31),wf(:,-2),wf(:,60))
