...
! **********************************************************************
  ...
  M(1) = M(1) + (CI*f(12) * den(39)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,1),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(12)) * den(39)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,1),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(12) * den(39)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,11),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(12)) * den(39)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,11),T3sum(1:35,5))
  ...
  M(1) = M(1) + (-(CI*f(5)) * den(88)) * TI2_call(4,momenta_17,masses2_6,G4tensor(:,89),T4sum(1:70,19))
  M(2) = M(2) + (CI*f(5) * den(88)) * TI2_call(4,momenta_17,masses2_6,G4tensor(:,89),T4sum(1:70,19))
  M(1) = M(1) + (-(CI*f(4)) * den(88)) * TI2_call(4,momenta_17,masses2_5,G4tensor(:,23),T4sum(1:70,20))
  M(2) = M(2) + (CI*f(4) * den(88)) * TI2_call(4,momenta_17,masses2_5,G4tensor(:,23),T4sum(1:70,20))
  M(1) = M(1) + (-(CI*f(5)) * den(88)) * TI2_call(4,momenta_17,masses2_6,G4tensor(:,125),T4sum(1:70,19))
  M(2) = M(2) + (CI*f(5) * den(88)) * TI2_call(4,momenta_17,masses2_6,G4tensor(:,125),T4sum(1:70,19))
  M(1) = M(1) + (-(CI*f(4)) * den(88)) * TI2_call(4,momenta_17,masses2_5,G4tensor(:,1),T4sum(1:70,20))
  M(2) = M(2) + (CI*f(4) * den(88)) * TI2_call(4,momenta_17,masses2_5,G4tensor(:,1),T4sum(1:70,20))
  M(1) = M(1) + (-(CI*f(5)) * den(88)) * TI2_call(4,momenta_17,masses2_6,G4tensor(:,90),T4sum(1:70,19))
  M(2) = M(2) + (CI*f(5) * den(88)) * TI2_call(4,momenta_17,masses2_6,G4tensor(:,90),T4sum(1:70,19))
  M(1) = M(1) + (-(CI*f(4)) * den(88)) * TI2_call(4,momenta_17,masses2_4,G4tensor(:,67),T4sum(1:70,21))
  M(2) = M(2) + (CI*f(4) * den(88)) * TI2_call(4,momenta_17,masses2_4,G4tensor(:,67),T4sum(1:70,21))
  M(1) = M(1) + (-(CI*f(5)) * den(88)) * TI2_call(4,momenta_17,masses2_6,G4tensor(:,126),T4sum(1:70,19))
  M(2) = M(2) + (CI*f(5) * den(88)) * TI2_call(4,momenta_17,masses2_6,G4tensor(:,126),T4sum(1:70,19))
  M(1) = M(1) + (-(CI*f(4)) * den(88)) * TI2_call(4,momenta_17,masses2_4,G4tensor(:,45),T4sum(1:70,21))
  M(2) = M(2) + (CI*f(4) * den(88)) * TI2_call(4,momenta_17,masses2_4,G4tensor(:,45),T4sum(1:70,21))
  M(1) = M(1) + (-f(13) * den(36)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,2),T4sum(1:70,30))
  M(2) = M(2) + (-f(13) * den(36)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,24),T4sum(1:70,30))
  ...
  M(2) = M(2) + (-f(13) * den(36)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,12),T4sum(1:70,32))
  M(1) = M(1) + (-f(13) * den(36)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,34),T4sum(1:70,32))
  ...
  M(1) = M(1) + (f(7) * den(4)) * TI2_call(5,momenta_42,masses2_9,G5tensor(:,53),T5sum(1:126,10))
  M(1) = M(1) + (f(6) * den(4)) * TI2_call(5,momenta_42,masses2_8,G5tensor(:,3),T5sum(1:126,11))
  M(2) = M(2) + (f(7) * den(4)) * TI2_call(5,momenta_42,masses2_9,G5tensor(:,37),T5sum(1:126,10))
  M(2) = M(2) + (f(6) * den(4)) * TI2_call(5,momenta_42,masses2_8,G5tensor(:,11),T5sum(1:126,11))
  M(1) = M(1) + (f(7) * den(4)) * TI2_call(5,momenta_42,masses2_9,G5tensor(:,54),T5sum(1:126,10))
  M(1) = M(1) + (f(6) * den(4)) * TI2_call(5,momenta_42,masses2_7,G5tensor(:,19),T5sum(1:126,12))
  M(2) = M(2) + (f(7) * den(4)) * TI2_call(5,momenta_42,masses2_9,G5tensor(:,38),T5sum(1:126,10))
  M(2) = M(2) + (f(6) * den(4)) * TI2_call(5,momenta_42,masses2_7,G5tensor(:,27),T5sum(1:126,12))
  M(2) = M(2) + (f(7) * den(4)) * TI2_call(5,momenta_44,masses2_9,G5tensor(:,57),T5sum(1:126,22))
  M(2) = M(2) + (f(6) * den(4)) * TI2_call(5,momenta_44,masses2_8,G5tensor(:,5),T5sum(1:126,23))
  M(1) = M(1) + (f(7) * den(4)) * TI2_call(5,momenta_44,masses2_9,G5tensor(:,41),T5sum(1:126,22))
  M(1) = M(1) + (f(6) * den(4)) * TI2_call(5,momenta_44,masses2_8,G5tensor(:,13),T5sum(1:126,23))
  M(2) = M(2) + (f(7) * den(4)) * TI2_call(5,momenta_44,masses2_9,G5tensor(:,58),T5sum(1:126,22))
  M(2) = M(2) + (f(6) * den(4)) * TI2_call(5,momenta_44,masses2_7,G5tensor(:,21),T5sum(1:126,24))
  M(1) = M(1) + (f(7) * den(4)) * TI2_call(5,momenta_44,masses2_9,G5tensor(:,42),T5sum(1:126,22))
  M(1) = M(1) + (f(6) * den(4)) * TI2_call(5,momenta_44,masses2_7,G5tensor(:,29),T5sum(1:126,24))
  M(1) = M(1) + (f(7) * den(4)) * TI2_call(5,momenta_40,masses2_9,G5tensor(:,33),T5sum(1:126,31))
  M(1) = M(1) + (f(6) * den(4)) * TI2_call(5,momenta_40,masses2_8,G5tensor(:,9),T5sum(1:126,32))
  M(2) = M(2) + (f(7) * den(4)) * TI2_call(5,momenta_40,masses2_9,G5tensor(:,49),T5sum(1:126,31))
  M(2) = M(2) + (f(6) * den(4)) * TI2_call(5,momenta_40,masses2_8,G5tensor(:,1),T5sum(1:126,32))
  M(1) = M(1) + (f(7) * den(4)) * TI2_call(5,momenta_40,masses2_9,G5tensor(:,35),T5sum(1:126,31))
  M(1) = M(1) + (f(6) * den(4)) * TI2_call(5,momenta_40,masses2_7,G5tensor(:,25),T5sum(1:126,33))
  M(2) = M(2) + (f(7) * den(4)) * TI2_call(5,momenta_40,masses2_9,G5tensor(:,51),T5sum(1:126,31))
  M(2) = M(2) + (f(6) * den(4)) * TI2_call(5,momenta_40,masses2_7,G5tensor(:,17),T5sum(1:126,33))
  M(2) = M(2) + (f(7) * den(4)) * TI2_call(5,momenta_39,masses2_9,G5tensor(:,34),T5sum(1:126,34))
  M(2) = M(2) + (f(6) * den(4)) * TI2_call(5,momenta_39,masses2_8,G5tensor(:,10),T5sum(1:126,35))
  M(1) = M(1) + (f(7) * den(4)) * TI2_call(5,momenta_39,masses2_9,G5tensor(:,50),T5sum(1:126,34))
  M(1) = M(1) + (f(6) * den(4)) * TI2_call(5,momenta_39,masses2_8,G5tensor(:,2),T5sum(1:126,35))
  M(2) = M(2) + (f(7) * den(4)) * TI2_call(5,momenta_39,masses2_9,G5tensor(:,36),T5sum(1:126,34))
  M(2) = M(2) + (f(6) * den(4)) * TI2_call(5,momenta_39,masses2_7,G5tensor(:,26),T5sum(1:126,36))
  M(1) = M(1) + (f(7) * den(4)) * TI2_call(5,momenta_39,masses2_9,G5tensor(:,52),T5sum(1:126,34))
  M(1) = M(1) + (f(6) * den(4)) * TI2_call(5,momenta_39,masses2_7,G5tensor(:,18),T5sum(1:126,36))
  M(1) = M(1) + (-(CI*f(5)) * den(93)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,41),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(93)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,41),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(93)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,12),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(4) * den(93)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,12),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(5)) * den(93)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,57),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(93)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,57),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(93)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,2),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(4) * den(93)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,2),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(5)) * den(93)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,42),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(93)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,42),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(93)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,32),T3sum(1:35,6))
  M(2) = M(2) + (CI*f(4) * den(93)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,32),T3sum(1:35,6))
  M(1) = M(1) + (-(CI*f(5)) * den(93)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,58),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(93)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,58),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(93)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,22),T3sum(1:35,6))
  M(2) = M(2) + (CI*f(4) * den(93)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,22),T3sum(1:35,6))
  M(1) = M(1) + (-(CI*f(5)) * den(94)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,43),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(94)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,43),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(94)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,13),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(4) * den(94)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,13),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(5)) * den(94)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,59),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(94)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,59),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(94)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,3),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(4) * den(94)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,3),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(5)) * den(94)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,44),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(94)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,44),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(94)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,33),T3sum(1:35,6))
  M(2) = M(2) + (CI*f(4) * den(94)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,33),T3sum(1:35,6))
  M(1) = M(1) + (-(CI*f(5)) * den(94)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,60),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(94)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,60),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(94)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,23),T3sum(1:35,6))
  M(2) = M(2) + (CI*f(4) * den(94)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,23),T3sum(1:35,6))
  M(1) = M(1) + (f(7) * den(78)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,127),T4sum(1:70,35))
  M(1) = M(1) + (f(6) * den(78)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,3),T4sum(1:70,30))
  M(2) = M(2) + (f(7) * den(78)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,91),T4sum(1:70,35))
  M(2) = M(2) + (f(6) * den(78)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,25),T4sum(1:70,30))
  M(1) = M(1) + (f(7) * den(78)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,128),T4sum(1:70,35))
  M(1) = M(1) + (f(6) * den(78)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,47),T4sum(1:70,31))
  M(2) = M(2) + (f(7) * den(78)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,92),T4sum(1:70,35))
  M(2) = M(2) + (f(6) * den(78)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,69),T4sum(1:70,31))
  M(2) = M(2) + (f(7) * den(78)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,143),T4sum(1:70,36))
  M(2) = M(2) + (f(6) * den(78)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,13),T4sum(1:70,32))
  M(1) = M(1) + (f(7) * den(78)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,107),T4sum(1:70,36))
  M(1) = M(1) + (f(6) * den(78)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,35),T4sum(1:70,32))
  M(2) = M(2) + (f(7) * den(78)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,144),T4sum(1:70,36))
  M(2) = M(2) + (f(6) * den(78)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,57),T4sum(1:70,33))
  M(1) = M(1) + (f(7) * den(78)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,108),T4sum(1:70,36))
  M(1) = M(1) + (f(6) * den(78)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,79),T4sum(1:70,33))
  M(1) = M(1) + (f(7) * den(79)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,129),T4sum(1:70,35))
  M(1) = M(1) + (f(6) * den(79)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,4),T4sum(1:70,30))
  M(2) = M(2) + (f(7) * den(79)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,93),T4sum(1:70,35))
  M(2) = M(2) + (f(6) * den(79)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,26),T4sum(1:70,30))
  M(1) = M(1) + (f(7) * den(79)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,130),T4sum(1:70,35))
  M(1) = M(1) + (f(6) * den(79)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,48),T4sum(1:70,31))
  M(2) = M(2) + (f(7) * den(79)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,94),T4sum(1:70,35))
  M(2) = M(2) + (f(6) * den(79)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,70),T4sum(1:70,31))
  M(2) = M(2) + (f(7) * den(79)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,145),T4sum(1:70,36))
  M(2) = M(2) + (f(6) * den(79)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,14),T4sum(1:70,32))
  M(1) = M(1) + (f(7) * den(79)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,109),T4sum(1:70,36))
  M(1) = M(1) + (f(6) * den(79)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,36),T4sum(1:70,32))
  M(2) = M(2) + (f(7) * den(79)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,146),T4sum(1:70,36))
  M(2) = M(2) + (f(6) * den(79)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,58),T4sum(1:70,33))
  M(1) = M(1) + (f(7) * den(79)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,110),T4sum(1:70,36))
  M(1) = M(1) + (f(6) * den(79)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,80),T4sum(1:70,33))
  M(1) = M(1) + (CI*f(5) * den(95)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,161),T4sum(1:70,40))
  M(2) = M(2) + (-(CI*f(5)) * den(95)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,161),T4sum(1:70,40))
  M(1) = M(1) + (CI*f(4) * den(95)) * TI2_call(4,momenta_7,masses2_5,G4tensor(:,167),T4sum(1:70,41))
  M(2) = M(2) + (-(CI*f(4)) * den(95)) * TI2_call(4,momenta_7,masses2_5,G4tensor(:,167),T4sum(1:70,41))
  M(1) = M(1) + (CI*f(5) * den(95)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,173),T4sum(1:70,40))
  M(2) = M(2) + (-(CI*f(5)) * den(95)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,173),T4sum(1:70,40))
  M(1) = M(1) + (CI*f(4) * den(95)) * TI2_call(4,momenta_7,masses2_5,G4tensor(:,179),T4sum(1:70,41))
  M(2) = M(2) + (-(CI*f(4)) * den(95)) * TI2_call(4,momenta_7,masses2_5,G4tensor(:,179),T4sum(1:70,41))
  M(1) = M(1) + (CI*f(5) * den(95)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,185),T4sum(1:70,40))
  M(2) = M(2) + (-(CI*f(5)) * den(95)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,185),T4sum(1:70,40))
  M(1) = M(1) + (CI*f(4) * den(95)) * TI2_call(4,momenta_7,masses2_4,G4tensor(:,191),T4sum(1:70,42))
  M(2) = M(2) + (-(CI*f(4)) * den(95)) * TI2_call(4,momenta_7,masses2_4,G4tensor(:,191),T4sum(1:70,42))
  M(1) = M(1) + (CI*f(5) * den(95)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,197),T4sum(1:70,40))
  M(2) = M(2) + (-(CI*f(5)) * den(95)) * TI2_call(4,momenta_7,masses2_6,G4tensor(:,197),T4sum(1:70,40))
  M(1) = M(1) + (CI*f(4) * den(95)) * TI2_call(4,momenta_7,masses2_4,G4tensor(:,203),T4sum(1:70,42))
  M(2) = M(2) + (-(CI*f(4)) * den(95)) * TI2_call(4,momenta_7,masses2_4,G4tensor(:,203),T4sum(1:70,42))
  M(1) = M(1) + (CI*f(5) * den(95)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,174),T4sum(1:70,43))
  M(2) = M(2) + (-(CI*f(5)) * den(95)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,174),T4sum(1:70,43))
  M(1) = M(1) + (CI*f(4) * den(95)) * TI2_call(4,momenta_6,masses2_5,G4tensor(:,180),T4sum(1:70,44))
  M(2) = M(2) + (-(CI*f(4)) * den(95)) * TI2_call(4,momenta_6,masses2_5,G4tensor(:,180),T4sum(1:70,44))
  M(1) = M(1) + (CI*f(5) * den(95)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,162),T4sum(1:70,43))
  M(2) = M(2) + (-(CI*f(5)) * den(95)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,162),T4sum(1:70,43))
  M(1) = M(1) + (CI*f(4) * den(95)) * TI2_call(4,momenta_6,masses2_5,G4tensor(:,168),T4sum(1:70,44))
  M(2) = M(2) + (-(CI*f(4)) * den(95)) * TI2_call(4,momenta_6,masses2_5,G4tensor(:,168),T4sum(1:70,44))
  M(1) = M(1) + (CI*f(5) * den(95)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,198),T4sum(1:70,43))
  M(2) = M(2) + (-(CI*f(5)) * den(95)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,198),T4sum(1:70,43))
  M(1) = M(1) + (CI*f(4) * den(95)) * TI2_call(4,momenta_6,masses2_4,G4tensor(:,204),T4sum(1:70,45))
  M(2) = M(2) + (-(CI*f(4)) * den(95)) * TI2_call(4,momenta_6,masses2_4,G4tensor(:,204),T4sum(1:70,45))
  M(1) = M(1) + (CI*f(5) * den(95)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,186),T4sum(1:70,43))
  M(2) = M(2) + (-(CI*f(5)) * den(95)) * TI2_call(4,momenta_6,masses2_6,G4tensor(:,186),T4sum(1:70,43))
  M(1) = M(1) + (CI*f(4) * den(95)) * TI2_call(4,momenta_6,masses2_4,G4tensor(:,192),T4sum(1:70,45))
  M(2) = M(2) + (-(CI*f(4)) * den(95)) * TI2_call(4,momenta_6,masses2_4,G4tensor(:,192),T4sum(1:70,45))
  M(1) = M(1) + (-(CI*f(5)) * den(96)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,163),T4sum(1:70,49))
  M(2) = M(2) + (CI*f(5) * den(96)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,163),T4sum(1:70,49))
  M(1) = M(1) + (-(CI*f(4)) * den(96)) * TI2_call(4,momenta_5,masses2_5,G4tensor(:,169),T4sum(1:70,50))
  M(2) = M(2) + (CI*f(4) * den(96)) * TI2_call(4,momenta_5,masses2_5,G4tensor(:,169),T4sum(1:70,50))
  M(1) = M(1) + (-(CI*f(5)) * den(96)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,175),T4sum(1:70,49))
  M(2) = M(2) + (CI*f(5) * den(96)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,175),T4sum(1:70,49))
  M(1) = M(1) + (-(CI*f(4)) * den(96)) * TI2_call(4,momenta_5,masses2_5,G4tensor(:,181),T4sum(1:70,50))
  M(2) = M(2) + (CI*f(4) * den(96)) * TI2_call(4,momenta_5,masses2_5,G4tensor(:,181),T4sum(1:70,50))
  M(1) = M(1) + (-(CI*f(5)) * den(96)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,187),T4sum(1:70,49))
  M(2) = M(2) + (CI*f(5) * den(96)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,187),T4sum(1:70,49))
  M(1) = M(1) + (-(CI*f(4)) * den(96)) * TI2_call(4,momenta_5,masses2_4,G4tensor(:,193),T4sum(1:70,51))
  M(2) = M(2) + (CI*f(4) * den(96)) * TI2_call(4,momenta_5,masses2_4,G4tensor(:,193),T4sum(1:70,51))
  M(1) = M(1) + (-(CI*f(5)) * den(96)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,199),T4sum(1:70,49))
  M(2) = M(2) + (CI*f(5) * den(96)) * TI2_call(4,momenta_5,masses2_6,G4tensor(:,199),T4sum(1:70,49))
  M(1) = M(1) + (-(CI*f(4)) * den(96)) * TI2_call(4,momenta_5,masses2_4,G4tensor(:,205),T4sum(1:70,51))
  M(2) = M(2) + (CI*f(4) * den(96)) * TI2_call(4,momenta_5,masses2_4,G4tensor(:,205),T4sum(1:70,51))
  M(1) = M(1) + (-(CI*f(5)) * den(96)) * TI2_call(4,momenta_8,masses2_6,G4tensor(:,176),T4sum(1:70,52))
  M(2) = M(2) + (CI*f(5) * den(96)) * TI2_call(4,momenta_8,masses2_6,G4tensor(:,176),T4sum(1:70,52))
  M(1) = M(1) + (-(CI*f(4)) * den(96)) * TI2_call(4,momenta_8,masses2_5,G4tensor(:,182),T4sum(1:70,53))
  M(2) = M(2) + (CI*f(4) * den(96)) * TI2_call(4,momenta_8,masses2_5,G4tensor(:,182),T4sum(1:70,53))
  M(1) = M(1) + (-(CI*f(5)) * den(96)) * TI2_call(4,momenta_8,masses2_6,G4tensor(:,164),T4sum(1:70,52))
  M(2) = M(2) + (CI*f(5) * den(96)) * TI2_call(4,momenta_8,masses2_6,G4tensor(:,164),T4sum(1:70,52))
  M(1) = M(1) + (-(CI*f(4)) * den(96)) * TI2_call(4,momenta_8,masses2_5,G4tensor(:,170),T4sum(1:70,53))
  M(2) = M(2) + (CI*f(4) * den(96)) * TI2_call(4,momenta_8,masses2_5,G4tensor(:,170),T4sum(1:70,53))
  M(1) = M(1) + (-(CI*f(5)) * den(96)) * TI2_call(4,momenta_8,masses2_6,G4tensor(:,200),T4sum(1:70,52))
  M(2) = M(2) + (CI*f(5) * den(96)) * TI2_call(4,momenta_8,masses2_6,G4tensor(:,200),T4sum(1:70,52))
  M(1) = M(1) + (-(CI*f(4)) * den(96)) * TI2_call(4,momenta_8,masses2_4,G4tensor(:,206),T4sum(1:70,54))
  M(2) = M(2) + (CI*f(4) * den(96)) * TI2_call(4,momenta_8,masses2_4,G4tensor(:,206),T4sum(1:70,54))
  M(1) = M(1) + (-(CI*f(5)) * den(96)) * TI2_call(4,momenta_8,masses2_6,G4tensor(:,188),T4sum(1:70,52))
  M(2) = M(2) + (CI*f(5) * den(96)) * TI2_call(4,momenta_8,masses2_6,G4tensor(:,188),T4sum(1:70,52))
  M(1) = M(1) + (-(CI*f(4)) * den(96)) * TI2_call(4,momenta_8,masses2_4,G4tensor(:,194),T4sum(1:70,54))
  M(2) = M(2) + (CI*f(4) * den(96)) * TI2_call(4,momenta_8,masses2_4,G4tensor(:,194),T4sum(1:70,54))
  M(1) = M(1) + (-(CI*f(12)) * den(54)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,4),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(12) * den(54)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,4),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(12)) * den(54)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,14),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(12) * den(54)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,14),T3sum(1:35,5))
  ...
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_16,masses2_6,G4tensor(:,159),T4sum(1:70,55))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_16,masses2_6,G4tensor(:,159),T4sum(1:70,55))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_16,masses2_5,G4tensor(:,22),T4sum(1:70,56))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_16,masses2_5,G4tensor(:,22),T4sum(1:70,56))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_16,masses2_6,G4tensor(:,123),T4sum(1:70,55))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_16,masses2_6,G4tensor(:,123),T4sum(1:70,55))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_16,masses2_5,G4tensor(:,44),T4sum(1:70,56))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_16,masses2_5,G4tensor(:,44),T4sum(1:70,56))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_16,masses2_6,G4tensor(:,160),T4sum(1:70,55))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_16,masses2_6,G4tensor(:,160),T4sum(1:70,55))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_16,masses2_4,G4tensor(:,66),T4sum(1:70,57))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_16,masses2_4,G4tensor(:,66),T4sum(1:70,57))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_16,masses2_6,G4tensor(:,124),T4sum(1:70,55))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_16,masses2_6,G4tensor(:,124),T4sum(1:70,55))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_16,masses2_4,G4tensor(:,88),T4sum(1:70,57))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_16,masses2_4,G4tensor(:,88),T4sum(1:70,57))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,165),T4sum(1:70,58))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,165),T4sum(1:70,58))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_4,masses2_5,G4tensor(:,171),T4sum(1:70,59))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_4,masses2_5,G4tensor(:,171),T4sum(1:70,59))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,177),T4sum(1:70,58))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,177),T4sum(1:70,58))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_4,masses2_5,G4tensor(:,183),T4sum(1:70,59))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_4,masses2_5,G4tensor(:,183),T4sum(1:70,59))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,189),T4sum(1:70,58))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,189),T4sum(1:70,58))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_4,masses2_4,G4tensor(:,195),T4sum(1:70,60))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_4,masses2_4,G4tensor(:,195),T4sum(1:70,60))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,201),T4sum(1:70,58))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_4,masses2_6,G4tensor(:,201),T4sum(1:70,58))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_4,masses2_4,G4tensor(:,207),T4sum(1:70,60))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_4,masses2_4,G4tensor(:,207),T4sum(1:70,60))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_9,masses2_6,G4tensor(:,178),T4sum(1:70,61))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_9,masses2_6,G4tensor(:,178),T4sum(1:70,61))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_9,masses2_5,G4tensor(:,184),T4sum(1:70,62))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_9,masses2_5,G4tensor(:,184),T4sum(1:70,62))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_9,masses2_6,G4tensor(:,166),T4sum(1:70,61))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_9,masses2_6,G4tensor(:,166),T4sum(1:70,61))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_9,masses2_5,G4tensor(:,172),T4sum(1:70,62))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_9,masses2_5,G4tensor(:,172),T4sum(1:70,62))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_9,masses2_6,G4tensor(:,202),T4sum(1:70,61))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_9,masses2_6,G4tensor(:,202),T4sum(1:70,61))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_9,masses2_4,G4tensor(:,208),T4sum(1:70,63))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_9,masses2_4,G4tensor(:,208),T4sum(1:70,63))
  M(1) = M(1) + (CI*f(5) * den(97)) * TI2_call(4,momenta_9,masses2_6,G4tensor(:,190),T4sum(1:70,61))
  M(2) = M(2) + (-(CI*f(5)) * den(97)) * TI2_call(4,momenta_9,masses2_6,G4tensor(:,190),T4sum(1:70,61))
  M(1) = M(1) + (CI*f(4) * den(97)) * TI2_call(4,momenta_9,masses2_4,G4tensor(:,196),T4sum(1:70,63))
  M(2) = M(2) + (-(CI*f(4)) * den(97)) * TI2_call(4,momenta_9,masses2_4,G4tensor(:,196),T4sum(1:70,63))
  M(1) = M(1) + (f(13) * den(51)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,5),T4sum(1:70,30))
  M(2) = M(2) + (f(13) * den(51)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,27),T4sum(1:70,30))
  ...
  M(2) = M(2) + (f(13) * den(51)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,15),T4sum(1:70,32))
  M(1) = M(1) + (f(13) * den(51)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,37),T4sum(1:70,32))
  ...
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_27,masses2_9,G5tensor(:,67),T5sum(1:126,37))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_27,masses2_8,G5tensor(:,73),T5sum(1:126,38))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_27,masses2_9,G5tensor(:,79),T5sum(1:126,37))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_27,masses2_8,G5tensor(:,85),T5sum(1:126,38))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_27,masses2_9,G5tensor(:,91),T5sum(1:126,37))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_27,masses2_7,G5tensor(:,97),T5sum(1:126,39))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_27,masses2_9,G5tensor(:,103),T5sum(1:126,37))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_27,masses2_7,G5tensor(:,109),T5sum(1:126,39))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_29,masses2_9,G5tensor(:,77),T5sum(1:126,40))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_29,masses2_8,G5tensor(:,83),T5sum(1:126,41))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_29,masses2_9,G5tensor(:,65),T5sum(1:126,40))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_29,masses2_8,G5tensor(:,71),T5sum(1:126,41))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_29,masses2_9,G5tensor(:,101),T5sum(1:126,40))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_29,masses2_7,G5tensor(:,107),T5sum(1:126,42))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_29,masses2_9,G5tensor(:,89),T5sum(1:126,40))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_29,masses2_7,G5tensor(:,95),T5sum(1:126,42))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_25,masses2_9,G5tensor(:,81),T5sum(1:126,43))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_25,masses2_8,G5tensor(:,87),T5sum(1:126,44))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_25,masses2_9,G5tensor(:,69),T5sum(1:126,43))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_25,masses2_8,G5tensor(:,75),T5sum(1:126,44))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_25,masses2_9,G5tensor(:,105),T5sum(1:126,43))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_25,masses2_7,G5tensor(:,111),T5sum(1:126,45))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_25,masses2_9,G5tensor(:,93),T5sum(1:126,43))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_25,masses2_7,G5tensor(:,99),T5sum(1:126,45))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_30,masses2_9,G5tensor(:,66),T5sum(1:126,49))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_30,masses2_8,G5tensor(:,72),T5sum(1:126,50))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_30,masses2_9,G5tensor(:,78),T5sum(1:126,49))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_30,masses2_8,G5tensor(:,84),T5sum(1:126,50))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_30,masses2_9,G5tensor(:,90),T5sum(1:126,49))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_30,masses2_7,G5tensor(:,96),T5sum(1:126,51))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_30,masses2_9,G5tensor(:,102),T5sum(1:126,49))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_30,masses2_7,G5tensor(:,108),T5sum(1:126,51))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_41,masses2_9,G5tensor(:,55),T5sum(1:126,52))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_41,masses2_8,G5tensor(:,4),T5sum(1:126,53))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_41,masses2_9,G5tensor(:,39),T5sum(1:126,52))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_41,masses2_8,G5tensor(:,12),T5sum(1:126,53))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_41,masses2_9,G5tensor(:,56),T5sum(1:126,52))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_41,masses2_7,G5tensor(:,20),T5sum(1:126,54))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_41,masses2_9,G5tensor(:,40),T5sum(1:126,52))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_41,masses2_7,G5tensor(:,28),T5sum(1:126,54))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_26,masses2_9,G5tensor(:,82),T5sum(1:126,55))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_26,masses2_8,G5tensor(:,88),T5sum(1:126,56))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_26,masses2_9,G5tensor(:,70),T5sum(1:126,55))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_26,masses2_8,G5tensor(:,76),T5sum(1:126,56))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_26,masses2_9,G5tensor(:,106),T5sum(1:126,55))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_26,masses2_7,G5tensor(:,112),T5sum(1:126,57))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_26,masses2_9,G5tensor(:,94),T5sum(1:126,55))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_26,masses2_7,G5tensor(:,100),T5sum(1:126,57))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_28,masses2_9,G5tensor(:,68),T5sum(1:126,61))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_28,masses2_8,G5tensor(:,74),T5sum(1:126,62))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_28,masses2_9,G5tensor(:,80),T5sum(1:126,61))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_28,masses2_8,G5tensor(:,86),T5sum(1:126,62))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_28,masses2_9,G5tensor(:,92),T5sum(1:126,61))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_28,masses2_7,G5tensor(:,98),T5sum(1:126,63))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_28,masses2_9,G5tensor(:,104),T5sum(1:126,61))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_28,masses2_7,G5tensor(:,110),T5sum(1:126,63))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_43,masses2_9,G5tensor(:,59),T5sum(1:126,64))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_43,masses2_8,G5tensor(:,6),T5sum(1:126,65))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_43,masses2_9,G5tensor(:,43),T5sum(1:126,64))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_43,masses2_8,G5tensor(:,14),T5sum(1:126,65))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_43,masses2_9,G5tensor(:,60),T5sum(1:126,64))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_43,masses2_7,G5tensor(:,22),T5sum(1:126,66))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_43,masses2_9,G5tensor(:,44),T5sum(1:126,64))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_43,masses2_7,G5tensor(:,30),T5sum(1:126,66))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_37,masses2_9,G5tensor(:,61),T5sum(1:126,67))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_37,masses2_8,G5tensor(:,7),T5sum(1:126,68))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_37,masses2_9,G5tensor(:,45),T5sum(1:126,67))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_37,masses2_8,G5tensor(:,15),T5sum(1:126,68))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_37,masses2_9,G5tensor(:,63),T5sum(1:126,67))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_37,masses2_7,G5tensor(:,23),T5sum(1:126,69))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_37,masses2_9,G5tensor(:,47),T5sum(1:126,67))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_37,masses2_7,G5tensor(:,31),T5sum(1:126,69))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_38,masses2_9,G5tensor(:,62),T5sum(1:126,70))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_38,masses2_8,G5tensor(:,8),T5sum(1:126,71))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_38,masses2_9,G5tensor(:,46),T5sum(1:126,70))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_38,masses2_8,G5tensor(:,16),T5sum(1:126,71))
  M(2) = M(2) + (-f(7) * den(19)) * TI2_call(5,momenta_38,masses2_9,G5tensor(:,64),T5sum(1:126,70))
  M(2) = M(2) + (-f(6) * den(19)) * TI2_call(5,momenta_38,masses2_7,G5tensor(:,24),T5sum(1:126,72))
  M(1) = M(1) + (-f(7) * den(19)) * TI2_call(5,momenta_38,masses2_9,G5tensor(:,48),T5sum(1:126,70))
  M(1) = M(1) + (-f(6) * den(19)) * TI2_call(5,momenta_38,masses2_7,G5tensor(:,32),T5sum(1:126,72))
  M(1) = M(1) + (CI*f(5) * den(102)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,45),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(102)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,45),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(102)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,15),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(4)) * den(102)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,15),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(5) * den(102)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,61),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(102)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,61),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(102)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,5),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(4)) * den(102)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,5),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(5) * den(102)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,46),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(102)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,46),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(102)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,35),T3sum(1:35,6))
  M(2) = M(2) + (-(CI*f(4)) * den(102)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,35),T3sum(1:35,6))
  M(1) = M(1) + (CI*f(5) * den(102)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,62),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(102)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,62),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(102)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,25),T3sum(1:35,6))
  M(2) = M(2) + (-(CI*f(4)) * den(102)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,25),T3sum(1:35,6))
  M(1) = M(1) + (CI*f(5) * den(103)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,47),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(103)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,47),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(103)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,16),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(4)) * den(103)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,16),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(5) * den(103)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,63),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(103)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,63),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(103)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,6),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(4)) * den(103)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,6),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(5) * den(103)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,48),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(103)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,48),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(103)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,36),T3sum(1:35,6))
  M(2) = M(2) + (-(CI*f(4)) * den(103)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,36),T3sum(1:35,6))
  M(1) = M(1) + (CI*f(5) * den(103)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,64),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(103)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,64),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(103)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,26),T3sum(1:35,6))
  M(2) = M(2) + (-(CI*f(4)) * den(103)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,26),T3sum(1:35,6))
  M(1) = M(1) + (-f(7) * den(80)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,131),T4sum(1:70,35))
  M(1) = M(1) + (-f(6) * den(80)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,6),T4sum(1:70,30))
  M(2) = M(2) + (-f(7) * den(80)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,95),T4sum(1:70,35))
  M(2) = M(2) + (-f(6) * den(80)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,28),T4sum(1:70,30))
  M(1) = M(1) + (-f(7) * den(80)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,132),T4sum(1:70,35))
  M(1) = M(1) + (-f(6) * den(80)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,50),T4sum(1:70,31))
  M(2) = M(2) + (-f(7) * den(80)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,96),T4sum(1:70,35))
  M(2) = M(2) + (-f(6) * den(80)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,72),T4sum(1:70,31))
  M(2) = M(2) + (-f(7) * den(80)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,147),T4sum(1:70,36))
  M(2) = M(2) + (-f(6) * den(80)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,16),T4sum(1:70,32))
  M(1) = M(1) + (-f(7) * den(80)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,111),T4sum(1:70,36))
  M(1) = M(1) + (-f(6) * den(80)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,38),T4sum(1:70,32))
  M(2) = M(2) + (-f(7) * den(80)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,148),T4sum(1:70,36))
  M(2) = M(2) + (-f(6) * den(80)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,60),T4sum(1:70,33))
  M(1) = M(1) + (-f(7) * den(80)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,112),T4sum(1:70,36))
  M(1) = M(1) + (-f(6) * den(80)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,82),T4sum(1:70,33))
  M(1) = M(1) + (-f(7) * den(81)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,133),T4sum(1:70,35))
  M(1) = M(1) + (-f(6) * den(81)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,7),T4sum(1:70,30))
  M(2) = M(2) + (-f(7) * den(81)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,97),T4sum(1:70,35))
  M(2) = M(2) + (-f(6) * den(81)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,29),T4sum(1:70,30))
  M(1) = M(1) + (-f(7) * den(81)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,134),T4sum(1:70,35))
  M(1) = M(1) + (-f(6) * den(81)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,51),T4sum(1:70,31))
  M(2) = M(2) + (-f(7) * den(81)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,98),T4sum(1:70,35))
  M(2) = M(2) + (-f(6) * den(81)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,73),T4sum(1:70,31))
  M(2) = M(2) + (-f(7) * den(81)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,149),T4sum(1:70,36))
  M(2) = M(2) + (-f(6) * den(81)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,17),T4sum(1:70,32))
  M(1) = M(1) + (-f(7) * den(81)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,113),T4sum(1:70,36))
  M(1) = M(1) + (-f(6) * den(81)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,39),T4sum(1:70,32))
  M(2) = M(2) + (-f(7) * den(81)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,150),T4sum(1:70,36))
  M(2) = M(2) + (-f(6) * den(81)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,61),T4sum(1:70,33))
  M(1) = M(1) + (-f(7) * den(81)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,114),T4sum(1:70,36))
  M(1) = M(1) + (-f(6) * den(81)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,83),T4sum(1:70,33))
  M(1) = M(1) + (CI*f(5) * den(108)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,49),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(108)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,49),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(108)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,17),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(4)) * den(108)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,17),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(5) * den(108)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,65),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(108)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,65),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(108)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,7),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(4)) * den(108)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,7),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(5) * den(108)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,50),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(108)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,50),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(108)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,37),T3sum(1:35,6))
  M(2) = M(2) + (-(CI*f(4)) * den(108)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,37),T3sum(1:35,6))
  M(1) = M(1) + (CI*f(5) * den(108)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,66),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(108)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,66),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(108)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,27),T3sum(1:35,6))
  M(2) = M(2) + (-(CI*f(4)) * den(108)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,27),T3sum(1:35,6))
  M(1) = M(1) + (CI*f(5) * den(109)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,51),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(109)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,51),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(109)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,18),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(4)) * den(109)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,18),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(5) * den(109)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,67),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(109)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,67),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(109)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,8),T3sum(1:35,5))
  M(2) = M(2) + (-(CI*f(4)) * den(109)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,8),T3sum(1:35,5))
  M(1) = M(1) + (CI*f(5) * den(109)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,52),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(109)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,52),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(109)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,38),T3sum(1:35,6))
  M(2) = M(2) + (-(CI*f(4)) * den(109)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,38),T3sum(1:35,6))
  M(1) = M(1) + (CI*f(5) * den(109)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,68),T3sum(1:35,9))
  M(2) = M(2) + (-(CI*f(5)) * den(109)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,68),T3sum(1:35,9))
  M(1) = M(1) + (CI*f(4) * den(109)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,28),T3sum(1:35,6))
  M(2) = M(2) + (-(CI*f(4)) * den(109)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,28),T3sum(1:35,6))
  M(1) = M(1) + (-f(7) * den(82)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,135),T4sum(1:70,35))
  M(1) = M(1) + (-f(6) * den(82)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,8),T4sum(1:70,30))
  M(2) = M(2) + (-f(7) * den(82)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,99),T4sum(1:70,35))
  M(2) = M(2) + (-f(6) * den(82)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,30),T4sum(1:70,30))
  M(1) = M(1) + (-f(7) * den(82)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,136),T4sum(1:70,35))
  M(1) = M(1) + (-f(6) * den(82)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,52),T4sum(1:70,31))
  M(2) = M(2) + (-f(7) * den(82)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,100),T4sum(1:70,35))
  M(2) = M(2) + (-f(6) * den(82)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,74),T4sum(1:70,31))
  M(2) = M(2) + (-f(7) * den(82)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,151),T4sum(1:70,36))
  M(2) = M(2) + (-f(6) * den(82)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,18),T4sum(1:70,32))
  M(1) = M(1) + (-f(7) * den(82)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,115),T4sum(1:70,36))
  M(1) = M(1) + (-f(6) * den(82)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,40),T4sum(1:70,32))
  M(2) = M(2) + (-f(7) * den(82)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,152),T4sum(1:70,36))
  M(2) = M(2) + (-f(6) * den(82)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,62),T4sum(1:70,33))
  M(1) = M(1) + (-f(7) * den(82)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,116),T4sum(1:70,36))
  M(1) = M(1) + (-f(6) * den(82)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,84),T4sum(1:70,33))
  M(1) = M(1) + (-f(7) * den(83)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,137),T4sum(1:70,35))
  M(1) = M(1) + (-f(6) * den(83)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,9),T4sum(1:70,30))
  M(2) = M(2) + (-f(7) * den(83)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,101),T4sum(1:70,35))
  M(2) = M(2) + (-f(6) * den(83)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,31),T4sum(1:70,30))
  M(1) = M(1) + (-f(7) * den(83)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,138),T4sum(1:70,35))
  M(1) = M(1) + (-f(6) * den(83)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,53),T4sum(1:70,31))
  M(2) = M(2) + (-f(7) * den(83)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,102),T4sum(1:70,35))
  M(2) = M(2) + (-f(6) * den(83)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,75),T4sum(1:70,31))
  M(2) = M(2) + (-f(7) * den(83)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,153),T4sum(1:70,36))
  M(2) = M(2) + (-f(6) * den(83)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,19),T4sum(1:70,32))
  M(1) = M(1) + (-f(7) * den(83)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,117),T4sum(1:70,36))
  M(1) = M(1) + (-f(6) * den(83)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,41),T4sum(1:70,32))
  M(2) = M(2) + (-f(7) * den(83)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,154),T4sum(1:70,36))
  M(2) = M(2) + (-f(6) * den(83)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,63),T4sum(1:70,33))
  M(1) = M(1) + (-f(7) * den(83)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,118),T4sum(1:70,36))
  M(1) = M(1) + (-f(6) * den(83)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,85),T4sum(1:70,33))
  M(1) = M(1) + (-(CI*f(5)) * den(114)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,53),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(114)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,53),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(114)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,19),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(4) * den(114)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,19),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(5)) * den(114)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,69),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(114)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,69),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(114)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,9),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(4) * den(114)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,9),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(5)) * den(114)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,54),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(114)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,54),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(114)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,39),T3sum(1:35,6))
  M(2) = M(2) + (CI*f(4) * den(114)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,39),T3sum(1:35,6))
  M(1) = M(1) + (-(CI*f(5)) * den(114)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,70),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(114)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,70),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(114)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,29),T3sum(1:35,6))
  M(2) = M(2) + (CI*f(4) * den(114)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,29),T3sum(1:35,6))
  M(1) = M(1) + (-(CI*f(5)) * den(115)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,55),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(115)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,55),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(115)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,20),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(4) * den(115)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,20),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(5)) * den(115)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,71),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(115)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,71),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(115)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,10),T3sum(1:35,5))
  M(2) = M(2) + (CI*f(4) * den(115)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,10),T3sum(1:35,5))
  M(1) = M(1) + (-(CI*f(5)) * den(115)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,56),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(115)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,56),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(115)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,40),T3sum(1:35,6))
  M(2) = M(2) + (CI*f(4) * den(115)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,40),T3sum(1:35,6))
  M(1) = M(1) + (-(CI*f(5)) * den(115)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,72),T3sum(1:35,9))
  M(2) = M(2) + (CI*f(5) * den(115)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,72),T3sum(1:35,9))
  M(1) = M(1) + (-(CI*f(4)) * den(115)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,30),T3sum(1:35,6))
  M(2) = M(2) + (CI*f(4) * den(115)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,30),T3sum(1:35,6))
  M(1) = M(1) + (f(7) * den(84)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,139),T4sum(1:70,35))
  M(1) = M(1) + (f(6) * den(84)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,10),T4sum(1:70,30))
  M(2) = M(2) + (f(7) * den(84)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,103),T4sum(1:70,35))
  M(2) = M(2) + (f(6) * den(84)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,32),T4sum(1:70,30))
  M(1) = M(1) + (f(7) * den(84)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,140),T4sum(1:70,35))
  M(1) = M(1) + (f(6) * den(84)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,54),T4sum(1:70,31))
  M(2) = M(2) + (f(7) * den(84)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,104),T4sum(1:70,35))
  M(2) = M(2) + (f(6) * den(84)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,76),T4sum(1:70,31))
  M(2) = M(2) + (f(7) * den(84)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,155),T4sum(1:70,36))
  M(2) = M(2) + (f(6) * den(84)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,20),T4sum(1:70,32))
  M(1) = M(1) + (f(7) * den(84)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,119),T4sum(1:70,36))
  M(1) = M(1) + (f(6) * den(84)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,42),T4sum(1:70,32))
  M(2) = M(2) + (f(7) * den(84)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,156),T4sum(1:70,36))
  M(2) = M(2) + (f(6) * den(84)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,64),T4sum(1:70,33))
  M(1) = M(1) + (f(7) * den(84)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,120),T4sum(1:70,36))
  M(1) = M(1) + (f(6) * den(84)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,86),T4sum(1:70,33))
  M(1) = M(1) + (f(7) * den(85)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,141),T4sum(1:70,35))
  M(1) = M(1) + (f(6) * den(85)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,11),T4sum(1:70,30))
  M(2) = M(2) + (f(7) * den(85)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,105),T4sum(1:70,35))
  M(2) = M(2) + (f(6) * den(85)) * TI2_call(4,momenta_18,masses2_5,G4tensor(:,33),T4sum(1:70,30))
  M(1) = M(1) + (f(7) * den(85)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,142),T4sum(1:70,35))
  M(1) = M(1) + (f(6) * den(85)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,55),T4sum(1:70,31))
  M(2) = M(2) + (f(7) * den(85)) * TI2_call(4,momenta_18,masses2_6,G4tensor(:,106),T4sum(1:70,35))
  M(2) = M(2) + (f(6) * den(85)) * TI2_call(4,momenta_18,masses2_4,G4tensor(:,77),T4sum(1:70,31))
  M(2) = M(2) + (f(7) * den(85)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,157),T4sum(1:70,36))
  M(2) = M(2) + (f(6) * den(85)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,21),T4sum(1:70,32))
  M(1) = M(1) + (f(7) * den(85)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,121),T4sum(1:70,36))
  M(1) = M(1) + (f(6) * den(85)) * TI2_call(4,momenta_19,masses2_5,G4tensor(:,43),T4sum(1:70,32))
  M(2) = M(2) + (f(7) * den(85)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,158),T4sum(1:70,36))
  M(2) = M(2) + (f(6) * den(85)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,65),T4sum(1:70,33))
  M(1) = M(1) + (f(7) * den(85)) * TI2_call(4,momenta_19,masses2_6,G4tensor(:,122),T4sum(1:70,36))
  M(1) = M(1) + (f(6) * den(85)) * TI2_call(4,momenta_19,masses2_4,G4tensor(:,87),T4sum(1:70,33))
