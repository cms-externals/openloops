...
! **********************************************************************
  ...
  call tensor_integral(4, momenta_7, masses2_6, T4sum(:,3))
  ...
  call tensor_integral(4, momenta_2, masses2_5, T4sum(:,16))
  call tensor_integral(4, momenta_2, masses2_4, T4sum(:,17))
  call tensor_integral(4, momenta_2, masses2_6, T4sum(:,18))
