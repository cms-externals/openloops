...
subroutine diagrams(A)
  ...
  A(4) = cont_VV(wf(:,10),wf(:,12)) * den(13)
  A(5) = cont_VV(wf(:,10),wf(:,15)) * den(16)
  A(6) = cont_VV(wf(:,17),wf(:,19)) * den(21)
  A(7) = cont_VV(wf(:,17),wf(:,22)) * den(24)
  A(8) = cont_VV(wf(:,26),wf(:,27)) * den(29)
  A(9) = cont_VV(wf(:,26),wf(:,30)) * den(32)
  A(10) = cont_VV(wf(:,26),wf(:,33)) * den(35)
  A(11) = cont_VV(wf(:,26),wf(:,36)) * den(38)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(4)-A(5)-A(6)-A(7)-A(8)-A(9)-A(10)-A(11))*f(1)+A(1)*f(2)-A(3)*f(5)-A(2)*f(7)
