...
! **********************************************************************
module ol_tensor_sum_storage_ppllllj2_eeexexggg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllllj2_eeexexggg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllllj2_eeexexggg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 5
...
! **********************************************************************
  use ol_external_ppllllj2_eeexexggg_1, only: channel_number_ppllllj2_eeexexggg_1
  ...
  call channel_on(channel_number_ppllllj2_eeexexggg_1)
  M2 = 0
  ...
  call tensor_integral(4, momenta_24, masses2_5, T4sum(:,1))
  call tensor_integral(4, momenta_24, masses2_4, T4sum(:,2))
  call tensor_integral(4, momenta_24, masses2_6, T4sum(:,3))
  call tensor_integral(4, momenta_12, masses2_5, T4sum(:,4))
  call tensor_integral(4, momenta_12, masses2_4, T4sum(:,5))
  call tensor_integral(4, momenta_12, masses2_6, T4sum(:,6))
  call tensor_integral(4, momenta_13, masses2_5, T4sum(:,7))
  call tensor_integral(4, momenta_13, masses2_4, T4sum(:,8))
  call tensor_integral(4, momenta_13, masses2_6, T4sum(:,9))
  call tensor_integral(4, momenta_21, masses2_5, T4sum(:,10))
  call tensor_integral(4, momenta_21, masses2_4, T4sum(:,11))
  call tensor_integral(4, momenta_21, masses2_6, T4sum(:,12))
  call tensor_integral(4, momenta_14, masses2_5, T4sum(:,13))
  call tensor_integral(4, momenta_14, masses2_4, T4sum(:,14))
  call tensor_integral(4, momenta_14, masses2_6, T4sum(:,15))
  call tensor_integral(4, momenta_11, masses2_5, T4sum(:,16))
  call tensor_integral(4, momenta_11, masses2_4, T4sum(:,17))
  call tensor_integral(4, momenta_11, masses2_6, T4sum(:,18))
  call tensor_integral(4, momenta_17, masses2_5, T4sum(:,19))
  call tensor_integral(4, momenta_17, masses2_4, T4sum(:,20))
  call tensor_integral(4, momenta_17, masses2_6, T4sum(:,21))
  call tensor_integral(4, momenta_15, masses2_5, T4sum(:,22))
  call tensor_integral(4, momenta_15, masses2_4, T4sum(:,23))
  call tensor_integral(4, momenta_15, masses2_6, T4sum(:,24))
  call tensor_integral(4, momenta_10, masses2_5, T4sum(:,25))
  call tensor_integral(4, momenta_10, masses2_4, T4sum(:,26))
  call tensor_integral(4, momenta_10, masses2_6, T4sum(:,27))
  call tensor_integral(4, momenta_22, masses2_5, T4sum(:,28))
  call tensor_integral(4, momenta_22, masses2_4, T4sum(:,29))
  call tensor_integral(4, momenta_22, masses2_6, T4sum(:,30))
  call tensor_integral(4, momenta_18, masses2_5, T4sum(:,31))
  call tensor_integral(4, momenta_18, masses2_4, T4sum(:,32))
  call tensor_integral(4, momenta_18, masses2_6, T4sum(:,33))
  call tensor_integral(4, momenta_19, masses2_5, T4sum(:,34))
  call tensor_integral(4, momenta_19, masses2_4, T4sum(:,35))
  call tensor_integral(4, momenta_19, masses2_6, T4sum(:,36))
  call tensor_integral(4, momenta_23, masses2_5, T4sum(:,37))
  call tensor_integral(4, momenta_23, masses2_4, T4sum(:,38))
  call tensor_integral(4, momenta_23, masses2_6, T4sum(:,39))
  call tensor_integral(4, momenta_7, masses2_5, T4sum(:,40))
  call tensor_integral(4, momenta_7, masses2_4, T4sum(:,41))
  call tensor_integral(4, momenta_7, masses2_6, T4sum(:,42))
  call tensor_integral(4, momenta_6, masses2_5, T4sum(:,43))
  call tensor_integral(4, momenta_6, masses2_4, T4sum(:,44))
  call tensor_integral(4, momenta_6, masses2_6, T4sum(:,45))
  call tensor_integral(4, momenta_20, masses2_5, T4sum(:,46))
  call tensor_integral(4, momenta_20, masses2_4, T4sum(:,47))
  call tensor_integral(4, momenta_20, masses2_6, T4sum(:,48))
  call tensor_integral(4, momenta_5, masses2_5, T4sum(:,49))
  call tensor_integral(4, momenta_5, masses2_4, T4sum(:,50))
  call tensor_integral(4, momenta_5, masses2_6, T4sum(:,51))
  call tensor_integral(4, momenta_8, masses2_5, T4sum(:,52))
  call tensor_integral(4, momenta_8, masses2_4, T4sum(:,53))
  call tensor_integral(4, momenta_8, masses2_6, T4sum(:,54))
  call tensor_integral(4, momenta_16, masses2_5, T4sum(:,55))
  call tensor_integral(4, momenta_16, masses2_4, T4sum(:,56))
  call tensor_integral(4, momenta_16, masses2_6, T4sum(:,57))
  call tensor_integral(4, momenta_4, masses2_5, T4sum(:,58))
  call tensor_integral(4, momenta_4, masses2_4, T4sum(:,59))
  call tensor_integral(4, momenta_4, masses2_6, T4sum(:,60))
  call tensor_integral(4, momenta_9, masses2_5, T4sum(:,61))
  call tensor_integral(4, momenta_9, masses2_4, T4sum(:,62))
  call tensor_integral(4, momenta_9, masses2_6, T4sum(:,63))

  call tensor_integral(5, momenta_35, masses2_8, T5sum(:,1))
  call tensor_integral(5, momenta_35, masses2_7, T5sum(:,2))
  call tensor_integral(5, momenta_35, masses2_9, T5sum(:,3))
  call tensor_integral(5, momenta_33, masses2_8, T5sum(:,4))
  call tensor_integral(5, momenta_33, masses2_7, T5sum(:,5))
  call tensor_integral(5, momenta_33, masses2_9, T5sum(:,6))
  call tensor_integral(5, momenta_36, masses2_8, T5sum(:,7))
  call tensor_integral(5, momenta_36, masses2_7, T5sum(:,8))
  call tensor_integral(5, momenta_36, masses2_9, T5sum(:,9))
  call tensor_integral(5, momenta_42, masses2_8, T5sum(:,10))
  call tensor_integral(5, momenta_42, masses2_7, T5sum(:,11))
  call tensor_integral(5, momenta_42, masses2_9, T5sum(:,12))
  call tensor_integral(5, momenta_31, masses2_8, T5sum(:,13))
  call tensor_integral(5, momenta_31, masses2_7, T5sum(:,14))
  call tensor_integral(5, momenta_31, masses2_9, T5sum(:,15))
  call tensor_integral(5, momenta_48, masses2_8, T5sum(:,16))
  call tensor_integral(5, momenta_48, masses2_7, T5sum(:,17))
  call tensor_integral(5, momenta_48, masses2_9, T5sum(:,18))
  call tensor_integral(5, momenta_34, masses2_8, T5sum(:,19))
  call tensor_integral(5, momenta_34, masses2_7, T5sum(:,20))
  call tensor_integral(5, momenta_34, masses2_9, T5sum(:,21))
  call tensor_integral(5, momenta_44, masses2_8, T5sum(:,22))
  call tensor_integral(5, momenta_44, masses2_7, T5sum(:,23))
  call tensor_integral(5, momenta_44, masses2_9, T5sum(:,24))
  call tensor_integral(5, momenta_32, masses2_8, T5sum(:,25))
  call tensor_integral(5, momenta_32, masses2_7, T5sum(:,26))
  call tensor_integral(5, momenta_32, masses2_9, T5sum(:,27))
  call tensor_integral(5, momenta_46, masses2_8, T5sum(:,28))
  call tensor_integral(5, momenta_46, masses2_7, T5sum(:,29))
  call tensor_integral(5, momenta_46, masses2_9, T5sum(:,30))
  call tensor_integral(5, momenta_40, masses2_8, T5sum(:,31))
  call tensor_integral(5, momenta_40, masses2_7, T5sum(:,32))
  call tensor_integral(5, momenta_40, masses2_9, T5sum(:,33))
  call tensor_integral(5, momenta_39, masses2_8, T5sum(:,34))
  call tensor_integral(5, momenta_39, masses2_7, T5sum(:,35))
  call tensor_integral(5, momenta_39, masses2_9, T5sum(:,36))
  call tensor_integral(5, momenta_27, masses2_8, T5sum(:,37))
  call tensor_integral(5, momenta_27, masses2_7, T5sum(:,38))
  call tensor_integral(5, momenta_27, masses2_9, T5sum(:,39))
  call tensor_integral(5, momenta_29, masses2_8, T5sum(:,40))
  call tensor_integral(5, momenta_29, masses2_7, T5sum(:,41))
  call tensor_integral(5, momenta_29, masses2_9, T5sum(:,42))
  call tensor_integral(5, momenta_25, masses2_8, T5sum(:,43))
  call tensor_integral(5, momenta_25, masses2_7, T5sum(:,44))
  call tensor_integral(5, momenta_25, masses2_9, T5sum(:,45))
  call tensor_integral(5, momenta_47, masses2_8, T5sum(:,46))
  call tensor_integral(5, momenta_47, masses2_7, T5sum(:,47))
  call tensor_integral(5, momenta_47, masses2_9, T5sum(:,48))
  call tensor_integral(5, momenta_30, masses2_8, T5sum(:,49))
  call tensor_integral(5, momenta_30, masses2_7, T5sum(:,50))
  call tensor_integral(5, momenta_30, masses2_9, T5sum(:,51))
  call tensor_integral(5, momenta_41, masses2_8, T5sum(:,52))
  call tensor_integral(5, momenta_41, masses2_7, T5sum(:,53))
  call tensor_integral(5, momenta_41, masses2_9, T5sum(:,54))
  call tensor_integral(5, momenta_26, masses2_8, T5sum(:,55))
  call tensor_integral(5, momenta_26, masses2_7, T5sum(:,56))
  call tensor_integral(5, momenta_26, masses2_9, T5sum(:,57))
  call tensor_integral(5, momenta_45, masses2_8, T5sum(:,58))
  call tensor_integral(5, momenta_45, masses2_7, T5sum(:,59))
  call tensor_integral(5, momenta_45, masses2_9, T5sum(:,60))
  call tensor_integral(5, momenta_28, masses2_8, T5sum(:,61))
  call tensor_integral(5, momenta_28, masses2_7, T5sum(:,62))
  call tensor_integral(5, momenta_28, masses2_9, T5sum(:,63))
  call tensor_integral(5, momenta_43, masses2_8, T5sum(:,64))
  call tensor_integral(5, momenta_43, masses2_7, T5sum(:,65))
  call tensor_integral(5, momenta_43, masses2_9, T5sum(:,66))
  call tensor_integral(5, momenta_37, masses2_8, T5sum(:,67))
  call tensor_integral(5, momenta_37, masses2_7, T5sum(:,68))
  call tensor_integral(5, momenta_37, masses2_9, T5sum(:,69))
  call tensor_integral(5, momenta_38, masses2_8, T5sum(:,70))
  call tensor_integral(5, momenta_38, masses2_7, T5sum(:,71))
  call tensor_integral(5, momenta_38, masses2_9, T5sum(:,72))

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppllllj2_eeexexggg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllllj2_eeexexggg_1_/**/REALKIND
