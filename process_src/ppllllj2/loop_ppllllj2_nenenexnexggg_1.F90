...
subroutine diagrams(A)
  ...
  A(24) = cont_SS(wf(:,46),wf(:,47)) * den(37)
  A(25) = cont_SS(wf(:,46),wf(:,48)) * den(38)
  A(26) = cont_SS(wf(:,46),wf(:,48)) * den(38)
  A(27) = cont_SS(wf(:,46),wf(:,49)) * den(39)
  A(28) = cont_SS(wf(:,46),wf(:,49)) * den(39)
  A(29) = cont_VV(wf(:,51),wf(:,52)) * den(41)
  A(30) = cont_VV(wf(:,51),wf(:,54)) * den(44)
  A(31) = cont_VV(wf(:,52),wf(:,56)) * den(46)
  A(32) = cont_VV(wf(:,54),wf(:,56)) * den(47)
  A(33) = cont_VV(wf(:,52),wf(:,58)) * den(49)
  A(34) = cont_VV(wf(:,54),wf(:,58)) * den(50)
  A(35) = cont_SS(wf(:,47),wf(:,59)) * den(52)
  A(36) = cont_SS(wf(:,47),wf(:,59)) * den(52)
  A(37) = cont_SS(wf(:,48),wf(:,59)) * den(53)
  A(38) = cont_SS(wf(:,48),wf(:,59)) * den(53)
  A(39) = cont_SS(wf(:,49),wf(:,59)) * den(54)
  A(40) = cont_SS(wf(:,49),wf(:,59)) * den(54)
  A(41) = cont_VV(wf(:,51),wf(:,60)) * den(55)
  A(42) = cont_VV(wf(:,51),wf(:,62)) * den(58)
  A(43) = cont_VV(wf(:,56),wf(:,60)) * den(59)
  A(44) = cont_VV(wf(:,56),wf(:,62)) * den(60)
  A(45) = cont_VV(wf(:,58),wf(:,60)) * den(61)
  A(46) = cont_VV(wf(:,58),wf(:,62)) * den(62)
  A(47) = cont_VV(wf(:,51),wf(:,63)) * den(63)
  A(48) = cont_VV(wf(:,51),wf(:,65)) * den(65)
  A(49) = cont_VV(wf(:,56),wf(:,63)) * den(66)
  A(50) = cont_VV(wf(:,56),wf(:,65)) * den(67)
  A(51) = cont_VV(wf(:,58),wf(:,63)) * den(68)
  A(52) = cont_VV(wf(:,58),wf(:,65)) * den(69)
  A(53) = cont_VV(wf(:,51),wf(:,66)) * den(70)
  A(54) = cont_VV(wf(:,51),wf(:,68)) * den(72)
  A(55) = cont_VV(wf(:,56),wf(:,66)) * den(73)
  A(56) = cont_VV(wf(:,56),wf(:,68)) * den(74)
  A(57) = cont_VV(wf(:,58),wf(:,66)) * den(75)
  A(58) = cont_VV(wf(:,58),wf(:,68)) * den(76)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(4)-A(6)+A(11)+A(13)+A(15)+A(17)-A(19)-A(21))*f(1)+2*CI*(-A(29)-A(30)+A(31)+A(32)-A(33)-A(34)+A(41)+A(42)-A(43)-A(44) &
       +A(45)+A(46)+A(47)+A(48)-A(49)-A(50)+A(51)+A(52)-A(53)-A(54)+A(55)+A(56)-A(57)-A(58))*f(2)+2*CI*(-A(1)+A(2)-A(3)+A(8)-A(9) &
       +A(10))*f(3)+2*CI*(A(24)-A(26)+A(28)-A(36)+A(38)-A(40))*f(8)+2*CI*(A(23)-A(25)+A(27)-A(35)+A(37)-A(39))*f(11)
  M2(2) = (-A(5)-A(7)+A(12)+A(14)+A(16)+A(18)-A(20)-A(22))*f(1)+2*CI*(A(29)+A(30)-A(31)-A(32)+A(33)+A(34)-A(41)-A(42)+A(43)+A(44) &
       -A(45)-A(46)-A(47)-A(48)+A(49)+A(50)-A(51)-A(52)+A(53)+A(54)-A(55)-A(56)+A(57)+A(58))*f(2)+2*CI*(A(1)-A(2)+A(3)-A(8)+A(9) &
       -A(10))*f(3)+2*CI*(-A(24)+A(26)-A(28)+A(36)-A(38)+A(40))*f(8)+2*CI*(-A(23)+A(25)-A(27)+A(35)-A(37)+A(39))*f(11)
