...
module ol_vamp_1_ppllj2_nenexuuxg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllj2_nenexuuxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllj2_nenexuuxg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllj2_nenexuuxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllj2_nenexuuxg_1_/**/REALKIND
  ...
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(3)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,1),T3sum(1:35,1))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(3)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,3),T3sum(1:35,2))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(3)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,4),T3sum(1:35,1))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(3)) * TI2_call(3,momenta_1,masses2_2,G3tensor(:,6),T3sum(1:35,2))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(3)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,2),T3sum(1:35,1))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(3)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,7),T3sum(1:35,3))
  M(1) = M(1) + (-(f(3)/2._/**/REALKIND) * den(3)) * TI2_call(3,momenta_1,masses2_3,G3tensor(:,5),T3sum(1:35,1))
  M(1) = M(1) + (-(f(2)/2._/**/REALKIND) * den(3)) * TI2_call(3,momenta_1,masses2_1,G3tensor(:,8),T3sum(1:35,3))
...
end module ol_vamp_1_ppllj2_nenexuuxg_1_/**/REALKIND
