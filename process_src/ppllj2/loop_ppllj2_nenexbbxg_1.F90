...
module ol_colourmatrix_ppllj2_nenexbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllj2_nenexbbxg_1_/**/REALKIND



module ol_forced_parameters_ppllj2_nenexbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj2_nenexbbxg_1_/**/REALKIND

module ol_loop_ppllj2_nenexbbxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = eQED**2*gQCD**3*integralnorm*SwF
    f(3) = 2*eQED**2*gQCD**3*integralnorm*SwF
...
! **********************************************************************
  ...
  call counter_VG_G(wf(:,3),wf(:,-4),Q(:,16),wf(:,4),Q(:,19))
...
end module ol_loop_ppllj2_nenexbbxg_1_/**/REALKIND
