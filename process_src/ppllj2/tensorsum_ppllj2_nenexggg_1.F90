...
! **********************************************************************
module ol_tensor_sum_storage_ppllj2_nenexggg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllj2_nenexggg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllj2_nenexggg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppllj2_nenexggg_1, only: channel_number_ppllj2_nenexggg_1
  ...
  call channel_on(channel_number_ppllj2_nenexggg_1)
  M2 = 0
  ...
  call tensor_integral(4, momenta_6, masses2_6, T4sum(:,1))
  call tensor_integral(4, momenta_6, masses2_5, T4sum(:,2))
  call tensor_integral(4, momenta_6, masses2_4, T4sum(:,3))
  ...
  call channel_off(channel_number_ppllj2_nenexggg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllj2_nenexggg_1_/**/REALKIND
