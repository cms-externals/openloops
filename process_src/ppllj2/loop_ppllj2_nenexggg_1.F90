...
module ol_colourmatrix_ppllj2_nenexggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllj2_nenexggg_1_/**/REALKIND



module ol_forced_parameters_ppllj2_nenexggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllj2_nenexggg_1_/**/REALKIND

module ol_loop_ppllj2_nenexggg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(3) = CI*eQED**2*gQCD**3*integralnorm*SwF
    f(4) = 2*CI*eQED**2*gQCD**3*integralnorm*SwF
    f(5) = eQED**2*gQCD**3*integralnorm*SwF
    f(6) = 2*eQED**2*gQCD**3*integralnorm*SwF
...
end module ol_loop_ppllj2_nenexggg_1_/**/REALKIND
