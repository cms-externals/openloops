...
module ol_versiondata_ppwj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppwj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppwj
  end interface
end module ol_versiondata_ppwj


subroutine ol_version_ppwj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppwj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppwj
