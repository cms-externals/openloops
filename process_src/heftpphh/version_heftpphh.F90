...
module ol_versiondata_heftpphh
  implicit none
  character(4) :: generator_revision = "1699"
  interface
    subroutine version_heftpphh(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_heftpphh
  end interface
end module ol_versiondata_heftpphh


subroutine ol_version_heftpphh(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_heftpphh, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_heftpphh
