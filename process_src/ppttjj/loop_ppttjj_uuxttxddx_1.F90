...
module ol_colourmatrix_ppttjj_uuxttxddx_1_/**/REALKIND
...
end module ol_colourmatrix_ppttjj_uuxttxddx_1_/**/REALKIND



module ol_forced_parameters_ppttjj_uuxttxddx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppttjj_uuxttxddx_1_/**/REALKIND

module ol_loop_ppttjj_uuxttxddx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,32),Q(:,52),MT,1_intkind1,wf(:,33))
  call counter_AV_Q(wf(:,-3),wf(:,3),wf(:,34))
  call counter_AV_Q(wf(:,-3),wf(:,1),wf(:,35))
  call counter_VQ_A(wf(:,3),wf(:,-2),wf(:,36))
  call prop_A_Q(wf(:,15),Q(:,11),MT,1_intkind1,wf(:,37))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,38))
  call prop_A_Q(wf(:,12),Q(:,56),MT,1_intkind1,wf(:,39))
  ...
  call prop_Q_A(wf(:,62),Q(:,7),MT,1_intkind1,wf(:,63))
  ...
  call counter_Q_A(cttt,wf(:,13),Q(:,7),wf(:,78))
  call counter_Q_A(cttt,wf(:,16),Q(:,52),wf(:,79))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(39)+A(40)+A(41)+A(42)+A(43)+A(44)+A(51)+A(52)+A(53)+A(54)+A(55)+A(56))*f(3))/12._/**/REALKIND+((-A(9)-A(10)-A(11) &
       -A(12)-A(23)-A(24)-A(27)-A(28)-A(29)-A(30)-A(32)-A(33))*f(5))/12._/**/REALKIND+((-A(21)-A(22)-A(25) &
       -A(26))*f(7))/12._/**/REALKIND
  M2(2) = ((-A(40)-A(41)-A(44)-A(45)-A(47)-A(50)-A(52)-A(54)-A(55))*f(3))/4._/**/REALKIND+(CI*(-A(36)+A(37) &
       -A(38))*f(4))/4._/**/REALKIND+((A(10)+A(11)+A(14)+A(24)+A(28)+A(30)+A(33)+A(34))*f(5))/4._/**/REALKIND+(CI*(A(13) &
       +A(31))*f(6))/4._/**/REALKIND+((A(16)+A(19)+A(22)+A(25))*f(7))/4._/**/REALKIND+(CI*A(20)*f(8))/4._/**/REALKIND &
       +(CI*A(8)*f(9))/4._/**/REALKIND
  M2(3) = ((-A(39)-A(42)-A(43)-A(46)-A(48)-A(49)-A(51)-A(53)-A(56))*f(3))/4._/**/REALKIND+(CI*(A(36)-A(37) &
       +A(38))*f(4))/4._/**/REALKIND+((A(9)+A(12)+A(15)+A(23)+A(27)+A(29)+A(32)+A(35))*f(5))/4._/**/REALKIND+(CI*(-A(13) &
       -A(31))*f(6))/4._/**/REALKIND+((A(17)+A(18)+A(21)+A(26))*f(7))/4._/**/REALKIND-(CI*A(20)*f(8))/4._/**/REALKIND &
       -(CI*A(8)*f(9))/4._/**/REALKIND
  M2(4) = ((A(39)+A(40)+A(41)+A(42)+A(43)+A(44)+A(45)+A(46)+A(47)+A(48)+A(49)+A(50))*f(3))/12._/**/REALKIND+((-A(9)-A(10)-A(11) &
       -A(12)-A(14)-A(15)-A(32)-A(33)-A(34)-A(35))*f(5))/12._/**/REALKIND+((-A(16)-A(17)-A(18)-A(19)-A(21) &
       -A(22))*f(7))/12._/**/REALKIND
  M2(5) = ((A(45)+A(46)+A(47)+A(48)+A(49)+A(50)+A(51)+A(52)+A(53)+A(54)+A(55)+A(56))*f(3))/12._/**/REALKIND+((-A(14)-A(15)-A(23) &
       -A(24)-A(27)-A(28)-A(29)-A(30)-A(34)-A(35))*f(5))/12._/**/REALKIND+((-A(16)-A(17)-A(18)-A(19)-A(25) &
       -A(26))*f(7))/12._/**/REALKIND
  M2(6) = ((-A(39)-A(40)-A(41)-A(42)-A(43)-A(44)-A(45)-A(46)-A(47)-A(48)-A(49)-A(50)-A(51)-A(52)-A(53)-A(54)-A(55) &
       -A(56))*f(3))/36._/**/REALKIND+((A(9)+A(10)+A(11)+A(12)+A(14)+A(15)+A(23)+A(24)+A(27)+A(28)+A(29)+A(30)+A(32)+A(33)+A(34) &
       +A(35))*f(5))/36._/**/REALKIND+((A(16)+A(17)+A(18)+A(19)+A(21)+A(22)+A(25)+A(26))*f(7))/36._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppttjj_uuxttxddx_1_/**/REALKIND
