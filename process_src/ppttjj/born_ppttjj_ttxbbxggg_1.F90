...
module ol_colourmatrix_ppttjj_ttxbbxggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppttjj_ttxbbxggg_1_/**/REALKIND



module ol_forced_parameters_ppttjj_ttxbbxggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppttjj_ttxbbxggg_1_/**/REALKIND

module ol_tree_ppttjj_ttxbbxggg_1_/**/REALKIND
...
subroutine born_denominators_init()
  ...
  den(105) = 1 / (Q(5,84) - MB2)
  den(109) = 1 / (Q(5,104) - MB2)
  den(115) = 1 / (Q(5,52) - MB2)
  den(121) = 1 / (Q(5,11) - MB2)
  den(136) = 1 / (Q(5,100) - MB2)
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppttjj_ttxbbxggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppttjj_ttxbbxggg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for top anti-top bottom anti-bottom glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppttjj_ttxbbxggg_1, only: external_perm_ppttjj_ttxbbxggg_1, &
    & external_perm_inv_ppttjj_ttxbbxggg_1, extcomb_perm_ppttjj_ttxbbxggg_1, &
    & average_factor_ppttjj_ttxbbxggg_1
  use ol_external_ppttjj_ttxbbxggg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppttjj_ttxbbxggg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppttjj_ttxbbxggg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppttjj_ttxbbxggg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppttjj_ttxbbxggg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppttjj_ttxbbxggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppttjj_ttxbbxggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppttjj_ttxbbxggg_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf8(:,16), Q(:,7), MB, 1_intkind1, wf8(:,17), n2(7))
  ...
  call prop_Q_A(ntry, wf16(:,23), Q(:,116), MB, 1_intkind1, wf16(:,24), n2(8))
  call vert_VQ_A(ntry, wf8(:,8), ex3, wf16(:,25), n3(:,31), t3x16(:,:,6))
  call prop_Q_A(ntry, wf16(:,25), Q(:,116), MB, 1_intkind1, wf16(:,26), n2(9))
  call vert_VQ_A(ntry, wf8(:,9), ex3, wf16(:,27), n3(:,32), t3x16(:,:,7))
  call prop_Q_A(ntry, wf16(:,27), Q(:,116), MB, 1_intkind1, wf16(:,28), n2(10))
  ...
  call prop_Q_A(ntry, wf8(:,31), Q(:,84), MB, 1_intkind1, wf8(:,32), n2(21))
  call vert_AV_Q(ntry, wf4(:,13), ex7, wf8(:,33), n3(:,71), t3x8(:,:,27))
  call vert_VQ_A(ntry, wf4(:,1), wf4(:,7), wf16(:,52), n3(:,72), t3x16(:,:,28))
  call prop_A_Q(ntry, wf8(:,33), Q(:,104), MB, 1_intkind1, wf8(:,34), n2(22))
  ...
  call prop_Q_A(ntry, wf8(:,35), Q(:,52), MB, 1_intkind1, wf8(:,36), n2(23))
  call vert_AV_Q(ntry, wf4(:,17), ex6, wf8(:,37), n3(:,76), t3x8(:,:,29))
  call prop_A_Q(ntry, wf8(:,37), Q(:,104), MB, 1_intkind1, wf8(:,38), n2(24))
  call vert_VQ_A(ntry, wf4(:,5), wf4(:,7), wf16(:,55), n3(:,77), t3x16(:,:,31))
  call prop_A_Q(ntry, wf8(:,18), Q(:,11), MB, 1_intkind1, wf8(:,39), n2(25))
  call vert_AV_Q(ntry, ex4, wf4(:,5), wf8(:,40), n3(:,78), t3x8(:,:,30))
  call prop_A_Q(ntry, wf8(:,40), Q(:,104), MB, 1_intkind1, wf8(:,41), n2(26))
  ...
  call prop_Q_A(ntry, wf8(:,52), Q(:,52), MB, 1_intkind1, wf8(:,53), n2(32))
  call vert_AV_Q(ntry, wf4(:,17), ex5, wf8(:,54), n3(:,104), t3x8(:,:,37))
  call prop_A_Q(ntry, wf8(:,54), Q(:,88), MB, 1_intkind1, wf8(:,55), n2(33))
  call vert_VQ_A(ntry, wf4(:,4), wf4(:,11), wf16(:,75), n3(:,105), t3x16(:,:,51))
  call vert_AV_Q(ntry, ex4, wf4(:,4), wf8(:,56), n3(:,106), t3x8(:,:,38))
  call prop_A_Q(ntry, wf8(:,56), Q(:,88), MB, 1_intkind1, wf8(:,57), n2(34))
  ...
  call prop_Q_A(ntry, wf8(:,58), Q(:,84), MB, 1_intkind1, wf8(:,59), n2(35))
  call vert_AV_Q(ntry, wf4(:,13), ex5, wf8(:,60), n3(:,114), t3x8(:,:,40))
  call prop_A_Q(ntry, wf8(:,60), Q(:,56), MB, 1_intkind1, wf8(:,61), n2(36))
  call vert_AV_Q(ntry, wf4(:,13), wf4(:,4), wf16(:,82), n3(:,115), t3x16(:,:,58))
  call vert_VQ_A(ntry, wf4(:,4), ex3, wf8(:,62), n3(:,116), t3x8(:,:,41))
  call prop_Q_A(ntry, wf8(:,62), Q(:,84), MB, 1_intkind1, wf8(:,63), n2(37))
  ...
  call prop_A_Q(ntry, wf8(:,64), Q(:,56), MB, 1_intkind1, wf8(:,65), n2(38))
  call vert_AV_Q(ntry, wf4(:,17), wf4(:,3), wf16(:,89), n3(:,124), t3x16(:,:,65))
  call vert_VQ_A(ntry, wf4(:,3), ex3, wf8(:,66), n3(:,125), t3x8(:,:,43))
  call prop_Q_A(ntry, wf8(:,66), Q(:,52), MB, 1_intkind1, wf8(:,67), n2(39))
  ...
  M2add = M2 / average_factor_ppttjj_ttxbbxggg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppttjj_ttxbbxggg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppttjj_ttxbbxggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppttjj_ttxbbxggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppttjj_ttxbbxggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppttjj_ttxbbxggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppttjj_ttxbbxggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppttjj_ttxbbxggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppttjj_ttxbbxggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppttjj_ttxbbxggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppttjj_ttxbbxggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppttjj_ttxbbxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppttjj_ttxbbxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppttjj_ttxbbxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppttjj_ttxbbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppttjj_ttxbbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppttjj_ttxbbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppttjj_ttxbbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppttjj_ttxbbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppttjj_ttxbbxggg_1_/**/REALKIND
