...
module ol_versiondata_heftpph
  implicit none
  character(4) :: generator_revision = "1790"
  interface
    subroutine version_heftpph(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_heftpph
  end interface
end module ol_versiondata_heftpph


subroutine ol_version_heftpph(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_heftpph, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_heftpph
