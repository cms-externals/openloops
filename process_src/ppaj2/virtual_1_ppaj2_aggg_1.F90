...
module ol_vamp_1_ppaj2_aggg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppaj2_aggg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppaj2_aggg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppaj2_aggg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppaj2_aggg_1_/**/REALKIND
  ...
  M(2) = M(2) + (-f(4)) * TI2_call(4,momenta_2,masses2_3,G4tensor(:,1),T4sum(1:70,1))
  M(2) = M(2) + (-f(3)) * TI2_call(4,momenta_2,masses2_2,G4tensor(:,3),T4sum(1:70,2))
  ...
  M(2) = M(2) + (f(3)) * TI2_call(4,momenta_2,masses2_3,G4tensor(:,1),T4sum(1:70,1))
  M(2) = M(2) + (f(2)) * TI2_call(4,momenta_2,masses2_1,G4tensor(:,9),T4sum(1:70,3))
  ...
  M(2) = M(2) + (-f(4)) * TI2_call(4,momenta_1,masses2_3,G4tensor(:,6),T4sum(1:70,4))
  M(2) = M(2) + (-f(3)) * TI2_call(4,momenta_1,masses2_2,G4tensor(:,8),T4sum(1:70,5))
  ...
  M(2) = M(2) + (f(3)) * TI2_call(4,momenta_1,masses2_3,G4tensor(:,6),T4sum(1:70,4))
  M(2) = M(2) + (f(2)) * TI2_call(4,momenta_1,masses2_1,G4tensor(:,12),T4sum(1:70,6))
  M(2) = M(2) + (-f(4)) * TI2_call(4,momenta_3,masses2_3,G4tensor(:,13),T4sum(1:70,7))
  M(2) = M(2) + (-f(3)) * TI2_call(4,momenta_3,masses2_2,G4tensor(:,14),T4sum(1:70,8))
  M(1) = M(1) + (-f(4)) * TI2_call(4,momenta_3,masses2_3,G4tensor(:,15),T4sum(1:70,7))
  M(1) = M(1) + (-f(3)) * TI2_call(4,momenta_3,masses2_2,G4tensor(:,16),T4sum(1:70,8))
  M(2) = M(2) + (f(3)) * TI2_call(4,momenta_3,masses2_3,G4tensor(:,13),T4sum(1:70,7))
  M(2) = M(2) + (f(2)) * TI2_call(4,momenta_3,masses2_1,G4tensor(:,17),T4sum(1:70,9))
...
end module ol_vamp_1_ppaj2_aggg_1_/**/REALKIND
