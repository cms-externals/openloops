...
module ol_colourmatrix_pplnjj_ckm_neexcxsssx_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexcxsssx_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexcxsssx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexcxsssx_1_/**/REALKIND

module ol_loop_pplnjj_ckm_neexcxsssx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_A_Q(ctcc,wf(:,9),Q(:,44),wf(:,37))
  call vert_VQ_A(wf(:,34),wf(:,-4),wf(:,38))
  call counter_A_Q(ctcc,wf(:,14),Q(:,52),wf(:,39))
...
end module ol_loop_pplnjj_ckm_neexcxsssx_1_/**/REALKIND
