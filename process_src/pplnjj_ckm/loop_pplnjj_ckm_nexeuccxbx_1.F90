...
module ol_colourmatrix_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND

module ol_loop_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctqq,wf(:,9),Q(:,28),wf(:,23))
...
end module ol_loop_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND
