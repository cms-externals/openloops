...
module ol_colourmatrix_pplnjj_ckm_neexcxddxs_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexcxddxs_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexcxddxs_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexcxddxs_1_/**/REALKIND

module ol_loop_pplnjj_ckm_neexcxddxs_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_A_Q(ctqq,wf(:,6),Q(:,7),wf(:,22))
  call counter_A_Q(ctcc,wf(:,9),Q(:,28),wf(:,23))
...
end module ol_loop_pplnjj_ckm_neexcxddxs_1_/**/REALKIND
