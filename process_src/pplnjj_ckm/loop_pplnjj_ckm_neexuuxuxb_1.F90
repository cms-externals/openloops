...
module ol_colourmatrix_pplnjj_ckm_neexuuxuxb_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexuuxuxb_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexuuxuxb_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexuuxuxb_1_/**/REALKIND

module ol_loop_pplnjj_ckm_neexuuxuxb_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,4),Q(:,19),MB,1_intkind1,wf(:,6))
  ...
  call prop_A_Q(wf(:,11),Q(:,11),MB,1_intkind1,wf(:,13))
  ...
  call counter_A_Q(ctbb,wf(:,6),Q(:,19),wf(:,37))
  ...
  call counter_A_Q(ctbb,wf(:,13),Q(:,11),wf(:,42))
...
end module ol_loop_pplnjj_ckm_neexuuxuxb_1_/**/REALKIND
