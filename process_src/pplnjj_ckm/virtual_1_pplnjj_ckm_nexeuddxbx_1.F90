...
module ol_vamp_1_pplnjj_ckm_nexeuddxbx_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplnjj_ckm_nexeuddxbx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplnjj_ckm_nexeuddxbx_1.
! **********************************************************************
...
#endif
  use ol_loop_pplnjj_ckm_nexeuddxbx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplnjj_ckm_nexeuddxbx_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_A_Q(G1(:,:,:,5),Q(:,56),MB,G2(:,:,:,5))
  ...
  call loop_A_Q(G0(:,:,:,4),Q(:,56),MB,G1(:,:,:,9))
  ...
  call loop_A_Q(G1(:,:,:,14),Q(:,56),MB,G2(:,:,:,11))
  ...
  call loop_A_Q(G1(:,:,:,21),Q(:,56),MB,G2(:,:,:,16))
...
end module ol_vamp_1_pplnjj_ckm_nexeuddxbx_1_/**/REALKIND
