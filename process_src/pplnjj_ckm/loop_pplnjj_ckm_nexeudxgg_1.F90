...
module ol_colourmatrix_pplnjj_ckm_nexeudxgg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_nexeudxgg_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_nexeudxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_nexeudxgg_1_/**/REALKIND

module ol_loop_pplnjj_ckm_nexeudxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 2) = (eQED**2*gQCD**2*VCKMdu)/(sw**2*2._/**/REALKIND)
    f( 3) = (CI*countertermnorm*eQED**2*gQCD**4*VCKMdu)/(2._/**/REALKIND*sw**2)
    f( 4) = (countertermnorm*eQED**2*gQCD**4*VCKMdu)/(sw**2*2._/**/REALKIND)
    f( 5) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4*VCKMdu)/(2._/**/REALKIND*sw**2)
    f( 6) = (countertermnorm*ctGqq*eQED**2*gQCD**4*VCKMdu)/(sw**2*2._/**/REALKIND)
    f( 7) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4*VCKMdu)/(2._/**/REALKIND*sw**2)
    f( 8) = (countertermnorm*ctVqq*eQED**2*gQCD**4*VCKMdu)/(sw**2*2._/**/REALKIND)
    f( 9) = (countertermnorm*ctVVV*eQED**2*gQCD**4*VCKMdu)/(sw**2*2._/**/REALKIND)
    f(10) = (CI*eQED**2*gQCD**4*integralnorm*SwB*VCKMdu)/(4._/**/REALKIND*sw**2)
    f(11) = (CI*eQED**2*gQCD**4*integralnorm*SwB*VCKMdu)/(2._/**/REALKIND*sw**2)
    f(12) = (eQED**2*gQCD**4*integralnorm*SwB*VCKMdu)/(sw**2*2._/**/REALKIND)
    f(13) = (CI*eQED**2*gQCD**4*integralnorm*SwF*VCKMdu)/(2._/**/REALKIND*sw**2)
    f(14) = (CI*eQED**2*gQCD**4*integralnorm*SwF*VCKMdu)/sw**2
    f(15) = (eQED**2*gQCD**4*integralnorm*SwF*VCKMdu)/(sw**2*2._/**/REALKIND)
    f(16) = (eQED**2*gQCD**4*integralnorm*SwF*VCKMdu)/sw**2
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(37)+A(38)+A(39)+A(40)+A(41)+A(42))*f(3)+CI*(A(45)+A(46)+A(47)+A(48))*f(4)+(-A(12)-A(13)-A(23)-A(24)-A(26)-A(30))*f(5) &
       +CI*(-A(20)-A(28))*f(6)+(-A(11)-A(19)-A(25))*f(7)+CI*(-A(21)-A(29))*f(8)+CI*(-A(15)-A(16))*f(9)
  M2(2) = (A(33)+A(34)+A(35)+A(36)+A(43)+A(44))*f(3)+CI*(-A(45)-A(46)-A(47)-A(48))*f(4)+(-A(10)-A(14)-A(18)-A(22)-A(31) &
       -A(32))*f(5)+CI*(A(20)+A(28))*f(6)+(-A(9)-A(17)-A(27))*f(7)+CI*(A(21)+A(29))*f(8)+CI*(A(15)+A(16))*f(9)

end subroutine colourvectors

end module ol_loop_pplnjj_ckm_nexeudxgg_1_/**/REALKIND
