...
module ol_colourmatrix_pplnjj_ckm_neexcxsgg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexcxsgg_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexcxsgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexcxsgg_1_/**/REALKIND

module ol_loop_pplnjj_ckm_neexcxsgg_1_/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(33)+A(34)+A(35)+A(36)+A(43)+A(44))*f(3)+CI*(A(45)+A(46)+A(47)+A(48))*f(4)+(-A(10)-A(31)-A(32))*f(5)-CI*A(28)*f(6)+( &
       -A(14)-A(18)-A(22))*f(7)-CI*A(20)*f(8)+(-A(9)-A(17)-A(27))*f(9)+CI*(-A(21)-A(29))*f(10)+CI*(-A(15)-A(16))*f(11)
  M2(2) = (A(37)+A(38)+A(39)+A(40)+A(41)+A(42))*f(3)+CI*(-A(45)-A(46)-A(47)-A(48))*f(4)+(-A(13)-A(26)-A(30))*f(5)+CI*A(28)*f(6)+( &
       -A(12)-A(23)-A(24))*f(7)+CI*A(20)*f(8)+(-A(11)-A(19)-A(25))*f(9)+CI*(A(21)+A(29))*f(10)+CI*(A(15)+A(16))*f(11)

end subroutine colourvectors

end module ol_loop_pplnjj_ckm_neexcxsgg_1_/**/REALKIND
