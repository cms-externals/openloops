...
module ol_colourmatrix_pplnjj_ckm_neexcxbgg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexcxbgg_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexcxbgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexcxbgg_1_/**/REALKIND

module ol_loop_pplnjj_ckm_neexcxbgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,3),Q(:,40),MB,1_intkind1,wf(:,6))
  ...
  call prop_Q_A(wf(:,37),Q(:,40),MB,1_intkind1,wf(:,38))
  ...
  call counter_A_Q(ctcc,wf(:,5),Q(:,20),wf(:,59))
  call prop_Q_A(wf(:,58),Q(:,43),ZERO,0_intkind1,wf(:,60))
  call counter_Q_A(ctbb,wf(:,6),Q(:,40),wf(:,61))
  call prop_A_Q(wf(:,7),Q(:,23),MB,1_intkind1,wf(:,62))
  call prop_A_Q(wf(:,59),Q(:,20),ZERO,0_intkind1,wf(:,63))
  call vert_AV_Q(wf(:,63),wf(:,-5),wf(:,64))
  call counter_Q_A(ctcc,wf(:,10),Q(:,11),wf(:,65))
  call vert_WQ_A(wf(:,4),wf(:,14),wf(:,66))
  call counter_A_Q(ctcc,wf(:,13),Q(:,36),wf(:,67))
  call prop_Q_A(wf(:,66),Q(:,27),ZERO,0_intkind1,wf(:,68))
  call counter_Q_A(ctbb,wf(:,14),Q(:,24),wf(:,69))
  call prop_A_Q(wf(:,15),Q(:,39),MB,1_intkind1,wf(:,70))
  call counter_A_Q(ctbb,wf(:,18),Q(:,7),wf(:,71))
  call prop_Q_A(wf(:,69),Q(:,24),MB,1_intkind1,wf(:,72))
  call vert_VQ_A(wf(:,-5),wf(:,72),wf(:,73))
  call prop_A_Q(wf(:,67),Q(:,36),ZERO,0_intkind1,wf(:,74))
  call vert_AV_Q(wf(:,74),wf(:,-4),wf(:,75))
  call prop_Q_A(wf(:,61),Q(:,40),MB,1_intkind1,wf(:,76))
  call vert_VQ_A(wf(:,-4),wf(:,76),wf(:,77))
  call counter_A_Q(ctcc,wf(:,24),Q(:,52),wf(:,78))
  ...
  call prop_A_Q(wf(:,83),Q(:,23),MB,1_intkind1,wf(:,84))
  call vert_AV_Q(wf(:,18),wf(:,-5),wf(:,85))
  call prop_A_Q(wf(:,85),Q(:,39),MB,1_intkind1,wf(:,86))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(33)+A(34)+A(35)+A(36)+A(43)+A(44))*f(3)+CI*(A(45)+A(46)+A(47)+A(48))*f(4)+(-A(14)-A(18)-A(22))*f(5)-CI*A(20)*f(6)+( &
       -A(10)-A(31)-A(32))*f(7)-CI*A(28)*f(8)+(-A(9)-A(17)-A(27))*f(9)+CI*(-A(21)-A(29))*f(10)+CI*(-A(15)-A(16))*f(11)
  M2(2) = (A(37)+A(38)+A(39)+A(40)+A(41)+A(42))*f(3)+CI*(-A(45)-A(46)-A(47)-A(48))*f(4)+(-A(12)-A(23)-A(24))*f(5)+CI*A(20)*f(6)+( &
       -A(13)-A(26)-A(30))*f(7)+CI*A(28)*f(8)+(-A(11)-A(19)-A(25))*f(9)+CI*(A(21)+A(29))*f(10)+CI*(A(15)+A(16))*f(11)

end subroutine colourvectors

end module ol_loop_pplnjj_ckm_neexcxbgg_1_/**/REALKIND
