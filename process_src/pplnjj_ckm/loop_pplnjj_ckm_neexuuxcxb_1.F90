...
module ol_colourmatrix_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND

module ol_loop_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,5),Q(:,44),MB,1_intkind1,wf(:,15))
  ...
  call counter_A_Q(ctbb,wf(:,6),Q(:,19),wf(:,23))
...
end module ol_loop_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
