...
! **********************************************************************
module ol_tensor_sum_storage_pplnjj_ckm_neexcxdssx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplnjj_ckm_neexcxdssx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplnjj_ckm_neexcxdssx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pplnjj_ckm_neexcxdssx_1, only: channel_number_pplnjj_ckm_neexcxdssx_1
  ...
  call channel_on(channel_number_pplnjj_ckm_neexcxdssx_1)
  M2 = 0
  ...
  call TI_call(2, momenta_6, masses2_4, T2sum(:,8), M2)
  call TI_call(2, momenta_16, masses2_5, T2sum(:,9), M2)
  call TI_call(2, momenta_14, masses2_5, T2sum(:,10), M2)
  call TI_call(2, momenta_15, masses2_5, T2sum(:,11), M2)
  ...
  call TI_call(3, momenta_13, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_12, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_18, masses2_5, T3sum(:,3), M2)
  ...
  call channel_off(channel_number_pplnjj_ckm_neexcxdssx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplnjj_ckm_neexcxdssx_1_/**/REALKIND
