...
module ol_colourmatrix_pplnjj_ckm_nexecdxgg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_nexecdxgg_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_nexecdxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_nexecdxgg_1_/**/REALKIND

module ol_loop_pplnjj_ckm_nexecdxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f( 1) = (CI*eQED**2*gQCD**2*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 2) = (eQED**2*gQCD**2*VCKMdc)/(sw**2*2._/**/REALKIND)
    f( 3) = (CI*countertermnorm*eQED**2*gQCD**4*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 4) = (countertermnorm*eQED**2*gQCD**4*VCKMdc)/(sw**2*2._/**/REALKIND)
    f( 5) = (CI*countertermnorm*ctGcc*eQED**2*gQCD**4*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 6) = (countertermnorm*ctGcc*eQED**2*gQCD**4*VCKMdc)/(sw**2*2._/**/REALKIND)
    f( 7) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 8) = (countertermnorm*ctGqq*eQED**2*gQCD**4*VCKMdc)/(sw**2*2._/**/REALKIND)
    f( 9) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4*VCKMdc)/(2._/**/REALKIND*sw**2)
    f(10) = (countertermnorm*ctVqq*eQED**2*gQCD**4*VCKMdc)/(sw**2*2._/**/REALKIND)
    f(11) = (countertermnorm*ctVVV*eQED**2*gQCD**4*VCKMdc)/(sw**2*2._/**/REALKIND)
    f(12) = (CI*eQED**2*gQCD**4*integralnorm*SwB*VCKMdc)/(4._/**/REALKIND*sw**2)
    f(13) = (CI*eQED**2*gQCD**4*integralnorm*SwB*VCKMdc)/(2._/**/REALKIND*sw**2)
    f(14) = (eQED**2*gQCD**4*integralnorm*SwB*VCKMdc)/(sw**2*2._/**/REALKIND)
    f(15) = (CI*eQED**2*gQCD**4*integralnorm*SwF*VCKMdc)/(2._/**/REALKIND*sw**2)
    f(16) = (CI*eQED**2*gQCD**4*integralnorm*SwF*VCKMdc)/sw**2
    f(17) = (eQED**2*gQCD**4*integralnorm*SwF*VCKMdc)/(sw**2*2._/**/REALKIND)
    f(18) = (eQED**2*gQCD**4*integralnorm*SwF*VCKMdc)/sw**2
...
end module ol_loop_pplnjj_ckm_nexecdxgg_1_/**/REALKIND
