...
module ol_colourmatrix_pplnjj_ckm_neexccxcxb_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexccxcxb_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexccxcxb_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexccxcxb_1_/**/REALKIND

module ol_loop_pplnjj_ckm_neexccxcxb_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_A_Q(ctcc,wf(:,9),Q(:,28),wf(:,38))
  ...
  call counter_A_Q(ctcc,wf(:,15),Q(:,28),wf(:,43))
...
end module ol_loop_pplnjj_ckm_neexccxcxb_1_/**/REALKIND
