...
module ol_colourmatrix_pplnjj_ckm_neexcxdbbx_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexcxdbbx_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexcxdbbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexcxdbbx_1_/**/REALKIND

module ol_loop_pplnjj_ckm_neexcxdbbx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**4*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 4) = (CI*countertermnorm*ctGcc*eQED**2*gQCD**4*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 5) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 6) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 7) = (CI*eQED**2*gQCD**4*integralnorm*SwB*VCKMdc)/(2._/**/REALKIND*sw**2)
    f( 8) = (eQED**2*gQCD**4*integralnorm*SwB*VCKMdc)/(sw**2*4._/**/REALKIND)
    f( 9) = (eQED**2*gQCD**4*integralnorm*SwB*VCKMdc)/(sw**2*2._/**/REALKIND)
    f(10) = (eQED**2*gQCD**4*integralnorm*SwF*VCKMdc)/(sw**2*2._/**/REALKIND)
    f(11) = (eQED**2*gQCD**4*integralnorm*SwF*VCKMdc)/sw**2
...
end module ol_loop_pplnjj_ckm_neexcxdbbx_1_/**/REALKIND
