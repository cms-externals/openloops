...
! **********************************************************************
module ol_tensor_sum_storage_pplnjj_ckm_neexuxdddx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplnjj_ckm_neexuxdddx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplnjj_ckm_neexuxdddx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pplnjj_ckm_neexuxdddx_1, only: channel_number_pplnjj_ckm_neexuxdddx_1
  ...
  call channel_on(channel_number_pplnjj_ckm_neexuxdddx_1)
  M2 = 0
  ...
  call TI_call(2, momenta_10, masses2_4, T2sum(:,3), M2)
  ...
  call TI_call(2, momenta_12, masses2_4, T2sum(:,12), M2)
  call TI_call(2, momenta_8, masses2_4, T2sum(:,13), M2)
  call TI_call(2, momenta_13, masses2_4, T2sum(:,14), M2)
  call TI_call(2, momenta_11, masses2_4, T2sum(:,15), M2)
  call TI_call(2, momenta_29, masses2_5, T2sum(:,16), M2)
  call TI_call(2, momenta_31, masses2_5, T2sum(:,17), M2)
  call TI_call(2, momenta_22, masses2_5, T2sum(:,18), M2)
  call TI_call(2, momenta_26, masses2_5, T2sum(:,19), M2)
  call TI_call(2, momenta_27, masses2_5, T2sum(:,20), M2)
  call TI_call(2, momenta_32, masses2_5, T2sum(:,21), M2)
  call TI_call(2, momenta_23, masses2_5, T2sum(:,22), M2)
  call TI_call(2, momenta_30, masses2_5, T2sum(:,23), M2)
  call TI_call(2, momenta_1, masses2_3, T2sum(:,24), M2)
  call TI_call(2, momenta_1, masses2_2, T2sum(:,25), M2)
  ...
  call TI_call(3, momenta_28, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_25, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_33, masses2_5, T3sum(:,3), M2)
  call TI_call(3, momenta_24, masses2_5, T3sum(:,4), M2)
  ...
  call channel_off(channel_number_pplnjj_ckm_neexuxdddx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplnjj_ckm_neexuxdddx_1_/**/REALKIND
