...
module ol_vamp_1_pplnjj_ckm_neexuuxcxd_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplnjj_ckm_neexuuxcxd_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplnjj_ckm_neexuuxcxd_1.
! **********************************************************************
...
#endif
  use ol_loop_pplnjj_ckm_neexuuxcxd_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplnjj_ckm_neexuuxcxd_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_A_Q(G0(:,:,:,3),Q(:,19),ZERO,G1(:,:,:,6))
  ...
  call loop_A_Q(G1(:,:,:,16),Q(:,19),ZERO,G2(:,:,:,12))
  ...
  call loop_Q_A(G0(:,:,:,6),Q(:,44),ZERO,G1(:,:,:,17))
...
end module ol_vamp_1_pplnjj_ckm_neexuuxcxd_1_/**/REALKIND
