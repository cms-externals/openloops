...
#endif
  use ol_loop_pplnjj_ckm_nexeuuxcbx_1_/**/REALKIND, only: c, f, wf, den
...
if (mode == -1) return
  ...
  call loop_Q_A(G0(:,:,:,3),Q(:,19),MB,G1(:,:,:,6))
  ...
  call loop_Q_A(G1(:,:,:,16),Q(:,19),MB,G2(:,:,:,12))
  ...
  call loop_A_Q(G0(:,:,:,6),Q(:,44),MB,G1(:,:,:,17))
