...
module ol_colourmatrix_pplnjj_ckm_neexcxbggg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_neexcxbggg_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_neexcxbggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_neexcxbggg_1_/**/REALKIND

module ol_tree_pplnjj_ckm_neexcxbggg_1_/**/REALKIND
...
subroutine factors_init()
  ...
  ! factors of the diagrams
    f(1) = (CI*eQED**2*gQCD**3*VCKMbc)/(2._/**/REALKIND*sw**2)
    f(2) = (eQED**2*gQCD**3*VCKMbc)/(sw**2*2._/**/REALKIND)
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pplnjj_ckm_neexcxbggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pplnjj_ckm_neexcxbggg_1_/**/DREALKIND, only: &
    & ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for nu_e e+ anti-charm bottom glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_pplnjj_ckm_neexcxbggg_1, only: &
    & external_perm_pplnjj_ckm_neexcxbggg_1, &
    & external_perm_inv_pplnjj_ckm_neexcxbggg_1, &
    & extcomb_perm_pplnjj_ckm_neexcxbggg_1, &
    & average_factor_pplnjj_ckm_neexcxbggg_1
  use ol_external_pplnjj_ckm_neexcxbggg_1, only: &
    & H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_pplnjj_ckm_neexcxbggg_1_/**/REALKIND, only: &
    & colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_pplnjj_ckm_neexcxbggg_1_/**/REALKIND, only: &
    & check_forced_parameters
  use ol_heltables_pplnjj_ckm_neexcxbggg_1
  ...
  extmasses2 = [ rZERO2, rZERO2, rZERO2, rMB2, rZERO2, rZERO2, rZERO2 ]
  call conv_mom_scatt2in(P_scatt, extmasses2, P, &
    & external_perm_inv_pplnjj_ckm_neexcxbggg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pplnjj_ckm_neexcxbggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pplnjj_ckm_neexcxbggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_pplnjj_ckm_neexcxbggg_1(extcombs(k))
  end do
  ...
  call vert_AW_Q(ntry, ex3, wf4(:,2), wf8(:,2), n3(:,2), t3x8(:,:,1))
  call vert_VQ_A(ntry, wf8(:,1), ex4, wf16(:,1), n3(:,3), t3x16(:,:,1))
  call prop_A_Q(ntry, wf8(:,2), Q(:,7), MB, 1_intkind1, wf8(:,3), n2(2))
  call vert_GGG_G(ntry, ex6, ex7, ex5, wf8(:,4), n4(:,2), t4x8(:,:,2))
  call vert_VQ_A(ntry, wf8(:,4), ex4, wf16(:,2), n3(:,4), t3x16(:,:,2))
  call vert_GGG_G(ntry, ex7, ex5, ex6, wf8(:,5), n4(:,3), t4x8(:,:,3))
  call vert_VQ_A(ntry, wf8(:,5), ex4, wf16(:,3), n3(:,5), t3x16(:,:,3))
  call vert_AV_Q(ntry, ex3, wf8(:,1), wf16(:,4), n3(:,6), t3x16(:,:,4))
  call vert_WQ_A(ntry, wf4(:,2), ex4, wf8(:,6), n3(:,7), t3x8(:,:,2))
  call prop_A_Q(ntry, wf16(:,4), Q(:,116), ZERO, 0_intkind1, wf16(:,5), n2(3))
  call vert_AV_Q(ntry, ex3, wf8(:,4), wf16(:,6), n3(:,8), t3x16(:,:,5))
  call prop_A_Q(ntry, wf16(:,6), Q(:,116), ZERO, 0_intkind1, wf16(:,7), n2(4))
  call vert_AV_Q(ntry, ex3, wf8(:,5), wf16(:,8), n3(:,9), t3x16(:,:,6))
  call prop_A_Q(ntry, wf16(:,8), Q(:,116), ZERO, 0_intkind1, wf16(:,9), n2(5))
  call vert_AV_Q(ntry, ex3, ex5, wf4(:,3), n3(:,10), t3x4(:,:,2))
  call vert_VQ_A(ntry, ex6, ex4, wf4(:,4), n3(:,11), t3x4(:,:,3))
  call prop_A_Q(ntry, wf4(:,3), Q(:,20), ZERO, 0_intkind1, wf4(:,5), n2(6))
  call prop_Q_A(ntry, wf4(:,4), Q(:,40), MB, 1_intkind1, wf4(:,6), n2(7))
  call vert_AV_Q(ntry, wf4(:,5), ex7, wf8(:,7), n3(:,12), t3x8(:,:,3))
  call vert_WQ_A(ntry, wf4(:,2), wf4(:,6), wf16(:,10), n3(:,13), t3x16(:,:,7))
  call prop_A_Q(ntry, wf8(:,7), Q(:,84), ZERO, 0_intkind1, wf8(:,8), n2(8))
  call vert_VQ_A(ntry, ex7, wf4(:,6), wf8(:,9), n3(:,14), t3x8(:,:,4))
  call vert_AW_Q(ntry, wf4(:,5), wf4(:,2), wf16(:,11), n3(:,15), t3x16(:,:,8))
  call prop_Q_A(ntry, wf8(:,9), Q(:,104), MB, 1_intkind1, wf8(:,10), n2(9))
  call vert_VQ_A(ntry, ex7, ex4, wf4(:,7), n3(:,16), t3x4(:,:,4))
  call prop_Q_A(ntry, wf4(:,7), Q(:,72), MB, 1_intkind1, wf4(:,8), n2(10))
  call vert_AV_Q(ntry, wf4(:,5), ex6, wf8(:,11), n3(:,17), t3x8(:,:,5))
  call vert_WQ_A(ntry, wf4(:,2), wf4(:,8), wf16(:,12), n3(:,18), t3x16(:,:,9))
  call prop_A_Q(ntry, wf8(:,11), Q(:,52), ZERO, 0_intkind1, wf8(:,12), n2(11))
  call vert_VQ_A(ntry, ex6, wf4(:,8), wf8(:,13), n3(:,19), t3x8(:,:,6))
  call prop_Q_A(ntry, wf8(:,13), Q(:,104), MB, 1_intkind1, wf8(:,14), n2(12))
  call vert_UV_W(ntry, ex6, Q(:,32), ex7, Q(:,64), wf4(:,9), n3(:,20), t3x4(:,:,5))
  call vert_AV_Q(ntry, wf4(:,5), wf4(:,9), wf16(:,13), n3(:,21), t3x16(:,:,10))
  call prop_Q_A(ntry, wf8(:,6), Q(:,11), ZERO, 0_intkind1, wf8(:,15), n2(13))
  call vert_VQ_A(ntry, wf4(:,9), ex4, wf8(:,16), n3(:,22), t3x8(:,:,7))
  call prop_Q_A(ntry, wf8(:,16), Q(:,104), MB, 1_intkind1, wf8(:,17), n2(14))
  call vert_VQ_A(ntry, ex7, wf8(:,15), wf16(:,14), n3(:,23), t3x16(:,:,11))
  call vert_VQ_A(ntry, ex6, wf8(:,15), wf16(:,15), n3(:,24), t3x16(:,:,12))
  call vert_AV_Q(ntry, ex3, ex6, wf4(:,10), n3(:,25), t3x4(:,:,6))
  call vert_VQ_A(ntry, ex5, ex4, wf4(:,11), n3(:,26), t3x4(:,:,7))
  call prop_A_Q(ntry, wf4(:,10), Q(:,36), ZERO, 0_intkind1, wf4(:,12), n2(15))
  call prop_Q_A(ntry, wf4(:,11), Q(:,24), MB, 1_intkind1, wf4(:,13), n2(16))
  call vert_AV_Q(ntry, wf4(:,12), ex7, wf8(:,18), n3(:,27), t3x8(:,:,8))
  call vert_WQ_A(ntry, wf4(:,2), wf4(:,13), wf16(:,16), n3(:,28), t3x16(:,:,13))
  call prop_A_Q(ntry, wf8(:,18), Q(:,100), ZERO, 0_intkind1, wf8(:,19), n2(17))
  call vert_VQ_A(ntry, ex7, wf4(:,13), wf8(:,20), n3(:,29), t3x8(:,:,9))
  call vert_AW_Q(ntry, wf4(:,12), wf4(:,2), wf16(:,17), n3(:,30), t3x16(:,:,14))
  call prop_Q_A(ntry, wf8(:,20), Q(:,88), MB, 1_intkind1, wf8(:,21), n2(18))
  call vert_AV_Q(ntry, ex3, ex7, wf4(:,14), n3(:,31), t3x4(:,:,8))
  call prop_A_Q(ntry, wf4(:,14), Q(:,68), ZERO, 0_intkind1, wf4(:,15), n2(19))
  call vert_AV_Q(ntry, wf4(:,15), ex6, wf8(:,22), n3(:,32), t3x8(:,:,10))
  call prop_A_Q(ntry, wf8(:,22), Q(:,100), ZERO, 0_intkind1, wf8(:,23), n2(20))
  call vert_VQ_A(ntry, ex6, wf4(:,13), wf8(:,24), n3(:,33), t3x8(:,:,11))
  call vert_AW_Q(ntry, wf4(:,15), wf4(:,2), wf16(:,18), n3(:,34), t3x16(:,:,15))
  call prop_Q_A(ntry, wf8(:,24), Q(:,56), MB, 1_intkind1, wf8(:,25), n2(21))
  call vert_VQ_A(ntry, wf4(:,9), wf4(:,13), wf16(:,19), n3(:,35), t3x16(:,:,16))
  call vert_AV_Q(ntry, ex3, wf4(:,9), wf8(:,26), n3(:,36), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,26), Q(:,100), ZERO, 0_intkind1, wf8(:,27), n2(22))
  call vert_AV_Q(ntry, wf8(:,3), ex6, wf16(:,20), n3(:,37), t3x16(:,:,17))
  call vert_AV_Q(ntry, wf8(:,3), ex7, wf16(:,21), n3(:,38), t3x16(:,:,18))
  call vert_AV_Q(ntry, wf4(:,12), ex5, wf8(:,28), n3(:,39), t3x8(:,:,13))
  call prop_A_Q(ntry, wf8(:,28), Q(:,52), ZERO, 0_intkind1, wf8(:,29), n2(23))
  call vert_VQ_A(ntry, ex5, wf4(:,8), wf8(:,30), n3(:,40), t3x8(:,:,14))
  call prop_Q_A(ntry, wf8(:,30), Q(:,88), MB, 1_intkind1, wf8(:,31), n2(24))
  call vert_UV_W(ntry, ex5, Q(:,16), ex7, Q(:,64), wf4(:,16), n3(:,41), t3x4(:,:,9))
  call vert_AV_Q(ntry, wf4(:,12), wf4(:,16), wf16(:,22), n3(:,42), t3x16(:,:,19))
  call vert_VQ_A(ntry, wf4(:,16), ex4, wf8(:,32), n3(:,43), t3x8(:,:,15))
  call prop_Q_A(ntry, wf8(:,32), Q(:,88), MB, 1_intkind1, wf8(:,33), n2(25))
  call vert_VQ_A(ntry, ex5, wf8(:,15), wf16(:,23), n3(:,44), t3x16(:,:,20))
  call vert_AV_Q(ntry, wf4(:,15), ex5, wf8(:,34), n3(:,45), t3x8(:,:,16))
  call prop_A_Q(ntry, wf8(:,34), Q(:,84), ZERO, 0_intkind1, wf8(:,35), n2(26))
  call vert_VQ_A(ntry, ex5, wf4(:,6), wf8(:,36), n3(:,46), t3x8(:,:,17))
  call prop_Q_A(ntry, wf8(:,36), Q(:,56), MB, 1_intkind1, wf8(:,37), n2(27))
  call vert_VQ_A(ntry, wf4(:,16), wf4(:,6), wf16(:,24), n3(:,47), t3x16(:,:,21))
  call vert_AV_Q(ntry, ex3, wf4(:,16), wf8(:,38), n3(:,48), t3x8(:,:,18))
  call prop_A_Q(ntry, wf8(:,38), Q(:,84), ZERO, 0_intkind1, wf8(:,39), n2(28))
  call vert_AV_Q(ntry, wf8(:,3), ex5, wf16(:,25), n3(:,49), t3x16(:,:,22))
  call vert_UV_W(ntry, ex5, Q(:,16), ex6, Q(:,32), wf4(:,17), n3(:,50), t3x4(:,:,10))
  call vert_AV_Q(ntry, wf4(:,15), wf4(:,17), wf16(:,26), n3(:,51), t3x16(:,:,23))
  call vert_VQ_A(ntry, wf4(:,17), ex4, wf8(:,40), n3(:,52), t3x8(:,:,19))
  call prop_Q_A(ntry, wf8(:,40), Q(:,56), MB, 1_intkind1, wf8(:,41), n2(29))
  call vert_VQ_A(ntry, wf4(:,17), wf4(:,8), wf16(:,27), n3(:,53), t3x16(:,:,24))
  call vert_AV_Q(ntry, ex3, wf4(:,17), wf8(:,42), n3(:,54), t3x8(:,:,20))
  call prop_A_Q(ntry, wf8(:,42), Q(:,52), ZERO, 0_intkind1, wf8(:,43), n2(30))
  call vert_UV_W(ntry, wf4(:,17), Q(:,48), ex7, Q(:,64), wf8(:,44), n3(:,55), t3x8(:,:,21))
  call vert_QA_V(ntry, ex4, wf8(:,3), wf16(:,28), n3(:,56), t3x16(:,:,25))
  call vert_QA_V(ntry, wf8(:,15), ex3, wf16(:,29), n3(:,57), t3x16(:,:,26))
  call vert_AV_Q(ntry, wf8(:,43), ex7, wf16(:,30), n3(:,58), t3x16(:,:,27))
  call vert_UV_W(ntry, ex6, Q(:,32), wf4(:,16), Q(:,80), wf8(:,45), n3(:,59), t3x8(:,:,22))
  call vert_AV_Q(ntry, wf8(:,39), ex6, wf16(:,31), n3(:,60), t3x16(:,:,28))
  call vert_UV_W(ntry, ex5, Q(:,16), wf4(:,9), Q(:,96), wf8(:,46), n3(:,61), t3x8(:,:,23))
  call vert_AV_Q(ntry, wf8(:,27), ex5, wf16(:,32), n3(:,62), t3x16(:,:,29))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_pplnjj_ckm_neexcxbggg_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_pplnjj_ckm_neexcxbggg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_pplnjj_ckm_neexcxbggg_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = (-A(j,1)%j+A(j,2)%j-A(j,4)%j+A(j,5)%j-A(j,9)%j-A(j,10)%j-A(j,13)%j-A(j,39)%j-A(j,41)%j-A(j,45)%j-A(j,51)%j &
       -A(j,53)%j)*f(1)+CI*(-A(j,11)%j-A(j,12)%j-A(j,37)%j-A(j,38)%j-A(j,42)%j-A(j,52)%j)*f(2)
  M1(2) = (-A(j,2)%j+A(j,3)%j-A(j,5)%j+A(j,6)%j-A(j,7)%j-A(j,8)%j-A(j,14)%j-A(j,33)%j+A(j,47)%j+A(j,49)%j+A(j,51)%j &
       +A(j,53)%j)*f(1)+CI*(A(j,11)%j+A(j,12)%j-A(j,31)%j-A(j,32)%j-A(j,50)%j+A(j,52)%j)*f(2)
  M1(3) = (A(j,1)%j-A(j,3)%j+A(j,4)%j-A(j,6)%j-A(j,23)%j-A(j,24)%j-A(j,27)%j+A(j,39)%j+A(j,41)%j-A(j,46)%j-A(j,47)%j &
       -A(j,49)%j)*f(1)+CI*(-A(j,25)%j-A(j,26)%j+A(j,37)%j+A(j,38)%j+A(j,42)%j-A(j,48)%j)*f(2)
  M1(4) = (-A(j,2)%j+A(j,3)%j-A(j,5)%j+A(j,6)%j-A(j,15)%j-A(j,16)%j-A(j,21)%j-A(j,28)%j+A(j,47)%j+A(j,49)%j+A(j,51)%j &
       +A(j,53)%j)*f(1)+CI*(-A(j,19)%j-A(j,20)%j+A(j,25)%j+A(j,26)%j+A(j,48)%j-A(j,54)%j)*f(2)
  M1(5) = (A(j,1)%j-A(j,3)%j+A(j,4)%j-A(j,6)%j-A(j,29)%j-A(j,30)%j-A(j,34)%j+A(j,39)%j+A(j,41)%j-A(j,43)%j-A(j,47)%j &
       -A(j,49)%j)*f(1)+CI*(A(j,31)%j+A(j,32)%j-A(j,35)%j-A(j,36)%j-A(j,40)%j+A(j,50)%j)*f(2)
  M1(6) = (-A(j,1)%j+A(j,2)%j-A(j,4)%j+A(j,5)%j-A(j,17)%j-A(j,18)%j-A(j,22)%j-A(j,39)%j-A(j,41)%j-A(j,44)%j-A(j,51)%j &
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_pplnjj_ckm_neexcxbggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pplnjj_ckm_neexcxbggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pplnjj_ckm_neexcxbggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pplnjj_ckm_neexcxbggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pplnjj_ckm_neexcxbggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pplnjj_ckm_neexcxbggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pplnjj_ckm_neexcxbggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pplnjj_ckm_neexcxbggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pplnjj_ckm_neexcxbggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pplnjj_ckm_neexcxbggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pplnjj_ckm_neexcxbggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pplnjj_ckm_neexcxbggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pplnjj_ckm_neexcxbggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pplnjj_ckm_neexcxbggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pplnjj_ckm_neexcxbggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pplnjj_ckm_neexcxbggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pplnjj_ckm_neexcxbggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_pplnjj_ckm_neexcxbggg_1_/**/REALKIND
