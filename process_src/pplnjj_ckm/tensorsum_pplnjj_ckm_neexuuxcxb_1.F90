...
! **********************************************************************
module ol_tensor_sum_storage_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplnjj_ckm_neexuuxcxb_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplnjj_ckm_neexuuxcxb_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pplnjj_ckm_neexuuxcxb_1, only: channel_number_pplnjj_ckm_neexuuxcxb_1
  ...
  call channel_on(channel_number_pplnjj_ckm_neexuuxcxb_1)
  M2 = 0
  ...
  momenta_19(:,3) = Q(1:4,51)
  momenta_19(:,4) = Q(1:4,59)
  momenta_20(:,1) = Q(1:4,32)
  momenta_20(:,2) = Q(1:4,35)
  momenta_20(:,3) = Q(1:4,51)
  ...
  call TI_call(2, momenta_8, masses2_5, T2sum(:,1), M2)
  call TI_call(2, momenta_6, masses2_6, T2sum(:,2), M2)
  call TI_call(2, momenta_9, masses2_7, T2sum(:,3), M2)
  call TI_call(2, momenta_5, masses2_7, T2sum(:,4), M2)
  call TI_call(2, momenta_7, masses2_6, T2sum(:,5), M2)
  ...
  call TI_call(2, momenta_14, masses2_9, T2sum(:,10), M2)
  ...
  call TI_call(3, momenta_16, masses2_8, T3sum(:,1), M2)
  ...
  call channel_off(channel_number_pplnjj_ckm_neexuuxcxb_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
