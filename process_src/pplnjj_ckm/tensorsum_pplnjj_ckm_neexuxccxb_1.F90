...
! **********************************************************************
  use ol_external_pplnjj_ckm_neexuxccxb_1, only: channel_number_pplnjj_ckm_neexuxccxb_1
  ...
  call channel_on(channel_number_pplnjj_ckm_neexuxccxb_1)
  M2 = 0
  ...
  call channel_off(channel_number_pplnjj_ckm_neexuxccxb_1)
