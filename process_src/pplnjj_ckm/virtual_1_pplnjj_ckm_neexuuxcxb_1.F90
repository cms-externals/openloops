...
module ol_vamp_1_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplnjj_ckm_neexuuxcxb_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplnjj_ckm_neexuuxcxb_1.
! **********************************************************************
...
#endif
  use ol_loop_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_Q_A(G1(:,:,:,2),Q(:,44),MB,G2(:,:,:,1))
  ...
  call loop_A_Q(G0(:,:,:,3),Q(:,19),MB,G1(:,:,:,6))
  call loop_AQ_V(G1(:,:,:,6),wf(:,-5),G1(:,:,:,7))
  ...
  call loop_AW_Q(G1(:,:,:,13),wf(:,3),G1(:,:,:,16))
  call loop_A_Q(G1(:,:,:,16),Q(:,19),MB,G2(:,:,:,12))
  call loop_AQ_V(G2(:,:,:,12),wf(:,-5),G2(:,:,:,13))
  ...
  call loop_VQ_A(G0(:,:,:,1),wf(:,15),G0(:,:,:,6))
  call loop_Q_A(G0(:,:,:,6),Q(:,44),MB,G1(:,:,:,17))
  call loop_QW_A(G1(:,:,:,17),wf(:,3),G1(:,:,:,18))
  call loop_Q_A(G1(:,:,:,18),Q(:,47),ZERO,G2(:,:,:,15))
  call check_last_QA_V(l_switch,G2(:,:,:,15),wf(:,-4),G2tensor(:,10))
  call check_last_QA_V(l_switch,G1(:,:,:,17),wf(:,6),G1tensor(:,2))
...
end module ol_vamp_1_pplnjj_ckm_neexuuxcxb_1_/**/REALKIND
