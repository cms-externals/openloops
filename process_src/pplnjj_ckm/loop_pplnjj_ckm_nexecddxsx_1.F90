...
module ol_colourmatrix_pplnjj_ckm_nexecddxsx_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_ckm_nexecddxsx_1_/**/REALKIND



module ol_forced_parameters_pplnjj_ckm_nexecddxsx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_ckm_nexecddxsx_1_/**/REALKIND

module ol_loop_pplnjj_ckm_nexecddxsx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctqq,wf(:,6),Q(:,7),wf(:,22))
...
end module ol_loop_pplnjj_ckm_nexecddxsx_1_/**/REALKIND
