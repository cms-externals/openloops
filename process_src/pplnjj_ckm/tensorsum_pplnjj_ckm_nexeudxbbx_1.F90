...
! **********************************************************************
module ol_tensor_sum_storage_pplnjj_ckm_nexeudxbbx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplnjj_ckm_nexeudxbbx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplnjj_ckm_nexeudxbbx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pplnjj_ckm_nexeudxbbx_1, only: channel_number_pplnjj_ckm_nexeudxbbx_1
  ...
  call channel_on(channel_number_pplnjj_ckm_nexeudxbbx_1)
  M2 = 0
  ...
  call channel_off(channel_number_pplnjj_ckm_nexeudxbbx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplnjj_ckm_nexeudxbbx_1_/**/REALKIND
