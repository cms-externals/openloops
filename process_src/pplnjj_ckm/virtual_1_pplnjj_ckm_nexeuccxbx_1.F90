...
module ol_vamp_1_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplnjj_ckm_nexeuccxbx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplnjj_ckm_nexeuccxbx_1.
! **********************************************************************
...
#endif
  use ol_loop_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND
...
end module ol_vamp_1_pplnjj_ckm_nexeuccxbx_1_/**/REALKIND
