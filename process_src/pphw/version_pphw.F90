...
module ol_versiondata_pphw
  ...
  interface
    ...
    end subroutine version_pphw
  end interface
end module ol_versiondata_pphw


subroutine ol_version_pphw(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphw, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphw
