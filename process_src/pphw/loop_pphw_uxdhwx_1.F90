...
module ol_colourmatrix_pphw_uxdhwx_1_/**/REALKIND
...
end module ol_colourmatrix_pphw_uxdhwx_1_/**/REALKIND



module ol_forced_parameters_pphw_uxdhwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphw_uxdhwx_1_/**/REALKIND

module ol_loop_pphw_uxdhwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**2*lambdaHWW*MW)/(sqrt2*sw**2)
    f(3) = (eQED**2*gQCD**2*integralnorm*lambdaHWW*MW*SwB)/(sqrt2*sw**2)
...
! **********************************************************************
  ...
  call counter_QA_W(wf(:,-1),wf(:,0),wf(:,4))
...
end module ol_loop_pphw_uxdhwx_1_/**/REALKIND
