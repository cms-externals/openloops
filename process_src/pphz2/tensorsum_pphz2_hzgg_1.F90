...
! **********************************************************************
module ol_tensor_sum_storage_pphz2_hzgg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphz2_hzgg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphz2_hzgg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pphz2_hzgg_1, only: channel_number_pphz2_hzgg_1
  ...
  call channel_on(channel_number_pphz2_hzgg_1)
  M2 = 0
  ...
  call tensor_integral(4, momenta_2, masses2_5, T4sum(:,3))
  call tensor_integral(4, momenta_2, masses2_4, T4sum(:,4))
  ...
  call channel_off(channel_number_pphz2_hzgg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphz2_hzgg_1_/**/REALKIND
