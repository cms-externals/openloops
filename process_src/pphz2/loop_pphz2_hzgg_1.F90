...
module ol_colourmatrix_pphz2_hzgg_1_/**/REALKIND
...
end module ol_colourmatrix_pphz2_hzgg_1_/**/REALKIND



module ol_forced_parameters_pphz2_hzgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphz2_hzgg_1_/**/REALKIND

module ol_loop_pphz2_hzgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = (countertermnorm*ctZGG*eQED**2*gQCD**2*lambdaHZZ*MW)/(cw**2*sw)
    f(2) = (eQED**2*gQCD**2*integralnorm*lambdaHZZ*MW*SwF)/(cw**2*sw)
    f(3) = (2*eQED**2*gQCD**2*integralnorm*lambdaHZZ*MW*SwF)/(cw**2*sw)
    f(4) = (eQED**2*gQCD**2*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f(5) = (eQED**2*gQCD**2*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_GG_V(wf(:,-2),Q(:,4),wf(:,-3),Q(:,8),wf(:,2))
...
end module ol_loop_pphz2_hzgg_1_/**/REALKIND
