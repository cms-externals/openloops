...
module ol_versiondata_ppln
  implicit none
  character(4) :: generator_revision = "1500"
  interface
    subroutine version_ppln(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppln
  end interface
end module ol_versiondata_ppln


subroutine ol_version_ppln(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppln, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppln
