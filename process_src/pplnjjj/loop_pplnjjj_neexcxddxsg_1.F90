...
module ol_colourmatrix_pplnjjj_neexcxddxsg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjjj_neexcxddxsg_1_/**/REALKIND



module ol_forced_parameters_pplnjjj_neexcxddxsg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjjj_neexcxddxsg_1_/**/REALKIND

module ol_loop_pplnjjj_neexcxddxsg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (CI*countertermnorm*ctGcc*eQED**2*gQCD**5)/(2._/**/REALKIND*sw**2)
    f( 6) = (countertermnorm*ctGcc*eQED**2*gQCD**5)/(sw**2*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call vert_QA_V(wf(:,-5),wf(:,16),wf(:,21))
  ...
  call prop_Q_A(wf(:,25),Q(:,72),ZERO,0_intkind1,wf(:,26))
  call vert_QA_V(wf(:,26),wf(:,-4),wf(:,27))
  call vert_AV_Q(wf(:,-2),wf(:,27),wf(:,28))
  call vert_AV_Q(wf(:,-4),wf(:,-6),wf(:,29))
  call prop_A_Q(wf(:,29),Q(:,80),ZERO,0_intkind1,wf(:,30))
  call vert_QA_V(wf(:,-3),wf(:,30),wf(:,31))
  call vert_AV_Q(wf(:,-2),wf(:,31),wf(:,32))
  call counter_AV_Q(wf(:,5),wf(:,3),wf(:,33))
  call counter_AW_Q(wf(:,5),wf(:,4),wf(:,34))
  call counter_VQ_A(wf(:,3),wf(:,13),wf(:,35))
  call counter_WQ_A(wf(:,4),wf(:,13),wf(:,36))
  call counter_UV_W(wf(:,3),Q(:,24),wf(:,-6),Q(:,64),wf(:,37))
  call counter_AV_Q(wf(:,16),wf(:,-6),wf(:,38))
  call counter_AV_Q(wf(:,19),wf(:,-6),wf(:,39))
  call counter_VQ_A(wf(:,3),wf(:,-5),wf(:,40))
  call prop_A_Q(wf(:,10),Q(:,71),ZERO,0_intkind1,wf(:,41))
  call counter_WQ_A(wf(:,4),wf(:,-5),wf(:,42))
  call prop_A_Q(wf(:,7),Q(:,92),ZERO,0_intkind1,wf(:,43))
  call prop_Q_A(wf(:,40),Q(:,56),ZERO,0_intkind1,wf(:,44))
  call counter_QA_V(wf(:,-5),wf(:,16),wf(:,45))
  call prop_Q_A(wf(:,42),Q(:,35),ZERO,0_intkind1,wf(:,46))
  call vert_QA_V(wf(:,46),wf(:,-2),wf(:,47))
  call counter_VQ_A(wf(:,-6),wf(:,-5),wf(:,48))
  call prop_Q_A(wf(:,48),Q(:,96),ZERO,0_intkind1,wf(:,49))
  call vert_VQ_A(wf(:,3),wf(:,49),wf(:,50))
  call vert_WQ_A(wf(:,4),wf(:,49),wf(:,51))
  call counter_QA_V(wf(:,26),wf(:,-4),wf(:,52))
  call vert_AV_Q(wf(:,-2),wf(:,52),wf(:,53))
  call counter_AV_Q(wf(:,-4),wf(:,-6),wf(:,54))
  call prop_A_Q(wf(:,54),Q(:,80),ZERO,0_intkind1,wf(:,55))
  call vert_QA_V(wf(:,-3),wf(:,55),wf(:,56))
  call vert_AV_Q(wf(:,-2),wf(:,56),wf(:,57))
  call counter_QA_V(wf(:,-3),wf(:,30),wf(:,58))
  call vert_AV_Q(wf(:,-2),wf(:,58),wf(:,59))
  call counter_VQ_A(wf(:,-6),wf(:,-3),wf(:,60))
  call prop_Q_A(wf(:,60),Q(:,72),ZERO,0_intkind1,wf(:,61))
  call vert_QA_V(wf(:,61),wf(:,-4),wf(:,62))
  call vert_AV_Q(wf(:,-2),wf(:,62),wf(:,63))
  call counter_QA_V(wf(:,-3),wf(:,-4),wf(:,64))
  call vert_AV_Q(wf(:,5),wf(:,64),wf(:,65))
  call vert_VQ_A(wf(:,64),wf(:,-5),wf(:,66))
  call prop_Q_A(wf(:,66),Q(:,56),ZERO,0_intkind1,wf(:,67))
  call vert_VQ_A(wf(:,64),wf(:,13),wf(:,68))
  call vert_AV_Q(wf(:,-2),wf(:,64),wf(:,69))
  call prop_A_Q(wf(:,69),Q(:,28),ZERO,0_intkind1,wf(:,70))
  call vert_UV_W(wf(:,64),Q(:,24),wf(:,-6),Q(:,64),wf(:,71))
  call vert_AV_Q(wf(:,70),wf(:,-6),wf(:,72))
  call counter_AV_Q(wf(:,-2),wf(:,3),wf(:,73))
  call prop_Q_A(wf(:,18),Q(:,99),ZERO,0_intkind1,wf(:,74))
  call counter_AW_Q(wf(:,-2),wf(:,4),wf(:,75))
  call prop_Q_A(wf(:,15),Q(:,120),ZERO,0_intkind1,wf(:,76))
  call prop_A_Q(wf(:,73),Q(:,28),ZERO,0_intkind1,wf(:,77))
  call vert_AV_Q(wf(:,77),wf(:,-6),wf(:,78))
  call counter_QA_V(wf(:,8),wf(:,-2),wf(:,79))
  call prop_A_Q(wf(:,75),Q(:,7),ZERO,0_intkind1,wf(:,80))
  call vert_QA_V(wf(:,-5),wf(:,80),wf(:,81))
  call vert_AV_Q(wf(:,80),wf(:,-6),wf(:,82))
  call counter_AV_Q(wf(:,-2),wf(:,-6),wf(:,83))
  call prop_A_Q(wf(:,83),Q(:,68),ZERO,0_intkind1,wf(:,84))
  call vert_AV_Q(wf(:,84),wf(:,3),wf(:,85))
  call vert_AW_Q(wf(:,84),wf(:,4),wf(:,86))
  call counter_AV_Q(wf(:,-2),wf(:,27),wf(:,87))
  call counter_AV_Q(wf(:,-2),wf(:,31),wf(:,88))
  call counter_A_Q(ctcc,wf(:,5),Q(:,68),wf(:,89))
  call prop_A_Q(wf(:,89),Q(:,68),ZERO,0_intkind1,wf(:,90))
  call vert_AV_Q(wf(:,90),wf(:,3),wf(:,91))
  call vert_AW_Q(wf(:,90),wf(:,4),wf(:,92))
  call counter_V_V(ctGG,wf(:,3),Q(:,24),wf(:,93))
  call vert_VQ_A(wf(:,93),wf(:,-5),wf(:,94))
  call vert_AV_Q(wf(:,5),wf(:,93),wf(:,95))
  call counter_Q_A(ctcc,wf(:,8),Q(:,35),wf(:,96))
  call counter_Q_A(ctqq,wf(:,11),Q(:,56),wf(:,97))
  call vert_AV_Q(wf(:,-2),wf(:,93),wf(:,98))
  call counter_A_Q(ctqq,wf(:,16),Q(:,7),wf(:,99))
  call counter_A_Q(ctcc,wf(:,19),Q(:,28),wf(:,100))
  call vert_AV_Q(wf(:,16),wf(:,93),wf(:,101))
  call counter_Q_A(ctqq,wf(:,13),Q(:,96),wf(:,102))
  call prop_Q_A(wf(:,102),Q(:,96),ZERO,0_intkind1,wf(:,103))
  call vert_QA_V(wf(:,103),wf(:,16),wf(:,104))
  call vert_WQ_A(wf(:,4),wf(:,103),wf(:,105))
  call vert_VQ_A(wf(:,-6),wf(:,8),wf(:,106))
  call prop_A_Q(wf(:,98),Q(:,28),ZERO,0_intkind1,wf(:,107))
  call vert_VQ_A(wf(:,20),wf(:,-5),wf(:,108))
  call prop_Q_A(wf(:,108),Q(:,120),ZERO,0_intkind1,wf(:,109))
  call vert_AV_Q(wf(:,-2),wf(:,20),wf(:,110))
  call prop_A_Q(wf(:,110),Q(:,92),ZERO,0_intkind1,wf(:,111))
  call vert_VQ_A(wf(:,-6),wf(:,11),wf(:,112))
  call prop_Q_A(wf(:,112),Q(:,120),ZERO,0_intkind1,wf(:,113))
  call prop_Q_A(wf(:,106),Q(:,99),ZERO,0_intkind1,wf(:,114))
  call counter_V_V(ctGG,wf(:,20),Q(:,88),wf(:,115))
  call prop_Q_A(wf(:,94),Q(:,56),ZERO,0_intkind1,wf(:,116))
  call vert_UV_W(wf(:,93),Q(:,24),wf(:,-6),Q(:,64),wf(:,117))
  call prop_A_Q(wf(:,22),Q(:,71),ZERO,0_intkind1,wf(:,118))
  call prop_A_Q(wf(:,23),Q(:,92),ZERO,0_intkind1,wf(:,119))
  call counter_V_V(ctGG,wf(:,27),Q(:,88),wf(:,120))
  call vert_VQ_A(wf(:,27),wf(:,-5),wf(:,121))
  call prop_Q_A(wf(:,121),Q(:,120),ZERO,0_intkind1,wf(:,122))
  call prop_A_Q(wf(:,28),Q(:,92),ZERO,0_intkind1,wf(:,123))
  call counter_Q_A(ctqq,wf(:,26),Q(:,72),wf(:,124))
  call prop_Q_A(wf(:,124),Q(:,72),ZERO,0_intkind1,wf(:,125))
  call vert_QA_V(wf(:,125),wf(:,-4),wf(:,126))
  call counter_V_V(ctGG,wf(:,31),Q(:,88),wf(:,127))
  call vert_VQ_A(wf(:,31),wf(:,-5),wf(:,128))
  call prop_Q_A(wf(:,128),Q(:,120),ZERO,0_intkind1,wf(:,129))
  call prop_A_Q(wf(:,32),Q(:,92),ZERO,0_intkind1,wf(:,130))
  call counter_A_Q(ctqq,wf(:,30),Q(:,80),wf(:,131))
  call prop_A_Q(wf(:,131),Q(:,80),ZERO,0_intkind1,wf(:,132))
  call vert_QA_V(wf(:,-3),wf(:,132),wf(:,133))
  call vert_AV_Q(wf(:,16),wf(:,3),wf(:,134))
  call prop_A_Q(wf(:,134),Q(:,31),ZERO,0_intkind1,wf(:,135))
  call vert_VQ_A(wf(:,3),wf(:,8),wf(:,136))
  call prop_Q_A(wf(:,136),Q(:,59),ZERO,0_intkind1,wf(:,137))
  call vert_AW_Q(wf(:,19),wf(:,4),wf(:,138))
  call prop_A_Q(wf(:,138),Q(:,31),ZERO,0_intkind1,wf(:,139))
  call vert_WQ_A(wf(:,4),wf(:,11),wf(:,140))
  call prop_Q_A(wf(:,140),Q(:,59),ZERO,0_intkind1,wf(:,141))
  call vert_QA_V(wf(:,8),wf(:,5),wf(:,142))
  call vert_QA_V(wf(:,-5),wf(:,41),wf(:,143))
  call vert_QA_V(wf(:,13),wf(:,16),wf(:,144))
  call vert_QA_V(wf(:,74),wf(:,-2),wf(:,145))
  call vert_VQ_A(wf(:,21),wf(:,-3),wf(:,146))
  call prop_Q_A(wf(:,146),Q(:,47),ZERO,0_intkind1,wf(:,147))
  call vert_AV_Q(wf(:,-4),wf(:,21),wf(:,148))
  call prop_A_Q(wf(:,148),Q(:,55),ZERO,0_intkind1,wf(:,149))
  call vert_UV_W(wf(:,21),Q(:,39),wf(:,-6),Q(:,64),wf(:,150))
  call vert_QA_V(wf(:,-5),wf(:,118),wf(:,151))
  call vert_VQ_A(wf(:,24),wf(:,-3),wf(:,152))
  call prop_Q_A(wf(:,152),Q(:,47),ZERO,0_intkind1,wf(:,153))
  call vert_AV_Q(wf(:,-4),wf(:,24),wf(:,154))
  call prop_A_Q(wf(:,154),Q(:,55),ZERO,0_intkind1,wf(:,155))
  call vert_UV_W(wf(:,24),Q(:,39),wf(:,-6),Q(:,64),wf(:,156))
  call vert_QA_V(wf(:,114),wf(:,-2),wf(:,157))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(1)-A(2)-A(6)-A(9)-A(10))*f(1))/2._/**/REALKIND+(CI*(A(5)+A(8))*f(2))/2._/**/REALKIND
  M1(2) = ((A(1)+A(2)+A(3)+A(4)+A(6)+A(7))*f(1))/6._/**/REALKIND
  M1(3) = ((A(9)+A(10)+A(11)+A(12))*f(1))/6._/**/REALKIND
  M1(4) = ((-A(3)-A(4)-A(7)-A(11)-A(12))*f(1))/2._/**/REALKIND+(CI*(-A(5)-A(8))*f(2))/2._/**/REALKIND

  M2(1) = ((A(61)+A(62)+A(63)+A(64)+A(65)+A(66)+A(76)+A(79)+A(83)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90))*f(3))/2._/**/REALKIND+(CI*( &
       -A(74)-A(75)-A(78)-A(80)-A(81)-A(82))*f(4))/2._/**/REALKIND+((-A(13)-A(55)-A(56)-A(57))*f(5))/2._/**/REALKIND &
       +(CI*A(52)*f(6))/2._/**/REALKIND+((-A(18)-A(21)-A(23)-A(29)-A(33)-A(34)-A(39)-A(40)-A(41)-A(42) &
       -A(46))*f(7))/2._/**/REALKIND+(CI*(A(24)+A(45)+A(47))*f(8))/2._/**/REALKIND+((-A(14)-A(22)-A(30)-A(54) &
       -A(58))*f(9))/2._/**/REALKIND+(CI*(A(26)+A(53))*f(10))/2._/**/REALKIND+(CI*(A(17)+A(20))*f(11))/2._/**/REALKIND
  M2(2) = ((-A(61)-A(62)-A(63)-A(64)-A(65)-A(66)-A(67)-A(68)-A(69)-A(70)-A(71)-A(72)-A(73)-A(76)-A(77)-A(79)-A(83) &
       -A(84))*f(3))/6._/**/REALKIND+((A(13)+A(19)+A(49)+A(51)+A(55)+A(56))*f(5))/6._/**/REALKIND+((A(15)+A(18)+A(21)+A(23)+A(27) &
       +A(28)+A(41)+A(42)+A(43)+A(44)+A(46)+A(48))*f(7))/6._/**/REALKIND+((A(14)+A(16)+A(22)+A(25)+A(50) &
       +A(54))*f(9))/6._/**/REALKIND
  M2(3) = ((-A(85)-A(86)-A(87)-A(88)-A(89)-A(90)-A(91)-A(92)-A(93)-A(94)-A(95)-A(96))*f(3))/6._/**/REALKIND+((A(57) &
       +A(59))*f(5))/6._/**/REALKIND+((A(29)+A(31)+A(33)+A(34)+A(35)+A(36)+A(37)+A(38)+A(39)+A(40))*f(7))/6._/**/REALKIND+((A(30) &
       +A(32)+A(58)+A(60))*f(9))/6._/**/REALKIND
  M2(4) = ((A(67)+A(68)+A(69)+A(70)+A(71)+A(72)+A(73)+A(77)+A(84)+A(91)+A(92)+A(93)+A(94)+A(95)+A(96))*f(3))/2._/**/REALKIND &
       +(CI*(A(74)+A(75)+A(78)+A(80)+A(81)+A(82))*f(4))/2._/**/REALKIND+((-A(19)-A(49)-A(51)-A(59))*f(5))/2._/**/REALKIND &
       -(CI*A(52)*f(6))/2._/**/REALKIND+((-A(15)-A(27)-A(28)-A(31)-A(35)-A(36)-A(37)-A(38)-A(43)-A(44) &
       -A(48))*f(7))/2._/**/REALKIND+(CI*(-A(24)-A(45)-A(47))*f(8))/2._/**/REALKIND+((-A(16)-A(25)-A(32)-A(50) &
       -A(60))*f(9))/2._/**/REALKIND+(CI*(-A(26)-A(53))*f(10))/2._/**/REALKIND+(CI*(-A(17)-A(20))*f(11))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplnjjj_neexcxddxsg_1_/**/REALKIND
