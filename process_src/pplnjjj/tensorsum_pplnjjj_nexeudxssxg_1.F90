...
! **********************************************************************
module ol_tensor_sum_storage_pplnjjj_nexeudxssxg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplnjjj_nexeudxssxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplnjjj_nexeudxssxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pplnjjj_nexeudxssxg_1, only: channel_number_pplnjjj_nexeudxssxg_1
  ...
  call channel_on(channel_number_pplnjjj_nexeudxssxg_1)
  M2 = 0
  ...
  call TI_call(1, momenta_8, masses2_3, T1sum(:,9), M2)

  call TI_call(2, momenta_43, masses2_6, T2sum(:,1), M2)
  call TI_call(2, momenta_44, masses2_6, T2sum(:,2), M2)
  ...
  call TI_call(2, momenta_21, masses2_6, T2sum(:,7), M2)
  call TI_call(2, momenta_34, masses2_6, T2sum(:,8), M2)
  call TI_call(2, momenta_45, masses2_6, T2sum(:,9), M2)
  ...
  call TI_call(2, momenta_12, masses2_6, T2sum(:,18), M2)
  ...
  call TI_call(2, momenta_13, masses2_6, T2sum(:,23), M2)
  ...
  call TI_call(2, momenta_63, masses2_7, T2sum(:,27), M2)
  call TI_call(2, momenta_54, masses2_7, T2sum(:,28), M2)
  call TI_call(2, momenta_55, masses2_7, T2sum(:,29), M2)
  call TI_call(2, momenta_64, masses2_7, T2sum(:,30), M2)
  call TI_call(2, momenta_56, masses2_7, T2sum(:,31), M2)
  call TI_call(2, momenta_65, masses2_7, T2sum(:,32), M2)
  call TI_call(2, momenta_57, masses2_7, T2sum(:,33), M2)
  call TI_call(2, momenta_66, masses2_7, T2sum(:,34), M2)
  call TI_call(2, momenta_41, masses2_6, T2sum(:,35), M2)
  call TI_call(2, momenta_17, masses2_6, T2sum(:,36), M2)
  call TI_call(2, momenta_91, masses2_7, T2sum(:,37), M2)
  call TI_call(2, momenta_68, masses2_7, T2sum(:,38), M2)
  call TI_call(2, momenta_69, masses2_7, T2sum(:,39), M2)
  call TI_call(2, momenta_92, masses2_7, T2sum(:,40), M2)
  call TI_call(2, momenta_42, masses2_6, T2sum(:,41), M2)
  call TI_call(2, momenta_14, masses2_6, T2sum(:,42), M2)
  call TI_call(2, momenta_93, masses2_7, T2sum(:,43), M2)
  call TI_call(2, momenta_59, masses2_7, T2sum(:,44), M2)
  call TI_call(2, momenta_60, masses2_7, T2sum(:,45), M2)
  call TI_call(2, momenta_94, masses2_7, T2sum(:,46), M2)
  call TI_call(2, momenta_15, masses2_6, T2sum(:,47), M2)
  call TI_call(2, momenta_28, masses2_6, T2sum(:,48), M2)
  call TI_call(2, momenta_18, masses2_6, T2sum(:,49), M2)
  call TI_call(2, momenta_29, masses2_6, T2sum(:,50), M2)
  call TI_call(2, momenta_9, masses2_3, T2sum(:,51), M2)
  call TI_call(2, momenta_6, masses2_3, T2sum(:,52), M2)
  call TI_call(2, momenta_6, masses2_2, T2sum(:,53), M2)
  call TI_call(2, momenta_6, masses2_1, T2sum(:,54), M2)
  call TI_call(2, momenta_9, masses2_2, T2sum(:,55), M2)
  call TI_call(2, momenta_9, masses2_1, T2sum(:,56), M2)

  call TI_call(3, momenta_95, masses2_7, T3sum(:,1), M2)
  call TI_call(3, momenta_88, masses2_7, T3sum(:,2), M2)
  call TI_call(3, momenta_74, masses2_7, T3sum(:,3), M2)
  call TI_call(3, momenta_87, masses2_7, T3sum(:,4), M2)
  call TI_call(3, momenta_90, masses2_7, T3sum(:,5), M2)
  call TI_call(3, momenta_75, masses2_7, T3sum(:,6), M2)
  call TI_call(3, momenta_89, masses2_7, T3sum(:,7), M2)
  call TI_call(3, momenta_19, masses2_6, T3sum(:,8), M2)
  call TI_call(3, momenta_19, masses2_5, T3sum(:,9), M2)
  call TI_call(3, momenta_19, masses2_4, T3sum(:,10), M2)
  call TI_call(3, momenta_49, masses2_7, T3sum(:,11), M2)
  call TI_call(3, momenta_72, masses2_7, T3sum(:,12), M2)
  call TI_call(3, momenta_70, masses2_7, T3sum(:,13), M2)
  call TI_call(3, momenta_80, masses2_7, T3sum(:,14), M2)
  call TI_call(3, momenta_48, masses2_7, T3sum(:,15), M2)
  call TI_call(3, momenta_83, masses2_7, T3sum(:,16), M2)
  call TI_call(3, momenta_51, masses2_7, T3sum(:,17), M2)
  call TI_call(3, momenta_84, masses2_7, T3sum(:,18), M2)
  call TI_call(3, momenta_71, masses2_7, T3sum(:,19), M2)
  call TI_call(3, momenta_81, masses2_7, T3sum(:,20), M2)
  call TI_call(3, momenta_52, masses2_7, T3sum(:,21), M2)
  call TI_call(3, momenta_73, masses2_7, T3sum(:,22), M2)
  call TI_call(3, momenta_85, masses2_7, T3sum(:,23), M2)
  call TI_call(3, momenta_76, masses2_7, T3sum(:,24), M2)
  call TI_call(3, momenta_77, masses2_7, T3sum(:,25), M2)
  call TI_call(3, momenta_86, masses2_7, T3sum(:,26), M2)
  call TI_call(3, momenta_78, masses2_7, T3sum(:,27), M2)
  call TI_call(3, momenta_79, masses2_7, T3sum(:,28), M2)
  call TI_call(3, momenta_50, masses2_7, T3sum(:,29), M2)
  call TI_call(3, momenta_47, masses2_7, T3sum(:,30), M2)
  call TI_call(3, momenta_106, masses2_8, T3sum(:,31), M2)
  call TI_call(3, momenta_115, masses2_8, T3sum(:,32), M2)
  call TI_call(3, momenta_107, masses2_8, T3sum(:,33), M2)
  call TI_call(3, momenta_116, masses2_8, T3sum(:,34), M2)
  call TI_call(3, momenta_119, masses2_8, T3sum(:,35), M2)
  call TI_call(3, momenta_130, masses2_8, T3sum(:,36), M2)
  call TI_call(3, momenta_110, masses2_8, T3sum(:,37), M2)
  call TI_call(3, momenta_131, masses2_8, T3sum(:,38), M2)
  call TI_call(3, momenta_61, masses2_7, T3sum(:,39), M2)
  call TI_call(3, momenta_62, masses2_7, T3sum(:,40), M2)
  call TI_call(3, momenta_67, masses2_7, T3sum(:,41), M2)
  call TI_call(3, momenta_53, masses2_7, T3sum(:,42), M2)
  call TI_call(3, momenta_58, masses2_7, T3sum(:,43), M2)
  call TI_call(3, momenta_82, masses2_7, T3sum(:,44), M2)
  call TI_call(3, momenta_111, masses2_8, T3sum(:,45), M2)
  call TI_call(3, momenta_127, masses2_8, T3sum(:,46), M2)
  call TI_call(3, momenta_117, masses2_8, T3sum(:,47), M2)
  call TI_call(3, momenta_102, masses2_8, T3sum(:,48), M2)
  call TI_call(3, momenta_125, masses2_8, T3sum(:,49), M2)
  call TI_call(3, momenta_108, masses2_8, T3sum(:,50), M2)
  call TI_call(3, momenta_113, masses2_8, T3sum(:,51), M2)
  call TI_call(3, momenta_104, masses2_8, T3sum(:,52), M2)
  call TI_call(3, momenta_103, masses2_8, T3sum(:,53), M2)
  call TI_call(3, momenta_105, masses2_8, T3sum(:,54), M2)
  call TI_call(3, momenta_109, masses2_8, T3sum(:,55), M2)
  call TI_call(3, momenta_112, masses2_8, T3sum(:,56), M2)
  call TI_call(3, momenta_114, masses2_8, T3sum(:,57), M2)
  call TI_call(3, momenta_118, masses2_8, T3sum(:,58), M2)
  call TI_call(3, momenta_126, masses2_8, T3sum(:,59), M2)
  call TI_call(3, momenta_128, masses2_8, T3sum(:,60), M2)

  call TI_call(4, momenta_96, masses2_8, T4sum(:,1), M2)
  call TI_call(4, momenta_98, masses2_8, T4sum(:,2), M2)
  call TI_call(4, momenta_101, masses2_8, T4sum(:,3), M2)
  call TI_call(4, momenta_99, masses2_8, T4sum(:,4), M2)
  call TI_call(4, momenta_100, masses2_8, T4sum(:,5), M2)
  call TI_call(4, momenta_97, masses2_8, T4sum(:,6), M2)
  call TI_call(4, momenta_124, masses2_8, T4sum(:,7), M2)
  call TI_call(4, momenta_129, masses2_8, T4sum(:,8), M2)
  call TI_call(4, momenta_123, masses2_8, T4sum(:,9), M2)
  call TI_call(4, momenta_120, masses2_8, T4sum(:,10), M2)
  call TI_call(4, momenta_122, masses2_8, T4sum(:,11), M2)
  call TI_call(4, momenta_121, masses2_8, T4sum(:,12), M2)
  ...
  call TI_call(4, momenta_134, masses2_9, T4sum(:,16), M2)
  ...
  call TI_call(4, momenta_138, masses2_9, T4sum(:,20), M2)
  ...
  call channel_off(channel_number_pplnjjj_nexeudxssxg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplnjjj_nexeudxssxg_1_/**/REALKIND
