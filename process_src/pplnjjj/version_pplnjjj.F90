...
module ol_versiondata_pplnjjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pplnjjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplnjjj
  end interface
end module ol_versiondata_pplnjjj


subroutine ol_version_pplnjjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplnjjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplnjjj
