...
module ol_colourmatrix_pplnjjj_nexecddxsxg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjjj_nexecddxsxg_1_/**/REALKIND



module ol_forced_parameters_pplnjjj_nexecddxsxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjjj_nexecddxsxg_1_/**/REALKIND

module ol_loop_pplnjjj_nexecddxsxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 9) = (CI*countertermnorm*ctVsc*eQED**2*gQCD**5)/(2._/**/REALKIND*sw**2)
    f(10) = (countertermnorm*ctVsc*eQED**2*gQCD**5)/(sw**2*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,5),Q(:,68),wf(:,89))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(61)+A(62)+A(63)+A(64)+A(65)+A(66)+A(76)+A(79)+A(83)+A(91)+A(92)+A(93)+A(94)+A(95)+A(96))*f(3))/2._/**/REALKIND &
       +(CI*(A(74)+A(75)+A(78)+A(80)+A(81)+A(82))*f(4))/2._/**/REALKIND+((-A(13)-A(55)-A(56)-A(59))*f(5))/2._/**/REALKIND &
       -(CI*A(52)*f(6))/2._/**/REALKIND+((-A(18)-A(21)-A(23)-A(31)-A(35)-A(36)-A(37)-A(38)-A(41)-A(42) &
       -A(46))*f(7))/2._/**/REALKIND+(CI*(-A(24)-A(45)-A(47))*f(8))/2._/**/REALKIND+((-A(14)-A(22)-A(32)-A(54) &
       -A(60))*f(9))/2._/**/REALKIND+(CI*(-A(26)-A(53))*f(10))/2._/**/REALKIND+(CI*(-A(17)-A(20))*f(11))/2._/**/REALKIND
  M2(2) = ((-A(85)-A(86)-A(87)-A(88)-A(89)-A(90)-A(91)-A(92)-A(93)-A(94)-A(95)-A(96))*f(3))/6._/**/REALKIND+((A(57) &
  ...
  M2(4) = ((A(67)+A(68)+A(69)+A(70)+A(71)+A(72)+A(73)+A(77)+A(84)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90))*f(3))/2._/**/REALKIND+(CI*( &
       -A(74)-A(75)-A(78)-A(80)-A(81)-A(82))*f(4))/2._/**/REALKIND+((-A(19)-A(49)-A(51)-A(57))*f(5))/2._/**/REALKIND &
       +(CI*A(52)*f(6))/2._/**/REALKIND+((-A(15)-A(27)-A(28)-A(29)-A(33)-A(34)-A(39)-A(40)-A(43)-A(44) &
       -A(48))*f(7))/2._/**/REALKIND+(CI*(A(24)+A(45)+A(47))*f(8))/2._/**/REALKIND+((-A(16)-A(25)-A(30)-A(50) &
       -A(58))*f(9))/2._/**/REALKIND+(CI*(A(26)+A(53))*f(10))/2._/**/REALKIND+(CI*(A(17)+A(20))*f(11))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplnjjj_nexecddxsxg_1_/**/REALKIND
