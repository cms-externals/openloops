...
module ol_versiondata_ppzzj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppzzj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzzj
  end interface
end module ol_versiondata_ppzzj


subroutine ol_version_ppzzj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzzj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzzj
