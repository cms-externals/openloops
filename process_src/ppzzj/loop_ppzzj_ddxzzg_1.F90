...
module ol_colourmatrix_ppzzj_ddxzzg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzzj_ddxzzg_1_/**/REALKIND



module ol_forced_parameters_ppzzj_ddxzzg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzzj_ddxzzg_1_/**/REALKIND

module ol_loop_ppzzj_ddxzzg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,42),wf(:,43))
  call counter_ZQ_A(gZd,wf(:,-3),wf(:,0),wf(:,44))
  call prop_Q_A(wf(:,44),Q(:,9),ZERO,0_intkind1,wf(:,45))
  call vert_VQ_A(wf(:,-4),wf(:,45),wf(:,46))
  call vert_ZQ_A(gZd,wf(:,-2),wf(:,42),wf(:,47))
  call vert_ZQ_A(gZd,wf(:,-2),wf(:,45),wf(:,48))
  call counter_ZQ_A(gZd,wf(:,-2),wf(:,0),wf(:,49))
  call prop_Q_A(wf(:,49),Q(:,5),ZERO,0_intkind1,wf(:,50))
  call vert_VQ_A(wf(:,-4),wf(:,50),wf(:,51))
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,50),wf(:,52))
  ...
  call vert_AZ_Q(gZd,wf(:,7),wf(:,-3),wf(:,58))
  ...
  call vert_AZ_Q(gZd,wf(:,12),wf(:,-3),wf(:,67))
...
end module ol_loop_ppzzj_ddxzzg_1_/**/REALKIND
