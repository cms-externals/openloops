...
module ol_colourmatrix_ppzzjj_bbxzzggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzzjj_bbxzzggg_1_/**/REALKIND



module ol_forced_parameters_ppzzjj_bbxzzggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzzjj_bbxzzggg_1_/**/REALKIND

module ol_tree_ppzzjj_bbxzzggg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppzzjj_bbxzzggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppzzjj_bbxzzggg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for bottom anti-bottom Z Z glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppzzjj_bbxzzggg_1, only: external_perm_ppzzjj_bbxzzggg_1, &
    & external_perm_inv_ppzzjj_bbxzzggg_1, extcomb_perm_ppzzjj_bbxzzggg_1, &
    & average_factor_ppzzjj_bbxzzggg_1
  use ol_external_ppzzjj_bbxzzggg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppzzjj_bbxzzggg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppzzjj_bbxzzggg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppzzjj_bbxzzggg_1
  ...
  type(wfun) :: wf4(4,15), wf6(6,8), wf8(8,42), wf9(9,1), wf12(12,48), wf16(16,24), wf18(18,12), wf24(24,72), wf36(36,52), &
    wf288(288,282)
  ...
  extmasses2 = [ rMB2, rMB2, rMZ2, rMZ2, rZERO2, rZERO2, rZERO2 ]
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppzzjj_bbxzzggg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppzzjj_bbxzzggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppzzjj_bbxzzggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppzzjj_bbxzzggg_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf6(:,5), Q(:,9), MB, 1_intkind1, wf6(:,7), n2(6))
  call prop_A_Q(ntry, wf6(:,6), Q(:,6), MB, 1_intkind1, wf6(:,8), n2(7))
  ...
  call vert_VV_S(ntry, ex3, ex4, wf9(:,1), n3(:,17), t3x9(:,:,1))
  call vert_QS_A(gH,ntry, ex1, wf9(:,1), wf18(:,5), n3(:,18), t3x18(:,:,5))
  call prop_Q_A(ntry, wf18(:,5), Q(:,13), MB, 1_intkind1, wf18(:,6), n2(11))
  call vert_SA_Q(gH,ntry, wf9(:,1), ex2, wf18(:,7), n3(:,19), t3x18(:,:,6))
  ...
  call prop_Q_A(ntry, wf12(:,1), Q(:,69), MB, 1_intkind1, wf12(:,2), n2(12))
  call vert_AV_Q(ntry, wf6(:,4), ex7, wf12(:,3), n3(:,23), t3x12(:,:,2))
  call vert_VQ_A(ntry, wf4(:,1), wf6(:,3), wf24(:,2), n3(:,24), t3x24(:,:,2))
  call prop_A_Q(ntry, wf12(:,3), Q(:,74), MB, 1_intkind1, wf12(:,4), n2(13))
  ...
  call prop_Q_A(ntry, wf12(:,5), Q(:,37), MB, 1_intkind1, wf12(:,6), n2(14))
  call vert_AV_Q(ntry, wf6(:,4), ex6, wf12(:,7), n3(:,29), t3x12(:,:,4))
  call vert_VQ_A(ntry, wf4(:,2), wf6(:,3), wf24(:,4), n3(:,30), t3x24(:,:,4))
  call prop_A_Q(ntry, wf12(:,7), Q(:,42), MB, 1_intkind1, wf12(:,8), n2(15))
  ...
  call prop_Q_A(ntry, wf12(:,9), Q(:,21), MB, 1_intkind1, wf12(:,10), n2(16))
  call vert_AV_Q(ntry, wf6(:,4), ex5, wf12(:,11), n3(:,35), t3x12(:,:,6))
  call vert_VQ_A(ntry, wf4(:,3), wf6(:,3), wf24(:,6), n3(:,36), t3x24(:,:,6))
  call prop_A_Q(ntry, wf12(:,11), Q(:,26), MB, 1_intkind1, wf12(:,12), n2(17))
  ...
  call vert_AV_Q(ntry, ex2, ex5, wf4(:,4), n3(:,44), t3x4(:,:,4))
  call prop_A_Q(ntry, wf4(:,4), Q(:,18), MB, 1_intkind1, wf4(:,5), n2(18))
  call vert_AV_Q(ntry, wf4(:,5), wf4(:,3), wf16(:,13), n3(:,45), t3x16(:,:,7))
  call prop_Q_A(ntry, wf18(:,1), Q(:,13), MB, 1_intkind1, wf18(:,8), n2(19))
  call vert_AZ_Q(gZd,ntry, wf4(:,5), ex4, wf12(:,13), n3(:,46), t3x12(:,:,7))
  call prop_A_Q(ntry, wf12(:,13), Q(:,26), MB, 1_intkind1, wf12(:,14), n2(20))
  call vert_AV_Q(ntry, wf4(:,5), ex6, wf8(:,7), n3(:,47), t3x8(:,:,4))
  call prop_A_Q(ntry, wf8(:,7), Q(:,50), MB, 1_intkind1, wf8(:,8), n2(21))
  call vert_VQ_A(ntry, ex7, wf18(:,8), wf36(:,3), n3(:,48), t3x36(:,:,3))
  call vert_AV_Q(ntry, wf4(:,5), ex7, wf8(:,9), n3(:,49), t3x8(:,:,5))
  call prop_A_Q(ntry, wf8(:,9), Q(:,82), MB, 1_intkind1, wf8(:,10), n2(22))
  call vert_VQ_A(ntry, ex6, wf18(:,8), wf36(:,4), n3(:,50), t3x36(:,:,4))
  call vert_AV_Q(ntry, wf12(:,14), ex7, wf24(:,13), n3(:,51), t3x24(:,:,13))
  call vert_ZQ_A(gZd,ntry, ex4, wf12(:,6), wf36(:,5), n3(:,52), t3x36(:,:,5))
  call vert_AV_Q(ntry, wf12(:,14), ex6, wf24(:,14), n3(:,53), t3x24(:,:,14))
  call vert_AZ_Q(gZd,ntry, wf8(:,8), ex4, wf24(:,15), n3(:,54), t3x24(:,:,15))
  call vert_AV_Q(ntry, ex2, ex6, wf4(:,6), n3(:,55), t3x4(:,:,5))
  call prop_A_Q(ntry, wf4(:,6), Q(:,34), MB, 1_intkind1, wf4(:,7), n2(23))
  call vert_AV_Q(ntry, wf4(:,7), wf4(:,2), wf16(:,14), n3(:,56), t3x16(:,:,8))
  call vert_AZ_Q(gZd,ntry, wf4(:,7), ex4, wf12(:,15), n3(:,57), t3x12(:,:,8))
  call prop_A_Q(ntry, wf12(:,15), Q(:,42), MB, 1_intkind1, wf12(:,16), n2(24))
  call vert_AV_Q(ntry, wf4(:,7), ex5, wf8(:,11), n3(:,58), t3x8(:,:,6))
  call prop_A_Q(ntry, wf8(:,11), Q(:,50), MB, 1_intkind1, wf8(:,12), n2(25))
  call vert_AV_Q(ntry, wf4(:,7), ex7, wf8(:,13), n3(:,59), t3x8(:,:,7))
  call prop_A_Q(ntry, wf8(:,13), Q(:,98), MB, 1_intkind1, wf8(:,14), n2(26))
  call vert_VQ_A(ntry, ex5, wf18(:,8), wf36(:,6), n3(:,60), t3x36(:,:,6))
  call vert_AV_Q(ntry, wf12(:,16), ex7, wf24(:,16), n3(:,61), t3x24(:,:,16))
  call vert_ZQ_A(gZd,ntry, ex4, wf12(:,10), wf36(:,7), n3(:,62), t3x36(:,:,7))
  call vert_AV_Q(ntry, wf12(:,16), ex5, wf24(:,17), n3(:,63), t3x24(:,:,17))
  call vert_AZ_Q(gZd,ntry, wf8(:,12), ex4, wf24(:,18), n3(:,64), t3x24(:,:,18))
  call vert_AV_Q(ntry, ex2, ex7, wf4(:,8), n3(:,65), t3x4(:,:,6))
  call prop_A_Q(ntry, wf4(:,8), Q(:,66), MB, 1_intkind1, wf4(:,9), n2(27))
  call vert_AV_Q(ntry, wf4(:,9), wf4(:,1), wf16(:,15), n3(:,66), t3x16(:,:,9))
  call vert_AZ_Q(gZd,ntry, wf4(:,9), ex4, wf12(:,17), n3(:,67), t3x12(:,:,9))
  call prop_A_Q(ntry, wf12(:,17), Q(:,74), MB, 1_intkind1, wf12(:,18), n2(28))
  call vert_QA_V(ntry, wf18(:,8), ex2, wf36(:,8), n3(:,68), t3x36(:,:,8))
  call vert_AV_Q(ntry, ex2, wf4(:,1), wf8(:,15), n3(:,69), t3x8(:,:,8))
  call prop_A_Q(ntry, wf8(:,15), Q(:,50), MB, 1_intkind1, wf8(:,16), n2(29))
  call vert_AV_Q(ntry, wf8(:,16), ex7, wf16(:,16), n3(:,70), t3x16(:,:,10))
  call vert_AZ_Q(gZd,ntry, wf8(:,16), ex4, wf24(:,19), n3(:,71), t3x24(:,:,19))
  call vert_AV_Q(ntry, wf4(:,9), ex5, wf8(:,17), n3(:,72), t3x8(:,:,9))
  call prop_A_Q(ntry, wf8(:,17), Q(:,82), MB, 1_intkind1, wf8(:,18), n2(30))
  call vert_AV_Q(ntry, wf4(:,9), ex6, wf8(:,19), n3(:,73), t3x8(:,:,10))
  call prop_A_Q(ntry, wf8(:,19), Q(:,98), MB, 1_intkind1, wf8(:,20), n2(31))
  call vert_AV_Q(ntry, wf12(:,18), ex6, wf24(:,20), n3(:,74), t3x24(:,:,20))
  call vert_AV_Q(ntry, wf12(:,18), ex5, wf24(:,21), n3(:,75), t3x24(:,:,21))
  call vert_AZ_Q(gZd,ntry, wf8(:,18), ex4, wf24(:,22), n3(:,76), t3x24(:,:,22))
  call vert_AV_Q(ntry, ex2, wf4(:,2), wf8(:,21), n3(:,77), t3x8(:,:,11))
  call prop_A_Q(ntry, wf8(:,21), Q(:,82), MB, 1_intkind1, wf8(:,22), n2(32))
  call vert_AV_Q(ntry, wf8(:,22), ex6, wf16(:,17), n3(:,78), t3x16(:,:,11))
  call vert_AZ_Q(gZd,ntry, wf8(:,22), ex4, wf24(:,23), n3(:,79), t3x24(:,:,23))
  call vert_AV_Q(ntry, ex2, wf4(:,3), wf8(:,23), n3(:,80), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,23), Q(:,98), MB, 1_intkind1, wf8(:,24), n2(33))
  call vert_AV_Q(ntry, wf8(:,24), ex5, wf16(:,18), n3(:,81), t3x16(:,:,12))
  call vert_AZ_Q(gZd,ntry, wf8(:,24), ex4, wf24(:,24), n3(:,82), t3x24(:,:,24))
  call vert_VQ_A(ntry, ex7, wf6(:,7), wf12(:,19), n3(:,83), t3x12(:,:,10))
  call vert_AV_Q(ntry, wf6(:,8), wf4(:,1), wf24(:,25), n3(:,84), t3x24(:,:,25))
  call prop_Q_A(ntry, wf12(:,19), Q(:,73), MB, 1_intkind1, wf12(:,20), n2(34))
  call vert_AV_Q(ntry, wf6(:,8), ex7, wf12(:,21), n3(:,85), t3x12(:,:,11))
  call vert_VQ_A(ntry, wf4(:,1), wf6(:,7), wf24(:,26), n3(:,86), t3x24(:,:,26))
  call prop_A_Q(ntry, wf12(:,21), Q(:,70), MB, 1_intkind1, wf12(:,22), n2(35))
  call vert_VQ_A(ntry, ex6, wf6(:,7), wf12(:,23), n3(:,87), t3x12(:,:,12))
  call vert_AV_Q(ntry, wf6(:,8), wf4(:,2), wf24(:,27), n3(:,88), t3x24(:,:,27))
  call prop_Q_A(ntry, wf12(:,23), Q(:,41), MB, 1_intkind1, wf12(:,24), n2(36))
  call vert_AV_Q(ntry, wf6(:,8), ex6, wf12(:,25), n3(:,89), t3x12(:,:,13))
  call vert_VQ_A(ntry, wf4(:,2), wf6(:,7), wf24(:,28), n3(:,90), t3x24(:,:,28))
  call prop_A_Q(ntry, wf12(:,25), Q(:,38), MB, 1_intkind1, wf12(:,26), n2(37))
  call vert_VQ_A(ntry, ex5, wf6(:,7), wf12(:,27), n3(:,91), t3x12(:,:,14))
  call vert_AV_Q(ntry, wf6(:,8), wf4(:,3), wf24(:,29), n3(:,92), t3x24(:,:,29))
  call prop_Q_A(ntry, wf12(:,27), Q(:,25), MB, 1_intkind1, wf12(:,28), n2(38))
  call vert_AV_Q(ntry, wf6(:,8), ex5, wf12(:,29), n3(:,93), t3x12(:,:,15))
  call vert_VQ_A(ntry, wf4(:,3), wf6(:,7), wf24(:,30), n3(:,94), t3x24(:,:,30))
  call prop_A_Q(ntry, wf12(:,29), Q(:,22), MB, 1_intkind1, wf12(:,30), n2(39))
  call vert_VQ_A(ntry, ex7, wf12(:,28), wf24(:,31), n3(:,95), t3x24(:,:,31))
  call vert_VQ_A(ntry, ex6, wf12(:,28), wf24(:,32), n3(:,96), t3x24(:,:,32))
  call vert_AV_Q(ntry, wf12(:,30), ex7, wf24(:,33), n3(:,97), t3x24(:,:,33))
  call vert_VQ_A(ntry, ex5, wf12(:,24), wf24(:,34), n3(:,98), t3x24(:,:,34))
  call vert_AV_Q(ntry, wf12(:,30), ex6, wf24(:,35), n3(:,99), t3x24(:,:,35))
  call vert_AV_Q(ntry, wf12(:,26), ex5, wf24(:,36), n3(:,100), t3x24(:,:,36))
  call vert_VQ_A(ntry, ex5, ex1, wf4(:,10), n3(:,101), t3x4(:,:,7))
  call prop_Q_A(ntry, wf4(:,10), Q(:,17), MB, 1_intkind1, wf4(:,11), n2(40))
  call vert_ZQ_A(gZd,ntry, ex4, wf4(:,11), wf12(:,31), n3(:,102), t3x12(:,:,16))
  call prop_Q_A(ntry, wf12(:,31), Q(:,25), MB, 1_intkind1, wf12(:,32), n2(41))
  call vert_VQ_A(ntry, wf4(:,3), wf4(:,11), wf16(:,19), n3(:,103), t3x16(:,:,13))
  call prop_A_Q(ntry, wf18(:,2), Q(:,14), MB, 1_intkind1, wf18(:,9), n2(42))
  call vert_VQ_A(ntry, ex7, wf12(:,32), wf24(:,37), n3(:,104), t3x24(:,:,37))
  call vert_VQ_A(ntry, ex6, wf12(:,32), wf24(:,38), n3(:,105), t3x24(:,:,38))
  call vert_VQ_A(ntry, ex6, wf4(:,11), wf8(:,25), n3(:,106), t3x8(:,:,13))
  call prop_Q_A(ntry, wf8(:,25), Q(:,49), MB, 1_intkind1, wf8(:,26), n2(43))
  call vert_AV_Q(ntry, wf18(:,9), ex7, wf36(:,9), n3(:,107), t3x36(:,:,9))
  call vert_ZQ_A(gZd,ntry, ex4, wf8(:,26), wf24(:,39), n3(:,108), t3x24(:,:,39))
  call vert_VQ_A(ntry, ex7, wf4(:,11), wf8(:,27), n3(:,109), t3x8(:,:,14))
  call prop_Q_A(ntry, wf8(:,27), Q(:,81), MB, 1_intkind1, wf8(:,28), n2(44))
  call vert_AV_Q(ntry, wf18(:,9), ex6, wf36(:,10), n3(:,110), t3x36(:,:,10))
  call vert_AZ_Q(gZd,ntry, wf12(:,26), ex4, wf36(:,11), n3(:,111), t3x36(:,:,11))
  call vert_VQ_A(ntry, ex6, ex1, wf4(:,12), n3(:,112), t3x4(:,:,8))
  call prop_Q_A(ntry, wf4(:,12), Q(:,33), MB, 1_intkind1, wf4(:,13), n2(45))
  call vert_ZQ_A(gZd,ntry, ex4, wf4(:,13), wf12(:,33), n3(:,113), t3x12(:,:,17))
  call prop_Q_A(ntry, wf12(:,33), Q(:,41), MB, 1_intkind1, wf12(:,34), n2(46))
  call vert_VQ_A(ntry, wf4(:,2), wf4(:,13), wf16(:,20), n3(:,114), t3x16(:,:,14))
  call vert_VQ_A(ntry, ex7, wf12(:,34), wf24(:,40), n3(:,115), t3x24(:,:,40))
  call vert_VQ_A(ntry, ex5, wf12(:,34), wf24(:,41), n3(:,116), t3x24(:,:,41))
  call vert_VQ_A(ntry, ex5, wf4(:,13), wf8(:,29), n3(:,117), t3x8(:,:,15))
  call prop_Q_A(ntry, wf8(:,29), Q(:,49), MB, 1_intkind1, wf8(:,30), n2(47))
  call vert_ZQ_A(gZd,ntry, ex4, wf8(:,30), wf24(:,42), n3(:,118), t3x24(:,:,42))
  call vert_VQ_A(ntry, ex7, wf4(:,13), wf8(:,31), n3(:,119), t3x8(:,:,16))
  call prop_Q_A(ntry, wf8(:,31), Q(:,97), MB, 1_intkind1, wf8(:,32), n2(48))
  call vert_AV_Q(ntry, wf18(:,9), ex5, wf36(:,12), n3(:,120), t3x36(:,:,12))
  call vert_AZ_Q(gZd,ntry, wf12(:,30), ex4, wf36(:,13), n3(:,121), t3x36(:,:,13))
  call vert_VQ_A(ntry, ex7, ex1, wf4(:,14), n3(:,122), t3x4(:,:,9))
  call prop_Q_A(ntry, wf4(:,14), Q(:,65), MB, 1_intkind1, wf4(:,15), n2(49))
  call vert_ZQ_A(gZd,ntry, ex4, wf4(:,15), wf12(:,35), n3(:,123), t3x12(:,:,18))
  call prop_Q_A(ntry, wf12(:,35), Q(:,73), MB, 1_intkind1, wf12(:,36), n2(50))
  call vert_VQ_A(ntry, wf4(:,1), wf4(:,15), wf16(:,21), n3(:,124), t3x16(:,:,15))
  call vert_VQ_A(ntry, wf4(:,1), ex1, wf8(:,33), n3(:,125), t3x8(:,:,17))
  call prop_Q_A(ntry, wf8(:,33), Q(:,49), MB, 1_intkind1, wf8(:,34), n2(51))
  call vert_ZQ_A(gZd,ntry, ex4, wf8(:,34), wf24(:,43), n3(:,126), t3x24(:,:,43))
  call vert_QA_V(ntry, ex1, wf18(:,9), wf36(:,14), n3(:,127), t3x36(:,:,14))
  call vert_VQ_A(ntry, ex7, wf8(:,34), wf16(:,22), n3(:,128), t3x16(:,:,16))
  call vert_VQ_A(ntry, ex6, wf12(:,36), wf24(:,44), n3(:,129), t3x24(:,:,44))
  call vert_VQ_A(ntry, ex5, wf12(:,36), wf24(:,45), n3(:,130), t3x24(:,:,45))
  call vert_VQ_A(ntry, ex5, wf4(:,15), wf8(:,35), n3(:,131), t3x8(:,:,18))
  call prop_Q_A(ntry, wf8(:,35), Q(:,81), MB, 1_intkind1, wf8(:,36), n2(52))
  call vert_ZQ_A(gZd,ntry, ex4, wf8(:,36), wf24(:,46), n3(:,132), t3x24(:,:,46))
  call vert_VQ_A(ntry, ex6, wf4(:,15), wf8(:,37), n3(:,133), t3x8(:,:,19))
  call prop_Q_A(ntry, wf8(:,37), Q(:,97), MB, 1_intkind1, wf8(:,38), n2(53))
  call vert_VQ_A(ntry, wf4(:,2), ex1, wf8(:,39), n3(:,134), t3x8(:,:,20))
  call prop_Q_A(ntry, wf8(:,39), Q(:,81), MB, 1_intkind1, wf8(:,40), n2(54))
  call vert_ZQ_A(gZd,ntry, ex4, wf8(:,40), wf24(:,47), n3(:,135), t3x24(:,:,47))
  call vert_VQ_A(ntry, ex6, wf8(:,40), wf16(:,23), n3(:,136), t3x16(:,:,17))
  call vert_VQ_A(ntry, wf4(:,3), ex1, wf8(:,41), n3(:,137), t3x8(:,:,21))
  call prop_Q_A(ntry, wf8(:,41), Q(:,97), MB, 1_intkind1, wf8(:,42), n2(55))
  call vert_ZQ_A(gZd,ntry, ex4, wf8(:,42), wf24(:,48), n3(:,138), t3x24(:,:,48))
  call vert_VQ_A(ntry, ex5, wf8(:,42), wf16(:,24), n3(:,139), t3x16(:,:,18))
  call prop_Q_A(ntry, wf18(:,3), Q(:,13), MB, 1_intkind1, wf18(:,10), n2(56))
  call vert_AZ_Q(gZd,ntry, wf4(:,5), ex3, wf12(:,37), n3(:,140), t3x12(:,:,19))
  call prop_A_Q(ntry, wf12(:,37), Q(:,22), MB, 1_intkind1, wf12(:,38), n2(57))
  call vert_VQ_A(ntry, ex7, wf18(:,10), wf36(:,15), n3(:,141), t3x36(:,:,15))
  call vert_VQ_A(ntry, ex6, wf18(:,10), wf36(:,16), n3(:,142), t3x36(:,:,16))
  call vert_AV_Q(ntry, wf12(:,38), ex7, wf24(:,49), n3(:,143), t3x24(:,:,49))
  call vert_ZQ_A(gZd,ntry, ex3, wf12(:,24), wf36(:,17), n3(:,144), t3x36(:,:,17))
  call vert_AV_Q(ntry, wf12(:,38), ex6, wf24(:,50), n3(:,145), t3x24(:,:,50))
  call vert_AZ_Q(gZd,ntry, wf8(:,8), ex3, wf24(:,51), n3(:,146), t3x24(:,:,51))
  call vert_AZ_Q(gZd,ntry, wf4(:,7), ex3, wf12(:,39), n3(:,147), t3x12(:,:,20))
  call prop_A_Q(ntry, wf12(:,39), Q(:,38), MB, 1_intkind1, wf12(:,40), n2(58))
  call vert_VQ_A(ntry, ex5, wf18(:,10), wf36(:,18), n3(:,148), t3x36(:,:,18))
  call vert_AV_Q(ntry, wf12(:,40), ex7, wf24(:,52), n3(:,149), t3x24(:,:,52))
  call vert_ZQ_A(gZd,ntry, ex3, wf12(:,28), wf36(:,19), n3(:,150), t3x36(:,:,19))
  call vert_AV_Q(ntry, wf12(:,40), ex5, wf24(:,53), n3(:,151), t3x24(:,:,53))
  call vert_AZ_Q(gZd,ntry, wf8(:,12), ex3, wf24(:,54), n3(:,152), t3x24(:,:,54))
  call vert_AZ_Q(gZd,ntry, wf4(:,9), ex3, wf12(:,41), n3(:,153), t3x12(:,:,21))
  call prop_A_Q(ntry, wf12(:,41), Q(:,70), MB, 1_intkind1, wf12(:,42), n2(59))
  call vert_QA_V(ntry, wf18(:,10), ex2, wf36(:,20), n3(:,154), t3x36(:,:,20))
  call vert_AZ_Q(gZd,ntry, wf8(:,16), ex3, wf24(:,55), n3(:,155), t3x24(:,:,55))
  call vert_AV_Q(ntry, wf12(:,42), ex6, wf24(:,56), n3(:,156), t3x24(:,:,56))
  call vert_AV_Q(ntry, wf12(:,42), ex5, wf24(:,57), n3(:,157), t3x24(:,:,57))
  call vert_AZ_Q(gZd,ntry, wf8(:,18), ex3, wf24(:,58), n3(:,158), t3x24(:,:,58))
  call vert_AZ_Q(gZd,ntry, wf8(:,22), ex3, wf24(:,59), n3(:,159), t3x24(:,:,59))
  call vert_AZ_Q(gZd,ntry, wf8(:,24), ex3, wf24(:,60), n3(:,160), t3x24(:,:,60))
  call vert_ZQ_A(gZd,ntry, ex3, wf4(:,11), wf12(:,43), n3(:,161), t3x12(:,:,22))
  call prop_Q_A(ntry, wf12(:,43), Q(:,21), MB, 1_intkind1, wf12(:,44), n2(60))
  call prop_A_Q(ntry, wf18(:,4), Q(:,14), MB, 1_intkind1, wf18(:,11), n2(61))
  call vert_VQ_A(ntry, ex7, wf12(:,44), wf24(:,61), n3(:,162), t3x24(:,:,61))
  call vert_VQ_A(ntry, ex6, wf12(:,44), wf24(:,62), n3(:,163), t3x24(:,:,62))
  call vert_AV_Q(ntry, wf18(:,11), ex7, wf36(:,21), n3(:,164), t3x36(:,:,21))
  call vert_ZQ_A(gZd,ntry, ex3, wf8(:,26), wf24(:,63), n3(:,165), t3x24(:,:,63))
  call vert_AV_Q(ntry, wf18(:,11), ex6, wf36(:,22), n3(:,166), t3x36(:,:,22))
  call vert_AZ_Q(gZd,ntry, wf12(:,8), ex3, wf36(:,23), n3(:,167), t3x36(:,:,23))
  call vert_ZQ_A(gZd,ntry, ex3, wf4(:,13), wf12(:,45), n3(:,168), t3x12(:,:,23))
  call prop_Q_A(ntry, wf12(:,45), Q(:,37), MB, 1_intkind1, wf12(:,46), n2(62))
  call vert_VQ_A(ntry, ex7, wf12(:,46), wf24(:,64), n3(:,169), t3x24(:,:,64))
  call vert_VQ_A(ntry, ex5, wf12(:,46), wf24(:,65), n3(:,170), t3x24(:,:,65))
  call vert_ZQ_A(gZd,ntry, ex3, wf8(:,30), wf24(:,66), n3(:,171), t3x24(:,:,66))
  call vert_AV_Q(ntry, wf18(:,11), ex5, wf36(:,24), n3(:,172), t3x36(:,:,24))
  call vert_AZ_Q(gZd,ntry, wf12(:,12), ex3, wf36(:,25), n3(:,173), t3x36(:,:,25))
  call vert_ZQ_A(gZd,ntry, ex3, wf4(:,15), wf12(:,47), n3(:,174), t3x12(:,:,24))
  call prop_Q_A(ntry, wf12(:,47), Q(:,69), MB, 1_intkind1, wf12(:,48), n2(63))
  call vert_ZQ_A(gZd,ntry, ex3, wf8(:,34), wf24(:,67), n3(:,175), t3x24(:,:,67))
  call vert_QA_V(ntry, ex1, wf18(:,11), wf36(:,26), n3(:,176), t3x36(:,:,26))
  call vert_VQ_A(ntry, ex6, wf12(:,48), wf24(:,68), n3(:,177), t3x24(:,:,68))
  call vert_VQ_A(ntry, ex5, wf12(:,48), wf24(:,69), n3(:,178), t3x24(:,:,69))
  call vert_ZQ_A(gZd,ntry, ex3, wf8(:,36), wf24(:,70), n3(:,179), t3x24(:,:,70))
  call vert_ZQ_A(gZd,ntry, ex3, wf8(:,40), wf24(:,71), n3(:,180), t3x24(:,:,71))
  call vert_ZQ_A(gZd,ntry, ex3, wf8(:,42), wf24(:,72), n3(:,181), t3x24(:,:,72))
  call vert_SA_Q(gH,ntry, wf9(:,1), wf4(:,7), wf36(:,27), n3(:,182), t3x36(:,:,27))
  call vert_QS_A(gH,ntry, wf4(:,11), wf9(:,1), wf36(:,28), n3(:,183), t3x36(:,:,28))
  call vert_SA_Q(gH,ntry, wf9(:,1), wf4(:,9), wf36(:,29), n3(:,184), t3x36(:,:,29))
  call prop_A_Q(ntry, wf18(:,7), Q(:,14), MB, 1_intkind1, wf18(:,12), n2(64))
  call vert_AV_Q(ntry, wf18(:,12), ex7, wf36(:,30), n3(:,185), t3x36(:,:,30))
  call vert_AV_Q(ntry, wf18(:,12), ex6, wf36(:,31), n3(:,186), t3x36(:,:,31))
  call vert_SA_Q(gH,ntry, wf9(:,1), wf4(:,5), wf36(:,32), n3(:,187), t3x36(:,:,32))
  call vert_QS_A(gH,ntry, wf4(:,13), wf9(:,1), wf36(:,33), n3(:,188), t3x36(:,:,33))
  call vert_QS_A(gH,ntry, wf4(:,15), wf9(:,1), wf36(:,34), n3(:,189), t3x36(:,:,34))
  call vert_VQ_A(ntry, ex6, wf18(:,6), wf36(:,35), n3(:,190), t3x36(:,:,35))
  call vert_VQ_A(ntry, ex7, wf18(:,6), wf36(:,36), n3(:,191), t3x36(:,:,36))
  call vert_AV_Q(ntry, wf18(:,12), ex5, wf36(:,37), n3(:,192), t3x36(:,:,37))
  call vert_VQ_A(ntry, ex5, wf18(:,6), wf36(:,38), n3(:,193), t3x36(:,:,38))
  call vert_QA_V(ntry, wf18(:,6), ex2, wf36(:,39), n3(:,194), t3x36(:,:,39))
  call vert_QA_V(ntry, ex1, wf18(:,12), wf36(:,40), n3(:,195), t3x36(:,:,40))
  call vert_ZQ_A(gZd,ntry, ex4, wf12(:,44), wf36(:,41), n3(:,196), t3x36(:,:,41))
  call vert_ZQ_A(gZd,ntry, ex3, wf12(:,32), wf36(:,42), n3(:,197), t3x36(:,:,42))
  call vert_AZ_Q(gZd,ntry, wf12(:,40), ex4, wf36(:,43), n3(:,198), t3x36(:,:,43))
  call vert_AZ_Q(gZd,ntry, wf12(:,16), ex3, wf36(:,44), n3(:,199), t3x36(:,:,44))
  call vert_AZ_Q(gZd,ntry, wf12(:,42), ex4, wf36(:,45), n3(:,200), t3x36(:,:,45))
  call vert_AZ_Q(gZd,ntry, wf12(:,18), ex3, wf36(:,46), n3(:,201), t3x36(:,:,46))
  call vert_ZQ_A(gZd,ntry, ex4, wf12(:,46), wf36(:,47), n3(:,202), t3x36(:,:,47))
  call vert_ZQ_A(gZd,ntry, ex3, wf12(:,34), wf36(:,48), n3(:,203), t3x36(:,:,48))
  call vert_AZ_Q(gZd,ntry, wf12(:,38), ex4, wf36(:,49), n3(:,204), t3x36(:,:,49))
  call vert_AZ_Q(gZd,ntry, wf12(:,14), ex3, wf36(:,50), n3(:,205), t3x36(:,:,50))
  call vert_ZQ_A(gZd,ntry, ex4, wf12(:,48), wf36(:,51), n3(:,206), t3x36(:,:,51))
  call vert_ZQ_A(gZd,ntry, ex3, wf12(:,36), wf36(:,52), n3(:,207), t3x36(:,:,52))
  ...
  M2add = M2 / average_factor_ppzzjj_bbxzzggg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppzzjj_bbxzzggg_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = (A(j,1)%j-A(j,2)%j+A(j,4)%j-A(j,5)%j+A(j,7)%j-A(j,8)%j+A(j,10)%j-A(j,11)%j+A(j,13)%j-A(j,14)%j+A(j,16)%j-A(j,17)%j &
       +A(j,27)%j+A(j,33)%j+A(j,38)%j+A(j,42)%j+A(j,46)%j+A(j,47)%j+A(j,58)%j+A(j,70)%j+A(j,75)%j+A(j,81)%j+A(j,86)%j+A(j,107)%j &
       +A(j,109)%j+A(j,113)%j+A(j,114)%j+A(j,118)%j+A(j,123)%j+A(j,127)%j+A(j,128)%j+A(j,139)%j+A(j,151)%j+A(j,173)%j+A(j,175)%j &
       +A(j,179)%j+A(j,180)%j+A(j,184)%j+A(j,255)%j+A(j,256)%j+A(j,257)%j+A(j,258)%j+A(j,259)%j+A(j,260)%j)*f(1)+CI*(A(j,25)%j &
       +A(j,32)%j+A(j,40)%j+A(j,41)%j+A(j,59)%j+A(j,60)%j+A(j,73)%j+A(j,80)%j+A(j,104)%j+A(j,105)%j+A(j,119)%j+A(j,120)%j &
       +A(j,121)%j+A(j,122)%j+A(j,140)%j+A(j,141)%j+A(j,170)%j+A(j,171)%j+A(j,185)%j+A(j,186)%j+A(j,261)%j+A(j,262)%j+A(j,279)%j &
       +A(j,280)%j)*f(2)+(-A(j,19)%j+A(j,20)%j-A(j,22)%j+A(j,23)%j-A(j,197)%j-A(j,198)%j-A(j,202)%j-A(j,219)%j-A(j,220)%j &
       -A(j,224)%j-A(j,231)%j-A(j,232)%j)*f(3)+CI*(-A(j,199)%j-A(j,200)%j-A(j,215)%j-A(j,216)%j-A(j,221)%j-A(j,234)%j)*f(4)
  M1(2) = (A(j,2)%j-A(j,3)%j+A(j,5)%j-A(j,6)%j+A(j,8)%j-A(j,9)%j+A(j,11)%j-A(j,12)%j+A(j,14)%j-A(j,15)%j+A(j,17)%j-A(j,18)%j &
       -A(j,30)%j-A(j,33)%j+A(j,36)%j+A(j,43)%j+A(j,44)%j+A(j,45)%j-A(j,67)%j-A(j,70)%j-A(j,78)%j-A(j,81)%j+A(j,84)%j+A(j,98)%j &
       +A(j,102)%j+A(j,103)%j-A(j,116)%j-A(j,118)%j+A(j,124)%j+A(j,125)%j+A(j,126)%j-A(j,148)%j-A(j,151)%j+A(j,164)%j+A(j,168)%j &
       +A(j,169)%j-A(j,182)%j-A(j,184)%j+A(j,249)%j+A(j,250)%j+A(j,251)%j+A(j,252)%j+A(j,253)%j+A(j,254)%j)*f(1)+CI*(A(j,28)%j &
       -A(j,32)%j-A(j,40)%j-A(j,41)%j+A(j,68)%j+A(j,69)%j+A(j,76)%j-A(j,80)%j+A(j,96)%j+A(j,97)%j-A(j,119)%j-A(j,120)%j-A(j,121)%j &
       -A(j,122)%j+A(j,149)%j+A(j,150)%j+A(j,162)%j+A(j,163)%j-A(j,185)%j-A(j,186)%j-A(j,261)%j-A(j,262)%j+A(j,269)%j &
       +A(j,270)%j)*f(2)+(-A(j,20)%j+A(j,21)%j-A(j,23)%j+A(j,24)%j-A(j,195)%j-A(j,196)%j-A(j,201)%j-A(j,208)%j+A(j,227)%j &
       +A(j,228)%j+A(j,231)%j+A(j,232)%j)*f(3)+CI*(A(j,199)%j+A(j,200)%j-A(j,205)%j-A(j,206)%j-A(j,229)%j+A(j,234)%j)*f(4)
  M1(3) = (-A(j,1)%j+A(j,3)%j-A(j,4)%j+A(j,6)%j-A(j,7)%j+A(j,9)%j-A(j,10)%j+A(j,12)%j-A(j,13)%j+A(j,15)%j-A(j,16)%j+A(j,18)%j &
       -A(j,27)%j+A(j,30)%j+A(j,39)%j+A(j,50)%j+A(j,54)%j+A(j,55)%j-A(j,58)%j+A(j,67)%j-A(j,75)%j+A(j,78)%j+A(j,87)%j-A(j,107)%j &
       +A(j,110)%j+A(j,111)%j+A(j,112)%j+A(j,116)%j+A(j,131)%j+A(j,135)%j+A(j,136)%j-A(j,139)%j+A(j,148)%j-A(j,173)%j+A(j,176)%j &
       +A(j,177)%j+A(j,178)%j+A(j,182)%j+A(j,271)%j+A(j,272)%j+A(j,273)%j+A(j,274)%j+A(j,275)%j+A(j,276)%j)*f(1)+CI*(-A(j,25)%j &
       +A(j,29)%j+A(j,48)%j+A(j,49)%j-A(j,59)%j-A(j,60)%j-A(j,73)%j+A(j,77)%j-A(j,104)%j-A(j,105)%j+A(j,115)%j+A(j,117)%j &
       +A(j,129)%j+A(j,130)%j-A(j,140)%j-A(j,141)%j-A(j,170)%j-A(j,171)%j+A(j,181)%j+A(j,183)%j+A(j,277)%j+A(j,278)%j-A(j,279)%j &
       -A(j,280)%j)*f(2)+(A(j,19)%j-A(j,21)%j+A(j,22)%j-A(j,24)%j-A(j,209)%j-A(j,210)%j-A(j,214)%j+A(j,219)%j+A(j,220)%j &
       -A(j,223)%j-A(j,227)%j-A(j,228)%j)*f(3)+CI*(-A(j,211)%j-A(j,212)%j+A(j,215)%j+A(j,216)%j+A(j,221)%j-A(j,230)%j)*f(4)
  M1(4) = (A(j,2)%j-A(j,3)%j+A(j,5)%j-A(j,6)%j+A(j,8)%j-A(j,9)%j+A(j,11)%j-A(j,12)%j+A(j,14)%j-A(j,15)%j+A(j,17)%j-A(j,18)%j &
       -A(j,30)%j-A(j,33)%j+A(j,34)%j+A(j,51)%j+A(j,52)%j+A(j,53)%j-A(j,67)%j-A(j,70)%j-A(j,78)%j-A(j,81)%j+A(j,82)%j+A(j,90)%j &
       +A(j,94)%j+A(j,95)%j-A(j,116)%j-A(j,118)%j+A(j,132)%j+A(j,133)%j+A(j,134)%j-A(j,148)%j-A(j,151)%j+A(j,156)%j+A(j,160)%j &
       +A(j,161)%j-A(j,182)%j-A(j,184)%j+A(j,235)%j+A(j,236)%j+A(j,237)%j+A(j,238)%j+A(j,239)%j+A(j,240)%j)*f(1)+CI*(-A(j,29)%j &
       +A(j,31)%j-A(j,48)%j-A(j,49)%j+A(j,71)%j+A(j,72)%j-A(j,77)%j+A(j,79)%j+A(j,88)%j+A(j,89)%j-A(j,115)%j-A(j,117)%j-A(j,129)%j &
       -A(j,130)%j+A(j,152)%j+A(j,153)%j+A(j,154)%j+A(j,155)%j-A(j,181)%j-A(j,183)%j+A(j,247)%j+A(j,248)%j-A(j,277)%j &
       -A(j,278)%j)*f(2)+(-A(j,20)%j+A(j,21)%j-A(j,23)%j+A(j,24)%j-A(j,187)%j-A(j,188)%j-A(j,194)%j-A(j,213)%j+A(j,227)%j &
       +A(j,228)%j+A(j,231)%j+A(j,232)%j)*f(3)+CI*(-A(j,191)%j-A(j,192)%j+A(j,211)%j+A(j,212)%j+A(j,230)%j-A(j,233)%j)*f(4)
  M1(5) = (-A(j,1)%j+A(j,3)%j-A(j,4)%j+A(j,6)%j-A(j,7)%j+A(j,9)%j-A(j,10)%j+A(j,12)%j-A(j,13)%j+A(j,15)%j-A(j,16)%j+A(j,18)%j &
       -A(j,27)%j+A(j,30)%j+A(j,37)%j-A(j,58)%j+A(j,61)%j+A(j,65)%j+A(j,66)%j+A(j,67)%j-A(j,75)%j+A(j,78)%j+A(j,85)%j+A(j,99)%j &
       +A(j,100)%j+A(j,101)%j-A(j,107)%j+A(j,116)%j-A(j,139)%j+A(j,142)%j+A(j,146)%j+A(j,147)%j+A(j,148)%j+A(j,165)%j+A(j,166)%j &
       +A(j,167)%j-A(j,173)%j+A(j,182)%j+A(j,263)%j+A(j,264)%j+A(j,265)%j+A(j,266)%j+A(j,267)%j+A(j,268)%j)*f(1)+CI*(A(j,26)%j &
       -A(j,28)%j+A(j,56)%j+A(j,57)%j-A(j,68)%j-A(j,69)%j+A(j,74)%j-A(j,76)%j-A(j,96)%j-A(j,97)%j+A(j,106)%j+A(j,108)%j+A(j,137)%j &
       +A(j,138)%j-A(j,149)%j-A(j,150)%j-A(j,162)%j-A(j,163)%j+A(j,172)%j+A(j,174)%j-A(j,269)%j-A(j,270)%j+A(j,281)%j &
       +A(j,282)%j)*f(2)+(A(j,19)%j-A(j,21)%j+A(j,22)%j-A(j,24)%j-A(j,203)%j-A(j,204)%j-A(j,207)%j+A(j,219)%j+A(j,220)%j &
       -A(j,226)%j-A(j,227)%j-A(j,228)%j)*f(3)+CI*(A(j,205)%j+A(j,206)%j-A(j,217)%j-A(j,218)%j-A(j,222)%j+A(j,229)%j)*f(4)
  M1(6) = (A(j,1)%j-A(j,2)%j+A(j,4)%j-A(j,5)%j+A(j,7)%j-A(j,8)%j+A(j,10)%j-A(j,11)%j+A(j,13)%j-A(j,14)%j+A(j,16)%j-A(j,17)%j &
       +A(j,27)%j+A(j,33)%j+A(j,35)%j+A(j,58)%j+A(j,62)%j+A(j,63)%j+A(j,64)%j+A(j,70)%j+A(j,75)%j+A(j,81)%j+A(j,83)%j+A(j,91)%j &
       +A(j,92)%j+A(j,93)%j+A(j,107)%j+A(j,118)%j+A(j,139)%j+A(j,143)%j+A(j,144)%j+A(j,145)%j+A(j,151)%j+A(j,157)%j+A(j,158)%j &
       +A(j,159)%j+A(j,173)%j+A(j,184)%j+A(j,241)%j+A(j,242)%j+A(j,243)%j+A(j,244)%j+A(j,245)%j+A(j,246)%j)*f(1)+CI*(-A(j,26)%j &
       -A(j,31)%j-A(j,56)%j-A(j,57)%j-A(j,71)%j-A(j,72)%j-A(j,74)%j-A(j,79)%j-A(j,88)%j-A(j,89)%j-A(j,106)%j-A(j,108)%j-A(j,137)%j &
       -A(j,138)%j-A(j,152)%j-A(j,153)%j-A(j,154)%j-A(j,155)%j-A(j,172)%j-A(j,174)%j-A(j,247)%j-A(j,248)%j-A(j,281)%j &
       -A(j,282)%j)*f(2)+(-A(j,19)%j+A(j,20)%j-A(j,22)%j+A(j,23)%j-A(j,189)%j-A(j,190)%j-A(j,193)%j-A(j,219)%j-A(j,220)%j &
       -A(j,225)%j-A(j,231)%j-A(j,232)%j)*f(3)+CI*(A(j,191)%j+A(j,192)%j+A(j,217)%j+A(j,218)%j+A(j,222)%j+A(j,233)%j)*f(4)
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppzzjj_bbxzzggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppzzjj_bbxzzggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppzzjj_bbxzzggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppzzjj_bbxzzggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppzzjj_bbxzzggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppzzjj_bbxzzggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppzzjj_bbxzzggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppzzjj_bbxzzggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppzzjj_bbxzzggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppzzjj_bbxzzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppzzjj_bbxzzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppzzjj_bbxzzggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppzzjj_bbxzzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppzzjj_bbxzzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppzzjj_bbxzzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppzzjj_bbxzzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppzzjj_bbxzzggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppzzjj_bbxzzggg_1_/**/REALKIND
