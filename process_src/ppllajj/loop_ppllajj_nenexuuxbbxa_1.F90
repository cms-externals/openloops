...
module ol_colourmatrix_ppllajj_nenexuuxbbxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppllajj_nenexuuxbbxa_1_/**/REALKIND



module ol_forced_parameters_ppllajj_nenexuuxbbxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllajj_nenexuuxbbxa_1_/**/REALKIND

module ol_loop_ppllajj_nenexuuxbbxa_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(23), c(30)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 4) = (2*CI*countertermnorm*eQED**3*gQCD**4)/3._/**/REALKIND
    f( 5) = CI*countertermnorm*ctAZGG*eQED**3*gQCD**4
    f( 6) = (CI*countertermnorm*ctGbb*eQED**3*gQCD**4)/3._/**/REALKIND
    f( 7) = (2*CI*countertermnorm*ctGbb*eQED**3*gQCD**4)/3._/**/REALKIND
    f( 8) = (CI*countertermnorm*ctGqq*eQED**3*gQCD**4)/3._/**/REALKIND
    f( 9) = (2*CI*countertermnorm*ctGqq*eQED**3*gQCD**4)/3._/**/REALKIND
    f(10) = (CI*countertermnorm*ctVbb*eQED**3*gQCD**4)/3._/**/REALKIND
    f(11) = (2*CI*countertermnorm*ctVbb*eQED**3*gQCD**4)/3._/**/REALKIND
    f(12) = (CI*countertermnorm*ctVqq*eQED**3*gQCD**4)/3._/**/REALKIND
    f(13) = (2*CI*countertermnorm*ctVqq*eQED**3*gQCD**4)/3._/**/REALKIND
    f(14) = (countertermnorm*ctZGG*eQED**3*gQCD**4)/3._/**/REALKIND
    f(15) = (2*countertermnorm*ctZGG*eQED**3*gQCD**4)/3._/**/REALKIND
    f(16) = (CI*eQED**3*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(17) = (2*CI*eQED**3*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(18) = (eQED**3*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(19) = (eQED**3*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(20) = (2*eQED**3*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
  ...
  c = [ 9*CI*f(16), 27*CI*f(16), 9*CI*f(17), 27*CI*f(17), 18*f(18), 54*f(18), f(19), 3*f(19), 6*f(19), 8*f(19), 10*f(19), 18*f(19) &
    , 21*f(19), 24*f(19), 54*f(19), f(20), 3*f(20), 6*f(20), 8*f(20), 10*f(20), 18*f(20), 21*f(20), 24*f(20), 54*f(20), 3*f(21) &
    , 9*f(21), 3*f(22), 9*f(22), 3*f(23), 9*f(23) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZu,wf(:,4),wf(:,24),wf(:,29))
  ...
  call prop_Q_A(wf(:,10),Q(:,83),MB,1_intkind1,wf(:,60))
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,4),wf(:,61))
  call prop_Q_A(wf(:,7),Q(:,92),MB,1_intkind1,wf(:,62))
  call prop_A_Q(wf(:,59),Q(:,44),MB,1_intkind1,wf(:,63))
  call prop_A_Q(wf(:,61),Q(:,35),MB,1_intkind1,wf(:,64))
  call counter_AV_Q(wf(:,-5),wf(:,-6),wf(:,65))
  call prop_A_Q(wf(:,65),Q(:,96),MB,1_intkind1,wf(:,66))
  call vert_AV_Q(wf(:,66),wf(:,2),wf(:,67))
  call vert_AZ_Q(gZd,wf(:,66),wf(:,4),wf(:,68))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,69))
  call prop_A_Q(wf(:,18),Q(:,99),MB,1_intkind1,wf(:,70))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,-4),wf(:,71))
  call prop_A_Q(wf(:,15),Q(:,108),MB,1_intkind1,wf(:,72))
  call prop_Q_A(wf(:,69),Q(:,28),MB,1_intkind1,wf(:,73))
  call vert_VQ_A(wf(:,-6),wf(:,73),wf(:,74))
  call prop_Q_A(wf(:,71),Q(:,19),MB,1_intkind1,wf(:,75))
  call vert_VQ_A(wf(:,-6),wf(:,75),wf(:,76))
  call counter_VQ_A(wf(:,-6),wf(:,-4),wf(:,77))
  call prop_Q_A(wf(:,77),Q(:,80),MB,1_intkind1,wf(:,78))
  ...
  call counter_ZQ_A(gZu,wf(:,4),wf(:,24),wf(:,83))
  call counter_AV_Q(wf(:,32),wf(:,23),wf(:,84))
  call counter_AZ_Q(gZu,wf(:,32),wf(:,4),wf(:,85))
  ...
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,4),wf(:,106))
  ...
  call counter_ZQ_A(gZu,wf(:,4),wf(:,-2),wf(:,124))
  ...
  call vert_ZQ_A(gZu,wf(:,4),wf(:,131),wf(:,133))
  ...
  call counter_Q_A(ctbb,wf(:,5),Q(:,80),wf(:,153))
  call prop_Q_A(wf(:,153),Q(:,80),MB,1_intkind1,wf(:,154))
  call vert_VQ_A(wf(:,2),wf(:,154),wf(:,155))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,154),wf(:,156))
  call counter_A_Q(ctbb,wf(:,8),Q(:,35),wf(:,157))
  call counter_A_Q(ctbb,wf(:,11),Q(:,44),wf(:,158))
  call vert_VQ_A(wf(:,150),wf(:,-4),wf(:,159))
  call vert_VQ_A(wf(:,150),wf(:,16),wf(:,160))
  call counter_Q_A(ctbb,wf(:,16),Q(:,19),wf(:,161))
  call counter_Q_A(ctbb,wf(:,19),Q(:,28),wf(:,162))
  call counter_A_Q(ctbb,wf(:,13),Q(:,96),wf(:,163))
  call prop_A_Q(wf(:,163),Q(:,96),MB,1_intkind1,wf(:,164))
  call vert_AV_Q(wf(:,164),wf(:,2),wf(:,165))
  call vert_AZ_Q(gZd,wf(:,164),wf(:,4),wf(:,166))
  call vert_AV_Q(wf(:,8),wf(:,-6),wf(:,167))
  call prop_Q_A(wf(:,159),Q(:,28),MB,1_intkind1,wf(:,168))
  call prop_A_Q(wf(:,151),Q(:,44),MB,1_intkind1,wf(:,169))
  call vert_AV_Q(wf(:,11),wf(:,-6),wf(:,170))
  call prop_A_Q(wf(:,170),Q(:,108),MB,1_intkind1,wf(:,171))
  call prop_A_Q(wf(:,167),Q(:,99),MB,1_intkind1,wf(:,172))
  call prop_Q_A(wf(:,20),Q(:,83),MB,1_intkind1,wf(:,173))
  call prop_Q_A(wf(:,21),Q(:,92),MB,1_intkind1,wf(:,174))
  ...
  call vert_ZQ_A(gZu,wf(:,4),wf(:,176),wf(:,178))
  ...
  call vert_AZ_Q(gZu,wf(:,188),wf(:,4),wf(:,190))
  ...
  call prop_A_Q(wf(:,42),Q(:,108),MB,1_intkind1,wf(:,204))
  call prop_Q_A(wf(:,43),Q(:,92),MB,1_intkind1,wf(:,205))
  call vert_QA_V(wf(:,-2),wf(:,188),wf(:,206))
  call counter_V_V(ctGG,wf(:,44),Q(:,76),wf(:,207))
  call prop_A_Q(wf(:,45),Q(:,108),MB,1_intkind1,wf(:,208))
  call prop_Q_A(wf(:,46),Q(:,92),MB,1_intkind1,wf(:,209))
  ...
  call vert_ZQ_A(gZu,wf(:,4),wf(:,38),wf(:,234))
  call prop_Q_A(wf(:,234),Q(:,55),ZERO,0_intkind1,wf(:,235))
  call vert_AZ_Q(gZu,wf(:,30),wf(:,4),wf(:,236))
  ...
  call prop_Q_A(wf(:,246),Q(:,31),MB,1_intkind1,wf(:,247))
  call vert_AV_Q(wf(:,-5),wf(:,48),wf(:,248))
  call prop_A_Q(wf(:,248),Q(:,47),MB,1_intkind1,wf(:,249))
...
subroutine denominators()
  ...
  den(158) = 1 / (Q(5,51))
  den(180) = 1 / (Q(5,15))
  den(196) = 1 / (Q(5,31) - MB2)
  den(199) = 1 / (Q(5,47) - MB2)
  den(206) = 1 / (Q(5,55))
  den(209) = 1 / (Q(5,59))
  den(216) = 1 / (Q(5,79))
  den(223) = 1 / (Q(5,115))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(1)-A(2)-A(3)-A(4)-A(5)-A(6)-A(17)-A(18)-A(19)-A(20))*f(1))/2._/**/REALKIND+((A(7)+A(8)+A(9)+A(10)+A(11)+A(12)+A(13) &
       +A(14)+A(15)+A(16))*f(2))/2._/**/REALKIND
  M1(2) = ((A(1)+A(2)+A(3)+A(4)+A(5)+A(6)+A(17)+A(18)+A(19)+A(20))*f(1))/6._/**/REALKIND+((-A(7)-A(8)-A(9)-A(10)-A(11)-A(12)-A(13) &
       -A(14)-A(15)-A(16))*f(2))/6._/**/REALKIND

  M2(1) = ((A(106)+A(107)+A(108)+A(109)+A(110)+A(111)+A(112)+A(113)+A(114)+A(115)+A(116)+A(117)+A(118)+A(119)+A(120)+A(121)+A(122) &
       +A(123)+A(154)+A(155)+A(156)+A(157)+A(158)+A(159)+A(160)+A(161)+A(162)+A(163)+A(164)+A(165))*f(3))/2._/**/REALKIND+(( &
       -A(124)-A(125)-A(126)-A(127)-A(128)-A(129)-A(130)-A(131)-A(132)-A(133)-A(134)-A(135)-A(136)-A(137)-A(138)-A(139)-A(140) &
       -A(141)-A(142)-A(143)-A(144)-A(145)-A(146)-A(147)-A(148)-A(149)-A(150)-A(151)-A(152)-A(153))*f(4))/2._/**/REALKIND &
       -(A(21)*f(5))/2._/**/REALKIND+((-A(22)-A(25)-A(30)-A(32)-A(36)-A(38)-A(54)-A(55)-A(62)-A(63))*f(6))/2._/**/REALKIND+((A(50) &
       +A(52)+A(58)+A(60)+A(66)+A(67)+A(68)+A(69)+A(70)+A(71))*f(7))/2._/**/REALKIND+((-A(80)-A(82)-A(94)-A(96)-A(100)-A(101) &
       -A(102)-A(103)-A(104)-A(105))*f(8))/2._/**/REALKIND+((A(42)+A(45)+A(72)+A(74)+A(78)+A(79)+A(86)+A(88)+A(92) &
       +A(93))*f(9))/2._/**/REALKIND+((-A(23)-A(26)-A(28)-A(29)-A(31)-A(33)-A(34)-A(35)-A(37)-A(39)-A(40)-A(41)-A(56)-A(57)-A(64) &
       -A(65))*f(10))/2._/**/REALKIND+((A(51)+A(53)+A(59)+A(61))*f(11))/2._/**/REALKIND+((-A(81)-A(83)-A(95) &
       -A(97))*f(12))/2._/**/REALKIND+((A(44)+A(47)+A(48)+A(49)+A(73)+A(75)+A(76)+A(77)+A(84)+A(85)+A(87)+A(89)+A(90)+A(91)+A(98) &
       +A(99))*f(13))/2._/**/REALKIND+((A(24)+A(27))*f(14))/2._/**/REALKIND+((-A(43)-A(46))*f(15))/2._/**/REALKIND
  M2(2) = ((-A(106)-A(107)-A(108)-A(109)-A(110)-A(111)-A(112)-A(113)-A(114)-A(115)-A(116)-A(117)-A(118)-A(119)-A(120)-A(121) &
       -A(122)-A(123)-A(154)-A(155)-A(156)-A(157)-A(158)-A(159)-A(160)-A(161)-A(162)-A(163)-A(164)-A(165))*f(3))/6._/**/REALKIND &
       +((A(124)+A(125)+A(126)+A(127)+A(128)+A(129)+A(130)+A(131)+A(132)+A(133)+A(134)+A(135)+A(136)+A(137)+A(138)+A(139)+A(140) &
       +A(141)+A(142)+A(143)+A(144)+A(145)+A(146)+A(147)+A(148)+A(149)+A(150)+A(151)+A(152)+A(153))*f(4))/6._/**/REALKIND &
       +(A(21)*f(5))/6._/**/REALKIND+((A(22)+A(25)+A(30)+A(32)+A(36)+A(38)+A(54)+A(55)+A(62)+A(63))*f(6))/6._/**/REALKIND+((-A(50) &
       -A(52)-A(58)-A(60)-A(66)-A(67)-A(68)-A(69)-A(70)-A(71))*f(7))/6._/**/REALKIND+((A(80)+A(82)+A(94)+A(96)+A(100)+A(101) &
       +A(102)+A(103)+A(104)+A(105))*f(8))/6._/**/REALKIND+((-A(42)-A(45)-A(72)-A(74)-A(78)-A(79)-A(86)-A(88)-A(92) &
       -A(93))*f(9))/6._/**/REALKIND+((A(23)+A(26)+A(28)+A(29)+A(31)+A(33)+A(34)+A(35)+A(37)+A(39)+A(40)+A(41)+A(56)+A(57)+A(64) &
       +A(65))*f(10))/6._/**/REALKIND+((-A(51)-A(53)-A(59)-A(61))*f(11))/6._/**/REALKIND+((A(81)+A(83)+A(95) &
       +A(97))*f(12))/6._/**/REALKIND+((-A(44)-A(47)-A(48)-A(49)-A(73)-A(75)-A(76)-A(77)-A(84)-A(85)-A(87)-A(89)-A(90)-A(91)-A(98) &
       -A(99))*f(13))/6._/**/REALKIND+((-A(24)-A(27))*f(14))/6._/**/REALKIND+((A(43)+A(46))*f(15))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppllajj_nenexuuxbbxa_1_/**/REALKIND
