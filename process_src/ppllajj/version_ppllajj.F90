...
module ol_versiondata_ppllajj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppllajj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllajj
  end interface
end module ol_versiondata_ppllajj


subroutine ol_version_ppllajj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllajj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllajj
