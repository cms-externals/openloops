...
module ol_colourmatrix_ppllajj_eexuuxddxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppllajj_eexuuxddxag_1_/**/REALKIND



module ol_forced_parameters_ppllajj_eexuuxddxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllajj_eexuuxddxag_1_/**/REALKIND

module ol_tree_ppllajj_eexuuxddxag_1_/**/REALKIND
...
subroutine factors_init()
  ...
  ! factors of the diagrams
    ...
    f( 2) = (2*CI*eQED**3*gQCD**3)/9._/**/REALKIND
    f( 3) = (CI*eQED**3*gQCD**3)/3._/**/REALKIND
    f( 4) = (4*CI*eQED**3*gQCD**3)/9._/**/REALKIND
    f( 5) = (2*CI*eQED**3*gQCD**3)/3._/**/REALKIND
    f( 6) = CI*eQED**3*gQCD**3
    f( 7) = (eQED**3*gQCD**3)/9._/**/REALKIND
    f( 8) = (2*eQED**3*gQCD**3)/9._/**/REALKIND
    f( 9) = (eQED**3*gQCD**3)/3._/**/REALKIND
    f(10) = (4*eQED**3*gQCD**3)/9._/**/REALKIND
    f(11) = (2*eQED**3*gQCD**3)/3._/**/REALKIND
    f(12) = eQED**3*gQCD**3
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllajj_eexuuxddxag_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllajj_eexuuxddxag_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for e- e+ up anti-up down anti-down gamma glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppllajj_eexuuxddxag_1, only: external_perm_ppllajj_eexuuxddxag_1, &
    & external_perm_inv_ppllajj_eexuuxddxag_1, extcomb_perm_ppllajj_eexuuxddxag_1, &
    & average_factor_ppllajj_eexuuxddxag_1
  use ol_external_ppllajj_eexuuxddxag_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppllajj_eexuuxddxag_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllajj_eexuuxddxag_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppllajj_eexuuxddxag_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppllajj_eexuuxddxag_1,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllajj_eexuuxddxag_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllajj_eexuuxddxag_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllajj_eexuuxddxag_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf16(:,4), Q(:,83), ZERO, 0_intkind1, wf16(:,5), n2(5))
  ...
  call prop_Q_A(ntry, wf8(:,6), Q(:,208), ZERO, 0_intkind1, wf8(:,7), n2(10))
  ...
  call prop_A_Q(ntry, wf8(:,8), Q(:,44), ZERO, 0_intkind1, wf8(:,9), n2(12))
  ...
  call prop_Q_A(ntry, wf4(:,9), Q(:,144), ZERO, 0_intkind1, wf4(:,11), n2(13))
  ...
  call prop_Q_A(ntry, wf16(:,16), Q(:,147), ZERO, 0_intkind1, wf16(:,18), n2(15))
  call vert_ZQ_A(gZd,ntry, wf4(:,8), wf4(:,11), wf16(:,19), n3(:,31), t3x16(:,:,13))
  call prop_Q_A(ntry, wf16(:,19), Q(:,147), ZERO, 0_intkind1, wf16(:,20), n2(16))
  ...
  call prop_Q_A(ntry, wf8(:,10), Q(:,19), ZERO, 0_intkind1, wf8(:,11), n2(19))
  call vert_QA_V(ntry, wf8(:,11), wf4(:,12), wf32(:,7), n3(:,36), t3x32(:,:,7))
  call vert_ZQ_A(gZd,ntry, wf4(:,8), ex5, wf8(:,12), n3(:,37), t3x8(:,:,7))
  call prop_Q_A(ntry, wf8(:,12), Q(:,19), ZERO, 0_intkind1, wf8(:,13), n2(20))
  call vert_QA_V(ntry, wf8(:,13), wf4(:,12), wf32(:,8), n3(:,38), t3x32(:,:,8))
  call prop_A_Q(ntry, wf16(:,17), Q(:,108), ZERO, 0_intkind1, wf16(:,26), n2(21))
  ...
  call prop_Q_A(ntry, wf8(:,18), Q(:,208), ZERO, 0_intkind1, wf8(:,19), n2(24))
  ...
  call prop_A_Q(ntry, wf16(:,2), Q(:,172), ZERO, 0_intkind1, wf16(:,35), n2(26))
  ...
  call prop_Q_A(ntry, wf16(:,36), Q(:,83), ZERO, 0_intkind1, wf16(:,39), n2(28))
  call prop_Q_A(ntry, wf16(:,37), Q(:,83), ZERO, 0_intkind1, wf16(:,40), n2(29))
  call prop_A_Q(ntry, wf16(:,34), Q(:,108), ZERO, 0_intkind1, wf16(:,41), n2(30))
  call prop_A_Q(ntry, wf16(:,15), Q(:,172), ZERO, 0_intkind1, wf16(:,42), n2(31))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,8), wf4(:,16), wf16(:,50), n3(:,62), t3x16(:,:,29))
  ...
  call vert_AZ_Q(gZu,ntry, wf4(:,17), wf4(:,8), wf16(:,55), n3(:,65), t3x16(:,:,32))
  ...
  call vert_AZ_Q(gZu,ntry, ex4, wf4(:,8), wf8(:,26), n3(:,69), t3x8(:,:,14))
  ...
  call vert_AZ_Q(gZu,ntry, wf8(:,30), wf4(:,8), wf32(:,18), n3(:,78), t3x32(:,:,18))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,8), wf4(:,20), wf16(:,65), n3(:,85), t3x16(:,:,39))
  ...
  call vert_AZ_Q(gZu,ntry, wf4(:,21), wf4(:,8), wf16(:,70), n3(:,88), t3x16(:,:,42))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,8), ex3, wf8(:,33), n3(:,91), t3x8(:,:,18))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,8), wf8(:,38), wf32(:,24), n3(:,101), t3x32(:,:,24))
  ...
  call prop_A_Q(ntry, wf16(:,98), Q(:,108), ZERO, 0_intkind1, wf16(:,102), n2(70))
  ...
  call prop_Q_A(ntry, wf16(:,100), Q(:,92), ZERO, 0_intkind1, wf16(:,105), n2(71))
  ...
  call prop_A_Q(ntry, wf16(:,107), Q(:,108), ZERO, 0_intkind1, wf16(:,111), n2(72))
  ...
  call prop_Q_A(ntry, wf16(:,109), Q(:,92), ZERO, 0_intkind1, wf16(:,114), n2(73))
  ...
  call prop_A_Q(ntry, wf16(:,115), Q(:,172), ZERO, 0_intkind1, wf16(:,137), n2(78))
  call vert_QA_V(ntry, wf8(:,40), ex4, wf16(:,138), n3(:,171), t3x16(:,:,89))
  call prop_Q_A(ntry, wf16(:,128), Q(:,156), ZERO, 0_intkind1, wf16(:,139), n2(79))
  call prop_A_Q(ntry, wf16(:,117), Q(:,172), ZERO, 0_intkind1, wf16(:,140), n2(80))
  call vert_QA_V(ntry, ex3, wf8(:,42), wf16(:,141), n3(:,172), t3x16(:,:,90))
  call prop_Q_A(ntry, wf16(:,130), Q(:,156), ZERO, 0_intkind1, wf16(:,142), n2(81))
  ...
  call prop_Q_A(ntry, wf16(:,151), Q(:,83), ZERO, 0_intkind1, wf16(:,153), n2(88))
  call prop_Q_A(ntry, wf16(:,152), Q(:,83), ZERO, 0_intkind1, wf16(:,154), n2(89))
  call prop_A_Q(ntry, wf16(:,149), Q(:,99), ZERO, 0_intkind1, wf16(:,155), n2(90))
  call prop_A_Q(ntry, wf16(:,150), Q(:,99), ZERO, 0_intkind1, wf16(:,156), n2(91))
  ...
  call prop_Q_A(ntry, wf16(:,159), Q(:,83), ZERO, 0_intkind1, wf16(:,161), n2(94))
  call prop_Q_A(ntry, wf16(:,160), Q(:,83), ZERO, 0_intkind1, wf16(:,162), n2(95))
  call prop_A_Q(ntry, wf16(:,157), Q(:,99), ZERO, 0_intkind1, wf16(:,163), n2(96))
  call prop_A_Q(ntry, wf16(:,158), Q(:,99), ZERO, 0_intkind1, wf16(:,164), n2(97))
  call vert_AV_Q(ntry, ex4, wf8(:,51), wf16(:,165), n3(:,197), t3x16(:,:,101))
  call vert_AZ_Q(gZu,ntry, ex4, wf8(:,53), wf16(:,166), n3(:,198), t3x16(:,:,102))
  call vert_VQ_A(ntry, wf8(:,51), wf4(:,20), wf32(:,37), n3(:,199), t3x32(:,:,37))
  call vert_ZQ_A(gZu,ntry, wf8(:,53), wf4(:,20), wf32(:,38), n3(:,200), t3x32(:,:,38))
  call vert_VQ_A(ntry, wf8(:,51), ex3, wf16(:,167), n3(:,201), t3x16(:,:,103))
  call vert_ZQ_A(gZu,ntry, wf8(:,53), ex3, wf16(:,168), n3(:,202), t3x16(:,:,104))
  call vert_VQ_A(ntry, wf8(:,51), wf8(:,38), wf64(:,13), n3(:,203), t3x64(:,:,13))
  call vert_ZQ_A(gZu,ntry, wf8(:,53), wf8(:,38), wf64(:,14), n3(:,204), t3x64(:,:,14))
  ...
  call vert_AZ_Q(gZu,ntry, ex4, wf8(:,56), wf16(:,174), n3(:,206), t3x16(:,:,106))
  call vert_VQ_A(ntry, wf8(:,54), wf4(:,20), wf32(:,39), n3(:,207), t3x32(:,:,39))
  call vert_ZQ_A(gZu,ntry, wf8(:,56), wf4(:,20), wf32(:,40), n3(:,208), t3x32(:,:,40))
  call vert_VQ_A(ntry, wf8(:,54), ex3, wf16(:,175), n3(:,209), t3x16(:,:,107))
  call vert_ZQ_A(gZu,ntry, wf8(:,56), ex3, wf16(:,176), n3(:,210), t3x16(:,:,108))
  call vert_VQ_A(ntry, wf8(:,54), wf8(:,38), wf64(:,15), n3(:,211), t3x64(:,:,15))
  call vert_ZQ_A(gZu,ntry, wf8(:,56), wf8(:,38), wf64(:,16), n3(:,212), t3x64(:,:,16))
  ...
  M2add = M2 / average_factor_ppllajj_eexuuxddxag_1

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_ppllajj_eexuuxddxag_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = ((A(j,187)%j+A(j,189)%j+A(j,195)%j+A(j,197)%j+A(j,219)%j+A(j,221)%j+A(j,227)%j+A(j,229)%j+A(j,249)%j+A(j,253)%j &
       +A(j,257)%j+A(j,261)%j)*f(1))/6._/**/REALKIND+((-A(j,121)%j-A(j,123)%j-A(j,145)%j-A(j,151)%j-A(j,153)%j-A(j,155)%j &
       -A(j,177)%j-A(j,183)%j-A(j,185)%j-A(j,191)%j-A(j,193)%j-A(j,199)%j-A(j,209)%j-A(j,215)%j-A(j,217)%j-A(j,223)%j-A(j,225)%j &
       -A(j,231)%j-A(j,241)%j-A(j,247)%j-A(j,251)%j-A(j,255)%j-A(j,259)%j-A(j,263)%j)*f(2))/6._/**/REALKIND+((A(j,186)%j &
       +A(j,188)%j+A(j,190)%j+A(j,192)%j+A(j,194)%j+A(j,196)%j+A(j,198)%j+A(j,200)%j+A(j,210)%j+A(j,216)%j+A(j,218)%j+A(j,220)%j &
       +A(j,222)%j+A(j,224)%j+A(j,226)%j+A(j,228)%j+A(j,230)%j+A(j,232)%j+A(j,242)%j+A(j,248)%j+A(j,250)%j+A(j,254)%j+A(j,258)%j &
       +A(j,262)%j+A(j,345)%j+A(j,347)%j+A(j,349)%j+A(j,351)%j+A(j,361)%j+A(j,363)%j+A(j,365)%j+A(j,367)%j)*f(3))/6._/**/REALKIND &
       +((A(j,61)%j+A(j,63)%j+A(j,65)%j+A(j,67)%j+A(j,71)%j+A(j,73)%j+A(j,77)%j+A(j,79)%j+A(j,81)%j+A(j,83)%j+A(j,87)%j+A(j,89)%j &
       +A(j,93)%j+A(j,95)%j+A(j,97)%j+A(j,99)%j+A(j,101)%j+A(j,103)%j+A(j,105)%j+A(j,107)%j+A(j,109)%j+A(j,113)%j+A(j,115)%j &
       +A(j,117)%j)*f(4))/6._/**/REALKIND+((-A(j,62)%j-A(j,64)%j-A(j,66)%j-A(j,68)%j-A(j,72)%j-A(j,74)%j-A(j,78)%j-A(j,80)%j &
       -A(j,82)%j-A(j,84)%j-A(j,88)%j-A(j,90)%j-A(j,94)%j-A(j,96)%j-A(j,98)%j-A(j,100)%j-A(j,102)%j-A(j,104)%j-A(j,106)%j &
       -A(j,108)%j-A(j,110)%j-A(j,114)%j-A(j,116)%j-A(j,118)%j-A(j,122)%j-A(j,124)%j-A(j,146)%j-A(j,152)%j-A(j,154)%j-A(j,156)%j &
       -A(j,178)%j-A(j,184)%j-A(j,252)%j-A(j,256)%j-A(j,260)%j-A(j,264)%j-A(j,313)%j-A(j,315)%j-A(j,317)%j-A(j,319)%j-A(j,323)%j &
       -A(j,327)%j-A(j,329)%j-A(j,331)%j-A(j,333)%j-A(j,335)%j-A(j,339)%j-A(j,343)%j)*f(5))/6._/**/REALKIND+((A(j,314)%j &
       +A(j,316)%j+A(j,318)%j+A(j,320)%j+A(j,324)%j+A(j,328)%j+A(j,330)%j+A(j,332)%j+A(j,334)%j+A(j,336)%j+A(j,340)%j+A(j,344)%j &
       +A(j,346)%j+A(j,348)%j+A(j,350)%j+A(j,352)%j+A(j,362)%j+A(j,364)%j+A(j,366)%j+A(j,368)%j)*f(6))/6._/**/REALKIND
  M1(2) = ((-A(j,7)%j-A(j,11)%j-A(j,13)%j-A(j,17)%j-A(j,19)%j-A(j,23)%j-A(j,33)%j-A(j,35)%j-A(j,37)%j-A(j,39)%j-A(j,49)%j &
       -A(j,51)%j-A(j,195)%j-A(j,197)%j-A(j,227)%j-A(j,229)%j-A(j,257)%j-A(j,261)%j)*f(1))/2._/**/REALKIND+((A(j,121)%j+A(j,123)%j &
       +A(j,127)%j+A(j,129)%j+A(j,141)%j+A(j,159)%j+A(j,161)%j+A(j,173)%j+A(j,177)%j+A(j,183)%j+A(j,193)%j+A(j,199)%j+A(j,205)%j &
       +A(j,211)%j+A(j,215)%j+A(j,225)%j+A(j,231)%j+A(j,233)%j+A(j,235)%j+A(j,247)%j+A(j,259)%j+A(j,263)%j+A(j,265)%j &
       +A(j,269)%j)*f(2))/2._/**/REALKIND+((-A(j,8)%j-A(j,12)%j-A(j,14)%j-A(j,18)%j-A(j,20)%j-A(j,24)%j-A(j,34)%j-A(j,36)%j &
       -A(j,38)%j-A(j,40)%j-A(j,50)%j-A(j,52)%j-A(j,194)%j-A(j,196)%j-A(j,198)%j-A(j,200)%j-A(j,206)%j-A(j,212)%j-A(j,216)%j &
       -A(j,226)%j-A(j,228)%j-A(j,230)%j-A(j,232)%j-A(j,234)%j-A(j,236)%j-A(j,248)%j-A(j,258)%j-A(j,262)%j-A(j,266)%j-A(j,270)%j &
       -A(j,281)%j-A(j,283)%j-A(j,289)%j-A(j,297)%j-A(j,299)%j-A(j,305)%j-A(j,349)%j-A(j,351)%j-A(j,365)%j &
       -A(j,367)%j)*f(3))/2._/**/REALKIND+((-A(j,61)%j-A(j,63)%j-A(j,67)%j-A(j,83)%j-A(j,87)%j-A(j,89)%j-A(j,101)%j-A(j,103)%j &
       -A(j,105)%j-A(j,107)%j-A(j,115)%j-A(j,117)%j-A(j,125)%j-A(j,131)%j-A(j,157)%j-A(j,163)%j-A(j,267)%j &
       -A(j,271)%j)*f(4))/2._/**/REALKIND+((A(j,62)%j+A(j,64)%j+A(j,68)%j+A(j,84)%j+A(j,88)%j+A(j,90)%j+A(j,102)%j+A(j,104)%j &
       +A(j,106)%j+A(j,108)%j+A(j,116)%j+A(j,118)%j+A(j,122)%j+A(j,124)%j+A(j,126)%j+A(j,128)%j+A(j,130)%j+A(j,132)%j+A(j,142)%j &
       +A(j,158)%j+A(j,160)%j+A(j,162)%j+A(j,164)%j+A(j,174)%j+A(j,178)%j+A(j,184)%j+A(j,260)%j+A(j,264)%j+A(j,268)%j+A(j,272)%j &
       +A(j,317)%j+A(j,319)%j+A(j,327)%j+A(j,333)%j+A(j,335)%j+A(j,343)%j+A(j,353)%j+A(j,355)%j+A(j,369)%j &
       +A(j,371)%j)*f(5))/2._/**/REALKIND+((-A(j,282)%j-A(j,284)%j-A(j,290)%j-A(j,298)%j-A(j,300)%j-A(j,306)%j-A(j,318)%j &
       -A(j,320)%j-A(j,328)%j-A(j,334)%j-A(j,336)%j-A(j,344)%j-A(j,350)%j-A(j,352)%j-A(j,354)%j-A(j,356)%j-A(j,366)%j-A(j,368)%j &
       -A(j,370)%j-A(j,372)%j)*f(6))/2._/**/REALKIND+(CI*(-A(j,5)%j-A(j,15)%j-A(j,21)%j-A(j,31)%j-A(j,53)%j &
       -A(j,59)%j)*f(7))/2._/**/REALKIND+(CI*(A(j,143)%j+A(j,149)%j+A(j,175)%j+A(j,181)%j-A(j,207)%j-A(j,213)%j-A(j,239)%j &
       -A(j,245)%j)*f(8))/2._/**/REALKIND+(CI*(-A(j,6)%j-A(j,16)%j-A(j,22)%j-A(j,32)%j-A(j,54)%j-A(j,60)%j+A(j,208)%j+A(j,214)%j &
       +A(j,240)%j+A(j,246)%j-A(j,291)%j-A(j,295)%j-A(j,307)%j-A(j,311)%j)*f(9))/2._/**/REALKIND+(CI*(A(j,69)%j+A(j,75)%j &
       +A(j,85)%j+A(j,91)%j+A(j,111)%j+A(j,119)%j)*f(10))/2._/**/REALKIND+(CI*(-A(j,70)%j-A(j,76)%j-A(j,86)%j-A(j,92)%j-A(j,112)%j &
       -A(j,120)%j+A(j,144)%j+A(j,150)%j+A(j,176)%j+A(j,182)%j-A(j,321)%j-A(j,325)%j-A(j,337)%j-A(j,341)%j)*f(11))/2._/**/REALKIND &
       +(CI*(-A(j,292)%j-A(j,296)%j-A(j,308)%j-A(j,312)%j+A(j,322)%j+A(j,326)%j+A(j,338)%j+A(j,342)%j)*f(12))/2._/**/REALKIND
  M1(3) = ((-A(j,1)%j-A(j,3)%j-A(j,9)%j-A(j,25)%j-A(j,27)%j-A(j,29)%j-A(j,41)%j-A(j,43)%j-A(j,45)%j-A(j,47)%j-A(j,55)%j-A(j,57)%j &
       -A(j,187)%j-A(j,189)%j-A(j,219)%j-A(j,221)%j-A(j,249)%j-A(j,253)%j)*f(1))/2._/**/REALKIND+((A(j,135)%j+A(j,137)%j &
       +A(j,145)%j+A(j,147)%j+A(j,151)%j+A(j,153)%j+A(j,155)%j+A(j,167)%j+A(j,169)%j+A(j,179)%j+A(j,185)%j+A(j,191)%j+A(j,201)%j &
       +A(j,203)%j+A(j,209)%j+A(j,217)%j+A(j,223)%j+A(j,237)%j+A(j,241)%j+A(j,243)%j+A(j,251)%j+A(j,255)%j+A(j,273)%j &
       +A(j,277)%j)*f(2))/2._/**/REALKIND+((-A(j,2)%j-A(j,4)%j-A(j,10)%j-A(j,26)%j-A(j,28)%j-A(j,30)%j-A(j,42)%j-A(j,44)%j &
       -A(j,46)%j-A(j,48)%j-A(j,56)%j-A(j,58)%j-A(j,186)%j-A(j,188)%j-A(j,190)%j-A(j,192)%j-A(j,202)%j-A(j,204)%j-A(j,210)%j &
       -A(j,218)%j-A(j,220)%j-A(j,222)%j-A(j,224)%j-A(j,238)%j-A(j,242)%j-A(j,244)%j-A(j,250)%j-A(j,254)%j-A(j,274)%j-A(j,278)%j &
       -A(j,285)%j-A(j,287)%j-A(j,293)%j-A(j,301)%j-A(j,303)%j-A(j,309)%j-A(j,345)%j-A(j,347)%j-A(j,361)%j &
       -A(j,363)%j)*f(3))/2._/**/REALKIND+((-A(j,65)%j-A(j,71)%j-A(j,73)%j-A(j,77)%j-A(j,79)%j-A(j,81)%j-A(j,93)%j-A(j,95)%j &
       -A(j,97)%j-A(j,99)%j-A(j,109)%j-A(j,113)%j-A(j,133)%j-A(j,139)%j-A(j,165)%j-A(j,171)%j-A(j,275)%j &
       -A(j,279)%j)*f(4))/2._/**/REALKIND+((A(j,66)%j+A(j,72)%j+A(j,74)%j+A(j,78)%j+A(j,80)%j+A(j,82)%j+A(j,94)%j+A(j,96)%j &
       +A(j,98)%j+A(j,100)%j+A(j,110)%j+A(j,114)%j+A(j,134)%j+A(j,136)%j+A(j,138)%j+A(j,140)%j+A(j,146)%j+A(j,148)%j+A(j,152)%j &
       +A(j,154)%j+A(j,156)%j+A(j,166)%j+A(j,168)%j+A(j,170)%j+A(j,172)%j+A(j,180)%j+A(j,252)%j+A(j,256)%j+A(j,276)%j+A(j,280)%j &
       +A(j,313)%j+A(j,315)%j+A(j,323)%j+A(j,329)%j+A(j,331)%j+A(j,339)%j+A(j,357)%j+A(j,359)%j+A(j,373)%j &
       +A(j,375)%j)*f(5))/2._/**/REALKIND+((-A(j,286)%j-A(j,288)%j-A(j,294)%j-A(j,302)%j-A(j,304)%j-A(j,310)%j-A(j,314)%j &
       -A(j,316)%j-A(j,324)%j-A(j,330)%j-A(j,332)%j-A(j,340)%j-A(j,346)%j-A(j,348)%j-A(j,358)%j-A(j,360)%j-A(j,362)%j-A(j,364)%j &
       -A(j,374)%j-A(j,376)%j)*f(6))/2._/**/REALKIND+(CI*(A(j,5)%j+A(j,15)%j+A(j,21)%j+A(j,31)%j+A(j,53)%j &
       +A(j,59)%j)*f(7))/2._/**/REALKIND+(CI*(-A(j,143)%j-A(j,149)%j-A(j,175)%j-A(j,181)%j+A(j,207)%j+A(j,213)%j+A(j,239)%j &
       +A(j,245)%j)*f(8))/2._/**/REALKIND+(CI*(A(j,6)%j+A(j,16)%j+A(j,22)%j+A(j,32)%j+A(j,54)%j+A(j,60)%j-A(j,208)%j-A(j,214)%j &
       -A(j,240)%j-A(j,246)%j+A(j,291)%j+A(j,295)%j+A(j,307)%j+A(j,311)%j)*f(9))/2._/**/REALKIND+(CI*(-A(j,69)%j-A(j,75)%j &
       -A(j,85)%j-A(j,91)%j-A(j,111)%j-A(j,119)%j)*f(10))/2._/**/REALKIND+(CI*(A(j,70)%j+A(j,76)%j+A(j,86)%j+A(j,92)%j+A(j,112)%j &
  ...
  M1(4) = ((A(j,1)%j+A(j,3)%j+A(j,7)%j+A(j,9)%j+A(j,11)%j+A(j,13)%j+A(j,17)%j+A(j,19)%j+A(j,23)%j+A(j,25)%j+A(j,27)%j+A(j,29)%j &
       +A(j,33)%j+A(j,35)%j+A(j,37)%j+A(j,39)%j+A(j,41)%j+A(j,43)%j+A(j,45)%j+A(j,47)%j+A(j,49)%j+A(j,51)%j+A(j,55)%j &
       +A(j,57)%j)*f(1))/6._/**/REALKIND+((-A(j,127)%j-A(j,129)%j-A(j,135)%j-A(j,137)%j-A(j,141)%j-A(j,147)%j-A(j,159)%j &
       -A(j,161)%j-A(j,167)%j-A(j,169)%j-A(j,173)%j-A(j,179)%j-A(j,201)%j-A(j,203)%j-A(j,205)%j-A(j,211)%j-A(j,233)%j-A(j,235)%j &
       -A(j,237)%j-A(j,243)%j-A(j,265)%j-A(j,269)%j-A(j,273)%j-A(j,277)%j)*f(2))/6._/**/REALKIND+((A(j,2)%j+A(j,4)%j+A(j,8)%j &
       +A(j,10)%j+A(j,12)%j+A(j,14)%j+A(j,18)%j+A(j,20)%j+A(j,24)%j+A(j,26)%j+A(j,28)%j+A(j,30)%j+A(j,34)%j+A(j,36)%j+A(j,38)%j &
       +A(j,40)%j+A(j,42)%j+A(j,44)%j+A(j,46)%j+A(j,48)%j+A(j,50)%j+A(j,52)%j+A(j,56)%j+A(j,58)%j+A(j,202)%j+A(j,204)%j+A(j,206)%j &
       +A(j,212)%j+A(j,234)%j+A(j,236)%j+A(j,238)%j+A(j,244)%j+A(j,266)%j+A(j,270)%j+A(j,274)%j+A(j,278)%j+A(j,281)%j+A(j,283)%j &
       +A(j,285)%j+A(j,287)%j+A(j,289)%j+A(j,293)%j+A(j,297)%j+A(j,299)%j+A(j,301)%j+A(j,303)%j+A(j,305)%j &
       +A(j,309)%j)*f(3))/6._/**/REALKIND+((A(j,125)%j+A(j,131)%j+A(j,133)%j+A(j,139)%j+A(j,157)%j+A(j,163)%j+A(j,165)%j &
       +A(j,171)%j+A(j,267)%j+A(j,271)%j+A(j,275)%j+A(j,279)%j)*f(4))/6._/**/REALKIND+((-A(j,126)%j-A(j,128)%j-A(j,130)%j &
       -A(j,132)%j-A(j,134)%j-A(j,136)%j-A(j,138)%j-A(j,140)%j-A(j,142)%j-A(j,148)%j-A(j,158)%j-A(j,160)%j-A(j,162)%j-A(j,164)%j &
       -A(j,166)%j-A(j,168)%j-A(j,170)%j-A(j,172)%j-A(j,174)%j-A(j,180)%j-A(j,268)%j-A(j,272)%j-A(j,276)%j-A(j,280)%j-A(j,353)%j &
       -A(j,355)%j-A(j,357)%j-A(j,359)%j-A(j,369)%j-A(j,371)%j-A(j,373)%j-A(j,375)%j)*f(5))/6._/**/REALKIND+((A(j,282)%j &
       +A(j,284)%j+A(j,286)%j+A(j,288)%j+A(j,290)%j+A(j,294)%j+A(j,298)%j+A(j,300)%j+A(j,302)%j+A(j,304)%j+A(j,306)%j+A(j,310)%j &
       +A(j,354)%j+A(j,356)%j+A(j,358)%j+A(j,360)%j+A(j,370)%j+A(j,372)%j+A(j,374)%j+A(j,376)%j)*f(6))/6._/**/REALKIND
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllajj_eexuuxddxag_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllajj_eexuuxddxag_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllajj_eexuuxddxag_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllajj_eexuuxddxag_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllajj_eexuuxddxag_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllajj_eexuuxddxag_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllajj_eexuuxddxag_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllajj_eexuuxddxag_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllajj_eexuuxddxag_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllajj_eexuuxddxag_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllajj_eexuuxddxag_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllajj_eexuuxddxag_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllajj_eexuuxddxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllajj_eexuuxddxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllajj_eexuuxddxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllajj_eexuuxddxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllajj_eexuuxddxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_ppllajj_eexuuxddxag_1_/**/REALKIND
