...
module ol_colourmatrix_ppllajj_nenexuuxddxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppllajj_nenexuuxddxa_1_/**/REALKIND



module ol_forced_parameters_ppllajj_nenexuuxddxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllajj_nenexuuxddxa_1_/**/REALKIND

module ol_loop_ppllajj_nenexuuxddxa_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(19), c(30)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 6) = (CI*countertermnorm*ctGqq*eQED**3*gQCD**4)/3._/**/REALKIND
    f( 7) = (2*CI*countertermnorm*ctGqq*eQED**3*gQCD**4)/3._/**/REALKIND
    f( 8) = (CI*countertermnorm*ctVqq*eQED**3*gQCD**4)/3._/**/REALKIND
    f( 9) = (2*CI*countertermnorm*ctVqq*eQED**3*gQCD**4)/3._/**/REALKIND
    f(10) = (countertermnorm*ctZGG*eQED**3*gQCD**4)/3._/**/REALKIND
    f(11) = (2*countertermnorm*ctZGG*eQED**3*gQCD**4)/3._/**/REALKIND
    f(12) = (CI*eQED**3*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(13) = (2*CI*eQED**3*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(14) = (eQED**3*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(15) = (eQED**3*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(16) = (2*eQED**3*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(17) = (eQED**3*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(18) = (2*eQED**3*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(19) = (4*eQED**3*gQCD**4*integralnorm*SwF)/3._/**/REALKIND

  c = [ 9*CI*f(12), 27*CI*f(12), 9*CI*f(13), 27*CI*f(13), 18*f(14), 54*f(14), f(15), 3*f(15), 6*f(15), 8*f(15), 10*f(15), 18*f(15) &
    , 21*f(15), 24*f(15), 54*f(15), f(16), 3*f(16), 6*f(16), 8*f(16), 10*f(16), 18*f(16), 21*f(16), 24*f(16), 54*f(16), 3*f(17) &
    , 9*f(17), 3*f(18), 9*f(18), 3*f(19), 9*f(19) ]
  c = (1._/**/REALKIND / 36) * c
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(106)+A(107)+A(108)+A(109)+A(110)+A(111)+A(112)+A(113)+A(114)+A(115)+A(116)+A(117)+A(118)+A(119)+A(120)+A(121)+A(122) &
       ...
       -(A(21)*f(5))/2._/**/REALKIND+((-A(22)-A(25)-A(30)-A(32)-A(36)-A(38)-A(54)-A(55)-A(62)-A(63)-A(80)-A(82)-A(94)-A(96)-A(100) &
       -A(101)-A(102)-A(103)-A(104)-A(105))*f(6))/2._/**/REALKIND+((A(42)+A(45)+A(50)+A(52)+A(58)+A(60)+A(66)+A(67)+A(68)+A(69) &
       +A(70)+A(71)+A(72)+A(74)+A(78)+A(79)+A(86)+A(88)+A(92)+A(93))*f(7))/2._/**/REALKIND+((-A(23)-A(26)-A(28)-A(29)-A(31)-A(33) &
       -A(34)-A(35)-A(37)-A(39)-A(40)-A(41)-A(56)-A(57)-A(64)-A(65)-A(81)-A(83)-A(95)-A(97))*f(8))/2._/**/REALKIND+((A(44)+A(47) &
       +A(48)+A(49)+A(51)+A(53)+A(59)+A(61)+A(73)+A(75)+A(76)+A(77)+A(84)+A(85)+A(87)+A(89)+A(90)+A(91)+A(98) &
       +A(99))*f(9))/2._/**/REALKIND+((A(24)+A(27))*f(10))/2._/**/REALKIND+((-A(43)-A(46))*f(11))/2._/**/REALKIND
  M2(2) = ((-A(106)-A(107)-A(108)-A(109)-A(110)-A(111)-A(112)-A(113)-A(114)-A(115)-A(116)-A(117)-A(118)-A(119)-A(120)-A(121) &
       ...
       +(A(21)*f(5))/6._/**/REALKIND+((A(22)+A(25)+A(30)+A(32)+A(36)+A(38)+A(54)+A(55)+A(62)+A(63)+A(80)+A(82)+A(94)+A(96)+A(100) &
       +A(101)+A(102)+A(103)+A(104)+A(105))*f(6))/6._/**/REALKIND+((-A(42)-A(45)-A(50)-A(52)-A(58)-A(60)-A(66)-A(67)-A(68)-A(69) &
       -A(70)-A(71)-A(72)-A(74)-A(78)-A(79)-A(86)-A(88)-A(92)-A(93))*f(7))/6._/**/REALKIND+((A(23)+A(26)+A(28)+A(29)+A(31)+A(33) &
       +A(34)+A(35)+A(37)+A(39)+A(40)+A(41)+A(56)+A(57)+A(64)+A(65)+A(81)+A(83)+A(95)+A(97))*f(8))/6._/**/REALKIND+((-A(44)-A(47) &
       -A(48)-A(49)-A(51)-A(53)-A(59)-A(61)-A(73)-A(75)-A(76)-A(77)-A(84)-A(85)-A(87)-A(89)-A(90)-A(91)-A(98) &
       -A(99))*f(9))/6._/**/REALKIND+((-A(24)-A(27))*f(10))/6._/**/REALKIND+((A(43)+A(46))*f(11))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppllajj_nenexuuxddxa_1_/**/REALKIND
