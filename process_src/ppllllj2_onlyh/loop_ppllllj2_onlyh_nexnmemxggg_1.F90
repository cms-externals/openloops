...
module ol_colourmatrix_ppllllj2_onlyh_nexnmemxggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj2_onlyh_nexnmemxggg_1_/**/REALKIND



module ol_forced_parameters_ppllllj2_onlyh_nexnmemxggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj2_onlyh_nexnmemxggg_1_/**/REALKIND

module ol_loop_ppllllj2_onlyh_nexnmemxggg_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-7+1:11)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YB)/(4._/**/REALKIND*sw**4)
    f(3) = (eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YB)/(sw**4*4._/**/REALKIND)
    f(4) = (countertermnorm*ctHGG*eQED**4*gQCD**3*lambdaHWW*MT*MW*YT)/(MQ2sum*sw**3*2._/**/REALKIND)
    f(5) = (CI*eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YT)/(4._/**/REALKIND*sw**4)
    f(6) = (eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YT)/(sw**4*4._/**/REALKIND)
...
end module ol_loop_ppllllj2_onlyh_nexnmemxggg_1_/**/REALKIND
