...
module ol_colourmatrix_ppllllj2_onlyh_nenexeexggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj2_onlyh_nenexeexggg_1_/**/REALKIND



module ol_forced_parameters_ppllllj2_onlyh_nenexeexggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj2_onlyh_nenexeexggg_1_/**/REALKIND

module ol_loop_ppllllj2_onlyh_nenexeexggg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f( 1) = (countertermnorm*ctHGG*eQED**4*gQCD**3*lambdaHWW*MB*MW*YB)/(MQ2sum*sw**3*2._/**/REALKIND)
    f( 2) = (countertermnorm*ctHGG*eQED**4*gQCD**3*lambdaHZZ*MB*MW*YB)/(cw**2*MQ2sum*sw)
    f( 3) = (CI*eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YB)/(4._/**/REALKIND*sw**4)
    f( 4) = (eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YB)/(sw**4*4._/**/REALKIND)
    f( 5) = (CI*eQED**4*gQCD**3*integralnorm*lambdaHZZ*SwF*YB)/(2._/**/REALKIND*cw**2*sw**2)
    f( 6) = (eQED**4*gQCD**3*integralnorm*lambdaHZZ*SwF*YB)/(cw**2*sw**2*2._/**/REALKIND)
    f( 7) = (countertermnorm*ctHGG*eQED**4*gQCD**3*lambdaHWW*MT*MW*YT)/(MQ2sum*sw**3*2._/**/REALKIND)
    f( 8) = (countertermnorm*ctHGG*eQED**4*gQCD**3*lambdaHZZ*MT*MW*YT)/(cw**2*MQ2sum*sw)
    f( 9) = (CI*eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YT)/(4._/**/REALKIND*sw**4)
    f(10) = (eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YT)/(sw**4*4._/**/REALKIND)
    f(11) = (CI*eQED**4*gQCD**3*integralnorm*lambdaHZZ*SwF*YT)/(2._/**/REALKIND*cw**2*sw**2)
    f(12) = (eQED**4*gQCD**3*integralnorm*lambdaHZZ*SwF*YT)/(cw**2*sw**2*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call vert_QA_W(wf(:,0),wf(:,-3),wf(:,12))
  call vert_QA_W(wf(:,-2),wf(:,-1),wf(:,13))
  call prop_W_W(wf(:,12),Q(:,9),MW,1_intkind1,wf(:,14))
  call prop_W_W(wf(:,13),Q(:,6),MW,1_intkind1,wf(:,15))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = 2*CI*(A(8)-A(10)+A(12))*f(1)+2*CI*(-A(2)+A(4)-A(6))*f(2)+2*CI*(A(7)-A(9)+A(11))*f(7)+2*CI*(-A(1)+A(3)-A(5))*f(8)
  M2(2) = 2*CI*(-A(8)+A(10)-A(12))*f(1)+2*CI*(A(2)-A(4)+A(6))*f(2)+2*CI*(-A(7)+A(9)-A(11))*f(7)+2*CI*(A(1)-A(3)+A(5))*f(8)

end subroutine colourvectors

end module ol_loop_ppllllj2_onlyh_nenexeexggg_1_/**/REALKIND
