...
module ol_colourmatrix_ppllllj2_onlyh_nenenexnexuuxg_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND
  implicit none
  logical, save           :: colmat_not_initialised = .true.
  complex(REALKIND), save :: K1(0,0), K2(0,1), KL(0,1), KL2(30,1), KL2ct(30,1), KL2ct2(30,1)
  contains
...
end module ol_colourmatrix_ppllllj2_onlyh_nenenexnexuuxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj2_onlyh_nenenexnexuuxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj2_onlyh_nenenexnexuuxg_1_/**/REALKIND

module ol_loop_ppllllj2_onlyh_nenenexnexuuxg_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    f(1) = (CI*countertermnorm*ctHGG*eQED**4*gQCD**3*lambdaHZZ*MB*MW*YB)/(cw**2*MQ2sum*sw)
    f(2) = (eQED**4*gQCD**3*integralnorm*lambdaHZZ*SwF*YB)/(cw**2*sw**2*2._/**/REALKIND)
    f(3) = (CI*countertermnorm*ctHGG*eQED**4*gQCD**3*lambdaHZZ*MT*MW*YT)/(cw**2*MQ2sum*sw)
    f(4) = (eQED**4*gQCD**3*integralnorm*lambdaHZZ*SwF*YT)/(cw**2*sw**2*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call vert_QA_Z(gZn,wf(:,0),wf(:,-3),wf(:,8))
  call vert_QA_Z(gZn,wf(:,-1),wf(:,-2),wf(:,9))
  call prop_W_W(wf(:,8),Q(:,9),MZ,1_intkind1,wf(:,10))
  call prop_W_W(wf(:,9),Q(:,6),MZ,1_intkind1,wf(:,11))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(2)-A(4))*f(1)+(A(1)-A(3))*f(3)

end subroutine colourvectors

end module ol_loop_ppllllj2_onlyh_nenenexnexuuxg_1_/**/REALKIND
