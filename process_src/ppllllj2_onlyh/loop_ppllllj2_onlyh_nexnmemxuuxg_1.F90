...
module ol_colourmatrix_ppllllj2_onlyh_nexnmemxuuxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj2_onlyh_nexnmemxuuxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj2_onlyh_nexnmemxuuxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj2_onlyh_nexnmemxuuxg_1_/**/REALKIND

module ol_loop_ppllllj2_onlyh_nexnmemxuuxg_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YB)/(sw**4*4._/**/REALKIND)
    f(3) = (CI*countertermnorm*ctHGG*eQED**4*gQCD**3*lambdaHWW*MT*MW*YT)/(2._/**/REALKIND*MQ2sum*sw**3)
    f(4) = (eQED**4*gQCD**3*integralnorm*lambdaHWW*SwF*YT)/(sw**4*4._/**/REALKIND)
...
end module ol_loop_ppllllj2_onlyh_nexnmemxuuxg_1_/**/REALKIND
