...
module ol_external_ppllllj2_onlyh_eexmmxggg_1
  ...
  subroutine set_permutation(perm) &
    ...
    average_factor_ppllllj2_onlyh_eexmmxggg_1 = &
      ...
      external_perm_ppllllj2_onlyh_eexmmxggg_1(1)) &
      * average_factors_ppllllj2_onlyh_eexmmxggg_1( &
      external_perm_ppllllj2_onlyh_eexmmxggg_1(2))
    ! Symmetry factor for outgoing particles
    if (out_symmetry_on /= 0) then
      do i = 1, 7
        average_factor_ppllllj2_onlyh_eexmmxggg_1 = &
          average_factor_ppllllj2_onlyh_eexmmxggg_1 &
          * factorial(count(particle_types_perm_ppllllj2_onlyh_eexmmxggg_1(3:7) == i))
      end do
    end if
