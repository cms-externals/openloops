...
module ol_colourmatrix_ppllllj2_onlyh_eeexexggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj2_onlyh_eeexexggg_1_/**/REALKIND



module ol_forced_parameters_ppllllj2_onlyh_eeexexggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj2_onlyh_eeexexggg_1_/**/REALKIND

module ol_loop_ppllllj2_onlyh_eeexexggg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_QA_Z(gZl,wf(:,0),wf(:,-3),wf(:,12))
  call vert_QA_Z(gZl,wf(:,-1),wf(:,-2),wf(:,13))
...
end module ol_loop_ppllllj2_onlyh_eeexexggg_1_/**/REALKIND
