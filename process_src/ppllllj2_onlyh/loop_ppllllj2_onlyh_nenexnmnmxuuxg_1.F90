...
module ol_colourmatrix_ppllllj2_onlyh_nenexnmnmxuuxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj2_onlyh_nenexnmnmxuuxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj2_onlyh_nenexnmnmxuuxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj2_onlyh_nenexnmnmxuuxg_1_/**/REALKIND

module ol_loop_ppllllj2_onlyh_nenexnmnmxuuxg_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-7+1:7)
  ! denominators
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = -(A(2)*f(1))-A(1)*f(3)

end subroutine colourvectors

end module ol_loop_ppllllj2_onlyh_nenexnmnmxuuxg_1_/**/REALKIND
