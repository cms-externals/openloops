...
module ol_colourmatrix_pphz_ddxhz_1_/**/REALKIND
...
end module ol_colourmatrix_pphz_ddxhz_1_/**/REALKIND



module ol_forced_parameters_pphz_ddxhz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphz_ddxhz_1_/**/REALKIND

module ol_loop_pphz_ddxhz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**2*lambdaHZZ*MW)/(cw**2*sw)
...
! **********************************************************************
  ...
  call counter_QA_Z(gZd,wf(:,0),wf(:,-1),wf(:,4))
...
end module ol_loop_pphz_ddxhz_1_/**/REALKIND
