...
module ol_versiondata_pphz
  implicit none
  character(4) :: generator_revision = "1268"
  interface
    subroutine version_pphz(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphz
  end interface
end module ol_versiondata_pphz


subroutine ol_version_pphz(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphz, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphz
