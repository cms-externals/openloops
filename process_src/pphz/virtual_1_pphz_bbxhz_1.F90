...
module ol_vamp_1_pphz_bbxhz_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pphz_bbxhz_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pphz_bbxhz_1.
! **********************************************************************
...
#endif
  use ol_loop_pphz_bbxhz_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pphz_bbxhz_1_/**/REALKIND
  ...
  call loop_QS_A(G1(:,:,:,5),wf(:,-2),G1(:,:,:,6),gH)
  ...
  call loop_AZ_Q(G1(:,:,:,9),wf(:,17),G1(:,:,:,10),gZd)
  ...
  call loop_AS_Q(G1(:,:,:,9),wf(:,-2),G1(:,:,:,12),gH)
...
end module ol_vamp_1_pphz_bbxhz_1_/**/REALKIND
