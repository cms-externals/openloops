...
module ol_tree_pptllj_nenexutxdxb_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pptllj_nenexutxdxb_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pptllj_nenexutxdxb_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
...
! **********************************************************************
  ...
  use ol_external_pptllj_nenexutxdxb_1, only: H, hel_not_initialised, hel_init
  ...
  use ol_heltables_pptllj_nenexutxdxb_1
  ...
  type(wfun) :: wf4(4,4), wf8(8,17), wf16(16,2), wf64(64,8)
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_pptllj_nenexutxdxb_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pptllj_nenexutxdxb_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pptllj_nenexutxdxb_1(-I)
  end if
  ...
  call vert_UV_W(ntry, wf4(:,1), Q(:,3), wf4(:,2), Q(:,20), wf16(:,2), n3(:,6), t3x16(:,:,2))
  ...
  call prop_A_Q(ntry, wf8(:,4), Q(:,28), MB, 1_intkind1, wf8(:,6), n2(2))
  ...
  call prop_Q_A(ntry, wf8(:,10), Q(:,44), ZERO, 0_intkind1, wf8(:,12), n2(4))
  call vert_QS_A(gPln,ntry, ex1, wf4(:,3), wf8(:,13), n3(:,15), t3x8(:,:,9))
  call vert_AW_Q(ntry, ex2, wf4(:,2), wf8(:,14), n3(:,16), t3x8(:,:,10))
  call prop_Q_A(ntry, wf8(:,13), Q(:,41), ME, 1_intkind1, wf8(:,15), n2(5))
  call vert_WQ_A(ntry, wf4(:,4), ex1, wf8(:,16), n3(:,17), t3x8(:,:,11))
  call prop_Q_A(ntry, wf8(:,16), Q(:,41), ME, 1_intkind1, wf8(:,17), n2(6))
  ...
  M2add = M2 / average_factor_pptllj_nenexutxdxb_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_pptllj_nenexutxdxb_1(k))
  end do
...
subroutine diagrams()
  ...
  ! e.g. call cont_VV(nsync, wf3, wf6, A(:,1), n64, t64, nhel, den(5)) ...
    ...
    call cont_QA(nsync, wf8(:,14), wf8(:,17), A(:,8), n3(:,25), t3x64(:,:,8), nhel, den(20))
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pptllj_nenexutxdxb_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pptllj_nenexutxdxb_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pptllj_nenexutxdxb_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pptllj_nenexutxdxb_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pptllj_nenexutxdxb_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pptllj_nenexutxdxb_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pptllj_nenexutxdxb_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pptllj_nenexutxdxb_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pptllj_nenexutxdxb_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pptllj_nenexutxdxb_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pptllj_nenexutxdxb_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pptllj_nenexutxdxb_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pptllj_nenexutxdxb_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pptllj_nenexutxdxb_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pptllj_nenexutxdxb_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pptllj_nenexutxdxb_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_pptllj_nenexutxdxb_1_/**/REALKIND
