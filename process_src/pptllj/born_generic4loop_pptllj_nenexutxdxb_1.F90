...
! **********************************************************************
module ol_heltables_pptllj_nenexutxdxb_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(6), n3(3,25)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x16(2,16,2), t3x4(2,4,4), t3x64(2,64,8), t3x8(2,8,11)
...
! **********************************************************************
  ...
  call heltable([4,16,64], n3(:,19), t3x64(:,:,2))
...
end module ol_heltables_pptllj_nenexutxdxb_1
