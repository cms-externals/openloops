...
module ol_versiondata_pptllj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptllj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptllj
  end interface
end module ol_versiondata_pptllj


subroutine ol_version_pptllj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptllj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptllj
