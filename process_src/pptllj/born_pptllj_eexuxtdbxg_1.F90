...
module ol_colourmatrix_pptllj_eexuxtdbxg_1_/**/REALKIND
...
end module ol_colourmatrix_pptllj_eexuxtdbxg_1_/**/REALKIND



module ol_forced_parameters_pptllj_eexuxtdbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pptllj_eexuxtdbxg_1_/**/REALKIND

module ol_tree_pptllj_eexuxtdbxg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pptllj_eexuxtdbxg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pptllj_eexuxtdbxg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for e- e+ anti-up top down anti-bottom glue -> 0
...
! **********************************************************************
  ...
  use ol_external_pptllj_eexuxtdbxg_1, only: external_perm_pptllj_eexuxtdbxg_1, &
    & external_perm_inv_pptllj_eexuxtdbxg_1, extcomb_perm_pptllj_eexuxtdbxg_1, &
    & average_factor_pptllj_eexuxtdbxg_1
  use ol_external_pptllj_eexuxtdbxg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_pptllj_eexuxtdbxg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_pptllj_eexuxtdbxg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_pptllj_eexuxtdbxg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_pptllj_eexuxtdbxg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pptllj_eexuxtdbxg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pptllj_eexuxtdbxg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_pptllj_eexuxtdbxg_1(extcombs(k))
  end do
  ...
  call vert_SA_Q(gX,ntry, wf4(:,5), ex6, wf8(:,3), n3(:,7), t3x8(:,:,2))
  call prop_A_Q(ntry, wf8(:,3), Q(:,35), MB, 1_intkind1, wf8(:,4), n2(3))
  call vert_QA_V(ntry, ex1, ex2, wf4(:,6), n3(:,8), t3x4(:,:,5))
  call vert_AV_Q(ntry, ex6, wf4(:,6), wf8(:,5), n3(:,9), t3x8(:,:,3))
  call prop_A_Q(ntry, wf8(:,5), Q(:,35), MB, 1_intkind1, wf8(:,6), n2(4))
  call vert_QA_Z(gZl,ntry, ex1, ex2, wf4(:,7), n3(:,10), t3x4(:,:,6))
  call vert_AZ_Q(gZd,ntry, ex6, wf4(:,7), wf8(:,7), n3(:,11), t3x8(:,:,4))
  call prop_A_Q(ntry, wf8(:,7), Q(:,35), MB, 1_intkind1, wf8(:,8), n2(5))
  call vert_AW_Q(ntry, ex6, wf4(:,2), wf8(:,9), n3(:,12), t3x8(:,:,5))
  call vert_QS_A(gH,ntry, wf4(:,4), wf4(:,1), wf16(:,2), n3(:,13), t3x16(:,:,2))
  call prop_A_Q(ntry, wf8(:,9), Q(:,52), MT, 1_intkind1, wf8(:,10), n2(6))
  call vert_QS_A(gX,ntry, wf4(:,4), wf4(:,5), wf16(:,3), n3(:,14), t3x16(:,:,3))
  call vert_VQ_A(ntry, wf4(:,6), wf4(:,4), wf16(:,4), n3(:,15), t3x16(:,:,4))
  call vert_ZQ_A(gZu,ntry, wf4(:,7), wf4(:,4), wf16(:,5), n3(:,16), t3x16(:,:,5))
  call vert_AQ_S(gPbt,ntry, ex6, wf4(:,4), wf8(:,11), n3(:,17), t3x8(:,:,6))
  ...
  call vert_QA_W(ntry, wf4(:,4), ex6, wf8(:,12), n3(:,20), t3x8(:,:,7))
  ...
  call vert_UV_W(ntry, wf4(:,2), Q(:,20), wf4(:,6), Q(:,3), wf16(:,11), n3(:,24), t3x16(:,:,11))
  call vert_UV_W(ntry, wf4(:,2), Q(:,20), wf4(:,7), Q(:,3), wf16(:,12), n3(:,25), t3x16(:,:,12))
  call vert_AV_Q(ntry, ex6, ex7, wf4(:,8), n3(:,26), t3x4(:,:,7))
  call prop_A_Q(ntry, wf4(:,8), Q(:,96), MB, 1_intkind1, wf4(:,9), n2(7))
  call vert_QS_A(gH,ntry, ex4, wf4(:,1), wf8(:,13), n3(:,27), t3x8(:,:,8))
  call vert_AW_Q(ntry, wf4(:,9), wf4(:,2), wf16(:,13), n3(:,28), t3x16(:,:,13))
  call prop_Q_A(ntry, wf8(:,13), Q(:,11), MT, 1_intkind1, wf8(:,14), n2(8))
  call vert_QS_A(gX,ntry, ex4, wf4(:,5), wf8(:,15), n3(:,29), t3x8(:,:,9))
  call prop_Q_A(ntry, wf8(:,15), Q(:,11), MT, 1_intkind1, wf8(:,16), n2(9))
  call vert_VQ_A(ntry, wf4(:,6), ex4, wf8(:,17), n3(:,30), t3x8(:,:,10))
  call prop_Q_A(ntry, wf8(:,17), Q(:,11), MT, 1_intkind1, wf8(:,18), n2(10))
  call vert_ZQ_A(gZu,ntry, wf4(:,7), ex4, wf8(:,19), n3(:,31), t3x8(:,:,11))
  call prop_Q_A(ntry, wf8(:,19), Q(:,11), MT, 1_intkind1, wf8(:,20), n2(11))
  call vert_WQ_A(ntry, wf4(:,2), ex4, wf8(:,21), n3(:,32), t3x8(:,:,12))
  call vert_SA_Q(gH,ntry, wf4(:,1), wf4(:,9), wf16(:,14), n3(:,33), t3x16(:,:,14))
  call prop_Q_A(ntry, wf8(:,21), Q(:,28), MB, 1_intkind1, wf8(:,22), n2(12))
  call vert_SA_Q(gX,ntry, wf4(:,5), wf4(:,9), wf16(:,15), n3(:,34), t3x16(:,:,15))
  call vert_AV_Q(ntry, wf4(:,9), wf4(:,6), wf16(:,16), n3(:,35), t3x16(:,:,16))
  call vert_AZ_Q(gZd,ntry, wf4(:,9), wf4(:,7), wf16(:,17), n3(:,36), t3x16(:,:,17))
  call vert_AQ_S(gPbt,ntry, wf4(:,9), ex4, wf8(:,23), n3(:,37), t3x8(:,:,13))
  call vert_QA_W(ntry, ex4, wf4(:,9), wf8(:,24), n3(:,38), t3x8(:,:,14))
  call vert_VQ_A(ntry, ex7, wf8(:,14), wf16(:,18), n3(:,39), t3x16(:,:,18))
  call vert_VQ_A(ntry, ex7, wf8(:,16), wf16(:,19), n3(:,40), t3x16(:,:,19))
  call vert_VQ_A(ntry, ex7, wf8(:,18), wf16(:,20), n3(:,41), t3x16(:,:,20))
  call vert_VQ_A(ntry, ex7, wf8(:,20), wf16(:,21), n3(:,42), t3x16(:,:,21))
  call vert_VQ_A(ntry, ex7, wf8(:,22), wf16(:,22), n3(:,43), t3x16(:,:,22))
  call vert_AV_Q(ntry, ex3, ex7, wf4(:,10), n3(:,44), t3x4(:,:,8))
  call vert_QA_W(ntry, ex4, ex6, wf4(:,11), n3(:,45), t3x4(:,:,9))
  call prop_A_Q(ntry, wf4(:,10), Q(:,68), ZERO, 0_intkind1, wf4(:,12), n2(13))
  call vert_VQ_A(ntry, wf4(:,6), ex5, wf8(:,25), n3(:,46), t3x8(:,:,15))
  call vert_AW_Q(ntry, wf4(:,12), wf4(:,11), wf16(:,23), n3(:,47), t3x16(:,:,23))
  call prop_Q_A(ntry, wf8(:,25), Q(:,19), ZERO, 0_intkind1, wf8(:,26), n2(14))
  call vert_ZQ_A(gZd,ntry, wf4(:,7), ex5, wf8(:,27), n3(:,48), t3x8(:,:,16))
  call prop_Q_A(ntry, wf8(:,27), Q(:,19), ZERO, 0_intkind1, wf8(:,28), n2(15))
  call vert_AQ_S(gPbt,ntry, ex6, ex4, wf4(:,13), n3(:,49), t3x4(:,:,10))
  call vert_QA_W(ntry, ex5, wf4(:,12), wf8(:,29), n3(:,50), t3x8(:,:,17))
  ...
  call vert_UV_W(ntry, wf4(:,6), Q(:,3), wf4(:,11), Q(:,40), wf16(:,29), n3(:,56), t3x16(:,:,29))
  call vert_UV_W(ntry, wf4(:,7), Q(:,3), wf4(:,11), Q(:,40), wf16(:,30), n3(:,57), t3x16(:,:,30))
  call vert_WQ_A(ntry, wf4(:,11), ex5, wf8(:,30), n3(:,58), t3x8(:,:,18))
  call vert_AV_Q(ntry, wf4(:,12), wf4(:,6), wf16(:,31), n3(:,59), t3x16(:,:,31))
  call prop_Q_A(ntry, wf8(:,30), Q(:,56), ZERO, 0_intkind1, wf8(:,31), n2(16))
  call vert_AZ_Q(gZu,ntry, wf4(:,12), wf4(:,7), wf16(:,32), n3(:,60), t3x16(:,:,32))
  call vert_VQ_A(ntry, ex7, ex5, wf4(:,14), n3(:,61), t3x4(:,:,11))
  call prop_Q_A(ntry, wf4(:,14), Q(:,80), ZERO, 0_intkind1, wf4(:,15), n2(17))
  call vert_AV_Q(ntry, ex3, wf4(:,6), wf8(:,32), n3(:,62), t3x8(:,:,19))
  call vert_WQ_A(ntry, wf4(:,11), wf4(:,15), wf16(:,33), n3(:,63), t3x16(:,:,33))
  call prop_A_Q(ntry, wf8(:,32), Q(:,7), ZERO, 0_intkind1, wf8(:,33), n2(18))
  call vert_AZ_Q(gZu,ntry, ex3, wf4(:,7), wf8(:,34), n3(:,64), t3x8(:,:,20))
  call prop_A_Q(ntry, wf8(:,34), Q(:,7), ZERO, 0_intkind1, wf8(:,35), n2(19))
  call vert_AW_Q(ntry, ex3, wf4(:,11), wf8(:,36), n3(:,65), t3x8(:,:,21))
  call vert_VQ_A(ntry, wf4(:,6), wf4(:,15), wf16(:,34), n3(:,66), t3x16(:,:,34))
  call prop_A_Q(ntry, wf8(:,36), Q(:,44), ZERO, 0_intkind1, wf8(:,37), n2(20))
  call vert_ZQ_A(gZd,ntry, wf4(:,7), wf4(:,15), wf16(:,35), n3(:,67), t3x16(:,:,35))
  call vert_QA_W(ntry, wf4(:,15), ex3, wf8(:,38), n3(:,68), t3x8(:,:,22))
  call vert_AV_Q(ntry, wf8(:,33), ex7, wf16(:,36), n3(:,69), t3x16(:,:,36))
  call vert_AV_Q(ntry, wf8(:,35), ex7, wf16(:,37), n3(:,70), t3x16(:,:,37))
  call vert_AV_Q(ntry, wf8(:,37), ex7, wf16(:,38), n3(:,71), t3x16(:,:,38))
  call vert_QA_W(ntry, wf8(:,14), ex6, wf16(:,39), n3(:,72), t3x16(:,:,39))
  call vert_QA_W(ntry, wf8(:,16), ex6, wf16(:,40), n3(:,73), t3x16(:,:,40))
  call vert_QA_W(ntry, wf8(:,18), ex6, wf16(:,41), n3(:,74), t3x16(:,:,41))
  call vert_QA_W(ntry, wf8(:,20), ex6, wf16(:,42), n3(:,75), t3x16(:,:,42))
  call vert_WQ_A(ntry, wf8(:,29), ex4, wf16(:,43), n3(:,76), t3x16(:,:,43))
  call vert_QA_W(ntry, ex5, wf8(:,33), wf16(:,44), n3(:,77), t3x16(:,:,44))
  call vert_QA_W(ntry, ex5, wf8(:,35), wf16(:,45), n3(:,78), t3x16(:,:,45))
  call vert_QA_W(ntry, wf8(:,26), ex3, wf16(:,46), n3(:,79), t3x16(:,:,46))
  call vert_QA_W(ntry, wf8(:,28), ex3, wf16(:,47), n3(:,80), t3x16(:,:,47))
  call vert_AW_Q(ntry, ex6, wf8(:,38), wf16(:,48), n3(:,81), t3x16(:,:,48))
  call vert_WQ_A(ntry, wf8(:,38), ex4, wf16(:,49), n3(:,82), t3x16(:,:,49))
  call vert_AW_Q(ntry, ex3, wf8(:,24), wf16(:,50), n3(:,83), t3x16(:,:,50))
  call vert_AW_Q(ntry, ex2, wf4(:,2), wf8(:,39), n3(:,84), t3x8(:,:,23))
  call prop_A_Q(ntry, wf8(:,39), Q(:,22), ZERO, 0_intkind1, wf8(:,40), n2(21))
  call vert_AQ_S(gPnl,ntry, wf8(:,40), ex1, wf16(:,51), n3(:,85), t3x16(:,:,51))
  call vert_QA_W(ntry, ex1, wf8(:,40), wf16(:,52), n3(:,86), t3x16(:,:,52))
  call vert_QS_A(gPnl,ntry, ex1, wf4(:,13), wf8(:,41), n3(:,87), t3x8(:,:,24))
  call prop_Q_A(ntry, wf8(:,41), Q(:,41), ZERO, 0_intkind1, wf8(:,42), n2(22))
  call vert_QA_W(ntry, wf8(:,42), ex2, wf16(:,53), n3(:,88), t3x16(:,:,53))
  call vert_WQ_A(ntry, wf4(:,11), ex1, wf8(:,43), n3(:,89), t3x8(:,:,25))
  call prop_Q_A(ntry, wf8(:,43), Q(:,41), ZERO, 0_intkind1, wf8(:,44), n2(23))
  call vert_QA_W(ntry, wf8(:,44), ex2, wf16(:,54), n3(:,90), t3x16(:,:,54))
  ...
  M2add = M2 / average_factor_pptllj_eexuxtdbxg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_pptllj_eexuxtdbxg_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = (A(j,94)%j+A(j,96)%j)*f(1)+(-A(j,43)%j-A(j,56)%j)*f(2)+(-A(j,41)%j+A(j,42)%j-A(j,54)%j+A(j,55)%j)*f(3)+(-A(j,93)%j &
  ...
  M1(2) = (A(j,90)%j+A(j,92)%j)*f(1)+(-A(j,11)%j-A(j,26)%j)*f(2)+(-A(j,9)%j+A(j,10)%j-A(j,24)%j+A(j,25)%j)*f(3)+(-A(j,89)%j &
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_pptllj_eexuxtdbxg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pptllj_eexuxtdbxg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pptllj_eexuxtdbxg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pptllj_eexuxtdbxg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pptllj_eexuxtdbxg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pptllj_eexuxtdbxg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pptllj_eexuxtdbxg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pptllj_eexuxtdbxg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pptllj_eexuxtdbxg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pptllj_eexuxtdbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pptllj_eexuxtdbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pptllj_eexuxtdbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pptllj_eexuxtdbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pptllj_eexuxtdbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pptllj_eexuxtdbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pptllj_eexuxtdbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pptllj_eexuxtdbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_pptllj_eexuxtdbxg_1_/**/REALKIND
