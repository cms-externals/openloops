...
module ol_versiondata_pptaj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptaj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptaj
  end interface
end module ol_versiondata_pptaj


subroutine ol_version_pptaj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptaj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptaj
