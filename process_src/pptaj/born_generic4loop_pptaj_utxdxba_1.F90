...
! **********************************************************************
module ol_heltables_pptaj_utxdxba_1
! **********************************************************************
  ...
  integer(intkind2), save :: t3x8(2,8,6), t3x32(2,32,6), t3x4(2,4,7)
...
! **********************************************************************
  ...
  call heltable([4,8,32], n3(:,15), t3x32(:,:,2))
  call heltable([4,8,32], n3(:,16), t3x32(:,:,3))
  call heltable([4,8,32], n3(:,17), t3x32(:,:,4))
  call heltable([4,8,32], n3(:,18), t3x32(:,:,5))
  call heltable([4,8,32], n3(:,19), t3x32(:,:,6))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_pptaj_utxdxba_1
