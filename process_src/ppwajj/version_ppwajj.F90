...
module ol_versiondata_ppwajj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppwajj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppwajj
  end interface
end module ol_versiondata_ppwajj


subroutine ol_version_ppwajj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppwajj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppwajj
