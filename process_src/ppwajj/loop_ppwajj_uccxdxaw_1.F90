...
module ol_colourmatrix_ppwajj_uccxdxaw_1_/**/REALKIND
...
end module ol_colourmatrix_ppwajj_uccxdxaw_1_/**/REALKIND



module ol_forced_parameters_ppwajj_uccxdxaw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwajj_uccxdxaw_1_/**/REALKIND

module ol_loop_ppwajj_uccxdxaw_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_A_Q(ctqq,wf(:,5),Q(:,40),wf(:,86))
  ...
  call counter_Q_A(ctqq,wf(:,17),Q(:,7),wf(:,99))
  ...
  call counter_Q_A(ctcc,wf(:,26),Q(:,18),wf(:,108))
  ...
  call counter_A_Q(ctcc,wf(:,31),Q(:,20),wf(:,114))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(3)-A(4)-A(5))*f(1))/6._/**/REALKIND+((A(1)+A(2)+A(6)+A(9)+A(10)+A(11)+A(12))*f(2))/6._/**/REALKIND+((A(7) &
       +A(8))*f(3))/6._/**/REALKIND
  M1(2) = ((A(3)+A(4)+A(5))*f(1))/2._/**/REALKIND+((-A(1)-A(2)-A(6)-A(9)-A(10)-A(11)-A(12))*f(2))/2._/**/REALKIND+((-A(7) &
       -A(8))*f(3))/2._/**/REALKIND

  M2(1) = ((A(65)+A(66)+A(67)+A(68)+A(69)+A(70)+A(71)+A(72)+A(73))*f(4))/6._/**/REALKIND+((-A(59)-A(60)-A(61)-A(62)-A(63)-A(64) &
       -A(74)-A(75)-A(76)-A(81)-A(82)-A(83)-A(84)-A(85)-A(86)-A(87)-A(88)-A(89)-A(90)-A(91)-A(92))*f(5))/6._/**/REALKIND+((-A(77) &
       -A(78)-A(79)-A(80))*f(6))/6._/**/REALKIND+((-A(41)-A(42)-A(43))*f(7))/6._/**/REALKIND+((A(31)+A(32)+A(35)+A(36)+A(39)+A(40) &
       +A(44))*f(8))/6._/**/REALKIND+((A(45)+A(46))*f(9))/6._/**/REALKIND+((-A(15)-A(21)-A(47))*f(10))/6._/**/REALKIND+((A(13) &
       +A(19)+A(27)+A(29)+A(49)+A(55)+A(57))*f(11))/6._/**/REALKIND+((A(23)+A(50))*f(12))/6._/**/REALKIND+((A(33)+A(34)+A(37) &
       +A(38))*f(13))/6._/**/REALKIND+((-A(16)-A(17)-A(25)-A(26)-A(48)-A(52))*f(14))/6._/**/REALKIND+((A(14)+A(18)+A(20)+A(24) &
       +A(28)+A(30)+A(53)+A(54)+A(56)+A(58))*f(15))/6._/**/REALKIND+((A(22)+A(51))*f(16))/6._/**/REALKIND
  M2(2) = ((-A(65)-A(66)-A(67)-A(68)-A(69)-A(70)-A(71)-A(72)-A(73))*f(4))/2._/**/REALKIND+((A(59)+A(60)+A(61)+A(62)+A(63)+A(64) &
       +A(74)+A(75)+A(76)+A(81)+A(82)+A(83)+A(84)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90)+A(91)+A(92))*f(5))/2._/**/REALKIND+((A(77) &
       +A(78)+A(79)+A(80))*f(6))/2._/**/REALKIND+((A(41)+A(42)+A(43))*f(7))/2._/**/REALKIND+((-A(31)-A(32)-A(35)-A(36)-A(39)-A(40) &
       -A(44))*f(8))/2._/**/REALKIND+((-A(45)-A(46))*f(9))/2._/**/REALKIND+((A(15)+A(21)+A(47))*f(10))/2._/**/REALKIND+((-A(13) &
       -A(19)-A(27)-A(29)-A(49)-A(55)-A(57))*f(11))/2._/**/REALKIND+((-A(23)-A(50))*f(12))/2._/**/REALKIND+((-A(33)-A(34)-A(37) &
       -A(38))*f(13))/2._/**/REALKIND+((A(16)+A(17)+A(25)+A(26)+A(48)+A(52))*f(14))/2._/**/REALKIND+((-A(14)-A(18)-A(20)-A(24) &
       -A(28)-A(30)-A(53)-A(54)-A(56)-A(58))*f(15))/2._/**/REALKIND+((-A(22)-A(51))*f(16))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppwajj_uccxdxaw_1_/**/REALKIND
