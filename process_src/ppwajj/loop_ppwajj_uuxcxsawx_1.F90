...
! **********************************************************************
  ...
  call counter_VQ_A(wf(:,1),wf(:,-3),wf(:,39))
  call prop_A_Q(wf(:,8),Q(:,52),ZERO,0_intkind1,wf(:,40))
  call counter_WQ_A(wf(:,-5),wf(:,-3),wf(:,41))
  call prop_Q_A(wf(:,41),Q(:,40),ZERO,0_intkind1,wf(:,42))
  call prop_A_Q(wf(:,18),Q(:,52),ZERO,0_intkind1,wf(:,43))
  ...
  call counter_AV_Q(wf(:,-2),wf(:,1),wf(:,49))
  call prop_Q_A(wf(:,16),Q(:,56),ZERO,0_intkind1,wf(:,50))
  call counter_AW_Q(wf(:,-2),wf(:,-5),wf(:,51))
  call prop_A_Q(wf(:,51),Q(:,36),ZERO,0_intkind1,wf(:,52))
  call vert_AV_Q(wf(:,52),wf(:,1),wf(:,53))
  call prop_Q_A(wf(:,19),Q(:,56),ZERO,0_intkind1,wf(:,54))
  call counter_AW_Q(wf(:,-2),wf(:,21),wf(:,55))
  call prop_Q_A(wf(:,22),Q(:,56),ZERO,0_intkind1,wf(:,56))
  call vert_AV_Q(wf(:,52),wf(:,-4),wf(:,57))
  call counter_AV_Q(wf(:,-2),wf(:,-4),wf(:,58))
  call prop_A_Q(wf(:,58),Q(:,20),ZERO,0_intkind1,wf(:,59))
  call vert_AV_Q(wf(:,59),wf(:,1),wf(:,60))
  call vert_AW_Q(wf(:,59),wf(:,-5),wf(:,61))
  call counter_QA_V(wf(:,-3),wf(:,12),wf(:,62))
  call vert_QA_V(wf(:,42),wf(:,-2),wf(:,63))
  call counter_QA_V(wf(:,5),wf(:,-2),wf(:,64))
  call vert_QA_V(wf(:,-3),wf(:,52),wf(:,65))
  ...
  call vert_AV_Q(wf(:,4),wf(:,74),wf(:,75))
  call vert_VQ_A(wf(:,74),wf(:,-3),wf(:,76))
  call prop_Q_A(wf(:,76),Q(:,11),ZERO,0_intkind1,wf(:,77))
  call vert_AV_Q(wf(:,12),wf(:,74),wf(:,78))
  call vert_AV_Q(wf(:,-2),wf(:,74),wf(:,79))
  call prop_A_Q(wf(:,79),Q(:,7),ZERO,0_intkind1,wf(:,80))
  call vert_QA_V(wf(:,5),wf(:,4),wf(:,81))
  call counter_V_V(ctGG,wf(:,1),Q(:,3),wf(:,82))
  call vert_VQ_A(wf(:,1),wf(:,5),wf(:,83))
  call counter_A_Q(ctcc,wf(:,4),Q(:,20),wf(:,84))
  call prop_Q_A(wf(:,83),Q(:,43),ZERO,0_intkind1,wf(:,85))
  call counter_Q_A(ctcc,wf(:,5),Q(:,40),wf(:,86))
  call prop_A_Q(wf(:,6),Q(:,23),ZERO,0_intkind1,wf(:,87))
  call vert_VQ_A(wf(:,82),wf(:,-3),wf(:,88))
  call prop_A_Q(wf(:,84),Q(:,20),ZERO,0_intkind1,wf(:,89))
  call vert_AW_Q(wf(:,89),wf(:,-5),wf(:,90))
  call counter_Q_A(ctqq,wf(:,9),Q(:,11),wf(:,91))
  call vert_QA_V(wf(:,13),wf(:,12),wf(:,92))
  call vert_VQ_A(wf(:,1),wf(:,13),wf(:,93))
  call counter_A_Q(ctqq,wf(:,12),Q(:,36),wf(:,94))
  call prop_Q_A(wf(:,93),Q(:,27),ZERO,0_intkind1,wf(:,95))
  call counter_Q_A(ctqq,wf(:,13),Q(:,24),wf(:,96))
  call prop_A_Q(wf(:,14),Q(:,39),ZERO,0_intkind1,wf(:,97))
  call vert_AV_Q(wf(:,-2),wf(:,82),wf(:,98))
  call counter_A_Q(ctcc,wf(:,17),Q(:,7),wf(:,99))
  call prop_Q_A(wf(:,96),Q(:,24),ZERO,0_intkind1,wf(:,100))
  call vert_WQ_A(wf(:,-5),wf(:,100),wf(:,101))
  call prop_A_Q(wf(:,94),Q(:,36),ZERO,0_intkind1,wf(:,102))
  call vert_AV_Q(wf(:,102),wf(:,-4),wf(:,103))
  call prop_Q_A(wf(:,86),Q(:,40),ZERO,0_intkind1,wf(:,104))
  call vert_VQ_A(wf(:,-4),wf(:,104),wf(:,105))
  call counter_A_Q(ctqq,wf(:,24),Q(:,52),wf(:,106))
  ...
  call vert_QA_V(wf(:,-3),wf(:,102),wf(:,111))
  call vert_QA_V(wf(:,104),wf(:,-2),wf(:,112))
  ...
  call vert_AV_Q(wf(:,17),wf(:,-4),wf(:,117))
  call prop_A_Q(wf(:,117),Q(:,23),ZERO,0_intkind1,wf(:,118))
  call vert_AW_Q(wf(:,17),wf(:,-5),wf(:,119))
  call prop_A_Q(wf(:,119),Q(:,39),ZERO,0_intkind1,wf(:,120))
  call vert_VQ_A(wf(:,-4),wf(:,9),wf(:,121))
  call prop_Q_A(wf(:,121),Q(:,27),ZERO,0_intkind1,wf(:,122))
  call vert_WQ_A(wf(:,-5),wf(:,9),wf(:,123))
  call prop_Q_A(wf(:,123),Q(:,43),ZERO,0_intkind1,wf(:,124))
  call vert_AV_Q(wf(:,-2),wf(:,27),wf(:,125))
  call prop_A_Q(wf(:,125),Q(:,23),ZERO,0_intkind1,wf(:,126))
  call vert_VQ_A(wf(:,27),wf(:,-3),wf(:,127))
  call prop_Q_A(wf(:,127),Q(:,27),ZERO,0_intkind1,wf(:,128))
  call vert_AV_Q(wf(:,-2),wf(:,32),wf(:,129))
  call prop_A_Q(wf(:,129),Q(:,23),ZERO,0_intkind1,wf(:,130))
  call vert_VQ_A(wf(:,32),wf(:,-3),wf(:,131))
  call prop_Q_A(wf(:,131),Q(:,27),ZERO,0_intkind1,wf(:,132))
  call vert_QA_V(wf(:,-3),wf(:,40),wf(:,133))
  call vert_QA_V(wf(:,50),wf(:,-2),wf(:,134))
  ...
  call vert_QA_V(wf(:,-3),wf(:,43),wf(:,139))
  ...
  call vert_QA_V(wf(:,54),wf(:,-2),wf(:,144))
  call vert_QA_V(wf(:,-3),wf(:,24),wf(:,145))
  call vert_QA_V(wf(:,56),wf(:,-2),wf(:,146))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(65)+A(66)+A(67)+A(68)+A(69)+A(70)+A(71)+A(72)+A(73))*f(4))/2._/**/REALKIND+((-A(59)-A(60)-A(61)-A(62)-A(63)-A(64) &
       ...
       +A(34))*f(13))/2._/**/REALKIND+((-A(16)-A(17)-A(25)-A(26)-A(28)-A(32))*f(14))/2._/**/REALKIND+((A(14)+A(20)+A(24)+A(36) &
       +A(38)+A(40)+A(42)+A(45)+A(46)+A(49)+A(50))*f(15))/2._/**/REALKIND+((A(22)+A(30))*f(16))/2._/**/REALKIND
  M2(2) = ((-A(65)-A(66)-A(67)-A(68)-A(69)-A(70)-A(71)-A(72)-A(73))*f(4))/6._/**/REALKIND+((A(59)+A(60)+A(61)+A(62)+A(63)+A(64) &
       ...
       -A(34))*f(13))/6._/**/REALKIND+((A(16)+A(17)+A(25)+A(26)+A(28)+A(32))*f(14))/6._/**/REALKIND+((-A(14)-A(20)-A(24)-A(36) &
       -A(38)-A(40)-A(42)-A(45)-A(46)-A(49)-A(50))*f(15))/6._/**/REALKIND+((-A(22)-A(30))*f(16))/6._/**/REALKIND
