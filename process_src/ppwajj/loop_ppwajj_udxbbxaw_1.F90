...
module ol_colourmatrix_ppwajj_udxbbxaw_1_/**/REALKIND
...
end module ol_colourmatrix_ppwajj_udxbbxaw_1_/**/REALKIND



module ol_forced_parameters_ppwajj_udxbbxaw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwajj_udxbbxaw_1_/**/REALKIND

module ol_loop_ppwajj_udxbbxaw_1_/**/REALKIND
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(65)-A(66)-A(67)-A(68)-A(69)-A(70)-A(71)-A(72)-A(73)-A(81)-A(82)-A(83)-A(84)-A(85)-A(86)-A(87)-A(88)-A(89)-A(90) &
       ...
       +A(78)+A(79)+A(80))*f(6))/2._/**/REALKIND+((A(19)+A(20)+A(23)+A(24)+A(29)+A(30)+A(31))*f(7))/2._/**/REALKIND+((-A(27)-A(28) &
       -A(32))*f(8))/2._/**/REALKIND+((-A(33)-A(34))*f(9))/2._/**/REALKIND+((A(15)+A(37)+A(43)+A(45)+A(47)+A(55) &
  ...
  M2(2) = ((A(65)+A(66)+A(67)+A(68)+A(69)+A(70)+A(71)+A(72)+A(73)+A(81)+A(82)+A(83)+A(84)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90) &
       ...
       -A(77)-A(78)-A(79)-A(80))*f(6))/6._/**/REALKIND+((-A(19)-A(20)-A(23)-A(24)-A(29)-A(30)-A(31))*f(7))/6._/**/REALKIND+((A(27) &
       +A(28)+A(32))*f(8))/6._/**/REALKIND+((A(33)+A(34))*f(9))/6._/**/REALKIND+((-A(15)-A(37)-A(43)-A(45)-A(47)-A(55) &
...
end module ol_loop_ppwajj_udxbbxaw_1_/**/REALKIND
