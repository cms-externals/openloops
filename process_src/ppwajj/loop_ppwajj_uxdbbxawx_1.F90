...
module ol_colourmatrix_ppwajj_uxdbbxawx_1_/**/REALKIND
...
end module ol_colourmatrix_ppwajj_uxdbbxawx_1_/**/REALKIND



module ol_forced_parameters_ppwajj_uxdbbxawx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwajj_uxdbbxawx_1_/**/REALKIND

module ol_loop_ppwajj_uxdbbxawx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 7) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/(3._/**/REALKIND*sqrt2*sw)
    f( 8) = (2*CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/(3._/**/REALKIND*sqrt2*sw)
    f( 9) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/(sqrt2*sw)
    ...
    f(13) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**4)/(3._/**/REALKIND*sqrt2*sw)
...
! **********************************************************************
  ...
  call vert_VQ_A(wf(:,-4),wf(:,-1),wf(:,11))
  ...
  call prop_A_Q(wf(:,40),Q(:,24),MB,1_intkind1,wf(:,41))
  call vert_QA_V(wf(:,-2),wf(:,41),wf(:,42))
  call counter_QA_V(wf(:,-2),wf(:,31),wf(:,43))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,44))
  call prop_Q_A(wf(:,44),Q(:,20),MB,1_intkind1,wf(:,45))
  call vert_QA_V(wf(:,45),wf(:,-3),wf(:,46))
  call counter_QA_V(wf(:,-2),wf(:,-3),wf(:,47))
  call vert_VQ_A(wf(:,47),wf(:,-1),wf(:,48))
  call prop_Q_A(wf(:,48),Q(:,14),ZERO,0_intkind1,wf(:,49))
  call vert_AV_Q(wf(:,0),wf(:,47),wf(:,50))
  call prop_A_Q(wf(:,50),Q(:,13),ZERO,0_intkind1,wf(:,51))
  call counter_VQ_A(wf(:,3),wf(:,-1),wf(:,52))
  call prop_A_Q(wf(:,8),Q(:,49),ZERO,0_intkind1,wf(:,53))
  call counter_WQ_A(wf(:,-5),wf(:,-1),wf(:,54))
  call prop_Q_A(wf(:,54),Q(:,34),ZERO,0_intkind1,wf(:,55))
  call vert_QA_V(wf(:,55),wf(:,4),wf(:,56))
  call prop_A_Q(wf(:,18),Q(:,49),ZERO,0_intkind1,wf(:,57))
  call counter_WQ_A(wf(:,21),wf(:,-1),wf(:,58))
  call vert_VQ_A(wf(:,-4),wf(:,55),wf(:,59))
  call counter_VQ_A(wf(:,-4),wf(:,-1),wf(:,60))
  call prop_Q_A(wf(:,60),Q(:,18),ZERO,0_intkind1,wf(:,61))
  call vert_QA_V(wf(:,61),wf(:,12),wf(:,62))
  call vert_WQ_A(wf(:,-5),wf(:,61),wf(:,63))
  call counter_QA_V(wf(:,-1),wf(:,12),wf(:,64))
  call vert_QA_V(wf(:,55),wf(:,0),wf(:,65))
  call counter_AV_Q(wf(:,0),wf(:,3),wf(:,66))
  call prop_Q_A(wf(:,16),Q(:,50),ZERO,0_intkind1,wf(:,67))
  call counter_AW_Q(wf(:,0),wf(:,-5),wf(:,68))
  call prop_A_Q(wf(:,68),Q(:,33),ZERO,0_intkind1,wf(:,69))
  call vert_QA_V(wf(:,13),wf(:,69),wf(:,70))
  call prop_Q_A(wf(:,19),Q(:,50),ZERO,0_intkind1,wf(:,71))
  call prop_Q_A(wf(:,22),Q(:,50),ZERO,0_intkind1,wf(:,72))
  ...
  call vert_QA_V(wf(:,5),wf(:,76),wf(:,77))
  call vert_AW_Q(wf(:,76),wf(:,-5),wf(:,78))
  call counter_QA_V(wf(:,5),wf(:,0),wf(:,79))
  call vert_QA_V(wf(:,-1),wf(:,69),wf(:,80))
  call vert_VQ_A(wf(:,3),wf(:,5),wf(:,81))
  call counter_A_Q(ctqq,wf(:,4),Q(:,17),wf(:,82))
  call prop_Q_A(wf(:,81),Q(:,46),ZERO,0_intkind1,wf(:,83))
  call vert_AV_Q(wf(:,4),wf(:,3),wf(:,84))
  call counter_Q_A(ctqq,wf(:,5),Q(:,34),wf(:,85))
  call prop_A_Q(wf(:,84),Q(:,29),ZERO,0_intkind1,wf(:,86))
  call counter_V_V(ctGG,wf(:,3),Q(:,12),wf(:,87))
  call prop_A_Q(wf(:,82),Q(:,17),ZERO,0_intkind1,wf(:,88))
  call vert_AW_Q(wf(:,88),wf(:,-5),wf(:,89))
  call vert_VQ_A(wf(:,87),wf(:,-1),wf(:,90))
  call counter_Q_A(ctqq,wf(:,9),Q(:,14),wf(:,91))
  call vert_VQ_A(wf(:,3),wf(:,13),wf(:,92))
  call counter_A_Q(ctqq,wf(:,12),Q(:,33),wf(:,93))
  call prop_Q_A(wf(:,92),Q(:,30),ZERO,0_intkind1,wf(:,94))
  call vert_AV_Q(wf(:,12),wf(:,3),wf(:,95))
  call counter_Q_A(ctqq,wf(:,13),Q(:,18),wf(:,96))
  call prop_A_Q(wf(:,95),Q(:,45),ZERO,0_intkind1,wf(:,97))
  call vert_AV_Q(wf(:,0),wf(:,87),wf(:,98))
  call counter_A_Q(ctqq,wf(:,17),Q(:,13),wf(:,99))
  call prop_Q_A(wf(:,96),Q(:,18),ZERO,0_intkind1,wf(:,100))
  call vert_WQ_A(wf(:,-5),wf(:,100),wf(:,101))
  call prop_A_Q(wf(:,93),Q(:,33),ZERO,0_intkind1,wf(:,102))
  call vert_AV_Q(wf(:,102),wf(:,-4),wf(:,103))
  call prop_Q_A(wf(:,85),Q(:,34),ZERO,0_intkind1,wf(:,104))
  call vert_VQ_A(wf(:,-4),wf(:,104),wf(:,105))
  call counter_A_Q(ctqq,wf(:,24),Q(:,49),wf(:,106))
  call vert_QA_V(wf(:,-1),wf(:,102),wf(:,107))
  call counter_V_V(ctGG,wf(:,27),Q(:,35),wf(:,108))
  call counter_Q_A(ctbb,wf(:,26),Q(:,20),wf(:,109))
  call prop_Q_A(wf(:,109),Q(:,20),MB,1_intkind1,wf(:,110))
  call vert_QA_V(wf(:,110),wf(:,-3),wf(:,111))
  call vert_QA_V(wf(:,104),wf(:,0),wf(:,112))
  call counter_V_V(ctGG,wf(:,29),Q(:,35),wf(:,113))
  call counter_A_Q(ctbb,wf(:,31),Q(:,24),wf(:,114))
  call prop_A_Q(wf(:,114),Q(:,24),MB,1_intkind1,wf(:,115))
  call vert_QA_V(wf(:,-2),wf(:,115),wf(:,116))
  call vert_AV_Q(wf(:,17),wf(:,-4),wf(:,117))
  call prop_A_Q(wf(:,117),Q(:,29),ZERO,0_intkind1,wf(:,118))
  call vert_AW_Q(wf(:,17),wf(:,-5),wf(:,119))
  call prop_A_Q(wf(:,119),Q(:,45),ZERO,0_intkind1,wf(:,120))
  call vert_VQ_A(wf(:,-4),wf(:,9),wf(:,121))
  call prop_Q_A(wf(:,121),Q(:,30),ZERO,0_intkind1,wf(:,122))
  call vert_WQ_A(wf(:,-5),wf(:,9),wf(:,123))
  call prop_Q_A(wf(:,123),Q(:,46),ZERO,0_intkind1,wf(:,124))
  call vert_QA_V(wf(:,-1),wf(:,53),wf(:,125))
  call vert_QA_V(wf(:,67),wf(:,0),wf(:,126))
  call vert_AV_Q(wf(:,0),wf(:,28),wf(:,127))
  call prop_A_Q(wf(:,127),Q(:,29),ZERO,0_intkind1,wf(:,128))
  call vert_VQ_A(wf(:,28),wf(:,-1),wf(:,129))
  ...
  call vert_VQ_A(wf(:,32),wf(:,-1),wf(:,133))
  call prop_Q_A(wf(:,133),Q(:,30),ZERO,0_intkind1,wf(:,134))
  call vert_VQ_A(wf(:,27),wf(:,-2),wf(:,135))
  call prop_Q_A(wf(:,135),Q(:,39),MB,1_intkind1,wf(:,136))
  call vert_AV_Q(wf(:,-3),wf(:,27),wf(:,137))
  call prop_A_Q(wf(:,137),Q(:,43),MB,1_intkind1,wf(:,138))
  call vert_QA_V(wf(:,-1),wf(:,57),wf(:,139))
  call vert_VQ_A(wf(:,29),wf(:,-2),wf(:,140))
  call prop_Q_A(wf(:,140),Q(:,39),MB,1_intkind1,wf(:,141))
  call vert_AV_Q(wf(:,-3),wf(:,29),wf(:,142))
  call prop_A_Q(wf(:,142),Q(:,43),MB,1_intkind1,wf(:,143))
  call vert_QA_V(wf(:,71),wf(:,0),wf(:,144))
  call vert_QA_V(wf(:,-1),wf(:,24),wf(:,145))
  call vert_QA_V(wf(:,72),wf(:,0),wf(:,146))
...
subroutine denominators()
  ...
  den(68) = 1 / (Q(5,30))
  den(72) = 1 / (Q(5,45))
  den(117) = 1 / (Q(5,39) - MB2)
  den(119) = 1 / (Q(5,43) - MB2)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(65)+A(66)+A(67)+A(68)+A(69)+A(70)+A(71)+A(72)+A(73)+A(81)+A(82)+A(83)+A(84)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90) &
       ...
       -A(77)-A(78)-A(79)-A(80))*f(6))/2._/**/REALKIND+((-A(19)-A(20)-A(23)-A(24)-A(29)-A(30)-A(31))*f(7))/2._/**/REALKIND+((A(27) &
       +A(28)+A(32))*f(8))/2._/**/REALKIND+((A(33)+A(34))*f(9))/2._/**/REALKIND+((-A(15)-A(37)-A(43)-A(45)-A(47)-A(55) &
       -A(57))*f(10))/2._/**/REALKIND+((A(13)+A(35)+A(49))*f(11))/2._/**/REALKIND+((A(39)+A(50))*f(12))/2._/**/REALKIND+((-A(21) &
       -A(22)-A(25)-A(26))*f(13))/2._/**/REALKIND+((-A(16)-A(17)-A(41)-A(42)-A(44)-A(46)-A(48)-A(52)-A(56) &
       -A(58))*f(14))/2._/**/REALKIND+((A(14)+A(18)+A(36)+A(40)+A(53)+A(54))*f(15))/2._/**/REALKIND+((A(38) &
  ...
  M2(2) = ((-A(65)-A(66)-A(67)-A(68)-A(69)-A(70)-A(71)-A(72)-A(73)-A(81)-A(82)-A(83)-A(84)-A(85)-A(86)-A(87)-A(88)-A(89)-A(90) &
       ...
       +A(78)+A(79)+A(80))*f(6))/6._/**/REALKIND+((A(19)+A(20)+A(23)+A(24)+A(29)+A(30)+A(31))*f(7))/6._/**/REALKIND+((-A(27)-A(28) &
       -A(32))*f(8))/6._/**/REALKIND+((-A(33)-A(34))*f(9))/6._/**/REALKIND+((A(15)+A(37)+A(43)+A(45)+A(47)+A(55) &
       +A(57))*f(10))/6._/**/REALKIND+((-A(13)-A(35)-A(49))*f(11))/6._/**/REALKIND+((-A(39)-A(50))*f(12))/6._/**/REALKIND+((A(21) &
       +A(22)+A(25)+A(26))*f(13))/6._/**/REALKIND+((A(16)+A(17)+A(41)+A(42)+A(44)+A(46)+A(48)+A(52)+A(56) &
       +A(58))*f(14))/6._/**/REALKIND+((-A(14)-A(18)-A(36)-A(40)-A(53)-A(54))*f(15))/6._/**/REALKIND+((-A(38) &
       -A(51))*f(16))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppwajj_uxdbbxawx_1_/**/REALKIND
