...
module ol_colourmatrix_ppwajj_uxccxdawx_1_/**/REALKIND
...
end module ol_colourmatrix_ppwajj_uxccxdawx_1_/**/REALKIND



module ol_forced_parameters_ppwajj_uxccxdawx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwajj_uxccxdawx_1_/**/REALKIND

module ol_loop_ppwajj_uxccxdawx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctqq,wf(:,5),Q(:,40),wf(:,86))
  ...
  call counter_A_Q(ctqq,wf(:,17),Q(:,7),wf(:,99))
...
end module ol_loop_ppwajj_uxccxdawx_1_/**/REALKIND
