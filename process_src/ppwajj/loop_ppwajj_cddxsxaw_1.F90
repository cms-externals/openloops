...
module ol_colourmatrix_ppwajj_cddxsxaw_1_/**/REALKIND
...
end module ol_colourmatrix_ppwajj_cddxsxaw_1_/**/REALKIND



module ol_forced_parameters_ppwajj_cddxsxaw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwajj_cddxsxaw_1_/**/REALKIND

module ol_loop_ppwajj_cddxsxaw_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(15) = (CI*countertermnorm*ctVsc*eQED**2*gQCD**4)/(3._/**/REALKIND*sqrt2*sw)
    f(16) = (2*CI*countertermnorm*ctVsc*eQED**2*gQCD**4)/(3._/**/REALKIND*sqrt2*sw)
    f(17) = (CI*countertermnorm*ctVsc*eQED**2*gQCD**4)/(sqrt2*sw)
    f(18) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/(3._/**/REALKIND*sqrt2*sw)
    f(19) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/(3._/**/REALKIND*sqrt2*sw)
    f(20) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/(sqrt2*sw)
    f(21) = (eQED**2*gQCD**4*integralnorm*SwB)/(sqrt2*sw*6._/**/REALKIND)
    f(22) = (eQED**2*gQCD**4*integralnorm*SwB)/(sqrt2*sw*3._/**/REALKIND)
    f(23) = (eQED**2*gQCD**4*integralnorm*SwB)/(sqrt2*sw*2._/**/REALKIND)
    f(24) = (2*eQED**2*gQCD**4*integralnorm*SwB)/(sqrt2*sw*3._/**/REALKIND)
    f(25) = (eQED**2*gQCD**4*integralnorm*SwB)/(sqrt2*sw)
    f(26) = (eQED**2*gQCD**4*integralnorm*SwF)/(sqrt2*sw*3._/**/REALKIND)
    f(27) = (2*eQED**2*gQCD**4*integralnorm*SwF)/(sqrt2*sw*3._/**/REALKIND)
    f(28) = (eQED**2*gQCD**4*integralnorm*SwF)/(sqrt2*sw)
    f(29) = (4*eQED**2*gQCD**4*integralnorm*SwF)/(sqrt2*sw*3._/**/REALKIND)
    f(30) = (2*eQED**2*gQCD**4*integralnorm*SwF)/(sqrt2*sw)
...
! **********************************************************************
  ...
  call counter_AV_Q(wf(:,-3),wf(:,2),wf(:,39))
  call prop_Q_A(wf(:,8),Q(:,49),ZERO,0_intkind1,wf(:,40))
  call counter_AW_Q(wf(:,-3),wf(:,-5),wf(:,41))
  call prop_A_Q(wf(:,41),Q(:,40),ZERO,0_intkind1,wf(:,42))
  call prop_Q_A(wf(:,18),Q(:,49),ZERO,0_intkind1,wf(:,43))
  ...
  call counter_QA_V(wf(:,12),wf(:,-3),wf(:,49))
  call vert_QA_V(wf(:,0),wf(:,42),wf(:,50))
  ...
  call vert_VQ_A(wf(:,59),wf(:,4),wf(:,60))
  call vert_AV_Q(wf(:,-3),wf(:,59),wf(:,61))
  call prop_A_Q(wf(:,61),Q(:,14),ZERO,0_intkind1,wf(:,62))
  call vert_VQ_A(wf(:,59),wf(:,12),wf(:,63))
  call vert_VQ_A(wf(:,59),wf(:,0),wf(:,64))
  call prop_Q_A(wf(:,64),Q(:,7),ZERO,0_intkind1,wf(:,65))
  call counter_VQ_A(wf(:,2),wf(:,0),wf(:,66))
  call prop_A_Q(wf(:,16),Q(:,56),ZERO,0_intkind1,wf(:,67))
  call counter_WQ_A(wf(:,-5),wf(:,0),wf(:,68))
  call prop_Q_A(wf(:,68),Q(:,33),ZERO,0_intkind1,wf(:,69))
  call vert_VQ_A(wf(:,2),wf(:,69),wf(:,70))
  call prop_A_Q(wf(:,19),Q(:,56),ZERO,0_intkind1,wf(:,71))
  call prop_A_Q(wf(:,22),Q(:,56),ZERO,0_intkind1,wf(:,72))
  ...
  call vert_QA_V(wf(:,102),wf(:,-3),wf(:,107))
  ...
  call vert_QA_V(wf(:,0),wf(:,104),wf(:,113))
  ...
  call vert_VQ_A(wf(:,-4),wf(:,17),wf(:,118))
  ...
  call vert_AV_Q(wf(:,9),wf(:,-4),wf(:,122))
  ...
  call vert_QA_V(wf(:,40),wf(:,-3),wf(:,126))
  call vert_VQ_A(wf(:,27),wf(:,0),wf(:,127))
  call prop_Q_A(wf(:,127),Q(:,23),ZERO,0_intkind1,wf(:,128))
  call vert_AV_Q(wf(:,-3),wf(:,27),wf(:,129))
  call prop_A_Q(wf(:,129),Q(:,30),ZERO,0_intkind1,wf(:,130))
  call vert_VQ_A(wf(:,32),wf(:,0),wf(:,131))
  call prop_Q_A(wf(:,131),Q(:,23),ZERO,0_intkind1,wf(:,132))
  call vert_AV_Q(wf(:,-3),wf(:,32),wf(:,133))
  call prop_A_Q(wf(:,133),Q(:,30),ZERO,0_intkind1,wf(:,134))
  call vert_QA_V(wf(:,0),wf(:,67),wf(:,135))
  ...
  call vert_QA_V(wf(:,43),wf(:,-3),wf(:,140))
  ...
  call vert_QA_V(wf(:,0),wf(:,71),wf(:,145))
  call vert_QA_V(wf(:,24),wf(:,-3),wf(:,146))
  call vert_QA_V(wf(:,0),wf(:,72),wf(:,147))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(65)+A(66)+A(67)+A(68)+A(69)+A(70)+A(71)+A(72)+A(73)+A(81)+A(82)+A(83)+A(84)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90) &
       ...
       -A(77)-A(78)-A(79)-A(80))*f(6))/6._/**/REALKIND+((-A(47)-A(55)-A(57))*f(7))/6._/**/REALKIND+((A(13) &
       +A(49))*f(8))/6._/**/REALKIND+(A(50)*f(9))/6._/**/REALKIND+((-A(15)-A(21)-A(27)-A(29)-A(31)-A(32)-A(35)-A(36)-A(41)-A(42) &
       -A(43))*f(10))/6._/**/REALKIND+((A(19)+A(39)+A(40)+A(44))*f(11))/6._/**/REALKIND+((A(23)+A(45) &
       +A(46))*f(12))/6._/**/REALKIND+((A(18)+A(53)+A(54))*f(13))/6._/**/REALKIND+((-A(17)-A(25)-A(26)-A(33)-A(34)-A(37) &
       -A(38))*f(14))/6._/**/REALKIND+((-A(16)-A(28)-A(30)-A(48)-A(52)-A(56)-A(58))*f(15))/6._/**/REALKIND+((A(14)+A(20) &
       +A(24))*f(16))/6._/**/REALKIND+((A(22)+A(51))*f(17))/6._/**/REALKIND
  M2(2) = ((-A(65)-A(66)-A(67)-A(68)-A(69)-A(70)-A(71)-A(72)-A(73)-A(81)-A(82)-A(83)-A(84)-A(85)-A(86)-A(87)-A(88)-A(89)-A(90) &
       ...
       +A(78)+A(79)+A(80))*f(6))/2._/**/REALKIND+((A(47)+A(55)+A(57))*f(7))/2._/**/REALKIND+((-A(13)-A(49))*f(8))/2._/**/REALKIND &
       -(A(50)*f(9))/2._/**/REALKIND+((A(15)+A(21)+A(27)+A(29)+A(31)+A(32)+A(35)+A(36)+A(41)+A(42)+A(43))*f(10))/2._/**/REALKIND &
       +((-A(19)-A(39)-A(40)-A(44))*f(11))/2._/**/REALKIND+((-A(23)-A(45)-A(46))*f(12))/2._/**/REALKIND+((-A(18)-A(53) &
       -A(54))*f(13))/2._/**/REALKIND+((A(17)+A(25)+A(26)+A(33)+A(34)+A(37)+A(38))*f(14))/2._/**/REALKIND+((A(16)+A(28)+A(30) &
       +A(48)+A(52)+A(56)+A(58))*f(15))/2._/**/REALKIND+((-A(14)-A(20)-A(24))*f(16))/2._/**/REALKIND+((-A(22) &
       -A(51))*f(17))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppwajj_cddxsxaw_1_/**/REALKIND
