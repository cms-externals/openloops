...
module ol_tree_ppwajj_uuxcsxaw_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppwajj_uuxcsxaw_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppwajj_uuxcsxaw_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for up anti-up charm anti-strange gamma W- -> 0
...
! **********************************************************************
  ...
  use ol_external_ppwajj_uuxcsxaw_1, only: external_perm_ppwajj_uuxcsxaw_1, &
    & external_perm_inv_ppwajj_uuxcsxaw_1, extcomb_perm_ppwajj_uuxcsxaw_1, &
    & average_factor_ppwajj_uuxcsxaw_1
  use ol_external_ppwajj_uuxcsxaw_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppwajj_uuxcsxaw_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppwajj_uuxcsxaw_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppwajj_uuxcsxaw_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppwajj_uuxcsxaw_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppwajj_uuxcsxaw_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppwajj_uuxcsxaw_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppwajj_uuxcsxaw_1(extcombs(k))
  end do
  ...
  call vert_WQ_A(ntry, ex6, ex3, wf6(:,3), n3(:,7), t3x6(:,:,2))
  ...
  call vert_WQ_A(ntry, wf6(:,6), ex3, wf12(:,6), n3(:,16), t3x12(:,:,6))
  call prop_Q_A(ntry, wf12(:,6), Q(:,52), ZERO, 0_intkind1, wf12(:,7), n2(8))
  call vert_VQ_A(ntry, ex5, ex1, wf4(:,6), n3(:,17), t3x4(:,:,4))
  call prop_Q_A(ntry, wf4(:,6), Q(:,17), ZERO, 0_intkind1, wf4(:,7), n2(9))
  call vert_QA_V(ntry, wf4(:,7), ex2, wf8(:,5), n3(:,18), t3x8(:,:,3))
  call vert_QA_V(ntry, wf6(:,4), ex4, wf12(:,8), n3(:,19), t3x12(:,:,7))
  call vert_QA_V(ntry, ex3, wf6(:,2), wf12(:,9), n3(:,20), t3x12(:,:,8))
  call vert_AV_Q(ntry, ex2, ex5, wf4(:,8), n3(:,21), t3x4(:,:,5))
  call prop_A_Q(ntry, wf4(:,8), Q(:,18), ZERO, 0_intkind1, wf4(:,9), n2(10))
  ...
  M2add = M2 / average_factor_ppwajj_uuxcsxaw_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_ppwajj_uuxcsxaw_1(k))
  end do
...
subroutine diagrams()
  ...
  ! e.g. call cont_VV(nsync, wf3, wf6, A(:,1), n64, t64, nhel, den(5)) ...
    ...
    call cont_VV(nsync, wf8(:,5), wf12(:,9), A(:,10), n3(:,32), t3x96(:,:,10), nhel, den(27))
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppwajj_uuxcsxaw_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppwajj_uuxcsxaw_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppwajj_uuxcsxaw_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppwajj_uuxcsxaw_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppwajj_uuxcsxaw_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppwajj_uuxcsxaw_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppwajj_uuxcsxaw_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppwajj_uuxcsxaw_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppwajj_uuxcsxaw_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppwajj_uuxcsxaw_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppwajj_uuxcsxaw_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppwajj_uuxcsxaw_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppwajj_uuxcsxaw_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppwajj_uuxcsxaw_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppwajj_uuxcsxaw_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppwajj_uuxcsxaw_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppwajj_uuxcsxaw_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_ppwajj_uuxcsxaw_1_/**/REALKIND
