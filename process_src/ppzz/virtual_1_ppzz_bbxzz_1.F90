...
module ol_vamp_1_ppzz_bbxzz_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppzz_bbxzz_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppzz_bbxzz_1.
! **********************************************************************
...
#endif
  use ol_loop_ppzz_bbxzz_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppzz_bbxzz_1_/**/REALKIND
  ...
  call loop_QZ_A(G1(:,:,:,5),wf(:,-2),G1(:,:,:,6),gZd)
  call loop_Q_A(G1(:,:,:,6),Q(:,13),MB,G2(:,:,:,3))
  call check_last_QA_V(l_switch,G2(:,:,:,3),wf(:,-1),G2tensor(:,3))
  call check_last_QA_V(l_switch,G1(:,:,:,5),wf(:,12),G1tensor(:,1))
...
end module ol_vamp_1_ppzz_bbxzz_1_/**/REALKIND
