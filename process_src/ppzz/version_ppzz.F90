...
module ol_versiondata_ppzz
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppzz(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzz
  end interface
end module ol_versiondata_ppzz


subroutine ol_version_ppzz(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzz, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzz
