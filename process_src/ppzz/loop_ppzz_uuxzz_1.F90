...
module ol_colourmatrix_ppzz_uuxzz_1_/**/REALKIND
...
end module ol_colourmatrix_ppzz_uuxzz_1_/**/REALKIND



module ol_forced_parameters_ppzz_uuxzz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzz_uuxzz_1_/**/REALKIND

module ol_loop_ppzz_uuxzz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(3) = CI*countertermnorm*ctVqq*eQED**2*gQCD**2
    f(4) = eQED**2*gQCD**2*integralnorm*SwB
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,0),wf(:,4))
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,-2),wf(:,5))
  call prop_Q_A(wf(:,4),Q(:,9),ZERO,0_intkind1,wf(:,6))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-3),wf(:,7))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-2),wf(:,8))
  call counter_ZQ_A(gZu,wf(:,-3),wf(:,0),wf(:,9))
  call prop_A_Q(wf(:,5),Q(:,6),ZERO,0_intkind1,wf(:,10))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,0),wf(:,11))
...
end module ol_loop_ppzz_uuxzz_1_/**/REALKIND
