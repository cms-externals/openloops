...
! **********************************************************************
module ol_tensor_sum_storage_pptw_txbwxg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pptw_txbwxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pptw_txbwxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pptw_txbwxg_1, only: channel_number_pptw_txbwxg_1
  ...
  call channel_on(channel_number_pptw_txbwxg_1)
  M2 = 0
  ...
  momenta_9(:,1) = Q(1:4,2)
  momenta_9(:,2) = Q(1:4,6)
  momenta_9(:,3) = Q(1:4,14)
  momenta_10(:,1) = Q(1:4,2)
  momenta_10(:,2) = Q(1:4,10)
  ...
  call TI_call(2, momenta_3, masses2_3, T2sum(:,1), M2)
  call TI_call(2, momenta_5, masses2_7, T2sum(:,2), M2)
  call TI_call(2, momenta_4, masses2_6, T2sum(:,3), M2)
  ...
  call channel_off(channel_number_pptw_txbwxg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pptw_txbwxg_1_/**/REALKIND
