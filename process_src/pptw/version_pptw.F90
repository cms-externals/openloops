...
module ol_versiondata_pptw
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptw(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptw
  end interface
end module ol_versiondata_pptw


subroutine ol_version_pptw(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptw, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptw
