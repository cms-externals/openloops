...
module ol_colourmatrix_pph2_hgg_1_/**/REALKIND
...
end module ol_colourmatrix_pph2_hgg_1_/**/REALKIND



module ol_forced_parameters_pph2_hgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pph2_hgg_1_/**/REALKIND

module ol_loop_pph2_hgg_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-3+1:1)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = (CI*countertermnorm*ctHGG*eQED*gQCD**2*MB*YB)/MQ2sum
    f(2) = (eQED*gQCD**2*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f(3) = (CI*countertermnorm*ctHGG*eQED*gQCD**2*MT*YT)/MQ2sum
    f(4) = (eQED*gQCD**2*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
...
! **********************************************************************
  ...
  ! internal WFs
  call counter_SG_G(wf(:,0),wf(:,-1),wf(:,1))
...
end module ol_loop_pph2_hgg_1_/**/REALKIND
