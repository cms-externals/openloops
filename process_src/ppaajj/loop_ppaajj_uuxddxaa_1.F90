...
module ol_colourmatrix_ppaajj_uuxddxaa_1_/**/REALKIND
...
end module ol_colourmatrix_ppaajj_uuxddxaa_1_/**/REALKIND



module ol_forced_parameters_ppaajj_uuxddxaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaajj_uuxddxaa_1_/**/REALKIND

module ol_loop_ppaajj_uuxddxaa_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(24), c(43)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(11) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/9._/**/REALKIND
    f(12) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/9._/**/REALKIND
    f(13) = (4*CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/9._/**/REALKIND
    f(14) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(15) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(16) = (4*CI*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(17) = (eQED**2*gQCD**4*integralnorm*SwB)/18._/**/REALKIND
    f(18) = (eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(19) = (2*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(20) = (4*eQED**2*gQCD**4*integralnorm*SwB)/9._/**/REALKIND
    f(21) = (eQED**2*gQCD**4*integralnorm*SwF)/9._/**/REALKIND
    f(22) = (2*eQED**2*gQCD**4*integralnorm*SwF)/9._/**/REALKIND
    f(23) = (4*eQED**2*gQCD**4*integralnorm*SwF)/9._/**/REALKIND
    f(24) = (8*eQED**2*gQCD**4*integralnorm*SwF)/9._/**/REALKIND

  c = [ 9*CI*f(14), 27*CI*f(14), 9*CI*f(15), 27*CI*f(15), 9*CI*f(16), 27*CI*f(16), 18*f(17), 54*f(17), f(18), 3*f(18), 6*f(18) &
    , 8*f(18), 10*f(18), 18*f(18), 21*f(18), 24*f(18), 54*f(18), f(19), 3*f(19), 6*f(19), 8*f(19), 10*f(19), 18*f(19), 21*f(19) &
    , 24*f(19), 54*f(19), f(20), 3*f(20), 6*f(20), 8*f(20), 10*f(20), 18*f(20), 21*f(20), 24*f(20), 54*f(20), 3*f(21), 9*f(21) &
    , 3*f(22), 9*f(22), 3*f(23), 9*f(23), 3*f(24), 9*f(24) ]
  c = (1._/**/REALKIND / 36) * c
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(102)-A(103)-A(104)-A(105)-A(106)-A(107)-A(108)-A(109)-A(110)-A(111)-A(112)-A(113)-A(114)-A(115)-A(116)-A(117) &
       ...
       -A(137))*f(6))/2._/**/REALKIND+(A(21)*f(7))/2._/**/REALKIND+((A(22)+A(24)+A(28)+A(30)+A(34)+A(36)+A(96)+A(97)+A(98)+A(99) &
       +A(100)+A(101))*f(8))/2._/**/REALKIND+((-A(46)-A(48)-A(50)-A(51)-A(54)-A(56)-A(58)-A(59)-A(74)-A(75)-A(76)-A(78)-A(88) &
       -A(89)-A(90)-A(92))*f(9))/2._/**/REALKIND+((A(40)+A(42)+A(62)+A(63)+A(64)+A(65)+A(66)+A(67)+A(68)+A(70)+A(82) &
       +A(84))*f(10))/2._/**/REALKIND+((A(23)+A(25)+A(26)+A(27)+A(29)+A(31)+A(32)+A(33)+A(35)+A(37)+A(38) &
       +A(39))*f(11))/2._/**/REALKIND+((-A(47)-A(49)-A(52)-A(53)-A(55)-A(57)-A(60)-A(61)-A(77)-A(79)-A(80)-A(81)-A(91)-A(93)-A(94) &
       -A(95))*f(12))/2._/**/REALKIND+((A(41)+A(43)+A(44)+A(45)+A(69)+A(71)+A(72)+A(73)+A(83)+A(85)+A(86) &
       +A(87))*f(13))/2._/**/REALKIND
  M2(2) = ((A(102)+A(103)+A(104)+A(105)+A(106)+A(107)+A(108)+A(109)+A(110)+A(111)+A(112)+A(113)+A(114)+A(115)+A(116)+A(117)+A(118) &
       ...
       +A(137))*f(6))/6._/**/REALKIND-(A(21)*f(7))/6._/**/REALKIND+((-A(22)-A(24)-A(28)-A(30)-A(34)-A(36)-A(96)-A(97)-A(98)-A(99) &
       -A(100)-A(101))*f(8))/6._/**/REALKIND+((A(46)+A(48)+A(50)+A(51)+A(54)+A(56)+A(58)+A(59)+A(74)+A(75)+A(76)+A(78)+A(88)+A(89) &
       +A(90)+A(92))*f(9))/6._/**/REALKIND+((-A(40)-A(42)-A(62)-A(63)-A(64)-A(65)-A(66)-A(67)-A(68)-A(70)-A(82) &
       -A(84))*f(10))/6._/**/REALKIND+((-A(23)-A(25)-A(26)-A(27)-A(29)-A(31)-A(32)-A(33)-A(35)-A(37)-A(38) &
       -A(39))*f(11))/6._/**/REALKIND+((A(47)+A(49)+A(52)+A(53)+A(55)+A(57)+A(60)+A(61)+A(77)+A(79)+A(80)+A(81)+A(91)+A(93)+A(94) &
       +A(95))*f(12))/6._/**/REALKIND+((-A(41)-A(43)-A(44)-A(45)-A(69)-A(71)-A(72)-A(73)-A(83)-A(85)-A(86) &
       -A(87))*f(13))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppaajj_uuxddxaa_1_/**/REALKIND
