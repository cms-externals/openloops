...
module ol_versiondata_ppaajj
  implicit none
  character(4) :: generator_revision = "3336"
  interface
    subroutine version_ppaajj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppaajj
  end interface
end module ol_versiondata_ppaajj


subroutine ol_version_ppaajj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppaajj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppaajj
