...
module ol_colourmatrix_ppaajj_uuxbbxaa_1_/**/REALKIND
...
end module ol_colourmatrix_ppaajj_uuxbbxaa_1_/**/REALKIND



module ol_forced_parameters_ppaajj_uuxbbxaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaajj_uuxbbxaa_1_/**/REALKIND

module ol_loop_ppaajj_uuxbbxaa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(11) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/9._/**/REALKIND
    f(12) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/9._/**/REALKIND
    f(13) = (4*CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/9._/**/REALKIND
    ...
    f(17) = (4*CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/9._/**/REALKIND
...
end module ol_loop_ppaajj_uuxbbxaa_1_/**/REALKIND
