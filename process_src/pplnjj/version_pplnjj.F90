...
module ol_versiondata_pplnjj
  implicit none
  character(4) :: generator_revision = "1500"
  interface
    subroutine version_pplnjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplnjj
  end interface
end module ol_versiondata_pplnjj


subroutine ol_version_pplnjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplnjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplnjj
