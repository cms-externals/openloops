...
module ol_colourmatrix_pplnjj_nexeudxgg_1_/**/REALKIND
...
end module ol_colourmatrix_pplnjj_nexeudxgg_1_/**/REALKIND



module ol_forced_parameters_pplnjj_nexeudxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnjj_nexeudxgg_1_/**/REALKIND

module ol_loop_pplnjj_nexeudxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f( 4) = (countertermnorm*eQED**2*gQCD**4)/(sw**2*2._/**/REALKIND)
    f( 5) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f( 6) = (countertermnorm*ctGqq*eQED**2*gQCD**4)/(sw**2*2._/**/REALKIND)
    f( 7) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f( 8) = (countertermnorm*ctVqq*eQED**2*gQCD**4)/(sw**2*2._/**/REALKIND)
    f( 9) = (countertermnorm*ctVVV*eQED**2*gQCD**4)/(sw**2*2._/**/REALKIND)
    f(10) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/(4._/**/REALKIND*sw**2)
    f(11) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/(2._/**/REALKIND*sw**2)
    f(12) = (eQED**2*gQCD**4*integralnorm*SwB)/(sw**2*2._/**/REALKIND)
    f(13) = (CI*eQED**2*gQCD**4*integralnorm*SwF)/(2._/**/REALKIND*sw**2)
    f(14) = (CI*eQED**2*gQCD**4*integralnorm*SwF)/sw**2
    f(15) = (eQED**2*gQCD**4*integralnorm*SwF)/(sw**2*2._/**/REALKIND)
    f(16) = (eQED**2*gQCD**4*integralnorm*SwF)/sw**2
...
end module ol_loop_pplnjj_nexeudxgg_1_/**/REALKIND
