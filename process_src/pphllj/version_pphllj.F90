...
module ol_versiondata_pphllj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pphllj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphllj
  end interface
end module ol_versiondata_pphllj


subroutine ol_version_pphllj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphllj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphllj
