...
module ol_colourmatrix_pphllj_eexddxhg_1_/**/REALKIND
...
end module ol_colourmatrix_pphllj_eexddxhg_1_/**/REALKIND



module ol_forced_parameters_pphllj_eexddxhg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphllj_eexddxhg_1_/**/REALKIND

module ol_loop_pphllj_eexddxhg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(13) = (eQED**3*gQCD**3*integralnorm*SwF*YB)/(MW*sw*2._/**/REALKIND)
    f(14) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**3*MT*YT)/(3._/**/REALKIND*MQ2sum)
    f(15) = (CI*countertermnorm*ctHGG*eQED**3*gQCD**3*MT*YT)/MQ2sum
    f(16) = (eQED**3*gQCD**3*integralnorm*SwF*YT)/(MW*sw*6._/**/REALKIND)
    f(17) = (eQED**3*gQCD**3*integralnorm*SwF*YT)/(MW*sw*3._/**/REALKIND)
    f(18) = (eQED**3*gQCD**3*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)

  c = [ 9*CI*f(6), f(7), 8*f(7), 3*f(8), 3*f(9), 3*f(12), 3*f(13), 3*f(16), 3*f(17), 3*f(18) ]
  c = (1._/**/REALKIND / 6) * c
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,4),wf(:,-2),wf(:,20))
  ...
  call vert_ZQ_A(gZd,wf(:,14),wf(:,-2),wf(:,48))
  call prop_Q_A(wf(:,48),Q(:,23),ZERO,0_intkind1,wf(:,49))
  call vert_AZ_Q(gZd,wf(:,-3),wf(:,14),wf(:,50))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(16)-A(17))*f(2)+(A(13)+A(15))*f(3)+(A(12)+A(14))*f(4)-A(3)*f(5)+(A(5)+A(9))*f(10)+(A(7)+A(11))*f(11)+(A(4) &
       +A(8))*f(14)+(A(6)+A(10))*f(15)

end subroutine colourvectors

end module ol_loop_pphllj_eexddxhg_1_/**/REALKIND
