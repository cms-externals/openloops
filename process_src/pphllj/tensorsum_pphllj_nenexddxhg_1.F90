...
! **********************************************************************
module ol_tensor_sum_storage_pphllj_nenexddxhg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphllj_nenexddxhg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphllj_nenexddxhg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pphllj_nenexddxhg_1, only: channel_number_pphllj_nenexddxhg_1
  ...
  call TI_call(2, momenta_6, masses2_4, T2sum(:,5), M2)
  call TI_call(2, momenta_8, masses2_4, T2sum(:,6), M2)

  call TI_call(3, momenta_4, masses2_4, T3sum(:,1), M2)
  call TI_call(3, momenta_4, masses2_3, T3sum(:,2), M2)
  call TI_call(3, momenta_4, masses2_2, T3sum(:,3), M2)
  call TI_call(3, momenta_3, masses2_3, T3sum(:,4), M2)
  call TI_call(3, momenta_3, masses2_2, T3sum(:,5), M2)
  call TI_call(3, momenta_11, masses2_7, T3sum(:,6), M2)
  call TI_call(3, momenta_12, masses2_7, T3sum(:,7), M2)
  call TI_call(3, momenta_16, masses2_7, T3sum(:,8), M2)

  call TI_call(4, momenta_14, masses2_6, T4sum(:,1), M2)
  call TI_call(4, momenta_14, masses2_5, T4sum(:,2), M2)
  call TI_call(4, momenta_13, masses2_6, T4sum(:,3), M2)
  call TI_call(4, momenta_13, masses2_5, T4sum(:,4), M2)
  call TI_call(4, momenta_15, masses2_6, T4sum(:,5), M2)
  ...
  call channel_off(channel_number_pphllj_nenexddxhg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphllj_nenexddxhg_1_/**/REALKIND
