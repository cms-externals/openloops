...
module ol_versiondata_pplnj_nf5
  implicit none
  character(4) :: generator_revision = "4039"
  interface
    subroutine version_pplnj_nf5(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplnj_nf5
  end interface
end module ol_versiondata_pplnj_nf5


subroutine ol_version_pplnj_nf5(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplnj_nf5, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplnj_nf5
