...
module ol_versiondata_pptj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptj
  end interface
end module ol_versiondata_pptj


subroutine ol_version_pptj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptj
