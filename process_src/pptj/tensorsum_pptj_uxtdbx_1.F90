...
! **********************************************************************
module ol_tensor_sum_storage_pptj_uxtdbx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pptj_uxtdbx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pptj_uxtdbx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 2
...
! **********************************************************************
  use ol_external_pptj_uxtdbx_1, only: channel_number_pptj_uxtdbx_1
  ...
  call channel_on(channel_number_pptj_uxtdbx_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,4)
  momenta_1(:,2) = Q(1:4,14)
  momenta_2(:,1) = Q(1:4,8)
  momenta_2(:,2) = Q(1:4,13)
  momenta_3(:,1) = Q(1:4,2)
  momenta_3(:,2) = Q(1:4,10)
  momenta_3(:,3) = Q(1:4,14)
  momenta_4(:,1) = Q(1:4,4)
  momenta_4(:,2) = Q(1:4,5)
  momenta_4(:,3) = Q(1:4,13)
  momenta_5(:,1) = Q(1:4,8)
  momenta_5(:,2) = Q(1:4,10)
  momenta_5(:,3) = Q(1:4,11)
  momenta_6(:,1) = Q(1:4,8)
  momenta_6(:,2) = Q(1:4,10)
  momenta_6(:,3) = Q(1:4,14)

  masses2_1 = [ ZERO2, MB2, MT2 ]
  masses2_2 = [ ZERO2, ZERO2, ZERO2 ]
  masses2_3 = [ ZERO2, MB2, MW2, ZERO2 ]
  masses2_4 = [ ZERO2, MT2, MW2, ZERO2 ]
  masses2_5 = [ ZERO2, ZERO2, MW2, MT2 ]
  ...
  call TI_call(2, momenta_1, masses2_2, T2sum(:,2), M2)
  call TI_call(2, momenta_3, masses2_4, T2sum(:,3), M2)
  call TI_call(2, momenta_5, masses2_3, T2sum(:,4), M2)
  call TI_call(2, momenta_6, masses2_3, T2sum(:,5), M2)
  call TI_call(2, momenta_4, masses2_5, T2sum(:,6), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pptj_uxtdbx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pptj_uxtdbx_1_/**/REALKIND
