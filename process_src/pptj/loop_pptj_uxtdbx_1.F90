...
module ol_colourmatrix_pptj_uxtdbx_1_/**/REALKIND
...
end module ol_colourmatrix_pptj_uxtdbx_1_/**/REALKIND



module ol_forced_parameters_pptj_uxtdbx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pptj_uxtdbx_1_/**/REALKIND

module ol_loop_pptj_uxtdbx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_QA_W(wf(:,-1),wf(:,-3),wf(:,3))
  call vert_AQ_S(gPbt,wf(:,-3),wf(:,-1),wf(:,4))
  call counter_AQ_S(gPud,wf(:,0),wf(:,-2),wf(:,5))
  call counter_QA_W(wf(:,-2),wf(:,0),wf(:,6))
...
end module ol_loop_pptj_uxtdbx_1_/**/REALKIND
