...
module ol_colourmatrix_ppwjjj_udxbbbxbxw_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjjj_udxbbbxbxw_1_/**/REALKIND



module ol_forced_parameters_ppwjjj_udxbbbxbxw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjjj_udxbbbxbxw_1_/**/REALKIND

module ol_tree_ppwjjj_udxbbbxbxw_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppwjjj_udxbbbxbxw_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppwjjj_udxbbbxbxw_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for up anti-down bottom bottom anti-bottom anti-bottom W- -> 0
...
! **********************************************************************
  ...
  use ol_external_ppwjjj_udxbbbxbxw_1, only: external_perm_ppwjjj_udxbbbxbxw_1, &
    & external_perm_inv_ppwjjj_udxbbbxbxw_1, extcomb_perm_ppwjjj_udxbbbxbxw_1, &
    & average_factor_ppwjjj_udxbbbxbxw_1
  use ol_external_ppwjjj_udxbbbxbxw_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppwjjj_udxbbbxbxw_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppwjjj_udxbbbxbxw_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppwjjj_udxbbbxbxw_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppwjjj_udxbbbxbxw_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppwjjj_udxbbbxbxw_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppwjjj_udxbbbxbxw_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppwjjj_udxbbbxbxw_1(extcombs(k))
  end do
  ...
  call vert_QA_V(ntry, wf6(:,2), ex2, wf12(:,1), n3(:,4), t3x12(:,:,1))
  ...
  call prop_A_Q(ntry, wf8(:,1), Q(:,22), ZERO, 0_intkind1, wf8(:,2), n2(2))
  call vert_AV_Q(ntry, ex2, wf4(:,2), wf8(:,3), n3(:,8), t3x8(:,:,2))
  call vert_VQ_A(ntry, wf4(:,1), wf6(:,2), wf24(:,2), n3(:,9), t3x24(:,:,2))
  call prop_A_Q(ntry, wf8(:,3), Q(:,42), ZERO, 0_intkind1, wf8(:,4), n2(3))
  call vert_AW_Q(ntry, ex2, ex7, wf6(:,3), n3(:,10), t3x6(:,:,2))
  call prop_A_Q(ntry, wf6(:,3), Q(:,66), ZERO, 0_intkind1, wf6(:,4), n2(4))
  call vert_QA_V(ntry, ex1, wf6(:,4), wf12(:,2), n3(:,11), t3x12(:,:,2))
  call vert_VQ_A(ntry, wf4(:,1), ex1, wf8(:,5), n3(:,12), t3x8(:,:,3))
  call vert_AV_Q(ntry, wf6(:,4), wf4(:,2), wf24(:,3), n3(:,13), t3x24(:,:,3))
  ...
  call prop_Q_A(ntry, wf8(:,7), Q(:,41), ZERO, 0_intkind1, wf8(:,8), n2(6))
  ...
  call vert_AV_Q(ntry, ex2, wf4(:,3), wf8(:,13), n3(:,27), t3x8(:,:,7))
  call vert_VQ_A(ntry, wf4(:,4), wf6(:,2), wf24(:,11), n3(:,28), t3x24(:,:,11))
  call prop_A_Q(ntry, wf8(:,13), Q(:,38), ZERO, 0_intkind1, wf8(:,14), n2(9))
  call vert_AV_Q(ntry, ex2, wf4(:,4), wf8(:,15), n3(:,29), t3x8(:,:,8))
  call vert_VQ_A(ntry, wf4(:,3), wf6(:,2), wf24(:,12), n3(:,30), t3x24(:,:,12))
  call prop_A_Q(ntry, wf8(:,15), Q(:,26), ZERO, 0_intkind1, wf8(:,16), n2(10))
  call vert_VQ_A(ntry, wf4(:,3), ex1, wf8(:,17), n3(:,31), t3x8(:,:,9))
  call vert_AV_Q(ntry, wf6(:,4), wf4(:,4), wf24(:,13), n3(:,32), t3x24(:,:,13))
  call prop_Q_A(ntry, wf8(:,17), Q(:,37), ZERO, 0_intkind1, wf8(:,18), n2(11))
  call vert_VQ_A(ntry, wf4(:,4), ex1, wf8(:,19), n3(:,33), t3x8(:,:,10))
  call vert_AV_Q(ntry, wf6(:,4), wf4(:,3), wf24(:,14), n3(:,34), t3x24(:,:,14))
  call prop_Q_A(ntry, wf8(:,19), Q(:,25), ZERO, 0_intkind1, wf8(:,20), n2(12))
  call vert_WQ_A(ntry, ex7, wf8(:,18), wf24(:,15), n3(:,35), t3x24(:,:,15))
  call vert_WQ_A(ntry, ex7, wf8(:,20), wf24(:,16), n3(:,36), t3x24(:,:,16))
  ...
  M2add = M2 / average_factor_ppwjjj_udxbbbxbxw_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppwjjj_udxbbbxbxw_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppwjjj_udxbbbxbxw_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppwjjj_udxbbbxbxw_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppwjjj_udxbbbxbxw_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppwjjj_udxbbbxbxw_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppwjjj_udxbbbxbxw_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppwjjj_udxbbbxbxw_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppwjjj_udxbbbxbxw_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppwjjj_udxbbbxbxw_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppwjjj_udxbbbxbxw_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppwjjj_udxbbbxbxw_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppwjjj_udxbbbxbxw_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppwjjj_udxbbbxbxw_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppwjjj_udxbbbxbxw_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppwjjj_udxbbbxbxw_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppwjjj_udxbbbxbxw_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppwjjj_udxbbbxbxw_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppwjjj_udxbbbxbxw_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppwjjj_udxbbbxbxw_1_/**/REALKIND
