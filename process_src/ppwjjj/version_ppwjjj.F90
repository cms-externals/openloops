...
module ol_versiondata_ppwjjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppwjjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppwjjj
  end interface
end module ol_versiondata_ppwjjj


subroutine ol_version_ppwjjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppwjjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppwjjj
