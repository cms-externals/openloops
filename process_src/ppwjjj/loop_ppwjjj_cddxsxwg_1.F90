...
module ol_colourmatrix_ppwjjj_cddxsxwg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjjj_cddxsxwg_1_/**/REALKIND



module ol_forced_parameters_ppwjjj_cddxsxwg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjjj_cddxsxwg_1_/**/REALKIND

module ol_loop_ppwjjj_cddxsxwg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 9) = (CI*countertermnorm*ctVsc*eQED*gQCD**5)/(sqrt2*sw)
    f(10) = (countertermnorm*ctVsc*eQED*gQCD**5)/(sqrt2*sw)
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,19),Q(:,7),wf(:,99))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(65)+A(66)+A(69)+A(70)+A(71)+A(72)+A(79)+A(80)+A(81)+A(88)+A(89)+A(90)+A(94)+A(95)+A(96))*f(3))/2._/**/REALKIND &
       +(CI*(A(64)+A(67)+A(68)+A(74)+A(76)+A(77))*f(4))/2._/**/REALKIND+((-A(16)-A(51)-A(53)-A(58))*f(5))/2._/**/REALKIND &
       -(CI*A(50)*f(6))/2._/**/REALKIND+((-A(15)-A(21)-A(24)-A(30)-A(34)-A(36)-A(37)-A(39)-A(43)-A(44) &
       -A(47))*f(7))/2._/**/REALKIND+(CI*(-A(22)-A(42)-A(45))*f(8))/2._/**/REALKIND+((-A(19)-A(26)-A(32)-A(56) &
  ...
  M2(2) = ((-A(85)-A(86)-A(87)-A(88)-A(89)-A(90)-A(91)-A(92)-A(93)-A(94)-A(95)-A(96))*f(3))/6._/**/REALKIND+((A(57) &
       +A(58))*f(5))/6._/**/REALKIND+((A(29)+A(30)+A(33)+A(34)+A(35)+A(36)+A(37)+A(38)+A(39)+A(40))*f(7))/6._/**/REALKIND+((A(31) &
       +A(32)+A(59)+A(60))*f(9))/6._/**/REALKIND
  M2(3) = ((-A(61)-A(62)-A(63)-A(65)-A(66)-A(69)-A(70)-A(71)-A(72)-A(73)-A(75)-A(78)-A(79)-A(80)-A(81)-A(82)-A(83) &
       -A(84))*f(3))/6._/**/REALKIND+((A(16)+A(17)+A(49)+A(51)+A(52)+A(53))*f(5))/6._/**/REALKIND+((A(13)+A(15)+A(21)+A(23)+A(24) &
       +A(25)+A(41)+A(43)+A(44)+A(46)+A(47)+A(48))*f(7))/6._/**/REALKIND+((A(19)+A(20)+A(26)+A(27)+A(54) &
       +A(56))*f(9))/6._/**/REALKIND
  M2(4) = ((A(61)+A(62)+A(63)+A(73)+A(75)+A(78)+A(82)+A(83)+A(84)+A(85)+A(86)+A(87)+A(91)+A(92)+A(93))*f(3))/2._/**/REALKIND+(CI*( &
       -A(64)-A(67)-A(68)-A(74)-A(76)-A(77))*f(4))/2._/**/REALKIND+((-A(17)-A(49)-A(52)-A(57))*f(5))/2._/**/REALKIND &
       +(CI*A(50)*f(6))/2._/**/REALKIND+((-A(13)-A(23)-A(25)-A(29)-A(33)-A(35)-A(38)-A(40)-A(41)-A(46) &
       -A(48))*f(7))/2._/**/REALKIND+(CI*(A(22)+A(42)+A(45))*f(8))/2._/**/REALKIND+((-A(20)-A(27)-A(31)-A(54) &
       -A(59))*f(9))/2._/**/REALKIND+(CI*(A(28)+A(55))*f(10))/2._/**/REALKIND+(CI*(A(14)+A(18))*f(11))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppwjjj_cddxsxwg_1_/**/REALKIND
