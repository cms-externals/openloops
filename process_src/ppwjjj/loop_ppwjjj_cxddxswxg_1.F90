...
module ol_colourmatrix_ppwjjj_cxddxswxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwjjj_cxddxswxg_1_/**/REALKIND



module ol_forced_parameters_ppwjjj_cxddxswxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwjjj_cxddxswxg_1_/**/REALKIND

module ol_loop_ppwjjj_cxddxswxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (CI*countertermnorm*ctGcc*eQED*gQCD**5)/(sqrt2*sw)
    f( 6) = (countertermnorm*ctGcc*eQED*gQCD**5)/(sqrt2*sw)
...
! **********************************************************************
  ...
  call vert_QA_V(wf(:,-3),wf(:,4),wf(:,7))
  call vert_UV_W(wf(:,2),Q(:,6),wf(:,-5),Q(:,32),wf(:,8))
  call vert_VQ_A(wf(:,2),wf(:,-3),wf(:,9))
  ...
  call prop_Q_A(wf(:,23),Q(:,34),ZERO,0_intkind1,wf(:,24))
  ...
  call counter_AV_Q(wf(:,4),wf(:,2),wf(:,29))
  call counter_UV_W(wf(:,2),Q(:,6),wf(:,-5),Q(:,32),wf(:,30))
  call counter_AV_Q(wf(:,4),wf(:,-5),wf(:,31))
  call counter_AV_Q(wf(:,14),wf(:,2),wf(:,32))
  call counter_VQ_A(wf(:,-5),wf(:,15),wf(:,33))
  call counter_AW_Q(wf(:,14),wf(:,-4),wf(:,34))
  call counter_WQ_A(wf(:,-4),wf(:,5),wf(:,35))
  call counter_VQ_A(wf(:,2),wf(:,-3),wf(:,36))
  call prop_A_Q(wf(:,10),Q(:,49),ZERO,0_intkind1,wf(:,37))
  call counter_QA_V(wf(:,-3),wf(:,4),wf(:,38))
  call counter_VQ_A(wf(:,-5),wf(:,-3),wf(:,39))
  call prop_Q_A(wf(:,39),Q(:,40),ZERO,0_intkind1,wf(:,40))
  call prop_A_Q(wf(:,21),Q(:,49),ZERO,0_intkind1,wf(:,41))
  call vert_WQ_A(wf(:,-4),wf(:,40),wf(:,42))
  call counter_WQ_A(wf(:,-4),wf(:,-3),wf(:,43))
  call prop_Q_A(wf(:,43),Q(:,24),ZERO,0_intkind1,wf(:,44))
  call vert_VQ_A(wf(:,-5),wf(:,44),wf(:,45))
  call vert_QA_V(wf(:,44),wf(:,0),wf(:,46))
  call counter_QA_V(wf(:,24),wf(:,-2),wf(:,47))
  call counter_AV_Q(wf(:,-2),wf(:,-5),wf(:,48))
  call prop_A_Q(wf(:,48),Q(:,36),ZERO,0_intkind1,wf(:,49))
  call vert_QA_V(wf(:,-1),wf(:,49),wf(:,50))
  call counter_QA_V(wf(:,-1),wf(:,27),wf(:,51))
  call counter_VQ_A(wf(:,-5),wf(:,-1),wf(:,52))
  call prop_Q_A(wf(:,52),Q(:,34),ZERO,0_intkind1,wf(:,53))
  call vert_QA_V(wf(:,53),wf(:,-2),wf(:,54))
  call counter_QA_V(wf(:,-1),wf(:,-2),wf(:,55))
  call vert_AV_Q(wf(:,4),wf(:,55),wf(:,56))
  call vert_UV_W(wf(:,55),Q(:,6),wf(:,-5),Q(:,32),wf(:,57))
  call vert_VQ_A(wf(:,55),wf(:,-3),wf(:,58))
  call prop_Q_A(wf(:,58),Q(:,14),ZERO,0_intkind1,wf(:,59))
  call vert_AV_Q(wf(:,14),wf(:,55),wf(:,60))
  call vert_AV_Q(wf(:,0),wf(:,55),wf(:,61))
  call prop_A_Q(wf(:,61),Q(:,7),ZERO,0_intkind1,wf(:,62))
  call counter_AV_Q(wf(:,0),wf(:,2),wf(:,63))
  call prop_Q_A(wf(:,18),Q(:,56),ZERO,0_intkind1,wf(:,64))
  call counter_QA_V(wf(:,15),wf(:,0),wf(:,65))
  call counter_AV_Q(wf(:,0),wf(:,-5),wf(:,66))
  call prop_A_Q(wf(:,66),Q(:,33),ZERO,0_intkind1,wf(:,67))
  call vert_AV_Q(wf(:,67),wf(:,2),wf(:,68))
  ...
  call vert_AV_Q(wf(:,72),wf(:,2),wf(:,73))
  call vert_QA_V(wf(:,-3),wf(:,72),wf(:,74))
  call vert_AV_Q(wf(:,72),wf(:,-5),wf(:,75))
  call vert_VQ_A(wf(:,2),wf(:,5),wf(:,76))
  call counter_A_Q(ctqq,wf(:,4),Q(:,17),wf(:,77))
  call prop_Q_A(wf(:,76),Q(:,46),ZERO,0_intkind1,wf(:,78))
  call vert_QA_V(wf(:,5),wf(:,4),wf(:,79))
  call counter_V_V(ctGG,wf(:,2),Q(:,6),wf(:,80))
  call counter_Q_A(ctqq,wf(:,5),Q(:,40),wf(:,81))
  call prop_A_Q(wf(:,6),Q(:,23),ZERO,0_intkind1,wf(:,82))
  call prop_A_Q(wf(:,77),Q(:,17),ZERO,0_intkind1,wf(:,83))
  call vert_QA_V(wf(:,-3),wf(:,83),wf(:,84))
  call vert_AV_Q(wf(:,83),wf(:,-5),wf(:,85))
  call vert_VQ_A(wf(:,80),wf(:,-3),wf(:,86))
  call vert_UV_W(wf(:,80),Q(:,6),wf(:,-5),Q(:,32),wf(:,87))
  call counter_V_V(ctGG,wf(:,7),Q(:,25),wf(:,88))
  call counter_Q_A(ctqq,wf(:,11),Q(:,14),wf(:,89))
  call vert_VQ_A(wf(:,2),wf(:,15),wf(:,90))
  call counter_A_Q(ctcc,wf(:,14),Q(:,33),wf(:,91))
  call prop_Q_A(wf(:,90),Q(:,30),ZERO,0_intkind1,wf(:,92))
  call vert_QA_V(wf(:,15),wf(:,14),wf(:,93))
  call counter_Q_A(ctcc,wf(:,15),Q(:,24),wf(:,94))
  call prop_A_Q(wf(:,16),Q(:,39),ZERO,0_intkind1,wf(:,95))
  call vert_AV_Q(wf(:,0),wf(:,80),wf(:,96))
  call prop_Q_A(wf(:,94),Q(:,24),ZERO,0_intkind1,wf(:,97))
  call vert_QA_V(wf(:,97),wf(:,0),wf(:,98))
  call counter_A_Q(ctcc,wf(:,19),Q(:,7),wf(:,99))
  call counter_V_V(ctGG,wf(:,20),Q(:,25),wf(:,100))
  call vert_VQ_A(wf(:,-5),wf(:,97),wf(:,101))
  call prop_A_Q(wf(:,91),Q(:,33),ZERO,0_intkind1,wf(:,102))
  call vert_AW_Q(wf(:,102),wf(:,-4),wf(:,103))
  call prop_Q_A(wf(:,81),Q(:,40),ZERO,0_intkind1,wf(:,104))
  call vert_WQ_A(wf(:,-4),wf(:,104),wf(:,105))
  call counter_Q_A(ctqq,wf(:,24),Q(:,34),wf(:,106))
  call prop_Q_A(wf(:,106),Q(:,34),ZERO,0_intkind1,wf(:,107))
  call vert_QA_V(wf(:,107),wf(:,-2),wf(:,108))
  call counter_V_V(ctGG,wf(:,25),Q(:,38),wf(:,109))
  call counter_A_Q(ctqq,wf(:,27),Q(:,36),wf(:,110))
  call prop_A_Q(wf(:,110),Q(:,36),ZERO,0_intkind1,wf(:,111))
  call vert_QA_V(wf(:,-1),wf(:,111),wf(:,112))
  call counter_V_V(ctGG,wf(:,28),Q(:,38),wf(:,113))
  call vert_AW_Q(wf(:,19),wf(:,-4),wf(:,114))
  call prop_A_Q(wf(:,114),Q(:,23),ZERO,0_intkind1,wf(:,115))
  call vert_AV_Q(wf(:,19),wf(:,-5),wf(:,116))
  call prop_A_Q(wf(:,116),Q(:,39),ZERO,0_intkind1,wf(:,117))
  call vert_AV_Q(wf(:,0),wf(:,8),wf(:,118))
  call prop_A_Q(wf(:,118),Q(:,39),ZERO,0_intkind1,wf(:,119))
  call vert_WQ_A(wf(:,-4),wf(:,11),wf(:,120))
  call prop_Q_A(wf(:,120),Q(:,30),ZERO,0_intkind1,wf(:,121))
  call vert_VQ_A(wf(:,-5),wf(:,11),wf(:,122))
  call prop_Q_A(wf(:,122),Q(:,46),ZERO,0_intkind1,wf(:,123))
  call vert_VQ_A(wf(:,8),wf(:,-3),wf(:,124))
  call prop_Q_A(wf(:,124),Q(:,46),ZERO,0_intkind1,wf(:,125))
  call vert_VQ_A(wf(:,7),wf(:,-1),wf(:,126))
  call prop_Q_A(wf(:,126),Q(:,27),ZERO,0_intkind1,wf(:,127))
  call vert_AV_Q(wf(:,-2),wf(:,7),wf(:,128))
  call prop_A_Q(wf(:,128),Q(:,29),ZERO,0_intkind1,wf(:,129))
  call vert_UV_W(wf(:,7),Q(:,25),wf(:,-5),Q(:,32),wf(:,130))
  call vert_QA_V(wf(:,-3),wf(:,37),wf(:,131))
  call vert_VQ_A(wf(:,20),wf(:,-1),wf(:,132))
  call prop_Q_A(wf(:,132),Q(:,27),ZERO,0_intkind1,wf(:,133))
  call vert_AV_Q(wf(:,-2),wf(:,20),wf(:,134))
  call prop_A_Q(wf(:,134),Q(:,29),ZERO,0_intkind1,wf(:,135))
  call vert_UV_W(wf(:,20),Q(:,25),wf(:,-5),Q(:,32),wf(:,136))
  call vert_QA_V(wf(:,64),wf(:,0),wf(:,137))
  call vert_QA_V(wf(:,-3),wf(:,41),wf(:,138))
  call vert_AV_Q(wf(:,0),wf(:,25),wf(:,139))
  call prop_A_Q(wf(:,139),Q(:,39),ZERO,0_intkind1,wf(:,140))
  call vert_VQ_A(wf(:,25),wf(:,-3),wf(:,141))
  call prop_Q_A(wf(:,141),Q(:,46),ZERO,0_intkind1,wf(:,142))
  call vert_AV_Q(wf(:,0),wf(:,28),wf(:,143))
  call prop_A_Q(wf(:,143),Q(:,39),ZERO,0_intkind1,wf(:,144))
  call vert_VQ_A(wf(:,28),wf(:,-3),wf(:,145))
  call prop_Q_A(wf(:,145),Q(:,46),ZERO,0_intkind1,wf(:,146))
  call vert_QA_V(wf(:,69),wf(:,0),wf(:,147))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((A(3)+A(4)+A(7)+A(9)+A(11))*f(1))/2._/**/REALKIND+(CI*(-A(2)-A(6))*f(2))/2._/**/REALKIND
  M1(2) = ((-A(1)-A(3)-A(4)-A(5)-A(7)-A(8))*f(1))/6._/**/REALKIND
  M1(3) = ((-A(9)-A(10)-A(11)-A(12))*f(1))/6._/**/REALKIND
  M1(4) = ((A(1)+A(5)+A(8)+A(10)+A(12))*f(1))/2._/**/REALKIND+(CI*(A(2)+A(6))*f(2))/2._/**/REALKIND

  M2(1) = ((-A(65)-A(66)-A(69)-A(70)-A(71)-A(72)-A(79)-A(80)-A(81)-A(85)-A(86)-A(87)-A(91)-A(92)-A(93))*f(3))/2._/**/REALKIND &
       +(CI*(A(64)+A(67)+A(68)+A(74)+A(76)+A(77))*f(4))/2._/**/REALKIND+((A(16)+A(51)+A(53)+A(57))*f(5))/2._/**/REALKIND &
       -(CI*A(50)*f(6))/2._/**/REALKIND+((A(15)+A(21)+A(24)+A(29)+A(33)+A(35)+A(38)+A(40)+A(43)+A(44)+A(47))*f(7))/2._/**/REALKIND &
       +(CI*(-A(22)-A(42)-A(45))*f(8))/2._/**/REALKIND+((A(19)+A(26)+A(31)+A(56)+A(59))*f(9))/2._/**/REALKIND+(CI*(-A(28) &
       -A(55))*f(10))/2._/**/REALKIND+(CI*(-A(14)-A(18))*f(11))/2._/**/REALKIND
  M2(2) = ((A(61)+A(62)+A(63)+A(65)+A(66)+A(69)+A(70)+A(71)+A(72)+A(73)+A(75)+A(78)+A(79)+A(80)+A(81)+A(82)+A(83) &
       +A(84))*f(3))/6._/**/REALKIND+((-A(16)-A(17)-A(49)-A(51)-A(52)-A(53))*f(5))/6._/**/REALKIND+((-A(13)-A(15)-A(21)-A(23) &
       -A(24)-A(25)-A(41)-A(43)-A(44)-A(46)-A(47)-A(48))*f(7))/6._/**/REALKIND+((-A(19)-A(20)-A(26)-A(27)-A(54) &
       -A(56))*f(9))/6._/**/REALKIND
  M2(3) = ((A(85)+A(86)+A(87)+A(88)+A(89)+A(90)+A(91)+A(92)+A(93)+A(94)+A(95)+A(96))*f(3))/6._/**/REALKIND+((-A(57) &
       -A(58))*f(5))/6._/**/REALKIND+((-A(29)-A(30)-A(33)-A(34)-A(35)-A(36)-A(37)-A(38)-A(39)-A(40))*f(7))/6._/**/REALKIND+(( &
       -A(31)-A(32)-A(59)-A(60))*f(9))/6._/**/REALKIND
  M2(4) = ((-A(61)-A(62)-A(63)-A(73)-A(75)-A(78)-A(82)-A(83)-A(84)-A(88)-A(89)-A(90)-A(94)-A(95)-A(96))*f(3))/2._/**/REALKIND &
       +(CI*(-A(64)-A(67)-A(68)-A(74)-A(76)-A(77))*f(4))/2._/**/REALKIND+((A(17)+A(49)+A(52)+A(58))*f(5))/2._/**/REALKIND &
       +(CI*A(50)*f(6))/2._/**/REALKIND+((A(13)+A(23)+A(25)+A(30)+A(34)+A(36)+A(37)+A(39)+A(41)+A(46)+A(48))*f(7))/2._/**/REALKIND &
       +(CI*(A(22)+A(42)+A(45))*f(8))/2._/**/REALKIND+((A(20)+A(27)+A(32)+A(54)+A(60))*f(9))/2._/**/REALKIND+(CI*(A(28) &
       +A(55))*f(10))/2._/**/REALKIND+(CI*(A(14)+A(18))*f(11))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppwjjj_cxddxswxg_1_/**/REALKIND
