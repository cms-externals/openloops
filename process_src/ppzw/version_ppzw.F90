...
module ol_versiondata_ppzw
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppzw(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzw
  end interface
end module ol_versiondata_ppzw


subroutine ol_version_ppzw(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzw, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzw
