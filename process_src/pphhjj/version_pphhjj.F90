...
module ol_versiondata_pphhjj
  implicit none
  character(4) :: generator_revision = "1931"
  interface
    subroutine version_pphhjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphhjj
  end interface
end module ol_versiondata_pphhjj


subroutine ol_version_pphhjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphhjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphhjj
