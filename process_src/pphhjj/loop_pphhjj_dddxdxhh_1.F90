...
module ol_colourmatrix_pphhjj_dddxdxhh_1_/**/REALKIND
...
end module ol_colourmatrix_pphhjj_dddxdxhh_1_/**/REALKIND



module ol_forced_parameters_pphhjj_dddxdxhh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphhjj_dddxdxhh_1_/**/REALKIND

module ol_loop_pphhjj_dddxdxhh_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(19) = (eQED**4*gQCD**2*integralnorm*SwB)/(sw**2*12._/**/REALKIND)
    ...
    f(23) = (eQED**4*gQCD**2*integralnorm*MH**2*SwB)/(sw**2*12._/**/REALKIND)
    f(24) = (eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwB)/(sw**2*4._/**/REALKIND)
    f(25) = (eQED**4*gQCD**2*integralnorm*lambdaHHH*lambdaHWW*MH**2*SwB)/(sw**2*2._/**/REALKIND)
    f(26) = (3*eQED**4*gQCD**2*integralnorm*lambdaHHH*lambdaHZZ*MH**2*SwB)/(cw**2*sw**2*2._/**/REALKIND)
    f(27) = (eQED**4*gQCD**2*integralnorm*MH**2*SwB)/(MW**2*sw**2*12._/**/REALKIND)
    f(28) = (eQED**4*gQCD**2*integralnorm*MH**4*SwB)/(MW**2*sw**2*12._/**/REALKIND)
    f(29) = (eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**4*SwB)/(MW**2*sw**2*4._/**/REALKIND)
    f(30) = (eQED**4*gQCD**2*integralnorm*MW**2*SwB)/(sw**2*12._/**/REALKIND)
    f(31) = (eQED**4*gQCD**2*integralnorm*lambdaHWW*MW**2*SwB)/(sw**2*6._/**/REALKIND)
    f(32) = (eQED**4*gQCD**2*integralnorm*lambdaHWW**2*MW**2*SwB)/(sw**2*3._/**/REALKIND)
    ...
    f(42) = (eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YB)/(MW**2*sw**2*12._/**/REALKIND)
    f(43) = (3*eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YB)/(MW**2*sw**2*4._/**/REALKIND)
    f(44) = (eQED**4*gQCD**2*integralnorm*SwF*YB**2)/(MW**2*sw**2*36._/**/REALKIND)
    f(45) = (eQED**4*gQCD**2*integralnorm*SwF*YB**2)/(MW**2*sw**2*4._/**/REALKIND)
    f(46) = (eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YE)/(MW**2*sw**2*4._/**/REALKIND)
    f(47) = (3*eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YE)/(MW**2*sw**2*4._/**/REALKIND)
    f(48) = (eQED**4*gQCD**2*integralnorm*SwF*YE**2)/(MW**2*sw**2*12._/**/REALKIND)
    f(49) = (eQED**4*gQCD**2*integralnorm*SwF*YE**2)/(MW**2*sw**2*4._/**/REALKIND)
    f(50) = (eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YL)/(MW**2*sw**2*4._/**/REALKIND)
    f(51) = (3*eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YL)/(MW**2*sw**2*4._/**/REALKIND)
    f(52) = (eQED**4*gQCD**2*integralnorm*SwF*YL**2)/(MW**2*sw**2*12._/**/REALKIND)
    f(53) = (eQED**4*gQCD**2*integralnorm*SwF*YL**2)/(MW**2*sw**2*4._/**/REALKIND)
    f(54) = (eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YM)/(MW**2*sw**2*4._/**/REALKIND)
    f(55) = (3*eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YM)/(MW**2*sw**2*4._/**/REALKIND)
    f(56) = (eQED**4*gQCD**2*integralnorm*SwF*YM**2)/(MW**2*sw**2*12._/**/REALKIND)
    f(57) = (eQED**4*gQCD**2*integralnorm*SwF*YM**2)/(MW**2*sw**2*4._/**/REALKIND)
    f(58) = (eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YT)/(MW**2*sw**2*6._/**/REALKIND)
    f(59) = (3*eQED**4*gQCD**2*integralnorm*lambdaHHH*MH**2*SwF*YT)/(MW**2*sw**2*4._/**/REALKIND)
    f(60) = (eQED**4*gQCD**2*integralnorm*SwF*YT**2)/(MW**2*sw**2*18._/**/REALKIND)
...
! **********************************************************************
  ...
  ! internal WFs
  call vert_QA_Z(gZd,wf(:,0),wf(:,-2),wf(:,1))
  call vert_QA_Z(gZd,wf(:,-1),wf(:,-3),wf(:,2))
  call vert_SSV_V(wf(:,-4),wf(:,-5),wf(:,1),wf(:,3))
  call vert_QA_Z(gZd,wf(:,0),wf(:,-3),wf(:,4))
  call vert_QA_Z(gZd,wf(:,-1),wf(:,-2),wf(:,5))
  ...
  call counter_QA_Z(gZd,wf(:,-1),wf(:,-3),wf(:,26))
  call counter_QA_Z(gZd,wf(:,-1),wf(:,-2),wf(:,27))
  call counter_QA_Z(gZd,wf(:,0),wf(:,-3),wf(:,28))
  call vert_SSV_V(wf(:,-4),wf(:,-5),wf(:,28),wf(:,29))
  call counter_QA_Z(gZd,wf(:,0),wf(:,-2),wf(:,30))
  ...
  call vert_QA_Z(gZd,wf(:,54),wf(:,-3),wf(:,76))
  call vert_QA_V(wf(:,-1),wf(:,56),wf(:,77))
  call vert_QA_Z(gZd,wf(:,-1),wf(:,56),wf(:,78))
  ...
  call vert_QA_Z(gZd,wf(:,59),wf(:,-3),wf(:,85))
  call vert_QA_V(wf(:,0),wf(:,61),wf(:,86))
  call vert_QA_Z(gZd,wf(:,0),wf(:,61),wf(:,87))
  ...
  call vert_QA_Z(gZd,wf(:,65),wf(:,-2),wf(:,94))
  call vert_QA_V(wf(:,-1),wf(:,67),wf(:,95))
  call vert_QA_Z(gZd,wf(:,-1),wf(:,67),wf(:,96))
  ...
  call vert_QA_Z(gZd,wf(:,70),wf(:,-2),wf(:,103))
  call vert_QA_V(wf(:,0),wf(:,72),wf(:,104))
  call vert_QA_Z(gZd,wf(:,0),wf(:,72),wf(:,105))
...
end module ol_loop_pphhjj_dddxdxhh_1_/**/REALKIND
