...
module ol_colourmatrix_pphhjj_ddxssxhh_1_/**/REALKIND
...
end module ol_colourmatrix_pphhjj_ddxssxhh_1_/**/REALKIND



module ol_forced_parameters_pphhjj_ddxssxhh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphhjj_ddxssxhh_1_/**/REALKIND

module ol_loop_pphhjj_ddxssxhh_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_QA_Z(gZd,wf(:,34),wf(:,-1),wf(:,49))
  call vert_QA_V(wf(:,0),wf(:,36),wf(:,50))
  call vert_QA_Z(gZd,wf(:,0),wf(:,36),wf(:,51))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = (A(3)+A(5))*f(1)+A(1)*f(2)+A(2)*f(5)+(A(4)+A(6))*f(7)

  M2(1) = (A(10)+A(12)+A(15)+A(17))*f(3)+(A(7)+A(8))*f(4)+(A(9)+A(14))*f(6)+(A(11)+A(13)+A(16)+A(18))*f(8)

end subroutine colourvectors

end module ol_loop_pphhjj_ddxssxhh_1_/**/REALKIND
