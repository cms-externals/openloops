...
module ol_colourmatrix_ppvv2_aagg_1_/**/REALKIND
...
end module ol_colourmatrix_ppvv2_aagg_1_/**/REALKIND



module ol_forced_parameters_ppvv2_aagg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvv2_aagg_1_/**/REALKIND

module ol_loop_ppvv2_aagg_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-4+1:1)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = CI*countertermnorm*ctAAGG*eQED**2*gQCD**2
    f(2) = (eQED**2*gQCD**2*integralnorm*SwF)/9._/**/REALKIND
    f(3) = (2*eQED**2*gQCD**2*integralnorm*SwF)/9._/**/REALKIND
    f(4) = (4*eQED**2*gQCD**2*integralnorm*SwF)/9._/**/REALKIND
    f(5) = (8*eQED**2*gQCD**2*integralnorm*SwF)/9._/**/REALKIND
...
end module ol_loop_ppvv2_aagg_1_/**/REALKIND
