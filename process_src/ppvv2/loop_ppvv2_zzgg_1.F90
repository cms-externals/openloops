...
module ol_colourmatrix_ppvv2_zzgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppvv2_zzgg_1_/**/REALKIND



module ol_forced_parameters_ppvv2_zzgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvv2_zzgg_1_/**/REALKIND

module ol_loop_ppvv2_zzgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(4) = (CI*countertermnorm*ctHGG*eQED**2*gQCD**2*lambdaHZZ*MB*MW*YB)/(cw**2*MQ2sum*sw)
    f(5) = (eQED**2*gQCD**2*integralnorm*lambdaHZZ*SwF*YB)/(cw**2*sw**2*2._/**/REALKIND)
    f(6) = (CI*countertermnorm*ctHGG*eQED**2*gQCD**2*lambdaHZZ*MT*MW*YT)/(cw**2*MQ2sum*sw)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = 2*A(1)*f(1)-2*A(3)*f(4)-2*A(2)*f(6)

end subroutine colourvectors

end module ol_loop_ppvv2_zzgg_1_/**/REALKIND
