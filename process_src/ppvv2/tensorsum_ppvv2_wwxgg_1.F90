...
! **********************************************************************
module ol_tensor_sum_storage_ppvv2_wwxgg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppvv2_wwxgg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppvv2_wwxgg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppvv2_wwxgg_1, only: channel_number_ppvv2_wwxgg_1
  ...
  call channel_on(channel_number_ppvv2_wwxgg_1)
  M2 = 0
  ...
  momenta_2(:,1) = Q(1:4,2)
  momenta_2(:,2) = Q(1:4,6)
  momenta_2(:,3) = Q(1:4,14)
  momenta_3(:,1) = Q(1:4,2)
  momenta_3(:,2) = Q(1:4,10)
  momenta_3(:,3) = Q(1:4,14)
  momenta_4(:,1) = Q(1:4,4)
  momenta_4(:,2) = Q(1:4,6)
  momenta_4(:,3) = Q(1:4,14)
  ...
  call channel_off(channel_number_ppvv2_wwxgg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppvv2_wwxgg_1_/**/REALKIND
