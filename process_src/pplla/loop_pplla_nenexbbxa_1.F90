...
module ol_colourmatrix_pplla_nenexbbxa_1_/**/REALKIND
...
end module ol_colourmatrix_pplla_nenexbbxa_1_/**/REALKIND



module ol_forced_parameters_pplla_nenexbbxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplla_nenexbbxa_1_/**/REALKIND

module ol_loop_pplla_nenexbbxa_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,3),wf(:,-2),wf(:,8))
  call counter_AZ_Q(gZd,wf(:,-3),wf(:,3),wf(:,9))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,10))
  call prop_A_Q(wf(:,10),Q(:,24),MB,1_intkind1,wf(:,11))
  call counter_ZQ_A(gZd,wf(:,3),wf(:,-2),wf(:,12))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,13))
  call prop_Q_A(wf(:,13),Q(:,20),MB,1_intkind1,wf(:,14))
  call counter_Q_A(ctbb,wf(:,4),Q(:,20),wf(:,15))
  call prop_A_Q(wf(:,5),Q(:,11),MB,1_intkind1,wf(:,16))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(7)+A(8))*f(2)+(-A(3)-A(4)-A(5)-A(6))*f(3)

end subroutine colourvectors

end module ol_loop_pplla_nenexbbxa_1_/**/REALKIND
