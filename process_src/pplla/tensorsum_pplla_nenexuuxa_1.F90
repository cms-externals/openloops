...
! **********************************************************************
module ol_tensor_sum_storage_pplla_nenexuuxa_1_/**/REALKIND
! **********************************************************************
  ...
  complex(REALKIND), save :: T2sum(15,4) = 0
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplla_nenexuuxa_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplla_nenexuuxa_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pplla_nenexuuxa_1, only: channel_number_pplla_nenexuuxa_1
  ...
  call channel_on(channel_number_pplla_nenexuuxa_1)
  M2 = 0
  ...
  momenta_5(:,2) = Q(1:4,23)
  momenta_6(:,1) = Q(1:4,24)
  momenta_6(:,2) = Q(1:4,27)
  momenta_7(:,1) = Q(1:4,8)
  momenta_7(:,2) = Q(1:4,11)
  momenta_7(:,3) = Q(1:4,27)
  momenta_8(:,1) = Q(1:4,8)
  ...
  call TI_call(3, momenta_7, masses2_3, T3sum(:,1), M2)
  ...
  call channel_off(channel_number_pplla_nenexuuxa_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplla_nenexuuxa_1_/**/REALKIND
