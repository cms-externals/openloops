...
module ol_colourmatrix_pplla_eexuuxa_1_/**/REALKIND
...
end module ol_colourmatrix_pplla_eexuuxa_1_/**/REALKIND



module ol_forced_parameters_pplla_eexuuxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplla_eexuuxa_1_/**/REALKIND

module ol_loop_pplla_eexuuxa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (2*CI*countertermnorm*eQED**3*gQCD**2)/3._/**/REALKIND
    f( 6) = (4*CI*countertermnorm*ctVqq*eQED**3*gQCD**2)/9._/**/REALKIND
    f( 7) = (2*CI*countertermnorm*ctVqq*eQED**3*gQCD**2)/3._/**/REALKIND
    f( 8) = CI*countertermnorm*ctVqq*eQED**3*gQCD**2
    f( 9) = (4*eQED**3*gQCD**2*integralnorm*SwB)/9._/**/REALKIND
    f(10) = (2*eQED**3*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
...
end module ol_loop_pplla_eexuuxa_1_/**/REALKIND
