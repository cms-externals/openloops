...
module ol_vamp_1_pplla_eexbbxa_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplla_eexbbxa_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplla_eexbbxa_1.
! **********************************************************************
...
#endif
  use ol_loop_pplla_eexbbxa_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplla_eexbbxa_1_/**/REALKIND
  ...
  call loop_A_Q(G0(:,:,:,5),Q(:,11),MB,G1(:,:,:,15))
  ...
  call loop_A_Q(G0(:,:,:,6),Q(:,11),MB,G1(:,:,:,17))
  call loop_AV_Q(G1(:,:,:,17),wf(:,-4),G1(:,:,:,18))
  call loop_A_Q(G1(:,:,:,18),Q(:,27),MB,G2(:,:,:,17))
...
end module ol_vamp_1_pplla_eexbbxa_1_/**/REALKIND
