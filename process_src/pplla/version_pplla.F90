...
module ol_versiondata_pplla
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pplla(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplla
  end interface
end module ol_versiondata_pplla


subroutine ol_version_pplla(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplla, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplla
