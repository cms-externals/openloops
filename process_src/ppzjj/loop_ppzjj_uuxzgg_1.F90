...
module ol_colourmatrix_ppzjj_uuxzgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzjj_uuxzgg_1_/**/REALKIND



module ol_forced_parameters_ppzjj_uuxzgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzjj_uuxzgg_1_/**/REALKIND

module ol_loop_ppzjj_uuxzgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGqq*eQED*gQCD**4
    f( 6) = countertermnorm*ctGqq*eQED*gQCD**4
    f( 7) = CI*countertermnorm*ctVqq*eQED*gQCD**4
    f( 8) = countertermnorm*ctVqq*eQED*gQCD**4
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,44),Q(:,10),ZERO,0_intkind1,wf(:,45))
  ...
  call prop_Q_A(wf(:,53),Q(:,9),ZERO,0_intkind1,wf(:,54))
  ...
  call counter_Q_A(ctqq,wf(:,3),Q(:,5),wf(:,64))
  call prop_A_Q(wf(:,63),Q(:,26),ZERO,0_intkind1,wf(:,65))
  call counter_A_Q(ctqq,wf(:,4),Q(:,10),wf(:,66))
  call prop_Q_A(wf(:,5),Q(:,21),ZERO,0_intkind1,wf(:,67))
  call vert_AV_Q(wf(:,7),wf(:,-3),wf(:,68))
  call prop_A_Q(wf(:,68),Q(:,26),ZERO,0_intkind1,wf(:,69))
  call counter_A_Q(ctqq,wf(:,7),Q(:,18),wf(:,70))
  call prop_Q_A(wf(:,8),Q(:,13),ZERO,0_intkind1,wf(:,71))
  ...
  call counter_Q_A(ctqq,wf(:,13),Q(:,9),wf(:,76))
  call prop_A_Q(wf(:,75),Q(:,22),ZERO,0_intkind1,wf(:,77))
  call counter_A_Q(ctqq,wf(:,14),Q(:,6),wf(:,78))
  call prop_Q_A(wf(:,15),Q(:,25),ZERO,0_intkind1,wf(:,79))
  call vert_AV_Q(wf(:,14),wf(:,-3),wf(:,80))
  call counter_Q_A(ctqq,wf(:,17),Q(:,17),wf(:,81))
  call prop_A_Q(wf(:,80),Q(:,14),ZERO,0_intkind1,wf(:,82))
  call prop_Q_A(wf(:,18),Q(:,25),ZERO,0_intkind1,wf(:,83))
  call vert_VQ_A(wf(:,9),wf(:,0),wf(:,84))
  call prop_Q_A(wf(:,84),Q(:,25),ZERO,0_intkind1,wf(:,85))
  call vert_AZ_Q(gZu,wf(:,7),wf(:,-2),wf(:,86))
  call prop_A_Q(wf(:,86),Q(:,22),ZERO,0_intkind1,wf(:,87))
  call prop_Q_A(wf(:,20),Q(:,13),ZERO,0_intkind1,wf(:,88))
  call vert_AZ_Q(gZu,wf(:,4),wf(:,-2),wf(:,89))
  call prop_A_Q(wf(:,89),Q(:,14),ZERO,0_intkind1,wf(:,90))
  call prop_Q_A(wf(:,21),Q(:,21),ZERO,0_intkind1,wf(:,91))
...
end module ol_loop_ppzjj_uuxzgg_1_/**/REALKIND
