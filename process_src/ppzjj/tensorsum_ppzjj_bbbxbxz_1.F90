...
! **********************************************************************
module ol_tensor_sum_storage_ppzjj_bbbxbxz_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppzjj_bbbxbxz_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppzjj_bbbxbxz_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppzjj_bbbxbxz_1, only: channel_number_ppzjj_bbbxbxz_1
  ...
  call channel_on(channel_number_ppzjj_bbbxbxz_1)
  M2 = 0
  ...
  masses2_14 = [ ZERO2, MB2, MB2, ZERO2, MB2 ]
  masses2_15 = [ ZERO2, MB2, ZERO2, MB2, MB2 ]
  ...
  call TI_call(2, momenta_57, masses2_12, T2sum(:,25), M2)
  call TI_call(2, momenta_48, masses2_12, T2sum(:,26), M2)
  call TI_call(2, momenta_62, masses2_12, T2sum(:,27), M2)
  call TI_call(2, momenta_61, masses2_12, T2sum(:,28), M2)
  ...
  call TI_call(2, momenta_58, masses2_12, T2sum(:,33), M2)
  call TI_call(2, momenta_49, masses2_12, T2sum(:,34), M2)
  call TI_call(2, momenta_64, masses2_12, T2sum(:,35), M2)
  call TI_call(2, momenta_63, masses2_12, T2sum(:,36), M2)
  call TI_call(2, momenta_41, masses2_12, T2sum(:,37), M2)
  call TI_call(2, momenta_40, masses2_12, T2sum(:,38), M2)
  call TI_call(2, momenta_65, masses2_12, T2sum(:,39), M2)
  call TI_call(2, momenta_52, masses2_12, T2sum(:,40), M2)
  call TI_call(2, momenta_42, masses2_12, T2sum(:,41), M2)
  call TI_call(2, momenta_39, masses2_12, T2sum(:,42), M2)
  call TI_call(2, momenta_66, masses2_12, T2sum(:,43), M2)
  call TI_call(2, momenta_43, masses2_12, T2sum(:,44), M2)
  ...
  call TI_call(3, momenta_21, masses2_10, T3sum(:,1), M2)
  call TI_call(3, momenta_21, masses2_8, T3sum(:,2), M2)
  call TI_call(3, momenta_21, masses2_5, T3sum(:,3), M2)
  call TI_call(3, momenta_53, masses2_11, T3sum(:,4), M2)
  call TI_call(3, momenta_55, masses2_11, T3sum(:,5), M2)
  call TI_call(3, momenta_50, masses2_13, T3sum(:,6), M2)
  call TI_call(3, momenta_18, masses2_10, T3sum(:,7), M2)
  call TI_call(3, momenta_18, masses2_8, T3sum(:,8), M2)
  call TI_call(3, momenta_18, masses2_5, T3sum(:,9), M2)
  call TI_call(3, momenta_54, masses2_11, T3sum(:,10), M2)
  call TI_call(3, momenta_56, masses2_11, T3sum(:,11), M2)
  call TI_call(3, momenta_51, masses2_13, T3sum(:,12), M2)
  call TI_call(3, momenta_44, masses2_11, T3sum(:,13), M2)
  call TI_call(3, momenta_46, masses2_11, T3sum(:,14), M2)
  call TI_call(3, momenta_59, masses2_13, T3sum(:,15), M2)
  call TI_call(3, momenta_45, masses2_11, T3sum(:,16), M2)
  call TI_call(3, momenta_47, masses2_11, T3sum(:,17), M2)
  call TI_call(3, momenta_60, masses2_13, T3sum(:,18), M2)
  call TI_call(3, momenta_70, masses2_14, T3sum(:,19), M2)
  call TI_call(3, momenta_69, masses2_14, T3sum(:,20), M2)
  call TI_call(3, momenta_67, masses2_15, T3sum(:,21), M2)
  call TI_call(3, momenta_68, masses2_15, T3sum(:,22), M2)
  call TI_call(3, momenta_74, masses2_14, T3sum(:,23), M2)
  call TI_call(3, momenta_72, masses2_14, T3sum(:,24), M2)
  call TI_call(3, momenta_71, masses2_15, T3sum(:,25), M2)
  call TI_call(3, momenta_73, masses2_15, T3sum(:,26), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppzjj_bbbxbxz_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppzjj_bbbxbxz_1_/**/REALKIND
