...
! **********************************************************************
module ol_tensor_sum_storage_ppzjj_uuxbbxz_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppzjj_uuxbbxz_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppzjj_uuxbbxz_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppzjj_uuxbbxz_1, only: channel_number_ppzjj_uuxbbxz_1
  ...
  call channel_on(channel_number_ppzjj_uuxbbxz_1)
  M2 = 0
  ...
  masses2_15 = [ ZERO2, MB2, MB2, ZERO2, ZERO2 ]
  masses2_16 = [ ZERO2, MB2, ZERO2, ZERO2, ZERO2 ]
  ...
  call TI_call(2, momenta_21, masses2_6, T2sum(:,1), M2)
  call TI_call(2, momenta_11, masses2_7, T2sum(:,2), M2)
  call TI_call(2, momenta_22, masses2_6, T2sum(:,3), M2)
  call TI_call(2, momenta_8, masses2_7, T2sum(:,4), M2)
  call TI_call(2, momenta_9, masses2_6, T2sum(:,5), M2)
  call TI_call(2, momenta_12, masses2_6, T2sum(:,6), M2)
  ...
  call TI_call(3, momenta_13, masses2_8, T3sum(:,2), M2)
  ...
  call channel_off(channel_number_ppzjj_uuxbbxz_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppzjj_uuxbbxz_1_/**/REALKIND
