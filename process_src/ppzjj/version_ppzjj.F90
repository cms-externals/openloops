...
module ol_versiondata_ppzjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppzjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzjj
  end interface
end module ol_versiondata_ppzjj


subroutine ol_version_ppzjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzjj
