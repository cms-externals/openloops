...
! **********************************************************************
module ol_tensor_sum_storage_ppwaj_uxdawxg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwaj_uxdawxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwaj_uxdawxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppwaj_uxdawxg_1, only: channel_number_ppwaj_uxdawxg_1
  ...
  call channel_on(channel_number_ppwaj_uxdawxg_1)
  M2 = 0
  ...
  momenta_15(:,2) = Q(1:4,30)
  momenta_16(:,1) = Q(1:4,17)
  momenta_16(:,2) = Q(1:4,21)
  ...
  call TI_call(2, momenta_10, masses2_4, T2sum(:,4), M2)
  call TI_call(2, momenta_14, masses2_4, T2sum(:,5), M2)
  call TI_call(2, momenta_22, masses2_4, T2sum(:,6), M2)
  call TI_call(2, momenta_7, masses2_4, T2sum(:,7), M2)
  ...
  call TI_call(2, momenta_15, masses2_4, T2sum(:,11), M2)
  ...
  call TI_call(2, momenta_18, masses2_4, T2sum(:,17), M2)
  call TI_call(2, momenta_21, masses2_4, T2sum(:,18), M2)

  call TI_call(3, momenta_37, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_29, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_28, masses2_5, T3sum(:,3), M2)
  call TI_call(3, momenta_38, masses2_5, T3sum(:,4), M2)
  call TI_call(3, momenta_31, masses2_5, T3sum(:,5), M2)
  call TI_call(3, momenta_30, masses2_5, T3sum(:,6), M2)
  call TI_call(3, momenta_9, masses2_4, T3sum(:,7), M2)
  call TI_call(3, momenta_9, masses2_3, T3sum(:,8), M2)
  call TI_call(3, momenta_9, masses2_2, T3sum(:,9), M2)
  call TI_call(3, momenta_39, masses2_5, T3sum(:,10), M2)
  call TI_call(3, momenta_33, masses2_5, T3sum(:,11), M2)
  call TI_call(3, momenta_32, masses2_5, T3sum(:,12), M2)
  call TI_call(3, momenta_40, masses2_5, T3sum(:,13), M2)
  call TI_call(3, momenta_35, masses2_5, T3sum(:,14), M2)
  call TI_call(3, momenta_34, masses2_5, T3sum(:,15), M2)
  call TI_call(3, momenta_26, masses2_5, T3sum(:,16), M2)
  call TI_call(3, momenta_27, masses2_5, T3sum(:,17), M2)
  call TI_call(3, momenta_36, masses2_5, T3sum(:,18), M2)
  call TI_call(3, momenta_42, masses2_5, T3sum(:,19), M2)
  call TI_call(3, momenta_41, masses2_5, T3sum(:,20), M2)
  call TI_call(3, momenta_44, masses2_5, T3sum(:,21), M2)
  call TI_call(3, momenta_43, masses2_5, T3sum(:,22), M2)

  call TI_call(4, momenta_48, masses2_6, T4sum(:,1), M2)
  call TI_call(4, momenta_50, masses2_6, T4sum(:,2), M2)
  call TI_call(4, momenta_46, masses2_6, T4sum(:,3), M2)
  call TI_call(4, momenta_49, masses2_6, T4sum(:,4), M2)
  call TI_call(4, momenta_45, masses2_6, T4sum(:,5), M2)
  call TI_call(4, momenta_47, masses2_6, T4sum(:,6), M2)
  ...
  call channel_off(channel_number_ppwaj_uxdawxg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwaj_uxdawxg_1_/**/REALKIND
