...
module ol_versiondata_ppwaj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppwaj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppwaj
  end interface
end module ol_versiondata_ppwaj


subroutine ol_version_ppwaj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppwaj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppwaj
