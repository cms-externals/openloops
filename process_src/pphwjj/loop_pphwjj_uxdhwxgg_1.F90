...
module ol_colourmatrix_pphwjj_uxdhwxgg_1_/**/REALKIND
...
end module ol_colourmatrix_pphwjj_uxdhwxgg_1_/**/REALKIND



module ol_forced_parameters_pphwjj_uxdhwxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphwjj_uxdhwxgg_1_/**/REALKIND

module ol_loop_pphwjj_uxdhwxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_QA_W(wf(:,5),wf(:,4),wf(:,7))
  call vert_WQ_A(wf(:,6),wf(:,-1),wf(:,8))
  call vert_AV_Q(wf(:,4),wf(:,-5),wf(:,9))
  call prop_Q_A(wf(:,8),Q(:,14),ZERO,0_intkind1,wf(:,10))
  call vert_AV_Q(wf(:,0),wf(:,-5),wf(:,11))
  call vert_VQ_A(wf(:,-4),wf(:,-1),wf(:,12))
  call prop_A_Q(wf(:,11),Q(:,33),ZERO,0_intkind1,wf(:,13))
  call prop_Q_A(wf(:,12),Q(:,18),ZERO,0_intkind1,wf(:,14))
  call vert_QA_W(wf(:,14),wf(:,13),wf(:,15))
  call vert_AW_Q(wf(:,0),wf(:,6),wf(:,16))
  call vert_VQ_A(wf(:,-5),wf(:,14),wf(:,17))
  call prop_A_Q(wf(:,16),Q(:,13),ZERO,0_intkind1,wf(:,18))
  call vert_AV_Q(wf(:,13),wf(:,-4),wf(:,19))
  call vert_VQ_A(wf(:,-4),wf(:,5),wf(:,20))
  call vert_UV_W(wf(:,-4),Q(:,16),wf(:,-5),Q(:,32),wf(:,21))
  call vert_VQ_A(wf(:,21),wf(:,-1),wf(:,22))
  call vert_AV_Q(wf(:,0),wf(:,21),wf(:,23))
  call prop_A_Q(wf(:,23),Q(:,49),ZERO,0_intkind1,wf(:,24))
  call counter_QA_W(wf(:,5),wf(:,4),wf(:,25))
  call counter_AV_Q(wf(:,4),wf(:,-5),wf(:,26))
  call counter_QA_W(wf(:,14),wf(:,13),wf(:,27))
  call counter_VQ_A(wf(:,-5),wf(:,14),wf(:,28))
  call counter_AV_Q(wf(:,13),wf(:,-4),wf(:,29))
  call counter_VQ_A(wf(:,-4),wf(:,5),wf(:,30))
  call counter_UV_W(wf(:,-4),Q(:,16),wf(:,-5),Q(:,32),wf(:,31))
  call vert_VQ_A(wf(:,31),wf(:,-1),wf(:,32))
  call vert_AV_Q(wf(:,0),wf(:,31),wf(:,33))
  call prop_A_Q(wf(:,33),Q(:,49),ZERO,0_intkind1,wf(:,34))
  call vert_AW_Q(wf(:,0),wf(:,-3),wf(:,35))
  call counter_SG_G(wf(:,-2),wf(:,-5),wf(:,36))
  call prop_A_Q(wf(:,35),Q(:,9),ZERO,0_intkind1,wf(:,37))
  call vert_QA_V(wf(:,14),wf(:,37),wf(:,38))
  call vert_QA_V(wf(:,-1),wf(:,37),wf(:,39))
  call counter_SG_G(wf(:,-2),wf(:,21),wf(:,40))
  call vert_UV_W(wf(:,-4),Q(:,16),wf(:,36),Q(:,36),wf(:,41))
  call vert_VQ_A(wf(:,36),wf(:,-1),wf(:,42))
  call vert_AV_Q(wf(:,37),wf(:,-4),wf(:,43))
  call prop_Q_A(wf(:,42),Q(:,38),ZERO,0_intkind1,wf(:,44))
  call counter_SG_G(wf(:,-2),wf(:,-4),wf(:,45))
  call vert_QA_V(wf(:,5),wf(:,37),wf(:,46))
  call vert_UV_W(wf(:,45),Q(:,20),wf(:,-5),Q(:,32),wf(:,47))
  call vert_VQ_A(wf(:,45),wf(:,-1),wf(:,48))
  call vert_AV_Q(wf(:,37),wf(:,-5),wf(:,49))
  call prop_Q_A(wf(:,48),Q(:,22),ZERO,0_intkind1,wf(:,50))
  call vert_WQ_A(wf(:,-3),wf(:,-1),wf(:,51))
  call prop_Q_A(wf(:,51),Q(:,10),ZERO,0_intkind1,wf(:,52))
  call vert_QA_V(wf(:,52),wf(:,4),wf(:,53))
  call vert_QA_V(wf(:,52),wf(:,0),wf(:,54))
  call vert_AV_Q(wf(:,0),wf(:,36),wf(:,55))
  call vert_VQ_A(wf(:,-4),wf(:,52),wf(:,56))
  call prop_A_Q(wf(:,55),Q(:,37),ZERO,0_intkind1,wf(:,57))
  call vert_QA_V(wf(:,52),wf(:,13),wf(:,58))
  call vert_AV_Q(wf(:,0),wf(:,45),wf(:,59))
  call vert_VQ_A(wf(:,-5),wf(:,52),wf(:,60))
  call prop_A_Q(wf(:,59),Q(:,21),ZERO,0_intkind1,wf(:,61))
  call vert_AW_Q(wf(:,4),wf(:,-3),wf(:,62))
  call vert_WQ_A(wf(:,-3),wf(:,14),wf(:,63))
  call vert_AW_Q(wf(:,13),wf(:,-3),wf(:,64))
  call vert_WQ_A(wf(:,-3),wf(:,5),wf(:,65))
  call counter_WQ_A(wf(:,6),wf(:,-1),wf(:,66))
  call prop_A_Q(wf(:,9),Q(:,49),ZERO,0_intkind1,wf(:,67))
  call counter_VQ_A(wf(:,-5),wf(:,-1),wf(:,68))
  call prop_Q_A(wf(:,68),Q(:,34),ZERO,0_intkind1,wf(:,69))
  call vert_QA_W(wf(:,69),wf(:,4),wf(:,70))
  call prop_A_Q(wf(:,19),Q(:,49),ZERO,0_intkind1,wf(:,71))
  call counter_VQ_A(wf(:,21),wf(:,-1),wf(:,72))
  call vert_VQ_A(wf(:,-4),wf(:,69),wf(:,73))
  call counter_VQ_A(wf(:,-4),wf(:,-1),wf(:,74))
  call prop_Q_A(wf(:,74),Q(:,18),ZERO,0_intkind1,wf(:,75))
  call vert_QA_W(wf(:,75),wf(:,13),wf(:,76))
  call vert_VQ_A(wf(:,-5),wf(:,75),wf(:,77))
  call counter_AW_Q(wf(:,0),wf(:,6),wf(:,78))
  call prop_Q_A(wf(:,17),Q(:,50),ZERO,0_intkind1,wf(:,79))
  call counter_AV_Q(wf(:,0),wf(:,-5),wf(:,80))
  call prop_A_Q(wf(:,80),Q(:,33),ZERO,0_intkind1,wf(:,81))
  call vert_QA_W(wf(:,14),wf(:,81),wf(:,82))
  call prop_Q_A(wf(:,20),Q(:,50),ZERO,0_intkind1,wf(:,83))
  call prop_Q_A(wf(:,22),Q(:,50),ZERO,0_intkind1,wf(:,84))
  call counter_AV_Q(wf(:,0),wf(:,21),wf(:,85))
  call vert_AV_Q(wf(:,81),wf(:,-4),wf(:,86))
  call counter_AV_Q(wf(:,0),wf(:,-4),wf(:,87))
  call prop_A_Q(wf(:,87),Q(:,17),ZERO,0_intkind1,wf(:,88))
  call vert_QA_W(wf(:,5),wf(:,88),wf(:,89))
  call vert_AV_Q(wf(:,88),wf(:,-5),wf(:,90))
  call vert_WQ_A(wf(:,6),wf(:,5),wf(:,91))
  call counter_A_Q(ctqq,wf(:,4),Q(:,17),wf(:,92))
  call prop_Q_A(wf(:,91),Q(:,46),ZERO,0_intkind1,wf(:,93))
  call vert_AW_Q(wf(:,4),wf(:,6),wf(:,94))
  call counter_Q_A(ctqq,wf(:,5),Q(:,34),wf(:,95))
  call prop_A_Q(wf(:,94),Q(:,29),ZERO,0_intkind1,wf(:,96))
  call prop_A_Q(wf(:,92),Q(:,17),ZERO,0_intkind1,wf(:,97))
  call vert_AV_Q(wf(:,97),wf(:,-5),wf(:,98))
  call counter_Q_A(ctqq,wf(:,10),Q(:,14),wf(:,99))
  call vert_WQ_A(wf(:,6),wf(:,14),wf(:,100))
  call counter_A_Q(ctqq,wf(:,13),Q(:,33),wf(:,101))
  call prop_Q_A(wf(:,100),Q(:,30),ZERO,0_intkind1,wf(:,102))
  call vert_AW_Q(wf(:,13),wf(:,6),wf(:,103))
  call counter_Q_A(ctqq,wf(:,14),Q(:,18),wf(:,104))
  call prop_A_Q(wf(:,103),Q(:,45),ZERO,0_intkind1,wf(:,105))
  call counter_A_Q(ctqq,wf(:,18),Q(:,13),wf(:,106))
  call prop_Q_A(wf(:,104),Q(:,18),ZERO,0_intkind1,wf(:,107))
  call vert_VQ_A(wf(:,-5),wf(:,107),wf(:,108))
  call prop_A_Q(wf(:,101),Q(:,33),ZERO,0_intkind1,wf(:,109))
  call vert_AV_Q(wf(:,109),wf(:,-4),wf(:,110))
  call prop_Q_A(wf(:,95),Q(:,34),ZERO,0_intkind1,wf(:,111))
  call vert_VQ_A(wf(:,-4),wf(:,111),wf(:,112))
  call counter_A_Q(ctqq,wf(:,24),Q(:,49),wf(:,113))
  call counter_V_V(ctGG,wf(:,21),Q(:,48),wf(:,114))
  call vert_AV_Q(wf(:,0),wf(:,114),wf(:,115))
  call vert_VQ_A(wf(:,114),wf(:,-1),wf(:,116))
  call vert_UV_W(wf(:,39),Q(:,11),wf(:,-4),Q(:,16),wf(:,117))
  call vert_UV_W(wf(:,39),Q(:,11),wf(:,-5),Q(:,32),wf(:,118))
  call prop_A_Q(wf(:,43),Q(:,25),ZERO,0_intkind1,wf(:,119))
  call vert_QA_V(wf(:,-1),wf(:,119),wf(:,120))
  call prop_A_Q(wf(:,49),Q(:,41),ZERO,0_intkind1,wf(:,121))
  call vert_QA_V(wf(:,-1),wf(:,121),wf(:,122))
  call vert_UV_W(wf(:,54),Q(:,11),wf(:,-4),Q(:,16),wf(:,123))
  call vert_UV_W(wf(:,54),Q(:,11),wf(:,-5),Q(:,32),wf(:,124))
  call prop_Q_A(wf(:,56),Q(:,26),ZERO,0_intkind1,wf(:,125))
  call vert_QA_V(wf(:,125),wf(:,0),wf(:,126))
  call prop_Q_A(wf(:,60),Q(:,42),ZERO,0_intkind1,wf(:,127))
  call vert_QA_V(wf(:,127),wf(:,0),wf(:,128))
  call vert_QA_V(wf(:,-1),wf(:,18),wf(:,129))
  call vert_QA_V(wf(:,10),wf(:,0),wf(:,130))
  call vert_AV_Q(wf(:,18),wf(:,-4),wf(:,131))
  call prop_A_Q(wf(:,131),Q(:,29),ZERO,0_intkind1,wf(:,132))
  call vert_AV_Q(wf(:,18),wf(:,-5),wf(:,133))
  call prop_A_Q(wf(:,133),Q(:,45),ZERO,0_intkind1,wf(:,134))
  call vert_VQ_A(wf(:,-4),wf(:,10),wf(:,135))
  call prop_Q_A(wf(:,135),Q(:,30),ZERO,0_intkind1,wf(:,136))
  call vert_VQ_A(wf(:,-5),wf(:,10),wf(:,137))
  call prop_Q_A(wf(:,137),Q(:,46),ZERO,0_intkind1,wf(:,138))
  call prop_A_Q(wf(:,62),Q(:,25),ZERO,0_intkind1,wf(:,139))
  call vert_QA_V(wf(:,-1),wf(:,139),wf(:,140))
  call prop_Q_A(wf(:,63),Q(:,26),ZERO,0_intkind1,wf(:,141))
  call vert_QA_V(wf(:,141),wf(:,0),wf(:,142))
  call prop_A_Q(wf(:,64),Q(:,41),ZERO,0_intkind1,wf(:,143))
  call vert_QA_V(wf(:,-1),wf(:,143),wf(:,144))
  call prop_Q_A(wf(:,65),Q(:,42),ZERO,0_intkind1,wf(:,145))
  call vert_QA_V(wf(:,145),wf(:,0),wf(:,146))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(69)-A(70)-A(71)-A(72)-A(79)-A(80))*f(3)+CI*(-A(81)-A(82)-A(83)-A(84))*f(4)+(A(10)+A(14)+A(54)+A(58)+A(67) &
  ...
  M2(2) = (-A(73)-A(74)-A(75)-A(76)-A(77)-A(78))*f(3)+CI*(A(81)+A(82)+A(83)+A(84))*f(4)+(A(12)+A(13)+A(59)+A(60)+A(62)+A(66))*f(5) &
...
end module ol_loop_pphwjj_uxdhwxgg_1_/**/REALKIND
