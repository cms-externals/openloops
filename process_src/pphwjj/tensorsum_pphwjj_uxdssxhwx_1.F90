...
! **********************************************************************
module ol_tensor_sum_storage_pphwjj_uxdssxhwx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphwjj_uxdssxhwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphwjj_uxdssxhwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphwjj_uxdssxhwx_1, only: channel_number_pphwjj_uxdssxhwx_1
  ...
  call channel_on(channel_number_pphwjj_uxdssxhwx_1)
  M2 = 0
  ...
  momenta_10(:,1) = Q(1:4,49)
  momenta_10(:,2) = Q(1:4,61)
  momenta_11(:,1) = Q(1:4,50)
  ...
  call TI_call(2, momenta_7, masses2_6, T2sum(:,1), M2)
  ...
  call TI_call(3, momenta_9, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_9, masses2_4, T3sum(:,2), M2)
  ...
  call channel_off(channel_number_pphwjj_uxdssxhwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphwjj_uxdssxhwx_1_/**/REALKIND
