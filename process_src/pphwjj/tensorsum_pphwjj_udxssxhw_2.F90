...
! **********************************************************************
module ol_tensor_sum_storage_pphwjj_udxssxhw_2_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphwjj_udxssxhw_2")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphwjj_udxssxhw_2")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphwjj_udxssxhw_2, only: channel_number_pphwjj_udxssxhw_2
  ...
  call channel_on(channel_number_pphwjj_udxssxhw_2)
  M2 = 0
  ...
  call channel_off(channel_number_pphwjj_udxssxhw_2)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphwjj_udxssxhw_2_/**/REALKIND
