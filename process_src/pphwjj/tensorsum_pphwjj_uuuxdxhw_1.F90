...
! **********************************************************************
module ol_tensor_sum_storage_pphwjj_uuuxdxhw_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphwjj_uuuxdxhw_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphwjj_uuuxdxhw_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphwjj_uuuxdxhw_1, only: channel_number_pphwjj_uuuxdxhw_1
  ...
  call channel_on(channel_number_pphwjj_uuuxdxhw_1)
  M2 = 0
  ...
  momenta_32(:,2) = Q(1:4,57)
  momenta_32(:,3) = Q(1:4,61)
  momenta_33(:,1) = Q(1:4,8)
  momenta_33(:,2) = Q(1:4,58)
  momenta_33(:,3) = Q(1:4,62)
  momenta_34(:,1) = Q(1:4,49)
  momenta_34(:,2) = Q(1:4,57)
  momenta_34(:,3) = Q(1:4,61)
  momenta_35(:,1) = Q(1:4,50)
  ...
  call channel_off(channel_number_pphwjj_uuuxdxhw_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphwjj_uuuxdxhw_1_/**/REALKIND
