...
! **********************************************************************
module ol_tensor_sum_storage_pphwjj_uddxdxhw_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphwjj_uddxdxhw_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphwjj_uddxdxhw_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphwjj_uddxdxhw_1, only: channel_number_pphwjj_uddxdxhw_1
  ...
  call channel_on(channel_number_pphwjj_uddxdxhw_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,49)
  momenta_2(:,1) = Q(1:4,52)
  momenta_3(:,1) = Q(1:4,53)
  momenta_4(:,1) = Q(1:4,56)
  momenta_5(:,1) = Q(1:4,57)
  momenta_6(:,1) = Q(1:4,4)
  ...
  momenta_15(:,2) = Q(1:4,53)
  momenta_16(:,1) = Q(1:4,16)
  momenta_16(:,2) = Q(1:4,57)
  ...
  call TI_call(2, momenta_14, masses2_6, T2sum(:,4), M2)
  call TI_call(2, momenta_21, masses2_6, T2sum(:,5), M2)
  call TI_call(2, momenta_7, masses2_6, T2sum(:,6), M2)
  call TI_call(2, momenta_13, masses2_6, T2sum(:,7), M2)
  ...
  call TI_call(2, momenta_12, masses2_6, T2sum(:,11), M2)
  ...
  call channel_off(channel_number_pphwjj_uddxdxhw_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphwjj_uddxdxhw_1_/**/REALKIND
