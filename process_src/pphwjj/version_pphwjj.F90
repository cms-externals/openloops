...
module ol_versiondata_pphwjj
  implicit none
  character(4) :: generator_revision = "1268"
  interface
    subroutine version_pphwjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphwjj
  end interface
end module ol_versiondata_pphwjj


subroutine ol_version_pphwjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphwjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphwjj
