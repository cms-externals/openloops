...
! **********************************************************************
module ol_tensor_sum_storage_pphwjj_uuxuxdhwx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphwjj_uuxuxdhwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphwjj_uuxuxdhwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphwjj_uuxuxdhwx_1, only: channel_number_pphwjj_uuxuxdhwx_1
  ...
  call channel_on(channel_number_pphwjj_uuxuxdhwx_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,50)
  momenta_2(:,1) = Q(1:4,52)
  momenta_3(:,1) = Q(1:4,56)
  momenta_4(:,1) = Q(1:4,58)
  momenta_5(:,1) = Q(1:4,60)
  momenta_6(:,1) = Q(1:4,2)
  momenta_6(:,2) = Q(1:4,62)
  momenta_7(:,1) = Q(1:4,4)
  momenta_7(:,2) = Q(1:4,60)
  momenta_8(:,1) = Q(1:4,4)
  ...
  momenta_22(:,1) = Q(1:4,60)
  momenta_22(:,2) = Q(1:4,62)
  momenta_23(:,1) = Q(1:4,2)
  momenta_23(:,2) = Q(1:4,58)
  ...
  momenta_26(:,2) = Q(1:4,13)
  momenta_26(:,3) = Q(1:4,61)
  momenta_27(:,1) = Q(1:4,8)
  momenta_27(:,2) = Q(1:4,11)
  ...
  momenta_32(:,2) = Q(1:4,60)
  momenta_32(:,3) = Q(1:4,62)
  momenta_33(:,1) = Q(1:4,50)
  momenta_33(:,2) = Q(1:4,58)
  momenta_33(:,3) = Q(1:4,62)
  momenta_34(:,1) = Q(1:4,52)
  momenta_34(:,2) = Q(1:4,60)
  momenta_34(:,3) = Q(1:4,62)
  momenta_35(:,1) = Q(1:4,56)
  momenta_35(:,2) = Q(1:4,58)
  momenta_35(:,3) = Q(1:4,62)
  momenta_36(:,1) = Q(1:4,56)
  momenta_36(:,2) = Q(1:4,60)
  momenta_36(:,3) = Q(1:4,62)
  momenta_37(:,1) = Q(1:4,2)
  momenta_37(:,2) = Q(1:4,50)
  momenta_37(:,3) = Q(1:4,58)
  ...
  call TI_call(2, momenta_14, masses2_6, T2sum(:,7), M2)
  ...
  call TI_call(3, momenta_16, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_16, masses2_4, T3sum(:,2), M2)
  ...
  call TI_call(3, momenta_15, masses2_5, T3sum(:,6), M2)
  call TI_call(3, momenta_15, masses2_4, T3sum(:,7), M2)
  ...
  call channel_off(channel_number_pphwjj_uuxuxdhwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphwjj_uuxuxdhwx_1_/**/REALKIND
