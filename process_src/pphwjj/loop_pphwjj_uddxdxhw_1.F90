...
module ol_colourmatrix_pphwjj_uddxdxhw_1_/**/REALKIND
...
end module ol_colourmatrix_pphwjj_uddxdxhw_1_/**/REALKIND



module ol_forced_parameters_pphwjj_uddxdxhw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphwjj_uddxdxhw_1_/**/REALKIND

module ol_loop_pphwjj_uddxdxhw_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,11),Q(:,11),ZERO,0_intkind1,wf(:,13))
  call vert_AV_Q(wf(:,-2),wf(:,10),wf(:,14))
  call vert_WQ_A(wf(:,-5),wf(:,0),wf(:,15))
  call prop_Q_A(wf(:,15),Q(:,33),ZERO,0_intkind1,wf(:,16))
  call vert_QA_V(wf(:,16),wf(:,-3),wf(:,17))
  call counter_SG_G(wf(:,-4),wf(:,1),wf(:,18))
  call vert_AW_Q(wf(:,-3),wf(:,-5),wf(:,19))
  call prop_A_Q(wf(:,19),Q(:,40),ZERO,0_intkind1,wf(:,20))
  call vert_QA_V(wf(:,0),wf(:,20),wf(:,21))
  call counter_AW_Q(wf(:,-3),wf(:,3),wf(:,22))
  call counter_AV_Q(wf(:,-3),wf(:,1),wf(:,23))
  call vert_QA_V(wf(:,16),wf(:,-2),wf(:,24))
  call counter_SG_G(wf(:,-4),wf(:,10),wf(:,25))
  ...
  call counter_AV_Q(wf(:,-2),wf(:,10),wf(:,30))
  call counter_QA_V(wf(:,-1),wf(:,-3),wf(:,31))
  ...
  call counter_VQ_A(wf(:,1),wf(:,0),wf(:,39))
  call prop_A_Q(wf(:,5),Q(:,56),ZERO,0_intkind1,wf(:,40))
  call counter_WQ_A(wf(:,3),wf(:,0),wf(:,41))
  call prop_A_Q(wf(:,8),Q(:,14),ZERO,0_intkind1,wf(:,42))
  call counter_VQ_A(wf(:,10),wf(:,0),wf(:,43))
  call prop_A_Q(wf(:,12),Q(:,52),ZERO,0_intkind1,wf(:,44))
  call prop_A_Q(wf(:,14),Q(:,14),ZERO,0_intkind1,wf(:,45))
  call counter_V_V(ctGG,wf(:,1),Q(:,6),wf(:,46))
  call vert_VQ_A(wf(:,46),wf(:,0),wf(:,47))
  call counter_Q_A(ctqq,wf(:,6),Q(:,7),wf(:,48))
  call counter_Q_A(ctqq,wf(:,9),Q(:,49),wf(:,49))
  call vert_AV_Q(wf(:,-3),wf(:,46),wf(:,50))
  call counter_V_V(ctGG,wf(:,10),Q(:,10),wf(:,51))
  call vert_VQ_A(wf(:,51),wf(:,0),wf(:,52))
  call counter_Q_A(ctqq,wf(:,13),Q(:,11),wf(:,53))
  call vert_AV_Q(wf(:,-2),wf(:,51),wf(:,54))
  call vert_QA_V(wf(:,9),wf(:,-2),wf(:,55))
  call vert_QA_V(wf(:,0),wf(:,44),wf(:,56))
  call vert_QA_V(wf(:,9),wf(:,-3),wf(:,57))
  call vert_QA_V(wf(:,0),wf(:,40),wf(:,58))
...
subroutine diagrams(A)
  ...
  A(9) = cont_QA(wf(:,6),wf(:,22)) * den(5)
  A(10) = cont_QA(wf(:,9),wf(:,23)) * den(8)
  A(11) = cont_VV(wf(:,24),wf(:,25)) * den(23)
  A(12) = cont_VV(wf(:,24),wf(:,25)) * den(23)
  A(13) = cont_VV(wf(:,25),wf(:,28)) * den(26)
  A(14) = cont_VV(wf(:,25),wf(:,28)) * den(26)
  A(15) = cont_QA(wf(:,13),wf(:,29)) * den(12)
  A(16) = cont_QA(wf(:,9),wf(:,30)) * den(13)
  A(17) = cont_QA(wf(:,9),wf(:,32)) * den(13)
  A(18) = cont_QA(wf(:,12),wf(:,34)) * den(12)
  ...
  A(29) = cont_QA(wf(:,44),wf(:,52)) * den(44)
  A(30) = cont_QA(wf(:,44),wf(:,53)) * den(45)
  A(31) = cont_QA(wf(:,45),wf(:,49)) * den(46)
...
end module ol_loop_pphwjj_uddxdxhw_1_/**/REALKIND
