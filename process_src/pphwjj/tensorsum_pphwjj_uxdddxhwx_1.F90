...
! **********************************************************************
module ol_tensor_sum_storage_pphwjj_uxdddxhwx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphwjj_uxdddxhwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphwjj_uxdddxhwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphwjj_uxdddxhwx_1, only: channel_number_pphwjj_uxdddxhwx_1
  ...
  call channel_on(channel_number_pphwjj_uxdddxhwx_1)
  M2 = 0
  ...
  momenta_30(:,2) = Q(1:4,53)
  momenta_30(:,3) = Q(1:4,61)
  momenta_31(:,1) = Q(1:4,8)
  momenta_31(:,2) = Q(1:4,10)
  ...
  call TI_call(2, momenta_8, masses2_6, T2sum(:,3), M2)
  ...
  call channel_off(channel_number_pphwjj_uxdddxhwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphwjj_uxdddxhwx_1_/**/REALKIND
