...
! **********************************************************************
module ol_tensor_sum_storage_pphwjj_cxddxshwx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphwjj_cxddxshwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphwjj_cxddxshwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pphwjj_cxddxshwx_1, only: channel_number_pphwjj_cxddxshwx_1
  ...
  call channel_on(channel_number_pphwjj_cxddxshwx_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,49)
  momenta_2(:,1) = Q(1:4,56)
  momenta_3(:,1) = Q(1:4,57)
  momenta_4(:,1) = Q(1:4,4)
  ...
  momenta_12(:,1) = Q(1:4,57)
  momenta_12(:,2) = Q(1:4,61)
  ...
  momenta_17(:,3) = Q(1:4,62)
  momenta_18(:,1) = Q(1:4,8)
  momenta_18(:,2) = Q(1:4,57)
  momenta_18(:,3) = Q(1:4,61)
  momenta_19(:,1) = Q(1:4,49)
  ...
  call channel_off(channel_number_pphwjj_cxddxshwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphwjj_cxddxshwx_1_/**/REALKIND
