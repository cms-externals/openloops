...
module ol_colourmatrix_ppzttj_ttxbbxzg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzttj_ttxbbxzg_1_/**/REALKIND



module ol_forced_parameters_ppzttj_ttxbbxzg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzttj_ttxbbxzg_1_/**/REALKIND

module ol_loop_ppzttj_ttxbbxzg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGbb*eQED*gQCD**5
    f( 6) = countertermnorm*ctGbb*eQED*gQCD**5
    f( 7) = CI*countertermnorm*ctGtt*eQED*gQCD**5
    f( 8) = countertermnorm*ctGtt*eQED*gQCD**5
    f( 9) = CI*countertermnorm*ctVbb*eQED*gQCD**5
    f(10) = countertermnorm*ctVbb*eQED*gQCD**5
    f(11) = CI*countertermnorm*ctVtt*eQED*gQCD**5
    f(12) = countertermnorm*ctVtt*eQED*gQCD**5
    f(13) = countertermnorm*ctVVV*eQED*gQCD**5
    f(14) = CI*countertermnorm*ctZGG*eQED*gQCD**5
    f(15) = countertermnorm*ctZGG*eQED*gQCD**5
    f(16) = (CI*eQED*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(17) = CI*eQED*gQCD**5*integralnorm*SwB
    f(18) = (eQED*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(19) = eQED*gQCD**5*integralnorm*SwB
    f(20) = CI*eQED*gQCD**5*integralnorm*SwF
    f(21) = 2*CI*eQED*gQCD**5*integralnorm*SwF
    f(22) = eQED*gQCD**5*integralnorm*SwF
    f(23) = 2*eQED*gQCD**5*integralnorm*SwF
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,0),wf(:,23))
  ...
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,-4),wf(:,35))
  ...
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,36),wf(:,43))
  call vert_AZ_Q(gZu,wf(:,27),wf(:,-4),wf(:,44))
  ...
  call prop_A_Q(wf(:,18),Q(:,56),MB,1_intkind1,wf(:,78))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,79))
  call prop_Q_A(wf(:,79),Q(:,36),MB,1_intkind1,wf(:,80))
  call vert_VQ_A(wf(:,1),wf(:,80),wf(:,81))
  call prop_A_Q(wf(:,22),Q(:,56),MB,1_intkind1,wf(:,82))
  call vert_ZQ_A(gZd,wf(:,-4),wf(:,80),wf(:,83))
  call counter_ZQ_A(gZd,wf(:,-4),wf(:,-2),wf(:,84))
  call prop_Q_A(wf(:,84),Q(:,20),MB,1_intkind1,wf(:,85))
  ...
  call counter_ZQ_A(gZu,wf(:,-4),wf(:,36),wf(:,94))
  call counter_AZ_Q(gZu,wf(:,27),wf(:,-4),wf(:,95))
  call vert_AV_Q(wf(:,-1),wf(:,53),wf(:,96))
  call vert_VQ_A(wf(:,53),wf(:,0),wf(:,97))
  call prop_Q_A(wf(:,97),Q(:,49),MT,1_intkind1,wf(:,98))
  ...
  call prop_Q_A(wf(:,107),Q(:,13),MT,1_intkind1,wf(:,108))
  call counter_AV_Q(wf(:,-1),wf(:,25),wf(:,109))
  call prop_Q_A(wf(:,32),Q(:,49),MT,1_intkind1,wf(:,110))
  ...
  call prop_Q_A(wf(:,43),Q(:,49),MT,1_intkind1,wf(:,115))
  call vert_AZ_Q(gZu,wf(:,113),wf(:,-4),wf(:,116))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-4),wf(:,117))
  call prop_A_Q(wf(:,117),Q(:,18),MT,1_intkind1,wf(:,118))
  ...
  call prop_A_Q(wf(:,41),Q(:,50),MT,1_intkind1,wf(:,126))
  call counter_VQ_A(wf(:,-5),wf(:,0),wf(:,127))
  call prop_Q_A(wf(:,127),Q(:,33),MT,1_intkind1,wf(:,128))
  call vert_QA_V(wf(:,128),wf(:,37),wf(:,129))
  call prop_A_Q(wf(:,44),Q(:,50),MT,1_intkind1,wf(:,130))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,128),wf(:,131))
  call counter_ZQ_A(gZu,wf(:,-4),wf(:,0),wf(:,132))
  call prop_Q_A(wf(:,132),Q(:,17),MT,1_intkind1,wf(:,133))
  ...
  call prop_A_Q(wf(:,141),Q(:,11),MB,1_intkind1,wf(:,142))
  call vert_UV_W(wf(:,139),Q(:,3),wf(:,-5),Q(:,32),wf(:,143))
  call vert_VQ_A(wf(:,139),wf(:,14),wf(:,144))
  call vert_VQ_A(wf(:,139),wf(:,-2),wf(:,145))
  call prop_Q_A(wf(:,145),Q(:,7),MB,1_intkind1,wf(:,146))
  call vert_QA_V(wf(:,4),wf(:,5),wf(:,147))
  call counter_V_V(ctGG,wf(:,1),Q(:,3),wf(:,148))
  call vert_AV_Q(wf(:,5),wf(:,1),wf(:,149))
  call counter_Q_A(ctbb,wf(:,4),Q(:,20),wf(:,150))
  call prop_A_Q(wf(:,149),Q(:,43),MB,1_intkind1,wf(:,151))
  call counter_A_Q(ctbb,wf(:,5),Q(:,40),wf(:,152))
  call prop_Q_A(wf(:,6),Q(:,23),MB,1_intkind1,wf(:,153))
  call vert_AV_Q(wf(:,-3),wf(:,148),wf(:,154))
  call vert_UV_W(wf(:,148),Q(:,3),wf(:,-5),Q(:,32),wf(:,155))
  call prop_Q_A(wf(:,150),Q(:,20),MB,1_intkind1,wf(:,156))
  call vert_QA_V(wf(:,156),wf(:,-3),wf(:,157))
  call vert_VQ_A(wf(:,-5),wf(:,156),wf(:,158))
  call counter_A_Q(ctbb,wf(:,9),Q(:,11),wf(:,159))
  call counter_V_V(ctGG,wf(:,10),Q(:,28),wf(:,160))
  call vert_QA_V(wf(:,14),wf(:,15),wf(:,161))
  call vert_AV_Q(wf(:,15),wf(:,1),wf(:,162))
  call counter_Q_A(ctbb,wf(:,14),Q(:,36),wf(:,163))
  call prop_A_Q(wf(:,162),Q(:,27),MB,1_intkind1,wf(:,164))
  call counter_A_Q(ctbb,wf(:,15),Q(:,24),wf(:,165))
  call prop_Q_A(wf(:,16),Q(:,39),MB,1_intkind1,wf(:,166))
  call vert_VQ_A(wf(:,148),wf(:,-2),wf(:,167))
  call prop_A_Q(wf(:,165),Q(:,24),MB,1_intkind1,wf(:,168))
  call vert_QA_V(wf(:,-2),wf(:,168),wf(:,169))
  call counter_Q_A(ctbb,wf(:,19),Q(:,7),wf(:,170))
  call counter_V_V(ctGG,wf(:,20),Q(:,28),wf(:,171))
  call vert_AV_Q(wf(:,168),wf(:,-5),wf(:,172))
  call prop_Q_A(wf(:,163),Q(:,36),MB,1_intkind1,wf(:,173))
  call vert_ZQ_A(gZd,wf(:,-4),wf(:,173),wf(:,174))
  call prop_A_Q(wf(:,152),Q(:,40),MB,1_intkind1,wf(:,175))
  call vert_AZ_Q(gZd,wf(:,175),wf(:,-4),wf(:,176))
  call vert_AV_Q(wf(:,27),wf(:,25),wf(:,177))
  call counter_Q_A(cttt,wf(:,26),Q(:,17),wf(:,178))
  call prop_A_Q(wf(:,177),Q(:,46),MT,1_intkind1,wf(:,179))
  call vert_VQ_A(wf(:,25),wf(:,26),wf(:,180))
  call counter_A_Q(cttt,wf(:,27),Q(:,34),wf(:,181))
  call prop_Q_A(wf(:,180),Q(:,29),MT,1_intkind1,wf(:,182))
  call counter_V_V(ctGG,wf(:,25),Q(:,12),wf(:,183))
  call prop_Q_A(wf(:,178),Q(:,17),MT,1_intkind1,wf(:,184))
  ...
  call counter_A_Q(cttt,wf(:,33),Q(:,14),wf(:,189))
  call vert_UV_W(wf(:,183),Q(:,12),wf(:,-5),Q(:,32),wf(:,190))
  call vert_AV_Q(wf(:,37),wf(:,25),wf(:,191))
  call counter_Q_A(cttt,wf(:,36),Q(:,33),wf(:,192))
  call prop_A_Q(wf(:,191),Q(:,30),MT,1_intkind1,wf(:,193))
  call vert_VQ_A(wf(:,25),wf(:,36),wf(:,194))
  call counter_A_Q(cttt,wf(:,37),Q(:,18),wf(:,195))
  call prop_Q_A(wf(:,194),Q(:,45),MT,1_intkind1,wf(:,196))
  call prop_A_Q(wf(:,195),Q(:,18),MT,1_intkind1,wf(:,197))
  call vert_QA_V(wf(:,0),wf(:,197),wf(:,198))
  call vert_VQ_A(wf(:,183),wf(:,0),wf(:,199))
  call counter_V_V(ctGG,wf(:,39),Q(:,19),wf(:,200))
  call counter_Q_A(cttt,wf(:,42),Q(:,13),wf(:,201))
  call vert_AV_Q(wf(:,197),wf(:,-5),wf(:,202))
  call prop_Q_A(wf(:,192),Q(:,33),MT,1_intkind1,wf(:,203))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,203),wf(:,204))
  call prop_A_Q(wf(:,181),Q(:,34),MT,1_intkind1,wf(:,205))
  call vert_AZ_Q(gZu,wf(:,205),wf(:,-4),wf(:,206))
  ...
  call prop_A_Q(wf(:,219),Q(:,27),MB,1_intkind1,wf(:,220))
  call vert_AV_Q(wf(:,9),wf(:,-5),wf(:,221))
  call prop_A_Q(wf(:,221),Q(:,43),MB,1_intkind1,wf(:,222))
  call vert_VQ_A(wf(:,11),wf(:,-2),wf(:,223))
  call prop_Q_A(wf(:,223),Q(:,39),MB,1_intkind1,wf(:,224))
  call vert_AV_Q(wf(:,-3),wf(:,11),wf(:,225))
  call prop_A_Q(wf(:,225),Q(:,43),MB,1_intkind1,wf(:,226))
  call vert_QA_V(wf(:,42),wf(:,-1),wf(:,227))
  call vert_QA_V(wf(:,0),wf(:,33),wf(:,228))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,42),wf(:,229))
  ...
  call prop_Q_A(wf(:,233),Q(:,45),MT,1_intkind1,wf(:,234))
  call vert_AZ_Q(gZu,wf(:,33),wf(:,-4),wf(:,235))
  call prop_A_Q(wf(:,235),Q(:,30),MT,1_intkind1,wf(:,236))
  call vert_AV_Q(wf(:,33),wf(:,-5),wf(:,237))
  call prop_A_Q(wf(:,237),Q(:,46),MT,1_intkind1,wf(:,238))
  call vert_AV_Q(wf(:,-1),wf(:,30),wf(:,239))
  call prop_A_Q(wf(:,239),Q(:,46),MT,1_intkind1,wf(:,240))
  ...
  call prop_Q_A(wf(:,275),Q(:,45),MT,1_intkind1,wf(:,276))
  call vert_AV_Q(wf(:,-1),wf(:,45),wf(:,277))
  call prop_A_Q(wf(:,277),Q(:,46),MT,1_intkind1,wf(:,278))
  call vert_QA_V(wf(:,70),wf(:,-3),wf(:,279))
  call vert_VQ_A(wf(:,46),wf(:,0),wf(:,280))
  call prop_Q_A(wf(:,280),Q(:,45),MT,1_intkind1,wf(:,281))
  call vert_AV_Q(wf(:,-1),wf(:,46),wf(:,282))
  call prop_A_Q(wf(:,282),Q(:,46),MT,1_intkind1,wf(:,283))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(25)+A(26))*f(3))/12._/**/REALKIND+((-A(158)-A(159)-A(160)-A(162)-A(163)-A(165)-A(167)-A(168)-A(169)-A(171)-A(173) &
       ...
       -A(204)-A(205))*f(3))/6._/**/REALKIND+((A(74)+A(75)+A(82)+A(83)+A(86)+A(88)+A(89)+A(91)+A(92)+A(93))*f(5))/6._/**/REALKIND &
       +((A(58)+A(60)+A(61)+A(63)+A(94)+A(96)+A(97)+A(98)+A(104)+A(105)+A(106)+A(107)+A(111)+A(112)+A(113)+A(114)+A(120)+A(121) &
       +A(122)+A(123))*f(7))/6._/**/REALKIND+((A(76)+A(77)+A(84)+A(85))*f(9))/6._/**/REALKIND+((A(65)+A(67)+A(99)+A(100)+A(115) &
       +A(117))*f(11))/6._/**/REALKIND+((-A(64)-A(66)-A(68)-A(69))*f(15))/6._/**/REALKIND
  M2(2) = -(A(25)*f(3))/4._/**/REALKIND+((A(137)+A(140)+A(141)+A(143)+A(144)+A(145)+A(152)+A(153)+A(154)+A(158)+A(159)+A(160) &
       ...
       -A(175))*f(4))/2._/**/REALKIND+((-A(31)-A(33)-A(43)-A(45)-A(52)-A(54)-A(70)-A(72)-A(75)-A(79)-A(81)-A(83)-A(86)-A(91) &
       -A(93))*f(5))/2._/**/REALKIND+(CI*(-A(42)-A(50)+A(87)+A(90))*f(6))/2._/**/REALKIND+((-A(58)-A(63)-A(96)-A(98)-A(102)-A(105) &
       -A(107)-A(111)-A(113)-A(118)-A(120)-A(122)-A(127)-A(129)-A(132))*f(7))/2._/**/REALKIND+(CI*(A(95)+A(110)-A(128) &
       -A(131))*f(8))/2._/**/REALKIND+((-A(36)-A(47)-A(56)-A(77)-A(85))*f(9))/2._/**/REALKIND+(CI*(-A(49) &
       -A(57))*f(10))/2._/**/REALKIND+((-A(67)-A(100)-A(108)-A(115)-A(124))*f(11))/2._/**/REALKIND+(CI*(A(101) &
       +A(116))*f(12))/2._/**/REALKIND+(CI*(-A(32)-A(35)+A(59)+A(62))*f(13))/2._/**/REALKIND+(CI*(-A(27)+A(28) &
       +A(29))*f(14))/2._/**/REALKIND+((A(37)+A(41)+A(66)+A(68))*f(15))/2._/**/REALKIND
  M2(3) = -(A(26)*f(3))/4._/**/REALKIND+((A(134)+A(135)+A(136)+A(146)+A(149)+A(151)+A(155)+A(156)+A(157)+A(162)+A(163)+A(165) &
       ...
       +A(175))*f(4))/2._/**/REALKIND+((-A(30)-A(34)-A(44)-A(46)-A(51)-A(53)-A(71)-A(73)-A(74)-A(78)-A(80)-A(82)-A(88)-A(89) &
       -A(92))*f(5))/2._/**/REALKIND+(CI*(A(42)+A(50)-A(87)-A(90))*f(6))/2._/**/REALKIND+((-A(60)-A(61)-A(94)-A(97)-A(103)-A(104) &
       -A(106)-A(112)-A(114)-A(119)-A(121)-A(123)-A(126)-A(130)-A(133))*f(7))/2._/**/REALKIND+(CI*(-A(95)-A(110)+A(128) &
       +A(131))*f(8))/2._/**/REALKIND+((-A(38)-A(48)-A(55)-A(76)-A(84))*f(9))/2._/**/REALKIND+(CI*(A(49) &
       +A(57))*f(10))/2._/**/REALKIND+((-A(65)-A(99)-A(109)-A(117)-A(125))*f(11))/2._/**/REALKIND+(CI*(-A(101) &
       -A(116))*f(12))/2._/**/REALKIND+(CI*(A(32)+A(35)-A(59)-A(62))*f(13))/2._/**/REALKIND+(CI*(A(27)-A(28) &
       -A(29))*f(14))/2._/**/REALKIND+((A(39)+A(40)+A(64)+A(69))*f(15))/2._/**/REALKIND
  M2(4) = ((A(25)+A(26))*f(3))/12._/**/REALKIND+((-A(134)-A(135)-A(136)-A(137)-A(140)-A(141)-A(143)-A(144)-A(145)-A(146)-A(149) &
       ...
       +A(72)+A(73)+A(78)+A(79)+A(80)+A(81))*f(5))/6._/**/REALKIND+((A(102)+A(103)+A(118)+A(119)+A(126)+A(127)+A(129)+A(130) &
       +A(132)+A(133))*f(7))/6._/**/REALKIND+((A(36)+A(38)+A(47)+A(48)+A(55)+A(56))*f(9))/6._/**/REALKIND+((A(108)+A(109)+A(124) &
       +A(125))*f(11))/6._/**/REALKIND+((-A(37)-A(39)-A(40)-A(41))*f(15))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppzttj_ttxbbxzg_1_/**/REALKIND
