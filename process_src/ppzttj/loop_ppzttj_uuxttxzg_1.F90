...
module ol_colourmatrix_ppzttj_uuxttxzg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzttj_uuxttxzg_1_/**/REALKIND



module ol_forced_parameters_ppzttj_uuxttxzg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzttj_uuxttxzg_1_/**/REALKIND

module ol_loop_ppzttj_uuxttxzg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 9) = CI*countertermnorm*ctVqq*eQED*gQCD**5
    f(10) = countertermnorm*ctVqq*eQED*gQCD**5
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,7),Q(:,11),MT,1_intkind1,wf(:,9))
  call vert_QA_V(wf(:,4),wf(:,-3),wf(:,10))
  call vert_UV_W(wf(:,1),Q(:,3),wf(:,-5),Q(:,32),wf(:,11))
  call vert_VQ_A(wf(:,-5),wf(:,-2),wf(:,12))
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,-4),wf(:,13))
  call prop_Q_A(wf(:,12),Q(:,36),MT,1_intkind1,wf(:,14))
  ...
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,14),wf(:,21))
  call vert_AZ_Q(gZu,wf(:,5),wf(:,-4),wf(:,22))
  ...
  call counter_ZQ_A(gZu,wf(:,-4),wf(:,14),wf(:,60))
  call counter_AZ_Q(gZu,wf(:,5),wf(:,-4),wf(:,61))
  call vert_AV_Q(wf(:,-3),wf(:,53),wf(:,62))
  call vert_VQ_A(wf(:,53),wf(:,-2),wf(:,63))
  call prop_Q_A(wf(:,63),Q(:,52),MT,1_intkind1,wf(:,64))
  call counter_QA_V(wf(:,4),wf(:,-3),wf(:,65))
  call counter_AV_Q(wf(:,-3),wf(:,1),wf(:,66))
  call prop_Q_A(wf(:,8),Q(:,52),MT,1_intkind1,wf(:,67))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,68))
  call prop_A_Q(wf(:,68),Q(:,40),MT,1_intkind1,wf(:,69))
  call prop_Q_A(wf(:,21),Q(:,52),MT,1_intkind1,wf(:,70))
  call vert_AZ_Q(gZu,wf(:,69),wf(:,-4),wf(:,71))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,-4),wf(:,72))
  call prop_A_Q(wf(:,72),Q(:,24),MT,1_intkind1,wf(:,73))
  ...
  call prop_A_Q(wf(:,18),Q(:,56),MT,1_intkind1,wf(:,78))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,79))
  call prop_Q_A(wf(:,79),Q(:,36),MT,1_intkind1,wf(:,80))
  call vert_VQ_A(wf(:,1),wf(:,80),wf(:,81))
  call prop_A_Q(wf(:,22),Q(:,56),MT,1_intkind1,wf(:,82))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,80),wf(:,83))
  call counter_ZQ_A(gZu,wf(:,-4),wf(:,-2),wf(:,84))
  call prop_Q_A(wf(:,84),Q(:,20),MT,1_intkind1,wf(:,85))
  ...
  call prop_A_Q(wf(:,141),Q(:,11),MT,1_intkind1,wf(:,142))
  call vert_UV_W(wf(:,139),Q(:,3),wf(:,-5),Q(:,32),wf(:,143))
  call vert_VQ_A(wf(:,139),wf(:,14),wf(:,144))
  call vert_VQ_A(wf(:,139),wf(:,-2),wf(:,145))
  call prop_Q_A(wf(:,145),Q(:,7),MT,1_intkind1,wf(:,146))
  call vert_QA_V(wf(:,4),wf(:,5),wf(:,147))
  call counter_V_V(ctGG,wf(:,1),Q(:,3),wf(:,148))
  call vert_AV_Q(wf(:,5),wf(:,1),wf(:,149))
  call counter_Q_A(cttt,wf(:,4),Q(:,20),wf(:,150))
  call prop_A_Q(wf(:,149),Q(:,43),MT,1_intkind1,wf(:,151))
  call counter_A_Q(cttt,wf(:,5),Q(:,40),wf(:,152))
  call prop_Q_A(wf(:,6),Q(:,23),MT,1_intkind1,wf(:,153))
  call vert_AV_Q(wf(:,-3),wf(:,148),wf(:,154))
  call vert_UV_W(wf(:,148),Q(:,3),wf(:,-5),Q(:,32),wf(:,155))
  call prop_Q_A(wf(:,150),Q(:,20),MT,1_intkind1,wf(:,156))
  call vert_QA_V(wf(:,156),wf(:,-3),wf(:,157))
  call vert_VQ_A(wf(:,-5),wf(:,156),wf(:,158))
  call counter_A_Q(cttt,wf(:,9),Q(:,11),wf(:,159))
  call counter_V_V(ctGG,wf(:,10),Q(:,28),wf(:,160))
  call vert_QA_V(wf(:,14),wf(:,15),wf(:,161))
  call vert_AV_Q(wf(:,15),wf(:,1),wf(:,162))
  call counter_Q_A(cttt,wf(:,14),Q(:,36),wf(:,163))
  call prop_A_Q(wf(:,162),Q(:,27),MT,1_intkind1,wf(:,164))
  call counter_A_Q(cttt,wf(:,15),Q(:,24),wf(:,165))
  call prop_Q_A(wf(:,16),Q(:,39),MT,1_intkind1,wf(:,166))
  call vert_VQ_A(wf(:,148),wf(:,-2),wf(:,167))
  call prop_A_Q(wf(:,165),Q(:,24),MT,1_intkind1,wf(:,168))
  call vert_QA_V(wf(:,-2),wf(:,168),wf(:,169))
  call counter_Q_A(cttt,wf(:,19),Q(:,7),wf(:,170))
  call counter_V_V(ctGG,wf(:,20),Q(:,28),wf(:,171))
  call vert_AV_Q(wf(:,168),wf(:,-5),wf(:,172))
  call prop_Q_A(wf(:,163),Q(:,36),MT,1_intkind1,wf(:,173))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,173),wf(:,174))
  call prop_A_Q(wf(:,152),Q(:,40),MT,1_intkind1,wf(:,175))
  call vert_AZ_Q(gZu,wf(:,175),wf(:,-4),wf(:,176))
  ...
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,19),wf(:,214))
  call prop_Q_A(wf(:,214),Q(:,23),MT,1_intkind1,wf(:,215))
  call vert_VQ_A(wf(:,-5),wf(:,19),wf(:,216))
  call prop_Q_A(wf(:,216),Q(:,39),MT,1_intkind1,wf(:,217))
  call vert_QA_V(wf(:,-2),wf(:,9),wf(:,218))
  call vert_AZ_Q(gZu,wf(:,9),wf(:,-4),wf(:,219))
  call prop_A_Q(wf(:,219),Q(:,27),MT,1_intkind1,wf(:,220))
  call vert_AV_Q(wf(:,9),wf(:,-5),wf(:,221))
  call prop_A_Q(wf(:,221),Q(:,43),MT,1_intkind1,wf(:,222))
  call vert_VQ_A(wf(:,11),wf(:,-2),wf(:,223))
  call prop_Q_A(wf(:,223),Q(:,39),MT,1_intkind1,wf(:,224))
  call vert_AV_Q(wf(:,-3),wf(:,11),wf(:,225))
  call prop_A_Q(wf(:,225),Q(:,43),MT,1_intkind1,wf(:,226))
  ...
  call prop_Q_A(wf(:,241),Q(:,23),MT,1_intkind1,wf(:,242))
  call vert_AV_Q(wf(:,-3),wf(:,29),wf(:,243))
  call prop_A_Q(wf(:,243),Q(:,27),MT,1_intkind1,wf(:,244))
  call vert_UV_W(wf(:,29),Q(:,19),wf(:,-5),Q(:,32),wf(:,245))
  call vert_QA_V(wf(:,110),wf(:,-1),wf(:,246))
  call vert_VQ_A(wf(:,39),wf(:,-2),wf(:,247))
  call prop_Q_A(wf(:,247),Q(:,23),MT,1_intkind1,wf(:,248))
  call vert_AV_Q(wf(:,-3),wf(:,39),wf(:,249))
  call prop_A_Q(wf(:,249),Q(:,27),MT,1_intkind1,wf(:,250))
  ...
  call prop_Q_A(wf(:,265),Q(:,39),MT,1_intkind1,wf(:,266))
  call vert_AV_Q(wf(:,-3),wf(:,47),wf(:,267))
  call prop_A_Q(wf(:,267),Q(:,43),MT,1_intkind1,wf(:,268))
  call vert_QA_V(wf(:,115),wf(:,-1),wf(:,269))
  call vert_VQ_A(wf(:,48),wf(:,-2),wf(:,270))
  call prop_Q_A(wf(:,270),Q(:,39),MT,1_intkind1,wf(:,271))
  call vert_AV_Q(wf(:,-3),wf(:,48),wf(:,272))
  call prop_A_Q(wf(:,272),Q(:,43),MT,1_intkind1,wf(:,273))
...
subroutine denominators()
  ...
  den(99) = 1 / (Q(5,50))
  den(109) = 1 / (Q(5,60))
  den(113) = 1 / (Q(5,43) - MT2)
  den(116) = 1 / (Q(5,23) - MT2)
  den(131) = 1 / (Q(5,27) - MT2)
  den(134) = 1 / (Q(5,39) - MT2)
  den(153) = 1 / (Q(5,46))
  den(157) = 1 / (Q(5,29))
  den(160) = 1 / (Q(5,51))
  den(172) = 1 / (Q(5,30))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(25)+A(26))*f(3))/12._/**/REALKIND+((-A(158)-A(159)-A(160)-A(162)-A(163)-A(165)-A(167)-A(168)-A(169)-A(171)-A(173) &
       ...
       -A(204)-A(205))*f(3))/6._/**/REALKIND+((A(58)+A(60)+A(61)+A(63)+A(94)+A(96)+A(97)+A(98)+A(104)+A(105)+A(106)+A(107)+A(111) &
       +A(112)+A(113)+A(114)+A(120)+A(121)+A(122)+A(123))*f(5))/6._/**/REALKIND+((A(74)+A(75)+A(82)+A(83)+A(86)+A(88)+A(89)+A(91) &
       +A(92)+A(93))*f(7))/6._/**/REALKIND+((A(65)+A(67)+A(99)+A(100)+A(115)+A(117))*f(9))/6._/**/REALKIND+((A(76)+A(77)+A(84) &
       +A(85))*f(11))/6._/**/REALKIND+((-A(64)-A(66)-A(68)-A(69))*f(15))/6._/**/REALKIND
  M2(2) = -(A(25)*f(3))/4._/**/REALKIND+((A(137)+A(140)+A(141)+A(143)+A(144)+A(145)+A(152)+A(153)+A(154)+A(158)+A(159)+A(160) &
       ...
       -A(175))*f(4))/2._/**/REALKIND+((-A(58)-A(63)-A(96)-A(98)-A(102)-A(105)-A(107)-A(111)-A(113)-A(118)-A(120)-A(122)-A(127) &
       -A(129)-A(132))*f(5))/2._/**/REALKIND+(CI*(A(95)+A(110)-A(128)-A(131))*f(6))/2._/**/REALKIND+((-A(31)-A(33)-A(43)-A(45) &
       -A(52)-A(54)-A(70)-A(72)-A(75)-A(79)-A(81)-A(83)-A(86)-A(91)-A(93))*f(7))/2._/**/REALKIND+(CI*(-A(42)-A(50)+A(87) &
       +A(90))*f(8))/2._/**/REALKIND+((-A(67)-A(100)-A(108)-A(115)-A(124))*f(9))/2._/**/REALKIND+(CI*(A(101) &
       +A(116))*f(10))/2._/**/REALKIND+((-A(36)-A(47)-A(56)-A(77)-A(85))*f(11))/2._/**/REALKIND+(CI*(-A(49) &
       -A(57))*f(12))/2._/**/REALKIND+(CI*(-A(32)-A(35)+A(59)+A(62))*f(13))/2._/**/REALKIND+(CI*(-A(27)+A(28) &
  ...
  M2(3) = -(A(26)*f(3))/4._/**/REALKIND+((A(134)+A(135)+A(136)+A(146)+A(149)+A(151)+A(155)+A(156)+A(157)+A(162)+A(163)+A(165) &
       ...
       +A(175))*f(4))/2._/**/REALKIND+((-A(60)-A(61)-A(94)-A(97)-A(103)-A(104)-A(106)-A(112)-A(114)-A(119)-A(121)-A(123)-A(126) &
       -A(130)-A(133))*f(5))/2._/**/REALKIND+(CI*(-A(95)-A(110)+A(128)+A(131))*f(6))/2._/**/REALKIND+((-A(30)-A(34)-A(44)-A(46) &
       -A(51)-A(53)-A(71)-A(73)-A(74)-A(78)-A(80)-A(82)-A(88)-A(89)-A(92))*f(7))/2._/**/REALKIND+(CI*(A(42)+A(50)-A(87) &
       -A(90))*f(8))/2._/**/REALKIND+((-A(65)-A(99)-A(109)-A(117)-A(125))*f(9))/2._/**/REALKIND+(CI*(-A(101) &
       -A(116))*f(10))/2._/**/REALKIND+((-A(38)-A(48)-A(55)-A(76)-A(84))*f(11))/2._/**/REALKIND+(CI*(A(49) &
       +A(57))*f(12))/2._/**/REALKIND+(CI*(A(32)+A(35)-A(59)-A(62))*f(13))/2._/**/REALKIND+(CI*(A(27)-A(28) &
  ...
  M2(4) = ((A(25)+A(26))*f(3))/12._/**/REALKIND+((-A(134)-A(135)-A(136)-A(137)-A(140)-A(141)-A(143)-A(144)-A(145)-A(146)-A(149) &
       ...
       -A(192)-A(193))*f(3))/6._/**/REALKIND+((A(102)+A(103)+A(118)+A(119)+A(126)+A(127)+A(129)+A(130)+A(132) &
       +A(133))*f(5))/6._/**/REALKIND+((A(30)+A(31)+A(33)+A(34)+A(43)+A(44)+A(45)+A(46)+A(51)+A(52)+A(53)+A(54)+A(70)+A(71)+A(72) &
       +A(73)+A(78)+A(79)+A(80)+A(81))*f(7))/6._/**/REALKIND+((A(108)+A(109)+A(124)+A(125))*f(9))/6._/**/REALKIND+((A(36)+A(38) &
       +A(47)+A(48)+A(55)+A(56))*f(11))/6._/**/REALKIND+((-A(37)-A(39)-A(40)-A(41))*f(15))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppzttj_uuxttxzg_1_/**/REALKIND
