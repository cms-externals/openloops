...
module ol_colourmatrix_ppaa_bbxaa_1_/**/REALKIND
...
end module ol_colourmatrix_ppaa_bbxaa_1_/**/REALKIND



module ol_forced_parameters_ppaa_bbxaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaa_bbxaa_1_/**/REALKIND

module ol_loop_ppaa_bbxaa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**2*gQCD**2)/9._/**/REALKIND
    f(3) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**2)/9._/**/REALKIND
    f(4) = (eQED**2*gQCD**2*integralnorm*SwB)/9._/**/REALKIND
...
end module ol_loop_ppaa_bbxaa_1_/**/REALKIND
