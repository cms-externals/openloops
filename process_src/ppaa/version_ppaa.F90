...
module ol_versiondata_ppaa
  implicit none
  character(4) :: generator_revision = "3336"
  interface
    subroutine version_ppaa(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppaa
  end interface
end module ol_versiondata_ppaa


subroutine ol_version_ppaa(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppaa, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppaa
