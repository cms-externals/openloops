...
module ol_vamp_1_pphll_eexbbxh_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pphll_eexbbxh_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pphll_eexbbxh_1.
! **********************************************************************
...
#endif
  use ol_loop_pphll_eexbbxh_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pphll_eexbbxh_1_/**/REALKIND
  ...
  call check_last_QA_V(l_switch,G1(:,:,:,1),wf(:,26),G1tensor(:,1))
  call check_last_QA_V(l_switch,G1(:,:,:,1),wf(:,27),G1tensor(:,2))
  call loop_VA_Q(G0(:,:,:,1),wf(:,12),G0(:,:,:,3))
  ...
  call check_last_AQ_V(l_switch,G1(:,:,:,4),wf(:,29),G1tensor(:,3))
  call check_last_AQ_V(l_switch,G1(:,:,:,4),wf(:,30),G1tensor(:,4))
  ...
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,29),G2tensor(:,5))
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,30),G2tensor(:,6))
  ...
  call loop_VA_Q(G0(:,:,:,1),wf(:,26),G0(:,:,:,5))
  call loop_A_Q(G0(:,:,:,5),Q(:,11),MB,G1(:,:,:,12))
  call loop_AS_Q(G1(:,:,:,12),wf(:,-4),G1(:,:,:,13),gH)
  call loop_A_Q(G1(:,:,:,13),Q(:,27),MB,G2(:,:,:,13))
  call check_last_AQ_V(l_switch,G2(:,:,:,13),wf(:,-2),G2tensor(:,8))
  call loop_VA_Q(G0(:,:,:,1),wf(:,27),G0(:,:,:,6))
  call loop_A_Q(G0(:,:,:,6),Q(:,11),MB,G1(:,:,:,14))
  call loop_AS_Q(G1(:,:,:,14),wf(:,-4),G1(:,:,:,15),gH)
  call loop_A_Q(G1(:,:,:,15),Q(:,27),MB,G2(:,:,:,14))
...
end module ol_vamp_1_pphll_eexbbxh_1_/**/REALKIND
