...
module ol_versiondata_pphll
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pphll(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphll
  end interface
end module ol_versiondata_pphll


subroutine ol_version_pphll(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphll, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphll
