...
module ol_vamp_1_tbln_nexetbxg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_tbln_nexetbxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_tbln_nexetbxg_1.
! **********************************************************************
...
#endif
  use ol_loop_tbln_nexetbxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_tbln_nexetbxg_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_A_Q(G1(:,:,:,4),Q(:,27),MT,G2(:,:,:,2))
...
end module ol_vamp_1_tbln_nexetbxg_1_/**/REALKIND
