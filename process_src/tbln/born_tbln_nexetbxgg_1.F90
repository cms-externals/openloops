...
module ol_colourmatrix_tbln_nexetbxgg_1_/**/REALKIND
...
end module ol_colourmatrix_tbln_nexetbxgg_1_/**/REALKIND



module ol_forced_parameters_tbln_nexetbxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_tbln_nexetbxgg_1_/**/REALKIND

module ol_tree_tbln_nexetbxgg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_tbln_nexetbxgg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_tbln_nexetbxgg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for anti-nu_e e- top anti-bottom glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_tbln_nexetbxgg_1, only: external_perm_tbln_nexetbxgg_1, &
    & external_perm_inv_tbln_nexetbxgg_1, extcomb_perm_tbln_nexetbxgg_1, &
    & average_factor_tbln_nexetbxgg_1
  use ol_external_tbln_nexetbxgg_1, only: H, hel_not_initialised, hel_init, POLSEL
  use ol_colourmatrix_tbln_nexetbxgg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_tbln_nexetbxgg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_tbln_nexetbxgg_1
  ...
  extmasses2 = [ rZERO2, rME2, rMT2, rMB2, rZERO2, rZERO2 ]
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_tbln_nexetbxgg_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_tbln_nexetbxgg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_tbln_nexetbxgg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_tbln_nexetbxgg_1(extcombs(k))
  end do
  ...
  call pol_wf_Q(P(:,2), rME, H2, ex2, POLSEL(2))
  ...
  if (ntry == 1) then
    ...
    if (any(POLSEL /= 0)) then
      ...
      call pol_wf_Q(P(:,2), rME, H2, ex2, 0)
  ...
  call prop_Q_A(ntry, wf4(:,2), Q(:,20), MT, 1_intkind1, wf4(:,5), n2(2))
  ...
  call prop_A_Q(ntry, wf8(:,1), Q(:,11), MT, 1_intkind1, wf8(:,3), n2(4))
  call vert_VQ_A(ntry, ex6, ex3, wf4(:,7), n3(:,7), t3x4(:,:,4))
  call vert_AV_Q(ntry, ex4, ex5, wf4(:,8), n3(:,8), t3x4(:,:,5))
  call prop_Q_A(ntry, wf4(:,7), Q(:,36), MT, 1_intkind1, wf4(:,9), n2(5))
  ...
  call prop_Q_A(ntry, wf8(:,10), Q(:,52), MT, 1_intkind1, wf8(:,11), n2(8))
  ...
  if ( JBmunu /= 0 ) then ! POWHEG's Bmunu helicity correlation
    ...
    M2munu = M2munu / average_factor_tbln_nexetbxgg_1
  end if

  ! Colour and helicity average and symmetry factor of outgoing particles
  M2add = M2 / average_factor_tbln_nexetbxgg_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_tbln_nexetbxgg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_tbln_nexetbxgg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_tbln_nexetbxgg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_tbln_nexetbxgg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_tbln_nexetbxgg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_tbln_nexetbxgg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_tbln_nexetbxgg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_tbln_nexetbxgg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_tbln_nexetbxgg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_tbln_nexetbxgg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_tbln_nexetbxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_tbln_nexetbxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_tbln_nexetbxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_tbln_nexetbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_tbln_nexetbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_tbln_nexetbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_tbln_nexetbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_tbln_nexetbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_tbln_nexetbxgg_1_/**/REALKIND
