...
module ol_colourmatrix_tbln_nexetbxg_1_/**/REALKIND
...
end module ol_colourmatrix_tbln_nexetbxg_1_/**/REALKIND



module ol_forced_parameters_tbln_nexetbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_tbln_nexetbxg_1_/**/REALKIND

module ol_loop_tbln_nexetbxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  if (present(POLSEL)) then
    ...
    call pol_wf_Q(P(:,2), rME, H(2), wf(:,-1), POLSEL(2))
    ...
    call pol_wf_Q(P(:,2), rME, H(2), wf(:,-1), 0)
  ...
  call prop_Q_A(wf(:,13),Q(:,20),MT,1_intkind1,wf(:,14))
  call counter_Q_A(cttt,wf(:,4),Q(:,20),wf(:,15))
  call prop_A_Q(wf(:,5),Q(:,11),MT,1_intkind1,wf(:,16))
...
end module ol_loop_tbln_nexetbxg_1_/**/REALKIND
