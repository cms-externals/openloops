...
module ol_versiondata_tbln
  implicit none
  character(4) :: generator_revision = "1816"
  interface
    subroutine version_tbln(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_tbln
  end interface
end module ol_versiondata_tbln


subroutine ol_version_tbln(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_tbln, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_tbln
