...
module ol_vamp_1_tbln_nllxtxbg_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_tbln_nllxtxbg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_tbln_nllxtxbg_1.
! **********************************************************************
...
#endif
  use ol_loop_tbln_nllxtxbg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_tbln_nllxtxbg_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_Q_A(G1(:,:,:,4),Q(:,27),MT,G2(:,:,:,2))
  ...
  call loop_Q_A(G2(:,:,:,8),Q(:,27),MT,G3(:,:,:,3))
  ...
  call loop_Q_A(G0(:,:,:,5),Q(:,11),MT,G1(:,:,:,11))
  call loop_QV_A(G1(:,:,:,11),wf(:,-4),G1(:,:,:,12))
  call loop_Q_A(G1(:,:,:,12),Q(:,27),MT,G2(:,:,:,10))
...
end module ol_vamp_1_tbln_nllxtxbg_1_/**/REALKIND
