...
module ol_colourmatrix_tbln_nlxltbxg_1_/**/REALKIND
...
end module ol_colourmatrix_tbln_nlxltbxg_1_/**/REALKIND



module ol_forced_parameters_tbln_nlxltbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_tbln_nlxltbxg_1_/**/REALKIND

module ol_loop_tbln_nlxltbxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  if (present(POLSEL)) then
    ...
    call pol_wf_Q(P(:,2), rML, H(2), wf(:,-1), POLSEL(2))
    ...
    call pol_wf_Q(P(:,2), rML, H(2), wf(:,-1), 0)
...
end module ol_loop_tbln_nlxltbxg_1_/**/REALKIND
