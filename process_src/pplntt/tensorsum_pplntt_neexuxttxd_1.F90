...
! **********************************************************************
module ol_tensor_sum_storage_pplntt_neexuxttxd_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pplntt_neexuxttxd_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pplntt_neexuxttxd_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pplntt_neexuxttxd_1, only: channel_number_pplntt_neexuxttxd_1
  ...
  call channel_on(channel_number_pplntt_neexuxttxd_1)
  M2 = 0
  ...
  masses2_9 = [ ZERO2, MT2, ZERO2, ZERO2, ZERO2 ]
  ...
  call TI_call(2, momenta_12, masses2_7, T2sum(:,10), M2)
  call TI_call(2, momenta_13, masses2_7, T2sum(:,11), M2)
  call TI_call(2, momenta_15, masses2_7, T2sum(:,12), M2)
  ...
  call TI_call(3, momenta_18, masses2_8, T3sum(:,1), M2)
  call TI_call(3, momenta_17, masses2_8, T3sum(:,2), M2)
  call TI_call(3, momenta_16, masses2_8, T3sum(:,3), M2)
  ...
  call channel_off(channel_number_pplntt_neexuxttxd_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pplntt_neexuxttxd_1_/**/REALKIND
