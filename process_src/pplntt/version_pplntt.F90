...
module ol_versiondata_pplntt
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pplntt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplntt
  end interface
end module ol_versiondata_pplntt


subroutine ol_version_pplntt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplntt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplntt
