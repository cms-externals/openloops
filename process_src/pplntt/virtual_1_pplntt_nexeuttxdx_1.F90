...
module ol_vamp_1_pplntt_nexeuttxdx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplntt_nexeuttxdx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplntt_nexeuttxdx_1.
! **********************************************************************
...
#endif
  use ol_loop_pplntt_nexeuttxdx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplntt_nexeuttxdx_1_/**/REALKIND
  ...
  call loop_VA_Q(G1(:,:,:,4),wf(:,-5),G1(:,:,:,5))
  call loop_A_Q(G1(:,:,:,5),Q(:,56),ZERO,G2(:,:,:,5))
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,6),G2tensor(:,3))
  ...
  call loop_A_Q(G1(:,:,:,18),Q(:,55),MT,G2(:,:,:,15))
  ...
  call loop_Q_A(G0(:,:,:,6),Q(:,8),MT,G1(:,:,:,19))
  ...
  call check_last_AQ_V(l_switch,G2(:,:,:,18),wf(:,-2),G2tensor(:,14))
  call loop_UV_W(G0(:,:,:,1),Q(:,0),wf(:,26),Q(:,39),G1(:,:,:,23))
  call loop_VA_Q(G1(:,:,:,23),wf(:,-4),G1(:,:,:,24))
  call loop_A_Q(G1(:,:,:,24),Q(:,55),MT,G2(:,:,:,19))
...
end module ol_vamp_1_pplntt_nexeuttxdx_1_/**/REALKIND
