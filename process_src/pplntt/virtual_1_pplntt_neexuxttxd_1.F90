...
module ol_vamp_1_pplntt_neexuxttxd_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pplntt_neexuxttxd_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pplntt_neexuxttxd_1.
! **********************************************************************
...
#endif
  use ol_loop_pplntt_neexuxttxd_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pplntt_neexuxttxd_1_/**/REALKIND
  ...
  call loop_Q_A(G0(:,:,:,4),Q(:,56),ZERO,G1(:,:,:,9))
  ...
  call loop_Q_A(G1(:,:,:,14),Q(:,56),ZERO,G2(:,:,:,11))
...
end module ol_vamp_1_pplntt_neexuxttxd_1_/**/REALKIND
