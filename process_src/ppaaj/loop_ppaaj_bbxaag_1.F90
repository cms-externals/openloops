...
module ol_colourmatrix_ppaaj_bbxaag_1_/**/REALKIND
...
end module ol_colourmatrix_ppaaj_bbxaag_1_/**/REALKIND



module ol_forced_parameters_ppaaj_bbxaag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaaj_bbxaag_1_/**/REALKIND

module ol_loop_ppaaj_bbxaag_1_/**/REALKIND
  ...
  complex(REALKIND), save :: M0(1,32), Mct(1,32), Mcol_loop(1,32)
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 2) = (CI*countertermnorm*eQED**2*gQCD**3)/9._/**/REALKIND
    f( 3) = CI*countertermnorm*ctAAGG*eQED**2*gQCD**3
    f( 4) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**3)/9._/**/REALKIND
    f( 5) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**3)/9._/**/REALKIND
    f( 6) = (CI*eQED**2*gQCD**3*integralnorm*SwB)/9._/**/REALKIND
    f( 7) = (eQED**2*gQCD**3*integralnorm*SwB)/9._/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,29),Q(:,10),MB,1_intkind1,wf(:,30))
  call counter_AV_Q(wf(:,-1),wf(:,-2),wf(:,31))
  call prop_A_Q(wf(:,31),Q(:,6),MB,1_intkind1,wf(:,32))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,33))
  call prop_Q_A(wf(:,33),Q(:,17),MB,1_intkind1,wf(:,34))
  call vert_VQ_A(wf(:,-3),wf(:,34),wf(:,35))
  call counter_VQ_A(wf(:,-3),wf(:,0),wf(:,36))
  call prop_Q_A(wf(:,36),Q(:,9),MB,1_intkind1,wf(:,37))
  ...
  call prop_Q_A(wf(:,41),Q(:,5),MB,1_intkind1,wf(:,42))
  call vert_VQ_A(wf(:,-4),wf(:,42),wf(:,43))
  call vert_VQ_A(wf(:,-3),wf(:,42),wf(:,44))
  call vert_AV_Q(wf(:,4),wf(:,-4),wf(:,45))
  call counter_Q_A(ctbb,wf(:,3),Q(:,5),wf(:,46))
  call prop_A_Q(wf(:,45),Q(:,26),MB,1_intkind1,wf(:,47))
  call counter_A_Q(ctbb,wf(:,4),Q(:,10),wf(:,48))
  call prop_Q_A(wf(:,5),Q(:,21),MB,1_intkind1,wf(:,49))
  call vert_AV_Q(wf(:,7),wf(:,-3),wf(:,50))
  call prop_A_Q(wf(:,50),Q(:,26),MB,1_intkind1,wf(:,51))
  call counter_A_Q(ctbb,wf(:,7),Q(:,18),wf(:,52))
  call prop_Q_A(wf(:,8),Q(:,13),MB,1_intkind1,wf(:,53))
  call vert_AV_Q(wf(:,12),wf(:,-4),wf(:,54))
  call counter_Q_A(ctbb,wf(:,11),Q(:,9),wf(:,55))
  call prop_A_Q(wf(:,54),Q(:,22),MB,1_intkind1,wf(:,56))
  call counter_A_Q(ctbb,wf(:,12),Q(:,6),wf(:,57))
  call prop_Q_A(wf(:,13),Q(:,25),MB,1_intkind1,wf(:,58))
  call vert_AV_Q(wf(:,12),wf(:,-3),wf(:,59))
  call counter_Q_A(ctbb,wf(:,15),Q(:,17),wf(:,60))
  call prop_A_Q(wf(:,59),Q(:,14),MB,1_intkind1,wf(:,61))
  call prop_Q_A(wf(:,16),Q(:,25),MB,1_intkind1,wf(:,62))
  call vert_AV_Q(wf(:,7),wf(:,-2),wf(:,63))
  call prop_A_Q(wf(:,63),Q(:,22),MB,1_intkind1,wf(:,64))
  call prop_Q_A(wf(:,17),Q(:,13),MB,1_intkind1,wf(:,65))
  call vert_AV_Q(wf(:,4),wf(:,-2),wf(:,66))
  call prop_A_Q(wf(:,66),Q(:,14),MB,1_intkind1,wf(:,67))
  call prop_Q_A(wf(:,18),Q(:,21),MB,1_intkind1,wf(:,68))
...
end module ol_loop_ppaaj_bbxaag_1_/**/REALKIND
