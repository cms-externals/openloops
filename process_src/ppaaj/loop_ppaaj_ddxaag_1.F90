...
module ol_colourmatrix_ppaaj_ddxaag_1_/**/REALKIND
...
end module ol_colourmatrix_ppaaj_ddxaag_1_/**/REALKIND



module ol_forced_parameters_ppaaj_ddxaag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppaaj_ddxaag_1_/**/REALKIND

module ol_loop_ppaaj_ddxaag_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 4) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**3)/9._/**/REALKIND
    f( 5) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**3)/9._/**/REALKIND
...
end module ol_loop_ppaaj_ddxaag_1_/**/REALKIND
