...
module ol_versiondata_ppaaj
  implicit none
  character(4) :: generator_revision = "3336"
  interface
    subroutine version_ppaaj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppaaj
  end interface
end module ol_versiondata_ppaaj


subroutine ol_version_ppaaj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppaaj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppaaj
