...
module ol_colourmatrix_ppattj_uuxttxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppattj_uuxttxag_1_/**/REALKIND



module ol_forced_parameters_ppattj_uuxttxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppattj_uuxttxag_1_/**/REALKIND

module ol_loop_ppattj_uuxttxag_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 8) = (2*CI*countertermnorm*ctGtt*eQED*gQCD**5)/3._/**/REALKIND
    f( 9) = (2*countertermnorm*ctGtt*eQED*gQCD**5)/3._/**/REALKIND
    f(10) = (2*CI*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(11) = (2*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(12) = (2*CI*countertermnorm*ctVtt*eQED*gQCD**5)/3._/**/REALKIND
    f(13) = (2*countertermnorm*ctVtt*eQED*gQCD**5)/3._/**/REALKIND
    f(14) = (2*countertermnorm*ctVVV*eQED*gQCD**5)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,131),Q(:,11),MT,1_intkind1,wf(:,132))
  call vert_UV_W(wf(:,129),Q(:,3),wf(:,-5),Q(:,32),wf(:,133))
  call vert_VQ_A(wf(:,129),wf(:,14),wf(:,134))
  call vert_VQ_A(wf(:,129),wf(:,-2),wf(:,135))
  call prop_Q_A(wf(:,135),Q(:,7),MT,1_intkind1,wf(:,136))
  call vert_QA_V(wf(:,4),wf(:,5),wf(:,137))
  call counter_V_V(ctGG,wf(:,1),Q(:,3),wf(:,138))
  call vert_AV_Q(wf(:,5),wf(:,1),wf(:,139))
  call counter_Q_A(cttt,wf(:,4),Q(:,20),wf(:,140))
  call prop_A_Q(wf(:,139),Q(:,43),MT,1_intkind1,wf(:,141))
  call counter_A_Q(cttt,wf(:,5),Q(:,40),wf(:,142))
  call prop_Q_A(wf(:,6),Q(:,23),MT,1_intkind1,wf(:,143))
  call vert_AV_Q(wf(:,-3),wf(:,138),wf(:,144))
  call vert_UV_W(wf(:,138),Q(:,3),wf(:,-5),Q(:,32),wf(:,145))
  call prop_Q_A(wf(:,140),Q(:,20),MT,1_intkind1,wf(:,146))
  call vert_QA_V(wf(:,146),wf(:,-3),wf(:,147))
  call vert_VQ_A(wf(:,-5),wf(:,146),wf(:,148))
  call counter_A_Q(cttt,wf(:,9),Q(:,11),wf(:,149))
  call counter_V_V(ctGG,wf(:,10),Q(:,28),wf(:,150))
  call vert_QA_V(wf(:,14),wf(:,15),wf(:,151))
  call vert_AV_Q(wf(:,15),wf(:,1),wf(:,152))
  call counter_Q_A(cttt,wf(:,14),Q(:,36),wf(:,153))
  call prop_A_Q(wf(:,152),Q(:,27),MT,1_intkind1,wf(:,154))
  call counter_A_Q(cttt,wf(:,15),Q(:,24),wf(:,155))
  call prop_Q_A(wf(:,16),Q(:,39),MT,1_intkind1,wf(:,156))
  call vert_VQ_A(wf(:,138),wf(:,-2),wf(:,157))
  call prop_A_Q(wf(:,155),Q(:,24),MT,1_intkind1,wf(:,158))
  call vert_QA_V(wf(:,-2),wf(:,158),wf(:,159))
  call counter_Q_A(cttt,wf(:,19),Q(:,7),wf(:,160))
  call counter_V_V(ctGG,wf(:,20),Q(:,28),wf(:,161))
  call vert_AV_Q(wf(:,158),wf(:,-5),wf(:,162))
  call prop_Q_A(wf(:,153),Q(:,36),MT,1_intkind1,wf(:,163))
  call vert_VQ_A(wf(:,-4),wf(:,163),wf(:,164))
  call prop_A_Q(wf(:,142),Q(:,40),MT,1_intkind1,wf(:,165))
  ...
  call prop_Q_A(wf(:,205),Q(:,23),MT,1_intkind1,wf(:,206))
  call vert_VQ_A(wf(:,-5),wf(:,19),wf(:,207))
  call prop_Q_A(wf(:,207),Q(:,39),MT,1_intkind1,wf(:,208))
  call vert_QA_V(wf(:,-2),wf(:,9),wf(:,209))
  call vert_AV_Q(wf(:,9),wf(:,-4),wf(:,210))
  call prop_A_Q(wf(:,210),Q(:,27),MT,1_intkind1,wf(:,211))
  call vert_AV_Q(wf(:,9),wf(:,-5),wf(:,212))
  call prop_A_Q(wf(:,212),Q(:,43),MT,1_intkind1,wf(:,213))
  call vert_VQ_A(wf(:,11),wf(:,-2),wf(:,214))
  call prop_Q_A(wf(:,214),Q(:,39),MT,1_intkind1,wf(:,215))
  call vert_AV_Q(wf(:,-3),wf(:,11),wf(:,216))
  call prop_A_Q(wf(:,216),Q(:,43),MT,1_intkind1,wf(:,217))
  ...
  call prop_Q_A(wf(:,232),Q(:,23),MT,1_intkind1,wf(:,233))
  call vert_AV_Q(wf(:,-3),wf(:,29),wf(:,234))
  call prop_A_Q(wf(:,234),Q(:,27),MT,1_intkind1,wf(:,235))
  call vert_UV_W(wf(:,29),Q(:,19),wf(:,-5),Q(:,32),wf(:,236))
  call vert_QA_V(wf(:,100),wf(:,-1),wf(:,237))
  call vert_VQ_A(wf(:,39),wf(:,-2),wf(:,238))
  call prop_Q_A(wf(:,238),Q(:,23),MT,1_intkind1,wf(:,239))
  call vert_AV_Q(wf(:,-3),wf(:,39),wf(:,240))
  call prop_A_Q(wf(:,240),Q(:,27),MT,1_intkind1,wf(:,241))
  ...
  call prop_Q_A(wf(:,256),Q(:,39),MT,1_intkind1,wf(:,257))
  call vert_AV_Q(wf(:,-3),wf(:,47),wf(:,258))
  call prop_A_Q(wf(:,258),Q(:,43),MT,1_intkind1,wf(:,259))
  call vert_QA_V(wf(:,105),wf(:,-1),wf(:,260))
  call vert_VQ_A(wf(:,48),wf(:,-2),wf(:,261))
  call prop_Q_A(wf(:,261),Q(:,39),MT,1_intkind1,wf(:,262))
  call vert_AV_Q(wf(:,-3),wf(:,48),wf(:,263))
  call prop_A_Q(wf(:,263),Q(:,43),MT,1_intkind1,wf(:,264))
...
subroutine denominators()
  ...
  den(95) = 1 / (Q(5,60))
  den(99) = 1 / (Q(5,43) - MT2)
  den(102) = 1 / (Q(5,23) - MT2)
  den(117) = 1 / (Q(5,27) - MT2)
  den(120) = 1 / (Q(5,39) - MT2)
  den(139) = 1 / (Q(5,46))
  den(143) = 1 / (Q(5,29))
  den(146) = 1 / (Q(5,51))
  den(158) = 1 / (Q(5,30))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(147)+A(148)+A(149)+A(151)+A(152)+A(154)+A(156)+A(157)+A(158)+A(160)+A(162)+A(163)+A(165)+A(166)+A(167)+A(168)+A(169) &
       +A(170)+A(183)+A(184)+A(185)+A(186)+A(187)+A(188)+A(189)+A(190)+A(191)+A(192)+A(193)+A(194))*f(3))/6._/**/REALKIND+((A(25) &
       +A(26))*f(4))/12._/**/REALKIND+((-A(51)-A(53)-A(54)-A(56)-A(83)-A(85)-A(86)-A(87)-A(93)-A(94)-A(95)-A(96)-A(100)-A(101) &
       -A(102)-A(103)-A(109)-A(110)-A(111)-A(112))*f(6))/6._/**/REALKIND+((-A(63)-A(64)-A(71)-A(72)-A(75)-A(77)-A(78)-A(80)-A(81) &
       -A(82))*f(8))/6._/**/REALKIND+((-A(57)-A(58)-A(88)-A(89)-A(104)-A(106))*f(10))/6._/**/REALKIND+((-A(65)-A(66)-A(73) &
       -A(74))*f(12))/6._/**/REALKIND
  M2(2) = ((-A(126)-A(129)-A(130)-A(132)-A(133)-A(134)-A(141)-A(142)-A(143)-A(147)-A(148)-A(149)-A(160)-A(162)-A(163)-A(168) &
       -A(169)-A(170)-A(171)-A(172)-A(173)-A(177)-A(178)-A(179)-A(186)-A(187)-A(188)-A(192)-A(193)-A(194))*f(3))/2._/**/REALKIND &
       -(A(25)*f(4))/4._/**/REALKIND+(CI*(-A(127)-A(128)-A(131)-A(136)-A(137)-A(139)+A(150)+A(153)+A(155)+A(159)+A(161) &
       +A(164))*f(5))/2._/**/REALKIND+((A(51)+A(56)+A(85)+A(87)+A(91)+A(94)+A(96)+A(100)+A(102)+A(107)+A(109)+A(111)+A(116)+A(118) &
       +A(121))*f(6))/2._/**/REALKIND+(CI*(-A(84)-A(99)+A(117)+A(120))*f(7))/2._/**/REALKIND+((A(28)+A(30)+A(36)+A(38)+A(45)+A(47) &
       +A(59)+A(61)+A(64)+A(68)+A(70)+A(72)+A(75)+A(80)+A(82))*f(8))/2._/**/REALKIND+(CI*(A(35)+A(43)-A(76) &
       -A(79))*f(9))/2._/**/REALKIND+((A(58)+A(89)+A(97)+A(104)+A(113))*f(10))/2._/**/REALKIND+(CI*(-A(90) &
       -A(105))*f(11))/2._/**/REALKIND+((A(33)+A(40)+A(49)+A(66)+A(74))*f(12))/2._/**/REALKIND+(CI*(A(42) &
       +A(50))*f(13))/2._/**/REALKIND+(CI*(A(29)+A(32)-A(52)-A(55))*f(14))/2._/**/REALKIND
  M2(3) = ((-A(123)-A(124)-A(125)-A(135)-A(138)-A(140)-A(144)-A(145)-A(146)-A(151)-A(152)-A(154)-A(156)-A(157)-A(158)-A(165) &
       -A(166)-A(167)-A(174)-A(175)-A(176)-A(180)-A(181)-A(182)-A(183)-A(184)-A(185)-A(189)-A(190)-A(191))*f(3))/2._/**/REALKIND &
       -(A(26)*f(4))/4._/**/REALKIND+(CI*(A(127)+A(128)+A(131)+A(136)+A(137)+A(139)-A(150)-A(153)-A(155)-A(159)-A(161) &
       -A(164))*f(5))/2._/**/REALKIND+((A(53)+A(54)+A(83)+A(86)+A(92)+A(93)+A(95)+A(101)+A(103)+A(108)+A(110)+A(112)+A(115)+A(119) &
       +A(122))*f(6))/2._/**/REALKIND+(CI*(A(84)+A(99)-A(117)-A(120))*f(7))/2._/**/REALKIND+((A(27)+A(31)+A(37)+A(39)+A(44)+A(46) &
       +A(60)+A(62)+A(63)+A(67)+A(69)+A(71)+A(77)+A(78)+A(81))*f(8))/2._/**/REALKIND+(CI*(-A(35)-A(43)+A(76) &
       +A(79))*f(9))/2._/**/REALKIND+((A(57)+A(88)+A(98)+A(106)+A(114))*f(10))/2._/**/REALKIND+(CI*(A(90) &
       +A(105))*f(11))/2._/**/REALKIND+((A(34)+A(41)+A(48)+A(65)+A(73))*f(12))/2._/**/REALKIND+(CI*(-A(42) &
       -A(50))*f(13))/2._/**/REALKIND+(CI*(-A(29)-A(32)+A(52)+A(55))*f(14))/2._/**/REALKIND
  M2(4) = ((A(123)+A(124)+A(125)+A(126)+A(129)+A(130)+A(132)+A(133)+A(134)+A(135)+A(138)+A(140)+A(141)+A(142)+A(143)+A(144)+A(145) &
       +A(146)+A(171)+A(172)+A(173)+A(174)+A(175)+A(176)+A(177)+A(178)+A(179)+A(180)+A(181)+A(182))*f(3))/6._/**/REALKIND+((A(25) &
       +A(26))*f(4))/12._/**/REALKIND+((-A(91)-A(92)-A(107)-A(108)-A(115)-A(116)-A(118)-A(119)-A(121) &
       -A(122))*f(6))/6._/**/REALKIND+((-A(27)-A(28)-A(30)-A(31)-A(36)-A(37)-A(38)-A(39)-A(44)-A(45)-A(46)-A(47)-A(59)-A(60)-A(61) &
       -A(62)-A(67)-A(68)-A(69)-A(70))*f(8))/6._/**/REALKIND+((-A(97)-A(98)-A(113)-A(114))*f(10))/6._/**/REALKIND+((-A(33)-A(34) &
       -A(40)-A(41)-A(48)-A(49))*f(12))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppattj_uuxttxag_1_/**/REALKIND
