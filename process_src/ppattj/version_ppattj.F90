...
module ol_versiondata_ppattj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppattj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppattj
  end interface
end module ol_versiondata_ppattj


subroutine ol_version_ppattj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppattj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppattj
