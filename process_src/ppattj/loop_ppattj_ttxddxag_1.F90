...
module ol_colourmatrix_ppattj_ttxddxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppattj_ttxddxag_1_/**/REALKIND



module ol_forced_parameters_ppattj_ttxddxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppattj_ttxddxag_1_/**/REALKIND

module ol_loop_ppattj_ttxddxag_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(35), c(45)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 2) = (2*CI*eQED*gQCD**3)/3._/**/REALKIND
    f( 3) = (eQED*gQCD**3)/3._/**/REALKIND
    f( 4) = (2*eQED*gQCD**3)/3._/**/REALKIND
    f( 5) = (CI*countertermnorm*eQED*gQCD**5)/3._/**/REALKIND
    f( 6) = (2*CI*countertermnorm*eQED*gQCD**5)/3._/**/REALKIND
    f( 7) = CI*countertermnorm*eQED*gQCD**5
    f( 8) = (countertermnorm*eQED*gQCD**5)/3._/**/REALKIND
    f( 9) = (2*countertermnorm*eQED*gQCD**5)/3._/**/REALKIND
    f(10) = (CI*countertermnorm*ctGqq*eQED*gQCD**5)/3._/**/REALKIND
    f(11) = (2*CI*countertermnorm*ctGqq*eQED*gQCD**5)/3._/**/REALKIND
    f(12) = (countertermnorm*ctGqq*eQED*gQCD**5)/3._/**/REALKIND
    f(13) = (2*countertermnorm*ctGqq*eQED*gQCD**5)/3._/**/REALKIND
    f(14) = (CI*countertermnorm*ctGtt*eQED*gQCD**5)/3._/**/REALKIND
    f(15) = (2*CI*countertermnorm*ctGtt*eQED*gQCD**5)/3._/**/REALKIND
    f(16) = (countertermnorm*ctGtt*eQED*gQCD**5)/3._/**/REALKIND
    f(17) = (2*countertermnorm*ctGtt*eQED*gQCD**5)/3._/**/REALKIND
    f(18) = (CI*countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(19) = (countertermnorm*ctVqq*eQED*gQCD**5)/3._/**/REALKIND
    f(20) = (2*CI*countertermnorm*ctVtt*eQED*gQCD**5)/3._/**/REALKIND
    f(21) = (2*countertermnorm*ctVtt*eQED*gQCD**5)/3._/**/REALKIND
    f(22) = (countertermnorm*ctVVV*eQED*gQCD**5)/3._/**/REALKIND
    f(23) = (2*countertermnorm*ctVVV*eQED*gQCD**5)/3._/**/REALKIND
    f(24) = (CI*eQED*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(25) = (CI*eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(26) = (2*CI*eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(27) = (eQED*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(28) = (eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(29) = (2*eQED*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(30) = (CI*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(31) = (2*CI*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(32) = (4*CI*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(33) = (eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(34) = (2*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(35) = (4*eQED*gQCD**5*integralnorm*SwF)/3._/**/REALKIND

  c = [ 27*CI*f(24), 54*CI*f(24), 3*CI*f(25), 9*CI*f(25), 24*CI*f(25), 27*CI*f(25), 54*CI*f(25), 3*CI*f(26), 9*CI*f(26) &
    , 24*CI*f(26), 27*CI*f(26), 54*CI*f(26), 18*f(27), 54*f(27), f(28), 3*f(28), 6*f(28), 8*f(28), 9*f(28), 10*f(28), 18*f(28) &
    , 21*f(28), 24*f(28), 27*f(28), 54*f(28), f(29), 3*f(29), 6*f(29), 8*f(29), 9*f(29), 10*f(29), 18*f(29), 21*f(29), 24*f(29) &
    , 27*f(29), 54*f(29), 9*CI*f(30), 9*CI*f(31), 9*CI*f(32), 3*f(33), 9*f(33), 3*f(34), 9*f(34), 3*f(35), 9*f(35) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,18),Q(:,56),ZERO,0_intkind1,wf(:,71))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,72))
  call prop_Q_A(wf(:,72),Q(:,36),ZERO,0_intkind1,wf(:,73))
  call vert_VQ_A(wf(:,1),wf(:,73),wf(:,74))
  call prop_A_Q(wf(:,22),Q(:,56),ZERO,0_intkind1,wf(:,75))
  call vert_VQ_A(wf(:,-4),wf(:,73),wf(:,76))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,77))
  call prop_Q_A(wf(:,77),Q(:,20),ZERO,0_intkind1,wf(:,78))
  ...
  call prop_A_Q(wf(:,95),Q(:,14),MT,1_intkind1,wf(:,96))
  call vert_VQ_A(wf(:,93),wf(:,0),wf(:,97))
  call prop_Q_A(wf(:,97),Q(:,13),MT,1_intkind1,wf(:,98))
  call counter_AV_Q(wf(:,-1),wf(:,25),wf(:,99))
  call prop_Q_A(wf(:,32),Q(:,49),MT,1_intkind1,wf(:,100))
  call counter_QA_V(wf(:,26),wf(:,-1),wf(:,101))
  call counter_AV_Q(wf(:,-1),wf(:,-5),wf(:,102))
  call prop_A_Q(wf(:,102),Q(:,34),MT,1_intkind1,wf(:,103))
  call vert_QA_V(wf(:,26),wf(:,103),wf(:,104))
  call prop_Q_A(wf(:,43),Q(:,49),MT,1_intkind1,wf(:,105))
  call vert_AV_Q(wf(:,103),wf(:,-4),wf(:,106))
  call counter_AV_Q(wf(:,-1),wf(:,-4),wf(:,107))
  call prop_A_Q(wf(:,107),Q(:,18),MT,1_intkind1,wf(:,108))
  ...
  call prop_A_Q(wf(:,41),Q(:,50),MT,1_intkind1,wf(:,116))
  call counter_VQ_A(wf(:,-5),wf(:,0),wf(:,117))
  call prop_Q_A(wf(:,117),Q(:,33),MT,1_intkind1,wf(:,118))
  call vert_QA_V(wf(:,118),wf(:,37),wf(:,119))
  call prop_A_Q(wf(:,44),Q(:,50),MT,1_intkind1,wf(:,120))
  call vert_VQ_A(wf(:,-4),wf(:,118),wf(:,121))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,122))
  call prop_Q_A(wf(:,122),Q(:,17),MT,1_intkind1,wf(:,123))
  ...
  call prop_Q_A(wf(:,135),Q(:,7),ZERO,0_intkind1,wf(:,136))
  call vert_QA_V(wf(:,4),wf(:,5),wf(:,137))
  call counter_V_V(ctGG,wf(:,1),Q(:,3),wf(:,138))
  call vert_AV_Q(wf(:,5),wf(:,1),wf(:,139))
  call counter_Q_A(ctqq,wf(:,4),Q(:,20),wf(:,140))
  call prop_A_Q(wf(:,139),Q(:,43),ZERO,0_intkind1,wf(:,141))
  call counter_A_Q(ctqq,wf(:,5),Q(:,40),wf(:,142))
  call prop_Q_A(wf(:,6),Q(:,23),ZERO,0_intkind1,wf(:,143))
  call vert_AV_Q(wf(:,-3),wf(:,138),wf(:,144))
  call vert_UV_W(wf(:,138),Q(:,3),wf(:,-5),Q(:,32),wf(:,145))
  call prop_Q_A(wf(:,140),Q(:,20),ZERO,0_intkind1,wf(:,146))
  call vert_QA_V(wf(:,146),wf(:,-3),wf(:,147))
  call vert_VQ_A(wf(:,-5),wf(:,146),wf(:,148))
  call counter_A_Q(ctqq,wf(:,9),Q(:,11),wf(:,149))
  call counter_V_V(ctGG,wf(:,10),Q(:,28),wf(:,150))
  call vert_QA_V(wf(:,14),wf(:,15),wf(:,151))
  call vert_AV_Q(wf(:,15),wf(:,1),wf(:,152))
  call counter_Q_A(ctqq,wf(:,14),Q(:,36),wf(:,153))
  call prop_A_Q(wf(:,152),Q(:,27),ZERO,0_intkind1,wf(:,154))
  call counter_A_Q(ctqq,wf(:,15),Q(:,24),wf(:,155))
  call prop_Q_A(wf(:,16),Q(:,39),ZERO,0_intkind1,wf(:,156))
  call vert_VQ_A(wf(:,138),wf(:,-2),wf(:,157))
  call prop_A_Q(wf(:,155),Q(:,24),ZERO,0_intkind1,wf(:,158))
  call vert_QA_V(wf(:,-2),wf(:,158),wf(:,159))
  call counter_Q_A(ctqq,wf(:,19),Q(:,7),wf(:,160))
  call counter_V_V(ctGG,wf(:,20),Q(:,28),wf(:,161))
  call vert_AV_Q(wf(:,158),wf(:,-5),wf(:,162))
  call prop_Q_A(wf(:,153),Q(:,36),ZERO,0_intkind1,wf(:,163))
  call vert_VQ_A(wf(:,-4),wf(:,163),wf(:,164))
  call prop_A_Q(wf(:,142),Q(:,40),ZERO,0_intkind1,wf(:,165))
  call vert_AV_Q(wf(:,165),wf(:,-4),wf(:,166))
  call vert_AV_Q(wf(:,27),wf(:,25),wf(:,167))
  call counter_Q_A(cttt,wf(:,26),Q(:,17),wf(:,168))
  call prop_A_Q(wf(:,167),Q(:,46),MT,1_intkind1,wf(:,169))
  call vert_VQ_A(wf(:,25),wf(:,26),wf(:,170))
  call counter_A_Q(cttt,wf(:,27),Q(:,34),wf(:,171))
  call prop_Q_A(wf(:,170),Q(:,29),MT,1_intkind1,wf(:,172))
  call counter_V_V(ctGG,wf(:,25),Q(:,12),wf(:,173))
  call prop_Q_A(wf(:,168),Q(:,17),MT,1_intkind1,wf(:,174))
  ...
  call counter_A_Q(cttt,wf(:,33),Q(:,14),wf(:,179))
  call vert_UV_W(wf(:,173),Q(:,12),wf(:,-5),Q(:,32),wf(:,180))
  call vert_AV_Q(wf(:,37),wf(:,25),wf(:,181))
  call counter_Q_A(cttt,wf(:,36),Q(:,33),wf(:,182))
  call prop_A_Q(wf(:,181),Q(:,30),MT,1_intkind1,wf(:,183))
  call vert_VQ_A(wf(:,25),wf(:,36),wf(:,184))
  call counter_A_Q(cttt,wf(:,37),Q(:,18),wf(:,185))
  call prop_Q_A(wf(:,184),Q(:,45),MT,1_intkind1,wf(:,186))
  call prop_A_Q(wf(:,185),Q(:,18),MT,1_intkind1,wf(:,187))
  call vert_QA_V(wf(:,0),wf(:,187),wf(:,188))
  call vert_VQ_A(wf(:,173),wf(:,0),wf(:,189))
  call counter_V_V(ctGG,wf(:,39),Q(:,19),wf(:,190))
  call counter_Q_A(cttt,wf(:,42),Q(:,13),wf(:,191))
  call vert_AV_Q(wf(:,187),wf(:,-5),wf(:,192))
  call prop_Q_A(wf(:,182),Q(:,33),MT,1_intkind1,wf(:,193))
  call vert_VQ_A(wf(:,-4),wf(:,193),wf(:,194))
  call prop_A_Q(wf(:,171),Q(:,34),MT,1_intkind1,wf(:,195))
  ...
  call prop_Q_A(wf(:,205),Q(:,23),ZERO,0_intkind1,wf(:,206))
  ...
  call prop_A_Q(wf(:,212),Q(:,43),ZERO,0_intkind1,wf(:,213))
  call vert_VQ_A(wf(:,11),wf(:,-2),wf(:,214))
  call prop_Q_A(wf(:,214),Q(:,39),ZERO,0_intkind1,wf(:,215))
  call vert_AV_Q(wf(:,-3),wf(:,11),wf(:,216))
  call prop_A_Q(wf(:,216),Q(:,43),ZERO,0_intkind1,wf(:,217))
  call vert_QA_V(wf(:,42),wf(:,-1),wf(:,218))
  call vert_QA_V(wf(:,0),wf(:,33),wf(:,219))
  call vert_VQ_A(wf(:,-4),wf(:,42),wf(:,220))
  call prop_Q_A(wf(:,220),Q(:,29),MT,1_intkind1,wf(:,221))
  call vert_VQ_A(wf(:,-5),wf(:,42),wf(:,222))
  call prop_Q_A(wf(:,222),Q(:,45),MT,1_intkind1,wf(:,223))
  call vert_VQ_A(wf(:,30),wf(:,0),wf(:,224))
  call prop_Q_A(wf(:,224),Q(:,45),MT,1_intkind1,wf(:,225))
  call vert_AV_Q(wf(:,33),wf(:,-4),wf(:,226))
  call prop_A_Q(wf(:,226),Q(:,30),MT,1_intkind1,wf(:,227))
  call vert_AV_Q(wf(:,33),wf(:,-5),wf(:,228))
  call prop_A_Q(wf(:,228),Q(:,46),MT,1_intkind1,wf(:,229))
  call vert_AV_Q(wf(:,-1),wf(:,30),wf(:,230))
  call prop_A_Q(wf(:,230),Q(:,46),MT,1_intkind1,wf(:,231))
  call vert_VQ_A(wf(:,29),wf(:,-2),wf(:,232))
  call prop_Q_A(wf(:,232),Q(:,23),ZERO,0_intkind1,wf(:,233))
  call vert_AV_Q(wf(:,-3),wf(:,29),wf(:,234))
  call prop_A_Q(wf(:,234),Q(:,27),ZERO,0_intkind1,wf(:,235))
  call vert_UV_W(wf(:,29),Q(:,19),wf(:,-5),Q(:,32),wf(:,236))
  call vert_QA_V(wf(:,100),wf(:,-1),wf(:,237))
  call vert_VQ_A(wf(:,39),wf(:,-2),wf(:,238))
  call prop_Q_A(wf(:,238),Q(:,23),ZERO,0_intkind1,wf(:,239))
  ...
  call prop_A_Q(wf(:,263),Q(:,43),ZERO,0_intkind1,wf(:,264))
  call vert_QA_V(wf(:,0),wf(:,120),wf(:,265))
  call vert_VQ_A(wf(:,45),wf(:,0),wf(:,266))
  call prop_Q_A(wf(:,266),Q(:,45),MT,1_intkind1,wf(:,267))
  call vert_AV_Q(wf(:,-1),wf(:,45),wf(:,268))
  call prop_A_Q(wf(:,268),Q(:,46),MT,1_intkind1,wf(:,269))
  call vert_QA_V(wf(:,63),wf(:,-3),wf(:,270))
  call vert_VQ_A(wf(:,46),wf(:,0),wf(:,271))
  call prop_Q_A(wf(:,271),Q(:,45),MT,1_intkind1,wf(:,272))
  call vert_AV_Q(wf(:,-1),wf(:,46),wf(:,273))
  call prop_A_Q(wf(:,273),Q(:,46),MT,1_intkind1,wf(:,274))
...
subroutine denominators()
  ...
  den(117) = 1 / (Q(5,27))
  den(120) = 1 / (Q(5,39))
  den(139) = 1 / (Q(5,46) - MT2)
  den(143) = 1 / (Q(5,29) - MT2)
  den(146) = 1 / (Q(5,51))
  den(158) = 1 / (Q(5,30) - MT2)
  den(162) = 1 / (Q(5,45) - MT2)
  den(206) = 1 / (Q(5,15))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((A(21)+A(22)+A(23)+A(24))*f(1))/6._/**/REALKIND+((-A(9)-A(11)-A(12)-A(14)-A(15)-A(16))*f(2))/6._/**/REALKIND
  M1(2) = ((-A(2)-A(4)-A(7)-A(22)-A(24))*f(1))/2._/**/REALKIND+((A(9)+A(14)+A(16)+A(17)+A(19))*f(2))/2._/**/REALKIND+(CI*(-A(3) &
       -A(6))*f(3))/2._/**/REALKIND+(CI*(-A(10)-A(13))*f(4))/2._/**/REALKIND
  M1(3) = ((-A(1)-A(5)-A(8)-A(21)-A(23))*f(1))/2._/**/REALKIND+((A(11)+A(12)+A(15)+A(18)+A(20))*f(2))/2._/**/REALKIND+(CI*(A(3) &
       +A(6))*f(3))/2._/**/REALKIND+(CI*(A(10)+A(13))*f(4))/2._/**/REALKIND
  M1(4) = ((A(1)+A(2)+A(4)+A(5)+A(7)+A(8))*f(1))/6._/**/REALKIND+((-A(17)-A(18)-A(19)-A(20))*f(2))/6._/**/REALKIND

  M2(1) = ((-A(183)-A(184)-A(185)-A(186)-A(187)-A(188)-A(189)-A(190)-A(191)-A(192)-A(193)-A(194))*f(5))/6._/**/REALKIND+((A(147) &
       +A(148)+A(149)+A(151)+A(152)+A(154)+A(156)+A(157)+A(158)+A(160)+A(162)+A(163)+A(165)+A(166)+A(167)+A(168)+A(169) &
       +A(170))*f(6))/6._/**/REALKIND+((A(25)+A(26))*f(7))/12._/**/REALKIND+((A(63)+A(64)+A(71)+A(72))*f(10))/6._/**/REALKIND+(( &
       -A(75)-A(77)-A(78)-A(80)-A(81)-A(82))*f(11))/6._/**/REALKIND+((A(93)+A(94)+A(95)+A(96)+A(109)+A(110)+A(111) &
       +A(112))*f(14))/6._/**/REALKIND+((-A(51)-A(53)-A(54)-A(56)-A(83)-A(85)-A(86)-A(87)-A(100)-A(101)-A(102) &
       -A(103))*f(15))/6._/**/REALKIND+((A(65)+A(66)+A(73)+A(74))*f(18))/6._/**/REALKIND+((-A(57)-A(58)-A(88)-A(89)-A(104) &
       -A(106))*f(20))/6._/**/REALKIND
  M2(2) = ((A(126)+A(129)+A(130)+A(132)+A(133)+A(134)+A(141)+A(142)+A(143)+A(186)+A(187)+A(188)+A(192)+A(193) &
       +A(194))*f(5))/2._/**/REALKIND+((-A(147)-A(148)-A(149)-A(160)-A(162)-A(163)-A(168)-A(169)-A(170)-A(171)-A(172)-A(173) &
       -A(177)-A(178)-A(179))*f(6))/2._/**/REALKIND-(A(25)*f(7))/4._/**/REALKIND+(CI*(A(127)+A(128)+A(131)+A(136)+A(137) &
       +A(139))*f(8))/2._/**/REALKIND+(CI*(A(150)+A(153)+A(155)+A(159)+A(161)+A(164))*f(9))/2._/**/REALKIND+((-A(28)-A(30)-A(36) &
       -A(38)-A(45)-A(47)-A(64)-A(72))*f(10))/2._/**/REALKIND+((A(59)+A(61)+A(68)+A(70)+A(75)+A(80)+A(82))*f(11))/2._/**/REALKIND &
       +(CI*(-A(35)-A(43))*f(12))/2._/**/REALKIND+(CI*(-A(76)-A(79))*f(13))/2._/**/REALKIND+((-A(94)-A(96)-A(109)-A(111)-A(116) &
       -A(118)-A(121))*f(14))/2._/**/REALKIND+((A(51)+A(56)+A(85)+A(87)+A(91)+A(100)+A(102)+A(107))*f(15))/2._/**/REALKIND+(CI*( &
       -A(117)-A(120))*f(16))/2._/**/REALKIND+(CI*(-A(84)-A(99))*f(17))/2._/**/REALKIND+((-A(33)-A(40)-A(49)-A(66) &
       -A(74))*f(18))/2._/**/REALKIND+(CI*(-A(42)-A(50))*f(19))/2._/**/REALKIND+((A(58)+A(89)+A(97)+A(104) &
       +A(113))*f(20))/2._/**/REALKIND+(CI*(-A(90)-A(105))*f(21))/2._/**/REALKIND+(CI*(-A(29)-A(32))*f(22))/2._/**/REALKIND+(CI*( &
       -A(52)-A(55))*f(23))/2._/**/REALKIND
  M2(3) = ((A(123)+A(124)+A(125)+A(135)+A(138)+A(140)+A(144)+A(145)+A(146)+A(183)+A(184)+A(185)+A(189)+A(190) &
       +A(191))*f(5))/2._/**/REALKIND+((-A(151)-A(152)-A(154)-A(156)-A(157)-A(158)-A(165)-A(166)-A(167)-A(174)-A(175)-A(176) &
       -A(180)-A(181)-A(182))*f(6))/2._/**/REALKIND-(A(26)*f(7))/4._/**/REALKIND+(CI*(-A(127)-A(128)-A(131)-A(136)-A(137) &
       -A(139))*f(8))/2._/**/REALKIND+(CI*(-A(150)-A(153)-A(155)-A(159)-A(161)-A(164))*f(9))/2._/**/REALKIND+((-A(27)-A(31)-A(37) &
       -A(39)-A(44)-A(46)-A(63)-A(71))*f(10))/2._/**/REALKIND+((A(60)+A(62)+A(67)+A(69)+A(77)+A(78)+A(81))*f(11))/2._/**/REALKIND &
       +(CI*(A(35)+A(43))*f(12))/2._/**/REALKIND+(CI*(A(76)+A(79))*f(13))/2._/**/REALKIND+((-A(93)-A(95)-A(110)-A(112)-A(115) &
       -A(119)-A(122))*f(14))/2._/**/REALKIND+((A(53)+A(54)+A(83)+A(86)+A(92)+A(101)+A(103)+A(108))*f(15))/2._/**/REALKIND &
       +(CI*(A(117)+A(120))*f(16))/2._/**/REALKIND+(CI*(A(84)+A(99))*f(17))/2._/**/REALKIND+((-A(34)-A(41)-A(48)-A(65) &
       -A(73))*f(18))/2._/**/REALKIND+(CI*(A(42)+A(50))*f(19))/2._/**/REALKIND+((A(57)+A(88)+A(98)+A(106) &
       +A(114))*f(20))/2._/**/REALKIND+(CI*(A(90)+A(105))*f(21))/2._/**/REALKIND+(CI*(A(29)+A(32))*f(22))/2._/**/REALKIND &
       +(CI*(A(52)+A(55))*f(23))/2._/**/REALKIND
  M2(4) = ((-A(123)-A(124)-A(125)-A(126)-A(129)-A(130)-A(132)-A(133)-A(134)-A(135)-A(138)-A(140)-A(141)-A(142)-A(143)-A(144) &
       -A(145)-A(146))*f(5))/6._/**/REALKIND+((A(171)+A(172)+A(173)+A(174)+A(175)+A(176)+A(177)+A(178)+A(179)+A(180)+A(181) &
       +A(182))*f(6))/6._/**/REALKIND+((A(25)+A(26))*f(7))/12._/**/REALKIND+((A(27)+A(28)+A(30)+A(31)+A(36)+A(37)+A(38)+A(39) &
       +A(44)+A(45)+A(46)+A(47))*f(10))/6._/**/REALKIND+((-A(59)-A(60)-A(61)-A(62)-A(67)-A(68)-A(69)-A(70))*f(11))/6._/**/REALKIND &
       +((A(115)+A(116)+A(118)+A(119)+A(121)+A(122))*f(14))/6._/**/REALKIND+((-A(91)-A(92)-A(107)-A(108))*f(15))/6._/**/REALKIND &
       +((A(33)+A(34)+A(40)+A(41)+A(48)+A(49))*f(18))/6._/**/REALKIND+((-A(97)-A(98)-A(113)-A(114))*f(20))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppattj_ttxddxag_1_/**/REALKIND
