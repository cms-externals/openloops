...
module ol_colourmatrix_ppattj_ttxbbxagg_1_/**/REALKIND
...
end module ol_colourmatrix_ppattj_ttxbbxagg_1_/**/REALKIND



module ol_forced_parameters_ppattj_ttxbbxagg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppattj_ttxbbxagg_1_/**/REALKIND

module ol_tree_ppattj_ttxbbxagg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppattj_ttxbbxagg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppattj_ttxbbxagg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for top anti-top bottom anti-bottom gamma glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppattj_ttxbbxagg_1, only: external_perm_ppattj_ttxbbxagg_1, &
    & external_perm_inv_ppattj_ttxbbxagg_1, extcomb_perm_ppattj_ttxbbxagg_1, &
    & average_factor_ppattj_ttxbbxagg_1
  use ol_external_ppattj_ttxbbxagg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppattj_ttxbbxagg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppattj_ttxbbxagg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppattj_ttxbbxagg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppattj_ttxbbxagg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppattj_ttxbbxagg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppattj_ttxbbxagg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppattj_ttxbbxagg_1(extcombs(k))
  end do
  ...
  call prop_A_Q(ntry, wf4(:,11), Q(:,40), MB, 1_intkind1, wf4(:,12), n2(5))
  ...
  call prop_Q_A(ntry, wf8(:,6), Q(:,84), MB, 1_intkind1, wf8(:,7), n2(6))
  ...
  call prop_A_Q(ntry, wf4(:,13), Q(:,72), MB, 1_intkind1, wf4(:,14), n2(8))
  ...
  call prop_Q_A(ntry, wf8(:,11), Q(:,52), MB, 1_intkind1, wf8(:,12), n2(9))
  ...
  call prop_A_Q(ntry, wf8(:,15), Q(:,11), MB, 1_intkind1, wf8(:,16), n2(11))
  call vert_UV_W(ntry, wf4(:,1), Q(:,3), wf4(:,15), Q(:,96), wf16(:,13), n3(:,27), t3x16(:,:,7))
  call vert_AV_Q(ntry, ex4, wf4(:,15), wf8(:,17), n3(:,28), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,17), Q(:,104), MB, 1_intkind1, wf8(:,18), n2(12))
  ...
  call prop_Q_A(ntry, wf8(:,19), Q(:,100), MB, 1_intkind1, wf8(:,20), n2(14))
  call vert_AV_Q(ntry, wf4(:,5), ex7, wf8(:,21), n3(:,39), t3x8(:,:,14))
  call vert_VQ_A(ntry, wf4(:,1), wf4(:,17), wf16(:,22), n3(:,40), t3x16(:,:,16))
  call prop_A_Q(ntry, wf8(:,21), Q(:,88), MB, 1_intkind1, wf8(:,22), n2(15))
  call vert_VQ_A(ntry, ex7, ex3, wf4(:,18), n3(:,41), t3x4(:,:,11))
  call prop_Q_A(ntry, wf4(:,18), Q(:,68), MB, 1_intkind1, wf4(:,19), n2(16))
  ...
  call prop_A_Q(ntry, wf8(:,25), Q(:,56), MB, 1_intkind1, wf8(:,26), n2(18))
  call vert_VQ_A(ntry, wf4(:,1), ex3, wf8(:,27), n3(:,46), t3x8(:,:,17))
  call vert_AV_Q(ntry, wf4(:,5), wf4(:,15), wf16(:,25), n3(:,47), t3x16(:,:,19))
  call prop_Q_A(ntry, wf8(:,27), Q(:,7), MB, 1_intkind1, wf8(:,28), n2(19))
  call vert_VQ_A(ntry, wf4(:,15), ex3, wf8(:,29), n3(:,48), t3x8(:,:,18))
  call prop_Q_A(ntry, wf8(:,29), Q(:,100), MB, 1_intkind1, wf8(:,30), n2(20))
  ...
  call prop_Q_A(ntry, wf8(:,31), Q(:,52), MB, 1_intkind1, wf8(:,32), n2(21))
  call vert_AV_Q(ntry, wf4(:,14), ex5, wf8(:,33), n3(:,56), t3x8(:,:,20))
  call prop_A_Q(ntry, wf8(:,33), Q(:,88), MB, 1_intkind1, wf8(:,34), n2(22))
  ...
  call prop_Q_A(ntry, wf8(:,35), Q(:,84), MB, 1_intkind1, wf8(:,36), n2(23))
  call vert_AV_Q(ntry, wf4(:,12), ex5, wf8(:,37), n3(:,60), t3x8(:,:,22))
  call prop_A_Q(ntry, wf8(:,37), Q(:,56), MB, 1_intkind1, wf8(:,38), n2(24))
  ...
  M2add = M2 / average_factor_ppattj_ttxbbxagg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppattj_ttxbbxagg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppattj_ttxbbxagg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppattj_ttxbbxagg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppattj_ttxbbxagg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppattj_ttxbbxagg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppattj_ttxbbxagg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppattj_ttxbbxagg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppattj_ttxbbxagg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppattj_ttxbbxagg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppattj_ttxbbxagg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppattj_ttxbbxagg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppattj_ttxbbxagg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppattj_ttxbbxagg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppattj_ttxbbxagg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppattj_ttxbbxagg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppattj_ttxbbxagg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppattj_ttxbbxagg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppattj_ttxbbxagg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppattj_ttxbbxagg_1_/**/REALKIND
