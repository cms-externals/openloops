...
module ol_versiondata_pplnaj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pplnaj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplnaj
  end interface
end module ol_versiondata_pplnaj


subroutine ol_version_pplnaj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplnaj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplnaj
