...
module ol_colourmatrix_pplnaj_neexuxdag_1_/**/REALKIND
...
end module ol_colourmatrix_pplnaj_neexuxdag_1_/**/REALKIND



module ol_forced_parameters_pplnaj_neexuxdag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnaj_neexuxdag_1_/**/REALKIND

module ol_loop_pplnaj_neexuxdag_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_QA_W(wf(:,-3),wf(:,13),wf(:,20))
  call vert_UV_W(wf(:,-4),Q(:,16),wf(:,4),Q(:,3),wf(:,21))
  call prop_W_W(wf(:,20),Q(:,44),MW,1_intkind1,wf(:,22))
  call vert_VQ_A(wf(:,-4),wf(:,6),wf(:,23))
  call vert_QA_W(wf(:,6),wf(:,-2),wf(:,24))
  call prop_W_W(wf(:,24),Q(:,44),MW,1_intkind1,wf(:,25))
  call vert_AV_Q(wf(:,-1),wf(:,-4),wf(:,26))
  call prop_A_Q(wf(:,26),Q(:,18),ZERO,0_intkind1,wf(:,27))
  call vert_QA_W(wf(:,0),wf(:,27),wf(:,28))
  call prop_W_W(wf(:,28),Q(:,19),MW,1_intkind1,wf(:,29))
  call counter_AW_Q(wf(:,5),wf(:,4),wf(:,30))
  call counter_AV_Q(wf(:,5),wf(:,-5),wf(:,31))
  call counter_AW_Q(wf(:,13),wf(:,4),wf(:,32))
  call counter_VQ_A(wf(:,-5),wf(:,14),wf(:,33))
  call counter_AV_Q(wf(:,13),wf(:,-4),wf(:,34))
  call counter_VQ_A(wf(:,-4),wf(:,6),wf(:,35))
  call counter_WQ_A(wf(:,4),wf(:,-3),wf(:,36))
  call prop_A_Q(wf(:,9),Q(:,52),ZERO,0_intkind1,wf(:,37))
  call counter_VQ_A(wf(:,-5),wf(:,-3),wf(:,38))
  call prop_Q_A(wf(:,38),Q(:,40),ZERO,0_intkind1,wf(:,39))
  call counter_QA_W(wf(:,-3),wf(:,13),wf(:,40))
  call prop_W_W(wf(:,21),Q(:,19),MW,1_intkind1,wf(:,41))
  call prop_A_Q(wf(:,19),Q(:,52),ZERO,0_intkind1,wf(:,42))
  call vert_VQ_A(wf(:,-4),wf(:,39),wf(:,43))
  call vert_QA_W(wf(:,39),wf(:,-2),wf(:,44))
  ...
  call vert_VQ_A(wf(:,-5),wf(:,47),wf(:,48))
  call counter_AW_Q(wf(:,-2),wf(:,4),wf(:,49))
  call prop_Q_A(wf(:,17),Q(:,56),ZERO,0_intkind1,wf(:,50))
  call counter_AV_Q(wf(:,-2),wf(:,-5),wf(:,51))
  call prop_A_Q(wf(:,51),Q(:,36),ZERO,0_intkind1,wf(:,52))
  call vert_AW_Q(wf(:,52),wf(:,4),wf(:,53))
  call counter_QA_W(wf(:,6),wf(:,-2),wf(:,54))
  call prop_Q_A(wf(:,23),Q(:,56),ZERO,0_intkind1,wf(:,55))
  call vert_AV_Q(wf(:,52),wf(:,-4),wf(:,56))
  call vert_QA_W(wf(:,-3),wf(:,52),wf(:,57))
  call prop_W_W(wf(:,57),Q(:,44),MW,1_intkind1,wf(:,58))
  call counter_AV_Q(wf(:,-2),wf(:,-4),wf(:,59))
  call prop_A_Q(wf(:,59),Q(:,20),ZERO,0_intkind1,wf(:,60))
  call vert_AW_Q(wf(:,60),wf(:,4),wf(:,61))
  call vert_AV_Q(wf(:,60),wf(:,-5),wf(:,62))
  call vert_WQ_A(wf(:,4),wf(:,6),wf(:,63))
  call counter_A_Q(ctqq,wf(:,5),Q(:,20),wf(:,64))
  call prop_Q_A(wf(:,63),Q(:,43),ZERO,0_intkind1,wf(:,65))
  call counter_Q_A(ctqq,wf(:,6),Q(:,40),wf(:,66))
  call prop_A_Q(wf(:,7),Q(:,23),ZERO,0_intkind1,wf(:,67))
  call prop_A_Q(wf(:,64),Q(:,20),ZERO,0_intkind1,wf(:,68))
  call vert_AV_Q(wf(:,68),wf(:,-5),wf(:,69))
  call counter_Q_A(ctqq,wf(:,10),Q(:,11),wf(:,70))
  call vert_WQ_A(wf(:,4),wf(:,14),wf(:,71))
  call counter_A_Q(ctqq,wf(:,13),Q(:,36),wf(:,72))
  call prop_Q_A(wf(:,71),Q(:,27),ZERO,0_intkind1,wf(:,73))
  call counter_Q_A(ctqq,wf(:,14),Q(:,24),wf(:,74))
  call prop_A_Q(wf(:,15),Q(:,39),ZERO,0_intkind1,wf(:,75))
  call counter_A_Q(ctqq,wf(:,18),Q(:,7),wf(:,76))
  call prop_Q_A(wf(:,74),Q(:,24),ZERO,0_intkind1,wf(:,77))
  call vert_VQ_A(wf(:,-5),wf(:,77),wf(:,78))
  call prop_A_Q(wf(:,72),Q(:,36),ZERO,0_intkind1,wf(:,79))
  call vert_QA_W(wf(:,-3),wf(:,79),wf(:,80))
  call vert_AV_Q(wf(:,79),wf(:,-4),wf(:,81))
  call prop_Q_A(wf(:,66),Q(:,40),ZERO,0_intkind1,wf(:,82))
  call vert_QA_W(wf(:,82),wf(:,-2),wf(:,83))
  call vert_VQ_A(wf(:,-4),wf(:,82),wf(:,84))
  call vert_QA_V(wf(:,-3),wf(:,18),wf(:,85))
  call vert_AV_Q(wf(:,18),wf(:,-4),wf(:,86))
  call prop_A_Q(wf(:,86),Q(:,23),ZERO,0_intkind1,wf(:,87))
  call vert_AV_Q(wf(:,18),wf(:,-5),wf(:,88))
  call prop_A_Q(wf(:,88),Q(:,39),ZERO,0_intkind1,wf(:,89))
  call vert_QA_V(wf(:,10),wf(:,-2),wf(:,90))
  call vert_VQ_A(wf(:,-4),wf(:,10),wf(:,91))
  call prop_Q_A(wf(:,91),Q(:,27),ZERO,0_intkind1,wf(:,92))
  call vert_VQ_A(wf(:,-5),wf(:,10),wf(:,93))
  call prop_Q_A(wf(:,93),Q(:,43),ZERO,0_intkind1,wf(:,94))
  call vert_AW_Q(wf(:,-2),wf(:,41),wf(:,95))
  call prop_A_Q(wf(:,95),Q(:,23),ZERO,0_intkind1,wf(:,96))
  call vert_WQ_A(wf(:,41),wf(:,-3),wf(:,97))
  call prop_Q_A(wf(:,97),Q(:,27),ZERO,0_intkind1,wf(:,98))
  call vert_AW_Q(wf(:,-2),wf(:,29),wf(:,99))
  call prop_A_Q(wf(:,99),Q(:,23),ZERO,0_intkind1,wf(:,100))
  call vert_WQ_A(wf(:,29),wf(:,-3),wf(:,101))
  call prop_Q_A(wf(:,101),Q(:,27),ZERO,0_intkind1,wf(:,102))
...
end module ol_loop_pplnaj_neexuxdag_1_/**/REALKIND
