...
module ol_versiondata_pptzj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptzj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptzj
  end interface
end module ol_versiondata_pptzj


subroutine ol_version_pptzj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptzj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptzj
