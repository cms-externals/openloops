...
module ol_tree_pptzj_utxdxbz_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pptzj_utxdxbz_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pptzj_utxdxbz_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
...
! **********************************************************************
  ...
  use ol_external_pptzj_utxdxbz_1, only: H, hel_not_initialised, hel_init
  ...
  use ol_heltables_pptzj_utxdxbz_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_pptzj_utxdxbz_1,5)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pptzj_utxdxbz_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pptzj_utxdxbz_1(-I)
  end if
  ...
  call vert_UV_W(ntry, ex5, Q(:,16), wf4(:,1), Q(:,5), wf12(:,2), n3(:,5), t3x12(:,:,2))
  ...
  call prop_Q_A(ntry, wf6(:,3), Q(:,24), MB, 1_intkind1, wf6(:,4), n2(2))
  ...
  M2add = M2 / average_factor_pptzj_utxdxbz_1

  do k = 0, 17-1
    M2(k) = M2add(extcomb_perm_pptzj_utxdxbz_1(k))
  end do
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pptzj_utxdxbz_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pptzj_utxdxbz_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pptzj_utxdxbz_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pptzj_utxdxbz_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pptzj_utxdxbz_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pptzj_utxdxbz_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pptzj_utxdxbz_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pptzj_utxdxbz_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pptzj_utxdxbz_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pptzj_utxdxbz_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pptzj_utxdxbz_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pptzj_utxdxbz_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pptzj_utxdxbz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pptzj_utxdxbz_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2(0:17-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pptzj_utxdxbz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pptzj_utxdxbz_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2(5)
...
end module ol_tree_pptzj_utxdxbz_1_/**/REALKIND
