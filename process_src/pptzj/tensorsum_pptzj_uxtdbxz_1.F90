...
! **********************************************************************
module ol_tensor_sum_storage_pptzj_uxtdbxz_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pptzj_uxtdbxz_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pptzj_uxtdbxz_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pptzj_uxtdbxz_1, only: channel_number_pptzj_uxtdbxz_1
  ...
  call channel_on(channel_number_pptzj_uxtdbxz_1)
  M2 = 0
  ...
  momenta_21(:,3) = Q(1:4,27)
  momenta_22(:,1) = Q(1:4,8)
  momenta_22(:,2) = Q(1:4,10)
  ...
  momenta_31(:,2) = Q(1:4,21)
  momenta_31(:,3) = Q(1:4,23)
  momenta_32(:,1) = Q(1:4,20)
  momenta_32(:,2) = Q(1:4,21)
  momenta_32(:,3) = Q(1:4,29)
  momenta_33(:,1) = Q(1:4,24)
  momenta_33(:,2) = Q(1:4,26)
  momenta_33(:,3) = Q(1:4,27)
  momenta_34(:,1) = Q(1:4,24)
  momenta_34(:,2) = Q(1:4,26)
  ...
  momenta_37(:,1) = Q(1:4,2)
  momenta_37(:,2) = Q(1:4,18)
  momenta_37(:,3) = Q(1:4,26)
  momenta_37(:,4) = Q(1:4,30)
  momenta_38(:,1) = Q(1:4,4)
  momenta_38(:,2) = Q(1:4,5)
  momenta_38(:,3) = Q(1:4,13)
  momenta_38(:,4) = Q(1:4,29)
  momenta_39(:,1) = Q(1:4,4)
  momenta_39(:,2) = Q(1:4,5)
  momenta_39(:,3) = Q(1:4,21)
  momenta_39(:,4) = Q(1:4,29)
  momenta_40(:,1) = Q(1:4,4)
  momenta_40(:,2) = Q(1:4,20)
  momenta_40(:,3) = Q(1:4,21)
  momenta_40(:,4) = Q(1:4,29)
  momenta_41(:,1) = Q(1:4,8)
  momenta_41(:,2) = Q(1:4,10)
  momenta_41(:,3) = Q(1:4,11)
  momenta_41(:,4) = Q(1:4,27)
  momenta_42(:,1) = Q(1:4,8)
  momenta_42(:,2) = Q(1:4,10)
  momenta_42(:,3) = Q(1:4,14)
  momenta_42(:,4) = Q(1:4,30)
  momenta_43(:,1) = Q(1:4,8)
  momenta_43(:,2) = Q(1:4,10)
  momenta_43(:,3) = Q(1:4,26)
  momenta_43(:,4) = Q(1:4,27)
  momenta_44(:,1) = Q(1:4,8)
  momenta_44(:,2) = Q(1:4,10)
  momenta_44(:,3) = Q(1:4,26)
  momenta_44(:,4) = Q(1:4,30)
  momenta_45(:,1) = Q(1:4,8)
  momenta_45(:,2) = Q(1:4,24)
  momenta_45(:,3) = Q(1:4,26)
  momenta_45(:,4) = Q(1:4,27)
  momenta_46(:,1) = Q(1:4,8)
  momenta_46(:,2) = Q(1:4,24)
  momenta_46(:,3) = Q(1:4,26)
  ...
  masses2_8 = [ ZERO2, ZERO2, ZERO2 ]
  masses2_9 = [ ZERO2, MB2, MB2, MT2 ]
  masses2_10 = [ ZERO2, MB2, MT2, MT2 ]
  masses2_11 = [ ZERO2, MB2, MW2, ZERO2 ]
  masses2_12 = [ ZERO2, MT2, MW2, ZERO2 ]
  masses2_13 = [ ZERO2, ZERO2, MW2, MB2 ]
  masses2_14 = [ ZERO2, ZERO2, MW2, MT2 ]
  masses2_15 = [ ZERO2, ZERO2, ZERO2, ZERO2 ]
  masses2_16 = [ ZERO2, MB2, MB2, MW2, ZERO2 ]
  masses2_17 = [ ZERO2, MB2, MW2, MW2, ZERO2 ]
  masses2_18 = [ ZERO2, MB2, MW2, ZERO2, ZERO2 ]
  masses2_19 = [ ZERO2, MT2, MT2, MW2, ZERO2 ]
  masses2_20 = [ ZERO2, MT2, MW2, MW2, ZERO2 ]
  masses2_21 = [ ZERO2, MT2, MW2, ZERO2, ZERO2 ]
  masses2_22 = [ ZERO2, ZERO2, MW2, MT2, MT2 ]
  masses2_23 = [ ZERO2, ZERO2, MW2, MW2, MT2 ]
  masses2_24 = [ ZERO2, ZERO2, ZERO2, MW2, MT2 ]
  ...
  call TI_call(2, momenta_12, masses2_6, T2sum(:,1), M2)
  call TI_call(2, momenta_14, masses2_5, T2sum(:,2), M2)
  call TI_call(2, momenta_6, masses2_4, T2sum(:,3), M2)
  call TI_call(2, momenta_9, masses2_7, T2sum(:,4), M2)
  call TI_call(2, momenta_7, masses2_5, T2sum(:,5), M2)
  call TI_call(2, momenta_11, masses2_8, T2sum(:,6), M2)
  call TI_call(2, momenta_13, masses2_8, T2sum(:,7), M2)
  call TI_call(2, momenta_8, masses2_8, T2sum(:,8), M2)
  call TI_call(2, momenta_10, masses2_8, T2sum(:,9), M2)
  call TI_call(2, momenta_5, masses2_8, T2sum(:,10), M2)
  call TI_call(2, momenta_27, masses2_13, T2sum(:,11), M2)
  call TI_call(2, momenta_20, masses2_14, T2sum(:,12), M2)
  call TI_call(2, momenta_28, masses2_14, T2sum(:,13), M2)
  call TI_call(2, momenta_21, masses2_11, T2sum(:,14), M2)
  call TI_call(2, momenta_26, masses2_11, T2sum(:,15), M2)
  call TI_call(2, momenta_29, masses2_12, T2sum(:,16), M2)
  call TI_call(2, momenta_30, masses2_12, T2sum(:,17), M2)
  call TI_call(2, momenta_25, masses2_11, T2sum(:,18), M2)
  call TI_call(2, momenta_15, masses2_12, T2sum(:,19), M2)
  call TI_call(2, momenta_31, masses2_13, T2sum(:,20), M2)
  call TI_call(2, momenta_32, masses2_14, T2sum(:,21), M2)
  call TI_call(2, momenta_22, masses2_11, T2sum(:,22), M2)
  call TI_call(2, momenta_16, masses2_12, T2sum(:,23), M2)
  call TI_call(2, momenta_33, masses2_11, T2sum(:,24), M2)
  call TI_call(2, momenta_34, masses2_11, T2sum(:,25), M2)
  call TI_call(2, momenta_17, masses2_14, T2sum(:,26), M2)

  call TI_call(3, momenta_23, masses2_10, T3sum(:,1), M2)
  call TI_call(3, momenta_24, masses2_9, T3sum(:,2), M2)
  call TI_call(3, momenta_18, masses2_15, T3sum(:,3), M2)
  call TI_call(3, momenta_19, masses2_15, T3sum(:,4), M2)
  call TI_call(3, momenta_36, masses2_20, T3sum(:,5), M2)
  call TI_call(3, momenta_37, masses2_19, T3sum(:,6), M2)
  call TI_call(3, momenta_45, masses2_16, T3sum(:,7), M2)
  call TI_call(3, momenta_35, masses2_21, T3sum(:,8), M2)
  call TI_call(3, momenta_41, masses2_18, T3sum(:,9), M2)
  call TI_call(3, momenta_38, masses2_22, T3sum(:,10), M2)
  call TI_call(3, momenta_46, masses2_16, T3sum(:,11), M2)
  call TI_call(3, momenta_44, masses2_17, T3sum(:,12), M2)
  call TI_call(3, momenta_39, masses2_23, T3sum(:,13), M2)
  call TI_call(3, momenta_43, masses2_17, T3sum(:,14), M2)
  call TI_call(3, momenta_42, masses2_18, T3sum(:,15), M2)
  call TI_call(3, momenta_40, masses2_24, T3sum(:,16), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pptzj_uxtdbxz_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pptzj_uxtdbxz_1_/**/REALKIND
