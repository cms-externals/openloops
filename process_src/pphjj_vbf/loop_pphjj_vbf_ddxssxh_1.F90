...
module ol_colourmatrix_pphjj_vbf_ddxssxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphjj_vbf_ddxssxh_1_/**/REALKIND



module ol_forced_parameters_pphjj_vbf_ddxssxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphjj_vbf_ddxssxh_1_/**/REALKIND

module ol_loop_pphjj_vbf_ddxssxh_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_QA_Z(gZd,wf(:,-2),wf(:,-3),wf(:,6))
  call prop_W_W(wf(:,6),Q(:,12),MZ,1_intkind1,wf(:,7))
  call counter_QA_Z(gZd,wf(:,0),wf(:,-1),wf(:,8))
...
end module ol_loop_pphjj_vbf_ddxssxh_1_/**/REALKIND
