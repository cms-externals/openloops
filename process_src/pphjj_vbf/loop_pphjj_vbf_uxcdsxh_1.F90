...
module ol_colourmatrix_pphjj_vbf_uxcdsxh_1_/**/REALKIND
...
end module ol_colourmatrix_pphjj_vbf_uxcdsxh_1_/**/REALKIND



module ol_forced_parameters_pphjj_vbf_uxcdsxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphjj_vbf_uxcdsxh_1_/**/REALKIND

module ol_loop_pphjj_vbf_uxcdsxh_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVqq*eQED**3*gQCD**2*lambdaHWW*MW)/(2._/**/REALKIND*sw**3)
    f(3) = (CI*countertermnorm*ctVsc*eQED**3*gQCD**2*lambdaHWW*MW)/(2._/**/REALKIND*sw**3)
    f(4) = (eQED**3*gQCD**2*integralnorm*lambdaHWW*MW*SwB)/(sw**3*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_QA_W(wf(:,-1),wf(:,-3),wf(:,6))
  call prop_W_W(wf(:,6),Q(:,10),MW,1_intkind1,wf(:,7))
  call counter_QA_W(wf(:,-2),wf(:,0),wf(:,8))
  call prop_W_W(wf(:,8),Q(:,5),MW,1_intkind1,wf(:,9))
  call vert_SV_V(wf(:,-4),wf(:,9),wf(:,10))
  call prop_W_W(wf(:,5),Q(:,21),MW,1_intkind1,wf(:,11))
  call vert_SV_V(wf(:,-4),wf(:,4),wf(:,12))
  call prop_W_W(wf(:,12),Q(:,26),MW,1_intkind1,wf(:,13))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = A(3)*f(2)+A(2)*f(3)

end subroutine colourvectors

end module ol_loop_pphjj_vbf_uxcdsxh_1_/**/REALKIND
