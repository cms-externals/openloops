...
module ol_vamp_1_pphjj_vbf_uuuxuxh_1_/**/REALKIND
...
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pphjj_vbf_uuuxuxh_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pphjj_vbf_uuuxuxh_1.
! **********************************************************************
...
#endif
  use ol_loop_pphjj_vbf_uuuxuxh_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pphjj_vbf_uuuxuxh_1_/**/REALKIND
...
if (mode == -1) return
  ...
  call loop_QA_Z(G0(:,:,:,1),wf(:,-3),G0(:,:,:,2),gZu)
  call loop_VS_V(G0(:,:,:,2),wf(:,-4),G0(:,:,:,3))
  call loop_ZQ_A(G0(:,:,:,3),wf(:,15),G0(:,:,:,4),gZu)
  call check_last_Q_A(l_switch,G0(:,:,:,4),Q(:,31),ZERO,G1tensor(:,1))
  call loop_ZQ_A(G0(:,:,:,3),wf(:,20),G0(:,:,:,5),gZu)
  ...
  call loop_QA_Z(G0(:,:,:,1),wf(:,17),G0(:,:,:,10),gZu)
  call loop_VS_V(G0(:,:,:,10),wf(:,-4),G0(:,:,:,11))
  call loop_ZQ_A(G0(:,:,:,11),wf(:,-1),G0(:,:,:,12),gZu)
  ...
  call loop_QA_Z(G1(:,:,:,12),wf(:,-3),G1(:,:,:,13),gZu)
  call loop_VS_V(G1(:,:,:,13),wf(:,-4),G1(:,:,:,14))
  call loop_ZQ_A(G1(:,:,:,14),wf(:,-1),G1(:,:,:,15),gZu)
  ...
  call loop_QA_Z(G0(:,:,:,1),wf(:,22),G0(:,:,:,18),gZu)
  call loop_VS_V(G0(:,:,:,18),wf(:,-4),G0(:,:,:,19))
  call loop_ZQ_A(G0(:,:,:,19),wf(:,0),G0(:,:,:,20),gZu)
  ...
  call loop_QA_Z(G1(:,:,:,19),wf(:,-3),G1(:,:,:,20),gZu)
  call loop_VS_V(G1(:,:,:,20),wf(:,-4),G1(:,:,:,21))
  call loop_ZQ_A(G1(:,:,:,21),wf(:,0),G1(:,:,:,22),gZu)
  ...
  call loop_AQ_Z(G0(:,:,:,1),wf(:,26),G0(:,:,:,25),gZu)
  call loop_VS_V(G0(:,:,:,25),wf(:,-4),G0(:,:,:,26))
  call loop_ZA_Q(G0(:,:,:,26),wf(:,-2),G0(:,:,:,27),gZu)
  ...
  call loop_QA_Z(G0(:,:,:,1),wf(:,28),G0(:,:,:,31),gZu)
  call loop_VS_V(G0(:,:,:,31),wf(:,-4),G0(:,:,:,32))
  call loop_ZQ_A(G0(:,:,:,32),wf(:,-1),G0(:,:,:,33),gZu)
  ...
  call loop_QA_Z(G1(:,:,:,35),wf(:,-2),G1(:,:,:,36),gZu)
  call loop_VS_V(G1(:,:,:,36),wf(:,-4),G1(:,:,:,37))
  call loop_ZQ_A(G1(:,:,:,37),wf(:,-1),G1(:,:,:,38),gZu)
  ...
  call loop_AQ_Z(G0(:,:,:,1),wf(:,31),G0(:,:,:,39),gZu)
  call loop_VS_V(G0(:,:,:,39),wf(:,-4),G0(:,:,:,40))
  call loop_ZA_Q(G0(:,:,:,40),wf(:,-2),G0(:,:,:,41),gZu)
  ...
  call loop_QA_Z(G0(:,:,:,1),wf(:,33),G0(:,:,:,45),gZu)
  call loop_VS_V(G0(:,:,:,45),wf(:,-4),G0(:,:,:,46))
  call loop_ZQ_A(G0(:,:,:,46),wf(:,0),G0(:,:,:,47),gZu)
  ...
  call loop_QA_Z(G1(:,:,:,42),wf(:,-2),G1(:,:,:,43),gZu)
  call loop_VS_V(G1(:,:,:,43),wf(:,-4),G1(:,:,:,44))
  call loop_ZQ_A(G1(:,:,:,44),wf(:,0),G1(:,:,:,45),gZu)
...
end module ol_vamp_1_pphjj_vbf_uuuxuxh_1_/**/REALKIND
