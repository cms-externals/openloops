...
module ol_versiondata_pphjj_vbf
  implicit none
  character(4) :: generator_revision = "2786"
  interface
    subroutine version_pphjj_vbf(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphjj_vbf
  end interface
end module ol_versiondata_pphjj_vbf


subroutine ol_version_pphjj_vbf(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphjj_vbf, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphjj_vbf
