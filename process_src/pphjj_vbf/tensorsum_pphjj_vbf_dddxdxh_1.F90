...
! **********************************************************************
module ol_tensor_sum_storage_pphjj_vbf_dddxdxh_1_/**/REALKIND
! **********************************************************************
  ...
  complex(REALKIND), save :: T2sum(15,20) = 0

  contains

#ifdef PRECISION_dp
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphjj_vbf_dddxdxh_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphjj_vbf_dddxdxh_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 2
...
! **********************************************************************
  use ol_external_pphjj_vbf_dddxdxh_1, only: channel_number_pphjj_vbf_dddxdxh_1
  ...
  call channel_on(channel_number_pphjj_vbf_dddxdxh_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,4)
  momenta_1(:,2) = Q(1:4,29)
  momenta_2(:,1) = Q(1:4,4)
  ...
  momenta_9(:,1) = Q(1:4,5)
  momenta_9(:,2) = Q(1:4,13)
  momenta_9(:,3) = Q(1:4,29)
  momenta_10(:,1) = Q(1:4,6)
  ...
  masses2_4 = [ ZERO2, ZERO2, MW2, MW2 ]
  masses2_5 = [ ZERO2, ZERO2, MZ2, MZ2 ]
  masses2_6 = [ ZERO2, ZERO2, MZ2, MZ2, ZERO2 ]
  ...
  call TI_call(1, momenta_7, masses2_1, T1sum(:,4), M2)
  call TI_call(1, momenta_8, masses2_2, T1sum(:,5), M2)
  call TI_call(1, momenta_8, masses2_1, T1sum(:,6), M2)
  call TI_call(1, momenta_6, masses2_2, T1sum(:,7), M2)
  call TI_call(1, momenta_6, masses2_1, T1sum(:,8), M2)
  ...
  call TI_call(2, momenta_2, masses2_3, T2sum(:,10), M2)
  call TI_call(2, momenta_12, masses2_5, T2sum(:,11), M2)
  call TI_call(2, momenta_12, masses2_4, T2sum(:,12), M2)
  call TI_call(2, momenta_14, masses2_6, T2sum(:,13), M2)
  call TI_call(2, momenta_13, masses2_6, T2sum(:,14), M2)
  call TI_call(2, momenta_16, masses2_6, T2sum(:,15), M2)
  call TI_call(2, momenta_20, masses2_6, T2sum(:,16), M2)
  call TI_call(2, momenta_15, masses2_6, T2sum(:,17), M2)
  call TI_call(2, momenta_19, masses2_6, T2sum(:,18), M2)
  call TI_call(2, momenta_18, masses2_6, T2sum(:,19), M2)
  call TI_call(2, momenta_17, masses2_6, T2sum(:,20), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pphjj_vbf_dddxdxh_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphjj_vbf_dddxdxh_1_/**/REALKIND
