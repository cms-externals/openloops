...
! **********************************************************************
module ol_tensor_sum_storage_ppjj_bbxgg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppjj_bbxgg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppjj_bbxgg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppjj_bbxgg_1, only: channel_number_ppjj_bbxgg_1
  ...
  call channel_on(channel_number_ppjj_bbxgg_1)
  M2 = 0
  ...
  masses2_11 = [ ZERO2, ZERO2, MB2, MB2 ]
  ...
  call TI_call(1, momenta_3, masses2_2, T1sum(:,3), M2)
  call TI_call(1, momenta_2, masses2_2, T1sum(:,4), M2)
  ...
  call TI_call(2, momenta_15, masses2_6, T2sum(:,8), M2)
  call TI_call(2, momenta_9, masses2_8, T2sum(:,9), M2)
  call TI_call(2, momenta_6, masses2_6, T2sum(:,10), M2)
  call TI_call(2, momenta_5, masses2_4, T2sum(:,11), M2)
  call TI_call(2, momenta_5, masses2_3, T2sum(:,12), M2)
  call TI_call(2, momenta_5, masses2_1, T2sum(:,13), M2)

  call TI_call(3, momenta_7, masses2_9, T3sum(:,1), M2)
  call TI_call(3, momenta_7, masses2_7, T3sum(:,2), M2)
  ...
  call channel_off(channel_number_ppjj_bbxgg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppjj_bbxgg_1_/**/REALKIND
