...
! **********************************************************************
module ol_heltables_ppjj_gggg_1
! **********************************************************************
  ...
  integer(intkind2), save :: n3(3,12), n4(4,3)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x4(2,4,6), t3x16(2,16,6), t4x8(3,8,3)
...
end module ol_heltables_ppjj_gggg_1
