...
! **********************************************************************
module ol_tensor_sum_storage_ppjj_dddxdx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppjj_dddxdx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppjj_dddxdx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 2
...
! **********************************************************************
  use ol_external_ppjj_dddxdx_1, only: channel_number_ppjj_dddxdx_1
  ...
  call channel_on(channel_number_ppjj_dddxdx_1)
  M2 = 0
  ...
  call TI_call(2, momenta_12, masses2_5, T2sum(:,9), M2)
  call TI_call(2, momenta_11, masses2_5, T2sum(:,10), M2)
  call TI_call(2, momenta_14, masses2_5, T2sum(:,11), M2)
  ...
  call channel_off(channel_number_ppjj_dddxdx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppjj_dddxdx_1_/**/REALKIND
