...
module ol_colourmatrix_ppjj_bbxggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppjj_bbxggg_1_/**/REALKIND



module ol_forced_parameters_ppjj_bbxggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppjj_bbxggg_1_/**/REALKIND

module ol_tree_ppjj_bbxggg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppjj_bbxggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppjj_bbxggg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for bottom anti-bottom glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppjj_bbxggg_1, only: external_perm_ppjj_bbxggg_1, &
    & external_perm_inv_ppjj_bbxggg_1, extcomb_perm_ppjj_bbxggg_1, &
    & average_factor_ppjj_bbxggg_1
  use ol_external_ppjj_bbxggg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppjj_bbxggg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppjj_bbxggg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppjj_bbxggg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppjj_bbxggg_1,5)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppjj_bbxggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppjj_bbxggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppjj_bbxggg_1(extcombs(k))
  end do
  ...
  call vert_UV_W(ntry, wf4(:,1), Q(:,3), ex5, Q(:,16), wf8(:,4), n3(:,3), t3x8(:,:,1))
  call vert_UV_W(ntry, ex3, Q(:,4), ex5, Q(:,16), wf4(:,3), n3(:,4), t3x4(:,:,3))
  call vert_UV_W(ntry, wf4(:,1), Q(:,3), ex4, Q(:,8), wf8(:,5), n3(:,5), t3x8(:,:,2))
  call vert_UV_W(ntry, ex4, Q(:,8), ex5, Q(:,16), wf4(:,4), n3(:,6), t3x4(:,:,4))
  call vert_UV_W(ntry, wf4(:,1), Q(:,3), ex3, Q(:,4), wf8(:,6), n3(:,7), t3x8(:,:,3))
  call vert_VQ_A(ntry, ex3, ex1, wf4(:,5), n3(:,8), t3x4(:,:,5))
  call vert_AV_Q(ntry, ex2, ex4, wf4(:,6), n3(:,9), t3x4(:,:,6))
  call prop_Q_A(ntry, wf4(:,5), Q(:,5), MB, 1_intkind1, wf4(:,7), n2(1))
  call prop_A_Q(ntry, wf4(:,6), Q(:,10), MB, 1_intkind1, wf4(:,8), n2(2))
  call vert_VQ_A(ntry, ex5, wf4(:,7), wf8(:,7), n3(:,10), t3x8(:,:,4))
  call vert_AV_Q(ntry, ex2, ex5, wf4(:,9), n3(:,11), t3x4(:,:,7))
  call prop_A_Q(ntry, wf4(:,9), Q(:,18), MB, 1_intkind1, wf4(:,10), n2(3))
  ...
  call prop_Q_A(ntry, wf4(:,11), Q(:,9), MB, 1_intkind1, wf4(:,13), n2(4))
  call prop_A_Q(ntry, wf4(:,12), Q(:,6), MB, 1_intkind1, wf4(:,14), n2(5))
  call vert_VQ_A(ntry, ex5, wf4(:,13), wf8(:,10), n3(:,16), t3x8(:,:,7))
  call vert_VQ_A(ntry, ex5, ex1, wf4(:,15), n3(:,17), t3x4(:,:,10))
  call prop_Q_A(ntry, wf4(:,15), Q(:,17), MB, 1_intkind1, wf4(:,16), n2(6))
  ...
  M2add = M2 / average_factor_ppjj_bbxggg_1

  do k = 0, 17-1
    M2(k) = M2add(extcomb_perm_ppjj_bbxggg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppjj_bbxggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppjj_bbxggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppjj_bbxggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppjj_bbxggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppjj_bbxggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppjj_bbxggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppjj_bbxggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppjj_bbxggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppjj_bbxggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppjj_bbxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppjj_bbxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppjj_bbxggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppjj_bbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppjj_bbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppjj_bbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2(0:17-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppjj_bbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppjj_bbxggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,5)
  real(c_double), intent(out) :: m2(5)
...
end module ol_tree_ppjj_bbxggg_1_/**/REALKIND
