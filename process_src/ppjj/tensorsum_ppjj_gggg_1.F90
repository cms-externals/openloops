...
! **********************************************************************
module ol_tensor_sum_storage_ppjj_gggg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppjj_gggg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppjj_gggg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppjj_gggg_1, only: channel_number_ppjj_gggg_1
  ...
  call channel_on(channel_number_ppjj_gggg_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,8)
  momenta_2(:,1) = Q(1:4,9)
  momenta_3(:,1) = Q(1:4,10)
  momenta_4(:,1) = Q(1:4,11)
  momenta_5(:,1) = Q(1:4,12)
  momenta_6(:,1) = Q(1:4,13)
  momenta_7(:,1) = Q(1:4,14)
  momenta_8(:,1) = Q(1:4,2)
  momenta_8(:,2) = Q(1:4,14)
  momenta_9(:,1) = Q(1:4,4)
  momenta_9(:,2) = Q(1:4,12)
  momenta_10(:,1) = Q(1:4,4)
  momenta_10(:,2) = Q(1:4,13)
  momenta_11(:,1) = Q(1:4,4)
  momenta_11(:,2) = Q(1:4,14)
  momenta_12(:,1) = Q(1:4,5)
  momenta_12(:,2) = Q(1:4,13)
  momenta_13(:,1) = Q(1:4,6)
  momenta_13(:,2) = Q(1:4,14)
  momenta_14(:,1) = Q(1:4,2)
  momenta_14(:,2) = Q(1:4,6)
  momenta_14(:,3) = Q(1:4,14)
  momenta_15(:,1) = Q(1:4,2)
  momenta_15(:,2) = Q(1:4,10)
  momenta_15(:,3) = Q(1:4,14)
  ...
  call TI_call(2, momenta_3, masses2_3, T2sum(:,2), M2)
  call TI_call(2, momenta_2, masses2_3, T2sum(:,3), M2)
  call TI_call(2, momenta_5, masses2_2, T2sum(:,4), M2)
  call TI_call(2, momenta_5, masses2_1, T2sum(:,5), M2)
  call TI_call(2, momenta_3, masses2_2, T2sum(:,6), M2)
  call TI_call(2, momenta_3, masses2_1, T2sum(:,7), M2)
  call TI_call(2, momenta_2, masses2_2, T2sum(:,8), M2)
  call TI_call(2, momenta_2, masses2_1, T2sum(:,9), M2)

  call TI_call(3, momenta_8, masses2_6, T3sum(:,1), M2)
  call TI_call(3, momenta_11, masses2_6, T3sum(:,2), M2)
  call TI_call(3, momenta_13, masses2_6, T3sum(:,3), M2)
  call TI_call(3, momenta_10, masses2_6, T3sum(:,4), M2)
  call TI_call(3, momenta_12, masses2_6, T3sum(:,5), M2)
  call TI_call(3, momenta_9, masses2_6, T3sum(:,6), M2)
  call TI_call(3, momenta_9, masses2_5, T3sum(:,7), M2)
  call TI_call(3, momenta_9, masses2_4, T3sum(:,8), M2)
  call TI_call(3, momenta_12, masses2_5, T3sum(:,9), M2)
  call TI_call(3, momenta_12, masses2_4, T3sum(:,10), M2)
  call TI_call(3, momenta_13, masses2_5, T3sum(:,11), M2)
  call TI_call(3, momenta_13, masses2_4, T3sum(:,12), M2)
  call TI_call(3, momenta_10, masses2_5, T3sum(:,13), M2)
  call TI_call(3, momenta_10, masses2_4, T3sum(:,14), M2)
  call TI_call(3, momenta_11, masses2_5, T3sum(:,15), M2)
  call TI_call(3, momenta_11, masses2_4, T3sum(:,16), M2)
  call TI_call(3, momenta_8, masses2_5, T3sum(:,17), M2)
  call TI_call(3, momenta_8, masses2_4, T3sum(:,18), M2)

  call TI_call(4, momenta_15, masses2_9, T4sum(:,1), M2)
  call TI_call(4, momenta_15, masses2_8, T4sum(:,2), M2)
  call TI_call(4, momenta_15, masses2_7, T4sum(:,3), M2)
  call TI_call(4, momenta_14, masses2_9, T4sum(:,4), M2)
  call TI_call(4, momenta_14, masses2_8, T4sum(:,5), M2)
  call TI_call(4, momenta_14, masses2_7, T4sum(:,6), M2)
  call TI_call(4, momenta_16, masses2_9, T4sum(:,7), M2)
  call TI_call(4, momenta_16, masses2_8, T4sum(:,8), M2)
  call TI_call(4, momenta_16, masses2_7, T4sum(:,9), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppjj_gggg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppjj_gggg_1_/**/REALKIND
