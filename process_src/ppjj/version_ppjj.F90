...
module ol_versiondata_ppjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppjj
  end interface
end module ol_versiondata_ppjj


subroutine ol_version_ppjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppjj
