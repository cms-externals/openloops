...
module ol_vamp_1_ppjj_bbxgg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppjj_bbxgg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppjj_bbxgg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppjj_bbxgg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppjj_bbxgg_1_/**/REALKIND
  ...
  call loop_A_Q(G0(:,:,:,3),Q(:,14),MB,G1(:,:,:,1))
  ...
  call loop_A_Q(G0(:,:,:,5),Q(:,14),MB,G1(:,:,:,2))
  ...
  call loop_A_Q(G0(:,:,:,7),Q(:,14),MB,G1(:,:,:,3))
  ...
  call loop_A_Q(G0(:,:,:,17),Q(:,10),MB,G1(:,:,:,32))
  call loop_AV_Q(G1(:,:,:,32),wf(:,-2),G1(:,:,:,33))
  call loop_A_Q(G1(:,:,:,33),Q(:,14),MB,G2(:,:,:,30))
  ...
  call loop_A_Q(G1(:,:,:,39),Q(:,14),MB,G2(:,:,:,36))
...
end module ol_vamp_1_ppjj_bbxgg_1_/**/REALKIND
