...
module ol_colourmatrix_ppjj_ddxgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppjj_ddxgg_1_/**/REALKIND



module ol_forced_parameters_ppjj_ddxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppjj_ddxgg_1_/**/REALKIND

module ol_loop_ppjj_ddxgg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGqq*gQCD**4
    f( 6) = countertermnorm*ctGqq*gQCD**4
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,6),Q(:,9),ZERO,0_intkind1,wf(:,8))
  ...
  call prop_A_Q(wf(:,7),Q(:,6),ZERO,0_intkind1,wf(:,13))
  call counter_VQ_A(wf(:,-2),wf(:,0),wf(:,14))
  call prop_A_Q(wf(:,4),Q(:,10),ZERO,0_intkind1,wf(:,15))
  call counter_QA_V(wf(:,0),wf(:,-1),wf(:,16))
  call counter_V_V(ctGG,wf(:,1),Q(:,3),wf(:,17))
  call counter_Q_A(ctqq,wf(:,5),Q(:,5),wf(:,18))
  call counter_Q_A(ctqq,wf(:,8),Q(:,9),wf(:,19))
...
end module ol_loop_ppjj_ddxgg_1_/**/REALKIND
