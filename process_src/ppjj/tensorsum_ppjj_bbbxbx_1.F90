...
! **********************************************************************
module ol_tensor_sum_storage_ppjj_bbbxbx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppjj_bbbxbx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppjj_bbbxbx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 2
...
! **********************************************************************
  use ol_external_ppjj_bbbxbx_1, only: channel_number_ppjj_bbbxbx_1
  ...
  call channel_on(channel_number_ppjj_bbbxbx_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,9)
  momenta_2(:,1) = Q(1:4,10)
  momenta_3(:,1) = Q(1:4,4)
  momenta_3(:,2) = Q(1:4,13)
  momenta_4(:,1) = Q(1:4,4)
  momenta_4(:,2) = Q(1:4,14)
  momenta_5(:,1) = Q(1:4,5)
  momenta_5(:,2) = Q(1:4,13)
  momenta_6(:,1) = Q(1:4,6)
  momenta_6(:,2) = Q(1:4,14)
  momenta_7(:,1) = Q(1:4,8)
  momenta_7(:,2) = Q(1:4,13)
  momenta_8(:,1) = Q(1:4,8)
  ...
  masses2_6 = [ ZERO2, MB2, ZERO2, MB2 ]

#ifdef LOOPSQUARED
  if (a_switch == 1 .or. a_switch == 7) then
#endif

  call TI_call(2, momenta_7, masses2_4, T2sum(:,1), M2)
  call TI_call(2, momenta_5, masses2_5, T2sum(:,2), M2)
  call TI_call(2, momenta_8, masses2_4, T2sum(:,3), M2)
  call TI_call(2, momenta_6, masses2_5, T2sum(:,4), M2)
  call TI_call(2, momenta_3, masses2_4, T2sum(:,5), M2)
  call TI_call(2, momenta_9, masses2_5, T2sum(:,6), M2)
  call TI_call(2, momenta_4, masses2_4, T2sum(:,7), M2)
  call TI_call(2, momenta_10, masses2_5, T2sum(:,8), M2)
  call TI_call(2, momenta_12, masses2_6, T2sum(:,9), M2)
  call TI_call(2, momenta_11, masses2_6, T2sum(:,10), M2)
  call TI_call(2, momenta_14, masses2_6, T2sum(:,11), M2)
  call TI_call(2, momenta_13, masses2_6, T2sum(:,12), M2)
  ...
  call TI_call(2, momenta_1, masses2_3, T2sum(:,16), M2)
  call TI_call(2, momenta_1, masses2_2, T2sum(:,17), M2)
  call TI_call(2, momenta_1, masses2_1, T2sum(:,18), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppjj_bbbxbx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppjj_bbbxbx_1_/**/REALKIND
