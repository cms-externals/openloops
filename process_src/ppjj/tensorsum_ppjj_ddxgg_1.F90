...
! **********************************************************************
module ol_tensor_sum_storage_ppjj_ddxgg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppjj_ddxgg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppjj_ddxgg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppjj_ddxgg_1, only: channel_number_ppjj_ddxgg_1
  ...
  call channel_on(channel_number_ppjj_ddxgg_1)
  M2 = 0
  ...
  call TI_call(2, momenta_12, masses2_6, T2sum(:,3), M2)
  ...
  call TI_call(2, momenta_8, masses2_6, T2sum(:,7), M2)
  ...
  call TI_call(3, momenta_7, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_7, masses2_4, T3sum(:,3), M2)
  call TI_call(3, momenta_18, masses2_7, T3sum(:,4), M2)
  call TI_call(3, momenta_20, masses2_7, T3sum(:,5), M2)
  call TI_call(3, momenta_17, masses2_7, T3sum(:,6), M2)
  call TI_call(3, momenta_22, masses2_7, T3sum(:,7), M2)
  call TI_call(3, momenta_21, masses2_7, T3sum(:,8), M2)
  call TI_call(3, momenta_19, masses2_7, T3sum(:,9), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppjj_ddxgg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppjj_ddxgg_1_/**/REALKIND
