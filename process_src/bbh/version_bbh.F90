...
module ol_versiondata_bbh
  implicit none
  character(4) :: generator_revision = "4024"
  interface
    subroutine version_bbh(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_bbh
  end interface
end module ol_versiondata_bbh


subroutine ol_version_bbh(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_bbh, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
