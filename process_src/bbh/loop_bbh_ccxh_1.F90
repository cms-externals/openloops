...
module ol_colourmatrix_bbh_ccxh_1_/**/REALKIND
...
end module ol_colourmatrix_bbh_ccxh_1_/**/REALKIND



module ol_forced_parameters_bbh_ccxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_bbh_ccxh_1_/**/REALKIND

module ol_loop_bbh_ccxh_1_/**/REALKIND
  ...
  complex(REALKIND), save :: M0(1,4), Mct(1,4), Mcol_loop(1,4)
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctScc*eQED*gQCD**2*YC)/(2._/**/REALKIND*MW*sw)
    f(3) = (eQED*gQCD**2*integralnorm*SwB*YC)/(MW*sw*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_AQ_S(gH,wf(:,-1),wf(:,0),wf(:,2))
...
subroutine diagrams(A)
  ...
  A(1) = cont_SS(wf(:,-2),wf(:,1))

  A(2) = cont_SS(wf(:,-2),wf(:,2))
...
end module ol_loop_bbh_ccxh_1_/**/REALKIND
