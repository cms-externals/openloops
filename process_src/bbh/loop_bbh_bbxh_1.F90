...
module ol_colourmatrix_bbh_bbxh_1_/**/REALKIND
...
end module ol_colourmatrix_bbh_bbxh_1_/**/REALKIND



module ol_forced_parameters_bbh_bbxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_bbh_bbxh_1_/**/REALKIND

module ol_loop_bbh_bbxh_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctSbb*eQED*gQCD**2*YB)/(2._/**/REALKIND*MW*sw)
    f(3) = (eQED*gQCD**2*integralnorm*SwB*YB)/(MW*sw*2._/**/REALKIND)
...
end module ol_loop_bbh_bbxh_1_/**/REALKIND
