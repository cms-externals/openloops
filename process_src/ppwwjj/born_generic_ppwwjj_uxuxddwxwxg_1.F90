...
module ol_external_ppwwjj_uxuxddwxwxg_1
  implicit none
  integer :: dummy_counter
  ! Permutation and inverse permutation of external particles
  integer, save :: external_perm_ppwwjj_uxuxddwxwxg_1(7) = &
                     [ (dummy_counter, dummy_counter = 1, 7) ]
  integer, save :: external_perm_inv_ppwwjj_uxuxddwxwxg_1(7) = &
                     [ (dummy_counter, dummy_counter = 1, 7) ]
  integer, save :: extcomb_perm_ppwwjj_uxuxddwxwxg_1(0:29) = &
                     [ (dummy_counter, dummy_counter = 0, 29) ]
  ! Particle types (mapping of fields to integers is not fixed!)
  integer, save :: particle_types_ppwwjj_uxuxddwxwxg_1(7) = &
                     [ 1, 1, 2, 2, 3, 3, 4 ]
  ! Colour and helicity average factors per particle
  integer, save :: average_factors_ppwwjj_uxuxddwxwxg_1(7) = &
                     [ 6, 6, 6, 6, 3, 3, 16 ]
  ! Average factor; initialised to the identity permutation
  integer, save :: average_factor_ppwwjj_uxuxddwxwxg_1 = &
                     144
  integer, save :: channel_number_ppwwjj_uxuxddwxwxg_1 = -1
  ...
  subroutine n_external(n) &
      & bind(c,name="ol_f_n_external_ppwwjj_uxuxddwxwxg_1")
  ...
  subroutine n_external_c(n) &
      & bind(c,name="ol_n_external_ppwwjj_uxuxddwxwxg_1")
  ...
  subroutine set_permutation(perm) &
      & bind(c,name="ol_f_set_permutation_ppwwjj_uxuxddwxwxg_1")
    use ol_parameters_decl_/**/DREALKIND, only: out_symmetry_on
    use ol_generic, only: factorial
    implicit none
    integer, intent(in) :: perm(7)
    integer :: i, j, ii, jj
    integer :: particle_types_perm_ppwwjj_uxuxddwxwxg_1(7)
    external_perm_ppwwjj_uxuxddwxwxg_1 = perm
    do i = 1, 7
      external_perm_inv_ppwwjj_uxuxddwxwxg_1( &
        external_perm_ppwwjj_uxuxddwxwxg_1(i)) = i
      particle_types_perm_ppwwjj_uxuxddwxwxg_1(i) = &
        particle_types_ppwwjj_uxuxddwxwxg_1( &
        external_perm_ppwwjj_uxuxddwxwxg_1(i))
    end do
    do i = 1, 7
      do j = 1, i
        if (external_perm_ppwwjj_uxuxddwxwxg_1(i) >= &
          external_perm_ppwwjj_uxuxddwxwxg_1(j)) then
          ii = external_perm_ppwwjj_uxuxddwxwxg_1(i)
          jj = external_perm_ppwwjj_uxuxddwxwxg_1(j)
        else
          ii = external_perm_ppwwjj_uxuxddwxwxg_1(j)
          jj = external_perm_ppwwjj_uxuxddwxwxg_1(i)
        end if
        extcomb_perm_ppwwjj_uxuxddwxwxg_1((i*(i-1))/2 + j) = (ii*(ii-1))/2 + jj
      end do
    end do
    ! Colour and helicity average factor
    average_factor_ppwwjj_uxuxddwxwxg_1 = &
      average_factors_ppwwjj_uxuxddwxwxg_1( &
      external_perm_ppwwjj_uxuxddwxwxg_1(1)) &
      * average_factors_ppwwjj_uxuxddwxwxg_1( &
      external_perm_ppwwjj_uxuxddwxwxg_1(2))
    ! Symmetry factor for outgoing particles
    if (out_symmetry_on /= 0) then
      do i = 1, 7
        average_factor_ppwwjj_uxuxddwxwxg_1 = &
          average_factor_ppwwjj_uxuxddwxwxg_1 &
          * factorial(count(particle_types_perm_ppwwjj_uxuxddwxwxg_1(3:7) == i))
      end do
    end if
  ...
  subroutine set_permutation_c(perm) &
      & bind(c,name="ol_set_permutation_ppwwjj_uxuxddwxwxg_1")
    use, intrinsic :: iso_c_binding, only: c_int
    implicit none
  ...
  subroutine get_masses(m_ex) &
      & bind(c,name="ol_f_get_masses_ppwwjj_uxuxddwxwxg_1")
    ...
    do i = 1, 7
      m_ex(i) = m_ex_orig(external_perm_ppwwjj_uxuxddwxwxg_1(i))
    end do
  end subroutine get_masses


  subroutine get_masses_c(m_ex) &
      & bind(c,name="ol_get_masses_ppwwjj_uxuxddwxwxg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo(sqrt_s, p_rambo) &
      & bind(c,name="ol_f_rambo_ppwwjj_uxuxddwxwxg_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo_c(sqrt_s, p_rambo) &
      & bind(c,name="ol_rambo_ppwwjj_uxuxddwxwxg_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
...
end module ol_external_ppwwjj_uxuxddwxwxg_1


module colour_basis_ppwwjj_uxuxddwxwxg_1
  implicit none
  ! tree colour basis
  ...
  pure subroutine tree_colbasis_dim(extcols, ncolb, ncoupl, maxpows, nhel) &
    & bind(c, name="ol_tree_colbasis_dim_ppwwjj_uxuxddwxwxg_1")
    implicit none
  ...
  subroutine tree_colbasis(basis, powers) &
    & bind(c, name="ol_tree_colbasis_ppwwjj_uxuxddwxwxg_1")
    implicit none
...
end module colour_basis_ppwwjj_uxuxddwxwxg_1


! Only for compatibility with the Sherpa interface

subroutine set_permutation_ppwwjj_uxuxddwxwxg_1(perm)
  use ol_external_ppwwjj_uxuxddwxwxg_1, only: set_permutation
  implicit none
  integer, intent(in) :: perm(7)
  call set_permutation(perm)
end subroutine set_permutation_ppwwjj_uxuxddwxwxg_1

! **********************************************************************
module ol_heltables_ppwwjj_uxuxddwxwxg_1
! **********************************************************************
...
! **********************************************************************
  ...
  n2(4) = 4
  call heltable([2,6,12], n3(:,9), t3x12(:,:,3))
  call heltable([4,6,24], n3(:,10), t3x24(:,:,3))
  call heltable([2,6,12], n3(:,11), t3x12(:,:,4))
  call heltable([4,6,24], n3(:,12), t3x24(:,:,4))
  call heltable([12,2,24], n3(:,13), t3x24(:,:,5))
  call heltable([6,2,12], n3(:,14), t3x12(:,:,5))
  n2(5) = 12
  call heltable([12,2,24], n3(:,15), t3x24(:,:,6))
  call heltable([12,2,24], n3(:,16), t3x24(:,:,7))
  call heltable([12,2,24], n3(:,17), t3x24(:,:,8))
  call heltable([6,2,12], n3(:,18), t3x12(:,:,6))
  n2(6) = 12
  call heltable([12,2,24], n3(:,19), t3x24(:,:,9))
  call heltable([12,2,24], n3(:,20), t3x24(:,:,10))
  call heltable([2,2,4], n3(:,21), t3x4(:,:,3))
  call heltable([3,2,6], n3(:,22), t3x6(:,:,3))
  n2(7) = 4
  n2(8) = 6
  call heltable([6,4,24], n3(:,23), t3x24(:,:,11))
  call heltable([6,2,12], n3(:,24), t3x12(:,:,7))
  call heltable([12,2,24], n3(:,25), t3x24(:,:,12))
  call heltable([2,6,12], n3(:,26), t3x12(:,:,8))
  n2(9) = 12
  call heltable([2,12,24], n3(:,27), t3x24(:,:,13))
  call heltable([12,2,24], n3(:,28), t3x24(:,:,14))
  call heltable([3,2,6], n3(:,29), t3x6(:,:,4))
  n2(10) = 6
  call heltable([6,4,24], n3(:,30), t3x24(:,:,15))
  call heltable([6,2,12], n3(:,31), t3x12(:,:,9))
  call heltable([2,6,12], n3(:,32), t3x12(:,:,10))
  n2(11) = 12
  call heltable([2,12,24], n3(:,33), t3x24(:,:,16))
  call heltable([12,2,24], n3(:,34), t3x24(:,:,17))
  call heltable([12,2,24], n3(:,35), t3x24(:,:,18))
  call heltable([4,3,12], n3(:,36), t3x12(:,:,11))
  n2(12) = 12
  call heltable([3,4,12], n3(:,37), t3x12(:,:,12))
  n2(13) = 12
  call heltable([3,4,12], n3(:,38), t3x12(:,:,13))
  n2(14) = 12
  call heltable([2,3,6], n3(:,39), t3x6(:,:,5))
  call heltable([2,3,6], n3(:,40), t3x6(:,:,6))
  n2(15) = 6
  n2(16) = 6
  call heltable([2,6,12], n3(:,41), t3x12(:,:,14))
  call heltable([4,6,24], n3(:,42), t3x24(:,:,19))
  call heltable([2,6,12], n3(:,43), t3x12(:,:,15))
  call heltable([4,6,24], n3(:,44), t3x24(:,:,20))
  call heltable([2,6,12], n3(:,45), t3x12(:,:,16))
  call heltable([4,6,24], n3(:,46), t3x24(:,:,21))
  call heltable([2,6,12], n3(:,47), t3x12(:,:,17))
  call heltable([4,6,24], n3(:,48), t3x24(:,:,22))
  call heltable([12,2,24], n3(:,49), t3x24(:,:,23))
  call heltable([6,2,12], n3(:,50), t3x12(:,:,18))
  n2(17) = 12
  call heltable([12,2,24], n3(:,51), t3x24(:,:,24))
  call heltable([12,2,24], n3(:,52), t3x24(:,:,25))
  call heltable([12,2,24], n3(:,53), t3x24(:,:,26))
  call heltable([6,2,12], n3(:,54), t3x12(:,:,19))
  n2(18) = 12
  call heltable([12,2,24], n3(:,55), t3x24(:,:,27))
  call heltable([12,2,24], n3(:,56), t3x24(:,:,28))
  call heltable([2,2,4], n3(:,57), t3x4(:,:,4))
  n2(19) = 4
  call heltable([6,4,24], n3(:,58), t3x24(:,:,29))
  call heltable([6,2,12], n3(:,59), t3x12(:,:,20))
  call heltable([12,2,24], n3(:,60), t3x24(:,:,30))
  call heltable([12,2,24], n3(:,61), t3x24(:,:,31))
  call heltable([2,12,24], n3(:,62), t3x24(:,:,32))
  call heltable([6,4,24], n3(:,63), t3x24(:,:,33))
  call heltable([6,2,12], n3(:,64), t3x12(:,:,21))
  call heltable([12,2,24], n3(:,65), t3x24(:,:,34))
  call heltable([2,12,24], n3(:,66), t3x24(:,:,35))
  call heltable([12,2,24], n3(:,67), t3x24(:,:,36))
  call heltable([4,3,12], n3(:,68), t3x12(:,:,22))
  n2(20) = 12
  call heltable([3,2,6], n3(:,69), t3x6(:,:,7))
  n2(21) = 6
  call heltable([6,4,24], n3(:,70), t3x24(:,:,37))
  call heltable([6,2,12], n3(:,71), t3x12(:,:,23))
  call heltable([12,2,24], n3(:,72), t3x24(:,:,38))
  call heltable([2,6,12], n3(:,73), t3x12(:,:,24))
  n2(22) = 12
  call heltable([2,12,24], n3(:,74), t3x24(:,:,39))
  call heltable([12,2,24], n3(:,75), t3x24(:,:,40))
  call heltable([6,4,24], n3(:,76), t3x24(:,:,41))
  call heltable([6,2,12], n3(:,77), t3x12(:,:,25))
  call heltable([12,2,24], n3(:,78), t3x24(:,:,42))
  call heltable([12,2,24], n3(:,79), t3x24(:,:,43))
  call heltable([2,12,24], n3(:,80), t3x24(:,:,44))
  call heltable([2,12,24], n3(:,81), t3x24(:,:,45))
  call heltable([2,12,24], n3(:,82), t3x24(:,:,46))
  call heltable([2,12,24], n3(:,83), t3x24(:,:,47))
  call heltable([2,12,24], n3(:,84), t3x24(:,:,48))
  call heltable([3,2,6], n3(:,85), t3x6(:,:,8))
  n2(23) = 6
  call heltable([6,4,24], n3(:,86), t3x24(:,:,49))
  call heltable([6,2,12], n3(:,87), t3x12(:,:,26))
  call heltable([2,6,12], n3(:,88), t3x12(:,:,27))
  n2(24) = 12
  call heltable([2,12,24], n3(:,89), t3x24(:,:,50))
  call heltable([12,2,24], n3(:,90), t3x24(:,:,51))
  call heltable([12,2,24], n3(:,91), t3x24(:,:,52))
  call heltable([6,4,24], n3(:,92), t3x24(:,:,53))
  call heltable([6,2,12], n3(:,93), t3x12(:,:,28))
  call heltable([12,2,24], n3(:,94), t3x24(:,:,54))
  call heltable([2,12,24], n3(:,95), t3x24(:,:,55))
  call heltable([12,2,24], n3(:,96), t3x24(:,:,56))
  call heltable([2,12,24], n3(:,97), t3x24(:,:,57))
  call heltable([2,12,24], n3(:,98), t3x24(:,:,58))
  call heltable([2,12,24], n3(:,99), t3x24(:,:,59))
  call heltable([2,12,24], n3(:,100), t3x24(:,:,60))
  call heltable([4,3,12], n3(:,101), t3x12(:,:,29))
  n2(25) = 12
  call heltable([3,4,12], n3(:,102), t3x12(:,:,30))
  n2(26) = 12
  call heltable([3,4,12], n3(:,103), t3x12(:,:,31))
  n2(27) = 12
  call heltable([4,3,12], n3(:,104), t3x12(:,:,32))
  n2(28) = 12
...
end module ol_heltables_ppwwjj_uxuxddwxwxg_1
