...
! **********************************************************************
module ol_tensor_sum_storage_ppwwjj_ucxdxswwx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwwjj_ucxdxswwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwwjj_ucxdxswwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppwwjj_ucxdxswwx_1, only: channel_number_ppwwjj_ucxdxswwx_1
  ...
  call channel_on(channel_number_ppwwjj_ucxdxswwx_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,34)
  momenta_2(:,1) = Q(1:4,40)
  momenta_3(:,1) = Q(1:4,42)
  momenta_4(:,1) = Q(1:4,43)
  momenta_5(:,1) = Q(1:4,46)
  momenta_6(:,1) = Q(1:4,17)
  momenta_6(:,2) = Q(1:4,59)
  momenta_7(:,1) = Q(1:4,20)
  momenta_7(:,2) = Q(1:4,62)
  momenta_8(:,1) = Q(1:4,21)
  momenta_8(:,2) = Q(1:4,55)
  momenta_9(:,1) = Q(1:4,21)
  momenta_9(:,2) = Q(1:4,61)
  momenta_10(:,1) = Q(1:4,23)
  momenta_10(:,2) = Q(1:4,55)
  momenta_11(:,1) = Q(1:4,29)
  momenta_11(:,2) = Q(1:4,61)
  momenta_12(:,1) = Q(1:4,34)
  momenta_12(:,2) = Q(1:4,55)
  momenta_13(:,1) = Q(1:4,40)
  momenta_13(:,2) = Q(1:4,61)
  momenta_14(:,1) = Q(1:4,42)
  momenta_14(:,2) = Q(1:4,59)
  momenta_15(:,1) = Q(1:4,42)
  momenta_15(:,2) = Q(1:4,62)
  momenta_16(:,1) = Q(1:4,43)
  momenta_16(:,2) = Q(1:4,59)
  momenta_17(:,1) = Q(1:4,46)
  ...
  momenta_24(:,2) = Q(1:4,42)
  momenta_24(:,3) = Q(1:4,59)
  momenta_25(:,1) = Q(1:4,8)
  momenta_25(:,2) = Q(1:4,42)
  momenta_25(:,3) = Q(1:4,62)
  momenta_26(:,1) = Q(1:4,17)
  momenta_26(:,2) = Q(1:4,21)
  momenta_26(:,3) = Q(1:4,61)
  momenta_27(:,1) = Q(1:4,21)
  momenta_27(:,2) = Q(1:4,29)
  momenta_27(:,3) = Q(1:4,61)
  momenta_28(:,1) = Q(1:4,34)
  momenta_28(:,2) = Q(1:4,42)
  momenta_28(:,3) = Q(1:4,59)
  momenta_29(:,1) = Q(1:4,34)
  momenta_29(:,2) = Q(1:4,42)
  momenta_29(:,3) = Q(1:4,62)
  momenta_30(:,1) = Q(1:4,40)
  momenta_30(:,2) = Q(1:4,42)
  momenta_30(:,3) = Q(1:4,62)
  momenta_31(:,1) = Q(1:4,42)
  momenta_31(:,2) = Q(1:4,46)
  momenta_31(:,3) = Q(1:4,62)
  momenta_32(:,1) = Q(1:4,2)
  momenta_32(:,2) = Q(1:4,34)
  momenta_32(:,3) = Q(1:4,42)
  momenta_32(:,4) = Q(1:4,62)
  momenta_33(:,1) = Q(1:4,2)
  momenta_33(:,2) = Q(1:4,42)
  momenta_33(:,3) = Q(1:4,46)
  ...
  momenta_35(:,3) = Q(1:4,42)
  momenta_35(:,4) = Q(1:4,62)
  momenta_36(:,1) = Q(1:4,8)
  momenta_36(:,2) = Q(1:4,42)
  momenta_36(:,3) = Q(1:4,46)
  ...
  momenta_38(:,3) = Q(1:4,46)
  momenta_38(:,4) = Q(1:4,62)
  momenta_39(:,1) = Q(1:4,40)
  momenta_39(:,2) = Q(1:4,42)
  momenta_39(:,3) = Q(1:4,46)
  momenta_39(:,4) = Q(1:4,62)
  momenta_40(:,1) = Q(1:4,2)
  momenta_40(:,2) = Q(1:4,34)
  momenta_40(:,3) = Q(1:4,42)
  momenta_40(:,4) = Q(1:4,46)
  momenta_40(:,5) = Q(1:4,62)
  momenta_41(:,1) = Q(1:4,8)
  momenta_41(:,2) = Q(1:4,40)
  momenta_41(:,3) = Q(1:4,42)
  momenta_41(:,4) = Q(1:4,46)
  ...
  call TI_call(2, momenta_24, masses2_5, T2sum(:,5), M2)
  call TI_call(2, momenta_28, masses2_5, T2sum(:,6), M2)
  call TI_call(2, momenta_13, masses2_4, T2sum(:,7), M2)
  call TI_call(2, momenta_9, masses2_4, T2sum(:,8), M2)
  call TI_call(2, momenta_20, masses2_5, T2sum(:,9), M2)
  call TI_call(2, momenta_26, masses2_5, T2sum(:,10), M2)
  ...
  call TI_call(2, momenta_25, masses2_5, T2sum(:,15), M2)
  call TI_call(2, momenta_29, masses2_5, T2sum(:,16), M2)
  call TI_call(2, momenta_18, masses2_5, T2sum(:,17), M2)
  call TI_call(2, momenta_30, masses2_5, T2sum(:,18), M2)
  ...
  call TI_call(3, momenta_22, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_23, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_27, masses2_5, T3sum(:,3), M2)
  call TI_call(3, momenta_34, masses2_6, T3sum(:,4), M2)
  call TI_call(3, momenta_37, masses2_6, T3sum(:,5), M2)
  call TI_call(3, momenta_32, masses2_6, T3sum(:,6), M2)
  call TI_call(3, momenta_35, masses2_6, T3sum(:,7), M2)
  call TI_call(3, momenta_21, masses2_5, T3sum(:,8), M2)
  call TI_call(3, momenta_19, masses2_5, T3sum(:,9), M2)
  call TI_call(3, momenta_31, masses2_5, T3sum(:,10), M2)
  call TI_call(3, momenta_36, masses2_6, T3sum(:,11), M2)
  call TI_call(3, momenta_38, masses2_6, T3sum(:,12), M2)
  call TI_call(3, momenta_33, masses2_6, T3sum(:,13), M2)
  call TI_call(3, momenta_39, masses2_6, T3sum(:,14), M2)
  ...
  call channel_off(channel_number_ppwwjj_ucxdxswwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwwjj_ucxdxswwx_1_/**/REALKIND
