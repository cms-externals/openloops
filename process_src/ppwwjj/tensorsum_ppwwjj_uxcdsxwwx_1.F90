...
! **********************************************************************
module ol_tensor_sum_storage_ppwwjj_uxcdsxwwx_1_/**/REALKIND
! **********************************************************************
  ...
  complex(REALKIND), save :: masses2_7(6)

  complex(REALKIND), save :: T1sum(5,4) = 0
  complex(REALKIND), save :: T2sum(15,23) = 0
  complex(REALKIND), save :: T3sum(35,14) = 0
  complex(REALKIND), save :: T4sum(70,2) = 0

  contains

#ifdef PRECISION_dp
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwwjj_uxcdsxwwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwwjj_uxcdsxwwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppwwjj_uxcdsxwwx_1, only: channel_number_ppwwjj_uxcdsxwwx_1
  ...
  call channel_on(channel_number_ppwwjj_uxcdsxwwx_1)
  M2 = 0
  ...
  momenta_5(:,1) = Q(1:4,45)
  momenta_6(:,1) = Q(1:4,18)
  ...
  momenta_10(:,1) = Q(1:4,27)
  momenta_10(:,2) = Q(1:4,59)
  momenta_11(:,1) = Q(1:4,30)
  momenta_11(:,2) = Q(1:4,62)
  momenta_12(:,1) = Q(1:4,33)
  momenta_12(:,2) = Q(1:4,59)
  momenta_13(:,1) = Q(1:4,36)
  momenta_13(:,2) = Q(1:4,62)
  momenta_14(:,1) = Q(1:4,37)
  momenta_14(:,2) = Q(1:4,55)
  momenta_15(:,1) = Q(1:4,37)
  momenta_15(:,2) = Q(1:4,61)
  momenta_16(:,1) = Q(1:4,39)
  momenta_16(:,2) = Q(1:4,55)
  momenta_17(:,1) = Q(1:4,45)
  ...
  momenta_24(:,2) = Q(1:4,26)
  momenta_24(:,3) = Q(1:4,62)
  momenta_25(:,1) = Q(1:4,8)
  momenta_25(:,2) = Q(1:4,45)
  momenta_25(:,3) = Q(1:4,61)
  momenta_26(:,1) = Q(1:4,18)
  momenta_26(:,2) = Q(1:4,26)
  momenta_26(:,3) = Q(1:4,59)
  momenta_27(:,1) = Q(1:4,18)
  momenta_27(:,2) = Q(1:4,26)
  momenta_27(:,3) = Q(1:4,62)
  momenta_28(:,1) = Q(1:4,24)
  momenta_28(:,2) = Q(1:4,26)
  momenta_28(:,3) = Q(1:4,62)
  momenta_29(:,1) = Q(1:4,26)
  momenta_29(:,2) = Q(1:4,30)
  momenta_29(:,3) = Q(1:4,62)
  momenta_30(:,1) = Q(1:4,33)
  momenta_30(:,2) = Q(1:4,37)
  momenta_30(:,3) = Q(1:4,61)
  momenta_31(:,1) = Q(1:4,37)
  momenta_31(:,2) = Q(1:4,45)
  momenta_31(:,3) = Q(1:4,61)
  momenta_32(:,1) = Q(1:4,2)
  momenta_32(:,2) = Q(1:4,18)
  momenta_32(:,3) = Q(1:4,26)
  ...
  masses2_7 = [ ZERO2, ZERO2, ZERO2, ZERO2, ZERO2, ZERO2 ]
  ...
  call TI_call(1, momenta_4, masses2_3, T1sum(:,4), M2)

  call TI_call(2, momenta_6, masses2_4, T2sum(:,1), M2)
  call TI_call(2, momenta_14, masses2_4, T2sum(:,2), M2)
  call TI_call(2, momenta_12, masses2_4, T2sum(:,3), M2)
  call TI_call(2, momenta_8, masses2_4, T2sum(:,4), M2)
  call TI_call(2, momenta_23, masses2_5, T2sum(:,5), M2)
  call TI_call(2, momenta_26, masses2_5, T2sum(:,6), M2)
  call TI_call(2, momenta_13, masses2_4, T2sum(:,7), M2)
  call TI_call(2, momenta_9, masses2_4, T2sum(:,8), M2)
  call TI_call(2, momenta_24, masses2_5, T2sum(:,9), M2)
  call TI_call(2, momenta_27, masses2_5, T2sum(:,10), M2)
  call TI_call(2, momenta_10, masses2_4, T2sum(:,11), M2)
  call TI_call(2, momenta_11, masses2_4, T2sum(:,12), M2)
  ...
  call TI_call(2, momenta_30, masses2_5, T2sum(:,16), M2)
  call TI_call(2, momenta_18, masses2_5, T2sum(:,17), M2)
  call TI_call(2, momenta_28, masses2_5, T2sum(:,18), M2)
  call TI_call(2, momenta_16, masses2_4, T2sum(:,19), M2)
  call TI_call(2, momenta_17, masses2_4, T2sum(:,20), M2)
  call TI_call(2, momenta_3, masses2_3, T2sum(:,21), M2)
  call TI_call(2, momenta_3, masses2_2, T2sum(:,22), M2)
  call TI_call(2, momenta_3, masses2_1, T2sum(:,23), M2)

  call TI_call(3, momenta_19, masses2_5, T3sum(:,1), M2)
  call TI_call(3, momenta_20, masses2_5, T3sum(:,2), M2)
  call TI_call(3, momenta_29, masses2_5, T3sum(:,3), M2)
  call TI_call(3, momenta_36, masses2_6, T3sum(:,4), M2)
  call TI_call(3, momenta_37, masses2_6, T3sum(:,5), M2)
  call TI_call(3, momenta_33, masses2_6, T3sum(:,6), M2)
  call TI_call(3, momenta_38, masses2_6, T3sum(:,7), M2)
  call TI_call(3, momenta_25, masses2_5, T3sum(:,8), M2)
  call TI_call(3, momenta_22, masses2_5, T3sum(:,9), M2)
  call TI_call(3, momenta_31, masses2_5, T3sum(:,10), M2)
  call TI_call(3, momenta_34, masses2_6, T3sum(:,11), M2)
  call TI_call(3, momenta_39, masses2_6, T3sum(:,12), M2)
  call TI_call(3, momenta_32, masses2_6, T3sum(:,13), M2)
  call TI_call(3, momenta_35, masses2_6, T3sum(:,14), M2)

  call TI_call(4, momenta_40, masses2_7, T4sum(:,1), M2)
  call TI_call(4, momenta_41, masses2_7, T4sum(:,2), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppwwjj_uxcdsxwwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwwjj_uxcdsxwwx_1_/**/REALKIND
