...
module ol_colourmatrix_ppwwjj_uudxdxww_1_/**/REALKIND
...
end module ol_colourmatrix_ppwwjj_uudxdxww_1_/**/REALKIND



module ol_forced_parameters_ppwwjj_uudxdxww_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwwjj_uudxdxww_1_/**/REALKIND

module ol_loop_ppwwjj_uudxdxww_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_QA_V(wf(:,4),wf(:,-2),wf(:,7))
  call vert_QA_V(wf(:,3),wf(:,-3),wf(:,8))
  call vert_AW_Q(wf(:,-2),wf(:,-5),wf(:,9))
  call prop_A_Q(wf(:,9),Q(:,36),ZERO,0_intkind1,wf(:,10))
  call vert_QA_V(wf(:,-1),wf(:,10),wf(:,11))
  call vert_AW_Q(wf(:,-3),wf(:,-5),wf(:,12))
  call prop_A_Q(wf(:,12),Q(:,40),ZERO,0_intkind1,wf(:,13))
  call vert_QA_V(wf(:,-1),wf(:,13),wf(:,14))
  call vert_WQ_A(wf(:,-5),wf(:,0),wf(:,15))
  call vert_WQ_A(wf(:,-4),wf(:,-1),wf(:,16))
  call prop_Q_A(wf(:,15),Q(:,33),ZERO,0_intkind1,wf(:,17))
  call prop_Q_A(wf(:,16),Q(:,18),ZERO,0_intkind1,wf(:,18))
  call vert_QA_V(wf(:,17),wf(:,-2),wf(:,19))
  call vert_QA_V(wf(:,18),wf(:,-3),wf(:,20))
  call vert_QA_V(wf(:,18),wf(:,-2),wf(:,21))
  call vert_QA_V(wf(:,17),wf(:,-3),wf(:,22))
  call vert_QA_V(wf(:,0),wf(:,10),wf(:,23))
  call vert_QA_V(wf(:,0),wf(:,13),wf(:,24))
  call vert_AW_Q(wf(:,-2),wf(:,-4),wf(:,25))
  call prop_A_Q(wf(:,25),Q(:,20),ZERO,0_intkind1,wf(:,26))
  call vert_QA_V(wf(:,-1),wf(:,26),wf(:,27))
  call vert_QA_V(wf(:,0),wf(:,26),wf(:,28))
  call vert_AW_Q(wf(:,-3),wf(:,-4),wf(:,29))
  call prop_A_Q(wf(:,29),Q(:,24),ZERO,0_intkind1,wf(:,30))
  call vert_QA_V(wf(:,-1),wf(:,30),wf(:,31))
  call vert_QA_V(wf(:,0),wf(:,30),wf(:,32))
  call counter_QA_V(wf(:,4),wf(:,-3),wf(:,33))
  call counter_QA_V(wf(:,3),wf(:,-3),wf(:,34))
  call counter_AW_Q(wf(:,-3),wf(:,-5),wf(:,35))
  call prop_A_Q(wf(:,35),Q(:,40),ZERO,0_intkind1,wf(:,36))
  call vert_QA_V(wf(:,-1),wf(:,36),wf(:,37))
  call counter_QA_V(wf(:,18),wf(:,-3),wf(:,38))
  call counter_QA_V(wf(:,17),wf(:,-3),wf(:,39))
  call vert_QA_V(wf(:,0),wf(:,36),wf(:,40))
  call counter_AW_Q(wf(:,-3),wf(:,-4),wf(:,41))
  call prop_A_Q(wf(:,41),Q(:,24),ZERO,0_intkind1,wf(:,42))
  call vert_QA_V(wf(:,-1),wf(:,42),wf(:,43))
  call vert_QA_V(wf(:,0),wf(:,42),wf(:,44))
  call counter_QA_V(wf(:,4),wf(:,-2),wf(:,45))
  call counter_QA_V(wf(:,3),wf(:,-2),wf(:,46))
  call counter_AW_Q(wf(:,-2),wf(:,-5),wf(:,47))
  call prop_A_Q(wf(:,47),Q(:,36),ZERO,0_intkind1,wf(:,48))
  call vert_QA_V(wf(:,-1),wf(:,48),wf(:,49))
  call counter_QA_V(wf(:,18),wf(:,-2),wf(:,50))
  call counter_QA_V(wf(:,17),wf(:,-2),wf(:,51))
  call vert_QA_V(wf(:,0),wf(:,48),wf(:,52))
  call counter_AW_Q(wf(:,-2),wf(:,-4),wf(:,53))
  call prop_A_Q(wf(:,53),Q(:,20),ZERO,0_intkind1,wf(:,54))
  call vert_QA_V(wf(:,-1),wf(:,54),wf(:,55))
  call vert_QA_V(wf(:,0),wf(:,54),wf(:,56))
  call counter_QA_V(wf(:,-1),wf(:,10),wf(:,57))
  call counter_QA_V(wf(:,-1),wf(:,13),wf(:,58))
  call counter_WQ_A(wf(:,-5),wf(:,-1),wf(:,59))
  call prop_Q_A(wf(:,59),Q(:,34),ZERO,0_intkind1,wf(:,60))
  call vert_QA_V(wf(:,60),wf(:,-3),wf(:,61))
  call vert_QA_V(wf(:,60),wf(:,-2),wf(:,62))
  call counter_QA_V(wf(:,-1),wf(:,26),wf(:,63))
  call counter_QA_V(wf(:,-1),wf(:,30),wf(:,64))
  call counter_WQ_A(wf(:,-4),wf(:,-1),wf(:,65))
  call prop_Q_A(wf(:,65),Q(:,18),ZERO,0_intkind1,wf(:,66))
  call vert_QA_V(wf(:,66),wf(:,-3),wf(:,67))
  call vert_QA_V(wf(:,66),wf(:,-2),wf(:,68))
  call counter_QA_V(wf(:,0),wf(:,10),wf(:,69))
  call counter_QA_V(wf(:,0),wf(:,13),wf(:,70))
  call counter_WQ_A(wf(:,-5),wf(:,0),wf(:,71))
  call prop_Q_A(wf(:,71),Q(:,33),ZERO,0_intkind1,wf(:,72))
  call vert_QA_V(wf(:,72),wf(:,-2),wf(:,73))
  call vert_QA_V(wf(:,72),wf(:,-3),wf(:,74))
  call counter_QA_V(wf(:,0),wf(:,26),wf(:,75))
  call counter_QA_V(wf(:,0),wf(:,30),wf(:,76))
  call counter_WQ_A(wf(:,-4),wf(:,0),wf(:,77))
  call prop_Q_A(wf(:,77),Q(:,17),ZERO,0_intkind1,wf(:,78))
  call vert_QA_V(wf(:,78),wf(:,-2),wf(:,79))
  call vert_QA_V(wf(:,78),wf(:,-3),wf(:,80))
  call counter_Q_A(ctqq,wf(:,3),Q(:,17),wf(:,81))
  call prop_Q_A(wf(:,81),Q(:,17),ZERO,0_intkind1,wf(:,82))
  call vert_QA_V(wf(:,82),wf(:,-2),wf(:,83))
  call vert_QA_V(wf(:,82),wf(:,-3),wf(:,84))
  call counter_Q_A(ctqq,wf(:,4),Q(:,34),wf(:,85))
  call prop_Q_A(wf(:,85),Q(:,34),ZERO,0_intkind1,wf(:,86))
  call vert_QA_V(wf(:,86),wf(:,-2),wf(:,87))
  call vert_QA_V(wf(:,86),wf(:,-3),wf(:,88))
  call counter_V_V(ctGG,wf(:,5),Q(:,21),wf(:,89))
  call counter_V_V(ctGG,wf(:,7),Q(:,38),wf(:,90))
  call counter_A_Q(ctqq,wf(:,10),Q(:,36),wf(:,91))
  call prop_A_Q(wf(:,91),Q(:,36),ZERO,0_intkind1,wf(:,92))
  call vert_QA_V(wf(:,-1),wf(:,92),wf(:,93))
  call counter_V_V(ctGG,wf(:,11),Q(:,38),wf(:,94))
  call counter_V_V(ctGG,wf(:,14),Q(:,42),wf(:,95))
  call counter_A_Q(ctqq,wf(:,13),Q(:,40),wf(:,96))
  call prop_A_Q(wf(:,96),Q(:,40),ZERO,0_intkind1,wf(:,97))
  call vert_QA_V(wf(:,-1),wf(:,97),wf(:,98))
  call counter_Q_A(ctqq,wf(:,17),Q(:,33),wf(:,99))
  call prop_Q_A(wf(:,99),Q(:,33),ZERO,0_intkind1,wf(:,100))
  call vert_QA_V(wf(:,100),wf(:,-2),wf(:,101))
  call vert_QA_V(wf(:,100),wf(:,-3),wf(:,102))
  call counter_Q_A(ctqq,wf(:,18),Q(:,18),wf(:,103))
  call prop_Q_A(wf(:,103),Q(:,18),ZERO,0_intkind1,wf(:,104))
  call vert_QA_V(wf(:,104),wf(:,-2),wf(:,105))
  call vert_QA_V(wf(:,104),wf(:,-3),wf(:,106))
  call counter_V_V(ctGG,wf(:,19),Q(:,37),wf(:,107))
  call counter_V_V(ctGG,wf(:,21),Q(:,22),wf(:,108))
  call vert_QA_V(wf(:,0),wf(:,92),wf(:,109))
  call counter_V_V(ctGG,wf(:,23),Q(:,37),wf(:,110))
  call counter_V_V(ctGG,wf(:,24),Q(:,41),wf(:,111))
  call vert_QA_V(wf(:,0),wf(:,97),wf(:,112))
  call counter_A_Q(ctqq,wf(:,26),Q(:,20),wf(:,113))
  call prop_A_Q(wf(:,113),Q(:,20),ZERO,0_intkind1,wf(:,114))
  call vert_QA_V(wf(:,-1),wf(:,114),wf(:,115))
  call counter_V_V(ctGG,wf(:,27),Q(:,22),wf(:,116))
  call vert_QA_V(wf(:,0),wf(:,114),wf(:,117))
  call counter_V_V(ctGG,wf(:,28),Q(:,21),wf(:,118))
  call counter_V_V(ctGG,wf(:,31),Q(:,26),wf(:,119))
  call counter_A_Q(ctqq,wf(:,30),Q(:,24),wf(:,120))
  call prop_A_Q(wf(:,120),Q(:,24),ZERO,0_intkind1,wf(:,121))
  call vert_QA_V(wf(:,-1),wf(:,121),wf(:,122))
  call counter_V_V(ctGG,wf(:,32),Q(:,25),wf(:,123))
  call vert_QA_V(wf(:,0),wf(:,121),wf(:,124))
  call vert_VQ_A(wf(:,5),wf(:,-1),wf(:,125))
  call prop_Q_A(wf(:,125),Q(:,23),ZERO,0_intkind1,wf(:,126))
  call vert_AV_Q(wf(:,-3),wf(:,5),wf(:,127))
  call prop_A_Q(wf(:,127),Q(:,29),ZERO,0_intkind1,wf(:,128))
  call vert_VQ_A(wf(:,8),wf(:,-1),wf(:,129))
  call prop_Q_A(wf(:,129),Q(:,27),ZERO,0_intkind1,wf(:,130))
  call vert_AV_Q(wf(:,-2),wf(:,8),wf(:,131))
  call prop_A_Q(wf(:,131),Q(:,29),ZERO,0_intkind1,wf(:,132))
  call vert_VQ_A(wf(:,21),wf(:,0),wf(:,133))
  call prop_Q_A(wf(:,133),Q(:,23),ZERO,0_intkind1,wf(:,134))
  call vert_VQ_A(wf(:,20),wf(:,0),wf(:,135))
  call prop_Q_A(wf(:,135),Q(:,27),ZERO,0_intkind1,wf(:,136))
  call vert_AV_Q(wf(:,-3),wf(:,21),wf(:,137))
  call prop_A_Q(wf(:,137),Q(:,30),ZERO,0_intkind1,wf(:,138))
  call vert_AV_Q(wf(:,-2),wf(:,20),wf(:,139))
  call prop_A_Q(wf(:,139),Q(:,30),ZERO,0_intkind1,wf(:,140))
  call vert_VQ_A(wf(:,28),wf(:,-1),wf(:,141))
  call prop_Q_A(wf(:,141),Q(:,23),ZERO,0_intkind1,wf(:,142))
  call vert_VQ_A(wf(:,27),wf(:,0),wf(:,143))
  call prop_Q_A(wf(:,143),Q(:,23),ZERO,0_intkind1,wf(:,144))
  call vert_AV_Q(wf(:,-3),wf(:,28),wf(:,145))
  call prop_A_Q(wf(:,145),Q(:,29),ZERO,0_intkind1,wf(:,146))
  call vert_AV_Q(wf(:,-3),wf(:,27),wf(:,147))
  call prop_A_Q(wf(:,147),Q(:,30),ZERO,0_intkind1,wf(:,148))
  call vert_VQ_A(wf(:,32),wf(:,-1),wf(:,149))
  call prop_Q_A(wf(:,149),Q(:,27),ZERO,0_intkind1,wf(:,150))
  call vert_VQ_A(wf(:,31),wf(:,0),wf(:,151))
  call prop_Q_A(wf(:,151),Q(:,27),ZERO,0_intkind1,wf(:,152))
  call vert_AV_Q(wf(:,-2),wf(:,32),wf(:,153))
  call prop_A_Q(wf(:,153),Q(:,29),ZERO,0_intkind1,wf(:,154))
  call vert_AV_Q(wf(:,-2),wf(:,31),wf(:,155))
  call prop_A_Q(wf(:,155),Q(:,30),ZERO,0_intkind1,wf(:,156))
  call vert_VQ_A(wf(:,19),wf(:,-1),wf(:,157))
  call prop_Q_A(wf(:,157),Q(:,39),ZERO,0_intkind1,wf(:,158))
  call vert_AV_Q(wf(:,-3),wf(:,19),wf(:,159))
  call prop_A_Q(wf(:,159),Q(:,45),ZERO,0_intkind1,wf(:,160))
  call vert_VQ_A(wf(:,22),wf(:,-1),wf(:,161))
  call prop_Q_A(wf(:,161),Q(:,43),ZERO,0_intkind1,wf(:,162))
  call vert_AV_Q(wf(:,-2),wf(:,22),wf(:,163))
  call prop_A_Q(wf(:,163),Q(:,45),ZERO,0_intkind1,wf(:,164))
  call vert_VQ_A(wf(:,7),wf(:,0),wf(:,165))
  call prop_Q_A(wf(:,165),Q(:,39),ZERO,0_intkind1,wf(:,166))
  call vert_VQ_A(wf(:,6),wf(:,0),wf(:,167))
  call prop_Q_A(wf(:,167),Q(:,43),ZERO,0_intkind1,wf(:,168))
  call vert_AV_Q(wf(:,-3),wf(:,7),wf(:,169))
  call prop_A_Q(wf(:,169),Q(:,46),ZERO,0_intkind1,wf(:,170))
  call vert_AV_Q(wf(:,-2),wf(:,6),wf(:,171))
  call prop_A_Q(wf(:,171),Q(:,46),ZERO,0_intkind1,wf(:,172))
  call vert_VQ_A(wf(:,23),wf(:,-1),wf(:,173))
  call prop_Q_A(wf(:,173),Q(:,39),ZERO,0_intkind1,wf(:,174))
  call vert_VQ_A(wf(:,11),wf(:,0),wf(:,175))
  call prop_Q_A(wf(:,175),Q(:,39),ZERO,0_intkind1,wf(:,176))
  call vert_AV_Q(wf(:,-3),wf(:,23),wf(:,177))
  call prop_A_Q(wf(:,177),Q(:,45),ZERO,0_intkind1,wf(:,178))
  call vert_AV_Q(wf(:,-3),wf(:,11),wf(:,179))
  call prop_A_Q(wf(:,179),Q(:,46),ZERO,0_intkind1,wf(:,180))
  call vert_VQ_A(wf(:,24),wf(:,-1),wf(:,181))
  call prop_Q_A(wf(:,181),Q(:,43),ZERO,0_intkind1,wf(:,182))
  call vert_VQ_A(wf(:,14),wf(:,0),wf(:,183))
  call prop_Q_A(wf(:,183),Q(:,43),ZERO,0_intkind1,wf(:,184))
  call vert_AV_Q(wf(:,-2),wf(:,24),wf(:,185))
  call prop_A_Q(wf(:,185),Q(:,45),ZERO,0_intkind1,wf(:,186))
  call vert_AV_Q(wf(:,-2),wf(:,14),wf(:,187))
  call prop_A_Q(wf(:,187),Q(:,46),ZERO,0_intkind1,wf(:,188))
...
end module ol_loop_ppwwjj_uudxdxww_1_/**/REALKIND
