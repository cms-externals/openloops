...
module ol_colourmatrix_ppwwjj_ccxddxwwx_1_/**/REALKIND
...
end module ol_colourmatrix_ppwwjj_ccxddxwwx_1_/**/REALKIND



module ol_forced_parameters_ppwwjj_ccxddxwwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwwjj_ccxddxwwx_1_/**/REALKIND

module ol_loop_ppwwjj_ccxddxwwx_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(45), c(68)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = (CI*countertermnorm*ctGcc*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 6) = (2*CI*countertermnorm*ctGcc*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 7) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 8) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 9) = (2*CI*countertermnorm*ctVcc*eQED**2*gQCD**4)/3._/**/REALKIND
    f(10) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/3._/**/REALKIND
    ...
    f(14) = (CI*countertermnorm*ctGcc*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(15) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(16) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(17) = (CI*countertermnorm*ctVsc*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(18) = (CI*cw*eQED**2*gQCD**2)/sw
    f(19) = (CI*countertermnorm*cw*eQED**2*gQCD**4)/sw
    f(20) = (CI*countertermnorm*ctGcc*cw*eQED**2*gQCD**4)/sw
    f(21) = (CI*countertermnorm*ctGqq*cw*eQED**2*gQCD**4)/sw
    f(22) = (CI*countertermnorm*ctVcc*cw*eQED**2*gQCD**4)/sw
    f(23) = (CI*countertermnorm*ctVqq*cw*eQED**2*gQCD**4)/sw
    f(24) = (countertermnorm*ctZGG*cw*eQED**2*gQCD**4)/sw
    f(25) = (CI*countertermnorm*ctHGG*eQED**2*gQCD**4*MW)/sw
    f(26) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(27) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(28) = (eQED**2*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(29) = (eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(30) = (2*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    ...
    f(34) = (CI*cw*eQED**2*gQCD**4*integralnorm*SwB)/sw
    f(35) = (cw*eQED**2*gQCD**4*integralnorm*SwB)/(sw*2._/**/REALKIND)
    f(36) = (cw*eQED**2*gQCD**4*integralnorm*SwB)/sw
    f(37) = (eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(38) = (2*eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(39) = (4*eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(40) = (eQED**2*gQCD**4*integralnorm*SwF)/(sw**2*2._/**/REALKIND)
    f(41) = (eQED**2*gQCD**4*integralnorm*SwF)/sw**2
    f(42) = (eQED**2*gQCD**4*integralnorm*MB*SwF)/(sw**2*2._/**/REALKIND)
    f(43) = (eQED**2*gQCD**4*integralnorm*MT*SwF)/(sw**2*2._/**/REALKIND)
    f(44) = (cw*eQED**2*gQCD**4*integralnorm*SwF)/sw
    f(45) = (2*cw*eQED**2*gQCD**4*integralnorm*SwF)/sw

  c = [ 9*CI*f(26), 27*CI*f(26), 9*CI*f(27), 27*CI*f(27), 18*f(28), 54*f(28), f(29), 3*f(29), 6*f(29), 8*f(29), 10*f(29), 18*f(29) &
    , 21*f(29), 24*f(29), 54*f(29), f(30), 3*f(30), 6*f(30), 8*f(30), 10*f(30), 18*f(30), 21*f(30), 24*f(30), 54*f(30), 9*CI*f(31) &
    , 27*CI*f(31), 18*f(32), 54*f(32), f(33), 3*f(33), 6*f(33), 8*f(33), 10*f(33), 18*f(33), 21*f(33), 24*f(33), 54*f(33) &
    , 9*CI*f(34), 27*CI*f(34), 18*f(35), 54*f(35), f(36), 3*f(36), 6*f(36), 8*f(36), 10*f(36), 18*f(36), 21*f(36), 24*f(36) &
    , 54*f(36), 3*f(37), 9*f(37), 3*f(38), 9*f(38), 3*f(39), 9*f(39), 3*f(40), 9*f(40), 3*f(41), 9*f(41), 3*f(42), 9*f(42) &
    , 3*f(43), 9*f(43), 3*f(44), 9*f(44), 3*f(45), 9*f(45) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call counter_Q_A(ctqq,wf(:,4),Q(:,36),wf(:,98))
  call prop_A_Q(wf(:,97),Q(:,27),ZERO,0_intkind1,wf(:,99))
  call counter_A_Q(ctqq,wf(:,5),Q(:,24),wf(:,100))
  ...
  call counter_A_Q(ctcc,wf(:,29),Q(:,14),wf(:,122))
  call vert_VQ_A(wf(:,118),wf(:,0),wf(:,123))
  call counter_Q_A(ctcc,wf(:,32),Q(:,13),wf(:,124))
  call prop_A_Q(wf(:,116),Q(:,34),ZERO,0_intkind1,wf(:,125))
  call vert_AW_Q(wf(:,125),wf(:,-4),wf(:,126))
  call counter_Q_A(ctcc,wf(:,36),Q(:,49),wf(:,127))
  call counter_Q_A(ctcc,wf(:,38),Q(:,49),wf(:,128))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(4)-A(6))*f(1))/2._/**/REALKIND+((A(11)+A(13))*f(2))/2._/**/REALKIND+((A(1)+A(2)+A(3)+A(8)+A(9) &
       +A(10))*f(12))/2._/**/REALKIND+((A(5)+A(7)+A(12)+A(14))*f(18))/2._/**/REALKIND
  M1(2) = ((A(4)+A(6))*f(1))/6._/**/REALKIND+((-A(11)-A(13))*f(2))/6._/**/REALKIND+((-A(1)-A(2)-A(3)-A(8)-A(9) &
       -A(10))*f(12))/6._/**/REALKIND+((-A(5)-A(7)-A(12)-A(14))*f(18))/6._/**/REALKIND

  M2(1) = ((A(75)+A(77)+A(79)+A(81))*f(3))/2._/**/REALKIND+((-A(92)-A(94)-A(96)-A(98))*f(4))/2._/**/REALKIND+((-A(62) &
       -A(64))*f(5))/2._/**/REALKIND+((A(49)+A(53))*f(6))/2._/**/REALKIND+((-A(24)-A(32))*f(7))/2._/**/REALKIND+((A(41) &
       +A(43))*f(8))/2._/**/REALKIND+((A(47)+A(55))*f(9))/2._/**/REALKIND+((-A(22)-A(30))*f(10))/2._/**/REALKIND &
       +(A(15)*f(11))/2._/**/REALKIND+((-A(66)-A(67)-A(68)-A(69)-A(70)-A(71)-A(72)-A(73)-A(74)-A(83)-A(84)-A(85)-A(86)-A(87)-A(88) &
       -A(89)-A(90)-A(91))*f(13))/2._/**/REALKIND+((A(45)+A(52)+A(59)+A(60)+A(61))*f(14))/2._/**/REALKIND+((A(18)+A(21)+A(28) &
       +A(35)+A(38)+A(39)+A(40))*f(15))/2._/**/REALKIND+((A(19)+A(20)+A(26)+A(27)+A(29)+A(34)+A(36)+A(46) &
       +A(51))*f(16))/2._/**/REALKIND+((A(37)+A(57)+A(58))*f(17))/2._/**/REALKIND+((-A(76)-A(78)-A(80)-A(82)-A(93)-A(95)-A(97) &
       -A(99))*f(19))/2._/**/REALKIND+((A(50)+A(54)+A(63)+A(65))*f(20))/2._/**/REALKIND+((A(25)+A(33)+A(42) &
       +A(44))*f(21))/2._/**/REALKIND+((A(48)+A(56))*f(22))/2._/**/REALKIND+((A(23)+A(31))*f(23))/2._/**/REALKIND &
       -(A(17)*f(24))/2._/**/REALKIND-(A(16)*f(25))/2._/**/REALKIND
  M2(2) = ((-A(75)-A(77)-A(79)-A(81))*f(3))/6._/**/REALKIND+((A(92)+A(94)+A(96)+A(98))*f(4))/6._/**/REALKIND+((A(62) &
       +A(64))*f(5))/6._/**/REALKIND+((-A(49)-A(53))*f(6))/6._/**/REALKIND+((A(24)+A(32))*f(7))/6._/**/REALKIND+((-A(41) &
       -A(43))*f(8))/6._/**/REALKIND+((-A(47)-A(55))*f(9))/6._/**/REALKIND+((A(22)+A(30))*f(10))/6._/**/REALKIND &
       -(A(15)*f(11))/6._/**/REALKIND+((A(66)+A(67)+A(68)+A(69)+A(70)+A(71)+A(72)+A(73)+A(74)+A(83)+A(84)+A(85)+A(86)+A(87)+A(88) &
       +A(89)+A(90)+A(91))*f(13))/6._/**/REALKIND+((-A(45)-A(52)-A(59)-A(60)-A(61))*f(14))/6._/**/REALKIND+((-A(18)-A(21)-A(28) &
       -A(35)-A(38)-A(39)-A(40))*f(15))/6._/**/REALKIND+((-A(19)-A(20)-A(26)-A(27)-A(29)-A(34)-A(36)-A(46) &
       -A(51))*f(16))/6._/**/REALKIND+((-A(37)-A(57)-A(58))*f(17))/6._/**/REALKIND+((A(76)+A(78)+A(80)+A(82)+A(93)+A(95)+A(97) &
       +A(99))*f(19))/6._/**/REALKIND+((-A(50)-A(54)-A(63)-A(65))*f(20))/6._/**/REALKIND+((-A(25)-A(33)-A(42) &
       -A(44))*f(21))/6._/**/REALKIND+((-A(48)-A(56))*f(22))/6._/**/REALKIND+((-A(23)-A(31))*f(23))/6._/**/REALKIND &
       +(A(17)*f(24))/6._/**/REALKIND+(A(16)*f(25))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppwwjj_ccxddxwwx_1_/**/REALKIND
