...
module ol_colourmatrix_ppwwjj_uuxbbxwwx_1_/**/REALKIND
...
end module ol_colourmatrix_ppwwjj_uuxbbxwwx_1_/**/REALKIND



module ol_forced_parameters_ppwwjj_uuxbbxwwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwwjj_uuxbbxwwx_1_/**/REALKIND

module ol_loop_ppwwjj_uuxbbxwwx_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(55), c(83)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(15) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(16) = (CI*countertermnorm*ctGtt*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(17) = (CI*countertermnorm*ctVbt*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(18) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(19) = (CI*eQED**2*gQCD**2*MB)/(2._/**/REALKIND*sw**2)
    f(20) = (CI*countertermnorm*eQED**2*gQCD**4*MB)/(2._/**/REALKIND*sw**2)
    f(21) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**4*MB)/(2._/**/REALKIND*sw**2)
    f(22) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4*MB)/(2._/**/REALKIND*sw**2)
    f(23) = (CI*countertermnorm*ctSbb*eQED**2*gQCD**4*MB)/(2._/**/REALKIND*sw**2)
    f(24) = (CI*cw*eQED**2*gQCD**2)/sw
    f(25) = (CI*countertermnorm*cw*eQED**2*gQCD**4)/sw
    f(26) = (CI*countertermnorm*ctGbb*cw*eQED**2*gQCD**4)/sw
    f(27) = (CI*countertermnorm*ctGqq*cw*eQED**2*gQCD**4)/sw
    f(28) = (CI*countertermnorm*ctVbb*cw*eQED**2*gQCD**4)/sw
    f(29) = (CI*countertermnorm*ctVqq*cw*eQED**2*gQCD**4)/sw
    f(30) = (countertermnorm*ctZGG*cw*eQED**2*gQCD**4)/sw
    f(31) = (CI*countertermnorm*ctHGG*eQED**2*gQCD**4*MW)/sw
    f(32) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(33) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(34) = (eQED**2*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(35) = (eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(36) = (2*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(37) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/(2._/**/REALKIND*sw**2)
    f(38) = (eQED**2*gQCD**4*integralnorm*SwB)/(sw**2*4._/**/REALKIND)
    f(39) = (eQED**2*gQCD**4*integralnorm*SwB)/(sw**2*2._/**/REALKIND)
    f(40) = (CI*eQED**2*gQCD**4*integralnorm*MB*SwB)/(2._/**/REALKIND*sw**2)
    f(41) = (eQED**2*gQCD**4*integralnorm*MB*SwB)/(sw**2*4._/**/REALKIND)
    f(42) = (eQED**2*gQCD**4*integralnorm*MB*SwB)/(sw**2*2._/**/REALKIND)
    f(43) = (CI*cw*eQED**2*gQCD**4*integralnorm*SwB)/sw
    f(44) = (cw*eQED**2*gQCD**4*integralnorm*SwB)/(sw*2._/**/REALKIND)
    f(45) = (cw*eQED**2*gQCD**4*integralnorm*SwB)/sw
    f(46) = (eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(47) = (2*eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(48) = (4*eQED**2*gQCD**4*integralnorm*SwF)/3._/**/REALKIND
    f(49) = (eQED**2*gQCD**4*integralnorm*SwF)/(sw**2*2._/**/REALKIND)
    f(50) = (eQED**2*gQCD**4*integralnorm*SwF)/sw**2
    f(51) = (eQED**2*gQCD**4*integralnorm*MB*SwF)/(sw**2*2._/**/REALKIND)
    f(52) = (eQED**2*gQCD**4*integralnorm*MB*SwF)/sw**2
    f(53) = (eQED**2*gQCD**4*integralnorm*MT*SwF)/(sw**2*2._/**/REALKIND)
    f(54) = (cw*eQED**2*gQCD**4*integralnorm*SwF)/sw
    f(55) = (2*cw*eQED**2*gQCD**4*integralnorm*SwF)/sw

  c = [ 9*CI*f(32), 27*CI*f(32), 9*CI*f(33), 27*CI*f(33), 18*f(34), 54*f(34), f(35), 3*f(35), 6*f(35), 8*f(35), 10*f(35), 18*f(35) &
    , 21*f(35), 24*f(35), 54*f(35), f(36), 3*f(36), 6*f(36), 8*f(36), 10*f(36), 18*f(36), 21*f(36), 24*f(36), 54*f(36), 9*CI*f(37) &
    , 27*CI*f(37), 18*f(38), 54*f(38), f(39), 3*f(39), 6*f(39), 8*f(39), 10*f(39), 18*f(39), 21*f(39), 24*f(39), 54*f(39) &
    , 9*CI*f(40), 27*CI*f(40), 18*f(41), 54*f(41), f(42), 3*f(42), 6*f(42), 8*f(42), 10*f(42), 18*f(42), 21*f(42), 24*f(42) &
    , 54*f(42), 9*CI*f(43), 27*CI*f(43), 18*f(44), 54*f(44), f(45), 3*f(45), 6*f(45), 8*f(45), 10*f(45), 18*f(45), 21*f(45) &
    , 24*f(45), 54*f(45), 3*f(46), 9*f(46), 3*f(47), 9*f(47), 3*f(48), 9*f(48), 3*f(49), 9*f(49), 3*f(50), 9*f(50), 3*f(51) &
    , 9*f(51), 3*f(52), 9*f(52), 3*f(53), 9*f(53), 3*f(54), 9*f(54), 3*f(55), 9*f(55) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call vert_WQ_A(wf(:,-4),wf(:,0),wf(:,25))
  call vert_AW_Q(wf(:,-1),wf(:,-5),wf(:,26))
  call vert_QA_V(wf(:,-2),wf(:,-3),wf(:,27))
  call prop_Q_A(wf(:,25),Q(:,17),ZERO,0_intkind1,wf(:,28))
  call prop_A_Q(wf(:,26),Q(:,34),ZERO,0_intkind1,wf(:,29))
  call vert_QA_V(wf(:,28),wf(:,29),wf(:,30))
  call vert_AV_Q(wf(:,-1),wf(:,27),wf(:,31))
  call vert_WQ_A(wf(:,-5),wf(:,28),wf(:,32))
  call prop_A_Q(wf(:,31),Q(:,14),ZERO,0_intkind1,wf(:,33))
  call vert_VQ_A(wf(:,27),wf(:,0),wf(:,34))
  call vert_AW_Q(wf(:,29),wf(:,-4),wf(:,35))
  call prop_Q_A(wf(:,34),Q(:,13),ZERO,0_intkind1,wf(:,36))
  call vert_AV_Q(wf(:,-1),wf(:,15),wf(:,37))
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,17),wf(:,38))
  call vert_VQ_A(wf(:,15),wf(:,0),wf(:,39))
  call prop_Q_A(wf(:,39),Q(:,49),ZERO,0_intkind1,wf(:,40))
  call vert_ZQ_A(gZu,wf(:,17),wf(:,0),wf(:,41))
  ...
  call counter_WQ_A(wf(:,-5),wf(:,28),wf(:,70))
  call counter_AW_Q(wf(:,29),wf(:,-4),wf(:,71))
  call counter_QA_V(wf(:,-2),wf(:,-3),wf(:,72))
  call vert_AV_Q(wf(:,-1),wf(:,72),wf(:,73))
  call prop_A_Q(wf(:,73),Q(:,14),ZERO,0_intkind1,wf(:,74))
  call vert_VQ_A(wf(:,72),wf(:,0),wf(:,75))
  call prop_Q_A(wf(:,75),Q(:,13),ZERO,0_intkind1,wf(:,76))
  call counter_AV_Q(wf(:,-1),wf(:,27),wf(:,77))
  call prop_Q_A(wf(:,32),Q(:,49),ZERO,0_intkind1,wf(:,78))
  call counter_AW_Q(wf(:,-1),wf(:,-5),wf(:,79))
  call prop_A_Q(wf(:,79),Q(:,34),ZERO,0_intkind1,wf(:,80))
  call vert_QA_V(wf(:,28),wf(:,80),wf(:,81))
  call counter_AV_Q(wf(:,-1),wf(:,15),wf(:,82))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,17),wf(:,83))
  call vert_AW_Q(wf(:,80),wf(:,-4),wf(:,84))
  call counter_VQ_A(wf(:,27),wf(:,0),wf(:,85))
  call prop_A_Q(wf(:,35),Q(:,50),ZERO,0_intkind1,wf(:,86))
  call prop_A_Q(wf(:,37),Q(:,50),ZERO,0_intkind1,wf(:,87))
  call prop_A_Q(wf(:,38),Q(:,50),ZERO,0_intkind1,wf(:,88))
  call counter_VQ_A(wf(:,15),wf(:,0),wf(:,89))
  call counter_ZQ_A(gZu,wf(:,17),wf(:,0),wf(:,90))
  call counter_WQ_A(wf(:,-4),wf(:,0),wf(:,91))
  call prop_Q_A(wf(:,91),Q(:,17),ZERO,0_intkind1,wf(:,92))
  call vert_QA_V(wf(:,92),wf(:,29),wf(:,93))
  call vert_WQ_A(wf(:,-5),wf(:,92),wf(:,94))
  ...
  call counter_Q_A(ctqq,wf(:,28),Q(:,17),wf(:,120))
  call prop_A_Q(wf(:,119),Q(:,46),ZERO,0_intkind1,wf(:,121))
  call vert_VQ_A(wf(:,27),wf(:,28),wf(:,122))
  call counter_A_Q(ctqq,wf(:,29),Q(:,34),wf(:,123))
  call prop_Q_A(wf(:,122),Q(:,29),ZERO,0_intkind1,wf(:,124))
  call counter_V_V(ctGG,wf(:,27),Q(:,12),wf(:,125))
  call prop_Q_A(wf(:,120),Q(:,17),ZERO,0_intkind1,wf(:,126))
  call vert_WQ_A(wf(:,-5),wf(:,126),wf(:,127))
  call vert_AV_Q(wf(:,-1),wf(:,125),wf(:,128))
  call counter_A_Q(ctqq,wf(:,33),Q(:,14),wf(:,129))
  call vert_VQ_A(wf(:,125),wf(:,0),wf(:,130))
  call counter_Q_A(ctqq,wf(:,36),Q(:,13),wf(:,131))
  call prop_A_Q(wf(:,123),Q(:,34),ZERO,0_intkind1,wf(:,132))
  call vert_AW_Q(wf(:,132),wf(:,-4),wf(:,133))
  ...
  call vert_WQ_A(wf(:,-4),wf(:,36),wf(:,140))
  call prop_Q_A(wf(:,140),Q(:,29),ZERO,0_intkind1,wf(:,141))
  call vert_AW_Q(wf(:,33),wf(:,-5),wf(:,142))
  call prop_A_Q(wf(:,142),Q(:,46),ZERO,0_intkind1,wf(:,143))
  call vert_QA_V(wf(:,78),wf(:,-1),wf(:,144))
  call vert_QA_V(wf(:,-2),wf(:,58),wf(:,145))
  call vert_QA_V(wf(:,0),wf(:,86),wf(:,146))
  call vert_QA_V(wf(:,50),wf(:,-3),wf(:,147))
  call vert_QA_V(wf(:,40),wf(:,-1),wf(:,148))
  call vert_QA_V(wf(:,42),wf(:,-1),wf(:,149))
  call vert_QA_V(wf(:,0),wf(:,87),wf(:,150))
  call vert_QA_V(wf(:,0),wf(:,88),wf(:,151))
...
subroutine denominators()
  ...
  den(36) = den(14)*den(34)
  den(37) = den(16)*den(34)
  ...
  den(69) = den(14)*den(31)
  den(70) = den(16)*den(31)
  den(71) = den(2)*den(3)
  ...
  den(114) = den(25)**2
  den(115) = den(31)*den(114)
  den(116) = den(27)**2
  den(117) = den(60)*den(116)
  den(118) = den(31)*den(60)
  den(119) = den(63)*den(116)
  den(120) = den(34)*den(63)
  den(121) = den(26)**2
  den(122) = den(34)*den(121)
  den(123) = den(34)*den(65)
  den(124) = den(34)*den(67)
  den(125) = den(31)*den(39)
  den(126) = den(31)*den(41)
  den(127) = den(65)*den(116)
  den(128) = den(67)*den(116)
  den(129) = den(39)*den(116)
  den(130) = den(41)*den(116)
  den(131) = den(7)*den(79)
  den(132) = den(10)*den(76)
  den(133) = den(34)*den(108)
  den(134) = den(31)*den(104)
  den(135) = den(60)*den(111)
  den(136) = den(49)*den(72)
  den(137) = den(63)*den(111)
  ...
  den(169) = den(27)*den(135)
  den(170) = den(25)*den(134)
  den(171) = den(26)*den(133)
  den(172) = den(27)*den(137)
...
subroutine diagrams(A)
  ...
  A(13) = cont_QA(wf(:,36),wf(:,37)) * den(36)
  A(14) = cont_QA(wf(:,36),wf(:,38)) * den(37)
  A(15) = cont_QA(wf(:,31),wf(:,40)) * den(40)
  A(16) = cont_QA(wf(:,31),wf(:,42)) * den(42)
  ...
  A(47) = cont_QA(wf(:,40),wf(:,73)) * den(40)
  A(48) = cont_QA(wf(:,42),wf(:,73)) * den(42)
  A(49) = cont_QA(wf(:,37),wf(:,76)) * den(36)
  A(50) = cont_QA(wf(:,38),wf(:,76)) * den(37)
  A(51) = cont_QA(wf(:,77),wf(:,78)) * den(61)
  A(52) = cont_VV(wf(:,27),wf(:,81)) * den(29)
  A(53) = cont_QA(wf(:,36),wf(:,82)) * den(36)
  A(54) = cont_QA(wf(:,36),wf(:,83)) * den(37)
  A(55) = cont_QA(wf(:,40),wf(:,77)) * den(40)
  A(56) = cont_QA(wf(:,42),wf(:,77)) * den(42)
  A(57) = cont_QA(wf(:,36),wf(:,84)) * den(35)
  A(58) = cont_QA(wf(:,85),wf(:,86)) * den(64)
  A(59) = cont_QA(wf(:,85),wf(:,87)) * den(66)
  A(60) = cont_QA(wf(:,85),wf(:,88)) * den(68)
  A(61) = cont_QA(wf(:,33),wf(:,89)) * den(69)
  A(62) = cont_QA(wf(:,33),wf(:,90)) * den(70)
  A(63) = cont_VV(wf(:,27),wf(:,93)) * den(29)
  A(64) = cont_QA(wf(:,33),wf(:,94)) * den(32)
  ...
  A(98) = cont_QA(wf(:,33),wf(:,127)) * den(115)
  A(99) = cont_QA(wf(:,78),wf(:,128)) * den(117)
  A(100) = cont_QA(wf(:,78),wf(:,129)) * den(118)
  A(101) = cont_QA(wf(:,86),wf(:,130)) * den(119)
  A(102) = cont_QA(wf(:,86),wf(:,131)) * den(120)
  A(103) = cont_QA(wf(:,36),wf(:,133)) * den(122)
  A(104) = cont_QA(wf(:,87),wf(:,131)) * den(123)
  A(105) = cont_QA(wf(:,88),wf(:,131)) * den(124)
  A(106) = cont_QA(wf(:,33),wf(:,134)) * den(125)
  A(107) = cont_QA(wf(:,33),wf(:,135)) * den(126)
  A(108) = cont_QA(wf(:,87),wf(:,130)) * den(127)
  A(109) = cont_QA(wf(:,88),wf(:,130)) * den(128)
  A(110) = cont_QA(wf(:,40),wf(:,128)) * den(129)
  A(111) = cont_QA(wf(:,42),wf(:,128)) * den(130)
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(5)-A(8))*f(1))/2._/**/REALKIND+((A(13)+A(15))*f(2))/2._/**/REALKIND+((A(1)+A(2)+A(3)+A(10)+A(11) &
       +A(12))*f(12))/2._/**/REALKIND+((-A(4)-A(7))*f(19))/2._/**/REALKIND+((A(6)+A(9)+A(14)+A(16))*f(24))/2._/**/REALKIND
  M1(2) = ((A(5)+A(8))*f(1))/6._/**/REALKIND+((-A(13)-A(15))*f(2))/6._/**/REALKIND+((-A(1)-A(2)-A(3)-A(10)-A(11) &
       -A(12))*f(12))/6._/**/REALKIND+((A(4)+A(7))*f(19))/6._/**/REALKIND+((-A(6)-A(9)-A(14)-A(16))*f(24))/6._/**/REALKIND

  M2(1) = ((A(84)+A(87)+A(90)+A(93))*f(3))/2._/**/REALKIND+((-A(104)-A(106)-A(108)-A(110))*f(4))/2._/**/REALKIND+((-A(28) &
       -A(38))*f(5))/2._/**/REALKIND+((A(47)+A(49))*f(6))/2._/**/REALKIND+((-A(69)-A(72))*f(7))/2._/**/REALKIND+((A(55) &
       +A(59))*f(8))/2._/**/REALKIND+((-A(25)-A(35))*f(9))/2._/**/REALKIND+((A(53)+A(61))*f(10))/2._/**/REALKIND &
       +(A(17)*f(11))/2._/**/REALKIND+((-A(74)-A(75)-A(76)-A(77)-A(78)-A(79)-A(80)-A(81)-A(82)-A(95)-A(96)-A(97)-A(98)-A(99) &
       -A(100)-A(101)-A(102)-A(103))*f(13))/2._/**/REALKIND+((A(23)+A(32)+A(44)+A(45)+A(46))*f(14))/2._/**/REALKIND+((A(41)+A(51) &
       +A(58)+A(65)+A(66)+A(67))*f(15))/2._/**/REALKIND+(A(20)*f(16))/2._/**/REALKIND+((A(21)+A(22)+A(30)+A(31)+A(33) &
       +A(40))*f(17))/2._/**/REALKIND+((A(42)+A(43)+A(52)+A(57)+A(63)+A(64))*f(18))/2._/**/REALKIND+((A(83)+A(86)+A(89) &
       +A(92))*f(20))/2._/**/REALKIND+((-A(27)-A(37))*f(21))/2._/**/REALKIND+((-A(68)-A(71))*f(22))/2._/**/REALKIND+((-A(24) &
       -A(34))*f(23))/2._/**/REALKIND+((-A(85)-A(88)-A(91)-A(94)-A(105)-A(107)-A(109)-A(111))*f(25))/2._/**/REALKIND+((A(29)+A(39) &
       +A(48)+A(50))*f(26))/2._/**/REALKIND+((A(56)+A(60)+A(70)+A(73))*f(27))/2._/**/REALKIND+((A(26) &
       +A(36))*f(28))/2._/**/REALKIND+((A(54)+A(62))*f(29))/2._/**/REALKIND-(A(19)*f(30))/2._/**/REALKIND &
       -(A(18)*f(31))/2._/**/REALKIND
  M2(2) = ((-A(84)-A(87)-A(90)-A(93))*f(3))/6._/**/REALKIND+((A(104)+A(106)+A(108)+A(110))*f(4))/6._/**/REALKIND+((A(28) &
       +A(38))*f(5))/6._/**/REALKIND+((-A(47)-A(49))*f(6))/6._/**/REALKIND+((A(69)+A(72))*f(7))/6._/**/REALKIND+((-A(55) &
       -A(59))*f(8))/6._/**/REALKIND+((A(25)+A(35))*f(9))/6._/**/REALKIND+((-A(53)-A(61))*f(10))/6._/**/REALKIND &
       -(A(17)*f(11))/6._/**/REALKIND+((A(74)+A(75)+A(76)+A(77)+A(78)+A(79)+A(80)+A(81)+A(82)+A(95)+A(96)+A(97)+A(98)+A(99)+A(100) &
       +A(101)+A(102)+A(103))*f(13))/6._/**/REALKIND+((-A(23)-A(32)-A(44)-A(45)-A(46))*f(14))/6._/**/REALKIND+((-A(41)-A(51)-A(58) &
       -A(65)-A(66)-A(67))*f(15))/6._/**/REALKIND-(A(20)*f(16))/6._/**/REALKIND+((-A(21)-A(22)-A(30)-A(31)-A(33) &
       -A(40))*f(17))/6._/**/REALKIND+((-A(42)-A(43)-A(52)-A(57)-A(63)-A(64))*f(18))/6._/**/REALKIND+((-A(83)-A(86)-A(89) &
       -A(92))*f(20))/6._/**/REALKIND+((A(27)+A(37))*f(21))/6._/**/REALKIND+((A(68)+A(71))*f(22))/6._/**/REALKIND+((A(24) &
       +A(34))*f(23))/6._/**/REALKIND+((A(85)+A(88)+A(91)+A(94)+A(105)+A(107)+A(109)+A(111))*f(25))/6._/**/REALKIND+((-A(29)-A(39) &
       -A(48)-A(50))*f(26))/6._/**/REALKIND+((-A(56)-A(60)-A(70)-A(73))*f(27))/6._/**/REALKIND+((-A(26) &
       -A(36))*f(28))/6._/**/REALKIND+((-A(54)-A(62))*f(29))/6._/**/REALKIND+(A(19)*f(30))/6._/**/REALKIND &
       +(A(18)*f(31))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppwwjj_uuxbbxwwx_1_/**/REALKIND
