...
module ol_colourmatrix_ppthj_utxdxbh_1_/**/REALKIND
...
end module ol_colourmatrix_ppthj_utxdxbh_1_/**/REALKIND



module ol_forced_parameters_ppthj_utxdxbh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppthj_utxdxbh_1_/**/REALKIND

module ol_loop_ppthj_utxdxbh_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_SA_Q(gH,wf(:,-4),wf(:,-1),wf(:,6))
  call prop_A_Q(wf(:,6),Q(:,18),MT,1_intkind1,wf(:,7))
  call vert_WQ_A(wf(:,1),wf(:,-3),wf(:,8))
  call vert_QS_A(gH,wf(:,-3),wf(:,-4),wf(:,9))
  call prop_Q_A(wf(:,9),Q(:,24),MB,1_intkind1,wf(:,10))
  call vert_AW_Q(wf(:,-1),wf(:,1),wf(:,11))
  call counter_WQ_A(wf(:,1),wf(:,-3),wf(:,12))
  call counter_QS_A(gH,wf(:,-3),wf(:,-4),wf(:,13))
  call prop_Q_A(wf(:,13),Q(:,24),MB,1_intkind1,wf(:,14))
  call counter_AW_Q(wf(:,-1),wf(:,1),wf(:,15))
  call counter_SA_Q(gH,wf(:,-4),wf(:,-1),wf(:,16))
  call prop_A_Q(wf(:,16),Q(:,18),MT,1_intkind1,wf(:,17))
  call counter_AQ_S(ctStb,wf(:,-1),wf(:,-3),wf(:,18))
  call counter_QA_W(wf(:,-3),wf(:,-1),wf(:,19))
  call counter_AQ_S(gPdu,wf(:,-2),wf(:,0),wf(:,20))
  call vert_SS_S(wf(:,20),wf(:,-4),wf(:,21))
  call vert_ST_V(wf(:,20),Q(:,5),wf(:,-4),Q(:,16),wf(:,22))
  call counter_QA_W(wf(:,0),wf(:,-2),wf(:,23))
  call vert_TV_S(wf(:,-4),Q(:,16),wf(:,23),Q(:,5),wf(:,24))
  call vert_SV_V(wf(:,-4),wf(:,23),wf(:,25))
  call vert_QS_A(gPtb,wf(:,-3),wf(:,20),wf(:,26))
  call vert_WQ_A(wf(:,23),wf(:,-3),wf(:,27))
  call vert_SA_Q(gPtb,wf(:,20),wf(:,-1),wf(:,28))
  call vert_AW_Q(wf(:,-1),wf(:,23),wf(:,29))
  call counter_A_Q(cttt,wf(:,7),Q(:,18),wf(:,30))
  call prop_Q_A(wf(:,8),Q(:,13),MT,1_intkind1,wf(:,31))
  call counter_Q_A(ctbb,wf(:,10),Q(:,24),wf(:,32))
  call prop_A_Q(wf(:,11),Q(:,7),MB,1_intkind1,wf(:,33))
  call vert_ST_V(wf(:,2),Q(:,10),wf(:,-4),Q(:,16),wf(:,34))
  call vert_SV_V(wf(:,-4),wf(:,4),wf(:,35))
  call vert_QA_W(wf(:,-3),wf(:,7),wf(:,36))
  call vert_QA_W(wf(:,10),wf(:,-1),wf(:,37))
...
end module ol_loop_ppthj_utxdxbh_1_/**/REALKIND
