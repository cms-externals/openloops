...
module ol_versiondata_ppthj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppthj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppthj
  end interface
end module ol_versiondata_ppthj


subroutine ol_version_ppthj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppthj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppthj
