...
module ol_vamp_1_ppllll_nenenexexuxd_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nenenexexuxd_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nenenexexuxd_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nenenexexuxd_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nenenexexuxd_1_/**/REALKIND
  ...
  call loop_Q_A(G1(:,:,:,3),Q(:,37),ZERO,G2(:,:,:,3))
  ...
  call loop_QW_A(G1(:,:,:,1),wf(:,61),G1(:,:,:,4))
  call loop_Q_A(G1(:,:,:,4),Q(:,47),ZERO,G2(:,:,:,5))
  call check_last_QA_V(l_switch,G2(:,:,:,5),wf(:,-4),G2tensor(:,3))
  call loop_QW_A(G1(:,:,:,1),wf(:,63),G1(:,:,:,5))
  call loop_Q_A(G1(:,:,:,5),Q(:,47),ZERO,G2(:,:,:,6))
  call check_last_QA_V(l_switch,G2(:,:,:,6),wf(:,-4),G2tensor(:,4))
  call loop_QW_A(G1(:,:,:,1),wf(:,66),G1(:,:,:,6))
  call loop_Q_A(G1(:,:,:,6),Q(:,47),ZERO,G2(:,:,:,7))
  call check_last_QA_V(l_switch,G2(:,:,:,7),wf(:,-4),G2tensor(:,5))
  call loop_QZ_A(G1(:,:,:,1),wf(:,23),G1(:,:,:,7),gZd)
  call loop_Q_A(G1(:,:,:,7),Q(:,38),ZERO,G2(:,:,:,8))
  call check_last_QA_V(l_switch,G2(:,:,:,8),wf(:,27),G2tensor(:,6))
  call loop_QW_A(G2(:,:,:,8),wf(:,22),G2(:,:,:,9))
  call loop_Q_A(G2(:,:,:,9),Q(:,47),ZERO,G3(:,:,:,3))
  call check_last_QA_V(l_switch,G3(:,:,:,3),wf(:,-4),G3tensor(:,3))
  call loop_QW_A(G1(:,:,:,1),wf(:,22),G1(:,:,:,8))
  call loop_Q_A(G1(:,:,:,8),Q(:,41),ZERO,G2(:,:,:,10))
  call check_last_QA_V(l_switch,G2(:,:,:,10),wf(:,30),G2tensor(:,7))
  call loop_QZ_A(G2(:,:,:,10),wf(:,23),G2(:,:,:,11),gZu)
  call loop_Q_A(G2(:,:,:,11),Q(:,47),ZERO,G3(:,:,:,4))
  call check_last_QA_V(l_switch,G3(:,:,:,4),wf(:,-4),G3tensor(:,4))
  call loop_QW_A(G1(:,:,:,1),wf(:,67),G1(:,:,:,9))
  call loop_Q_A(G1(:,:,:,9),Q(:,47),ZERO,G2(:,:,:,12))
  call check_last_QA_V(l_switch,G2(:,:,:,12),wf(:,-4),G2tensor(:,8))
  call loop_QW_A(G1(:,:,:,1),wf(:,69),G1(:,:,:,10))
  call loop_Q_A(G1(:,:,:,10),Q(:,47),ZERO,G2(:,:,:,13))
  call check_last_QA_V(l_switch,G2(:,:,:,13),wf(:,-4),G2tensor(:,9))
  call loop_QW_A(G1(:,:,:,1),wf(:,72),G1(:,:,:,11))
  call loop_Q_A(G1(:,:,:,11),Q(:,47),ZERO,G2(:,:,:,14))
  call check_last_QA_V(l_switch,G2(:,:,:,14),wf(:,-4),G2tensor(:,10))
  call loop_QW_A(G1(:,:,:,1),wf(:,75),G1(:,:,:,12))
  call loop_Q_A(G1(:,:,:,12),Q(:,47),ZERO,G2(:,:,:,15))
  call check_last_QA_V(l_switch,G2(:,:,:,15),wf(:,-4),G2tensor(:,11))
  call loop_QW_A(G1(:,:,:,1),wf(:,78),G1(:,:,:,13))
  call loop_Q_A(G1(:,:,:,13),Q(:,47),ZERO,G2(:,:,:,16))
  call check_last_QA_V(l_switch,G2(:,:,:,16),wf(:,-4),G2tensor(:,12))
  call loop_VQ_A(G0(:,:,:,1),wf(:,41),G0(:,:,:,3))
  call loop_Q_A(G0(:,:,:,3),Q(:,37),ZERO,G1(:,:,:,14))
  call loop_QW_A(G1(:,:,:,14),wf(:,5),G1(:,:,:,15))
  call loop_Q_A(G1(:,:,:,15),Q(:,47),ZERO,G2(:,:,:,17))
  call check_last_QA_V(l_switch,G2(:,:,:,17),wf(:,-4),G2tensor(:,13))
  call check_last_QA_V(l_switch,G1(:,:,:,14),wf(:,13),G1tensor(:,1))
  call loop_VQ_A(G0(:,:,:,1),wf(:,43),G0(:,:,:,4))
  call loop_Q_A(G0(:,:,:,4),Q(:,42),ZERO,G1(:,:,:,16))
  call loop_QZ_A(G1(:,:,:,16),wf(:,4),G1(:,:,:,17),gZu)
  call loop_Q_A(G1(:,:,:,17),Q(:,47),ZERO,G2(:,:,:,18))
  call check_last_QA_V(l_switch,G2(:,:,:,18),wf(:,-4),G2tensor(:,14))
  call check_last_QA_V(l_switch,G1(:,:,:,16),wf(:,10),G1tensor(:,2))
  call loop_VQ_A(G0(:,:,:,1),wf(:,52),G0(:,:,:,5))
  call loop_Q_A(G0(:,:,:,5),Q(:,41),ZERO,G1(:,:,:,18))
  call loop_QZ_A(G1(:,:,:,18),wf(:,23),G1(:,:,:,19),gZu)
  call loop_Q_A(G1(:,:,:,19),Q(:,47),ZERO,G2(:,:,:,19))
  call check_last_QA_V(l_switch,G2(:,:,:,19),wf(:,-4),G2tensor(:,15))
  call check_last_QA_V(l_switch,G1(:,:,:,18),wf(:,30),G1tensor(:,3))
  call loop_VQ_A(G0(:,:,:,1),wf(:,54),G0(:,:,:,6))
  call loop_Q_A(G0(:,:,:,6),Q(:,38),ZERO,G1(:,:,:,20))
  call loop_QW_A(G1(:,:,:,20),wf(:,22),G1(:,:,:,21))
  call loop_Q_A(G1(:,:,:,21),Q(:,47),ZERO,G2(:,:,:,20))
  call check_last_QA_V(l_switch,G2(:,:,:,20),wf(:,-4),G2tensor(:,16))
  call check_last_QA_V(l_switch,G1(:,:,:,20),wf(:,27),G1tensor(:,4))
...
end module ol_vamp_1_ppllll_nenenexexuxd_1_/**/REALKIND
