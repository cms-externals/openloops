...
module ol_vamp_1_ppllll_nexnmemxbbx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nexnmemxbbx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nexnmemxbbx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nexnmemxbbx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nexnmemxbbx_1_/**/REALKIND
  ...
  call loop_A_Q(G0(:,:,:,2),Q(:,37),MT,G1(:,:,:,1))
  call loop_AW_Q(G1(:,:,:,1),wf(:,5),G1(:,:,:,2))
  call loop_A_Q(G1(:,:,:,2),Q(:,47),MB,G2(:,:,:,1))
  ...
  call loop_A_Q(G0(:,:,:,3),Q(:,32),MB,G1(:,:,:,3))
  call loop_AW_Q(G1(:,:,:,3),wf(:,4),G1(:,:,:,4))
  call loop_A_Q(G1(:,:,:,4),Q(:,37),MT,G2(:,:,:,2))
  call check_last_AQ_V(l_switch,G2(:,:,:,2),wf(:,13),G2tensor(:,2))
  call loop_AW_Q(G2(:,:,:,2),wf(:,5),G2(:,:,:,3))
  call loop_A_Q(G2(:,:,:,3),Q(:,47),MB,G3(:,:,:,1))
  call check_last_AQ_V(l_switch,G3(:,:,:,1),wf(:,-4),G3tensor(:,1))
  call loop_AS_Q(G1(:,:,:,3),wf(:,6),G1(:,:,:,5),gH)
  call loop_A_Q(G1(:,:,:,5),Q(:,47),MB,G2(:,:,:,4))
  call check_last_AQ_V(l_switch,G2(:,:,:,4),wf(:,-4),G2tensor(:,3))
  call loop_AV_Q(G1(:,:,:,3),wf(:,8),G1(:,:,:,6))
  call loop_A_Q(G1(:,:,:,6),Q(:,47),MB,G2(:,:,:,5))
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,-4),G2tensor(:,4))
  call loop_AZ_Q(G1(:,:,:,3),wf(:,44),G1(:,:,:,7),gZd)
  call loop_A_Q(G1(:,:,:,7),Q(:,47),MB,G2(:,:,:,6))
  call check_last_AQ_V(l_switch,G2(:,:,:,6),wf(:,-4),G2tensor(:,5))
  call loop_AV_Q(G1(:,:,:,3),wf(:,45),G1(:,:,:,8))
  call loop_A_Q(G1(:,:,:,8),Q(:,47),MB,G2(:,:,:,7))
  call check_last_AQ_V(l_switch,G2(:,:,:,7),wf(:,-4),G2tensor(:,6))
  call loop_AZ_Q(G1(:,:,:,3),wf(:,47),G1(:,:,:,9),gZd)
  call loop_A_Q(G1(:,:,:,9),Q(:,47),MB,G2(:,:,:,8))
  call check_last_AQ_V(l_switch,G2(:,:,:,8),wf(:,-4),G2tensor(:,7))
  call loop_AZ_Q(G1(:,:,:,3),wf(:,50),G1(:,:,:,10),gZd)
  call loop_A_Q(G1(:,:,:,10),Q(:,47),MB,G2(:,:,:,9))
  call check_last_AQ_V(l_switch,G2(:,:,:,9),wf(:,-4),G2tensor(:,8))
  call loop_AV_Q(G1(:,:,:,3),wf(:,51),G1(:,:,:,11))
  call loop_A_Q(G1(:,:,:,11),Q(:,47),MB,G2(:,:,:,10))
  ...
  call loop_AZ_Q(G1(:,:,:,3),wf(:,56),G1(:,:,:,13),gZd)
...
end module ol_vamp_1_ppllll_nexnmemxbbx_1_/**/REALKIND
