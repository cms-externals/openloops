...
! **********************************************************************
module ol_tensor_sum_storage_ppllll_nenmnmxexuxd_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllll_nenmnmxexuxd_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllll_nenmnmxexuxd_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppllll_nenmnmxexuxd_1, only: channel_number_ppllll_nenmnmxexuxd_1
  ...
  call channel_on(channel_number_ppllll_nenmnmxexuxd_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,38)
  momenta_2(:,1) = Q(1:4,41)
  momenta_3(:,1) = Q(1:4,32)
  momenta_3(:,2) = Q(1:4,38)
  momenta_4(:,1) = Q(1:4,32)
  momenta_4(:,2) = Q(1:4,41)
  ...
  momenta_8(:,2) = Q(1:4,38)
  momenta_8(:,3) = Q(1:4,47)
  momenta_9(:,1) = Q(1:4,32)
  momenta_9(:,2) = Q(1:4,41)
  ...
  call channel_off(channel_number_ppllll_nenmnmxexuxd_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllll_nenmnmxexuxd_1_/**/REALKIND
