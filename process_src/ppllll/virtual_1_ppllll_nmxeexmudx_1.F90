...
module ol_vamp_1_ppllll_nmxeexmudx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nmxeexmudx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nmxeexmudx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nmxeexmudx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nmxeexmudx_1_/**/REALKIND
  ...
  call loop_A_Q(G1(:,:,:,2),Q(:,38),ZERO,G2(:,:,:,1))
  ...
  call loop_A_Q(G1(:,:,:,3),Q(:,38),ZERO,G2(:,:,:,3))
  ...
  call loop_A_Q(G1(:,:,:,4),Q(:,41),ZERO,G2(:,:,:,5))
  ...
  call check_last_AQ_V(l_switch,G1(:,:,:,11),wf(:,16),G1tensor(:,1))
  call check_last_AQ_V(l_switch,G1(:,:,:,11),wf(:,18),G1tensor(:,2))
  call loop_VA_Q(G0(:,:,:,1),wf(:,36),G0(:,:,:,4))
  call loop_A_Q(G0(:,:,:,4),Q(:,38),ZERO,G1(:,:,:,14))
  call loop_AW_Q(G1(:,:,:,14),wf(:,4),G1(:,:,:,15))
  call loop_A_Q(G1(:,:,:,15),Q(:,47),ZERO,G2(:,:,:,16))
  call check_last_AQ_V(l_switch,G2(:,:,:,16),wf(:,-4),G2tensor(:,13))
  call check_last_AQ_V(l_switch,G1(:,:,:,14),wf(:,12),G1tensor(:,3))
  call loop_VA_Q(G0(:,:,:,1),wf(:,37),G0(:,:,:,5))
  call loop_A_Q(G0(:,:,:,5),Q(:,38),ZERO,G1(:,:,:,16))
  call loop_AW_Q(G1(:,:,:,16),wf(:,4),G1(:,:,:,17))
  call loop_A_Q(G1(:,:,:,17),Q(:,47),ZERO,G2(:,:,:,17))
  call check_last_AQ_V(l_switch,G2(:,:,:,17),wf(:,-4),G2tensor(:,14))
  call check_last_AQ_V(l_switch,G1(:,:,:,16),wf(:,12),G1tensor(:,4))
...
end module ol_vamp_1_ppllll_nmxeexmudx_1_/**/REALKIND
