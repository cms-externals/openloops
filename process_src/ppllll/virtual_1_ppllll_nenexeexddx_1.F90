...
module ol_vamp_1_ppllll_nenexeexddx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nenexeexddx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nenexeexddx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nenexeexddx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nenexeexddx_1_/**/REALKIND
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,79),G1(:,:,:,6),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,84),G1(:,:,:,11),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,93),G1(:,:,:,16),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,20),wf(:,8),G1(:,:,:,22),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,25),wf(:,3),G1(:,:,:,26),gZd)
  ...
  call loop_A_Q(G0(:,:,:,6),Q(:,38),ZERO,G1(:,:,:,27))
  call loop_AW_Q(G1(:,:,:,27),wf(:,29),G1(:,:,:,28))
...
end module ol_vamp_1_ppllll_nenexeexddx_1_/**/REALKIND
