...
! **********************************************************************
module ol_heltables_ppllll_nenmxexmuux_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(8), n3(3,26)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x16(2,16,1), t3x4(2,4,4), t3x64(2,64,9), t3x8(2,8,12)
...
! **********************************************************************
  ...
  n2(6) = 8
  call heltable([4,2,8], n3(:,13), t3x8(:,:,8))
  ...
  n2(8) = 8
  call heltable([4,16,64], n3(:,18), t3x64(:,:,1))
  call heltable([16,4,64], n3(:,19), t3x64(:,:,2))
  ...
  call heltable([8,8,64], n3(:,26), t3x64(:,:,9))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_ppllll_nenmxexmuux_1
