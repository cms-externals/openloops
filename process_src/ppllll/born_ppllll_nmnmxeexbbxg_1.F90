...
module ol_colourmatrix_ppllll_nmnmxeexbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllll_nmnmxeexbbxg_1_/**/REALKIND



module ol_forced_parameters_ppllll_nmnmxeexbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllll_nmnmxeexbbxg_1_/**/REALKIND

module ol_tree_ppllll_nmnmxeexbbxg_1_/**/REALKIND
...
subroutine factors_init()
  ...
  ! factors of the diagrams
    ...
    f(2) = CI*eQED**4*gQCD
    f(3) = (CI*eQED**4*gQCD*MB)/(2._/**/REALKIND*cw**2*sw**2)
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllll_nmnmxeexbbxg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllll_nmnmxeexbbxg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for nu_mu anti-nu_mu e- e+ bottom anti-bottom glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppllll_nmnmxeexbbxg_1, only: external_perm_ppllll_nmnmxeexbbxg_1, &
    & external_perm_inv_ppllll_nmnmxeexbbxg_1, extcomb_perm_ppllll_nmnmxeexbbxg_1, &
    & average_factor_ppllll_nmnmxeexbbxg_1
  use ol_external_ppllll_nmnmxeexbbxg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppllll_nmnmxeexbbxg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllll_nmnmxeexbbxg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppllll_nmnmxeexbbxg_1
  ...
  type(wfun) :: wf4(4,9), wf8(8,28), wf16(16,16), wf128(128,26)

  type(polcont) :: A(128,26)
  complex(REALKIND) :: Aj(26)
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppllll_nmnmxeexbbxg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllll_nmnmxeexbbxg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllll_nmnmxeexbbxg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllll_nmnmxeexbbxg_1(extcombs(k))
  end do
  ...
  call vert_ZQ_A(gZn,ntry, wf4(:,7), ex1, wf8(:,25), n3(:,34), t3x8(:,:,15))
  call prop_Q_A(ntry, wf8(:,25), Q(:,13), ZERO, 0_intkind1, wf8(:,26), n2(15))
  call vert_QA_Z(gZn,ntry, wf8(:,26), ex2, wf16(:,15), n3(:,35), t3x16(:,:,15))
  call vert_AZ_Q(gZn,ntry, ex2, wf4(:,7), wf8(:,27), n3(:,36), t3x8(:,:,16))
  call prop_A_Q(ntry, wf8(:,27), Q(:,14), ZERO, 0_intkind1, wf8(:,28), n2(16))
  call vert_QA_Z(gZn,ntry, ex1, wf8(:,28), wf16(:,16), n3(:,37), t3x16(:,:,16))
  ...
  M2add = M2 / average_factor_ppllll_nmnmxeexbbxg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppllll_nmnmxeexbbxg_1(k))
  end do
...
subroutine diagrams()
  ...
  ! e.g. call cont_VV(nsync, wf3, wf6, A(:,1), n64, t64, nhel, den(5)) ...
    ...
    call cont_QA(nsync, wf8(:,2), wf16(:,2), A(:,2), n3(:,39), t3x128(:,:,2), nhel, den(10))
    call cont_QA(nsync, wf16(:,3), wf8(:,4), A(:,3), n3(:,40), t3x128(:,:,3), nhel, den(14))
    call cont_QA(nsync, wf16(:,3), wf8(:,6), A(:,4), n3(:,41), t3x128(:,:,4), nhel, den(16))
    call cont_SS(nsync, wf8(:,7), wf16(:,4), A(:,5), n3(:,42), t3x128(:,:,5), nhel, den(20))
    call cont_QA(nsync, wf16(:,5), wf8(:,9), A(:,6), n3(:,43), t3x128(:,:,6), nhel, den(25))
    call cont_QA(nsync, wf8(:,9), wf16(:,6), A(:,7), n3(:,44), t3x128(:,:,7), nhel, den(27))
    call cont_QA(nsync, wf16(:,7), wf8(:,11), A(:,8), n3(:,45), t3x128(:,:,8), nhel, den(31))
    call cont_QA(nsync, wf16(:,7), wf8(:,13), A(:,9), n3(:,46), t3x128(:,:,9), nhel, den(33))
    call cont_SS(nsync, wf16(:,4), wf8(:,14), A(:,10), n3(:,47), t3x128(:,:,10), nhel, den(35))
    call cont_QA(nsync, wf8(:,4), wf16(:,8), A(:,11), n3(:,48), t3x128(:,:,11), nhel, den(36))
    call cont_QA(nsync, wf8(:,6), wf16(:,8), A(:,12), n3(:,49), t3x128(:,:,12), nhel, den(37))
    call cont_QA(nsync, wf8(:,2), wf16(:,9), A(:,13), n3(:,50), t3x128(:,:,13), nhel, den(38))
    call cont_QA(nsync, wf8(:,2), wf16(:,10), A(:,14), n3(:,51), t3x128(:,:,14), nhel, den(39))
    call cont_VV(nsync, wf8(:,16), wf16(:,11), A(:,15), n3(:,52), t3x128(:,:,15), nhel, den(44))
    call cont_VV(nsync, wf8(:,19), wf16(:,12), A(:,16), n3(:,53), t3x128(:,:,16), nhel, den(47))
    call cont_VV(nsync, wf8(:,16), wf16(:,13), A(:,17), n3(:,54), t3x128(:,:,17), nhel, den(50))
    call cont_VV(nsync, wf8(:,19), wf16(:,14), A(:,18), n3(:,55), t3x128(:,:,18), nhel, den(51))
    call cont_VV(nsync, wf16(:,11), wf8(:,22), A(:,19), n3(:,56), t3x128(:,:,19), nhel, den(53))
    call cont_VV(nsync, wf16(:,12), wf8(:,24), A(:,20), n3(:,57), t3x128(:,:,20), nhel, den(55))
    call cont_VV(nsync, wf16(:,13), wf8(:,22), A(:,21), n3(:,58), t3x128(:,:,21), nhel, den(56))
    call cont_VV(nsync, wf16(:,14), wf8(:,24), A(:,22), n3(:,59), t3x128(:,:,22), nhel, den(57))
    call cont_VV(nsync, wf8(:,19), wf16(:,15), A(:,23), n3(:,60), t3x128(:,:,23), nhel, den(60))
    call cont_VV(nsync, wf8(:,19), wf16(:,16), A(:,24), n3(:,61), t3x128(:,:,24), nhel, den(63))
    call cont_VV(nsync, wf8(:,24), wf16(:,15), A(:,25), n3(:,62), t3x128(:,:,25), nhel, den(64))
    call cont_VV(nsync, wf8(:,24), wf16(:,16), A(:,26), n3(:,63), t3x128(:,:,26), nhel, den(65))
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = (A(j,1)%j+A(j,3)%j+A(j,6)%j+A(j,8)%j+A(j,11)%j+A(j,13)%j+A(j,15)%j+A(j,17)%j+A(j,19)%j+A(j,21)%j)*f(1)+(A(j,2)%j &
       +A(j,4)%j+A(j,7)%j+A(j,9)%j+A(j,12)%j+A(j,14)%j+A(j,16)%j+A(j,18)%j+A(j,20)%j+A(j,22)%j+A(j,23)%j+A(j,24)%j+A(j,25)%j &
       +A(j,26)%j)*f(2)+(-A(j,5)%j-A(j,10)%j)*f(3)
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllll_nmnmxeexbbxg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllll_nmnmxeexbbxg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllll_nmnmxeexbbxg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllll_nmnmxeexbbxg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllll_nmnmxeexbbxg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllll_nmnmxeexbbxg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllll_nmnmxeexbbxg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllll_nmnmxeexbbxg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllll_nmnmxeexbbxg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllll_nmnmxeexbbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllll_nmnmxeexbbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllll_nmnmxeexbbxg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllll_nmnmxeexbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllll_nmnmxeexbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllll_nmnmxeexbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllll_nmnmxeexbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllll_nmnmxeexbbxg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppllll_nmnmxeexbbxg_1_/**/REALKIND
