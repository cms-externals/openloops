...
module ol_colourmatrix_ppllll_nmnmxeexuux_1_/**/REALKIND
...
end module ol_colourmatrix_ppllll_nmnmxeexuux_1_/**/REALKIND



module ol_forced_parameters_ppllll_nmnmxeexuux_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllll_nmnmxeexuux_1_/**/REALKIND

module ol_loop_ppllll_nmnmxeexuux_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(7) = (2*eQED**4*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,8),wf(:,34))
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,3),wf(:,35))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,36))
  call prop_A_Q(wf(:,11),Q(:,35),ZERO,0_intkind1,wf(:,37))
  call counter_ZQ_A(gZu,wf(:,8),wf(:,-4),wf(:,38))
  call counter_ZQ_A(gZu,wf(:,3),wf(:,-4),wf(:,39))
  ...
  call counter_QA_Z(gZu,wf(:,-4),wf(:,-5),wf(:,44))
...
end module ol_loop_ppllll_nmnmxeexuux_1_/**/REALKIND
