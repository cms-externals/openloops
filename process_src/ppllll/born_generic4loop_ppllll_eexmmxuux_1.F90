...
! **********************************************************************
module ol_heltables_ppllll_eexmmxuux_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(15), n3(3,54)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x4(2,4,6), t3x8(2,8,24), t3x64(2,64,24)
...
! **********************************************************************
  ...
  call heltable([4,2,8], n3(:,23), t3x8(:,:,17))
  call heltable([2,4,8], n3(:,24), t3x8(:,:,18))
  n2(12) = 8
  call heltable([2,4,8], n3(:,25), t3x8(:,:,19))
  call heltable([4,2,8], n3(:,26), t3x8(:,:,20))
  n2(13) = 8
  call heltable([4,2,8], n3(:,27), t3x8(:,:,21))
  call heltable([2,4,8], n3(:,28), t3x8(:,:,22))
  n2(14) = 8
  call heltable([2,4,8], n3(:,29), t3x8(:,:,23))
  call heltable([4,2,8], n3(:,30), t3x8(:,:,24))
  n2(15) = 8
  ...
  call heltable([8,8,64], n3(:,39), t3x64(:,:,9))
  call heltable([8,8,64], n3(:,40), t3x64(:,:,10))
  ...
  call heltable([8,8,64], n3(:,50), t3x64(:,:,20))
  call heltable([8,8,64], n3(:,51), t3x64(:,:,21))
  call heltable([8,8,64], n3(:,52), t3x64(:,:,22))
  call heltable([8,8,64], n3(:,53), t3x64(:,:,23))
  call heltable([8,8,64], n3(:,54), t3x64(:,:,24))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_ppllll_eexmmxuux_1
