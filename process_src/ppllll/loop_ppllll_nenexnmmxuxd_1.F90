...
module ol_colourmatrix_ppllll_nenexnmmxuxd_1_/**/REALKIND
...
end module ol_colourmatrix_ppllll_nenexnmmxuxd_1_/**/REALKIND



module ol_forced_parameters_ppllll_nenexnmmxuxd_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllll_nenexnmmxuxd_1_/**/REALKIND

module ol_loop_ppllll_nenexnmmxuxd_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_UV_W(wf(:,4),Q(:,3),wf(:,5),Q(:,12),wf(:,7))
  call vert_AZ_Q(gZu,wf(:,-4),wf(:,4),wf(:,8))
  call vert_WQ_A(wf(:,5),wf(:,-5),wf(:,9))
  call prop_A_Q(wf(:,8),Q(:,19),ZERO,0_intkind1,wf(:,10))
  call vert_AW_Q(wf(:,-4),wf(:,5),wf(:,11))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,-5),wf(:,12))
  call prop_A_Q(wf(:,11),Q(:,28),ZERO,0_intkind1,wf(:,13))
  call vert_ZQ_A(gZn,wf(:,4),wf(:,-2),wf(:,14))
  call vert_AW_Q(wf(:,-3),wf(:,6),wf(:,15))
  call prop_Q_A(wf(:,14),Q(:,7),ZERO,0_intkind1,wf(:,16))
  call vert_WQ_A(wf(:,6),wf(:,-2),wf(:,17))
  call vert_AZ_Q(gZl,wf(:,-3),wf(:,4),wf(:,18))
  call prop_Q_A(wf(:,17),Q(:,52),ZERO,0_intkind1,wf(:,19))
  call vert_WQ_A(wf(:,6),wf(:,0),wf(:,20))
  call vert_AW_Q(wf(:,-1),wf(:,5),wf(:,21))
  call prop_Q_A(wf(:,20),Q(:,49),ZERO,0_intkind1,wf(:,22))
  call counter_WQ_A(wf(:,5),wf(:,-5),wf(:,23))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,-5),wf(:,24))
  call counter_AW_Q(wf(:,-4),wf(:,5),wf(:,25))
  call prop_Q_A(wf(:,12),Q(:,35),ZERO,0_intkind1,wf(:,26))
  call counter_AZ_Q(gZu,wf(:,-4),wf(:,4),wf(:,27))
  call prop_Q_A(wf(:,9),Q(:,44),ZERO,0_intkind1,wf(:,28))
  call counter_QA_W(wf(:,-5),wf(:,-4),wf(:,29))
  call prop_W_W(wf(:,29),Q(:,48),MW,1_intkind1,wf(:,30))
  call vert_AW_Q(wf(:,-3),wf(:,30),wf(:,31))
  call vert_WQ_A(wf(:,30),wf(:,-2),wf(:,32))
  call prop_Q_A(wf(:,32),Q(:,52),ZERO,0_intkind1,wf(:,33))
  call vert_WQ_A(wf(:,30),wf(:,0),wf(:,34))
  call prop_Q_A(wf(:,34),Q(:,49),ZERO,0_intkind1,wf(:,35))
  call counter_A_Q(ctqq,wf(:,10),Q(:,19),wf(:,36))
  call counter_A_Q(ctqq,wf(:,13),Q(:,28),wf(:,37))
  call prop_W_W(wf(:,7),Q(:,15),MW,1_intkind1,wf(:,38))
  call vert_QA_W(wf(:,16),wf(:,-3),wf(:,39))
  call prop_W_W(wf(:,39),Q(:,15),MW,1_intkind1,wf(:,40))
  call prop_A_Q(wf(:,18),Q(:,11),ZERO,0_intkind1,wf(:,41))
  call vert_QA_W(wf(:,-2),wf(:,41),wf(:,42))
  call prop_W_W(wf(:,42),Q(:,15),MW,1_intkind1,wf(:,43))
  call prop_A_Q(wf(:,21),Q(:,14),ZERO,0_intkind1,wf(:,44))
...
end module ol_loop_ppllll_nenexnmmxuxd_1_/**/REALKIND
