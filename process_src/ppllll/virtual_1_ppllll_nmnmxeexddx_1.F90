...
module ol_vamp_1_ppllll_nmnmxeexddx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nmnmxeexddx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nmnmxeexddx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nmnmxeexddx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nmnmxeexddx_1_/**/REALKIND
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,3),G1(:,:,:,4),gZd)
  ...
  call loop_A_Q(G1(:,:,:,12),Q(:,47),ZERO,G2(:,:,:,14))
  call check_last_AQ_V(l_switch,G2(:,:,:,14),wf(:,-4),G2tensor(:,11))
  call loop_AZ_Q(G1(:,:,:,11),wf(:,8),G1(:,:,:,13),gZd)
  call loop_A_Q(G1(:,:,:,13),Q(:,47),ZERO,G2(:,:,:,15))
  call check_last_AQ_V(l_switch,G2(:,:,:,15),wf(:,-4),G2tensor(:,12))
  call check_last_AQ_V(l_switch,G1(:,:,:,11),wf(:,12),G1tensor(:,1))
  call check_last_AQ_V(l_switch,G1(:,:,:,11),wf(:,14),G1tensor(:,2))
  call loop_VA_Q(G0(:,:,:,1),wf(:,40),G0(:,:,:,4))
  call loop_A_Q(G0(:,:,:,4),Q(:,44),ZERO,G1(:,:,:,14))
  call loop_AZ_Q(G1(:,:,:,14),wf(:,3),G1(:,:,:,15),gZd)
  call loop_A_Q(G1(:,:,:,15),Q(:,47),ZERO,G2(:,:,:,16))
  call check_last_AQ_V(l_switch,G2(:,:,:,16),wf(:,-4),G2tensor(:,13))
  call check_last_AQ_V(l_switch,G1(:,:,:,14),wf(:,6),G1tensor(:,3))
  call loop_VA_Q(G0(:,:,:,1),wf(:,41),G0(:,:,:,5))
  call loop_A_Q(G0(:,:,:,5),Q(:,44),ZERO,G1(:,:,:,16))
  call loop_AZ_Q(G1(:,:,:,16),wf(:,3),G1(:,:,:,17),gZd)
  call loop_A_Q(G1(:,:,:,17),Q(:,47),ZERO,G2(:,:,:,17))
  call check_last_AQ_V(l_switch,G2(:,:,:,17),wf(:,-4),G2tensor(:,14))
  call check_last_AQ_V(l_switch,G1(:,:,:,16),wf(:,6),G1tensor(:,4))
...
end module ol_vamp_1_ppllll_nmnmxeexddx_1_/**/REALKIND
