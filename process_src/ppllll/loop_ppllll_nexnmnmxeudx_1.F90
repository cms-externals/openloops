...
module ol_colourmatrix_ppllll_nexnmnmxeudx_1_/**/REALKIND
...
end module ol_colourmatrix_ppllll_nexnmnmxeudx_1_/**/REALKIND



module ol_forced_parameters_ppllll_nexnmnmxeudx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllll_nexnmnmxeudx_1_/**/REALKIND

module ol_loop_ppllll_nexnmnmxeudx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_UV_W(wf(:,4),Q(:,9),wf(:,5),Q(:,6),wf(:,7))
  call vert_WQ_A(wf(:,4),wf(:,-4),wf(:,8))
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,5),wf(:,9))
  call prop_Q_A(wf(:,8),Q(:,25),ZERO,0_intkind1,wf(:,10))
  call vert_ZQ_A(gZu,wf(:,5),wf(:,-4),wf(:,11))
  call vert_AW_Q(wf(:,-5),wf(:,4),wf(:,12))
  call prop_Q_A(wf(:,11),Q(:,22),ZERO,0_intkind1,wf(:,13))
  call vert_AZ_Q(gZn,wf(:,0),wf(:,5),wf(:,14))
  call vert_WQ_A(wf(:,6),wf(:,-3),wf(:,15))
  call prop_A_Q(wf(:,14),Q(:,7),ZERO,0_intkind1,wf(:,16))
  call vert_AW_Q(wf(:,0),wf(:,6),wf(:,17))
  call vert_ZQ_A(gZl,wf(:,5),wf(:,-3),wf(:,18))
  call prop_A_Q(wf(:,17),Q(:,49),ZERO,0_intkind1,wf(:,19))
  call vert_WQ_A(wf(:,4),wf(:,-1),wf(:,20))
  call vert_AW_Q(wf(:,-2),wf(:,6),wf(:,21))
  call prop_Q_A(wf(:,20),Q(:,11),ZERO,0_intkind1,wf(:,22))
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,5),wf(:,23))
  call counter_AW_Q(wf(:,-5),wf(:,4),wf(:,24))
  call counter_ZQ_A(gZu,wf(:,5),wf(:,-4),wf(:,25))
  call prop_A_Q(wf(:,12),Q(:,41),ZERO,0_intkind1,wf(:,26))
  call counter_WQ_A(wf(:,4),wf(:,-4),wf(:,27))
  call prop_A_Q(wf(:,9),Q(:,38),ZERO,0_intkind1,wf(:,28))
  call counter_QA_W(wf(:,-4),wf(:,-5),wf(:,29))
  call prop_W_W(wf(:,29),Q(:,48),MW,1_intkind1,wf(:,30))
  call vert_WQ_A(wf(:,30),wf(:,-3),wf(:,31))
  call vert_AW_Q(wf(:,0),wf(:,30),wf(:,32))
  call prop_A_Q(wf(:,32),Q(:,49),ZERO,0_intkind1,wf(:,33))
  call vert_AW_Q(wf(:,-2),wf(:,30),wf(:,34))
  call counter_Q_A(ctqq,wf(:,10),Q(:,25),wf(:,35))
  call counter_Q_A(ctqq,wf(:,13),Q(:,22),wf(:,36))
  call prop_W_W(wf(:,7),Q(:,15),MW,1_intkind1,wf(:,37))
  call vert_QA_W(wf(:,-3),wf(:,16),wf(:,38))
  call prop_W_W(wf(:,38),Q(:,15),MW,1_intkind1,wf(:,39))
  call prop_Q_A(wf(:,18),Q(:,14),ZERO,0_intkind1,wf(:,40))
  call vert_QA_W(wf(:,40),wf(:,0),wf(:,41))
  call prop_W_W(wf(:,41),Q(:,15),MW,1_intkind1,wf(:,42))
  call vert_QA_W(wf(:,22),wf(:,-2),wf(:,43))
  call prop_W_W(wf(:,43),Q(:,15),MW,1_intkind1,wf(:,44))
...
subroutine diagrams(A)
  ...
  A(14) = cont_QA(wf(:,22),wf(:,34)) * den(20)
  A(15) = cont_QA(wf(:,28),wf(:,35)) * den(27)
  A(16) = cont_QA(wf(:,26),wf(:,36)) * den(28)
...
end module ol_loop_ppllll_nexnmnmxeudx_1_/**/REALKIND
