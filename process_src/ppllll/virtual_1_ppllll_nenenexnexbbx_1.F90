...
module ol_vamp_1_ppllll_nenenexnexbbx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nenenexnexbbx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nenenexnexbbx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nenenexnexbbx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nenenexnexbbx_1_/**/REALKIND
  ...
  call loop_A_Q(G1(:,:,:,3),Q(:,37),MB,G2(:,:,:,3))
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,70),G1(:,:,:,5),gZd)
  call loop_A_Q(G1(:,:,:,5),Q(:,47),MB,G2(:,:,:,6))
  call check_last_AQ_V(l_switch,G2(:,:,:,6),wf(:,-4),G2tensor(:,4))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,73),G1(:,:,:,6),gZd)
  call loop_A_Q(G1(:,:,:,6),Q(:,47),MB,G2(:,:,:,7))
  call check_last_AQ_V(l_switch,G2(:,:,:,7),wf(:,-4),G2tensor(:,5))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,24),G1(:,:,:,7),gZd)
  call loop_A_Q(G1(:,:,:,7),Q(:,38),MB,G2(:,:,:,8))
  call check_last_AQ_V(l_switch,G2(:,:,:,8),wf(:,28),G2tensor(:,6))
  call loop_AZ_Q(G2(:,:,:,8),wf(:,23),G2(:,:,:,9),gZd)
  call loop_A_Q(G2(:,:,:,9),Q(:,47),MB,G3(:,:,:,3))
  call check_last_AQ_V(l_switch,G3(:,:,:,3),wf(:,-4),G3tensor(:,3))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,23),G1(:,:,:,8),gZd)
  call loop_A_Q(G1(:,:,:,8),Q(:,41),MB,G2(:,:,:,10))
  call check_last_AQ_V(l_switch,G2(:,:,:,10),wf(:,31),G2tensor(:,7))
  call loop_AZ_Q(G2(:,:,:,10),wf(:,24),G2(:,:,:,11),gZd)
  call loop_A_Q(G2(:,:,:,11),Q(:,47),MB,G3(:,:,:,4))
  call check_last_AQ_V(l_switch,G3(:,:,:,4),wf(:,-4),G3tensor(:,4))
  call loop_AS_Q(G1(:,:,:,1),wf(:,25),G1(:,:,:,9),gH)
  call loop_A_Q(G1(:,:,:,9),Q(:,47),MB,G2(:,:,:,12))
  call check_last_AQ_V(l_switch,G2(:,:,:,12),wf(:,-4),G2tensor(:,8))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,75),G1(:,:,:,10),gZd)
  call loop_A_Q(G1(:,:,:,10),Q(:,47),MB,G2(:,:,:,13))
  call check_last_AQ_V(l_switch,G2(:,:,:,13),wf(:,-4),G2tensor(:,9))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,78),G1(:,:,:,11),gZd)
  call loop_A_Q(G1(:,:,:,11),Q(:,47),MB,G2(:,:,:,14))
  call check_last_AQ_V(l_switch,G2(:,:,:,14),wf(:,-4),G2tensor(:,10))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,80),G1(:,:,:,12),gZd)
  call loop_A_Q(G1(:,:,:,12),Q(:,47),MB,G2(:,:,:,15))
  call check_last_AQ_V(l_switch,G2(:,:,:,15),wf(:,-4),G2tensor(:,11))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,83),G1(:,:,:,13),gZd)
  call loop_A_Q(G1(:,:,:,13),Q(:,47),MB,G2(:,:,:,16))
  call check_last_AQ_V(l_switch,G2(:,:,:,16),wf(:,-4),G2tensor(:,12))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,85),G1(:,:,:,14),gZd)
  call loop_A_Q(G1(:,:,:,14),Q(:,47),MB,G2(:,:,:,17))
  call check_last_AQ_V(l_switch,G2(:,:,:,17),wf(:,-4),G2tensor(:,13))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,88),G1(:,:,:,15),gZd)
  call loop_A_Q(G1(:,:,:,15),Q(:,47),MB,G2(:,:,:,18))
  call check_last_AQ_V(l_switch,G2(:,:,:,18),wf(:,-4),G2tensor(:,14))
  call loop_VA_Q(G0(:,:,:,1),wf(:,47),G0(:,:,:,3))
  call loop_A_Q(G0(:,:,:,3),Q(:,37),MB,G1(:,:,:,16))
  call loop_AZ_Q(G1(:,:,:,16),wf(:,5),G1(:,:,:,17),gZd)
  call loop_A_Q(G1(:,:,:,17),Q(:,47),MB,G2(:,:,:,19))
  call check_last_AQ_V(l_switch,G2(:,:,:,19),wf(:,-4),G2tensor(:,15))
  call check_last_AQ_V(l_switch,G1(:,:,:,16),wf(:,12),G1tensor(:,1))
  call loop_VA_Q(G0(:,:,:,1),wf(:,49),G0(:,:,:,4))
  call loop_A_Q(G0(:,:,:,4),Q(:,42),MB,G1(:,:,:,18))
  call loop_AZ_Q(G1(:,:,:,18),wf(:,4),G1(:,:,:,19),gZd)
  call loop_A_Q(G1(:,:,:,19),Q(:,47),MB,G2(:,:,:,20))
  call check_last_AQ_V(l_switch,G2(:,:,:,20),wf(:,-4),G2tensor(:,16))
  call check_last_AQ_V(l_switch,G1(:,:,:,18),wf(:,9),G1tensor(:,2))
  call loop_VA_Q(G0(:,:,:,1),wf(:,59),G0(:,:,:,5))
  call loop_A_Q(G0(:,:,:,5),Q(:,41),MB,G1(:,:,:,20))
  call loop_AZ_Q(G1(:,:,:,20),wf(:,24),G1(:,:,:,21),gZd)
  call loop_A_Q(G1(:,:,:,21),Q(:,47),MB,G2(:,:,:,21))
  call check_last_AQ_V(l_switch,G2(:,:,:,21),wf(:,-4),G2tensor(:,17))
  call check_last_AQ_V(l_switch,G1(:,:,:,20),wf(:,31),G1tensor(:,3))
  call loop_VA_Q(G0(:,:,:,1),wf(:,61),G0(:,:,:,6))
  call loop_A_Q(G0(:,:,:,6),Q(:,38),MB,G1(:,:,:,22))
  call loop_AZ_Q(G1(:,:,:,22),wf(:,23),G1(:,:,:,23),gZd)
  call loop_A_Q(G1(:,:,:,23),Q(:,47),MB,G2(:,:,:,22))
  call check_last_AQ_V(l_switch,G2(:,:,:,22),wf(:,-4),G2tensor(:,18))
  call check_last_AQ_V(l_switch,G1(:,:,:,22),wf(:,28),G1tensor(:,4))
...
end module ol_vamp_1_ppllll_nenenexnexbbx_1_/**/REALKIND
