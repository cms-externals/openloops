...
module ol_vamp_1_ppllll_nenmnmxexuxd_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nenmnmxexuxd_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nenmnmxexuxd_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nenmnmxexuxd_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nenmnmxexuxd_1_/**/REALKIND
  ...
  call loop_Q_A(G1(:,:,:,3),Q(:,41),ZERO,G2(:,:,:,3))
  call check_last_QA_V(l_switch,G2(:,:,:,3),wf(:,13),G2tensor(:,2))
  call loop_QZ_A(G2(:,:,:,3),wf(:,5),G2(:,:,:,4),gZu)
  ...
  call loop_Q_A(G0(:,:,:,3),Q(:,41),ZERO,G1(:,:,:,8))
  call loop_QZ_A(G1(:,:,:,8),wf(:,5),G1(:,:,:,9),gZu)
  ...
  call loop_Q_A(G0(:,:,:,4),Q(:,38),ZERO,G1(:,:,:,10))
...
end module ol_vamp_1_ppllll_nenmnmxexuxd_1_/**/REALKIND
