...
! **********************************************************************
...
#endif
  use ol_loop_ppllll_eexmmxuux_1_/**/REALKIND, only: c, f, wf, den
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,79),G1(:,:,:,7),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,82),G1(:,:,:,9),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,86),G1(:,:,:,11),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,90),G1(:,:,:,13),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,93),G1(:,:,:,15),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,22),wf(:,7),G1(:,:,:,24),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,25),wf(:,7),G1(:,:,:,27),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,31),wf(:,10),G1(:,:,:,33),gZu)
