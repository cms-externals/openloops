...
! **********************************************************************
module ol_tensor_sum_storage_ppllll_nenexeexuux_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllll_nenexeexuux_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllll_nenexeexuux_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppllll_nenexeexuux_1, only: channel_number_ppllll_nenexeexuux_1
  ...
  call channel_on(channel_number_ppllll_nenexeexuux_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,35)
  momenta_2(:,1) = Q(1:4,41)
  ...
  call TI_call(2, momenta_4, masses2_2, T2sum(:,3), M2)
  ...
  call TI_call(2, momenta_5, masses2_2, T2sum(:,7), M2)

  call TI_call(3, momenta_13, masses2_3, T3sum(:,1), M2)
  call TI_call(3, momenta_11, masses2_3, T3sum(:,2), M2)
  call TI_call(3, momenta_12, masses2_3, T3sum(:,3), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppllll_nenexeexuux_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllll_nenexeexuux_1_/**/REALKIND
