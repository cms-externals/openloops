...
module ol_colourmatrix_ppllll_eeexexddx_1_/**/REALKIND
...
end module ol_colourmatrix_ppllll_eeexexddx_1_/**/REALKIND



module ol_forced_parameters_ppllll_eeexexddx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllll_eeexexddx_1_/**/REALKIND

module ol_loop_ppllll_eeexexddx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,40),wf(:,-4),wf(:,49))
  call prop_Q_A(wf(:,49),Q(:,22),ZERO,0_intkind1,wf(:,50))
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,43),wf(:,51))
  ...
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,7),wf(:,77))
  call counter_AV_Q(wf(:,-5),wf(:,1),wf(:,78))
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,10),wf(:,79))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,80))
  call prop_A_Q(wf(:,14),Q(:,37),ZERO,0_intkind1,wf(:,81))
  call counter_ZQ_A(gZd,wf(:,7),wf(:,-4),wf(:,82))
  ...
  call counter_ZQ_A(gZd,wf(:,10),wf(:,-4),wf(:,87))
  call counter_QA_V(wf(:,-4),wf(:,-5),wf(:,88))
  call vert_AV_Q(wf(:,-3),wf(:,88),wf(:,89))
  call counter_QA_Z(gZd,wf(:,-4),wf(:,-5),wf(:,90))
  ...
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,40),wf(:,98))
  call counter_AV_Q(wf(:,-5),wf(:,34),wf(:,99))
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,43),wf(:,100))
  call counter_VQ_A(wf(:,35),wf(:,-4),wf(:,101))
  call prop_A_Q(wf(:,47),Q(:,41),ZERO,0_intkind1,wf(:,102))
  call counter_ZQ_A(gZd,wf(:,40),wf(:,-4),wf(:,103))
  ...
  call counter_ZQ_A(gZd,wf(:,43),wf(:,-4),wf(:,108))
...
end module ol_loop_ppllll_eeexexddx_1_/**/REALKIND
