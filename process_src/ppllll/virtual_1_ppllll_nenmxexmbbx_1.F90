...
module ol_vamp_1_ppllll_nenmxexmbbx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nenmxexmbbx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nenmxexmbbx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nenmxexmbbx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nenmxexmbbx_1_/**/REALKIND
  ...
  complex(REALKIND), dimension(4,5,4,13) :: G1
  ...
  call loop_A_Q(G1(:,:,:,2),Q(:,42),MT,G2(:,:,:,1))
  call check_last_AQ_V(l_switch,G2(:,:,:,1),wf(:,13),G2tensor(:,1))
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,56),G1(:,:,:,11),gZd)
  call loop_A_Q(G1(:,:,:,11),Q(:,47),MB,G2(:,:,:,11))
  call check_last_AQ_V(l_switch,G2(:,:,:,11),wf(:,-4),G2tensor(:,10))
  call loop_VA_Q(G0(:,:,:,1),wf(:,30),G0(:,:,:,3))
  call loop_A_Q(G0(:,:,:,3),Q(:,42),MT,G1(:,:,:,12))
  call loop_AW_Q(G1(:,:,:,12),wf(:,4),G1(:,:,:,13))
  call loop_A_Q(G1(:,:,:,13),Q(:,47),MB,G2(:,:,:,12))
  call check_last_AQ_V(l_switch,G2(:,:,:,12),wf(:,-4),G2tensor(:,11))
  call check_last_AQ_V(l_switch,G1(:,:,:,12),wf(:,13),G1tensor(:,1))
...
end module ol_vamp_1_ppllll_nenmxexmbbx_1_/**/REALKIND
