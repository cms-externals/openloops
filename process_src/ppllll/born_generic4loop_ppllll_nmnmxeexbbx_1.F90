...
! **********************************************************************
module ol_heltables_ppllll_nmnmxeexbbx_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(11), n3(3,34)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x16(2,16,1), t3x4(2,4,6), t3x64(2,64,11), t3x8(2,8,16)
...
! **********************************************************************
  ...
  n2(11) = 8
  call heltable([4,16,64], n3(:,24), t3x64(:,:,1))
  call heltable([8,8,64], n3(:,25), t3x64(:,:,2))
  call heltable([8,8,64], n3(:,26), t3x64(:,:,3))
  call heltable([8,8,64], n3(:,27), t3x64(:,:,4))
  call heltable([8,8,64], n3(:,28), t3x64(:,:,5))
  call heltable([8,8,64], n3(:,29), t3x64(:,:,6))
  call heltable([8,8,64], n3(:,30), t3x64(:,:,7))
  call heltable([8,8,64], n3(:,31), t3x64(:,:,8))
  call heltable([8,8,64], n3(:,32), t3x64(:,:,9))
  call heltable([8,8,64], n3(:,33), t3x64(:,:,10))
  call heltable([8,8,64], n3(:,34), t3x64(:,:,11))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_ppllll_nmnmxeexbbx_1
