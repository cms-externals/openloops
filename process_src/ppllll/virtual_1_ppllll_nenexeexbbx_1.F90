...
module ol_vamp_1_ppllll_nenexeexbbx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllll_nenexeexbbx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllll_nenexeexbbx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllll_nenexeexbbx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllll_nenexeexbbx_1_/**/REALKIND
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,83),G1(:,:,:,7),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,87),G1(:,:,:,9),gZd)
  call loop_A_Q(G1(:,:,:,9),Q(:,47),MB,G2(:,:,:,12))
  call check_last_AQ_V(l_switch,G2(:,:,:,12),wf(:,-4),G2tensor(:,9))
  call loop_AW_Q(G1(:,:,:,1),wf(:,32),G1(:,:,:,10))
  call loop_A_Q(G1(:,:,:,10),Q(:,38),MT,G2(:,:,:,13))
  call check_last_AQ_V(l_switch,G2(:,:,:,13),wf(:,37),G2tensor(:,10))
  call loop_AW_Q(G2(:,:,:,13),wf(:,31),G2(:,:,:,14))
  call loop_A_Q(G2(:,:,:,14),Q(:,47),MB,G3(:,:,:,5))
  call check_last_AQ_V(l_switch,G3(:,:,:,5),wf(:,-4),G3tensor(:,5))
  call loop_AS_Q(G1(:,:,:,1),wf(:,33),G1(:,:,:,11),gH)
  call loop_A_Q(G1(:,:,:,11),Q(:,47),MB,G2(:,:,:,15))
  call check_last_AQ_V(l_switch,G2(:,:,:,15),wf(:,-4),G2tensor(:,11))
  call loop_AV_Q(G1(:,:,:,1),wf(:,34),G1(:,:,:,12))
  call loop_A_Q(G1(:,:,:,12),Q(:,47),MB,G2(:,:,:,16))
  call check_last_AQ_V(l_switch,G2(:,:,:,16),wf(:,-4),G2tensor(:,12))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,88),G1(:,:,:,13),gZd)
  call loop_A_Q(G1(:,:,:,13),Q(:,47),MB,G2(:,:,:,17))
  call check_last_AQ_V(l_switch,G2(:,:,:,17),wf(:,-4),G2tensor(:,13))
  call loop_AV_Q(G1(:,:,:,1),wf(:,89),G1(:,:,:,14))
  call loop_A_Q(G1(:,:,:,14),Q(:,47),MB,G2(:,:,:,18))
  call check_last_AQ_V(l_switch,G2(:,:,:,18),wf(:,-4),G2tensor(:,14))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,91),G1(:,:,:,15),gZd)
  call loop_A_Q(G1(:,:,:,15),Q(:,47),MB,G2(:,:,:,19))
  call check_last_AQ_V(l_switch,G2(:,:,:,19),wf(:,-4),G2tensor(:,15))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,94),G1(:,:,:,16),gZd)
  call loop_A_Q(G1(:,:,:,16),Q(:,47),MB,G2(:,:,:,20))
  call check_last_AQ_V(l_switch,G2(:,:,:,20),wf(:,-4),G2tensor(:,16))
  call loop_AV_Q(G1(:,:,:,1),wf(:,95),G1(:,:,:,17))
  call loop_A_Q(G1(:,:,:,17),Q(:,47),MB,G2(:,:,:,21))
  call check_last_AQ_V(l_switch,G2(:,:,:,21),wf(:,-4),G2tensor(:,17))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,97),G1(:,:,:,18),gZd)
  call loop_A_Q(G1(:,:,:,18),Q(:,47),MB,G2(:,:,:,22))
  call check_last_AQ_V(l_switch,G2(:,:,:,22),wf(:,-4),G2tensor(:,18))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,100),G1(:,:,:,19),gZd)
  call loop_A_Q(G1(:,:,:,19),Q(:,47),MB,G2(:,:,:,23))
  call check_last_AQ_V(l_switch,G2(:,:,:,23),wf(:,-4),G2tensor(:,19))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,102),G1(:,:,:,20),gZd)
  call loop_A_Q(G1(:,:,:,20),Q(:,47),MB,G2(:,:,:,24))
  call check_last_AQ_V(l_switch,G2(:,:,:,24),wf(:,-4),G2tensor(:,20))
  call loop_AZ_Q(G1(:,:,:,1),wf(:,105),G1(:,:,:,21),gZd)
  call loop_A_Q(G1(:,:,:,21),Q(:,47),MB,G2(:,:,:,25))
  ...
  call loop_A_Q(G1(:,:,:,23),Q(:,47),MB,G2(:,:,:,26))
  call check_last_AQ_V(l_switch,G2(:,:,:,26),wf(:,-4),G2tensor(:,22))
  call loop_AZ_Q(G1(:,:,:,22),wf(:,5),G1(:,:,:,24),gZd)
  call loop_A_Q(G1(:,:,:,24),Q(:,47),MB,G2(:,:,:,27))
  call check_last_AQ_V(l_switch,G2(:,:,:,27),wf(:,-4),G2tensor(:,23))
  call check_last_AQ_V(l_switch,G1(:,:,:,22),wf(:,14),G1tensor(:,1))
  call check_last_AQ_V(l_switch,G1(:,:,:,22),wf(:,16),G1tensor(:,2))
  call loop_VA_Q(G0(:,:,:,1),wf(:,58),G0(:,:,:,4))
  call loop_A_Q(G0(:,:,:,4),Q(:,44),MB,G1(:,:,:,25))
  call loop_AZ_Q(G1(:,:,:,25),wf(:,4),G1(:,:,:,26),gZd)
  call loop_A_Q(G1(:,:,:,26),Q(:,47),MB,G2(:,:,:,28))
  call check_last_AQ_V(l_switch,G2(:,:,:,28),wf(:,-4),G2tensor(:,24))
  call check_last_AQ_V(l_switch,G1(:,:,:,25),wf(:,10),G1tensor(:,3))
  call loop_VA_Q(G0(:,:,:,1),wf(:,59),G0(:,:,:,5))
  call loop_A_Q(G0(:,:,:,5),Q(:,44),MB,G1(:,:,:,27))
  call loop_AZ_Q(G1(:,:,:,27),wf(:,4),G1(:,:,:,28),gZd)
  call loop_A_Q(G1(:,:,:,28),Q(:,47),MB,G2(:,:,:,29))
  call check_last_AQ_V(l_switch,G2(:,:,:,29),wf(:,-4),G2tensor(:,25))
  call check_last_AQ_V(l_switch,G1(:,:,:,27),wf(:,10),G1tensor(:,4))
  call loop_VA_Q(G0(:,:,:,1),wf(:,72),G0(:,:,:,6))
  call loop_A_Q(G0(:,:,:,6),Q(:,38),MT,G1(:,:,:,29))
  call loop_AW_Q(G1(:,:,:,29),wf(:,31),G1(:,:,:,30))
  call loop_A_Q(G1(:,:,:,30),Q(:,47),MB,G2(:,:,:,30))
  call check_last_AQ_V(l_switch,G2(:,:,:,30),wf(:,-4),G2tensor(:,26))
  call check_last_AQ_V(l_switch,G1(:,:,:,29),wf(:,37),G1tensor(:,5))
...
end module ol_vamp_1_ppllll_nenexeexbbx_1_/**/REALKIND
