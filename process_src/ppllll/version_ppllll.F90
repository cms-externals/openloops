...
module ol_versiondata_ppllll
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppllll(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllll
  end interface
end module ol_versiondata_ppllll


subroutine ol_version_ppllll(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllll, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllll
