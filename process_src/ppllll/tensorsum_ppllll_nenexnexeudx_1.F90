...
! **********************************************************************
module ol_tensor_sum_storage_ppllll_nenexnexeudx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllll_nenexnexeudx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllll_nenexnexeudx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppllll_nenexnexeudx_1, only: channel_number_ppllll_nenexnexeudx_1
  ...
  call channel_on(channel_number_ppllll_nenexnexeudx_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,35)
  momenta_2(:,1) = Q(1:4,37)
  momenta_3(:,1) = Q(1:4,42)
  momenta_4(:,1) = Q(1:4,44)
  momenta_5(:,1) = Q(1:4,32)
  momenta_5(:,2) = Q(1:4,35)
  momenta_6(:,1) = Q(1:4,32)
  momenta_6(:,2) = Q(1:4,37)
  momenta_7(:,1) = Q(1:4,32)
  momenta_7(:,2) = Q(1:4,42)
  ...
  momenta_11(:,1) = Q(1:4,37)
  momenta_11(:,2) = Q(1:4,47)
  momenta_12(:,1) = Q(1:4,42)
  ...
  call TI_call(2, momenta_6, masses2_2, T2sum(:,8), M2)
  ...
  call TI_call(3, momenta_16, masses2_3, T3sum(:,3), M2)
  call TI_call(3, momenta_15, masses2_3, T3sum(:,4), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppllll_nenexnexeudx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllll_nenexnexeudx_1_/**/REALKIND
