...
! **********************************************************************
module ol_tensor_sum_storage_ppllll_nexnmemxbbx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllll_nexnmemxbbx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllll_nexnmemxbbx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppllll_nexnmemxbbx_1, only: channel_number_ppllll_nexnmemxbbx_1
  ...
  call channel_on(channel_number_ppllll_nexnmemxbbx_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,37)
  momenta_2(:,1) = Q(1:4,32)
  momenta_2(:,2) = Q(1:4,37)
  ...
  call TI_call(2, momenta_2, masses2_3, T2sum(:,2), M2)
  ...
  call channel_off(channel_number_ppllll_nexnmemxbbx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllll_nexnmemxbbx_1_/**/REALKIND
