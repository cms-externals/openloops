...
module ol_colourmatrix_ppllll_nenexnmnmxuux_1_/**/REALKIND
...
end module ol_colourmatrix_ppllll_nenexnmnmxuux_1_/**/REALKIND



module ol_forced_parameters_ppllll_nenexnmnmxuux_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllll_nenexnmnmxuux_1_/**/REALKIND

module ol_loop_ppllll_nenexnmnmxuux_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,4),wf(:,25))
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,3),wf(:,26))
  call counter_ZQ_A(gZu,wf(:,4),wf(:,-4),wf(:,27))
  call prop_A_Q(wf(:,9),Q(:,35),ZERO,0_intkind1,wf(:,28))
  call counter_ZQ_A(gZu,wf(:,3),wf(:,-4),wf(:,29))
  call prop_A_Q(wf(:,6),Q(:,44),ZERO,0_intkind1,wf(:,30))
  call counter_QA_Z(gZu,wf(:,-4),wf(:,-5),wf(:,31))
...
end module ol_loop_ppllll_nenexnmnmxuux_1_/**/REALKIND
