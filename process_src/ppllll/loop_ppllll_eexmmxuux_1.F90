...
module ol_colourmatrix_ppllll_eexmmxuux_1_/**/REALKIND
...
end module ol_colourmatrix_ppllll_eexmmxuux_1_/**/REALKIND



module ol_forced_parameters_ppllll_eexmmxuux_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllll_eexmmxuux_1_/**/REALKIND

module ol_loop_ppllll_eexmmxuux_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,7),wf(:,47))
  call counter_AV_Q(wf(:,-5),wf(:,1),wf(:,48))
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,10),wf(:,49))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,50))
  call prop_A_Q(wf(:,14),Q(:,35),ZERO,0_intkind1,wf(:,51))
  call counter_ZQ_A(gZu,wf(:,7),wf(:,-4),wf(:,52))
  ...
  call counter_ZQ_A(gZu,wf(:,10),wf(:,-4),wf(:,57))
  call counter_QA_V(wf(:,-4),wf(:,-5),wf(:,58))
  call vert_AV_Q(wf(:,-3),wf(:,58),wf(:,59))
  call counter_QA_Z(gZu,wf(:,-4),wf(:,-5),wf(:,60))
...
end module ol_loop_ppllll_eexmmxuux_1_/**/REALKIND
