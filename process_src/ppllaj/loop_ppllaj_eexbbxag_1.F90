...
module ol_colourmatrix_ppllaj_eexbbxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppllaj_eexbbxag_1_/**/REALKIND



module ol_forced_parameters_ppllaj_eexbbxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllaj_eexbbxag_1_/**/REALKIND

module ol_loop_ppllaj_eexbbxag_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 9) = (CI*countertermnorm*ctGbb*eQED**3*gQCD**3)/9._/**/REALKIND
    f(10) = (CI*countertermnorm*ctGbb*eQED**3*gQCD**3)/3._/**/REALKIND
    f(11) = CI*countertermnorm*ctGbb*eQED**3*gQCD**3
    f(12) = (CI*countertermnorm*ctVbb*eQED**3*gQCD**3)/9._/**/REALKIND
    f(13) = (CI*countertermnorm*ctVbb*eQED**3*gQCD**3)/3._/**/REALKIND
    f(14) = CI*countertermnorm*ctVbb*eQED**3*gQCD**3
...
! **********************************************************************
  ...
  call counter_Q_A(ctbb,wf(:,4),Q(:,20),wf(:,90))
  call prop_A_Q(wf(:,89),Q(:,43),MB,1_intkind1,wf(:,91))
  call vert_AZ_Q(gZd,wf(:,5),wf(:,8),wf(:,92))
  call prop_A_Q(wf(:,92),Q(:,43),MB,1_intkind1,wf(:,93))
  call counter_A_Q(ctbb,wf(:,5),Q(:,40),wf(:,94))
  call prop_Q_A(wf(:,6),Q(:,23),MB,1_intkind1,wf(:,95))
  call prop_Q_A(wf(:,9),Q(:,23),MB,1_intkind1,wf(:,96))
  call prop_Q_A(wf(:,90),Q(:,20),MB,1_intkind1,wf(:,97))
  call vert_VQ_A(wf(:,-5),wf(:,97),wf(:,98))
  call counter_A_Q(ctbb,wf(:,12),Q(:,11),wf(:,99))
  call counter_A_Q(ctbb,wf(:,14),Q(:,11),wf(:,100))
  call vert_AV_Q(wf(:,18),wf(:,1),wf(:,101))
  call counter_Q_A(ctbb,wf(:,17),Q(:,36),wf(:,102))
  call prop_A_Q(wf(:,101),Q(:,27),MB,1_intkind1,wf(:,103))
  call vert_AZ_Q(gZd,wf(:,18),wf(:,8),wf(:,104))
  call prop_A_Q(wf(:,104),Q(:,27),MB,1_intkind1,wf(:,105))
  call counter_A_Q(ctbb,wf(:,18),Q(:,24),wf(:,106))
  call prop_Q_A(wf(:,19),Q(:,39),MB,1_intkind1,wf(:,107))
  call prop_Q_A(wf(:,20),Q(:,39),MB,1_intkind1,wf(:,108))
  call counter_Q_A(ctbb,wf(:,23),Q(:,7),wf(:,109))
  call counter_Q_A(ctbb,wf(:,25),Q(:,7),wf(:,110))
  call prop_A_Q(wf(:,106),Q(:,24),MB,1_intkind1,wf(:,111))
  call vert_AV_Q(wf(:,111),wf(:,-5),wf(:,112))
  call prop_Q_A(wf(:,102),Q(:,36),MB,1_intkind1,wf(:,113))
  call vert_VQ_A(wf(:,-4),wf(:,113),wf(:,114))
  call prop_A_Q(wf(:,94),Q(:,40),MB,1_intkind1,wf(:,115))
  ...
  call prop_Q_A(wf(:,123),Q(:,23),MB,1_intkind1,wf(:,124))
  call vert_VQ_A(wf(:,-4),wf(:,25),wf(:,125))
  call prop_Q_A(wf(:,125),Q(:,23),MB,1_intkind1,wf(:,126))
  call vert_VQ_A(wf(:,-5),wf(:,23),wf(:,127))
  call prop_Q_A(wf(:,127),Q(:,39),MB,1_intkind1,wf(:,128))
  call vert_VQ_A(wf(:,-5),wf(:,25),wf(:,129))
  call prop_Q_A(wf(:,129),Q(:,39),MB,1_intkind1,wf(:,130))
  ...
  call prop_A_Q(wf(:,135),Q(:,27),MB,1_intkind1,wf(:,136))
  ...
  call prop_Q_A(wf(:,141),Q(:,23),MB,1_intkind1,wf(:,142))
  call vert_ZQ_A(gZd,wf(:,34),wf(:,-2),wf(:,143))
  call prop_Q_A(wf(:,143),Q(:,23),MB,1_intkind1,wf(:,144))
  call vert_AV_Q(wf(:,-3),wf(:,30),wf(:,145))
  call prop_A_Q(wf(:,145),Q(:,27),MB,1_intkind1,wf(:,146))
  call vert_AZ_Q(gZd,wf(:,-3),wf(:,34),wf(:,147))
  call prop_A_Q(wf(:,147),Q(:,27),MB,1_intkind1,wf(:,148))
  call vert_VQ_A(wf(:,39),wf(:,-2),wf(:,149))
  call prop_Q_A(wf(:,149),Q(:,23),MB,1_intkind1,wf(:,150))
  call vert_ZQ_A(gZd,wf(:,41),wf(:,-2),wf(:,151))
  call prop_Q_A(wf(:,151),Q(:,23),MB,1_intkind1,wf(:,152))
  call vert_AV_Q(wf(:,-3),wf(:,39),wf(:,153))
  call prop_A_Q(wf(:,153),Q(:,27),MB,1_intkind1,wf(:,154))
  call vert_AZ_Q(gZd,wf(:,-3),wf(:,41),wf(:,155))
  call prop_A_Q(wf(:,155),Q(:,27),MB,1_intkind1,wf(:,156))
...
end module ol_loop_ppllaj_eexbbxag_1_/**/REALKIND
