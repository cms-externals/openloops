...
module ol_colourmatrix_ppllaj_nenexbbxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppllaj_nenexbbxag_1_/**/REALKIND



module ol_forced_parameters_ppllaj_nenexbbxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllaj_nenexbbxag_1_/**/REALKIND

module ol_loop_ppllaj_nenexbbxag_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,9),Q(:,52),MB,1_intkind1,wf(:,33))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,34))
  call prop_A_Q(wf(:,34),Q(:,40),MB,1_intkind1,wf(:,35))
  call prop_Q_A(wf(:,19),Q(:,52),MB,1_intkind1,wf(:,36))
  call vert_AV_Q(wf(:,35),wf(:,-4),wf(:,37))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,38))
  call prop_A_Q(wf(:,38),Q(:,24),MB,1_intkind1,wf(:,39))
  call vert_AV_Q(wf(:,39),wf(:,-5),wf(:,40))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,-2),wf(:,41))
  call prop_A_Q(wf(:,17),Q(:,56),MB,1_intkind1,wf(:,42))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,43))
  call prop_Q_A(wf(:,43),Q(:,36),MB,1_intkind1,wf(:,44))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,44),wf(:,45))
  call prop_A_Q(wf(:,20),Q(:,56),MB,1_intkind1,wf(:,46))
  call vert_VQ_A(wf(:,-4),wf(:,44),wf(:,47))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,48))
  call prop_Q_A(wf(:,48),Q(:,20),MB,1_intkind1,wf(:,49))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,49),wf(:,50))
  call vert_VQ_A(wf(:,-5),wf(:,49),wf(:,51))
  call vert_AZ_Q(gZd,wf(:,6),wf(:,4),wf(:,52))
  call counter_Q_A(ctbb,wf(:,5),Q(:,20),wf(:,53))
  call prop_A_Q(wf(:,52),Q(:,43),MB,1_intkind1,wf(:,54))
  call counter_A_Q(ctbb,wf(:,6),Q(:,40),wf(:,55))
  call prop_Q_A(wf(:,7),Q(:,23),MB,1_intkind1,wf(:,56))
  call prop_Q_A(wf(:,53),Q(:,20),MB,1_intkind1,wf(:,57))
  call vert_VQ_A(wf(:,-5),wf(:,57),wf(:,58))
  call counter_A_Q(ctbb,wf(:,10),Q(:,11),wf(:,59))
  call vert_AZ_Q(gZd,wf(:,14),wf(:,4),wf(:,60))
  call counter_Q_A(ctbb,wf(:,13),Q(:,36),wf(:,61))
  call prop_A_Q(wf(:,60),Q(:,27),MB,1_intkind1,wf(:,62))
  call counter_A_Q(ctbb,wf(:,14),Q(:,24),wf(:,63))
  call prop_Q_A(wf(:,15),Q(:,39),MB,1_intkind1,wf(:,64))
  call counter_Q_A(ctbb,wf(:,18),Q(:,7),wf(:,65))
  call prop_A_Q(wf(:,63),Q(:,24),MB,1_intkind1,wf(:,66))
  call vert_AV_Q(wf(:,66),wf(:,-5),wf(:,67))
  call prop_Q_A(wf(:,61),Q(:,36),MB,1_intkind1,wf(:,68))
  call vert_VQ_A(wf(:,-4),wf(:,68),wf(:,69))
  call prop_A_Q(wf(:,55),Q(:,40),MB,1_intkind1,wf(:,70))
  call vert_AV_Q(wf(:,70),wf(:,-4),wf(:,71))
  call vert_QA_V(wf(:,18),wf(:,-3),wf(:,72))
  call vert_VQ_A(wf(:,-4),wf(:,18),wf(:,73))
  call prop_Q_A(wf(:,73),Q(:,23),MB,1_intkind1,wf(:,74))
  call vert_VQ_A(wf(:,-5),wf(:,18),wf(:,75))
  call prop_Q_A(wf(:,75),Q(:,39),MB,1_intkind1,wf(:,76))
  call vert_QA_V(wf(:,-2),wf(:,10),wf(:,77))
  call vert_AV_Q(wf(:,10),wf(:,-4),wf(:,78))
  call prop_A_Q(wf(:,78),Q(:,27),MB,1_intkind1,wf(:,79))
  call vert_AV_Q(wf(:,10),wf(:,-5),wf(:,80))
  call prop_A_Q(wf(:,80),Q(:,43),MB,1_intkind1,wf(:,81))
...
end module ol_loop_ppllaj_nenexbbxag_1_/**/REALKIND
