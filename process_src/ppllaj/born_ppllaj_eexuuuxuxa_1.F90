...
module ol_colourmatrix_ppllaj_eexuuuxuxa_1_/**/REALKIND
...
end module ol_colourmatrix_ppllaj_eexuuuxuxa_1_/**/REALKIND



module ol_forced_parameters_ppllaj_eexuuuxuxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllaj_eexuuuxuxa_1_/**/REALKIND

module ol_tree_ppllaj_eexuuuxuxa_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllaj_eexuuuxuxa_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllaj_eexuuuxuxa_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for e- e+ up up anti-up anti-up gamma -> 0
...
! **********************************************************************
  ...
  use ol_external_ppllaj_eexuuuxuxa_1, only: external_perm_ppllaj_eexuuuxuxa_1, &
    & external_perm_inv_ppllaj_eexuuuxuxa_1, extcomb_perm_ppllaj_eexuuuxuxa_1, &
    & average_factor_ppllaj_eexuuuxuxa_1
  use ol_external_ppllaj_eexuuuxuxa_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppllaj_eexuuuxuxa_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllaj_eexuuuxuxa_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppllaj_eexuuuxuxa_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppllaj_eexuuuxuxa_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllaj_eexuuuxuxa_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllaj_eexuuuxuxa_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllaj_eexuuuxuxa_1(extcombs(k))
  end do
  ...
  call prop_A_Q(ntry, wf8(:,13), Q(:,56), ZERO, 0_intkind1, wf8(:,14), n2(11))
  call vert_ZQ_A(gZu,ntry, wf4(:,6), wf4(:,11), wf16(:,12), n3(:,26), t3x16(:,:,12))
  call vert_VQ_A(ntry, wf4(:,1), ex3, wf8(:,15), n3(:,27), t3x8(:,:,8))
  call vert_AV_Q(ntry, wf4(:,8), wf4(:,10), wf16(:,13), n3(:,28), t3x16(:,:,13))
  call prop_Q_A(ntry, wf8(:,15), Q(:,7), ZERO, 0_intkind1, wf8(:,16), n2(12))
  call vert_ZQ_A(gZu,ntry, wf4(:,6), ex3, wf8(:,17), n3(:,29), t3x8(:,:,9))
  call prop_Q_A(ntry, wf8(:,17), Q(:,7), ZERO, 0_intkind1, wf8(:,18), n2(13))
  call vert_VQ_A(ntry, wf4(:,10), ex3, wf8(:,19), n3(:,30), t3x8(:,:,10))
  call prop_Q_A(ntry, wf8(:,19), Q(:,28), ZERO, 0_intkind1, wf8(:,20), n2(14))
  ...
  call prop_A_Q(ntry, wf8(:,21), Q(:,19), ZERO, 0_intkind1, wf8(:,22), n2(15))
  call vert_AZ_Q(gZu,ntry, ex5, wf4(:,6), wf8(:,23), n3(:,37), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,23), Q(:,19), ZERO, 0_intkind1, wf8(:,24), n2(16))
  call vert_AV_Q(ntry, ex5, wf4(:,12), wf8(:,25), n3(:,38), t3x8(:,:,13))
  call prop_A_Q(ntry, wf8(:,25), Q(:,52), ZERO, 0_intkind1, wf8(:,26), n2(17))
  ...
  call prop_Q_A(ntry, wf8(:,27), Q(:,44), ZERO, 0_intkind1, wf8(:,28), n2(19))
  call vert_AZ_Q(gZu,ntry, wf4(:,14), wf4(:,6), wf16(:,20), n3(:,43), t3x16(:,:,20))
  ...
  call prop_A_Q(ntry, wf8(:,29), Q(:,56), ZERO, 0_intkind1, wf8(:,30), n2(20))
  call vert_AV_Q(ntry, wf4(:,14), wf4(:,15), wf16(:,23), n3(:,48), t3x16(:,:,23))
  call vert_VQ_A(ntry, wf4(:,15), ex3, wf8(:,31), n3(:,49), t3x8(:,:,16))
  call prop_Q_A(ntry, wf8(:,31), Q(:,44), ZERO, 0_intkind1, wf8(:,32), n2(21))
  ...
  call vert_ZQ_A(gZu,ntry, wf8(:,43), ex4, wf16(:,46), n3(:,83), t3x16(:,:,46))
  call vert_AV_Q(ntry, ex6, wf8(:,41), wf16(:,47), n3(:,84), t3x16(:,:,47))
  call vert_AZ_Q(gZu,ntry, ex6, wf8(:,43), wf16(:,48), n3(:,85), t3x16(:,:,48))
  ...
  call vert_ZQ_A(gZu,ntry, wf8(:,46), ex4, wf16(:,50), n3(:,90), t3x16(:,:,50))
  call vert_AV_Q(ntry, ex6, wf8(:,44), wf16(:,51), n3(:,91), t3x16(:,:,51))
  call vert_AZ_Q(gZu,ntry, ex6, wf8(:,46), wf16(:,52), n3(:,92), t3x16(:,:,52))
  call vert_VQ_A(ntry, wf8(:,41), ex3, wf16(:,53), n3(:,93), t3x16(:,:,53))
  call vert_ZQ_A(gZu,ntry, wf8(:,43), ex3, wf16(:,54), n3(:,94), t3x16(:,:,54))
  call vert_VQ_A(ntry, wf8(:,44), ex3, wf16(:,55), n3(:,95), t3x16(:,:,55))
  call vert_ZQ_A(gZu,ntry, wf8(:,46), ex3, wf16(:,56), n3(:,96), t3x16(:,:,56))
  call vert_AV_Q(ntry, ex5, wf8(:,41), wf16(:,57), n3(:,97), t3x16(:,:,57))
  call vert_AZ_Q(gZu,ntry, ex5, wf8(:,43), wf16(:,58), n3(:,98), t3x16(:,:,58))
  call vert_AV_Q(ntry, ex5, wf8(:,44), wf16(:,59), n3(:,99), t3x16(:,:,59))
  call vert_AZ_Q(gZu,ntry, ex5, wf8(:,46), wf16(:,60), n3(:,100), t3x16(:,:,60))
  ...
  M2add = M2 / average_factor_ppllaj_eexuuuxuxa_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppllaj_eexuuuxuxa_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = ((A(j,1)%j+A(j,3)%j+A(j,5)%j+A(j,7)%j+A(j,9)%j+A(j,11)%j+A(j,37)%j+A(j,39)%j+A(j,41)%j+A(j,43)%j+A(j,45)%j+A(j,47)%j &
       ...
       -A(j,101)%j-A(j,103)%j)*f(2))/6._/**/REALKIND+((-A(j,2)%j-A(j,4)%j-A(j,6)%j-A(j,8)%j-A(j,10)%j-A(j,12)%j-A(j,38)%j &
       -A(j,40)%j-A(j,42)%j-A(j,44)%j-A(j,46)%j-A(j,48)%j-A(j,50)%j-A(j,56)%j-A(j,58)%j-A(j,62)%j-A(j,68)%j-A(j,70)%j-A(j,74)%j &
       -A(j,78)%j-A(j,81)%j-A(j,83)%j-A(j,85)%j-A(j,87)%j-A(j,105)%j-A(j,107)%j-A(j,109)%j-A(j,111)%j)*f(2))/2._/**/REALKIND &
       +((A(j,90)%j+A(j,92)%j+A(j,94)%j+A(j,96)%j+A(j,98)%j+A(j,100)%j+A(j,102)%j+A(j,104)%j)*f(3))/6._/**/REALKIND+((A(j,82)%j &
       +A(j,84)%j+A(j,86)%j+A(j,88)%j+A(j,106)%j+A(j,108)%j+A(j,110)%j+A(j,112)%j)*f(3))/2._/**/REALKIND
  M1(2) = ((-A(j,1)%j-A(j,3)%j-A(j,5)%j-A(j,7)%j-A(j,9)%j-A(j,11)%j-A(j,37)%j-A(j,39)%j-A(j,41)%j-A(j,43)%j-A(j,45)%j-A(j,47)%j &
       ...
       +A(j,18)%j+A(j,20)%j+A(j,22)%j+A(j,24)%j+A(j,26)%j+A(j,28)%j+A(j,30)%j+A(j,32)%j+A(j,34)%j+A(j,36)%j+A(j,52)%j+A(j,54)%j &
       +A(j,60)%j+A(j,64)%j+A(j,66)%j+A(j,72)%j+A(j,76)%j+A(j,80)%j+A(j,89)%j+A(j,91)%j+A(j,93)%j+A(j,95)%j+A(j,97)%j+A(j,99)%j &
       +A(j,101)%j+A(j,103)%j)*f(2))/2._/**/REALKIND+((A(j,2)%j+A(j,4)%j+A(j,6)%j+A(j,8)%j+A(j,10)%j+A(j,12)%j+A(j,38)%j+A(j,40)%j &
       +A(j,42)%j+A(j,44)%j+A(j,46)%j+A(j,48)%j+A(j,50)%j+A(j,56)%j+A(j,58)%j+A(j,62)%j+A(j,68)%j+A(j,70)%j+A(j,74)%j+A(j,78)%j &
       +A(j,81)%j+A(j,83)%j+A(j,85)%j+A(j,87)%j+A(j,105)%j+A(j,107)%j+A(j,109)%j+A(j,111)%j)*f(2))/6._/**/REALKIND+((-A(j,90)%j &
       -A(j,92)%j-A(j,94)%j-A(j,96)%j-A(j,98)%j-A(j,100)%j-A(j,102)%j-A(j,104)%j)*f(3))/2._/**/REALKIND+((-A(j,82)%j-A(j,84)%j &
       -A(j,86)%j-A(j,88)%j-A(j,106)%j-A(j,108)%j-A(j,110)%j-A(j,112)%j)*f(3))/6._/**/REALKIND
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllaj_eexuuuxuxa_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllaj_eexuuuxuxa_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllaj_eexuuuxuxa_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllaj_eexuuuxuxa_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllaj_eexuuuxuxa_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllaj_eexuuuxuxa_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllaj_eexuuuxuxa_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllaj_eexuuuxuxa_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllaj_eexuuuxuxa_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllaj_eexuuuxuxa_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllaj_eexuuuxuxa_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllaj_eexuuuxuxa_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllaj_eexuuuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllaj_eexuuuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllaj_eexuuuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllaj_eexuuuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllaj_eexuuuxuxa_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppllaj_eexuuuxuxa_1_/**/REALKIND
