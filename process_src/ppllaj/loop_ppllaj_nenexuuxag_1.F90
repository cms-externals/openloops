...
module ol_colourmatrix_ppllaj_nenexuuxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppllaj_nenexuuxag_1_/**/REALKIND



module ol_forced_parameters_ppllaj_nenexuuxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllaj_nenexuuxag_1_/**/REALKIND

module ol_loop_ppllaj_nenexuuxag_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 6) = (2*countertermnorm*ctZGG*eQED**3*gQCD**3)/3._/**/REALKIND
    f( 7) = (2*CI*eQED**3*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f( 8) = (2*eQED**3*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,4),wf(:,32))
  ...
  call counter_ZQ_A(gZu,wf(:,4),wf(:,-2),wf(:,41))
  ...
  call vert_ZQ_A(gZu,wf(:,4),wf(:,49),wf(:,50))
  call vert_VQ_A(wf(:,-5),wf(:,49),wf(:,51))
  call vert_AZ_Q(gZu,wf(:,6),wf(:,4),wf(:,52))
  ...
  call vert_AZ_Q(gZu,wf(:,14),wf(:,4),wf(:,60))
...
end module ol_loop_ppllaj_nenexuuxag_1_/**/REALKIND
