...
module ol_colourmatrix_ppllaj_eexuuxag_1_/**/REALKIND
...
end module ol_colourmatrix_ppllaj_eexuuxag_1_/**/REALKIND



module ol_forced_parameters_ppllaj_eexuuxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllaj_eexuuxag_1_/**/REALKIND

module ol_loop_ppllaj_eexuuxag_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 3) = CI*eQED**3*gQCD
    f( 4) = (4*CI*countertermnorm*eQED**3*gQCD**3)/9._/**/REALKIND
    f( 5) = (2*CI*countertermnorm*eQED**3*gQCD**3)/3._/**/REALKIND
    ...
    f( 9) = (4*CI*countertermnorm*ctGqq*eQED**3*gQCD**3)/9._/**/REALKIND
    f(10) = (2*CI*countertermnorm*ctGqq*eQED**3*gQCD**3)/3._/**/REALKIND
    f(11) = CI*countertermnorm*ctGqq*eQED**3*gQCD**3
    f(12) = (4*CI*countertermnorm*ctVqq*eQED**3*gQCD**3)/9._/**/REALKIND
    f(13) = (2*CI*countertermnorm*ctVqq*eQED**3*gQCD**3)/3._/**/REALKIND
    f(14) = CI*countertermnorm*ctVqq*eQED**3*gQCD**3
    f(15) = (2*countertermnorm*ctZGG*eQED**3*gQCD**3)/3._/**/REALKIND
    f(16) = countertermnorm*ctZGG*eQED**3*gQCD**3
    f(17) = (4*CI*eQED**3*gQCD**3*integralnorm*SwB)/9._/**/REALKIND
    f(18) = (2*CI*eQED**3*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(19) = CI*eQED**3*gQCD**3*integralnorm*SwB
    f(20) = (4*eQED**3*gQCD**3*integralnorm*SwB)/9._/**/REALKIND
    f(21) = (2*eQED**3*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_ZQ_A(gZu,wf(:,8),wf(:,4),wf(:,46))
  ...
  call counter_ZQ_A(gZu,wf(:,8),wf(:,17),wf(:,51))
  ...
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,8),wf(:,58))
  ...
  call vert_AZ_Q(gZu,wf(:,18),wf(:,8),wf(:,104))
  ...
  call vert_QA_Z(gZu,wf(:,113),wf(:,-3),wf(:,118))
  call vert_QA_V(wf(:,-2),wf(:,115),wf(:,119))
  call vert_QA_Z(gZu,wf(:,-2),wf(:,115),wf(:,120))
  ...
  call vert_ZQ_A(gZu,wf(:,34),wf(:,-2),wf(:,143))
  ...
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,34),wf(:,147))
  ...
  call vert_ZQ_A(gZu,wf(:,41),wf(:,-2),wf(:,151))
  ...
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,41),wf(:,155))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(79)+A(81)+A(83)+A(85)+A(87)+A(89)+A(91)+A(93)+A(95)+A(97)+A(99)+A(101))*f(4)+(-A(80)-A(82)-A(84)-A(86)-A(88)-A(90) &
       ...
       -A(22)*f(8)+(-A(25)-A(30)-A(39)-A(43)-A(51)-A(55))*f(9)+(A(26)+A(31)+A(40)+A(44)+A(52)+A(56)+A(65)+A(69)+A(73)+A(77))*f(10) &
       +(-A(66)-A(70)-A(74)-A(78))*f(11)+(-A(23)-A(28)-A(33)-A(35)-A(37)-A(41)-A(45)-A(47)-A(49)-A(53)-A(57)-A(59))*f(12)+(A(24) &
       +A(29)+A(34)+A(36)+A(38)+A(42)+A(46)+A(48)+A(50)+A(54)+A(58)+A(60)+A(63)+A(67)+A(71)+A(75))*f(13)+(-A(64)-A(68)-A(72) &
       -A(76))*f(14)+(-A(27)-A(32))*f(15)+(A(61)+A(62))*f(16)

end subroutine colourvectors

end module ol_loop_ppllaj_eexuuxag_1_/**/REALKIND
