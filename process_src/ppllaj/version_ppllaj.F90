...
module ol_versiondata_ppllaj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppllaj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllaj
  end interface
end module ol_versiondata_ppllaj


subroutine ol_version_ppllaj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllaj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllaj
