...
! **********************************************************************
module ol_tensor_sum_storage_heftpphhj_ddxhhg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_heftpphhj_ddxhhg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_heftpphhj_ddxhhg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_heftpphhj_ddxhhg_1, only: channel_number_heftpphhj_ddxhhg_1
  ...
  call channel_on(channel_number_heftpphhj_ddxhhg_1)
  M2 = 0
  ...
  call TI_call(2, momenta_4, masses2_2, T2sum(:,2), M2)
  call TI_call(2, momenta_2, masses2_1, T2sum(:,3), M2)
  call TI_call(2, momenta_1, masses2_1, T2sum(:,4), M2)
  call TI_call(2, momenta_3, masses2_1, T2sum(:,5), M2)

  call TI_call(3, momenta_6, masses2_2, T3sum(:,1), M2)
  call TI_call(3, momenta_7, masses2_2, T3sum(:,2), M2)

  call TI_call(4, momenta_5, masses2_2, T4sum(:,1), M2)
  call TI_call(4, momenta_11, masses2_3, T4sum(:,2), M2)
  call TI_call(4, momenta_10, masses2_3, T4sum(:,3), M2)
  call TI_call(4, momenta_9, masses2_3, T4sum(:,4), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_heftpphhj_ddxhhg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_heftpphhj_ddxhhg_1_/**/REALKIND
