...
! **********************************************************************
module ol_tensor_sum_storage_heftpphhj_hhggg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_heftpphhj_hhggg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_heftpphhj_hhggg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 5
...
! **********************************************************************
  use ol_external_heftpphhj_hhggg_1, only: channel_number_heftpphhj_hhggg_1
  ...
  call channel_on(channel_number_heftpphhj_hhggg_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,16)
  momenta_2(:,1) = Q(1:4,19)
  momenta_3(:,1) = Q(1:4,20)
  momenta_4(:,1) = Q(1:4,23)
  ...
  call TI_call(2, momenta_3, masses2_1, T2sum(:,2), M2)
  call TI_call(2, momenta_5, masses2_1, T2sum(:,3), M2)
  call TI_call(2, momenta_6, masses2_1, T2sum(:,4), M2)
  call TI_call(2, momenta_4, masses2_1, T2sum(:,5), M2)
  call TI_call(2, momenta_1, masses2_1, T2sum(:,6), M2)
  call TI_call(2, momenta_7, masses2_1, T2sum(:,7), M2)

  call TI_call(3, momenta_10, masses2_2, T3sum(:,1), M2)
  call TI_call(3, momenta_12, masses2_2, T3sum(:,2), M2)
  call TI_call(3, momenta_9, masses2_2, T3sum(:,3), M2)

  call TI_call(4, momenta_8, masses2_2, T4sum(:,1), M2)
  call TI_call(4, momenta_11, masses2_2, T4sum(:,2), M2)
  call TI_call(4, momenta_13, masses2_2, T4sum(:,3), M2)

  call TI_call(5, momenta_16, masses2_3, T5sum(:,1), M2)
  call TI_call(5, momenta_14, masses2_3, T5sum(:,2), M2)
  call TI_call(5, momenta_15, masses2_3, T5sum(:,3), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_heftpphhj_hhggg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_heftpphhj_hhggg_1_/**/REALKIND
