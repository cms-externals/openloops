...
module ol_versiondata_heftpphhj
  implicit none
  character(4) :: generator_revision = "1699"
  interface
    subroutine version_heftpphhj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_heftpphhj
  end interface
end module ol_versiondata_heftpphhj


subroutine ol_version_heftpphhj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_heftpphhj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_heftpphhj
