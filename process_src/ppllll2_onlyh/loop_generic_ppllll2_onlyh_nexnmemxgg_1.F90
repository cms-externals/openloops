...
module ol_external_ppllll2_onlyh_nexnmemxgg_1
  ...
  subroutine set_permutation(perm) &
    ...
    average_factor_ppllll2_onlyh_nexnmemxgg_1 = &
      ...
      external_perm_ppllll2_onlyh_nexnmemxgg_1(1)) &
      * average_factors_ppllll2_onlyh_nexnmemxgg_1( &
      external_perm_ppllll2_onlyh_nexnmemxgg_1(2))
    ! Symmetry factor for outgoing particles
    if (out_symmetry_on /= 0) then
      do i = 1, 6
        average_factor_ppllll2_onlyh_nexnmemxgg_1 = &
          average_factor_ppllll2_onlyh_nexnmemxgg_1 &
          * factorial(count(particle_types_perm_ppllll2_onlyh_nexnmemxgg_1(3:6) == i))
      end do
    end if
