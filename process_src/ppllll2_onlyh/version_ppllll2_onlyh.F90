...
module ol_versiondata_ppllll2_onlyh
  implicit none
  character(4) :: generator_revision = "2780"
  interface
    subroutine version_ppllll2_onlyh(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllll2_onlyh
  end interface
end module ol_versiondata_ppllll2_onlyh


subroutine ol_version_ppllll2_onlyh(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllll2_onlyh, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllll2_onlyh
