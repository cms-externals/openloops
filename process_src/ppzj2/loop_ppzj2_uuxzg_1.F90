...
module ol_colourmatrix_ppzj2_uuxzg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzj2_uuxzg_1_/**/REALKIND



module ol_forced_parameters_ppzj2_uuxzg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzj2_uuxzg_1_/**/REALKIND

module ol_loop_ppzj2_uuxzg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = countertermnorm*ctZGG*eQED*gQCD**3
    f(2) = eQED*gQCD**3*integralnorm*SwF
    f(3) = 2*eQED*gQCD**3*integralnorm*SwF
...
! **********************************************************************
  ...
  call counter_VG_G(wf(:,-2),wf(:,-3),Q(:,8),wf(:,2),Q(:,12))
...
end module ol_loop_ppzj2_uuxzg_1_/**/REALKIND
