...
module ol_colourmatrix_ppzj2_zggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzj2_zggg_1_/**/REALKIND



module ol_forced_parameters_ppzj2_zggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzj2_zggg_1_/**/REALKIND

module ol_loop_ppzj2_zggg_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-4+1:8)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = CI*countertermnorm*ctZGG*eQED*gQCD**3
    f(3) = CI*eQED*gQCD**3*integralnorm*SwF
    f(4) = 2*CI*eQED*gQCD**3*integralnorm*SwF
    f(5) = eQED*gQCD**3*integralnorm*SwF
    f(6) = 2*eQED*gQCD**3*integralnorm*SwF
...
! **********************************************************************
  ...
  ! internal WFs
  call counter_VGG_G(ctZGGG,wf(:,0),wf(:,-1),wf(:,-2),wf(:,1))
  call counter_VGG_G(ctZGGG,wf(:,0),wf(:,-2),wf(:,-1),wf(:,2))
  call vert_UV_W(wf(:,-1),Q(:,2),wf(:,-2),Q(:,4),wf(:,3))
  call counter_VG_G(wf(:,0),wf(:,-3),Q(:,8),wf(:,4),Q(:,9))
  call vert_UV_W(wf(:,-1),Q(:,2),wf(:,-3),Q(:,8),wf(:,5))
  call counter_VG_G(wf(:,0),wf(:,-2),Q(:,4),wf(:,6),Q(:,5))
  call vert_UV_W(wf(:,-2),Q(:,4),wf(:,-3),Q(:,8),wf(:,7))
  call counter_VG_G(wf(:,0),wf(:,-1),Q(:,2),wf(:,8),Q(:,3))
...
end module ol_loop_ppzj2_zggg_1_/**/REALKIND
