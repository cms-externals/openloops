...
module ol_versiondata_ppzj2
  implicit none
  character(4) :: generator_revision = "1733"
  interface
    subroutine version_ppzj2(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzj2
  end interface
end module ol_versiondata_ppzj2


subroutine ol_version_ppzj2(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzj2, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzj2
