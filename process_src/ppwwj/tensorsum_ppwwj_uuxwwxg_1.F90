...
! **********************************************************************
module ol_tensor_sum_storage_ppwwj_uuxwwxg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwwj_uuxwwxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwwj_uuxwwxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppwwj_uuxwwxg_1, only: channel_number_ppwwj_uuxwwxg_1
  ...
  call channel_on(channel_number_ppwwj_uuxwwxg_1)
  M2 = 0
  ...
  momenta_22(:,1) = Q(1:4,5)
  momenta_22(:,2) = Q(1:4,13)
  momenta_22(:,3) = Q(1:4,29)
  momenta_23(:,1) = Q(1:4,5)
  momenta_23(:,2) = Q(1:4,21)
  ...
  call TI_call(2, momenta_12, masses2_4, T2sum(:,7), M2)
  call TI_call(2, momenta_8, masses2_4, T2sum(:,8), M2)
  call TI_call(2, momenta_11, masses2_4, T2sum(:,9), M2)
  ...
  call channel_off(channel_number_ppwwj_uuxwwxg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwwj_uuxwwxg_1_/**/REALKIND
