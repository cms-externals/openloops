...
! **********************************************************************
module ol_tensor_sum_storage_ppwwj_bbxwwxg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwwj_bbxwwxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwwj_bbxwwxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppwwj_bbxwwxg_1, only: channel_number_ppwwj_bbxwwxg_1
  ...
  call channel_on(channel_number_ppwwj_bbxwwxg_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,17)
  momenta_2(:,1) = Q(1:4,18)
  momenta_3(:,1) = Q(1:4,22)
  momenta_4(:,1) = Q(1:4,25)
  momenta_5(:,1) = Q(1:4,9)
  momenta_5(:,2) = Q(1:4,25)
  ...
  momenta_13(:,1) = Q(1:4,17)
  momenta_13(:,2) = Q(1:4,29)
  momenta_14(:,1) = Q(1:4,18)
  momenta_14(:,2) = Q(1:4,22)
  momenta_15(:,1) = Q(1:4,18)
  ...
  momenta_34(:,2) = Q(1:4,18)
  momenta_34(:,3) = Q(1:4,22)
  ...
  masses2_13 = [ MT2, MB2, MB2, MT2 ]
  masses2_14 = [ ZERO2, MB2, MT2, MB2 ]
  masses2_15 = [ MT2, MB2, MT2, MT2 ]
  masses2_16 = [ MB2, MT2, MB2, MB2 ]
  masses2_17 = [ ZERO2, MT2, MB2, MB2 ]
  masses2_18 = [ MB2, MT2, MT2, MB2 ]
  masses2_19 = [ ZERO2, MT2, MT2, MB2 ]
  masses2_20 = [ ZERO2, ZERO2, MB2, MB2 ]
  masses2_21 = [ ZERO2, ZERO2, MT2, MB2 ]
  masses2_22 = [ ZERO2, ZERO2, ZERO2, ZERO2 ]
  masses2_23 = [ ZERO2, MB2, MB2, MT2, MB2 ]
  masses2_24 = [ ZERO2, MB2, MT2, MB2, MB2 ]
  masses2_25 = [ ZERO2, MB2, MT2, MT2, MB2 ]
  masses2_26 = [ ZERO2, ZERO2, MB2, MT2, MB2 ]
  ...
  call TI_call(1, momenta_3, masses2_2, T1sum(:,2), M2)
  call TI_call(1, momenta_1, masses2_1, T1sum(:,3), M2)
  call TI_call(1, momenta_2, masses2_1, T1sum(:,4), M2)

  call TI_call(2, momenta_5, masses2_8, T2sum(:,1), M2)
  call TI_call(2, momenta_9, masses2_10, T2sum(:,2), M2)
  call TI_call(2, momenta_12, masses2_5, T2sum(:,3), M2)
  call TI_call(2, momenta_8, masses2_4, T2sum(:,4), M2)
  call TI_call(2, momenta_11, masses2_9, T2sum(:,5), M2)
  call TI_call(2, momenta_16, masses2_6, T2sum(:,6), M2)
  call TI_call(2, momenta_14, masses2_5, T2sum(:,7), M2)
  call TI_call(2, momenta_7, masses2_4, T2sum(:,8), M2)
  call TI_call(2, momenta_10, masses2_9, T2sum(:,9), M2)
  ...
  call TI_call(3, momenta_6, masses2_7, T3sum(:,1), M2)
  call TI_call(3, momenta_6, masses2_3, T3sum(:,2), M2)
  call TI_call(3, momenta_6, masses2_11, T3sum(:,3), M2)
  call TI_call(3, momenta_28, masses2_21, T3sum(:,4), M2)
  call TI_call(3, momenta_23, masses2_19, T3sum(:,5), M2)
  call TI_call(3, momenta_22, masses2_17, T3sum(:,6), M2)
  call TI_call(3, momenta_29, masses2_21, T3sum(:,7), M2)
  call TI_call(3, momenta_26, masses2_19, T3sum(:,8), M2)
  call TI_call(3, momenta_25, masses2_17, T3sum(:,9), M2)
  call TI_call(3, momenta_18, masses2_12, T3sum(:,10), M2)
  call TI_call(3, momenta_19, masses2_12, T3sum(:,11), M2)
  call TI_call(3, momenta_27, masses2_20, T3sum(:,12), M2)
  call TI_call(3, momenta_30, masses2_14, T3sum(:,13), M2)
  call TI_call(3, momenta_31, masses2_14, T3sum(:,14), M2)

  call TI_call(4, momenta_24, masses2_22, T4sum(:,1), M2)
  call TI_call(4, momenta_24, masses2_15, T4sum(:,2), M2)
  call TI_call(4, momenta_24, masses2_16, T4sum(:,3), M2)
  call TI_call(4, momenta_20, masses2_22, T4sum(:,4), M2)
  call TI_call(4, momenta_20, masses2_15, T4sum(:,5), M2)
  call TI_call(4, momenta_20, masses2_16, T4sum(:,6), M2)
  call TI_call(4, momenta_21, masses2_22, T4sum(:,7), M2)
  call TI_call(4, momenta_21, masses2_18, T4sum(:,8), M2)
  call TI_call(4, momenta_21, masses2_13, T4sum(:,9), M2)
  call TI_call(4, momenta_33, masses2_25, T4sum(:,10), M2)
  call TI_call(4, momenta_34, masses2_23, T4sum(:,11), M2)
  call TI_call(4, momenta_32, masses2_24, T4sum(:,12), M2)
  call TI_call(4, momenta_35, masses2_26, T4sum(:,13), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppwwj_bbxwwxg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwwj_bbxwwxg_1_/**/REALKIND
