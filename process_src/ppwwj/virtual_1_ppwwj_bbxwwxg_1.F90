...
module ol_vamp_1_ppwwj_bbxwwxg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppwwj_bbxwwxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppwwj_bbxwwxg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppwwj_bbxwwxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppwwj_bbxwwxg_1_/**/REALKIND
  ...
  complex(REALKIND), dimension(4,35,4,49) :: G3
  ...
  call loop_QV_A(G0(:,:,:,1),wf(:,14),G0(:,:,:,9))
  ...
  call loop_AV_Q(G0(:,:,:,1),wf(:,14),G0(:,:,:,10))
  ...
  call loop_QZ_A(G0(:,:,:,1),wf(:,16),G0(:,:,:,15),gZu)
  ...
  call loop_AZ_Q(G0(:,:,:,1),wf(:,16),G0(:,:,:,16),gZd)
  ...
  call loop_AZ_Q(G0(:,:,:,1),wf(:,16),G0(:,:,:,17),gZd)
  ...
  call loop_QZ_A(G0(:,:,:,1),wf(:,16),G0(:,:,:,18),gZd)
  ...
  call loop_QZ_A(G0(:,:,:,1),wf(:,16),G0(:,:,:,19),gZd)
  ...
  call loop_AV_Q(G3(:,:,:,1),wf(:,21),G3(:,:,:,2))
  ...
  call loop_AV_Q(G3(:,:,:,3),wf(:,21),G3(:,:,:,4))
  ...
  call loop_QV_A(G3(:,:,:,5),wf(:,21),G3(:,:,:,6))
  ...
  call loop_QV_A(G3(:,:,:,7),wf(:,21),G3(:,:,:,8))
  ...
  call loop_QV_A(G3(:,:,:,9),wf(:,21),G3(:,:,:,10))
  ...
  call loop_QV_A(G3(:,:,:,11),wf(:,21),G3(:,:,:,12))
  ...
  call loop_QV_A(G3(:,:,:,13),wf(:,21),G3(:,:,:,14))
  ...
  call loop_QV_A(G3(:,:,:,15),wf(:,21),G3(:,:,:,16))
  ...
  call loop_AV_Q(G3(:,:,:,19),wf(:,21),G3(:,:,:,20))
  ...
  call loop_AV_Q(G3(:,:,:,21),wf(:,21),G3(:,:,:,22))
  ...
  call loop_Q_A(G1(:,:,:,61),Q(:,25),MT,G2(:,:,:,65))
  call check_last_QA_V(l_switch,G2(:,:,:,65),wf(:,4),G2tensor(:,2))
  call loop_QW_A(G2(:,:,:,65),wf(:,-2),G2(:,:,:,66))
  call loop_Q_A(G2(:,:,:,66),Q(:,29),MB,G3(:,:,:,27))
  call check_last_QA_V(l_switch,G3(:,:,:,27),wf(:,-1),G3tensor(:,21))
  call loop_VA_Q(G1(:,:,:,60),wf(:,58),G1(:,:,:,62))
  call loop_A_Q(G1(:,:,:,62),Q(:,30),MB,G2(:,:,:,67))
  call check_last_AQ_V(l_switch,G2(:,:,:,67),wf(:,0),G2tensor(:,3))
  call loop_VA_Q(G1(:,:,:,60),wf(:,4),G1(:,:,:,63))
  call loop_A_Q(G1(:,:,:,63),Q(:,22),MT,G2(:,:,:,68))
  call loop_AW_Q(G2(:,:,:,68),wf(:,-3),G2(:,:,:,69))
  call loop_A_Q(G2(:,:,:,69),Q(:,30),MB,G3(:,:,:,28))
  call check_last_AQ_V(l_switch,G3(:,:,:,28),wf(:,0),G3tensor(:,22))
  call loop_VQ_A(G1(:,:,:,60),wf(:,63),G1(:,:,:,64))
  call loop_Q_A(G1(:,:,:,64),Q(:,29),MB,G2(:,:,:,70))
  call check_last_QA_V(l_switch,G2(:,:,:,70),wf(:,-1),G2tensor(:,4))
  call loop_VQ_A(G1(:,:,:,60),wf(:,71),G1(:,:,:,65))
  call loop_Q_A(G1(:,:,:,65),Q(:,29),MB,G2(:,:,:,71))
  call check_last_QA_V(l_switch,G2(:,:,:,71),wf(:,-1),G2tensor(:,5))
  call loop_VQ_A(G1(:,:,:,60),wf(:,73),G1(:,:,:,66))
  call loop_Q_A(G1(:,:,:,66),Q(:,29),MB,G2(:,:,:,72))
  call check_last_QA_V(l_switch,G2(:,:,:,72),wf(:,-1),G2tensor(:,6))
  call loop_VQ_A(G1(:,:,:,60),wf(:,75),G1(:,:,:,67))
  call loop_Q_A(G1(:,:,:,67),Q(:,29),MB,G2(:,:,:,73))
  call check_last_QA_V(l_switch,G2(:,:,:,73),wf(:,-1),G2tensor(:,7))
  call loop_VA_Q(G1(:,:,:,60),wf(:,65),G1(:,:,:,68))
  call loop_A_Q(G1(:,:,:,68),Q(:,30),MB,G2(:,:,:,74))
  call check_last_AQ_V(l_switch,G2(:,:,:,74),wf(:,0),G2tensor(:,8))
  call loop_VA_Q(G1(:,:,:,60),wf(:,67),G1(:,:,:,69))
  call loop_A_Q(G1(:,:,:,69),Q(:,30),MB,G2(:,:,:,75))
  call check_last_AQ_V(l_switch,G2(:,:,:,75),wf(:,0),G2tensor(:,9))
  call loop_VA_Q(G1(:,:,:,60),wf(:,69),G1(:,:,:,70))
  call loop_A_Q(G1(:,:,:,70),Q(:,30),MB,G2(:,:,:,76))
  call check_last_AQ_V(l_switch,G2(:,:,:,76),wf(:,0),G2tensor(:,10))
  call loop_VA_Q(G1(:,:,:,60),wf(:,-1),G1(:,:,:,71))
  call loop_A_Q(G1(:,:,:,71),Q(:,18),MB,G2(:,:,:,77))
  call loop_AS_Q(G2(:,:,:,77),wf(:,12),G2(:,:,:,78),gH)
  call loop_A_Q(G2(:,:,:,78),Q(:,30),MB,G3(:,:,:,29))
  call check_last_AQ_V(l_switch,G3(:,:,:,29),wf(:,0),G3tensor(:,23))
  call loop_AV_Q(G2(:,:,:,77),wf(:,14),G2(:,:,:,79))
  call loop_A_Q(G2(:,:,:,79),Q(:,30),MB,G3(:,:,:,30))
  call check_last_AQ_V(l_switch,G3(:,:,:,30),wf(:,0),G3tensor(:,24))
  call loop_AZ_Q(G2(:,:,:,77),wf(:,16),G2(:,:,:,80),gZd)
  call loop_A_Q(G2(:,:,:,80),Q(:,30),MB,G3(:,:,:,31))
  call check_last_AQ_V(l_switch,G3(:,:,:,31),wf(:,0),G3tensor(:,25))
  call loop_AW_Q(G2(:,:,:,77),wf(:,-2),G2(:,:,:,81))
  call loop_A_Q(G2(:,:,:,81),Q(:,22),MT,G3(:,:,:,32))
  ...
  call loop_Q_A(G0(:,:,:,29),Q(:,17),MB,G1(:,:,:,72))
  call loop_QW_A(G1(:,:,:,72),wf(:,-3),G1(:,:,:,73))
  call loop_Q_A(G1(:,:,:,73),Q(:,25),MT,G2(:,:,:,82))
  call check_last_QA_V(l_switch,G2(:,:,:,82),wf(:,4),G2tensor(:,11))
  call loop_QW_A(G2(:,:,:,82),wf(:,-2),G2(:,:,:,83))
  call loop_Q_A(G2(:,:,:,83),Q(:,29),MB,G3(:,:,:,34))
  call check_last_QA_V(l_switch,G3(:,:,:,34),wf(:,-1),G3tensor(:,26))
  call loop_QS_A(G1(:,:,:,72),wf(:,12),G1(:,:,:,74),gH)
  call loop_Q_A(G1(:,:,:,74),Q(:,29),MB,G2(:,:,:,84))
  call check_last_QA_V(l_switch,G2(:,:,:,84),wf(:,-1),G2tensor(:,12))
  call loop_QV_A(G1(:,:,:,72),wf(:,14),G1(:,:,:,75))
  call loop_Q_A(G1(:,:,:,75),Q(:,29),MB,G2(:,:,:,85))
  call check_last_QA_V(l_switch,G2(:,:,:,85),wf(:,-1),G2tensor(:,13))
  call loop_QZ_A(G1(:,:,:,72),wf(:,16),G1(:,:,:,76),gZd)
  call loop_Q_A(G1(:,:,:,76),Q(:,29),MB,G2(:,:,:,86))
  call check_last_QA_V(l_switch,G2(:,:,:,86),wf(:,-1),G2tensor(:,14))
  call check_last_QA_V(l_switch,G1(:,:,:,72),wf(:,58),G1tensor(:,1))
  call check_last_QA_V(l_switch,G1(:,:,:,72),wf(:,65),G1tensor(:,2))
  call check_last_QA_V(l_switch,G1(:,:,:,72),wf(:,67),G1tensor(:,3))
  call check_last_QA_V(l_switch,G1(:,:,:,72),wf(:,69),G1tensor(:,4))
  call loop_VA_Q(G0(:,:,:,1),wf(:,58),G0(:,:,:,30))
  call loop_A_Q(G0(:,:,:,30),Q(:,14),MB,G1(:,:,:,77))
  call loop_AV_Q(G1(:,:,:,77),wf(:,-4),G1(:,:,:,78))
  call loop_A_Q(G1(:,:,:,78),Q(:,30),MB,G2(:,:,:,87))
  call check_last_AQ_V(l_switch,G2(:,:,:,87),wf(:,0),G2tensor(:,15))
  call loop_VA_Q(G0(:,:,:,1),wf(:,53),G0(:,:,:,31))
  call loop_A_Q(G0(:,:,:,31),Q(:,22),MT,G1(:,:,:,79))
  call loop_AW_Q(G1(:,:,:,79),wf(:,-3),G1(:,:,:,80))
  call loop_A_Q(G1(:,:,:,80),Q(:,30),MB,G2(:,:,:,88))
  call check_last_AQ_V(l_switch,G2(:,:,:,88),wf(:,0),G2tensor(:,16))
  call check_last_AQ_V(l_switch,G1(:,:,:,79),wf(:,3),G1tensor(:,5))
  call loop_VA_Q(G0(:,:,:,1),wf(:,4),G0(:,:,:,32))
  call loop_A_Q(G0(:,:,:,32),Q(:,6),MT,G1(:,:,:,81))
  call loop_AV_Q(G1(:,:,:,81),wf(:,-4),G1(:,:,:,82))
  call loop_A_Q(G1(:,:,:,82),Q(:,22),MT,G2(:,:,:,89))
  call loop_AW_Q(G2(:,:,:,89),wf(:,-3),G2(:,:,:,90))
  call loop_A_Q(G2(:,:,:,90),Q(:,30),MB,G3(:,:,:,35))
  call check_last_AQ_V(l_switch,G3(:,:,:,35),wf(:,0),G3tensor(:,27))
  call loop_AW_Q(G1(:,:,:,81),wf(:,-3),G1(:,:,:,83))
  call loop_A_Q(G1(:,:,:,83),Q(:,14),MB,G2(:,:,:,91))
  call loop_AV_Q(G2(:,:,:,91),wf(:,-4),G2(:,:,:,92))
  call loop_A_Q(G2(:,:,:,92),Q(:,30),MB,G3(:,:,:,36))
  call check_last_AQ_V(l_switch,G3(:,:,:,36),wf(:,0),G3tensor(:,28))
  call loop_VA_Q(G0(:,:,:,1),wf(:,10),G0(:,:,:,33))
  call loop_A_Q(G0(:,:,:,33),Q(:,18),MB,G1(:,:,:,84))
  call loop_AW_Q(G1(:,:,:,84),wf(:,-2),G1(:,:,:,85))
  call loop_A_Q(G1(:,:,:,85),Q(:,22),MT,G2(:,:,:,93))
  call check_last_AQ_V(l_switch,G2(:,:,:,93),wf(:,3),G2tensor(:,17))
  call loop_AW_Q(G2(:,:,:,93),wf(:,-3),G2(:,:,:,94))
  call loop_A_Q(G2(:,:,:,94),Q(:,30),MB,G3(:,:,:,37))
  call check_last_AQ_V(l_switch,G3(:,:,:,37),wf(:,0),G3tensor(:,29))
  call loop_AS_Q(G1(:,:,:,84),wf(:,12),G1(:,:,:,86),gH)
  call loop_A_Q(G1(:,:,:,86),Q(:,30),MB,G2(:,:,:,95))
  call check_last_AQ_V(l_switch,G2(:,:,:,95),wf(:,0),G2tensor(:,18))
  call loop_AV_Q(G1(:,:,:,84),wf(:,14),G1(:,:,:,87))
  call loop_A_Q(G1(:,:,:,87),Q(:,30),MB,G2(:,:,:,96))
  call check_last_AQ_V(l_switch,G2(:,:,:,96),wf(:,0),G2tensor(:,19))
  call loop_AZ_Q(G1(:,:,:,84),wf(:,16),G1(:,:,:,88),gZd)
  call loop_A_Q(G1(:,:,:,88),Q(:,30),MB,G2(:,:,:,97))
  call check_last_AQ_V(l_switch,G2(:,:,:,97),wf(:,0),G2tensor(:,20))
  call check_last_AQ_V(l_switch,G1(:,:,:,84),wf(:,63),G1tensor(:,6))
  call check_last_AQ_V(l_switch,G1(:,:,:,84),wf(:,71),G1tensor(:,7))
  call check_last_AQ_V(l_switch,G1(:,:,:,84),wf(:,73),G1tensor(:,8))
  call check_last_AQ_V(l_switch,G1(:,:,:,84),wf(:,75),G1tensor(:,9))
  call loop_VQ_A(G0(:,:,:,1),wf(:,63),G0(:,:,:,34))
  call loop_Q_A(G0(:,:,:,34),Q(:,13),MB,G1(:,:,:,89))
  call loop_QV_A(G1(:,:,:,89),wf(:,-4),G1(:,:,:,90))
  call loop_Q_A(G1(:,:,:,90),Q(:,29),MB,G2(:,:,:,98))
  call check_last_QA_V(l_switch,G2(:,:,:,98),wf(:,-1),G2tensor(:,21))
  call loop_VQ_A(G0(:,:,:,1),wf(:,55),G0(:,:,:,35))
  call loop_Q_A(G0(:,:,:,35),Q(:,25),MT,G1(:,:,:,91))
  call loop_QW_A(G1(:,:,:,91),wf(:,-2),G1(:,:,:,92))
  call loop_Q_A(G1(:,:,:,92),Q(:,29),MB,G2(:,:,:,99))
  call check_last_QA_V(l_switch,G2(:,:,:,99),wf(:,-1),G2tensor(:,22))
  call check_last_QA_V(l_switch,G1(:,:,:,91),wf(:,4),G1tensor(:,10))
  call loop_VQ_A(G0(:,:,:,1),wf(:,71),G0(:,:,:,36))
  call loop_Q_A(G0(:,:,:,36),Q(:,13),MB,G1(:,:,:,93))
  call loop_QV_A(G1(:,:,:,93),wf(:,-4),G1(:,:,:,94))
  call loop_Q_A(G1(:,:,:,94),Q(:,29),MB,G2(:,:,:,100))
  call check_last_QA_V(l_switch,G2(:,:,:,100),wf(:,-1),G2tensor(:,23))
  call loop_VQ_A(G0(:,:,:,1),wf(:,73),G0(:,:,:,37))
  call loop_Q_A(G0(:,:,:,37),Q(:,13),MB,G1(:,:,:,95))
  call loop_QV_A(G1(:,:,:,95),wf(:,-4),G1(:,:,:,96))
  call loop_Q_A(G1(:,:,:,96),Q(:,29),MB,G2(:,:,:,101))
  call check_last_QA_V(l_switch,G2(:,:,:,101),wf(:,-1),G2tensor(:,24))
  call loop_VQ_A(G0(:,:,:,1),wf(:,75),G0(:,:,:,38))
  call loop_Q_A(G0(:,:,:,38),Q(:,13),MB,G1(:,:,:,97))
  call loop_QV_A(G1(:,:,:,97),wf(:,-4),G1(:,:,:,98))
  call loop_Q_A(G1(:,:,:,98),Q(:,29),MB,G2(:,:,:,102))
  call check_last_QA_V(l_switch,G2(:,:,:,102),wf(:,-1),G2tensor(:,25))
  call loop_VA_Q(G0(:,:,:,1),wf(:,65),G0(:,:,:,39))
  call loop_A_Q(G0(:,:,:,39),Q(:,14),MB,G1(:,:,:,99))
  call loop_AV_Q(G1(:,:,:,99),wf(:,-4),G1(:,:,:,100))
  call loop_A_Q(G1(:,:,:,100),Q(:,30),MB,G2(:,:,:,103))
  call check_last_AQ_V(l_switch,G2(:,:,:,103),wf(:,0),G2tensor(:,26))
  call loop_VA_Q(G0(:,:,:,1),wf(:,67),G0(:,:,:,40))
  call loop_A_Q(G0(:,:,:,40),Q(:,14),MB,G1(:,:,:,101))
  call loop_AV_Q(G1(:,:,:,101),wf(:,-4),G1(:,:,:,102))
  call loop_A_Q(G1(:,:,:,102),Q(:,30),MB,G2(:,:,:,104))
  call check_last_AQ_V(l_switch,G2(:,:,:,104),wf(:,0),G2tensor(:,27))
  call loop_VA_Q(G0(:,:,:,1),wf(:,69),G0(:,:,:,41))
  call loop_A_Q(G0(:,:,:,41),Q(:,14),MB,G1(:,:,:,103))
  call loop_AV_Q(G1(:,:,:,103),wf(:,-4),G1(:,:,:,104))
  call loop_A_Q(G1(:,:,:,104),Q(:,30),MB,G2(:,:,:,105))
  call check_last_AQ_V(l_switch,G2(:,:,:,105),wf(:,0),G2tensor(:,28))
  call loop_VA_Q(G0(:,:,:,1),wf(:,-1),G0(:,:,:,42))
  call loop_A_Q(G0(:,:,:,42),Q(:,2),MB,G1(:,:,:,105))
  call loop_AS_Q(G1(:,:,:,105),wf(:,12),G1(:,:,:,106),gH)
  call loop_A_Q(G1(:,:,:,106),Q(:,14),MB,G2(:,:,:,106))
  call loop_AV_Q(G2(:,:,:,106),wf(:,-4),G2(:,:,:,107))
  call loop_A_Q(G2(:,:,:,107),Q(:,30),MB,G3(:,:,:,38))
  call check_last_AQ_V(l_switch,G3(:,:,:,38),wf(:,0),G3tensor(:,30))
  call loop_AV_Q(G1(:,:,:,105),wf(:,14),G1(:,:,:,107))
  call loop_A_Q(G1(:,:,:,107),Q(:,14),MB,G2(:,:,:,108))
  call loop_AV_Q(G2(:,:,:,108),wf(:,-4),G2(:,:,:,109))
  call loop_A_Q(G2(:,:,:,109),Q(:,30),MB,G3(:,:,:,39))
  call check_last_AQ_V(l_switch,G3(:,:,:,39),wf(:,0),G3tensor(:,31))
  call loop_AZ_Q(G1(:,:,:,105),wf(:,16),G1(:,:,:,108),gZd)
  call loop_A_Q(G1(:,:,:,108),Q(:,14),MB,G2(:,:,:,110))
  call loop_AV_Q(G2(:,:,:,110),wf(:,-4),G2(:,:,:,111))
  call loop_A_Q(G2(:,:,:,111),Q(:,30),MB,G3(:,:,:,40))
  call check_last_AQ_V(l_switch,G3(:,:,:,40),wf(:,0),G3tensor(:,32))
  call loop_AV_Q(G1(:,:,:,105),wf(:,-4),G1(:,:,:,109))
  call loop_A_Q(G1(:,:,:,109),Q(:,18),MB,G2(:,:,:,112))
  call loop_AS_Q(G2(:,:,:,112),wf(:,12),G2(:,:,:,113),gH)
  call loop_A_Q(G2(:,:,:,113),Q(:,30),MB,G3(:,:,:,41))
  call check_last_AQ_V(l_switch,G3(:,:,:,41),wf(:,0),G3tensor(:,33))
  call loop_AV_Q(G2(:,:,:,112),wf(:,14),G2(:,:,:,114))
  call loop_A_Q(G2(:,:,:,114),Q(:,30),MB,G3(:,:,:,42))
  call check_last_AQ_V(l_switch,G3(:,:,:,42),wf(:,0),G3tensor(:,34))
  call loop_AZ_Q(G2(:,:,:,112),wf(:,16),G2(:,:,:,115),gZd)
  call loop_A_Q(G2(:,:,:,115),Q(:,30),MB,G3(:,:,:,43))
  call check_last_AQ_V(l_switch,G3(:,:,:,43),wf(:,0),G3tensor(:,35))
  call loop_AW_Q(G2(:,:,:,112),wf(:,-2),G2(:,:,:,116))
  call loop_A_Q(G2(:,:,:,116),Q(:,22),MT,G3(:,:,:,44))
  call loop_AW_Q(G3(:,:,:,44),wf(:,-3),G3(:,:,:,45))
  call loop_A_Q(G3(:,:,:,45),Q(:,30),MB,G4(:,:,:,2))
  call check_last_AQ_V(l_switch,G4(:,:,:,2),wf(:,0),G4tensor(:,14))
  call loop_AW_Q(G1(:,:,:,105),wf(:,-2),G1(:,:,:,110))
  call loop_A_Q(G1(:,:,:,110),Q(:,6),MT,G2(:,:,:,117))
  call loop_AV_Q(G2(:,:,:,117),wf(:,-4),G2(:,:,:,118))
  call loop_A_Q(G2(:,:,:,118),Q(:,22),MT,G3(:,:,:,46))
  call loop_AW_Q(G3(:,:,:,46),wf(:,-3),G3(:,:,:,47))
  call loop_A_Q(G3(:,:,:,47),Q(:,30),MB,G4(:,:,:,3))
  call check_last_AQ_V(l_switch,G4(:,:,:,3),wf(:,0),G4tensor(:,15))
  call loop_AW_Q(G2(:,:,:,117),wf(:,-3),G2(:,:,:,119))
  call loop_A_Q(G2(:,:,:,119),Q(:,14),MB,G3(:,:,:,48))
  call loop_AV_Q(G3(:,:,:,48),wf(:,-4),G3(:,:,:,49))
  call loop_A_Q(G3(:,:,:,49),Q(:,30),MB,G4(:,:,:,4))
  call check_last_AQ_V(l_switch,G4(:,:,:,4),wf(:,0),G4tensor(:,16))
  call loop_VQ_A(G0(:,:,:,1),wf(:,59),G0(:,:,:,43))
  call loop_Q_A(G0(:,:,:,43),Q(:,25),MT,G1(:,:,:,111))
  call loop_QW_A(G1(:,:,:,111),wf(:,-2),G1(:,:,:,112))
  call loop_Q_A(G1(:,:,:,112),Q(:,29),MB,G2(:,:,:,120))
  call check_last_QA_V(l_switch,G2(:,:,:,120),wf(:,-1),G2tensor(:,29))
  call check_last_QA_V(l_switch,G1(:,:,:,111),wf(:,4),G1tensor(:,11))
  call loop_VA_Q(G0(:,:,:,1),wf(:,61),G0(:,:,:,44))
  call loop_A_Q(G0(:,:,:,44),Q(:,22),MT,G1(:,:,:,113))
  call loop_AW_Q(G1(:,:,:,113),wf(:,-3),G1(:,:,:,114))
  call loop_A_Q(G1(:,:,:,114),Q(:,30),MB,G2(:,:,:,121))
  call check_last_AQ_V(l_switch,G2(:,:,:,121),wf(:,0),G2tensor(:,30))
  call check_last_AQ_V(l_switch,G1(:,:,:,113),wf(:,3),G1tensor(:,12))
...
end module ol_vamp_1_ppwwj_bbxwwxg_1_/**/REALKIND
