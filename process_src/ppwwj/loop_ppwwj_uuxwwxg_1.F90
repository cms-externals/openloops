...
module ol_colourmatrix_ppwwj_uuxwwxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppwwj_uuxwwxg_1_/**/REALKIND



module ol_forced_parameters_ppwwj_uuxwwxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppwwj_uuxwwxg_1_/**/REALKIND

module ol_loop_ppwwj_uuxwwxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 2) = (2*CI*countertermnorm*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 3) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 4) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**3)/3._/**/REALKIND
    ...
    f(16) = (2*CI*eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(17) = (2*eQED**2*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call vert_VQ_A(wf(:,-4),wf(:,0),wf(:,9))
  call prop_Q_A(wf(:,9),Q(:,17),ZERO,0_intkind1,wf(:,10))
  call vert_WQ_A(wf(:,-2),wf(:,10),wf(:,11))
  call vert_UV_W(wf(:,-3),Q(:,8),wf(:,-2),Q(:,4),wf(:,12))
  call vert_QA_V(wf(:,10),wf(:,-1),wf(:,13))
  call prop_W_W(wf(:,12),Q(:,12),MZ,1_intkind1,wf(:,14))
  call vert_QA_Z(gZu,wf(:,10),wf(:,-1),wf(:,15))
  call vert_QA_V(wf(:,0),wf(:,7),wf(:,16))
  call vert_QA_Z(gZu,wf(:,0),wf(:,7),wf(:,17))
  ...
  call counter_WQ_A(wf(:,-2),wf(:,10),wf(:,25))
  call counter_AV_Q(wf(:,-1),wf(:,-4),wf(:,26))
  call prop_A_Q(wf(:,26),Q(:,18),ZERO,0_intkind1,wf(:,27))
  call counter_AW_Q(wf(:,-1),wf(:,-3),wf(:,28))
  call prop_A_Q(wf(:,28),Q(:,10),ZERO,0_intkind1,wf(:,29))
  call counter_QA_V(wf(:,10),wf(:,-1),wf(:,30))
  call counter_QA_Z(gZu,wf(:,10),wf(:,-1),wf(:,31))
  call vert_QA_V(wf(:,0),wf(:,27),wf(:,32))
  call vert_QA_Z(gZu,wf(:,0),wf(:,27),wf(:,33))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,34))
  call prop_Q_A(wf(:,34),Q(:,17),ZERO,0_intkind1,wf(:,35))
  call vert_WQ_A(wf(:,-2),wf(:,35),wf(:,36))
  call counter_QA_V(wf(:,0),wf(:,7),wf(:,37))
  call counter_QA_Z(gZu,wf(:,0),wf(:,7),wf(:,38))
  call vert_QA_V(wf(:,35),wf(:,-1),wf(:,39))
  call vert_QA_Z(gZu,wf(:,35),wf(:,-1),wf(:,40))
  call counter_WQ_A(wf(:,-2),wf(:,0),wf(:,41))
  call prop_Q_A(wf(:,41),Q(:,5),ZERO,0_intkind1,wf(:,42))
  call vert_VQ_A(wf(:,-4),wf(:,42),wf(:,43))
  call vert_WQ_A(wf(:,-3),wf(:,42),wf(:,44))
  ...
  call vert_AW_Q(wf(:,7),wf(:,-3),wf(:,50))
  ...
  call vert_AW_Q(wf(:,4),wf(:,-2),wf(:,54))
  call counter_Q_A(ctqq,wf(:,10),Q(:,17),wf(:,55))
  call prop_A_Q(wf(:,54),Q(:,14),ZERO,0_intkind1,wf(:,56))
  call prop_Q_A(wf(:,11),Q(:,21),ZERO,0_intkind1,wf(:,57))
  call vert_AV_Q(wf(:,-1),wf(:,12),wf(:,58))
  call prop_A_Q(wf(:,58),Q(:,14),ZERO,0_intkind1,wf(:,59))
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,14),wf(:,60))
  ...
  call vert_ZQ_A(gZu,wf(:,14),wf(:,0),wf(:,64))
...
subroutine diagrams(A)
  ...
  A(12) = cont_QA(wf(:,7),wf(:,24)) * den(5)
  A(13) = cont_QA(wf(:,4),wf(:,25)) * den(7)
  A(14) = cont_QA(wf(:,8),wf(:,27)) * den(5)
  A(15) = cont_QA(wf(:,5),wf(:,29)) * den(3)
  A(16) = cont_VV(wf(:,12),wf(:,30)) * den(9)
  A(17) = cont_VV(wf(:,14),wf(:,31)) * den(11)
  A(18) = cont_VV(wf(:,12),wf(:,32)) * den(12)
  A(19) = cont_VV(wf(:,14),wf(:,33)) * den(13)
  A(20) = cont_QA(wf(:,11),wf(:,29)) * den(7)
  A(21) = cont_QA(wf(:,4),wf(:,36)) * den(7)
  A(22) = cont_VV(wf(:,12),wf(:,37)) * den(12)
  A(23) = cont_VV(wf(:,14),wf(:,38)) * den(13)
  A(24) = cont_VV(wf(:,12),wf(:,39)) * den(9)
  A(25) = cont_VV(wf(:,14),wf(:,40)) * den(11)
  A(26) = cont_QA(wf(:,4),wf(:,43)) * den(3)
  A(27) = cont_QA(wf(:,7),wf(:,44)) * den(5)
  A(28) = cont_QA(wf(:,46),wf(:,47)) * den(20)
  A(29) = cont_QA(wf(:,48),wf(:,49)) * den(23)
  A(30) = cont_QA(wf(:,46),wf(:,51)) * den(25)
  A(31) = cont_QA(wf(:,52),wf(:,53)) * den(28)
  A(32) = cont_QA(wf(:,55),wf(:,56)) * den(31)
  A(33) = cont_QA(wf(:,48),wf(:,57)) * den(33)
  A(34) = cont_QA(wf(:,55),wf(:,59)) * den(35)
  A(35) = cont_QA(wf(:,55),wf(:,61)) * den(37)
  A(36) = cont_QA(wf(:,52),wf(:,63)) * den(39)
  A(37) = cont_QA(wf(:,52),wf(:,65)) * den(41)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(34)-A(36))*f(2)+(A(18)+A(24))*f(3)+(A(16)+A(22))*f(4)+A(8)*f(5)+(-A(28)-A(29)-A(30)-A(31)-A(32)-A(33))*f(7)+(A(11) &
       +A(14)+A(21))*f(8)+(A(12)+A(13)+A(15)+A(20)+A(26)+A(27))*f(9)+(-A(35)-A(37))*f(11)+(A(19)+A(25))*f(12)+(A(17)+A(23))*f(13) &
       -A(10)*f(14)-A(9)*f(15)

end subroutine colourvectors

end module ol_loop_ppwwj_uuxwwxg_1_/**/REALKIND
