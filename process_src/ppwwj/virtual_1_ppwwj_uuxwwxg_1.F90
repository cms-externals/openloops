...
module ol_vamp_1_ppwwj_uuxwwxg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppwwj_uuxwwxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppwwj_uuxwwxg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppwwj_uuxwwxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppwwj_uuxwwxg_1_/**/REALKIND
  ...
  call loop_VA_Q(G0(:,:,:,1),wf(:,4),G0(:,:,:,28))
  call loop_A_Q(G0(:,:,:,28),Q(:,10),ZERO,G1(:,:,:,57))
  call loop_AV_Q(G1(:,:,:,57),wf(:,-4),G1(:,:,:,58))
  call loop_A_Q(G1(:,:,:,58),Q(:,26),ZERO,G2(:,:,:,61))
  call check_last_AQ_V(l_switch,G2(:,:,:,61),wf(:,3),G2tensor(:,1))
  call loop_AW_Q(G2(:,:,:,61),wf(:,-2),G2(:,:,:,62))
  call loop_A_Q(G2(:,:,:,62),Q(:,30),ZERO,G3(:,:,:,25))
  call check_last_AQ_V(l_switch,G3(:,:,:,25),wf(:,0),G3tensor(:,19))
  call loop_AW_Q(G1(:,:,:,57),wf(:,-2),G1(:,:,:,59))
  call loop_A_Q(G1(:,:,:,59),Q(:,14),ZERO,G2(:,:,:,63))
  call loop_AV_Q(G2(:,:,:,63),wf(:,-4),G2(:,:,:,64))
  call loop_A_Q(G2(:,:,:,64),Q(:,30),ZERO,G3(:,:,:,26))
  ...
  call loop_A_Q(G1(:,:,:,61),Q(:,26),ZERO,G2(:,:,:,65))
  call check_last_AQ_V(l_switch,G2(:,:,:,65),wf(:,3),G2tensor(:,2))
  call loop_AW_Q(G2(:,:,:,65),wf(:,-2),G2(:,:,:,66))
  call loop_A_Q(G2(:,:,:,66),Q(:,30),ZERO,G3(:,:,:,27))
  call check_last_AQ_V(l_switch,G3(:,:,:,27),wf(:,0),G3tensor(:,21))
  call loop_VQ_A(G1(:,:,:,60),wf(:,53),G1(:,:,:,62))
  call loop_Q_A(G1(:,:,:,62),Q(:,29),ZERO,G2(:,:,:,67))
  call check_last_QA_V(l_switch,G2(:,:,:,67),wf(:,-1),G2tensor(:,3))
  call loop_VQ_A(G1(:,:,:,60),wf(:,3),G1(:,:,:,63))
  call loop_Q_A(G1(:,:,:,63),Q(:,21),ZERO,G2(:,:,:,68))
  call loop_QW_A(G2(:,:,:,68),wf(:,-3),G2(:,:,:,69))
  call loop_Q_A(G2(:,:,:,69),Q(:,29),ZERO,G3(:,:,:,28))
  call check_last_QA_V(l_switch,G3(:,:,:,28),wf(:,-1),G3tensor(:,22))
  call loop_VA_Q(G1(:,:,:,60),wf(:,56),G1(:,:,:,64))
  call loop_A_Q(G1(:,:,:,64),Q(:,30),ZERO,G2(:,:,:,70))
  call check_last_AQ_V(l_switch,G2(:,:,:,70),wf(:,0),G2tensor(:,4))
  ...
  call loop_AZ_Q(G2(:,:,:,75),wf(:,14),G2(:,:,:,77),gZu)
  call loop_A_Q(G2(:,:,:,77),Q(:,30),ZERO,G3(:,:,:,30))
  call check_last_AQ_V(l_switch,G3(:,:,:,30),wf(:,0),G3tensor(:,24))
  call loop_AW_Q(G2(:,:,:,75),wf(:,-3),G2(:,:,:,78))
  call loop_A_Q(G2(:,:,:,78),Q(:,26),ZERO,G3(:,:,:,31))
  call loop_AW_Q(G3(:,:,:,31),wf(:,-2),G3(:,:,:,32))
  call loop_A_Q(G3(:,:,:,32),Q(:,30),ZERO,G4(:,:,:,1))
  call check_last_AQ_V(l_switch,G4(:,:,:,1),wf(:,0),G4tensor(:,13))
  call loop_VA_Q(G0(:,:,:,1),wf(:,7),G0(:,:,:,29))
  call loop_A_Q(G0(:,:,:,29),Q(:,18),ZERO,G1(:,:,:,70))
  call loop_AW_Q(G1(:,:,:,70),wf(:,-3),G1(:,:,:,71))
  call loop_A_Q(G1(:,:,:,71),Q(:,26),ZERO,G2(:,:,:,79))
  call check_last_AQ_V(l_switch,G2(:,:,:,79),wf(:,3),G2tensor(:,9))
  call loop_AW_Q(G2(:,:,:,79),wf(:,-2),G2(:,:,:,80))
  call loop_A_Q(G2(:,:,:,80),Q(:,30),ZERO,G3(:,:,:,33))
  call check_last_AQ_V(l_switch,G3(:,:,:,33),wf(:,0),G3tensor(:,25))
  call loop_AV_Q(G1(:,:,:,70),wf(:,12),G1(:,:,:,72))
  call loop_A_Q(G1(:,:,:,72),Q(:,30),ZERO,G2(:,:,:,81))
  call check_last_AQ_V(l_switch,G2(:,:,:,81),wf(:,0),G2tensor(:,10))
  call loop_AZ_Q(G1(:,:,:,70),wf(:,14),G1(:,:,:,73),gZu)
  call loop_A_Q(G1(:,:,:,73),Q(:,30),ZERO,G2(:,:,:,82))
  call check_last_AQ_V(l_switch,G2(:,:,:,82),wf(:,0),G2tensor(:,11))
  call check_last_AQ_V(l_switch,G1(:,:,:,70),wf(:,53),G1tensor(:,1))
  call check_last_AQ_V(l_switch,G1(:,:,:,70),wf(:,63),G1tensor(:,2))
  call check_last_AQ_V(l_switch,G1(:,:,:,70),wf(:,65),G1tensor(:,3))
  call loop_VQ_A(G0(:,:,:,1),wf(:,53),G0(:,:,:,30))
  call loop_Q_A(G0(:,:,:,30),Q(:,13),ZERO,G1(:,:,:,74))
  call loop_QV_A(G1(:,:,:,74),wf(:,-4),G1(:,:,:,75))
  call loop_Q_A(G1(:,:,:,75),Q(:,29),ZERO,G2(:,:,:,83))
  call check_last_QA_V(l_switch,G2(:,:,:,83),wf(:,-1),G2tensor(:,12))
  call loop_VQ_A(G0(:,:,:,1),wf(:,49),G0(:,:,:,31))
  call loop_Q_A(G0(:,:,:,31),Q(:,21),ZERO,G1(:,:,:,76))
  call loop_QW_A(G1(:,:,:,76),wf(:,-3),G1(:,:,:,77))
  call loop_Q_A(G1(:,:,:,77),Q(:,29),ZERO,G2(:,:,:,84))
  call check_last_QA_V(l_switch,G2(:,:,:,84),wf(:,-1),G2tensor(:,13))
  call check_last_QA_V(l_switch,G1(:,:,:,76),wf(:,4),G1tensor(:,4))
  call loop_VQ_A(G0(:,:,:,1),wf(:,3),G0(:,:,:,32))
  call loop_Q_A(G0(:,:,:,32),Q(:,5),ZERO,G1(:,:,:,78))
  call loop_QV_A(G1(:,:,:,78),wf(:,-4),G1(:,:,:,79))
  call loop_Q_A(G1(:,:,:,79),Q(:,21),ZERO,G2(:,:,:,85))
  call loop_QW_A(G2(:,:,:,85),wf(:,-3),G2(:,:,:,86))
  call loop_Q_A(G2(:,:,:,86),Q(:,29),ZERO,G3(:,:,:,34))
  call check_last_QA_V(l_switch,G3(:,:,:,34),wf(:,-1),G3tensor(:,26))
  call loop_QW_A(G1(:,:,:,78),wf(:,-3),G1(:,:,:,80))
  call loop_Q_A(G1(:,:,:,80),Q(:,13),ZERO,G2(:,:,:,87))
  call loop_QV_A(G2(:,:,:,87),wf(:,-4),G2(:,:,:,88))
  call loop_Q_A(G2(:,:,:,88),Q(:,29),ZERO,G3(:,:,:,35))
  call check_last_QA_V(l_switch,G3(:,:,:,35),wf(:,-1),G3tensor(:,27))
  call loop_VQ_A(G0(:,:,:,1),wf(:,10),G0(:,:,:,33))
  call loop_Q_A(G0(:,:,:,33),Q(:,17),ZERO,G1(:,:,:,81))
  call loop_QW_A(G1(:,:,:,81),wf(:,-2),G1(:,:,:,82))
  call loop_Q_A(G1(:,:,:,82),Q(:,21),ZERO,G2(:,:,:,89))
  call check_last_QA_V(l_switch,G2(:,:,:,89),wf(:,4),G2tensor(:,14))
  call loop_QW_A(G2(:,:,:,89),wf(:,-3),G2(:,:,:,90))
  call loop_Q_A(G2(:,:,:,90),Q(:,29),ZERO,G3(:,:,:,36))
  ...
  call loop_QZ_A(G1(:,:,:,81),wf(:,14),G1(:,:,:,84),gZu)
  call loop_Q_A(G1(:,:,:,84),Q(:,29),ZERO,G2(:,:,:,92))
  call check_last_QA_V(l_switch,G2(:,:,:,92),wf(:,-1),G2tensor(:,16))
  call check_last_QA_V(l_switch,G1(:,:,:,81),wf(:,56),G1tensor(:,5))
  call check_last_QA_V(l_switch,G1(:,:,:,81),wf(:,59),G1tensor(:,6))
  call check_last_QA_V(l_switch,G1(:,:,:,81),wf(:,61),G1tensor(:,7))
  call loop_VA_Q(G0(:,:,:,1),wf(:,56),G0(:,:,:,34))
  call loop_A_Q(G0(:,:,:,34),Q(:,14),ZERO,G1(:,:,:,85))
  call loop_AV_Q(G1(:,:,:,85),wf(:,-4),G1(:,:,:,86))
  call loop_A_Q(G1(:,:,:,86),Q(:,30),ZERO,G2(:,:,:,93))
  call check_last_AQ_V(l_switch,G2(:,:,:,93),wf(:,0),G2tensor(:,17))
  call loop_VA_Q(G0(:,:,:,1),wf(:,47),G0(:,:,:,35))
  call loop_A_Q(G0(:,:,:,35),Q(:,26),ZERO,G1(:,:,:,87))
  call loop_AW_Q(G1(:,:,:,87),wf(:,-2),G1(:,:,:,88))
  call loop_A_Q(G1(:,:,:,88),Q(:,30),ZERO,G2(:,:,:,94))
  call check_last_AQ_V(l_switch,G2(:,:,:,94),wf(:,0),G2tensor(:,18))
  call check_last_AQ_V(l_switch,G1(:,:,:,87),wf(:,3),G1tensor(:,8))
  ...
  call loop_AZ_Q(G1(:,:,:,97),wf(:,14),G1(:,:,:,99),gZu)
  ...
  call loop_Q_A(G0(:,:,:,41),Q(:,21),ZERO,G1(:,:,:,102))
  ...
  call loop_VA_Q(G0(:,:,:,1),wf(:,51),G0(:,:,:,42))
  call loop_A_Q(G0(:,:,:,42),Q(:,26),ZERO,G1(:,:,:,104))
...
end module ol_vamp_1_ppwwj_uuxwwxg_1_/**/REALKIND
