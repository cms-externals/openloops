...
module ol_versiondata_pptln
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pptln(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pptln
  end interface
end module ol_versiondata_pptln


subroutine ol_version_pptln(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pptln, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pptln
