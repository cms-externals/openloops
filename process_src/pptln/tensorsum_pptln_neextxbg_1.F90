...
! **********************************************************************
module ol_tensor_sum_storage_pptln_neextxbg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pptln_neextxbg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pptln_neextxbg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_pptln_neextxbg_1, only: channel_number_pptln_neextxbg_1
  ...
  call channel_on(channel_number_pptln_neextxbg_1)
  M2 = 0
  ...
  momenta_9(:,1) = Q(1:4,8)
  momenta_9(:,2) = Q(1:4,11)
  momenta_9(:,3) = Q(1:4,27)
  ...
  masses2_11 = [ ZERO2, ZERO2, MB2, MT2 ]
  ...
  call TI_call(2, momenta_4, masses2_6, T2sum(:,5), M2)
  call TI_call(2, momenta_6, masses2_8, T2sum(:,6), M2)

  call TI_call(3, momenta_9, masses2_10, T3sum(:,1), M2)
  call TI_call(3, momenta_10, masses2_9, T3sum(:,2), M2)
  call TI_call(3, momenta_11, masses2_11, T3sum(:,3), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pptln_neextxbg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pptln_neextxbg_1_/**/REALKIND
