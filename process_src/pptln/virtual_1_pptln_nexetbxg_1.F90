...
module ol_vamp_1_pptln_nexetbxg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_pptln_nexetbxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_pptln_nexetbxg_1.
! **********************************************************************
...
#endif
  use ol_loop_pptln_nexetbxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_pptln_nexetbxg_1_/**/REALKIND
  ...
  call loop_Q_A(G0(:,:,:,2),Q(:,20),MT,G1(:,:,:,1))
  call loop_QS_A(G1(:,:,:,1),wf(:,1),G1(:,:,:,2),gPbt)
  call loop_Q_A(G1(:,:,:,2),Q(:,23),MB,G2(:,:,:,1))
  call check_last_QA_V(l_switch,G2(:,:,:,1),wf(:,-3),G2tensor(:,1))
  call loop_QW_A(G1(:,:,:,1),wf(:,5),G1(:,:,:,3))
  call loop_Q_A(G1(:,:,:,3),Q(:,23),MB,G2(:,:,:,2))
  call check_last_QA_V(l_switch,G2(:,:,:,2),wf(:,-3),G2tensor(:,2))
  call check_last_QA_V(l_switch,G1(:,:,:,1),wf(:,20),G1tensor(:,1))
  call check_last_QA_V(l_switch,G1(:,:,:,1),wf(:,21),G1tensor(:,2))
  call loop_VA_Q(G0(:,:,:,1),wf(:,8),G0(:,:,:,3))
  call loop_A_Q(G0(:,:,:,3),Q(:,24),MB,G1(:,:,:,4))
  call loop_AS_Q(G1(:,:,:,4),wf(:,1),G1(:,:,:,5),gPbt)
  call loop_A_Q(G1(:,:,:,5),Q(:,27),MT,G2(:,:,:,3))
  call check_last_AQ_V(l_switch,G2(:,:,:,3),wf(:,-2),G2tensor(:,3))
  call loop_AW_Q(G1(:,:,:,4),wf(:,5),G1(:,:,:,6))
  call loop_A_Q(G1(:,:,:,6),Q(:,27),MT,G2(:,:,:,4))
  call check_last_AQ_V(l_switch,G2(:,:,:,4),wf(:,-2),G2tensor(:,4))
  call check_last_AQ_V(l_switch,G1(:,:,:,4),wf(:,23),G1tensor(:,3))
  call check_last_AQ_V(l_switch,G1(:,:,:,4),wf(:,24),G1tensor(:,4))
  call loop_VA_Q(G0(:,:,:,1),wf(:,-3),G0(:,:,:,4))
  call loop_A_Q(G0(:,:,:,4),Q(:,8),MB,G1(:,:,:,7))
  call loop_AV_Q(G1(:,:,:,7),wf(:,-4),G1(:,:,:,8))
  call loop_A_Q(G1(:,:,:,8),Q(:,24),MB,G2(:,:,:,5))
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,23),G2tensor(:,5))
  call check_last_AQ_V(l_switch,G2(:,:,:,5),wf(:,24),G2tensor(:,6))
  call loop_AS_Q(G2(:,:,:,5),wf(:,1),G2(:,:,:,6),gPbt)
  call loop_A_Q(G2(:,:,:,6),Q(:,27),MT,G3(:,:,:,1))
  call check_last_AQ_V(l_switch,G3(:,:,:,1),wf(:,-2),G3tensor(:,1))
  call loop_AW_Q(G2(:,:,:,5),wf(:,5),G2(:,:,:,7))
  call loop_A_Q(G2(:,:,:,7),Q(:,27),MT,G3(:,:,:,2))
  call check_last_AQ_V(l_switch,G3(:,:,:,2),wf(:,-2),G3tensor(:,2))
  call loop_AS_Q(G1(:,:,:,7),wf(:,1),G1(:,:,:,9),gPbt)
  call loop_A_Q(G1(:,:,:,9),Q(:,11),MT,G2(:,:,:,8))
  call loop_AV_Q(G2(:,:,:,8),wf(:,-4),G2(:,:,:,9))
  call loop_A_Q(G2(:,:,:,9),Q(:,27),MT,G3(:,:,:,3))
  call check_last_AQ_V(l_switch,G3(:,:,:,3),wf(:,-2),G3tensor(:,3))
  call loop_AW_Q(G1(:,:,:,7),wf(:,5),G1(:,:,:,10))
  call loop_A_Q(G1(:,:,:,10),Q(:,11),MT,G2(:,:,:,10))
  call loop_AV_Q(G2(:,:,:,10),wf(:,-4),G2(:,:,:,11))
  call loop_A_Q(G2(:,:,:,11),Q(:,27),MT,G3(:,:,:,4))
  call check_last_AQ_V(l_switch,G3(:,:,:,4),wf(:,-2),G3tensor(:,4))
  call loop_UV_W(G0(:,:,:,1),Q(:,0),wf(:,-4),Q(:,16),G1(:,:,:,11))
  call loop_VA_Q(G1(:,:,:,11),wf(:,-3),G1(:,:,:,12))
  call loop_A_Q(G1(:,:,:,12),Q(:,24),MB,G2(:,:,:,12))
  call check_last_AQ_V(l_switch,G2(:,:,:,12),wf(:,23),G2tensor(:,7))
  call check_last_AQ_V(l_switch,G2(:,:,:,12),wf(:,24),G2tensor(:,8))
  call loop_AS_Q(G2(:,:,:,12),wf(:,1),G2(:,:,:,13),gPbt)
  call loop_A_Q(G2(:,:,:,13),Q(:,27),MT,G3(:,:,:,5))
  call check_last_AQ_V(l_switch,G3(:,:,:,5),wf(:,-2),G3tensor(:,5))
  call loop_AW_Q(G2(:,:,:,12),wf(:,5),G2(:,:,:,14))
  call loop_A_Q(G2(:,:,:,14),Q(:,27),MT,G3(:,:,:,6))
  call check_last_AQ_V(l_switch,G3(:,:,:,6),wf(:,-2),G3tensor(:,6))
  call loop_VA_Q(G1(:,:,:,11),wf(:,20),G1(:,:,:,13))
  call loop_A_Q(G1(:,:,:,13),Q(:,27),MT,G2(:,:,:,15))
  call check_last_AQ_V(l_switch,G2(:,:,:,15),wf(:,-2),G2tensor(:,9))
  call loop_VA_Q(G1(:,:,:,11),wf(:,21),G1(:,:,:,14))
  call loop_A_Q(G1(:,:,:,14),Q(:,27),MT,G2(:,:,:,16))
  call check_last_AQ_V(l_switch,G2(:,:,:,16),wf(:,-2),G2tensor(:,10))
  call loop_VA_Q(G0(:,:,:,1),wf(:,20),G0(:,:,:,5))
  call loop_A_Q(G0(:,:,:,5),Q(:,11),MT,G1(:,:,:,15))
  call loop_AV_Q(G1(:,:,:,15),wf(:,-4),G1(:,:,:,16))
  call loop_A_Q(G1(:,:,:,16),Q(:,27),MT,G2(:,:,:,17))
  call check_last_AQ_V(l_switch,G2(:,:,:,17),wf(:,-2),G2tensor(:,11))
  call loop_VA_Q(G0(:,:,:,1),wf(:,21),G0(:,:,:,6))
  call loop_A_Q(G0(:,:,:,6),Q(:,11),MT,G1(:,:,:,17))
  call loop_AV_Q(G1(:,:,:,17),wf(:,-4),G1(:,:,:,18))
  call loop_A_Q(G1(:,:,:,18),Q(:,27),MT,G2(:,:,:,18))
...
end module ol_vamp_1_pptln_nexetbxg_1_/**/REALKIND
