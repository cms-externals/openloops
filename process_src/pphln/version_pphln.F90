...
module ol_versiondata_pphln
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pphln(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphln
  end interface
end module ol_versiondata_pphln


subroutine ol_version_pphln(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphln, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphln
