...
module ol_colourmatrix_pphln_neexuxdh_1_/**/REALKIND
...
end module ol_colourmatrix_pphln_neexuxdh_1_/**/REALKIND



module ol_forced_parameters_pphln_neexuxdh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphln_neexuxdh_1_/**/REALKIND

module ol_loop_pphln_neexuxdh_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_QA_W(wf(:,-3),wf(:,-2),wf(:,6))
  call prop_W_W(wf(:,6),Q(:,12),MW,1_intkind1,wf(:,7))
  call prop_W_W(wf(:,5),Q(:,19),MW,1_intkind1,wf(:,8))
...
end module ol_loop_pphln_neexuxdh_1_/**/REALKIND
