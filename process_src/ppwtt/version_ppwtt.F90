...
module ol_versiondata_ppwtt
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppwtt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppwtt
  end interface
end module ol_versiondata_ppwtt


subroutine ol_version_ppwtt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppwtt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppwtt
