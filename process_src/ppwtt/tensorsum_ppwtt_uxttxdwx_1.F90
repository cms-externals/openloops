...
! **********************************************************************
module ol_tensor_sum_storage_ppwtt_uxttxdwx_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppwtt_uxttxdwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppwtt_uxttxdwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_ppwtt_uxttxdwx_1, only: channel_number_ppwtt_uxttxdwx_1
  ...
  call channel_on(channel_number_ppwtt_uxttxdwx_1)
  M2 = 0
  ...
  masses2_7 = [ ZERO2, MT2, ZERO2, ZERO2 ]
  masses2_8 = [ ZERO2, ZERO2, ZERO2, MT2 ]
  masses2_9 = [ ZERO2, ZERO2, ZERO2, ZERO2 ]
  masses2_10 = [ ZERO2, MT2, ZERO2, ZERO2, ZERO2 ]
  ...
  call TI_call(2, momenta_10, masses2_6, T2sum(:,3), M2)
  ...
  call TI_call(2, momenta_12, masses2_7, T2sum(:,11), M2)
  call TI_call(2, momenta_13, masses2_7, T2sum(:,12), M2)
  ...
  call TI_call(3, momenta_15, masses2_9, T3sum(:,1), M2)
  call TI_call(3, momenta_16, masses2_9, T3sum(:,2), M2)
  call TI_call(3, momenta_14, masses2_9, T3sum(:,3), M2)
  call TI_call(3, momenta_19, masses2_10, T3sum(:,4), M2)
  call TI_call(3, momenta_20, masses2_10, T3sum(:,5), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppwtt_uxttxdwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppwtt_uxttxdwx_1_/**/REALKIND
