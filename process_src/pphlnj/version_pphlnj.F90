...
module ol_versiondata_pphlnj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pphlnj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphlnj
  end interface
end module ol_versiondata_pphlnj


subroutine ol_version_pphlnj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphlnj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphlnj
