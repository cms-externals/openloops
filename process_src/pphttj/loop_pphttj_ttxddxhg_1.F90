...
subroutine diagrams(A)
  ...
  A(15) = cont_VV(wf(:,8),wf(:,32)) * den(35)
  A(16) = cont_VV(wf(:,8),wf(:,32)) * den(35)
  A(17) = cont_VV(wf(:,33),wf(:,34)) * den(38)
  A(18) = cont_VV(wf(:,33),wf(:,34)) * den(38)
  A(19) = cont_VV(wf(:,25),wf(:,32)) * den(40)
  A(20) = cont_VV(wf(:,25),wf(:,32)) * den(40)
  A(21) = cont_VV(wf(:,28),wf(:,32)) * den(42)
  A(22) = cont_VV(wf(:,28),wf(:,32)) * den(42)
  A(23) = cont_QA(wf(:,36),wf(:,37)) * den(45)
  A(24) = cont_QA(wf(:,36),wf(:,37)) * den(45)
  A(25) = cont_QA(wf(:,39),wf(:,40)) * den(48)
  A(26) = cont_QA(wf(:,39),wf(:,40)) * den(48)
  A(27) = cont_VV(wf(:,3),wf(:,41)) * den(5)
  A(28) = cont_VV(wf(:,7),wf(:,42)) * den(8)
  A(29) = cont_QA(wf(:,11),wf(:,43)) * den(11)
  A(30) = cont_VV(wf(:,3),wf(:,44)) * den(15)
  A(31) = cont_VV(wf(:,17),wf(:,42)) * den(17)
  A(32) = cont_QA(wf(:,20),wf(:,45)) * den(20)
  A(33) = cont_VV(wf(:,31),wf(:,46)) * den(50)
  A(34) = cont_VV(wf(:,31),wf(:,46)) * den(50)
  A(35) = cont_QA(wf(:,11),wf(:,47)) * den(21)
  A(36) = cont_VV(wf(:,31),wf(:,48)) * den(52)
  A(37) = cont_VV(wf(:,31),wf(:,48)) * den(52)
  A(38) = cont_QA(wf(:,20),wf(:,49)) * den(22)
  A(39) = cont_QA(wf(:,20),wf(:,50)) * den(53)
  A(40) = cont_QA(wf(:,20),wf(:,50)) * den(53)
  A(41) = cont_QA(wf(:,9),wf(:,52)) * den(56)
  A(42) = cont_QA(wf(:,9),wf(:,52)) * den(56)
  A(43) = cont_VV(wf(:,7),wf(:,53)) * den(24)
  A(44) = cont_VV(wf(:,7),wf(:,56)) * den(26)
  A(45) = cont_VV(wf(:,17),wf(:,53)) * den(27)
  A(46) = cont_VV(wf(:,17),wf(:,56)) * den(28)
  A(47) = cont_VV(wf(:,7),wf(:,57)) * den(26)
  A(48) = cont_VV(wf(:,7),wf(:,60)) * den(24)
  A(49) = cont_VV(wf(:,17),wf(:,57)) * den(28)
  A(50) = cont_VV(wf(:,17),wf(:,60)) * den(27)
  A(51) = cont_VV(wf(:,6),wf(:,61)) * den(5)
  A(52) = cont_VV(wf(:,7),wf(:,62)) * den(8)
  A(53) = cont_QA(wf(:,10),wf(:,64)) * den(11)
  A(54) = cont_VV(wf(:,16),wf(:,61)) * den(15)
  A(55) = cont_VV(wf(:,17),wf(:,62)) * den(17)
  A(56) = cont_QA(wf(:,19),wf(:,66)) * den(20)
  A(57) = cont_QA(wf(:,21),wf(:,64)) * den(21)
  A(58) = cont_QA(wf(:,22),wf(:,66)) * den(22)
  A(59) = cont_QA(wf(:,67),wf(:,68)) * den(58)
  A(60) = cont_VV(wf(:,8),wf(:,69)) * den(59)
  A(61) = cont_VV(wf(:,3),wf(:,72)) * den(5)
  A(62) = cont_QA(wf(:,67),wf(:,73)) * den(61)
  A(63) = cont_QA(wf(:,20),wf(:,74)) * den(22)
  A(64) = cont_VV(wf(:,3),wf(:,77)) * den(15)
  A(65) = cont_QA(wf(:,20),wf(:,78)) * den(20)
  A(66) = cont_VV(wf(:,8),wf(:,79)) * den(17)
  A(67) = cont_VV(wf(:,25),wf(:,69)) * den(62)
  A(68) = cont_VV(wf(:,28),wf(:,69)) * den(63)
  A(69) = cont_VV(wf(:,25),wf(:,79)) * den(27)
  A(70) = cont_VV(wf(:,28),wf(:,79)) * den(28)
  A(71) = cont_VV(wf(:,8),wf(:,80)) * den(64)
  A(72) = cont_QA(wf(:,81),wf(:,82)) * den(67)
  A(73) = cont_VV(wf(:,3),wf(:,85)) * den(15)
  A(74) = cont_QA(wf(:,81),wf(:,86)) * den(69)
  A(75) = cont_QA(wf(:,11),wf(:,87)) * den(21)
  A(76) = cont_VV(wf(:,3),wf(:,90)) * den(5)
  A(77) = cont_VV(wf(:,8),wf(:,91)) * den(8)
  A(78) = cont_QA(wf(:,11),wf(:,92)) * den(11)
  A(79) = cont_VV(wf(:,25),wf(:,80)) * den(70)
  A(80) = cont_VV(wf(:,28),wf(:,80)) * den(71)
  A(81) = cont_VV(wf(:,25),wf(:,91)) * den(24)
  A(82) = cont_VV(wf(:,28),wf(:,91)) * den(26)
  A(83) = cont_QA(wf(:,94),wf(:,95)) * den(75)
  A(84) = cont_QA(wf(:,97),wf(:,98)) * den(79)
  A(85) = cont_VV(wf(:,6),wf(:,99)) * den(82)
  A(86) = cont_VV(wf(:,8),wf(:,101)) * den(84)
  A(87) = cont_QA(wf(:,11),wf(:,102)) * den(85)
  A(88) = cont_QA(wf(:,68),wf(:,103)) * den(87)
  A(89) = cont_VV(wf(:,8),wf(:,104)) * den(88)
  A(90) = cont_QA(wf(:,68),wf(:,105)) * den(89)
  A(91) = cont_VV(wf(:,7),wf(:,106)) * den(90)
  A(92) = cont_QA(wf(:,108),wf(:,109)) * den(94)
  A(93) = cont_QA(wf(:,111),wf(:,112)) * den(98)
  A(94) = cont_VV(wf(:,16),wf(:,99)) * den(100)
  A(95) = cont_VV(wf(:,8),wf(:,114)) * den(102)
  A(96) = cont_QA(wf(:,82),wf(:,115)) * den(103)
  A(97) = cont_VV(wf(:,8),wf(:,116)) * den(104)
  A(98) = cont_QA(wf(:,82),wf(:,117)) * den(105)
  A(99) = cont_QA(wf(:,20),wf(:,118)) * den(106)
  A(100) = cont_VV(wf(:,17),wf(:,106)) * den(107)
  A(101) = cont_QA(wf(:,11),wf(:,120)) * den(109)
  A(102) = cont_QA(wf(:,73),wf(:,103)) * den(110)
  A(103) = cont_QA(wf(:,73),wf(:,105)) * den(111)
  A(104) = cont_QA(wf(:,86),wf(:,115)) * den(112)
  A(105) = cont_QA(wf(:,86),wf(:,117)) * den(113)
  A(106) = cont_QA(wf(:,20),wf(:,122)) * den(115)
  A(107) = cont_VV(wf(:,25),wf(:,101)) * den(116)
  A(108) = cont_VV(wf(:,25),wf(:,104)) * den(117)
  A(109) = cont_VV(wf(:,7),wf(:,125)) * den(119)
  A(110) = cont_VV(wf(:,28),wf(:,101)) * den(120)
  A(111) = cont_VV(wf(:,28),wf(:,104)) * den(121)
  A(112) = cont_VV(wf(:,7),wf(:,128)) * den(123)
  A(113) = cont_VV(wf(:,25),wf(:,114)) * den(124)
  A(114) = cont_VV(wf(:,25),wf(:,116)) * den(125)
  A(115) = cont_VV(wf(:,17),wf(:,125)) * den(126)
  A(116) = cont_VV(wf(:,28),wf(:,114)) * den(127)
  A(117) = cont_VV(wf(:,28),wf(:,116)) * den(128)
  A(118) = cont_VV(wf(:,17),wf(:,128)) * den(129)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(34)-A(37)-A(40)-A(42))*f(1))/6._/**/REALKIND+((-A(33)-A(36)-A(39)-A(41))*f(5))/6._/**/REALKIND+((A(83)+A(84)+A(85) &
       +A(87)+A(88)+A(90)+A(92)+A(93)+A(94)+A(96)+A(98)+A(99)+A(101)+A(102)+A(103)+A(104)+A(105)+A(106))*f(9))/6._/**/REALKIND+(( &
       -A(51)-A(53)-A(54)-A(56)-A(57)-A(58))*f(11))/6._/**/REALKIND+((-A(27)-A(29)-A(30)-A(32)-A(59)-A(61)-A(62)-A(63)-A(72)-A(73) &
       -A(74)-A(75))*f(13))/6._/**/REALKIND+((-A(35)-A(38)-A(64)-A(65)-A(76)-A(78))*f(15))/6._/**/REALKIND
  M2(2) = ((A(20)+A(26)+A(37)+A(40))*f(1))/2._/**/REALKIND+(CI*(A(14)-A(16)-A(18))*f(2))/2._/**/REALKIND+((A(19)+A(25)+A(36) &
       +A(39))*f(5))/2._/**/REALKIND+(CI*(A(13)-A(15)-A(17))*f(6))/2._/**/REALKIND+((-A(83)-A(84)-A(85)-A(96)-A(98)-A(99)-A(104) &
       -A(105)-A(106)-A(107)-A(108)-A(109)-A(113)-A(114)-A(115))*f(9))/2._/**/REALKIND+(CI*(A(86)+A(89)+A(91)+A(95)+A(97) &
       +A(100))*f(10))/2._/**/REALKIND+((A(43)+A(45)+A(48)+A(50)+A(51)+A(56)+A(58))*f(11))/2._/**/REALKIND+(CI*(-A(52) &
       -A(55))*f(12))/2._/**/REALKIND+((A(27)+A(32)+A(61)+A(63)+A(67)+A(72)+A(74)+A(79))*f(13))/2._/**/REALKIND+(CI*(-A(60) &
       -A(71))*f(14))/2._/**/REALKIND+((A(38)+A(65)+A(69)+A(76)+A(81))*f(15))/2._/**/REALKIND+(CI*(-A(66) &
       -A(77))*f(16))/2._/**/REALKIND+(CI*(-A(28)-A(31))*f(17))/2._/**/REALKIND
  M2(3) = ((A(22)+A(24)+A(34)+A(42))*f(1))/2._/**/REALKIND+(CI*(-A(14)+A(16)+A(18))*f(2))/2._/**/REALKIND+((A(21)+A(23)+A(33) &
       +A(41))*f(5))/2._/**/REALKIND+(CI*(-A(13)+A(15)+A(17))*f(6))/2._/**/REALKIND+((-A(87)-A(88)-A(90)-A(92)-A(93)-A(94)-A(101) &
       -A(102)-A(103)-A(110)-A(111)-A(112)-A(116)-A(117)-A(118))*f(9))/2._/**/REALKIND+(CI*(-A(86)-A(89)-A(91)-A(95)-A(97) &
       -A(100))*f(10))/2._/**/REALKIND+((A(44)+A(46)+A(47)+A(49)+A(53)+A(54)+A(57))*f(11))/2._/**/REALKIND+(CI*(A(52) &
       +A(55))*f(12))/2._/**/REALKIND+((A(29)+A(30)+A(59)+A(62)+A(68)+A(73)+A(75)+A(80))*f(13))/2._/**/REALKIND+(CI*(A(60) &
       +A(71))*f(14))/2._/**/REALKIND+((A(35)+A(64)+A(70)+A(78)+A(82))*f(15))/2._/**/REALKIND+(CI*(A(66) &
       +A(77))*f(16))/2._/**/REALKIND+(CI*(A(28)+A(31))*f(17))/2._/**/REALKIND
  M2(4) = ((-A(20)-A(22)-A(24)-A(26))*f(1))/6._/**/REALKIND+((-A(19)-A(21)-A(23)-A(25))*f(5))/6._/**/REALKIND+((A(107)+A(108) &
       +A(109)+A(110)+A(111)+A(112)+A(113)+A(114)+A(115)+A(116)+A(117)+A(118))*f(9))/6._/**/REALKIND+((-A(43)-A(44)-A(45)-A(46) &
       -A(47)-A(48)-A(49)-A(50))*f(11))/6._/**/REALKIND+((-A(67)-A(68)-A(79)-A(80))*f(13))/6._/**/REALKIND+((-A(69)-A(70)-A(81) &
       -A(82))*f(15))/6._/**/REALKIND
