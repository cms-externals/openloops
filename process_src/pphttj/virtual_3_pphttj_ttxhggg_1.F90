...
module ol_vamp_3_pphttj_ttxhggg_1_/**/REALKIND
contains
...
! **********************************************************************
  ...
  T3sum(1:15,11) = T3sum(1:15,11) + Gcoeff * G2tensor(:,1)
  ...
  T3sum(1:15,12) = T3sum(1:15,12) + Gcoeff * G2tensor(:,2)
  ...
  T3sum(1:15,18) = T3sum(1:15,18) + Gcoeff * G2tensor(:,48)
  ...
  T3sum(1:15,19) = T3sum(1:15,19) + Gcoeff * G2tensor(:,49)
  ...
  T3sum(1:15,20) = T3sum(1:15,20) + Gcoeff * G2tensor(:,57)
  Gcoeff = (c(20)*(M(1)+M(6))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(30)
  T3sum(1:15,20) = T3sum(1:15,20) + Gcoeff * G2tensor(:,65)
  Gcoeff = (c(20)*(M(1)-M(3)-M(5)+M(6))) * den(30)
  T3sum(1:15,20) = T3sum(1:15,20) + Gcoeff * G2tensor(:,73)
  ...
  T3sum(1:15,22) = T3sum(1:15,22) + Gcoeff * G2tensor(:,69)
  Gcoeff = (c(17)*(-M(10)+M(11))) * den(1)
  ...
  T3sum(1:15,23) = T3sum(1:15,23) + Gcoeff * G2tensor(:,74)
  ...
  T3sum(1:15,29) = T3sum(1:15,29) + Gcoeff * G2tensor(:,38)
  Gcoeff = (c(10)*M(4)+c(8)*(M(7)+M(8)+M(9)-M(11))) * den(4)
  T3sum(1:15,29) = T3sum(1:15,29) + Gcoeff * G2tensor(:,44)
  Gcoeff = (c(10)*(-M(3)+M(4))+c(8)*(M(10)-M(11))) * den(4)
  T3sum(1:15,29) = T3sum(1:15,29) + Gcoeff * G2tensor(:,50)
  ...
  T3sum(1:15,20) = T3sum(1:15,20) + Gcoeff * G2tensor(:,59)
  Gcoeff = (c(20)*(M(1)+M(6))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(65)
  T3sum(1:15,20) = T3sum(1:15,20) + Gcoeff * G2tensor(:,67)
  Gcoeff = (c(20)*(M(1)-M(3)-M(5)+M(6))) * den(65)
  T3sum(1:15,20) = T3sum(1:15,20) + Gcoeff * G2tensor(:,75)
  ...
  T3sum(1:15,31) = T3sum(1:15,31) + Gcoeff * G2tensor(:,71)
  Gcoeff = (c(17)*(M(10)-M(11))) * den(4)
  T3sum(1:15,31) = T3sum(1:15,31) + Gcoeff * G2tensor(:,79)
  Gcoeff = (c(10)*M(5)+c(8)*(M(7)+M(8)+M(9)-M(11))) * den(4)
  T3sum(1:15,32) = T3sum(1:15,32) + Gcoeff * G2tensor(:,60)
  Gcoeff = (c(10)*M(6)+c(8)*(M(7)+M(8)+M(9)-M(10))) * den(4)
  T3sum(1:15,32) = T3sum(1:15,32) + Gcoeff * G2tensor(:,68)
  Gcoeff = (c(10)*(-M(5)+M(6))+c(8)*(-M(10)+M(11))) * den(4)
  T3sum(1:15,32) = T3sum(1:15,32) + Gcoeff * G2tensor(:,76)
  ...
  T3sum(1:15,36) = T3sum(1:15,36) + Gcoeff * G2tensor(:,51)
  ...
  T3sum(1:15,37) = T3sum(1:15,37) + Gcoeff * G2tensor(:,35)
  ...
  T3sum(1:15,35) = T3sum(1:15,35) + Gcoeff * G2tensor(:,53)
  Gcoeff = (c(10)*(-M(1)+M(2))+c(8)*(-M(10)+M(11))) * den(7)
  T3sum(1:15,35) = T3sum(1:15,35) + Gcoeff * G2tensor(:,54)
  Gcoeff = (c(10)*(-M(1)+M(2)+M(4)-M(6))) * den(7)
  T3sum(1:15,35) = T3sum(1:15,35) + Gcoeff * G2tensor(:,55)
  ...
  T3sum(1:15,38) = T3sum(1:15,38) + Gcoeff * G2tensor(:,62)
  Gcoeff = (c(20)*M(1)+c(17)*M(7)) * den(62)
  T3sum(1:15,38) = T3sum(1:15,38) + Gcoeff * G2tensor(:,70)
  Gcoeff = (c(20)*(M(1)-M(3))) * den(62)
  T3sum(1:15,38) = T3sum(1:15,38) + Gcoeff * G2tensor(:,78)
  ...
  T4sum(1:70,64) = T4sum(1:70,64) + Gcoeff * G4tensor(:,23)
  Gcoeff = (-(c(10)*M(1))+c(8)*(-M(7)-M(8)-M(9)+M(11))) * den(1)
  ...
  T3sum(1:35,125) = T3sum(1:35,125) + Gcoeff * G3tensor(:,31)
  ...
  Gcoeff = (c(20)*(M(2)+M(4))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(65)
  T4sum(1:70,55) = T4sum(1:70,55) + Gcoeff * G4tensor(:,4)
  Gcoeff = (c(10)*M(4)) * den(494)
  T2sum(1:15,78) = T2sum(1:15,78) + Gcoeff * G2tensor(:,23)
  Gcoeff = (-(c(8)*M(8))) * den(52)
  T3sum(1:35,139) = T3sum(1:35,139) + Gcoeff * G3tensor(:,34)
  Gcoeff = (c(20)*M(4)+c(17)*M(8)) * den(52)
  ...
  T3sum(1:35,145) = T3sum(1:35,145) + Gcoeff * G3tensor(:,35)
  Gcoeff = (c(20)*M(6)+c(17)*M(7)) * den(159)
  T3sum(1:35,147) = T3sum(1:35,147) + Gcoeff * G3tensor(:,16)
  Gcoeff = (c(17)*(-M(7)-M(9)+M(11))) * den(4)
  T4sum(1:70,83) = T4sum(1:70,83) + Gcoeff * G4tensor(:,8)
  ...
  T4sum(1:70,88) = T4sum(1:70,88) + Gcoeff * G4tensor(:,29)
  Gcoeff = (c(10)*M(6)+c(8)*(M(7)+M(8)+M(9)-M(10))) * den(4)
  T4sum(1:70,91) = T4sum(1:70,91) + Gcoeff * G4tensor(:,15)
  Gcoeff = (c(10)*M(4)+c(8)*(M(7)+M(8)+M(9)-M(11))) * den(4)
  T4sum(1:70,93) = T4sum(1:70,93) + Gcoeff * G4tensor(:,5)
  ...
  T3sum(1:35,183) = T3sum(1:35,183) + Gcoeff * G3tensor(:,28)
  Gcoeff = (c(8)*M(8)) * den(54)
  T4sum(1:70,130) = T4sum(1:70,130) + Gcoeff * G4tensor(:,24)
  Gcoeff = (c(20)*M(2)+c(17)*M(8)) * den(54)
  T4sum(1:70,131) = T4sum(1:70,131) + Gcoeff * G4tensor(:,7)
  Gcoeff = (c(8)*M(8)) * den(54)
  T4sum(1:70,137) = T4sum(1:70,137) + Gcoeff * G4tensor(:,25)
  Gcoeff = (c(10)*M(4)) * den(542)
  T2sum(1:15,78) = T2sum(1:15,78) + Gcoeff * G2tensor(:,27)
  Gcoeff = (-(c(8)*M(8))) * den(82)
  T3sum(1:35,139) = T3sum(1:35,139) + Gcoeff * G3tensor(:,37)
  Gcoeff = (c(20)*M(4)+c(17)*M(8)) * den(82)
  T3sum(1:35,141) = T3sum(1:35,141) + Gcoeff * G3tensor(:,10)
  ...
  T4sum(1:70,142) = T4sum(1:70,142) + Gcoeff * G4tensor(:,9)
  Gcoeff = (c(20)*M(4)+c(17)*M(8)) * den(16)
  ...
  Gcoeff = (c(20)*M(6)+c(17)*M(7)) * den(25)
  T4sum(1:70,175) = T4sum(1:70,175) + Gcoeff * G4tensor(:,11)
  Gcoeff = (-(c(8)*M(7))) * den(25)
  ...
  T3sum(1:35,183) = T3sum(1:35,183) + Gcoeff * G3tensor(:,32)
  ...
  T4sum(1:70,200) = T4sum(1:70,200) + Gcoeff * G4tensor(:,30)
  Gcoeff = (c(17)*(M(10)-M(11))) * den(7)
  T4sum(1:70,201) = T4sum(1:70,201) + Gcoeff * G4tensor(:,31)
  Gcoeff = (c(10)*M(4)+c(8)*(M(7)+M(8)+M(9)-M(11)))
  T5sum(1:126,49) = T5sum(1:126,49) + Gcoeff * G5tensor(:,1)
  Gcoeff = (c(10)*M(6)+c(8)*(M(7)+M(8)+M(9)-M(10)))
  T5sum(1:126,50) = T5sum(1:126,50) + Gcoeff * G5tensor(:,4)
  Gcoeff = (c(8)*(M(9)-M(10)))
  T5sum(1:126,51) = T5sum(1:126,51) + Gcoeff * G5tensor(:,9)
  Gcoeff = (c(8)*(M(9)-M(11)))
  T5sum(1:126,52) = T5sum(1:126,52) + Gcoeff * G5tensor(:,11)
  Gcoeff = (c(17)*(-M(7)-M(9)+M(11)))
  T5sum(1:126,53) = T5sum(1:126,53) + Gcoeff * G5tensor(:,2)
  Gcoeff = (c(17)*(-M(8)-M(9)+M(10)))
  T5sum(1:126,54) = T5sum(1:126,54) + Gcoeff * G5tensor(:,5)
  Gcoeff = (c(8)*(M(9)-M(11)))
  T5sum(1:126,67) = T5sum(1:126,67) + Gcoeff * G5tensor(:,7)
  Gcoeff = (c(17)*(-M(7)-M(9)+M(11)))
  T5sum(1:126,70) = T5sum(1:126,70) + Gcoeff * G5tensor(:,3)
  Gcoeff = (c(8)*(M(9)-M(11)))
  T5sum(1:126,71) = T5sum(1:126,71) + Gcoeff * G5tensor(:,12)
  Gcoeff = (c(8)*(M(9)-M(10)))
  T5sum(1:126,73) = T5sum(1:126,73) + Gcoeff * G5tensor(:,8)
  Gcoeff = (c(17)*(-M(8)-M(9)+M(10)))
  T5sum(1:126,75) = T5sum(1:126,75) + Gcoeff * G5tensor(:,6)
  Gcoeff = (c(8)*(M(9)-M(10)))
  T5sum(1:126,77) = T5sum(1:126,77) + Gcoeff * G5tensor(:,10)
...
end module ol_vamp_3_pphttj_ttxhggg_1_/**/REALKIND
