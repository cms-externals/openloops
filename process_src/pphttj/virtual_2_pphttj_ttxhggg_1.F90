...
module ol_vamp_2_pphttj_ttxhggg_1_/**/REALKIND
contains
...
! **********************************************************************
  ...
  T3sum(1:15,9) = T3sum(1:15,9) + Gcoeff * G2tensor(:,22)
  ...
  T3sum(1:15,9) = T3sum(1:15,9) + Gcoeff * G2tensor(:,24)
  ...
  Gcoeff = (c(20)*(M(1)+M(6))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(30)
  T3sum(1:15,15) = T3sum(1:15,15) + Gcoeff * G2tensor(:,26)
  Gcoeff = (c(20)*(M(1)-M(2)-M(4)+M(6))) * den(30)
  T3sum(1:15,15) = T3sum(1:15,15) + Gcoeff * G2tensor(:,27)
  Gcoeff = (c(20)*(M(2)+M(4))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(30)
  T3sum(1:15,16) = T3sum(1:15,16) + Gcoeff * G2tensor(:,31)
  Gcoeff = (c(20)*(M(3)+M(5))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(30)
  T3sum(1:15,16) = T3sum(1:15,16) + Gcoeff * G2tensor(:,35)
  Gcoeff = (c(20)*(-M(2)+M(3)-M(4)+M(5))) * den(30)
  T3sum(1:15,16) = T3sum(1:15,16) + Gcoeff * G2tensor(:,39)
  Gcoeff = (-(c(10)*M(4))+c(8)*(-M(7)-M(8)-M(9)+M(11))) * den(1)
  ...
  T3sum(1:15,17) = T3sum(1:15,17) + Gcoeff * G2tensor(:,40)
  ...
  T3sum(1:15,9) = T3sum(1:15,9) + Gcoeff * G2tensor(:,44)
  Gcoeff = (c(20)*(-M(1)+M(3)+M(5)-M(6))) * den(65)
  T3sum(1:15,9) = T3sum(1:15,9) + Gcoeff * G2tensor(:,45)
  ...
  T3sum(1:15,25) = T3sum(1:15,25) + Gcoeff * G2tensor(:,18)
  ...
  T3sum(1:15,26) = T3sum(1:15,26) + Gcoeff * G2tensor(:,10)
  ...
  Gcoeff = (c(20)*(M(2)+M(4))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(65)
  T3sum(1:15,16) = T3sum(1:15,16) + Gcoeff * G2tensor(:,33)
  Gcoeff = (c(20)*(M(3)+M(5))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(65)
  T3sum(1:15,16) = T3sum(1:15,16) + Gcoeff * G2tensor(:,37)
  Gcoeff = (c(20)*(-M(2)+M(3)-M(4)+M(5))) * den(65)
  T3sum(1:15,16) = T3sum(1:15,16) + Gcoeff * G2tensor(:,41)
  Gcoeff = (c(10)*M(2)+c(8)*(M(7)+M(8)+M(9)-M(10))) * den(4)
  ...
  T3sum(1:15,33) = T3sum(1:15,33) + Gcoeff * G2tensor(:,17)
  ...
  T3sum(1:15,34) = T3sum(1:15,34) + Gcoeff * G2tensor(:,13)
  ...
  T3sum(1:15,35) = T3sum(1:15,35) + Gcoeff * G2tensor(:,76)
  Gcoeff = (c(10)*(-M(3)+M(4))+c(8)*(M(10)-M(11))) * den(17)
  T3sum(1:15,35) = T3sum(1:15,35) + Gcoeff * G2tensor(:,77)
  Gcoeff = (c(10)*(M(2)-M(3)+M(4)-M(5))) * den(17)
  T3sum(1:15,35) = T3sum(1:15,35) + Gcoeff * G2tensor(:,78)
  ...
  Gcoeff = (-(c(4)*M(2))+c(3)*M(11)) * den(106)
  T5sum(1:126,20) = T5sum(1:126,20) + Gcoeff * G5tensor(:,10)
  ...
  Gcoeff = (-(c(4)*M(1))+c(3)*M(10)) * den(106)
  T5sum(1:126,24) = T5sum(1:126,24) + Gcoeff * G5tensor(:,8)
  ...
  Gcoeff = (c(20)*M(2)+c(17)*M(9)) * den(8)
  T3sum(1:35,51) = T3sum(1:35,51) + Gcoeff * G3tensor(:,29)
  ...
  T3sum(1:35,99) = T3sum(1:35,99) + Gcoeff * G3tensor(:,45)
  Gcoeff = (c(20)*M(3)+c(17)*M(7)) * den(143)
  T3sum(1:35,104) = T3sum(1:35,104) + Gcoeff * G3tensor(:,53)
  ...
  Gcoeff = (c(20)*(M(3)+M(5))+c(18)*(M(7)+M(8)+M(9))+c(17)*(-M(10)-M(11))) * den(65)
  T4sum(1:70,49) = T4sum(1:70,49) + Gcoeff * G4tensor(:,32)
  ...
  T3sum(1:35,133) = T3sum(1:35,133) + Gcoeff * G3tensor(:,78)
  Gcoeff = (c(20)*M(2)+c(17)*M(9)) * den(60)
  ...
  T3sum(1:35,144) = T3sum(1:35,144) + Gcoeff * G3tensor(:,68)
  Gcoeff = (c(20)*M(5)+c(17)*M(7)) * den(159)
  T3sum(1:35,149) = T3sum(1:35,149) + Gcoeff * G3tensor(:,55)
  Gcoeff = (c(8)*(M(8)-M(10))) * den(4)
  T4sum(1:70,82) = T4sum(1:70,82) + Gcoeff * G4tensor(:,44)
  Gcoeff = (c(17)*(-M(7)-M(8)+M(10))) * den(4)
  T4sum(1:70,85) = T4sum(1:70,85) + Gcoeff * G4tensor(:,24)
  Gcoeff = (c(17)*(-M(8)-M(9)+M(11))) * den(4)
  T4sum(1:70,95) = T4sum(1:70,95) + Gcoeff * G4tensor(:,36)
  Gcoeff = (c(8)*(M(8)-M(11))) * den(4)
  T4sum(1:70,96) = T4sum(1:70,96) + Gcoeff * G4tensor(:,45)
  Gcoeff = (c(10)*M(5)+c(8)*(M(7)+M(8)+M(9)-M(11))) * den(4)
  T4sum(1:70,99) = T4sum(1:70,99) + Gcoeff * G4tensor(:,33)
  Gcoeff = (c(10)*M(2)+c(8)*(M(7)+M(8)+M(9)-M(10))) * den(4)
  T4sum(1:70,101) = T4sum(1:70,101) + Gcoeff * G4tensor(:,22)
  ...
  T3sum(1:35,155) = T3sum(1:35,155) + Gcoeff * G3tensor(:,49)
  ...
  T3sum(1:35,161) = T3sum(1:35,161) + Gcoeff * G3tensor(:,67)
  Gcoeff = (c(8)*M(9)) * den(45)
  T4sum(1:70,106) = T4sum(1:70,106) + Gcoeff * G4tensor(:,40)
  Gcoeff = (c(20)*M(4)+c(17)*M(9)) * den(45)
  T4sum(1:70,107) = T4sum(1:70,107) + Gcoeff * G4tensor(:,23)
  Gcoeff = (c(8)*M(9)) * den(45)
  T4sum(1:70,113) = T4sum(1:70,113) + Gcoeff * G4tensor(:,41)
  ...
  T3sum(1:35,169) = T3sum(1:35,169) + Gcoeff * G3tensor(:,72)
  ...
  T3sum(1:35,175) = T3sum(1:35,175) + Gcoeff * G3tensor(:,46)
  Gcoeff = (-(c(8)*M(9))) * den(6)
  T4sum(1:70,118) = T4sum(1:70,118) + Gcoeff * G4tensor(:,25)
  Gcoeff = (c(20)*M(2)+c(17)*M(9)) * den(6)
  ...
  T3sum(1:35,104) = T3sum(1:35,104) + Gcoeff * G3tensor(:,56)
  ...
  T3sum(1:35,144) = T3sum(1:35,144) + Gcoeff * G3tensor(:,79)
  ...
  T4sum(1:70,177) = T4sum(1:70,177) + Gcoeff * G4tensor(:,29)
  Gcoeff = (-(c(8)*M(7))) * den(25)
  T4sum(1:70,180) = T4sum(1:70,180) + Gcoeff * G4tensor(:,28)
  ...
  T3sum(1:35,175) = T3sum(1:35,175) + Gcoeff * G3tensor(:,62)
  Gcoeff = (c(10)*(-M(2)+M(5))+c(8)*(M(10)-M(11))) * den(17)
  T4sum(1:70,5) = T4sum(1:70,5) + Gcoeff * G4tensor(:,37)
  Gcoeff = (c(17)*(-M(10)+M(11))) * den(17)
  T4sum(1:70,192) = T4sum(1:70,192) + Gcoeff * G4tensor(:,46)
  Gcoeff = (c(17)*(-M(10)+M(11))) * den(17)
  T4sum(1:70,193) = T4sum(1:70,193) + Gcoeff * G4tensor(:,47)
  Gcoeff = (c(10)*M(2)+c(8)*(M(7)+M(8)+M(9)-M(10)))
  T5sum(1:126,55) = T5sum(1:126,55) + Gcoeff * G5tensor(:,19)
  Gcoeff = (c(10)*M(5)+c(8)*(M(7)+M(8)+M(9)-M(11)))
  T5sum(1:126,56) = T5sum(1:126,56) + Gcoeff * G5tensor(:,22)
  Gcoeff = (c(8)*(M(8)-M(11)))
  T5sum(1:126,57) = T5sum(1:126,57) + Gcoeff * G5tensor(:,27)
  Gcoeff = (c(17)*(-M(7)-M(8)+M(10)))
  T5sum(1:126,58) = T5sum(1:126,58) + Gcoeff * G5tensor(:,20)
  Gcoeff = (c(17)*(-M(8)-M(9)+M(11)))
  T5sum(1:126,59) = T5sum(1:126,59) + Gcoeff * G5tensor(:,23)
  Gcoeff = (c(8)*(M(8)-M(10)))
  T5sum(1:126,60) = T5sum(1:126,60) + Gcoeff * G5tensor(:,29)
  Gcoeff = (c(8)*(M(8)-M(10)))
  T5sum(1:126,68) = T5sum(1:126,68) + Gcoeff * G5tensor(:,25)
  Gcoeff = (c(17)*(-M(7)-M(8)+M(10)))
  T5sum(1:126,69) = T5sum(1:126,69) + Gcoeff * G5tensor(:,21)
  Gcoeff = (c(8)*(M(8)-M(10)))
  T5sum(1:126,72) = T5sum(1:126,72) + Gcoeff * G5tensor(:,30)
  Gcoeff = (c(17)*(-M(8)-M(9)+M(11)))
  T5sum(1:126,80) = T5sum(1:126,80) + Gcoeff * G5tensor(:,24)
  Gcoeff = (c(8)*(M(8)-M(11)))
  T5sum(1:126,81) = T5sum(1:126,81) + Gcoeff * G5tensor(:,26)
  Gcoeff = (c(8)*(M(8)-M(11)))
  T5sum(1:126,83) = T5sum(1:126,83) + Gcoeff * G5tensor(:,28)
...
end module ol_vamp_2_pphttj_ttxhggg_1_/**/REALKIND
