...
module ol_colourmatrix_pphttj_ttxbbxhg_1_/**/REALKIND
...
end module ol_colourmatrix_pphttj_ttxbbxhg_1_/**/REALKIND



module ol_forced_parameters_pphttj_ttxbbxhg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphttj_ttxbbxhg_1_/**/REALKIND

module ol_loop_pphttj_ttxbbxhg_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(42), c(52)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 9) = (CI*countertermnorm*ctGtt*eQED*gQCD**5*YB)/(2._/**/REALKIND*MW*sw)
    f(10) = (countertermnorm*ctGtt*eQED*gQCD**5*YB)/(MW*sw*2._/**/REALKIND)
    ...
    f(24) = (CI*eQED*gQCD**3*YT)/(2._/**/REALKIND*MW*sw)
    f(25) = (eQED*gQCD**3*YT)/(MW*sw*2._/**/REALKIND)
    f(26) = (CI*countertermnorm*eQED*gQCD**5*YT)/(2._/**/REALKIND*MW*sw)
    f(27) = (countertermnorm*eQED*gQCD**5*YT)/(MW*sw*2._/**/REALKIND)
    f(28) = (CI*countertermnorm*ctGbb*eQED*gQCD**5*YT)/(2._/**/REALKIND*MW*sw)
    f(29) = (countertermnorm*ctGbb*eQED*gQCD**5*YT)/(MW*sw*2._/**/REALKIND)
    f(30) = (CI*countertermnorm*ctGtt*eQED*gQCD**5*YT)/(2._/**/REALKIND*MW*sw)
    f(31) = (countertermnorm*ctGtt*eQED*gQCD**5*YT)/(MW*sw*2._/**/REALKIND)
    f(32) = (CI*countertermnorm*ctStt*eQED*gQCD**5*YT)/(2._/**/REALKIND*MW*sw)
    f(33) = (countertermnorm*ctStt*eQED*gQCD**5*YT)/(MW*sw*2._/**/REALKIND)
    f(34) = (countertermnorm*ctVVV*eQED*gQCD**5*YT)/(MW*sw*2._/**/REALKIND)
    f(35) = (CI*eQED*gQCD**5*integralnorm*SwB*YT)/(4._/**/REALKIND*MW*sw)
    f(36) = (CI*eQED*gQCD**5*integralnorm*SwB*YT)/(2._/**/REALKIND*MW*sw)
    f(37) = (eQED*gQCD**5*integralnorm*SwB*YT)/(MW*sw*4._/**/REALKIND)
    f(38) = (eQED*gQCD**5*integralnorm*SwB*YT)/(MW*sw*2._/**/REALKIND)
    f(39) = (CI*eQED*gQCD**5*integralnorm*SwF*YT)/(2._/**/REALKIND*MW*sw)
    f(40) = (CI*eQED*gQCD**5*integralnorm*SwF*YT)/(MW*sw)
    f(41) = (eQED*gQCD**5*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
    f(42) = (eQED*gQCD**5*integralnorm*SwF*YT)/(MW*sw)
  ...
  c = [ 27*CI*f(14), 54*CI*f(14), 3*CI*f(15), 9*CI*f(15), 24*CI*f(15), 27*CI*f(15), 54*CI*f(15), 18*f(16), 54*f(16), f(17) &
    ...
    , 9*CI*f(39), 9*CI*f(40), 3*f(41), 9*f(41), 3*f(42), 9*f(42) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,23),Q(:,17),MT,1_intkind1,wf(:,26))
  call prop_A_Q(wf(:,24),Q(:,34),MT,1_intkind1,wf(:,27))
  ...
  call prop_A_Q(wf(:,31),Q(:,14),MT,1_intkind1,wf(:,33))
  call vert_VQ_A(wf(:,-5),wf(:,0),wf(:,34))
  call vert_SA_Q(gH,wf(:,-4),wf(:,-1),wf(:,35))
  call prop_Q_A(wf(:,34),Q(:,33),MT,1_intkind1,wf(:,36))
  call prop_A_Q(wf(:,35),Q(:,18),MT,1_intkind1,wf(:,37))
  ...
  call prop_Q_A(wf(:,40),Q(:,13),MT,1_intkind1,wf(:,42))
  ...
  call prop_Q_A(wf(:,95),Q(:,49),MT,1_intkind1,wf(:,96))
  ...
  call prop_A_Q(wf(:,103),Q(:,14),MT,1_intkind1,wf(:,104))
  call vert_VQ_A(wf(:,101),wf(:,0),wf(:,105))
  call prop_Q_A(wf(:,105),Q(:,13),MT,1_intkind1,wf(:,106))
  call counter_AV_Q(wf(:,-1),wf(:,25),wf(:,107))
  call prop_Q_A(wf(:,32),Q(:,49),MT,1_intkind1,wf(:,108))
  call counter_QA_V(wf(:,26),wf(:,-1),wf(:,109))
  call counter_AV_Q(wf(:,-1),wf(:,-5),wf(:,110))
  call prop_A_Q(wf(:,110),Q(:,34),MT,1_intkind1,wf(:,111))
  call vert_QA_V(wf(:,26),wf(:,111),wf(:,112))
  call prop_Q_A(wf(:,43),Q(:,49),MT,1_intkind1,wf(:,113))
  call vert_SA_Q(gH,wf(:,-4),wf(:,111),wf(:,114))
  call counter_SA_Q(gH,wf(:,-4),wf(:,-1),wf(:,115))
  call prop_A_Q(wf(:,115),Q(:,18),MT,1_intkind1,wf(:,116))
  ...
  call prop_A_Q(wf(:,41),Q(:,50),MT,1_intkind1,wf(:,124))
  call counter_VQ_A(wf(:,-5),wf(:,0),wf(:,125))
  call prop_Q_A(wf(:,125),Q(:,33),MT,1_intkind1,wf(:,126))
  call vert_QA_V(wf(:,126),wf(:,37),wf(:,127))
  call prop_A_Q(wf(:,44),Q(:,50),MT,1_intkind1,wf(:,128))
  call vert_QS_A(gH,wf(:,126),wf(:,-4),wf(:,129))
  call counter_QS_A(gH,wf(:,0),wf(:,-4),wf(:,130))
  call prop_Q_A(wf(:,130),Q(:,17),MT,1_intkind1,wf(:,131))
  ...
  call counter_Q_A(cttt,wf(:,26),Q(:,17),wf(:,176))
  call prop_A_Q(wf(:,175),Q(:,46),MT,1_intkind1,wf(:,177))
  call vert_VQ_A(wf(:,25),wf(:,26),wf(:,178))
  call counter_A_Q(cttt,wf(:,27),Q(:,34),wf(:,179))
  call prop_Q_A(wf(:,178),Q(:,29),MT,1_intkind1,wf(:,180))
  call counter_V_V(ctGG,wf(:,25),Q(:,12),wf(:,181))
  call prop_Q_A(wf(:,176),Q(:,17),MT,1_intkind1,wf(:,182))
  ...
  call counter_A_Q(cttt,wf(:,33),Q(:,14),wf(:,187))
  call vert_UV_W(wf(:,181),Q(:,12),wf(:,-5),Q(:,32),wf(:,188))
  call vert_AV_Q(wf(:,37),wf(:,25),wf(:,189))
  call counter_Q_A(cttt,wf(:,36),Q(:,33),wf(:,190))
  call prop_A_Q(wf(:,189),Q(:,30),MT,1_intkind1,wf(:,191))
  call vert_VQ_A(wf(:,25),wf(:,36),wf(:,192))
  call counter_A_Q(cttt,wf(:,37),Q(:,18),wf(:,193))
  call prop_Q_A(wf(:,192),Q(:,45),MT,1_intkind1,wf(:,194))
  call prop_A_Q(wf(:,193),Q(:,18),MT,1_intkind1,wf(:,195))
  call vert_QA_V(wf(:,0),wf(:,195),wf(:,196))
  call vert_VQ_A(wf(:,181),wf(:,0),wf(:,197))
  call counter_V_V(ctGG,wf(:,39),Q(:,19),wf(:,198))
  call counter_Q_A(cttt,wf(:,42),Q(:,13),wf(:,199))
  call vert_AV_Q(wf(:,195),wf(:,-5),wf(:,200))
  call prop_Q_A(wf(:,190),Q(:,33),MT,1_intkind1,wf(:,201))
  call vert_QS_A(gH,wf(:,201),wf(:,-4),wf(:,202))
  call prop_A_Q(wf(:,179),Q(:,34),MT,1_intkind1,wf(:,203))
  ...
  call prop_Q_A(wf(:,227),Q(:,29),MT,1_intkind1,wf(:,228))
  call vert_VQ_A(wf(:,-5),wf(:,42),wf(:,229))
  call prop_Q_A(wf(:,229),Q(:,45),MT,1_intkind1,wf(:,230))
  call vert_VQ_A(wf(:,30),wf(:,0),wf(:,231))
  call prop_Q_A(wf(:,231),Q(:,45),MT,1_intkind1,wf(:,232))
  call vert_SA_Q(gH,wf(:,-4),wf(:,33),wf(:,233))
  call prop_A_Q(wf(:,233),Q(:,30),MT,1_intkind1,wf(:,234))
  call vert_AV_Q(wf(:,33),wf(:,-5),wf(:,235))
  call prop_A_Q(wf(:,235),Q(:,46),MT,1_intkind1,wf(:,236))
  call vert_AV_Q(wf(:,-1),wf(:,30),wf(:,237))
  call prop_A_Q(wf(:,237),Q(:,46),MT,1_intkind1,wf(:,238))
  ...
  call prop_Q_A(wf(:,251),Q(:,29),MT,1_intkind1,wf(:,252))
  call vert_AV_Q(wf(:,-1),wf(:,10),wf(:,253))
  call prop_A_Q(wf(:,253),Q(:,30),MT,1_intkind1,wf(:,254))
  call vert_UV_W(wf(:,10),Q(:,28),wf(:,-5),Q(:,32),wf(:,255))
  call vert_QA_V(wf(:,65),wf(:,-3),wf(:,256))
  call vert_VQ_A(wf(:,20),wf(:,0),wf(:,257))
  call prop_Q_A(wf(:,257),Q(:,29),MT,1_intkind1,wf(:,258))
  call vert_AV_Q(wf(:,-1),wf(:,20),wf(:,259))
  call prop_A_Q(wf(:,259),Q(:,30),MT,1_intkind1,wf(:,260))
  ...
  call prop_Q_A(wf(:,273),Q(:,45),MT,1_intkind1,wf(:,274))
  call vert_AV_Q(wf(:,-1),wf(:,45),wf(:,275))
  call prop_A_Q(wf(:,275),Q(:,46),MT,1_intkind1,wf(:,276))
  call vert_QA_V(wf(:,68),wf(:,-3),wf(:,277))
  call vert_VQ_A(wf(:,46),wf(:,0),wf(:,278))
  call prop_Q_A(wf(:,278),Q(:,45),MT,1_intkind1,wf(:,279))
  call vert_AV_Q(wf(:,-1),wf(:,46),wf(:,280))
  call prop_A_Q(wf(:,280),Q(:,46),MT,1_intkind1,wf(:,281))
...
subroutine denominators()
  ...
  den(153) = 1 / (Q(5,46) - MT2)
  den(157) = 1 / (Q(5,29) - MT2)
  den(160) = 1 / (Q(5,51))
  den(172) = 1 / (Q(5,30) - MT2)
  den(176) = 1 / (Q(5,45) - MT2)
  den(220) = 1 / (Q(5,15))
...
subroutine diagrams(A)
  ...
  implicit none
  complex(REALKIND), intent(out) :: A(214)
  ...
  A(27) = cont_VV(wf(:,30),wf(:,50)) * den(60)
  A(28) = cont_VV(wf(:,30),wf(:,50)) * den(60)
  A(29) = cont_VV(wf(:,51),wf(:,52)) * den(63)
  A(30) = cont_VV(wf(:,51),wf(:,52)) * den(63)
  A(31) = cont_QA(wf(:,5),wf(:,53)) * den(5)
  A(32) = cont_QA(wf(:,9),wf(:,54)) * den(8)
  A(33) = cont_VV(wf(:,10),wf(:,55)) * den(11)
  A(34) = cont_QA(wf(:,15),wf(:,56)) * den(15)
  A(35) = cont_QA(wf(:,19),wf(:,57)) * den(18)
  A(36) = cont_VV(wf(:,20),wf(:,55)) * den(20)
  A(37) = cont_QA(wf(:,9),wf(:,58)) * den(21)
  A(38) = cont_VV(wf(:,45),wf(:,50)) * den(65)
  A(39) = cont_VV(wf(:,45),wf(:,50)) * den(65)
  A(40) = cont_QA(wf(:,19),wf(:,59)) * den(22)
  A(41) = cont_VV(wf(:,46),wf(:,50)) * den(67)
  A(42) = cont_VV(wf(:,46),wf(:,50)) * den(67)
  A(43) = cont_QA(wf(:,19),wf(:,60)) * den(68)
  A(44) = cont_QA(wf(:,19),wf(:,60)) * den(68)
  A(45) = cont_QA(wf(:,7),wf(:,62)) * den(71)
  A(46) = cont_QA(wf(:,7),wf(:,62)) * den(71)
  A(47) = cont_VV(wf(:,11),wf(:,63)) * den(72)
  A(48) = cont_QA(wf(:,64),wf(:,65)) * den(74)
  A(49) = cont_QA(wf(:,6),wf(:,67)) * den(5)
  A(50) = cont_QA(wf(:,64),wf(:,68)) * den(76)
  A(51) = cont_QA(wf(:,19),wf(:,69)) * den(22)
  A(52) = cont_QA(wf(:,16),wf(:,71)) * den(15)
  A(53) = cont_QA(wf(:,19),wf(:,72)) * den(18)
  A(54) = cont_VV(wf(:,11),wf(:,73)) * den(20)
  A(55) = cont_VV(wf(:,11),wf(:,74)) * den(77)
  A(56) = cont_QA(wf(:,75),wf(:,76)) * den(80)
  A(57) = cont_QA(wf(:,15),wf(:,79)) * den(15)
  A(58) = cont_QA(wf(:,75),wf(:,80)) * den(82)
  A(59) = cont_QA(wf(:,9),wf(:,81)) * den(21)
  A(60) = cont_QA(wf(:,5),wf(:,84)) * den(5)
  A(61) = cont_QA(wf(:,9),wf(:,85)) * den(8)
  A(62) = cont_VV(wf(:,11),wf(:,86)) * den(11)
  A(63) = cont_VV(wf(:,25),wf(:,87)) * den(27)
  A(64) = cont_VV(wf(:,29),wf(:,88)) * den(30)
  A(65) = cont_QA(wf(:,33),wf(:,89)) * den(33)
  A(66) = cont_VV(wf(:,25),wf(:,90)) * den(37)
  A(67) = cont_VV(wf(:,39),wf(:,88)) * den(39)
  A(68) = cont_QA(wf(:,42),wf(:,91)) * den(42)
  A(69) = cont_VV(wf(:,47),wf(:,49)) * den(83)
  A(70) = cont_VV(wf(:,47),wf(:,49)) * den(83)
  A(71) = cont_QA(wf(:,33),wf(:,92)) * den(43)
  A(72) = cont_VV(wf(:,48),wf(:,49)) * den(84)
  A(73) = cont_VV(wf(:,48),wf(:,49)) * den(84)
  A(74) = cont_QA(wf(:,42),wf(:,93)) * den(44)
  A(75) = cont_QA(wf(:,42),wf(:,94)) * den(85)
  A(76) = cont_QA(wf(:,42),wf(:,94)) * den(85)
  A(77) = cont_QA(wf(:,31),wf(:,96)) * den(88)
  A(78) = cont_QA(wf(:,31),wf(:,96)) * den(88)
  A(79) = cont_VV(wf(:,29),wf(:,97)) * den(45)
  A(80) = cont_VV(wf(:,29),wf(:,98)) * den(46)
  A(81) = cont_VV(wf(:,39),wf(:,97)) * den(47)
  A(82) = cont_VV(wf(:,39),wf(:,98)) * den(48)
  A(83) = cont_VV(wf(:,47),wf(:,63)) * den(51)
  A(84) = cont_VV(wf(:,48),wf(:,63)) * den(53)
  A(85) = cont_VV(wf(:,47),wf(:,73)) * den(54)
  A(86) = cont_VV(wf(:,48),wf(:,73)) * den(55)
  A(87) = cont_VV(wf(:,29),wf(:,99)) * den(46)
  A(88) = cont_VV(wf(:,29),wf(:,100)) * den(45)
  A(89) = cont_VV(wf(:,39),wf(:,99)) * den(48)
  A(90) = cont_VV(wf(:,39),wf(:,100)) * den(47)
  A(91) = cont_VV(wf(:,47),wf(:,74)) * den(54)
  A(92) = cont_VV(wf(:,48),wf(:,74)) * den(55)
  A(93) = cont_VV(wf(:,47),wf(:,86)) * den(51)
  A(94) = cont_VV(wf(:,48),wf(:,86)) * den(53)
  A(95) = cont_VV(wf(:,28),wf(:,101)) * den(27)
  A(96) = cont_VV(wf(:,29),wf(:,102)) * den(30)
  A(97) = cont_QA(wf(:,32),wf(:,104)) * den(33)
  A(98) = cont_VV(wf(:,38),wf(:,101)) * den(37)
  A(99) = cont_VV(wf(:,39),wf(:,102)) * den(39)
  A(100) = cont_QA(wf(:,41),wf(:,106)) * den(42)
  A(101) = cont_QA(wf(:,43),wf(:,104)) * den(43)
  A(102) = cont_QA(wf(:,44),wf(:,106)) * den(44)
  A(103) = cont_QA(wf(:,107),wf(:,108)) * den(90)
  A(104) = cont_VV(wf(:,30),wf(:,109)) * den(91)
  A(105) = cont_VV(wf(:,25),wf(:,112)) * den(27)
  A(106) = cont_QA(wf(:,107),wf(:,113)) * den(93)
  A(107) = cont_QA(wf(:,42),wf(:,114)) * den(44)
  A(108) = cont_VV(wf(:,25),wf(:,117)) * den(37)
  A(109) = cont_QA(wf(:,42),wf(:,118)) * den(42)
  A(110) = cont_VV(wf(:,30),wf(:,119)) * den(39)
  A(111) = cont_VV(wf(:,45),wf(:,109)) * den(94)
  A(112) = cont_VV(wf(:,46),wf(:,109)) * den(95)
  A(113) = cont_VV(wf(:,10),wf(:,120)) * den(96)
  A(114) = cont_VV(wf(:,10),wf(:,121)) * den(53)
  A(115) = cont_VV(wf(:,20),wf(:,120)) * den(97)
  A(116) = cont_VV(wf(:,20),wf(:,121)) * den(55)
  A(117) = cont_VV(wf(:,45),wf(:,119)) * den(47)
  A(118) = cont_VV(wf(:,46),wf(:,119)) * den(48)
  A(119) = cont_VV(wf(:,30),wf(:,122)) * den(98)
  A(120) = cont_QA(wf(:,123),wf(:,124)) * den(101)
  A(121) = cont_VV(wf(:,25),wf(:,127)) * den(37)
  A(122) = cont_QA(wf(:,123),wf(:,128)) * den(103)
  A(123) = cont_QA(wf(:,33),wf(:,129)) * den(43)
  A(124) = cont_VV(wf(:,25),wf(:,132)) * den(27)
  A(125) = cont_VV(wf(:,30),wf(:,133)) * den(30)
  A(126) = cont_QA(wf(:,33),wf(:,134)) * den(33)
  A(127) = cont_VV(wf(:,45),wf(:,122)) * den(104)
  A(128) = cont_VV(wf(:,46),wf(:,122)) * den(105)
  A(129) = cont_VV(wf(:,10),wf(:,135)) * den(106)
  A(130) = cont_VV(wf(:,10),wf(:,136)) * den(51)
  A(131) = cont_VV(wf(:,20),wf(:,135)) * den(107)
  A(132) = cont_VV(wf(:,20),wf(:,136)) * den(54)
  A(133) = cont_VV(wf(:,45),wf(:,133)) * den(45)
  A(134) = cont_VV(wf(:,46),wf(:,133)) * den(46)
  A(135) = cont_QA(wf(:,5),wf(:,138)) * den(5)
  A(136) = cont_QA(wf(:,8),wf(:,140)) * den(8)
  A(137) = cont_VV(wf(:,10),wf(:,141)) * den(11)
  A(138) = cont_QA(wf(:,15),wf(:,142)) * den(15)
  A(139) = cont_QA(wf(:,18),wf(:,144)) * den(18)
  A(140) = cont_VV(wf(:,20),wf(:,141)) * den(20)
  A(141) = cont_QA(wf(:,21),wf(:,140)) * den(21)
  A(142) = cont_QA(wf(:,22),wf(:,144)) * den(22)
  A(143) = cont_VV(wf(:,145),wf(:,146)) * den(111)
  A(144) = cont_QA(wf(:,148),wf(:,149)) * den(115)
  A(145) = cont_QA(wf(:,150),wf(:,151)) * den(118)
  A(146) = cont_QA(wf(:,65),wf(:,152)) * den(120)
  A(147) = cont_VV(wf(:,10),wf(:,153)) * den(121)
  A(148) = cont_VV(wf(:,11),wf(:,155)) * den(123)
  A(149) = cont_QA(wf(:,9),wf(:,156)) * den(124)
  A(150) = cont_QA(wf(:,65),wf(:,157)) * den(125)
  A(151) = cont_VV(wf(:,11),wf(:,158)) * den(126)
  A(152) = cont_VV(wf(:,146),wf(:,159)) * den(129)
  A(153) = cont_QA(wf(:,161),wf(:,162)) * den(133)
  A(154) = cont_QA(wf(:,163),wf(:,164)) * den(136)
  A(155) = cont_QA(wf(:,76),wf(:,165)) * den(137)
  A(156) = cont_VV(wf(:,20),wf(:,153)) * den(138)
  A(157) = cont_VV(wf(:,11),wf(:,167)) * den(140)
  A(158) = cont_QA(wf(:,76),wf(:,168)) * den(141)
  A(159) = cont_VV(wf(:,11),wf(:,169)) * den(142)
  A(160) = cont_QA(wf(:,19),wf(:,170)) * den(143)
  A(161) = cont_QA(wf(:,68),wf(:,152)) * den(144)
  A(162) = cont_QA(wf(:,9),wf(:,172)) * den(146)
  A(163) = cont_QA(wf(:,68),wf(:,157)) * den(147)
  A(164) = cont_QA(wf(:,80),wf(:,165)) * den(148)
  A(165) = cont_QA(wf(:,80),wf(:,168)) * den(149)
  A(166) = cont_QA(wf(:,19),wf(:,174)) * den(151)
  A(167) = cont_QA(wf(:,176),wf(:,177)) * den(155)
  A(168) = cont_QA(wf(:,179),wf(:,180)) * den(159)
  A(169) = cont_VV(wf(:,28),wf(:,181)) * den(162)
  A(170) = cont_VV(wf(:,30),wf(:,183)) * den(164)
  A(171) = cont_QA(wf(:,33),wf(:,184)) * den(165)
  A(172) = cont_QA(wf(:,108),wf(:,185)) * den(167)
  A(173) = cont_VV(wf(:,30),wf(:,186)) * den(168)
  A(174) = cont_QA(wf(:,108),wf(:,187)) * den(169)
  A(175) = cont_VV(wf(:,29),wf(:,188)) * den(170)
  A(176) = cont_QA(wf(:,190),wf(:,191)) * den(174)
  A(177) = cont_QA(wf(:,193),wf(:,194)) * den(178)
  A(178) = cont_VV(wf(:,38),wf(:,181)) * den(180)
  A(179) = cont_VV(wf(:,30),wf(:,196)) * den(182)
  A(180) = cont_QA(wf(:,124),wf(:,197)) * den(183)
  A(181) = cont_VV(wf(:,30),wf(:,198)) * den(184)
  A(182) = cont_QA(wf(:,124),wf(:,199)) * den(185)
  A(183) = cont_QA(wf(:,42),wf(:,200)) * den(186)
  A(184) = cont_VV(wf(:,39),wf(:,188)) * den(187)
  A(185) = cont_QA(wf(:,33),wf(:,202)) * den(189)
  A(186) = cont_QA(wf(:,113),wf(:,185)) * den(190)
  A(187) = cont_QA(wf(:,113),wf(:,187)) * den(191)
  A(188) = cont_QA(wf(:,128),wf(:,197)) * den(192)
  A(189) = cont_QA(wf(:,128),wf(:,199)) * den(193)
  A(190) = cont_QA(wf(:,42),wf(:,204)) * den(195)
  A(191) = cont_VV(wf(:,45),wf(:,183)) * den(196)
  A(192) = cont_VV(wf(:,45),wf(:,186)) * den(197)
  A(193) = cont_VV(wf(:,29),wf(:,205)) * den(198)
  A(194) = cont_VV(wf(:,46),wf(:,183)) * den(199)
  A(195) = cont_VV(wf(:,46),wf(:,186)) * den(200)
  A(196) = cont_VV(wf(:,29),wf(:,206)) * den(201)
  A(197) = cont_VV(wf(:,45),wf(:,196)) * den(202)
  A(198) = cont_VV(wf(:,45),wf(:,198)) * den(203)
  A(199) = cont_VV(wf(:,39),wf(:,205)) * den(204)
  A(200) = cont_VV(wf(:,46),wf(:,196)) * den(205)
  A(201) = cont_VV(wf(:,46),wf(:,198)) * den(206)
  A(202) = cont_VV(wf(:,39),wf(:,206)) * den(207)
  A(203) = cont_VV(wf(:,10),wf(:,207)) * den(208)
  A(204) = cont_VV(wf(:,10),wf(:,208)) * den(209)
  A(205) = cont_VV(wf(:,47),wf(:,155)) * den(210)
  A(206) = cont_VV(wf(:,10),wf(:,209)) * den(211)
  A(207) = cont_VV(wf(:,10),wf(:,210)) * den(212)
  A(208) = cont_VV(wf(:,48),wf(:,155)) * den(213)
  A(209) = cont_VV(wf(:,20),wf(:,207)) * den(214)
  A(210) = cont_VV(wf(:,20),wf(:,208)) * den(215)
  A(211) = cont_VV(wf(:,47),wf(:,167)) * den(216)
  A(212) = cont_VV(wf(:,20),wf(:,209)) * den(217)
  A(213) = cont_VV(wf(:,20),wf(:,210)) * den(218)
  A(214) = cont_VV(wf(:,48),wf(:,167)) * den(219)
...
subroutine colourvectors(A, M1, M2)
  ...
  use ol_parameters_decl_/**/REALKIND, only: CI
  implicit none
  complex(REALKIND), intent(in) :: A(214)
  complex(REALKIND), intent(out) :: M1(4), M2(4)
  ...
  M2(1) = ((-A(70)-A(73)-A(76)-A(78))*f(1))/6._/**/REALKIND+((A(203)+A(204)+A(205)+A(206)+A(207)+A(208)+A(209)+A(210)+A(211) &
       +A(212)+A(213)+A(214))*f(5))/6._/**/REALKIND+((-A(83)-A(84)-A(91)-A(92))*f(7))/6._/**/REALKIND+((-A(113)-A(114)-A(115) &
       -A(116)-A(129)-A(130)-A(131)-A(132))*f(9))/6._/**/REALKIND+((-A(85)-A(86)-A(93)-A(94))*f(11))/6._/**/REALKIND+((-A(69) &
       -A(72)-A(75)-A(77))*f(22))/6._/**/REALKIND+((A(167)+A(168)+A(169)+A(171)+A(172)+A(174)+A(176)+A(177)+A(178)+A(180)+A(182) &
       +A(183)+A(185)+A(186)+A(187)+A(188)+A(189)+A(190))*f(26))/6._/**/REALKIND+((-A(95)-A(97)-A(98)-A(100)-A(101) &
       -A(102))*f(28))/6._/**/REALKIND+((-A(63)-A(65)-A(66)-A(68)-A(103)-A(105)-A(106)-A(107)-A(120)-A(121)-A(122) &
       -A(123))*f(30))/6._/**/REALKIND+((-A(71)-A(74)-A(108)-A(109)-A(124)-A(126))*f(32))/6._/**/REALKIND
  M2(2) = ((A(39)+A(46)+A(73)+A(76))*f(1))/2._/**/REALKIND+(CI*(A(26)-A(28)-A(30))*f(2))/2._/**/REALKIND+((-A(146)-A(149)-A(150) &
       -A(152)-A(153)-A(154)-A(161)-A(162)-A(163)-A(206)-A(207)-A(208)-A(212)-A(213)-A(214))*f(5))/2._/**/REALKIND+(CI*(-A(147) &
       -A(148)-A(151)-A(156)-A(157)-A(159))*f(6))/2._/**/REALKIND+((A(32)+A(34)+A(48)+A(50)+A(57)+A(59)+A(84) &
       +A(92))*f(7))/2._/**/REALKIND+(CI*(A(47)+A(55))*f(8))/2._/**/REALKIND+((A(114)+A(116)+A(129)+A(131)+A(136)+A(138) &
       +A(141))*f(9))/2._/**/REALKIND+(CI*(A(137)+A(140))*f(10))/2._/**/REALKIND+((A(37)+A(52)+A(61)+A(86) &
       +A(94))*f(11))/2._/**/REALKIND+(CI*(A(54)+A(62))*f(12))/2._/**/REALKIND+(CI*(A(33)+A(36))*f(13))/2._/**/REALKIND+((A(38) &
       +A(45)+A(72)+A(75))*f(22))/2._/**/REALKIND+(CI*(A(25)-A(27)-A(29))*f(23))/2._/**/REALKIND+((-A(167)-A(168)-A(169)-A(180) &
       -A(182)-A(183)-A(188)-A(189)-A(190)-A(191)-A(192)-A(193)-A(197)-A(198)-A(199))*f(26))/2._/**/REALKIND+(CI*(A(170)+A(173) &
       +A(175)+A(179)+A(181)+A(184))*f(27))/2._/**/REALKIND+((A(79)+A(81)+A(88)+A(90)+A(95)+A(100)+A(102))*f(28))/2._/**/REALKIND &
       +(CI*(-A(96)-A(99))*f(29))/2._/**/REALKIND+((A(63)+A(68)+A(105)+A(107)+A(111)+A(120)+A(122)+A(127))*f(30))/2._/**/REALKIND &
       +(CI*(-A(104)-A(119))*f(31))/2._/**/REALKIND+((A(74)+A(109)+A(117)+A(124)+A(133))*f(32))/2._/**/REALKIND+(CI*(-A(110) &
       -A(125))*f(33))/2._/**/REALKIND+(CI*(-A(64)-A(67))*f(34))/2._/**/REALKIND
  M2(3) = ((A(42)+A(44)+A(70)+A(78))*f(1))/2._/**/REALKIND+(CI*(-A(26)+A(28)+A(30))*f(2))/2._/**/REALKIND+((-A(143)-A(144)-A(145) &
       -A(155)-A(158)-A(160)-A(164)-A(165)-A(166)-A(203)-A(204)-A(205)-A(209)-A(210)-A(211))*f(5))/2._/**/REALKIND+(CI*(A(147) &
       +A(148)+A(151)+A(156)+A(157)+A(159))*f(6))/2._/**/REALKIND+((A(31)+A(35)+A(49)+A(51)+A(56)+A(58)+A(83) &
       +A(91))*f(7))/2._/**/REALKIND+(CI*(-A(47)-A(55))*f(8))/2._/**/REALKIND+((A(113)+A(115)+A(130)+A(132)+A(135)+A(139) &
       +A(142))*f(9))/2._/**/REALKIND+(CI*(-A(137)-A(140))*f(10))/2._/**/REALKIND+((A(40)+A(53)+A(60)+A(85) &
       +A(93))*f(11))/2._/**/REALKIND+(CI*(-A(54)-A(62))*f(12))/2._/**/REALKIND+(CI*(-A(33)-A(36))*f(13))/2._/**/REALKIND+((A(41) &
       +A(43)+A(69)+A(77))*f(22))/2._/**/REALKIND+(CI*(-A(25)+A(27)+A(29))*f(23))/2._/**/REALKIND+((-A(171)-A(172)-A(174)-A(176) &
       -A(177)-A(178)-A(185)-A(186)-A(187)-A(194)-A(195)-A(196)-A(200)-A(201)-A(202))*f(26))/2._/**/REALKIND+(CI*(-A(170)-A(173) &
       -A(175)-A(179)-A(181)-A(184))*f(27))/2._/**/REALKIND+((A(80)+A(82)+A(87)+A(89)+A(97)+A(98)+A(101))*f(28))/2._/**/REALKIND &
       +(CI*(A(96)+A(99))*f(29))/2._/**/REALKIND+((A(65)+A(66)+A(103)+A(106)+A(112)+A(121)+A(123)+A(128))*f(30))/2._/**/REALKIND &
       +(CI*(A(104)+A(119))*f(31))/2._/**/REALKIND+((A(71)+A(108)+A(118)+A(126)+A(134))*f(32))/2._/**/REALKIND+(CI*(A(110) &
       +A(125))*f(33))/2._/**/REALKIND+(CI*(A(64)+A(67))*f(34))/2._/**/REALKIND
  M2(4) = ((-A(39)-A(42)-A(44)-A(46))*f(1))/6._/**/REALKIND+((A(143)+A(144)+A(145)+A(146)+A(149)+A(150)+A(152)+A(153)+A(154) &
       +A(155)+A(158)+A(160)+A(161)+A(162)+A(163)+A(164)+A(165)+A(166))*f(5))/6._/**/REALKIND+((-A(31)-A(32)-A(34)-A(35)-A(48) &
       -A(49)-A(50)-A(51)-A(56)-A(57)-A(58)-A(59))*f(7))/6._/**/REALKIND+((-A(135)-A(136)-A(138)-A(139)-A(141) &
       -A(142))*f(9))/6._/**/REALKIND+((-A(37)-A(40)-A(52)-A(53)-A(60)-A(61))*f(11))/6._/**/REALKIND+((-A(38)-A(41)-A(43) &
       -A(45))*f(22))/6._/**/REALKIND+((A(191)+A(192)+A(193)+A(194)+A(195)+A(196)+A(197)+A(198)+A(199)+A(200)+A(201) &
       +A(202))*f(26))/6._/**/REALKIND+((-A(79)-A(80)-A(81)-A(82)-A(87)-A(88)-A(89)-A(90))*f(28))/6._/**/REALKIND+((-A(111)-A(112) &
       -A(127)-A(128))*f(30))/6._/**/REALKIND+((-A(117)-A(118)-A(133)-A(134))*f(32))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pphttj_ttxbbxhg_1_/**/REALKIND
