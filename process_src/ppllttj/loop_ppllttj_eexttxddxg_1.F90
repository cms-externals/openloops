...
module ol_colourmatrix_ppllttj_eexttxddxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllttj_eexttxddxg_1_/**/REALKIND



module ol_forced_parameters_ppllttj_eexttxddxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllttj_eexttxddxg_1_/**/REALKIND

module ol_loop_ppllttj_eexttxddxg_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(57), c(71)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 3) = CI*eQED**2*gQCD**3
    f( 4) = (eQED**2*gQCD**3)/3._/**/REALKIND
    f( 5) = (2*eQED**2*gQCD**3)/3._/**/REALKIND
    f( 6) = eQED**2*gQCD**3
    f( 7) = (CI*countertermnorm*eQED**2*gQCD**5)/3._/**/REALKIND
    f( 8) = (2*CI*countertermnorm*eQED**2*gQCD**5)/3._/**/REALKIND
    f( 9) = CI*countertermnorm*eQED**2*gQCD**5
    f(10) = (countertermnorm*eQED**2*gQCD**5)/3._/**/REALKIND
    f(11) = (2*countertermnorm*eQED**2*gQCD**5)/3._/**/REALKIND
    f(12) = countertermnorm*eQED**2*gQCD**5
    f(13) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(14) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(15) = CI*countertermnorm*ctGqq*eQED**2*gQCD**5
    f(16) = (countertermnorm*ctGqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(17) = (2*countertermnorm*ctGqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(18) = countertermnorm*ctGqq*eQED**2*gQCD**5
    f(19) = (CI*countertermnorm*ctGtt*eQED**2*gQCD**5)/3._/**/REALKIND
    f(20) = (2*CI*countertermnorm*ctGtt*eQED**2*gQCD**5)/3._/**/REALKIND
    f(21) = CI*countertermnorm*ctGtt*eQED**2*gQCD**5
    f(22) = (countertermnorm*ctGtt*eQED**2*gQCD**5)/3._/**/REALKIND
    f(23) = (2*countertermnorm*ctGtt*eQED**2*gQCD**5)/3._/**/REALKIND
    f(24) = countertermnorm*ctGtt*eQED**2*gQCD**5
    f(25) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(26) = CI*countertermnorm*ctVqq*eQED**2*gQCD**5
    f(27) = (countertermnorm*ctVqq*eQED**2*gQCD**5)/3._/**/REALKIND
    f(28) = countertermnorm*ctVqq*eQED**2*gQCD**5
    f(29) = (2*CI*countertermnorm*ctVtt*eQED**2*gQCD**5)/3._/**/REALKIND
    f(30) = CI*countertermnorm*ctVtt*eQED**2*gQCD**5
    f(31) = (2*countertermnorm*ctVtt*eQED**2*gQCD**5)/3._/**/REALKIND
    f(32) = countertermnorm*ctVtt*eQED**2*gQCD**5
    f(33) = (countertermnorm*ctVVV*eQED**2*gQCD**5)/3._/**/REALKIND
    f(34) = (2*countertermnorm*ctVVV*eQED**2*gQCD**5)/3._/**/REALKIND
    f(35) = countertermnorm*ctVVV*eQED**2*gQCD**5
    f(36) = CI*countertermnorm*ctZGG*eQED**2*gQCD**5
    f(37) = countertermnorm*ctZGG*eQED**2*gQCD**5
    f(38) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(39) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(40) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(41) = (2*CI*eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(42) = CI*eQED**2*gQCD**5*integralnorm*SwB
    f(43) = (eQED**2*gQCD**5*integralnorm*SwB)/6._/**/REALKIND
    f(44) = (eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(45) = (eQED**2*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(46) = (2*eQED**2*gQCD**5*integralnorm*SwB)/3._/**/REALKIND
    f(47) = eQED**2*gQCD**5*integralnorm*SwB
    f(48) = (CI*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(49) = (2*CI*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(50) = CI*eQED**2*gQCD**5*integralnorm*SwF
    f(51) = (4*CI*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(52) = 2*CI*eQED**2*gQCD**5*integralnorm*SwF
    f(53) = (eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(54) = (2*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(55) = eQED**2*gQCD**5*integralnorm*SwF
    f(56) = (4*eQED**2*gQCD**5*integralnorm*SwF)/3._/**/REALKIND
    f(57) = 2*eQED**2*gQCD**5*integralnorm*SwF

  c = [ 27*CI*f(38), 54*CI*f(38), 3*CI*f(39), 9*CI*f(39), 24*CI*f(39), 27*CI*f(39), 54*CI*f(39), 27*CI*f(40), 54*CI*f(40) &
    , 3*CI*f(41), 9*CI*f(41), 24*CI*f(41), 27*CI*f(41), 54*CI*f(41), 3*CI*f(42), 9*CI*f(42), 24*CI*f(42), 27*CI*f(42), 54*CI*f(42) &
    , 18*f(43), 54*f(43), f(44), 3*f(44), 6*f(44), 8*f(44), 9*f(44), 10*f(44), 18*f(44), 21*f(44), 24*f(44), 27*f(44), 54*f(44) &
    , 18*f(45), 54*f(45), f(46), 3*f(46), 6*f(46), 8*f(46), 9*f(46), 10*f(46), 18*f(46), 21*f(46), 24*f(46), 27*f(46), 54*f(46) &
    , f(47), 3*f(47), 6*f(47), 8*f(47), 9*f(47), 10*f(47), 18*f(47), 21*f(47), 24*f(47), 27*f(47), 54*f(47), 9*CI*f(48) &
    , 9*CI*f(49), 9*CI*f(50), 9*CI*f(51), 9*CI*f(52), 3*f(53), 9*f(53), 3*f(54), 9*f(54), 3*f(55), 9*f(55), 3*f(56), 9*f(56) &
    , 3*f(57), 9*f(57) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,55),Q(:,75),MT,1_intkind1,wf(:,187))
  call prop_A_Q(wf(:,57),Q(:,75),MT,1_intkind1,wf(:,188))
  call counter_VQ_A(wf(:,1),wf(:,-2),wf(:,189))
  call prop_A_Q(wf(:,50),Q(:,120),MT,1_intkind1,wf(:,190))
  call counter_ZQ_A(gZu,wf(:,9),wf(:,-2),wf(:,191))
  call counter_QA_V(wf(:,-2),wf(:,40),wf(:,192))
  call counter_QA_V(wf(:,-2),wf(:,42),wf(:,193))
  call prop_Q_A(wf(:,186),Q(:,52),MT,1_intkind1,wf(:,194))
  call vert_VQ_A(wf(:,-6),wf(:,194),wf(:,195))
  call prop_Q_A(wf(:,189),Q(:,7),MT,1_intkind1,wf(:,196))
  call vert_QA_V(wf(:,196),wf(:,-3),wf(:,197))
  call prop_Q_A(wf(:,191),Q(:,7),MT,1_intkind1,wf(:,198))
  ...
  call prop_Q_A(wf(:,202),Q(:,68),MT,1_intkind1,wf(:,203))
  ...
  call counter_Q_A(cttt,wf(:,37),Q(:,68),wf(:,261))
  call prop_Q_A(wf(:,261),Q(:,68),MT,1_intkind1,wf(:,262))
  ...
  call counter_A_Q(cttt,wf(:,40),Q(:,11),wf(:,269))
  call counter_A_Q(cttt,wf(:,42),Q(:,11),wf(:,270))
  call counter_A_Q(cttt,wf(:,45),Q(:,56),wf(:,271))
  call vert_VQ_A(wf(:,267),wf(:,37),wf(:,272))
  call vert_VQ_A(wf(:,267),wf(:,-2),wf(:,273))
  call counter_Q_A(cttt,wf(:,51),Q(:,7),wf(:,274))
  call counter_Q_A(cttt,wf(:,53),Q(:,7),wf(:,275))
  call counter_Q_A(cttt,wf(:,56),Q(:,52),wf(:,276))
  call counter_A_Q(cttt,wf(:,48),Q(:,72),wf(:,277))
  call prop_A_Q(wf(:,277),Q(:,72),MT,1_intkind1,wf(:,278))
  ...
  call prop_A_Q(wf(:,285),Q(:,120),MT,1_intkind1,wf(:,286))
  call vert_VQ_A(wf(:,58),wf(:,-2),wf(:,287))
  call prop_Q_A(wf(:,287),Q(:,116),MT,1_intkind1,wf(:,288))
  call vert_AV_Q(wf(:,40),wf(:,-6),wf(:,289))
  call prop_Q_A(wf(:,273),Q(:,52),MT,1_intkind1,wf(:,290))
  call vert_AV_Q(wf(:,42),wf(:,-6),wf(:,291))
  call vert_AV_Q(wf(:,45),wf(:,-6),wf(:,292))
  call prop_A_Q(wf(:,292),Q(:,120),MT,1_intkind1,wf(:,293))
  call counter_V_V(ctGG,wf(:,58),Q(:,112),wf(:,294))
  call prop_A_Q(wf(:,289),Q(:,75),MT,1_intkind1,wf(:,295))
  call prop_A_Q(wf(:,291),Q(:,75),MT,1_intkind1,wf(:,296))
  call prop_A_Q(wf(:,268),Q(:,56),MT,1_intkind1,wf(:,297))
  call prop_Q_A(wf(:,61),Q(:,71),MT,1_intkind1,wf(:,298))
  call prop_Q_A(wf(:,62),Q(:,71),MT,1_intkind1,wf(:,299))
  call prop_Q_A(wf(:,65),Q(:,116),MT,1_intkind1,wf(:,300))
  ...
  call prop_A_Q(wf(:,310),Q(:,120),MT,1_intkind1,wf(:,311))
  call vert_VQ_A(wf(:,72),wf(:,-2),wf(:,312))
  call prop_Q_A(wf(:,312),Q(:,116),MT,1_intkind1,wf(:,313))
  call counter_V_V(ctGG,wf(:,72),Q(:,112),wf(:,314))
  call vert_QA_V(wf(:,226),wf(:,-5),wf(:,315))
  call vert_AV_Q(wf(:,-3),wf(:,73),wf(:,316))
  call prop_A_Q(wf(:,316),Q(:,120),MT,1_intkind1,wf(:,317))
  call vert_VQ_A(wf(:,73),wf(:,-2),wf(:,318))
  call prop_Q_A(wf(:,318),Q(:,116),MT,1_intkind1,wf(:,319))
  ...
  call prop_Q_A(wf(:,338),Q(:,55),MT,1_intkind1,wf(:,339))
  call vert_VQ_A(wf(:,36),wf(:,53),wf(:,340))
  call prop_Q_A(wf(:,340),Q(:,55),MT,1_intkind1,wf(:,341))
  call vert_AV_Q(wf(:,40),wf(:,36),wf(:,342))
  call prop_A_Q(wf(:,342),Q(:,59),MT,1_intkind1,wf(:,343))
  call vert_AV_Q(wf(:,42),wf(:,36),wf(:,344))
  call prop_A_Q(wf(:,344),Q(:,59),MT,1_intkind1,wf(:,345))
  call vert_VQ_A(wf(:,1),wf(:,56),wf(:,346))
  call prop_Q_A(wf(:,346),Q(:,55),MT,1_intkind1,wf(:,347))
  call vert_ZQ_A(gZu,wf(:,9),wf(:,56),wf(:,348))
  call prop_Q_A(wf(:,348),Q(:,55),MT,1_intkind1,wf(:,349))
  call vert_AV_Q(wf(:,45),wf(:,1),wf(:,350))
  call prop_A_Q(wf(:,350),Q(:,59),MT,1_intkind1,wf(:,351))
  call vert_AZ_Q(gZu,wf(:,45),wf(:,9),wf(:,352))
  call prop_A_Q(wf(:,352),Q(:,59),MT,1_intkind1,wf(:,353))
  ...
  call prop_Q_A(wf(:,394),Q(:,55),MT,1_intkind1,wf(:,395))
  call vert_VQ_A(wf(:,31),wf(:,-2),wf(:,396))
  call prop_Q_A(wf(:,396),Q(:,55),MT,1_intkind1,wf(:,397))
  call vert_AV_Q(wf(:,-3),wf(:,30),wf(:,398))
  call prop_A_Q(wf(:,398),Q(:,59),MT,1_intkind1,wf(:,399))
  call vert_AV_Q(wf(:,-3),wf(:,31),wf(:,400))
  call prop_A_Q(wf(:,400),Q(:,59),MT,1_intkind1,wf(:,401))
  ...
  call prop_Q_A(wf(:,406),Q(:,55),MT,1_intkind1,wf(:,407))
  call vert_VQ_A(wf(:,34),wf(:,-2),wf(:,408))
  call prop_Q_A(wf(:,408),Q(:,55),MT,1_intkind1,wf(:,409))
  call vert_AV_Q(wf(:,-3),wf(:,33),wf(:,410))
  call prop_A_Q(wf(:,410),Q(:,59),MT,1_intkind1,wf(:,411))
  call vert_AV_Q(wf(:,-3),wf(:,34),wf(:,412))
  call prop_A_Q(wf(:,412),Q(:,59),MT,1_intkind1,wf(:,413))
...
subroutine denominators()
  ...
  den(123) = 1 / (Q(5,99))
  den(128) = 1 / (Q(5,108))
  den(136) = 1 / (Q(5,71) - MT2)
  den(141) = 1 / (Q(5,116) - MT2)
  den(145) = 1 / (Q(5,75) - MT2)
  den(150) = 1 / (Q(5,120) - MT2)
  den(196) = 1 / (Q(5,51))
  den(279) = 1 / (Q(5,15))
  den(365) = 1 / (Q(5,31))
  den(370) = 1 / (Q(5,47))
  den(385) = 1 / (Q(5,55) - MT2)
  den(390) = 1 / (Q(5,59) - MT2)
  den(405) = 1 / (Q(5,79))
  den(418) = 1 / (Q(5,115))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(33)-A(35)-A(37)-A(39))*f(1))/6._/**/REALKIND+((A(17)+A(19)+A(21)+A(23)+A(27)+A(31))*f(2))/6._/**/REALKIND+((-A(18) &
       -A(20)-A(22)-A(24)-A(28)-A(32)-A(34)-A(36)-A(38)-A(40))*f(3))/6._/**/REALKIND
  M1(2) = ((A(1)+A(3)+A(9)+A(37)+A(39))*f(1))/2._/**/REALKIND+((-A(21)-A(23)-A(31)-A(41)-A(43))*f(2))/2._/**/REALKIND+((A(2)+A(4) &
       +A(10)+A(22)+A(24)+A(32)+A(38)+A(40)+A(42)+A(44))*f(3))/2._/**/REALKIND+(CI*(A(11)+A(15))*f(4))/2._/**/REALKIND+(CI*(A(25) &
       +A(29))*f(5))/2._/**/REALKIND+(CI*(A(12)+A(16)-A(26)-A(30))*f(6))/2._/**/REALKIND
  M1(3) = ((A(5)+A(7)+A(13)+A(33)+A(35))*f(1))/2._/**/REALKIND+((-A(17)-A(19)-A(27)-A(45)-A(47))*f(2))/2._/**/REALKIND+((A(6)+A(8) &
       +A(14)+A(18)+A(20)+A(28)+A(34)+A(36)+A(46)+A(48))*f(3))/2._/**/REALKIND+(CI*(-A(11)-A(15))*f(4))/2._/**/REALKIND+(CI*( &
       -A(25)-A(29))*f(5))/2._/**/REALKIND+(CI*(-A(12)-A(16)+A(26)+A(30))*f(6))/2._/**/REALKIND
  M1(4) = ((-A(1)-A(3)-A(5)-A(7)-A(9)-A(13))*f(1))/6._/**/REALKIND+((A(41)+A(43)+A(45)+A(47))*f(2))/6._/**/REALKIND+((-A(2)-A(4) &
       -A(6)-A(8)-A(10)-A(14)-A(42)-A(44)-A(46)-A(48))*f(3))/6._/**/REALKIND

  M2(1) = ((A(352)+A(354)+A(356)+A(358)+A(360)+A(362)+A(364)+A(366)+A(368)+A(370)+A(372)+A(374))*f(7))/6._/**/REALKIND+((-A(304) &
       -A(306)-A(308)-A(310)-A(312)-A(314)-A(316)-A(318)-A(320)-A(322)-A(324)-A(326)-A(332)-A(334)-A(338)-A(340)-A(344) &
       -A(346))*f(8))/6._/**/REALKIND+((-A(49)-A(50)-A(51)-A(52))*f(9))/12._/**/REALKIND+((A(305)+A(307)+A(309)+A(311)+A(313) &
       +A(315)+A(317)+A(319)+A(321)+A(323)+A(325)+A(327)+A(333)+A(335)+A(339)+A(341)+A(345)+A(347)+A(353)+A(355)+A(357)+A(359) &
       +A(361)+A(363)+A(365)+A(367)+A(369)+A(371)+A(373)+A(375))*f(9))/6._/**/REALKIND+((-A(128)-A(132)-A(144) &
       -A(148))*f(13))/6._/**/REALKIND+((A(160)+A(162)+A(164)+A(166)+A(170)+A(174))*f(14))/6._/**/REALKIND+((-A(129)-A(133)-A(145) &
       -A(149)-A(161)-A(163)-A(165)-A(167)-A(171)-A(175))*f(15))/6._/**/REALKIND+((-A(192)-A(194)-A(204)-A(206)-A(224)-A(226) &
       -A(236)-A(238))*f(19))/6._/**/REALKIND+((A(108)+A(113)+A(120)+A(124)+A(176)+A(180)+A(188)+A(190)+A(208)+A(214)+A(220) &
       +A(222))*f(20))/6._/**/REALKIND+((-A(109)-A(114)-A(121)-A(125)-A(177)-A(181)-A(189)-A(191)-A(193)-A(195)-A(205)-A(207) &
       -A(209)-A(215)-A(221)-A(223)-A(225)-A(227)-A(237)-A(239))*f(21))/6._/**/REALKIND+((-A(130)-A(134)-A(146) &
       -A(150))*f(25))/6._/**/REALKIND+((-A(131)-A(135)-A(147)-A(151))*f(26))/6._/**/REALKIND+((A(111)+A(116)+A(178)+A(184)+A(210) &
       +A(218))*f(29))/6._/**/REALKIND+((-A(112)-A(117)-A(179)-A(185)-A(211)-A(219))*f(30))/6._/**/REALKIND+((A(110)+A(115)+A(126) &
       +A(127))*f(37))/6._/**/REALKIND
  M2(2) = ((-A(256)-A(258)-A(260)-A(262)-A(264)-A(266)-A(282)-A(292)-A(298)-A(364)-A(366)-A(368)-A(370)-A(372) &
       -A(374))*f(7))/2._/**/REALKIND+((A(316)+A(318)+A(320)+A(322)+A(324)+A(326)+A(332)+A(338)+A(346)+A(376)+A(378)+A(380)+A(382) &
       +A(384)+A(386))*f(8))/2._/**/REALKIND+((A(49)+A(51))*f(9))/4._/**/REALKIND+((-A(257)-A(259)-A(261)-A(263)-A(265)-A(267) &
       -A(283)-A(293)-A(299)-A(317)-A(319)-A(321)-A(323)-A(325)-A(327)-A(333)-A(339)-A(347)-A(365)-A(367)-A(369)-A(371)-A(373) &
       -A(375)-A(377)-A(379)-A(381)-A(383)-A(385)-A(387))*f(9))/2._/**/REALKIND+(CI*(-A(284)-A(286)-A(288)-A(290)-A(296) &
       -A(300))*f(10))/2._/**/REALKIND+(CI*(-A(328)-A(330)-A(336)-A(342)-A(348)-A(350))*f(11))/2._/**/REALKIND+(CI*(-A(285)-A(287) &
       -A(289)-A(291)-A(297)-A(301)+A(329)+A(331)+A(337)+A(343)+A(349)+A(351))*f(12))/2._/**/REALKIND+((A(56)+A(66)+A(76)+A(82) &
       +A(104)+A(106)+A(132)+A(148))*f(13))/2._/**/REALKIND+((-A(136)-A(138)-A(156)-A(158)-A(164)-A(166) &
       -A(174))*f(14))/2._/**/REALKIND+((A(57)+A(67)+A(77)+A(83)+A(105)+A(107)+A(133)+A(137)+A(139)+A(149)+A(157)+A(159)+A(165) &
       +A(167)+A(175))*f(15))/2._/**/REALKIND+(CI*(A(80)+A(96))*f(16))/2._/**/REALKIND+(CI*(A(168)+A(172))*f(17))/2._/**/REALKIND &
       +(CI*(A(81)+A(97)-A(169)-A(173))*f(18))/2._/**/REALKIND+((A(204)+A(206)+A(224)+A(226)+A(240)+A(242) &
       +A(248))*f(19))/2._/**/REALKIND+((-A(113)-A(124)-A(188)-A(190)-A(196)-A(208)-A(214)-A(228))*f(20))/2._/**/REALKIND+((A(114) &
       +A(125)+A(189)+A(191)+A(197)+A(205)+A(207)+A(209)+A(215)+A(225)+A(227)+A(229)+A(241)+A(243)+A(249))*f(21))/2._/**/REALKIND &
       +(CI*(A(250)+A(254))*f(22))/2._/**/REALKIND+(CI*(A(182)+A(212))*f(23))/2._/**/REALKIND+(CI*(-A(183)-A(213)+A(251) &
       +A(255))*f(24))/2._/**/REALKIND+((A(58)+A(78)+A(100)+A(134)+A(150))*f(25))/2._/**/REALKIND+((A(59)+A(79)+A(101)+A(135) &
       +A(151))*f(26))/2._/**/REALKIND+(CI*(A(86)+A(102))*f(27))/2._/**/REALKIND+(CI*(A(87)+A(103))*f(28))/2._/**/REALKIND+(( &
       -A(116)-A(184)-A(198)-A(210)-A(230))*f(29))/2._/**/REALKIND+((A(117)+A(185)+A(199)+A(211)+A(231))*f(30))/2._/**/REALKIND &
       +(CI*(A(186)+A(216))*f(31))/2._/**/REALKIND+(CI*(-A(187)-A(217))*f(32))/2._/**/REALKIND+(CI*(A(68) &
       +A(72))*f(33))/2._/**/REALKIND+(CI*(A(118)+A(122))*f(34))/2._/**/REALKIND+(CI*(A(69)+A(73)-A(119) &
       -A(123))*f(35))/2._/**/REALKIND+(CI*(A(53)-A(54)-A(55))*f(36))/2._/**/REALKIND+((-A(60)-A(75)-A(115) &
       -A(126))*f(37))/2._/**/REALKIND
  M2(3) = ((-A(268)-A(270)-A(272)-A(274)-A(276)-A(278)-A(280)-A(294)-A(302)-A(352)-A(354)-A(356)-A(358)-A(360) &
       -A(362))*f(7))/2._/**/REALKIND+((A(304)+A(306)+A(308)+A(310)+A(312)+A(314)+A(334)+A(340)+A(344)+A(388)+A(390)+A(392)+A(394) &
       +A(396)+A(398))*f(8))/2._/**/REALKIND+((A(50)+A(52))*f(9))/4._/**/REALKIND+((-A(269)-A(271)-A(273)-A(275)-A(277)-A(279) &
       -A(281)-A(295)-A(303)-A(305)-A(307)-A(309)-A(311)-A(313)-A(315)-A(335)-A(341)-A(345)-A(353)-A(355)-A(357)-A(359)-A(361) &
       -A(363)-A(389)-A(391)-A(393)-A(395)-A(397)-A(399))*f(9))/2._/**/REALKIND+(CI*(A(284)+A(286)+A(288)+A(290)+A(296) &
       +A(300))*f(10))/2._/**/REALKIND+(CI*(A(328)+A(330)+A(336)+A(342)+A(348)+A(350))*f(11))/2._/**/REALKIND+(CI*(A(285)+A(287) &
       +A(289)+A(291)+A(297)+A(301)-A(329)-A(331)-A(337)-A(343)-A(349)-A(351))*f(12))/2._/**/REALKIND+((A(61)+A(70)+A(88)+A(90) &
       +A(92)+A(98)+A(128)+A(144))*f(13))/2._/**/REALKIND+((-A(140)-A(142)-A(152)-A(154)-A(160)-A(162) &
       -A(170))*f(14))/2._/**/REALKIND+((A(62)+A(71)+A(89)+A(91)+A(93)+A(99)+A(129)+A(141)+A(143)+A(145)+A(153)+A(155)+A(161) &
       +A(163)+A(171))*f(15))/2._/**/REALKIND+(CI*(-A(80)-A(96))*f(16))/2._/**/REALKIND+(CI*(-A(168) &
       -A(172))*f(17))/2._/**/REALKIND+(CI*(-A(81)-A(97)+A(169)+A(173))*f(18))/2._/**/REALKIND+((A(192)+A(194)+A(236)+A(238) &
       +A(244)+A(246)+A(252))*f(19))/2._/**/REALKIND+((-A(108)-A(120)-A(176)-A(180)-A(200)-A(220)-A(222) &
       -A(232))*f(20))/2._/**/REALKIND+((A(109)+A(121)+A(177)+A(181)+A(193)+A(195)+A(201)+A(221)+A(223)+A(233)+A(237)+A(239) &
       +A(245)+A(247)+A(253))*f(21))/2._/**/REALKIND+(CI*(-A(250)-A(254))*f(22))/2._/**/REALKIND+(CI*(-A(182) &
       -A(212))*f(23))/2._/**/REALKIND+(CI*(A(183)+A(213)-A(251)-A(255))*f(24))/2._/**/REALKIND+((A(63)+A(84)+A(94)+A(130) &
       +A(146))*f(25))/2._/**/REALKIND+((A(64)+A(85)+A(95)+A(131)+A(147))*f(26))/2._/**/REALKIND+(CI*(-A(86) &
       -A(102))*f(27))/2._/**/REALKIND+(CI*(-A(87)-A(103))*f(28))/2._/**/REALKIND+((-A(111)-A(178)-A(202)-A(218) &
       -A(234))*f(29))/2._/**/REALKIND+((A(112)+A(179)+A(203)+A(219)+A(235))*f(30))/2._/**/REALKIND+(CI*(-A(186) &
       -A(216))*f(31))/2._/**/REALKIND+(CI*(A(187)+A(217))*f(32))/2._/**/REALKIND+(CI*(-A(68)-A(72))*f(33))/2._/**/REALKIND+(CI*( &
       -A(118)-A(122))*f(34))/2._/**/REALKIND+(CI*(-A(69)-A(73)+A(119)+A(123))*f(35))/2._/**/REALKIND+(CI*(-A(53)+A(54) &
       +A(55))*f(36))/2._/**/REALKIND+((-A(65)-A(74)-A(110)-A(127))*f(37))/2._/**/REALKIND
  M2(4) = ((A(256)+A(258)+A(260)+A(262)+A(264)+A(266)+A(268)+A(270)+A(272)+A(274)+A(276)+A(278)+A(280)+A(282)+A(292)+A(294)+A(298) &
       +A(302))*f(7))/6._/**/REALKIND+((-A(376)-A(378)-A(380)-A(382)-A(384)-A(386)-A(388)-A(390)-A(392)-A(394)-A(396) &
       -A(398))*f(8))/6._/**/REALKIND+((-A(49)-A(50)-A(51)-A(52))*f(9))/12._/**/REALKIND+((A(257)+A(259)+A(261)+A(263)+A(265) &
       +A(267)+A(269)+A(271)+A(273)+A(275)+A(277)+A(279)+A(281)+A(283)+A(293)+A(295)+A(299)+A(303)+A(377)+A(379)+A(381)+A(383) &
       +A(385)+A(387)+A(389)+A(391)+A(393)+A(395)+A(397)+A(399))*f(9))/6._/**/REALKIND+((-A(56)-A(61)-A(66)-A(70)-A(76)-A(82) &
       -A(88)-A(90)-A(92)-A(98)-A(104)-A(106))*f(13))/6._/**/REALKIND+((A(136)+A(138)+A(140)+A(142)+A(152)+A(154)+A(156) &
       +A(158))*f(14))/6._/**/REALKIND+((-A(57)-A(62)-A(67)-A(71)-A(77)-A(83)-A(89)-A(91)-A(93)-A(99)-A(105)-A(107)-A(137)-A(139) &
       -A(141)-A(143)-A(153)-A(155)-A(157)-A(159))*f(15))/6._/**/REALKIND+((-A(240)-A(242)-A(244)-A(246)-A(248) &
       -A(252))*f(19))/6._/**/REALKIND+((A(196)+A(200)+A(228)+A(232))*f(20))/6._/**/REALKIND+((-A(197)-A(201)-A(229)-A(233)-A(241) &
       -A(243)-A(245)-A(247)-A(249)-A(253))*f(21))/6._/**/REALKIND+((-A(58)-A(63)-A(78)-A(84)-A(94)-A(100))*f(25))/6._/**/REALKIND &
       +((-A(59)-A(64)-A(79)-A(85)-A(95)-A(101))*f(26))/6._/**/REALKIND+((A(198)+A(202)+A(230)+A(234))*f(29))/6._/**/REALKIND+(( &
       -A(199)-A(203)-A(231)-A(235))*f(30))/6._/**/REALKIND+((A(60)+A(65)+A(74)+A(75))*f(37))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppllttj_eexttxddxg_1_/**/REALKIND
