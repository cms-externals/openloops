...
module ol_versiondata_ppllttj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppllttj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllttj
  end interface
end module ol_versiondata_ppllttj


subroutine ol_version_ppllttj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllttj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllttj
