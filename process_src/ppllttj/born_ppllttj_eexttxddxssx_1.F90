...
module ol_colourmatrix_ppllttj_eexttxddxssx_1_/**/REALKIND
...
end module ol_colourmatrix_ppllttj_eexttxddxssx_1_/**/REALKIND



module ol_forced_parameters_ppllttj_eexttxddxssx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllttj_eexttxddxssx_1_/**/REALKIND

module ol_tree_ppllttj_eexttxddxssx_1_/**/REALKIND
...
subroutine born_denominators_init()
  ...
  den(117) = 1 / (Q(5,7) - MT2)
  den(119) = 1 / (Q(5,240))
  den(124) = 1 / (Q(5,56) - MT2)
  den(130) = 1 / (Q(5,200) - MT2)
  den(136) = 1 / (Q(5,11) - MT2)
  den(141) = 1 / (Q(5,52) - MT2)
  den(147) = 1 / (Q(5,196) - MT2)
  den(161) = 1 / (Q(5,15))
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllttj_eexttxddxssx_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllttj_eexttxddxssx_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for e- e+ top anti-top down anti-down strange anti-strange -> 0
...
! **********************************************************************
  ...
  use ol_external_ppllttj_eexttxddxssx_1, only: external_perm_ppllttj_eexttxddxssx_1, &
    & external_perm_inv_ppllttj_eexttxddxssx_1, extcomb_perm_ppllttj_eexttxddxssx_1, &
    & average_factor_ppllttj_eexttxddxssx_1
  use ol_external_ppllttj_eexttxddxssx_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppllttj_eexttxddxssx_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllttj_eexttxddxssx_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppllttj_eexttxddxssx_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppllttj_eexttxddxssx_1,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllttj_eexttxddxssx_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllttj_eexttxddxssx_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllttj_eexttxddxssx_1(extcombs(k))
  end do
  ...
  call prop_Q_A(ntry, wf8(:,35), Q(:,7), MT, 1_intkind1, wf8(:,36), n2(19))
  call vert_QA_V(ntry, wf8(:,36), ex4, wf16(:,17), n3(:,61), t3x16(:,:,17))
  call vert_AV_Q(ntry, ex4, wf4(:,3), wf8(:,37), n3(:,62), t3x8(:,:,19))
  call prop_A_Q(ntry, wf8(:,37), Q(:,56), MT, 1_intkind1, wf8(:,38), n2(20))
  ...
  call prop_A_Q(ntry, wf8(:,39), Q(:,200), MT, 1_intkind1, wf8(:,40), n2(21))
  ...
  call prop_Q_A(ntry, wf8(:,47), Q(:,196), MT, 1_intkind1, wf8(:,48), n2(25))
  ...
  M2add = M2 / average_factor_ppllttj_eexttxddxssx_1

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_ppllttj_eexttxddxssx_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllttj_eexttxddxssx_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllttj_eexttxddxssx_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllttj_eexttxddxssx_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllttj_eexttxddxssx_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllttj_eexttxddxssx_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllttj_eexttxddxssx_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllttj_eexttxddxssx_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllttj_eexttxddxssx_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllttj_eexttxddxssx_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllttj_eexttxddxssx_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllttj_eexttxddxssx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllttj_eexttxddxssx_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllttj_eexttxddxssx_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllttj_eexttxddxssx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllttj_eexttxddxssx_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllttj_eexttxddxssx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllttj_eexttxddxssx_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_ppllttj_eexttxddxssx_1_/**/REALKIND
