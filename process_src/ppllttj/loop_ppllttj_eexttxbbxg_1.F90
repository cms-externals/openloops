...
module ol_colourmatrix_ppllttj_eexttxbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllttj_eexttxbbxg_1_/**/REALKIND



module ol_forced_parameters_ppllttj_eexttxbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllttj_eexttxbbxg_1_/**/REALKIND

module ol_loop_ppllttj_eexttxbbxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(13) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**5)/3._/**/REALKIND
    f(14) = (2*CI*countertermnorm*ctGbb*eQED**2*gQCD**5)/3._/**/REALKIND
    f(15) = CI*countertermnorm*ctGbb*eQED**2*gQCD**5
    f(16) = (countertermnorm*ctGbb*eQED**2*gQCD**5)/3._/**/REALKIND
    f(17) = (2*countertermnorm*ctGbb*eQED**2*gQCD**5)/3._/**/REALKIND
    f(18) = countertermnorm*ctGbb*eQED**2*gQCD**5
    ...
    f(25) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**5)/3._/**/REALKIND
    f(26) = CI*countertermnorm*ctVbb*eQED**2*gQCD**5
    f(27) = (countertermnorm*ctVbb*eQED**2*gQCD**5)/3._/**/REALKIND
    f(28) = countertermnorm*ctVbb*eQED**2*gQCD**5
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,13),Q(:,83),MB,1_intkind1,wf(:,95))
  call prop_Q_A(wf(:,15),Q(:,83),MB,1_intkind1,wf(:,96))
  call counter_AV_Q(wf(:,-5),wf(:,1),wf(:,97))
  call prop_Q_A(wf(:,6),Q(:,92),MB,1_intkind1,wf(:,98))
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,9),wf(:,99))
  call counter_QA_V(wf(:,20),wf(:,-5),wf(:,100))
  call counter_QA_V(wf(:,22),wf(:,-5),wf(:,101))
  call prop_A_Q(wf(:,94),Q(:,44),MB,1_intkind1,wf(:,102))
  call prop_A_Q(wf(:,97),Q(:,35),MB,1_intkind1,wf(:,103))
  call prop_A_Q(wf(:,99),Q(:,35),MB,1_intkind1,wf(:,104))
  ...
  call prop_A_Q(wf(:,24),Q(:,99),MB,1_intkind1,wf(:,113))
  call prop_A_Q(wf(:,26),Q(:,99),MB,1_intkind1,wf(:,114))
  call counter_VQ_A(wf(:,1),wf(:,-4),wf(:,115))
  call prop_A_Q(wf(:,19),Q(:,108),MB,1_intkind1,wf(:,116))
  call counter_ZQ_A(gZd,wf(:,9),wf(:,-4),wf(:,117))
  call counter_QA_V(wf(:,-4),wf(:,7),wf(:,118))
  call counter_QA_V(wf(:,-4),wf(:,11),wf(:,119))
  call prop_Q_A(wf(:,112),Q(:,28),MB,1_intkind1,wf(:,120))
  call vert_VQ_A(wf(:,-6),wf(:,120),wf(:,121))
  call prop_Q_A(wf(:,115),Q(:,19),MB,1_intkind1,wf(:,122))
  call vert_VQ_A(wf(:,-6),wf(:,122),wf(:,123))
  call prop_Q_A(wf(:,117),Q(:,19),MB,1_intkind1,wf(:,124))
  ...
  call prop_Q_A(wf(:,128),Q(:,80),MB,1_intkind1,wf(:,129))
  ...
  call prop_A_Q(wf(:,215),Q(:,44),MB,1_intkind1,wf(:,216))
  call vert_AV_Q(wf(:,17),wf(:,213),wf(:,217))
  call vert_VQ_A(wf(:,213),wf(:,-4),wf(:,218))
  call prop_Q_A(wf(:,218),Q(:,28),MB,1_intkind1,wf(:,219))
  ...
  call counter_Q_A(ctbb,wf(:,4),Q(:,80),wf(:,225))
  call prop_Q_A(wf(:,225),Q(:,80),MB,1_intkind1,wf(:,226))
  ...
  call counter_A_Q(ctbb,wf(:,11),Q(:,35),wf(:,231))
  call counter_A_Q(ctbb,wf(:,14),Q(:,44),wf(:,232))
  call vert_VQ_A(wf(:,222),wf(:,-4),wf(:,233))
  call vert_VQ_A(wf(:,222),wf(:,20),wf(:,234))
  call vert_VQ_A(wf(:,222),wf(:,22),wf(:,235))
  call counter_Q_A(ctbb,wf(:,20),Q(:,19),wf(:,236))
  call counter_Q_A(ctbb,wf(:,22),Q(:,19),wf(:,237))
  call counter_Q_A(ctbb,wf(:,25),Q(:,28),wf(:,238))
  call counter_A_Q(ctbb,wf(:,17),Q(:,96),wf(:,239))
  call prop_A_Q(wf(:,239),Q(:,96),MB,1_intkind1,wf(:,240))
  ...
  call prop_Q_A(wf(:,233),Q(:,28),MB,1_intkind1,wf(:,245))
  call vert_AV_Q(wf(:,11),wf(:,-6),wf(:,246))
  call prop_A_Q(wf(:,223),Q(:,44),MB,1_intkind1,wf(:,247))
  call vert_UV_W(wf(:,222),Q(:,12),wf(:,-6),Q(:,64),wf(:,248))
  call vert_AV_Q(wf(:,-5),wf(:,29),wf(:,249))
  call prop_A_Q(wf(:,249),Q(:,108),MB,1_intkind1,wf(:,250))
  call vert_VQ_A(wf(:,29),wf(:,-4),wf(:,251))
  call prop_Q_A(wf(:,251),Q(:,92),MB,1_intkind1,wf(:,252))
  call vert_AV_Q(wf(:,14),wf(:,-6),wf(:,253))
  call prop_A_Q(wf(:,253),Q(:,108),MB,1_intkind1,wf(:,254))
  call prop_A_Q(wf(:,244),Q(:,99),MB,1_intkind1,wf(:,255))
  call prop_A_Q(wf(:,246),Q(:,99),MB,1_intkind1,wf(:,256))
  call counter_V_V(ctGG,wf(:,29),Q(:,76),wf(:,257))
  call prop_Q_A(wf(:,27),Q(:,83),MB,1_intkind1,wf(:,258))
  call prop_Q_A(wf(:,28),Q(:,83),MB,1_intkind1,wf(:,259))
  call prop_Q_A(wf(:,32),Q(:,92),MB,1_intkind1,wf(:,260))
  ...
  call prop_A_Q(wf(:,67),Q(:,108),MB,1_intkind1,wf(:,304))
  call prop_Q_A(wf(:,68),Q(:,92),MB,1_intkind1,wf(:,305))
  call vert_QA_V(wf(:,-2),wf(:,278),wf(:,306))
  call counter_V_V(ctGG,wf(:,69),Q(:,76),wf(:,307))
  call prop_A_Q(wf(:,70),Q(:,108),MB,1_intkind1,wf(:,308))
  call prop_Q_A(wf(:,71),Q(:,92),MB,1_intkind1,wf(:,309))
  ...
  call prop_Q_A(wf(:,322),Q(:,31),MB,1_intkind1,wf(:,323))
  call vert_VQ_A(wf(:,2),wf(:,22),wf(:,324))
  call prop_Q_A(wf(:,324),Q(:,31),MB,1_intkind1,wf(:,325))
  call vert_AV_Q(wf(:,7),wf(:,2),wf(:,326))
  call prop_A_Q(wf(:,326),Q(:,47),MB,1_intkind1,wf(:,327))
  call vert_AV_Q(wf(:,11),wf(:,2),wf(:,328))
  call prop_A_Q(wf(:,328),Q(:,47),MB,1_intkind1,wf(:,329))
  call vert_VQ_A(wf(:,1),wf(:,25),wf(:,330))
  call prop_Q_A(wf(:,330),Q(:,31),MB,1_intkind1,wf(:,331))
  call vert_ZQ_A(gZd,wf(:,9),wf(:,25),wf(:,332))
  call prop_Q_A(wf(:,332),Q(:,31),MB,1_intkind1,wf(:,333))
  call vert_AV_Q(wf(:,14),wf(:,1),wf(:,334))
  call prop_A_Q(wf(:,334),Q(:,47),MB,1_intkind1,wf(:,335))
  call vert_AZ_Q(gZd,wf(:,14),wf(:,9),wf(:,336))
  call prop_A_Q(wf(:,336),Q(:,47),MB,1_intkind1,wf(:,337))
  ...
  call prop_Q_A(wf(:,370),Q(:,31),MB,1_intkind1,wf(:,371))
  call vert_VQ_A(wf(:,60),wf(:,-4),wf(:,372))
  call prop_Q_A(wf(:,372),Q(:,31),MB,1_intkind1,wf(:,373))
  call vert_AV_Q(wf(:,-5),wf(:,59),wf(:,374))
  call prop_A_Q(wf(:,374),Q(:,47),MB,1_intkind1,wf(:,375))
  call vert_AV_Q(wf(:,-5),wf(:,60),wf(:,376))
  call prop_A_Q(wf(:,376),Q(:,47),MB,1_intkind1,wf(:,377))
  ...
  call prop_Q_A(wf(:,382),Q(:,31),MB,1_intkind1,wf(:,383))
  call vert_VQ_A(wf(:,64),wf(:,-4),wf(:,384))
  call prop_Q_A(wf(:,384),Q(:,31),MB,1_intkind1,wf(:,385))
  call vert_AV_Q(wf(:,-5),wf(:,63),wf(:,386))
  call prop_A_Q(wf(:,386),Q(:,47),MB,1_intkind1,wf(:,387))
  call vert_AV_Q(wf(:,-5),wf(:,64),wf(:,388))
  call prop_A_Q(wf(:,388),Q(:,47),MB,1_intkind1,wf(:,389))
...
subroutine denominators()
  ...
  den(105) = 1 / (Q(5,60))
  den(110) = 1 / (Q(5,67))
  den(114) = 1 / (Q(5,83) - MB2)
  den(119) = 1 / (Q(5,92) - MB2)
  den(123) = 1 / (Q(5,99) - MB2)
  den(128) = 1 / (Q(5,108) - MB2)
  ...
  den(196) = 1 / (Q(5,51))
  den(279) = 1 / (Q(5,15))
  den(365) = 1 / (Q(5,31) - MB2)
  den(370) = 1 / (Q(5,47) - MB2)
...
end module ol_loop_ppllttj_eexttxbbxg_1_/**/REALKIND
