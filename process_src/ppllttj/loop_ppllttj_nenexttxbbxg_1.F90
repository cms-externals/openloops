...
module ol_colourmatrix_ppllttj_nenexttxbbxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllttj_nenexttxbbxg_1_/**/REALKIND



module ol_forced_parameters_ppllttj_nenexttxbbxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllttj_nenexttxbbxg_1_/**/REALKIND

module ol_loop_ppllttj_nenexttxbbxg_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, intkind1
  implicit none
  ! diagram prefactors
  integer,           save :: fac_status_loop1 = -1, fac_status_loop2 = -1
  complex(REALKIND), save :: f(23), c(26)
  ! tree wavefunctions
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctGbb*eQED**2*gQCD**5
    f( 6) = countertermnorm*ctGbb*eQED**2*gQCD**5
    f( 7) = CI*countertermnorm*ctGtt*eQED**2*gQCD**5
    f( 8) = countertermnorm*ctGtt*eQED**2*gQCD**5
    f( 9) = CI*countertermnorm*ctVbb*eQED**2*gQCD**5
    f(10) = countertermnorm*ctVbb*eQED**2*gQCD**5
    f(11) = CI*countertermnorm*ctVtt*eQED**2*gQCD**5
    f(12) = countertermnorm*ctVtt*eQED**2*gQCD**5
    f(13) = countertermnorm*ctVVV*eQED**2*gQCD**5
    f(14) = CI*countertermnorm*ctZGG*eQED**2*gQCD**5
    f(15) = countertermnorm*ctZGG*eQED**2*gQCD**5
    f(16) = (CI*eQED**2*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(17) = CI*eQED**2*gQCD**5*integralnorm*SwB
    f(18) = (eQED**2*gQCD**5*integralnorm*SwB)/2._/**/REALKIND
    f(19) = eQED**2*gQCD**5*integralnorm*SwB
    f(20) = CI*eQED**2*gQCD**5*integralnorm*SwF
    f(21) = 2*CI*eQED**2*gQCD**5*integralnorm*SwF
    f(22) = eQED**2*gQCD**5*integralnorm*SwF
    f(23) = 2*eQED**2*gQCD**5*integralnorm*SwF

  c = [ 27*CI*f(16), 54*CI*f(16), 3*CI*f(17), 9*CI*f(17), 24*CI*f(17), 27*CI*f(17), 54*CI*f(17), 18*f(18), 54*f(18), f(19) &
    , 3*f(19), 6*f(19), 8*f(19), 9*f(19), 10*f(19), 18*f(19), 21*f(19), 24*f(19), 27*f(19), 54*f(19), 9*CI*f(20), 9*CI*f(21) &
    , 3*f(22), 9*f(22), 3*f(23), 9*f(23) ]
  c = (1._/**/REALKIND / 36) * c
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,25),Q(:,68),MT,1_intkind1,wf(:,27))
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,4),wf(:,28))
  call vert_VQ_A(wf(:,26),wf(:,27),wf(:,29))
  call prop_A_Q(wf(:,28),Q(:,11),MT,1_intkind1,wf(:,30))
  call vert_AV_Q(wf(:,-3),wf(:,26),wf(:,31))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,27),wf(:,32))
  call prop_A_Q(wf(:,31),Q(:,56),MT,1_intkind1,wf(:,33))
  call vert_AV_Q(wf(:,-3),wf(:,-6),wf(:,34))
  call prop_A_Q(wf(:,34),Q(:,72),MT,1_intkind1,wf(:,35))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,-2),wf(:,36))
  call vert_AV_Q(wf(:,35),wf(:,26),wf(:,37))
  call prop_Q_A(wf(:,36),Q(:,7),MT,1_intkind1,wf(:,38))
  call vert_VQ_A(wf(:,26),wf(:,-2),wf(:,39))
  call vert_AZ_Q(gZu,wf(:,35),wf(:,4),wf(:,40))
  call prop_Q_A(wf(:,39),Q(:,52),MT,1_intkind1,wf(:,41))
  ...
  call prop_A_Q(wf(:,115),Q(:,56),MT,1_intkind1,wf(:,116))
  call vert_AV_Q(wf(:,35),wf(:,113),wf(:,117))
  call vert_VQ_A(wf(:,113),wf(:,-2),wf(:,118))
  call prop_Q_A(wf(:,118),Q(:,52),MT,1_intkind1,wf(:,119))
  call vert_UV_W(wf(:,113),Q(:,48),wf(:,-6),Q(:,64),wf(:,120))
  call vert_VQ_A(wf(:,-6),wf(:,119),wf(:,121))
  call counter_AV_Q(wf(:,-3),wf(:,26),wf(:,122))
  call prop_Q_A(wf(:,32),Q(:,71),MT,1_intkind1,wf(:,123))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,4),wf(:,124))
  call prop_Q_A(wf(:,29),Q(:,116),MT,1_intkind1,wf(:,125))
  call prop_A_Q(wf(:,122),Q(:,56),MT,1_intkind1,wf(:,126))
  call counter_QA_V(wf(:,38),wf(:,-3),wf(:,127))
  call prop_A_Q(wf(:,124),Q(:,11),MT,1_intkind1,wf(:,128))
  call vert_QA_V(wf(:,-2),wf(:,128),wf(:,129))
  call counter_AV_Q(wf(:,-3),wf(:,-6),wf(:,130))
  call prop_A_Q(wf(:,130),Q(:,72),MT,1_intkind1,wf(:,131))
  call vert_AV_Q(wf(:,131),wf(:,26),wf(:,132))
  call vert_AZ_Q(gZu,wf(:,131),wf(:,4),wf(:,133))
  ...
  call prop_A_Q(wf(:,40),Q(:,75),MT,1_intkind1,wf(:,141))
  call counter_ZQ_A(gZu,wf(:,4),wf(:,-2),wf(:,142))
  call prop_A_Q(wf(:,37),Q(:,120),MT,1_intkind1,wf(:,143))
  call counter_QA_V(wf(:,-2),wf(:,30),wf(:,144))
  call prop_Q_A(wf(:,140),Q(:,52),MT,1_intkind1,wf(:,145))
  call vert_VQ_A(wf(:,-6),wf(:,145),wf(:,146))
  call prop_Q_A(wf(:,142),Q(:,7),MT,1_intkind1,wf(:,147))
  call vert_QA_V(wf(:,147),wf(:,-3),wf(:,148))
  call vert_VQ_A(wf(:,-6),wf(:,147),wf(:,149))
  call counter_VQ_A(wf(:,-6),wf(:,-2),wf(:,150))
  call prop_Q_A(wf(:,150),Q(:,68),MT,1_intkind1,wf(:,151))
  call vert_VQ_A(wf(:,26),wf(:,151),wf(:,152))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,151),wf(:,153))
  ...
  call prop_A_Q(wf(:,162),Q(:,44),MB,1_intkind1,wf(:,163))
  call vert_AV_Q(wf(:,13),wf(:,160),wf(:,164))
  call vert_VQ_A(wf(:,160),wf(:,-4),wf(:,165))
  call prop_Q_A(wf(:,165),Q(:,28),MB,1_intkind1,wf(:,166))
  ...
  call counter_Q_A(ctbb,wf(:,5),Q(:,80),wf(:,172))
  call prop_Q_A(wf(:,172),Q(:,80),MB,1_intkind1,wf(:,173))
  call vert_VQ_A(wf(:,2),wf(:,173),wf(:,174))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,173),wf(:,175))
  call counter_A_Q(ctbb,wf(:,8),Q(:,35),wf(:,176))
  call counter_A_Q(ctbb,wf(:,11),Q(:,44),wf(:,177))
  call vert_VQ_A(wf(:,169),wf(:,-4),wf(:,178))
  call vert_VQ_A(wf(:,169),wf(:,16),wf(:,179))
  call counter_Q_A(ctbb,wf(:,16),Q(:,19),wf(:,180))
  call counter_Q_A(ctbb,wf(:,19),Q(:,28),wf(:,181))
  call counter_A_Q(ctbb,wf(:,13),Q(:,96),wf(:,182))
  call prop_A_Q(wf(:,182),Q(:,96),MB,1_intkind1,wf(:,183))
  call vert_AV_Q(wf(:,183),wf(:,2),wf(:,184))
  call vert_AZ_Q(gZd,wf(:,183),wf(:,4),wf(:,185))
  call vert_AV_Q(wf(:,8),wf(:,-6),wf(:,186))
  call prop_Q_A(wf(:,178),Q(:,28),MB,1_intkind1,wf(:,187))
  call prop_A_Q(wf(:,170),Q(:,44),MB,1_intkind1,wf(:,188))
  ...
  call prop_Q_A(wf(:,192),Q(:,92),MB,1_intkind1,wf(:,193))
  call vert_AV_Q(wf(:,11),wf(:,-6),wf(:,194))
  call prop_A_Q(wf(:,194),Q(:,108),MB,1_intkind1,wf(:,195))
  call prop_A_Q(wf(:,186),Q(:,99),MB,1_intkind1,wf(:,196))
  call counter_V_V(ctGG,wf(:,21),Q(:,76),wf(:,197))
  call prop_Q_A(wf(:,20),Q(:,83),MB,1_intkind1,wf(:,198))
  call prop_Q_A(wf(:,23),Q(:,92),MB,1_intkind1,wf(:,199))
  call counter_Q_A(cttt,wf(:,27),Q(:,68),wf(:,200))
  call prop_Q_A(wf(:,200),Q(:,68),MT,1_intkind1,wf(:,201))
  call vert_QA_V(wf(:,201),wf(:,30),wf(:,202))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,201),wf(:,203))
  call counter_V_V(ctGG,wf(:,26),Q(:,48),wf(:,204))
  call vert_AV_Q(wf(:,-3),wf(:,204),wf(:,205))
  call counter_A_Q(cttt,wf(:,30),Q(:,11),wf(:,206))
  call counter_A_Q(cttt,wf(:,33),Q(:,56),wf(:,207))
  call vert_VQ_A(wf(:,204),wf(:,27),wf(:,208))
  call vert_VQ_A(wf(:,204),wf(:,-2),wf(:,209))
  call counter_Q_A(cttt,wf(:,38),Q(:,7),wf(:,210))
  call counter_Q_A(cttt,wf(:,41),Q(:,52),wf(:,211))
  call counter_A_Q(cttt,wf(:,35),Q(:,72),wf(:,212))
  call prop_A_Q(wf(:,212),Q(:,72),MT,1_intkind1,wf(:,213))
  call vert_QA_V(wf(:,38),wf(:,213),wf(:,214))
  call vert_AZ_Q(gZu,wf(:,213),wf(:,4),wf(:,215))
  call vert_VQ_A(wf(:,204),wf(:,38),wf(:,216))
  call vert_AV_Q(wf(:,-3),wf(:,42),wf(:,217))
  call prop_A_Q(wf(:,217),Q(:,120),MT,1_intkind1,wf(:,218))
  call vert_VQ_A(wf(:,42),wf(:,-2),wf(:,219))
  call prop_Q_A(wf(:,219),Q(:,116),MT,1_intkind1,wf(:,220))
  call vert_AV_Q(wf(:,30),wf(:,-6),wf(:,221))
  call prop_Q_A(wf(:,209),Q(:,52),MT,1_intkind1,wf(:,222))
  call vert_AV_Q(wf(:,33),wf(:,-6),wf(:,223))
  call prop_A_Q(wf(:,223),Q(:,120),MT,1_intkind1,wf(:,224))
  call counter_V_V(ctGG,wf(:,42),Q(:,112),wf(:,225))
  call prop_A_Q(wf(:,221),Q(:,75),MT,1_intkind1,wf(:,226))
  call prop_A_Q(wf(:,205),Q(:,56),MT,1_intkind1,wf(:,227))
  call prop_Q_A(wf(:,44),Q(:,71),MT,1_intkind1,wf(:,228))
  call prop_Q_A(wf(:,46),Q(:,116),MT,1_intkind1,wf(:,229))
  call vert_UV_W(wf(:,204),Q(:,48),wf(:,-6),Q(:,64),wf(:,230))
  call vert_QA_V(wf(:,201),wf(:,-3),wf(:,231))
  call counter_V_V(ctGG,wf(:,47),Q(:,76),wf(:,232))
  call prop_A_Q(wf(:,48),Q(:,108),MB,1_intkind1,wf(:,233))
  call prop_Q_A(wf(:,49),Q(:,92),MB,1_intkind1,wf(:,234))
  call vert_QA_V(wf(:,-2),wf(:,213),wf(:,235))
  call counter_V_V(ctGG,wf(:,50),Q(:,76),wf(:,236))
  call prop_A_Q(wf(:,51),Q(:,108),MB,1_intkind1,wf(:,237))
  call prop_Q_A(wf(:,52),Q(:,92),MB,1_intkind1,wf(:,238))
  call vert_AV_Q(wf(:,-3),wf(:,53),wf(:,239))
  call prop_A_Q(wf(:,239),Q(:,120),MT,1_intkind1,wf(:,240))
  call vert_VQ_A(wf(:,53),wf(:,-2),wf(:,241))
  call prop_Q_A(wf(:,241),Q(:,116),MT,1_intkind1,wf(:,242))
  call counter_V_V(ctGG,wf(:,53),Q(:,112),wf(:,243))
  call vert_QA_V(wf(:,173),wf(:,-5),wf(:,244))
  call vert_AV_Q(wf(:,-3),wf(:,54),wf(:,245))
  call prop_A_Q(wf(:,245),Q(:,120),MT,1_intkind1,wf(:,246))
  call vert_VQ_A(wf(:,54),wf(:,-2),wf(:,247))
  call prop_Q_A(wf(:,247),Q(:,116),MT,1_intkind1,wf(:,248))
  ...
  call prop_Q_A(wf(:,259),Q(:,55),MT,1_intkind1,wf(:,260))
  call vert_AV_Q(wf(:,30),wf(:,26),wf(:,261))
  call prop_A_Q(wf(:,261),Q(:,59),MT,1_intkind1,wf(:,262))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,41),wf(:,263))
  call prop_Q_A(wf(:,263),Q(:,55),MT,1_intkind1,wf(:,264))
  call vert_AZ_Q(gZu,wf(:,33),wf(:,4),wf(:,265))
  call prop_A_Q(wf(:,265),Q(:,59),MT,1_intkind1,wf(:,266))
...
subroutine denominators()
  ...
  den(82) = 1 / (Q(5,92) - MB2)
  den(85) = 1 / (Q(5,99) - MB2)
  den(88) = 1 / (Q(5,108) - MB2)
  den(95) = 1 / (Q(5,71) - MT2)
  den(98) = 1 / (Q(5,116) - MT2)
  den(101) = 1 / (Q(5,75) - MT2)
  den(104) = 1 / (Q(5,120) - MT2)
  den(132) = 1 / (Q(5,51))
  den(180) = 1 / (Q(5,15))
  den(230) = 1 / (Q(5,31) - MB2)
  den(233) = 1 / (Q(5,47) - MB2)
  den(242) = 1 / (Q(5,55) - MT2)
  den(245) = 1 / (Q(5,59) - MT2)
  den(254) = 1 / (Q(5,79))
  den(261) = 1 / (Q(5,115))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(25)-A(26))*f(3))/12._/**/REALKIND+((A(158)+A(159)+A(160)+A(161)+A(162)+A(163)+A(164)+A(165)+A(166)+A(167)+A(168) &
       ...
       +A(192)+A(193))*f(3))/6._/**/REALKIND+((-A(70)-A(72)-A(78)-A(80)-A(86)-A(87)-A(88)-A(89)-A(91)-A(93))*f(5))/6._/**/REALKIND &
       +((-A(58)-A(61)-A(65)-A(67)-A(94)-A(96)-A(100)-A(101)-A(102)-A(103)-A(108)-A(109)-A(110)-A(113)-A(116)-A(117)-A(118)-A(119) &
       -A(124)-A(125))*f(7))/6._/**/REALKIND+((-A(71)-A(73)-A(79)-A(81))*f(9))/6._/**/REALKIND+((-A(60)-A(63)-A(95)-A(98)-A(111) &
       -A(115))*f(11))/6._/**/REALKIND+((A(59)+A(62)+A(68)+A(69))*f(15))/6._/**/REALKIND
  M2(2) = (A(25)*f(3))/4._/**/REALKIND+((-A(134)-A(135)-A(136)-A(137)-A(138)-A(139)-A(147)-A(152)-A(155)-A(164)-A(165)-A(166) &
       ...
       +A(181))*f(4))/2._/**/REALKIND+((A(30)+A(36)+A(42)+A(45)+A(56)+A(57)+A(72)+A(74)+A(75)+A(80)+A(84)+A(85)+A(88)+A(89) &
       +A(93))*f(5))/2._/**/REALKIND+(CI*(A(44)+A(52)-A(90)-A(92))*f(6))/2._/**/REALKIND+((A(61)+A(67)+A(100)+A(101)+A(104)+A(108) &
       +A(109)+A(110)+A(113)+A(118)+A(119)+A(120)+A(126)+A(127)+A(130))*f(7))/2._/**/REALKIND+(CI*(-A(97)-A(112)+A(131) &
       +A(133))*f(8))/2._/**/REALKIND+((A(31)+A(43)+A(54)+A(73)+A(81))*f(9))/2._/**/REALKIND+(CI*(A(47) &
       +A(55))*f(10))/2._/**/REALKIND+((A(63)+A(98)+A(105)+A(111)+A(121))*f(11))/2._/**/REALKIND+(CI*(-A(99) &
       -A(114))*f(12))/2._/**/REALKIND+(CI*(A(37)+A(39)-A(64)-A(66))*f(13))/2._/**/REALKIND+(CI*(A(27)-A(28) &
       -A(29))*f(14))/2._/**/REALKIND+((-A(32)-A(41)-A(62)-A(68))*f(15))/2._/**/REALKIND
  M2(3) = (A(26)*f(3))/4._/**/REALKIND+((-A(140)-A(141)-A(142)-A(143)-A(144)-A(145)-A(146)-A(153)-A(157)-A(158)-A(159)-A(160) &
       ...
       -A(181))*f(4))/2._/**/REALKIND+((A(33)+A(38)+A(48)+A(49)+A(50)+A(53)+A(70)+A(76)+A(77)+A(78)+A(82)+A(83)+A(86)+A(87) &
       +A(91))*f(5))/2._/**/REALKIND+(CI*(-A(44)-A(52)+A(90)+A(92))*f(6))/2._/**/REALKIND+((A(58)+A(65)+A(94)+A(96)+A(102)+A(103) &
       +A(106)+A(116)+A(117)+A(122)+A(124)+A(125)+A(128)+A(129)+A(132))*f(7))/2._/**/REALKIND+(CI*(A(97)+A(112)-A(131) &
       -A(133))*f(8))/2._/**/REALKIND+((A(34)+A(46)+A(51)+A(71)+A(79))*f(9))/2._/**/REALKIND+(CI*(-A(47) &
       -A(55))*f(10))/2._/**/REALKIND+((A(60)+A(95)+A(107)+A(115)+A(123))*f(11))/2._/**/REALKIND+(CI*(A(99) &
       +A(114))*f(12))/2._/**/REALKIND+(CI*(-A(37)-A(39)+A(64)+A(66))*f(13))/2._/**/REALKIND+(CI*(-A(27)+A(28) &
       +A(29))*f(14))/2._/**/REALKIND+((-A(35)-A(40)-A(59)-A(69))*f(15))/2._/**/REALKIND
  M2(4) = ((-A(25)-A(26))*f(3))/12._/**/REALKIND+((A(134)+A(135)+A(136)+A(137)+A(138)+A(139)+A(140)+A(141)+A(142)+A(143)+A(144) &
       ...
       -A(75)-A(76)-A(77)-A(82)-A(83)-A(84)-A(85))*f(5))/6._/**/REALKIND+((-A(104)-A(106)-A(120)-A(122)-A(126)-A(127)-A(128) &
       -A(129)-A(130)-A(132))*f(7))/6._/**/REALKIND+((-A(31)-A(34)-A(43)-A(46)-A(51)-A(54))*f(9))/6._/**/REALKIND+((-A(105)-A(107) &
       -A(121)-A(123))*f(11))/6._/**/REALKIND+((A(32)+A(35)+A(40)+A(41))*f(15))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppllttj_nenexttxbbxg_1_/**/REALKIND
