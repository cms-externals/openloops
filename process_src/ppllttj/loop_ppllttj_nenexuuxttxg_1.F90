...
module ol_colourmatrix_ppllttj_nenexuuxttxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllttj_nenexuuxttxg_1_/**/REALKIND



module ol_forced_parameters_ppllttj_nenexuuxttxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllttj_nenexuuxttxg_1_/**/REALKIND

module ol_loop_ppllttj_nenexuuxttxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 9) = CI*countertermnorm*ctVqq*eQED**2*gQCD**5
    f(10) = countertermnorm*ctVqq*eQED**2*gQCD**5
...
! **********************************************************************
  ...
  call counter_ZQ_A(gZu,wf(:,4),wf(:,5),wf(:,62))
  call counter_AV_Q(wf(:,13),wf(:,2),wf(:,63))
  call counter_AZ_Q(gZu,wf(:,13),wf(:,4),wf(:,64))
  ...
  call prop_Q_A(wf(:,10),Q(:,83),MT,1_intkind1,wf(:,71))
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,4),wf(:,72))
  call prop_Q_A(wf(:,7),Q(:,92),MT,1_intkind1,wf(:,73))
  call counter_QA_V(wf(:,16),wf(:,-5),wf(:,74))
  call prop_A_Q(wf(:,70),Q(:,44),MT,1_intkind1,wf(:,75))
  call prop_A_Q(wf(:,72),Q(:,35),MT,1_intkind1,wf(:,76))
  call vert_QA_V(wf(:,-4),wf(:,76),wf(:,77))
  call counter_AV_Q(wf(:,-5),wf(:,-6),wf(:,78))
  call prop_A_Q(wf(:,78),Q(:,96),MT,1_intkind1,wf(:,79))
  call vert_AV_Q(wf(:,79),wf(:,2),wf(:,80))
  call vert_AZ_Q(gZu,wf(:,79),wf(:,4),wf(:,81))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,82))
  call prop_A_Q(wf(:,18),Q(:,99),MT,1_intkind1,wf(:,83))
  call counter_ZQ_A(gZu,wf(:,4),wf(:,-4),wf(:,84))
  call prop_A_Q(wf(:,15),Q(:,108),MT,1_intkind1,wf(:,85))
  call counter_QA_V(wf(:,-4),wf(:,8),wf(:,86))
  call prop_Q_A(wf(:,82),Q(:,28),MT,1_intkind1,wf(:,87))
  call vert_VQ_A(wf(:,-6),wf(:,87),wf(:,88))
  call prop_Q_A(wf(:,84),Q(:,19),MT,1_intkind1,wf(:,89))
  call vert_VQ_A(wf(:,-6),wf(:,89),wf(:,90))
  call vert_QA_V(wf(:,89),wf(:,-5),wf(:,91))
  call counter_VQ_A(wf(:,-6),wf(:,-4),wf(:,92))
  call prop_Q_A(wf(:,92),Q(:,80),MT,1_intkind1,wf(:,93))
  call vert_VQ_A(wf(:,2),wf(:,93),wf(:,94))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,93),wf(:,95))
  ...
  call prop_A_Q(wf(:,162),Q(:,44),MT,1_intkind1,wf(:,163))
  call vert_AV_Q(wf(:,13),wf(:,160),wf(:,164))
  call vert_VQ_A(wf(:,160),wf(:,-4),wf(:,165))
  call prop_Q_A(wf(:,165),Q(:,28),MT,1_intkind1,wf(:,166))
  ...
  call counter_Q_A(cttt,wf(:,5),Q(:,80),wf(:,172))
  call prop_Q_A(wf(:,172),Q(:,80),MT,1_intkind1,wf(:,173))
  call vert_VQ_A(wf(:,2),wf(:,173),wf(:,174))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,173),wf(:,175))
  call counter_A_Q(cttt,wf(:,8),Q(:,35),wf(:,176))
  call counter_A_Q(cttt,wf(:,11),Q(:,44),wf(:,177))
  call vert_VQ_A(wf(:,169),wf(:,-4),wf(:,178))
  call vert_VQ_A(wf(:,169),wf(:,16),wf(:,179))
  call counter_Q_A(cttt,wf(:,16),Q(:,19),wf(:,180))
  call counter_Q_A(cttt,wf(:,19),Q(:,28),wf(:,181))
  call counter_A_Q(cttt,wf(:,13),Q(:,96),wf(:,182))
  call prop_A_Q(wf(:,182),Q(:,96),MT,1_intkind1,wf(:,183))
  call vert_AV_Q(wf(:,183),wf(:,2),wf(:,184))
  call vert_AZ_Q(gZu,wf(:,183),wf(:,4),wf(:,185))
  call vert_AV_Q(wf(:,8),wf(:,-6),wf(:,186))
  call prop_Q_A(wf(:,178),Q(:,28),MT,1_intkind1,wf(:,187))
  call prop_A_Q(wf(:,170),Q(:,44),MT,1_intkind1,wf(:,188))
  call vert_UV_W(wf(:,169),Q(:,12),wf(:,-6),Q(:,64),wf(:,189))
  call vert_AV_Q(wf(:,-5),wf(:,21),wf(:,190))
  call prop_A_Q(wf(:,190),Q(:,108),MT,1_intkind1,wf(:,191))
  call vert_VQ_A(wf(:,21),wf(:,-4),wf(:,192))
  call prop_Q_A(wf(:,192),Q(:,92),MT,1_intkind1,wf(:,193))
  call vert_AV_Q(wf(:,11),wf(:,-6),wf(:,194))
  call prop_A_Q(wf(:,194),Q(:,108),MT,1_intkind1,wf(:,195))
  call prop_A_Q(wf(:,186),Q(:,99),MT,1_intkind1,wf(:,196))
  call counter_V_V(ctGG,wf(:,21),Q(:,76),wf(:,197))
  call prop_Q_A(wf(:,20),Q(:,83),MT,1_intkind1,wf(:,198))
  call prop_Q_A(wf(:,23),Q(:,92),MT,1_intkind1,wf(:,199))
  ...
  call prop_A_Q(wf(:,48),Q(:,108),MT,1_intkind1,wf(:,233))
  call prop_Q_A(wf(:,49),Q(:,92),MT,1_intkind1,wf(:,234))
  call vert_QA_V(wf(:,-2),wf(:,213),wf(:,235))
  call counter_V_V(ctGG,wf(:,50),Q(:,76),wf(:,236))
  call prop_A_Q(wf(:,51),Q(:,108),MT,1_intkind1,wf(:,237))
  call prop_Q_A(wf(:,52),Q(:,92),MT,1_intkind1,wf(:,238))
  ...
  call prop_Q_A(wf(:,251),Q(:,31),MT,1_intkind1,wf(:,252))
  call vert_AV_Q(wf(:,8),wf(:,2),wf(:,253))
  call prop_A_Q(wf(:,253),Q(:,47),MT,1_intkind1,wf(:,254))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,19),wf(:,255))
  call prop_Q_A(wf(:,255),Q(:,31),MT,1_intkind1,wf(:,256))
  call vert_AZ_Q(gZu,wf(:,11),wf(:,4),wf(:,257))
  call prop_A_Q(wf(:,257),Q(:,47),MT,1_intkind1,wf(:,258))
  ...
  call prop_Q_A(wf(:,275),Q(:,31),MT,1_intkind1,wf(:,276))
  call vert_AV_Q(wf(:,-5),wf(:,43),wf(:,277))
  call prop_A_Q(wf(:,277),Q(:,47),MT,1_intkind1,wf(:,278))
  call vert_UV_W(wf(:,43),Q(:,15),wf(:,-6),Q(:,64),wf(:,279))
  call vert_QA_V(wf(:,228),wf(:,-3),wf(:,280))
  call vert_VQ_A(wf(:,45),wf(:,-4),wf(:,281))
  call prop_Q_A(wf(:,281),Q(:,31),MT,1_intkind1,wf(:,282))
  call vert_AV_Q(wf(:,-5),wf(:,45),wf(:,283))
  call prop_A_Q(wf(:,283),Q(:,47),MT,1_intkind1,wf(:,284))
...
subroutine denominators()
  ...
  den(132) = 1 / (Q(5,51))
  den(180) = 1 / (Q(5,15))
  den(230) = 1 / (Q(5,31) - MT2)
  den(233) = 1 / (Q(5,47) - MT2)
  den(242) = 1 / (Q(5,55))
  den(245) = 1 / (Q(5,59))
  den(254) = 1 / (Q(5,79))
  den(261) = 1 / (Q(5,115))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(25)-A(26))*f(3))/12._/**/REALKIND+((A(158)+A(159)+A(160)+A(161)+A(162)+A(163)+A(164)+A(165)+A(166)+A(167)+A(168) &
       ...
       +A(192)+A(193))*f(3))/6._/**/REALKIND+((-A(58)-A(61)-A(65)-A(67)-A(94)-A(96)-A(100)-A(101)-A(102)-A(103)-A(108)-A(109) &
       -A(110)-A(113)-A(116)-A(117)-A(118)-A(119)-A(124)-A(125))*f(5))/6._/**/REALKIND+((-A(70)-A(72)-A(78)-A(80)-A(86)-A(87) &
       -A(88)-A(89)-A(91)-A(93))*f(7))/6._/**/REALKIND+((-A(60)-A(63)-A(95)-A(98)-A(111)-A(115))*f(9))/6._/**/REALKIND+((-A(71) &
       -A(73)-A(79)-A(81))*f(11))/6._/**/REALKIND+((A(59)+A(62)+A(68)+A(69))*f(15))/6._/**/REALKIND
  M2(2) = (A(25)*f(3))/4._/**/REALKIND+((-A(134)-A(135)-A(136)-A(137)-A(138)-A(139)-A(147)-A(152)-A(155)-A(164)-A(165)-A(166) &
       ...
       +A(181))*f(4))/2._/**/REALKIND+((A(61)+A(67)+A(100)+A(101)+A(104)+A(108)+A(109)+A(110)+A(113)+A(118)+A(119)+A(120)+A(126) &
       +A(127)+A(130))*f(5))/2._/**/REALKIND+(CI*(-A(97)-A(112)+A(131)+A(133))*f(6))/2._/**/REALKIND+((A(30)+A(36)+A(42)+A(45) &
       +A(56)+A(57)+A(72)+A(74)+A(75)+A(80)+A(84)+A(85)+A(88)+A(89)+A(93))*f(7))/2._/**/REALKIND+(CI*(A(44)+A(52)-A(90) &
       -A(92))*f(8))/2._/**/REALKIND+((A(63)+A(98)+A(105)+A(111)+A(121))*f(9))/2._/**/REALKIND+(CI*(-A(99) &
       -A(114))*f(10))/2._/**/REALKIND+((A(31)+A(43)+A(54)+A(73)+A(81))*f(11))/2._/**/REALKIND+(CI*(A(47) &
       +A(55))*f(12))/2._/**/REALKIND+(CI*(A(37)+A(39)-A(64)-A(66))*f(13))/2._/**/REALKIND+(CI*(A(27)-A(28) &
  ...
  M2(3) = (A(26)*f(3))/4._/**/REALKIND+((-A(140)-A(141)-A(142)-A(143)-A(144)-A(145)-A(146)-A(153)-A(157)-A(158)-A(159)-A(160) &
       ...
       -A(181))*f(4))/2._/**/REALKIND+((A(58)+A(65)+A(94)+A(96)+A(102)+A(103)+A(106)+A(116)+A(117)+A(122)+A(124)+A(125)+A(128) &
       +A(129)+A(132))*f(5))/2._/**/REALKIND+(CI*(A(97)+A(112)-A(131)-A(133))*f(6))/2._/**/REALKIND+((A(33)+A(38)+A(48)+A(49) &
       +A(50)+A(53)+A(70)+A(76)+A(77)+A(78)+A(82)+A(83)+A(86)+A(87)+A(91))*f(7))/2._/**/REALKIND+(CI*(-A(44)-A(52)+A(90) &
       +A(92))*f(8))/2._/**/REALKIND+((A(60)+A(95)+A(107)+A(115)+A(123))*f(9))/2._/**/REALKIND+(CI*(A(99) &
       +A(114))*f(10))/2._/**/REALKIND+((A(34)+A(46)+A(51)+A(71)+A(79))*f(11))/2._/**/REALKIND+(CI*(-A(47) &
       -A(55))*f(12))/2._/**/REALKIND+(CI*(-A(37)-A(39)+A(64)+A(66))*f(13))/2._/**/REALKIND+(CI*(-A(27)+A(28) &
  ...
  M2(4) = ((-A(25)-A(26))*f(3))/12._/**/REALKIND+((A(134)+A(135)+A(136)+A(137)+A(138)+A(139)+A(140)+A(141)+A(142)+A(143)+A(144) &
       ...
       +A(204)+A(205))*f(3))/6._/**/REALKIND+((-A(104)-A(106)-A(120)-A(122)-A(126)-A(127)-A(128)-A(129)-A(130) &
       -A(132))*f(5))/6._/**/REALKIND+((-A(30)-A(33)-A(36)-A(38)-A(42)-A(45)-A(48)-A(49)-A(50)-A(53)-A(56)-A(57)-A(74)-A(75)-A(76) &
       -A(77)-A(82)-A(83)-A(84)-A(85))*f(7))/6._/**/REALKIND+((-A(105)-A(107)-A(121)-A(123))*f(9))/6._/**/REALKIND+((-A(31)-A(34) &
       -A(43)-A(46)-A(51)-A(54))*f(11))/6._/**/REALKIND+((A(32)+A(35)+A(40)+A(41))*f(15))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppllttj_nenexuuxttxg_1_/**/REALKIND
