...
module ol_colourmatrix_ppzwjj_udxzwggg_1_/**/REALKIND
...
end module ol_colourmatrix_ppzwjj_udxzwggg_1_/**/REALKIND



module ol_forced_parameters_ppzwjj_udxzwggg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzwjj_udxzwggg_1_/**/REALKIND

module ol_tree_ppzwjj_udxzwggg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppzwjj_udxzwggg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppzwjj_udxzwggg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for up anti-down Z W- glue glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppzwjj_udxzwggg_1, only: external_perm_ppzwjj_udxzwggg_1, &
    & external_perm_inv_ppzwjj_udxzwggg_1, extcomb_perm_ppzwjj_udxzwggg_1, &
    & average_factor_ppzwjj_udxzwggg_1
  use ol_external_ppzwjj_udxzwggg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppzwjj_udxzwggg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppzwjj_udxzwggg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppzwjj_udxzwggg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppzwjj_udxzwggg_1,7)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppzwjj_udxzwggg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppzwjj_udxzwggg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppzwjj_udxzwggg_1(extcombs(k))
  end do
  ...
  call vert_WQ_A(ntry, ex4, ex1, wf6(:,5), n3(:,8), t3x6(:,:,3))
  ...
  call vert_AW_Q(ntry, wf6(:,8), ex4, wf18(:,2), n3(:,12), t3x18(:,:,2))
  ...
  call vert_UV_W(ntry, ex4, Q(:,8), ex3, Q(:,4), wf9(:,1), n3(:,17), t3x9(:,:,1))
  call prop_W_W(ntry, wf9(:,1), Q(:,12), MW, 1_intkind1, wf9(:,2), n2(11))
  call vert_WQ_A(ntry, wf9(:,2), ex1, wf18(:,5), n3(:,18), t3x18(:,:,5))
  call prop_Q_A(ntry, wf18(:,5), Q(:,13), ZERO, 0_intkind1, wf18(:,6), n2(12))
  call vert_AW_Q(ntry, ex2, wf9(:,2), wf18(:,7), n3(:,19), t3x18(:,:,6))
  ...
  call prop_Q_A(ntry, wf12(:,1), Q(:,69), ZERO, 0_intkind1, wf12(:,2), n2(13))
  ...
  call prop_A_Q(ntry, wf12(:,7), Q(:,42), ZERO, 0_intkind1, wf12(:,8), n2(16))
  ...
  call prop_Q_A(ntry, wf12(:,9), Q(:,21), ZERO, 0_intkind1, wf12(:,10), n2(17))
  call vert_AV_Q(ntry, wf6(:,4), ex5, wf12(:,11), n3(:,35), t3x12(:,:,6))
  call vert_VQ_A(ntry, wf4(:,3), wf6(:,3), wf24(:,6), n3(:,36), t3x24(:,:,6))
  call prop_A_Q(ntry, wf12(:,11), Q(:,26), ZERO, 0_intkind1, wf12(:,12), n2(18))
  ...
  call prop_A_Q(ntry, wf4(:,4), Q(:,18), ZERO, 0_intkind1, wf4(:,5), n2(19))
  call vert_AV_Q(ntry, wf4(:,5), wf4(:,3), wf16(:,13), n3(:,45), t3x16(:,:,7))
  call prop_Q_A(ntry, wf18(:,1), Q(:,13), ZERO, 0_intkind1, wf18(:,8), n2(20))
  call vert_AW_Q(ntry, wf4(:,5), ex4, wf12(:,13), n3(:,46), t3x12(:,:,7))
  call prop_A_Q(ntry, wf12(:,13), Q(:,26), ZERO, 0_intkind1, wf12(:,14), n2(21))
  call vert_AV_Q(ntry, wf4(:,5), ex6, wf8(:,7), n3(:,47), t3x8(:,:,4))
  call prop_A_Q(ntry, wf8(:,7), Q(:,50), ZERO, 0_intkind1, wf8(:,8), n2(22))
  call vert_VQ_A(ntry, ex7, wf18(:,8), wf36(:,3), n3(:,48), t3x36(:,:,3))
  call vert_AV_Q(ntry, wf4(:,5), ex7, wf8(:,9), n3(:,49), t3x8(:,:,5))
  call prop_A_Q(ntry, wf8(:,9), Q(:,82), ZERO, 0_intkind1, wf8(:,10), n2(23))
  call vert_VQ_A(ntry, ex6, wf18(:,8), wf36(:,4), n3(:,50), t3x36(:,:,4))
  call vert_AV_Q(ntry, wf12(:,14), ex7, wf24(:,13), n3(:,51), t3x24(:,:,13))
  call vert_WQ_A(ntry, ex4, wf12(:,6), wf36(:,5), n3(:,52), t3x36(:,:,5))
  call vert_AV_Q(ntry, wf12(:,14), ex6, wf24(:,14), n3(:,53), t3x24(:,:,14))
  call vert_AW_Q(ntry, wf8(:,8), ex4, wf24(:,15), n3(:,54), t3x24(:,:,15))
  call vert_AV_Q(ntry, ex2, ex6, wf4(:,6), n3(:,55), t3x4(:,:,5))
  call prop_A_Q(ntry, wf4(:,6), Q(:,34), ZERO, 0_intkind1, wf4(:,7), n2(24))
  call vert_AV_Q(ntry, wf4(:,7), wf4(:,2), wf16(:,14), n3(:,56), t3x16(:,:,8))
  call vert_AW_Q(ntry, wf4(:,7), ex4, wf12(:,15), n3(:,57), t3x12(:,:,8))
  call prop_A_Q(ntry, wf12(:,15), Q(:,42), ZERO, 0_intkind1, wf12(:,16), n2(25))
  call vert_AV_Q(ntry, wf4(:,7), ex5, wf8(:,11), n3(:,58), t3x8(:,:,6))
  call prop_A_Q(ntry, wf8(:,11), Q(:,50), ZERO, 0_intkind1, wf8(:,12), n2(26))
  call vert_AV_Q(ntry, wf4(:,7), ex7, wf8(:,13), n3(:,59), t3x8(:,:,7))
  call prop_A_Q(ntry, wf8(:,13), Q(:,98), ZERO, 0_intkind1, wf8(:,14), n2(27))
  call vert_VQ_A(ntry, ex5, wf18(:,8), wf36(:,6), n3(:,60), t3x36(:,:,6))
  call vert_AV_Q(ntry, wf12(:,16), ex7, wf24(:,16), n3(:,61), t3x24(:,:,16))
  call vert_WQ_A(ntry, ex4, wf12(:,10), wf36(:,7), n3(:,62), t3x36(:,:,7))
  call vert_AV_Q(ntry, wf12(:,16), ex5, wf24(:,17), n3(:,63), t3x24(:,:,17))
  call vert_AW_Q(ntry, wf8(:,12), ex4, wf24(:,18), n3(:,64), t3x24(:,:,18))
  call vert_AV_Q(ntry, ex2, ex7, wf4(:,8), n3(:,65), t3x4(:,:,6))
  call prop_A_Q(ntry, wf4(:,8), Q(:,66), ZERO, 0_intkind1, wf4(:,9), n2(28))
  call vert_AV_Q(ntry, wf4(:,9), wf4(:,1), wf16(:,15), n3(:,66), t3x16(:,:,9))
  call vert_AW_Q(ntry, wf4(:,9), ex4, wf12(:,17), n3(:,67), t3x12(:,:,9))
  call prop_A_Q(ntry, wf12(:,17), Q(:,74), ZERO, 0_intkind1, wf12(:,18), n2(29))
  call vert_QA_V(ntry, wf18(:,8), ex2, wf36(:,8), n3(:,68), t3x36(:,:,8))
  call vert_AV_Q(ntry, ex2, wf4(:,1), wf8(:,15), n3(:,69), t3x8(:,:,8))
  call prop_A_Q(ntry, wf8(:,15), Q(:,50), ZERO, 0_intkind1, wf8(:,16), n2(30))
  call vert_AV_Q(ntry, wf8(:,16), ex7, wf16(:,16), n3(:,70), t3x16(:,:,10))
  call vert_AW_Q(ntry, wf8(:,16), ex4, wf24(:,19), n3(:,71), t3x24(:,:,19))
  call vert_AV_Q(ntry, wf4(:,9), ex5, wf8(:,17), n3(:,72), t3x8(:,:,9))
  call prop_A_Q(ntry, wf8(:,17), Q(:,82), ZERO, 0_intkind1, wf8(:,18), n2(31))
  call vert_AV_Q(ntry, wf4(:,9), ex6, wf8(:,19), n3(:,73), t3x8(:,:,10))
  call prop_A_Q(ntry, wf8(:,19), Q(:,98), ZERO, 0_intkind1, wf8(:,20), n2(32))
  call vert_AV_Q(ntry, wf12(:,18), ex6, wf24(:,20), n3(:,74), t3x24(:,:,20))
  call vert_AV_Q(ntry, wf12(:,18), ex5, wf24(:,21), n3(:,75), t3x24(:,:,21))
  call vert_AW_Q(ntry, wf8(:,18), ex4, wf24(:,22), n3(:,76), t3x24(:,:,22))
  call vert_AV_Q(ntry, ex2, wf4(:,2), wf8(:,21), n3(:,77), t3x8(:,:,11))
  call prop_A_Q(ntry, wf8(:,21), Q(:,82), ZERO, 0_intkind1, wf8(:,22), n2(33))
  call vert_AV_Q(ntry, wf8(:,22), ex6, wf16(:,17), n3(:,78), t3x16(:,:,11))
  call vert_AW_Q(ntry, wf8(:,22), ex4, wf24(:,23), n3(:,79), t3x24(:,:,23))
  call vert_AV_Q(ntry, ex2, wf4(:,3), wf8(:,23), n3(:,80), t3x8(:,:,12))
  call prop_A_Q(ntry, wf8(:,23), Q(:,98), ZERO, 0_intkind1, wf8(:,24), n2(34))
  call vert_AV_Q(ntry, wf8(:,24), ex5, wf16(:,18), n3(:,81), t3x16(:,:,12))
  call vert_AW_Q(ntry, wf8(:,24), ex4, wf24(:,24), n3(:,82), t3x24(:,:,24))
  call vert_VQ_A(ntry, ex7, wf6(:,7), wf12(:,19), n3(:,83), t3x12(:,:,10))
  call vert_AV_Q(ntry, wf6(:,8), wf4(:,1), wf24(:,25), n3(:,84), t3x24(:,:,25))
  call prop_Q_A(ntry, wf12(:,19), Q(:,73), ZERO, 0_intkind1, wf12(:,20), n2(35))
  call vert_AV_Q(ntry, wf6(:,8), ex7, wf12(:,21), n3(:,85), t3x12(:,:,11))
  call vert_VQ_A(ntry, wf4(:,1), wf6(:,7), wf24(:,26), n3(:,86), t3x24(:,:,26))
  call prop_A_Q(ntry, wf12(:,21), Q(:,70), ZERO, 0_intkind1, wf12(:,22), n2(36))
  ...
  call prop_Q_A(ntry, wf4(:,10), Q(:,17), ZERO, 0_intkind1, wf4(:,11), n2(41))
  call vert_WQ_A(ntry, ex4, wf4(:,11), wf12(:,31), n3(:,102), t3x12(:,:,16))
  call prop_Q_A(ntry, wf12(:,31), Q(:,25), ZERO, 0_intkind1, wf12(:,32), n2(42))
  call vert_VQ_A(ntry, wf4(:,3), wf4(:,11), wf16(:,19), n3(:,103), t3x16(:,:,13))
  call prop_A_Q(ntry, wf18(:,2), Q(:,14), ZERO, 0_intkind1, wf18(:,9), n2(43))
  ...
  call prop_Q_A(ntry, wf8(:,25), Q(:,49), ZERO, 0_intkind1, wf8(:,26), n2(44))
  call vert_AV_Q(ntry, wf18(:,9), ex7, wf36(:,9), n3(:,107), t3x36(:,:,9))
  call vert_WQ_A(ntry, ex4, wf8(:,26), wf24(:,39), n3(:,108), t3x24(:,:,39))
  call vert_VQ_A(ntry, ex7, wf4(:,11), wf8(:,27), n3(:,109), t3x8(:,:,14))
  call prop_Q_A(ntry, wf8(:,27), Q(:,81), ZERO, 0_intkind1, wf8(:,28), n2(45))
  call vert_AV_Q(ntry, wf18(:,9), ex6, wf36(:,10), n3(:,110), t3x36(:,:,10))
  call vert_AW_Q(ntry, wf12(:,26), ex4, wf36(:,11), n3(:,111), t3x36(:,:,11))
  call vert_VQ_A(ntry, ex6, ex1, wf4(:,12), n3(:,112), t3x4(:,:,8))
  call prop_Q_A(ntry, wf4(:,12), Q(:,33), ZERO, 0_intkind1, wf4(:,13), n2(46))
  call vert_WQ_A(ntry, ex4, wf4(:,13), wf12(:,33), n3(:,113), t3x12(:,:,17))
  ...
  call prop_Q_A(ntry, wf8(:,29), Q(:,49), ZERO, 0_intkind1, wf8(:,30), n2(48))
  call vert_WQ_A(ntry, ex4, wf8(:,30), wf24(:,42), n3(:,118), t3x24(:,:,42))
  call vert_VQ_A(ntry, ex7, wf4(:,13), wf8(:,31), n3(:,119), t3x8(:,:,16))
  call prop_Q_A(ntry, wf8(:,31), Q(:,97), ZERO, 0_intkind1, wf8(:,32), n2(49))
  call vert_AV_Q(ntry, wf18(:,9), ex5, wf36(:,12), n3(:,120), t3x36(:,:,12))
  call vert_AW_Q(ntry, wf12(:,30), ex4, wf36(:,13), n3(:,121), t3x36(:,:,13))
  call vert_VQ_A(ntry, ex7, ex1, wf4(:,14), n3(:,122), t3x4(:,:,9))
  call prop_Q_A(ntry, wf4(:,14), Q(:,65), ZERO, 0_intkind1, wf4(:,15), n2(50))
  call vert_WQ_A(ntry, ex4, wf4(:,15), wf12(:,35), n3(:,123), t3x12(:,:,18))
  call prop_Q_A(ntry, wf12(:,35), Q(:,73), ZERO, 0_intkind1, wf12(:,36), n2(51))
  call vert_VQ_A(ntry, wf4(:,1), wf4(:,15), wf16(:,21), n3(:,124), t3x16(:,:,15))
  call vert_VQ_A(ntry, wf4(:,1), ex1, wf8(:,33), n3(:,125), t3x8(:,:,17))
  call prop_Q_A(ntry, wf8(:,33), Q(:,49), ZERO, 0_intkind1, wf8(:,34), n2(52))
  call vert_WQ_A(ntry, ex4, wf8(:,34), wf24(:,43), n3(:,126), t3x24(:,:,43))
  ...
  call prop_Q_A(ntry, wf8(:,35), Q(:,81), ZERO, 0_intkind1, wf8(:,36), n2(53))
  call vert_WQ_A(ntry, ex4, wf8(:,36), wf24(:,46), n3(:,132), t3x24(:,:,46))
  call vert_VQ_A(ntry, ex6, wf4(:,15), wf8(:,37), n3(:,133), t3x8(:,:,19))
  call prop_Q_A(ntry, wf8(:,37), Q(:,97), ZERO, 0_intkind1, wf8(:,38), n2(54))
  call vert_VQ_A(ntry, wf4(:,2), ex1, wf8(:,39), n3(:,134), t3x8(:,:,20))
  call prop_Q_A(ntry, wf8(:,39), Q(:,81), ZERO, 0_intkind1, wf8(:,40), n2(55))
  call vert_WQ_A(ntry, ex4, wf8(:,40), wf24(:,47), n3(:,135), t3x24(:,:,47))
  call vert_VQ_A(ntry, ex6, wf8(:,40), wf16(:,23), n3(:,136), t3x16(:,:,17))
  call vert_VQ_A(ntry, wf4(:,3), ex1, wf8(:,41), n3(:,137), t3x8(:,:,21))
  call prop_Q_A(ntry, wf8(:,41), Q(:,97), ZERO, 0_intkind1, wf8(:,42), n2(56))
  call vert_WQ_A(ntry, ex4, wf8(:,42), wf24(:,48), n3(:,138), t3x24(:,:,48))
  call vert_VQ_A(ntry, ex5, wf8(:,42), wf16(:,24), n3(:,139), t3x16(:,:,18))
  call prop_Q_A(ntry, wf18(:,3), Q(:,13), ZERO, 0_intkind1, wf18(:,10), n2(57))
  call vert_AZ_Q(gZd,ntry, wf4(:,5), ex3, wf12(:,37), n3(:,140), t3x12(:,:,19))
  call prop_A_Q(ntry, wf12(:,37), Q(:,22), ZERO, 0_intkind1, wf12(:,38), n2(58))
  ...
  call prop_A_Q(ntry, wf12(:,39), Q(:,38), ZERO, 0_intkind1, wf12(:,40), n2(59))
  ...
  call prop_A_Q(ntry, wf12(:,41), Q(:,70), ZERO, 0_intkind1, wf12(:,42), n2(60))
  ...
  call vert_ZQ_A(gZu,ntry, ex3, wf4(:,11), wf12(:,43), n3(:,161), t3x12(:,:,22))
  call prop_Q_A(ntry, wf12(:,43), Q(:,21), ZERO, 0_intkind1, wf12(:,44), n2(61))
  call prop_A_Q(ntry, wf18(:,4), Q(:,14), ZERO, 0_intkind1, wf18(:,11), n2(62))
  ...
  call vert_ZQ_A(gZu,ntry, ex3, wf8(:,26), wf24(:,63), n3(:,165), t3x24(:,:,63))
  call vert_AV_Q(ntry, wf18(:,11), ex6, wf36(:,22), n3(:,166), t3x36(:,:,22))
  call vert_AZ_Q(gZu,ntry, wf12(:,8), ex3, wf36(:,23), n3(:,167), t3x36(:,:,23))
  call vert_ZQ_A(gZu,ntry, ex3, wf4(:,13), wf12(:,45), n3(:,168), t3x12(:,:,23))
  call prop_Q_A(ntry, wf12(:,45), Q(:,37), ZERO, 0_intkind1, wf12(:,46), n2(63))
  call vert_VQ_A(ntry, ex7, wf12(:,46), wf24(:,64), n3(:,169), t3x24(:,:,64))
  call vert_VQ_A(ntry, ex5, wf12(:,46), wf24(:,65), n3(:,170), t3x24(:,:,65))
  call vert_ZQ_A(gZu,ntry, ex3, wf8(:,30), wf24(:,66), n3(:,171), t3x24(:,:,66))
  call vert_AV_Q(ntry, wf18(:,11), ex5, wf36(:,24), n3(:,172), t3x36(:,:,24))
  call vert_AZ_Q(gZu,ntry, wf12(:,12), ex3, wf36(:,25), n3(:,173), t3x36(:,:,25))
  call vert_ZQ_A(gZu,ntry, ex3, wf4(:,15), wf12(:,47), n3(:,174), t3x12(:,:,24))
  call prop_Q_A(ntry, wf12(:,47), Q(:,69), ZERO, 0_intkind1, wf12(:,48), n2(64))
  call vert_ZQ_A(gZu,ntry, ex3, wf8(:,34), wf24(:,67), n3(:,175), t3x24(:,:,67))
  ...
  call vert_ZQ_A(gZu,ntry, ex3, wf8(:,36), wf24(:,70), n3(:,179), t3x24(:,:,70))
  call vert_ZQ_A(gZu,ntry, ex3, wf8(:,40), wf24(:,71), n3(:,180), t3x24(:,:,71))
  call vert_ZQ_A(gZu,ntry, ex3, wf8(:,42), wf24(:,72), n3(:,181), t3x24(:,:,72))
  call vert_AW_Q(ntry, wf4(:,7), wf9(:,2), wf36(:,27), n3(:,182), t3x36(:,:,27))
  call vert_WQ_A(ntry, wf9(:,2), wf4(:,11), wf36(:,28), n3(:,183), t3x36(:,:,28))
  call vert_AW_Q(ntry, wf4(:,9), wf9(:,2), wf36(:,29), n3(:,184), t3x36(:,:,29))
  call prop_A_Q(ntry, wf18(:,7), Q(:,14), ZERO, 0_intkind1, wf18(:,12), n2(65))
  call vert_AV_Q(ntry, wf18(:,12), ex7, wf36(:,30), n3(:,185), t3x36(:,:,30))
  call vert_AV_Q(ntry, wf18(:,12), ex6, wf36(:,31), n3(:,186), t3x36(:,:,31))
  call vert_AW_Q(ntry, wf4(:,5), wf9(:,2), wf36(:,32), n3(:,187), t3x36(:,:,32))
  call vert_WQ_A(ntry, wf9(:,2), wf4(:,13), wf36(:,33), n3(:,188), t3x36(:,:,33))
  call vert_WQ_A(ntry, wf9(:,2), wf4(:,15), wf36(:,34), n3(:,189), t3x36(:,:,34))
  ...
  call vert_WQ_A(ntry, ex4, wf12(:,44), wf36(:,41), n3(:,196), t3x36(:,:,41))
  call vert_ZQ_A(gZd,ntry, ex3, wf12(:,32), wf36(:,42), n3(:,197), t3x36(:,:,42))
  call vert_AW_Q(ntry, wf12(:,40), ex4, wf36(:,43), n3(:,198), t3x36(:,:,43))
  call vert_AZ_Q(gZu,ntry, wf12(:,16), ex3, wf36(:,44), n3(:,199), t3x36(:,:,44))
  call vert_AW_Q(ntry, wf12(:,42), ex4, wf36(:,45), n3(:,200), t3x36(:,:,45))
  call vert_AZ_Q(gZu,ntry, wf12(:,18), ex3, wf36(:,46), n3(:,201), t3x36(:,:,46))
  call vert_WQ_A(ntry, ex4, wf12(:,46), wf36(:,47), n3(:,202), t3x36(:,:,47))
  call vert_ZQ_A(gZd,ntry, ex3, wf12(:,34), wf36(:,48), n3(:,203), t3x36(:,:,48))
  call vert_AW_Q(ntry, wf12(:,38), ex4, wf36(:,49), n3(:,204), t3x36(:,:,49))
  call vert_AZ_Q(gZu,ntry, wf12(:,14), ex3, wf36(:,50), n3(:,205), t3x36(:,:,50))
  call vert_WQ_A(ntry, ex4, wf12(:,48), wf36(:,51), n3(:,206), t3x36(:,:,51))
  ...
  M2add = M2 / average_factor_ppzwjj_udxzwggg_1

  do k = 0, 30-1
    M2(k) = M2add(extcomb_perm_ppzwjj_udxzwggg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppzwjj_udxzwggg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppzwjj_udxzwggg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppzwjj_udxzwggg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppzwjj_udxzwggg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppzwjj_udxzwggg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppzwjj_udxzwggg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppzwjj_udxzwggg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppzwjj_udxzwggg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppzwjj_udxzwggg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppzwjj_udxzwggg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppzwjj_udxzwggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppzwjj_udxzwggg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppzwjj_udxzwggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppzwjj_udxzwggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppzwjj_udxzwggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(0:30-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppzwjj_udxzwggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppzwjj_udxzwggg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,7)
  real(c_double), intent(out) :: m2(7)
...
end module ol_tree_ppzwjj_udxzwggg_1_/**/REALKIND
