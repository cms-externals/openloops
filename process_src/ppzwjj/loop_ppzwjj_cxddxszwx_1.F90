...
module ol_colourmatrix_ppzwjj_cxddxszwx_1_/**/REALKIND
...
end module ol_colourmatrix_ppzwjj_cxddxszwx_1_/**/REALKIND



module ol_forced_parameters_ppzwjj_cxddxszwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzwjj_cxddxszwx_1_/**/REALKIND

module ol_loop_ppzwjj_cxddxszwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,-4),wf(:,-1),wf(:,25))
  ...
  call vert_AZ_Q(gZd,wf(:,-2),wf(:,-4),wf(:,30))
  ...
  call counter_VQ_A(wf(:,2),wf(:,-3),wf(:,40))
  call prop_A_Q(wf(:,8),Q(:,49),ZERO,0_intkind1,wf(:,41))
  call counter_WQ_A(wf(:,-5),wf(:,-3),wf(:,42))
  call prop_Q_A(wf(:,42),Q(:,40),ZERO,0_intkind1,wf(:,43))
  call prop_A_Q(wf(:,18),Q(:,49),ZERO,0_intkind1,wf(:,44))
  ...
  call counter_QA_V(wf(:,-3),wf(:,12),wf(:,50))
  call vert_QA_V(wf(:,43),wf(:,0),wf(:,51))
  call counter_QA_V(wf(:,26),wf(:,-2),wf(:,52))
  call counter_AZ_Q(gZd,wf(:,-2),wf(:,-4),wf(:,53))
  call prop_A_Q(wf(:,53),Q(:,20),ZERO,0_intkind1,wf(:,54))
  call vert_QA_V(wf(:,-1),wf(:,54),wf(:,55))
  call counter_QA_V(wf(:,-1),wf(:,31),wf(:,56))
  call counter_ZQ_A(gZd,wf(:,-4),wf(:,-1),wf(:,57))
  call prop_Q_A(wf(:,57),Q(:,18),ZERO,0_intkind1,wf(:,58))
  call vert_QA_V(wf(:,58),wf(:,-2),wf(:,59))
  call counter_QA_V(wf(:,-1),wf(:,-2),wf(:,60))
  call vert_AV_Q(wf(:,4),wf(:,60),wf(:,61))
  call vert_VQ_A(wf(:,60),wf(:,-3),wf(:,62))
  call prop_Q_A(wf(:,62),Q(:,14),ZERO,0_intkind1,wf(:,63))
  call vert_AV_Q(wf(:,12),wf(:,60),wf(:,64))
  call vert_AV_Q(wf(:,0),wf(:,60),wf(:,65))
  call prop_A_Q(wf(:,65),Q(:,7),ZERO,0_intkind1,wf(:,66))
  call counter_AV_Q(wf(:,0),wf(:,2),wf(:,67))
  ...
  call vert_AV_Q(wf(:,70),wf(:,2),wf(:,71))
  ...
  call vert_QA_V(wf(:,-3),wf(:,70),wf(:,81))
  call vert_VQ_A(wf(:,2),wf(:,5),wf(:,82))
  call counter_A_Q(ctcc,wf(:,4),Q(:,17),wf(:,83))
  call prop_Q_A(wf(:,82),Q(:,46),ZERO,0_intkind1,wf(:,84))
  call vert_QA_V(wf(:,5),wf(:,4),wf(:,85))
  ...
  call vert_QA_V(wf(:,-3),wf(:,103),wf(:,108))
  call counter_Q_A(ctqq,wf(:,26),Q(:,18),wf(:,109))
  ...
  call vert_QA_V(wf(:,105),wf(:,0),wf(:,114))
  call counter_A_Q(ctqq,wf(:,31),Q(:,20),wf(:,115))
  call prop_A_Q(wf(:,115),Q(:,20),ZERO,0_intkind1,wf(:,116))
  call vert_QA_V(wf(:,-1),wf(:,116),wf(:,117))
  call counter_V_V(ctGG,wf(:,32),Q(:,22),wf(:,118))
  call vert_AZ_Q(gZu,wf(:,17),wf(:,-4),wf(:,119))
  call prop_A_Q(wf(:,119),Q(:,23),ZERO,0_intkind1,wf(:,120))
  call vert_AW_Q(wf(:,17),wf(:,-5),wf(:,121))
  call prop_A_Q(wf(:,121),Q(:,39),ZERO,0_intkind1,wf(:,122))
  call vert_ZQ_A(gZd,wf(:,-4),wf(:,9),wf(:,123))
  call prop_Q_A(wf(:,123),Q(:,30),ZERO,0_intkind1,wf(:,124))
  call vert_WQ_A(wf(:,-5),wf(:,9),wf(:,125))
  call prop_Q_A(wf(:,125),Q(:,46),ZERO,0_intkind1,wf(:,126))
  call vert_QA_V(wf(:,-3),wf(:,41),wf(:,127))
  call vert_AV_Q(wf(:,0),wf(:,27),wf(:,128))
  call prop_A_Q(wf(:,128),Q(:,23),ZERO,0_intkind1,wf(:,129))
  call vert_VQ_A(wf(:,27),wf(:,-3),wf(:,130))
  call prop_Q_A(wf(:,130),Q(:,30),ZERO,0_intkind1,wf(:,131))
  call vert_AV_Q(wf(:,0),wf(:,32),wf(:,132))
  call prop_A_Q(wf(:,132),Q(:,23),ZERO,0_intkind1,wf(:,133))
  call vert_VQ_A(wf(:,32),wf(:,-3),wf(:,134))
  call prop_Q_A(wf(:,134),Q(:,30),ZERO,0_intkind1,wf(:,135))
  call vert_QA_V(wf(:,68),wf(:,0),wf(:,136))
  ...
  call vert_QA_V(wf(:,-3),wf(:,44),wf(:,141))
  ...
  call vert_QA_V(wf(:,-3),wf(:,24),wf(:,147))
  call vert_QA_V(wf(:,73),wf(:,0),wf(:,148))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(79)-A(80)-A(81)-A(82))*f(2))/6._/**/REALKIND+(A(52)*f(3))/6._/**/REALKIND+((A(25)+A(47) &
       +A(48))*f(4))/6._/**/REALKIND+((A(24)+A(53))*f(5))/6._/**/REALKIND+((-A(61)-A(62)-A(63)-A(64)-A(65)-A(66)-A(67)-A(68)-A(69) &
       -A(70)-A(71)-A(72)-A(73)-A(74)-A(75)-A(76)-A(77)-A(78)-A(83)-A(84)-A(85)-A(86)-A(87)-A(88)-A(89)-A(90)-A(91)-A(92)-A(93) &
       -A(94))*f(7))/6._/**/REALKIND+((A(13)+A(49)+A(51)+A(57)+A(59))*f(8))/6._/**/REALKIND+((A(15)+A(21)+A(23)+A(29)+A(31)+A(33) &
       +A(34)+A(37)+A(38)+A(41)+A(42)+A(43)+A(44)+A(45)+A(46))*f(9))/6._/**/REALKIND+((A(19)+A(55)+A(56))*f(10))/6._/**/REALKIND &
       +((A(14)+A(16)+A(18)+A(22)+A(26)+A(27)+A(28)+A(30)+A(32)+A(35)+A(36)+A(39)+A(40)+A(50)+A(54)+A(58) &
       +A(60))*f(11))/6._/**/REALKIND+((-A(17)-A(20))*f(12))/6._/**/REALKIND
  M2(2) = ((A(79)+A(80)+A(81)+A(82))*f(2))/2._/**/REALKIND-(A(52)*f(3))/2._/**/REALKIND+((-A(25)-A(47) &
       -A(48))*f(4))/2._/**/REALKIND+((-A(24)-A(53))*f(5))/2._/**/REALKIND+((A(61)+A(62)+A(63)+A(64)+A(65)+A(66)+A(67)+A(68)+A(69) &
       +A(70)+A(71)+A(72)+A(73)+A(74)+A(75)+A(76)+A(77)+A(78)+A(83)+A(84)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90)+A(91)+A(92)+A(93) &
       +A(94))*f(7))/2._/**/REALKIND+((-A(13)-A(49)-A(51)-A(57)-A(59))*f(8))/2._/**/REALKIND+((-A(15)-A(21)-A(23)-A(29)-A(31) &
       -A(33)-A(34)-A(37)-A(38)-A(41)-A(42)-A(43)-A(44)-A(45)-A(46))*f(9))/2._/**/REALKIND+((-A(19)-A(55) &
       -A(56))*f(10))/2._/**/REALKIND+((-A(14)-A(16)-A(18)-A(22)-A(26)-A(27)-A(28)-A(30)-A(32)-A(35)-A(36)-A(39)-A(40)-A(50)-A(54) &
       -A(58)-A(60))*f(11))/2._/**/REALKIND+((A(17)+A(20))*f(12))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppzwjj_cxddxszwx_1_/**/REALKIND
