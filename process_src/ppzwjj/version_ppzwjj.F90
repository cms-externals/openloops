...
module ol_versiondata_ppzwjj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppzwjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzwjj
  end interface
end module ol_versiondata_ppzwjj


subroutine ol_version_ppzwjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzwjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzwjj
