...
module ol_colourmatrix_ppzwjj_uxccxdzwx_1_/**/REALKIND
...
end module ol_colourmatrix_ppzwjj_uxccxdzwx_1_/**/REALKIND



module ol_forced_parameters_ppzwjj_uxccxdzwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzwjj_uxccxdzwx_1_/**/REALKIND

module ol_loop_ppzwjj_uxccxdzwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_Q_A(ctqq,wf(:,5),Q(:,40),wf(:,87))
  ...
  call counter_A_Q(ctqq,wf(:,17),Q(:,7),wf(:,100))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(79)-A(80)-A(81)-A(82))*f(2))/6._/**/REALKIND+((A(47)+A(48))*f(3))/6._/**/REALKIND+((A(25) &
       ...
       -A(94))*f(7))/6._/**/REALKIND+((A(33)+A(34)+A(37)+A(38)+A(41)+A(42)+A(43)+A(44)+A(45)+A(46))*f(8))/6._/**/REALKIND+((A(13) &
       +A(15)+A(21)+A(23)+A(29)+A(31)+A(49)+A(51)+A(57)+A(59))*f(9))/6._/**/REALKIND+((A(35)+A(36)+A(39) &
  ...
  M2(2) = ((A(79)+A(80)+A(81)+A(82))*f(2))/2._/**/REALKIND+((-A(47)-A(48))*f(3))/2._/**/REALKIND+((-A(25) &
       ...
       +A(70)+A(71)+A(72)+A(73)+A(74)+A(75)+A(76)+A(77)+A(78)+A(83)+A(84)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90)+A(91)+A(92)+A(93) &
       +A(94))*f(7))/2._/**/REALKIND+((-A(33)-A(34)-A(37)-A(38)-A(41)-A(42)-A(43)-A(44)-A(45)-A(46))*f(8))/2._/**/REALKIND+(( &
       -A(13)-A(15)-A(21)-A(23)-A(29)-A(31)-A(49)-A(51)-A(57)-A(59))*f(9))/2._/**/REALKIND+((-A(35)-A(36)-A(39) &
...
end module ol_loop_ppzwjj_uxccxdzwx_1_/**/REALKIND
