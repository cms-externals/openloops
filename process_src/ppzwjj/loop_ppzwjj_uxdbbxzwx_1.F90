...
module ol_colourmatrix_ppzwjj_uxdbbxzwx_1_/**/REALKIND
...
end module ol_colourmatrix_ppzwjj_uxdbbxzwx_1_/**/REALKIND



module ol_forced_parameters_ppzwjj_uxdbbxzwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzwjj_uxdbbxzwx_1_/**/REALKIND

module ol_loop_ppzwjj_uxdbbxzwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*ctGbb*cw*eQED**2*gQCD**4)/(sqrt2*sw**2)
    ...
    f( 8) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/(sqrt2*sw)
    f( 9) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/(sqrt2*sw)
    f(10) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**4)/(sqrt2*sw)
...
! **********************************************************************
  ...
  call vert_WQ_A(wf(:,21),wf(:,-1),wf(:,22))
  ...
  call vert_QA_V(wf(:,-1),wf(:,12),wf(:,27))
  call vert_QA_V(wf(:,26),wf(:,-3),wf(:,28))
  call vert_QA_V(wf(:,5),wf(:,0),wf(:,29))
  call vert_AZ_Q(gZd,wf(:,-3),wf(:,-4),wf(:,30))
  call prop_A_Q(wf(:,30),Q(:,24),MB,1_intkind1,wf(:,31))
  call vert_QA_V(wf(:,-2),wf(:,31),wf(:,32))
  call counter_QA_V(wf(:,5),wf(:,4),wf(:,33))
  call counter_AW_Q(wf(:,4),wf(:,-5),wf(:,34))
  call counter_QA_V(wf(:,13),wf(:,12),wf(:,35))
  call counter_WQ_A(wf(:,-5),wf(:,13),wf(:,36))
  call counter_VG_G(wf(:,-4),wf(:,3),Q(:,12),wf(:,37),Q(:,28))
  call counter_AZ_Q(gZd,wf(:,12),wf(:,-4),wf(:,38))
  call counter_ZQ_A(gZu,wf(:,-4),wf(:,5),wf(:,39))
  call counter_QA_V(wf(:,26),wf(:,-3),wf(:,40))
  call counter_AZ_Q(gZd,wf(:,-3),wf(:,-4),wf(:,41))
  call prop_A_Q(wf(:,41),Q(:,24),MB,1_intkind1,wf(:,42))
  call vert_QA_V(wf(:,-2),wf(:,42),wf(:,43))
  call counter_QA_V(wf(:,-2),wf(:,31),wf(:,44))
  call counter_ZQ_A(gZd,wf(:,-4),wf(:,-2),wf(:,45))
  call prop_Q_A(wf(:,45),Q(:,20),MB,1_intkind1,wf(:,46))
  call vert_QA_V(wf(:,46),wf(:,-3),wf(:,47))
  call counter_QA_V(wf(:,-2),wf(:,-3),wf(:,48))
  call vert_VQ_A(wf(:,48),wf(:,-1),wf(:,49))
  call prop_Q_A(wf(:,49),Q(:,14),ZERO,0_intkind1,wf(:,50))
  call vert_AV_Q(wf(:,0),wf(:,48),wf(:,51))
  call prop_A_Q(wf(:,51),Q(:,13),ZERO,0_intkind1,wf(:,52))
  call counter_VQ_A(wf(:,3),wf(:,-1),wf(:,53))
  call prop_A_Q(wf(:,8),Q(:,49),ZERO,0_intkind1,wf(:,54))
  call counter_WQ_A(wf(:,-5),wf(:,-1),wf(:,55))
  call prop_Q_A(wf(:,55),Q(:,34),ZERO,0_intkind1,wf(:,56))
  call vert_QA_V(wf(:,56),wf(:,4),wf(:,57))
  call prop_A_Q(wf(:,18),Q(:,49),ZERO,0_intkind1,wf(:,58))
  call counter_WQ_A(wf(:,21),wf(:,-1),wf(:,59))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,56),wf(:,60))
  call counter_ZQ_A(gZd,wf(:,-4),wf(:,-1),wf(:,61))
  call prop_Q_A(wf(:,61),Q(:,18),ZERO,0_intkind1,wf(:,62))
  call vert_QA_V(wf(:,62),wf(:,12),wf(:,63))
  call vert_WQ_A(wf(:,-5),wf(:,62),wf(:,64))
  call counter_QA_V(wf(:,-1),wf(:,12),wf(:,65))
  call vert_QA_V(wf(:,56),wf(:,0),wf(:,66))
  call counter_AV_Q(wf(:,0),wf(:,3),wf(:,67))
  call prop_Q_A(wf(:,16),Q(:,50),ZERO,0_intkind1,wf(:,68))
  call counter_AW_Q(wf(:,0),wf(:,-5),wf(:,69))
  call prop_A_Q(wf(:,69),Q(:,33),ZERO,0_intkind1,wf(:,70))
  call vert_QA_V(wf(:,13),wf(:,70),wf(:,71))
  call prop_Q_A(wf(:,19),Q(:,50),ZERO,0_intkind1,wf(:,72))
  call prop_Q_A(wf(:,22),Q(:,50),ZERO,0_intkind1,wf(:,73))
  call counter_AW_Q(wf(:,0),wf(:,21),wf(:,74))
  call vert_AZ_Q(gZd,wf(:,70),wf(:,-4),wf(:,75))
  call counter_AZ_Q(gZu,wf(:,0),wf(:,-4),wf(:,76))
  call prop_A_Q(wf(:,76),Q(:,17),ZERO,0_intkind1,wf(:,77))
  call vert_QA_V(wf(:,5),wf(:,77),wf(:,78))
  call vert_AW_Q(wf(:,77),wf(:,-5),wf(:,79))
  call counter_QA_V(wf(:,5),wf(:,0),wf(:,80))
  call vert_QA_V(wf(:,-1),wf(:,70),wf(:,81))
  call vert_VQ_A(wf(:,3),wf(:,5),wf(:,82))
  call counter_A_Q(ctqq,wf(:,4),Q(:,17),wf(:,83))
  call prop_Q_A(wf(:,82),Q(:,46),ZERO,0_intkind1,wf(:,84))
  call vert_AV_Q(wf(:,4),wf(:,3),wf(:,85))
  call counter_Q_A(ctqq,wf(:,5),Q(:,34),wf(:,86))
  call prop_A_Q(wf(:,85),Q(:,29),ZERO,0_intkind1,wf(:,87))
  call counter_V_V(ctGG,wf(:,3),Q(:,12),wf(:,88))
  call prop_A_Q(wf(:,83),Q(:,17),ZERO,0_intkind1,wf(:,89))
  call vert_AW_Q(wf(:,89),wf(:,-5),wf(:,90))
  call vert_VQ_A(wf(:,88),wf(:,-1),wf(:,91))
  call counter_Q_A(ctqq,wf(:,9),Q(:,14),wf(:,92))
  call vert_VQ_A(wf(:,3),wf(:,13),wf(:,93))
  call counter_A_Q(ctqq,wf(:,12),Q(:,33),wf(:,94))
  call prop_Q_A(wf(:,93),Q(:,30),ZERO,0_intkind1,wf(:,95))
  call vert_AV_Q(wf(:,12),wf(:,3),wf(:,96))
  call counter_Q_A(ctqq,wf(:,13),Q(:,18),wf(:,97))
  call prop_A_Q(wf(:,96),Q(:,45),ZERO,0_intkind1,wf(:,98))
  call vert_AV_Q(wf(:,0),wf(:,88),wf(:,99))
  call counter_A_Q(ctqq,wf(:,17),Q(:,13),wf(:,100))
  call prop_Q_A(wf(:,97),Q(:,18),ZERO,0_intkind1,wf(:,101))
  call vert_WQ_A(wf(:,-5),wf(:,101),wf(:,102))
  call prop_A_Q(wf(:,94),Q(:,33),ZERO,0_intkind1,wf(:,103))
  call vert_AZ_Q(gZd,wf(:,103),wf(:,-4),wf(:,104))
  call prop_Q_A(wf(:,86),Q(:,34),ZERO,0_intkind1,wf(:,105))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,105),wf(:,106))
  call counter_A_Q(ctqq,wf(:,24),Q(:,49),wf(:,107))
  call vert_QA_V(wf(:,-1),wf(:,103),wf(:,108))
  call counter_V_V(ctGG,wf(:,27),Q(:,35),wf(:,109))
  call counter_Q_A(ctbb,wf(:,26),Q(:,20),wf(:,110))
  call prop_Q_A(wf(:,110),Q(:,20),MB,1_intkind1,wf(:,111))
  call vert_QA_V(wf(:,111),wf(:,-3),wf(:,112))
  call vert_QA_V(wf(:,105),wf(:,0),wf(:,113))
  call counter_V_V(ctGG,wf(:,29),Q(:,35),wf(:,114))
  call counter_A_Q(ctbb,wf(:,31),Q(:,24),wf(:,115))
  call prop_A_Q(wf(:,115),Q(:,24),MB,1_intkind1,wf(:,116))
  call vert_QA_V(wf(:,-2),wf(:,116),wf(:,117))
  call vert_AZ_Q(gZu,wf(:,17),wf(:,-4),wf(:,118))
  call prop_A_Q(wf(:,118),Q(:,29),ZERO,0_intkind1,wf(:,119))
  call vert_AW_Q(wf(:,17),wf(:,-5),wf(:,120))
  call prop_A_Q(wf(:,120),Q(:,45),ZERO,0_intkind1,wf(:,121))
  ...
  call vert_QA_V(wf(:,-1),wf(:,54),wf(:,126))
  call vert_QA_V(wf(:,68),wf(:,0),wf(:,127))
  call vert_AV_Q(wf(:,0),wf(:,28),wf(:,128))
  call prop_A_Q(wf(:,128),Q(:,29),ZERO,0_intkind1,wf(:,129))
  call vert_VQ_A(wf(:,28),wf(:,-1),wf(:,130))
  call prop_Q_A(wf(:,130),Q(:,30),ZERO,0_intkind1,wf(:,131))
  call vert_AV_Q(wf(:,0),wf(:,32),wf(:,132))
  call prop_A_Q(wf(:,132),Q(:,29),ZERO,0_intkind1,wf(:,133))
  call vert_VQ_A(wf(:,32),wf(:,-1),wf(:,134))
  call prop_Q_A(wf(:,134),Q(:,30),ZERO,0_intkind1,wf(:,135))
  call vert_VQ_A(wf(:,27),wf(:,-2),wf(:,136))
  call prop_Q_A(wf(:,136),Q(:,39),MB,1_intkind1,wf(:,137))
  call vert_AV_Q(wf(:,-3),wf(:,27),wf(:,138))
  call prop_A_Q(wf(:,138),Q(:,43),MB,1_intkind1,wf(:,139))
  call vert_QA_V(wf(:,-1),wf(:,58),wf(:,140))
  ...
  call vert_QA_V(wf(:,72),wf(:,0),wf(:,145))
  call vert_QA_V(wf(:,-1),wf(:,24),wf(:,146))
  call vert_QA_V(wf(:,73),wf(:,0),wf(:,147))
...
subroutine denominators()
  ...
  den(70) = 1 / (Q(5,30))
  den(74) = 1 / (Q(5,45))
  den(119) = 1 / (Q(5,39) - MB2)
  den(121) = 1 / (Q(5,43) - MB2)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(79)+A(80)+A(81)+A(82))*f(2))/2._/**/REALKIND+((-A(35)-A(36))*f(3))/2._/**/REALKIND+((-A(41) &
       -A(52))*f(4))/2._/**/REALKIND+((-A(40)-A(53))*f(5))/2._/**/REALKIND+((A(61)+A(62)+A(63)+A(64)+A(65)+A(66)+A(67)+A(68)+A(69) &
       +A(70)+A(71)+A(72)+A(73)+A(74)+A(75)+A(76)+A(77)+A(78)+A(83)+A(84)+A(85)+A(86)+A(87)+A(88)+A(89)+A(90)+A(91)+A(92)+A(93) &
       +A(94))*f(7))/2._/**/REALKIND+((-A(21)-A(22)-A(25)-A(26)-A(29)-A(30)-A(31)-A(32)-A(33)-A(34))*f(8))/2._/**/REALKIND+(( &
       -A(13)-A(15)-A(37)-A(39)-A(45)-A(47)-A(49)-A(51)-A(57)-A(59))*f(9))/2._/**/REALKIND+((-A(23)-A(24)-A(27) &
       -A(28))*f(10))/2._/**/REALKIND+((-A(14)-A(16)-A(18)-A(20)-A(38)-A(42)-A(43)-A(44)-A(46)-A(48)-A(50)-A(54)-A(55)-A(56)-A(58) &
       -A(60))*f(11))/2._/**/REALKIND+((A(17)+A(19))*f(12))/2._/**/REALKIND
  M2(2) = ((-A(79)-A(80)-A(81)-A(82))*f(2))/6._/**/REALKIND+((A(35)+A(36))*f(3))/6._/**/REALKIND+((A(41) &
       +A(52))*f(4))/6._/**/REALKIND+((A(40)+A(53))*f(5))/6._/**/REALKIND+((-A(61)-A(62)-A(63)-A(64)-A(65)-A(66)-A(67)-A(68)-A(69) &
       -A(70)-A(71)-A(72)-A(73)-A(74)-A(75)-A(76)-A(77)-A(78)-A(83)-A(84)-A(85)-A(86)-A(87)-A(88)-A(89)-A(90)-A(91)-A(92)-A(93) &
       -A(94))*f(7))/6._/**/REALKIND+((A(21)+A(22)+A(25)+A(26)+A(29)+A(30)+A(31)+A(32)+A(33)+A(34))*f(8))/6._/**/REALKIND+((A(13) &
       +A(15)+A(37)+A(39)+A(45)+A(47)+A(49)+A(51)+A(57)+A(59))*f(9))/6._/**/REALKIND+((A(23)+A(24)+A(27) &
       +A(28))*f(10))/6._/**/REALKIND+((A(14)+A(16)+A(18)+A(20)+A(38)+A(42)+A(43)+A(44)+A(46)+A(48)+A(50)+A(54)+A(55)+A(56)+A(58) &
       +A(60))*f(11))/6._/**/REALKIND+((-A(17)-A(19))*f(12))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_ppzwjj_uxdbbxzwx_1_/**/REALKIND
