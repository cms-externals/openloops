...
module ol_colourmatrix_pplnajj_neexuuxcxsa_1_/**/REALKIND
...
end module ol_colourmatrix_pplnajj_neexuuxcxsa_1_/**/REALKIND



module ol_forced_parameters_pplnajj_neexuuxcxsa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnajj_neexuuxcxsa_1_/**/REALKIND

module ol_loop_pplnajj_neexuuxcxsa_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_VQ_A(wf(:,28),wf(:,-5),wf(:,29))
  call vert_AV_Q(wf(:,-4),wf(:,28),wf(:,30))
  call vert_AV_Q(wf(:,-3),wf(:,-6),wf(:,31))
  call prop_A_Q(wf(:,31),Q(:,72),ZERO,0_intkind1,wf(:,32))
  call vert_QA_V(wf(:,-2),wf(:,32),wf(:,33))
  call vert_VQ_A(wf(:,33),wf(:,-5),wf(:,34))
  call vert_AV_Q(wf(:,-4),wf(:,33),wf(:,35))
  call vert_AV_Q(wf(:,-1),wf(:,-6),wf(:,36))
  call prop_A_Q(wf(:,36),Q(:,66),ZERO,0_intkind1,wf(:,37))
  call vert_QA_W(wf(:,0),wf(:,37),wf(:,38))
  call prop_W_W(wf(:,38),Q(:,67),MW,1_intkind1,wf(:,39))
  call vert_AW_Q(wf(:,-4),wf(:,39),wf(:,40))
  call vert_WQ_A(wf(:,39),wf(:,-5),wf(:,41))
  call counter_AV_Q(wf(:,5),wf(:,2),wf(:,42))
  call counter_AW_Q(wf(:,5),wf(:,4),wf(:,43))
  call counter_VQ_A(wf(:,2),wf(:,13),wf(:,44))
  call counter_WQ_A(wf(:,4),wf(:,13),wf(:,45))
  call counter_AV_Q(wf(:,16),wf(:,-6),wf(:,46))
  call counter_AV_Q(wf(:,19),wf(:,-6),wf(:,47))
  call counter_VQ_A(wf(:,2),wf(:,-5),wf(:,48))
  call prop_A_Q(wf(:,10),Q(:,83),ZERO,0_intkind1,wf(:,49))
  call counter_WQ_A(wf(:,4),wf(:,-5),wf(:,50))
  call prop_A_Q(wf(:,7),Q(:,92),ZERO,0_intkind1,wf(:,51))
  call prop_Q_A(wf(:,48),Q(:,44),ZERO,0_intkind1,wf(:,52))
  call counter_QA_W(wf(:,-5),wf(:,19),wf(:,53))
  call vert_QA_W(wf(:,52),wf(:,-4),wf(:,54))
  call prop_Q_A(wf(:,50),Q(:,35),ZERO,0_intkind1,wf(:,55))
  call counter_VQ_A(wf(:,-6),wf(:,-5),wf(:,56))
  call prop_Q_A(wf(:,56),Q(:,96),ZERO,0_intkind1,wf(:,57))
  call vert_VQ_A(wf(:,2),wf(:,57),wf(:,58))
  call vert_WQ_A(wf(:,4),wf(:,57),wf(:,59))
  call counter_AV_Q(wf(:,-4),wf(:,2),wf(:,60))
  call prop_Q_A(wf(:,18),Q(:,99),ZERO,0_intkind1,wf(:,61))
  call counter_AW_Q(wf(:,-4),wf(:,4),wf(:,62))
  call prop_Q_A(wf(:,15),Q(:,108),ZERO,0_intkind1,wf(:,63))
  call prop_A_Q(wf(:,60),Q(:,28),ZERO,0_intkind1,wf(:,64))
  call vert_AV_Q(wf(:,64),wf(:,-6),wf(:,65))
  call counter_QA_W(wf(:,11),wf(:,-4),wf(:,66))
  call vert_QA_W(wf(:,-5),wf(:,64),wf(:,67))
  call prop_A_Q(wf(:,62),Q(:,19),ZERO,0_intkind1,wf(:,68))
  call vert_AV_Q(wf(:,68),wf(:,-6),wf(:,69))
  call counter_AV_Q(wf(:,-4),wf(:,-6),wf(:,70))
  call prop_A_Q(wf(:,70),Q(:,80),ZERO,0_intkind1,wf(:,71))
  call vert_AV_Q(wf(:,71),wf(:,2),wf(:,72))
  call vert_AW_Q(wf(:,71),wf(:,4),wf(:,73))
  call counter_VQ_A(wf(:,28),wf(:,-5),wf(:,74))
  call counter_VQ_A(wf(:,33),wf(:,-5),wf(:,75))
  call counter_AV_Q(wf(:,-4),wf(:,28),wf(:,76))
  call counter_AV_Q(wf(:,-4),wf(:,33),wf(:,77))
  call counter_QA_V(wf(:,27),wf(:,-3),wf(:,78))
  call vert_VQ_A(wf(:,78),wf(:,-5),wf(:,79))
  call vert_AV_Q(wf(:,-4),wf(:,78),wf(:,80))
  call counter_AV_Q(wf(:,-3),wf(:,-6),wf(:,81))
  call prop_A_Q(wf(:,81),Q(:,72),ZERO,0_intkind1,wf(:,82))
  call vert_QA_V(wf(:,-2),wf(:,82),wf(:,83))
  call vert_VQ_A(wf(:,83),wf(:,-5),wf(:,84))
  call vert_AV_Q(wf(:,-4),wf(:,83),wf(:,85))
  call counter_QA_V(wf(:,-2),wf(:,32),wf(:,86))
  call vert_VQ_A(wf(:,86),wf(:,-5),wf(:,87))
  ...
  call vert_VQ_A(wf(:,91),wf(:,-5),wf(:,92))
  call vert_AV_Q(wf(:,-4),wf(:,91),wf(:,93))
  call counter_QA_V(wf(:,-2),wf(:,-3),wf(:,94))
  call vert_AV_Q(wf(:,5),wf(:,94),wf(:,95))
  call vert_VQ_A(wf(:,94),wf(:,-5),wf(:,96))
  call prop_Q_A(wf(:,96),Q(:,44),ZERO,0_intkind1,wf(:,97))
  call vert_VQ_A(wf(:,94),wf(:,13),wf(:,98))
  call vert_AV_Q(wf(:,-4),wf(:,94),wf(:,99))
  call prop_A_Q(wf(:,99),Q(:,28),ZERO,0_intkind1,wf(:,100))
  call vert_AV_Q(wf(:,100),wf(:,-6),wf(:,101))
  call vert_QA_W(wf(:,-5),wf(:,100),wf(:,102))
  call vert_QA_W(wf(:,97),wf(:,-4),wf(:,103))
  call counter_WQ_A(wf(:,39),wf(:,-5),wf(:,104))
  call counter_AW_Q(wf(:,-4),wf(:,39),wf(:,105))
  call counter_V_V(ctGG,wf(:,2),Q(:,12),wf(:,106))
  call vert_VQ_A(wf(:,106),wf(:,-5),wf(:,107))
  call vert_AV_Q(wf(:,5),wf(:,106),wf(:,108))
  call counter_A_Q(ctcc,wf(:,5),Q(:,80),wf(:,109))
  call prop_A_Q(wf(:,109),Q(:,80),ZERO,0_intkind1,wf(:,110))
  call vert_AV_Q(wf(:,110),wf(:,2),wf(:,111))
  call vert_AW_Q(wf(:,110),wf(:,4),wf(:,112))
  call counter_Q_A(ctcc,wf(:,8),Q(:,35),wf(:,113))
  call counter_Q_A(ctqq,wf(:,11),Q(:,44),wf(:,114))
  call vert_AV_Q(wf(:,-4),wf(:,106),wf(:,115))
  call vert_AV_Q(wf(:,16),wf(:,106),wf(:,116))
  call counter_A_Q(ctqq,wf(:,16),Q(:,19),wf(:,117))
  call counter_A_Q(ctcc,wf(:,19),Q(:,28),wf(:,118))
  call counter_Q_A(ctqq,wf(:,13),Q(:,96),wf(:,119))
  call prop_Q_A(wf(:,119),Q(:,96),ZERO,0_intkind1,wf(:,120))
  call vert_VQ_A(wf(:,2),wf(:,120),wf(:,121))
  call vert_WQ_A(wf(:,4),wf(:,120),wf(:,122))
  call vert_VQ_A(wf(:,-6),wf(:,8),wf(:,123))
  call prop_A_Q(wf(:,115),Q(:,28),ZERO,0_intkind1,wf(:,124))
  call vert_WQ_A(wf(:,23),wf(:,-5),wf(:,125))
  call prop_Q_A(wf(:,107),Q(:,44),ZERO,0_intkind1,wf(:,126))
  call vert_AW_Q(wf(:,-4),wf(:,23),wf(:,127))
  call prop_A_Q(wf(:,127),Q(:,83),ZERO,0_intkind1,wf(:,128))
  call prop_Q_A(wf(:,125),Q(:,99),ZERO,0_intkind1,wf(:,129))
  call vert_VQ_A(wf(:,-6),wf(:,11),wf(:,130))
  call prop_Q_A(wf(:,130),Q(:,108),ZERO,0_intkind1,wf(:,131))
  call prop_Q_A(wf(:,123),Q(:,99),ZERO,0_intkind1,wf(:,132))
  call prop_A_Q(wf(:,20),Q(:,83),ZERO,0_intkind1,wf(:,133))
  call prop_A_Q(wf(:,21),Q(:,92),ZERO,0_intkind1,wf(:,134))
  call counter_Q_A(ctqq,wf(:,27),Q(:,68),wf(:,135))
  call prop_Q_A(wf(:,135),Q(:,68),ZERO,0_intkind1,wf(:,136))
  call vert_QA_V(wf(:,136),wf(:,-3),wf(:,137))
  call vert_QA_V(wf(:,-5),wf(:,16),wf(:,138))
  call vert_QA_V(wf(:,8),wf(:,-4),wf(:,139))
  call counter_V_V(ctGG,wf(:,28),Q(:,76),wf(:,140))
  call prop_Q_A(wf(:,29),Q(:,108),ZERO,0_intkind1,wf(:,141))
  call prop_A_Q(wf(:,30),Q(:,92),ZERO,0_intkind1,wf(:,142))
  ...
  call prop_Q_A(wf(:,34),Q(:,108),ZERO,0_intkind1,wf(:,147))
  call prop_A_Q(wf(:,35),Q(:,92),ZERO,0_intkind1,wf(:,148))
  call prop_A_Q(wf(:,40),Q(:,83),ZERO,0_intkind1,wf(:,149))
  call prop_Q_A(wf(:,41),Q(:,99),ZERO,0_intkind1,wf(:,150))
  call vert_AV_Q(wf(:,16),wf(:,2),wf(:,151))
  call prop_A_Q(wf(:,151),Q(:,31),ZERO,0_intkind1,wf(:,152))
  call vert_VQ_A(wf(:,2),wf(:,8),wf(:,153))
  call prop_Q_A(wf(:,153),Q(:,47),ZERO,0_intkind1,wf(:,154))
  call vert_AW_Q(wf(:,19),wf(:,4),wf(:,155))
  call prop_A_Q(wf(:,155),Q(:,31),ZERO,0_intkind1,wf(:,156))
  call vert_WQ_A(wf(:,4),wf(:,11),wf(:,157))
  call prop_Q_A(wf(:,157),Q(:,47),ZERO,0_intkind1,wf(:,158))
  call vert_QA_V(wf(:,8),wf(:,5),wf(:,159))
  call vert_QA_V(wf(:,-5),wf(:,49),wf(:,160))
  call vert_QA_V(wf(:,13),wf(:,16),wf(:,161))
  call vert_QA_V(wf(:,61),wf(:,-4),wf(:,162))
  ...
  call vert_QA_V(wf(:,-5),wf(:,133),wf(:,167))
  ...
  call vert_QA_V(wf(:,132),wf(:,-4),wf(:,172))
  call vert_QA_V(wf(:,-5),wf(:,128),wf(:,173))
  call vert_QA_V(wf(:,129),wf(:,-4),wf(:,174))
  call vert_QA_V(wf(:,-5),wf(:,149),wf(:,175))
  call vert_QA_V(wf(:,150),wf(:,-4),wf(:,176))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(73)-A(74)-A(75)-A(76)-A(77)-A(78)-A(81)-A(85)-A(87))*f(4))/2._/**/REALKIND+((A(67)+A(68)+A(69)+A(70)+A(71)+A(72) &
       ...
       +A(66))*f(12))/2._/**/REALKIND+((-A(20)-A(35)-A(36))*f(13))/2._/**/REALKIND+((A(18)+A(19)+A(27)+A(28)+A(30) &
       +A(34))*f(14))/2._/**/REALKIND+((-A(16)-A(22)-A(26)-A(38)-A(40)-A(42)-A(44)-A(47)-A(48)-A(51)-A(52))*f(15))/2._/**/REALKIND &
       +((-A(24)-A(32)+A(62)+A(64))*f(16))/2._/**/REALKIND
  M2(2) = ((A(73)+A(74)+A(75)+A(76)+A(77)+A(78)+A(81)+A(85)+A(87))*f(4))/6._/**/REALKIND+((-A(67)-A(68)-A(69)-A(70)-A(71)-A(72) &
       ...
       -A(66))*f(12))/6._/**/REALKIND+((A(20)+A(35)+A(36))*f(13))/6._/**/REALKIND+((-A(18)-A(19)-A(27)-A(28)-A(30) &
       -A(34))*f(14))/6._/**/REALKIND+((A(16)+A(22)+A(26)+A(38)+A(40)+A(42)+A(44)+A(47)+A(48)+A(51)+A(52))*f(15))/6._/**/REALKIND &
       +((A(24)+A(32)-A(62)-A(64))*f(16))/6._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplnajj_neexuuxcxsa_1_/**/REALKIND
