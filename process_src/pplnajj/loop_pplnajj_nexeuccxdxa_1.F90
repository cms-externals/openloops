...
module ol_colourmatrix_pplnajj_nexeuccxdxa_1_/**/REALKIND
...
end module ol_colourmatrix_pplnajj_nexeuccxdxa_1_/**/REALKIND



module ol_forced_parameters_pplnajj_nexeuccxdxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnajj_nexeuccxdxa_1_/**/REALKIND

module ol_loop_pplnajj_nexeuccxdxa_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_QA_V(wf(:,16),wf(:,-5),wf(:,29))
  ...
  call vert_VQ_A(wf(:,33),wf(:,-2),wf(:,34))
  call vert_VQ_A(wf(:,-6),wf(:,-1),wf(:,35))
  call prop_Q_A(wf(:,35),Q(:,66),ZERO,0_intkind1,wf(:,36))
  call vert_QA_W(wf(:,36),wf(:,0),wf(:,37))
  call prop_W_W(wf(:,37),Q(:,67),MW,1_intkind1,wf(:,38))
  call vert_WQ_A(wf(:,38),wf(:,-2),wf(:,39))
  call vert_AW_Q(wf(:,-5),wf(:,38),wf(:,40))
  call counter_VQ_A(wf(:,3),wf(:,5),wf(:,41))
  call counter_WQ_A(wf(:,4),wf(:,5),wf(:,42))
  call counter_AV_Q(wf(:,13),wf(:,3),wf(:,43))
  call counter_AW_Q(wf(:,13),wf(:,4),wf(:,44))
  call counter_VQ_A(wf(:,-6),wf(:,16),wf(:,45))
  call counter_VQ_A(wf(:,-6),wf(:,19),wf(:,46))
  call counter_AV_Q(wf(:,-5),wf(:,3),wf(:,47))
  call prop_Q_A(wf(:,10),Q(:,71),ZERO,0_intkind1,wf(:,48))
  call counter_AW_Q(wf(:,-5),wf(:,4),wf(:,49))
  call prop_Q_A(wf(:,7),Q(:,92),ZERO,0_intkind1,wf(:,50))
  call prop_A_Q(wf(:,47),Q(:,56),ZERO,0_intkind1,wf(:,51))
  call counter_QA_W(wf(:,19),wf(:,-5),wf(:,52))
  call vert_QA_W(wf(:,-2),wf(:,51),wf(:,53))
  call prop_A_Q(wf(:,49),Q(:,35),ZERO,0_intkind1,wf(:,54))
  call counter_AV_Q(wf(:,-5),wf(:,-6),wf(:,55))
  call prop_A_Q(wf(:,55),Q(:,96),ZERO,0_intkind1,wf(:,56))
  call vert_AV_Q(wf(:,56),wf(:,3),wf(:,57))
  call vert_AW_Q(wf(:,56),wf(:,4),wf(:,58))
  call counter_QA_V(wf(:,16),wf(:,-5),wf(:,59))
  ...
  call vert_VQ_A(wf(:,70),wf(:,-2),wf(:,71))
  call counter_QA_V(wf(:,-3),wf(:,-4),wf(:,72))
  call vert_VQ_A(wf(:,72),wf(:,5),wf(:,73))
  call vert_AV_Q(wf(:,-5),wf(:,72),wf(:,74))
  call prop_A_Q(wf(:,74),Q(:,56),ZERO,0_intkind1,wf(:,75))
  call vert_AV_Q(wf(:,13),wf(:,72),wf(:,76))
  call vert_VQ_A(wf(:,72),wf(:,-2),wf(:,77))
  call prop_Q_A(wf(:,77),Q(:,28),ZERO,0_intkind1,wf(:,78))
  call vert_VQ_A(wf(:,-6),wf(:,78),wf(:,79))
  call vert_QA_W(wf(:,-2),wf(:,75),wf(:,80))
  call vert_QA_W(wf(:,78),wf(:,-5),wf(:,81))
  call counter_VQ_A(wf(:,3),wf(:,-2),wf(:,82))
  call prop_A_Q(wf(:,18),Q(:,99),ZERO,0_intkind1,wf(:,83))
  call counter_WQ_A(wf(:,4),wf(:,-2),wf(:,84))
  call prop_A_Q(wf(:,15),Q(:,120),ZERO,0_intkind1,wf(:,85))
  call prop_Q_A(wf(:,82),Q(:,28),ZERO,0_intkind1,wf(:,86))
  call vert_VQ_A(wf(:,-6),wf(:,86),wf(:,87))
  call vert_QA_W(wf(:,86),wf(:,-5),wf(:,88))
  call counter_QA_W(wf(:,-2),wf(:,11),wf(:,89))
  call prop_Q_A(wf(:,84),Q(:,7),ZERO,0_intkind1,wf(:,90))
  call vert_VQ_A(wf(:,-6),wf(:,90),wf(:,91))
  call counter_VQ_A(wf(:,-6),wf(:,-2),wf(:,92))
  call prop_Q_A(wf(:,92),Q(:,68),ZERO,0_intkind1,wf(:,93))
  call vert_VQ_A(wf(:,3),wf(:,93),wf(:,94))
  call vert_WQ_A(wf(:,4),wf(:,93),wf(:,95))
  call counter_VQ_A(wf(:,28),wf(:,-2),wf(:,96))
  call vert_QA_V(wf(:,90),wf(:,-5),wf(:,97))
  call counter_VQ_A(wf(:,33),wf(:,-2),wf(:,98))
  call counter_AW_Q(wf(:,-5),wf(:,38),wf(:,99))
  call counter_WQ_A(wf(:,38),wf(:,-2),wf(:,100))
  call counter_Q_A(ctqq,wf(:,5),Q(:,68),wf(:,101))
  call prop_Q_A(wf(:,101),Q(:,68),ZERO,0_intkind1,wf(:,102))
  call vert_VQ_A(wf(:,3),wf(:,102),wf(:,103))
  call vert_WQ_A(wf(:,4),wf(:,102),wf(:,104))
  call counter_V_V(ctGG,wf(:,3),Q(:,24),wf(:,105))
  call vert_AV_Q(wf(:,-5),wf(:,105),wf(:,106))
  call vert_VQ_A(wf(:,105),wf(:,5),wf(:,107))
  call counter_A_Q(ctqq,wf(:,8),Q(:,35),wf(:,108))
  call counter_A_Q(ctqq,wf(:,11),Q(:,56),wf(:,109))
  call vert_VQ_A(wf(:,105),wf(:,-2),wf(:,110))
  call counter_Q_A(ctqq,wf(:,16),Q(:,7),wf(:,111))
  call counter_Q_A(ctqq,wf(:,19),Q(:,28),wf(:,112))
  call vert_VQ_A(wf(:,105),wf(:,16),wf(:,113))
  call counter_A_Q(ctqq,wf(:,13),Q(:,96),wf(:,114))
  call prop_A_Q(wf(:,114),Q(:,96),ZERO,0_intkind1,wf(:,115))
  call vert_QA_V(wf(:,16),wf(:,115),wf(:,116))
  call vert_AW_Q(wf(:,115),wf(:,4),wf(:,117))
  call vert_AV_Q(wf(:,8),wf(:,-6),wf(:,118))
  call prop_Q_A(wf(:,110),Q(:,28),ZERO,0_intkind1,wf(:,119))
  call vert_AW_Q(wf(:,-5),wf(:,23),wf(:,120))
  call prop_A_Q(wf(:,120),Q(:,99),ZERO,0_intkind1,wf(:,121))
  call vert_WQ_A(wf(:,23),wf(:,-2),wf(:,122))
  call prop_Q_A(wf(:,122),Q(:,71),ZERO,0_intkind1,wf(:,123))
  call vert_AV_Q(wf(:,11),wf(:,-6),wf(:,124))
  call prop_A_Q(wf(:,124),Q(:,120),ZERO,0_intkind1,wf(:,125))
  call prop_A_Q(wf(:,118),Q(:,99),ZERO,0_intkind1,wf(:,126))
  call prop_A_Q(wf(:,106),Q(:,56),ZERO,0_intkind1,wf(:,127))
  call prop_Q_A(wf(:,20),Q(:,71),ZERO,0_intkind1,wf(:,128))
  call prop_Q_A(wf(:,21),Q(:,92),ZERO,0_intkind1,wf(:,129))
  call vert_QA_V(wf(:,-2),wf(:,8),wf(:,130))
  call counter_V_V(ctGG,wf(:,28),Q(:,88),wf(:,131))
  call vert_AV_Q(wf(:,-5),wf(:,28),wf(:,132))
  call prop_A_Q(wf(:,132),Q(:,120),ZERO,0_intkind1,wf(:,133))
  call prop_Q_A(wf(:,30),Q(:,92),ZERO,0_intkind1,wf(:,134))
  call counter_Q_A(ctcc,wf(:,27),Q(:,72),wf(:,135))
  call prop_Q_A(wf(:,135),Q(:,72),ZERO,0_intkind1,wf(:,136))
  call vert_QA_V(wf(:,136),wf(:,-4),wf(:,137))
  call counter_V_V(ctGG,wf(:,33),Q(:,88),wf(:,138))
  call vert_AV_Q(wf(:,-5),wf(:,33),wf(:,139))
  call prop_A_Q(wf(:,139),Q(:,120),ZERO,0_intkind1,wf(:,140))
  call prop_Q_A(wf(:,34),Q(:,92),ZERO,0_intkind1,wf(:,141))
  call counter_A_Q(ctcc,wf(:,32),Q(:,80),wf(:,142))
  call prop_A_Q(wf(:,142),Q(:,80),ZERO,0_intkind1,wf(:,143))
  call vert_QA_V(wf(:,-3),wf(:,143),wf(:,144))
  call prop_Q_A(wf(:,39),Q(:,71),ZERO,0_intkind1,wf(:,145))
  call prop_A_Q(wf(:,40),Q(:,99),ZERO,0_intkind1,wf(:,146))
  call vert_VQ_A(wf(:,3),wf(:,16),wf(:,147))
  call prop_Q_A(wf(:,147),Q(:,31),ZERO,0_intkind1,wf(:,148))
  call vert_AV_Q(wf(:,8),wf(:,3),wf(:,149))
  call prop_A_Q(wf(:,149),Q(:,59),ZERO,0_intkind1,wf(:,150))
  call vert_WQ_A(wf(:,4),wf(:,19),wf(:,151))
  call prop_Q_A(wf(:,151),Q(:,31),ZERO,0_intkind1,wf(:,152))
  call vert_AW_Q(wf(:,11),wf(:,4),wf(:,153))
  call prop_A_Q(wf(:,153),Q(:,59),ZERO,0_intkind1,wf(:,154))
  call vert_QA_V(wf(:,5),wf(:,8),wf(:,155))
  call vert_QA_V(wf(:,48),wf(:,-5),wf(:,156))
  call vert_QA_V(wf(:,16),wf(:,13),wf(:,157))
  call vert_QA_V(wf(:,-2),wf(:,83),wf(:,158))
  ...
  call vert_QA_V(wf(:,128),wf(:,-5),wf(:,163))
  ...
  call vert_QA_V(wf(:,-2),wf(:,126),wf(:,168))
  call vert_QA_V(wf(:,123),wf(:,-5),wf(:,169))
  call vert_QA_V(wf(:,-2),wf(:,121),wf(:,170))
  call vert_QA_V(wf(:,145),wf(:,-5),wf(:,171))
  call vert_QA_V(wf(:,-2),wf(:,146),wf(:,172))
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = ((-A(3)-A(4)-A(5))*f(1))/6._/**/REALKIND+((A(1)+A(2)+A(6)+A(9)+A(10)+A(11)+A(12))*f(2))/6._/**/REALKIND+((A(7)+A(8) &
       -A(13)-A(14))*f(3))/6._/**/REALKIND
  M1(2) = ((A(3)+A(4)+A(5))*f(1))/2._/**/REALKIND+((-A(1)-A(2)-A(6)-A(9)-A(10)-A(11)-A(12))*f(2))/2._/**/REALKIND+((-A(7)-A(8) &
       +A(13)+A(14))*f(3))/2._/**/REALKIND

  M2(1) = ((A(73)+A(74)+A(75)+A(76)+A(77)+A(78)+A(83)+A(85)+A(87))*f(4))/6._/**/REALKIND+((-A(67)-A(68)-A(69)-A(70)-A(71)-A(72) &
       -A(79)-A(84)-A(88)-A(89)-A(90)-A(91)-A(92)-A(93)-A(94)-A(95)-A(96)-A(97)-A(98)-A(99)-A(100))*f(5))/6._/**/REALKIND+((-A(80) &
       -A(81)-A(82)-A(86)+A(101)+A(102)+A(103)+A(104))*f(6))/6._/**/REALKIND+((-A(43)-A(44)-A(45))*f(7))/6._/**/REALKIND+((A(33) &
       +A(34)+A(37)+A(38)+A(41)+A(42)+A(46))*f(8))/6._/**/REALKIND+((A(47)+A(48)-A(63)-A(64))*f(9))/6._/**/REALKIND+((-A(17)-A(23) &
       -A(49))*f(10))/6._/**/REALKIND+((A(15)+A(21)+A(29)+A(31)+A(51)+A(57)+A(59))*f(11))/6._/**/REALKIND+((A(25)+A(52)-A(61) &
       -A(65))*f(12))/6._/**/REALKIND+((A(35)+A(36)+A(39)+A(40))*f(13))/6._/**/REALKIND+((-A(18)-A(19)-A(27)-A(28)-A(50) &
       -A(54))*f(14))/6._/**/REALKIND+((A(16)+A(20)+A(22)+A(26)+A(30)+A(32)+A(55)+A(56)+A(58)+A(60))*f(15))/6._/**/REALKIND &
       +((A(24)+A(53)-A(62)-A(66))*f(16))/6._/**/REALKIND
  M2(2) = ((-A(73)-A(74)-A(75)-A(76)-A(77)-A(78)-A(83)-A(85)-A(87))*f(4))/2._/**/REALKIND+((A(67)+A(68)+A(69)+A(70)+A(71)+A(72) &
       +A(79)+A(84)+A(88)+A(89)+A(90)+A(91)+A(92)+A(93)+A(94)+A(95)+A(96)+A(97)+A(98)+A(99)+A(100))*f(5))/2._/**/REALKIND+((A(80) &
       +A(81)+A(82)+A(86)-A(101)-A(102)-A(103)-A(104))*f(6))/2._/**/REALKIND+((A(43)+A(44)+A(45))*f(7))/2._/**/REALKIND+((-A(33) &
       -A(34)-A(37)-A(38)-A(41)-A(42)-A(46))*f(8))/2._/**/REALKIND+((-A(47)-A(48)+A(63)+A(64))*f(9))/2._/**/REALKIND+((A(17)+A(23) &
       +A(49))*f(10))/2._/**/REALKIND+((-A(15)-A(21)-A(29)-A(31)-A(51)-A(57)-A(59))*f(11))/2._/**/REALKIND+((-A(25)-A(52)+A(61) &
       +A(65))*f(12))/2._/**/REALKIND+((-A(35)-A(36)-A(39)-A(40))*f(13))/2._/**/REALKIND+((A(18)+A(19)+A(27)+A(28)+A(50) &
       +A(54))*f(14))/2._/**/REALKIND+((-A(16)-A(20)-A(22)-A(26)-A(30)-A(32)-A(55)-A(56)-A(58)-A(60))*f(15))/2._/**/REALKIND+(( &
       -A(24)-A(53)+A(62)+A(66))*f(16))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplnajj_nexeuccxdxa_1_/**/REALKIND
