...
module ol_versiondata_pplnajj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pplnajj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplnajj
  end interface
end module ol_versiondata_pplnajj


subroutine ol_version_pplnajj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplnajj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplnajj
