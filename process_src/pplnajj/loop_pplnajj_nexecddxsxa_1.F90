...
module ol_colourmatrix_pplnajj_nexecddxsxa_1_/**/REALKIND
...
end module ol_colourmatrix_pplnajj_nexecddxsxa_1_/**/REALKIND



module ol_forced_parameters_pplnajj_nexecddxsxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnajj_nexecddxsxa_1_/**/REALKIND

module ol_loop_pplnajj_nexecddxsxa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(15) = (CI*countertermnorm*ctVsc*eQED**3*gQCD**4)/(6._/**/REALKIND*sw**2)
    f(16) = (CI*countertermnorm*ctVsc*eQED**3*gQCD**4)/(3._/**/REALKIND*sw**2)
    f(17) = (CI*countertermnorm*ctVsc*eQED**3*gQCD**4)/(2._/**/REALKIND*sw**2)
    f(18) = (CI*eQED**3*gQCD**4*integralnorm*SwB)/(6._/**/REALKIND*sw**2)
    f(19) = (CI*eQED**3*gQCD**4*integralnorm*SwB)/(3._/**/REALKIND*sw**2)
    f(20) = (CI*eQED**3*gQCD**4*integralnorm*SwB)/(2._/**/REALKIND*sw**2)
    f(21) = (eQED**3*gQCD**4*integralnorm*SwB)/(sw**2*12._/**/REALKIND)
    f(22) = (eQED**3*gQCD**4*integralnorm*SwB)/(sw**2*6._/**/REALKIND)
    f(23) = (eQED**3*gQCD**4*integralnorm*SwB)/(sw**2*4._/**/REALKIND)
    f(24) = (eQED**3*gQCD**4*integralnorm*SwB)/(sw**2*3._/**/REALKIND)
    f(25) = (eQED**3*gQCD**4*integralnorm*SwB)/(sw**2*2._/**/REALKIND)
    f(26) = (eQED**3*gQCD**4*integralnorm*SwF)/(sw**2*6._/**/REALKIND)
    f(27) = (eQED**3*gQCD**4*integralnorm*SwF)/(sw**2*3._/**/REALKIND)
    f(28) = (eQED**3*gQCD**4*integralnorm*SwF)/(sw**2*2._/**/REALKIND)
    f(29) = (2*eQED**3*gQCD**4*integralnorm*SwF)/(sw**2*3._/**/REALKIND)
    f(30) = (eQED**3*gQCD**4*integralnorm*SwF)/sw**2
...
! **********************************************************************
  ...
  call counter_Q_A(ctcc,wf(:,5),Q(:,68),wf(:,101))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((A(73)+A(74)+A(75)+A(76)+A(77)+A(78)+A(83)+A(85)+A(87)+A(89)+A(90)+A(91)+A(92)+A(93)+A(94)+A(95)+A(96)+A(97)+A(98) &
       ...
       -A(61)-A(63)-A(64))*f(12))/6._/**/REALKIND+((A(20)+A(55)+A(56))*f(13))/6._/**/REALKIND+((-A(19)-A(27)-A(28)-A(35)-A(36) &
       -A(39)-A(40))*f(14))/6._/**/REALKIND+((-A(18)-A(30)-A(32)-A(50)-A(54)-A(58)-A(60))*f(15))/6._/**/REALKIND+((A(16)+A(22) &
       +A(26))*f(16))/6._/**/REALKIND+((A(24)+A(53)-A(62)-A(66))*f(17))/6._/**/REALKIND
  M2(2) = ((-A(73)-A(74)-A(75)-A(76)-A(77)-A(78)-A(83)-A(85)-A(87)-A(89)-A(90)-A(91)-A(92)-A(93)-A(94)-A(95)-A(96)-A(97)-A(98) &
       ...
       +A(64))*f(12))/2._/**/REALKIND+((-A(20)-A(55)-A(56))*f(13))/2._/**/REALKIND+((A(19)+A(27)+A(28)+A(35)+A(36)+A(39) &
       +A(40))*f(14))/2._/**/REALKIND+((A(18)+A(30)+A(32)+A(50)+A(54)+A(58)+A(60))*f(15))/2._/**/REALKIND+((-A(16)-A(22) &
       -A(26))*f(16))/2._/**/REALKIND+((-A(24)-A(53)+A(62)+A(66))*f(17))/2._/**/REALKIND

end subroutine colourvectors

end module ol_loop_pplnajj_nexecddxsxa_1_/**/REALKIND
