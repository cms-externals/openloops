...
module ol_colourmatrix_pplnajj_nexecddxsxag_1_/**/REALKIND
...
end module ol_colourmatrix_pplnajj_nexecddxsxag_1_/**/REALKIND



module ol_forced_parameters_pplnajj_nexecddxsxag_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnajj_nexecddxsxag_1_/**/REALKIND

module ol_tree_pplnajj_nexecddxsxag_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_pplnajj_nexecddxsxag_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pplnajj_nexecddxsxag_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for anti-nu_e e- charm down anti-down anti-strange gamma glue -> 0
...
! **********************************************************************
  ...
  use ol_external_pplnajj_nexecddxsxag_1, only: external_perm_pplnajj_nexecddxsxag_1, &
    & external_perm_inv_pplnajj_nexecddxsxag_1, extcomb_perm_pplnajj_nexecddxsxag_1, &
    & average_factor_pplnajj_nexecddxsxag_1
  use ol_external_pplnajj_nexecddxsxag_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_pplnajj_nexecddxsxag_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_pplnajj_nexecddxsxag_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_pplnajj_nexecddxsxag_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_pplnajj_nexecddxsxag_1,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pplnajj_nexecddxsxag_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pplnajj_nexecddxsxag_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_pplnajj_nexecddxsxag_1(extcombs(k))
  end do
  ...
  call vert_VQ_A(ntry, wf8(:,20), wf4(:,6), wf32(:,9), n3(:,47), t3x32(:,:,9))
  call vert_AV_Q(ntry, ex6, wf8(:,20), wf16(:,37), n3(:,48), t3x16(:,:,21))
  ...
  call vert_VQ_A(ntry, wf8(:,21), wf4(:,6), wf32(:,10), n3(:,51), t3x32(:,:,10))
  call vert_AV_Q(ntry, ex6, wf8(:,21), wf16(:,38), n3(:,52), t3x16(:,:,22))
  ...
  call vert_VQ_A(ntry, wf8(:,22), wf4(:,10), wf32(:,11), n3(:,55), t3x32(:,:,11))
  call vert_AV_Q(ntry, ex6, wf8(:,22), wf16(:,39), n3(:,56), t3x16(:,:,23))
  call vert_QA_V(ntry, wf4(:,17), wf4(:,15), wf16(:,40), n3(:,57), t3x16(:,:,24))
  call vert_QA_V(ntry, wf8(:,9), ex6, wf16(:,41), n3(:,58), t3x16(:,:,25))
  call vert_QA_V(ntry, ex3, wf8(:,3), wf16(:,42), n3(:,59), t3x16(:,:,26))
  call vert_VQ_A(ntry, wf8(:,22), wf8(:,9), wf64(:,1), n3(:,60), t3x64(:,:,1))
  call vert_VQ_A(ntry, wf8(:,22), ex3, wf16(:,43), n3(:,61), t3x16(:,:,27))
  ...
  call prop_A_Q(ntry, wf16(:,39), Q(:,120), ZERO, 0_intkind1, wf16(:,46), n2(35))
  call prop_Q_A(ntry, wf16(:,43), Q(:,92), ZERO, 0_intkind1, wf16(:,47), n2(36))
  ...
  call vert_VQ_A(ntry, wf8(:,25), wf4(:,10), wf32(:,12), n3(:,67), t3x32(:,:,12))
  call vert_AV_Q(ntry, ex6, wf8(:,25), wf16(:,48), n3(:,68), t3x16(:,:,30))
  call vert_QA_V(ntry, wf4(:,13), wf4(:,19), wf16(:,49), n3(:,69), t3x16(:,:,31))
  call vert_VQ_A(ntry, wf8(:,25), wf8(:,9), wf64(:,2), n3(:,70), t3x64(:,:,2))
  call vert_VQ_A(ntry, wf8(:,25), ex3, wf16(:,50), n3(:,71), t3x16(:,:,32))
  ...
  call prop_A_Q(ntry, wf16(:,48), Q(:,120), ZERO, 0_intkind1, wf16(:,53), n2(39))
  call prop_Q_A(ntry, wf16(:,50), Q(:,92), ZERO, 0_intkind1, wf16(:,54), n2(40))
  call vert_VQ_A(ntry, wf8(:,20), wf8(:,9), wf64(:,3), n3(:,75), t3x64(:,:,3))
  call vert_VQ_A(ntry, wf8(:,20), ex3, wf16(:,55), n3(:,76), t3x16(:,:,35))
  call vert_VQ_A(ntry, wf8(:,21), wf8(:,9), wf64(:,4), n3(:,77), t3x64(:,:,4))
  call vert_VQ_A(ntry, wf8(:,21), ex3, wf16(:,56), n3(:,78), t3x16(:,:,36))
  ...
  call prop_Q_A(ntry, wf16(:,55), Q(:,156), ZERO, 0_intkind1, wf16(:,59), n2(43))
  ...
  call prop_Q_A(ntry, wf16(:,56), Q(:,156), ZERO, 0_intkind1, wf16(:,62), n2(46))
  call vert_VQ_A(ntry, ex7, ex2, wf4(:,20), n3(:,83), t3x4(:,:,11))
  call prop_Q_A(ntry, wf4(:,20), Q(:,66), ZERO, 0_intkind1, wf4(:,21), n2(47))
  call vert_QA_W(ntry, wf4(:,21), ex1, wf8(:,32), n3(:,84), t3x8(:,:,19))
  call prop_W_W(ntry, wf8(:,32), Q(:,67), MW, 1_intkind1, wf8(:,33), n2(48))
  call vert_AW_Q(ntry, ex6, wf8(:,33), wf16(:,63), n3(:,85), t3x16(:,:,39))
  call vert_WQ_A(ntry, wf8(:,33), wf4(:,10), wf32(:,13), n3(:,86), t3x32(:,:,13))
  call vert_WQ_A(ntry, wf8(:,33), ex3, wf16(:,64), n3(:,87), t3x16(:,:,40))
  call vert_WQ_A(ntry, wf8(:,33), wf8(:,13), wf64(:,5), n3(:,88), t3x64(:,:,5))
  call prop_Q_A(ntry, wf16(:,64), Q(:,71), ZERO, 0_intkind1, wf16(:,65), n2(49))
  call prop_A_Q(ntry, wf16(:,63), Q(:,99), ZERO, 0_intkind1, wf16(:,66), n2(50))
  ...
  M2add = M2 / average_factor_pplnajj_nexecddxsxag_1

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_pplnajj_nexecddxsxag_1(k))
  end do
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = ((A(j,9)%j+A(j,10)%j+A(j,11)%j+A(j,22)%j+A(j,29)%j+A(j,31)%j+A(j,43)%j+A(j,44)%j+A(j,45)%j+A(j,46)%j+A(j,51)%j+A(j,55)%j &
       +A(j,56)%j+A(j,62)%j+A(j,63)%j+A(j,64)%j+A(j,69)%j+A(j,70)%j+A(j,77)%j+A(j,78)%j+A(j,79)%j)*f(1))/2._/**/REALKIND+(( &
       ...
       +(CI*(A(j,12)%j+A(j,16)%j+A(j,30)%j+A(j,49)%j+A(j,54)%j+A(j,61)%j+A(j,66)%j)*f(4))/2._/**/REALKIND+(CI*(-A(j,4)%j-A(j,8)%j &
       -A(j,34)%j)*f(5))/2._/**/REALKIND+(CI*(-A(j,36)%j-A(j,37)%j+A(j,87)%j+A(j,90)%j)*f(6))/2._/**/REALKIND
  M1(2) = ((-A(j,45)%j-A(j,46)%j-A(j,50)%j-A(j,52)%j-A(j,57)%j-A(j,58)%j-A(j,62)%j-A(j,64)%j-A(j,67)%j-A(j,68)%j-A(j,69)%j &
       -A(j,70)%j-A(j,71)%j-A(j,72)%j-A(j,73)%j-A(j,77)%j-A(j,78)%j-A(j,79)%j)*f(1))/6._/**/REALKIND+((A(j,39)%j+A(j,40)%j &
  ...
  M1(3) = ((-A(j,9)%j-A(j,10)%j-A(j,11)%j-A(j,13)%j-A(j,14)%j-A(j,15)%j-A(j,22)%j-A(j,23)%j-A(j,24)%j-A(j,28)%j-A(j,29)%j &
       -A(j,31)%j-A(j,43)%j-A(j,44)%j-A(j,47)%j-A(j,48)%j-A(j,51)%j-A(j,53)%j-A(j,55)%j-A(j,56)%j-A(j,59)%j-A(j,60)%j-A(j,63)%j &
       -A(j,65)%j)*f(1))/6._/**/REALKIND+((A(j,1)%j+A(j,2)%j+A(j,3)%j+A(j,5)%j+A(j,6)%j+A(j,7)%j+A(j,17)%j+A(j,18)%j+A(j,21)%j &
       +A(j,27)%j+A(j,32)%j+A(j,33)%j)*f(2))/6._/**/REALKIND+((A(j,19)%j+A(j,20)%j+A(j,25)%j+A(j,26)%j+A(j,35)%j+A(j,38)%j &
       -A(j,83)%j-A(j,84)%j-A(j,85)%j-A(j,86)%j-A(j,88)%j-A(j,89)%j)*f(3))/6._/**/REALKIND
  M1(4) = ((A(j,13)%j+A(j,14)%j+A(j,15)%j+A(j,23)%j+A(j,24)%j+A(j,28)%j+A(j,47)%j+A(j,48)%j+A(j,50)%j+A(j,52)%j+A(j,53)%j &
       +A(j,57)%j+A(j,58)%j+A(j,59)%j+A(j,60)%j+A(j,65)%j+A(j,67)%j+A(j,68)%j+A(j,71)%j+A(j,72)%j+A(j,73)%j)*f(1))/2._/**/REALKIND &
       +((-A(j,1)%j-A(j,2)%j-A(j,5)%j-A(j,27)%j-A(j,32)%j-A(j,33)%j-A(j,39)%j-A(j,40)%j-A(j,74)%j)*f(2))/2._/**/REALKIND+(( &
       -A(j,25)%j-A(j,26)%j-A(j,35)%j-A(j,75)%j-A(j,76)%j+A(j,85)%j+A(j,86)%j+A(j,89)%j+A(j,91)%j+A(j,92)%j)*f(3))/2._/**/REALKIND &
       +(CI*(-A(j,12)%j-A(j,16)%j-A(j,30)%j-A(j,49)%j-A(j,54)%j-A(j,61)%j-A(j,66)%j)*f(4))/2._/**/REALKIND+(CI*(A(j,4)%j+A(j,8)%j &
       +A(j,34)%j)*f(5))/2._/**/REALKIND+(CI*(A(j,36)%j+A(j,37)%j-A(j,87)%j-A(j,90)%j)*f(6))/2._/**/REALKIND
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_pplnajj_nexecddxsxag_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pplnajj_nexecddxsxag_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_pplnajj_nexecddxsxag_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_pplnajj_nexecddxsxag_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_pplnajj_nexecddxsxag_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_pplnajj_nexecddxsxag_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_pplnajj_nexecddxsxag_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_pplnajj_nexecddxsxag_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_pplnajj_nexecddxsxag_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_pplnajj_nexecddxsxag_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_pplnajj_nexecddxsxag_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_pplnajj_nexecddxsxag_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_pplnajj_nexecddxsxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_pplnajj_nexecddxsxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_pplnajj_nexecddxsxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_pplnajj_nexecddxsxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_pplnajj_nexecddxsxag_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_pplnajj_nexecddxsxag_1_/**/REALKIND
