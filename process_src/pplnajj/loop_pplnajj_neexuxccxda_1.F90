...
module ol_colourmatrix_pplnajj_neexuxccxda_1_/**/REALKIND
...
end module ol_colourmatrix_pplnajj_neexuxccxda_1_/**/REALKIND



module ol_forced_parameters_pplnajj_neexuxccxda_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplnajj_neexuxccxda_1_/**/REALKIND

module ol_loop_pplnajj_neexuxccxda_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_A_Q(ctqq,wf(:,5),Q(:,68),wf(:,101))
...
end module ol_loop_pplnajj_neexuxccxda_1_/**/REALKIND
