...
module ol_versiondata_ppllaa
  implicit none
  character(4) :: generator_revision = "2198"
  interface
    subroutine version_ppllaa(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllaa
  end interface
end module ol_versiondata_ppllaa


subroutine ol_version_ppllaa(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllaa, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllaa
