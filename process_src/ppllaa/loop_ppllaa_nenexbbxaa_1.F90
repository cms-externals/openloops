...
module ol_colourmatrix_ppllaa_nenexbbxaa_1_/**/REALKIND
...
end module ol_colourmatrix_ppllaa_nenexbbxaa_1_/**/REALKIND



module ol_forced_parameters_ppllaa_nenexbbxaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllaa_nenexbbxaa_1_/**/REALKIND

module ol_loop_ppllaa_nenexbbxaa_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**4*gQCD**2)/9._/**/REALKIND
    f(3) = (CI*countertermnorm*ctVbb*eQED**4*gQCD**2)/9._/**/REALKIND
    f(4) = (eQED**4*gQCD**2*integralnorm*SwB)/9._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_ZQ_A(gZd,wf(:,4),wf(:,5),wf(:,21))
  call counter_VQ_A(wf(:,-5),wf(:,5),wf(:,22))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,13),wf(:,23))
  ...
  call prop_Q_A(wf(:,9),Q(:,52),MB,1_intkind1,wf(:,28))
  call counter_AV_Q(wf(:,-3),wf(:,-5),wf(:,29))
  call prop_A_Q(wf(:,29),Q(:,40),MB,1_intkind1,wf(:,30))
  call prop_Q_A(wf(:,19),Q(:,52),MB,1_intkind1,wf(:,31))
  call vert_AV_Q(wf(:,30),wf(:,-4),wf(:,32))
  call counter_AV_Q(wf(:,-3),wf(:,-4),wf(:,33))
  call prop_A_Q(wf(:,33),Q(:,24),MB,1_intkind1,wf(:,34))
  call vert_AV_Q(wf(:,34),wf(:,-5),wf(:,35))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,-2),wf(:,36))
  call prop_A_Q(wf(:,17),Q(:,56),MB,1_intkind1,wf(:,37))
  call counter_VQ_A(wf(:,-5),wf(:,-2),wf(:,38))
  call prop_Q_A(wf(:,38),Q(:,36),MB,1_intkind1,wf(:,39))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,39),wf(:,40))
  call prop_A_Q(wf(:,20),Q(:,56),MB,1_intkind1,wf(:,41))
  call vert_VQ_A(wf(:,-4),wf(:,39),wf(:,42))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,43))
  call prop_Q_A(wf(:,43),Q(:,20),MB,1_intkind1,wf(:,44))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,44),wf(:,45))
  call vert_VQ_A(wf(:,-5),wf(:,44),wf(:,46))
  call vert_AZ_Q(gZd,wf(:,6),wf(:,4),wf(:,47))
  call counter_Q_A(ctbb,wf(:,5),Q(:,20),wf(:,48))
  call prop_A_Q(wf(:,47),Q(:,43),MB,1_intkind1,wf(:,49))
  call counter_A_Q(ctbb,wf(:,6),Q(:,40),wf(:,50))
  call prop_Q_A(wf(:,7),Q(:,23),MB,1_intkind1,wf(:,51))
  call prop_Q_A(wf(:,48),Q(:,20),MB,1_intkind1,wf(:,52))
  call vert_VQ_A(wf(:,-5),wf(:,52),wf(:,53))
  call counter_A_Q(ctbb,wf(:,10),Q(:,11),wf(:,54))
  call vert_AZ_Q(gZd,wf(:,14),wf(:,4),wf(:,55))
  call counter_Q_A(ctbb,wf(:,13),Q(:,36),wf(:,56))
  call prop_A_Q(wf(:,55),Q(:,27),MB,1_intkind1,wf(:,57))
  call counter_A_Q(ctbb,wf(:,14),Q(:,24),wf(:,58))
  call prop_Q_A(wf(:,15),Q(:,39),MB,1_intkind1,wf(:,59))
  call counter_Q_A(ctbb,wf(:,18),Q(:,7),wf(:,60))
  call prop_A_Q(wf(:,58),Q(:,24),MB,1_intkind1,wf(:,61))
  call vert_AV_Q(wf(:,61),wf(:,-5),wf(:,62))
  call prop_Q_A(wf(:,56),Q(:,36),MB,1_intkind1,wf(:,63))
  call vert_VQ_A(wf(:,-4),wf(:,63),wf(:,64))
  call prop_A_Q(wf(:,50),Q(:,40),MB,1_intkind1,wf(:,65))
  call vert_AV_Q(wf(:,65),wf(:,-4),wf(:,66))
  call vert_VQ_A(wf(:,-4),wf(:,18),wf(:,67))
  call prop_Q_A(wf(:,67),Q(:,23),MB,1_intkind1,wf(:,68))
  call vert_VQ_A(wf(:,-5),wf(:,18),wf(:,69))
  call prop_Q_A(wf(:,69),Q(:,39),MB,1_intkind1,wf(:,70))
  call vert_AV_Q(wf(:,10),wf(:,-4),wf(:,71))
  call prop_A_Q(wf(:,71),Q(:,27),MB,1_intkind1,wf(:,72))
  call vert_AV_Q(wf(:,10),wf(:,-5),wf(:,73))
  call prop_A_Q(wf(:,73),Q(:,43),MB,1_intkind1,wf(:,74))
...
end module ol_loop_ppllaa_nenexbbxaa_1_/**/REALKIND
