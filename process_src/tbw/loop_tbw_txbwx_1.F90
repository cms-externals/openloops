...
module ol_colourmatrix_tbw_txbwx_1_/**/REALKIND
...
end module ol_colourmatrix_tbw_txbwx_1_/**/REALKIND



module ol_forced_parameters_tbw_txbwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_tbw_txbwx_1_/**/REALKIND

module ol_loop_tbw_txbwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVbt*eQED*gQCD**2)/(sqrt2*sw)
    f(3) = (eQED*gQCD**2*integralnorm*SwB)/(sqrt2*sw)
...
end module ol_loop_tbw_txbwx_1_/**/REALKIND
