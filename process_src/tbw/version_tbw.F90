...
module ol_versiondata_tbw
  implicit none
  character(4) :: generator_revision = "1497"
  interface
    subroutine version_tbw(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_tbw
  end interface
end module ol_versiondata_tbw


subroutine ol_version_tbw(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_tbw, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
