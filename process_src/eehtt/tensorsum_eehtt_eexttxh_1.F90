...
! **********************************************************************
module ol_tensor_sum_storage_eehtt_eexttxh_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_eehtt_eexttxh_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_eehtt_eexttxh_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 3
...
! **********************************************************************
  use ol_external_eehtt_eexttxh_1, only: channel_number_eehtt_eexttxh_1
  ...
  call channel_on(channel_number_eehtt_eexttxh_1)
  M2 = 0
  ...
  momenta_6(:,1) = Q(1:4,20)
  momenta_6(:,2) = Q(1:4,23)
  momenta_7(:,1) = Q(1:4,24)
  momenta_7(:,2) = Q(1:4,27)
  momenta_8(:,1) = Q(1:4,8)
  momenta_8(:,2) = Q(1:4,11)
  momenta_8(:,3) = Q(1:4,27)
  momenta_9(:,1) = Q(1:4,8)
  momenta_9(:,2) = Q(1:4,24)
  momenta_9(:,3) = Q(1:4,27)

  masses2_1 = [ ZERO2, MT2 ]
  masses2_2 = [ ZERO2, MT2, MT2 ]
  masses2_3 = [ ZERO2, MT2, MT2, MT2 ]
  ...
  call channel_off(channel_number_eehtt_eexttxh_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_eehtt_eexttxh_1_/**/REALKIND
