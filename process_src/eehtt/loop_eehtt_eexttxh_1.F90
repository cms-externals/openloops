...
module ol_colourmatrix_eehtt_eexttxh_1_/**/REALKIND
...
end module ol_colourmatrix_eehtt_eexttxh_1_/**/REALKIND



module ol_forced_parameters_eehtt_eexttxh_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_eehtt_eexttxh_1_/**/REALKIND

module ol_loop_eehtt_eexttxh_1_/**/REALKIND
...
!  use ol_loop_parameters_decl_/**/DREALKIND, only: DOI
  ...
  ! factors of the diagrams
    ...
    f( 2) = (CI*countertermnorm*ctVtt*eQED**3*gQCD**2*lambdaHZZ*MW)/(cw**2*sw)
    f( 3) = (eQED**3*gQCD**2*integralnorm*lambdaHZZ*MW*SwB)/(cw**2*sw)
    f( 4) = (CI*eQED**3*YT)/(3._/**/REALKIND*MW*sw)
    f( 5) = (CI*eQED**3*YT)/(2._/**/REALKIND*MW*sw)
    f( 6) = (CI*countertermnorm*eQED**3*gQCD**2*YT)/(3._/**/REALKIND*MW*sw)
    f( 7) = (CI*countertermnorm*eQED**3*gQCD**2*YT)/(2._/**/REALKIND*MW*sw)
    f( 8) = (CI*countertermnorm*ctStt*eQED**3*gQCD**2*YT)/(3._/**/REALKIND*MW*sw)
    f( 9) = (CI*countertermnorm*ctStt*eQED**3*gQCD**2*YT)/(2._/**/REALKIND*MW*sw)
    f(10) = (CI*countertermnorm*ctVtt*eQED**3*gQCD**2*YT)/(3._/**/REALKIND*MW*sw)
    f(11) = (CI*countertermnorm*ctVtt*eQED**3*gQCD**2*YT)/(2._/**/REALKIND*MW*sw)
    f(12) = (eQED**3*gQCD**2*integralnorm*SwB*YT)/(MW*sw*3._/**/REALKIND)
    f(13) = (eQED**3*gQCD**2*integralnorm*SwB*YT)/(MW*sw*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,7),Q(:,20),MT,1_intkind1,wf(:,8))
  call vert_AV_Q(wf(:,-3),wf(:,6),wf(:,9))
  call vert_AZ_Q(gZu,wf(:,-3),wf(:,3),wf(:,10))
  call vert_SA_Q(gH,wf(:,-4),wf(:,-3),wf(:,11))
  call prop_A_Q(wf(:,11),Q(:,24),MT,1_intkind1,wf(:,12))
  call vert_VQ_A(wf(:,6),wf(:,-2),wf(:,13))
  call vert_ZQ_A(gZu,wf(:,3),wf(:,-2),wf(:,14))
  call counter_AV_Q(wf(:,-3),wf(:,6),wf(:,15))
  call counter_AZ_Q(gZu,wf(:,-3),wf(:,3),wf(:,16))
  call counter_SA_Q(gH,wf(:,-4),wf(:,-3),wf(:,17))
  call prop_A_Q(wf(:,17),Q(:,24),MT,1_intkind1,wf(:,18))
  call counter_VQ_A(wf(:,6),wf(:,-2),wf(:,19))
  call counter_ZQ_A(gZu,wf(:,3),wf(:,-2),wf(:,20))
  call counter_QS_A(gH,wf(:,-2),wf(:,-4),wf(:,21))
  call prop_Q_A(wf(:,21),Q(:,20),MT,1_intkind1,wf(:,22))
  call counter_QA_Z(gZu,wf(:,-2),wf(:,-3),wf(:,23))
  call prop_W_W(wf(:,23),Q(:,12),MZ,1_intkind1,wf(:,24))
  call counter_Q_A(cttt,wf(:,8),Q(:,20),wf(:,25))
  call prop_A_Q(wf(:,9),Q(:,11),MT,1_intkind1,wf(:,26))
  call prop_A_Q(wf(:,10),Q(:,11),MT,1_intkind1,wf(:,27))
  call counter_A_Q(cttt,wf(:,12),Q(:,24),wf(:,28))
  call prop_Q_A(wf(:,13),Q(:,7),MT,1_intkind1,wf(:,29))
  call prop_Q_A(wf(:,14),Q(:,7),MT,1_intkind1,wf(:,30))
...
end module ol_loop_eehtt_eexttxh_1_/**/REALKIND
