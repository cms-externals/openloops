...
module ol_versiondata_eehtt
  implicit none
  character(4) :: generator_revision = "1857"
  interface
    subroutine version_eehtt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_eehtt
  end interface
end module ol_versiondata_eehtt


subroutine ol_version_eehtt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_eehtt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_eehtt
