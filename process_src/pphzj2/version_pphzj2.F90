...
module ol_versiondata_pphzj2
  implicit none
  character(4) :: generator_revision = "1733"
  interface
    subroutine version_pphzj2(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphzj2
  end interface
end module ol_versiondata_pphzj2


subroutine ol_version_pphzj2(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphzj2, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphzj2
