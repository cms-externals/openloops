...
! **********************************************************************
module ol_tensor_sum_storage_pphzj2_hzggg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphzj2_hzggg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphzj2_hzggg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 5
...
! **********************************************************************
  use ol_external_pphzj2_hzggg_1, only: channel_number_pphzj2_hzggg_1
  ...
  call channel_on(channel_number_pphzj2_hzggg_1)
  M2 = 0
  ...
  call tensor_integral(4, momenta_14, masses2_6, T4sum(:,1))
  call tensor_integral(4, momenta_14, masses2_5, T4sum(:,2))
  call tensor_integral(4, momenta_14, masses2_4, T4sum(:,3))
  call tensor_integral(4, momenta_11, masses2_6, T4sum(:,4))
  call tensor_integral(4, momenta_11, masses2_5, T4sum(:,5))
  call tensor_integral(4, momenta_11, masses2_4, T4sum(:,6))
  call tensor_integral(4, momenta_12, masses2_6, T4sum(:,7))
  call tensor_integral(4, momenta_12, masses2_5, T4sum(:,8))
  call tensor_integral(4, momenta_12, masses2_4, T4sum(:,9))
  call tensor_integral(4, momenta_6, masses2_5, T4sum(:,10))
  call tensor_integral(4, momenta_6, masses2_4, T4sum(:,11))
  call tensor_integral(4, momenta_7, masses2_5, T4sum(:,12))
  call tensor_integral(4, momenta_7, masses2_4, T4sum(:,13))
  call tensor_integral(4, momenta_15, masses2_5, T4sum(:,14))
  call tensor_integral(4, momenta_15, masses2_4, T4sum(:,15))
  ...
  call tensor_integral(4, momenta_5, masses2_4, T4sum(:,19))
  call tensor_integral(4, momenta_13, masses2_5, T4sum(:,20))
  call tensor_integral(4, momenta_13, masses2_4, T4sum(:,21))
  call tensor_integral(4, momenta_9, masses2_5, T4sum(:,22))
  call tensor_integral(4, momenta_9, masses2_4, T4sum(:,23))
  call tensor_integral(4, momenta_4, masses2_5, T4sum(:,24))
  call tensor_integral(4, momenta_4, masses2_4, T4sum(:,25))
  ...
  call tensor_integral(5, momenta_21, masses2_8, T5sum(:,3))
  call tensor_integral(5, momenta_21, masses2_7, T5sum(:,4))
  call tensor_integral(5, momenta_17, masses2_8, T5sum(:,5))
  call tensor_integral(5, momenta_17, masses2_7, T5sum(:,6))
  call tensor_integral(5, momenta_20, masses2_8, T5sum(:,7))
  call tensor_integral(5, momenta_20, masses2_7, T5sum(:,8))
  call tensor_integral(5, momenta_16, masses2_8, T5sum(:,9))
  call tensor_integral(5, momenta_16, masses2_7, T5sum(:,10))
  call tensor_integral(5, momenta_18, masses2_8, T5sum(:,11))
  call tensor_integral(5, momenta_18, masses2_7, T5sum(:,12))
  call tensor_integral(5, momenta_23, masses2_8, T5sum(:,13))
  call tensor_integral(5, momenta_23, masses2_7, T5sum(:,14))
  call tensor_integral(5, momenta_25, masses2_8, T5sum(:,15))
  call tensor_integral(5, momenta_25, masses2_7, T5sum(:,16))
  call tensor_integral(5, momenta_22, masses2_8, T5sum(:,17))
  call tensor_integral(5, momenta_22, masses2_7, T5sum(:,18))
  call tensor_integral(5, momenta_24, masses2_8, T5sum(:,19))
  call tensor_integral(5, momenta_24, masses2_7, T5sum(:,20))
  call tensor_integral(5, momenta_26, masses2_8, T5sum(:,21))
  call tensor_integral(5, momenta_26, masses2_7, T5sum(:,22))
  call tensor_integral(5, momenta_27, masses2_8, T5sum(:,23))
  call tensor_integral(5, momenta_27, masses2_7, T5sum(:,24))

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pphzj2_hzggg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphzj2_hzggg_1_/**/REALKIND
