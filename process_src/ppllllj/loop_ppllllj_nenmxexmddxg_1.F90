...
module ol_colourmatrix_ppllllj_nenmxexmddxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nenmxexmddxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nenmxexmddxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nenmxexmddxg_1_/**/REALKIND

module ol_loop_ppllllj_nenmxexmddxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_UV_W(wf(:,5),Q(:,5),wf(:,4),Q(:,10),wf(:,11))
  ...
  call vert_AW_Q(wf(:,-1),wf(:,5),wf(:,23))
  call prop_A_Q(wf(:,23),Q(:,7),ZERO,0_intkind1,wf(:,24))
  call vert_QA_V(wf(:,-3),wf(:,24),wf(:,25))
  call vert_QA_Z(gZl,wf(:,-3),wf(:,24),wf(:,26))
  call vert_WQ_A(wf(:,5),wf(:,-3),wf(:,27))
  call prop_Q_A(wf(:,27),Q(:,13),ZERO,0_intkind1,wf(:,28))
  call vert_QA_Z(gZn,wf(:,28),wf(:,-1),wf(:,29))
  call vert_WQ_A(wf(:,4),wf(:,0),wf(:,30))
  call prop_Q_A(wf(:,30),Q(:,11),ZERO,0_intkind1,wf(:,31))
  call vert_QA_V(wf(:,31),wf(:,-2),wf(:,32))
  call vert_QA_Z(gZl,wf(:,31),wf(:,-2),wf(:,33))
...
end module ol_loop_ppllllj_nenmxexmddxg_1_/**/REALKIND
