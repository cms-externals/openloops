...
module ol_vamp_1_ppllllj_eeexexuuxg_1_/**/REALKIND
contains
...
! **********************************************************************
  ...
  call loop_QS_A(G2(:,:,:,1),wf(:,152),G2(:,:,:,2),gH)
  ...
  call loop_QZ_A(G2(:,:,:,1),wf(:,323),G2(:,:,:,4),gZu)
  ...
  call loop_QZ_A(G2(:,:,:,1),wf(:,324),G2(:,:,:,6),gZu)
  ...
  call loop_QZ_A(G2(:,:,:,1),wf(:,325),G2(:,:,:,8),gZu)
  ...
  call loop_AZ_Q(G3(:,:,:,22),wf(:,67),G3(:,:,:,24),gZu)
  ...
  call loop_QZ_A(G3(:,:,:,34),wf(:,67),G3(:,:,:,36),gZd)
  ...
  call loop_AZ_Q(G3(:,:,:,46),wf(:,67),G3(:,:,:,48),gZd)
  ...
  call loop_AZ_Q(G3(:,:,:,66),wf(:,67),G3(:,:,:,68),gZd)
  ...
  call loop_AV_Q(G2(:,:,:,297),wf(:,143),G2(:,:,:,298))
  ...
  call loop_AV_Q(G1(:,:,:,44),wf(:,143),G1(:,:,:,45))
  ...
  call loop_AV_Q(G2(:,:,:,301),wf(:,143),G2(:,:,:,302))
  ...
  call loop_QV_A(G1(:,:,:,47),wf(:,143),G1(:,:,:,48))
  ...
  call loop_QV_A(G2(:,:,:,305),wf(:,143),G2(:,:,:,306))
  ...
  call loop_QV_A(G1(:,:,:,50),wf(:,143),G1(:,:,:,51))
  ...
  call loop_QV_A(G2(:,:,:,309),wf(:,143),G2(:,:,:,310))
  ...
  call loop_AV_Q(G1(:,:,:,53),wf(:,143),G1(:,:,:,54))
  ...
  call loop_AV_Q(G2(:,:,:,313),wf(:,143),G2(:,:,:,314))
  ...
  call loop_QV_A(G1(:,:,:,56),wf(:,143),G1(:,:,:,57))
  ...
  call loop_QV_A(G2(:,:,:,317),wf(:,143),G2(:,:,:,318))
  ...
  call loop_AV_Q(G1(:,:,:,59),wf(:,143),G1(:,:,:,60))
  ...
  call loop_AV_Q(G2(:,:,:,321),wf(:,143),G2(:,:,:,322))
  ...
  call loop_AV_Q(G1(:,:,:,62),wf(:,143),G1(:,:,:,63))
  ...
  call loop_AV_Q(G2(:,:,:,325),wf(:,143),G2(:,:,:,326))
  ...
  call loop_QV_A(G1(:,:,:,65),wf(:,143),G1(:,:,:,66))
  ...
  call loop_QV_A(G2(:,:,:,329),wf(:,143),G2(:,:,:,330))
  ...
  call loop_QV_A(G1(:,:,:,68),wf(:,143),G1(:,:,:,69))
  ...
  call loop_QV_A(G2(:,:,:,333),wf(:,143),G2(:,:,:,334))
  ...
  call loop_AV_Q(G1(:,:,:,71),wf(:,143),G1(:,:,:,72))
  ...
  call loop_AV_Q(G2(:,:,:,337),wf(:,143),G2(:,:,:,338))
  ...
  call loop_AV_Q(G1(:,:,:,74),wf(:,143),G1(:,:,:,75))
  ...
  call loop_AV_Q(G2(:,:,:,341),wf(:,143),G2(:,:,:,342))
  ...
  call loop_QV_A(G1(:,:,:,77),wf(:,143),G1(:,:,:,78))
  ...
  call loop_QV_A(G2(:,:,:,345),wf(:,143),G2(:,:,:,346))
  ...
  call loop_QV_A(G1(:,:,:,80),wf(:,143),G1(:,:,:,81))
  ...
  call loop_QV_A(G2(:,:,:,349),wf(:,143),G2(:,:,:,350))
  ...
  Gcoeff = (-(c(17)*M(1))) * den(688)
  T4sum(1:70,1) = T4sum(1:70,1) + Gcoeff * G4tensor(:,34)
  Gcoeff = (-(c(14)*M(1))) * den(688)
  ...
  Gcoeff = (c(18)*M(1)) * den(689)
  T4sum(1:70,1) = T4sum(1:70,1) + Gcoeff * G4tensor(:,37)
  Gcoeff = (c(16)*M(1)) * den(689)
  ...
  Gcoeff = (c(14)*M(1)) * den(746)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,137)
  Gcoeff = (c(12)*M(1)) * den(746)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,104)
  Gcoeff = (c(14)*M(1)) * den(746)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,185)
  Gcoeff = (c(12)*M(1)) * den(746)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,70)
  Gcoeff = (c(18)*M(1)) * den(747)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,138)
  Gcoeff = (c(16)*M(1)) * den(747)
  ...
  Gcoeff = (-(c(17)*M(1))) * den(748)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,140)
  Gcoeff = (-(c(14)*M(1))) * den(748)
  ...
  Gcoeff = (-(c(14)*M(1))) * den(830)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,149)
  Gcoeff = (-(c(12)*M(1))) * den(830)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,113)
  Gcoeff = (-(c(14)*M(1))) * den(830)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,197)
  Gcoeff = (-(c(12)*M(1))) * den(830)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,79)
  Gcoeff = (-(c(18)*M(1))) * den(831)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,150)
  Gcoeff = (-(c(16)*M(1))) * den(831)
  ...
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,156)
  Gcoeff = (c(14)*M(1)) * den(835)
  ...
  Gcoeff = (-(c(18)*M(1))) * den(836)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,206)
  Gcoeff = (-(c(16)*M(1))) * den(836)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,85)
  Gcoeff = (-(c(18)*M(1))) * den(837)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,159)
  Gcoeff = (-(c(16)*M(1))) * den(837)
  T3sum(1:35,1) = T3sum(1:35,1) + Gcoeff * G3tensor(:,52)
  Gcoeff = (-(c(18)*M(1))) * den(837)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,207)
  Gcoeff = (-(c(16)*M(1))) * den(837)
  ...
  Gcoeff = (-(c(17)*M(1))) * den(878)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,173)
  Gcoeff = (-(c(14)*M(1))) * den(878)
  ...
  Gcoeff = (c(14)*M(1)) * den(878)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,173)
  Gcoeff = (c(12)*M(1)) * den(878)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,129)
  Gcoeff = (c(14)*M(1)) * den(878)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,221)
  Gcoeff = (c(12)*M(1)) * den(878)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,95)
  Gcoeff = (c(18)*M(1)) * den(879)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,174)
  Gcoeff = (c(16)*M(1)) * den(879)
  ...
  Gcoeff = (c(18)*M(1)) * den(879)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,175)
  Gcoeff = (c(16)*M(1)) * den(879)
  ...
  Gcoeff = (-(c(17)*M(1))) * den(880)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,176)
  Gcoeff = (-(c(14)*M(1))) * den(880)
  ...
  Gcoeff = (c(18)*M(1)) * den(881)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,178)
  Gcoeff = (c(16)*M(1)) * den(881)
  ...
  Gcoeff = (-(c(17)*M(1))) * den(882)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,179)
  Gcoeff = (-(c(14)*M(1))) * den(882)
  ...
  Gcoeff = (c(14)*M(1)) * den(882)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,179)
  Gcoeff = (c(12)*M(1)) * den(882)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,133)
  Gcoeff = (c(14)*M(1)) * den(882)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,227)
  Gcoeff = (c(12)*M(1)) * den(882)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,99)
  Gcoeff = (-(c(17)*M(1))) * den(883)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,180)
  Gcoeff = (-(c(14)*M(1))) * den(883)
  ...
  Gcoeff = (c(18)*M(1)) * den(885)
  T3sum(1:35,25) = T3sum(1:35,25) + Gcoeff * G3tensor(:,232)
  Gcoeff = (c(16)*M(1)) * den(885)
  T3sum(1:35,2) = T3sum(1:35,2) + Gcoeff * G3tensor(:,102)

end subroutine vamp_1

end module ol_vamp_1_ppllllj_eeexexuuxg_1_/**/REALKIND
