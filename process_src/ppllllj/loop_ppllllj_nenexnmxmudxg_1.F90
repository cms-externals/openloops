...
module ol_colourmatrix_ppllllj_nenexnmxmudxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nenexnmxmudxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nenexnmxmudxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nenexnmxmudxg_1_/**/REALKIND

module ol_loop_ppllllj_nenexnmxmudxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_WQ_A(wf(:,5),wf(:,0),wf(:,34))
  call prop_Q_A(wf(:,34),Q(:,13),ZERO,0_intkind1,wf(:,35))
  call vert_QA_W(wf(:,35),wf(:,-1),wf(:,36))
  call counter_WQ_A(wf(:,5),wf(:,6),wf(:,37))
  call counter_ZQ_A(gZu,wf(:,4),wf(:,6),wf(:,38))
  call counter_AW_Q(wf(:,17),wf(:,5),wf(:,39))
  call counter_AZ_Q(gZd,wf(:,17),wf(:,4),wf(:,40))
  call counter_VQ_A(wf(:,-6),wf(:,20),wf(:,41))
  call counter_VQ_A(wf(:,-6),wf(:,23),wf(:,42))
  call counter_VG_G(wf(:,4),wf(:,-6),Q(:,64),wf(:,43),Q(:,67))
  call vert_QA_V(wf(:,23),wf(:,-5),wf(:,44))
  call vert_QA_V(wf(:,-4),wf(:,12),wf(:,45))
  call counter_QA_W(wf(:,6),wf(:,-5),wf(:,46))
  call prop_W_W(wf(:,14),Q(:,15),MW,1_intkind1,wf(:,47))
  call counter_AW_Q(wf(:,-5),wf(:,5),wf(:,48))
  call prop_Q_A(wf(:,11),Q(:,83),ZERO,0_intkind1,wf(:,49))
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,4),wf(:,50))
  call prop_Q_A(wf(:,8),Q(:,92),ZERO,0_intkind1,wf(:,51))
  call prop_A_Q(wf(:,48),Q(:,44),ZERO,0_intkind1,wf(:,52))
  call prop_A_Q(wf(:,50),Q(:,35),ZERO,0_intkind1,wf(:,53))
  call counter_AV_Q(wf(:,-5),wf(:,-6),wf(:,54))
  call prop_A_Q(wf(:,54),Q(:,96),ZERO,0_intkind1,wf(:,55))
  call vert_AW_Q(wf(:,55),wf(:,5),wf(:,56))
  call vert_AZ_Q(gZd,wf(:,55),wf(:,4),wf(:,57))
  call vert_QA_W(wf(:,-4),wf(:,55),wf(:,58))
  call prop_W_W(wf(:,58),Q(:,112),MW,1_intkind1,wf(:,59))
  call counter_QA_W(wf(:,-4),wf(:,17),wf(:,60))
  call counter_WQ_A(wf(:,5),wf(:,-4),wf(:,61))
  call prop_A_Q(wf(:,22),Q(:,99),ZERO,0_intkind1,wf(:,62))
  call counter_ZQ_A(gZu,wf(:,4),wf(:,-4),wf(:,63))
  call prop_A_Q(wf(:,19),Q(:,108),ZERO,0_intkind1,wf(:,64))
  call prop_Q_A(wf(:,61),Q(:,28),ZERO,0_intkind1,wf(:,65))
  call vert_VQ_A(wf(:,-6),wf(:,65),wf(:,66))
  call prop_Q_A(wf(:,63),Q(:,19),ZERO,0_intkind1,wf(:,67))
  call vert_VQ_A(wf(:,-6),wf(:,67),wf(:,68))
  call counter_VQ_A(wf(:,-6),wf(:,-4),wf(:,69))
  call prop_Q_A(wf(:,69),Q(:,80),ZERO,0_intkind1,wf(:,70))
  call vert_WQ_A(wf(:,5),wf(:,70),wf(:,71))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,70),wf(:,72))
  call vert_QA_W(wf(:,70),wf(:,-5),wf(:,73))
  ...
  call counter_Q_A(ctqq,wf(:,6),Q(:,80),wf(:,77))
  call prop_Q_A(wf(:,77),Q(:,80),ZERO,0_intkind1,wf(:,78))
  call vert_QA_W(wf(:,78),wf(:,-5),wf(:,79))
  call vert_WQ_A(wf(:,5),wf(:,78),wf(:,80))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,78),wf(:,81))
  call counter_A_Q(ctqq,wf(:,9),Q(:,35),wf(:,82))
  call counter_A_Q(ctqq,wf(:,12),Q(:,44),wf(:,83))
  call counter_A_Q(ctqq,wf(:,17),Q(:,96),wf(:,84))
  call prop_A_Q(wf(:,84),Q(:,96),ZERO,0_intkind1,wf(:,85))
  call vert_QA_W(wf(:,-4),wf(:,85),wf(:,86))
  call counter_Q_A(ctqq,wf(:,20),Q(:,19),wf(:,87))
  call counter_Q_A(ctqq,wf(:,23),Q(:,28),wf(:,88))
  call vert_AW_Q(wf(:,85),wf(:,5),wf(:,89))
  call vert_AZ_Q(gZd,wf(:,85),wf(:,4),wf(:,90))
  call vert_AV_Q(wf(:,12),wf(:,-6),wf(:,91))
  call prop_A_Q(wf(:,91),Q(:,108),ZERO,0_intkind1,wf(:,92))
  call vert_AV_Q(wf(:,9),wf(:,-6),wf(:,93))
  call prop_A_Q(wf(:,93),Q(:,99),ZERO,0_intkind1,wf(:,94))
  call prop_Q_A(wf(:,26),Q(:,83),ZERO,0_intkind1,wf(:,95))
  call prop_Q_A(wf(:,27),Q(:,92),ZERO,0_intkind1,wf(:,96))
  ...
  call vert_WQ_A(wf(:,5),wf(:,20),wf(:,100))
  call prop_Q_A(wf(:,100),Q(:,31),ZERO,0_intkind1,wf(:,101))
  call vert_AW_Q(wf(:,9),wf(:,5),wf(:,102))
  call prop_A_Q(wf(:,102),Q(:,47),ZERO,0_intkind1,wf(:,103))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,23),wf(:,104))
  call prop_Q_A(wf(:,104),Q(:,31),ZERO,0_intkind1,wf(:,105))
  call vert_AZ_Q(gZu,wf(:,12),wf(:,4),wf(:,106))
  call prop_A_Q(wf(:,106),Q(:,47),ZERO,0_intkind1,wf(:,107))
  call vert_WQ_A(wf(:,47),wf(:,-4),wf(:,108))
  call prop_Q_A(wf(:,108),Q(:,31),ZERO,0_intkind1,wf(:,109))
  call vert_AW_Q(wf(:,-5),wf(:,47),wf(:,110))
  call prop_A_Q(wf(:,110),Q(:,47),ZERO,0_intkind1,wf(:,111))
  call vert_WQ_A(wf(:,97),wf(:,-4),wf(:,112))
  call prop_Q_A(wf(:,112),Q(:,31),ZERO,0_intkind1,wf(:,113))
  call vert_AW_Q(wf(:,-5),wf(:,97),wf(:,114))
  call prop_A_Q(wf(:,114),Q(:,47),ZERO,0_intkind1,wf(:,115))
  call vert_WQ_A(wf(:,98),wf(:,-4),wf(:,116))
  call prop_Q_A(wf(:,116),Q(:,31),ZERO,0_intkind1,wf(:,117))
  call vert_AW_Q(wf(:,-5),wf(:,98),wf(:,118))
  call prop_A_Q(wf(:,118),Q(:,47),ZERO,0_intkind1,wf(:,119))
  call vert_WQ_A(wf(:,99),wf(:,-4),wf(:,120))
  call prop_Q_A(wf(:,120),Q(:,31),ZERO,0_intkind1,wf(:,121))
  call vert_AW_Q(wf(:,-5),wf(:,99),wf(:,122))
  call prop_A_Q(wf(:,122),Q(:,47),ZERO,0_intkind1,wf(:,123))
...
subroutine denominators()
  ...
  den(102) = den(1)*den(23)
  den(103) = den(95)*den(102)
  den(104) = den(10)*den(100)
  den(105) = den(1)*den(10)
  den(106) = den(98)*den(105)
  den(107) = den(46)*den(95)
  den(108) = den(46)*den(98)
  den(109) = den(85)*den(95)
  den(110) = den(85)*den(98)
  den(111) = den(87)*den(95)
  den(112) = den(87)*den(98)
  den(113) = den(91)*den(95)
  den(114) = den(91)*den(98)
  ...
  den(121) = den(2)*den(81)
  den(122) = den(2)*den(79)
  den(123) = den(1)*den(101)
  den(124) = den(1)*den(83)
  den(125) = den(1)*den(104)
  ...
  den(133) = den(3)*den(99)
  den(134) = den(3)*den(106)
  den(135) = den(3)*den(108)
  den(136) = den(16)*den(96)
  den(137) = den(16)*den(103)
...
subroutine diagrams(A)
  ...
  A(20) = cont_QA(wf(:,9),wf(:,42)) * den(28)
  A(21) = cont_VV(wf(:,43),wf(:,44)) * den(43)
  A(22) = cont_VV(wf(:,43),wf(:,45)) * den(44)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(69)+A(70))*f(2)+(-A(48)-A(50))*f(3)+(-A(47)-A(49))*f(4)+(A(51)+A(56))*f(6)+(-A(30)-A(38))*f(7)+(-A(23)-A(31))*f(8) &
       +(A(52)+A(53)+A(54)+A(55)+A(57)+A(58)+A(59)+A(60)+A(61)+A(62)+A(63)+A(64)+A(65)+A(66)+A(67)+A(68))*f(10)+(-A(19)-A(20) &
       -A(28)-A(29)-A(36)-A(37)-A(41)-A(42)-A(45)-A(46))*f(11)+(-A(15)-A(16)-A(17)-A(18)-A(24)-A(25)-A(26)-A(27)-A(32)-A(33)-A(34) &
       -A(35)-A(39)-A(40)-A(43)-A(44))*f(12)+(A(21)+A(22))*f(13)

end subroutine colourvectors

end module ol_loop_ppllllj_nenexnmxmudxg_1_/**/REALKIND
