...
module ol_colourmatrix_ppllllj_eexmmxddxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_eexmmxddxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_eexmmxddxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_eexmmxddxg_1_/**/REALKIND

module ol_loop_ppllllj_eexmmxddxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call counter_ZQ_A(gZd,wf(:,9),wf(:,4),wf(:,85))
  call counter_VQ_A(wf(:,1),wf(:,4),wf(:,86))
  call counter_ZQ_A(gZd,wf(:,12),wf(:,4),wf(:,87))
  call counter_AV_Q(wf(:,22),wf(:,2),wf(:,88))
  call counter_AZ_Q(gZd,wf(:,22),wf(:,9),wf(:,89))
  call counter_AV_Q(wf(:,22),wf(:,1),wf(:,90))
  call counter_AZ_Q(gZd,wf(:,22),wf(:,12),wf(:,91))
  ...
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,9),wf(:,108))
  ...
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,12),wf(:,113))
  ...
  call counter_ZQ_A(gZd,wf(:,12),wf(:,-4),wf(:,131))
  ...
  call vert_ZQ_A(gZd,wf(:,9),wf(:,141),wf(:,143))
  call vert_VQ_A(wf(:,1),wf(:,141),wf(:,144))
  call vert_ZQ_A(gZd,wf(:,12),wf(:,141),wf(:,145))
  ...
  call vert_ZQ_A(gZd,wf(:,9),wf(:,161),wf(:,163))
  call vert_VQ_A(wf(:,1),wf(:,161),wf(:,164))
  call vert_ZQ_A(gZd,wf(:,12),wf(:,161),wf(:,165))
  ...
  call vert_AZ_Q(gZd,wf(:,175),wf(:,9),wf(:,177))
  call vert_AV_Q(wf(:,175),wf(:,1),wf(:,178))
  call vert_AZ_Q(gZd,wf(:,175),wf(:,12),wf(:,179))
  ...
  call vert_QA_Z(gZd,wf(:,161),wf(:,-5),wf(:,193))
  ...
  call vert_QA_Z(gZd,wf(:,-4),wf(:,175),wf(:,199))
  ...
  call vert_ZQ_A(gZd,wf(:,9),wf(:,25),wf(:,206))
  ...
  call vert_ZQ_A(gZd,wf(:,9),wf(:,28),wf(:,210))
  ...
  call vert_AZ_Q(gZd,wf(:,7),wf(:,9),wf(:,214))
  ...
  call vert_AZ_Q(gZd,wf(:,14),wf(:,9),wf(:,218))
  ...
  call vert_ZQ_A(gZd,wf(:,12),wf(:,31),wf(:,224))
  call prop_Q_A(wf(:,224),Q(:,31),ZERO,0_intkind1,wf(:,225))
  call vert_ZQ_A(gZd,wf(:,12),wf(:,33),wf(:,226))
  ...
  call vert_AZ_Q(gZd,wf(:,17),wf(:,12),wf(:,232))
  call prop_A_Q(wf(:,232),Q(:,47),ZERO,0_intkind1,wf(:,233))
  call vert_AZ_Q(gZd,wf(:,19),wf(:,12),wf(:,234))
  ...
  call vert_ZQ_A(gZd,wf(:,194),wf(:,-4),wf(:,238))
  ...
  call vert_ZQ_A(gZd,wf(:,195),wf(:,-4),wf(:,242))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,194),wf(:,246))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,195),wf(:,250))
  ...
  call vert_ZQ_A(gZd,wf(:,196),wf(:,-4),wf(:,254))
  ...
  call vert_ZQ_A(gZd,wf(:,197),wf(:,-4),wf(:,258))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,196),wf(:,262))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,197),wf(:,266))
  ...
  call vert_ZQ_A(gZd,wf(:,200),wf(:,-4),wf(:,270))
  ...
  call vert_ZQ_A(gZd,wf(:,201),wf(:,-4),wf(:,274))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,200),wf(:,278))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,201),wf(:,282))
  ...
  call vert_ZQ_A(gZd,wf(:,202),wf(:,-4),wf(:,288))
  call prop_Q_A(wf(:,288),Q(:,31),ZERO,0_intkind1,wf(:,289))
  call vert_ZQ_A(gZd,wf(:,203),wf(:,-4),wf(:,290))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,202),wf(:,296))
  call prop_A_Q(wf(:,296),Q(:,47),ZERO,0_intkind1,wf(:,297))
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,203),wf(:,298))
...
subroutine diagrams(A)
  ...
  implicit none
  complex(REALKIND), intent(out) :: A(293)
...
subroutine colourvectors(A, M1, M2)
  ...
  use ol_parameters_decl_/**/REALKIND, only: CI
  implicit none
  complex(REALKIND), intent(in) :: A(293)
  complex(REALKIND), intent(out) :: M1(1), M2(1)

  M1(1) = (A(1)+A(5)+A(9)+A(13)+A(17)+A(21))*f(1)+(A(2)+A(3)+A(6)+A(7)+A(10)+A(11)+A(14)+A(15)+A(18)+A(19)+A(22)+A(23)+A(25)+A(27) &
       +A(29)+A(31)+A(33)+A(35)+A(37)+A(39)+A(41)+A(43)+A(45)+A(46)+A(49)+A(51)+A(53)+A(54))*f(2)+(A(4)+A(8)+A(12)+A(16)+A(20) &
       +A(24)+A(26)+A(28)+A(30)+A(32)+A(34)+A(36)+A(38)+A(40)+A(42)+A(44)+A(47)+A(48)+A(50)+A(52)+A(55)+A(56))*f(3)

  M2(1) = (-A(214)-A(218)-A(222)-A(226)-A(230)-A(234)-A(238)-A(242)-A(246)-A(250)-A(254)-A(258))*f(4)+(-A(215)-A(216)-A(219) &
       -A(220)-A(223)-A(224)-A(227)-A(228)-A(231)-A(232)-A(235)-A(236)-A(239)-A(240)-A(243)-A(244)-A(247)-A(248)-A(251)-A(252) &
       -A(255)-A(256)-A(259)-A(260)-A(262)-A(264)-A(266)-A(268)-A(270)-A(272)-A(274)-A(276)-A(278)-A(280)-A(282)-A(283)-A(286) &
       -A(288)-A(290)-A(291))*f(5)+(-A(217)-A(221)-A(225)-A(229)-A(233)-A(237)-A(241)-A(245)-A(249)-A(253)-A(257)-A(261)-A(263) &
       -A(265)-A(267)-A(269)-A(271)-A(273)-A(275)-A(277)-A(279)-A(281)-A(284)-A(285)-A(287)-A(289)-A(292)-A(293))*f(6)+A(57)*f(7) &
       +(A(58)+A(59))*f(8)+(A(78)+A(84)+A(110)+A(114)+A(134)+A(138))*f(9)+(A(79)+A(80)+A(85)+A(86)+A(111)+A(112)+A(115)+A(116) &
       +A(135)+A(136)+A(139)+A(140)+A(154)+A(156)+A(158)+A(160)+A(170)+A(172)+A(174)+A(176)+A(190)+A(192)+A(194)+A(195)+A(206) &
       +A(208)+A(210)+A(211))*f(10)+(A(81)+A(87)+A(113)+A(117)+A(137)+A(141)+A(155)+A(157)+A(159)+A(161)+A(171)+A(173)+A(175) &
       +A(177)+A(191)+A(193)+A(196)+A(197)+A(207)+A(209)+A(212)+A(213))*f(11)+(A(62)+A(66)+A(70)+A(74)+A(94)+A(98)+A(102)+A(106) &
       +A(118)+A(122)+A(126)+A(130))*f(12)+(A(63)+A(64)+A(67)+A(68)+A(71)+A(72)+A(75)+A(76)+A(95)+A(96)+A(99)+A(100)+A(103)+A(104) &
...
end module ol_loop_ppllllj_eexmmxddxg_1_/**/REALKIND
