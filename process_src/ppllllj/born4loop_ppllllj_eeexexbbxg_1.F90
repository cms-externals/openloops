...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllllj_eeexexbbxg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
...
! **********************************************************************
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllllj_eeexexbbxg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllllj_eeexexbbxg_1(-I)
  end if
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllllj_eeexexbbxg_1")
