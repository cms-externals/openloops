...
module ol_colourmatrix_ppllllj_nenexeexddxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nenexeexddxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nenexeexddxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nenexeexddxg_1_/**/REALKIND

module ol_loop_ppllllj_nenexeexddxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(23) = (CI*eQED**4*gQCD)/(6._/**/REALKIND*sw**2)
    f(24) = (CI*eQED**4*gQCD)/(2._/**/REALKIND*sw**2)
    f(25) = (CI*countertermnorm*eQED**4*gQCD**3)/(6._/**/REALKIND*sw**2)
    f(26) = (CI*countertermnorm*eQED**4*gQCD**3)/(2._/**/REALKIND*sw**2)
    f(27) = (CI*countertermnorm*ctGqq*eQED**4*gQCD**3)/(6._/**/REALKIND*sw**2)
    f(28) = (CI*countertermnorm*ctGqq*eQED**4*gQCD**3)/(2._/**/REALKIND*sw**2)
    f(29) = (CI*countertermnorm*ctVqq*eQED**4*gQCD**3)/(6._/**/REALKIND*sw**2)
    ...
    f(34) = (CI*eQED**4*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(35) = CI*eQED**4*gQCD**3*integralnorm*SwB
    f(36) = (eQED**4*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    ...
    f(42) = (CI*eQED**4*gQCD**3*integralnorm*SwB)/(6._/**/REALKIND*sw**2)
    f(43) = (CI*eQED**4*gQCD**3*integralnorm*SwB)/(2._/**/REALKIND*sw**2)
    f(44) = (eQED**4*gQCD**3*integralnorm*SwB)/(sw**2*6._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_VVG_G(wf(:,47),wf(:,48),wf(:,-6),wf(:,80))
  call vert_VV_S(wf(:,4),wf(:,10),wf(:,81))
  call counter_GG_S(wf(:,77),wf(:,-6),wf(:,82))
  call counter_VQ_A(wf(:,2),wf(:,5),wf(:,83))
  call counter_ZQ_A(gZd,wf(:,10),wf(:,5),wf(:,84))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,5),wf(:,85))
  call counter_AV_Q(wf(:,18),wf(:,2),wf(:,86))
  call counter_AZ_Q(gZd,wf(:,18),wf(:,10),wf(:,87))
  call counter_AZ_Q(gZd,wf(:,18),wf(:,4),wf(:,88))
  ...
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,10),wf(:,102))
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,4),wf(:,103))
  ...
  call vert_AZ_Q(gZd,wf(:,110),wf(:,10),wf(:,112))
  call vert_AZ_Q(gZd,wf(:,110),wf(:,4),wf(:,113))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,114))
  call prop_A_Q(wf(:,24),Q(:,99),ZERO,0_intkind1,wf(:,115))
  call counter_ZQ_A(gZd,wf(:,10),wf(:,-4),wf(:,116))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,-4),wf(:,117))
  ...
  call vert_ZQ_A(gZd,wf(:,10),wf(:,127),wf(:,129))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,127),wf(:,130))
  ...
  call prop_Q_A(wf(:,50),Q(:,89),ZERO,0_intkind1,wf(:,151))
  call prop_A_Q(wf(:,150),Q(:,38),ZERO,0_intkind1,wf(:,152))
  call vert_AW_Q(wf(:,110),wf(:,47),wf(:,153))
  call counter_WQ_A(wf(:,48),wf(:,-4),wf(:,154))
  call prop_A_Q(wf(:,54),Q(:,102),ZERO,0_intkind1,wf(:,155))
  call prop_Q_A(wf(:,154),Q(:,25),ZERO,0_intkind1,wf(:,156))
  ...
  call vert_ZQ_A(gZd,wf(:,10),wf(:,160),wf(:,162))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,160),wf(:,163))
  ...
  call vert_AZ_Q(gZd,wf(:,171),wf(:,10),wf(:,173))
  call vert_AZ_Q(gZd,wf(:,171),wf(:,4),wf(:,174))
  ...
  call vert_QA_Z(gZd,wf(:,160),wf(:,-5),wf(:,185))
  ...
  call vert_QA_Z(gZd,wf(:,-4),wf(:,171),wf(:,189))
  call vert_WQ_A(wf(:,48),wf(:,160),wf(:,190))
  call counter_A_Q(ctqq,wf(:,51),Q(:,38),wf(:,191))
  call counter_Q_A(ctqq,wf(:,55),Q(:,25),wf(:,192))
  call vert_AW_Q(wf(:,171),wf(:,47),wf(:,193))
  call vert_AV_Q(wf(:,51),wf(:,-6),wf(:,194))
  call prop_A_Q(wf(:,194),Q(:,102),ZERO,0_intkind1,wf(:,195))
  call prop_Q_A(wf(:,56),Q(:,89),ZERO,0_intkind1,wf(:,196))
  ...
  call vert_ZQ_A(gZd,wf(:,10),wf(:,21),wf(:,205))
  ...
  call vert_ZQ_A(gZd,wf(:,186),wf(:,-4),wf(:,221))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,186),wf(:,225))
  ...
  call vert_ZQ_A(gZd,wf(:,187),wf(:,-4),wf(:,229))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,187),wf(:,233))
  call prop_A_Q(wf(:,233),Q(:,47),ZERO,0_intkind1,wf(:,234))
  call vert_WQ_A(wf(:,47),wf(:,55),wf(:,235))
  call prop_Q_A(wf(:,235),Q(:,31),ZERO,0_intkind1,wf(:,236))
  call vert_AW_Q(wf(:,51),wf(:,48),wf(:,237))
  ...
  call vert_ZQ_A(gZd,wf(:,146),wf(:,-4),wf(:,241))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,146),wf(:,245))
  ...
  call vert_ZQ_A(gZd,wf(:,197),wf(:,-4),wf(:,249))
  ...
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,197),wf(:,253))
  call prop_A_Q(wf(:,253),Q(:,47),ZERO,0_intkind1,wf(:,254))
  call vert_ZQ_A(gZd,wf(:,198),wf(:,-4),wf(:,255))
  call prop_Q_A(wf(:,255),Q(:,31),ZERO,0_intkind1,wf(:,256))
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,198),wf(:,257))
  ...
  call vert_ZQ_A(gZd,wf(:,199),wf(:,-4),wf(:,261))
...
subroutine denominators()
  ...
  den(277) = den(52)*den(63)
  den(278) = den(246)*den(277)
  den(279) = den(53)*den(56)
  den(280) = den(252)*den(279)
  ...
  den(349) = den(52)*den(217)
  den(350) = den(53)*den(215)
  ...
  den(391) = den(3)*den(280)
  den(392) = den(3)*den(283)
  den(393) = den(3)*den(284)
  den(394) = den(17)*den(278)
...
end module ol_loop_ppllllj_nenexeexddxg_1_/**/REALKIND
