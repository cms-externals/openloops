...
module ol_colourmatrix_ppllllj_nmnmxeexuuxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nmnmxeexuuxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nmnmxeexuuxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nmnmxeexuuxg_1_/**/REALKIND

module ol_loop_ppllllj_nmnmxeexuuxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(14) = (2*CI*eQED**4*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
    f(15) = CI*eQED**4*gQCD**3*integralnorm*SwB
    f(16) = (2*eQED**4*gQCD**3*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_ZQ_A(gZu,wf(:,10),wf(:,5),wf(:,57))
  call counter_ZQ_A(gZu,wf(:,4),wf(:,5),wf(:,58))
  call counter_AV_Q(wf(:,18),wf(:,2),wf(:,59))
  call counter_AZ_Q(gZu,wf(:,18),wf(:,10),wf(:,60))
  call counter_AZ_Q(gZu,wf(:,18),wf(:,4),wf(:,61))
  ...
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,10),wf(:,75))
  call counter_AZ_Q(gZu,wf(:,-5),wf(:,4),wf(:,76))
  ...
  call vert_AZ_Q(gZu,wf(:,83),wf(:,10),wf(:,85))
  call vert_AZ_Q(gZu,wf(:,83),wf(:,4),wf(:,86))
  call counter_VQ_A(wf(:,2),wf(:,-4),wf(:,87))
  call prop_A_Q(wf(:,24),Q(:,99),ZERO,0_intkind1,wf(:,88))
  call counter_ZQ_A(gZu,wf(:,10),wf(:,-4),wf(:,89))
  call counter_ZQ_A(gZu,wf(:,4),wf(:,-4),wf(:,90))
  ...
  call vert_ZQ_A(gZu,wf(:,10),wf(:,100),wf(:,102))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,100),wf(:,103))
  ...
  call vert_ZQ_A(gZu,wf(:,10),wf(:,119),wf(:,121))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,119),wf(:,122))
  ...
  call vert_AZ_Q(gZu,wf(:,130),wf(:,10),wf(:,132))
  call vert_AZ_Q(gZu,wf(:,130),wf(:,4),wf(:,133))
  ...
  call vert_QA_Z(gZu,wf(:,119),wf(:,-5),wf(:,144))
  ...
  call vert_QA_Z(gZu,wf(:,-4),wf(:,130),wf(:,148))
  ...
  call vert_ZQ_A(gZu,wf(:,10),wf(:,21),wf(:,153))
  ...
  call vert_ZQ_A(gZu,wf(:,145),wf(:,-4),wf(:,169))
  ...
  call vert_AZ_Q(gZu,wf(:,-5),wf(:,145),wf(:,173))
  ...
  call vert_ZQ_A(gZu,wf(:,146),wf(:,-4),wf(:,177))
...
end module ol_loop_ppllllj_nmnmxeexuuxg_1_/**/REALKIND
