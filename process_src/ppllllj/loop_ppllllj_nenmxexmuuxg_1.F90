...
module ol_colourmatrix_ppllllj_nenmxexmuuxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nenmxexmuuxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nenmxexmuuxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nenmxexmuuxg_1_/**/REALKIND

module ol_loop_ppllllj_nenmxexmuuxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_UV_W(wf(:,4),Q(:,5),wf(:,5),Q(:,10),wf(:,11))
  ...
  call vert_AW_Q(wf(:,-1),wf(:,4),wf(:,23))
...
end module ol_loop_ppllllj_nenmxexmuuxg_1_/**/REALKIND
