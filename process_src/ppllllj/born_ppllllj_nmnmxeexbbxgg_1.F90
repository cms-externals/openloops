...
module ol_colourmatrix_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND

module ol_tree_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND, DREALKIND, intkind1, intkind2
  implicit none
  integer,           save :: factors_status = -1
  complex(REALKIND), save :: f(6)
  complex(REALKIND), save :: den(222)
#ifdef PRECISION_dp
...
subroutine factors_init()
  ...
  ! factors of the diagrams
    ...
    f(4) = eQED**4*gQCD**2
    f(5) = (CI*eQED**4*gQCD**2*MB)/(2._/**/REALKIND*cw**2*sw**2)
    f(6) = (eQED**4*gQCD**2*MB)/(cw**2*sw**2*2._/**/REALKIND)
...
subroutine born_denominators_init()
  ...
  den(203) = den(159)*den(202)
  den(205) = den(2)*den(204)
  den(206) = den(159)*den(205)
  den(207) = den(168)*den(202)
  den(208) = den(28)*den(207)
  den(209) = den(168)*den(205)
  den(210) = den(28)*den(209)
  den(211) = den(177)*den(202)
  den(212) = den(177)*den(205)
  den(213) = den(74)*den(207)
  den(214) = den(74)*den(209)
  den(215) = den(89)*den(207)
  den(216) = den(89)*den(209)
  den(217) = den(107)*den(207)
  den(218) = den(107)*den(209)
  den(219) = den(120)*den(207)
  den(220) = den(127)*den(207)
  den(221) = den(120)*den(209)
  den(222) = den(127)*den(209)
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllllj_nmnmxeexbbxgg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllllj_nmnmxeexbbxgg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for nu_mu anti-nu_mu e- e+ bottom anti-bottom glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppllllj_nmnmxeexbbxgg_1, only: external_perm_ppllllj_nmnmxeexbbxgg_1, &
    & external_perm_inv_ppllllj_nmnmxeexbbxgg_1, extcomb_perm_ppllllj_nmnmxeexbbxgg_1, &
    & average_factor_ppllllj_nmnmxeexbbxgg_1
  use ol_external_ppllllj_nmnmxeexbbxgg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppllllj_nmnmxeexbbxgg_1
  ...
  type(wfun) :: wf4(4,14), wf8(8,32), wf16(16,79), wf32(32,11), wf64(64,4), wf256(256,116)

  type(polcont) :: A(256,116)
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppllllj_nmnmxeexbbxgg_1,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllllj_nmnmxeexbbxgg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllllj_nmnmxeexbbxgg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllllj_nmnmxeexbbxgg_1(extcombs(k))
  end do
  ...
  call vert_ZQ_A(gZn,ntry, wf4(:,6), ex1, wf8(:,29), n3(:,91), t3x8(:,:,15))
  call prop_Q_A(ntry, wf8(:,29), Q(:,13), ZERO, 0_intkind1, wf8(:,30), n2(43))
  call vert_QA_Z(gZn,ntry, wf8(:,30), ex2, wf16(:,76), n3(:,92), t3x16(:,:,54))
  call vert_AZ_Q(gZn,ntry, ex2, wf4(:,6), wf8(:,31), n3(:,93), t3x8(:,:,16))
  call prop_A_Q(ntry, wf8(:,31), Q(:,14), ZERO, 0_intkind1, wf8(:,32), n2(44))
  call vert_QA_Z(gZn,ntry, ex1, wf8(:,32), wf16(:,77), n3(:,94), t3x16(:,:,55))
  call prop_W_W(ntry, wf16(:,76), Q(:,15), MZ, 1_intkind1, wf16(:,78), n2(45))
  call prop_W_W(ntry, wf16(:,77), Q(:,15), MZ, 1_intkind1, wf16(:,79), n2(46))
  ...
  M2add = M2 / average_factor_ppllllj_nmnmxeexbbxgg_1

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_ppllllj_nmnmxeexbbxgg_1(k))
  end do
...
subroutine diagrams()
  ...
  ! e.g. call cont_VV(nsync, wf3, wf6, A(:,1), n64, t64, nhel, den(5)) ...
    ...
    call cont_SS(nsync, wf16(:,1), wf16(:,2), A(:,1), n3(:,95), t3x256(:,:,1), nhel, den(9))
    call cont_QA(nsync, wf16(:,4), wf16(:,5), A(:,2), n3(:,96), t3x256(:,:,2), nhel, den(15))
    call cont_QA(nsync, wf16(:,5), wf16(:,6), A(:,3), n3(:,97), t3x256(:,:,3), nhel, den(17))
    call cont_QA(nsync, wf16(:,8), wf16(:,9), A(:,4), n3(:,98), t3x256(:,:,4), nhel, den(22))
    call cont_QA(nsync, wf16(:,9), wf16(:,10), A(:,5), n3(:,99), t3x256(:,:,5), nhel, den(24))
    call cont_QA(nsync, wf8(:,4), wf32(:,1), A(:,6), n3(:,100), t3x256(:,:,6), nhel, den(30))
    call cont_QA(nsync, wf8(:,4), wf32(:,2), A(:,7), n3(:,101), t3x256(:,:,7), nhel, den(32))
    call cont_QA(nsync, wf16(:,11), wf16(:,12), A(:,8), n3(:,102), t3x256(:,:,8), nhel, den(35))
    call cont_QA(nsync, wf16(:,12), wf16(:,13), A(:,9), n3(:,103), t3x256(:,:,9), nhel, den(37))
    call cont_QA(nsync, wf8(:,4), wf32(:,3), A(:,10), n3(:,104), t3x256(:,:,10), nhel, den(41))
    call cont_QA(nsync, wf8(:,4), wf32(:,4), A(:,11), n3(:,105), t3x256(:,:,11), nhel, den(44))
    call cont_QA(nsync, wf16(:,5), wf16(:,14), A(:,12), n3(:,106), t3x256(:,:,12), nhel, den(45))
    call cont_QA(nsync, wf16(:,5), wf16(:,15), A(:,13), n3(:,107), t3x256(:,:,13), nhel, den(46))
    call cont_SS(nsync, wf16(:,1), wf16(:,16), A(:,14), n3(:,108), t3x256(:,:,14), nhel, den(47))
    call cont_SS(nsync, wf16(:,1), wf16(:,17), A(:,15), n3(:,109), t3x256(:,:,15), nhel, den(51))
    call cont_QA(nsync, wf16(:,19), wf16(:,20), A(:,16), n3(:,110), t3x256(:,:,16), nhel, den(56))
    call cont_QA(nsync, wf16(:,20), wf16(:,21), A(:,17), n3(:,111), t3x256(:,:,17), nhel, den(58))
    call cont_QA(nsync, wf16(:,23), wf16(:,24), A(:,18), n3(:,112), t3x256(:,:,18), nhel, den(63))
    call cont_QA(nsync, wf16(:,24), wf16(:,25), A(:,19), n3(:,113), t3x256(:,:,19), nhel, den(65))
    call cont_QA(nsync, wf16(:,26), wf16(:,27), A(:,20), n3(:,114), t3x256(:,:,20), nhel, den(70))
    call cont_QA(nsync, wf16(:,27), wf16(:,28), A(:,21), n3(:,115), t3x256(:,:,21), nhel, den(72))
    call cont_QA(nsync, wf8(:,12), wf32(:,5), A(:,22), n3(:,116), t3x256(:,:,22), nhel, den(76))
    call cont_QA(nsync, wf8(:,12), wf32(:,6), A(:,23), n3(:,117), t3x256(:,:,23), nhel, den(78))
    call cont_QA(nsync, wf16(:,24), wf16(:,29), A(:,24), n3(:,118), t3x256(:,:,24), nhel, den(81))
    call cont_QA(nsync, wf16(:,24), wf16(:,30), A(:,25), n3(:,119), t3x256(:,:,25), nhel, den(83))
    call cont_QA(nsync, wf8(:,12), wf32(:,7), A(:,26), n3(:,120), t3x256(:,:,26), nhel, den(85))
    call cont_QA(nsync, wf8(:,12), wf32(:,8), A(:,27), n3(:,121), t3x256(:,:,27), nhel, den(87))
    call cont_SS(nsync, wf16(:,1), wf16(:,31), A(:,28), n3(:,122), t3x256(:,:,28), nhel, den(88))
    call cont_QA(nsync, wf32(:,1), wf8(:,18), A(:,29), n3(:,123), t3x256(:,:,29), nhel, den(90))
    call cont_QA(nsync, wf32(:,2), wf8(:,18), A(:,30), n3(:,124), t3x256(:,:,30), nhel, den(91))
    call cont_QA(nsync, wf16(:,32), wf16(:,33), A(:,31), n3(:,125), t3x256(:,:,31), nhel, den(94))
    call cont_QA(nsync, wf16(:,33), wf16(:,34), A(:,32), n3(:,126), t3x256(:,:,32), nhel, den(96))
    call cont_QA(nsync, wf32(:,3), wf8(:,18), A(:,33), n3(:,127), t3x256(:,:,33), nhel, den(97))
    call cont_QA(nsync, wf32(:,4), wf8(:,18), A(:,34), n3(:,128), t3x256(:,:,34), nhel, den(98))
    call cont_QA(nsync, wf16(:,20), wf16(:,35), A(:,35), n3(:,129), t3x256(:,:,35), nhel, den(99))
    call cont_QA(nsync, wf16(:,20), wf16(:,36), A(:,36), n3(:,130), t3x256(:,:,36), nhel, den(100))
    call cont_SS(nsync, wf16(:,1), wf16(:,37), A(:,37), n3(:,131), t3x256(:,:,37), nhel, den(101))
    call cont_QA(nsync, wf16(:,38), wf16(:,39), A(:,38), n3(:,132), t3x256(:,:,38), nhel, den(104))
    call cont_QA(nsync, wf16(:,39), wf16(:,40), A(:,39), n3(:,133), t3x256(:,:,39), nhel, den(106))
    call cont_QA(nsync, wf32(:,5), wf8(:,20), A(:,40), n3(:,134), t3x256(:,:,40), nhel, den(108))
    call cont_QA(nsync, wf32(:,6), wf8(:,20), A(:,41), n3(:,135), t3x256(:,:,41), nhel, den(109))
    call cont_QA(nsync, wf16(:,9), wf16(:,41), A(:,42), n3(:,136), t3x256(:,:,42), nhel, den(110))
    call cont_QA(nsync, wf16(:,9), wf16(:,42), A(:,43), n3(:,137), t3x256(:,:,43), nhel, den(111))
    call cont_QA(nsync, wf32(:,7), wf8(:,20), A(:,44), n3(:,138), t3x256(:,:,44), nhel, den(112))
    call cont_QA(nsync, wf32(:,8), wf8(:,20), A(:,45), n3(:,139), t3x256(:,:,45), nhel, den(113))
    call cont_SS(nsync, wf16(:,1), wf16(:,43), A(:,46), n3(:,140), t3x256(:,:,46), nhel, den(114))
    call cont_VV(nsync, wf4(:,14), wf64(:,1), A(:,47), n3(:,141), t3x256(:,:,47), nhel, den(117))
    call cont_VV(nsync, wf4(:,14), wf64(:,2), A(:,48), n3(:,142), t3x256(:,:,48), nhel, den(119))
    call cont_QA(nsync, wf32(:,5), wf8(:,22), A(:,49), n3(:,143), t3x256(:,:,49), nhel, den(121))
    call cont_QA(nsync, wf32(:,6), wf8(:,22), A(:,50), n3(:,144), t3x256(:,:,50), nhel, den(122))
    call cont_VV(nsync, wf4(:,14), wf64(:,3), A(:,51), n3(:,145), t3x256(:,:,51), nhel, den(124))
    call cont_VV(nsync, wf4(:,14), wf64(:,4), A(:,52), n3(:,146), t3x256(:,:,52), nhel, den(126))
    call cont_QA(nsync, wf8(:,3), wf32(:,9), A(:,53), n3(:,147), t3x256(:,:,53), nhel, den(129))
    call cont_QA(nsync, wf8(:,3), wf32(:,10), A(:,54), n3(:,148), t3x256(:,:,54), nhel, den(131))
    call cont_QA(nsync, wf32(:,7), wf8(:,22), A(:,55), n3(:,149), t3x256(:,:,55), nhel, den(132))
    call cont_QA(nsync, wf32(:,8), wf8(:,22), A(:,56), n3(:,150), t3x256(:,:,56), nhel, den(133))
    call cont_QA(nsync, wf8(:,6), wf32(:,11), A(:,57), n3(:,151), t3x256(:,:,57), nhel, den(135))
    call cont_QA(nsync, wf8(:,8), wf32(:,11), A(:,58), n3(:,152), t3x256(:,:,58), nhel, den(136))
    call cont_SS(nsync, wf16(:,1), wf16(:,44), A(:,59), n3(:,153), t3x256(:,:,59), nhel, den(137))
    call cont_SS(nsync, wf16(:,1), wf16(:,45), A(:,60), n3(:,154), t3x256(:,:,60), nhel, den(138))
    call cont_QA(nsync, wf16(:,14), wf16(:,46), A(:,61), n3(:,155), t3x256(:,:,61), nhel, den(140))
    call cont_QA(nsync, wf16(:,15), wf16(:,46), A(:,62), n3(:,156), t3x256(:,:,62), nhel, den(141))
    call cont_QA(nsync, wf16(:,27), wf16(:,47), A(:,63), n3(:,157), t3x256(:,:,63), nhel, den(143))
    call cont_QA(nsync, wf16(:,27), wf16(:,48), A(:,64), n3(:,158), t3x256(:,:,64), nhel, den(145))
    call cont_QA(nsync, wf16(:,12), wf16(:,49), A(:,65), n3(:,159), t3x256(:,:,65), nhel, den(147))
    call cont_QA(nsync, wf16(:,12), wf16(:,50), A(:,66), n3(:,160), t3x256(:,:,66), nhel, den(149))
    call cont_QA(nsync, wf16(:,29), wf16(:,51), A(:,67), n3(:,161), t3x256(:,:,67), nhel, den(151))
    call cont_QA(nsync, wf16(:,30), wf16(:,51), A(:,68), n3(:,162), t3x256(:,:,68), nhel, den(152))
    call cont_VV(nsync, wf16(:,52), wf16(:,53), A(:,69), n3(:,163), t3x256(:,:,69), nhel, den(157))
    call cont_VV(nsync, wf16(:,55), wf16(:,56), A(:,70), n3(:,164), t3x256(:,:,70), nhel, den(160))
    call cont_VV(nsync, wf16(:,52), wf16(:,57), A(:,71), n3(:,165), t3x256(:,:,71), nhel, den(163))
    call cont_VV(nsync, wf16(:,55), wf16(:,58), A(:,72), n3(:,166), t3x256(:,:,72), nhel, den(164))
    call cont_VV(nsync, wf16(:,53), wf16(:,59), A(:,73), n3(:,167), t3x256(:,:,73), nhel, den(167))
    call cont_VV(nsync, wf16(:,60), wf16(:,61), A(:,74), n3(:,168), t3x256(:,:,74), nhel, den(170))
    call cont_VV(nsync, wf16(:,57), wf16(:,59), A(:,75), n3(:,169), t3x256(:,:,75), nhel, den(172))
    call cont_VV(nsync, wf16(:,60), wf16(:,62), A(:,76), n3(:,170), t3x256(:,:,76), nhel, den(174))
    call cont_VV(nsync, wf16(:,53), wf16(:,63), A(:,77), n3(:,171), t3x256(:,:,77), nhel, den(176))
    call cont_VV(nsync, wf16(:,56), wf16(:,65), A(:,78), n3(:,172), t3x256(:,:,78), nhel, den(178))
    call cont_VV(nsync, wf16(:,57), wf16(:,63), A(:,79), n3(:,173), t3x256(:,:,79), nhel, den(179))
    call cont_VV(nsync, wf16(:,58), wf16(:,65), A(:,80), n3(:,174), t3x256(:,:,80), nhel, den(180))
    call cont_VV(nsync, wf16(:,53), wf16(:,66), A(:,81), n3(:,175), t3x256(:,:,81), nhel, den(181))
    call cont_VV(nsync, wf16(:,61), wf16(:,67), A(:,82), n3(:,176), t3x256(:,:,82), nhel, den(182))
    call cont_VV(nsync, wf16(:,57), wf16(:,66), A(:,83), n3(:,177), t3x256(:,:,83), nhel, den(183))
    call cont_VV(nsync, wf16(:,62), wf16(:,67), A(:,84), n3(:,178), t3x256(:,:,84), nhel, den(184))
    call cont_VV(nsync, wf16(:,53), wf16(:,68), A(:,85), n3(:,179), t3x256(:,:,85), nhel, den(185))
    call cont_VV(nsync, wf16(:,61), wf16(:,69), A(:,86), n3(:,180), t3x256(:,:,86), nhel, den(186))
    call cont_VV(nsync, wf16(:,57), wf16(:,68), A(:,87), n3(:,181), t3x256(:,:,87), nhel, den(187))
    call cont_VV(nsync, wf16(:,62), wf16(:,69), A(:,88), n3(:,182), t3x256(:,:,88), nhel, den(188))
    call cont_VV(nsync, wf16(:,53), wf16(:,70), A(:,89), n3(:,183), t3x256(:,:,89), nhel, den(189))
    call cont_VV(nsync, wf16(:,61), wf16(:,71), A(:,90), n3(:,184), t3x256(:,:,90), nhel, den(190))
    call cont_VV(nsync, wf16(:,57), wf16(:,70), A(:,91), n3(:,185), t3x256(:,:,91), nhel, den(191))
    call cont_VV(nsync, wf16(:,62), wf16(:,71), A(:,92), n3(:,186), t3x256(:,:,92), nhel, den(192))
    call cont_VV(nsync, wf16(:,53), wf16(:,72), A(:,93), n3(:,187), t3x256(:,:,93), nhel, den(193))
    call cont_VV(nsync, wf16(:,61), wf16(:,73), A(:,94), n3(:,188), t3x256(:,:,94), nhel, den(194))
    call cont_VV(nsync, wf16(:,53), wf16(:,74), A(:,95), n3(:,189), t3x256(:,:,95), nhel, den(195))
    call cont_VV(nsync, wf16(:,61), wf16(:,75), A(:,96), n3(:,190), t3x256(:,:,96), nhel, den(196))
    call cont_VV(nsync, wf16(:,57), wf16(:,72), A(:,97), n3(:,191), t3x256(:,:,97), nhel, den(197))
    call cont_VV(nsync, wf16(:,62), wf16(:,73), A(:,98), n3(:,192), t3x256(:,:,98), nhel, den(198))
    call cont_VV(nsync, wf16(:,57), wf16(:,74), A(:,99), n3(:,193), t3x256(:,:,99), nhel, den(199))
    call cont_VV(nsync, wf16(:,62), wf16(:,75), A(:,100), n3(:,194), t3x256(:,:,100), nhel, den(200))
    call cont_VV(nsync, wf16(:,55), wf16(:,76), A(:,101), n3(:,195), t3x256(:,:,101), nhel, den(203))
    call cont_VV(nsync, wf16(:,55), wf16(:,77), A(:,102), n3(:,196), t3x256(:,:,102), nhel, den(206))
    call cont_VV(nsync, wf16(:,60), wf16(:,78), A(:,103), n3(:,197), t3x256(:,:,103), nhel, den(208))
    call cont_VV(nsync, wf16(:,60), wf16(:,79), A(:,104), n3(:,198), t3x256(:,:,104), nhel, den(210))
    call cont_VV(nsync, wf16(:,65), wf16(:,76), A(:,105), n3(:,199), t3x256(:,:,105), nhel, den(211))
    call cont_VV(nsync, wf16(:,65), wf16(:,77), A(:,106), n3(:,200), t3x256(:,:,106), nhel, den(212))
    call cont_VV(nsync, wf16(:,67), wf16(:,78), A(:,107), n3(:,201), t3x256(:,:,107), nhel, den(213))
    call cont_VV(nsync, wf16(:,67), wf16(:,79), A(:,108), n3(:,202), t3x256(:,:,108), nhel, den(214))
    call cont_VV(nsync, wf16(:,69), wf16(:,78), A(:,109), n3(:,203), t3x256(:,:,109), nhel, den(215))
    call cont_VV(nsync, wf16(:,69), wf16(:,79), A(:,110), n3(:,204), t3x256(:,:,110), nhel, den(216))
    call cont_VV(nsync, wf16(:,71), wf16(:,78), A(:,111), n3(:,205), t3x256(:,:,111), nhel, den(217))
    call cont_VV(nsync, wf16(:,71), wf16(:,79), A(:,112), n3(:,206), t3x256(:,:,112), nhel, den(218))
    call cont_VV(nsync, wf16(:,73), wf16(:,78), A(:,113), n3(:,207), t3x256(:,:,113), nhel, den(219))
    call cont_VV(nsync, wf16(:,75), wf16(:,78), A(:,114), n3(:,208), t3x256(:,:,114), nhel, den(220))
    call cont_VV(nsync, wf16(:,73), wf16(:,79), A(:,115), n3(:,209), t3x256(:,:,115), nhel, den(221))
    call cont_VV(nsync, wf16(:,75), wf16(:,79), A(:,116), n3(:,210), t3x256(:,:,116), nhel, den(222))
...
subroutine colourvector(A, j, M1)
  ...
  M1(1) = (A(j,16)%j+A(j,18)%j+A(j,20)%j+A(j,22)%j+A(j,24)%j+A(j,26)%j+A(j,29)%j+A(j,31)%j+A(j,33)%j+A(j,35)%j+A(j,63)%j+A(j,67)%j &
       ...
       +A(j,88)%j+A(j,105)%j+A(j,106)%j+A(j,107)%j+A(j,108)%j+A(j,109)%j+A(j,110)%j)*f(2)+CI*(A(j,47)%j+A(j,49)%j+A(j,51)%j &
       +A(j,53)%j+A(j,55)%j+A(j,57)%j+A(j,93)%j+A(j,95)%j+A(j,97)%j+A(j,99)%j)*f(3)+CI*(A(j,48)%j+A(j,50)%j+A(j,52)%j+A(j,54)%j &
       +A(j,56)%j+A(j,58)%j+A(j,94)%j+A(j,96)%j+A(j,98)%j+A(j,100)%j+A(j,113)%j+A(j,114)%j+A(j,115)%j+A(j,116)%j)*f(4)+(-A(j,15)%j &
       -A(j,28)%j-A(j,37)%j)*f(5)+CI*(-A(j,59)%j-A(j,60)%j)*f(6)
  M1(2) = (A(j,2)%j+A(j,4)%j+A(j,6)%j+A(j,8)%j+A(j,10)%j+A(j,12)%j+A(j,38)%j+A(j,40)%j+A(j,42)%j+A(j,44)%j+A(j,61)%j+A(j,65)%j &
       ...
       +A(j,101)%j+A(j,102)%j+A(j,103)%j+A(j,104)%j+A(j,111)%j+A(j,112)%j)*f(2)+CI*(-A(j,47)%j-A(j,49)%j-A(j,51)%j-A(j,53)%j &
       -A(j,55)%j-A(j,57)%j-A(j,93)%j-A(j,95)%j-A(j,97)%j-A(j,99)%j)*f(3)+CI*(-A(j,48)%j-A(j,50)%j-A(j,52)%j-A(j,54)%j-A(j,56)%j &
       -A(j,58)%j-A(j,94)%j-A(j,96)%j-A(j,98)%j-A(j,100)%j-A(j,113)%j-A(j,114)%j-A(j,115)%j-A(j,116)%j)*f(4)+(-A(j,1)%j-A(j,14)%j &
       -A(j,46)%j)*f(5)+CI*(A(j,59)%j+A(j,60)%j)*f(6)
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllllj_nmnmxeexbbxgg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllllj_nmnmxeexbbxgg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllllj_nmnmxeexbbxgg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllllj_nmnmxeexbbxgg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllllj_nmnmxeexbbxgg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllllj_nmnmxeexbbxgg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllllj_nmnmxeexbbxgg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllllj_nmnmxeexbbxgg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllllj_nmnmxeexbbxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllllj_nmnmxeexbbxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllllj_nmnmxeexbbxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllllj_nmnmxeexbbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllllj_nmnmxeexbbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllllj_nmnmxeexbbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllllj_nmnmxeexbbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllllj_nmnmxeexbbxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_ppllllj_nmnmxeexbbxgg_1_/**/REALKIND
