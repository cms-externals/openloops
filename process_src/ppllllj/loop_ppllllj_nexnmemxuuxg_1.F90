...
module ol_colourmatrix_ppllllj_nexnmemxuuxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nexnmemxuuxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nexnmemxuuxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nexnmemxuuxg_1_/**/REALKIND

module ol_loop_ppllllj_nexnmemxuuxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(11) = (CI*eQED**4*gQCD)/(3._/**/REALKIND*sw**2)
    ...
    f(15) = (CI*countertermnorm*ctGqq*eQED**4*gQCD**3)/(3._/**/REALKIND*sw**2)
    f(16) = (CI*countertermnorm*ctGqq*eQED**4*gQCD**3)/(2._/**/REALKIND*sw**2)
    f(17) = (CI*countertermnorm*ctVqq*eQED**4*gQCD**3)/(3._/**/REALKIND*sw**2)
    ...
    f(25) = (CI*eQED**4*gQCD**3*integralnorm*SwB)/(3._/**/REALKIND*sw**2)
    f(26) = (CI*eQED**4*gQCD**3*integralnorm*SwB)/(2._/**/REALKIND*sw**2)
    f(27) = (eQED**4*gQCD**3*integralnorm*SwB)/(sw**2*3._/**/REALKIND)
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,7),Q(:,42),ZERO,0_intkind1,wf(:,9))
  call vert_QA_V(wf(:,6),wf(:,-5),wf(:,10))
  call vert_UV_W(wf(:,4),Q(:,10),wf(:,5),Q(:,5),wf(:,11))
  call vert_QA_Z(gZu,wf(:,6),wf(:,-5),wf(:,12))
  ...
  call counter_QA_Z(gZu,wf(:,6),wf(:,-5),wf(:,47))
  call counter_AW_Q(wf(:,-5),wf(:,4),wf(:,48))
  call prop_Q_A(wf(:,8),Q(:,85),ZERO,0_intkind1,wf(:,49))
  call prop_A_Q(wf(:,48),Q(:,42),ZERO,0_intkind1,wf(:,50))
  ...
  call vert_QA_Z(gZu,wf(:,-4),wf(:,52),wf(:,55))
  call prop_W_W(wf(:,55),Q(:,112),MZ,1_intkind1,wf(:,56))
  call counter_QA_V(wf(:,-4),wf(:,15),wf(:,57))
  call counter_QA_Z(gZu,wf(:,-4),wf(:,15),wf(:,58))
  call counter_WQ_A(wf(:,5),wf(:,-4),wf(:,59))
  call prop_A_Q(wf(:,17),Q(:,106),ZERO,0_intkind1,wf(:,60))
  ...
  call vert_QA_Z(gZu,wf(:,64),wf(:,-5),wf(:,67))
  ...
  call vert_QA_Z(gZu,wf(:,73),wf(:,-5),wf(:,75))
  call vert_WQ_A(wf(:,5),wf(:,73),wf(:,76))
  call counter_A_Q(ctqq,wf(:,9),Q(:,42),wf(:,77))
  call counter_A_Q(ctqq,wf(:,15),Q(:,96),wf(:,78))
  call prop_A_Q(wf(:,78),Q(:,96),ZERO,0_intkind1,wf(:,79))
  call vert_QA_V(wf(:,-4),wf(:,79),wf(:,80))
  call vert_QA_Z(gZu,wf(:,-4),wf(:,79),wf(:,81))
  call counter_Q_A(ctqq,wf(:,18),Q(:,21),wf(:,82))
  call vert_AW_Q(wf(:,79),wf(:,4),wf(:,83))
  call vert_AV_Q(wf(:,9),wf(:,-6),wf(:,84))
  call prop_A_Q(wf(:,84),Q(:,106),ZERO,0_intkind1,wf(:,85))
  call prop_Q_A(wf(:,22),Q(:,85),ZERO,0_intkind1,wf(:,86))
  ...
  call vert_WQ_A(wf(:,4),wf(:,18),wf(:,91))
  call prop_Q_A(wf(:,91),Q(:,31),ZERO,0_intkind1,wf(:,92))
  call vert_AW_Q(wf(:,9),wf(:,5),wf(:,93))
  call prop_A_Q(wf(:,93),Q(:,47),ZERO,0_intkind1,wf(:,94))
  call vert_VQ_A(wf(:,11),wf(:,-4),wf(:,95))
  call prop_Q_A(wf(:,95),Q(:,31),ZERO,0_intkind1,wf(:,96))
  call vert_ZQ_A(gZu,wf(:,42),wf(:,-4),wf(:,97))
  ...
  call vert_AZ_Q(gZu,wf(:,-5),wf(:,42),wf(:,101))
  ...
  call vert_ZQ_A(gZu,wf(:,87),wf(:,-4),wf(:,105))
  ...
  call vert_AZ_Q(gZu,wf(:,-5),wf(:,87),wf(:,109))
  call prop_A_Q(wf(:,109),Q(:,47),ZERO,0_intkind1,wf(:,110))
  call vert_ZQ_A(gZu,wf(:,88),wf(:,-4),wf(:,111))
  call prop_Q_A(wf(:,111),Q(:,31),ZERO,0_intkind1,wf(:,112))
  call vert_AZ_Q(gZu,wf(:,-5),wf(:,88),wf(:,113))
  ...
  call vert_ZQ_A(gZu,wf(:,89),wf(:,-4),wf(:,117))
  ...
  call vert_AZ_Q(gZu,wf(:,-5),wf(:,89),wf(:,121))
  call prop_A_Q(wf(:,121),Q(:,47),ZERO,0_intkind1,wf(:,122))
  call vert_ZQ_A(gZu,wf(:,90),wf(:,-4),wf(:,123))
  call prop_Q_A(wf(:,123),Q(:,31),ZERO,0_intkind1,wf(:,124))
  call vert_AZ_Q(gZu,wf(:,-5),wf(:,90),wf(:,125))
...
subroutine denominators()
  ...
  den(104) = den(1)*den(18)
  den(106) = den(104)*den(105)
  den(107) = den(2)*den(6)
  den(109) = den(107)*den(108)
  den(110) = den(54)*den(105)
  den(111) = den(51)*den(105)
  den(112) = den(54)*den(108)
  den(113) = den(51)*den(108)
  den(114) = den(86)*den(105)
  den(115) = den(88)*den(105)
  den(116) = den(86)*den(108)
  den(117) = den(88)*den(108)
  den(118) = den(90)*den(105)
  den(119) = den(90)*den(108)
  den(120) = den(95)*den(105)
  den(121) = den(97)*den(105)
  den(122) = den(95)*den(108)
  den(123) = den(97)*den(108)
  den(124) = den(99)*den(105)
  den(125) = den(99)*den(108)
  ...
  den(132) = den(1)*den(84)
  den(133) = den(2)*den(82)
  ...
  den(152) = den(3)*den(109)
  den(153) = den(3)*den(112)
  den(154) = den(3)*den(113)
  den(155) = den(15)*den(106)
...
end module ol_loop_ppllllj_nexnmemxuuxg_1_/**/REALKIND
