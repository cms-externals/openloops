...
module ol_colourmatrix_ppllllj_neeexexuxdg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_neeexexuxdg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_neeexexuxdg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_neeexexuxdg_1_/**/REALKIND

module ol_loop_ppllllj_neeexexuxdg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,6),Q(:,37),ZERO,0_intkind1,wf(:,8))
  call vert_QA_Z(gZl,wf(:,-1),wf(:,-3),wf(:,9))
  call prop_W_W(wf(:,9),Q(:,10),MZ,1_intkind1,wf(:,10))
  call vert_AZ_Q(gZu,wf(:,5),wf(:,10),wf(:,11))
  call vert_VQ_A(wf(:,2),wf(:,-5),wf(:,12))
  call vert_AW_Q(wf(:,5),wf(:,4),wf(:,13))
  call prop_Q_A(wf(:,12),Q(:,42),ZERO,0_intkind1,wf(:,14))
  call vert_ZQ_A(gZd,wf(:,10),wf(:,-5),wf(:,15))
  call prop_Q_A(wf(:,15),Q(:,42),ZERO,0_intkind1,wf(:,16))
  call vert_QA_W(wf(:,-5),wf(:,5),wf(:,17))
  call vert_UV_W(wf(:,2),Q(:,10),wf(:,4),Q(:,5),wf(:,18))
  call prop_W_W(wf(:,17),Q(:,112),MW,1_intkind1,wf(:,19))
  call vert_UV_W(wf(:,10),Q(:,10),wf(:,4),Q(:,5),wf(:,20))
  ...
  call prop_A_Q(wf(:,23),Q(:,21),ZERO,0_intkind1,wf(:,25))
  call vert_ZQ_A(gZd,wf(:,10),wf(:,22),wf(:,26))
  call vert_AV_Q(wf(:,-4),wf(:,2),wf(:,27))
  call vert_WQ_A(wf(:,4),wf(:,22),wf(:,28))
  call prop_A_Q(wf(:,27),Q(:,26),ZERO,0_intkind1,wf(:,29))
  call vert_AZ_Q(gZu,wf(:,-4),wf(:,10),wf(:,30))
  call prop_A_Q(wf(:,30),Q(:,26),ZERO,0_intkind1,wf(:,31))
  ...
  call vert_WQ_A(wf(:,4),wf(:,-1),wf(:,37))
  call prop_Q_A(wf(:,37),Q(:,7),ZERO,0_intkind1,wf(:,38))
  call vert_QA_W(wf(:,38),wf(:,-3),wf(:,39))
  call vert_QA_W(wf(:,0),wf(:,-3),wf(:,40))
  call vert_QA_V(wf(:,-1),wf(:,-2),wf(:,41))
  call prop_W_W(wf(:,40),Q(:,9),MW,1_intkind1,wf(:,42))
  call vert_WQ_A(wf(:,42),wf(:,-5),wf(:,43))
  call vert_AV_Q(wf(:,5),wf(:,41),wf(:,44))
  call prop_Q_A(wf(:,43),Q(:,41),ZERO,0_intkind1,wf(:,45))
  call vert_QA_Z(gZl,wf(:,-1),wf(:,-2),wf(:,46))
  call prop_W_W(wf(:,46),Q(:,6),MZ,1_intkind1,wf(:,47))
  call vert_AZ_Q(gZu,wf(:,5),wf(:,47),wf(:,48))
  call vert_VQ_A(wf(:,41),wf(:,-5),wf(:,49))
  call vert_AW_Q(wf(:,5),wf(:,42),wf(:,50))
  call prop_Q_A(wf(:,49),Q(:,38),ZERO,0_intkind1,wf(:,51))
  call vert_ZQ_A(gZd,wf(:,47),wf(:,-5),wf(:,52))
  call prop_Q_A(wf(:,52),Q(:,38),ZERO,0_intkind1,wf(:,53))
  call vert_UV_W(wf(:,41),Q(:,6),wf(:,42),Q(:,9),wf(:,54))
  call vert_UV_W(wf(:,47),Q(:,6),wf(:,42),Q(:,9),wf(:,55))
  call vert_AW_Q(wf(:,-4),wf(:,42),wf(:,56))
  call vert_VQ_A(wf(:,41),wf(:,22),wf(:,57))
  call prop_A_Q(wf(:,56),Q(:,25),ZERO,0_intkind1,wf(:,58))
  call vert_ZQ_A(gZd,wf(:,47),wf(:,22),wf(:,59))
  call vert_AV_Q(wf(:,-4),wf(:,41),wf(:,60))
  call vert_WQ_A(wf(:,42),wf(:,22),wf(:,61))
  call prop_A_Q(wf(:,60),Q(:,22),ZERO,0_intkind1,wf(:,62))
  call vert_AZ_Q(gZu,wf(:,-4),wf(:,47),wf(:,63))
  call prop_A_Q(wf(:,63),Q(:,22),ZERO,0_intkind1,wf(:,64))
  call vert_AV_Q(wf(:,58),wf(:,-6),wf(:,65))
  call vert_AV_Q(wf(:,62),wf(:,-6),wf(:,66))
  call vert_AV_Q(wf(:,64),wf(:,-6),wf(:,67))
  call vert_ZQ_A(gZn,wf(:,47),wf(:,0),wf(:,68))
  call prop_Q_A(wf(:,68),Q(:,7),ZERO,0_intkind1,wf(:,69))
  call vert_QA_W(wf(:,69),wf(:,-3),wf(:,70))
  call vert_AV_Q(wf(:,-3),wf(:,41),wf(:,71))
  call prop_A_Q(wf(:,71),Q(:,14),ZERO,0_intkind1,wf(:,72))
  call vert_QA_W(wf(:,0),wf(:,72),wf(:,73))
  call vert_AZ_Q(gZl,wf(:,-3),wf(:,47),wf(:,74))
  call prop_A_Q(wf(:,74),Q(:,14),ZERO,0_intkind1,wf(:,75))
  call vert_QA_W(wf(:,0),wf(:,75),wf(:,76))
  call vert_WQ_A(wf(:,42),wf(:,-1),wf(:,77))
  call prop_Q_A(wf(:,77),Q(:,11),ZERO,0_intkind1,wf(:,78))
  call vert_QA_W(wf(:,78),wf(:,-2),wf(:,79))
  call vert_ZQ_A(gZn,wf(:,10),wf(:,0),wf(:,80))
  call prop_Q_A(wf(:,80),Q(:,11),ZERO,0_intkind1,wf(:,81))
  call vert_QA_W(wf(:,81),wf(:,-2),wf(:,82))
  call vert_AV_Q(wf(:,-2),wf(:,2),wf(:,83))
  call prop_A_Q(wf(:,83),Q(:,14),ZERO,0_intkind1,wf(:,84))
  call vert_QA_W(wf(:,0),wf(:,84),wf(:,85))
  call vert_AZ_Q(gZl,wf(:,-2),wf(:,10),wf(:,86))
  call prop_A_Q(wf(:,86),Q(:,14),ZERO,0_intkind1,wf(:,87))
  call vert_QA_W(wf(:,0),wf(:,87),wf(:,88))
  call counter_AV_Q(wf(:,5),wf(:,2),wf(:,89))
  call counter_AZ_Q(gZu,wf(:,5),wf(:,10),wf(:,90))
  call counter_AW_Q(wf(:,5),wf(:,4),wf(:,91))
  call counter_VQ_A(wf(:,2),wf(:,22),wf(:,92))
  call counter_ZQ_A(gZd,wf(:,10),wf(:,22),wf(:,93))
  call counter_WQ_A(wf(:,4),wf(:,22),wf(:,94))
  call counter_AV_Q(wf(:,25),wf(:,-6),wf(:,95))
  call counter_VG_G(wf(:,10),wf(:,-6),Q(:,64),wf(:,96),Q(:,74))
  call vert_QA_V(wf(:,-5),wf(:,25),wf(:,97))
  call counter_AV_Q(wf(:,29),wf(:,-6),wf(:,98))
  call counter_AV_Q(wf(:,31),wf(:,-6),wf(:,99))
  call vert_QA_V(wf(:,8),wf(:,-4),wf(:,100))
  ...
  call counter_VQ_A(wf(:,2),wf(:,-5),wf(:,104))
  call prop_A_Q(wf(:,13),Q(:,85),ZERO,0_intkind1,wf(:,105))
  call counter_ZQ_A(gZd,wf(:,10),wf(:,-5),wf(:,106))
  call counter_WQ_A(wf(:,4),wf(:,-5),wf(:,107))
  call prop_A_Q(wf(:,7),Q(:,90),ZERO,0_intkind1,wf(:,108))
  call prop_A_Q(wf(:,11),Q(:,90),ZERO,0_intkind1,wf(:,109))
  call prop_Q_A(wf(:,104),Q(:,42),ZERO,0_intkind1,wf(:,110))
  call prop_Q_A(wf(:,106),Q(:,42),ZERO,0_intkind1,wf(:,111))
  call prop_Q_A(wf(:,107),Q(:,37),ZERO,0_intkind1,wf(:,112))
  call counter_VQ_A(wf(:,-6),wf(:,-5),wf(:,113))
  call prop_Q_A(wf(:,113),Q(:,96),ZERO,0_intkind1,wf(:,114))
  call vert_VQ_A(wf(:,2),wf(:,114),wf(:,115))
  call vert_ZQ_A(gZd,wf(:,10),wf(:,114),wf(:,116))
  call vert_WQ_A(wf(:,4),wf(:,114),wf(:,117))
  call vert_QA_W(wf(:,114),wf(:,-4),wf(:,118))
  call prop_W_W(wf(:,118),Q(:,112),MW,1_intkind1,wf(:,119))
  call counter_QA_W(wf(:,22),wf(:,-4),wf(:,120))
  call counter_AV_Q(wf(:,-4),wf(:,2),wf(:,121))
  call prop_Q_A(wf(:,28),Q(:,101),ZERO,0_intkind1,wf(:,122))
  call counter_AZ_Q(gZu,wf(:,-4),wf(:,10),wf(:,123))
  call counter_AW_Q(wf(:,-4),wf(:,4),wf(:,124))
  call prop_Q_A(wf(:,24),Q(:,106),ZERO,0_intkind1,wf(:,125))
  call prop_Q_A(wf(:,26),Q(:,106),ZERO,0_intkind1,wf(:,126))
  call prop_A_Q(wf(:,121),Q(:,26),ZERO,0_intkind1,wf(:,127))
  call vert_AV_Q(wf(:,127),wf(:,-6),wf(:,128))
  call prop_A_Q(wf(:,123),Q(:,26),ZERO,0_intkind1,wf(:,129))
  call vert_AV_Q(wf(:,129),wf(:,-6),wf(:,130))
  call prop_A_Q(wf(:,124),Q(:,21),ZERO,0_intkind1,wf(:,131))
  call vert_AV_Q(wf(:,131),wf(:,-6),wf(:,132))
  call counter_AV_Q(wf(:,-4),wf(:,-6),wf(:,133))
  call prop_A_Q(wf(:,133),Q(:,80),ZERO,0_intkind1,wf(:,134))
  call vert_AV_Q(wf(:,134),wf(:,2),wf(:,135))
  call vert_AZ_Q(gZu,wf(:,134),wf(:,10),wf(:,136))
  call vert_AW_Q(wf(:,134),wf(:,4),wf(:,137))
  call vert_QA_W(wf(:,-5),wf(:,134),wf(:,138))
  ...
  call counter_AV_Q(wf(:,5),wf(:,41),wf(:,142))
  call counter_AZ_Q(gZu,wf(:,5),wf(:,47),wf(:,143))
  call counter_AW_Q(wf(:,5),wf(:,42),wf(:,144))
  call counter_VQ_A(wf(:,41),wf(:,22),wf(:,145))
  call counter_ZQ_A(gZd,wf(:,47),wf(:,22),wf(:,146))
  call counter_WQ_A(wf(:,42),wf(:,22),wf(:,147))
  call counter_AV_Q(wf(:,58),wf(:,-6),wf(:,148))
  call counter_VG_G(wf(:,47),wf(:,-6),Q(:,64),wf(:,149),Q(:,70))
  call vert_QA_V(wf(:,-5),wf(:,58),wf(:,150))
  call counter_AV_Q(wf(:,62),wf(:,-6),wf(:,151))
  call counter_AV_Q(wf(:,64),wf(:,-6),wf(:,152))
  call vert_QA_V(wf(:,45),wf(:,-4),wf(:,153))
  call prop_W_W(wf(:,54),Q(:,15),MW,1_intkind1,wf(:,154))
  call prop_W_W(wf(:,55),Q(:,15),MW,1_intkind1,wf(:,155))
  call counter_VQ_A(wf(:,41),wf(:,-5),wf(:,156))
  call prop_A_Q(wf(:,50),Q(:,89),ZERO,0_intkind1,wf(:,157))
  call counter_ZQ_A(gZd,wf(:,47),wf(:,-5),wf(:,158))
  call counter_WQ_A(wf(:,42),wf(:,-5),wf(:,159))
  call prop_A_Q(wf(:,44),Q(:,86),ZERO,0_intkind1,wf(:,160))
  call prop_A_Q(wf(:,48),Q(:,86),ZERO,0_intkind1,wf(:,161))
  call prop_Q_A(wf(:,156),Q(:,38),ZERO,0_intkind1,wf(:,162))
  call prop_Q_A(wf(:,158),Q(:,38),ZERO,0_intkind1,wf(:,163))
  call prop_Q_A(wf(:,159),Q(:,41),ZERO,0_intkind1,wf(:,164))
  call vert_VQ_A(wf(:,41),wf(:,114),wf(:,165))
  call vert_ZQ_A(gZd,wf(:,47),wf(:,114),wf(:,166))
  call vert_WQ_A(wf(:,42),wf(:,114),wf(:,167))
  call counter_AV_Q(wf(:,-4),wf(:,41),wf(:,168))
  call prop_Q_A(wf(:,61),Q(:,105),ZERO,0_intkind1,wf(:,169))
  call counter_AZ_Q(gZu,wf(:,-4),wf(:,47),wf(:,170))
  call counter_AW_Q(wf(:,-4),wf(:,42),wf(:,171))
  call prop_Q_A(wf(:,57),Q(:,102),ZERO,0_intkind1,wf(:,172))
  call prop_Q_A(wf(:,59),Q(:,102),ZERO,0_intkind1,wf(:,173))
  call prop_A_Q(wf(:,168),Q(:,22),ZERO,0_intkind1,wf(:,174))
  call vert_AV_Q(wf(:,174),wf(:,-6),wf(:,175))
  call prop_A_Q(wf(:,170),Q(:,22),ZERO,0_intkind1,wf(:,176))
  call vert_AV_Q(wf(:,176),wf(:,-6),wf(:,177))
  call prop_A_Q(wf(:,171),Q(:,25),ZERO,0_intkind1,wf(:,178))
  call vert_AV_Q(wf(:,178),wf(:,-6),wf(:,179))
  call vert_AV_Q(wf(:,134),wf(:,41),wf(:,180))
  call vert_AZ_Q(gZu,wf(:,134),wf(:,47),wf(:,181))
  call vert_AW_Q(wf(:,134),wf(:,42),wf(:,182))
  call counter_A_Q(ctqq,wf(:,5),Q(:,80),wf(:,183))
  call prop_A_Q(wf(:,183),Q(:,80),ZERO,0_intkind1,wf(:,184))
  call vert_QA_W(wf(:,-5),wf(:,184),wf(:,185))
  call vert_AV_Q(wf(:,184),wf(:,2),wf(:,186))
  call vert_AZ_Q(gZu,wf(:,184),wf(:,10),wf(:,187))
  call vert_AW_Q(wf(:,184),wf(:,4),wf(:,188))
  call counter_Q_A(ctqq,wf(:,8),Q(:,37),wf(:,189))
  call counter_Q_A(ctqq,wf(:,14),Q(:,42),wf(:,190))
  call counter_Q_A(ctqq,wf(:,16),Q(:,42),wf(:,191))
  call counter_Q_A(ctqq,wf(:,22),Q(:,96),wf(:,192))
  call prop_Q_A(wf(:,192),Q(:,96),ZERO,0_intkind1,wf(:,193))
  call vert_QA_W(wf(:,193),wf(:,-4),wf(:,194))
  call counter_A_Q(ctqq,wf(:,25),Q(:,21),wf(:,195))
  call counter_A_Q(ctqq,wf(:,29),Q(:,26),wf(:,196))
  call counter_A_Q(ctqq,wf(:,31),Q(:,26),wf(:,197))
  call vert_VQ_A(wf(:,2),wf(:,193),wf(:,198))
  call vert_ZQ_A(gZd,wf(:,10),wf(:,193),wf(:,199))
  call vert_WQ_A(wf(:,4),wf(:,193),wf(:,200))
  call vert_VQ_A(wf(:,-6),wf(:,14),wf(:,201))
  call prop_Q_A(wf(:,201),Q(:,106),ZERO,0_intkind1,wf(:,202))
  call vert_VQ_A(wf(:,-6),wf(:,16),wf(:,203))
  call prop_Q_A(wf(:,203),Q(:,106),ZERO,0_intkind1,wf(:,204))
  call vert_VQ_A(wf(:,-6),wf(:,8),wf(:,205))
  call prop_Q_A(wf(:,205),Q(:,101),ZERO,0_intkind1,wf(:,206))
  call prop_A_Q(wf(:,34),Q(:,85),ZERO,0_intkind1,wf(:,207))
  call prop_A_Q(wf(:,35),Q(:,90),ZERO,0_intkind1,wf(:,208))
  call prop_A_Q(wf(:,36),Q(:,90),ZERO,0_intkind1,wf(:,209))
  call prop_W_W(wf(:,39),Q(:,15),MW,1_intkind1,wf(:,210))
  call vert_AV_Q(wf(:,184),wf(:,41),wf(:,211))
  call vert_AZ_Q(gZu,wf(:,184),wf(:,47),wf(:,212))
  call vert_AW_Q(wf(:,184),wf(:,42),wf(:,213))
  call counter_Q_A(ctqq,wf(:,45),Q(:,41),wf(:,214))
  call counter_Q_A(ctqq,wf(:,51),Q(:,38),wf(:,215))
  call counter_Q_A(ctqq,wf(:,53),Q(:,38),wf(:,216))
  call counter_A_Q(ctqq,wf(:,58),Q(:,25),wf(:,217))
  call counter_A_Q(ctqq,wf(:,62),Q(:,22),wf(:,218))
  call counter_A_Q(ctqq,wf(:,64),Q(:,22),wf(:,219))
  call vert_VQ_A(wf(:,41),wf(:,193),wf(:,220))
  call vert_ZQ_A(gZd,wf(:,47),wf(:,193),wf(:,221))
  call vert_WQ_A(wf(:,42),wf(:,193),wf(:,222))
  call vert_VQ_A(wf(:,-6),wf(:,51),wf(:,223))
  call prop_Q_A(wf(:,223),Q(:,102),ZERO,0_intkind1,wf(:,224))
  call vert_VQ_A(wf(:,-6),wf(:,53),wf(:,225))
  call prop_Q_A(wf(:,225),Q(:,102),ZERO,0_intkind1,wf(:,226))
  call vert_VQ_A(wf(:,-6),wf(:,45),wf(:,227))
  call prop_Q_A(wf(:,227),Q(:,105),ZERO,0_intkind1,wf(:,228))
  call prop_A_Q(wf(:,65),Q(:,89),ZERO,0_intkind1,wf(:,229))
  call prop_A_Q(wf(:,66),Q(:,86),ZERO,0_intkind1,wf(:,230))
  call prop_A_Q(wf(:,67),Q(:,86),ZERO,0_intkind1,wf(:,231))
  ...
  call vert_AV_Q(wf(:,25),wf(:,2),wf(:,239))
  call prop_A_Q(wf(:,239),Q(:,31),ZERO,0_intkind1,wf(:,240))
  call vert_AZ_Q(gZd,wf(:,25),wf(:,10),wf(:,241))
  call prop_A_Q(wf(:,241),Q(:,31),ZERO,0_intkind1,wf(:,242))
  call vert_VQ_A(wf(:,2),wf(:,8),wf(:,243))
  call prop_Q_A(wf(:,243),Q(:,47),ZERO,0_intkind1,wf(:,244))
  call vert_ZQ_A(gZu,wf(:,10),wf(:,8),wf(:,245))
  call prop_Q_A(wf(:,245),Q(:,47),ZERO,0_intkind1,wf(:,246))
  call vert_AW_Q(wf(:,29),wf(:,4),wf(:,247))
  call prop_A_Q(wf(:,247),Q(:,31),ZERO,0_intkind1,wf(:,248))
  call vert_AW_Q(wf(:,31),wf(:,4),wf(:,249))
  call prop_A_Q(wf(:,249),Q(:,31),ZERO,0_intkind1,wf(:,250))
  call vert_WQ_A(wf(:,4),wf(:,14),wf(:,251))
  call prop_Q_A(wf(:,251),Q(:,47),ZERO,0_intkind1,wf(:,252))
  call vert_WQ_A(wf(:,4),wf(:,16),wf(:,253))
  call prop_Q_A(wf(:,253),Q(:,47),ZERO,0_intkind1,wf(:,254))
  call vert_AW_Q(wf(:,-4),wf(:,102),wf(:,255))
  call prop_A_Q(wf(:,255),Q(:,31),ZERO,0_intkind1,wf(:,256))
  call vert_AW_Q(wf(:,-4),wf(:,103),wf(:,257))
  call prop_A_Q(wf(:,257),Q(:,31),ZERO,0_intkind1,wf(:,258))
  call vert_WQ_A(wf(:,102),wf(:,-5),wf(:,259))
  call prop_Q_A(wf(:,259),Q(:,47),ZERO,0_intkind1,wf(:,260))
  call vert_WQ_A(wf(:,103),wf(:,-5),wf(:,261))
  call prop_Q_A(wf(:,261),Q(:,47),ZERO,0_intkind1,wf(:,262))
  call vert_AW_Q(wf(:,-4),wf(:,210),wf(:,263))
  call prop_A_Q(wf(:,263),Q(:,31),ZERO,0_intkind1,wf(:,264))
  call vert_WQ_A(wf(:,210),wf(:,-5),wf(:,265))
  call prop_Q_A(wf(:,265),Q(:,47),ZERO,0_intkind1,wf(:,266))
  call vert_AV_Q(wf(:,58),wf(:,41),wf(:,267))
  call prop_A_Q(wf(:,267),Q(:,31),ZERO,0_intkind1,wf(:,268))
  call vert_AZ_Q(gZd,wf(:,58),wf(:,47),wf(:,269))
  call prop_A_Q(wf(:,269),Q(:,31),ZERO,0_intkind1,wf(:,270))
  call vert_VQ_A(wf(:,41),wf(:,45),wf(:,271))
  call prop_Q_A(wf(:,271),Q(:,47),ZERO,0_intkind1,wf(:,272))
  call vert_ZQ_A(gZu,wf(:,47),wf(:,45),wf(:,273))
  call prop_Q_A(wf(:,273),Q(:,47),ZERO,0_intkind1,wf(:,274))
  call vert_AW_Q(wf(:,62),wf(:,42),wf(:,275))
  call prop_A_Q(wf(:,275),Q(:,31),ZERO,0_intkind1,wf(:,276))
  call vert_AW_Q(wf(:,64),wf(:,42),wf(:,277))
  call prop_A_Q(wf(:,277),Q(:,31),ZERO,0_intkind1,wf(:,278))
  call vert_WQ_A(wf(:,42),wf(:,51),wf(:,279))
  call prop_Q_A(wf(:,279),Q(:,47),ZERO,0_intkind1,wf(:,280))
  call vert_WQ_A(wf(:,42),wf(:,53),wf(:,281))
  call prop_Q_A(wf(:,281),Q(:,47),ZERO,0_intkind1,wf(:,282))
  call vert_AW_Q(wf(:,-4),wf(:,154),wf(:,283))
  call prop_A_Q(wf(:,283),Q(:,31),ZERO,0_intkind1,wf(:,284))
  call vert_AW_Q(wf(:,-4),wf(:,155),wf(:,285))
  call prop_A_Q(wf(:,285),Q(:,31),ZERO,0_intkind1,wf(:,286))
  call vert_WQ_A(wf(:,154),wf(:,-5),wf(:,287))
  call prop_Q_A(wf(:,287),Q(:,47),ZERO,0_intkind1,wf(:,288))
  call vert_WQ_A(wf(:,155),wf(:,-5),wf(:,289))
  call prop_Q_A(wf(:,289),Q(:,47),ZERO,0_intkind1,wf(:,290))
  call vert_AW_Q(wf(:,-4),wf(:,232),wf(:,291))
  call prop_A_Q(wf(:,291),Q(:,31),ZERO,0_intkind1,wf(:,292))
  call vert_WQ_A(wf(:,232),wf(:,-5),wf(:,293))
  call prop_Q_A(wf(:,293),Q(:,47),ZERO,0_intkind1,wf(:,294))
  call vert_AW_Q(wf(:,-4),wf(:,233),wf(:,295))
  call prop_A_Q(wf(:,295),Q(:,31),ZERO,0_intkind1,wf(:,296))
  call vert_AW_Q(wf(:,-4),wf(:,234),wf(:,297))
  call prop_A_Q(wf(:,297),Q(:,31),ZERO,0_intkind1,wf(:,298))
  call vert_WQ_A(wf(:,233),wf(:,-5),wf(:,299))
  call prop_Q_A(wf(:,299),Q(:,47),ZERO,0_intkind1,wf(:,300))
  call vert_WQ_A(wf(:,234),wf(:,-5),wf(:,301))
  call prop_Q_A(wf(:,301),Q(:,47),ZERO,0_intkind1,wf(:,302))
  call vert_AW_Q(wf(:,-4),wf(:,235),wf(:,303))
  call prop_A_Q(wf(:,303),Q(:,31),ZERO,0_intkind1,wf(:,304))
  call vert_WQ_A(wf(:,235),wf(:,-5),wf(:,305))
  call prop_Q_A(wf(:,305),Q(:,47),ZERO,0_intkind1,wf(:,306))
  call vert_AW_Q(wf(:,-4),wf(:,236),wf(:,307))
  call prop_A_Q(wf(:,307),Q(:,31),ZERO,0_intkind1,wf(:,308))
  call vert_WQ_A(wf(:,236),wf(:,-5),wf(:,309))
  call prop_Q_A(wf(:,309),Q(:,47),ZERO,0_intkind1,wf(:,310))
  call vert_AW_Q(wf(:,-4),wf(:,237),wf(:,311))
  call prop_A_Q(wf(:,311),Q(:,31),ZERO,0_intkind1,wf(:,312))
  call vert_AW_Q(wf(:,-4),wf(:,238),wf(:,313))
  call prop_A_Q(wf(:,313),Q(:,31),ZERO,0_intkind1,wf(:,314))
  call vert_WQ_A(wf(:,237),wf(:,-5),wf(:,315))
  call prop_Q_A(wf(:,315),Q(:,47),ZERO,0_intkind1,wf(:,316))
  call vert_WQ_A(wf(:,238),wf(:,-5),wf(:,317))
  call prop_Q_A(wf(:,317),Q(:,47),ZERO,0_intkind1,wf(:,318))
...
subroutine denominators()
  ...
  den(249) = den(84)*den(111)
  den(250) = den(164)*den(249)
  den(251) = den(87)*den(111)
  den(252) = den(164)*den(251)
  den(253) = den(89)*den(111)
  den(254) = den(164)*den(253)
  den(255) = den(178)*den(249)
  den(256) = den(178)*den(251)
  den(257) = den(178)*den(253)
  den(258) = den(95)*den(111)
  den(259) = den(164)*den(258)
  den(260) = den(178)*den(258)
  ...
  den(322) = den(251)*den(273)
  den(323) = den(253)*den(273)
  den(324) = den(251)*den(279)
  den(325) = den(253)*den(279)
  den(326) = den(258)*den(273)
  den(327) = den(258)*den(279)
  ...
  den(385) = den(3)*den(251)
  den(386) = den(3)*den(253)
  den(387) = den(23)*den(249)
  den(388) = den(23)*den(251)
  den(389) = den(23)*den(253)
  den(390) = den(3)*den(258)
  den(391) = den(23)*den(258)
  ...
  den(425) = den(3)*den(324)
  den(426) = den(3)*den(325)
  den(427) = den(23)*den(320)
  den(428) = den(23)*den(322)
  den(429) = den(23)*den(323)
  den(430) = den(3)*den(327)
  den(431) = den(23)*den(326)
...
subroutine diagrams(A)
  ...
  A(35) = cont_VV(wf(:,19),wf(:,70)) * den(85)
  A(36) = cont_VV(wf(:,19),wf(:,73)) * den(88)
  A(37) = cont_VV(wf(:,19),wf(:,76)) * den(90)
  A(38) = cont_VV(wf(:,33),wf(:,70)) * den(91)
  A(39) = cont_VV(wf(:,33),wf(:,73)) * den(92)
  A(40) = cont_VV(wf(:,33),wf(:,76)) * den(93)
  A(41) = cont_VV(wf(:,19),wf(:,79)) * den(96)
  ...
  A(145) = cont_VV(wf(:,70),wf(:,140)) * den(85)
  A(146) = cont_VV(wf(:,73),wf(:,140)) * den(88)
  A(147) = cont_VV(wf(:,76),wf(:,140)) * den(90)
  A(148) = cont_VV(wf(:,70),wf(:,119)) * den(91)
  A(149) = cont_VV(wf(:,73),wf(:,119)) * den(92)
  A(150) = cont_VV(wf(:,76),wf(:,119)) * den(93)
  A(151) = cont_VV(wf(:,70),wf(:,141)) * den(91)
  A(152) = cont_VV(wf(:,73),wf(:,141)) * den(92)
  A(153) = cont_VV(wf(:,76),wf(:,141)) * den(93)
  A(154) = cont_VV(wf(:,70),wf(:,139)) * den(85)
  A(155) = cont_VV(wf(:,73),wf(:,139)) * den(88)
  A(156) = cont_VV(wf(:,76),wf(:,139)) * den(90)
  A(157) = cont_VV(wf(:,79),wf(:,140)) * den(96)
  A(158) = cont_VV(wf(:,79),wf(:,119)) * den(97)
  A(159) = cont_VV(wf(:,79),wf(:,141)) * den(97)
  A(160) = cont_VV(wf(:,79),wf(:,139)) * den(96)
  ...
  A(232) = cont_VV(wf(:,185),wf(:,233)) * den(252)
  A(233) = cont_VV(wf(:,185),wf(:,234)) * den(254)
  A(234) = cont_VV(wf(:,194),wf(:,232)) * den(255)
  A(235) = cont_VV(wf(:,194),wf(:,233)) * den(256)
  A(236) = cont_VV(wf(:,194),wf(:,234)) * den(257)
  A(237) = cont_VV(wf(:,185),wf(:,235)) * den(259)
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = (A(17)+A(18)-A(41)-A(42))*f(1)+(A(6)+A(12)-A(24)-A(30))*f(5)+(A(3)+A(7)+A(13)-A(21)-A(25)-A(31))*f(9)+(-A(1)-A(9)-A(15) &
       +A(19)+A(27)+A(33))*f(10)+(A(2)+A(4)-A(5)+A(8)+A(10)-A(11)+A(14)+A(16)-A(20)-A(22)+A(23)-A(26)-A(28)+A(29)-A(32)-A(34) &
       -A(35)-A(36)-A(37)-A(38)-A(39)-A(40)+A(43)+A(44)+A(45)+A(46)+A(47)+A(48))*f(11)

  M2(1) = (-A(201)-A(202)+A(237)+A(238))*f(2)+(A(96)+A(98)-A(158)-A(160))*f(3)+(A(95)+A(97)-A(157)-A(159))*f(4)+(-A(174)-A(184) &
       +A(204)+A(214))*f(6)+(A(78)+A(94)-A(128)-A(144))*f(7)+(A(64)+A(80)-A(114)-A(130))*f(8)+(-A(177)-A(181)-A(185)-A(189)-A(193) &
       -A(197)+A(207)+A(211)+A(215)+A(219)+A(223)+A(227))*f(12)+(A(175)+A(179)+A(187)+A(191)+A(195)+A(199)-A(205)-A(209)-A(217) &
       -A(221)-A(225)-A(229))*f(13)+(A(173)-A(176)-A(178)-A(180)-A(182)+A(183)-A(186)-A(188)-A(190)-A(192)-A(194)-A(196)-A(198) &
       -A(200)-A(203)+A(206)+A(208)+A(210)+A(212)-A(213)+A(216)+A(218)+A(220)+A(222)+A(224)+A(226)+A(228)+A(230)+A(231)+A(232) &
       +A(233)+A(234)+A(235)+A(236)-A(239)-A(240)-A(241)-A(242)-A(243)-A(244))*f(14)+(A(57)+A(73)+A(91)-A(107)-A(123) &
       -A(141))*f(15)+(-A(60)-A(75)-A(89)+A(110)+A(125)+A(139))*f(16)+(A(58)+A(61)+A(74)+A(76)-A(77)+A(90)+A(92)-A(93)-A(108) &
       -A(111)-A(124)-A(126)+A(127)-A(140)-A(142)+A(143)-A(148)-A(149)-A(150)-A(154)-A(155)-A(156)+A(164)+A(165)+A(166)+A(170) &
       ...
       -A(136)-A(138)-A(145)-A(146)-A(147)-A(151)-A(152)-A(153)+A(161)+A(162)+A(163)+A(167)+A(168)+A(169))*f(20)+(-A(59)-A(62) &
       +A(109)+A(112))*f(21)

end subroutine colourvectors

end module ol_loop_ppllllj_neeexexuxdg_1_/**/REALKIND
