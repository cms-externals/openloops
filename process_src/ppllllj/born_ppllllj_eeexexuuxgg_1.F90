...
module ol_colourmatrix_ppllllj_eeexexuuxgg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_eeexexuuxgg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_eeexexuuxgg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_eeexexuuxgg_1_/**/REALKIND

module ol_tree_ppllllj_eeexexuuxgg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppllllj_eeexexuuxgg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppllllj_eeexexuuxgg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for e- e- e+ e+ up anti-up glue glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppllllj_eeexexuuxgg_1, only: external_perm_ppllllj_eeexexuuxgg_1, &
    & external_perm_inv_ppllllj_eeexexuuxgg_1, extcomb_perm_ppllllj_eeexexuuxgg_1, &
    & average_factor_ppllllj_eeexexuuxgg_1
  use ol_external_ppllllj_eeexexuuxgg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppllllj_eeexexuuxgg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppllllj_eeexexuuxgg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppllllj_eeexexuuxgg_1
  ...
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppllllj_eeexexuuxgg_1,8)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppllllj_eeexexuuxgg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppllllj_eeexexuuxgg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppllllj_eeexexuuxgg_1(extcombs(k))
  end do
  ...
  call vert_AZ_Q(gZu,ntry, wf4(:,6), wf4(:,19), wf16(:,90), n3(:,117), t3x16(:,:,59))
  call vert_QA_Z(gZl,ntry, ex1, ex4, wf4(:,20), n3(:,118), t3x4(:,:,13))
  call prop_W_W(ntry, wf4(:,20), Q(:,9), MZ, 1_intkind1, wf4(:,21), n2(57))
  call vert_ZQ_A(gZu,ntry, wf4(:,21), wf4(:,5), wf16(:,91), n3(:,119), t3x16(:,:,60))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,19), wf4(:,5), wf16(:,96), n3(:,122), t3x16(:,:,63))
  call vert_AZ_Q(gZu,ntry, wf4(:,6), wf4(:,21), wf16(:,97), n3(:,123), t3x16(:,:,64))
  ...
  call vert_AZ_Q(gZu,ntry, wf8(:,38), wf4(:,19), wf32(:,22), n3(:,126), t3x32(:,:,22))
  call vert_AZ_Q(gZu,ntry, ex6, wf4(:,21), wf8(:,39), n3(:,127), t3x8(:,:,20))
  call prop_A_Q(ntry, wf8(:,39), Q(:,41), ZERO, 0_intkind1, wf8(:,40), n2(62))
  call vert_AV_Q(ntry, wf8(:,40), wf4(:,17), wf32(:,23), n3(:,128), t3x32(:,:,23))
  call vert_AZ_Q(gZu,ntry, wf8(:,40), wf4(:,19), wf32(:,24), n3(:,129), t3x32(:,:,24))
  ...
  call vert_AZ_Q(gZu,ntry, ex6, wf4(:,19), wf8(:,43), n3(:,134), t3x8(:,:,22))
  call prop_A_Q(ntry, wf8(:,43), Q(:,38), ZERO, 0_intkind1, wf8(:,44), n2(66))
  call vert_AV_Q(ntry, wf8(:,44), wf4(:,16), wf32(:,26), n3(:,135), t3x32(:,:,26))
  call vert_AZ_Q(gZu,ntry, wf8(:,42), wf4(:,21), wf32(:,27), n3(:,136), t3x32(:,:,27))
  call vert_AZ_Q(gZu,ntry, wf8(:,44), wf4(:,21), wf32(:,28), n3(:,137), t3x32(:,:,28))
  ...
  call vert_AZ_Q(gZu,ntry, wf4(:,14), wf4(:,19), wf16(:,108), n3(:,142), t3x16(:,:,71))
  call vert_ZQ_A(gZu,ntry, wf4(:,21), wf4(:,13), wf16(:,109), n3(:,143), t3x16(:,:,72))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,19), wf4(:,13), wf16(:,114), n3(:,146), t3x16(:,:,75))
  call vert_AZ_Q(gZu,ntry, wf4(:,14), wf4(:,21), wf16(:,115), n3(:,147), t3x16(:,:,76))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,21), ex5, wf8(:,47), n3(:,150), t3x8(:,:,24))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,19), wf8(:,46), wf32(:,30), n3(:,153), t3x32(:,:,30))
  call vert_VQ_A(ntry, wf4(:,17), wf8(:,48), wf32(:,31), n3(:,154), t3x32(:,:,31))
  call vert_ZQ_A(gZu,ntry, wf4(:,19), wf8(:,48), wf32(:,32), n3(:,155), t3x32(:,:,32))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,19), ex5, wf8(:,51), n3(:,158), t3x8(:,:,26))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,21), wf8(:,50), wf32(:,35), n3(:,162), t3x32(:,:,35))
  call vert_ZQ_A(gZu,ntry, wf4(:,21), wf8(:,52), wf32(:,36), n3(:,163), t3x32(:,:,36))
  ...
  call vert_ZQ_A(gZu,ntry, wf4(:,19), wf8(:,28), wf32(:,38), n3(:,181), t3x32(:,:,38))
  call vert_VQ_A(ntry, wf4(:,16), wf8(:,28), wf32(:,39), n3(:,182), t3x32(:,:,39))
  call vert_ZQ_A(gZu,ntry, wf4(:,21), wf8(:,28), wf32(:,40), n3(:,183), t3x32(:,:,40))
  ...
  M2add = M2 / average_factor_ppllllj_eeexexuuxgg_1

  do k = 0, 38-1
    M2(k) = M2add(extcomb_perm_ppllllj_eeexexuuxgg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppllllj_eeexexuuxgg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppllllj_eeexexuuxgg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppllllj_eeexexuuxgg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppllllj_eeexexuuxgg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppllllj_eeexexuuxgg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppllllj_eeexexuuxgg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppllllj_eeexexuuxgg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppllllj_eeexexuuxgg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppllllj_eeexexuuxgg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppllllj_eeexexuuxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppllllj_eeexexuuxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppllllj_eeexexuuxgg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppllllj_eeexexuuxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppllllj_eeexexuuxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppllllj_eeexexuuxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(0:38-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppllllj_eeexexuuxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppllllj_eeexexuuxgg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,8)
  real(c_double), intent(out) :: m2(8)
...
end module ol_tree_ppllllj_eeexexuuxgg_1_/**/REALKIND
