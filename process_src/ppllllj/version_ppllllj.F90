...
module ol_versiondata_ppllllj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppllllj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppllllj
  end interface
end module ol_versiondata_ppllllj


subroutine ol_version_ppllllj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppllllj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppllllj
