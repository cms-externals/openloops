...
module ol_colourmatrix_ppllllj_nexnmnmxeudxg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nexnmnmxeudxg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nexnmnmxeudxg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nexnmnmxeudxg_1_/**/REALKIND

module ol_loop_ppllllj_nexnmnmxeudxg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,7),Q(:,41),ZERO,0_intkind1,wf(:,9))
  call vert_AZ_Q(gZd,wf(:,-5),wf(:,5),wf(:,10))
  call vert_WQ_A(wf(:,4),wf(:,6),wf(:,11))
  call prop_A_Q(wf(:,10),Q(:,38),ZERO,0_intkind1,wf(:,12))
  call vert_QA_W(wf(:,6),wf(:,-5),wf(:,13))
  call vert_UV_W(wf(:,4),Q(:,9),wf(:,5),Q(:,6),wf(:,14))
  ...
  call vert_WQ_A(wf(:,4),wf(:,-4),wf(:,18))
  call vert_AZ_Q(gZd,wf(:,17),wf(:,5),wf(:,19))
  call prop_Q_A(wf(:,18),Q(:,25),ZERO,0_intkind1,wf(:,20))
  call vert_ZQ_A(gZu,wf(:,5),wf(:,-4),wf(:,21))
  call vert_AW_Q(wf(:,17),wf(:,4),wf(:,22))
  call prop_Q_A(wf(:,21),Q(:,22),ZERO,0_intkind1,wf(:,23))
  ...
  call vert_AZ_Q(gZn,wf(:,0),wf(:,5),wf(:,28))
  call prop_A_Q(wf(:,28),Q(:,7),ZERO,0_intkind1,wf(:,29))
  call vert_QA_W(wf(:,-3),wf(:,29),wf(:,30))
  call vert_ZQ_A(gZl,wf(:,5),wf(:,-3),wf(:,31))
  call prop_Q_A(wf(:,31),Q(:,14),ZERO,0_intkind1,wf(:,32))
  call vert_QA_W(wf(:,32),wf(:,0),wf(:,33))
  call vert_WQ_A(wf(:,4),wf(:,-1),wf(:,34))
  call prop_Q_A(wf(:,34),Q(:,11),ZERO,0_intkind1,wf(:,35))
  call vert_QA_W(wf(:,35),wf(:,-2),wf(:,36))
  call counter_ZQ_A(gZu,wf(:,5),wf(:,6),wf(:,37))
  call counter_WQ_A(wf(:,4),wf(:,6),wf(:,38))
  call counter_AZ_Q(gZd,wf(:,17),wf(:,5),wf(:,39))
  call counter_AW_Q(wf(:,17),wf(:,4),wf(:,40))
  call counter_VQ_A(wf(:,-6),wf(:,20),wf(:,41))
  call counter_VG_G(wf(:,5),wf(:,-6),Q(:,64),wf(:,42),Q(:,70))
  call vert_QA_V(wf(:,20),wf(:,-5),wf(:,43))
  call counter_VQ_A(wf(:,-6),wf(:,23),wf(:,44))
  call vert_QA_V(wf(:,-4),wf(:,9),wf(:,45))
  call counter_QA_W(wf(:,6),wf(:,-5),wf(:,46))
  call prop_W_W(wf(:,14),Q(:,15),MW,1_intkind1,wf(:,47))
  call counter_AZ_Q(gZd,wf(:,-5),wf(:,5),wf(:,48))
  call prop_Q_A(wf(:,11),Q(:,89),ZERO,0_intkind1,wf(:,49))
  call counter_AW_Q(wf(:,-5),wf(:,4),wf(:,50))
  call prop_Q_A(wf(:,8),Q(:,86),ZERO,0_intkind1,wf(:,51))
  call prop_A_Q(wf(:,48),Q(:,38),ZERO,0_intkind1,wf(:,52))
  call prop_A_Q(wf(:,50),Q(:,41),ZERO,0_intkind1,wf(:,53))
  call counter_AV_Q(wf(:,-5),wf(:,-6),wf(:,54))
  call prop_A_Q(wf(:,54),Q(:,96),ZERO,0_intkind1,wf(:,55))
  call vert_AZ_Q(gZd,wf(:,55),wf(:,5),wf(:,56))
  call vert_AW_Q(wf(:,55),wf(:,4),wf(:,57))
  call vert_QA_W(wf(:,-4),wf(:,55),wf(:,58))
  call prop_W_W(wf(:,58),Q(:,112),MW,1_intkind1,wf(:,59))
  call counter_QA_W(wf(:,-4),wf(:,17),wf(:,60))
  call counter_ZQ_A(gZu,wf(:,5),wf(:,-4),wf(:,61))
  call prop_A_Q(wf(:,22),Q(:,105),ZERO,0_intkind1,wf(:,62))
  call counter_WQ_A(wf(:,4),wf(:,-4),wf(:,63))
  call prop_A_Q(wf(:,19),Q(:,102),ZERO,0_intkind1,wf(:,64))
  call prop_Q_A(wf(:,61),Q(:,22),ZERO,0_intkind1,wf(:,65))
  call vert_VQ_A(wf(:,-6),wf(:,65),wf(:,66))
  call prop_Q_A(wf(:,63),Q(:,25),ZERO,0_intkind1,wf(:,67))
  call vert_VQ_A(wf(:,-6),wf(:,67),wf(:,68))
  call counter_VQ_A(wf(:,-6),wf(:,-4),wf(:,69))
  call prop_Q_A(wf(:,69),Q(:,80),ZERO,0_intkind1,wf(:,70))
  call vert_ZQ_A(gZu,wf(:,5),wf(:,70),wf(:,71))
  call vert_WQ_A(wf(:,4),wf(:,70),wf(:,72))
  ...
  call vert_ZQ_A(gZu,wf(:,5),wf(:,78),wf(:,80))
  call vert_WQ_A(wf(:,4),wf(:,78),wf(:,81))
  call counter_A_Q(ctqq,wf(:,9),Q(:,41),wf(:,82))
  call counter_A_Q(ctqq,wf(:,12),Q(:,38),wf(:,83))
  call counter_A_Q(ctqq,wf(:,17),Q(:,96),wf(:,84))
  call prop_A_Q(wf(:,84),Q(:,96),ZERO,0_intkind1,wf(:,85))
  call vert_QA_W(wf(:,-4),wf(:,85),wf(:,86))
  call counter_Q_A(ctqq,wf(:,20),Q(:,25),wf(:,87))
  call counter_Q_A(ctqq,wf(:,23),Q(:,22),wf(:,88))
  call vert_AZ_Q(gZd,wf(:,85),wf(:,5),wf(:,89))
  call vert_AW_Q(wf(:,85),wf(:,4),wf(:,90))
  call vert_AV_Q(wf(:,12),wf(:,-6),wf(:,91))
  call prop_A_Q(wf(:,91),Q(:,102),ZERO,0_intkind1,wf(:,92))
  call vert_AV_Q(wf(:,9),wf(:,-6),wf(:,93))
  call prop_A_Q(wf(:,93),Q(:,105),ZERO,0_intkind1,wf(:,94))
  call prop_Q_A(wf(:,26),Q(:,89),ZERO,0_intkind1,wf(:,95))
  call prop_Q_A(wf(:,27),Q(:,86),ZERO,0_intkind1,wf(:,96))
...
end module ol_loop_ppllllj_nexnmnmxeudxg_1_/**/REALKIND
