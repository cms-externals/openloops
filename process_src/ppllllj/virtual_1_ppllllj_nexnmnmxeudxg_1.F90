...
module ol_vamp_1_ppllllj_nexnmnmxeudxg_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppllllj_nexnmnmxeudxg_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppllllj_nexnmnmxeudxg_1.
! **********************************************************************
...
#endif
  use ol_loop_ppllllj_nexnmnmxeudxg_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppllllj_nexnmnmxeudxg_1_/**/REALKIND
  ...
  call loop_Q_A(G1(:,:,:,3),Q(:,89),ZERO,G2(:,:,:,3))
  ...
  call loop_Q_A(G0(:,:,:,3),Q(:,89),ZERO,G1(:,:,:,8))
  call loop_QZ_A(G1(:,:,:,8),wf(:,5),G1(:,:,:,9),gZd)
  ...
  call loop_Q_A(G0(:,:,:,4),Q(:,86),ZERO,G1(:,:,:,10))
  ...
  call loop_AZ_Q(G1(:,:,:,12),wf(:,5),G1(:,:,:,13),gZd)
  call loop_A_Q(G1(:,:,:,13),Q(:,102),ZERO,G2(:,:,:,11))
  ...
  call loop_AW_Q(G1(:,:,:,12),wf(:,4),G1(:,:,:,14))
  call loop_A_Q(G1(:,:,:,14),Q(:,105),ZERO,G2(:,:,:,13))
  ...
  call loop_A_Q(G0(:,:,:,6),Q(:,105),ZERO,G1(:,:,:,19))
  call loop_AZ_Q(G1(:,:,:,19),wf(:,5),G1(:,:,:,20),gZu)
  ...
  call loop_A_Q(G0(:,:,:,7),Q(:,102),ZERO,G1(:,:,:,21))
  ...
  call loop_A_Q(G0(:,:,:,8),Q(:,38),ZERO,G1(:,:,:,23))
  call loop_AV_Q(G1(:,:,:,23),wf(:,-6),G1(:,:,:,24))
  call loop_A_Q(G1(:,:,:,24),Q(:,102),ZERO,G2(:,:,:,21))
  ...
  call loop_AW_Q(G1(:,:,:,23),wf(:,4),G1(:,:,:,25))
  ...
  call loop_A_Q(G1(:,:,:,27),Q(:,102),ZERO,G2(:,:,:,25))
  ...
  call loop_AZ_Q(G2(:,:,:,27),wf(:,5),G2(:,:,:,28),gZd)
  call loop_A_Q(G2(:,:,:,28),Q(:,102),ZERO,G3(:,:,:,8))
  ...
  call loop_AW_Q(G2(:,:,:,27),wf(:,4),G2(:,:,:,29))
  call loop_A_Q(G2(:,:,:,29),Q(:,105),ZERO,G3(:,:,:,10))
  call check_last_AQ_V(l_switch,G3(:,:,:,10),wf(:,23),G3tensor(:,9))
  call loop_AZ_Q(G3(:,:,:,10),wf(:,5),G3(:,:,:,11),gZu)
  ...
  call loop_A_Q(G1(:,:,:,29),Q(:,105),ZERO,G2(:,:,:,34))
  call check_last_AQ_V(l_switch,G2(:,:,:,34),wf(:,23),G2tensor(:,25))
  call loop_AZ_Q(G2(:,:,:,34),wf(:,5),G2(:,:,:,35),gZu)
  ...
  call loop_VQ_A(G0(:,:,:,1),wf(:,95),G0(:,:,:,15))
  call loop_Q_A(G0(:,:,:,15),Q(:,89),ZERO,G1(:,:,:,48))
  call loop_QZ_A(G1(:,:,:,48),wf(:,5),G1(:,:,:,49),gZd)
  call loop_Q_A(G1(:,:,:,49),Q(:,95),ZERO,G2(:,:,:,56))
  call check_last_QA_V(l_switch,G2(:,:,:,56),wf(:,-5),G2tensor(:,32))
  call check_last_QA_V(l_switch,G1(:,:,:,48),wf(:,12),G1tensor(:,17))
  call loop_VA_Q(G0(:,:,:,1),wf(:,-5),G0(:,:,:,16))
  call loop_A_Q(G0(:,:,:,16),Q(:,32),ZERO,G1(:,:,:,50))
  call loop_AV_Q(G1(:,:,:,50),wf(:,-6),G1(:,:,:,51))
  call loop_A_Q(G1(:,:,:,51),Q(:,96),ZERO,G2(:,:,:,57))
  call check_last_AQ_V(l_switch,G2(:,:,:,57),wf(:,101),G2tensor(:,33))
  call loop_AZ_Q(G2(:,:,:,57),wf(:,5),G2(:,:,:,58),gZd)
  call loop_A_Q(G2(:,:,:,58),Q(:,102),ZERO,G3(:,:,:,17))
  call check_last_AQ_V(l_switch,G3(:,:,:,17),wf(:,20),G3tensor(:,23))
  call loop_AW_Q(G3(:,:,:,17),wf(:,4),G3(:,:,:,18))
  call loop_A_Q(G3(:,:,:,18),Q(:,111),ZERO,G4(:,:,:,3))
  call check_last_AQ_V(l_switch,G4(:,:,:,3),wf(:,-4),G4tensor(:,3))
  call check_last_AQ_V(l_switch,G2(:,:,:,57),wf(:,105),G2tensor(:,34))
  call loop_AW_Q(G2(:,:,:,57),wf(:,4),G2(:,:,:,59))
  call loop_A_Q(G2(:,:,:,59),Q(:,105),ZERO,G3(:,:,:,19))
  call check_last_AQ_V(l_switch,G3(:,:,:,19),wf(:,23),G3tensor(:,24))
  call loop_AZ_Q(G3(:,:,:,19),wf(:,5),G3(:,:,:,20),gZu)
  call loop_A_Q(G3(:,:,:,20),Q(:,111),ZERO,G4(:,:,:,4))
  call check_last_AQ_V(l_switch,G4(:,:,:,4),wf(:,-4),G4tensor(:,4))
  call check_last_AQ_V(l_switch,G2(:,:,:,57),wf(:,109),G2tensor(:,35))
  call loop_AW_Q(G2(:,:,:,57),wf(:,47),G2(:,:,:,60))
  call loop_A_Q(G2(:,:,:,60),Q(:,111),ZERO,G3(:,:,:,21))
  call check_last_AQ_V(l_switch,G3(:,:,:,21),wf(:,-4),G3tensor(:,25))
  call check_last_AQ_V(l_switch,G2(:,:,:,57),wf(:,113),G2tensor(:,36))
  call loop_AW_Q(G2(:,:,:,57),wf(:,97),G2(:,:,:,61))
  call loop_A_Q(G2(:,:,:,61),Q(:,111),ZERO,G3(:,:,:,22))
  call check_last_AQ_V(l_switch,G3(:,:,:,22),wf(:,-4),G3tensor(:,26))
  call check_last_AQ_V(l_switch,G2(:,:,:,57),wf(:,117),G2tensor(:,37))
  call loop_AW_Q(G2(:,:,:,57),wf(:,98),G2(:,:,:,62))
  call loop_A_Q(G2(:,:,:,62),Q(:,111),ZERO,G3(:,:,:,23))
  call check_last_AQ_V(l_switch,G3(:,:,:,23),wf(:,-4),G3tensor(:,27))
  call check_last_AQ_V(l_switch,G2(:,:,:,57),wf(:,121),G2tensor(:,38))
  call loop_AW_Q(G2(:,:,:,57),wf(:,99),G2(:,:,:,63))
  call loop_A_Q(G2(:,:,:,63),Q(:,111),ZERO,G3(:,:,:,24))
  call check_last_AQ_V(l_switch,G3(:,:,:,24),wf(:,-4),G3tensor(:,28))
  call loop_AZ_Q(G1(:,:,:,50),wf(:,5),G1(:,:,:,52),gZd)
  call loop_A_Q(G1(:,:,:,52),Q(:,38),ZERO,G2(:,:,:,64))
  call loop_AV_Q(G2(:,:,:,64),wf(:,-6),G2(:,:,:,65))
  call loop_A_Q(G2(:,:,:,65),Q(:,102),ZERO,G3(:,:,:,25))
  call check_last_AQ_V(l_switch,G3(:,:,:,25),wf(:,20),G3tensor(:,29))
  ...
  call loop_A_Q(G2(:,:,:,66),Q(:,47),ZERO,G3(:,:,:,27))
  call loop_AV_Q(G3(:,:,:,27),wf(:,-6),G3(:,:,:,28))
  call loop_A_Q(G3(:,:,:,28),Q(:,111),ZERO,G4(:,:,:,6))
  call check_last_AQ_V(l_switch,G4(:,:,:,6),wf(:,-4),G4tensor(:,6))
  call loop_AW_Q(G1(:,:,:,50),wf(:,4),G1(:,:,:,53))
  call loop_A_Q(G1(:,:,:,53),Q(:,41),ZERO,G2(:,:,:,67))
  call loop_AV_Q(G2(:,:,:,67),wf(:,-6),G2(:,:,:,68))
  call loop_A_Q(G2(:,:,:,68),Q(:,105),ZERO,G3(:,:,:,29))
  call check_last_AQ_V(l_switch,G3(:,:,:,29),wf(:,23),G3tensor(:,30))
  call loop_AZ_Q(G3(:,:,:,29),wf(:,5),G3(:,:,:,30),gZu)
  call loop_A_Q(G3(:,:,:,30),Q(:,111),ZERO,G4(:,:,:,7))
  call check_last_AQ_V(l_switch,G4(:,:,:,7),wf(:,-4),G4tensor(:,7))
  call loop_AZ_Q(G2(:,:,:,67),wf(:,5),G2(:,:,:,69),gZu)
  call loop_A_Q(G2(:,:,:,69),Q(:,47),ZERO,G3(:,:,:,31))
  call loop_AV_Q(G3(:,:,:,31),wf(:,-6),G3(:,:,:,32))
  call loop_A_Q(G3(:,:,:,32),Q(:,111),ZERO,G4(:,:,:,8))
  call check_last_AQ_V(l_switch,G4(:,:,:,8),wf(:,-4),G4tensor(:,8))
  call loop_AW_Q(G1(:,:,:,50),wf(:,47),G1(:,:,:,54))
  call loop_A_Q(G1(:,:,:,54),Q(:,47),ZERO,G2(:,:,:,70))
  call loop_AV_Q(G2(:,:,:,70),wf(:,-6),G2(:,:,:,71))
  call loop_A_Q(G2(:,:,:,71),Q(:,111),ZERO,G3(:,:,:,33))
  call check_last_AQ_V(l_switch,G3(:,:,:,33),wf(:,-4),G3tensor(:,31))
  call loop_AW_Q(G1(:,:,:,50),wf(:,97),G1(:,:,:,55))
  call loop_A_Q(G1(:,:,:,55),Q(:,47),ZERO,G2(:,:,:,72))
  call loop_AV_Q(G2(:,:,:,72),wf(:,-6),G2(:,:,:,73))
  call loop_A_Q(G2(:,:,:,73),Q(:,111),ZERO,G3(:,:,:,34))
  call check_last_AQ_V(l_switch,G3(:,:,:,34),wf(:,-4),G3tensor(:,32))
  call loop_AW_Q(G1(:,:,:,50),wf(:,98),G1(:,:,:,56))
  call loop_A_Q(G1(:,:,:,56),Q(:,47),ZERO,G2(:,:,:,74))
  call loop_AV_Q(G2(:,:,:,74),wf(:,-6),G2(:,:,:,75))
  call loop_A_Q(G2(:,:,:,75),Q(:,111),ZERO,G3(:,:,:,35))
  call check_last_AQ_V(l_switch,G3(:,:,:,35),wf(:,-4),G3tensor(:,33))
  call loop_AW_Q(G1(:,:,:,50),wf(:,99),G1(:,:,:,57))
  call loop_A_Q(G1(:,:,:,57),Q(:,47),ZERO,G2(:,:,:,76))
  call loop_AV_Q(G2(:,:,:,76),wf(:,-6),G2(:,:,:,77))
  call loop_A_Q(G2(:,:,:,77),Q(:,111),ZERO,G3(:,:,:,36))
  call check_last_AQ_V(l_switch,G3(:,:,:,36),wf(:,-4),G3tensor(:,34))
  call loop_VA_Q(G0(:,:,:,1),wf(:,9),G0(:,:,:,17))
  call loop_A_Q(G0(:,:,:,17),Q(:,41),ZERO,G1(:,:,:,58))
  call loop_AV_Q(G1(:,:,:,58),wf(:,-6),G1(:,:,:,59))
  call loop_A_Q(G1(:,:,:,59),Q(:,105),ZERO,G2(:,:,:,78))
  call check_last_AQ_V(l_switch,G2(:,:,:,78),wf(:,23),G2tensor(:,39))
  call loop_AZ_Q(G2(:,:,:,78),wf(:,5),G2(:,:,:,79),gZu)
  call loop_A_Q(G2(:,:,:,79),Q(:,111),ZERO,G3(:,:,:,37))
  call check_last_AQ_V(l_switch,G3(:,:,:,37),wf(:,-4),G3tensor(:,35))
  call loop_AZ_Q(G1(:,:,:,58),wf(:,5),G1(:,:,:,60),gZu)
  call loop_A_Q(G1(:,:,:,60),Q(:,47),ZERO,G2(:,:,:,80))
  call loop_AV_Q(G2(:,:,:,80),wf(:,-6),G2(:,:,:,81))
  call loop_A_Q(G2(:,:,:,81),Q(:,111),ZERO,G3(:,:,:,38))
  call check_last_AQ_V(l_switch,G3(:,:,:,38),wf(:,-4),G3tensor(:,36))
  ...
  call loop_A_Q(G0(:,:,:,24),Q(:,105),ZERO,G1(:,:,:,73))
  call loop_AZ_Q(G1(:,:,:,73),wf(:,5),G1(:,:,:,74),gZu)
  call loop_A_Q(G1(:,:,:,74),Q(:,111),ZERO,G2(:,:,:,96))
  call check_last_AQ_V(l_switch,G2(:,:,:,96),wf(:,-4),G2tensor(:,40))
  call check_last_AQ_V(l_switch,G1(:,:,:,73),wf(:,23),G1tensor(:,18))
  call loop_VA_Q(G0(:,:,:,1),wf(:,103),G0(:,:,:,25))
  call loop_A_Q(G0(:,:,:,25),Q(:,47),ZERO,G1(:,:,:,75))
  call loop_AV_Q(G1(:,:,:,75),wf(:,-6),G1(:,:,:,76))
  call loop_A_Q(G1(:,:,:,76),Q(:,111),ZERO,G2(:,:,:,97))
  call check_last_AQ_V(l_switch,G2(:,:,:,97),wf(:,-4),G2tensor(:,41))
  call loop_VQ_A(G0(:,:,:,1),wf(:,96),G0(:,:,:,26))
  call loop_Q_A(G0(:,:,:,26),Q(:,86),ZERO,G1(:,:,:,77))
  call loop_QW_A(G1(:,:,:,77),wf(:,4),G1(:,:,:,78))
  call loop_Q_A(G1(:,:,:,78),Q(:,95),ZERO,G2(:,:,:,98))
  call check_last_QA_V(l_switch,G2(:,:,:,98),wf(:,-5),G2tensor(:,42))
  call check_last_QA_V(l_switch,G1(:,:,:,77),wf(:,9),G1tensor(:,19))
  call loop_VA_Q(G0(:,:,:,1),wf(:,92),G0(:,:,:,27))
  call loop_A_Q(G0(:,:,:,27),Q(:,102),ZERO,G1(:,:,:,79))
...
end module ol_vamp_1_ppllllj_nexnmnmxeudxg_1_/**/REALKIND
