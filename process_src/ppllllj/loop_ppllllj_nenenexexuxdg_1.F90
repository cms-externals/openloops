...
module ol_colourmatrix_ppllllj_nenenexexuxdg_1_/**/REALKIND
...
end module ol_colourmatrix_ppllllj_nenenexexuxdg_1_/**/REALKIND



module ol_forced_parameters_ppllllj_nenenexexuxdg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppllllj_nenenexexuxdg_1_/**/REALKIND

module ol_loop_ppllllj_nenenexexuxdg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_AW_Q(wf(:,6),wf(:,5),wf(:,8))
  call prop_Q_A(wf(:,7),Q(:,37),ZERO,0_intkind1,wf(:,9))
  call vert_WQ_A(wf(:,5),wf(:,-5),wf(:,10))
  call vert_AZ_Q(gZu,wf(:,6),wf(:,4),wf(:,11))
  call prop_Q_A(wf(:,10),Q(:,42),ZERO,0_intkind1,wf(:,12))
  call vert_QA_W(wf(:,-5),wf(:,6),wf(:,13))
  call vert_UV_W(wf(:,4),Q(:,5),wf(:,5),Q(:,10),wf(:,14))
  ...
  call vert_AZ_Q(gZu,wf(:,-4),wf(:,4),wf(:,18))
  call vert_WQ_A(wf(:,5),wf(:,17),wf(:,19))
  call prop_A_Q(wf(:,18),Q(:,21),ZERO,0_intkind1,wf(:,20))
  call vert_AW_Q(wf(:,-4),wf(:,5),wf(:,21))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,17),wf(:,22))
  call prop_A_Q(wf(:,21),Q(:,26),ZERO,0_intkind1,wf(:,23))
  ...
  call vert_AZ_Q(gZl,wf(:,-3),wf(:,4),wf(:,31))
  call prop_A_Q(wf(:,31),Q(:,13),ZERO,0_intkind1,wf(:,32))
  call vert_QA_W(wf(:,-1),wf(:,32),wf(:,33))
  call vert_QA_W(wf(:,0),wf(:,-3),wf(:,34))
  call vert_QA_Z(gZn,wf(:,-1),wf(:,-2),wf(:,35))
  call prop_W_W(wf(:,34),Q(:,9),MW,1_intkind1,wf(:,36))
  call prop_W_W(wf(:,35),Q(:,6),MZ,1_intkind1,wf(:,37))
  call vert_WQ_A(wf(:,36),wf(:,-5),wf(:,38))
  call vert_AZ_Q(gZu,wf(:,6),wf(:,37),wf(:,39))
  call prop_Q_A(wf(:,38),Q(:,41),ZERO,0_intkind1,wf(:,40))
  call vert_ZQ_A(gZd,wf(:,37),wf(:,-5),wf(:,41))
  call vert_AW_Q(wf(:,6),wf(:,36),wf(:,42))
  call prop_Q_A(wf(:,41),Q(:,38),ZERO,0_intkind1,wf(:,43))
  call vert_UV_W(wf(:,37),Q(:,6),wf(:,36),Q(:,9),wf(:,44))
  call vert_AW_Q(wf(:,-4),wf(:,36),wf(:,45))
  call vert_ZQ_A(gZd,wf(:,37),wf(:,17),wf(:,46))
  call prop_A_Q(wf(:,45),Q(:,25),ZERO,0_intkind1,wf(:,47))
  call vert_AZ_Q(gZu,wf(:,-4),wf(:,37),wf(:,48))
  call vert_WQ_A(wf(:,36),wf(:,17),wf(:,49))
  call prop_A_Q(wf(:,48),Q(:,22),ZERO,0_intkind1,wf(:,50))
  call vert_AV_Q(wf(:,47),wf(:,-6),wf(:,51))
  call vert_AV_Q(wf(:,50),wf(:,-6),wf(:,52))
  call vert_ZQ_A(gZn,wf(:,37),wf(:,0),wf(:,53))
  call prop_Q_A(wf(:,53),Q(:,7),ZERO,0_intkind1,wf(:,54))
  call vert_QA_W(wf(:,54),wf(:,-3),wf(:,55))
  call vert_AZ_Q(gZl,wf(:,-3),wf(:,37),wf(:,56))
  call prop_A_Q(wf(:,56),Q(:,14),ZERO,0_intkind1,wf(:,57))
  call vert_QA_W(wf(:,0),wf(:,57),wf(:,58))
  call vert_AW_Q(wf(:,-2),wf(:,36),wf(:,59))
  call prop_A_Q(wf(:,59),Q(:,13),ZERO,0_intkind1,wf(:,60))
  call vert_QA_W(wf(:,-1),wf(:,60),wf(:,61))
  call vert_AW_Q(wf(:,-2),wf(:,5),wf(:,62))
  call prop_A_Q(wf(:,62),Q(:,14),ZERO,0_intkind1,wf(:,63))
  call vert_QA_W(wf(:,0),wf(:,63),wf(:,64))
  call counter_AW_Q(wf(:,6),wf(:,5),wf(:,65))
  call counter_AZ_Q(gZu,wf(:,6),wf(:,4),wf(:,66))
  call counter_WQ_A(wf(:,5),wf(:,17),wf(:,67))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,17),wf(:,68))
  call counter_AV_Q(wf(:,20),wf(:,-6),wf(:,69))
  call counter_AV_Q(wf(:,23),wf(:,-6),wf(:,70))
  call counter_VG_G(wf(:,4),wf(:,-6),Q(:,64),wf(:,71),Q(:,69))
  call vert_QA_V(wf(:,-5),wf(:,23),wf(:,72))
  call vert_QA_V(wf(:,12),wf(:,-4),wf(:,73))
  call counter_QA_W(wf(:,-5),wf(:,6),wf(:,74))
  call prop_W_W(wf(:,14),Q(:,15),MW,1_intkind1,wf(:,75))
  call counter_WQ_A(wf(:,5),wf(:,-5),wf(:,76))
  call prop_A_Q(wf(:,11),Q(:,85),ZERO,0_intkind1,wf(:,77))
  call counter_ZQ_A(gZd,wf(:,4),wf(:,-5),wf(:,78))
  call prop_A_Q(wf(:,8),Q(:,90),ZERO,0_intkind1,wf(:,79))
  call prop_Q_A(wf(:,76),Q(:,42),ZERO,0_intkind1,wf(:,80))
  call prop_Q_A(wf(:,78),Q(:,37),ZERO,0_intkind1,wf(:,81))
  call counter_VQ_A(wf(:,-6),wf(:,-5),wf(:,82))
  call prop_Q_A(wf(:,82),Q(:,96),ZERO,0_intkind1,wf(:,83))
  call vert_WQ_A(wf(:,5),wf(:,83),wf(:,84))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,83),wf(:,85))
  call vert_QA_W(wf(:,83),wf(:,-4),wf(:,86))
  call prop_W_W(wf(:,86),Q(:,112),MW,1_intkind1,wf(:,87))
  call counter_QA_W(wf(:,17),wf(:,-4),wf(:,88))
  call counter_AW_Q(wf(:,-4),wf(:,5),wf(:,89))
  call prop_Q_A(wf(:,22),Q(:,101),ZERO,0_intkind1,wf(:,90))
  call counter_AZ_Q(gZu,wf(:,-4),wf(:,4),wf(:,91))
  call prop_Q_A(wf(:,19),Q(:,106),ZERO,0_intkind1,wf(:,92))
  call prop_A_Q(wf(:,89),Q(:,26),ZERO,0_intkind1,wf(:,93))
  call vert_AV_Q(wf(:,93),wf(:,-6),wf(:,94))
  call prop_A_Q(wf(:,91),Q(:,21),ZERO,0_intkind1,wf(:,95))
  call vert_AV_Q(wf(:,95),wf(:,-6),wf(:,96))
  call counter_AV_Q(wf(:,-4),wf(:,-6),wf(:,97))
  call prop_A_Q(wf(:,97),Q(:,80),ZERO,0_intkind1,wf(:,98))
  call vert_AW_Q(wf(:,98),wf(:,5),wf(:,99))
  call vert_AZ_Q(gZu,wf(:,98),wf(:,4),wf(:,100))
  call vert_QA_W(wf(:,-5),wf(:,98),wf(:,101))
  ...
  call counter_AZ_Q(gZu,wf(:,6),wf(:,37),wf(:,105))
  call counter_AW_Q(wf(:,6),wf(:,36),wf(:,106))
  call counter_ZQ_A(gZd,wf(:,37),wf(:,17),wf(:,107))
  call counter_WQ_A(wf(:,36),wf(:,17),wf(:,108))
  call counter_AV_Q(wf(:,47),wf(:,-6),wf(:,109))
  call counter_VG_G(wf(:,37),wf(:,-6),Q(:,64),wf(:,110),Q(:,70))
  call vert_QA_V(wf(:,-5),wf(:,47),wf(:,111))
  call counter_AV_Q(wf(:,50),wf(:,-6),wf(:,112))
  call vert_QA_V(wf(:,40),wf(:,-4),wf(:,113))
  call prop_W_W(wf(:,44),Q(:,15),MW,1_intkind1,wf(:,114))
  call counter_ZQ_A(gZd,wf(:,37),wf(:,-5),wf(:,115))
  call prop_A_Q(wf(:,42),Q(:,89),ZERO,0_intkind1,wf(:,116))
  call counter_WQ_A(wf(:,36),wf(:,-5),wf(:,117))
  call prop_A_Q(wf(:,39),Q(:,86),ZERO,0_intkind1,wf(:,118))
  call prop_Q_A(wf(:,115),Q(:,38),ZERO,0_intkind1,wf(:,119))
  call prop_Q_A(wf(:,117),Q(:,41),ZERO,0_intkind1,wf(:,120))
  call vert_ZQ_A(gZd,wf(:,37),wf(:,83),wf(:,121))
  call vert_WQ_A(wf(:,36),wf(:,83),wf(:,122))
  call counter_AZ_Q(gZu,wf(:,-4),wf(:,37),wf(:,123))
  call prop_Q_A(wf(:,49),Q(:,105),ZERO,0_intkind1,wf(:,124))
  call counter_AW_Q(wf(:,-4),wf(:,36),wf(:,125))
  call prop_Q_A(wf(:,46),Q(:,102),ZERO,0_intkind1,wf(:,126))
  call prop_A_Q(wf(:,123),Q(:,22),ZERO,0_intkind1,wf(:,127))
  call vert_AV_Q(wf(:,127),wf(:,-6),wf(:,128))
  call prop_A_Q(wf(:,125),Q(:,25),ZERO,0_intkind1,wf(:,129))
  call vert_AV_Q(wf(:,129),wf(:,-6),wf(:,130))
  call vert_AZ_Q(gZu,wf(:,98),wf(:,37),wf(:,131))
  call vert_AW_Q(wf(:,98),wf(:,36),wf(:,132))
  call counter_A_Q(ctqq,wf(:,6),Q(:,80),wf(:,133))
  call prop_A_Q(wf(:,133),Q(:,80),ZERO,0_intkind1,wf(:,134))
  call vert_QA_W(wf(:,-5),wf(:,134),wf(:,135))
  call vert_AW_Q(wf(:,134),wf(:,5),wf(:,136))
  call vert_AZ_Q(gZu,wf(:,134),wf(:,4),wf(:,137))
  call counter_Q_A(ctqq,wf(:,9),Q(:,37),wf(:,138))
  call counter_Q_A(ctqq,wf(:,12),Q(:,42),wf(:,139))
  call counter_Q_A(ctqq,wf(:,17),Q(:,96),wf(:,140))
  call prop_Q_A(wf(:,140),Q(:,96),ZERO,0_intkind1,wf(:,141))
  call vert_QA_W(wf(:,141),wf(:,-4),wf(:,142))
  call counter_A_Q(ctqq,wf(:,20),Q(:,21),wf(:,143))
  call counter_A_Q(ctqq,wf(:,23),Q(:,26),wf(:,144))
  call vert_WQ_A(wf(:,5),wf(:,141),wf(:,145))
  call vert_ZQ_A(gZd,wf(:,4),wf(:,141),wf(:,146))
  call vert_VQ_A(wf(:,-6),wf(:,12),wf(:,147))
  call prop_Q_A(wf(:,147),Q(:,106),ZERO,0_intkind1,wf(:,148))
  call vert_VQ_A(wf(:,-6),wf(:,9),wf(:,149))
  call prop_Q_A(wf(:,149),Q(:,101),ZERO,0_intkind1,wf(:,150))
  call prop_A_Q(wf(:,26),Q(:,85),ZERO,0_intkind1,wf(:,151))
  call prop_A_Q(wf(:,27),Q(:,90),ZERO,0_intkind1,wf(:,152))
  call prop_W_W(wf(:,30),Q(:,15),MW,1_intkind1,wf(:,153))
  call prop_W_W(wf(:,33),Q(:,15),MW,1_intkind1,wf(:,154))
  call vert_AZ_Q(gZu,wf(:,134),wf(:,37),wf(:,155))
  call vert_AW_Q(wf(:,134),wf(:,36),wf(:,156))
  call counter_Q_A(ctqq,wf(:,40),Q(:,41),wf(:,157))
  call counter_Q_A(ctqq,wf(:,43),Q(:,38),wf(:,158))
  call counter_A_Q(ctqq,wf(:,47),Q(:,25),wf(:,159))
  call counter_A_Q(ctqq,wf(:,50),Q(:,22),wf(:,160))
  call vert_ZQ_A(gZd,wf(:,37),wf(:,141),wf(:,161))
  call vert_WQ_A(wf(:,36),wf(:,141),wf(:,162))
  call vert_VQ_A(wf(:,-6),wf(:,43),wf(:,163))
  call prop_Q_A(wf(:,163),Q(:,102),ZERO,0_intkind1,wf(:,164))
  call vert_VQ_A(wf(:,-6),wf(:,40),wf(:,165))
  call prop_Q_A(wf(:,165),Q(:,105),ZERO,0_intkind1,wf(:,166))
  call prop_A_Q(wf(:,51),Q(:,89),ZERO,0_intkind1,wf(:,167))
  call prop_A_Q(wf(:,52),Q(:,86),ZERO,0_intkind1,wf(:,168))
  ...
  call vert_AW_Q(wf(:,20),wf(:,5),wf(:,173))
  call prop_A_Q(wf(:,173),Q(:,31),ZERO,0_intkind1,wf(:,174))
  call vert_WQ_A(wf(:,5),wf(:,9),wf(:,175))
  call prop_Q_A(wf(:,175),Q(:,47),ZERO,0_intkind1,wf(:,176))
  call vert_AZ_Q(gZd,wf(:,23),wf(:,4),wf(:,177))
  call prop_A_Q(wf(:,177),Q(:,31),ZERO,0_intkind1,wf(:,178))
  call vert_ZQ_A(gZu,wf(:,4),wf(:,12),wf(:,179))
  call prop_Q_A(wf(:,179),Q(:,47),ZERO,0_intkind1,wf(:,180))
  call vert_AW_Q(wf(:,-4),wf(:,75),wf(:,181))
  call prop_A_Q(wf(:,181),Q(:,31),ZERO,0_intkind1,wf(:,182))
  call vert_WQ_A(wf(:,75),wf(:,-5),wf(:,183))
  call prop_Q_A(wf(:,183),Q(:,47),ZERO,0_intkind1,wf(:,184))
  call vert_AW_Q(wf(:,-4),wf(:,153),wf(:,185))
  call prop_A_Q(wf(:,185),Q(:,31),ZERO,0_intkind1,wf(:,186))
  call vert_WQ_A(wf(:,153),wf(:,-5),wf(:,187))
  call prop_Q_A(wf(:,187),Q(:,47),ZERO,0_intkind1,wf(:,188))
  call vert_AW_Q(wf(:,-4),wf(:,154),wf(:,189))
  call prop_A_Q(wf(:,189),Q(:,31),ZERO,0_intkind1,wf(:,190))
  call vert_WQ_A(wf(:,154),wf(:,-5),wf(:,191))
  call prop_Q_A(wf(:,191),Q(:,47),ZERO,0_intkind1,wf(:,192))
  call vert_AZ_Q(gZd,wf(:,47),wf(:,37),wf(:,193))
  call prop_A_Q(wf(:,193),Q(:,31),ZERO,0_intkind1,wf(:,194))
  call vert_ZQ_A(gZu,wf(:,37),wf(:,40),wf(:,195))
  call prop_Q_A(wf(:,195),Q(:,47),ZERO,0_intkind1,wf(:,196))
  call vert_AW_Q(wf(:,50),wf(:,36),wf(:,197))
  call prop_A_Q(wf(:,197),Q(:,31),ZERO,0_intkind1,wf(:,198))
  call vert_WQ_A(wf(:,36),wf(:,43),wf(:,199))
  call prop_Q_A(wf(:,199),Q(:,47),ZERO,0_intkind1,wf(:,200))
  call vert_AW_Q(wf(:,-4),wf(:,114),wf(:,201))
  call prop_A_Q(wf(:,201),Q(:,31),ZERO,0_intkind1,wf(:,202))
  call vert_WQ_A(wf(:,114),wf(:,-5),wf(:,203))
  call prop_Q_A(wf(:,203),Q(:,47),ZERO,0_intkind1,wf(:,204))
  call vert_AW_Q(wf(:,-4),wf(:,169),wf(:,205))
  call prop_A_Q(wf(:,205),Q(:,31),ZERO,0_intkind1,wf(:,206))
  call vert_WQ_A(wf(:,169),wf(:,-5),wf(:,207))
  call prop_Q_A(wf(:,207),Q(:,47),ZERO,0_intkind1,wf(:,208))
  call vert_AW_Q(wf(:,-4),wf(:,170),wf(:,209))
  call prop_A_Q(wf(:,209),Q(:,31),ZERO,0_intkind1,wf(:,210))
  call vert_WQ_A(wf(:,170),wf(:,-5),wf(:,211))
  call prop_Q_A(wf(:,211),Q(:,47),ZERO,0_intkind1,wf(:,212))
  call vert_AW_Q(wf(:,-4),wf(:,171),wf(:,213))
  call prop_A_Q(wf(:,213),Q(:,31),ZERO,0_intkind1,wf(:,214))
  call vert_WQ_A(wf(:,171),wf(:,-5),wf(:,215))
  call prop_Q_A(wf(:,215),Q(:,47),ZERO,0_intkind1,wf(:,216))
  call vert_AW_Q(wf(:,-4),wf(:,172),wf(:,217))
  call prop_A_Q(wf(:,217),Q(:,31),ZERO,0_intkind1,wf(:,218))
  call vert_WQ_A(wf(:,172),wf(:,-5),wf(:,219))
  call prop_Q_A(wf(:,219),Q(:,47),ZERO,0_intkind1,wf(:,220))
...
subroutine denominators()
  ...
  den(92) = den(1)*den(91)
  den(94) = den(38)*den(93)
  den(95) = den(51)*den(94)
  den(96) = den(41)*den(94)
  ...
  den(197) = den(38)*den(51)
  den(198) = den(177)*den(197)
  den(199) = den(41)*den(195)
  den(200) = den(38)*den(41)
  den(201) = den(180)*den(200)
  den(202) = den(37)*den(55)
  den(203) = den(177)*den(202)
  ...
  den(238) = den(38)*den(196)
  den(239) = den(38)*den(160)
  den(240) = den(38)*den(199)
  den(241) = den(38)*den(158)
  den(242) = den(37)*den(162)
  ...
  den(262) = den(3)*den(201)
  den(263) = den(3)*den(205)
  den(264) = den(3)*den(207)
  den(265) = den(16)*den(198)
  den(266) = den(16)*den(203)
...
subroutine diagrams(A)
  ...
  A(66) = cont_VV(wf(:,110),wf(:,111)) * den(95)
  A(67) = cont_QA(wf(:,40),wf(:,112)) * den(59)
  A(68) = cont_VV(wf(:,110),wf(:,113)) * den(96)
...
subroutine colourvectors(A, M1, M2)
  ...
  M1(1) = (-A(25)-A(26)+A(27)+A(28))*f(1)+(A(3)+A(6)-A(15)-A(18))*f(5)+(A(1)+A(2)+A(4)+A(5)+A(7)+A(8)+A(9)+A(10)+A(11)+A(12)-A(13) &
       -A(14)-A(16)-A(17)-A(19)-A(20)-A(21)-A(22)-A(23)-A(24))*f(9)

  M2(1) = (A(137)+A(138)-A(139)-A(140))*f(2)+(-A(94)-A(96)+A(98)+A(100))*f(3)+(-A(93)-A(95)+A(97)+A(99))*f(4)+(-A(101)-A(106) &
       +A(119)+A(124))*f(6)+(A(44)+A(52)-A(76)-A(84))*f(7)+(A(37)+A(45)-A(69)-A(77))*f(8)+(-A(102)-A(103)-A(104)-A(105)-A(107) &
       -A(108)-A(109)-A(110)-A(111)-A(112)-A(113)-A(114)-A(115)-A(116)-A(117)-A(118)+A(120)+A(121)+A(122)+A(123)+A(125)+A(126) &
       +A(127)+A(128)+A(129)+A(130)+A(131)+A(132)+A(133)+A(134)+A(135)+A(136))*f(10)+(A(33)+A(34)+A(42)+A(43)+A(50)+A(51)+A(55) &
       +A(56)+A(59)+A(60)-A(65)-A(67)-A(74)-A(75)-A(82)-A(83)-A(87)-A(88)-A(91)-A(92))*f(11)+(A(29)+A(30)+A(31)+A(32)+A(38)+A(39) &
       +A(40)+A(41)+A(46)+A(47)+A(48)+A(49)+A(53)+A(54)+A(57)+A(58)-A(61)-A(62)-A(63)-A(64)-A(70)-A(71)-A(72)-A(73)-A(78)-A(79) &
       -A(80)-A(81)-A(85)-A(86)-A(89)-A(90))*f(12)+(-A(35)-A(36)+A(66)+A(68))*f(13)

end subroutine colourvectors

end module ol_loop_ppllllj_nenenexexuxdg_1_/**/REALKIND
