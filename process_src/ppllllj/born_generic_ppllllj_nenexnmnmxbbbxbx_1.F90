...
module ol_external_ppllllj_nenexnmnmxbbbxbx_1
  implicit none
  integer :: dummy_counter
  ! Permutation and inverse permutation of external particles
  integer, save :: external_perm_ppllllj_nenexnmnmxbbbxbx_1(8) = &
                     [ (dummy_counter, dummy_counter = 1, 8) ]
  integer, save :: external_perm_inv_ppllllj_nenexnmnmxbbbxbx_1(8) = &
                     [ (dummy_counter, dummy_counter = 1, 8) ]
  integer, save :: extcomb_perm_ppllllj_nenexnmnmxbbbxbx_1(0:37) = &
                     [ (dummy_counter, dummy_counter = 0, 37) ]
  ! Particle types (mapping of fields to integers is not fixed!)
  integer, save :: particle_types_ppllllj_nenexnmnmxbbbxbx_1(8) = &
                     [ 1, 2, 3, 4, 5, 5, 6, 6 ]
  ! Colour and helicity average factors per particle
  integer, save :: average_factors_ppllllj_nenexnmnmxbbbxbx_1(8) = &
                     [ 2, 2, 2, 2, 6, 6, 6, 6 ]
  ! Average factor; initialised to the identity permutation
  integer, save :: average_factor_ppllllj_nenexnmnmxbbbxbx_1 = &
                     16
  integer, save :: channel_number_ppllllj_nenexnmnmxbbbxbx_1 = -1
  ...
  subroutine n_external(n) &
      & bind(c,name="ol_f_n_external_ppllllj_nenexnmnmxbbbxbx_1")
  ...
  subroutine n_external_c(n) &
      & bind(c,name="ol_n_external_ppllllj_nenexnmnmxbbbxbx_1")
  ...
  subroutine set_permutation(perm) &
      & bind(c,name="ol_f_set_permutation_ppllllj_nenexnmnmxbbbxbx_1")
    use ol_parameters_decl_/**/DREALKIND, only: out_symmetry_on
    use ol_generic, only: factorial
    implicit none
    integer, intent(in) :: perm(8)
    integer :: i, j, ii, jj
    integer :: particle_types_perm_ppllllj_nenexnmnmxbbbxbx_1(8)
    external_perm_ppllllj_nenexnmnmxbbbxbx_1 = perm
    do i = 1, 8
      external_perm_inv_ppllllj_nenexnmnmxbbbxbx_1( &
        external_perm_ppllllj_nenexnmnmxbbbxbx_1(i)) = i
      particle_types_perm_ppllllj_nenexnmnmxbbbxbx_1(i) = &
        particle_types_ppllllj_nenexnmnmxbbbxbx_1( &
        external_perm_ppllllj_nenexnmnmxbbbxbx_1(i))
    end do
    do i = 1, 8
      do j = 1, i
        if (external_perm_ppllllj_nenexnmnmxbbbxbx_1(i) >= &
          external_perm_ppllllj_nenexnmnmxbbbxbx_1(j)) then
          ii = external_perm_ppllllj_nenexnmnmxbbbxbx_1(i)
          jj = external_perm_ppllllj_nenexnmnmxbbbxbx_1(j)
        else
          ii = external_perm_ppllllj_nenexnmnmxbbbxbx_1(j)
          jj = external_perm_ppllllj_nenexnmnmxbbbxbx_1(i)
        end if
        extcomb_perm_ppllllj_nenexnmnmxbbbxbx_1((i*(i-1))/2 + j) = (ii*(ii-1))/2 + jj
      end do
    end do
    ! Colour and helicity average factor
    average_factor_ppllllj_nenexnmnmxbbbxbx_1 = &
      average_factors_ppllllj_nenexnmnmxbbbxbx_1( &
      external_perm_ppllllj_nenexnmnmxbbbxbx_1(1)) &
      * average_factors_ppllllj_nenexnmnmxbbbxbx_1( &
      external_perm_ppllllj_nenexnmnmxbbbxbx_1(2))
    ! Symmetry factor for outgoing particles
    if (out_symmetry_on /= 0) then
      do i = 1, 8
        average_factor_ppllllj_nenexnmnmxbbbxbx_1 = &
          average_factor_ppllllj_nenexnmnmxbbbxbx_1 &
          * factorial(count(particle_types_perm_ppllllj_nenexnmnmxbbbxbx_1(3:8) == i))
      end do
    end if
  ...
  subroutine set_permutation_c(perm) &
      & bind(c,name="ol_set_permutation_ppllllj_nenexnmnmxbbbxbx_1")
    use, intrinsic :: iso_c_binding, only: c_int
    implicit none
  ...
  subroutine get_masses(m_ex) &
      & bind(c,name="ol_f_get_masses_ppllllj_nenexnmnmxbbbxbx_1")
    ...
    do i = 1, 8
      m_ex(i) = m_ex_orig(external_perm_ppllllj_nenexnmnmxbbbxbx_1(i))
    end do
  end subroutine get_masses


  subroutine get_masses_c(m_ex) &
      & bind(c,name="ol_get_masses_ppllllj_nenexnmnmxbbbxbx_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo(sqrt_s, p_rambo) &
      & bind(c,name="ol_f_rambo_ppllllj_nenexnmnmxbbbxbx_1")
    use KIND_TYPES, only: DREALKIND
  ...
  subroutine rambo_c(sqrt_s, p_rambo) &
      & bind(c,name="ol_rambo_ppllllj_nenexnmnmxbbbxbx_1")
    use KIND_TYPES, only: DREALKIND
    use, intrinsic :: iso_c_binding, only: c_double
    implicit none
...
end module ol_external_ppllllj_nenexnmnmxbbbxbx_1


module colour_basis_ppllllj_nenexnmnmxbbbxbx_1
  implicit none
  ! tree colour basis
  ...
  pure subroutine tree_colbasis_dim(extcols, ncolb, ncoupl, maxpows, nhel) &
    & bind(c, name="ol_tree_colbasis_dim_ppllllj_nenexnmnmxbbbxbx_1")
    implicit none
  ...
  subroutine tree_colbasis(basis, powers) &
    & bind(c, name="ol_tree_colbasis_ppllllj_nenexnmnmxbbbxbx_1")
    implicit none
...
end module colour_basis_ppllllj_nenexnmnmxbbbxbx_1


! Only for compatibility with the Sherpa interface

subroutine set_permutation_ppllllj_nenexnmnmxbbbxbx_1(perm)
  use ol_external_ppllllj_nenexnmnmxbbbxbx_1, only: set_permutation
  implicit none
  integer, intent(in) :: perm(8)
  call set_permutation(perm)
end subroutine set_permutation_ppllllj_nenexnmnmxbbbxbx_1

! **********************************************************************
module ol_heltables_ppllllj_nenexnmnmxbbbxbx_1
! **********************************************************************
  ...
  integer(intkind2), save :: n2(26), n3(3,163)

  ! helicity tables used in the construction of the h helicity states of a wave function (amplitude)
  ! from an v-point vertex (contraction): t<v>x<h>(v-1,h,sz)
  integer(intkind2), save :: t3x4(2,4,6), t3x8(2,8,20), t3x32(2,32,20), t3x16(2,16,37), t3x256(2,256,80)
...
! **********************************************************************
  ...
  n2(23) = 8
  call heltable([8,2,16], n3(:,81), t3x16(:,:,36))
  n2(24) = 16
  call heltable([2,4,8], n3(:,82), t3x8(:,:,20))
  n2(25) = 8
  call heltable([2,8,16], n3(:,83), t3x16(:,:,37))
  n2(26) = 16
  call heltable([8,32,256], n3(:,84), t3x256(:,:,1))
  call heltable([8,32,256], n3(:,85), t3x256(:,:,2))
  call heltable([8,32,256], n3(:,86), t3x256(:,:,3))
  call heltable([8,32,256], n3(:,87), t3x256(:,:,4))
  call heltable([8,32,256], n3(:,88), t3x256(:,:,5))
  call heltable([8,32,256], n3(:,89), t3x256(:,:,6))
  call heltable([16,16,256], n3(:,90), t3x256(:,:,7))
  call heltable([16,16,256], n3(:,91), t3x256(:,:,8))
  call heltable([8,32,256], n3(:,92), t3x256(:,:,9))
  call heltable([8,32,256], n3(:,93), t3x256(:,:,10))
  call heltable([8,32,256], n3(:,94), t3x256(:,:,11))
  call heltable([8,32,256], n3(:,95), t3x256(:,:,12))
  call heltable([8,32,256], n3(:,96), t3x256(:,:,13))
  call heltable([8,32,256], n3(:,97), t3x256(:,:,14))
  call heltable([16,16,256], n3(:,98), t3x256(:,:,15))
  call heltable([16,16,256], n3(:,99), t3x256(:,:,16))
  call heltable([8,32,256], n3(:,100), t3x256(:,:,17))
  call heltable([32,8,256], n3(:,101), t3x256(:,:,18))
  call heltable([8,32,256], n3(:,102), t3x256(:,:,19))
  call heltable([8,32,256], n3(:,103), t3x256(:,:,20))
  call heltable([32,8,256], n3(:,104), t3x256(:,:,21))
  call heltable([8,32,256], n3(:,105), t3x256(:,:,22))
  call heltable([16,16,256], n3(:,106), t3x256(:,:,23))
  call heltable([16,16,256], n3(:,107), t3x256(:,:,24))
  call heltable([8,32,256], n3(:,108), t3x256(:,:,25))
  call heltable([32,8,256], n3(:,109), t3x256(:,:,26))
  call heltable([8,32,256], n3(:,110), t3x256(:,:,27))
  call heltable([8,32,256], n3(:,111), t3x256(:,:,28))
  call heltable([32,8,256], n3(:,112), t3x256(:,:,29))
  call heltable([8,32,256], n3(:,113), t3x256(:,:,30))
  call heltable([16,16,256], n3(:,114), t3x256(:,:,31))
  call heltable([16,16,256], n3(:,115), t3x256(:,:,32))
  call heltable([16,16,256], n3(:,116), t3x256(:,:,33))
  call heltable([16,16,256], n3(:,117), t3x256(:,:,34))
  call heltable([16,16,256], n3(:,118), t3x256(:,:,35))
  call heltable([16,16,256], n3(:,119), t3x256(:,:,36))
  call heltable([16,16,256], n3(:,120), t3x256(:,:,37))
  call heltable([16,16,256], n3(:,121), t3x256(:,:,38))
  call heltable([16,16,256], n3(:,122), t3x256(:,:,39))
  call heltable([16,16,256], n3(:,123), t3x256(:,:,40))
  call heltable([16,16,256], n3(:,124), t3x256(:,:,41))
  call heltable([16,16,256], n3(:,125), t3x256(:,:,42))
  call heltable([16,16,256], n3(:,126), t3x256(:,:,43))
  call heltable([16,16,256], n3(:,127), t3x256(:,:,44))
  call heltable([16,16,256], n3(:,128), t3x256(:,:,45))
  call heltable([16,16,256], n3(:,129), t3x256(:,:,46))
  call heltable([16,16,256], n3(:,130), t3x256(:,:,47))
  call heltable([16,16,256], n3(:,131), t3x256(:,:,48))
  call heltable([16,16,256], n3(:,132), t3x256(:,:,49))
  call heltable([16,16,256], n3(:,133), t3x256(:,:,50))
  call heltable([16,16,256], n3(:,134), t3x256(:,:,51))
  call heltable([16,16,256], n3(:,135), t3x256(:,:,52))
  call heltable([16,16,256], n3(:,136), t3x256(:,:,53))
  call heltable([16,16,256], n3(:,137), t3x256(:,:,54))
  call heltable([16,16,256], n3(:,138), t3x256(:,:,55))
  call heltable([16,16,256], n3(:,139), t3x256(:,:,56))
  call heltable([16,16,256], n3(:,140), t3x256(:,:,57))
  call heltable([16,16,256], n3(:,141), t3x256(:,:,58))
  call heltable([16,16,256], n3(:,142), t3x256(:,:,59))
  call heltable([16,16,256], n3(:,143), t3x256(:,:,60))
  call heltable([16,16,256], n3(:,144), t3x256(:,:,61))
  call heltable([16,16,256], n3(:,145), t3x256(:,:,62))
  call heltable([16,16,256], n3(:,146), t3x256(:,:,63))
  call heltable([16,16,256], n3(:,147), t3x256(:,:,64))
  call heltable([16,16,256], n3(:,148), t3x256(:,:,65))
  call heltable([16,16,256], n3(:,149), t3x256(:,:,66))
  call heltable([16,16,256], n3(:,150), t3x256(:,:,67))
  call heltable([16,16,256], n3(:,151), t3x256(:,:,68))
  call heltable([16,16,256], n3(:,152), t3x256(:,:,69))
  call heltable([16,16,256], n3(:,153), t3x256(:,:,70))
  call heltable([16,16,256], n3(:,154), t3x256(:,:,71))
  call heltable([16,16,256], n3(:,155), t3x256(:,:,72))
  call heltable([16,16,256], n3(:,156), t3x256(:,:,73))
  call heltable([16,16,256], n3(:,157), t3x256(:,:,74))
  call heltable([16,16,256], n3(:,158), t3x256(:,:,75))
  call heltable([16,16,256], n3(:,159), t3x256(:,:,76))
  call heltable([16,16,256], n3(:,160), t3x256(:,:,77))
  call heltable([16,16,256], n3(:,161), t3x256(:,:,78))
  call heltable([16,16,256], n3(:,162), t3x256(:,:,79))
  call heltable([16,16,256], n3(:,163), t3x256(:,:,80))

  heltables_not_init = .false.

end subroutine init_heltables

end module ol_heltables_ppllllj_nenexnmnmxbbbxbx_1
