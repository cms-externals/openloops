...
! **********************************************************************
module ol_tensor_sum_storage_ppllllj_nenmxexmddxg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppllllj_nenmxexmddxg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppllllj_nenmxexmddxg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppllllj_nenmxexmddxg_1, only: channel_number_ppllllj_nenmxexmddxg_1
  ...
  call channel_on(channel_number_ppllllj_nenmxexmddxg_1)
  M2 = 0
  ...
  call TI_call(3, momenta_27, masses2_9, T3sum(:,6), M2)
  call TI_call(3, momenta_22, masses2_9, T3sum(:,7), M2)
  call TI_call(3, momenta_20, masses2_9, T3sum(:,8), M2)
  call TI_call(3, momenta_29, masses2_9, T3sum(:,9), M2)
  call TI_call(3, momenta_24, masses2_9, T3sum(:,10), M2)
  call TI_call(3, momenta_25, masses2_9, T3sum(:,11), M2)
  ...
  call channel_off(channel_number_ppllllj_nenmxexmddxg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppllllj_nenmxexmddxg_1_/**/REALKIND
