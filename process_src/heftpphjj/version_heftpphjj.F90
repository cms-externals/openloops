...
module ol_versiondata_heftpphjj
  implicit none
  character(4) :: generator_revision = "1790"
  interface
    subroutine version_heftpphjj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_heftpphjj
  end interface
end module ol_versiondata_heftpphjj


subroutine ol_version_heftpphjj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_heftpphjj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_heftpphjj
