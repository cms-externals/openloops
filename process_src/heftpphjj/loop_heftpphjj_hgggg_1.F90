...
subroutine colourvectors(A, M1, M2)
  ...
  M2(4) = 2*(-A(73)+A(74)+A(76)-A(78)-A(80)+A(81)-A(82)+A(83)+A(94)-A(95)+A(113)-A(114)-A(115)+A(117)+A(118)-A(119)+A(133)-A(135) &
       ...
       +A(38))*f(3)-4*A(39)*f(3)+2*(-A(85)+A(87)+A(88)-A(90))*f(4)+2*(-A(67)+A(69)+A(70)-A(72)+A(91)-A(93)-A(97)+A(99)+A(101) &
       -A(102)-A(103)-A(104)-A(105)+A(106)+A(110)+A(111)-A(121)+A(122)+A(125)+A(126)+A(127)-A(130)-A(131)-A(132))*f(5)+2*(A(43) &
       +A(44)+A(50)+A(51)+A(55)+A(57)+A(61)+A(62))*f(6)+4*(-A(45)-A(49)-A(56)-A(63))*f(6)+17*(-A(46)-A(47)-A(53)-A(54)-A(58)-A(60) &
       -A(64)-A(65))*f(7)+(98*(A(48)+A(52)+A(59)+A(66))*f(7))/3._/**/REALKIND+63*(A(40)+A(41))*f(8)-123*A(42)*f(8)
  M2(5) = 2*(A(73)-A(75)-A(76)+A(77)-A(79)+A(80)-A(83)+A(84)+A(95)-A(96)+A(112)-A(113)+A(115)-A(116)-A(118)+A(120)-A(133)-A(134) &
       ...
       +A(100)+A(102)+A(103)+A(104)+A(105)+A(107)+A(108)+A(109)+A(121)+A(123)+A(124)+A(128)+A(129)+A(130)+A(131)+A(132))*f(5)+4*( &
       -A(43)-A(51)-A(57)-A(62))*f(6)+2*(A(44)+A(45)+A(49)+A(50)+A(55)+A(56)+A(61)+A(63))*f(6)+(98*(A(46)+A(54)+A(60) &
  ...
  M2(6) = 2*(-A(74)+A(75)-A(77)+A(78)+A(79)-A(81)+A(82)-A(84)-A(94)+A(96)-A(112)+A(114)+A(116)-A(117)+A(119)-A(120)+A(134)+A(135) &
       ...
       -A(100)-A(101)-A(106)-A(107)-A(108)-A(109)-A(110)-A(111)-A(122)-A(123)-A(124)-A(125)-A(126)-A(127)-A(128)-A(129))*f(5)+4*( &
       -A(44)-A(50)-A(55)-A(61))*f(6)+2*(A(43)+A(45)+A(49)+A(51)+A(56)+A(57)+A(62)+A(63))*f(6)+(98*(A(47)+A(53)+A(58) &
