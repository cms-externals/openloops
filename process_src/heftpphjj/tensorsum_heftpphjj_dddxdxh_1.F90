...
! **********************************************************************
module ol_tensor_sum_storage_heftpphjj_dddxdxh_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_heftpphjj_dddxdxh_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_heftpphjj_dddxdxh_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_heftpphjj_dddxdxh_1, only: channel_number_heftpphjj_dddxdxh_1
  ...
  call channel_on(channel_number_heftpphjj_dddxdxh_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,16)
  momenta_2(:,1) = Q(1:4,21)
  momenta_3(:,1) = Q(1:4,22)
  momenta_4(:,1) = Q(1:4,25)
  momenta_5(:,1) = Q(1:4,26)
  momenta_6(:,1) = Q(1:4,4)
  momenta_6(:,2) = Q(1:4,29)
  momenta_7(:,1) = Q(1:4,4)
  ...
  momenta_16(:,1) = Q(1:4,21)
  momenta_16(:,2) = Q(1:4,29)
  momenta_17(:,1) = Q(1:4,22)
  momenta_17(:,2) = Q(1:4,30)
  momenta_18(:,1) = Q(1:4,25)
  momenta_18(:,2) = Q(1:4,29)
  momenta_19(:,1) = Q(1:4,26)
  ...
  momenta_33(:,3) = Q(1:4,26)
  momenta_33(:,4) = Q(1:4,30)
  momenta_34(:,1) = Q(1:4,4)
  momenta_34(:,2) = Q(1:4,6)
  ...
  momenta_38(:,2) = Q(1:4,20)
  momenta_38(:,3) = Q(1:4,22)
  momenta_38(:,4) = Q(1:4,30)
  momenta_39(:,1) = Q(1:4,16)
  momenta_39(:,2) = Q(1:4,24)
  momenta_39(:,3) = Q(1:4,26)
  ...
  call TI_call(2, momenta_8, masses2_4, T2sum(:,5), M2)
  call TI_call(2, momenta_9, masses2_4, T2sum(:,6), M2)
  call TI_call(2, momenta_6, masses2_4, T2sum(:,7), M2)
  call TI_call(2, momenta_7, masses2_4, T2sum(:,8), M2)
  call TI_call(2, momenta_1, masses2_2, T2sum(:,9), M2)
  call TI_call(2, momenta_5, masses2_2, T2sum(:,10), M2)
  call TI_call(2, momenta_2, masses2_2, T2sum(:,11), M2)
  call TI_call(2, momenta_3, masses2_2, T2sum(:,12), M2)
  call TI_call(2, momenta_4, masses2_2, T2sum(:,13), M2)
  call TI_call(2, momenta_2, masses2_1, T2sum(:,14), M2)
  call TI_call(2, momenta_5, masses2_1, T2sum(:,15), M2)
  call TI_call(2, momenta_4, masses2_1, T2sum(:,16), M2)
  call TI_call(2, momenta_3, masses2_1, T2sum(:,17), M2)
  ...
  call TI_call(3, momenta_10, masses2_3, T3sum(:,4), M2)
  call TI_call(3, momenta_15, masses2_4, T3sum(:,5), M2)
  call TI_call(3, momenta_13, masses2_4, T3sum(:,6), M2)

  call TI_call(4, momenta_11, masses2_4, T4sum(:,1), M2)
  call TI_call(4, momenta_26, masses2_5, T4sum(:,2), M2)
  call TI_call(4, momenta_20, masses2_5, T4sum(:,3), M2)
  call TI_call(4, momenta_28, masses2_5, T4sum(:,4), M2)
  call TI_call(4, momenta_10, masses2_4, T4sum(:,5), M2)
  call TI_call(4, momenta_27, masses2_5, T4sum(:,6), M2)
  call TI_call(4, momenta_21, masses2_5, T4sum(:,7), M2)
  call TI_call(4, momenta_29, masses2_5, T4sum(:,8), M2)
  call TI_call(4, momenta_30, masses2_5, T4sum(:,9), M2)
  call TI_call(4, momenta_22, masses2_5, T4sum(:,10), M2)
  call TI_call(4, momenta_24, masses2_5, T4sum(:,11), M2)
  call TI_call(4, momenta_31, masses2_5, T4sum(:,12), M2)
  call TI_call(4, momenta_23, masses2_5, T4sum(:,13), M2)
  call TI_call(4, momenta_25, masses2_5, T4sum(:,14), M2)
  call TI_call(4, momenta_33, masses2_6, T4sum(:,15), M2)
  call TI_call(4, momenta_32, masses2_6, T4sum(:,16), M2)
  call TI_call(4, momenta_34, masses2_6, T4sum(:,17), M2)
  call TI_call(4, momenta_35, masses2_6, T4sum(:,18), M2)
  call TI_call(4, momenta_39, masses2_6, T4sum(:,19), M2)
  call TI_call(4, momenta_37, masses2_6, T4sum(:,20), M2)
  call TI_call(4, momenta_38, masses2_6, T4sum(:,21), M2)
  call TI_call(4, momenta_36, masses2_6, T4sum(:,22), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_heftpphjj_dddxdxh_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_heftpphjj_dddxdxh_1_/**/REALKIND
