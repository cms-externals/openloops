...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(26)+A(27)-A(54)-A(55)-A(56)-A(57))*f(3)+CI*(-A(19)+A(20)+A(21)-A(22)-A(46)+A(47)-A(48)-A(49)-A(50)-A(51))*f(4)+(A(30) &
       +A(32)+A(36)+A(38))*f(5)+CI*(A(12)-A(43)+A(44)+A(45))*f(6)+CI*A(9)*f(7)+CI*(-A(16)+A(17)+A(18))*f(8)+(-A(11)-A(13))*f(9) &
       -CI*A(15)*f(10)+(-A(25)-A(34)-A(40))*f(11)+CI*(-A(35)-A(42))*f(12)
  M2(2) = (A(24)+A(28)-A(52)-A(53)-A(58)-A(59))*f(3)+CI*(A(19)-A(20)-A(21)+A(22)+A(46)-A(47)+A(48)+A(49)+A(50)+A(51))*f(4)+(A(29) &
       +A(31)+A(37)+A(39))*f(5)+CI*(-A(12)+A(43)-A(44)-A(45))*f(6)-CI*A(9)*f(7)+CI*(A(16)-A(17)-A(18))*f(8)+(-A(10)-A(14))*f(9) &
       +CI*A(15)*f(10)+(-A(23)-A(33)-A(41))*f(11)+CI*(A(35)+A(42))*f(12)
