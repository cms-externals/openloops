...
module ol_versiondata_pplna
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pplna(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplna
  end interface
end module ol_versiondata_pplna


subroutine ol_version_pplna(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplna, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplna
