...
module ol_colourmatrix_pplna_nexeudxa_1_/**/REALKIND
...
end module ol_colourmatrix_pplna_nexeudxa_1_/**/REALKIND



module ol_forced_parameters_pplna_nexeudxa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pplna_nexeudxa_1_/**/REALKIND

module ol_loop_pplna_nexeudxa_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_UV_W(wf(:,3),Q(:,3),wf(:,-4),Q(:,16),wf(:,5))
  call vert_VQ_A(wf(:,-4),wf(:,-2),wf(:,6))
  call prop_Q_A(wf(:,6),Q(:,20),ZERO,0_intkind1,wf(:,7))
  ...
  call prop_Q_A(wf(:,12),Q(:,18),ZERO,0_intkind1,wf(:,13))
  call vert_QA_W(wf(:,13),wf(:,0),wf(:,14))
  ...
  call counter_QA_W(wf(:,-2),wf(:,-3),wf(:,21))
  call prop_W_W(wf(:,21),Q(:,12),MW,1_intkind1,wf(:,22))
  call counter_Q_A(ctqq,wf(:,7),Q(:,20),wf(:,23))
  call prop_A_Q(wf(:,8),Q(:,11),ZERO,0_intkind1,wf(:,24))
  call counter_A_Q(ctqq,wf(:,10),Q(:,24),wf(:,25))
  call prop_Q_A(wf(:,11),Q(:,7),ZERO,0_intkind1,wf(:,26))
...
end module ol_loop_pplna_nexeudxa_1_/**/REALKIND
