...
module ol_versiondata_pplnj
  implicit none
  character(4) :: generator_revision = "1500"
  interface
    subroutine version_pplnj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pplnj
  end interface
end module ol_versiondata_pplnj


subroutine ol_version_pplnj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pplnj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pplnj
