...
module ol_colourmatrix_ppajj2_uuxagg_1_/**/REALKIND
  use KIND_TYPES, only: REALKIND
  implicit none
  logical, save           :: colmat_not_initialised = .true.
  complex(REALKIND), save :: K1(0,0), K2(0,3), KL(0,3), KL2(3,3), KL2ct(3,3), KL2ct2(3,3)
  contains
...
end module ol_colourmatrix_ppajj2_uuxagg_1_/**/REALKIND



module ol_forced_parameters_ppajj2_uuxagg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppajj2_uuxagg_1_/**/REALKIND

module ol_loop_ppajj2_uuxagg_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (2*countertermnorm*eQED*gQCD**4)/3._/**/REALKIND
    f(3) = (2*countertermnorm*ctGqq*eQED*gQCD**4)/3._/**/REALKIND
    f(4) = (2*countertermnorm*ctVqq*eQED*gQCD**4)/3._/**/REALKIND
    f(5) = (2*countertermnorm*ctVVV*eQED*gQCD**4)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,8),Q(:,6),ZERO,0_intkind1,wf(:,9))
  ...
  call prop_A_Q(wf(:,13),Q(:,6),ZERO,0_intkind1,wf(:,14))
  call vert_QA_V(wf(:,0),wf(:,14),wf(:,15))
  call counter_QA_V(wf(:,0),wf(:,9),wf(:,16))
  call counter_VQ_A(wf(:,-2),wf(:,0),wf(:,17))
  call prop_Q_A(wf(:,17),Q(:,5),ZERO,0_intkind1,wf(:,18))
  call vert_QA_V(wf(:,18),wf(:,-1),wf(:,19))
  call vert_AV_Q(wf(:,-1),wf(:,11),wf(:,20))
  call counter_Q_A(ctqq,wf(:,6),Q(:,5),wf(:,21))
  call prop_A_Q(wf(:,20),Q(:,26),ZERO,0_intkind1,wf(:,22))
  call vert_VQ_A(wf(:,11),wf(:,0),wf(:,23))
  call counter_A_Q(ctqq,wf(:,9),Q(:,6),wf(:,24))
...
end module ol_loop_ppajj2_uuxagg_1_/**/REALKIND
