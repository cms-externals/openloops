...
module ol_colourmatrix_ppln_ckm_nexeusx_1_/**/REALKIND
...
end module ol_colourmatrix_ppln_ckm_nexeusx_1_/**/REALKIND



module ol_forced_parameters_ppln_ckm_nexeusx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppln_ckm_nexeusx_1_/**/REALKIND

module ol_loop_ppln_ckm_nexeusx_1_/**/REALKIND
  ...
  ! tree wavefunctions
  complex(REALKIND), save :: wf(4,-4+1:4)
  ! denominators
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**2*VCKMsu)/(2._/**/REALKIND*sw**2)
    f(3) = (eQED**2*gQCD**2*integralnorm*SwB*VCKMsu)/(sw**2*2._/**/REALKIND)
...
! **********************************************************************
  ...
  call counter_QA_W(wf(:,-2),wf(:,-3),wf(:,4))
...
end module ol_loop_ppln_ckm_nexeusx_1_/**/REALKIND
