...
module ol_colourmatrix_ppln_ckm_neexcxs_1_/**/REALKIND
...
end module ol_colourmatrix_ppln_ckm_neexcxs_1_/**/REALKIND



module ol_forced_parameters_ppln_ckm_neexcxs_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppln_ckm_neexcxs_1_/**/REALKIND

module ol_loop_ppln_ckm_neexcxs_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVsc*eQED**2*gQCD**2*VCKMsc)/(2._/**/REALKIND*sw**2)
    f(3) = (eQED**2*gQCD**2*integralnorm*SwB*VCKMsc)/(sw**2*2._/**/REALKIND)
...
end module ol_loop_ppln_ckm_neexcxs_1_/**/REALKIND
