...
module ol_colourmatrix_ppln_ckm_neexcxd_1_/**/REALKIND
...
end module ol_colourmatrix_ppln_ckm_neexcxd_1_/**/REALKIND



module ol_forced_parameters_ppln_ckm_neexcxd_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppln_ckm_neexcxd_1_/**/REALKIND

module ol_loop_ppln_ckm_neexcxd_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**2*VCKMdc)/(2._/**/REALKIND*sw**2)
    f(3) = (eQED**2*gQCD**2*integralnorm*SwB*VCKMdc)/(sw**2*2._/**/REALKIND)
...
end module ol_loop_ppln_ckm_neexcxd_1_/**/REALKIND
