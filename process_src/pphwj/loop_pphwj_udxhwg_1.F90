...
module ol_colourmatrix_pphwj_udxhwg_1_/**/REALKIND
...
end module ol_colourmatrix_pphwj_udxhwg_1_/**/REALKIND



module ol_forced_parameters_pphwj_udxhwg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_pphwj_udxhwg_1_/**/REALKIND

module ol_loop_pphwj_udxhwg_1_/**/REALKIND
...
! **********************************************************************
  ...
  call prop_A_Q(wf(:,13),Q(:,10),ZERO,0_intkind1,wf(:,14))
  call vert_QA_V(wf(:,0),wf(:,14),wf(:,15))
  call counter_QA_W(wf(:,3),wf(:,-1),wf(:,16))
  call counter_AV_Q(wf(:,-1),wf(:,-4),wf(:,17))
  call prop_A_Q(wf(:,17),Q(:,18),ZERO,0_intkind1,wf(:,18))
  call vert_QA_W(wf(:,0),wf(:,18),wf(:,19))
  call counter_QA_W(wf(:,0),wf(:,7),wf(:,20))
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,21))
  call prop_Q_A(wf(:,21),Q(:,17),ZERO,0_intkind1,wf(:,22))
  call vert_QA_W(wf(:,22),wf(:,-1),wf(:,23))
  call vert_AW_Q(wf(:,-1),wf(:,4),wf(:,24))
  call counter_Q_A(ctqq,wf(:,3),Q(:,17),wf(:,25))
  call prop_A_Q(wf(:,24),Q(:,14),ZERO,0_intkind1,wf(:,26))
  call vert_WQ_A(wf(:,4),wf(:,0),wf(:,27))
  call counter_A_Q(ctqq,wf(:,7),Q(:,18),wf(:,28))
...
end module ol_loop_pphwj_udxhwg_1_/**/REALKIND
