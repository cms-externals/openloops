...
module ol_versiondata_pphwj
  implicit none
  character(4) :: generator_revision = "1268"
  interface
    subroutine version_pphwj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphwj
  end interface
end module ol_versiondata_pphwj


subroutine ol_version_pphwj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphwj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphwj
