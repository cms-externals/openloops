...
! **********************************************************************
module ol_tensor_sum_storage_pphzj_uuxhzg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphzj_uuxhzg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphzj_uuxhzg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pphzj_uuxhzg_1, only: channel_number_pphzj_uuxhzg_1
  ...
  call channel_on(channel_number_pphzj_uuxhzg_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,17)
  momenta_2(:,1) = Q(1:4,18)
  momenta_3(:,1) = Q(1:4,11)
  momenta_3(:,2) = Q(1:4,27)
  momenta_4(:,1) = Q(1:4,12)
  momenta_4(:,2) = Q(1:4,28)
  momenta_5(:,1) = Q(1:4,13)
  momenta_5(:,2) = Q(1:4,29)
  momenta_6(:,1) = Q(1:4,14)
  ...
  call TI_call(4, momenta_15, masses2_6, T4sum(:,1), M2)
  call TI_call(4, momenta_15, masses2_5, T4sum(:,2), M2)
  call TI_call(4, momenta_13, masses2_6, T4sum(:,3), M2)
  call TI_call(4, momenta_13, masses2_5, T4sum(:,4), M2)
  call TI_call(4, momenta_14, masses2_6, T4sum(:,5), M2)
  call TI_call(4, momenta_14, masses2_5, T4sum(:,6), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pphzj_uuxhzg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphzj_uuxhzg_1_/**/REALKIND
