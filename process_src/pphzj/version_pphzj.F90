...
module ol_versiondata_pphzj
  implicit none
  character(4) :: generator_revision = "1268"
  interface
    subroutine version_pphzj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphzj
  end interface
end module ol_versiondata_pphzj


subroutine ol_version_pphzj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphzj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphzj
