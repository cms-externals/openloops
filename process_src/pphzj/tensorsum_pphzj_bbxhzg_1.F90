...
! **********************************************************************
module ol_tensor_sum_storage_pphzj_bbxhzg_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_pphzj_bbxhzg_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_pphzj_bbxhzg_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_pphzj_bbxhzg_1, only: channel_number_pphzj_bbxhzg_1
  ...
  call channel_on(channel_number_pphzj_bbxhzg_1)
  M2 = 0
  ...
  call TI_call(3, momenta_11, masses2_6, T3sum(:,1), M2)
  call TI_call(3, momenta_11, masses2_4, T3sum(:,2), M2)
  call TI_call(3, momenta_11, masses2_2, T3sum(:,3), M2)
  call TI_call(3, momenta_7, masses2_6, T3sum(:,4), M2)
  call TI_call(3, momenta_7, masses2_4, T3sum(:,5), M2)
  call TI_call(3, momenta_7, masses2_2, T3sum(:,6), M2)
  call TI_call(3, momenta_42, masses2_10, T3sum(:,7), M2)
  call TI_call(3, momenta_33, masses2_8, T3sum(:,8), M2)
  call TI_call(3, momenta_32, masses2_8, T3sum(:,9), M2)
  call TI_call(3, momenta_43, masses2_10, T3sum(:,10), M2)
  call TI_call(3, momenta_35, masses2_8, T3sum(:,11), M2)
  call TI_call(3, momenta_34, masses2_8, T3sum(:,12), M2)
  ...
  call TI_call(4, momenta_36, masses2_9, T4sum(:,1), M2)
  call TI_call(4, momenta_36, masses2_7, T4sum(:,2), M2)
  call TI_call(4, momenta_30, masses2_9, T4sum(:,3), M2)
  call TI_call(4, momenta_30, masses2_7, T4sum(:,4), M2)
  call TI_call(4, momenta_31, masses2_9, T4sum(:,5), M2)
  call TI_call(4, momenta_31, masses2_7, T4sum(:,6), M2)
  call TI_call(4, momenta_53, masses2_11, T4sum(:,7), M2)
  call TI_call(4, momenta_55, masses2_11, T4sum(:,8), M2)
  call TI_call(4, momenta_51, masses2_11, T4sum(:,9), M2)
  call TI_call(4, momenta_54, masses2_11, T4sum(:,10), M2)
  call TI_call(4, momenta_50, masses2_11, T4sum(:,11), M2)
  call TI_call(4, momenta_52, masses2_11, T4sum(:,12), M2)
  call TI_call(4, momenta_57, masses2_12, T4sum(:,13), M2)
  call TI_call(4, momenta_56, masses2_12, T4sum(:,14), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_pphzj_bbxhzg_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_pphzj_bbxhzg_1_/**/REALKIND
