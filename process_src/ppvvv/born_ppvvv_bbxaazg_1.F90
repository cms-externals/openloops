...
module ol_colourmatrix_ppvvv_bbxaazg_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_bbxaazg_1_/**/REALKIND



module ol_forced_parameters_ppvvv_bbxaazg_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_bbxaazg_1_/**/REALKIND

module ol_tree_ppvvv_bbxaazg_1_/**/REALKIND
...
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu) &
    & bind(c,name="ol_f_amp2_ppvvv_bbxaazg_1")
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_ppvvv_bbxaazg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
! P_scatt(0:3,Npart) = incoming external momenta
! M2  = helicity-summed squared matrix element for bottom anti-bottom gamma gamma Z glue -> 0
...
! **********************************************************************
  ...
  use ol_external_ppvvv_bbxaazg_1, only: external_perm_ppvvv_bbxaazg_1, &
    & external_perm_inv_ppvvv_bbxaazg_1, extcomb_perm_ppvvv_bbxaazg_1, &
    & average_factor_ppvvv_bbxaazg_1
  use ol_external_ppvvv_bbxaazg_1, only: H, hel_not_initialised, hel_init
  use ol_colourmatrix_ppvvv_bbxaazg_1_/**/REALKIND, only: colmat_not_initialised, colourmatrix_init
  use ol_forced_parameters_ppvvv_bbxaazg_1_/**/REALKIND, only: check_forced_parameters
  use ol_heltables_ppvvv_bbxaazg_1
  ...
  extmasses2 = [ rMB2, rMB2, rZERO2, rZERO2, rMZ2, rZERO2 ]
  call conv_mom_scatt2in(P_scatt, extmasses2, P, external_perm_inv_ppvvv_bbxaazg_1,6)
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_ppvvv_bbxaazg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_ppvvv_bbxaazg_1(-I)
  end if

  do k = 1, nextcombs
    extcombs_permuted(k) = extcomb_perm_ppvvv_bbxaazg_1(extcombs(k))
  end do
  ...
  call prop_A_Q(ntry, wf4(:,5), Q(:,34), MB, 1_intkind1, wf4(:,6), n2(8))
  call vert_AZ_Q(gZd,ntry, wf4(:,6), ex5, wf12(:,8), n3(:,12), t3x12(:,:,5))
  call vert_AV_Q(ntry, wf4(:,6), ex4, wf8(:,5), n3(:,13), t3x8(:,:,4))
  call prop_A_Q(ntry, wf8(:,5), Q(:,42), MB, 1_intkind1, wf8(:,6), n2(9))
  call vert_VQ_A(ntry, ex4, ex1, wf4(:,7), n3(:,14), t3x4(:,:,4))
  call vert_AV_Q(ntry, ex2, ex3, wf4(:,8), n3(:,15), t3x4(:,:,5))
  call prop_Q_A(ntry, wf4(:,7), Q(:,9), MB, 1_intkind1, wf4(:,9), n2(10))
  call prop_A_Q(ntry, wf4(:,8), Q(:,6), MB, 1_intkind1, wf4(:,10), n2(11))
  call vert_ZQ_A(gZd,ntry, ex5, wf4(:,9), wf12(:,9), n3(:,16), t3x12(:,:,6))
  call vert_AV_Q(ntry, wf4(:,10), ex6, wf8(:,7), n3(:,17), t3x8(:,:,5))
  call prop_Q_A(ntry, wf12(:,9), Q(:,25), MB, 1_intkind1, wf12(:,10), n2(12))
  call vert_AZ_Q(gZd,ntry, wf4(:,10), ex5, wf12(:,11), n3(:,18), t3x12(:,:,7))
  call vert_VQ_A(ntry, ex6, wf4(:,9), wf8(:,8), n3(:,19), t3x8(:,:,6))
  call prop_A_Q(ntry, wf12(:,11), Q(:,22), MB, 1_intkind1, wf12(:,12), n2(13))
  call vert_ZQ_A(gZd,ntry, ex5, ex1, wf6(:,3), n3(:,20), t3x6(:,:,2))
  call prop_Q_A(ntry, wf6(:,3), Q(:,17), MB, 1_intkind1, wf6(:,4), n2(14))
  call vert_VQ_A(ntry, ex4, wf6(:,4), wf12(:,13), n3(:,21), t3x12(:,:,8))
  call prop_Q_A(ntry, wf12(:,13), Q(:,25), MB, 1_intkind1, wf12(:,14), n2(15))
  call vert_AV_Q(ntry, wf4(:,10), ex4, wf8(:,9), n3(:,22), t3x8(:,:,7))
  call vert_VQ_A(ntry, ex6, wf6(:,4), wf12(:,15), n3(:,23), t3x12(:,:,9))
  call prop_A_Q(ntry, wf8(:,9), Q(:,14), MB, 1_intkind1, wf8(:,10), n2(16))
  call vert_VQ_A(ntry, ex6, ex1, wf4(:,11), n3(:,24), t3x4(:,:,6))
  call prop_Q_A(ntry, wf4(:,11), Q(:,33), MB, 1_intkind1, wf4(:,12), n2(17))
  call vert_VQ_A(ntry, ex4, wf4(:,12), wf8(:,11), n3(:,25), t3x8(:,:,8))
  call prop_Q_A(ntry, wf8(:,11), Q(:,41), MB, 1_intkind1, wf8(:,12), n2(18))
  call vert_ZQ_A(gZd,ntry, ex5, wf4(:,12), wf12(:,16), n3(:,26), t3x12(:,:,10))
  call vert_VQ_A(ntry, ex3, wf4(:,9), wf8(:,13), n3(:,27), t3x8(:,:,9))
  call prop_Q_A(ntry, wf8(:,13), Q(:,13), MB, 1_intkind1, wf8(:,14), n2(19))
  call vert_AV_Q(ntry, wf6(:,2), ex3, wf12(:,17), n3(:,28), t3x12(:,:,11))
  call prop_A_Q(ntry, wf12(:,17), Q(:,22), MB, 1_intkind1, wf12(:,18), n2(20))
  call vert_AV_Q(ntry, wf4(:,6), ex3, wf8(:,15), n3(:,29), t3x8(:,:,10))
  call prop_A_Q(ntry, wf8(:,15), Q(:,38), MB, 1_intkind1, wf8(:,16), n2(21))
  call vert_VQ_A(ntry, ex3, wf6(:,4), wf12(:,19), n3(:,30), t3x12(:,:,12))
  call prop_Q_A(ntry, wf12(:,19), Q(:,21), MB, 1_intkind1, wf12(:,20), n2(22))
  call vert_AV_Q(ntry, wf4(:,4), ex3, wf8(:,17), n3(:,31), t3x8(:,:,11))
  call prop_A_Q(ntry, wf8(:,17), Q(:,14), MB, 1_intkind1, wf8(:,18), n2(23))
  call vert_VQ_A(ntry, ex3, wf4(:,12), wf8(:,19), n3(:,32), t3x8(:,:,12))
  call prop_Q_A(ntry, wf8(:,19), Q(:,37), MB, 1_intkind1, wf8(:,20), n2(24))
  ...
  M2add = M2 / average_factor_ppvvv_bbxaazg_1

  do k = 0, 23-1
    M2(k) = M2add(extcomb_perm_ppvvv_bbxaazg_1(k))
  end do
...
! i=j=0 -> 0 means no colour insertion.
! **********************************************************************
  use ol_colourmatrix_ppvvv_bbxaazg_1_/**/REALKIND, only: K1
  implicit none
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_ppvvv_bbxaazg_1")
...
subroutine amp2tree(P, M2) &
    & bind(c,name="ol_f_amp2tree_ppvvv_bbxaazg_1")
#else
subroutine amp2tree(P, M2)
#endif
...
subroutine amp2ccone(P, M2, I, J) &
    & bind(c,name="ol_f_amp2ccone_ppvvv_bbxaazg_1")
#else
subroutine amp2ccone(P, M2, I, J)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2ccall(P, M2) &
    & bind(c,name="ol_f_amp2ccall_ppvvv_bbxaazg_1")
#else
subroutine amp2ccall(P, M2)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcone(P, M2, I, J, MOM) &
    & bind(c,name="ol_f_amp2hcone_ppvvv_bbxaazg_1")
#else
subroutine amp2hcone(P, M2, I, J, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2hcall(P, M2, I, MOM) &
    & bind(c,name="ol_f_amp2hcall_ppvvv_bbxaazg_1")
#else
subroutine amp2hcall(P, M2, I, MOM)
#endif
  ! This is an interface for AMP2.
...
subroutine amp2tree_c(p, m2) &
    & bind(c,name="ol_amp2tree_ppvvv_bbxaazg_1")
...
subroutine amp2ccone_c(p, m2, i, j) &
    & bind(c,name="ol_amp2ccone_ppvvv_bbxaazg_1")
...
subroutine amp2ccall_c(p, m2) &
    & bind(c,name="ol_amp2ccall_ppvvv_bbxaazg_1")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2hcone_c(p, m2, i, j, mom) &
    & bind(c,name="ol_amp2hcone_ppvvv_bbxaazg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_c(p, m2, i, mom) &
    & bind(c,name="ol_amp2hcall_ppvvv_bbxaazg_1")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
...
subroutine amp2tree_legacy(p, m2) &
    & bind(c,name="amp2tree_ppvvv_bbxaazg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccone_legacy(p, m2, i, j) &
    & bind(c,name="amp2ccone_ppvvv_bbxaazg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2ccall_legacy(p, m2) &
    & bind(c,name="amp2ccall_ppvvv_bbxaazg_1_")
  use, intrinsic :: iso_c_binding, only: c_double
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(0:23-1)
...
subroutine amp2hcone_legacy(p, m2, i, j, mom) &
    & bind(c,name="amp2hcone_ppvvv_bbxaazg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2
...
subroutine amp2hcall_legacy(p, m2, i, mom) &
    & bind(c,name="amp2hcall_ppvvv_bbxaazg_1_")
  use, intrinsic :: iso_c_binding, only: c_double, c_int
  implicit none
  real(c_double), intent(in)  :: p(0:3,6)
  real(c_double), intent(out) :: m2(6)
...
end module ol_tree_ppvvv_bbxaazg_1_/**/REALKIND
