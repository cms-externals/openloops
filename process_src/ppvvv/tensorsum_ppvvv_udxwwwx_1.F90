...
! **********************************************************************
module ol_tensor_sum_storage_ppvvv_udxwwwx_1_/**/REALKIND
! **********************************************************************
  ...
  complex(REALKIND), save :: T2sum(15,11) = 0
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppvvv_udxwwwx_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppvvv_udxwwwx_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppvvv_udxwwwx_1, only: channel_number_ppvvv_udxwwwx_1
  ...
  call channel_on(channel_number_ppvvv_udxwwwx_1)
  M2 = 0

  momenta_1(:,1) = Q(1:4,21)
  ...
  momenta_12(:,1) = Q(1:4,21)
  momenta_12(:,2) = Q(1:4,29)
  momenta_13(:,1) = Q(1:4,22)
  momenta_13(:,2) = Q(1:4,30)
  momenta_14(:,1) = Q(1:4,25)
  momenta_14(:,2) = Q(1:4,29)
  momenta_15(:,1) = Q(1:4,26)
  ...
  call TI_call(2, momenta_12, masses2_2, T2sum(:,4), M2)
  ...
  call TI_call(2, momenta_11, masses2_2, T2sum(:,10), M2)
  call TI_call(2, momenta_15, masses2_2, T2sum(:,11), M2)

  call TI_call(3, momenta_20, masses2_3, T3sum(:,1), M2)
  call TI_call(3, momenta_21, masses2_3, T3sum(:,2), M2)
  ...
  call TI_call(3, momenta_19, masses2_3, T3sum(:,7), M2)
  call TI_call(3, momenta_16, masses2_3, T3sum(:,8), M2)

  call TI_call(4, momenta_25, masses2_4, T4sum(:,1), M2)
  call TI_call(4, momenta_24, masses2_4, T4sum(:,2), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppvvv_udxwwwx_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppvvv_udxwwwx_1_/**/REALKIND
