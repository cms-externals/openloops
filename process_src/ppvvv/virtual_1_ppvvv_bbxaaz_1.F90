...
module ol_vamp_1_ppvvv_bbxaaz_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppvvv_bbxaaz_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppvvv_bbxaaz_1.
! **********************************************************************
...
#endif
  use ol_loop_ppvvv_bbxaaz_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppvvv_bbxaaz_1_/**/REALKIND
  ...
  call loop_Q_A(G0(:,:,:,4),Q(:,13),MB,G1(:,:,:,7))
  ...
  call loop_Q_A(G0(:,:,:,5),Q(:,21),MB,G1(:,:,:,9))
  call loop_QV_A(G1(:,:,:,9),wf(:,-3),G1(:,:,:,10))
  call loop_Q_A(G1(:,:,:,10),Q(:,29),MB,G2(:,:,:,10))
  ...
  call loop_Q_A(G0(:,:,:,6),Q(:,5),MB,G1(:,:,:,11))
  call loop_QZ_A(G1(:,:,:,11),wf(:,-4),G1(:,:,:,12),gZd)
  call loop_Q_A(G1(:,:,:,12),Q(:,21),MB,G2(:,:,:,11))
  call loop_QV_A(G2(:,:,:,11),wf(:,-3),G2(:,:,:,12))
  call loop_Q_A(G2(:,:,:,12),Q(:,29),MB,G3(:,:,:,5))
  ...
  call loop_A_Q(G0(:,:,:,11),Q(:,6),MB,G1(:,:,:,24))
  call loop_AZ_Q(G1(:,:,:,24),wf(:,-4),G1(:,:,:,25),gZd)
  call loop_A_Q(G1(:,:,:,25),Q(:,22),MB,G2(:,:,:,25))
  ...
  call loop_A_Q(G1(:,:,:,26),Q(:,14),MB,G2(:,:,:,27))
  ...
  call loop_Q_A(G0(:,:,:,16),Q(:,21),MB,G1(:,:,:,35))
  call loop_QV_A(G1(:,:,:,35),wf(:,-3),G1(:,:,:,36))
  call loop_Q_A(G1(:,:,:,36),Q(:,29),MB,G2(:,:,:,33))
  ...
  call loop_Q_A(G0(:,:,:,17),Q(:,25),MB,G1(:,:,:,37))
  call loop_QV_A(G1(:,:,:,37),wf(:,-2),G1(:,:,:,38))
  call loop_Q_A(G1(:,:,:,38),Q(:,29),MB,G2(:,:,:,34))
  ...
  call loop_A_Q(G0(:,:,:,18),Q(:,22),MB,G1(:,:,:,39))
  call loop_AV_Q(G1(:,:,:,39),wf(:,-3),G1(:,:,:,40))
  call loop_A_Q(G1(:,:,:,40),Q(:,30),MB,G2(:,:,:,35))
  ...
  call loop_A_Q(G0(:,:,:,19),Q(:,26),MB,G1(:,:,:,41))
  call loop_AV_Q(G1(:,:,:,41),wf(:,-2),G1(:,:,:,42))
  call loop_A_Q(G1(:,:,:,42),Q(:,30),MB,G2(:,:,:,36))
...
end module ol_vamp_1_ppvvv_bbxaaz_1_/**/REALKIND
