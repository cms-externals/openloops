...
module ol_versiondata_ppvvv
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppvvv(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppvvv
  end interface
end module ol_versiondata_ppvvv


subroutine ol_version_ppvvv(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppvvv, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppvvv
