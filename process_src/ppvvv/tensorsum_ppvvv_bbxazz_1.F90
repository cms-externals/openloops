...
! **********************************************************************
module ol_tensor_sum_storage_ppvvv_bbxazz_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppvvv_bbxazz_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppvvv_bbxazz_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppvvv_bbxazz_1, only: channel_number_ppvvv_bbxazz_1
  ...
  call channel_on(channel_number_ppvvv_bbxazz_1)
  M2 = 0
  ...
  momenta_13(:,2) = Q(1:4,21)
  momenta_14(:,1) = Q(1:4,17)
  momenta_14(:,2) = Q(1:4,25)
  momenta_15(:,1) = Q(1:4,18)
  momenta_15(:,2) = Q(1:4,22)
  momenta_16(:,1) = Q(1:4,18)
  momenta_16(:,2) = Q(1:4,26)
  momenta_17(:,1) = Q(1:4,21)
  momenta_17(:,2) = Q(1:4,29)
  momenta_18(:,1) = Q(1:4,22)
  ...
  momenta_33(:,2) = Q(1:4,22)
  momenta_33(:,3) = Q(1:4,30)
  momenta_34(:,1) = Q(1:4,18)
  ...
  momenta_39(:,2) = Q(1:4,18)
  momenta_39(:,3) = Q(1:4,22)
  ...
  call TI_call(2, momenta_10, masses2_2, T2sum(:,1), M2)
  call TI_call(2, momenta_16, masses2_2, T2sum(:,2), M2)
  call TI_call(2, momenta_7, masses2_2, T2sum(:,3), M2)
  ...
  call TI_call(2, momenta_8, masses2_2, T2sum(:,8), M2)
  call TI_call(2, momenta_12, masses2_2, T2sum(:,9), M2)
  call TI_call(2, momenta_18, masses2_2, T2sum(:,10), M2)
  call TI_call(2, momenta_15, masses2_2, T2sum(:,11), M2)
  call TI_call(2, momenta_19, masses2_2, T2sum(:,12), M2)
  call TI_call(2, momenta_13, masses2_2, T2sum(:,13), M2)
  call TI_call(2, momenta_20, masses2_2, T2sum(:,14), M2)

  call TI_call(3, momenta_24, masses2_3, T3sum(:,1), M2)
  call TI_call(3, momenta_23, masses2_3, T3sum(:,2), M2)
  call TI_call(3, momenta_26, masses2_3, T3sum(:,3), M2)
  call TI_call(3, momenta_25, masses2_3, T3sum(:,4), M2)
  call TI_call(3, momenta_28, masses2_3, T3sum(:,5), M2)
  call TI_call(3, momenta_27, masses2_3, T3sum(:,6), M2)
  call TI_call(3, momenta_30, masses2_3, T3sum(:,7), M2)
  call TI_call(3, momenta_29, masses2_3, T3sum(:,8), M2)
  call TI_call(3, momenta_32, masses2_3, T3sum(:,9), M2)
  call TI_call(3, momenta_31, masses2_3, T3sum(:,10), M2)
  call TI_call(3, momenta_34, masses2_3, T3sum(:,11), M2)
  call TI_call(3, momenta_33, masses2_3, T3sum(:,12), M2)
  call TI_call(3, momenta_22, masses2_3, T3sum(:,13), M2)
  call TI_call(3, momenta_21, masses2_3, T3sum(:,14), M2)

  call TI_call(4, momenta_38, masses2_4, T4sum(:,1), M2)
  call TI_call(4, momenta_40, masses2_4, T4sum(:,2), M2)
  call TI_call(4, momenta_36, masses2_4, T4sum(:,3), M2)
  call TI_call(4, momenta_39, masses2_4, T4sum(:,4), M2)
  call TI_call(4, momenta_35, masses2_4, T4sum(:,5), M2)
  call TI_call(4, momenta_37, masses2_4, T4sum(:,6), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppvvv_bbxazz_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppvvv_bbxazz_1_/**/REALKIND
