...
module ol_vamp_1_ppvvv_ddxawwx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppvvv_ddxawwx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppvvv_ddxawwx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppvvv_ddxawwx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppvvv_ddxawwx_1_/**/REALKIND
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,34),G1(:,:,:,3),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,92),G1(:,:,:,5),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,94),G1(:,:,:,8),gZd)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,20),G1(:,:,:,11),gZd)
  ...
  call loop_A_Q(G0(:,:,:,3),Q(:,10),ZERO,G1(:,:,:,13))
  ...
  call loop_AW_Q(G1(:,:,:,13),wf(:,10),G1(:,:,:,15))
  call loop_A_Q(G1(:,:,:,15),Q(:,30),ZERO,G2(:,:,:,23))
  call check_last_AQ_V(l_switch,G2(:,:,:,23),wf(:,0),G2tensor(:,8))
  call loop_AV_Q(G1(:,:,:,13),wf(:,-2),G1(:,:,:,16))
  call loop_A_Q(G1(:,:,:,16),Q(:,14),ZERO,G2(:,:,:,24))
  ...
  call check_last_QA_V(l_switch,G2(:,:,:,31),wf(:,25),G2tensor(:,12))
  ...
  call loop_Q_A(G1(:,:,:,25),Q(:,21),ZERO,G2(:,:,:,33))
  call check_last_QA_V(l_switch,G2(:,:,:,33),wf(:,16),G2tensor(:,13))
  call loop_QW_A(G2(:,:,:,33),wf(:,-3),G2(:,:,:,34))
  call loop_Q_A(G2(:,:,:,34),Q(:,29),ZERO,G3(:,:,:,17))
  call check_last_QA_V(l_switch,G3(:,:,:,17),wf(:,-1),G3tensor(:,11))
  call loop_QW_A(G1(:,:,:,23),wf(:,6),G1(:,:,:,26))
  call loop_Q_A(G1(:,:,:,26),Q(:,29),ZERO,G2(:,:,:,35))
  call check_last_QA_V(l_switch,G2(:,:,:,35),wf(:,-1),G2tensor(:,14))
  call check_last_QA_V(l_switch,G1(:,:,:,23),wf(:,77),G1tensor(:,2))
  call check_last_QA_V(l_switch,G1(:,:,:,23),wf(:,85),G1tensor(:,3))
  call check_last_QA_V(l_switch,G1(:,:,:,23),wf(:,90),G1tensor(:,4))
  ...
  call loop_AZ_Q(G1(:,:,:,27),wf(:,20),G1(:,:,:,29),gZd)
  call loop_A_Q(G1(:,:,:,29),Q(:,30),ZERO,G2(:,:,:,37))
  call check_last_AQ_V(l_switch,G2(:,:,:,37),wf(:,0),G2tensor(:,16))
  call loop_AW_Q(G1(:,:,:,27),wf(:,-3),G1(:,:,:,30))
  call loop_A_Q(G1(:,:,:,30),Q(:,14),ZERO,G2(:,:,:,38))
  ...
  call loop_A_Q(G0(:,:,:,8),Q(:,14),ZERO,G1(:,:,:,31))
  ...
  call loop_A_Q(G0(:,:,:,9),Q(:,14),ZERO,G1(:,:,:,33))
  ...
  call loop_VQ_A(G0(:,:,:,1),wf(:,86),G0(:,:,:,12))
  call loop_Q_A(G0(:,:,:,12),Q(:,21),ZERO,G1(:,:,:,39))
  call loop_QW_A(G1(:,:,:,39),wf(:,-3),G1(:,:,:,40))
  call loop_Q_A(G1(:,:,:,40),Q(:,29),ZERO,G2(:,:,:,44))
  call check_last_QA_V(l_switch,G2(:,:,:,44),wf(:,-1),G2tensor(:,21))
  call check_last_QA_V(l_switch,G1(:,:,:,39),wf(:,16),G1tensor(:,6))
  call loop_VQ_A(G0(:,:,:,1),wf(:,79),G0(:,:,:,13))
  call loop_Q_A(G0(:,:,:,13),Q(:,25),ZERO,G1(:,:,:,41))
  call loop_QV_A(G1(:,:,:,41),wf(:,-2),G1(:,:,:,42))
  call loop_Q_A(G1(:,:,:,42),Q(:,29),ZERO,G2(:,:,:,45))
  call check_last_QA_V(l_switch,G2(:,:,:,45),wf(:,-1),G2tensor(:,22))
  call check_last_QA_V(l_switch,G1(:,:,:,41),wf(:,25),G1tensor(:,7))
  call loop_VQ_A(G0(:,:,:,1),wf(:,88),G0(:,:,:,14))
  call loop_Q_A(G0(:,:,:,14),Q(:,21),ZERO,G1(:,:,:,43))
  call loop_QW_A(G1(:,:,:,43),wf(:,-3),G1(:,:,:,44))
  call loop_Q_A(G1(:,:,:,44),Q(:,29),ZERO,G2(:,:,:,46))
  call check_last_QA_V(l_switch,G2(:,:,:,46),wf(:,-1),G2tensor(:,23))
  call check_last_QA_V(l_switch,G1(:,:,:,43),wf(:,16),G1tensor(:,8))
...
end module ol_vamp_1_ppvvv_ddxawwx_1_/**/REALKIND
