...
module ol_vamp_1_ppvvv_uuxazz_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppvvv_uuxazz_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppvvv_uuxazz_1.
! **********************************************************************
...
#endif
  use ol_loop_ppvvv_uuxazz_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppvvv_uuxazz_1_/**/REALKIND
  ...
  call loop_QZ_A(G1(:,:,:,11),wf(:,-3),G1(:,:,:,13),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,22),wf(:,-3),G1(:,:,:,23),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,24),wf(:,-4),G1(:,:,:,25),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,35),wf(:,-3),G1(:,:,:,36),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,43),wf(:,-4),G1(:,:,:,45),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,43),wf(:,-3),G2(:,:,:,45),gZu)
...
end module ol_vamp_1_ppvvv_uuxazz_1_/**/REALKIND
