...
module ol_colourmatrix_ppvvv_uuxzwwx_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_uuxzwwx_1_/**/REALKIND



module ol_forced_parameters_ppvvv_uuxzwwx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_uuxzwwx_1_/**/REALKIND

module ol_loop_ppvvv_uuxzwwx_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(14) = (2*CI*cw*eQED**3)/(3._/**/REALKIND*sw)
    f(15) = (CI*cw*eQED**3)/sw
    f(16) = (CI*countertermnorm*cw*eQED**3*gQCD**2)/sw
    f(17) = (2*CI*countertermnorm*ctVqq*cw*eQED**3*gQCD**2)/(3._/**/REALKIND*sw)
    f(18) = (CI*countertermnorm*ctVqq*cw*eQED**3*gQCD**2)/sw
    f(19) = (2*eQED**3*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
    ...
    f(24) = (2*cw*eQED**3*gQCD**2*integralnorm*SwB)/(sw*3._/**/REALKIND)
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,0),wf(:,15))
  ...
  call vert_WQ_A(wf(:,-3),wf(:,17),wf(:,19))
  call vert_UV_W(wf(:,-4),Q(:,16),wf(:,-3),Q(:,8),wf(:,20))
  call vert_QA_V(wf(:,17),wf(:,-1),wf(:,21))
  call prop_W_W(wf(:,20),Q(:,24),MZ,1_intkind1,wf(:,22))
  call vert_QA_Z(gZu,wf(:,17),wf(:,-1),wf(:,23))
  call vert_WQ_A(wf(:,-3),wf(:,0),wf(:,24))
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,-2),wf(:,25))
  call prop_Q_A(wf(:,24),Q(:,9),ZERO,0_intkind1,wf(:,26))
  call prop_A_Q(wf(:,25),Q(:,6),ZERO,0_intkind1,wf(:,27))
  call vert_WQ_A(wf(:,-4),wf(:,26),wf(:,28))
  call vert_QA_V(wf(:,0),wf(:,27),wf(:,29))
  call vert_QA_Z(gZu,wf(:,0),wf(:,27),wf(:,30))
  call vert_ZQ_A(gZd,wf(:,-2),wf(:,26),wf(:,31))
  call vert_QA_W(wf(:,26),wf(:,-1),wf(:,32))
  call vert_QA_W(wf(:,0),wf(:,18),wf(:,33))
  call counter_QA_V(wf(:,0),wf(:,-1),wf(:,34))
  call counter_QA_Z(gZu,wf(:,0),wf(:,-1),wf(:,35))
  call prop_W_W(wf(:,2),Q(:,28),MZ,1_intkind1,wf(:,36))
  call counter_WQ_A(wf(:,-3),wf(:,17),wf(:,37))
  call counter_WQ_A(wf(:,-4),wf(:,26),wf(:,38))
  call counter_ZQ_A(gZd,wf(:,-2),wf(:,26),wf(:,39))
  call counter_QA_V(wf(:,17),wf(:,-1),wf(:,40))
  call counter_QA_Z(gZu,wf(:,17),wf(:,-1),wf(:,41))
  call counter_AW_Q(wf(:,-1),wf(:,-4),wf(:,42))
  call prop_A_Q(wf(:,42),Q(:,18),ZERO,0_intkind1,wf(:,43))
  call counter_QA_W(wf(:,26),wf(:,-1),wf(:,44))
  call vert_QA_W(wf(:,0),wf(:,43),wf(:,45))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-2),wf(:,46))
  call prop_A_Q(wf(:,46),Q(:,6),ZERO,0_intkind1,wf(:,47))
  call vert_QA_V(wf(:,0),wf(:,47),wf(:,48))
  call vert_QA_Z(gZu,wf(:,0),wf(:,47),wf(:,49))
  call counter_QA_V(wf(:,0),wf(:,27),wf(:,50))
  call counter_QA_Z(gZu,wf(:,0),wf(:,27),wf(:,51))
  call counter_WQ_A(wf(:,-3),wf(:,0),wf(:,52))
  call prop_Q_A(wf(:,52),Q(:,9),ZERO,0_intkind1,wf(:,53))
  call vert_WQ_A(wf(:,-4),wf(:,53),wf(:,54))
  call counter_QA_W(wf(:,0),wf(:,18),wf(:,55))
  call vert_ZQ_A(gZd,wf(:,-2),wf(:,53),wf(:,56))
  call vert_QA_W(wf(:,53),wf(:,-1),wf(:,57))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,0),wf(:,58))
  call prop_Q_A(wf(:,58),Q(:,5),ZERO,0_intkind1,wf(:,59))
  call vert_WQ_A(wf(:,-3),wf(:,59),wf(:,60))
  call vert_QA_V(wf(:,59),wf(:,-1),wf(:,61))
  call vert_QA_Z(gZu,wf(:,59),wf(:,-1),wf(:,62))
  ...
  call vert_AW_Q(wf(:,18),wf(:,-3),wf(:,69))
  call counter_Q_A(ctqq,wf(:,17),Q(:,5),wf(:,70))
  call prop_A_Q(wf(:,69),Q(:,26),ZERO,0_intkind1,wf(:,71))
  call counter_A_Q(ctqq,wf(:,18),Q(:,18),wf(:,72))
  call prop_Q_A(wf(:,19),Q(:,13),ZERO,0_intkind1,wf(:,73))
  call vert_AV_Q(wf(:,-1),wf(:,20),wf(:,74))
  call prop_A_Q(wf(:,74),Q(:,26),ZERO,0_intkind1,wf(:,75))
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,22),wf(:,76))
  call prop_A_Q(wf(:,76),Q(:,26),ZERO,0_intkind1,wf(:,77))
  call vert_AW_Q(wf(:,27),wf(:,-4),wf(:,78))
  call counter_Q_A(ctqq,wf(:,26),Q(:,9),wf(:,79))
  call prop_A_Q(wf(:,78),Q(:,22),ZERO,0_intkind1,wf(:,80))
  ...
  call vert_ZQ_A(gZu,wf(:,22),wf(:,0),wf(:,85))
  call prop_Q_A(wf(:,85),Q(:,25),ZERO,0_intkind1,wf(:,86))
  call vert_AZ_Q(gZd,wf(:,18),wf(:,-2),wf(:,87))
  call prop_A_Q(wf(:,87),Q(:,22),ZERO,0_intkind1,wf(:,88))
  call prop_Q_A(wf(:,31),Q(:,13),ZERO,0_intkind1,wf(:,89))
  call vert_AW_Q(wf(:,-1),wf(:,10),wf(:,90))
  call prop_A_Q(wf(:,90),Q(:,22),ZERO,0_intkind1,wf(:,91))
  call vert_WQ_A(wf(:,6),wf(:,0),wf(:,92))
  call prop_Q_A(wf(:,92),Q(:,13),ZERO,0_intkind1,wf(:,93))
...
subroutine diagrams(A)
  ...
  A(25) = cont_VV(wf(:,10),wf(:,44)) * den(24)
  A(26) = cont_QA(wf(:,31),wf(:,43)) * den(23)
  A(27) = cont_VV(wf(:,6),wf(:,45)) * den(25)
  ...
  A(34) = cont_VV(wf(:,6),wf(:,55)) * den(25)
  A(35) = cont_QA(wf(:,18),wf(:,56)) * den(23)
  A(36) = cont_VV(wf(:,10),wf(:,57)) * den(24)
  ...
  A(55) = cont_QA(wf(:,79),wf(:,91)) * den(53)
  A(56) = cont_QA(wf(:,72),wf(:,93)) * den(55)
...
end module ol_loop_ppvvv_uuxzwwx_1_/**/REALKIND
