...
! **********************************************************************
  use ol_external_ppvvv_bbxawwx_1, only: channel_number_ppvvv_bbxawwx_1
  ...
  call channel_on(channel_number_ppvvv_bbxawwx_1)
  M2 = 0
  ...
  call channel_off(channel_number_ppvvv_bbxawwx_1)
