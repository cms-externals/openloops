...
module ol_colourmatrix_ppvvv_bbxaaa_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_bbxaaa_1_/**/REALKIND



module ol_forced_parameters_ppvvv_bbxaaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_bbxaaa_1_/**/REALKIND

module ol_loop_ppvvv_bbxaaa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**3*gQCD**2)/27._/**/REALKIND
    f(3) = (CI*countertermnorm*ctVbb*eQED**3*gQCD**2)/27._/**/REALKIND
    f(4) = (eQED**3*gQCD**2*integralnorm*SwB)/27._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_VQ_A(wf(:,-4),wf(:,11),wf(:,21))
  ...
  call counter_VQ_A(wf(:,-4),wf(:,0),wf(:,31))
  ...
  call vert_VQ_A(wf(:,-4),wf(:,35),wf(:,36))
  ...
  call vert_AV_Q(wf(:,4),wf(:,-4),wf(:,43))
  ...
  call vert_AV_Q(wf(:,12),wf(:,-4),wf(:,52))
...
end module ol_loop_ppvvv_bbxaaa_1_/**/REALKIND
