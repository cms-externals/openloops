...
module ol_vamp_1_ppvvv_uuxzzz_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppvvv_uuxzzz_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppvvv_uuxzzz_1.
! **********************************************************************
...
#endif
  use ol_loop_ppvvv_uuxzzz_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppvvv_uuxzzz_1_/**/REALKIND
  ...
  call loop_AZ_Q(G1(:,:,:,4),wf(:,-2),G1(:,:,:,6),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,14),wf(:,-2),G1(:,:,:,16),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,17),wf(:,-2),G1(:,:,:,19),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,33),wf(:,-2),G1(:,:,:,34),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,36),wf(:,-2),G2(:,:,:,38),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,35),wf(:,-2),G1(:,:,:,41),gZu)
  ...
  call loop_AZ_Q(G2(:,:,:,42),wf(:,-3),G2(:,:,:,44),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,44),wf(:,-2),G1(:,:,:,45),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,48),wf(:,-2),G1(:,:,:,49),gZu)
...
end module ol_vamp_1_ppvvv_uuxzzz_1_/**/REALKIND
