...
module ol_colourmatrix_ppvvv_uuxzzz_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_uuxzzz_1_/**/REALKIND



module ol_forced_parameters_ppvvv_uuxzzz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_uuxzzz_1_/**/REALKIND

module ol_loop_ppvvv_uuxzzz_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,0),wf(:,9))
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,-3),wf(:,10))
  ...
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,-4),wf(:,14))
  call prop_A_Q(wf(:,14),Q(:,18),ZERO,0_intkind1,wf(:,15))
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,11),wf(:,16))
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,0),wf(:,17))
  call vert_AZ_Q(gZu,wf(:,-1),wf(:,-2),wf(:,18))
  call prop_Q_A(wf(:,17),Q(:,9),ZERO,0_intkind1,wf(:,19))
  call prop_A_Q(wf(:,18),Q(:,6),ZERO,0_intkind1,wf(:,20))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,19),wf(:,21))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,0),wf(:,22))
  call prop_Q_A(wf(:,22),Q(:,17),ZERO,0_intkind1,wf(:,23))
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,23),wf(:,24))
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,19),wf(:,25))
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,23),wf(:,26))
  call counter_ZQ_A(gZu,wf(:,-4),wf(:,11),wf(:,27))
  call counter_ZQ_A(gZu,wf(:,-3),wf(:,11),wf(:,28))
  call counter_ZQ_A(gZu,wf(:,-4),wf(:,19),wf(:,29))
  call counter_ZQ_A(gZu,wf(:,-3),wf(:,23),wf(:,30))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,19),wf(:,31))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,23),wf(:,32))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-4),wf(:,33))
  call prop_A_Q(wf(:,33),Q(:,18),ZERO,0_intkind1,wf(:,34))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-3),wf(:,35))
  call prop_A_Q(wf(:,35),Q(:,10),ZERO,0_intkind1,wf(:,36))
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-2),wf(:,37))
  call prop_A_Q(wf(:,37),Q(:,6),ZERO,0_intkind1,wf(:,38))
  call counter_ZQ_A(gZu,wf(:,-4),wf(:,0),wf(:,39))
  call prop_Q_A(wf(:,39),Q(:,17),ZERO,0_intkind1,wf(:,40))
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,40),wf(:,41))
  call counter_ZQ_A(gZu,wf(:,-3),wf(:,0),wf(:,42))
  call prop_Q_A(wf(:,42),Q(:,9),ZERO,0_intkind1,wf(:,43))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,43),wf(:,44))
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,40),wf(:,45))
  call vert_ZQ_A(gZu,wf(:,-2),wf(:,43),wf(:,46))
  call counter_ZQ_A(gZu,wf(:,-2),wf(:,0),wf(:,47))
  call prop_Q_A(wf(:,47),Q(:,5),ZERO,0_intkind1,wf(:,48))
  call vert_ZQ_A(gZu,wf(:,-4),wf(:,48),wf(:,49))
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,48),wf(:,50))
  call counter_QA_Z(gZu,wf(:,0),wf(:,-1),wf(:,51))
  ...
  call vert_AZ_Q(gZu,wf(:,12),wf(:,-4),wf(:,56))
  ...
  call vert_AZ_Q(gZu,wf(:,15),wf(:,-3),wf(:,61))
  ...
  call vert_AZ_Q(gZu,wf(:,20),wf(:,-4),wf(:,65))
  ...
  call vert_AZ_Q(gZu,wf(:,20),wf(:,-3),wf(:,70))
...
end module ol_loop_ppvvv_uuxzzz_1_/**/REALKIND
