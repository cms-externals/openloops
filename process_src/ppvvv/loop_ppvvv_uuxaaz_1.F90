...
module ol_colourmatrix_ppvvv_uuxaaz_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_uuxaaz_1_/**/REALKIND



module ol_forced_parameters_ppvvv_uuxaaz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_uuxaaz_1_/**/REALKIND

module ol_loop_ppvvv_uuxaaz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (4*CI*countertermnorm*eQED**3*gQCD**2)/9._/**/REALKIND
    f(3) = (4*CI*countertermnorm*ctVqq*eQED**3*gQCD**2)/9._/**/REALKIND
    f(4) = (4*eQED**3*gQCD**2*integralnorm*SwB)/9._/**/REALKIND
...
end module ol_loop_ppvvv_uuxaaz_1_/**/REALKIND
