...
module ol_colourmatrix_ppvvv_uuxaaa_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_uuxaaa_1_/**/REALKIND



module ol_forced_parameters_ppvvv_uuxaaa_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_uuxaaa_1_/**/REALKIND

module ol_loop_ppvvv_uuxaaa_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (8*CI*countertermnorm*eQED**3*gQCD**2)/27._/**/REALKIND
    f(3) = (8*CI*countertermnorm*ctVqq*eQED**3*gQCD**2)/27._/**/REALKIND
    f(4) = (8*eQED**3*gQCD**2*integralnorm*SwB)/27._/**/REALKIND
...
end module ol_loop_ppvvv_uuxaaa_1_/**/REALKIND
