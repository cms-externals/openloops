...
! **********************************************************************
module ol_tensor_sum_storage_ppvvv_uuxzzz_1_/**/REALKIND
! **********************************************************************
...
subroutine max_point(r) &
    & bind(c,name="ol_f_max_point_ppvvv_uuxzzz_1")
...
subroutine tensor_rank(r) &
    & bind(c,name="ol_f_tensor_rank_ppvvv_uuxzzz_1")
  ! Return the number maximal tensor rank
  implicit none
  integer, intent(out) :: r
  r = 4
...
! **********************************************************************
  use ol_external_ppvvv_uuxzzz_1, only: channel_number_ppvvv_uuxzzz_1
  ...
  call channel_on(channel_number_ppvvv_uuxzzz_1)
  M2 = 0
  ...
  call TI_call(2, momenta_9, masses2_2, T2sum(:,1), M2)
  call TI_call(2, momenta_15, masses2_2, T2sum(:,2), M2)
  call TI_call(2, momenta_10, masses2_2, T2sum(:,3), M2)
  call TI_call(2, momenta_16, masses2_2, T2sum(:,4), M2)
  call TI_call(2, momenta_8, masses2_2, T2sum(:,5), M2)
  call TI_call(2, momenta_13, masses2_2, T2sum(:,6), M2)
  ...
  call TI_call(2, momenta_12, masses2_2, T2sum(:,11), M2)
  call TI_call(2, momenta_19, masses2_2, T2sum(:,12), M2)
  call TI_call(2, momenta_7, masses2_2, T2sum(:,13), M2)

  call TI_call(3, momenta_21, masses2_3, T3sum(:,1), M2)
  call TI_call(3, momenta_20, masses2_3, T3sum(:,2), M2)
  call TI_call(3, momenta_23, masses2_3, T3sum(:,3), M2)
  call TI_call(3, momenta_22, masses2_3, T3sum(:,4), M2)
  call TI_call(3, momenta_25, masses2_3, T3sum(:,5), M2)
  call TI_call(3, momenta_24, masses2_3, T3sum(:,6), M2)
  call TI_call(3, momenta_27, masses2_3, T3sum(:,7), M2)
  call TI_call(3, momenta_26, masses2_3, T3sum(:,8), M2)
  call TI_call(3, momenta_29, masses2_3, T3sum(:,9), M2)
  call TI_call(3, momenta_28, masses2_3, T3sum(:,10), M2)
  ...
  call TI_call(4, momenta_37, masses2_4, T4sum(:,2), M2)
  call TI_call(4, momenta_33, masses2_4, T4sum(:,3), M2)
  call TI_call(4, momenta_36, masses2_4, T4sum(:,4), M2)
  call TI_call(4, momenta_32, masses2_4, T4sum(:,5), M2)
  call TI_call(4, momenta_34, masses2_4, T4sum(:,6), M2)

#ifdef LOOPSQUARED
  end if
#endif

  call channel_off(channel_number_ppvvv_uuxzzz_1)
end subroutine integrate_tensor_sum

end module ol_tensor_sum_storage_ppvvv_uuxzzz_1_/**/REALKIND
