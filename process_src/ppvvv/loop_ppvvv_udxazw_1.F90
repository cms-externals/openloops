...
module ol_colourmatrix_ppvvv_udxazw_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_udxazw_1_/**/REALKIND



module ol_forced_parameters_ppvvv_udxazw_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_udxazw_1_/**/REALKIND

module ol_loop_ppvvv_udxazw_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_AZ_Q(gZd,wf(:,-1),wf(:,-3),wf(:,11))
  ...
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,12),wf(:,17))
  call vert_QA_W(wf(:,12),wf(:,-1),wf(:,18))
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,0),wf(:,19))
  ...
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,25),wf(:,26))
  ...
  call counter_ZQ_A(gZu,wf(:,-3),wf(:,12),wf(:,35))
  call counter_WQ_A(wf(:,-4),wf(:,21),wf(:,36))
  call counter_ZQ_A(gZd,wf(:,-3),wf(:,25),wf(:,37))
  ...
  call counter_AZ_Q(gZd,wf(:,-1),wf(:,-3),wf(:,43))
  ...
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,52),wf(:,53))
  call counter_ZQ_A(gZu,wf(:,-3),wf(:,0),wf(:,54))
  ...
  call vert_ZQ_A(gZu,wf(:,-3),wf(:,62),wf(:,64))
  ...
  call vert_AZ_Q(gZu,wf(:,16),wf(:,-3),wf(:,74))
  ...
  call vert_AZ_Q(gZd,wf(:,22),wf(:,-3),wf(:,85))
...
end module ol_loop_ppvvv_udxazw_1_/**/REALKIND
