...
module ol_colourmatrix_ppvvv_bbxaaz_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_bbxaaz_1_/**/REALKIND



module ol_forced_parameters_ppvvv_bbxaaz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_bbxaaz_1_/**/REALKIND

module ol_loop_ppvvv_bbxaaz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(2) = (CI*countertermnorm*eQED**3*gQCD**2)/9._/**/REALKIND
    f(3) = (CI*countertermnorm*ctVbb*eQED**3*gQCD**2)/9._/**/REALKIND
    f(4) = (eQED**3*gQCD**2*integralnorm*SwB)/9._/**/REALKIND
...
! **********************************************************************
  ...
  call vert_ZQ_A(gZd,wf(:,-4),wf(:,0),wf(:,14))
  ...
  call counter_VQ_A(wf(:,-3),wf(:,3),wf(:,20))
  call counter_ZQ_A(gZd,wf(:,-4),wf(:,11),wf(:,21))
  call counter_VQ_A(wf(:,-3),wf(:,15),wf(:,22))
  call counter_VQ_A(wf(:,-2),wf(:,11),wf(:,23))
  call counter_VQ_A(wf(:,-2),wf(:,15),wf(:,24))
  call counter_AZ_Q(gZd,wf(:,-1),wf(:,-4),wf(:,25))
  call prop_A_Q(wf(:,25),Q(:,18),MB,1_intkind1,wf(:,26))
  call counter_AV_Q(wf(:,-1),wf(:,-3),wf(:,27))
  call prop_A_Q(wf(:,27),Q(:,10),MB,1_intkind1,wf(:,28))
  call counter_AV_Q(wf(:,-1),wf(:,-2),wf(:,29))
  call prop_A_Q(wf(:,29),Q(:,6),MB,1_intkind1,wf(:,30))
  call counter_ZQ_A(gZd,wf(:,-4),wf(:,0),wf(:,31))
  call prop_Q_A(wf(:,31),Q(:,17),MB,1_intkind1,wf(:,32))
  call vert_VQ_A(wf(:,-3),wf(:,32),wf(:,33))
  call counter_VQ_A(wf(:,-3),wf(:,0),wf(:,34))
  call prop_Q_A(wf(:,34),Q(:,9),MB,1_intkind1,wf(:,35))
  call vert_ZQ_A(gZd,wf(:,-4),wf(:,35),wf(:,36))
  call vert_VQ_A(wf(:,-2),wf(:,32),wf(:,37))
  call vert_VQ_A(wf(:,-2),wf(:,35),wf(:,38))
  call counter_VQ_A(wf(:,-2),wf(:,0),wf(:,39))
  call prop_Q_A(wf(:,39),Q(:,5),MB,1_intkind1,wf(:,40))
  call vert_ZQ_A(gZd,wf(:,-4),wf(:,40),wf(:,41))
  call vert_VQ_A(wf(:,-3),wf(:,40),wf(:,42))
  call vert_AZ_Q(gZd,wf(:,4),wf(:,-4),wf(:,43))
  call counter_Q_A(ctbb,wf(:,3),Q(:,5),wf(:,44))
  call prop_A_Q(wf(:,43),Q(:,26),MB,1_intkind1,wf(:,45))
  call counter_A_Q(ctbb,wf(:,4),Q(:,10),wf(:,46))
  call prop_Q_A(wf(:,5),Q(:,21),MB,1_intkind1,wf(:,47))
  call vert_AV_Q(wf(:,7),wf(:,-3),wf(:,48))
  call prop_A_Q(wf(:,48),Q(:,26),MB,1_intkind1,wf(:,49))
  call counter_A_Q(ctbb,wf(:,7),Q(:,18),wf(:,50))
  call prop_Q_A(wf(:,8),Q(:,13),MB,1_intkind1,wf(:,51))
  call vert_AZ_Q(gZd,wf(:,12),wf(:,-4),wf(:,52))
  call counter_Q_A(ctbb,wf(:,11),Q(:,9),wf(:,53))
  call prop_A_Q(wf(:,52),Q(:,22),MB,1_intkind1,wf(:,54))
  call counter_A_Q(ctbb,wf(:,12),Q(:,6),wf(:,55))
  call prop_Q_A(wf(:,13),Q(:,25),MB,1_intkind1,wf(:,56))
  call vert_AV_Q(wf(:,12),wf(:,-3),wf(:,57))
  call counter_Q_A(ctbb,wf(:,15),Q(:,17),wf(:,58))
  call prop_A_Q(wf(:,57),Q(:,14),MB,1_intkind1,wf(:,59))
  call prop_Q_A(wf(:,16),Q(:,25),MB,1_intkind1,wf(:,60))
  call vert_AV_Q(wf(:,7),wf(:,-2),wf(:,61))
  call prop_A_Q(wf(:,61),Q(:,22),MB,1_intkind1,wf(:,62))
  call prop_Q_A(wf(:,17),Q(:,13),MB,1_intkind1,wf(:,63))
  call vert_AV_Q(wf(:,4),wf(:,-2),wf(:,64))
  call prop_A_Q(wf(:,64),Q(:,14),MB,1_intkind1,wf(:,65))
  call prop_Q_A(wf(:,18),Q(:,21),MB,1_intkind1,wf(:,66))
...
end module ol_loop_ppvvv_bbxaaz_1_/**/REALKIND
