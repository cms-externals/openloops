...
module ol_colourmatrix_ppvvv_uxdaawx_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_uxdaawx_1_/**/REALKIND



module ol_forced_parameters_ppvvv_uxdaawx_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_uxdaawx_1_/**/REALKIND

module ol_loop_ppvvv_uxdaawx_1_/**/REALKIND
...
! **********************************************************************
  ...
  call vert_VQ_A(wf(:,-3),wf(:,-1),wf(:,11))
  ...
  call vert_AV_Q(wf(:,12),wf(:,-3),wf(:,17))
  call vert_QA_W(wf(:,-1),wf(:,12),wf(:,18))
  call vert_AV_Q(wf(:,0),wf(:,-3),wf(:,19))
  ...
  call vert_AV_Q(wf(:,25),wf(:,-3),wf(:,26))
  ...
  call counter_AV_Q(wf(:,12),wf(:,-3),wf(:,35))
  call counter_AW_Q(wf(:,21),wf(:,-4),wf(:,36))
  call counter_AV_Q(wf(:,25),wf(:,-3),wf(:,37))
  ...
  call counter_VQ_A(wf(:,-3),wf(:,-1),wf(:,43))
  ...
  call vert_AV_Q(wf(:,52),wf(:,-3),wf(:,53))
  call counter_AV_Q(wf(:,0),wf(:,-3),wf(:,54))
  ...
  call vert_AV_Q(wf(:,62),wf(:,-3),wf(:,64))
  ...
  call vert_VQ_A(wf(:,-3),wf(:,16),wf(:,74))
  ...
  call vert_VQ_A(wf(:,-3),wf(:,22),wf(:,85))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (-A(50)-A(51)-A(56)-A(57))*f(7)+(A(43)+A(44)+A(48)+A(49))*f(8)+(A(52)+A(58))*f(9)+(-A(45)-A(46)-A(53)-A(54))*f(10)+( &
       ...
       -A(31)-A(34))*f(14)+(A(16)+A(19)+A(22)+A(25)+A(36)+A(39))*f(15)+(A(21)+A(24)+A(37)+A(40))*f(16)+(-A(14)+A(41)+A(42))*f(17)

end subroutine colourvectors

end module ol_loop_ppvvv_uxdaawx_1_/**/REALKIND
