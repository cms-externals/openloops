...
module ol_colourmatrix_ppvvv_ddxazz_1_/**/REALKIND
...
end module ol_colourmatrix_ppvvv_ddxazz_1_/**/REALKIND



module ol_forced_parameters_ppvvv_ddxazz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppvvv_ddxazz_1_/**/REALKIND

module ol_loop_ppvvv_ddxazz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f(4) = (eQED**3*gQCD**2*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call counter_ZQ_A(gZd,wf(:,-3),wf(:,3),wf(:,20))
  call counter_ZQ_A(gZd,wf(:,-4),wf(:,11),wf(:,21))
  call counter_ZQ_A(gZd,wf(:,-3),wf(:,15),wf(:,22))
  ...
  call counter_AZ_Q(gZd,wf(:,-1),wf(:,-3),wf(:,27))
  ...
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,32),wf(:,33))
  call counter_ZQ_A(gZd,wf(:,-3),wf(:,0),wf(:,34))
  ...
  call vert_ZQ_A(gZd,wf(:,-3),wf(:,40),wf(:,42))
  ...
  call vert_AZ_Q(gZd,wf(:,7),wf(:,-3),wf(:,48))
  ...
  call vert_AZ_Q(gZd,wf(:,12),wf(:,-3),wf(:,57))
...
end module ol_loop_ppvvv_ddxazz_1_/**/REALKIND
