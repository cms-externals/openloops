...
module ol_vamp_1_ppvvv_uuxzwwx_1_/**/REALKIND
contains

! **********************************************************************
subroutine vamp_1(M)
! P(0:3,nlegs) = incoming external momenta
! Uses tree structures 'wf', factors 'c', and denominators 'den' from loop_ppvvv_uuxzwwx_1.
! Sets colour stripped amplitudes A from the module loop_amplitudes_ppvvv_uuxzwwx_1.
! **********************************************************************
...
#endif
  use ol_loop_ppvvv_uuxzwwx_1_/**/REALKIND, only: c, f, wf, den
  use ol_vert_interface_/**/REALKIND
  use ol_prop_interface_/**/REALKIND
  use ol_last_step_/**/REALKIND
  use ol_tensor_sum_storage_ppvvv_uuxzwwx_1_/**/REALKIND
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,36),G1(:,:,:,3),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,95),G1(:,:,:,5),gZu)
  ...
  call loop_AZ_Q(G3(:,:,:,2),wf(:,-2),G3(:,:,:,3),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,99),G1(:,:,:,10),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,1),wf(:,-2),G1(:,:,:,13),gZu)
  ...
  call loop_A_Q(G0(:,:,:,3),Q(:,18),ZERO,G1(:,:,:,14))
  call loop_AW_Q(G1(:,:,:,14),wf(:,-3),G1(:,:,:,15))
  call loop_A_Q(G1(:,:,:,15),Q(:,26),ZERO,G2(:,:,:,22))
  call check_last_AQ_V(l_switch,G2(:,:,:,22),wf(:,17),G2tensor(:,8))
  call loop_AZ_Q(G2(:,:,:,22),wf(:,-2),G2(:,:,:,23),gZu)
  call loop_A_Q(G2(:,:,:,23),Q(:,30),ZERO,G3(:,:,:,13))
  call check_last_AQ_V(l_switch,G3(:,:,:,13),wf(:,0),G3tensor(:,7))
  call loop_AZ_Q(G1(:,:,:,14),wf(:,-2),G1(:,:,:,16),gZd)
  call loop_A_Q(G1(:,:,:,16),Q(:,22),ZERO,G2(:,:,:,24))
  call check_last_AQ_V(l_switch,G2(:,:,:,24),wf(:,26),G2tensor(:,9))
  call loop_AW_Q(G2(:,:,:,24),wf(:,-3),G2(:,:,:,25))
  call loop_A_Q(G2(:,:,:,25),Q(:,30),ZERO,G3(:,:,:,14))
  call check_last_AQ_V(l_switch,G3(:,:,:,14),wf(:,0),G3tensor(:,8))
  call loop_AW_Q(G1(:,:,:,14),wf(:,6),G1(:,:,:,17))
  call loop_A_Q(G1(:,:,:,17),Q(:,30),ZERO,G2(:,:,:,26))
  call check_last_AQ_V(l_switch,G2(:,:,:,26),wf(:,0),G2tensor(:,10))
  call check_last_AQ_V(l_switch,G1(:,:,:,14),wf(:,73),G1tensor(:,1))
  call check_last_AQ_V(l_switch,G1(:,:,:,14),wf(:,89),G1tensor(:,2))
  call check_last_AQ_V(l_switch,G1(:,:,:,14),wf(:,93),G1tensor(:,3))
  ...
  call loop_QZ_A(G1(:,:,:,18),wf(:,22),G1(:,:,:,20),gZu)
  call loop_Q_A(G1(:,:,:,20),Q(:,29),ZERO,G2(:,:,:,28))
  call check_last_QA_V(l_switch,G2(:,:,:,28),wf(:,-1),G2tensor(:,12))
  call loop_QW_A(G1(:,:,:,18),wf(:,-3),G1(:,:,:,21))
  call loop_Q_A(G1(:,:,:,21),Q(:,13),ZERO,G2(:,:,:,29))
  ...
  call loop_Q_A(G0(:,:,:,5),Q(:,13),ZERO,G1(:,:,:,22))
  ...
  call loop_Q_A(G0(:,:,:,6),Q(:,9),ZERO,G1(:,:,:,24))
  call loop_QW_A(G1(:,:,:,24),wf(:,-4),G1(:,:,:,25))
  call loop_Q_A(G1(:,:,:,25),Q(:,25),ZERO,G2(:,:,:,32))
  call check_last_QA_V(l_switch,G2(:,:,:,32),wf(:,27),G2tensor(:,14))
  ...
  call loop_QW_A(G1(:,:,:,24),wf(:,10),G1(:,:,:,26))
  call loop_Q_A(G1(:,:,:,26),Q(:,29),ZERO,G2(:,:,:,34))
  call check_last_QA_V(l_switch,G2(:,:,:,34),wf(:,-1),G2tensor(:,15))
  call loop_QZ_A(G1(:,:,:,24),wf(:,-2),G1(:,:,:,27),gZd)
  call loop_Q_A(G1(:,:,:,27),Q(:,13),ZERO,G2(:,:,:,35))
  call loop_QW_A(G2(:,:,:,35),wf(:,-4),G2(:,:,:,36))
  call loop_Q_A(G2(:,:,:,36),Q(:,29),ZERO,G3(:,:,:,17))
  ...
  call loop_AZ_Q(G1(:,:,:,28),wf(:,22),G1(:,:,:,30),gZu)
  call loop_A_Q(G1(:,:,:,30),Q(:,30),ZERO,G2(:,:,:,38))
  call check_last_AQ_V(l_switch,G2(:,:,:,38),wf(:,0),G2tensor(:,17))
  call loop_AW_Q(G1(:,:,:,28),wf(:,-4),G1(:,:,:,31))
  call loop_A_Q(G1(:,:,:,31),Q(:,22),ZERO,G2(:,:,:,39))
  ...
  call loop_A_Q(G0(:,:,:,8),Q(:,22),ZERO,G1(:,:,:,32))
  call loop_AW_Q(G1(:,:,:,32),wf(:,-3),G1(:,:,:,33))
  call loop_A_Q(G1(:,:,:,33),Q(:,30),ZERO,G2(:,:,:,41))
  call check_last_AQ_V(l_switch,G2(:,:,:,41),wf(:,0),G2tensor(:,18))
  call check_last_AQ_V(l_switch,G1(:,:,:,32),wf(:,26),G1tensor(:,4))
  call loop_VQ_A(G0(:,:,:,1),wf(:,89),G0(:,:,:,9))
  call loop_Q_A(G0(:,:,:,9),Q(:,13),ZERO,G1(:,:,:,34))
  call loop_QW_A(G1(:,:,:,34),wf(:,-4),G1(:,:,:,35))
  call loop_Q_A(G1(:,:,:,35),Q(:,29),ZERO,G2(:,:,:,42))
  call check_last_QA_V(l_switch,G2(:,:,:,42),wf(:,-1),G2tensor(:,19))
  call loop_VQ_A(G0(:,:,:,1),wf(:,82),G0(:,:,:,10))
  call loop_Q_A(G0(:,:,:,10),Q(:,25),ZERO,G1(:,:,:,36))
  call loop_QZ_A(G1(:,:,:,36),wf(:,-2),G1(:,:,:,37),gZu)
  call loop_Q_A(G1(:,:,:,37),Q(:,29),ZERO,G2(:,:,:,43))
  call check_last_QA_V(l_switch,G2(:,:,:,43),wf(:,-1),G2tensor(:,20))
  call check_last_QA_V(l_switch,G1(:,:,:,36),wf(:,27),G1tensor(:,5))
  call loop_VQ_A(G0(:,:,:,1),wf(:,93),G0(:,:,:,11))
  call loop_Q_A(G0(:,:,:,11),Q(:,13),ZERO,G1(:,:,:,38))
  call loop_QW_A(G1(:,:,:,38),wf(:,-4),G1(:,:,:,39))
  call loop_Q_A(G1(:,:,:,39),Q(:,29),ZERO,G2(:,:,:,44))
  call check_last_QA_V(l_switch,G2(:,:,:,44),wf(:,-1),G2tensor(:,21))
  call loop_VA_Q(G0(:,:,:,1),wf(:,88),G0(:,:,:,12))
  call loop_A_Q(G0(:,:,:,12),Q(:,22),ZERO,G1(:,:,:,40))
  call loop_AW_Q(G1(:,:,:,40),wf(:,-3),G1(:,:,:,41))
  call loop_A_Q(G1(:,:,:,41),Q(:,30),ZERO,G2(:,:,:,45))
  call check_last_AQ_V(l_switch,G2(:,:,:,45),wf(:,0),G2tensor(:,22))
  call check_last_AQ_V(l_switch,G1(:,:,:,40),wf(:,26),G1tensor(:,6))
  call loop_VA_Q(G0(:,:,:,1),wf(:,71),G0(:,:,:,13))
  call loop_A_Q(G0(:,:,:,13),Q(:,26),ZERO,G1(:,:,:,42))
  call loop_AZ_Q(G1(:,:,:,42),wf(:,-2),G1(:,:,:,43),gZu)
  call loop_A_Q(G1(:,:,:,43),Q(:,30),ZERO,G2(:,:,:,46))
  call check_last_AQ_V(l_switch,G2(:,:,:,46),wf(:,0),G2tensor(:,23))
  call check_last_AQ_V(l_switch,G1(:,:,:,42),wf(:,17),G1tensor(:,7))
  call loop_VA_Q(G0(:,:,:,1),wf(:,91),G0(:,:,:,14))
  call loop_A_Q(G0(:,:,:,14),Q(:,22),ZERO,G1(:,:,:,44))
  call loop_AW_Q(G1(:,:,:,44),wf(:,-3),G1(:,:,:,45))
  call loop_A_Q(G1(:,:,:,45),Q(:,30),ZERO,G2(:,:,:,47))
  call check_last_AQ_V(l_switch,G2(:,:,:,47),wf(:,0),G2tensor(:,24))
  call check_last_AQ_V(l_switch,G1(:,:,:,44),wf(:,26),G1tensor(:,8))
  call loop_VQ_A(G0(:,:,:,1),wf(:,84),G0(:,:,:,15))
  call loop_Q_A(G0(:,:,:,15),Q(:,25),ZERO,G1(:,:,:,46))
  call loop_QZ_A(G1(:,:,:,46),wf(:,-2),G1(:,:,:,47),gZu)
  ...
  call loop_QZ_A(G1(:,:,:,48),wf(:,-2),G1(:,:,:,49),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,50),wf(:,-2),G1(:,:,:,51),gZu)
  ...
  call loop_AZ_Q(G1(:,:,:,52),wf(:,-2),G1(:,:,:,53),gZu)
...
end module ol_vamp_1_ppvvv_uuxzwwx_1_/**/REALKIND
