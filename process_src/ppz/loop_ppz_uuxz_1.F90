...
module ol_colourmatrix_ppz_uuxz_1_/**/REALKIND
...
end module ol_colourmatrix_ppz_uuxz_1_/**/REALKIND



module ol_forced_parameters_ppz_uuxz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppz_uuxz_1_/**/REALKIND

module ol_loop_ppz_uuxz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    f(1) = CI*eQED
    f(2) = CI*countertermnorm*ctVqq*eQED*gQCD**2
    f(3) = eQED*gQCD**2*integralnorm*SwB
...
! **********************************************************************
  ...
  call counter_QA_Z(gZu,wf(:,0),wf(:,-1),wf(:,2))
...
end module ol_loop_ppz_uuxz_1_/**/REALKIND
