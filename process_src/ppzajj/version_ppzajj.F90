...
module ol_versiondata_ppzajj
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_ppzajj(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_ppzajj
  end interface
end module ol_versiondata_ppzajj


subroutine ol_version_ppzajj(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_ppzajj, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_ppzajj
