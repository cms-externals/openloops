...
module ol_colourmatrix_ppzajj_uuxbbxaz_1_/**/REALKIND
...
end module ol_colourmatrix_ppzajj_uuxbbxaz_1_/**/REALKIND



module ol_forced_parameters_ppzajj_uuxbbxaz_1_/**/REALKIND
  implicit none
  contains
...
end module ol_forced_parameters_ppzajj_uuxbbxaz_1_/**/REALKIND

module ol_loop_ppzajj_uuxbbxaz_1_/**/REALKIND
...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 5) = CI*countertermnorm*ctAZGG*eQED**2*gQCD**4
    f( 6) = (CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 7) = (2*CI*countertermnorm*ctGbb*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 8) = (CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f( 9) = (2*CI*countertermnorm*ctGqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(10) = (CI*countertermnorm*ctVbb*eQED**2*gQCD**4)/3._/**/REALKIND
    f(11) = (2*CI*countertermnorm*ctVbb*eQED**2*gQCD**4)/3._/**/REALKIND
    f(12) = (CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(13) = (2*CI*countertermnorm*ctVqq*eQED**2*gQCD**4)/3._/**/REALKIND
    f(14) = (countertermnorm*ctZGG*eQED**2*gQCD**4)/3._/**/REALKIND
    f(15) = (2*countertermnorm*ctZGG*eQED**2*gQCD**4)/3._/**/REALKIND
    f(16) = (CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(17) = (2*CI*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(18) = (eQED**2*gQCD**4*integralnorm*SwB)/6._/**/REALKIND
    f(19) = (eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
    f(20) = (2*eQED**2*gQCD**4*integralnorm*SwB)/3._/**/REALKIND
...
! **********************************************************************
  ...
  call prop_Q_A(wf(:,8),Q(:,52),MB,1_intkind1,wf(:,56))
  call counter_AZ_Q(gZd,wf(:,-3),wf(:,-5),wf(:,57))
  call prop_A_Q(wf(:,57),Q(:,40),MB,1_intkind1,wf(:,58))
  call prop_Q_A(wf(:,18),Q(:,52),MB,1_intkind1,wf(:,59))
  ...
  call prop_A_Q(wf(:,16),Q(:,56),MB,1_intkind1,wf(:,65))
  call counter_ZQ_A(gZd,wf(:,-5),wf(:,-2),wf(:,66))
  call prop_Q_A(wf(:,66),Q(:,36),MB,1_intkind1,wf(:,67))
  call vert_VQ_A(wf(:,1),wf(:,67),wf(:,68))
  call prop_A_Q(wf(:,19),Q(:,56),MB,1_intkind1,wf(:,69))
  call vert_VQ_A(wf(:,-4),wf(:,67),wf(:,70))
  call counter_VQ_A(wf(:,-4),wf(:,-2),wf(:,71))
  call prop_Q_A(wf(:,71),Q(:,20),MB,1_intkind1,wf(:,72))
  ...
  call counter_ZQ_A(gZu,wf(:,-5),wf(:,23),wf(:,77))
  call counter_QA_V(wf(:,31),wf(:,32),wf(:,78))
  call counter_AZ_Q(gZu,wf(:,32),wf(:,-5),wf(:,79))
  ...
  call counter_AZ_Q(gZu,wf(:,-1),wf(:,-5),wf(:,97))
  ...
  call vert_AZ_Q(gZu,wf(:,103),wf(:,-5),wf(:,105))
  ...
  call counter_ZQ_A(gZu,wf(:,-5),wf(:,0),wf(:,112))
  ...
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,118),wf(:,120))
  ...
  call prop_A_Q(wf(:,127),Q(:,11),MB,1_intkind1,wf(:,128))
  call vert_VQ_A(wf(:,125),wf(:,12),wf(:,129))
  call vert_VQ_A(wf(:,125),wf(:,-2),wf(:,130))
  call prop_Q_A(wf(:,130),Q(:,7),MB,1_intkind1,wf(:,131))
  ...
  call counter_A_Q(ctbb,wf(:,5),Q(:,40),wf(:,137))
  call prop_Q_A(wf(:,6),Q(:,23),MB,1_intkind1,wf(:,138))
  call vert_AV_Q(wf(:,-3),wf(:,133),wf(:,139))
  call prop_Q_A(wf(:,135),Q(:,20),MB,1_intkind1,wf(:,140))
  call vert_ZQ_A(gZd,wf(:,-5),wf(:,140),wf(:,141))
  call counter_A_Q(ctbb,wf(:,9),Q(:,11),wf(:,142))
  call vert_QA_V(wf(:,12),wf(:,13),wf(:,143))
  call vert_AV_Q(wf(:,13),wf(:,1),wf(:,144))
  call counter_Q_A(ctbb,wf(:,12),Q(:,36),wf(:,145))
  call prop_A_Q(wf(:,144),Q(:,27),MB,1_intkind1,wf(:,146))
  call counter_A_Q(ctbb,wf(:,13),Q(:,24),wf(:,147))
  call prop_Q_A(wf(:,14),Q(:,39),MB,1_intkind1,wf(:,148))
  call vert_VQ_A(wf(:,133),wf(:,-2),wf(:,149))
  call counter_Q_A(ctbb,wf(:,17),Q(:,7),wf(:,150))
  call prop_A_Q(wf(:,147),Q(:,24),MB,1_intkind1,wf(:,151))
  call vert_AZ_Q(gZd,wf(:,151),wf(:,-5),wf(:,152))
  call prop_Q_A(wf(:,145),Q(:,36),MB,1_intkind1,wf(:,153))
  call vert_VQ_A(wf(:,-4),wf(:,153),wf(:,154))
  call prop_A_Q(wf(:,137),Q(:,40),MB,1_intkind1,wf(:,155))
  ...
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,164),wf(:,165))
  ...
  call vert_AZ_Q(gZu,wf(:,176),wf(:,-5),wf(:,177))
  ...
  call prop_Q_A(wf(:,194),Q(:,23),MB,1_intkind1,wf(:,195))
  call vert_ZQ_A(gZd,wf(:,-5),wf(:,17),wf(:,196))
  call prop_Q_A(wf(:,196),Q(:,39),MB,1_intkind1,wf(:,197))
  call vert_AV_Q(wf(:,9),wf(:,-4),wf(:,198))
  call prop_A_Q(wf(:,198),Q(:,27),MB,1_intkind1,wf(:,199))
  call vert_AZ_Q(gZd,wf(:,9),wf(:,-5),wf(:,200))
  call prop_A_Q(wf(:,200),Q(:,43),MB,1_intkind1,wf(:,201))
  call vert_VQ_A(wf(:,-4),wf(:,36),wf(:,202))
  call prop_Q_A(wf(:,202),Q(:,29),ZERO,0_intkind1,wf(:,203))
  call vert_ZQ_A(gZu,wf(:,-5),wf(:,36),wf(:,204))
  ...
  call vert_AZ_Q(gZu,wf(:,28),wf(:,-5),wf(:,208))
  ...
  call prop_A_Q(wf(:,212),Q(:,27),MB,1_intkind1,wf(:,213))
  call vert_QA_V(wf(:,96),wf(:,-1),wf(:,214))
  call vert_VQ_A(wf(:,42),wf(:,-2),wf(:,215))
  call prop_Q_A(wf(:,215),Q(:,23),MB,1_intkind1,wf(:,216))
  ...
  call prop_Q_A(wf(:,230),Q(:,39),MB,1_intkind1,wf(:,231))
  call vert_AV_Q(wf(:,-3),wf(:,43),wf(:,232))
  call prop_A_Q(wf(:,232),Q(:,43),MB,1_intkind1,wf(:,233))
  call vert_QA_V(wf(:,100),wf(:,-1),wf(:,234))
  call vert_VQ_A(wf(:,45),wf(:,-2),wf(:,235))
  call prop_Q_A(wf(:,235),Q(:,39),MB,1_intkind1,wf(:,236))
...
subroutine denominators()
  ...
  den(93) = 1 / (Q(5,43) - MB2)
  den(96) = 1 / (Q(5,23) - MB2)
  den(108) = 1 / (Q(5,27) - MB2)
  den(111) = 1 / (Q(5,39) - MB2)
  den(127) = 1 / (Q(5,46))
  den(131) = 1 / (Q(5,29))
  den(134) = 1 / (Q(5,51))
  den(143) = 1 / (Q(5,30))
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = ((-A(106)-A(107)-A(108)-A(109)-A(110)-A(111)-A(112)-A(113)-A(114)-A(115)-A(116)-A(117)-A(118)-A(119)-A(120)-A(121) &
       -A(122)-A(123)-A(154)-A(155)-A(156)-A(157)-A(158)-A(159)-A(160)-A(161)-A(162)-A(163)-A(164)-A(165))*f(3))/2._/**/REALKIND &
  ...
  M2(2) = ((A(106)+A(107)+A(108)+A(109)+A(110)+A(111)+A(112)+A(113)+A(114)+A(115)+A(116)+A(117)+A(118)+A(119)+A(120)+A(121)+A(122) &
       +A(123)+A(154)+A(155)+A(156)+A(157)+A(158)+A(159)+A(160)+A(161)+A(162)+A(163)+A(164)+A(165))*f(3))/6._/**/REALKIND+(( &
       -A(124)-A(125)-A(126)-A(127)-A(128)-A(129)-A(130)-A(131)-A(132)-A(133)-A(134)-A(135)-A(136)-A(137)-A(138)-A(139)-A(140) &
...
end module ol_loop_ppzajj_uuxbbxaz_1_/**/REALKIND
