...
subroutine factors_init()
  ...
  ! factors of the diagrams
    ...
    f(2) = (eQED*gQCD**2*YT)/(MW*sw*2._/**/REALKIND)
...
#else
subroutine amp2(P_scatt, M2, I, MOM, nextcombs, extcombs, M2munu)
  use ol_tree_pphtt_ttxhgg_1_/**/DREALKIND, only: ntry, nhel, Hel, M1helarr
#endif
...
! **********************************************************************
  ...
  use ol_external_pphtt_ttxhgg_1, only: H, hel_not_initialised, hel_init, POLSEL
  ...
  JBmunu = 0
  if (I > 0) then
    ReplacePol = external_perm_pphtt_ttxhgg_1(I)
  else if (I < 0) then
    JBmunu = external_perm_pphtt_ttxhgg_1(-I)
  end if
  ...
  call prop_A_Q(ntry, wf4(:,4), Q(:,18), MT, 1_intkind1, wf4(:,5), n2(3))
  ...
  call prop_Q_A(ntry, wf4(:,9), Q(:,9), MT, 1_intkind1, wf4(:,10), n2(4))
  call prop_A_Q(ntry, wf2(:,3), Q(:,6), MT, 1_intkind1, wf2(:,4), n2(5))
  call vert_VQ_A(ntry, ex5, wf4(:,10), wf8(:,1), n3(:,10), t3x8(:,:,1))
  call vert_VQ_A(ntry, ex5, ex1, wf4(:,11), n3(:,11), t3x4(:,:,8))
  call prop_Q_A(ntry, wf4(:,11), Q(:,17), MT, 1_intkind1, wf4(:,12), n2(6))
...
subroutine colourvector(M1out, nhelout) &
  & bind(c,name="ol_tree_colvect_pphtt_ttxhgg_1")
