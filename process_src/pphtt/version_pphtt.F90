...
module ol_versiondata_pphtt
  implicit none
  character(4) :: generator_revision = "1248"
  interface
    subroutine version_pphtt(outstring)
      implicit none
      character(60), intent(out), optional :: outstring
    end subroutine version_pphtt
  end interface
end module ol_versiondata_pphtt


subroutine ol_version_pphtt(outstring)
  use ol_version, only: version, revision
  use ol_versiondata_pphtt, only: generator_revision
  implicit none
  character(60), intent(out), optional :: outstring
...
end subroutine ol_version_pphtt
