...
! **********************************************************************
  ...
  ! factors of the diagrams
    ...
    f( 3) = (CI*countertermnorm*ctHGG*eQED*gQCD**4*MT*YT)/MQ2sum
    f( 4) = (CI*eQED*gQCD**2*YT)/(2._/**/REALKIND*MW*sw)
    f( 5) = (CI*countertermnorm*eQED*gQCD**4*YT)/(2._/**/REALKIND*MW*sw)
    f( 6) = (CI*countertermnorm*ctGqq*eQED*gQCD**4*YT)/(2._/**/REALKIND*MW*sw)
    f( 7) = (CI*countertermnorm*ctGtt*eQED*gQCD**4*YT)/(2._/**/REALKIND*MW*sw)
    f( 8) = (CI*countertermnorm*ctStt*eQED*gQCD**4*YT)/(2._/**/REALKIND*MW*sw)
    f( 9) = (CI*eQED*gQCD**4*integralnorm*SwB*YT)/(2._/**/REALKIND*MW*sw)
    f(10) = (eQED*gQCD**4*integralnorm*SwB*YT)/(MW*sw*4._/**/REALKIND)
    f(11) = (eQED*gQCD**4*integralnorm*SwB*YT)/(MW*sw*2._/**/REALKIND)
    f(12) = (eQED*gQCD**4*integralnorm*SwF*YT)/(MW*sw*2._/**/REALKIND)
    f(13) = (eQED*gQCD**4*integralnorm*SwF*YT)/(MW*sw)

  c = [ 3*f(2), 9*f(2), 9*CI*f(9), 27*CI*f(9), 18*f(10), 54*f(10), f(11), 3*f(11), 6*f(11), 8*f(11), 10*f(11), 18*f(11), 21*f(11) &
    , 24*f(11), 54*f(11), 3*f(12), 9*f(12), 3*f(13), 9*f(13) ]
  c = (1._/**/REALKIND / 36) * c
...
subroutine diagrams(A)
  ...
  A(5) = cont_VV(wf(:,4),wf(:,10)) * den(3)
  A(6) = cont_VV(wf(:,7),wf(:,10)) * den(5)
  A(7) = cont_VV(wf(:,2),wf(:,11)) * den(3)
  A(8) = cont_VV(wf(:,2),wf(:,14)) * den(5)
  A(9) = cont_VV(wf(:,2),wf(:,15)) * den(5)
  A(10) = cont_VV(wf(:,2),wf(:,18)) * den(3)
  A(11) = cont_QA(wf(:,20),wf(:,21)) * den(10)
  A(12) = cont_VV(wf(:,4),wf(:,22)) * den(13)
  A(13) = cont_QA(wf(:,24),wf(:,25)) * den(16)
  A(14) = cont_VV(wf(:,7),wf(:,22)) * den(18)
...
subroutine colourvectors(A, M1, M2)
  ...
  M2(1) = (A(4)*f(1))/2._/**/REALKIND+(A(3)*f(3))/2._/**/REALKIND+((-A(11)-A(12)-A(13)-A(14))*f(5))/2._/**/REALKIND+((A(5) &
       +A(6))*f(6))/2._/**/REALKIND+((A(7)+A(9))*f(7))/2._/**/REALKIND+((A(8)+A(10))*f(8))/2._/**/REALKIND
  M2(2) = -(A(4)*f(1))/6._/**/REALKIND-(A(3)*f(3))/6._/**/REALKIND+((A(11)+A(12)+A(13)+A(14))*f(5))/6._/**/REALKIND+((-A(5) &
       -A(6))*f(6))/6._/**/REALKIND+((-A(7)-A(9))*f(7))/6._/**/REALKIND+((-A(8)-A(10))*f(8))/6._/**/REALKIND
